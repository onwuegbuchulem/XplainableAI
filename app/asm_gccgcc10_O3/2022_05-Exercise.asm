...
/app/bin_gccgcc10_O3/2022_05-Exercise:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e2:	66 0f ef d2          	pxor   %xmm2,%xmm2
    10e6:	48 8d 35 33 0f 00 00 	lea    0xf33(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    10ed:	bf 01 00 00 00       	mov    $0x1,%edi
    10f2:	b8 02 00 00 00       	mov    $0x2,%eax
    10f7:	f3 0f 2c d0          	cvttss2si %xmm0,%edx
    10fb:	0f 28 c8             	movaps %xmm0,%xmm1
    10fe:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1102:	f3 0f 2a d2          	cvtsi2ss %edx,%xmm2
    1106:	f3 0f 5c ca          	subss  %xmm2,%xmm1
    110a:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
