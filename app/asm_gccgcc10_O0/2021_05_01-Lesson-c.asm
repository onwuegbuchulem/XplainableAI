...
/app/bin_gccgcc10_O0/2021_05_01-Lesson-c:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    11ce:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11d5:	00 00 
    11d7:	74 05                	je     11de <main+0x75>
