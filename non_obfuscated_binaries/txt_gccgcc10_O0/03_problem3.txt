...
/app/bin_gccgcc10_O0/03_problem3:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	f3 0f 10 05 cb 0e 00 	movss  0xecb(%rip),%xmm0        # 2028 <_IO_stdin_used+0x28>
    115c:	00 
    115d:	f3 0f 11 45 f8       	movss  %xmm0,-0x8(%rbp)
    1162:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1166:	f3 0f 5a 4d f8       	cvtss2sd -0x8(%rbp),%xmm1
    116b:	f2 0f 10 05 bd 0e 00 	movsd  0xebd(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    1172:	00 
    1173:	f2 0f 59 c8          	mulsd  %xmm0,%xmm1
    1177:	f2 0f 10 05 b9 0e 00 	movsd  0xeb9(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    117e:	00 
    117f:	f2 0f 58 c1          	addsd  %xmm1,%xmm0
    1183:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    1187:	f3 0f 11 45 fc       	movss  %xmm0,-0x4(%rbp)
    118c:	66 0f ef d2          	pxor   %xmm2,%xmm2
    1190:	f3 0f 5a 55 fc       	cvtss2sd -0x4(%rbp),%xmm2
    1195:	66 48 0f 7e d0       	movq   %xmm2,%rax
    ...
    11ab:	e8 a0 fe ff ff       	callq  1050 <printf@plt>
