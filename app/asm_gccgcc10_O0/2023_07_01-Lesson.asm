...
/app/bin_gccgcc10_O0/2023_07_01-Lesson:     file format elf64-x86-64
...
00000000000010a0 <snprintf@plt>:
    ...
    10a4:	f2 ff 25 1d 2f 00 00 	bnd jmpq *0x2f1d(%rip)        # 3fc8 <snprintf@GLIBC_2.2.5>
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d 4f 01 00 00 	lea    0x14f(%rip),%rdi        # 1237 <main>
...
00000000000011a9 <sum>:
    ...
    11c7:	8b 55 bc             	mov    -0x44(%rbp),%edx
    11ca:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    11ce:	89 d1                	mov    %edx,%ecx
    11d0:	48 8d 15 2d 0e 00 00 	lea    0xe2d(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    11d7:	be 20 00 00 00       	mov    $0x20,%esi
    11dc:	48 89 c7             	mov    %rax,%rdi
    11df:	b8 00 00 00 00       	mov    $0x0,%eax
    11e4:	e8 b7 fe ff ff       	callq  10a0 <snprintf@plt>
    11e9:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%rbp)
    11f0:	c7 45 cc 00 00 00 00 	movl   $0x0,-0x34(%rbp)
    11f7:	eb 17                	jmp    1210 <sum+0x67>
    11f9:	8b 45 c8             	mov    -0x38(%rbp),%eax
    11fc:	48 98                	cltq   
    11fe:	0f b6 44 05 d0       	movzbl -0x30(%rbp,%rax,1),%eax
    1203:	0f be c0             	movsbl %al,%eax
    1206:	83 e8 30             	sub    $0x30,%eax
    1209:	01 45 cc             	add    %eax,-0x34(%rbp)
    120c:	83 45 c8 01          	addl   $0x1,-0x38(%rbp)
    1210:	8b 45 c8             	mov    -0x38(%rbp),%eax
    1213:	48 98                	cltq   
    1215:	0f b6 44 05 d0       	movzbl -0x30(%rbp,%rax,1),%eax
    121a:	84 c0                	test   %al,%al
    121c:	75 db                	jne    11f9 <sum+0x50>
    121e:	8b 45 cc             	mov    -0x34(%rbp),%eax
    1221:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1225:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    122c:	00 00 
    122e:	74 05                	je     1235 <sum+0x8c>
    1230:	e8 4b fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    1235:	c9                   	leaveq 
    1236:	c3                   	retq   
...
0000000000001237 <main>:
    ...
    1252:	48 8d 3d ae 0d 00 00 	lea    0xdae(%rip),%rdi        # 2007 <_IO_stdin_used+0x7>
    1259:	b8 00 00 00 00       	mov    $0x0,%eax
    125e:	e8 2d fe ff ff       	callq  1090 <printf@plt>
    1263:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    ...
    127b:	8b 45 f0             	mov    -0x10(%rbp),%eax
    127e:	89 c7                	mov    %eax,%edi
    1280:	e8 24 ff ff ff       	callq  11a9 <sum>
    1285:	89 45 f4             	mov    %eax,-0xc(%rbp)
    1288:	8b 45 f4             	mov    -0xc(%rbp),%eax
    128b:	89 c6                	mov    %eax,%esi
    128d:	48 8d 3d 8e 0d 00 00 	lea    0xd8e(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    1294:	b8 00 00 00 00       	mov    $0x0,%eax
    1299:	e8 f2 fd ff ff       	callq  1090 <printf@plt>
    129e:	b8 00 00 00 00       	mov    $0x0,%eax
    12a3:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    12a7:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    12ae:	00 00 
    12b0:	74 05                	je     12b7 <main+0x80>
