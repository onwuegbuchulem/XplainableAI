...
/app/bin_gccgcc10_O1/SwapIntegersWithout3rdVariable(Arithmatic):     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    116d:	55                   	push   %rbp
    116e:	53                   	push   %rbx
    116f:	48 83 ec 18          	sub    $0x18,%rsp
    1173:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    117a:	00 00 
    117c:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    1181:	31 c0                	xor    %eax,%eax
    1183:	c7 04 24 05 00 00 00 	movl   $0x5,(%rsp)
    118a:	c7 44 24 04 0a 00 00 	movl   $0xa,0x4(%rsp)
    1191:	00 
    1192:	48 8d 6c 24 04       	lea    0x4(%rsp),%rbp
    1197:	48 89 e3             	mov    %rsp,%rbx
    ...
    11b1:	8b 44 24 04          	mov    0x4(%rsp),%eax
    11b5:	8b 14 24             	mov    (%rsp),%edx
    11b8:	89 54 24 04          	mov    %edx,0x4(%rsp)
    11bc:	89 04 24             	mov    %eax,(%rsp)
    11bf:	48 89 e9             	mov    %rbp,%rcx
    11c2:	48 89 da             	mov    %rbx,%rdx
    11c5:	48 8d 35 54 0e 00 00 	lea    0xe54(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    11cc:	bf 01 00 00 00       	mov    $0x1,%edi
    11d1:	b8 00 00 00 00       	mov    $0x0,%eax
    11d6:	e8 95 fe ff ff       	callq  1070 <__printf_chk@plt>
    11db:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11e0:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11e7:	00 00 
    11e9:	75 0c                	jne    11f7 <main+0x8e>
    11eb:	b8 00 00 00 00       	mov    $0x0,%eax
    11f0:	48 83 c4 18          	add    $0x18,%rsp
    11f4:	5b                   	pop    %rbx
    11f5:	5d                   	pop    %rbp
    11f6:	c3                   	retq   
    11f7:	e8 64 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
