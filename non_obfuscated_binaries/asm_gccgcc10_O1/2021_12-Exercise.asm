...
/app/bin_gccgcc10_O1/2021_12-Exercise:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119d:	eb 1b                	jmp    11ba <main+0x31>
    119f:	89 da                	mov    %ebx,%edx
    11a1:	29 ea                	sub    %ebp,%edx
    11a3:	0f b6 d2             	movzbl %dl,%edx
    ...
    11b8:	89 dd                	mov    %ebx,%ebp
    11ba:	48 8b 3d 5f 2e 00 00 	mov    0x2e5f(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    11c1:	e8 ca fe ff ff       	callq  1090 <getc@plt>
    11c6:	89 c3                	mov    %eax,%ebx
    11c8:	83 f8 ff             	cmp    $0xffffffff,%eax
    11cb:	75 d2                	jne    119f <main+0x16>
    11cd:	48 8b 35 3c 2e 00 00 	mov    0x2e3c(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11d4:	bf 0a 00 00 00       	mov    $0xa,%edi
    11d9:	e8 92 fe ff ff       	callq  1070 <putc@plt>
