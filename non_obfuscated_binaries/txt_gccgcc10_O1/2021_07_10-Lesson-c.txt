...
/app/bin_gccgcc10_O1/2021_07_10-Lesson-c:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117a:	48 89 f5             	mov    %rsi,%rbp
    117d:	c7 05 b9 2e 00 00 00 	movl   $0x0,0x2eb9(%rip)        # 4040 <opterr@@GLIBC_2.2.5>
    1184:	00 00 00 
    1187:	bb 00 00 00 00       	mov    $0x0,%ebx
    118c:	4c 8d 2d a7 0e 00 00 	lea    0xea7(%rip),%r13        # 203a <_IO_stdin_used+0x3a>
    1193:	eb 1f                	jmp    11b4 <main+0x4b>
    1195:	8b 15 85 2e 00 00    	mov    0x2e85(%rip),%edx        # 4020 <optopt@@GLIBC_2.2.5>
    ...
    11ac:	e8 af fe ff ff       	callq  1060 <__printf_chk@plt>
    11b1:	83 c3 01             	add    $0x1,%ebx
    11b4:	4c 89 ea             	mov    %r13,%rdx
    11b7:	48 89 ee             	mov    %rbp,%rsi
    11ba:	44 89 e7             	mov    %r12d,%edi
    11bd:	e8 ae fe ff ff       	callq  1070 <getopt@plt>
    11c2:	83 f8 ff             	cmp    $0xffffffff,%eax
    11c5:	74 1f                	je     11e6 <main+0x7d>
    11c7:	83 f8 3f             	cmp    $0x3f,%eax
    11ca:	74 c9                	je     1195 <main+0x2c>
    11cc:	89 c2                	mov    %eax,%edx
    11ce:	48 8d 35 52 0e 00 00 	lea    0xe52(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    11d5:	bf 01 00 00 00       	mov    $0x1,%edi
    11da:	b8 00 00 00 00       	mov    $0x0,%eax
    11df:	e8 7c fe ff ff       	callq  1060 <__printf_chk@plt>
    11e4:	eb cb                	jmp    11b1 <main+0x48>
    11e6:	89 da                	mov    %ebx,%edx
    11e8:	48 8d 35 4f 0e 00 00 	lea    0xe4f(%rip),%rsi        # 203e <_IO_stdin_used+0x3e>
    11ef:	bf 01 00 00 00       	mov    $0x1,%edi
    11f4:	b8 00 00 00 00       	mov    $0x0,%eax
    11f9:	e8 62 fe ff ff       	callq  1060 <__printf_chk@plt>
    11fe:	b8 00 00 00 00       	mov    $0x0,%eax
    1203:	48 83 c4 08          	add    $0x8,%rsp
    1207:	5b                   	pop    %rbx
    1208:	5d                   	pop    %rbp
    1209:	41 5c                	pop    %r12
    120b:	41 5d                	pop    %r13
