...
/app/bin_gccgcc10_O0/2021_04_03-Lesson-b:     file format elf64-x86-64
...
00000000000011a8 <main>:
    ...
    11bf:	eb 36                	jmp    11f7 <main+0x4f>
    11c1:	0f b6 45 fb          	movzbl -0x5(%rbp),%eax
    11c5:	0f b6 c0             	movzbl %al,%eax
    11c8:	89 c7                	mov    %eax,%edi
    11ca:	e8 7a ff ff ff       	callq  1149 <binbin>
    11cf:	48 89 c2             	mov    %rax,%rdx
    11d2:	0f be 45 fb          	movsbl -0x5(%rbp),%eax
    ...
    11e9:	0f b6 45 fb          	movzbl -0x5(%rbp),%eax
    11ed:	83 c0 01             	add    $0x1,%eax
    11f0:	88 45 fb             	mov    %al,-0x5(%rbp)
    11f3:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    11f7:	81 7d fc ff 00 00 00 	cmpl   $0xff,-0x4(%rbp)
    11fe:	7e c1                	jle    11c1 <main+0x19>
