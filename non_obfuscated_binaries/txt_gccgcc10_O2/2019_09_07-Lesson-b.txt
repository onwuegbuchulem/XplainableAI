...
/app/bin_gccgcc10_O2/2019_09_07-Lesson-b:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    110d:	49 89 e0             	mov    %rsp,%r8
    1110:	31 c0                	xor    %eax,%eax
    1112:	b9 1a 00 00 00       	mov    $0x1a,%ecx
    1117:	4c 89 c7             	mov    %r8,%rdi
    111a:	f3 48 ab             	rep stos %rax,%es:(%rdi)
    111d:	4c 89 c7             	mov    %r8,%rdi
    1120:	e8 2b 01 00 00       	callq  1250 <draw>
    1125:	48 8d 35 d8 0e 00 00 	lea    0xed8(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    ...
    113a:	48 8b 84 24 d8 00 00 	mov    0xd8(%rsp),%rax
    1141:	00 
    1142:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1149:	00 00 
    114b:	75 0a                	jne    1157 <main+0x77>
    114d:	31 c0                	xor    %eax,%eax
    114f:	48 81 c4 e8 00 00 00 	add    $0xe8,%rsp
    1156:	c3                   	retq   
    1157:	e8 34 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
...
0000000000001250 <draw>:
    1250:	f3 0f 1e fa          	endbr64 
    1254:	53                   	push   %rbx
    1255:	48 89 fb             	mov    %rdi,%rbx
    1258:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    125f:	00 
    1260:	e8 6b fe ff ff       	callq  10d0 <rand@plt>
    1265:	89 c2                	mov    %eax,%edx
    1267:	48 98                	cltq   
    1269:	48 69 c0 4f ec c4 4e 	imul   $0x4ec4ec4f,%rax,%rax
    1270:	89 d1                	mov    %edx,%ecx
    1272:	c1 f9 1f             	sar    $0x1f,%ecx
    1275:	48 c1 f8 24          	sar    $0x24,%rax
    1279:	29 c8                	sub    %ecx,%eax
    127b:	6b c8 34             	imul   $0x34,%eax,%ecx
    127e:	89 d0                	mov    %edx,%eax
    1280:	29 c8                	sub    %ecx,%eax
    1282:	48 63 d0             	movslq %eax,%rdx
    1285:	48 8d 14 93          	lea    (%rbx,%rdx,4),%rdx
    1289:	8b 0a                	mov    (%rdx),%ecx
    128b:	85 c9                	test   %ecx,%ecx
    128d:	75 d1                	jne    1260 <draw+0x10>
    128f:	c7 02 01 00 00 00    	movl   $0x1,(%rdx)
    1295:	5b                   	pop    %rbx
    1296:	c3                   	retq   
