...
/app/bin_gccgcc10_O3/2020_12_12-Lesson:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    106c:	53                   	push   %rbx
    106d:	bb 32 00 00 00       	mov    $0x32,%ebx
    1072:	48 83 ec 18          	sub    $0x18,%rsp
    1076:	f2 0f 10 0d 92 0f 00 	movsd  0xf92(%rip),%xmm1        # 2010 <_IO_stdin_used+0x10>
    107d:	00 
    107e:	66 0f 28 d1          	movapd %xmm1,%xmm2
    1082:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1088:	66 0f 28 c2          	movapd %xmm2,%xmm0
    108c:	48 89 ee             	mov    %rbp,%rsi
    108f:	bf 01 00 00 00       	mov    $0x1,%edi
    1094:	b8 01 00 00 00       	mov    $0x1,%eax
    1099:	f2 0f 11 4c 24 08    	movsd  %xmm1,0x8(%rsp)
    109f:	f2 0f 11 14 24       	movsd  %xmm2,(%rsp)
    10a4:	e8 a7 ff ff ff       	callq  1050 <__printf_chk@plt>
    10a9:	f2 0f 10 4c 24 08    	movsd  0x8(%rsp),%xmm1
    10af:	f2 0f 10 14 24       	movsd  (%rsp),%xmm2
    10b4:	48 89 ee             	mov    %rbp,%rsi
    10b7:	bf 01 00 00 00       	mov    $0x1,%edi
    10bc:	b8 01 00 00 00       	mov    $0x1,%eax
    10c1:	f2 0f 58 d1          	addsd  %xmm1,%xmm2
    10c5:	66 0f 28 c1          	movapd %xmm1,%xmm0
    10c9:	f2 0f 11 0c 24       	movsd  %xmm1,(%rsp)
    10ce:	f2 0f 11 54 24 08    	movsd  %xmm2,0x8(%rsp)
    10d4:	e8 77 ff ff ff       	callq  1050 <__printf_chk@plt>
    10d9:	f2 0f 10 0c 24       	movsd  (%rsp),%xmm1
    10de:	f2 0f 10 54 24 08    	movsd  0x8(%rsp),%xmm2
    10e4:	f2 0f 58 ca          	addsd  %xmm2,%xmm1
    10e8:	83 eb 01             	sub    $0x1,%ebx
    10eb:	75 9b                	jne    1088 <main+0x28>
    10ed:	48 83 c4 18          	add    $0x18,%rsp
