...
/app/bin_gccgcc10_O1/2021_11_27-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <strspn@plt>:
    1080:	f3 0f 1e fa          	endbr64 
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <strspn@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    11a1:	48 b8 48 45 4c 4c 4f 	movabs $0x57202c4f4c4c4548,%rax
    11a8:	2c 20 57 
    11ab:	48 89 44 24 02       	mov    %rax,0x2(%rsp)
    11b0:	c7 44 24 0a 4f 52 4c 	movl   $0x444c524f,0xa(%rsp)
    11b7:	44 
    11b8:	66 c7 44 24 0e 21 00 	movw   $0x21,0xe(%rsp)
    ...
    11d8:	48 89 54 24 18       	mov    %rdx,0x18(%rsp)
    11dd:	48 b8 51 52 53 54 55 	movabs $0x5857565554535251,%rax
    11e4:	56 57 58 
    11e7:	48 89 44 24 20       	mov    %rax,0x20(%rsp)
    11ec:	66 c7 44 24 28 59 5a 	movw   $0x5a59,0x28(%rsp)
    11f3:	c6 44 24 2a 00       	movb   $0x0,0x2a(%rsp)
    11f8:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    11fd:	48 8d 7c 24 02       	lea    0x2(%rsp),%rdi
    1202:	e8 79 fe ff ff       	callq  1080 <strspn@plt>
    1207:	48 89 c2             	mov    %rax,%rdx
    120a:	0f be 4c 04 02       	movsbl 0x2(%rsp,%rax,1),%ecx
    120f:	48 8d 35 ee 0d 00 00 	lea    0xdee(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1216:	bf 01 00 00 00       	mov    $0x1,%edi
    121b:	b8 00 00 00 00       	mov    $0x0,%eax
    1220:	e8 6b fe ff ff       	callq  1090 <__printf_chk@plt>
    1225:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    122a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1231:	00 00 
    1233:	75 0a                	jne    123f <main+0xb6>
    1235:	b8 00 00 00 00       	mov    $0x0,%eax
    123a:	48 83 c4 48          	add    $0x48,%rsp
    123e:	c3                   	retq   
    123f:	e8 2c fe ff ff       	callq  1070 <__stack_chk_fail@plt>
