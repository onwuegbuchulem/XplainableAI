...
/app/bin_gccgcc10_O3/2023_05_13-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c2:	e8 a9 ff ff ff       	callq  1070 <clock_gettime@plt>
    10c7:	31 ff                	xor    %edi,%edi
    10c9:	48 89 ee             	mov    %rbp,%rsi
    10cc:	48 8b 5c 24 08       	mov    0x8(%rsp),%rbx
    10d1:	e8 9a ff ff ff       	callq  1070 <clock_gettime@plt>
    10d6:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    10db:	31 c0                	xor    %eax,%eax
    10dd:	48 8d 35 20 0f 00 00 	lea    0xf20(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10e4:	bf 01 00 00 00       	mov    $0x1,%edi
    10e9:	48 29 da             	sub    %rbx,%rdx
    ...
    10fd:	00 00 
    10ff:	75 09                	jne    110a <main+0x6a>
    1101:	48 83 c4 28          	add    $0x28,%rsp
    1105:	31 c0                	xor    %eax,%eax
    1107:	5b                   	pop    %rbx
    1108:	5d                   	pop    %rbp
    1109:	c3                   	retq   
    110a:	e8 71 ff ff ff       	callq  1080 <__stack_chk_fail@plt>
    110f:	90                   	nop
