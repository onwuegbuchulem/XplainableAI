...
/app/bin_gccgcc10_O0/2024_07_06-Lesson-b:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11bc:	eb 0e                	jmp    11cc <main+0x23>
    11be:	bf 58 00 00 00       	mov    $0x58,%edi
    11c3:	e8 b8 fe ff ff       	callq  1080 <putchar@plt>
    11c8:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    11cc:	83 7d fc 13          	cmpl   $0x13,-0x4(%rbp)
    11d0:	7e ec                	jle    11be <main+0x15>
    11d2:	48 8b 05 37 2e 00 00 	mov    0x2e37(%rip),%rax        # 4010 <stdout@@GLIBC_2.2.5>
    11d9:	48 89 c7             	mov    %rax,%rdi
    11dc:	e8 bf fe ff ff       	callq  10a0 <fflush@plt>
    11e1:	bf 01 00 00 00       	mov    $0x1,%edi
    11e6:	e8 c5 fe ff ff       	callq  10b0 <sleep@plt>
    11eb:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
    11f2:	eb 15                	jmp    1209 <main+0x60>
    11f4:	48 8d 3d 09 0e 00 00 	lea    0xe09(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11fb:	b8 00 00 00 00       	mov    $0x0,%eax
    1200:	e8 8b fe ff ff       	callq  1090 <printf@plt>
    1205:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    1209:	83 7d fc 13          	cmpl   $0x13,-0x4(%rbp)
    120d:	7e e5                	jle    11f4 <main+0x4b>
    120f:	bf 0a 00 00 00       	mov    $0xa,%edi
    1214:	e8 67 fe ff ff       	callq  1080 <putchar@plt>
