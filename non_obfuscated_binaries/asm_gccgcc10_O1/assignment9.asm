...
/app/bin_gccgcc10_O1/assignment9:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	83 ff 03             	cmp    $0x3,%edi
    1154:	74 20                	je     1176 <main+0x2d>
    1156:	48 8d 35 ab 0e 00 00 	lea    0xeab(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    ...
    1175:	c3                   	retq   
    1176:	48 8b 4e 10          	mov    0x10(%rsi),%rcx
    117a:	48 8b 56 08          	mov    0x8(%rsi),%rdx
    117e:	48 8d 35 ab 0e 00 00 	lea    0xeab(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    1185:	bf 01 00 00 00       	mov    $0x1,%edi
    118a:	b8 00 00 00 00       	mov    $0x0,%eax
    118f:	e8 bc fe ff ff       	callq  1050 <__printf_chk@plt>
    1194:	eb d6                	jmp    116c <main+0x23>
