...
/app/bin_gccgcc10_O0/FibonacciGeneration:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d 00 01 00 00 	lea    0x100(%rip),%rdi        # 1188 <main>
...
0000000000001149 <fib>:
    ...
    1159:	83 7d ec 01          	cmpl   $0x1,-0x14(%rbp)
    115d:	7f 05                	jg     1164 <fib+0x1b>
    115f:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1162:	eb 1e                	jmp    1182 <fib+0x39>
    1164:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1167:	83 e8 01             	sub    $0x1,%eax
    116a:	89 c7                	mov    %eax,%edi
    116c:	e8 d8 ff ff ff       	callq  1149 <fib>
    1171:	89 c3                	mov    %eax,%ebx
    1173:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1176:	83 e8 02             	sub    $0x2,%eax
    1179:	89 c7                	mov    %eax,%edi
    117b:	e8 c9 ff ff ff       	callq  1149 <fib>
    1180:	01 d8                	add    %ebx,%eax
    1182:	48 8b 5d f8          	mov    -0x8(%rbp),%rbx
    1186:	c9                   	leaveq 
    1187:	c3                   	retq   
...
0000000000001188 <main>:
    ...
    1194:	c7 45 fc 0b 00 00 00 	movl   $0xb,-0x4(%rbp)
    119b:	8b 45 fc             	mov    -0x4(%rbp),%eax
    119e:	89 c7                	mov    %eax,%edi
    11a0:	e8 a4 ff ff ff       	callq  1149 <fib>
