...
/app/bin_gccgcc10_O1/checksum01:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1171:	55                   	push   %rbp
    1172:	53                   	push   %rbx
    1173:	48 83 ec 38          	sub    $0x38,%rsp
    1177:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    117e:	00 00 
    1180:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    1185:	31 c0                	xor    %eax,%eax
    1187:	c7 04 24 41 00 00 00 	movl   $0x41,(%rsp)
    118e:	c7 44 24 04 42 00 00 	movl   $0x42,0x4(%rsp)
    1195:	00 
    1196:	c7 44 24 08 43 00 00 	movl   $0x43,0x8(%rsp)
    119d:	00 
    119e:	c7 44 24 0c 44 00 00 	movl   $0x44,0xc(%rsp)
    11a5:	00 
    11a6:	c7 44 24 10 45 00 00 	movl   $0x45,0x10(%rsp)
    11ad:	00 
    11ae:	c7 44 24 14 46 00 00 	movl   $0x46,0x14(%rsp)
    11b5:	00 
    11b6:	c7 44 24 18 47 00 00 	movl   $0x47,0x18(%rsp)
    11bd:	00 
    11be:	c7 44 24 1c 48 00 00 	movl   $0x48,0x1c(%rsp)
    11c5:	00 
    11c6:	c7 44 24 20 49 00 00 	movl   $0x49,0x20(%rsp)
    11cd:	00 
    11ce:	c7 44 24 24 4a 00 00 	movl   $0x4a,0x24(%rsp)
    11d5:	00 
    11d6:	48 89 e3             	mov    %rsp,%rbx
    11d9:	4c 8d 6c 24 28       	lea    0x28(%rsp),%r13
    11de:	bd 00 00 00 00       	mov    $0x0,%ebp
    11e3:	4c 8d 25 1a 0e 00 00 	lea    0xe1a(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    11ea:	8b 13                	mov    (%rbx),%edx
    11ec:	01 d5                	add    %edx,%ebp
    11ee:	4c 89 e6             	mov    %r12,%rsi
    11f1:	bf 01 00 00 00       	mov    $0x1,%edi
    11f6:	b8 00 00 00 00       	mov    $0x0,%eax
    11fb:	e8 70 fe ff ff       	callq  1070 <__printf_chk@plt>
    1200:	48 83 c3 04          	add    $0x4,%rbx
    1204:	4c 39 eb             	cmp    %r13,%rbx
    1207:	75 e1                	jne    11ea <main+0x81>
    1209:	89 e8                	mov    %ebp,%eax
    120b:	c1 f8 1f             	sar    $0x1f,%eax
    120e:	c1 e8 18             	shr    $0x18,%eax
    1211:	8d 54 05 00          	lea    0x0(%rbp,%rax,1),%edx
    1215:	0f b6 d2             	movzbl %dl,%edx
    1218:	29 c2                	sub    %eax,%edx
    121a:	48 8d 35 e9 0d 00 00 	lea    0xde9(%rip),%rsi        # 200a <_IO_stdin_used+0xa>
    1221:	bf 01 00 00 00       	mov    $0x1,%edi
    1226:	b8 00 00 00 00       	mov    $0x0,%eax
    122b:	e8 40 fe ff ff       	callq  1070 <__printf_chk@plt>
    1230:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    1235:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    123c:	00 00 
    123e:	75 10                	jne    1250 <main+0xe7>
    1240:	b8 00 00 00 00       	mov    $0x0,%eax
    1245:	48 83 c4 38          	add    $0x38,%rsp
    1249:	5b                   	pop    %rbx
    124a:	5d                   	pop    %rbp
    124b:	41 5c                	pop    %r12
    124d:	41 5d                	pop    %r13
