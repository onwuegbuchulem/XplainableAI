...
/app/bin_gccgcc10_O0/2019_05_25-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	48 b8 48 65 6c 6c 6f 	movabs $0x6874206f6c6c6548,%rax
    118b:	20 74 68 
    118e:	48 ba 65 72 65 20 73 	movabs $0x6172747320657265,%rdx
    1195:	74 72 61 
    ...
    11bc:	66 c7 45 f0 74 0a    	movw   $0xa74,-0x10(%rbp)
    11c2:	c6 45 f2 00          	movb   $0x0,-0xe(%rbp)
    11c6:	c7 45 cc 00 00 00 00 	movl   $0x0,-0x34(%rbp)
    11cd:	eb 5c                	jmp    122b <main+0xc2>
    11cf:	8b 45 cc             	mov    -0x34(%rbp),%eax
    11d2:	48 98                	cltq   
    11d4:	0f b6 44 05 d0       	movzbl -0x30(%rbp,%rax,1),%eax
    11d9:	0f be c0             	movsbl %al,%eax
    11dc:	83 e8 0a             	sub    $0xa,%eax
    11df:	83 f8 35             	cmp    $0x35,%eax
    11e2:	77 2f                	ja     1213 <main+0xaa>
    11e4:	89 c0                	mov    %eax,%eax
    11e6:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
    11ed:	00 
    11ee:	48 8d 05 0f 0e 00 00 	lea    0xe0f(%rip),%rax        # 2004 <_IO_stdin_used+0x4>
    11f5:	8b 04 02             	mov    (%rdx,%rax,1),%eax
    11f8:	48 98                	cltq   
    11fa:	48 8d 15 03 0e 00 00 	lea    0xe03(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    1201:	48 01 d0             	add    %rdx,%rax
    1204:	3e ff e0             	notrack jmpq *%rax
    1207:	bf 0a 00 00 00       	mov    $0xa,%edi
    120c:	e8 4f fe ff ff       	callq  1060 <putchar@plt>
    1211:	eb 14                	jmp    1227 <main+0xbe>
    1213:	8b 45 cc             	mov    -0x34(%rbp),%eax
    1216:	48 98                	cltq   
    1218:	0f b6 44 05 d0       	movzbl -0x30(%rbp,%rax,1),%eax
    121d:	0f be c0             	movsbl %al,%eax
    1220:	89 c7                	mov    %eax,%edi
    1222:	e8 39 fe ff ff       	callq  1060 <putchar@plt>
    1227:	83 45 cc 01          	addl   $0x1,-0x34(%rbp)
    122b:	8b 45 cc             	mov    -0x34(%rbp),%eax
    122e:	48 98                	cltq   
    1230:	0f b6 44 05 d0       	movzbl -0x30(%rbp,%rax,1),%eax
    1235:	84 c0                	test   %al,%al
    1237:	75 96                	jne    11cf <main+0x66>
    1239:	b8 00 00 00 00       	mov    $0x0,%eax
    123e:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1242:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1249:	00 00 
    124b:	74 05                	je     1252 <main+0xe9>
    124d:	e8 1e fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1252:	c9                   	leaveq 
    1253:	c3                   	retq   
