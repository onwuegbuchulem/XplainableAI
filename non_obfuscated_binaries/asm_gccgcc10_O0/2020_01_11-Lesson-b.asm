...
/app/bin_gccgcc10_O0/2020_01_11-Lesson-b:     file format elf64-x86-64
...
0000000000001090 <asprintf@plt>:
    1090:	f3 0f 1e fa          	endbr64 
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <asprintf@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    1199:	ba 0d 00 00 00       	mov    $0xd,%edx
    ...
    11ad:	e8 de fe ff ff       	callq  1090 <asprintf@plt>
    11b2:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11b5:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11b9:	48 8b 00             	mov    (%rax),%rax
    11bc:	48 89 c7             	mov    %rax,%rdi
    11bf:	e8 ac fe ff ff       	callq  1070 <puts@plt>
    11c4:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11c7:	89 c6                	mov    %eax,%esi
    11c9:	48 8d 3d 45 0e 00 00 	lea    0xe45(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    11d0:	b8 00 00 00 00       	mov    $0x0,%eax
    11d5:	e8 a6 fe ff ff       	callq  1080 <printf@plt>
