...
/app/bin_gccgcc10_O2/random02:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	41 54                	push   %r12
    10a6:	41 bc 05 00 00 00    	mov    $0x5,%r12d
    10ac:	55                   	push   %rbp
    10ad:	48 8d 2d 50 0f 00 00 	lea    0xf50(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    10b4:	53                   	push   %rbx
    10b5:	bb 05 00 00 00       	mov    $0x5,%ebx
    10ba:	e8 d1 ff ff ff       	callq  1090 <rand@plt>
    10bf:	48 89 ee             	mov    %rbp,%rsi
    10c2:	bf 01 00 00 00       	mov    $0x1,%edi
    10c7:	48 63 d0             	movslq %eax,%rdx
    10ca:	89 c1                	mov    %eax,%ecx
    10cc:	48 69 d2 1f 85 eb 51 	imul   $0x51eb851f,%rdx,%rdx
    10d3:	c1 f9 1f             	sar    $0x1f,%ecx
    10d6:	48 c1 fa 25          	sar    $0x25,%rdx
    10da:	29 ca                	sub    %ecx,%edx
    10dc:	6b d2 64             	imul   $0x64,%edx,%edx
    10df:	29 d0                	sub    %edx,%eax
    10e1:	8d 50 01             	lea    0x1(%rax),%edx
    10e4:	31 c0                	xor    %eax,%eax
    10e6:	e8 95 ff ff ff       	callq  1080 <__printf_chk@plt>
    10eb:	83 eb 01             	sub    $0x1,%ebx
    10ee:	75 ca                	jne    10ba <main+0x1a>
    10f0:	48 8b 35 19 2f 00 00 	mov    0x2f19(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10f7:	bf 0a 00 00 00       	mov    $0xa,%edi
    10fc:	e8 6f ff ff ff       	callq  1070 <putc@plt>
    1101:	41 83 ec 01          	sub    $0x1,%r12d
    1105:	75 ae                	jne    10b5 <main+0x15>
    1107:	5b                   	pop    %rbx
