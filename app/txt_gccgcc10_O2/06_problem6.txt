...
/app/bin_gccgcc10_O2/06_problem6:     file format elf64-x86-64
...
0000000000001090 <_start>:
    ...
    10a1:	50                   	push   %rax
    10a2:	54                   	push   %rsp
    10a3:	4c 8d 05 76 01 00 00 	lea    0x176(%rip),%r8        # 1220 <__libc_csu_fini>
    10aa:	48 8d 0d ff 00 00 00 	lea    0xff(%rip),%rcx        # 11b0 <__libc_csu_init>
...
0000000000001180 <sum_natural>:
    ...
    1186:	83 ff 01             	cmp    $0x1,%edi
    1189:	74 15                	je     11a0 <sum_natural+0x20>
    118b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1190:	89 fa                	mov    %edi,%edx
    1192:	83 ef 01             	sub    $0x1,%edi
    1195:	01 d0                	add    %edx,%eax
    1197:	83 ff 01             	cmp    $0x1,%edi
    119a:	75 f4                	jne    1190 <sum_natural+0x10>
