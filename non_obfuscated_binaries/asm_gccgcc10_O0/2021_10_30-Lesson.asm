...
/app/bin_gccgcc10_O0/2021_10_30-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	48 b8 53 65 65 20 50 	movabs $0x676f725020656553,%rax
    118b:	72 6f 67 
    118e:	48 ba 72 61 6d 6d 65 	movabs $0x72656d6d6172,%rdx
    1195:	72 00 00 
    1198:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    119c:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
    11a0:	48 c7 45 e0 00 00 00 	movq   $0x0,-0x20(%rbp)
    11a7:	00 
    11a8:	48 c7 45 e8 00 00 00 	movq   $0x0,-0x18(%rbp)
    11af:	00 
    11b0:	c7 45 f0 1d 00 00 00 	movl   $0x1d,-0x10(%rbp)
    11b7:	f3 0f 10 05 65 0e 00 	movss  0xe65(%rip),%xmm0        # 2024 <_IO_stdin_used+0x24>
    11be:	00 
    11bf:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    11c4:	f3 0f 10 45 f4       	movss  -0xc(%rbp),%xmm0
    11c9:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11cd:	f3 0f 5a c8          	cvtss2sd %xmm0,%xmm1
    11d1:	66 48 0f 7e c9       	movq   %xmm1,%rcx
    11d6:	8b 55 f0             	mov    -0x10(%rbp),%edx
    11d9:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    11dd:	66 48 0f 6e c1       	movq   %rcx,%xmm0
    ...
    11fb:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    11ff:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    1206:	00 00 
