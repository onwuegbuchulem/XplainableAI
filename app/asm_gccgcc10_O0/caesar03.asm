...
/app/bin_gccgcc10_O0/caesar03:     file format elf64-x86-64
...
0000000000001080 <getchar@plt>:
    ...
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <getchar@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    1195:	c7 45 fc fd ff ff ff 	movl   $0xfffffffd,-0x4(%rbp)
    119c:	eb 48                	jmp    11e6 <main+0x5d>
    119e:	e8 ed fe ff ff       	callq  1090 <__ctype_b_loc@plt>
    11a3:	48 8b 10             	mov    (%rax),%rdx
    11a6:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11a9:	48 98                	cltq   
    11ab:	48 01 c0             	add    %rax,%rax
    11ae:	48 01 d0             	add    %rdx,%rax
    11b1:	0f b7 00             	movzwl (%rax),%eax
    11b4:	0f b7 c0             	movzwl %ax,%eax
    11b7:	25 00 04 00 00       	and    $0x400,%eax
    11bc:	85 c0                	test   %eax,%eax
    11be:	74 1c                	je     11dc <main+0x53>
    11c0:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11c3:	01 45 f8             	add    %eax,-0x8(%rbp)
    11c6:	83 7d f8 40          	cmpl   $0x40,-0x8(%rbp)
    11ca:	7e 0c                	jle    11d8 <main+0x4f>
    11cc:	83 7d f8 5a          	cmpl   $0x5a,-0x8(%rbp)
    11d0:	7e 0a                	jle    11dc <main+0x53>
    11d2:	83 7d f8 60          	cmpl   $0x60,-0x8(%rbp)
    11d6:	7f 04                	jg     11dc <main+0x53>
    11d8:	83 45 f8 1a          	addl   $0x1a,-0x8(%rbp)
    11dc:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11df:	89 c7                	mov    %eax,%edi
    11e1:	e8 8a fe ff ff       	callq  1070 <putchar@plt>
    11e6:	e8 95 fe ff ff       	callq  1080 <getchar@plt>
    11eb:	89 45 f8             	mov    %eax,-0x8(%rbp)
    11ee:	83 7d f8 ff          	cmpl   $0xffffffff,-0x8(%rbp)
    11f2:	75 aa                	jne    119e <main+0x15>
