...
/app/bin_gccgcc10_O1/07_switch:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11ec:	83 f8 03             	cmp    $0x3,%eax
    11ef:	74 53                	je     1244 <main+0x9b>
    11f1:	7f 18                	jg     120b <main+0x62>
    11f3:	83 f8 01             	cmp    $0x1,%eax
    11f6:	74 26                	je     121e <main+0x75>
    11f8:	83 f8 02             	cmp    $0x2,%eax
    11fb:	75 55                	jne    1252 <main+0xa9>
    11fd:	48 8d 3d 1b 0e 00 00 	lea    0xe1b(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    1204:	e8 77 fe ff ff       	callq  1080 <puts@plt>
    1209:	eb 1f                	jmp    122a <main+0x81>
    120b:	83 f8 04             	cmp    $0x4,%eax
    120e:	75 42                	jne    1252 <main+0xa9>
    1210:	48 8d 3d 24 0e 00 00 	lea    0xe24(%rip),%rdi        # 203b <_IO_stdin_used+0x3b>
    1217:	e8 64 fe ff ff       	callq  1080 <puts@plt>
    121c:	eb 0c                	jmp    122a <main+0x81>
    121e:	48 8d 3d ec 0d 00 00 	lea    0xdec(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    1225:	e8 56 fe ff ff       	callq  1080 <puts@plt>
    122a:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    122f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1236:	00 00 
    1238:	75 30                	jne    126a <main+0xc1>
    123a:	b8 00 00 00 00       	mov    $0x0,%eax
    123f:	48 83 c4 18          	add    $0x18,%rsp
    1243:	c3                   	retq   
    1244:	48 8d 3d e2 0d 00 00 	lea    0xde2(%rip),%rdi        # 202d <_IO_stdin_used+0x2d>
    124b:	e8 30 fe ff ff       	callq  1080 <puts@plt>
    1250:	eb d8                	jmp    122a <main+0x81>
    1252:	48 8d 35 f0 0d 00 00 	lea    0xdf0(%rip),%rsi        # 2049 <_IO_stdin_used+0x49>
    1259:	bf 01 00 00 00       	mov    $0x1,%edi
    125e:	b8 00 00 00 00       	mov    $0x0,%eax
    1263:	e8 38 fe ff ff       	callq  10a0 <__printf_chk@plt>
    1268:	eb c0                	jmp    122a <main+0x81>
