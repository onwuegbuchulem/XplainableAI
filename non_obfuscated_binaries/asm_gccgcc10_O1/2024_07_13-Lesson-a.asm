...
/app/bin_gccgcc10_O1/2024_07_13-Lesson-a:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    1221:	bb 14 00 00 00       	mov    $0x14,%ebx
    1226:	48 8b 35 e3 2d 00 00 	mov    0x2de3(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    122d:	bf 5a 00 00 00       	mov    $0x5a,%edi
    1232:	e8 49 fe ff ff       	callq  1080 <putc@plt>
    1237:	83 eb 01             	sub    $0x1,%ebx
    123a:	75 ea                	jne    1226 <main+0x7d>
