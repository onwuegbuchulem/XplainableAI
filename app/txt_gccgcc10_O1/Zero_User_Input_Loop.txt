...
/app/bin_gccgcc10_O1/Zero_User_Input_Loop:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11d1:	8b 54 24 04          	mov    0x4(%rsp),%edx
    ...
    11eb:	83 7c 24 04 00       	cmpl   $0x0,0x4(%rsp)
    11f0:	75 b5                	jne    11a7 <main+0x1e>
    11f2:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11f7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11fe:	00 00 
    1200:	75 0b                	jne    120d <main+0x84>
    1202:	b8 00 00 00 00       	mov    $0x0,%eax
    1207:	48 83 c4 10          	add    $0x10,%rsp
    120b:	5b                   	pop    %rbx
    120c:	c3                   	retq   
