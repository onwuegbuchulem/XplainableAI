...
/app/bin_gccgcc10_O2/2024_03_16-Lesson-b:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1080:	ba 19 00 00 00       	mov    $0x19,%edx
    1085:	48 8d 35 84 0f 00 00 	lea    0xf84(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    ...
    10a9:	00 
    10aa:	48 8d 35 74 0f 00 00 	lea    0xf74(%rip),%rsi        # 2025 <_IO_stdin_used+0x25>
    10b1:	e8 9a ff ff ff       	callq  1050 <__printf_chk@plt>
    10b6:	ba 19 00 00 00       	mov    $0x19,%edx
    10bb:	48 8d 35 4e 0f 00 00 	lea    0xf4e(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    10c2:	31 c0                	xor    %eax,%eax
    10c4:	bf 01 00 00 00       	mov    $0x1,%edi
    10c9:	e8 82 ff ff ff       	callq  1050 <__printf_chk@plt>
    10ce:	31 c0                	xor    %eax,%eax
    10d0:	48 83 c4 08          	add    $0x8,%rsp
    10d4:	c3                   	retq   
    10d5:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10dc:	00 00 00 
    10df:	90                   	nop
