...
/app/bin_gccgcc10_O1/cyrillic:     file format elf64-x86-64
...
00000000000010a0 <fputwc@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 0d 2f 00 00 	bnd jmpq *0x2f0d(%rip)        # 3fb8 <fputwc@GLIBC_2.2.5>
...
00000000000010c0 <fopen@plt>:
    ...
    10c4:	f2 ff 25 fd 2e 00 00 	bnd jmpq *0x2efd(%rip)        # 3fc8 <fopen@GLIBC_2.2.5>
    10cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010d0 <__wprintf_chk@plt>:
    10d0:	f3 0f 1e fa          	endbr64 
    10d4:	f2 ff 25 f5 2e 00 00 	bnd jmpq *0x2ef5(%rip)        # 3fd0 <__wprintf_chk@GLIBC_2.4>
...
00000000000010e0 <_start>:
    ...
    10f1:	50                   	push   %rax
    10f2:	54                   	push   %rsp
    10f3:	4c 8d 05 e6 01 00 00 	lea    0x1e6(%rip),%r8        # 12e0 <__libc_csu_fini>
    10fa:	48 8d 0d 6f 01 00 00 	lea    0x16f(%rip),%rcx        # 1270 <__libc_csu_init>
...
00000000000011c9 <main>:
    ...
    11d3:	48 8d 35 2a 0e 00 00 	lea    0xe2a(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11da:	48 8d 3d 25 0e 00 00 	lea    0xe25(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    11e1:	e8 da fe ff ff       	callq  10c0 <fopen@plt>
    11e6:	48 89 c5             	mov    %rax,%rbp
    11e9:	48 8d 35 24 0e 00 00 	lea    0xe24(%rip),%rsi        # 2014 <_IO_stdin_used+0x14>
    11f0:	bf 00 00 00 00       	mov    $0x0,%edi
    11f5:	e8 b6 fe ff ff       	callq  10b0 <setlocale@plt>
    11fa:	48 8d 35 1f 0e 00 00 	lea    0xe1f(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    1201:	bf 01 00 00 00       	mov    $0x1,%edi
    1206:	b8 00 00 00 00       	mov    $0x0,%eax
    120b:	e8 c0 fe ff ff       	callq  10d0 <__wprintf_chk@plt>
    1210:	bb 10 04 00 00       	mov    $0x410,%ebx
    1215:	48 89 ee             	mov    %rbp,%rsi
    1218:	89 df                	mov    %ebx,%edi
    121a:	e8 81 fe ff ff       	callq  10a0 <fputwc@plt>
    121f:	48 8b 35 ea 2d 00 00 	mov    0x2dea(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1226:	89 df                	mov    %ebx,%edi
    1228:	e8 73 fe ff ff       	callq  10a0 <fputwc@plt>
    122d:	83 c3 01             	add    $0x1,%ebx
    1230:	81 fb 30 04 00 00    	cmp    $0x430,%ebx
    1236:	75 dd                	jne    1215 <main+0x4c>
    1238:	48 89 ee             	mov    %rbp,%rsi
    123b:	bf 00 00 00 00       	mov    $0x0,%edi
    1240:	e8 5b fe ff ff       	callq  10a0 <fputwc@plt>
    1245:	48 89 ef             	mov    %rbp,%rdi
    1248:	e8 43 fe ff ff       	callq  1090 <fclose@plt>
    124d:	48 8d 35 54 0e 00 00 	lea    0xe54(%rip),%rsi        # 20a8 <_IO_stdin_used+0xa8>
    1254:	bf 01 00 00 00       	mov    $0x1,%edi
    1259:	b8 00 00 00 00       	mov    $0x0,%eax
    125e:	e8 6d fe ff ff       	callq  10d0 <__wprintf_chk@plt>
