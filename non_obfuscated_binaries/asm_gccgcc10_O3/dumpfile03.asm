...
/app/bin_gccgcc10_O3/dumpfile03:     file format elf64-x86-64
...
0000000000001340 <_start>:
    ...
    1351:	50                   	push   %rax
    1352:	54                   	push   %rsp
    1353:	4c 8d 05 b6 02 00 00 	lea    0x2b6(%rip),%r8        # 1610 <__libc_csu_fini>
    135a:	48 8d 0d 3f 02 00 00 	lea    0x23f(%rip),%rcx        # 15a0 <__libc_csu_init>
...
0000000000001430 <line_out>:
    ...
    14be:	49 39 de             	cmp    %rbx,%r14
    14c1:	75 cd                	jne    1490 <line_out+0x60>
    14c3:	41 83 fc 0f          	cmp    $0xf,%r12d
    14c7:	0f 8f a3 00 00 00    	jg     1570 <line_out+0x140>
    14cd:	44 89 e3             	mov    %r12d,%ebx
    14d0:	4c 8d 2d 39 0b 00 00 	lea    0xb39(%rip),%r13        # 2010 <_IO_stdin_used+0x10>
    14d7:	eb 1d                	jmp    14f6 <line_out+0xc6>
    14d9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    14e0:	48 8b 35 39 2b 00 00 	mov    0x2b39(%rip),%rsi        # 4020 <stdout@@GLIBC_2.2.5>
    14e7:	bf 20 00 00 00       	mov    $0x20,%edi
    14ec:	e8 3f fc ff ff       	callq  1130 <putc@plt>
    14f1:	83 fb 10             	cmp    $0x10,%ebx
    14f4:	74 1c                	je     1512 <line_out+0xe2>
    14f6:	4c 89 ee             	mov    %r13,%rsi
    14f9:	bf 01 00 00 00       	mov    $0x1,%edi
    14fe:	31 c0                	xor    %eax,%eax
    1500:	83 c3 01             	add    $0x1,%ebx
    1503:	e8 58 fc ff ff       	callq  1160 <__printf_chk@plt>
    1508:	f6 c3 07             	test   $0x7,%bl
    150b:	74 d3                	je     14e0 <line_out+0xb0>
    150d:	83 fb 10             	cmp    $0x10,%ebx
    1510:	75 e4                	jne    14f6 <line_out+0xc6>
    ...
    156f:	90                   	nop
    1570:	48 8b 35 a9 2a 00 00 	mov    0x2aa9(%rip),%rsi        # 4020 <stdout@@GLIBC_2.2.5>
    1577:	bf 20 00 00 00       	mov    $0x20,%edi
    157c:	e8 af fb ff ff       	callq  1130 <putc@plt>
    1581:	eb a5                	jmp    1528 <line_out+0xf8>
    1583:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1588:	bb 01 00 00 00       	mov    $0x1,%ebx
    158d:	e9 3e ff ff ff       	jmpq   14d0 <line_out+0xa0>
