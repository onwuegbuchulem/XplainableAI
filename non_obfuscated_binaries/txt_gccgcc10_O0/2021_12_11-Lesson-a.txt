...
/app/bin_gccgcc10_O0/2021_12_11-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1171:	48 81 ec 90 02 00 00 	sub    $0x290,%rsp
    1178:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    117f:	00 00 
    1181:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1185:	31 c0                	xor    %eax,%eax
    1187:	48 8d 85 70 fd ff ff 	lea    -0x290(%rbp),%rax
    118e:	48 8d 15 7b 0e 00 00 	lea    0xe7b(%rip),%rdx        # 2010 <_IO_stdin_used+0x10>
    1195:	b9 4f 00 00 00       	mov    $0x4f,%ecx
    119a:	48 89 c7             	mov    %rax,%rdi
    119d:	48 89 d6             	mov    %rdx,%rsi
    11a0:	f3 48 a5             	rep movsq %ds:(%rsi),%es:(%rdi)
    11a3:	48 89 f2             	mov    %rsi,%rdx
    11a6:	48 89 f8             	mov    %rdi,%rax
    11a9:	8b 0a                	mov    (%rdx),%ecx
    11ab:	89 08                	mov    %ecx,(%rax)
    11ad:	48 8d 40 04          	lea    0x4(%rax),%rax
    11b1:	48 8d 52 04          	lea    0x4(%rdx),%rdx
    11b5:	0f b6 0a             	movzbl (%rdx),%ecx
    11b8:	88 08                	mov    %cl,(%rax)
    11ba:	48 8d 85 70 fd ff ff 	lea    -0x290(%rbp),%rax
    ...
    11da:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    11de:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    11e5:	00 00 
    11e7:	74 05                	je     11ee <main+0x85>
    11e9:	e8 72 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    11ee:	c9                   	leaveq 
    11ef:	c3                   	retq   
