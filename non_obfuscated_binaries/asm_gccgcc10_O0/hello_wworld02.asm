...
/app/bin_gccgcc10_O0/hello_wworld02:     file format elf64-x86-64
...
0000000000001070 <wprintf@plt>:
    1070:	f3 0f 1e fa          	endbr64 
    1074:	f2 ff 25 55 2f 00 00 	bnd jmpq *0x2f55(%rip)        # 3fd0 <wprintf@GLIBC_2.2.5>
...
0000000000001169 <main>:
    ...
    1184:	48 b8 48 00 00 00 65 	movabs $0x6500000048,%rax
    118b:	00 00 00 
    118e:	48 ba 6c 00 00 00 6c 	movabs $0x6c0000006c,%rdx
    1195:	00 00 00 
    1198:	48 89 45 a0          	mov    %rax,-0x60(%rbp)
    119c:	48 89 55 a8          	mov    %rdx,-0x58(%rbp)
    11a0:	48 b8 6f 00 00 00 2c 	movabs $0x2c0000006f,%rax
    11a7:	00 00 00 
    11aa:	48 ba 20 00 00 00 77 	movabs $0x7700000020,%rdx
    11b1:	00 00 00 
    11b4:	48 89 45 b0          	mov    %rax,-0x50(%rbp)
    11b8:	48 89 55 b8          	mov    %rdx,-0x48(%rbp)
    ...
    11d4:	48 89 55 c8          	mov    %rdx,-0x38(%rbp)
    11d8:	48 b8 77 00 00 00 6f 	movabs $0x6f00000077,%rax
    11df:	00 00 00 
    11e2:	48 ba 72 00 00 00 6c 	movabs $0x6c00000072,%rdx
    11e9:	00 00 00 
    11ec:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    11f0:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
    11f4:	48 b8 64 00 00 00 21 	movabs $0x2100000064,%rax
    11fb:	00 00 00 
    11fe:	ba 0a 00 00 00       	mov    $0xa,%edx
    1203:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    1207:	48 89 55 e8          	mov    %rdx,-0x18(%rbp)
    120b:	48 8d 45 a0          	lea    -0x60(%rbp),%rax
    ...
    121e:	e8 4d fe ff ff       	callq  1070 <wprintf@plt>
    1223:	b8 00 00 00 00       	mov    $0x0,%eax
    1228:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    122c:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1233:	00 00 
    1235:	74 05                	je     123c <main+0xd3>
    1237:	e8 24 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    123c:	c9                   	leaveq 
    123d:	c3                   	retq   
