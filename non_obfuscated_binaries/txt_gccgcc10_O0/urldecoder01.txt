...
/app/bin_gccgcc10_O0/urldecoder01:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d 0f 01 00 00 	lea    0x10f(%rip),%rdi        # 11b7 <main>
...
0000000000001169 <tohex>:
    ...
    1174:	83 7d fc 2f          	cmpl   $0x2f,-0x4(%rbp)
    1178:	7e 0e                	jle    1188 <tohex+0x1f>
    117a:	83 7d fc 39          	cmpl   $0x39,-0x4(%rbp)
    117e:	7f 08                	jg     1188 <tohex+0x1f>
    1180:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1183:	83 e8 30             	sub    $0x30,%eax
    1186:	eb 2d                	jmp    11b5 <tohex+0x4c>
    1188:	83 7d fc 40          	cmpl   $0x40,-0x4(%rbp)
    118c:	7e 0e                	jle    119c <tohex+0x33>
    118e:	83 7d fc 46          	cmpl   $0x46,-0x4(%rbp)
    1192:	7f 08                	jg     119c <tohex+0x33>
    1194:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1197:	83 e8 37             	sub    $0x37,%eax
    119a:	eb 19                	jmp    11b5 <tohex+0x4c>
    119c:	83 7d fc 60          	cmpl   $0x60,-0x4(%rbp)
    11a0:	7e 0e                	jle    11b0 <tohex+0x47>
    11a2:	83 7d fc 66          	cmpl   $0x66,-0x4(%rbp)
    11a6:	7f 08                	jg     11b0 <tohex+0x47>
    11a8:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11ab:	83 e8 57             	sub    $0x57,%eax
    11ae:	eb 05                	jmp    11b5 <tohex+0x4c>
...
00000000000011b7 <main>:
    ...
    11c3:	eb 5c                	jmp    1221 <main+0x6a>
    11c5:	83 7d f4 25          	cmpl   $0x25,-0xc(%rbp)
    11c9:	75 4c                	jne    1217 <main+0x60>
    11cb:	e8 a0 fe ff ff       	callq  1070 <getchar@plt>
    11d0:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11d3:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%rbp)
    11d7:	74 58                	je     1231 <main+0x7a>
    11d9:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11dc:	89 c7                	mov    %eax,%edi
    11de:	e8 86 ff ff ff       	callq  1169 <tohex>
    11e3:	89 45 f8             	mov    %eax,-0x8(%rbp)
    11e6:	e8 85 fe ff ff       	callq  1070 <getchar@plt>
    11eb:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11ee:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%rbp)
    11f2:	74 40                	je     1234 <main+0x7d>
    11f4:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11f7:	89 c7                	mov    %eax,%edi
    11f9:	e8 6b ff ff ff       	callq  1169 <tohex>
    11fe:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1201:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1204:	c1 e0 04             	shl    $0x4,%eax
    1207:	89 c2                	mov    %eax,%edx
    1209:	8b 45 fc             	mov    -0x4(%rbp),%eax
    120c:	01 d0                	add    %edx,%eax
    120e:	89 c7                	mov    %eax,%edi
    1210:	e8 4b fe ff ff       	callq  1060 <putchar@plt>
    1215:	eb 0a                	jmp    1221 <main+0x6a>
    1217:	8b 45 f4             	mov    -0xc(%rbp),%eax
    121a:	89 c7                	mov    %eax,%edi
    121c:	e8 3f fe ff ff       	callq  1060 <putchar@plt>
    1221:	e8 4a fe ff ff       	callq  1070 <getchar@plt>
    1226:	89 45 f4             	mov    %eax,-0xc(%rbp)
    1229:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%rbp)
    122d:	75 96                	jne    11c5 <main+0xe>
    122f:	eb 04                	jmp    1235 <main+0x7e>
    1231:	90                   	nop
    1232:	eb 01                	jmp    1235 <main+0x7e>
    1234:	90                   	nop
