...
/app/bin_gccgcc10_O3/2022_02-Exercise:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ce:	48 8d 3d 47 0f 00 00 	lea    0xf47(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	e8 b4 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10dc:	48 63 54 24 04       	movslq 0x4(%rsp),%rdx
    10e1:	48 89 d1             	mov    %rdx,%rcx
    10e4:	48 69 d2 c5 b3 a2 91 	imul   $0xffffffff91a2b3c5,%rdx,%rdx
    10eb:	89 c8                	mov    %ecx,%eax
    10ed:	c1 f8 1f             	sar    $0x1f,%eax
    10f0:	48 c1 ea 20          	shr    $0x20,%rdx
    10f4:	01 ca                	add    %ecx,%edx
    10f6:	c1 fa 0b             	sar    $0xb,%edx
    10f9:	29 c2                	sub    %eax,%edx
    10fb:	69 c2 f0 f1 ff ff    	imul   $0xfffff1f0,%edx,%eax
    1101:	01 c8                	add    %ecx,%eax
    1103:	48 63 c8             	movslq %eax,%rcx
    1106:	89 c6                	mov    %eax,%esi
    1108:	48 69 c9 89 88 88 88 	imul   $0xffffffff88888889,%rcx,%rcx
    110f:	c1 fe 1f             	sar    $0x1f,%esi
    1112:	48 c1 e9 20          	shr    $0x20,%rcx
    1116:	01 c1                	add    %eax,%ecx
    1118:	c1 f9 05             	sar    $0x5,%ecx
    111b:	29 f1                	sub    %esi,%ecx
    111d:	89 cf                	mov    %ecx,%edi
    111f:	89 ce                	mov    %ecx,%esi
    1121:	c1 e7 04             	shl    $0x4,%edi
    1124:	29 fe                	sub    %edi,%esi
    1126:	bf 01 00 00 00       	mov    $0x1,%edi
    112b:	44 8d 04 b0          	lea    (%rax,%rsi,4),%r8d
    112f:	31 c0                	xor    %eax,%eax
    1131:	48 8d 35 e7 0e 00 00 	lea    0xee7(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    1138:	44 89 44 24 04       	mov    %r8d,0x4(%rsp)
    113d:	e8 3e ff ff ff       	callq  1080 <__printf_chk@plt>
    1142:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1147:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    114e:	00 00 
    1150:	75 07                	jne    1159 <main+0xb9>
    1152:	31 c0                	xor    %eax,%eax
    1154:	48 83 c4 18          	add    $0x18,%rsp
    1158:	c3                   	retq   
    1159:	e8 12 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
