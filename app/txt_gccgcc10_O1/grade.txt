...
/app/bin_gccgcc10_O1/grade:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%rsp)
    11c8:	00 
    ...
    11df:	48 8d 3d 33 0e 00 00 	lea    0xe33(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    11e6:	b8 00 00 00 00       	mov    $0x0,%eax
    11eb:	e8 c0 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11f0:	8b 44 24 04          	mov    0x4(%rsp),%eax
    11f4:	83 f8 59             	cmp    $0x59,%eax
    11f7:	7f 1d                	jg     1216 <main+0x6d>
    11f9:	83 f8 4f             	cmp    $0x4f,%eax
    11fc:	7f 3e                	jg     123c <main+0x93>
    11fe:	83 f8 45             	cmp    $0x45,%eax
    1201:	7f 47                	jg     124a <main+0xa1>
    1203:	83 f8 3b             	cmp    $0x3b,%eax
    1206:	7e 50                	jle    1258 <main+0xaf>
    1208:	48 8d 3d 13 0e 00 00 	lea    0xe13(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    120f:	e8 6c fe ff ff       	callq  1080 <puts@plt>
    1214:	eb 0c                	jmp    1222 <main+0x79>
    1216:	48 8d 3d ff 0d 00 00 	lea    0xdff(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    121d:	e8 5e fe ff ff       	callq  1080 <puts@plt>
    1222:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1227:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    122e:	00 00 
    1230:	75 34                	jne    1266 <main+0xbd>
    1232:	b8 00 00 00 00       	mov    $0x0,%eax
    1237:	48 83 c4 18          	add    $0x18,%rsp
    123b:	c3                   	retq   
    123c:	48 8d 3d db 0d 00 00 	lea    0xddb(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    1243:	e8 38 fe ff ff       	callq  1080 <puts@plt>
    1248:	eb d8                	jmp    1222 <main+0x79>
    124a:	48 8d 3d cf 0d 00 00 	lea    0xdcf(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    1251:	e8 2a fe ff ff       	callq  1080 <puts@plt>
    1256:	eb ca                	jmp    1222 <main+0x79>
    1258:	48 8d 3d c5 0d 00 00 	lea    0xdc5(%rip),%rdi        # 2024 <_IO_stdin_used+0x24>
    125f:	e8 1c fe ff ff       	callq  1080 <puts@plt>
    1264:	eb bc                	jmp    1222 <main+0x79>
    1266:	e8 25 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
