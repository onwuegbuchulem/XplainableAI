...
/app/bin_gccgcc10_O2/ex13:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10a0:	7e 35                	jle    10d7 <main+0x57>
    10a2:	48 89 f5             	mov    %rsi,%rbp
    10a5:	4c 63 ef             	movslq %edi,%r13
    10a8:	4c 8d 25 78 0f 00 00 	lea    0xf78(%rip),%r12        # 2027 <_IO_stdin_used+0x27>
    10af:	31 db                	xor    %ebx,%ebx
    10b1:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    10b8:	48 8b 4c dd 00       	mov    0x0(%rbp,%rbx,8),%rcx
    10bd:	89 da                	mov    %ebx,%edx
    10bf:	4c 89 e6             	mov    %r12,%rsi
    10c2:	bf 01 00 00 00       	mov    $0x1,%edi
    10c7:	31 c0                	xor    %eax,%eax
    10c9:	48 83 c3 01          	add    $0x1,%rbx
    10cd:	e8 9e ff ff ff       	callq  1070 <__printf_chk@plt>
    10d2:	4c 39 eb             	cmp    %r13,%rbx
    10d5:	75 e1                	jne    10b8 <main+0x38>
    10d7:	48 8d 05 31 0f 00 00 	lea    0xf31(%rip),%rax        # 200f <_IO_stdin_used+0xf>
    10de:	31 db                	xor    %ebx,%ebx
    10e0:	48 8d 0d 1d 0f 00 00 	lea    0xf1d(%rip),%rcx        # 2004 <_IO_stdin_used+0x4>
    10e7:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10ec:	48 8d 05 23 0f 00 00 	lea    0xf23(%rip),%rax        # 2016 <_IO_stdin_used+0x16>
    10f3:	48 8d 2d 39 0f 00 00 	lea    0xf39(%rip),%rbp        # 2033 <_IO_stdin_used+0x33>
    10fa:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    10ff:	48 8d 05 1b 0f 00 00 	lea    0xf1b(%rip),%rax        # 2021 <_IO_stdin_used+0x21>
    1106:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    110b:	89 da                	mov    %ebx,%edx
    110d:	48 89 ee             	mov    %rbp,%rsi
    1110:	bf 01 00 00 00       	mov    $0x1,%edi
    1115:	31 c0                	xor    %eax,%eax
    1117:	e8 54 ff ff ff       	callq  1070 <__printf_chk@plt>
    111c:	48 83 c3 01          	add    $0x1,%rbx
    1120:	48 83 fb 05          	cmp    $0x5,%rbx
    1124:	74 0a                	je     1130 <main+0xb0>
    1126:	48 8b 0c dc          	mov    (%rsp,%rbx,8),%rcx
    112a:	eb df                	jmp    110b <main+0x8b>
    112c:	0f 1f 40 00          	nopl   0x0(%rax)
    1130:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    1135:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    113c:	00 00 
    113e:	75 0d                	jne    114d <main+0xcd>
    1140:	48 83 c4 38          	add    $0x38,%rsp
    ...
    114a:	41 5d                	pop    %r13
    114c:	c3                   	retq   
    114d:	e8 0e ff ff ff       	callq  1060 <__stack_chk_fail@plt>
