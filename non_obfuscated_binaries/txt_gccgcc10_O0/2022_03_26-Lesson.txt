...
/app/bin_gccgcc10_O0/2022_03_26-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119c:	48 8d 3d 63 0e 00 00 	lea    0xe63(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    11a3:	e8 d8 fe ff ff       	callq  1080 <popen@plt>
    11a8:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11ac:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
    11b1:	75 27                	jne    11da <main+0x51>
    11b3:	48 8b 05 66 2e 00 00 	mov    0x2e66(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    11ba:	48 89 c1             	mov    %rax,%rcx
    11bd:	ba 14 00 00 00       	mov    $0x14,%edx
    11c2:	be 01 00 00 00       	mov    $0x1,%esi
    11c7:	48 8d 3d 3b 0e 00 00 	lea    0xe3b(%rip),%rdi        # 2009 <_IO_stdin_used+0x9>
    11ce:	e8 bd fe ff ff       	callq  1090 <fwrite@plt>
    11d3:	b8 01 00 00 00       	mov    $0x1,%eax
    11d8:	eb 2e                	jmp    1208 <main+0x7f>
    11da:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11de:	48 89 c1             	mov    %rax,%rcx
    11e1:	ba 14 00 00 00       	mov    $0x14,%edx
    11e6:	be 01 00 00 00       	mov    $0x1,%esi
    11eb:	48 8d 3d 2c 0e 00 00 	lea    0xe2c(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    11f2:	e8 99 fe ff ff       	callq  1090 <fwrite@plt>
    11f7:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11fb:	48 89 c7             	mov    %rax,%rdi
    11fe:	e8 6d fe ff ff       	callq  1070 <pclose@plt>
