...
/app/bin_gccgcc10_O2/byte_values03:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10d7:	0f b6 14 24          	movzbl (%rsp),%edx
    10db:	bf 01 00 00 00       	mov    $0x1,%edi
    10e0:	31 c0                	xor    %eax,%eax
    10e2:	bb 02 00 00 00       	mov    $0x2,%ebx
    10e7:	48 8d 35 16 0f 00 00 	lea    0xf16(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10ee:	4c 8d 64 24 ff       	lea    -0x1(%rsp),%r12
    10f3:	e8 98 ff ff ff       	callq  1090 <__printf_chk@plt>
    10f8:	48 8d 2d 05 0f 00 00 	lea    0xf05(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    10ff:	90                   	nop
    1100:	41 0f b6 14 1c       	movzbl (%r12,%rbx,1),%edx
    1105:	31 c0                	xor    %eax,%eax
    1107:	48 89 ee             	mov    %rbp,%rsi
    110a:	bf 01 00 00 00       	mov    $0x1,%edi
    110f:	e8 7c ff ff ff       	callq  1090 <__printf_chk@plt>
    1114:	f6 c3 0f             	test   $0xf,%bl
    1117:	75 11                	jne    112a <main+0x8a>
    1119:	48 8b 35 f0 2e 00 00 	mov    0x2ef0(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1120:	bf 0a 00 00 00       	mov    $0xa,%edi
    1125:	e8 56 ff ff ff       	callq  1080 <putc@plt>
    112a:	48 83 c3 01          	add    $0x1,%rbx
    112e:	48 81 fb 01 01 00 00 	cmp    $0x101,%rbx
    1135:	75 c9                	jne    1100 <main+0x60>
    1137:	48 8b 84 24 08 01 00 	mov    0x108(%rsp),%rax
    113e:	00 
    113f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1146:	00 00 
    1148:	75 0e                	jne    1158 <main+0xb8>
    114a:	48 81 c4 10 01 00 00 	add    $0x110,%rsp
