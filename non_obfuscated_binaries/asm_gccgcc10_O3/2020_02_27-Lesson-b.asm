...
/app/bin_gccgcc10_O3/2020_02_27-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10bb:	48 c7 04 24 00 00 00 	movq   $0x0,(%rsp)
    10c2:	00 
    10c3:	e8 a8 ff ff ff       	callq  1070 <ctime@plt>
    10c8:	48 8d 35 35 0f 00 00 	lea    0xf35(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10cf:	bf 01 00 00 00       	mov    $0x1,%edi
    10d4:	48 89 c2             	mov    %rax,%rdx
