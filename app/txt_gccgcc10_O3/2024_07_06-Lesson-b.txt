...
/app/bin_gccgcc10_O3/2024_07_06-Lesson-b:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10d7:	bf 58 00 00 00       	mov    $0x58,%edi
    10dc:	e8 9f ff ff ff       	callq  1080 <putc@plt>
    10e1:	83 eb 01             	sub    $0x1,%ebx
    10e4:	75 ea                	jne    10d0 <main+0x10>
    10e6:	48 8b 3d 23 2f 00 00 	mov    0x2f23(%rip),%rdi        # 4010 <stdout@@GLIBC_2.2.5>
    10ed:	bb 14 00 00 00       	mov    $0x14,%ebx
    10f2:	48 8d 2d 0b 0f 00 00 	lea    0xf0b(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    10f9:	e8 92 ff ff ff       	callq  1090 <fflush@plt>
    10fe:	bf 01 00 00 00       	mov    $0x1,%edi
    1103:	e8 a8 ff ff ff       	callq  10b0 <sleep@plt>
    ...
    111a:	e8 81 ff ff ff       	callq  10a0 <__printf_chk@plt>
    111f:	83 eb 01             	sub    $0x1,%ebx
    1122:	75 ec                	jne    1110 <main+0x50>
    1124:	48 8b 35 e5 2e 00 00 	mov    0x2ee5(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    112b:	bf 0a 00 00 00       	mov    $0xa,%edi
    1130:	e8 4b ff ff ff       	callq  1080 <putc@plt>
    1135:	48 83 c4 08          	add    $0x8,%rsp
