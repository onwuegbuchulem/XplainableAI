...
/app/bin_gccgcc10_O1/byte_sizes:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	f2 0f 10 05 df 0e 00 	movsd  0xedf(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    1158:	00 
    1159:	b9 08 00 00 00       	mov    $0x8,%ecx
    115e:	48 8d 15 9f 0e 00 00 	lea    0xe9f(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    ...
    1176:	e8 d5 fe ff ff       	callq  1050 <__printf_chk@plt>
    117b:	f2 0f 10 05 bd 0e 00 	movsd  0xebd(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    1182:	00 
    1183:	b9 10 00 00 00       	mov    $0x10,%ecx
    1188:	48 8d 15 90 0e 00 00 	lea    0xe90(%rip),%rdx        # 201f <_IO_stdin_used+0x1f>
    118f:	48 8d 35 73 0e 00 00 	lea    0xe73(%rip),%rsi        # 2009 <_IO_stdin_used+0x9>
    1196:	bf 01 00 00 00       	mov    $0x1,%edi
    119b:	b8 01 00 00 00       	mov    $0x1,%eax
    11a0:	e8 ab fe ff ff       	callq  1050 <__printf_chk@plt>
    11a5:	f2 0f 10 05 9b 0e 00 	movsd  0xe9b(%rip),%xmm0        # 2048 <_IO_stdin_used+0x48>
    11ac:	00 
    11ad:	b9 20 00 00 00       	mov    $0x20,%ecx
    11b2:	48 8d 15 6b 0e 00 00 	lea    0xe6b(%rip),%rdx        # 2024 <_IO_stdin_used+0x24>
    11b9:	48 8d 35 49 0e 00 00 	lea    0xe49(%rip),%rsi        # 2009 <_IO_stdin_used+0x9>
    11c0:	bf 01 00 00 00       	mov    $0x1,%edi
    11c5:	b8 01 00 00 00       	mov    $0x1,%eax
    11ca:	e8 81 fe ff ff       	callq  1050 <__printf_chk@plt>
    11cf:	f2 0f 10 05 79 0e 00 	movsd  0xe79(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    11d6:	00 
    11d7:	b9 40 00 00 00       	mov    $0x40,%ecx
    11dc:	48 8d 15 4c 0e 00 00 	lea    0xe4c(%rip),%rdx        # 202f <_IO_stdin_used+0x2f>
    11e3:	48 8d 35 1f 0e 00 00 	lea    0xe1f(%rip),%rsi        # 2009 <_IO_stdin_used+0x9>
    11ea:	bf 01 00 00 00       	mov    $0x1,%edi
    11ef:	b8 01 00 00 00       	mov    $0x1,%eax
    11f4:	e8 57 fe ff ff       	callq  1050 <__printf_chk@plt>
