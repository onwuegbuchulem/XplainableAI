...
/app/bin_gccgcc10_O0/2019_07_27-Lesson:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11cb:	bf 02 00 00 00       	mov    $0x2,%edi
    11d0:	e8 db fe ff ff       	callq  10b0 <getrlimit@plt>
    11d5:	89 45 dc             	mov    %eax,-0x24(%rbp)
    11d8:	83 7d dc ff          	cmpl   $0xffffffff,-0x24(%rbp)
    11dc:	75 27                	jne    1205 <main+0x5c>
    11de:	48 8b 05 3b 2e 00 00 	mov    0x2e3b(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    11e5:	48 89 c1             	mov    %rax,%rcx
    11e8:	ba 11 00 00 00       	mov    $0x11,%edx
    11ed:	be 01 00 00 00       	mov    $0x1,%esi
    11f2:	48 8d 3d 0f 0e 00 00 	lea    0xe0f(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11f9:	e8 a2 fe ff ff       	callq  10a0 <fwrite@plt>
    11fe:	b8 01 00 00 00       	mov    $0x1,%eax
    1203:	eb 35                	jmp    123a <main+0x91>
    1205:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1209:	48 89 c6             	mov    %rax,%rsi
    120c:	48 8d 3d 0d 0e 00 00 	lea    0xe0d(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    1213:	b8 00 00 00 00       	mov    $0x0,%eax
    1218:	e8 73 fe ff ff       	callq  1090 <printf@plt>
    ...
    1230:	e8 5b fe ff ff       	callq  1090 <printf@plt>
    1235:	b8 00 00 00 00       	mov    $0x0,%eax
    123a:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    123e:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1245:	00 00 
    1247:	74 05                	je     124e <main+0xa5>
    1249:	e8 32 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    124e:	c9                   	leaveq 
    124f:	c3                   	retq   
