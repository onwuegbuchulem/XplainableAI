...
/app/bin_gccgcc10_O2/2021_07_31-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10bf:	48 89 e2             	mov    %rsp,%rdx
    10c2:	48 8d 7c 24 04       	lea    0x4(%rsp),%rdi
    10c7:	c7 44 24 04 38 32 37 	movl   $0x373238,0x4(%rsp)
    10ce:	00 
    10cf:	e8 ac ff ff ff       	callq  1080 <__isoc99_sscanf@plt>
    10d4:	85 c0                	test   %eax,%eax
    10d6:	75 17                	jne    10ef <main+0x4f>
    10d8:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10dd:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10e4:	00 00 
    10e6:	75 1f                	jne    1107 <main+0x67>
    10e8:	31 c0                	xor    %eax,%eax
    10ea:	48 83 c4 18          	add    $0x18,%rsp
    10ee:	c3                   	retq   
    10ef:	8b 14 24             	mov    (%rsp),%edx
    10f2:	48 8d 35 0f 0f 00 00 	lea    0xf0f(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    10f9:	bf 01 00 00 00       	mov    $0x1,%edi
    10fe:	31 c0                	xor    %eax,%eax
    1100:	e8 8b ff ff ff       	callq  1090 <__printf_chk@plt>
    1105:	eb d1                	jmp    10d8 <main+0x38>
