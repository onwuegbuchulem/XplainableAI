...
/app/bin_gccgcc10_O3/assignment9:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1068:	83 ff 03             	cmp    $0x3,%edi
    106b:	74 1a                	je     1087 <main+0x27>
    106d:	48 8d 35 94 0f 00 00 	lea    0xf94(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    ...
    1086:	c3                   	retq   
    1087:	48 8b 4e 10          	mov    0x10(%rsi),%rcx
    108b:	48 8b 56 08          	mov    0x8(%rsi),%rdx
    108f:	bf 01 00 00 00       	mov    $0x1,%edi
    1094:	31 c0                	xor    %eax,%eax
    1096:	48 8d 35 93 0f 00 00 	lea    0xf93(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    109d:	e8 ae ff ff ff       	callq  1050 <__printf_chk@plt>
    10a2:	eb dc                	jmp    1080 <main+0x20>
    10a4:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10ab:	00 00 00 
