...
/app/bin_gccgcc10_O0/2020_10-Exercise-non-recursive:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d f3 00 00 00 	lea    0xf3(%rip),%rdi        # 11bb <main>
...
0000000000001189 <cumulative>:
    ...
    11a2:	eb 0a                	jmp    11ae <cumulative+0x25>
    11a4:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11a7:	01 45 fc             	add    %eax,-0x4(%rbp)
    11aa:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11ae:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11b1:	3b 45 ec             	cmp    -0x14(%rbp),%eax
    11b4:	76 ee                	jbe    11a4 <cumulative+0x1b>
...
00000000000011bb <main>:
    ...
    11d6:	48 8d 3d 2b 0e 00 00 	lea    0xe2b(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11dd:	b8 00 00 00 00       	mov    $0x0,%eax
    11e2:	e8 99 fe ff ff       	callq  1080 <printf@plt>
    11e7:	48 8d 45 f4          	lea    -0xc(%rbp),%rax
    11eb:	48 89 c6             	mov    %rax,%rsi
    11ee:	48 8d 3d 33 0e 00 00 	lea    0xe33(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    ...
    1204:	e8 80 ff ff ff       	callq  1189 <cumulative>
    1209:	89 c2                	mov    %eax,%edx
    120b:	8b 45 f4             	mov    -0xc(%rbp),%eax
    120e:	89 c6                	mov    %eax,%esi
    1210:	48 8d 3d 19 0e 00 00 	lea    0xe19(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    1217:	b8 00 00 00 00       	mov    $0x0,%eax
    121c:	e8 5f fe ff ff       	callq  1080 <printf@plt>
    1221:	b8 00 00 00 00       	mov    $0x0,%eax
    1226:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    122a:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1231:	00 00 
    1233:	74 05                	je     123a <main+0x7f>
