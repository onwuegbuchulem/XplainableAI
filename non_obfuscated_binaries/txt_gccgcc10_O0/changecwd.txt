...
/app/bin_gccgcc10_O0/changecwd:     file format elf64-x86-64
...
00000000000010d0 <getcwd@plt>:
    10d0:	f3 0f 1e fa          	endbr64 
    10d4:	f2 ff 25 e5 2e 00 00 	bnd jmpq *0x2ee5(%rip)        # 3fc0 <getcwd@GLIBC_2.2.5>
...
00000000000011e9 <main>:
    ...
    1204:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    ...
    1223:	e8 78 fe ff ff       	callq  10a0 <chdir@plt>
    1228:	89 85 ec df ff ff    	mov    %eax,-0x2014(%rbp)
    122e:	83 bd ec df ff ff ff 	cmpl   $0xffffffff,-0x2014(%rbp)
    1235:	75 2a                	jne    1261 <main+0x78>
    1237:	48 8b 05 e2 2d 00 00 	mov    0x2de2(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    123e:	48 89 c1             	mov    %rax,%rcx
    1241:	ba 1d 00 00 00       	mov    $0x1d,%edx
    1246:	be 01 00 00 00       	mov    $0x1,%esi
    124b:	48 8d 3d b9 0d 00 00 	lea    0xdb9(%rip),%rdi        # 200b <_IO_stdin_used+0xb>
    1252:	e8 99 fe ff ff       	callq  10f0 <fwrite@plt>
    1257:	bf 01 00 00 00       	mov    $0x1,%edi
    125c:	e8 7f fe ff ff       	callq  10e0 <exit@plt>
    1261:	48 8d 85 f0 df ff ff 	lea    -0x2010(%rbp),%rax
    1268:	be 00 20 00 00       	mov    $0x2000,%esi
    126d:	48 89 c7             	mov    %rax,%rdi
    1270:	e8 5b fe ff ff       	callq  10d0 <getcwd@plt>
    1275:	48 8d 85 f0 df ff ff 	lea    -0x2010(%rbp),%rax
    ...
    128b:	e8 30 fe ff ff       	callq  10c0 <printf@plt>
    1290:	b8 00 00 00 00       	mov    $0x0,%eax
    1295:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1299:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    12a0:	00 00 
    12a2:	74 05                	je     12a9 <main+0xc0>
    12a4:	e8 07 fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
    12a9:	c9                   	leaveq 
    12aa:	c3                   	retq   
