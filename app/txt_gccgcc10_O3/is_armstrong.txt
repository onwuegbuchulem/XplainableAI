...
/app/bin_gccgcc10_O3/is_armstrong:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c9:	48 8d 3d 43 0f 00 00 	lea    0xf43(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    10d0:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	e8 b4 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10dc:	44 8b 44 24 04       	mov    0x4(%rsp),%r8d
    10e1:	31 ff                	xor    %edi,%edi
    10e3:	44 89 c2             	mov    %r8d,%edx
    10e6:	45 85 c0             	test   %r8d,%r8d
    10e9:	74 6f                	je     115a <main+0xba>
    ...
    1105:	8d 34 80             	lea    (%rax,%rax,4),%esi
    1108:	89 c1                	mov    %eax,%ecx
    110a:	89 d0                	mov    %edx,%eax
    110c:	01 f6                	add    %esi,%esi
    110e:	29 f0                	sub    %esi,%eax
    1110:	89 c2                	mov    %eax,%edx
    1112:	0f af d0             	imul   %eax,%edx
    1115:	0f af c2             	imul   %edx,%eax
    1118:	89 ca                	mov    %ecx,%edx
    111a:	01 c7                	add    %eax,%edi
    111c:	85 c9                	test   %ecx,%ecx
    111e:	75 d0                	jne    10f0 <main+0x50>
    1120:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%rsp)
    1127:	00 
    1128:	41 39 f8             	cmp    %edi,%r8d
    112b:	74 2d                	je     115a <main+0xba>
    112d:	44 89 c2             	mov    %r8d,%edx
    1130:	48 8d 35 01 0f 00 00 	lea    0xf01(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    1137:	bf 01 00 00 00       	mov    $0x1,%edi
    113c:	31 c0                	xor    %eax,%eax
    113e:	e8 3d ff ff ff       	callq  1080 <__printf_chk@plt>
    1143:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1148:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    114f:	00 00 
    1151:	75 1f                	jne    1172 <main+0xd2>
    ...
    1170:	eb d1                	jmp    1143 <main+0xa3>
    1172:	e8 f9 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
