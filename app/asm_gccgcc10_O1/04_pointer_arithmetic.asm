...
/app/bin_gccgcc10_O1/04_pointer_arithmetic:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1182:	c6 44 24 07 41       	movb   $0x41,0x7(%rsp)
    1187:	48 8d 5c 24 07       	lea    0x7(%rsp),%rbx
    118c:	48 89 da             	mov    %rbx,%rdx
    ...
    11b4:	e8 b7 fe ff ff       	callq  1070 <__printf_chk@plt>
    11b9:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx
    11be:	48 8d 35 57 0e 00 00 	lea    0xe57(%rip),%rsi        # 201c <_IO_stdin_used+0x1c>
    11c5:	bf 01 00 00 00       	mov    $0x1,%edi
    11ca:	b8 00 00 00 00       	mov    $0x0,%eax
    11cf:	e8 9c fe ff ff       	callq  1070 <__printf_chk@plt>
    11d4:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11d9:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11e0:	00 00 
    11e2:	75 0b                	jne    11ef <main+0x86>
    11e4:	b8 00 00 00 00       	mov    $0x0,%eax
    11e9:	48 83 c4 10          	add    $0x10,%rsp
    11ed:	5b                   	pop    %rbx
    11ee:	c3                   	retq   
    11ef:	e8 6c fe ff ff       	callq  1060 <__stack_chk_fail@plt>
