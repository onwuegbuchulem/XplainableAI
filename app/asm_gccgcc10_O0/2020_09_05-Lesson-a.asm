...
/app/bin_gccgcc10_O0/2020_09_05-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b5:	48 8d 4d f7          	lea    -0x9(%rbp),%rcx
    11b9:	48 8d 55 f6          	lea    -0xa(%rbp),%rdx
    11bd:	48 8d 45 f5          	lea    -0xb(%rbp),%rax
    11c1:	48 89 c6             	mov    %rax,%rsi
    11c4:	48 8d 3d 46 0e 00 00 	lea    0xe46(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    11cb:	b8 00 00 00 00       	mov    $0x0,%eax
    11d0:	e8 bb fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11d5:	0f b6 45 f7          	movzbl -0x9(%rbp),%eax
    11d9:	0f be c8             	movsbl %al,%ecx
    11dc:	0f b6 45 f6          	movzbl -0xa(%rbp),%eax
    11e0:	0f be d0             	movsbl %al,%edx
    11e3:	0f b6 45 f5          	movzbl -0xb(%rbp),%eax
    11e7:	0f be c0             	movsbl %al,%eax
    11ea:	89 c6                	mov    %eax,%esi
    11ec:	48 8d 3d 25 0e 00 00 	lea    0xe25(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    11f3:	b8 00 00 00 00       	mov    $0x0,%eax
    11f8:	e8 83 fe ff ff       	callq  1080 <printf@plt>
    11fd:	b8 00 00 00 00       	mov    $0x0,%eax
    1202:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    1206:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    120d:	00 00 
    120f:	74 05                	je     1216 <main+0x8d>
    1211:	e8 5a fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1216:	c9                   	leaveq 
    1217:	c3                   	retq   
