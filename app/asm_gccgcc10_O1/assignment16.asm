...
/app/bin_gccgcc10_O1/assignment16:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1185:	48 89 da             	mov    %rbx,%rdx
    1188:	48 8d 35 75 0e 00 00 	lea    0xe75(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    118f:	bf 01 00 00 00       	mov    $0x1,%edi
    1194:	e8 d7 fe ff ff       	callq  1070 <__printf_chk@plt>
    1199:	48 89 da             	mov    %rbx,%rdx
    ...
    11b2:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    11b7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11be:	00 00 
    11c0:	75 0b                	jne    11cd <main+0x64>
    11c2:	b8 00 00 00 00       	mov    $0x0,%eax
    11c7:	48 83 c4 30          	add    $0x30,%rsp
    11cb:	5b                   	pop    %rbx
    11cc:	c3                   	retq   
    11cd:	e8 8e fe ff ff       	callq  1060 <__stack_chk_fail@plt>
