...
/app/bin_gccgcc10_O1/2023_01_28-Lesson-c:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11d6:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11da:	f3 48 0f 2a c0       	cvtsi2ss %rax,%xmm0
    11df:	f3 0f 5e 05 51 0e 00 	divss  0xe51(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    11e6:	00 
    11e7:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    ...
    11fc:	e8 bf fe ff ff       	callq  10c0 <__printf_chk@plt>
    1201:	bf 00 00 00 00       	mov    $0x0,%edi
    1206:	e8 a5 fe ff ff       	callq  10b0 <time@plt>
    120b:	48 89 c7             	mov    %rax,%rdi
    120e:	e8 8d fe ff ff       	callq  10a0 <srand@plt>
    1213:	e8 b8 fe ff ff       	callq  10d0 <rand@plt>
    1218:	89 c2                	mov    %eax,%edx
    121a:	48 98                	cltq   
    121c:	48 69 c0 d3 4d 62 10 	imul   $0x10624dd3,%rax,%rax
    1223:	48 c1 f8 26          	sar    $0x26,%rax
    1227:	89 d1                	mov    %edx,%ecx
    1229:	c1 f9 1f             	sar    $0x1f,%ecx
    122c:	29 c8                	sub    %ecx,%eax
    122e:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
    1234:	29 c2                	sub    %eax,%edx
    1236:	83 fa 01             	cmp    $0x1,%edx
    1239:	75 d8                	jne    1213 <main+0x4a>
    123b:	e8 50 fe ff ff       	callq  1090 <clock@plt>
    1240:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1244:	f3 48 0f 2a c0       	cvtsi2ss %rax,%xmm0
    1249:	f3 0f 5e 05 e7 0d 00 	divss  0xde7(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    1250:	00 
    1251:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1255:	48 8d 35 c2 0d 00 00 	lea    0xdc2(%rip),%rsi        # 201e <_IO_stdin_used+0x1e>
    125c:	bf 01 00 00 00       	mov    $0x1,%edi
    1261:	b8 01 00 00 00       	mov    $0x1,%eax
    1266:	e8 55 fe ff ff       	callq  10c0 <__printf_chk@plt>
