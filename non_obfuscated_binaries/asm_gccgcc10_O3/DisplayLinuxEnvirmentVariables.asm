...
/app/bin_gccgcc10_O3/DisplayLinuxEnvirmentVariables:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1064:	48 8b 3a             	mov    (%rdx),%rdi
    1067:	48 85 ff             	test   %rdi,%rdi
    106a:	74 21                	je     108d <main+0x2d>
    106c:	53                   	push   %rbx
    106d:	48 8d 5a 08          	lea    0x8(%rdx),%rbx
    1071:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    1078:	e8 d3 ff ff ff       	callq  1050 <puts@plt>
    107d:	48 8b 3b             	mov    (%rbx),%rdi
    1080:	48 83 c3 08          	add    $0x8,%rbx
    1084:	48 85 ff             	test   %rdi,%rdi
