...
/app/bin_gccgcc10_O0/2024_01_13-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1193:	00 
    1194:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%rbp)
    119b:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
    11a2:	eb 23                	jmp    11c7 <main+0x5e>
    11a4:	8b 45 dc             	mov    -0x24(%rbp),%eax
    11a7:	48 98                	cltq   
    11a9:	8b 54 85 e0          	mov    -0x20(%rbp,%rax,4),%edx
    11ad:	8b 45 dc             	mov    -0x24(%rbp),%eax
    11b0:	89 c6                	mov    %eax,%esi
    11b2:	48 8d 3d 4b 0e 00 00 	lea    0xe4b(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11b9:	b8 00 00 00 00       	mov    $0x0,%eax
    11be:	e8 ad fe ff ff       	callq  1070 <printf@plt>
    11c3:	83 45 dc 01          	addl   $0x1,-0x24(%rbp)
    11c7:	83 7d dc 04          	cmpl   $0x4,-0x24(%rbp)
    11cb:	7e d7                	jle    11a4 <main+0x3b>
    11cd:	b8 00 00 00 00       	mov    $0x0,%eax
    11d2:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11d6:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11dd:	00 00 
    11df:	74 05                	je     11e6 <main+0x7d>
