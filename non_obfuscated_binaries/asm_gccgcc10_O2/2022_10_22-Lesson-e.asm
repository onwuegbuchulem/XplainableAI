...
/app/bin_gccgcc10_O2/2022_10_22-Lesson-e:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    10ec:	48 83 ec 20          	sub    $0x20,%rsp
    10f0:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10f7:	00 00 
    10f9:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10fe:	48 b8 2f 64 65 76 2f 	movabs $0x6e61722f7665642f,%rax
    1105:	72 61 6e 
    1108:	48 8d 7c 24 0c       	lea    0xc(%rsp),%rdi
    110d:	c7 44 24 14 64 6f 6d 	movl   $0x6d6f64,0x14(%rsp)
    1114:	00 
    1115:	48 89 44 24 0c       	mov    %rax,0xc(%rsp)
    111a:	e8 b1 ff ff ff       	callq  10d0 <fopen@plt>
    111f:	48 85 c0             	test   %rax,%rax
    1122:	74 3b                	je     115f <main+0x7f>
    1124:	48 89 e7             	mov    %rsp,%rdi
    1127:	48 89 c1             	mov    %rax,%rcx
    112a:	ba 01 00 00 00       	mov    $0x1,%edx
    112f:	be 08 00 00 00       	mov    $0x8,%esi
    1134:	48 89 c5             	mov    %rax,%rbp
    1137:	e8 54 ff ff ff       	callq  1090 <fread@plt>
    113c:	f2 0f 10 04 24       	movsd  (%rsp),%xmm0
    1141:	bf 01 00 00 00       	mov    $0x1,%edi
    1146:	48 8d 35 b9 0e 00 00 	lea    0xeb9(%rip),%rsi        # 2006 <_IO_stdin_used+0x6>
    114d:	b8 01 00 00 00       	mov    $0x1,%eax
    1152:	e8 69 ff ff ff       	callq  10c0 <__printf_chk@plt>
    1157:	48 89 ef             	mov    %rbp,%rdi
    115a:	e8 41 ff ff ff       	callq  10a0 <fclose@plt>
    115f:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1164:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    116b:	00 00 
    116d:	75 08                	jne    1177 <main+0x97>
    116f:	48 83 c4 20          	add    $0x20,%rsp
    1173:	31 c0                	xor    %eax,%eax
    1175:	5d                   	pop    %rbp
    1176:	c3                   	retq   
    1177:	e8 34 ff ff ff       	callq  10b0 <__stack_chk_fail@plt>
