...
/app/bin_gccgcc10_O1/FahrenheitToCelciusConv:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d2:	48 8d 3d 5b 0e 00 00 	lea    0xe5b(%rip),%rdi        # 2034 <_IO_stdin_used+0x34>
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	e8 cd fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e3:	f3 0f 10 44 24 04    	movss  0x4(%rsp),%xmm0
    11e9:	f3 0f 5c 05 47 0e 00 	subss  0xe47(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    11f0:	00 
    11f1:	f3 0f 59 05 43 0e 00 	mulss  0xe43(%rip),%xmm0        # 203c <_IO_stdin_used+0x3c>
    11f8:	00 
    11f9:	f3 0f 5e 05 3f 0e 00 	divss  0xe3f(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    1200:	00 
    1201:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1205:	48 8d 35 13 0e 00 00 	lea    0xe13(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    ...
    1227:	00 00 
    1229:	75 0a                	jne    1235 <main+0x8c>
    122b:	b8 00 00 00 00       	mov    $0x0,%eax
    1230:	48 83 c4 18          	add    $0x18,%rsp
    1234:	c3                   	retq   
    1235:	e8 56 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
