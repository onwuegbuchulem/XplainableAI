...
/app/bin_gccgcc10_O3/return02:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 54                	push   %r12
    1086:	48 8d 3d 77 0f 00 00 	lea    0xf77(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    108d:	e8 ce ff ff ff       	callq  1060 <system@plt>
    1092:	48 8d 35 79 0f 00 00 	lea    0xf79(%rip),%rsi        # 2012 <_IO_stdin_used+0x12>
    1099:	bf 01 00 00 00       	mov    $0x1,%edi
    109e:	41 89 c4             	mov    %eax,%r12d
    10a1:	89 c2                	mov    %eax,%edx
    10a3:	31 c0                	xor    %eax,%eax
    10a5:	e8 c6 ff ff ff       	callq  1070 <__printf_chk@plt>
    10aa:	44 89 e0             	mov    %r12d,%eax
    10ad:	41 5c                	pop    %r12
    10af:	c3                   	retq   
