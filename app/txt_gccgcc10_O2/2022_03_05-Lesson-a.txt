...
/app/bin_gccgcc10_O2/2022_03_05-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	48 8d 35 79 0f 00 00 	lea    0xf79(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    108f:	bf 01 00 00 00       	mov    $0x1,%edi
    1094:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    109b:	00 00 
    109d:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10a2:	31 c0                	xor    %eax,%eax
    10a4:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    10a9:	e8 c2 ff ff ff       	callq  1070 <__printf_chk@plt>
    10ae:	8b 54 24 04          	mov    0x4(%rsp),%edx
    10b2:	31 c0                	xor    %eax,%eax
    10b4:	bf 01 00 00 00       	mov    $0x1,%edi
    10b9:	48 8d 35 67 0f 00 00 	lea    0xf67(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    10c0:	e8 ab ff ff ff       	callq  1070 <__printf_chk@plt>
    10c5:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10ca:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10d1:	00 00 
    10d3:	75 07                	jne    10dc <main+0x5c>
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	48 83 c4 18          	add    $0x18,%rsp
    10db:	c3                   	retq   
    10dc:	e8 7f ff ff ff       	callq  1060 <__stack_chk_fail@plt>
