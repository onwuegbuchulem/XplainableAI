...
/app/bin_gccgcc10_O0/2019_01_19-Lesson-b:     file format elf64-x86-64
...
00000000000010b0 <signal@plt>:
    ...
    10b4:	f2 ff 25 15 2f 00 00 	bnd jmpq *0x2f15(%rip)        # 3fd0 <signal@GLIBC_2.2.5>
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d f3 00 00 00 	lea    0xf3(%rip),%rdi        # 11db <main>
...
00000000000011a9 <ctrap>:
    ...
    11c4:	e8 d7 fe ff ff       	callq  10a0 <getchar@plt>
    11c9:	be 00 00 00 00       	mov    $0x0,%esi
    11ce:	bf 02 00 00 00       	mov    $0x2,%edi
    11d3:	e8 d8 fe ff ff       	callq  10b0 <signal@plt>
    11d8:	90                   	nop
    11d9:	c9                   	leaveq 
    11da:	c3                   	retq   
...
00000000000011db <main>:
    ...
    11e3:	48 83 ec 10          	sub    $0x10,%rsp
    11e7:	c6 45 ff 00          	movb   $0x0,-0x1(%rbp)
    11eb:	48 8d 35 b7 ff ff ff 	lea    -0x49(%rip),%rsi        # 11a9 <ctrap>
    11f2:	bf 02 00 00 00       	mov    $0x2,%edi
    11f7:	e8 b4 fe ff ff       	callq  10b0 <signal@plt>
    11fc:	0f be 45 ff          	movsbl -0x1(%rbp),%eax
    1200:	89 c6                	mov    %eax,%esi
    1202:	48 8d 3d 0f 0e 00 00 	lea    0xe0f(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    1209:	b8 00 00 00 00       	mov    $0x0,%eax
    120e:	e8 7d fe ff ff       	callq  1090 <printf@plt>
    1213:	0f b6 45 ff          	movzbl -0x1(%rbp),%eax
    1217:	83 c0 01             	add    $0x1,%eax
    121a:	88 45 ff             	mov    %al,-0x1(%rbp)
    121d:	eb dd                	jmp    11fc <main+0x21>
    121f:	90                   	nop
