...
/app/bin_gccgcc10_O0/2021_05_01-Lesson-b:     file format elf64-x86-64
...
0000000000001090 <memset@plt>:
    ...
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <memset@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    1198:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    119d:	48 81 ec 00 10 00 00 	sub    $0x1000,%rsp
    11a4:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    ...
    11bc:	48 8d 85 f0 df ff ff 	lea    -0x2010(%rbp),%rax
    11c3:	ba 00 20 00 00       	mov    $0x2000,%edx
    11c8:	be 00 00 00 00       	mov    $0x0,%esi
    11cd:	48 89 c7             	mov    %rax,%rdi
    11d0:	e8 bb fe ff ff       	callq  1090 <memset@plt>
    11d5:	48 8d 3d 28 0e 00 00 	lea    0xe28(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11dc:	e8 8f fe ff ff       	callq  1070 <puts@plt>
    ...
    11f5:	e8 86 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    11fa:	c9                   	leaveq 
    11fb:	c3                   	retq   
