...
/app/bin_gccgcc10_O1/QuotientRemainder:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b3:	48 89 e6             	mov    %rsp,%rsi
    11b6:	48 8d 3d 58 0e 00 00 	lea    0xe58(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    11bd:	b8 00 00 00 00       	mov    $0x0,%eax
    11c2:	e8 c9 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c7:	48 8d 35 4a 0e 00 00 	lea    0xe4a(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    ...
    11e2:	48 8d 3d 2c 0e 00 00 	lea    0xe2c(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    11e9:	b8 00 00 00 00       	mov    $0x0,%eax
    11ee:	e8 9d fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f3:	8b 04 24             	mov    (%rsp),%eax
    11f6:	99                   	cltd   
    11f7:	f7 7c 24 04          	idivl  0x4(%rsp)
    11fb:	89 d3                	mov    %edx,%ebx
    11fd:	89 c2                	mov    %eax,%edx
    11ff:	48 8d 35 23 0e 00 00 	lea    0xe23(%rip),%rsi        # 2029 <_IO_stdin_used+0x29>
    1206:	bf 01 00 00 00       	mov    $0x1,%edi
    120b:	b8 00 00 00 00       	mov    $0x0,%eax
    1210:	e8 6b fe ff ff       	callq  1080 <__printf_chk@plt>
    1215:	89 da                	mov    %ebx,%edx
    1217:	48 8d 35 1a 0e 00 00 	lea    0xe1a(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    ...
    1239:	00 00 
    123b:	75 0b                	jne    1248 <main+0xbf>
    123d:	b8 00 00 00 00       	mov    $0x0,%eax
    1242:	48 83 c4 10          	add    $0x10,%rsp
    1246:	5b                   	pop    %rbx
    1247:	c3                   	retq   
    1248:	e8 23 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
