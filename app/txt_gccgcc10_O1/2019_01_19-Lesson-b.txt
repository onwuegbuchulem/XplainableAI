...
/app/bin_gccgcc10_O1/2019_01_19-Lesson-b:     file format elf64-x86-64
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d f5 00 00 00 	lea    0xf5(%rip),%rdi        # 11dd <main>
...
00000000000011a9 <ctrap>:
    ...
    11c4:	e8 e7 fe ff ff       	callq  10b0 <getc@plt>
    11c9:	be 00 00 00 00       	mov    $0x0,%esi
    11ce:	bf 02 00 00 00       	mov    $0x2,%edi
    11d3:	e8 b8 fe ff ff       	callq  1090 <signal@plt>
...
00000000000011dd <main>:
    ...
    11e7:	48 8d 35 bb ff ff ff 	lea    -0x45(%rip),%rsi        # 11a9 <ctrap>
    11ee:	bf 02 00 00 00       	mov    $0x2,%edi
    11f3:	e8 98 fe ff ff       	callq  1090 <signal@plt>
    11f8:	bb 00 00 00 00       	mov    $0x0,%ebx
    11fd:	48 8d 2d 14 0e 00 00 	lea    0xe14(%rip),%rbp        # 2018 <_IO_stdin_used+0x18>
    1204:	0f be d3             	movsbl %bl,%edx
    1207:	48 89 ee             	mov    %rbp,%rsi
