...
/app/bin_gccgcc10_O2/hexenfilter01:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ac:	eb 11                	jmp    10bf <main+0x1f>
    10ae:	66 90                	xchg   %ax,%ax
    10b0:	48 89 de             	mov    %rbx,%rsi
    10b3:	bf 01 00 00 00       	mov    $0x1,%edi
    10b8:	31 c0                	xor    %eax,%eax
    10ba:	e8 c1 ff ff ff       	callq  1080 <__printf_chk@plt>
    10bf:	48 8b 3d 5a 2f 00 00 	mov    0x2f5a(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    10c6:	e8 c5 ff ff ff       	callq  1090 <getc@plt>
    10cb:	89 c2                	mov    %eax,%edx
    10cd:	83 f8 ff             	cmp    $0xffffffff,%eax
    10d0:	75 de                	jne    10b0 <main+0x10>
    10d2:	48 8b 35 37 2f 00 00 	mov    0x2f37(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10d9:	bf 0a 00 00 00       	mov    $0xa,%edi
