...
/app/bin_gccgcc10_O3/wide_hello:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10b4:	66 0f 6f 05 54 0f 00 	movdqa 0xf54(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    10bb:	00 
    10bc:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10c3:	00 00 
    10c5:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    10ca:	31 c0                	xor    %eax,%eax
    10cc:	48 8b 05 6d 0f 00 00 	mov    0xf6d(%rip),%rax        # 2040 <_IO_stdin_used+0x40>
    10d3:	c7 44 24 40 00 00 00 	movl   $0x0,0x40(%rsp)
    10da:	00 
    10db:	0f 29 44 24 20       	movaps %xmm0,0x20(%rsp)
    10e0:	66 0f 6f 05 38 0f 00 	movdqa 0xf38(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10e7:	00 
    10e8:	48 89 04 24          	mov    %rax,(%rsp)
    10ec:	0f 29 44 24 30       	movaps %xmm0,0x30(%rsp)
    10f1:	66 0f 6f 05 37 0f 00 	movdqa 0xf37(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    10f8:	00 
    10f9:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%rsp)
    1100:	00 
    1101:	0f 29 44 24 10       	movaps %xmm0,0x10(%rsp)
    1106:	e8 85 ff ff ff       	callq  1090 <setlocale@plt>
    110b:	48 8b 35 fe 2e 00 00 	mov    0x2efe(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1112:	48 8d 7c 24 20       	lea    0x20(%rsp),%rdi
    1117:	e8 64 ff ff ff       	callq  1080 <fputws@plt>
    111c:	48 8b 35 ed 2e 00 00 	mov    0x2eed(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1123:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
    1128:	e8 53 ff ff ff       	callq  1080 <fputws@plt>
    112d:	48 8b 35 dc 2e 00 00 	mov    0x2edc(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1134:	48 89 e7             	mov    %rsp,%rdi
    1137:	e8 44 ff ff ff       	callq  1080 <fputws@plt>
    113c:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    1141:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1148:	00 00 
    114a:	75 07                	jne    1153 <main+0xb3>
    114c:	31 c0                	xor    %eax,%eax
    114e:	48 83 c4 58          	add    $0x58,%rsp
    1152:	c3                   	retq   
    1153:	e8 18 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
