...
/app/bin_gccgcc10_O2/thefirst03:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1068:	ba 19 00 00 00       	mov    $0x19,%edx
    106d:	bf 01 00 00 00       	mov    $0x1,%edi
    1072:	31 c0                	xor    %eax,%eax
    1074:	4c 8d 05 89 0f 00 00 	lea    0xf89(%rip),%r8        # 2004 <_IO_stdin_used+0x4>
    107b:	48 8d 0d 8c 0f 00 00 	lea    0xf8c(%rip),%rcx        # 200e <_IO_stdin_used+0xe>
    1082:	48 8d 35 8f 0f 00 00 	lea    0xf8f(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    1089:	e8 c2 ff ff ff       	callq  1050 <__printf_chk@plt>
    108e:	31 c0                	xor    %eax,%eax
    1090:	48 83 c4 08          	add    $0x8,%rsp
    1094:	c3                   	retq   
    1095:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    109c:	00 00 00 
    109f:	90                   	nop
...
0000000000001190 <thefirst>:
    1190:	f3 0f 1e fa          	endbr64 
    1194:	48 63 c6             	movslq %esi,%rax
    1197:	89 f2                	mov    %esi,%edx
    1199:	48 69 c0 93 24 49 92 	imul   $0xffffffff92492493,%rax,%rax
    11a0:	c1 fa 1f             	sar    $0x1f,%edx
    11a3:	48 c1 e8 20          	shr    $0x20,%rax
    11a7:	01 f0                	add    %esi,%eax
    11a9:	c1 f8 02             	sar    $0x2,%eax
    11ac:	29 d0                	sub    %edx,%eax
    11ae:	8d 14 c5 00 00 00 00 	lea    0x0(,%rax,8),%edx
    11b5:	29 c2                	sub    %eax,%edx
    11b7:	89 f8                	mov    %edi,%eax
    11b9:	29 d6                	sub    %edx,%esi
    11bb:	29 f0                	sub    %esi,%eax
    11bd:	8d 50 08             	lea    0x8(%rax),%edx
    11c0:	83 c0 01             	add    $0x1,%eax
    11c3:	0f 48 c2             	cmovs  %edx,%eax
    11c6:	c3                   	retq   
