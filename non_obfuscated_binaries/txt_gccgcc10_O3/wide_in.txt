...
/app/bin_gccgcc10_O3/wide_in:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    111a:	4c 89 e2             	mov    %r12,%rdx
    111d:	bf 01 00 00 00       	mov    $0x1,%edi
    1122:	48 8d 35 47 0f 00 00 	lea    0xf47(%rip),%rsi        # 2070 <_IO_stdin_used+0x70>
    1129:	e8 82 ff ff ff       	callq  10b0 <__wprintf_chk@plt>
    112e:	48 8b 84 24 88 00 00 	mov    0x88(%rsp),%rax
    1135:	00 
    1136:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    113d:	00 00 
    113f:	75 0c                	jne    114d <main+0x8d>
    1141:	48 81 c4 90 00 00 00 	add    $0x90,%rsp
    1148:	31 c0                	xor    %eax,%eax
    114a:	41 5c                	pop    %r12
    114c:	c3                   	retq   
    114d:	e8 3e ff ff ff       	callq  1090 <__stack_chk_fail@plt>
