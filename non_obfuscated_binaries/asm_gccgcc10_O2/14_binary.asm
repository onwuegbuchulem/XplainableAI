...
/app/bin_gccgcc10_O2/14_binary:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e5:	48 8d 35 2e 0f 00 00 	lea    0xf2e(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    10ec:	8d 14 00             	lea    (%rax,%rax,1),%edx
    10ef:	31 c0                	xor    %eax,%eax
    10f1:	e8 8a ff ff ff       	callq  1080 <__printf_chk@plt>
    10f6:	8b 54 24 04          	mov    0x4(%rsp),%edx
    ...
    111b:	00 00 
    111d:	75 07                	jne    1126 <main+0x86>
    111f:	31 c0                	xor    %eax,%eax
    1121:	48 83 c4 18          	add    $0x18,%rsp
    1125:	c3                   	retq   
    1126:	e8 45 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
