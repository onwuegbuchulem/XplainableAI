...
/app/bin_gccgcc10_O1/14_binary:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11cc:	8d 14 00             	lea    (%rax,%rax,1),%edx
    11cf:	48 8d 35 44 0e 00 00 	lea    0xe44(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    11d6:	bf 01 00 00 00       	mov    $0x1,%edi
    11db:	b8 00 00 00 00       	mov    $0x0,%eax
    11e0:	e8 9b fe ff ff       	callq  1080 <__printf_chk@plt>
    11e5:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11e9:	d1 fa                	sar    %edx
