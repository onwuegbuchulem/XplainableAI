...
/app/bin_gccgcc10_O1/2021_10_09-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11d5:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11da:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11e1:	00 00 
    11e3:	75 0b                	jne    11f0 <main+0x67>
    11e5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ea:	48 83 c4 10          	add    $0x10,%rsp
    11ee:	5b                   	pop    %rbx
    11ef:	c3                   	retq   
    11f0:	e8 8b fe ff ff       	callq  1080 <__stack_chk_fail@plt>
