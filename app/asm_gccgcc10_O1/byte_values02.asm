...
/app/bin_gccgcc10_O1/byte_values02:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    116f:	55                   	push   %rbp
    1170:	53                   	push   %rbx
    1171:	48 81 ec 10 01 00 00 	sub    $0x110,%rsp
    1178:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    117f:	00 00 
    1181:	48 89 84 24 08 01 00 	mov    %rax,0x108(%rsp)
    1188:	00 
    1189:	31 c0                	xor    %eax,%eax
    118b:	88 04 04             	mov    %al,(%rsp,%rax,1)
    118e:	48 83 c0 01          	add    $0x1,%rax
    1192:	48 3d 00 01 00 00    	cmp    $0x100,%rax
    1198:	75 f1                	jne    118b <main+0x22>
    119a:	48 89 e3             	mov    %rsp,%rbx
    119d:	4c 8d a4 24 00 01 00 	lea    0x100(%rsp),%r12
    11a4:	00 
    11a5:	48 8d 2d 58 0e 00 00 	lea    0xe58(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    11ac:	0f b6 13             	movzbl (%rbx),%edx
    ...
    11c1:	48 83 c3 01          	add    $0x1,%rbx
    11c5:	4c 39 e3             	cmp    %r12,%rbx
    11c8:	75 e2                	jne    11ac <main+0x43>
    11ca:	48 8b 84 24 08 01 00 	mov    0x108(%rsp),%rax
    11d1:	00 
    11d2:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11d9:	00 00 
    11db:	75 11                	jne    11ee <main+0x85>
    11dd:	b8 00 00 00 00       	mov    $0x0,%eax
    11e2:	48 81 c4 10 01 00 00 	add    $0x110,%rsp
    11e9:	5b                   	pop    %rbx
    11ea:	5d                   	pop    %rbp
    11eb:	41 5c                	pop    %r12
    11ed:	c3                   	retq   
    11ee:	e8 6d fe ff ff       	callq  1060 <__stack_chk_fail@plt>
