...
/app/bin_gccgcc10_O3/assignment3:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10b2:	41 54                	push   %r12
    10b4:	48 83 ec 48          	sub    $0x48,%rsp
    10b8:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10bf:	00 00 
    10c1:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    10c6:	31 c0                	xor    %eax,%eax
    10c8:	49 89 e4             	mov    %rsp,%r12
    10cb:	4c 8d 6c 24 20       	lea    0x20(%rsp),%r13
    10d0:	e8 ab ff ff ff       	callq  1080 <__printf_chk@plt>
    10d5:	4c 89 e6             	mov    %r12,%rsi
    10d8:	48 8d 3d 3d 0f 00 00 	lea    0xf3d(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    10df:	31 c0                	xor    %eax,%eax
    10e1:	e8 aa ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10e6:	48 8d 35 32 0f 00 00 	lea    0xf32(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    10ed:	bf 01 00 00 00       	mov    $0x1,%edi
    10f2:	31 c0                	xor    %eax,%eax
    10f4:	e8 87 ff ff ff       	callq  1080 <__printf_chk@plt>
    10f9:	4c 89 ee             	mov    %r13,%rsi
    10fc:	48 8d 3d 19 0f 00 00 	lea    0xf19(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    1103:	31 c0                	xor    %eax,%eax
    1105:	e8 86 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    110a:	31 c0                	xor    %eax,%eax
    110c:	4c 89 e9             	mov    %r13,%rcx
    110f:	4c 89 e2             	mov    %r12,%rdx
    1112:	48 8d 35 1d 0f 00 00 	lea    0xf1d(%rip),%rsi        # 2036 <_IO_stdin_used+0x36>
    1119:	bf 01 00 00 00       	mov    $0x1,%edi
    111e:	e8 5d ff ff ff       	callq  1080 <__printf_chk@plt>
    1123:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1128:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    112f:	00 00 
    1131:	75 0b                	jne    113e <main+0x9e>
    1133:	48 83 c4 48          	add    $0x48,%rsp
    1137:	31 c0                	xor    %eax,%eax
    1139:	41 5c                	pop    %r12
    113b:	41 5d                	pop    %r13
    113d:	c3                   	retq   
    113e:	e8 2d ff ff ff       	callq  1070 <__stack_chk_fail@plt>
