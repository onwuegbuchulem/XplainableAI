...
/app/bin_gccgcc10_O3/RussianPeasantMultiplication:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10fc:	4c 8b 4c 24 08       	mov    0x8(%rsp),%r9
    1101:	4c 8b 54 24 10       	mov    0x10(%rsp),%r10
    1106:	4d 85 c9             	test   %r9,%r9
    1109:	7e 5d                	jle    1168 <main+0xa8>
    110b:	4c 89 d2             	mov    %r10,%rdx
    110e:	4c 89 c8             	mov    %r9,%rax
    1111:	45 31 c0             	xor    %r8d,%r8d
    1114:	0f 1f 40 00          	nopl   0x0(%rax)
    1118:	a8 01                	test   $0x1,%al
    111a:	49 8d 0c 10          	lea    (%r8,%rdx,1),%rcx
    111e:	4c 0f 45 c1          	cmovne %rcx,%r8
    1122:	48 01 d2             	add    %rdx,%rdx
    1125:	48 d1 f8             	sar    %rax
    1128:	75 ee                	jne    1118 <main+0x58>
    112a:	48 89 54 24 10       	mov    %rdx,0x10(%rsp)
    112f:	48 c7 44 24 08 00 00 	movq   $0x0,0x8(%rsp)
    1136:	00 00 
    1138:	31 c0                	xor    %eax,%eax
    113a:	4c 89 d1             	mov    %r10,%rcx
    113d:	4c 89 ca             	mov    %r9,%rdx
    1140:	bf 01 00 00 00       	mov    $0x1,%edi
    1145:	48 8d 35 dc 0e 00 00 	lea    0xedc(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    114c:	e8 4f ff ff ff       	callq  10a0 <__printf_chk@plt>
    1151:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1156:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    115d:	00 00 
    115f:	75 0c                	jne    116d <main+0xad>
    1161:	31 c0                	xor    %eax,%eax
    1163:	48 83 c4 28          	add    $0x28,%rsp
    1167:	c3                   	retq   
    1168:	45 31 c0             	xor    %r8d,%r8d
    116b:	eb cb                	jmp    1138 <main+0x78>
