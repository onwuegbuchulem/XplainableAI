...
/app/bin_gccgcc10_O2/2022_07_23-Lesson-b:     file format elf64-x86-64
...
0000000000001250 <binString>:
    ...
    1264:	74 2a                	je     1290 <binString+0x40>
    1266:	49 89 c0             	mov    %rax,%r8
    1269:	48 8d 48 08          	lea    0x8(%rax),%rcx
    126d:	0f 1f 00             	nopl   (%rax)
    1270:	89 da                	mov    %ebx,%edx
    1272:	48 83 c0 01          	add    $0x1,%rax
    1276:	01 db                	add    %ebx,%ebx
    1278:	c0 ea 07             	shr    $0x7,%dl
    127b:	83 c2 30             	add    $0x30,%edx
    127e:	88 50 ff             	mov    %dl,-0x1(%rax)
    1281:	48 39 c8             	cmp    %rcx,%rax
    1284:	75 ea                	jne    1270 <binString+0x20>
    1286:	41 c6 40 08 00       	movb   $0x0,0x8(%r8)
    128b:	4c 89 c0             	mov    %r8,%rax
    128e:	5b                   	pop    %rbx
    128f:	c3                   	retq   
    1290:	bf 01 00 00 00       	mov    $0x1,%edi
    1295:	e8 36 fe ff ff       	callq  10d0 <exit@plt>
