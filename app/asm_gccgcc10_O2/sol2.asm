...
/app/bin_gccgcc10_O2/sol2:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c9:	44 8b 54 24 04       	mov    0x4(%rsp),%r10d
    10ce:	bf 03 00 00 00       	mov    $0x3,%edi
    10d3:	45 31 c9             	xor    %r9d,%r9d
    10d6:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10dd:	00 00 00 
    10e0:	44 8d 47 ff          	lea    -0x1(%rdi),%r8d
    10e4:	b9 01 00 00 00       	mov    $0x1,%ecx
    10e9:	31 f6                	xor    %esi,%esi
    10eb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10f0:	44 89 c0             	mov    %r8d,%eax
    10f3:	99                   	cltd   
    10f4:	f7 f9                	idiv   %ecx
    10f6:	83 fa 01             	cmp    $0x1,%edx
    10f9:	83 d6 00             	adc    $0x0,%esi
    10fc:	83 c1 01             	add    $0x1,%ecx
    10ff:	39 f9                	cmp    %edi,%ecx
    1101:	75 ed                	jne    10f0 <main+0x50>
    1103:	83 fe 02             	cmp    $0x2,%esi
    1106:	74 08                	je     1110 <main+0x70>
    1108:	83 c7 01             	add    $0x1,%edi
    110b:	eb d3                	jmp    10e0 <main+0x40>
    110d:	0f 1f 00             	nopl   (%rax)
    1110:	41 83 c1 01          	add    $0x1,%r9d
    1114:	45 39 ca             	cmp    %r9d,%r10d
    1117:	75 ef                	jne    1108 <main+0x68>
    1119:	31 c0                	xor    %eax,%eax
    111b:	44 89 c2             	mov    %r8d,%edx
    111e:	bf 01 00 00 00       	mov    $0x1,%edi
    1123:	48 8d 35 da 0e 00 00 	lea    0xeda(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    112a:	e8 51 ff ff ff       	callq  1080 <__printf_chk@plt>
    112f:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1134:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    113b:	00 00 
    113d:	75 07                	jne    1146 <main+0xa6>
