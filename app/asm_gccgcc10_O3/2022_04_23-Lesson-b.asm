...
/app/bin_gccgcc10_O3/2022_04_23-Lesson-b:     file format elf64-x86-64
...
0000000000001100 <main>:
    ...
    1104:	55                   	push   %rbp
    1105:	48 8d 2d 13 0f 00 00 	lea    0xf13(%rip),%rbp        # 201f <_IO_stdin_used+0x1f>
    110c:	53                   	push   %rbx
    110d:	31 db                	xor    %ebx,%ebx
    110f:	48 83 ec 08          	sub    $0x8,%rsp
    1113:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1118:	89 da                	mov    %ebx,%edx
    111a:	48 89 ee             	mov    %rbp,%rsi
    111d:	bf 01 00 00 00       	mov    $0x1,%edi
    1122:	31 c0                	xor    %eax,%eax
    1124:	e8 a7 ff ff ff       	callq  10d0 <__printf_chk@plt>
    1129:	bf 00 00 00 40       	mov    $0x40000000,%edi
    112e:	e8 8d ff ff ff       	callq  10c0 <malloc@plt>
    1133:	48 89 c7             	mov    %rax,%rdi
    1136:	48 85 c0             	test   %rax,%rax
    1139:	74 25                	je     1160 <main+0x60>
    113b:	e8 60 ff ff ff       	callq  10a0 <free@plt>
    1140:	83 c3 01             	add    $0x1,%ebx
    1143:	48 8d 3d ef 0e 00 00 	lea    0xeef(%rip),%rdi        # 2039 <_IO_stdin_used+0x39>
    114a:	e8 61 ff ff ff       	callq  10b0 <puts@plt>
    114f:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
    1155:	75 c1                	jne    1118 <main+0x18>
    1157:	48 83 c4 08          	add    $0x8,%rsp
    115b:	31 c0                	xor    %eax,%eax
    115d:	5b                   	pop    %rbx
    115e:	5d                   	pop    %rbp
    115f:	c3                   	retq   
    1160:	48 8b 0d b9 2e 00 00 	mov    0x2eb9(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1167:	ba 1a 00 00 00       	mov    $0x1a,%edx
    116c:	be 01 00 00 00       	mov    $0x1,%esi
    1171:	48 8d 3d 8c 0e 00 00 	lea    0xe8c(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1178:	e8 73 ff ff ff       	callq  10f0 <fwrite@plt>
    117d:	bf 01 00 00 00       	mov    $0x1,%edi
    1182:	e8 59 ff ff ff       	callq  10e0 <exit@plt>
...
0000000000001190 <_start>:
    ...
    11b1:	48 8d 3d 48 ff ff ff 	lea    -0xb8(%rip),%rdi        # 1100 <main>
...
0000000000001230 <__do_global_dtors_aux>:
    ...
    1252:	e8 39 fe ff ff       	callq  1090 <__cxa_finalize@plt>
...
0000000000001280 <memory>:
    1280:	f3 0f 1e fa          	endbr64 
    1284:	48 83 ec 08          	sub    $0x8,%rsp
    1288:	bf 00 00 00 40       	mov    $0x40000000,%edi
    128d:	e8 2e fe ff ff       	callq  10c0 <malloc@plt>
    1292:	48 85 c0             	test   %rax,%rax
    1295:	74 0c                	je     12a3 <memory+0x23>
    1297:	48 89 c7             	mov    %rax,%rdi
    129a:	48 83 c4 08          	add    $0x8,%rsp
    129e:	e9 fd fd ff ff       	jmpq   10a0 <free@plt>
    12a3:	48 8b 0d 76 2d 00 00 	mov    0x2d76(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    12aa:	ba 1a 00 00 00       	mov    $0x1a,%edx
    12af:	be 01 00 00 00       	mov    $0x1,%esi
    12b4:	48 8d 3d 49 0d 00 00 	lea    0xd49(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    12bb:	e8 30 fe ff ff       	callq  10f0 <fwrite@plt>
    12c0:	bf 01 00 00 00       	mov    $0x1,%edi
    12c5:	e8 16 fe ff ff       	callq  10e0 <exit@plt>
