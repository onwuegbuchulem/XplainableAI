...
/app/bin_gccgcc10_O0/getdate01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c9:	e8 e2 fe ff ff       	callq  10b0 <time@plt>
    11ce:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    11d2:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    11d6:	48 89 c7             	mov    %rax,%rdi
    11d9:	e8 a2 fe ff ff       	callq  1080 <localtime@plt>
    11de:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11e2:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    11e6:	8b 40 10             	mov    0x10(%rax),%eax
    11e9:	83 c0 01             	add    $0x1,%eax
    11ec:	89 45 d8             	mov    %eax,-0x28(%rbp)
    11ef:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    11f3:	8b 40 0c             	mov    0xc(%rax),%eax
    11f6:	89 45 dc             	mov    %eax,-0x24(%rbp)
    11f9:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    11fd:	8b 40 18             	mov    0x18(%rax),%eax
    1200:	89 45 e0             	mov    %eax,-0x20(%rbp)
    1203:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1207:	8b 40 14             	mov    0x14(%rax),%eax
    120a:	05 6c 07 00 00       	add    $0x76c,%eax
    120f:	89 45 e4             	mov    %eax,-0x1c(%rbp)
    1212:	8b 75 e4             	mov    -0x1c(%rbp),%esi
    1215:	8b 4d dc             	mov    -0x24(%rbp),%ecx
    1218:	8b 55 d8             	mov    -0x28(%rbp),%edx
    121b:	8b 45 e0             	mov    -0x20(%rbp),%eax
    ...
    1244:	00 00 
    1246:	74 05                	je     124d <main+0xa4>
    1248:	e8 43 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    124d:	c9                   	leaveq 
    124e:	c3                   	retq   
    124f:	90                   	nop
