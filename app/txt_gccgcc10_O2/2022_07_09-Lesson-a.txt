...
/app/bin_gccgcc10_O2/2022_07_09-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c4:	48 c7 44 24 08 00 00 	movq   $0x0,0x8(%rsp)
    10cb:	00 00 
    10cd:	48 c7 44 24 10 20 00 	movq   $0x20,0x10(%rsp)
    10d4:	00 00 
    10d6:	e8 a5 ff ff ff       	callq  1080 <__printf_chk@plt>
    10db:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    10e0:	48 8d 7c 24 08       	lea    0x8(%rsp),%rdi
    10e5:	48 8b 15 24 2f 00 00 	mov    0x2f24(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    ...
    1107:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    110c:	31 c0                	xor    %eax,%eax
    110e:	48 8d 35 1b 0f 00 00 	lea    0xf1b(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    1115:	bf 01 00 00 00       	mov    $0x1,%edi
    111a:	e8 61 ff ff ff       	callq  1080 <__printf_chk@plt>
    111f:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1124:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    112b:	00 00 
    112d:	75 07                	jne    1136 <main+0x96>
    112f:	31 c0                	xor    %eax,%eax
    1131:	48 83 c4 28          	add    $0x28,%rsp
    1135:	c3                   	retq   
