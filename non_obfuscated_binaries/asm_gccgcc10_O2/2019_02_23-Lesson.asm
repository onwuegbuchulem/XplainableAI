...
/app/bin_gccgcc10_O2/2019_02_23-Lesson:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10ee:	48 8d 3d 28 0f 00 00 	lea    0xf28(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    ...
    1102:	7e 23                	jle    1127 <main+0x67>
    1104:	48 8d 3d 15 0f 00 00 	lea    0xf15(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    110b:	e8 70 ff ff ff       	callq  1080 <puts@plt>
    1110:	31 c0                	xor    %eax,%eax
    1112:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    1117:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    111e:	00 00 
    1120:	75 18                	jne    113a <main+0x7a>
    1122:	48 83 c4 18          	add    $0x18,%rsp
    1126:	c3                   	retq   
    1127:	48 8d 3d fa 0e 00 00 	lea    0xefa(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    112e:	e8 4d ff ff ff       	callq  1080 <puts@plt>
    1133:	b8 01 00 00 00       	mov    $0x1,%eax
    1138:	eb d8                	jmp    1112 <main+0x52>
