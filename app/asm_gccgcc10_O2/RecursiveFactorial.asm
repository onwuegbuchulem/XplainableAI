...
/app/bin_gccgcc10_O2/RecursiveFactorial:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ce:	48 8d 3d 58 0f 00 00 	lea    0xf58(%rip),%rdi        # 202d <_IO_stdin_used+0x2d>
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	e8 b4 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10dc:	44 8b 44 24 04       	mov    0x4(%rsp),%r8d
    10e1:	b9 01 00 00 00       	mov    $0x1,%ecx
    10e6:	44 89 c0             	mov    %r8d,%eax
    10e9:	41 83 f8 01          	cmp    $0x1,%r8d
    10ed:	74 0e                	je     10fd <main+0x5d>
    10ef:	90                   	nop
    10f0:	89 c2                	mov    %eax,%edx
    10f2:	83 e8 01             	sub    $0x1,%eax
    10f5:	0f af ca             	imul   %edx,%ecx
    10f8:	83 f8 01             	cmp    $0x1,%eax
    10fb:	75 f3                	jne    10f0 <main+0x50>
    10fd:	31 c0                	xor    %eax,%eax
    10ff:	44 89 c2             	mov    %r8d,%edx
    1102:	bf 01 00 00 00       	mov    $0x1,%edi
    1107:	48 8d 35 0f 0f 00 00 	lea    0xf0f(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    110e:	e8 6d ff ff ff       	callq  1080 <__printf_chk@plt>
    1113:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1118:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    111f:	00 00 
    1121:	75 07                	jne    112a <main+0x8a>
    1123:	31 c0                	xor    %eax,%eax
    1125:	48 83 c4 18          	add    $0x18,%rsp
    1129:	c3                   	retq   
    112a:	e8 41 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
    112f:	90                   	nop
...
0000000000001220 <factorial>:
    1220:	f3 0f 1e fa          	endbr64 
    1224:	b8 01 00 00 00       	mov    $0x1,%eax
    1229:	83 ff 01             	cmp    $0x1,%edi
    122c:	74 0f                	je     123d <factorial+0x1d>
    122e:	66 90                	xchg   %ax,%ax
    1230:	89 fa                	mov    %edi,%edx
    1232:	83 ef 01             	sub    $0x1,%edi
    1235:	0f af c2             	imul   %edx,%eax
    1238:	83 ff 01             	cmp    $0x1,%edi
    123b:	75 f3                	jne    1230 <factorial+0x10>
    123d:	c3                   	retq   
