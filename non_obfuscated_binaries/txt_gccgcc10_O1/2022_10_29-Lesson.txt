...
/app/bin_gccgcc10_O1/2022_10_29-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1185:	c7 04 24 fe ff ff ff 	movl   $0xfffffffe,(%rsp)
    118c:	c7 44 24 04 ff ff ff 	movl   $0xffffffff,0x4(%rsp)
    1193:	ff 
    1194:	c7 44 24 08 fe ff ff 	movl   $0xfffffffe,0x8(%rsp)
    119b:	ff 
    119c:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%rsp)
    11a3:	00 
    11a4:	c7 44 24 10 ff ff ff 	movl   $0xffffffff,0x10(%rsp)
    11ab:	ff 
    11ac:	c7 44 24 14 fe ff ff 	movl   $0xfffffffe,0x14(%rsp)
    11b3:	ff 
    11b4:	c7 44 24 18 ff ff ff 	movl   $0xffffffff,0x18(%rsp)
    11bb:	ff 
    11bc:	c7 44 24 1c 02 00 00 	movl   $0x2,0x1c(%rsp)
    11c3:	00 
    11c4:	c7 44 24 20 01 00 00 	movl   $0x1,0x20(%rsp)
    11cb:	00 
    11cc:	c7 44 24 24 fe ff ff 	movl   $0xfffffffe,0x24(%rsp)
    11d3:	ff 
    11d4:	c7 44 24 28 01 00 00 	movl   $0x1,0x28(%rsp)
    11db:	00 
    11dc:	c7 44 24 2c 02 00 00 	movl   $0x2,0x2c(%rsp)
    11e3:	00 
    11e4:	c7 44 24 30 02 00 00 	movl   $0x2,0x30(%rsp)
    11eb:	00 
    11ec:	c7 44 24 34 ff ff ff 	movl   $0xffffffff,0x34(%rsp)
    11f3:	ff 
    11f4:	c7 44 24 38 02 00 00 	movl   $0x2,0x38(%rsp)
    11fb:	00 
    11fc:	c7 44 24 3c 01 00 00 	movl   $0x1,0x3c(%rsp)
    1203:	00 
    1204:	48 89 e3             	mov    %rsp,%rbx
    1207:	4c 8d 64 24 40       	lea    0x40(%rsp),%r12
    120c:	48 8d 2d f1 0d 00 00 	lea    0xdf1(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1213:	8b 4b 04             	mov    0x4(%rbx),%ecx
    1216:	8b 13                	mov    (%rbx),%edx
    1218:	48 89 ee             	mov    %rbp,%rsi
    121b:	bf 01 00 00 00       	mov    $0x1,%edi
    1220:	b8 00 00 00 00       	mov    $0x0,%eax
    1225:	e8 46 fe ff ff       	callq  1070 <__printf_chk@plt>
    122a:	48 83 c3 08          	add    $0x8,%rbx
    122e:	4c 39 e3             	cmp    %r12,%rbx
    1231:	75 e0                	jne    1213 <main+0xaa>
    1233:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    1238:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    123f:	00 00 
    1241:	75 0e                	jne    1251 <main+0xe8>
    1243:	b8 00 00 00 00       	mov    $0x0,%eax
    1248:	48 83 c4 50          	add    $0x50,%rsp
    124c:	5b                   	pop    %rbx
    124d:	5d                   	pop    %rbp
    124e:	41 5c                	pop    %r12
    1250:	c3                   	retq   
    1251:	e8 0a fe ff ff       	callq  1060 <__stack_chk_fail@plt>
