...
/app/bin_gccgcc10_O3/getcwd:     file format elf64-x86-64
...
0000000000001080 <getcwd@plt>:
    ...
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <getcwd@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10a4:	41 54                	push   %r12
    10a6:	48 81 ec 00 10 00 00 	sub    $0x1000,%rsp
    10ad:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    10b2:	48 81 ec 00 10 00 00 	sub    $0x1000,%rsp
    10b9:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    10be:	48 83 ec 10          	sub    $0x10,%rsp
    10c2:	be 00 20 00 00       	mov    $0x2000,%esi
    10c7:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10ce:	00 00 
    10d0:	48 89 84 24 08 20 00 	mov    %rax,0x2008(%rsp)
    10d7:	00 
    10d8:	31 c0                	xor    %eax,%eax
    10da:	49 89 e4             	mov    %rsp,%r12
    10dd:	4c 89 e7             	mov    %r12,%rdi
    10e0:	e8 9b ff ff ff       	callq  1080 <getcwd@plt>
    ...
    10f6:	e8 95 ff ff ff       	callq  1090 <__printf_chk@plt>
    10fb:	48 8b 84 24 08 20 00 	mov    0x2008(%rsp),%rax
    1102:	00 
    1103:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    110a:	00 00 
    110c:	75 0c                	jne    111a <main+0x7a>
    110e:	48 81 c4 10 20 00 00 	add    $0x2010,%rsp
    1115:	31 c0                	xor    %eax,%eax
    1117:	41 5c                	pop    %r12
    1119:	c3                   	retq   
    111a:	e8 51 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
    111f:	90                   	nop
