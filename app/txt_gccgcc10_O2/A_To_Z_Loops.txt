...
/app/bin_gccgcc10_O2/A_To_Z_Loops:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1094:	83 fb 7b             	cmp    $0x7b,%ebx
    1097:	75 e7                	jne    1080 <main+0x20>
    1099:	bb 41 00 00 00       	mov    $0x41,%ebx
    109e:	48 8d 2d 5f 0f 00 00 	lea    0xf5f(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    10a5:	0f 1f 00             	nopl   (%rax)
    10a8:	89 da                	mov    %ebx,%edx
    10aa:	48 89 ee             	mov    %rbp,%rsi
    10ad:	bf 01 00 00 00       	mov    $0x1,%edi
    10b2:	31 c0                	xor    %eax,%eax
    10b4:	e8 97 ff ff ff       	callq  1050 <__printf_chk@plt>
    10b9:	83 c3 01             	add    $0x1,%ebx
    10bc:	83 fb 5b             	cmp    $0x5b,%ebx
    10bf:	75 e7                	jne    10a8 <main+0x48>
