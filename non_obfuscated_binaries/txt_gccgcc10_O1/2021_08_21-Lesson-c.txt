...
/app/bin_gccgcc10_O1/2021_08_21-Lesson-c:     file format elf64-x86-64
...
0000000000001149 <output>:
    1149:	f3 0f 1e fa          	endbr64 
    114d:	53                   	push   %rbx
    114e:	48 89 fb             	mov    %rdi,%rbx
    1151:	0f b6 3f             	movzbl (%rdi),%edi
    1154:	40 84 ff             	test   %dil,%dil
    1157:	74 21                	je     117a <output+0x31>
    1159:	48 83 c3 01          	add    $0x1,%rbx
    115d:	40 0f be ff          	movsbl %dil,%edi
    1161:	48 8b 35 a8 2e 00 00 	mov    0x2ea8(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1168:	e8 e3 fe ff ff       	callq  1050 <putc@plt>
    116d:	48 83 c3 01          	add    $0x1,%rbx
    1171:	0f b6 7b ff          	movzbl -0x1(%rbx),%edi
    1175:	40 84 ff             	test   %dil,%dil
    1178:	75 e3                	jne    115d <output+0x14>
    117a:	48 8b 35 8f 2e 00 00 	mov    0x2e8f(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1181:	bf 0a 00 00 00       	mov    $0xa,%edi
    1186:	e8 c5 fe ff ff       	callq  1050 <putc@plt>
    118b:	5b                   	pop    %rbx
    118c:	c3                   	retq   
...
000000000000118d <main>:
    ...
    119c:	e8 a8 ff ff ff       	callq  1149 <output>
    11a1:	48 8d 3d 6a 0e 00 00 	lea    0xe6a(%rip),%rdi        # 2012 <_IO_stdin_used+0x12>
    11a8:	e8 9c ff ff ff       	callq  1149 <output>
    11ad:	48 8d 3d 74 0e 00 00 	lea    0xe74(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    11b4:	e8 90 ff ff ff       	callq  1149 <output>
