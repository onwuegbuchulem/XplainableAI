...
/app/bin_gccgcc10_O1/2019_06_22-Lesson-a:     file format elf64-x86-64
...
0000000000001070 <strncpy@plt>:
    ...
    1074:	f2 ff 25 45 2f 00 00 	bnd jmpq *0x2f45(%rip)        # 3fc0 <strncpy@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    118d:	53                   	push   %rbx
    118e:	48 83 ec 50          	sub    $0x50,%rsp
    1192:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1199:	00 00 
    119b:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    11a0:	31 c0                	xor    %eax,%eax
    11a2:	48 b8 4d 79 20 74 65 	movabs $0x207478657420794d,%rax
    11a9:	78 74 20 
    11ac:	48 ba 77 69 6c 6c 20 	movabs $0x206562206c6c6977,%rdx
    11b3:	62 65 20 
    11b6:	48 89 04 24          	mov    %rax,(%rsp)
    11ba:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    11bf:	c7 44 24 10 63 6f 70 	movl   $0x69706f63,0x10(%rsp)
    11c6:	69 
    11c7:	66 c7 44 24 14 65 64 	movw   $0x6465,0x14(%rsp)
    11ce:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
    11d3:	48 b8 31 32 33 34 35 	movabs $0x3837363534333231,%rax
    11da:	36 37 38 
    11dd:	48 ba 39 30 31 32 33 	movabs $0x3635343332313039,%rdx
    11e4:	34 35 36 
    11e7:	48 89 44 24 20       	mov    %rax,0x20(%rsp)
    11ec:	48 89 54 24 28       	mov    %rdx,0x28(%rsp)
    11f1:	48 b8 37 38 39 30 31 	movabs $0x3433323130393837,%rax
    11f8:	32 33 34 
    11fb:	48 89 44 24 30       	mov    %rax,0x30(%rsp)
    1200:	c7 44 24 38 35 36 37 	movl   $0x38373635,0x38(%rsp)
    1207:	38 
    1208:	66 c7 44 24 3c 39 30 	movw   $0x3039,0x3c(%rsp)
    120f:	c6 44 24 3e 00       	movb   $0x0,0x3e(%rsp)
    1214:	48 89 e6             	mov    %rsp,%rsi
    1217:	48 8d 5c 24 20       	lea    0x20(%rsp),%rbx
    121c:	ba 07 00 00 00       	mov    $0x7,%edx
    1221:	48 89 df             	mov    %rbx,%rdi
    1224:	e8 47 fe ff ff       	callq  1070 <strncpy@plt>
    1229:	48 89 df             	mov    %rbx,%rdi
    122c:	e8 4f fe ff ff       	callq  1080 <puts@plt>
    1231:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    1236:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    123d:	00 00 
    123f:	75 0b                	jne    124c <main+0xc3>
    1241:	b8 00 00 00 00       	mov    $0x0,%eax
    1246:	48 83 c4 50          	add    $0x50,%rsp
    124a:	5b                   	pop    %rbx
    124b:	c3                   	retq   
    124c:	e8 3f fe ff ff       	callq  1090 <__stack_chk_fail@plt>
