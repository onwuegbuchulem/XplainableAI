...
/app/bin_gccgcc10_O0/2021_07_03-Lesson-b:     file format elf64-x86-64
...
0000000000001120 <__do_global_dtors_aux>:
    ...
    1124:	80 3d f9 2e 00 00 00 	cmpb   $0x0,0x2ef9(%rip)        # 4024 <completed.0>
    ...
    114c:	c6 05 d1 2e 00 00 01 	movb   $0x1,0x2ed1(%rip)        # 4024 <completed.0>
    1153:	5d                   	pop    %rbp
    1154:	c3                   	retq   
...
0000000000001169 <main>:
    ...
    117c:	c7 05 9a 2e 00 00 00 	movl   $0x0,0x2e9a(%rip)        # 4020 <opterr@@GLIBC_2.2.5>
    1183:	00 00 00 
    1186:	48 8b 4d e0          	mov    -0x20(%rbp),%rcx
    118a:	8b 45 ec             	mov    -0x14(%rbp),%eax
    118d:	48 8d 15 74 0e 00 00 	lea    0xe74(%rip),%rdx        # 2008 <_IO_stdin_used+0x8>
    1194:	48 89 ce             	mov    %rcx,%rsi
    1197:	89 c7                	mov    %eax,%edi
    1199:	e8 d2 fe ff ff       	callq  1070 <getopt@plt>
    119e:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11a1:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11a4:	89 c6                	mov    %eax,%esi
    11a6:	48 8d 3d 63 0e 00 00 	lea    0xe63(%rip),%rdi        # 2010 <_IO_stdin_used+0x10>
    11ad:	b8 00 00 00 00       	mov    $0x0,%eax
    11b2:	e8 a9 fe ff ff       	callq  1060 <printf@plt>
