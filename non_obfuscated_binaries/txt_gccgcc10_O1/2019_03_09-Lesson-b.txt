...
/app/bin_gccgcc10_O1/2019_03_09-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a2:	48 b8 4d 79 20 6e 61 	movabs $0x20656d616e20794d,%rax
    11a9:	6d 65 20 
    11ac:	48 89 44 24 12       	mov    %rax,0x12(%rsp)
    11b1:	c7 44 24 1a 69 73 20 	movl   $0x25207369,0x1a(%rsp)
    11b8:	25 
    11b9:	66 c7 44 24 1e 73 00 	movw   $0x73,0x1e(%rsp)
    11c0:	c7 44 24 0d 20 25 73 	movl   $0xa732520,0xd(%rsp)
    11c7:	0a 
    11c8:	c6 44 24 11 00       	movb   $0x0,0x11(%rsp)
    11cd:	48 8d 5c 24 20       	lea    0x20(%rsp),%rbx
    11d2:	4c 8d 4c 24 0d       	lea    0xd(%rsp),%r9
    11d7:	4c 8d 44 24 12       	lea    0x12(%rsp),%r8
    11dc:	48 8d 0d 21 0e 00 00 	lea    0xe21(%rip),%rcx        # 2004 <_IO_stdin_used+0x4>
    11e3:	ba 20 00 00 00       	mov    $0x20,%edx
    11e8:	be 01 00 00 00       	mov    $0x1,%esi
    11ed:	48 89 df             	mov    %rbx,%rdi
    11f0:	b8 00 00 00 00       	mov    $0x0,%eax
    11f5:	e8 96 fe ff ff       	callq  1090 <__sprintf_chk@plt>
    11fa:	48 8d 0d 08 0e 00 00 	lea    0xe08(%rip),%rcx        # 2009 <_IO_stdin_used+0x9>
    1201:	48 8d 15 08 0e 00 00 	lea    0xe08(%rip),%rdx        # 2010 <_IO_stdin_used+0x10>
    1208:	48 89 de             	mov    %rbx,%rsi
    120b:	bf 01 00 00 00       	mov    $0x1,%edi
    1210:	b8 00 00 00 00       	mov    $0x0,%eax
    1215:	e8 66 fe ff ff       	callq  1080 <__printf_chk@plt>
    121a:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    121f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1226:	00 00 
    1228:	75 0b                	jne    1235 <main+0xac>
    122a:	b8 00 00 00 00       	mov    $0x0,%eax
    122f:	48 83 c4 50          	add    $0x50,%rsp
    1233:	5b                   	pop    %rbx
    1234:	c3                   	retq   
    1235:	e8 36 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
