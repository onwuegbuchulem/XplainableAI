...
/app/bin_gccgcc10_O3/2021_01_02-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10be:	66 0f ef c0          	pxor   %xmm0,%xmm0
    10c2:	48 89 ee             	mov    %rbp,%rsi
    10c5:	bf 01 00 00 00       	mov    $0x1,%edi
    10ca:	48 83 c3 04          	add    $0x4,%rbx
    10ce:	b8 01 00 00 00       	mov    $0x1,%eax
    10d3:	f3 0f 5a 43 fc       	cvtss2sd -0x4(%rbx),%xmm0
    10d8:	e8 93 ff ff ff       	callq  1070 <__printf_chk@plt>
    10dd:	4c 39 e3             	cmp    %r12,%rbx
    10e0:	75 dc                	jne    10be <main+0x3e>
    10e2:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10e7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10ee:	00 00 
    10f0:	75 0b                	jne    10fd <main+0x7d>
    10f2:	48 83 c4 20          	add    $0x20,%rsp
    10f6:	31 c0                	xor    %eax,%eax
    10f8:	5b                   	pop    %rbx
    10f9:	5d                   	pop    %rbp
    10fa:	41 5c                	pop    %r12
    10fc:	c3                   	retq   
    10fd:	e8 5e ff ff ff       	callq  1060 <__stack_chk_fail@plt>
