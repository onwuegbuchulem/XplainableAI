...
/app/bin_gccgcc10_O2/yen02:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a8:	66 0f 6f 05 70 0f 00 	movdqa 0xf70(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10af:	00 
    10b0:	31 ff                	xor    %edi,%edi
    10b2:	48 8d 35 4b 0f 00 00 	lea    0xf4b(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10b9:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10c0:	00 00 
    10c2:	48 89 44 24 58       	mov    %rax,0x58(%rsp)
    10c7:	31 c0                	xor    %eax,%eax
    10c9:	c7 44 24 48 00 00 00 	movl   $0x0,0x48(%rsp)
    10d0:	00 
    10d1:	48 b8 30 00 00 00 0a 	movabs $0xa00000030,%rax
    10d8:	00 00 00 
    10db:	0f 11 04 24          	movups %xmm0,(%rsp)
    10df:	66 0f 6f 05 49 0f 00 	movdqa 0xf49(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    10e6:	00 
    10e7:	48 89 44 24 40       	mov    %rax,0x40(%rsp)
    10ec:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10f1:	66 0f 6f 05 47 0f 00 	movdqa 0xf47(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    10f8:	00 
    10f9:	0f 11 44 24 20       	movups %xmm0,0x20(%rsp)
    10fe:	66 0f 6f 05 4a 0f 00 	movdqa 0xf4a(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    1105:	00 
    1106:	0f 11 44 24 30       	movups %xmm0,0x30(%rsp)
    110b:	e8 70 ff ff ff       	callq  1080 <setlocale@plt>
    1110:	31 c0                	xor    %eax,%eax
    1112:	48 89 e2             	mov    %rsp,%rdx
    1115:	bf 01 00 00 00       	mov    $0x1,%edi
    111a:	48 8d 35 ef 0e 00 00 	lea    0xeef(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    1121:	c7 44 24 34 a5 00 00 	movl   $0xa5,0x34(%rsp)
    1128:	00 
    1129:	e8 62 ff ff ff       	callq  1090 <__wprintf_chk@plt>
    112e:	48 8b 44 24 58       	mov    0x58(%rsp),%rax
    1133:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    113a:	00 00 
    113c:	75 07                	jne    1145 <main+0xa5>
    113e:	31 c0                	xor    %eax,%eax
    1140:	48 83 c4 68          	add    $0x68,%rsp
    1144:	c3                   	retq   
    1145:	e8 26 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
