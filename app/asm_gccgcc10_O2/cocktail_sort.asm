...
/app/bin_gccgcc10_O2/cocktail_sort:     file format elf64-x86-64
...
0000000000001270 <_start>:
    ...
    1281:	50                   	push   %rax
    1282:	54                   	push   %rsp
    1283:	4c 8d 05 06 02 00 00 	lea    0x206(%rip),%r8        # 1490 <__libc_csu_fini>
    128a:	48 8d 0d 8f 01 00 00 	lea    0x18f(%rip),%rcx        # 1420 <__libc_csu_init>
...
0000000000001360 <cocktailSort>:
    ...
    1382:	0f 8d 90 00 00 00    	jge    1418 <cocktailSort+0xb8>
    1388:	48 63 c2             	movslq %edx,%rax
    138b:	49 8d 04 80          	lea    (%r8,%rax,4),%rax
    138f:	8b 08                	mov    (%rax),%ecx
    1391:	8b 70 04             	mov    0x4(%rax),%esi
    1394:	83 c2 01             	add    $0x1,%edx
    1397:	39 f1                	cmp    %esi,%ecx
    1399:	7e e5                	jle    1380 <cocktailSort+0x20>
    139b:	89 30                	mov    %esi,(%rax)
    139d:	41 bb 01 00 00 00    	mov    $0x1,%r11d
    13a3:	48 83 c0 04          	add    $0x4,%rax
    13a7:	89 08                	mov    %ecx,(%rax)
    13a9:	39 d7                	cmp    %edx,%edi
    13ab:	7f e2                	jg     138f <cocktailSort+0x2f>
    13ad:	89 fa                	mov    %edi,%edx
    13af:	83 ef 01             	sub    $0x1,%edi
    13b2:	83 ea 02             	sub    $0x2,%edx
    13b5:	44 39 ca             	cmp    %r9d,%edx
    13b8:	7c 63                	jl     141d <cocktailSort+0xbd>
    13ba:	48 63 ca             	movslq %edx,%rcx
    13bd:	44 29 ca             	sub    %r9d,%edx
    13c0:	45 31 db             	xor    %r11d,%r11d
    13c3:	48 c1 e1 02          	shl    $0x2,%rcx
    13c7:	48 c1 e2 02          	shl    $0x2,%rdx
    13cb:	49 8d 74 0a 08       	lea    0x8(%r10,%rcx,1),%rsi
    13d0:	49 8d 04 08          	lea    (%r8,%rcx,1),%rax
    13d4:	48 29 d6             	sub    %rdx,%rsi
    13d7:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    13de:	00 00 
    13e0:	8b 50 04             	mov    0x4(%rax),%edx
    13e3:	8b 08                	mov    (%rax),%ecx
    13e5:	39 ca                	cmp    %ecx,%edx
    13e7:	7d 0b                	jge    13f4 <cocktailSort+0x94>
    13e9:	89 48 04             	mov    %ecx,0x4(%rax)
    13ec:	41 bb 01 00 00 00    	mov    $0x1,%r11d
    13f2:	89 10                	mov    %edx,(%rax)
    13f4:	48 83 e8 04          	sub    $0x4,%rax
    13f8:	48 39 c6             	cmp    %rax,%rsi
    13fb:	75 e3                	jne    13e0 <cocktailSort+0x80>
    13fd:	41 8d 51 01          	lea    0x1(%r9),%edx
    1401:	45 85 db             	test   %r11d,%r11d
    1404:	74 17                	je     141d <cocktailSort+0xbd>
    1406:	45 31 db             	xor    %r11d,%r11d
    1409:	39 fa                	cmp    %edi,%edx
    140b:	7d 10                	jge    141d <cocktailSort+0xbd>
    140d:	41 89 d1             	mov    %edx,%r9d
    1410:	e9 73 ff ff ff       	jmpq   1388 <cocktailSort+0x28>
    1415:	0f 1f 00             	nopl   (%rax)
    1418:	45 85 db             	test   %r11d,%r11d
    141b:	75 90                	jne    13ad <cocktailSort+0x4d>
    141d:	c3                   	retq   
