...
/app/bin_gccgcc10_O1/readdir02:     file format elf64-x86-64
...
0000000000001100 <_start>:
    ...
    1111:	50                   	push   %rax
    1112:	54                   	push   %rsp
    1113:	4c 8d 05 a6 01 00 00 	lea    0x1a6(%rip),%r8        # 12c0 <__libc_csu_fini>
    111a:	48 8d 0d 2f 01 00 00 	lea    0x12f(%rip),%rcx        # 1250 <__libc_csu_init>
...
00000000000011e9 <main>:
    ...
    11f5:	e8 b6 fe ff ff       	callq  10b0 <opendir@plt>
    11fa:	48 85 c0             	test   %rax,%rax
    11fd:	74 34                	je     1233 <main+0x4a>
    11ff:	48 89 c3             	mov    %rax,%rbx
    1202:	48 89 c7             	mov    %rax,%rdi
    1205:	e8 c6 fe ff ff       	callq  10d0 <readdir@plt>
    120a:	48 8d 50 13          	lea    0x13(%rax),%rdx
    ...
    1227:	e8 94 fe ff ff       	callq  10c0 <closedir@plt>
    122c:	b8 00 00 00 00       	mov    $0x0,%eax
    1231:	5b                   	pop    %rbx
    1232:	c3                   	retq   
    1233:	48 8d 3d cc 0d 00 00 	lea    0xdcc(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    123a:	e8 61 fe ff ff       	callq  10a0 <puts@plt>
    123f:	bf 01 00 00 00       	mov    $0x1,%edi
    1244:	e8 a7 fe ff ff       	callq  10f0 <exit@plt>
