...
/app/bin_gccgcc10_O0/2022_05_21-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1195:	e8 d6 fe ff ff       	callq  1070 <getpid@plt>
    119a:	89 45 f4             	mov    %eax,-0xc(%rbp)
    119d:	e8 ee fe ff ff       	callq  1090 <fork@plt>
    11a2:	e8 c9 fe ff ff       	callq  1070 <getpid@plt>
    11a7:	89 45 f8             	mov    %eax,-0x8(%rbp)
    11aa:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11ad:	3b 45 f4             	cmp    -0xc(%rbp),%eax
    11b0:	75 18                	jne    11ca <main+0x41>
    11b2:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11b5:	89 c6                	mov    %eax,%esi
    11b7:	48 8d 3d 46 0e 00 00 	lea    0xe46(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 b8 fe ff ff       	callq  1080 <printf@plt>
    11c8:	eb 43                	jmp    120d <main+0x84>
    11ca:	e8 c1 fe ff ff       	callq  1090 <fork@plt>
    11cf:	e8 9c fe ff ff       	callq  1070 <getpid@plt>
    11d4:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11d7:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11da:	3b 45 fc             	cmp    -0x4(%rbp),%eax
    11dd:	75 18                	jne    11f7 <main+0x6e>
    11df:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11e2:	89 c6                	mov    %eax,%esi
    11e4:	48 8d 3d 2e 0e 00 00 	lea    0xe2e(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    11eb:	b8 00 00 00 00       	mov    $0x0,%eax
    11f0:	e8 8b fe ff ff       	callq  1080 <printf@plt>
    11f5:	eb 16                	jmp    120d <main+0x84>
    11f7:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11fa:	89 c6                	mov    %eax,%esi
    11fc:	48 8d 3d 2a 0e 00 00 	lea    0xe2a(%rip),%rdi        # 202d <_IO_stdin_used+0x2d>
    1203:	b8 00 00 00 00       	mov    $0x0,%eax
    1208:	e8 73 fe ff ff       	callq  1080 <printf@plt>
