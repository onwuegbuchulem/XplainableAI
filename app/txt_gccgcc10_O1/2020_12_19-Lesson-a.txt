...
/app/bin_gccgcc10_O1/2020_12_19-Lesson-a:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	f3 0f 10 05 d7 0e 00 	movss  0xed7(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    1158:	00 
    1159:	b8 02 00 00 00       	mov    $0x2,%eax
    115e:	f2 0f 10 1d d2 0e 00 	movsd  0xed2(%rip),%xmm3        # 2038 <_IO_stdin_used+0x38>
    1165:	00 
    1166:	66 0f ef d2          	pxor   %xmm2,%xmm2
    116a:	f3 0f 2a d0          	cvtsi2ss %eax,%xmm2
    116e:	f3 0f 5a d2          	cvtss2sd %xmm2,%xmm2
    1172:	66 0f 28 cb          	movapd %xmm3,%xmm1
    1176:	f2 0f 5e ca          	divsd  %xmm2,%xmm1
    117a:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    117e:	f2 0f 58 c1          	addsd  %xmm1,%xmm0
    1182:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    1186:	83 c0 01             	add    $0x1,%eax
    1189:	3d e9 03 00 00       	cmp    $0x3e9,%eax
    118e:	75 d6                	jne    1166 <main+0x1d>
    1190:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1194:	48 8d 35 6d 0e 00 00 	lea    0xe6d(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    119b:	bf 01 00 00 00       	mov    $0x1,%edi
    11a0:	b8 01 00 00 00       	mov    $0x1,%eax
    11a5:	e8 a6 fe ff ff       	callq  1050 <__printf_chk@plt>
    11aa:	b8 00 00 00 00       	mov    $0x0,%eax
    11af:	48 83 c4 08          	add    $0x8,%rsp
    11b3:	c3                   	retq   
