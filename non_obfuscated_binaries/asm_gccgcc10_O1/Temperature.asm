...
/app/bin_gccgcc10_O1/Temperature:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b7:	48 8d 3d 92 0e 00 00 	lea    0xe92(%rip),%rdi        # 2050 <_IO_stdin_used+0x50>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	f3 0f 10 05 84 0e 00 	movss  0xe84(%rip),%xmm0        # 2054 <_IO_stdin_used+0x54>
    11cf:	00 
    11d0:	f3 0f 58 44 24 04    	addss  0x4(%rsp),%xmm0
    11d6:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    11da:	48 8d 35 4f 0e 00 00 	lea    0xe4f(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
