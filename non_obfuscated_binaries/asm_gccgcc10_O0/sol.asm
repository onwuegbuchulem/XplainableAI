...
/app/bin_gccgcc10_O0/sol:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1163:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%rbp)
    116a:	eb 13                	jmp    117f <main+0x36>
    116c:	8b 45 f8             	mov    -0x8(%rbp),%eax
    116f:	0f af c0             	imul   %eax,%eax
    1172:	01 45 f0             	add    %eax,-0x10(%rbp)
    1175:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1178:	01 45 f4             	add    %eax,-0xc(%rbp)
    117b:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    117f:	83 7d f8 64          	cmpl   $0x64,-0x8(%rbp)
    1183:	76 e7                	jbe    116c <main+0x23>
    1185:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1188:	0f af c0             	imul   %eax,%eax
    118b:	2b 45 f0             	sub    -0x10(%rbp),%eax
    118e:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1191:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1194:	89 c6                	mov    %eax,%esi
    1196:	48 8d 3d 67 0e 00 00 	lea    0xe67(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
