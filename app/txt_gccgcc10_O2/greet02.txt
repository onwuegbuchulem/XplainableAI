...
/app/bin_gccgcc10_O2/greet02:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	83 ff 01             	cmp    $0x1,%edi
    108b:	7e 1e                	jle    10ab <main+0x2b>
    108d:	48 8b 56 08          	mov    0x8(%rsi),%rdx
    1091:	bf 01 00 00 00       	mov    $0x1,%edi
    1096:	31 c0                	xor    %eax,%eax
    1098:	48 8d 35 80 0f 00 00 	lea    0xf80(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    109f:	e8 cc ff ff ff       	callq  1070 <__printf_chk@plt>
    10a4:	31 c0                	xor    %eax,%eax
    10a6:	48 83 c4 08          	add    $0x8,%rsp
    10aa:	c3                   	retq   
    10ab:	48 8d 3d 52 0f 00 00 	lea    0xf52(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    10b2:	e8 a9 ff ff ff       	callq  1060 <puts@plt>
    10b7:	eb eb                	jmp    10a4 <main+0x24>
