...
/app/bin_gccgcc10_O3/2022_10_22-Lesson-d:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    113c:	48 8b 14 24          	mov    (%rsp),%rdx
    1140:	bf 01 00 00 00       	mov    $0x1,%edi
    1145:	31 c0                	xor    %eax,%eax
    1147:	48 8d 35 b8 0e 00 00 	lea    0xeb8(%rip),%rsi        # 2006 <_IO_stdin_used+0x6>
    114e:	e8 6d ff ff ff       	callq  10c0 <__printf_chk@plt>
    1153:	48 89 ef             	mov    %rbp,%rdi
    1156:	e8 45 ff ff ff       	callq  10a0 <fclose@plt>
    115b:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1160:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1167:	00 00 
    1169:	75 08                	jne    1173 <main+0x93>
    116b:	48 83 c4 20          	add    $0x20,%rsp
    116f:	31 c0                	xor    %eax,%eax
    1171:	5d                   	pop    %rbp
    1172:	c3                   	retq   
    1173:	e8 38 ff ff ff       	callq  10b0 <__stack_chk_fail@plt>
