...
/app/bin_gccgcc10_O2/2020_07-Exercise:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ca:	48 b8 05 00 00 00 03 	movabs $0x300000005,%rax
    10d1:	00 00 00 
    10d4:	c7 44 24 10 02 00 00 	movl   $0x2,0x10(%rsp)
    10db:	00 
    10dc:	49 89 e6             	mov    %rsp,%r14
    10df:	48 89 04 24          	mov    %rax,(%rsp)
    10e3:	48 b8 08 00 00 00 07 	movabs $0x700000008,%rax
    10ea:	00 00 00 
    10ed:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10f2:	89 ea                	mov    %ebp,%edx
    10f4:	4c 89 ee             	mov    %r13,%rsi
    10f7:	bf 01 00 00 00       	mov    $0x1,%edi
    10fc:	31 c0                	xor    %eax,%eax
    10fe:	e8 8d ff ff ff       	callq  1090 <__printf_chk@plt>
    1103:	45 8b 64 ae fc       	mov    -0x4(%r14,%rbp,4),%r12d
    1108:	45 85 e4             	test   %r12d,%r12d
    110b:	7e 1c                	jle    1129 <main+0x89>
    110d:	31 db                	xor    %ebx,%ebx
    110f:	90                   	nop
    1110:	48 8b 35 f9 2e 00 00 	mov    0x2ef9(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1117:	bf 2a 00 00 00       	mov    $0x2a,%edi
    111c:	83 c3 01             	add    $0x1,%ebx
    111f:	e8 5c ff ff ff       	callq  1080 <putc@plt>
    1124:	41 39 dc             	cmp    %ebx,%r12d
    1127:	75 e7                	jne    1110 <main+0x70>
    1129:	44 89 e2             	mov    %r12d,%edx
    112c:	48 8d 35 d6 0e 00 00 	lea    0xed6(%rip),%rsi        # 2009 <_IO_stdin_used+0x9>
    1133:	31 c0                	xor    %eax,%eax
    1135:	48 83 c5 01          	add    $0x1,%rbp
    1139:	bf 01 00 00 00       	mov    $0x1,%edi
    113e:	e8 4d ff ff ff       	callq  1090 <__printf_chk@plt>
    1143:	48 83 fd 06          	cmp    $0x6,%rbp
    1147:	75 a9                	jne    10f2 <main+0x52>
    1149:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    114e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1155:	00 00 
    1157:	75 0f                	jne    1168 <main+0xc8>
    1159:	48 83 c4 20          	add    $0x20,%rsp
