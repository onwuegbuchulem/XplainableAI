...
/app/bin_gccgcc10_O2/Division:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10df:	8b 04 24             	mov    (%rsp),%eax
    10e2:	bf 01 00 00 00       	mov    $0x1,%edi
    10e7:	48 8d 35 31 0f 00 00 	lea    0xf31(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    10ee:	99                   	cltd   
    10ef:	f7 7c 24 04          	idivl  0x4(%rsp)
    10f3:	89 c2                	mov    %eax,%edx
    ...
    1108:	00 00 
    110a:	75 05                	jne    1111 <main+0x71>
    110c:	48 83 c4 18          	add    $0x18,%rsp
    1110:	c3                   	retq   
