...
/app/bin_gccgcc10_O0/2020_03_21-Lesson-a:     file format elf64-x86-64
...
0000000000001100 <feof@plt>:
    1100:	f3 0f 1e fa          	endbr64 
    1104:	f2 ff 25 bd 2e 00 00 	bnd jmpq *0x2ebd(%rip)        # 3fc8 <feof@GLIBC_2.2.5>
...
0000000000001209 <main>:
    ...
    1224:	48 b8 67 65 74 74 79 	movabs $0x7562737974746567,%rax
    122b:	73 62 75 
    122e:	48 89 45 e9          	mov    %rax,-0x17(%rbp)
    1232:	c7 45 f1 72 67 2e 74 	movl   $0x742e6772,-0xf(%rbp)
    1239:	66 c7 45 f5 78 74    	movw   $0x7478,-0xb(%rbp)
    123f:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    1243:	48 8d 45 e9          	lea    -0x17(%rbp),%rax
    1247:	48 8d 35 b6 0d 00 00 	lea    0xdb6(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    124e:	48 89 c7             	mov    %rax,%rdi
    1251:	e8 ba fe ff ff       	callq  1110 <fopen@plt>
    1256:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    125a:	48 83 7d e0 00       	cmpq   $0x0,-0x20(%rbp)
    125f:	75 4f                	jne    12b0 <main+0xa7>
    1261:	48 8b 05 d8 2d 00 00 	mov    0x2dd8(%rip),%rax        # 4040 <stderr@@GLIBC_2.2.5>
    1268:	48 8d 55 e9          	lea    -0x17(%rbp),%rdx
    126c:	48 8d 35 93 0d 00 00 	lea    0xd93(%rip),%rsi        # 2006 <_IO_stdin_used+0x6>
    1273:	48 89 c7             	mov    %rax,%rdi
    1276:	b8 00 00 00 00       	mov    $0x0,%eax
    127b:	e8 70 fe ff ff       	callq  10f0 <fprintf@plt>
    1280:	b8 01 00 00 00       	mov    $0x1,%eax
    1285:	eb 4d                	jmp    12d4 <main+0xcb>
    1287:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    128b:	48 89 c7             	mov    %rax,%rdi
    128e:	e8 3d fe ff ff       	callq  10d0 <fgetc@plt>
    1293:	89 45 dc             	mov    %eax,-0x24(%rbp)
    1296:	83 7d dc ff          	cmpl   $0xffffffff,-0x24(%rbp)
    129a:	74 26                	je     12c2 <main+0xb9>
    129c:	48 8b 15 7d 2d 00 00 	mov    0x2d7d(%rip),%rdx        # 4020 <stdout@@GLIBC_2.2.5>
    12a3:	8b 45 dc             	mov    -0x24(%rbp),%eax
    12a6:	48 89 d6             	mov    %rdx,%rsi
    12a9:	89 c7                	mov    %eax,%edi
    12ab:	e8 30 fe ff ff       	callq  10e0 <fputc@plt>
    12b0:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    12b4:	48 89 c7             	mov    %rax,%rdi
    12b7:	e8 44 fe ff ff       	callq  1100 <feof@plt>
    12bc:	85 c0                	test   %eax,%eax
    12be:	74 c7                	je     1287 <main+0x7e>
    12c0:	eb 01                	jmp    12c3 <main+0xba>
    12c2:	90                   	nop
    12c3:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    12c7:	48 89 c7             	mov    %rax,%rdi
    12ca:	e8 e1 fd ff ff       	callq  10b0 <fclose@plt>
    12cf:	b8 00 00 00 00       	mov    $0x0,%eax
    12d4:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    12d8:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    12df:	00 00 
    12e1:	74 05                	je     12e8 <main+0xdf>
