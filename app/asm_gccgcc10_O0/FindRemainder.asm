...
/app/bin_gccgcc10_O0/FindRemainder:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
    11ab:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    ...
    11be:	e8 cd fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c3:	eb 3e                	jmp    1203 <main+0x7a>
    11c5:	48 8d 55 f0          	lea    -0x10(%rbp),%rdx
    11c9:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    11cd:	48 89 c6             	mov    %rax,%rsi
    11d0:	48 8d 3d 30 0e 00 00 	lea    0xe30(%rip),%rdi        # 2007 <_IO_stdin_used+0x7>
    11d7:	b8 00 00 00 00       	mov    $0x0,%eax
    11dc:	e8 af fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11e1:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11e4:	8b 4d f0             	mov    -0x10(%rbp),%ecx
    11e7:	99                   	cltd   
    11e8:	f7 f9                	idiv   %ecx
    11ea:	89 55 f4             	mov    %edx,-0xc(%rbp)
    11ed:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11f0:	89 c6                	mov    %eax,%esi
    11f2:	48 8d 3d 13 0e 00 00 	lea    0xe13(%rip),%rdi        # 200c <_IO_stdin_used+0xc>
    11f9:	b8 00 00 00 00       	mov    $0x0,%eax
    11fe:	e8 7d fe ff ff       	callq  1080 <printf@plt>
    1203:	8b 45 e8             	mov    -0x18(%rbp),%eax
    1206:	8d 50 ff             	lea    -0x1(%rax),%edx
    1209:	89 55 e8             	mov    %edx,-0x18(%rbp)
    120c:	85 c0                	test   %eax,%eax
    120e:	75 b5                	jne    11c5 <main+0x3c>
    1210:	b8 00 00 00 00       	mov    $0x0,%eax
    1215:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1219:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1220:	00 00 
    1222:	74 05                	je     1229 <main+0xa0>
