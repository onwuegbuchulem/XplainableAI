...
/app/bin_gccgcc10_O0/2019_04_06-Lesson-c:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11c0:	48 8d 3d 6a 0e 00 00 	lea    0xe6a(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    11c7:	b8 00 00 00 00       	mov    $0x0,%eax
    11cc:	e8 bf fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11d1:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11d4:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11d7:	39 c2                	cmp    %eax,%edx
    11d9:	0f 4d c2             	cmovge %edx,%eax
    11dc:	89 c6                	mov    %eax,%esi
    11de:	48 8d 3d 52 0e 00 00 	lea    0xe52(%rip),%rdi        # 2037 <_IO_stdin_used+0x37>
    ...
    11ff:	00 00 
    1201:	74 05                	je     1208 <main+0x7f>
    1203:	e8 68 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1208:	c9                   	leaveq 
    1209:	c3                   	retq   
