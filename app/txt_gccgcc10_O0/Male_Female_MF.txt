...
/app/bin_gccgcc10_O0/Male_Female_MF:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b5:	48 8d 45 f7          	lea    -0x9(%rbp),%rax
    11b9:	48 89 c6             	mov    %rax,%rsi
    11bc:	48 8d 3d 55 0e 00 00 	lea    0xe55(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	e8 c3 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cd:	0f b6 45 f7          	movzbl -0x9(%rbp),%eax
    11d1:	0f be c0             	movsbl %al,%eax
    11d4:	83 f8 6d             	cmp    $0x6d,%eax
    11d7:	74 19                	je     11f2 <main+0x69>
    11d9:	83 f8 6d             	cmp    $0x6d,%eax
    11dc:	7f 3a                	jg     1218 <main+0x8f>
    11de:	83 f8 66             	cmp    $0x66,%eax
    11e1:	74 22                	je     1205 <main+0x7c>
    11e3:	83 f8 66             	cmp    $0x66,%eax
    11e6:	7f 30                	jg     1218 <main+0x8f>
    11e8:	83 f8 46             	cmp    $0x46,%eax
    11eb:	74 18                	je     1205 <main+0x7c>
    11ed:	83 f8 4d             	cmp    $0x4d,%eax
    11f0:	75 26                	jne    1218 <main+0x8f>
    11f2:	48 8d 3d 22 0e 00 00 	lea    0xe22(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    11f9:	b8 00 00 00 00       	mov    $0x0,%eax
    11fe:	e8 7d fe ff ff       	callq  1080 <printf@plt>
    1203:	eb 24                	jmp    1229 <main+0xa0>
    1205:	48 8d 3d 15 0e 00 00 	lea    0xe15(%rip),%rdi        # 2021 <_IO_stdin_used+0x21>
    120c:	b8 00 00 00 00       	mov    $0x0,%eax
    1211:	e8 6a fe ff ff       	callq  1080 <printf@plt>
    1216:	eb 11                	jmp    1229 <main+0xa0>
    1218:	48 8d 3d 0a 0e 00 00 	lea    0xe0a(%rip),%rdi        # 2029 <_IO_stdin_used+0x29>
    121f:	b8 00 00 00 00       	mov    $0x0,%eax
    1224:	e8 57 fe ff ff       	callq  1080 <printf@plt>
    1229:	b8 00 00 00 00       	mov    $0x0,%eax
    122e:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1232:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1239:	00 00 
    123b:	74 05                	je     1242 <main+0xb9>
    123d:	e8 2e fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1242:	c9                   	leaveq 
    1243:	c3                   	retq   
