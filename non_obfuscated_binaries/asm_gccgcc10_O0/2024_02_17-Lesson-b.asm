...
/app/bin_gccgcc10_O0/2024_02_17-Lesson-b:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    1204:	48 b8 6c 61 6e 67 61 	movabs $0x65677561676e616c,%rax
    120b:	75 67 65 
    120e:	48 89 45 ef          	mov    %rax,-0x11(%rbp)
    1212:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    1216:	66 c7 45 ed 43 00    	movw   $0x43,-0x13(%rbp)
    121c:	48 8d 55 ed          	lea    -0x13(%rbp),%rdx
    1220:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    1224:	48 89 c6             	mov    %rax,%rsi
    1227:	48 8d 3d da 0d 00 00 	lea    0xdda(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    122e:	b8 00 00 00 00       	mov    $0x0,%eax
    1233:	e8 a8 fe ff ff       	callq  10e0 <printf@plt>
    1238:	48 8d 4d ed          	lea    -0x13(%rbp),%rcx
    123c:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    1240:	ba 00 00 00 00       	mov    $0x0,%edx
    1245:	48 89 ce             	mov    %rcx,%rsi
    1248:	48 89 c7             	mov    %rax,%rdi
    124b:	e8 70 fe ff ff       	callq  10c0 <setenv@plt>
    1250:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    1254:	48 89 c7             	mov    %rax,%rdi
    1257:	e8 44 fe ff ff       	callq  10a0 <getenv@plt>
    125c:	48 89 c6             	mov    %rax,%rsi
    125f:	48 8d 3d c1 0d 00 00 	lea    0xdc1(%rip),%rdi        # 2027 <_IO_stdin_used+0x27>
    1266:	b8 00 00 00 00       	mov    $0x0,%eax
    126b:	e8 70 fe ff ff       	callq  10e0 <printf@plt>
    1270:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    1274:	48 89 c6             	mov    %rax,%rsi
    1277:	48 8d 3d b7 0d 00 00 	lea    0xdb7(%rip),%rdi        # 2035 <_IO_stdin_used+0x35>
    127e:	b8 00 00 00 00       	mov    $0x0,%eax
    1283:	e8 58 fe ff ff       	callq  10e0 <printf@plt>
    1288:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    128c:	48 89 c7             	mov    %rax,%rdi
    128f:	e8 5c fe ff ff       	callq  10f0 <unsetenv@plt>
    1294:	48 8d 3d aa 0d 00 00 	lea    0xdaa(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    ...
    12b0:	00 00 
    12b2:	74 05                	je     12b9 <main+0xd0>
    12b4:	e8 17 fe ff ff       	callq  10d0 <__stack_chk_fail@plt>
    12b9:	c9                   	leaveq 
    12ba:	c3                   	retq   
