...
/app/bin_gccgcc10_O2/2020_05_30-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	55                   	push   %rbp
    1085:	53                   	push   %rbx
    1086:	48 83 ec 48          	sub    $0x48,%rsp
    108a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1091:	00 00 
    1093:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    1098:	31 c0                	xor    %eax,%eax
    109a:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    109f:	c7 04 24 01 00 00 00 	movl   $0x1,(%rsp)
    10a6:	48 8d 4c 24 28       	lea    0x28(%rsp),%rcx
    10ab:	b8 01 00 00 00       	mov    $0x1,%eax
    10b0:	eb 0a                	jmp    10bc <main+0x3c>
    10b2:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    10b8:	48 83 c2 04          	add    $0x4,%rdx
    10bc:	8d 04 40             	lea    (%rax,%rax,2),%eax
    10bf:	89 02                	mov    %eax,(%rdx)
    10c1:	48 39 ca             	cmp    %rcx,%rdx
    10c4:	75 f2                	jne    10b8 <main+0x38>
    10c6:	31 db                	xor    %ebx,%ebx
    10c8:	41 b8 01 00 00 00    	mov    $0x1,%r8d
    10ce:	48 8d 2d 2f 0f 00 00 	lea    0xf2f(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    10d5:	eb 0d                	jmp    10e4 <main+0x64>
    10d7:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    10de:	00 00 
    10e0:	44 8b 04 9c          	mov    (%rsp,%rbx,4),%r8d
    10e4:	89 d9                	mov    %ebx,%ecx
    10e6:	ba 03 00 00 00       	mov    $0x3,%edx
    10eb:	48 89 ee             	mov    %rbp,%rsi
    10ee:	bf 01 00 00 00       	mov    $0x1,%edi
    10f3:	31 c0                	xor    %eax,%eax
    10f5:	48 83 c3 01          	add    $0x1,%rbx
    10f9:	e8 72 ff ff ff       	callq  1070 <__printf_chk@plt>
    10fe:	48 83 fb 0b          	cmp    $0xb,%rbx
    1102:	75 dc                	jne    10e0 <main+0x60>
    1104:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1109:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1110:	00 00 
    1112:	75 09                	jne    111d <main+0x9d>
    1114:	48 83 c4 48          	add    $0x48,%rsp
    1118:	31 c0                	xor    %eax,%eax
    111a:	5b                   	pop    %rbx
    111b:	5d                   	pop    %rbp
    111c:	c3                   	retq   
    111d:	e8 3e ff ff ff       	callq  1060 <__stack_chk_fail@plt>
