...
/app/bin_gccgcc10_O2/DynamicTwoDArrayUsingOnePointer:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1093:	e8 c8 ff ff ff       	callq  1060 <malloc@plt>
    1098:	31 f6                	xor    %esi,%esi
    109a:	b9 04 00 00 00       	mov    $0x4,%ecx
    109f:	48 89 c5             	mov    %rax,%rbp
    10a2:	89 f0                	mov    %esi,%eax
    10a4:	48 8d 54 b5 00       	lea    0x0(%rbp,%rsi,4),%rdx
    10a9:	83 c0 01             	add    $0x1,%eax
    10ac:	48 83 c2 04          	add    $0x4,%rdx
    10b0:	89 42 fc             	mov    %eax,-0x4(%rdx)
    10b3:	39 c8                	cmp    %ecx,%eax
    10b5:	75 f2                	jne    10a9 <main+0x29>
    10b7:	8d 48 04             	lea    0x4(%rax),%ecx
    10ba:	48 83 c6 04          	add    $0x4,%rsi
    10be:	83 f8 0c             	cmp    $0xc,%eax
    10c1:	75 df                	jne    10a2 <main+0x22>
    10c3:	48 83 c5 10          	add    $0x10,%rbp
    10c7:	45 31 ed             	xor    %r13d,%r13d
    10ca:	4c 8d 25 33 0f 00 00 	lea    0xf33(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    10d1:	48 8d 5d f0          	lea    -0x10(%rbp),%rbx
    10d5:	8b 13                	mov    (%rbx),%edx
    10d7:	4c 89 e6             	mov    %r12,%rsi
    10da:	bf 01 00 00 00       	mov    $0x1,%edi
    10df:	31 c0                	xor    %eax,%eax
    10e1:	48 83 c3 04          	add    $0x4,%rbx
    10e5:	e8 86 ff ff ff       	callq  1070 <__printf_chk@plt>
    10ea:	48 39 eb             	cmp    %rbp,%rbx
    10ed:	75 e6                	jne    10d5 <main+0x55>
    10ef:	49 83 c5 04          	add    $0x4,%r13
    10f3:	48 8d 6b 10          	lea    0x10(%rbx),%rbp
    10f7:	49 83 fd 0c          	cmp    $0xc,%r13
    10fb:	75 d4                	jne    10d1 <main+0x51>
