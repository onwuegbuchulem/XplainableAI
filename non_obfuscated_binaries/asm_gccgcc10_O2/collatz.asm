...
/app/bin_gccgcc10_O2/collatz:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10df:	0f 84 9b 00 00 00    	je     1180 <main+0xc0>
    ...
    1114:	74 39                	je     114f <main+0x8f>
    1116:	48 8d 2d 03 0f 00 00 	lea    0xf03(%rip),%rbp        # 2020 <_IO_stdin_used+0x20>
    111d:	eb 0a                	jmp    1129 <main+0x69>
    111f:	90                   	nop
    1120:	48 d1 eb             	shr    %rbx
    1123:	48 83 fb 01          	cmp    $0x1,%rbx
    1127:	74 26                	je     114f <main+0x8f>
    1129:	31 c0                	xor    %eax,%eax
    112b:	48 89 da             	mov    %rbx,%rdx
    112e:	48 89 ee             	mov    %rbp,%rsi
    1131:	bf 01 00 00 00       	mov    $0x1,%edi
    1136:	49 83 c4 01          	add    $0x1,%r12
    113a:	e8 61 ff ff ff       	callq  10a0 <__printf_chk@plt>
    113f:	f6 c3 01             	test   $0x1,%bl
    1142:	74 dc                	je     1120 <main+0x60>
    1144:	48 8d 5c 5b 01       	lea    0x1(%rbx,%rbx,2),%rbx
    1149:	48 83 fb 01          	cmp    $0x1,%rbx
    114d:	75 da                	jne    1129 <main+0x69>
    114f:	31 c0                	xor    %eax,%eax
    1151:	4c 89 e2             	mov    %r12,%rdx
    1154:	bf 01 00 00 00       	mov    $0x1,%edi
    1159:	48 8d 35 c7 0e 00 00 	lea    0xec7(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    ...
    1171:	00 00 
    1173:	75 24                	jne    1199 <main+0xd9>
    1175:	48 83 c4 10          	add    $0x10,%rsp
    ...
    118b:	e8 00 ff ff ff       	callq  1090 <strtoull@plt>
    1190:	48 89 04 24          	mov    %rax,(%rsp)
    1194:	e9 70 ff ff ff       	jmpq   1109 <main+0x49>
    1199:	e8 e2 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
