...
/app/bin_gccgcc10_O0/byte_values02:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1171:	48 81 ec 20 01 00 00 	sub    $0x120,%rsp
    1178:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    117f:	00 00 
    1181:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1185:	31 c0                	xor    %eax,%eax
    1187:	c7 85 ec fe ff ff 00 	movl   $0x0,-0x114(%rbp)
    118e:	00 00 00 
    1191:	eb 1e                	jmp    11b1 <main+0x48>
    1193:	8b 85 ec fe ff ff    	mov    -0x114(%rbp),%eax
    1199:	89 c2                	mov    %eax,%edx
    119b:	8b 85 ec fe ff ff    	mov    -0x114(%rbp),%eax
    11a1:	48 98                	cltq   
    11a3:	88 94 05 f0 fe ff ff 	mov    %dl,-0x110(%rbp,%rax,1)
    11aa:	83 85 ec fe ff ff 01 	addl   $0x1,-0x114(%rbp)
    11b1:	81 bd ec fe ff ff ff 	cmpl   $0xff,-0x114(%rbp)
    11b8:	00 00 00 
    11bb:	7e d6                	jle    1193 <main+0x2a>
    11bd:	c7 85 ec fe ff ff 00 	movl   $0x0,-0x114(%rbp)
    11c4:	00 00 00 
    11c7:	eb 2d                	jmp    11f6 <main+0x8d>
    11c9:	8b 85 ec fe ff ff    	mov    -0x114(%rbp),%eax
    11cf:	48 98                	cltq   
    11d1:	0f b6 84 05 f0 fe ff 	movzbl -0x110(%rbp,%rax,1),%eax
    11d8:	ff 
    11d9:	0f b6 c0             	movzbl %al,%eax
    11dc:	89 c6                	mov    %eax,%esi
    11de:	48 8d 3d 1f 0e 00 00 	lea    0xe1f(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11e5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ea:	e8 81 fe ff ff       	callq  1070 <printf@plt>
    11ef:	83 85 ec fe ff ff 01 	addl   $0x1,-0x114(%rbp)
    11f6:	81 bd ec fe ff ff ff 	cmpl   $0xff,-0x114(%rbp)
    11fd:	00 00 00 
    1200:	7e c7                	jle    11c9 <main+0x60>
    1202:	b8 00 00 00 00       	mov    $0x0,%eax
    1207:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    120b:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1212:	00 00 
    1214:	74 05                	je     121b <main+0xb2>
