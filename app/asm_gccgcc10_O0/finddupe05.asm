...
/app/bin_gccgcc10_O0/finddupe05:     file format elf64-x86-64
...
0000000000001220 <_start>:
    ...
    1231:	50                   	push   %rax
    1232:	54                   	push   %rsp
    1233:	4c 8d 05 b6 07 00 00 	lea    0x7b6(%rip),%r8        # 19f0 <__libc_csu_fini>
    123a:	48 8d 0d 3f 07 00 00 	lea    0x73f(%rip),%rcx        # 1980 <__libc_csu_init>
...
0000000000001309 <find>:
    ...
    13b0:	e8 4b 06 00 00       	callq  1a00 <__stat>
...
0000000000001609 <main>:
    ...
    18b5:	eb 74                	jmp    192b <main+0x322>
    ...
    18da:	75 3a                	jne    1916 <main+0x30d>
    ...
    190f:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%rax)
    1916:	48 8b 85 e0 ef ff ff 	mov    -0x1020(%rbp),%rax
    191d:	48 8b 80 08 30 00 00 	mov    0x3008(%rax),%rax
    1924:	48 89 85 e0 ef ff ff 	mov    %rax,-0x1020(%rbp)
    192b:	48 83 bd e0 ef ff ff 	cmpq   $0x0,-0x1020(%rbp)
    1932:	00 
    1933:	75 82                	jne    18b7 <main+0x2ae>
    1935:	48 8b 85 d8 ef ff ff 	mov    -0x1028(%rbp),%rax
    193c:	48 8b 80 08 30 00 00 	mov    0x3008(%rax),%rax
    1943:	48 89 85 d8 ef ff ff 	mov    %rax,-0x1028(%rbp)
    194a:	48 83 bd d8 ef ff ff 	cmpq   $0x0,-0x1028(%rbp)
    1951:	00 
    1952:	0f 85 d0 fe ff ff    	jne    1828 <main+0x21f>
    1958:	b8 00 00 00 00       	mov    $0x0,%eax
    195d:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1961:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1968:	00 00 
    196a:	74 05                	je     1971 <main+0x368>
    196c:	e8 ff f7 ff ff       	callq  1170 <__stack_chk_fail@plt>
    1971:	c9                   	leaveq 
    1972:	c3                   	retq   
    1973:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    197a:	00 00 00 
...
0000000000001980 <__libc_csu_init>:
    ...
    1984:	41 57                	push   %r15
    1986:	4c 8d 3d bb 23 00 00 	lea    0x23bb(%rip),%r15        # 3d48 <__frame_dummy_init_array_entry>
    198d:	41 56                	push   %r14
    ...
    199c:	55                   	push   %rbp
    199d:	48 8d 2d ac 23 00 00 	lea    0x23ac(%rip),%rbp        # 3d50 <__do_global_dtors_aux_fini_array_entry>
    19a4:	53                   	push   %rbx
...
0000000000001a00 <__stat>:
    1a00:	f3 0f 1e fa          	endbr64 
    1a04:	48 89 f2             	mov    %rsi,%rdx
    1a07:	48 89 fe             	mov    %rdi,%rsi
    1a0a:	bf 01 00 00 00       	mov    $0x1,%edi
    1a0f:	e9 bc f7 ff ff       	jmpq   11d0 <__xstat@plt>

Disassembly of section .fini:

0000000000001a14 <_fini>:
    1a14:	f3 0f 1e fa          	endbr64 
    1a18:	48 83 ec 08          	sub    $0x8,%rsp
    1a1c:	48 83 c4 08          	add    $0x8,%rsp
    1a20:	c3                   	retq   
