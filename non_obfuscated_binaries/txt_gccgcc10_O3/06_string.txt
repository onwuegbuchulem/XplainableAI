...
/app/bin_gccgcc10_O3/06_string:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	b9 74 65 00 00       	mov    $0x6574,%ecx
    ...
    10af:	65 2e 74 
    10b2:	48 8d 54 24 10       	lea    0x10(%rsp),%rdx
    10b7:	48 8d 35 4a 0f 00 00 	lea    0xf4a(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    10be:	c6 44 24 0f 00       	movb   $0x0,0xf(%rsp)
    10c3:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10c8:	66 89 4c 24 14       	mov    %cx,0x14(%rsp)
    10cd:	48 8d 4c 24 05       	lea    0x5(%rsp),%rcx
    10d2:	c7 44 24 10 75 70 64 	movl   $0x61647075,0x10(%rsp)
    10d9:	61 
    10da:	48 89 44 24 05       	mov    %rax,0x5(%rsp)
    10df:	b8 78 74 00 00       	mov    $0x7478,%eax
    10e4:	66 89 44 24 0d       	mov    %ax,0xd(%rsp)
    10e9:	31 c0                	xor    %eax,%eax
    10eb:	e8 80 ff ff ff       	callq  1070 <__printf_chk@plt>
    10f0:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    10f5:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10fc:	00 00 
    10fe:	75 07                	jne    1107 <main+0x87>
    1100:	31 c0                	xor    %eax,%eax
    1102:	48 83 c4 38          	add    $0x38,%rsp
    1106:	c3                   	retq   
    1107:	e8 54 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
