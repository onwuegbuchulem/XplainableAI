...
/app/bin_gccgcc10_O1/StringLength:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d e6 00 00 00 	lea    0xe6(%rip),%rdi        # 11ae <main>
...
0000000000001189 <stringLength>:
    1189:	f3 0f 1e fa          	endbr64 
    118d:	80 3f 00             	cmpb   $0x0,(%rdi)
    1190:	74 15                	je     11a7 <stringLength+0x1e>
    1192:	b8 01 00 00 00       	mov    $0x1,%eax
    1197:	89 c2                	mov    %eax,%edx
    1199:	48 83 c0 01          	add    $0x1,%rax
    119d:	80 7c 07 ff 00       	cmpb   $0x0,-0x1(%rdi,%rax,1)
    11a2:	75 f3                	jne    1197 <stringLength+0xe>
    11a4:	89 d0                	mov    %edx,%eax
    11a6:	c3                   	retq   
    11a7:	ba 00 00 00 00       	mov    $0x0,%edx
    11ac:	eb f6                	jmp    11a4 <stringLength+0x1b>

00000000000011ae <main>:
    11ae:	f3 0f 1e fa          	endbr64 
    11b2:	53                   	push   %rbx
    11b3:	48 83 ec 70          	sub    $0x70,%rsp
    11b7:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11be:	00 00 
    11c0:	48 89 44 24 68       	mov    %rax,0x68(%rsp)
    11c5:	31 c0                	xor    %eax,%eax
    11c7:	48 8d 35 3a 0e 00 00 	lea    0xe3a(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    11ce:	bf 01 00 00 00       	mov    $0x1,%edi
    11d3:	e8 a8 fe ff ff       	callq  1080 <__printf_chk@plt>
    11d8:	48 89 e3             	mov    %rsp,%rbx
    11db:	48 89 de             	mov    %rbx,%rsi
    11de:	48 8d 3d 5e 0e 00 00 	lea    0xe5e(%rip),%rdi        # 2043 <_IO_stdin_used+0x43>
    11e5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ea:	e8 a1 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11ef:	48 89 df             	mov    %rbx,%rdi
    11f2:	e8 92 ff ff ff       	callq  1189 <stringLength>
    11f7:	89 c1                	mov    %eax,%ecx
    11f9:	48 89 da             	mov    %rbx,%rdx
    11fc:	48 8d 35 43 0e 00 00 	lea    0xe43(%rip),%rsi        # 2046 <_IO_stdin_used+0x46>
    1203:	bf 01 00 00 00       	mov    $0x1,%edi
    1208:	b8 00 00 00 00       	mov    $0x0,%eax
    120d:	e8 6e fe ff ff       	callq  1080 <__printf_chk@plt>
    1212:	48 8b 44 24 68       	mov    0x68(%rsp),%rax
    1217:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    121e:	00 00 
    1220:	75 0b                	jne    122d <main+0x7f>
    1222:	b8 00 00 00 00       	mov    $0x0,%eax
    1227:	48 83 c4 70          	add    $0x70,%rsp
    122b:	5b                   	pop    %rbx
    122c:	c3                   	retq   
