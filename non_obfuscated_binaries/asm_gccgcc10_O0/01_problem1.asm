...
/app/bin_gccgcc10_O0/01_problem1:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11e8:	48 8d 3d 29 0e 00 00 	lea    0xe29(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    11ef:	e8 8c fe ff ff       	callq  1080 <puts@plt>
    11f4:	48 8d 45 f4          	lea    -0xc(%rbp),%rax
    11f8:	48 89 c6             	mov    %rax,%rsi
    11fb:	48 8d 3d 13 0e 00 00 	lea    0xe13(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    1202:	b8 00 00 00 00       	mov    $0x0,%eax
    1207:	e8 a4 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    120c:	8b 55 f0             	mov    -0x10(%rbp),%edx
    120f:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1212:	0f af c2             	imul   %edx,%eax
    1215:	89 c6                	mov    %eax,%esi
    1217:	48 8d 3d 0a 0e 00 00 	lea    0xe0a(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    ...
    1238:	00 00 
    123a:	74 05                	je     1241 <main+0x98>
    123c:	e8 4f fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    1241:	c9                   	leaveq 
    1242:	c3                   	retq   
