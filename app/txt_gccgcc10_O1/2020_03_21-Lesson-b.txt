...
/app/bin_gccgcc10_O1/2020_03_21-Lesson-b:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11e2:	48 b8 67 65 74 74 79 	movabs $0x7562737974746567,%rax
    11e9:	73 62 75 
    11ec:	48 89 44 24 09       	mov    %rax,0x9(%rsp)
    11f1:	c7 44 24 11 72 67 2e 	movl   $0x742e6772,0x11(%rsp)
    11f8:	74 
    11f9:	66 c7 44 24 15 78 74 	movw   $0x7478,0x15(%rsp)
    1200:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    1205:	48 8d 7c 24 09       	lea    0x9(%rsp),%rdi
    120a:	be 00 00 00 00       	mov    $0x0,%esi
    120f:	b8 00 00 00 00       	mov    $0x0,%eax
    1214:	e8 a7 fe ff ff       	callq  10c0 <open@plt>
    1219:	83 f8 ff             	cmp    $0xffffffff,%eax
    121c:	74 3f                	je     125d <main+0x94>
    121e:	89 c3                	mov    %eax,%ebx
    1220:	48 8d 54 24 09       	lea    0x9(%rsp),%rdx
    1225:	48 8d 35 ec 0d 00 00 	lea    0xdec(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    122c:	bf 01 00 00 00       	mov    $0x1,%edi
    1231:	b8 00 00 00 00       	mov    $0x0,%eax
    1236:	e8 75 fe ff ff       	callq  10b0 <__printf_chk@plt>
    123b:	89 df                	mov    %ebx,%edi
    123d:	e8 5e fe ff ff       	callq  10a0 <close@plt>
    1242:	b8 00 00 00 00       	mov    $0x0,%eax
    1247:	48 8b 4c 24 18       	mov    0x18(%rsp),%rcx
    124c:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1253:	00 00 
    1255:	75 2f                	jne    1286 <main+0xbd>
    1257:	48 83 c4 20          	add    $0x20,%rsp
    125b:	5b                   	pop    %rbx
    125c:	c3                   	retq   
    125d:	48 8d 4c 24 09       	lea    0x9(%rsp),%rcx
    ...
    127a:	e8 51 fe ff ff       	callq  10d0 <__fprintf_chk@plt>
    127f:	b8 01 00 00 00       	mov    $0x1,%eax
    1284:	eb c1                	jmp    1247 <main+0x7e>
    1286:	e8 05 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
