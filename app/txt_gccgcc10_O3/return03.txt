...
/app/bin_gccgcc10_O3/return03:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    10ea:	e8 c1 ff ff ff       	callq  10b0 <time@plt>
    10ef:	48 89 c7             	mov    %rax,%rdi
    10f2:	e8 a9 ff ff ff       	callq  10a0 <srand@plt>
    10f7:	e8 d4 ff ff ff       	callq  10d0 <rand@plt>
    10fc:	a8 01                	test   $0x1,%al
    10fe:	74 27                	je     1127 <main+0x47>
    1100:	48 8b 0d 19 2f 00 00 	mov    0x2f19(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1107:	ba 1f 00 00 00       	mov    $0x1f,%edx
    110c:	be 01 00 00 00       	mov    $0x1,%esi
    1111:	48 8d 3d f0 0e 00 00 	lea    0xef0(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    1118:	e8 a3 ff ff ff       	callq  10c0 <fwrite@plt>
    111d:	b8 01 00 00 00       	mov    $0x1,%eax
    1122:	48 83 c4 08          	add    $0x8,%rsp
    1126:	c3                   	retq   
    1127:	48 8d 3d fa 0e 00 00 	lea    0xefa(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    112e:	e8 5d ff ff ff       	callq  1090 <puts@plt>
    1133:	31 c0                	xor    %eax,%eax
    1135:	eb eb                	jmp    1122 <main+0x42>
