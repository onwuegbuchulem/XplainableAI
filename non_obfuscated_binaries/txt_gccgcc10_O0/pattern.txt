...
/app/bin_gccgcc10_O0/pattern:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11cb:	e8 c0 fe ff ff       	callq  1090 <puts@plt>
    11d0:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    11d4:	48 89 c6             	mov    %rax,%rsi
    11d7:	48 8d 3d 67 0e 00 00 	lea    0xe67(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 c8 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e8:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11eb:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11ee:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%rbp)
    11f5:	eb 52                	jmp    1249 <main+0xa0>
    11f7:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%rbp)
    11fe:	eb 0e                	jmp    120e <main+0x65>
    1200:	bf 20 00 00 00       	mov    $0x20,%edi
    1205:	e8 76 fe ff ff       	callq  1080 <putchar@plt>
    120a:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    120e:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1211:	3b 45 f4             	cmp    -0xc(%rbp),%eax
    1214:	7c ea                	jl     1200 <main+0x57>
    1216:	83 6d f4 01          	subl   $0x1,-0xc(%rbp)
    121a:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%rbp)
    1221:	eb 0e                	jmp    1231 <main+0x88>
    1223:	bf 2a 00 00 00       	mov    $0x2a,%edi
    1228:	e8 53 fe ff ff       	callq  1080 <putchar@plt>
    122d:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    1231:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1234:	01 c0                	add    %eax,%eax
    1236:	39 45 f0             	cmp    %eax,-0x10(%rbp)
    1239:	7c e8                	jl     1223 <main+0x7a>
    123b:	bf 0a 00 00 00       	mov    $0xa,%edi
    1240:	e8 3b fe ff ff       	callq  1080 <putchar@plt>
    1245:	83 45 ec 01          	addl   $0x1,-0x14(%rbp)
    1249:	8b 45 e8             	mov    -0x18(%rbp),%eax
    124c:	39 45 ec             	cmp    %eax,-0x14(%rbp)
    124f:	7e a6                	jle    11f7 <main+0x4e>
    ...
    1265:	e8 36 fe ff ff       	callq  10a0 <__stack_chk_fail@plt>
    126a:	c9                   	leaveq 
    126b:	c3                   	retq   
