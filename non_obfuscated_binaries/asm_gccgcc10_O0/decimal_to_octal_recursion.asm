...
/app/bin_gccgcc10_O0/decimal_to_octal_recursion:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d 22 01 00 00 	lea    0x122(%rip),%rdi        # 11ea <main>
...
0000000000001189 <decimal_to_octal>:
    ...
    1198:	83 7d fc 07          	cmpl   $0x7,-0x4(%rbp)
    119c:	7f 0b                	jg     11a9 <decimal_to_octal+0x20>
    119e:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    11a2:	7e 05                	jle    11a9 <decimal_to_octal+0x20>
    11a4:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11a7:	eb 3f                	jmp    11e8 <decimal_to_octal+0x5f>
    11a9:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    11ad:	75 07                	jne    11b6 <decimal_to_octal+0x2d>
    11af:	b8 00 00 00 00       	mov    $0x0,%eax
    11b4:	eb 32                	jmp    11e8 <decimal_to_octal+0x5f>
    11b6:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11b9:	8d 50 07             	lea    0x7(%rax),%edx
    11bc:	85 c0                	test   %eax,%eax
    11be:	0f 48 c2             	cmovs  %edx,%eax
    11c1:	c1 f8 03             	sar    $0x3,%eax
    11c4:	89 c7                	mov    %eax,%edi
    11c6:	e8 be ff ff ff       	callq  1189 <decimal_to_octal>
    11cb:	89 c2                	mov    %eax,%edx
    11cd:	89 d0                	mov    %edx,%eax
    11cf:	c1 e0 02             	shl    $0x2,%eax
    11d2:	01 d0                	add    %edx,%eax
    11d4:	01 c0                	add    %eax,%eax
    11d6:	89 c1                	mov    %eax,%ecx
    11d8:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11db:	99                   	cltd   
    11dc:	c1 ea 1d             	shr    $0x1d,%edx
    11df:	01 d0                	add    %edx,%eax
    11e1:	83 e0 07             	and    $0x7,%eax
    11e4:	29 d0                	sub    %edx,%eax
...
00000000000011ea <main>:
    ...
    121d:	48 8d 3d fe 0d 00 00 	lea    0xdfe(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    1224:	b8 00 00 00 00       	mov    $0x0,%eax
    1229:	e8 62 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    122e:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1231:	89 c7                	mov    %eax,%edi
    1233:	e8 51 ff ff ff       	callq  1189 <decimal_to_octal>
    1238:	89 45 f4             	mov    %eax,-0xc(%rbp)
    123b:	8b 45 f0             	mov    -0x10(%rbp),%eax
    123e:	8b 55 f4             	mov    -0xc(%rbp),%edx
    1241:	89 c6                	mov    %eax,%esi
    1243:	48 8d 3d db 0d 00 00 	lea    0xddb(%rip),%rdi        # 2025 <_IO_stdin_used+0x25>
    124a:	b8 00 00 00 00       	mov    $0x0,%eax
    124f:	e8 2c fe ff ff       	callq  1080 <printf@plt>
    1254:	b8 00 00 00 00       	mov    $0x0,%eax
    1259:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    125d:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1264:	00 00 
    1266:	74 05                	je     126d <main+0x83>
    1268:	e8 03 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    126d:	c9                   	leaveq 
    126e:	c3                   	retq   
    126f:	90                   	nop
