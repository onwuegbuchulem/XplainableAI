...
/app/bin_gccgcc10_O1/2021_10_02-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a2:	48 b8 48 65 6c 6c 6f 	movabs $0x6874206f6c6c6548,%rax
    11a9:	20 74 68 
    11ac:	48 ba 65 72 65 2c 20 	movabs $0x6e6168202c657265,%rdx
    11b3:	68 61 6e 
    11b6:	48 89 04 24          	mov    %rax,(%rsp)
    11ba:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    11bf:	48 b8 64 73 6f 6d 65 	movabs $0x656420656d6f7364,%rax
    11c6:	20 64 65 
    11c9:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11ce:	c7 44 24 18 76 69 6c 	movl   $0x216c6976,0x18(%rsp)
    11d5:	21 
    11d6:	c6 44 24 1c 00       	movb   $0x0,0x1c(%rsp)
    11db:	48 89 e3             	mov    %rsp,%rbx
    11de:	48 89 da             	mov    %rbx,%rdx
    11e1:	48 8d 35 1c 0e 00 00 	lea    0xe1c(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    ...
    11fa:	e8 91 fe ff ff       	callq  1090 <strfry@plt>
    11ff:	48 89 c2             	mov    %rax,%rdx
    1202:	48 8d 35 07 0e 00 00 	lea    0xe07(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    1209:	bf 01 00 00 00       	mov    $0x1,%edi
    120e:	b8 00 00 00 00       	mov    $0x0,%eax
    1213:	e8 68 fe ff ff       	callq  1080 <__printf_chk@plt>
    1218:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    121d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1224:	00 00 
    1226:	75 0b                	jne    1233 <main+0xaa>
    1228:	b8 00 00 00 00       	mov    $0x0,%eax
    122d:	48 83 c4 30          	add    $0x30,%rsp
    1231:	5b                   	pop    %rbx
    1232:	c3                   	retq   
    1233:	e8 38 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
