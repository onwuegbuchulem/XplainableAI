...
/app/bin_gccgcc10_O3/ttt04:     file format elf64-x86-64
...
0000000000001510 <winner>:
    ...
    1518:	8b 17                	mov    (%rdi),%edx
    151a:	8b 77 0c             	mov    0xc(%rdi),%esi
    151d:	8b 47 10             	mov    0x10(%rdi),%eax
    1520:	8b 4f 04             	mov    0x4(%rdi),%ecx
    1523:	44 8d 0c 32          	lea    (%rdx,%rsi,1),%r9d
    1527:	44 03 4f 18          	add    0x18(%rdi),%r9d
    152b:	44 8b 5f 08          	mov    0x8(%rdi),%r11d
    152f:	44 8d 14 01          	lea    (%rcx,%rax,1),%r10d
    1533:	01 c6                	add    %eax,%esi
    1535:	01 d1                	add    %edx,%ecx
    1537:	44 8b 47 18          	mov    0x18(%rdi),%r8d
    153b:	01 c2                	add    %eax,%edx
    153d:	44 03 5f 14          	add    0x14(%rdi),%r11d
    1541:	44 03 47 1c          	add    0x1c(%rdi),%r8d
    1545:	03 47 08             	add    0x8(%rdi),%eax
    1548:	44 03 57 1c          	add    0x1c(%rdi),%r10d
    154c:	44 03 5f 20          	add    0x20(%rdi),%r11d
    1550:	03 4f 08             	add    0x8(%rdi),%ecx
    1553:	03 77 14             	add    0x14(%rdi),%esi
    1556:	44 03 47 20          	add    0x20(%rdi),%r8d
    155a:	03 57 20             	add    0x20(%rdi),%edx
    155d:	03 47 18             	add    0x18(%rdi),%eax
    1560:	41 83 f9 fd          	cmp    $0xfffffffd,%r9d
    1564:	74 6a                	je     15d0 <winner+0xc0>
    1566:	41 83 f9 03          	cmp    $0x3,%r9d
    156a:	0f 84 80 00 00 00    	je     15f0 <winner+0xe0>
    1570:	41 83 fa fd          	cmp    $0xfffffffd,%r10d
    1574:	74 5a                	je     15d0 <winner+0xc0>
    1576:	41 83 fa 03          	cmp    $0x3,%r10d
    157a:	74 74                	je     15f0 <winner+0xe0>
    157c:	41 83 fb fd          	cmp    $0xfffffffd,%r11d
    1580:	74 4e                	je     15d0 <winner+0xc0>
    1582:	41 83 fb 03          	cmp    $0x3,%r11d
    1586:	74 68                	je     15f0 <winner+0xe0>
    1588:	83 f9 fd             	cmp    $0xfffffffd,%ecx
    158b:	74 43                	je     15d0 <winner+0xc0>
    158d:	83 f9 03             	cmp    $0x3,%ecx
    1590:	74 5e                	je     15f0 <winner+0xe0>
    1592:	83 fe fd             	cmp    $0xfffffffd,%esi
    1595:	74 39                	je     15d0 <winner+0xc0>
    1597:	83 fe 03             	cmp    $0x3,%esi
    159a:	74 54                	je     15f0 <winner+0xe0>
    159c:	41 83 f8 fd          	cmp    $0xfffffffd,%r8d
    15a0:	74 2e                	je     15d0 <winner+0xc0>
    15a2:	41 83 f8 03          	cmp    $0x3,%r8d
    15a6:	74 48                	je     15f0 <winner+0xe0>
    15a8:	83 fa fd             	cmp    $0xfffffffd,%edx
    15ab:	74 23                	je     15d0 <winner+0xc0>
    15ad:	83 fa 03             	cmp    $0x3,%edx
    15b0:	74 3e                	je     15f0 <winner+0xe0>
    15b2:	83 f8 fd             	cmp    $0xfffffffd,%eax
    15b5:	74 19                	je     15d0 <winner+0xc0>
    15b7:	45 31 c0             	xor    %r8d,%r8d
    15ba:	83 f8 03             	cmp    $0x3,%eax
    15bd:	74 31                	je     15f0 <winner+0xe0>
    15bf:	44 89 c0             	mov    %r8d,%eax
    ...
    15e1:	41 b8 01 00 00 00    	mov    $0x1,%r8d
    15e7:	48 83 c4 08          	add    $0x8,%rsp
    15eb:	44 89 c0             	mov    %r8d,%eax
    15ee:	c3                   	retq   
    15ef:	90                   	nop
    ...
    1601:	41 b8 01 00 00 00    	mov    $0x1,%r8d
    1607:	48 83 c4 08          	add    $0x8,%rsp
    160b:	44 89 c0             	mov    %r8d,%eax
    160e:	c3                   	retq   
    160f:	90                   	nop
