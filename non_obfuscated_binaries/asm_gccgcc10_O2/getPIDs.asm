...
/app/bin_gccgcc10_O2/getPIDs:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c4:	41 55                	push   %r13
    10c6:	bf 05 00 00 00       	mov    $0x5,%edi
    10cb:	41 54                	push   %r12
    10cd:	48 83 ec 08          	sub    $0x8,%rsp
    10d1:	e8 da ff ff ff       	callq  10b0 <sleep@plt>
    10d6:	e8 a5 ff ff ff       	callq  1080 <getpid@plt>
    10db:	41 89 c5             	mov    %eax,%r13d
    10de:	e8 bd ff ff ff       	callq  10a0 <getppid@plt>
    10e3:	44 89 ea             	mov    %r13d,%edx
    10e6:	bf 01 00 00 00       	mov    $0x1,%edi
    10eb:	48 8d 35 12 0f 00 00 	lea    0xf12(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10f2:	41 89 c4             	mov    %eax,%r12d
    10f5:	31 c0                	xor    %eax,%eax
    10f7:	e8 94 ff ff ff       	callq  1090 <__printf_chk@plt>
    10fc:	48 83 c4 08          	add    $0x8,%rsp
    1100:	44 89 e2             	mov    %r12d,%edx
    1103:	31 c0                	xor    %eax,%eax
    1105:	41 5c                	pop    %r12
    1107:	48 8d 35 12 0f 00 00 	lea    0xf12(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    110e:	bf 01 00 00 00       	mov    $0x1,%edi
    1113:	41 5d                	pop    %r13
    1115:	e9 76 ff ff ff       	jmpq   1090 <__printf_chk@plt>
