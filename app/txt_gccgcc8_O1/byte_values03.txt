...
/app/bin_gccgcc8_O1/byte_values03:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	55                   	push   %rbp
    118e:	53                   	push   %rbx
    118f:	48 81 ec 18 01 00 00 	sub    $0x118,%rsp
    1196:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    119d:	00 00 
    119f:	48 89 84 24 08 01 00 	mov    %rax,0x108(%rsp)
    11a6:	00 
    11a7:	31 c0                	xor    %eax,%eax
    11a9:	88 04 04             	mov    %al,(%rsp,%rax,1)
    11ac:	48 83 c0 01          	add    $0x1,%rax
    11b0:	48 3d 00 01 00 00    	cmp    $0x100,%rax
    11b6:	75 f1                	jne    11a9 <main+0x20>
    11b8:	0f b6 14 24          	movzbl (%rsp),%edx
    11bc:	48 8d 35 41 0e 00 00 	lea    0xe41(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11c3:	bf 01 00 00 00       	mov    $0x1,%edi
    11c8:	b8 00 00 00 00       	mov    $0x0,%eax
    11cd:	e8 be fe ff ff       	callq  1090 <__printf_chk@plt>
    11d2:	bb 02 00 00 00       	mov    $0x2,%ebx
    11d7:	48 8d 6c 24 ff       	lea    -0x1(%rsp),%rbp
    11dc:	eb 0d                	jmp    11eb <main+0x62>
    11de:	48 83 c3 01          	add    $0x1,%rbx
    11e2:	48 81 fb 01 01 00 00 	cmp    $0x101,%rbx
    11e9:	74 33                	je     121e <main+0x95>
    11eb:	0f b6 54 1d 00       	movzbl 0x0(%rbp,%rbx,1),%edx
    11f0:	48 8d 35 0d 0e 00 00 	lea    0xe0d(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11f7:	bf 01 00 00 00       	mov    $0x1,%edi
    11fc:	b8 00 00 00 00       	mov    $0x0,%eax
    1201:	e8 8a fe ff ff       	callq  1090 <__printf_chk@plt>
    1206:	f6 c3 0f             	test   $0xf,%bl
    1209:	75 d3                	jne    11de <main+0x55>
    120b:	48 8b 35 fe 2d 00 00 	mov    0x2dfe(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1212:	bf 0a 00 00 00       	mov    $0xa,%edi
    1217:	e8 64 fe ff ff       	callq  1080 <putc@plt>
    121c:	eb c0                	jmp    11de <main+0x55>
    121e:	48 8b 84 24 08 01 00 	mov    0x108(%rsp),%rax
    1225:	00 
    1226:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    122d:	00 00 
    122f:	75 0f                	jne    1240 <main+0xb7>
    1231:	b8 00 00 00 00       	mov    $0x0,%eax
    1236:	48 81 c4 18 01 00 00 	add    $0x118,%rsp
    123d:	5b                   	pop    %rbx
    123e:	5d                   	pop    %rbp
    123f:	c3                   	retq   
