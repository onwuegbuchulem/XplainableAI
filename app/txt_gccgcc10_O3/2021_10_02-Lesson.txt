...
/app/bin_gccgcc10_O3/2021_10_02-Lesson:     file format elf64-x86-64
...
0000000000001090 <strfry@plt>:
    1090:	f3 0f 1e fa          	endbr64 
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <strfry@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10b5:	66 0f 6f 05 63 0f 00 	movdqa 0xf63(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10bc:	00 
    ...
    10d0:	c7 44 24 18 76 69 6c 	movl   $0x216c6976,0x18(%rsp)
    10d7:	21 
    10d8:	48 b8 64 73 6f 6d 65 	movabs $0x656420656d6f7364,%rax
    10df:	20 64 65 
    10e2:	48 89 ea             	mov    %rbp,%rdx
    10e5:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    10ea:	31 c0                	xor    %eax,%eax
    10ec:	0f 11 04 24          	movups %xmm0,(%rsp)
    10f0:	c6 44 24 1c 00       	movb   $0x0,0x1c(%rsp)
    10f5:	e8 86 ff ff ff       	callq  1080 <__printf_chk@plt>
    10fa:	48 89 ef             	mov    %rbp,%rdi
    10fd:	e8 8e ff ff ff       	callq  1090 <strfry@plt>
    1102:	48 8d 35 07 0f 00 00 	lea    0xf07(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    1109:	bf 01 00 00 00       	mov    $0x1,%edi
    110e:	48 89 c2             	mov    %rax,%rdx
    1111:	31 c0                	xor    %eax,%eax
    1113:	e8 68 ff ff ff       	callq  1080 <__printf_chk@plt>
    1118:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    111d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1124:	00 00 
    1126:	75 08                	jne    1130 <main+0x90>
    1128:	48 83 c4 30          	add    $0x30,%rsp
    112c:	31 c0                	xor    %eax,%eax
    112e:	5d                   	pop    %rbp
    112f:	c3                   	retq   
    1130:	e8 3b ff ff ff       	callq  1070 <__stack_chk_fail@plt>
