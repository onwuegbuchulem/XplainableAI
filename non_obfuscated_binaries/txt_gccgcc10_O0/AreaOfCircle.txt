...
/app/bin_gccgcc10_O0/AreaOfCircle:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bd:	e8 be fe ff ff       	callq  1080 <printf@plt>
    11c2:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    11c6:	48 89 c6             	mov    %rax,%rsi
    11c9:	48 8d 3d 4a 0e 00 00 	lea    0xe4a(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    11d0:	b8 00 00 00 00       	mov    $0x0,%eax
    11d5:	e8 b6 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11da:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11dd:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11e1:	f3 0f 2a c0          	cvtsi2ss %eax,%xmm0
    11e5:	0f 28 c8             	movaps %xmm0,%xmm1
    11e8:	f3 0f 59 4d ec       	mulss  -0x14(%rbp),%xmm1
    11ed:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11f0:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11f4:	f3 0f 2a c0          	cvtsi2ss %eax,%xmm0
    11f8:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    11fc:	f3 0f 11 45 f0       	movss  %xmm0,-0x10(%rbp)
    1201:	f3 0f 10 45 ec       	movss  -0x14(%rbp),%xmm0
    1206:	0f 28 c8             	movaps %xmm0,%xmm1
    1209:	f3 0f 58 c8          	addss  %xmm0,%xmm1
    120d:	8b 45 e8             	mov    -0x18(%rbp),%eax
    1210:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1214:	f3 0f 2a c0          	cvtsi2ss %eax,%xmm0
    1218:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    121c:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    1221:	66 0f ef d2          	pxor   %xmm2,%xmm2
    1225:	f3 0f 5a 55 f0       	cvtss2sd -0x10(%rbp),%xmm2
    122a:	66 48 0f 7e d0       	movq   %xmm2,%rax
    122f:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1234:	48 8d 3d e2 0d 00 00 	lea    0xde2(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    123b:	b8 01 00 00 00       	mov    $0x1,%eax
    1240:	e8 3b fe ff ff       	callq  1080 <printf@plt>
    1245:	66 0f ef db          	pxor   %xmm3,%xmm3
    1249:	f3 0f 5a 5d f4       	cvtss2sd -0xc(%rbp),%xmm3
    124e:	66 48 0f 7e d8       	movq   %xmm3,%rax
    1253:	66 48 0f 6e c0       	movq   %rax,%xmm0
    ...
    126e:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1272:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1279:	00 00 
    127b:	74 05                	je     1282 <main+0xf9>
