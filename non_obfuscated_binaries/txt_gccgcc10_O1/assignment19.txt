...
/app/bin_gccgcc10_O1/assignment19:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	53                   	push   %rbx
    118e:	bf 0a 00 00 00       	mov    $0xa,%edi
    1193:	e8 e8 fe ff ff       	callq  1080 <malloc@plt>
    1198:	48 85 c0             	test   %rax,%rax
    119b:	74 28                	je     11c5 <main+0x3c>
    119d:	48 89 c3             	mov    %rax,%rbx
    11a0:	48 8d 35 81 0e 00 00 	lea    0xe81(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    ...
    11b9:	e8 b2 fe ff ff       	callq  1070 <free@plt>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	5b                   	pop    %rbx
    11c4:	c3                   	retq   
    11c5:	48 8d 35 3c 0e 00 00 	lea    0xe3c(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    11cc:	bf 01 00 00 00       	mov    $0x1,%edi
    11d1:	b8 00 00 00 00       	mov    $0x0,%eax
    11d6:	e8 b5 fe ff ff       	callq  1090 <__printf_chk@plt>
    11db:	b8 01 00 00 00       	mov    $0x1,%eax
    11e0:	eb e1                	jmp    11c3 <main+0x3a>
