...
/app/bin_gccgcc10_O0/04_call_by_value:     file format elf64-x86-64
...
0000000000001149 <sum>:
    ...
    1157:	c7 45 fc 06 00 00 00 	movl   $0x6,-0x4(%rbp)
...
0000000000001168 <main>:
    ...
    1174:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%rbp)
    117b:	c7 45 fc 06 00 00 00 	movl   $0x6,-0x4(%rbp)
    1182:	8b 55 fc             	mov    -0x4(%rbp),%edx
    1185:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1188:	89 d6                	mov    %edx,%esi
    118a:	89 c7                	mov    %eax,%edi
    118c:	e8 b8 ff ff ff       	callq  1149 <sum>
    ...
    11a9:	48 8d 3d 6e 0e 00 00 	lea    0xe6e(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
