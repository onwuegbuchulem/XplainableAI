...
/app/bin_gccgcc10_O1/2020_10_24-Lesson-b:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1167:	e8 e4 fe ff ff       	callq  1050 <__printf_chk@plt>
    116c:	bd 02 00 00 00       	mov    $0x2,%ebp
    1171:	be 00 00 00 00       	mov    $0x0,%esi
    1176:	41 bc 02 00 00 00    	mov    $0x2,%r12d
    117c:	eb 16                	jmp    1194 <main+0x4b>
    117e:	89 c1                	mov    %eax,%ecx
    1180:	89 d8                	mov    %ebx,%eax
    1182:	99                   	cltd   
    1183:	f7 f9                	idiv   %ecx
    1185:	83 fa 01             	cmp    $0x1,%edx
    1188:	83 d6 00             	adc    $0x0,%esi
    118b:	8d 41 01             	lea    0x1(%rcx),%eax
    118e:	39 cd                	cmp    %ecx,%ebp
    1190:	75 ec                	jne    117e <main+0x35>
    1192:	89 dd                	mov    %ebx,%ebp
    1194:	89 f2                	mov    %esi,%edx
    1196:	48 8d 35 6b 0e 00 00 	lea    0xe6b(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    119d:	bf 01 00 00 00       	mov    $0x1,%edi
    11a2:	b8 00 00 00 00       	mov    $0x0,%eax
    11a7:	e8 a4 fe ff ff       	callq  1050 <__printf_chk@plt>
    11ac:	8d 5d 01             	lea    0x1(%rbp),%ebx
    11af:	83 fd 63             	cmp    $0x63,%ebp
    11b2:	74 2e                	je     11e2 <main+0x99>
    ...
    11c7:	e8 84 fe ff ff       	callq  1050 <__printf_chk@plt>
    11cc:	83 fb 02             	cmp    $0x2,%ebx
    11cf:	7e 0a                	jle    11db <main+0x92>
    11d1:	be 00 00 00 00       	mov    $0x0,%esi
    11d6:	44 89 e1             	mov    %r12d,%ecx
    11d9:	eb a5                	jmp    1180 <main+0x37>
    11db:	be 00 00 00 00       	mov    $0x0,%esi
    11e0:	eb b0                	jmp    1192 <main+0x49>
