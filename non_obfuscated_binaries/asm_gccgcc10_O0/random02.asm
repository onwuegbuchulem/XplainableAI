...
/app/bin_gccgcc10_O0/random02:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1195:	c7 45 f8 05 00 00 00 	movl   $0x5,-0x8(%rbp)
    119c:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%rbp)
    11a3:	eb 63                	jmp    1208 <main+0x7f>
    11a5:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
    11ac:	eb 44                	jmp    11f2 <main+0x69>
    11ae:	e8 dd fe ff ff       	callq  1090 <rand@plt>
    11b3:	48 63 d0             	movslq %eax,%rdx
    11b6:	48 69 d2 1f 85 eb 51 	imul   $0x51eb851f,%rdx,%rdx
    11bd:	48 c1 ea 20          	shr    $0x20,%rdx
    11c1:	c1 fa 05             	sar    $0x5,%edx
    11c4:	89 c1                	mov    %eax,%ecx
    11c6:	c1 f9 1f             	sar    $0x1f,%ecx
    11c9:	29 ca                	sub    %ecx,%edx
    11cb:	6b ca 64             	imul   $0x64,%edx,%ecx
    11ce:	29 c8                	sub    %ecx,%eax
    11d0:	89 c2                	mov    %eax,%edx
    11d2:	8d 42 01             	lea    0x1(%rdx),%eax
    ...
    11e9:	e8 92 fe ff ff       	callq  1080 <printf@plt>
    11ee:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    11f2:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11f5:	3b 45 f8             	cmp    -0x8(%rbp),%eax
    11f8:	7c b4                	jl     11ae <main+0x25>
    11fa:	bf 0a 00 00 00       	mov    $0xa,%edi
    11ff:	e8 6c fe ff ff       	callq  1070 <putchar@plt>
    1204:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    1208:	8b 45 f0             	mov    -0x10(%rbp),%eax
    120b:	3b 45 f8             	cmp    -0x8(%rbp),%eax
    120e:	7c 95                	jl     11a5 <main+0x1c>
