...
/app/bin_gccgcc10_O0/2020_12_12-Lesson:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1162:	f2 0f 10 45 f8       	movsd  -0x8(%rbp),%xmm0
    1167:	f2 0f 11 45 f0       	movsd  %xmm0,-0x10(%rbp)
    116c:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
    1173:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1177:	66 48 0f 6e c0       	movq   %rax,%xmm0
    ...
    118d:	f2 0f 10 45 f0       	movsd  -0x10(%rbp),%xmm0
    1192:	f2 0f 58 45 f8       	addsd  -0x8(%rbp),%xmm0
    1197:	f2 0f 11 45 f0       	movsd  %xmm0,-0x10(%rbp)
    119c:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11a0:	66 48 0f 6e c0       	movq   %rax,%xmm0
    11a5:	48 8d 3d 5c 0e 00 00 	lea    0xe5c(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11ac:	b8 01 00 00 00       	mov    $0x1,%eax
    11b1:	e8 9a fe ff ff       	callq  1050 <printf@plt>
    11b6:	f2 0f 10 45 f8       	movsd  -0x8(%rbp),%xmm0
    11bb:	f2 0f 58 45 f0       	addsd  -0x10(%rbp),%xmm0
    11c0:	f2 0f 11 45 f8       	movsd  %xmm0,-0x8(%rbp)
    11c5:	83 45 ec 02          	addl   $0x2,-0x14(%rbp)
    11c9:	83 7d ec 63          	cmpl   $0x63,-0x14(%rbp)
    11cd:	7e a4                	jle    1173 <main+0x2a>
