...
/app/bin_gccgcc10_O3/2021_07_10-Lesson-c:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10d9:	74 25                	je     1100 <main+0x80>
    10db:	83 fa 3f             	cmp    $0x3f,%edx
    10de:	75 d0                	jne    10b0 <main+0x30>
    10e0:	8b 15 3a 2f 00 00    	mov    0x2f3a(%rip),%edx        # 4020 <optopt@@GLIBC_2.2.5>
    10e6:	48 8d 35 1b 0f 00 00 	lea    0xf1b(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    10ed:	bf 01 00 00 00       	mov    $0x1,%edi
    10f2:	31 c0                	xor    %eax,%eax
    10f4:	e8 67 ff ff ff       	callq  1060 <__printf_chk@plt>
    10f9:	eb c8                	jmp    10c3 <main+0x43>
    10fb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1100:	44 89 e2             	mov    %r12d,%edx
    1103:	48 8d 35 34 0f 00 00 	lea    0xf34(%rip),%rsi        # 203e <_IO_stdin_used+0x3e>
    110a:	bf 01 00 00 00       	mov    $0x1,%edi
    110f:	31 c0                	xor    %eax,%eax
    1111:	e8 4a ff ff ff       	callq  1060 <__printf_chk@plt>
