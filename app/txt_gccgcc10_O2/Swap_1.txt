...
/app/bin_gccgcc10_O2/Swap_1:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10d3:	48 8d 3d 47 0f 00 00 	lea    0xf47(%rip),%rdi        # 2021 <_IO_stdin_used+0x21>
    10da:	e8 b1 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10df:	8b 54 24 04          	mov    0x4(%rsp),%edx
    10e3:	8b 0c 24             	mov    (%rsp),%ecx
    10e6:	31 c0                	xor    %eax,%eax
    10e8:	48 8d 35 2a 0f 00 00 	lea    0xf2a(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    10ef:	bf 01 00 00 00       	mov    $0x1,%edi
    10f4:	89 4c 24 04          	mov    %ecx,0x4(%rsp)
    10f8:	89 14 24             	mov    %edx,(%rsp)
