...
/app/bin_gccgcc10_O3/02_quick_quiz:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1072:	f2 0f 10 05 96 0f 00 	movsd  0xf96(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    1079:	00 
    107a:	48 8d 35 83 0f 00 00 	lea    0xf83(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1081:	e8 ca ff ff ff       	callq  1050 <__printf_chk@plt>
    1086:	bf 01 00 00 00       	mov    $0x1,%edi
    108b:	b8 01 00 00 00       	mov    $0x1,%eax
    1090:	f2 0f 10 05 80 0f 00 	movsd  0xf80(%rip),%xmm0        # 2018 <_IO_stdin_used+0x18>
    1097:	00 
    1098:	48 8d 35 65 0f 00 00 	lea    0xf65(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    109f:	e8 ac ff ff ff       	callq  1050 <__printf_chk@plt>
    10a4:	bf 01 00 00 00       	mov    $0x1,%edi
    10a9:	b8 01 00 00 00       	mov    $0x1,%eax
    10ae:	f2 0f 10 05 6a 0f 00 	movsd  0xf6a(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10b5:	00 
    ...
    10cc:	f2 0f 10 05 54 0f 00 	movsd  0xf54(%rip),%xmm0        # 2028 <_IO_stdin_used+0x28>
    10d3:	00 
    10d4:	48 8d 35 29 0f 00 00 	lea    0xf29(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10db:	e8 70 ff ff ff       	callq  1050 <__printf_chk@plt>
    10e0:	bf 01 00 00 00       	mov    $0x1,%edi
    10e5:	b8 01 00 00 00       	mov    $0x1,%eax
    10ea:	f2 0f 10 05 3e 0f 00 	movsd  0xf3e(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    10f1:	00 
    10f2:	48 8d 35 0b 0f 00 00 	lea    0xf0b(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10f9:	e8 52 ff ff ff       	callq  1050 <__printf_chk@plt>
    10fe:	31 c0                	xor    %eax,%eax
    1100:	48 83 c4 08          	add    $0x8,%rsp
    1104:	c3                   	retq   
    1105:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    110c:	00 00 00 
    110f:	90                   	nop
