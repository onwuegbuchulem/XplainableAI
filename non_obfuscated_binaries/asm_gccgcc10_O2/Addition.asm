...
/app/bin_gccgcc10_O2/Addition:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10d3:	48 8d 3d 3f 0f 00 00 	lea    0xf3f(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    10da:	e8 b1 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10df:	8b 54 24 04          	mov    0x4(%rsp),%edx
    10e3:	31 c0                	xor    %eax,%eax
    10e5:	03 14 24             	add    (%rsp),%edx
    10e8:	48 8d 35 30 0f 00 00 	lea    0xf30(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    10ef:	bf 01 00 00 00       	mov    $0x1,%edi
    10f4:	e8 87 ff ff ff       	callq  1080 <__printf_chk@plt>
    10f9:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10fe:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1105:	00 00 
    1107:	75 05                	jne    110e <main+0x6e>
    1109:	48 83 c4 18          	add    $0x18,%rsp
    110d:	c3                   	retq   
