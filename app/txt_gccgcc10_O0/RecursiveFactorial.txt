...
/app/bin_gccgcc10_O0/RecursiveFactorial:     file format elf64-x86-64
...
0000000000001189 <factorial>:
    ...
    1198:	83 7d fc 01          	cmpl   $0x1,-0x4(%rbp)
    119c:	75 07                	jne    11a5 <factorial+0x1c>
    119e:	b8 01 00 00 00       	mov    $0x1,%eax
    11a3:	eb 11                	jmp    11b6 <factorial+0x2d>
    11a5:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11a8:	83 e8 01             	sub    $0x1,%eax
    11ab:	89 c7                	mov    %eax,%edi
    11ad:	e8 d7 ff ff ff       	callq  1189 <factorial>
    11b2:	0f af 45 fc          	imul   -0x4(%rbp),%eax
    11b6:	c9                   	leaveq 
    11b7:	c3                   	retq   
...
00000000000011b8 <main>:
    ...
    11eb:	48 8d 3d 2b 0e 00 00 	lea    0xe2b(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    11f2:	b8 00 00 00 00       	mov    $0x0,%eax
    11f7:	e8 94 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11fc:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11ff:	89 c7                	mov    %eax,%edi
    1201:	e8 83 ff ff ff       	callq  1189 <factorial>
    1206:	89 c2                	mov    %eax,%edx
    1208:	8b 45 f4             	mov    -0xc(%rbp),%eax
    120b:	89 c6                	mov    %eax,%esi
    120d:	48 8d 3d 0c 0e 00 00 	lea    0xe0c(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    1214:	b8 00 00 00 00       	mov    $0x0,%eax
    1219:	e8 62 fe ff ff       	callq  1080 <printf@plt>
    121e:	b8 00 00 00 00       	mov    $0x0,%eax
    1223:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1227:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    122e:	00 00 
    1230:	74 05                	je     1237 <main+0x7f>
