...
/app/bin_gccgcc10_O3/2022_04_30-Lesson-c:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1098:	48 8b 05 69 0f 00 00 	mov    0xf69(%rip),%rax        # 2008 <_IO_stdin_used+0x8>
    109f:	48 89 e7             	mov    %rsp,%rdi
    10a2:	c6 44 24 0a 00       	movb   $0x0,0xa(%rsp)
    10a7:	48 89 04 24          	mov    %rax,(%rsp)
    10ab:	b8 49 4a 00 00       	mov    $0x4a49,%eax
    10b0:	66 89 44 24 08       	mov    %ax,0x8(%rsp)
    10b5:	e8 a6 ff ff ff       	callq  1060 <puts@plt>
    10ba:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10bf:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10c6:	00 00 
    10c8:	75 07                	jne    10d1 <main+0x51>
    10ca:	31 c0                	xor    %eax,%eax
    10cc:	48 83 c4 28          	add    $0x28,%rsp
    10d0:	c3                   	retq   
    10d1:	e8 9a ff ff ff       	callq  1070 <__stack_chk_fail@plt>
