...
/app/bin_gccgcc10_O3/2024_07_06-Lesson-a:     file format elf64-x86-64
...
0000000000001090 <sleep@plt>:
    ...
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <sleep@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10a4:	53                   	push   %rbx
    10a5:	bb 14 00 00 00       	mov    $0x14,%ebx
    10aa:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    10b0:	48 8b 35 59 2f 00 00 	mov    0x2f59(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10b7:	bf 58 00 00 00       	mov    $0x58,%edi
    10bc:	e8 af ff ff ff       	callq  1070 <putc@plt>
    10c1:	83 eb 01             	sub    $0x1,%ebx
    10c4:	75 ea                	jne    10b0 <main+0x10>
    10c6:	48 8b 3d 43 2f 00 00 	mov    0x2f43(%rip),%rdi        # 4010 <stdout@@GLIBC_2.2.5>
    10cd:	bb 14 00 00 00       	mov    $0x14,%ebx
    10d2:	e8 a9 ff ff ff       	callq  1080 <fflush@plt>
    10d7:	bf 01 00 00 00       	mov    $0x1,%edi
    10dc:	e8 af ff ff ff       	callq  1090 <sleep@plt>
    10e1:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    10e8:	48 8b 35 21 2f 00 00 	mov    0x2f21(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10ef:	bf 08 00 00 00       	mov    $0x8,%edi
    10f4:	e8 77 ff ff ff       	callq  1070 <putc@plt>
    10f9:	83 eb 01             	sub    $0x1,%ebx
    10fc:	75 ea                	jne    10e8 <main+0x48>
    10fe:	48 8b 35 0b 2f 00 00 	mov    0x2f0b(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1105:	bf 0a 00 00 00       	mov    $0xa,%edi
    110a:	e8 61 ff ff ff       	callq  1070 <putc@plt>
    110f:	31 c0                	xor    %eax,%eax
    1111:	5b                   	pop    %rbx
    1112:	c3                   	retq   
    1113:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    111a:	00 00 00 
