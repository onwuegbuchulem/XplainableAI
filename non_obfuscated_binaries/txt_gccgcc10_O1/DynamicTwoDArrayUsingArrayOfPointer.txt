...
/app/bin_gccgcc10_O1/DynamicTwoDArrayUsingArrayOfPointer:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a7:	bf 10 00 00 00       	mov    $0x10,%edi
    11ac:	e8 cf fe ff ff       	callq  1080 <malloc@plt>
    11b1:	48 89 c5             	mov    %rax,%rbp
    11b4:	48 89 04 24          	mov    %rax,(%rsp)
    11b8:	bf 10 00 00 00       	mov    $0x10,%edi
    11bd:	e8 be fe ff ff       	callq  1080 <malloc@plt>
    11c2:	48 89 c3             	mov    %rax,%rbx
    11c5:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11ca:	bf 10 00 00 00       	mov    $0x10,%edi
    11cf:	e8 ac fe ff ff       	callq  1080 <malloc@plt>
    11d4:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11d9:	c7 45 00 01 00 00 00 	movl   $0x1,0x0(%rbp)
    11e0:	c7 45 04 02 00 00 00 	movl   $0x2,0x4(%rbp)
    11e7:	c7 45 08 03 00 00 00 	movl   $0x3,0x8(%rbp)
    11ee:	c7 45 0c 04 00 00 00 	movl   $0x4,0xc(%rbp)
    11f5:	c7 03 05 00 00 00    	movl   $0x5,(%rbx)
    11fb:	c7 43 04 06 00 00 00 	movl   $0x6,0x4(%rbx)
    1202:	c7 43 08 07 00 00 00 	movl   $0x7,0x8(%rbx)
    1209:	c7 43 0c 08 00 00 00 	movl   $0x8,0xc(%rbx)
    1210:	c7 00 09 00 00 00    	movl   $0x9,(%rax)
    1216:	c7 40 04 0a 00 00 00 	movl   $0xa,0x4(%rax)
    121d:	c7 40 08 0b 00 00 00 	movl   $0xb,0x8(%rax)
    1224:	c7 40 0c 0c 00 00 00 	movl   $0xc,0xc(%rax)
    122b:	48 89 e5             	mov    %rsp,%rbp
    122e:	4c 8d 6c 24 18       	lea    0x18(%rsp),%r13
    1233:	4c 8d 25 ca 0d 00 00 	lea    0xdca(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    123a:	bb 00 00 00 00       	mov    $0x0,%ebx
    123f:	48 8b 45 00          	mov    0x0(%rbp),%rax
    1243:	8b 14 18             	mov    (%rax,%rbx,1),%edx
    1246:	4c 89 e6             	mov    %r12,%rsi
    1249:	bf 01 00 00 00       	mov    $0x1,%edi
    124e:	b8 00 00 00 00       	mov    $0x0,%eax
    1253:	e8 38 fe ff ff       	callq  1090 <__printf_chk@plt>
    1258:	48 83 c3 04          	add    $0x4,%rbx
    125c:	48 83 fb 10          	cmp    $0x10,%rbx
    1260:	75 dd                	jne    123f <main+0xb6>
    1262:	48 83 c5 08          	add    $0x8,%rbp
    1266:	4c 39 ed             	cmp    %r13,%rbp
    1269:	75 cf                	jne    123a <main+0xb1>
    126b:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1270:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1277:	00 00 
    1279:	75 10                	jne    128b <main+0x102>
    127b:	b8 00 00 00 00       	mov    $0x0,%eax
    1280:	48 83 c4 28          	add    $0x28,%rsp
    1284:	5b                   	pop    %rbx
    1285:	5d                   	pop    %rbp
    1286:	41 5c                	pop    %r12
    1288:	41 5d                	pop    %r13
