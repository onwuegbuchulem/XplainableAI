...
/app/bin_gccgcc10_O1/NumberGuess:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    1266:	bd 00 00 00 00       	mov    $0x0,%ebp
    126b:	4c 8d 64 24 04       	lea    0x4(%rsp),%r12
    1270:	eb 2b                	jmp    129d <main+0x94>
    1272:	89 ea                	mov    %ebp,%edx
    1274:	48 8d 35 b5 0d 00 00 	lea    0xdb5(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    127b:	bf 01 00 00 00       	mov    $0x1,%edi
    1280:	b8 00 00 00 00       	mov    $0x0,%eax
    1285:	e8 66 fe ff ff       	callq  10f0 <__printf_chk@plt>
    128a:	eb 6e                	jmp    12fa <main+0xf1>
    128c:	48 8d 3d 46 0e 00 00 	lea    0xe46(%rip),%rdi        # 20d9 <_IO_stdin_used+0xd9>
    1293:	e8 18 fe ff ff       	callq  10b0 <puts@plt>
    1298:	83 fd 0a             	cmp    $0xa,%ebp
    129b:	74 45                	je     12e2 <main+0xd9>
    129d:	48 8d 35 03 0e 00 00 	lea    0xe03(%rip),%rsi        # 20a7 <_IO_stdin_used+0xa7>
    12a4:	bf 01 00 00 00       	mov    $0x1,%edi
    12a9:	b8 00 00 00 00       	mov    $0x0,%eax
    12ae:	e8 3d fe ff ff       	callq  10f0 <__printf_chk@plt>
    12b3:	4c 89 e6             	mov    %r12,%rsi
    12b6:	48 8d 3d 05 0e 00 00 	lea    0xe05(%rip),%rdi        # 20c2 <_IO_stdin_used+0xc2>
    12bd:	b8 00 00 00 00       	mov    $0x0,%eax
    12c2:	e8 39 fe ff ff       	callq  1100 <__isoc99_scanf@plt>
    12c7:	83 c5 01             	add    $0x1,%ebp
    12ca:	8b 44 24 04          	mov    0x4(%rsp),%eax
    12ce:	39 d8                	cmp    %ebx,%eax
    12d0:	74 a0                	je     1272 <main+0x69>
    12d2:	7d b8                	jge    128c <main+0x83>
    12d4:	48 8d 3d ea 0d 00 00 	lea    0xdea(%rip),%rdi        # 20c5 <_IO_stdin_used+0xc5>
    12db:	e8 d0 fd ff ff       	callq  10b0 <puts@plt>
    12e0:	eb b6                	jmp    1298 <main+0x8f>
    12e2:	89 da                	mov    %ebx,%edx
    12e4:	48 8d 35 85 0d 00 00 	lea    0xd85(%rip),%rsi        # 2070 <_IO_stdin_used+0x70>
    12eb:	bf 01 00 00 00       	mov    $0x1,%edi
    12f0:	b8 00 00 00 00       	mov    $0x0,%eax
    12f5:	e8 f6 fd ff ff       	callq  10f0 <__printf_chk@plt>
    12fa:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    12ff:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1306:	00 00 
    1308:	75 0e                	jne    1318 <main+0x10f>
    130a:	b8 00 00 00 00       	mov    $0x0,%eax
    130f:	48 83 c4 10          	add    $0x10,%rsp
    1313:	5b                   	pop    %rbx
    1314:	5d                   	pop    %rbp
    1315:	41 5c                	pop    %r12
    1317:	c3                   	retq   
