...
/app/bin_gccgcc10_O2/filter01:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	eb 12                	jmp    109c <main+0x1c>
    108a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1090:	48 8b 35 79 2f 00 00 	mov    0x2f79(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1097:	e8 c4 ff ff ff       	callq  1060 <putc@plt>
    109c:	48 8b 3d 7d 2f 00 00 	mov    0x2f7d(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    10a3:	e8 c8 ff ff ff       	callq  1070 <getc@plt>
    10a8:	89 c7                	mov    %eax,%edi
    10aa:	83 f8 ff             	cmp    $0xffffffff,%eax
    10ad:	75 e1                	jne    1090 <main+0x10>
