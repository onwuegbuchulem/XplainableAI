...
/app/bin_gccgcc10_O0/2020_04_04-Lesson:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    1278:	be 41 00 00 00       	mov    $0x41,%esi
    127d:	48 89 c7             	mov    %rax,%rdi
    1280:	b8 00 00 00 00       	mov    $0x0,%eax
    1285:	e8 76 fe ff ff       	callq  1100 <open@plt>
    128a:	89 45 b8             	mov    %eax,-0x48(%rbp)
    128d:	83 7d b8 ff          	cmpl   $0xffffffff,-0x48(%rbp)
    1291:	75 26                	jne    12b9 <main+0xb0>
    1293:	48 8b 05 86 2d 00 00 	mov    0x2d86(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    129a:	48 8d 55 c0          	lea    -0x40(%rbp),%rdx
    ...
    12ad:	e8 3e fe ff ff       	callq  10f0 <fprintf@plt>
    12b2:	b8 01 00 00 00       	mov    $0x1,%eax
    12b7:	eb 66                	jmp    131f <main+0x116>
    12b9:	48 8d 4d d0          	lea    -0x30(%rbp),%rcx
    12bd:	8b 45 b8             	mov    -0x48(%rbp),%eax
    12c0:	ba 1a 00 00 00       	mov    $0x1a,%edx
    12c5:	48 89 ce             	mov    %rcx,%rsi
    12c8:	89 c7                	mov    %eax,%edi
    12ca:	e8 e1 fd ff ff       	callq  10b0 <write@plt>
    12cf:	89 45 bc             	mov    %eax,-0x44(%rbp)
    12d2:	83 7d bc 1a          	cmpl   $0x1a,-0x44(%rbp)
    12d6:	74 20                	je     12f8 <main+0xef>
    12d8:	48 8b 05 41 2d 00 00 	mov    0x2d41(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    12df:	48 89 c1             	mov    %rax,%rcx
    12e2:	ba 20 00 00 00       	mov    $0x20,%edx
    12e7:	be 01 00 00 00       	mov    $0x1,%esi
    12ec:	48 8d 3d 2d 0d 00 00 	lea    0xd2d(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    12f3:	e8 18 fe ff ff       	callq  1110 <fwrite@plt>
    12f8:	48 8d 45 c0          	lea    -0x40(%rbp),%rax
    12fc:	48 89 c6             	mov    %rax,%rsi
    12ff:	48 8d 3d 3b 0d 00 00 	lea    0xd3b(%rip),%rdi        # 2041 <_IO_stdin_used+0x41>
    1306:	b8 00 00 00 00       	mov    $0x0,%eax
    130b:	e8 c0 fd ff ff       	callq  10d0 <printf@plt>
    1310:	8b 45 b8             	mov    -0x48(%rbp),%eax
    1313:	89 c7                	mov    %eax,%edi
    1315:	e8 c6 fd ff ff       	callq  10e0 <close@plt>
    131a:	b8 00 00 00 00       	mov    $0x0,%eax
    131f:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1323:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    132a:	00 00 
    132c:	74 05                	je     1333 <main+0x12a>
    132e:	e8 8d fd ff ff       	callq  10c0 <__stack_chk_fail@plt>
    1333:	c9                   	leaveq 
    1334:	c3                   	retq   
