...
/app/bin_gccgcc10_O3/mood:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10b1:	e8 ca ff ff ff       	callq  1080 <setlocale@plt>
    10b6:	48 8d 35 53 0f 00 00 	lea    0xf53(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    10bd:	bf 01 00 00 00       	mov    $0x1,%edi
    10c2:	31 c0                	xor    %eax,%eax
    10c4:	e8 c7 ff ff ff       	callq  1090 <__wprintf_chk@plt>
    10c9:	e8 a2 ff ff ff       	callq  1070 <getwchar@plt>
    10ce:	48 8d 35 8b 0f 00 00 	lea    0xf8b(%rip),%rsi        # 2060 <_IO_stdin_used+0x60>
    10d5:	bf 01 00 00 00       	mov    $0x1,%edi
    10da:	89 c2                	mov    %eax,%edx
    10dc:	31 c0                	xor    %eax,%eax
    10de:	e8 ad ff ff ff       	callq  1090 <__wprintf_chk@plt>
