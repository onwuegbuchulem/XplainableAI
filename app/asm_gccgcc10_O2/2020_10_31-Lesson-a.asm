...
/app/bin_gccgcc10_O2/2020_10_31-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 54                	push   %r12
    1086:	41 bc 02 00 00 00    	mov    $0x2,%r12d
    108c:	53                   	push   %rbx
    ...
    10a2:	44 89 e2             	mov    %r12d,%edx
    10a5:	48 89 de             	mov    %rbx,%rsi
    10a8:	bf 01 00 00 00       	mov    $0x1,%edi
    10ad:	e8 be ff ff ff       	callq  1070 <__printf_chk@plt>
    10b2:	41 83 fc 02          	cmp    $0x2,%r12d
    10b6:	74 22                	je     10da <main+0x5a>
    10b8:	41 f6 c4 01          	test   $0x1,%r12b
    10bc:	74 42                	je     1100 <main+0x80>
    10be:	b9 02 00 00 00       	mov    $0x2,%ecx
    10c3:	eb 0d                	jmp    10d2 <main+0x52>
    10c5:	0f 1f 00             	nopl   (%rax)
    10c8:	44 89 e0             	mov    %r12d,%eax
    10cb:	99                   	cltd   
    10cc:	f7 f9                	idiv   %ecx
    10ce:	85 d2                	test   %edx,%edx
    10d0:	74 2e                	je     1100 <main+0x80>
    10d2:	83 c1 01             	add    $0x1,%ecx
    10d5:	44 39 e1             	cmp    %r12d,%ecx
    10d8:	75 ee                	jne    10c8 <main+0x48>
    10da:	48 8d 3d 27 0f 00 00 	lea    0xf27(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    10e1:	e8 7a ff ff ff       	callq  1060 <puts@plt>
    10e6:	41 83 c4 01          	add    $0x1,%r12d
    10ea:	41 83 fc 64          	cmp    $0x64,%r12d
    10ee:	75 b0                	jne    10a0 <main+0x20>
    ...
    1100:	48 8d 3d 07 0f 00 00 	lea    0xf07(%rip),%rdi        # 200e <_IO_stdin_used+0xe>
    1107:	e8 54 ff ff ff       	callq  1060 <puts@plt>
    110c:	eb d8                	jmp    10e6 <main+0x66>
