...
/app/bin_gccgcc10_O3/2022_02_12-Lesson:     file format elf64-x86-64
...
0000000000001100 <main>:
    ...
    1118:	e8 d3 ff ff ff       	callq  10f0 <fork@plt>
    111d:	85 c0                	test   %eax,%eax
    111f:	75 25                	jne    1146 <main+0x46>
    1121:	31 f6                	xor    %esi,%esi
    1123:	48 8d 3d da 0e 00 00 	lea    0xeda(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    112a:	e8 a1 ff ff ff       	callq  10d0 <execl@plt>
    112f:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1134:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    113b:	00 00 
    113d:	75 40                	jne    117f <main+0x7f>
    113f:	31 c0                	xor    %eax,%eax
    1141:	48 83 c4 18          	add    $0x18,%rsp
    1145:	c3                   	retq   
    1146:	48 8d 7c 24 04       	lea    0x4(%rsp),%rdi
    114b:	e8 90 ff ff ff       	callq  10e0 <wait@plt>
    1150:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1154:	f6 c2 7f             	test   $0x7f,%dl
    1157:	75 18                	jne    1171 <main+0x71>
    1159:	0f b6 d6             	movzbl %dh,%edx
    115c:	48 8d 35 c5 0e 00 00 	lea    0xec5(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    1163:	bf 01 00 00 00       	mov    $0x1,%edi
    1168:	31 c0                	xor    %eax,%eax
    116a:	e8 51 ff ff ff       	callq  10c0 <__printf_chk@plt>
    116f:	eb be                	jmp    112f <main+0x2f>
    1171:	48 8d 3d 93 0e 00 00 	lea    0xe93(%rip),%rdi        # 200b <_IO_stdin_used+0xb>
    1178:	e8 23 ff ff ff       	callq  10a0 <puts@plt>
    117d:	eb b0                	jmp    112f <main+0x2f>
    117f:	e8 2c ff ff ff       	callq  10b0 <__stack_chk_fail@plt>
