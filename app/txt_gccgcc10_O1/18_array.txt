...
/app/bin_gccgcc10_O1/18_array:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1185:	c7 04 24 02 00 00 00 	movl   $0x2,(%rsp)
    118c:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%rsp)
    1193:	00 
    1194:	c7 44 24 08 05 00 00 	movl   $0x5,0x8(%rsp)
    119b:	00 
    119c:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%rsp)
    11a3:	00 
    11a4:	c7 44 24 10 0d 00 00 	movl   $0xd,0x10(%rsp)
    11ab:	00 
    ...
    11bb:	8b 13                	mov    (%rbx),%edx
    11bd:	89 d1                	mov    %edx,%ecx
    11bf:	48 89 ee             	mov    %rbp,%rsi
    ...
    11d5:	4c 39 e3             	cmp    %r12,%rbx
    11d8:	75 e1                	jne    11bb <main+0x52>
    11da:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11df:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11e6:	00 00 
    11e8:	75 0e                	jne    11f8 <main+0x8f>
    11ea:	b8 00 00 00 00       	mov    $0x0,%eax
    11ef:	48 83 c4 20          	add    $0x20,%rsp
    11f3:	5b                   	pop    %rbx
    11f4:	5d                   	pop    %rbp
    11f5:	41 5c                	pop    %r12
    11f7:	c3                   	retq   
    11f8:	e8 63 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
