...
/app/bin_gccgcc10_O0/05_call_by_reference:     file format elf64-x86-64
...
0000000000001169 <sum>:
    ...
    117d:	c7 00 06 00 00 00    	movl   $0x6,(%rax)
    1183:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1187:	8b 10                	mov    (%rax),%edx
...
0000000000001193 <main>:
    ...
    11ae:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%rbp)
    11b5:	c7 45 f4 06 00 00 00 	movl   $0x6,-0xc(%rbp)
    11bc:	48 8d 55 f4          	lea    -0xc(%rbp),%rdx
    11c0:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    11c4:	48 89 d6             	mov    %rdx,%rsi
    11c7:	48 89 c7             	mov    %rax,%rdi
    11ca:	e8 9a ff ff ff       	callq  1169 <sum>
    ...
    11e2:	8b 45 f0             	mov    -0x10(%rbp),%eax
