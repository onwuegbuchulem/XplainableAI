...
/app/bin_gccgcc10_O0/2020_05_30-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 bc 03 00 00 00 	movl   $0x3,-0x44(%rbp)
    118b:	c7 45 c0 01 00 00 00 	movl   $0x1,-0x40(%rbp)
    1192:	c7 45 b8 01 00 00 00 	movl   $0x1,-0x48(%rbp)
    1199:	eb 1f                	jmp    11ba <main+0x51>
    119b:	8b 45 b8             	mov    -0x48(%rbp),%eax
    119e:	83 e8 01             	sub    $0x1,%eax
    11a1:	48 98                	cltq   
    11a3:	8b 44 85 c0          	mov    -0x40(%rbp,%rax,4),%eax
    11a7:	0f af 45 bc          	imul   -0x44(%rbp),%eax
    11ab:	89 c2                	mov    %eax,%edx
    11ad:	8b 45 b8             	mov    -0x48(%rbp),%eax
    11b0:	48 98                	cltq   
    11b2:	89 54 85 c0          	mov    %edx,-0x40(%rbp,%rax,4)
    11b6:	83 45 b8 01          	addl   $0x1,-0x48(%rbp)
    11ba:	83 7d b8 0a          	cmpl   $0xa,-0x48(%rbp)
    11be:	7e db                	jle    119b <main+0x32>
    11c0:	c7 45 b8 00 00 00 00 	movl   $0x0,-0x48(%rbp)
    11c7:	eb 26                	jmp    11ef <main+0x86>
    11c9:	8b 45 b8             	mov    -0x48(%rbp),%eax
    11cc:	48 98                	cltq   
    11ce:	8b 4c 85 c0          	mov    -0x40(%rbp,%rax,4),%ecx
    11d2:	8b 55 b8             	mov    -0x48(%rbp),%edx
    11d5:	8b 45 bc             	mov    -0x44(%rbp),%eax
    11d8:	89 c6                	mov    %eax,%esi
    11da:	48 8d 3d 23 0e 00 00 	lea    0xe23(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11e1:	b8 00 00 00 00       	mov    $0x0,%eax
    11e6:	e8 85 fe ff ff       	callq  1070 <printf@plt>
    11eb:	83 45 b8 01          	addl   $0x1,-0x48(%rbp)
    11ef:	83 7d b8 0a          	cmpl   $0xa,-0x48(%rbp)
    11f3:	7e d4                	jle    11c9 <main+0x60>
    11f5:	b8 00 00 00 00       	mov    $0x0,%eax
    11fa:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    11fe:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    1205:	00 00 
    1207:	74 05                	je     120e <main+0xa5>
    1209:	e8 52 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    120e:	c9                   	leaveq 
    120f:	c3                   	retq   
