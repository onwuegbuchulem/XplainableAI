...
/app/bin_gccgcc10_O0/2019_04_06-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d db 00 00 00 	lea    0xdb(%rip),%rdi        # 11a3 <main>
...
00000000000011a3 <main>:
    ...
    11b6:	00 00 
    11b8:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    ...
    11cf:	48 8d 55 f4          	lea    -0xc(%rbp),%rdx
    11d3:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    11d7:	48 89 c6             	mov    %rax,%rsi
    11da:	48 8d 3d 50 0e 00 00 	lea    0xe50(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    11e1:	b8 00 00 00 00       	mov    $0x0,%eax
    11e6:	e8 a5 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11eb:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11ee:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11f1:	89 d6                	mov    %edx,%esi
    11f3:	89 c7                	mov    %eax,%edi
    11f5:	b8 00 00 00 00       	mov    $0x0,%eax
    11fa:	e8 8a ff ff ff       	callq  1189 <max>
    11ff:	89 c6                	mov    %eax,%esi
    1201:	48 8d 3d 2f 0e 00 00 	lea    0xe2f(%rip),%rdi        # 2037 <_IO_stdin_used+0x37>
    ...
    121b:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1222:	00 00 
    1224:	74 05                	je     122b <main+0x88>
