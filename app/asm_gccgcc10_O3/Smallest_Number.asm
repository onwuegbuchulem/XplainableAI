...
/app/bin_gccgcc10_O3/Smallest_Number:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    1134:	7d 41                	jge    1177 <main+0xd7>
    1136:	3b 54 24 14          	cmp    0x14(%rsp),%edx
    113a:	7c 5f                	jl     119b <main+0xfb>
    113c:	44 8b 4c 24 14       	mov    0x14(%rsp),%r9d
    1141:	44 39 c2             	cmp    %r8d,%edx
    1144:	41 0f 4f d0          	cmovg  %r8d,%edx
    1148:	41 39 d1             	cmp    %edx,%r9d
    114b:	7c 63                	jl     11b0 <main+0x110>
    114d:	48 8d 35 f3 0e 00 00 	lea    0xef3(%rip),%rsi        # 2047 <_IO_stdin_used+0x47>
    ...
    117c:	7e c3                	jle    1141 <main+0xa1>
    117e:	45 39 c8             	cmp    %r9d,%r8d
    1181:	7d be                	jge    1141 <main+0xa1>
    1183:	44 89 c2             	mov    %r8d,%edx
    1186:	48 8d 35 fb 0e 00 00 	lea    0xefb(%rip),%rsi        # 2088 <_IO_stdin_used+0x88>
    ...
    119b:	48 8d 35 c6 0e 00 00 	lea    0xec6(%rip),%rsi        # 2068 <_IO_stdin_used+0x68>
    ...
    11b3:	48 8d 35 ee 0e 00 00 	lea    0xeee(%rip),%rsi        # 20a8 <_IO_stdin_used+0xa8>
