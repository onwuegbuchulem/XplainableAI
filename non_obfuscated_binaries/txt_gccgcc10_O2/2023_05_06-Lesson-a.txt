...
/app/bin_gccgcc10_O2/2023_05_06-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a8:	31 ff                	xor    %edi,%edi
    10aa:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10b1:	00 00 
    10b3:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10b8:	31 c0                	xor    %eax,%eax
    10ba:	48 89 e6             	mov    %rsp,%rsi
    10bd:	e8 ae ff ff ff       	callq  1070 <clock_gettime@plt>
    10c2:	48 8b 4c 24 08       	mov    0x8(%rsp),%rcx
    10c7:	48 8b 14 24          	mov    (%rsp),%rdx
    10cb:	31 c0                	xor    %eax,%eax
    10cd:	48 8d 35 34 0f 00 00 	lea    0xf34(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    10d4:	bf 01 00 00 00       	mov    $0x1,%edi
    10d9:	e8 b2 ff ff ff       	callq  1090 <__printf_chk@plt>
    10de:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10e3:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10ea:	00 00 
    10ec:	75 07                	jne    10f5 <main+0x55>
    10ee:	31 c0                	xor    %eax,%eax
    10f0:	48 83 c4 28          	add    $0x28,%rsp
    10f4:	c3                   	retq   
    10f5:	e8 86 ff ff ff       	callq  1080 <__stack_chk_fail@plt>
