...
/app/bin_gccgcc10_O1/Sum_Number_Digits:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11c8:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11cc:	85 d2                	test   %edx,%edx
    11ce:	74 63                	je     1233 <main+0xaa>
    11d0:	be 00 00 00 00       	mov    $0x0,%esi
    11d5:	48 63 c2             	movslq %edx,%rax
    11d8:	48 69 c0 67 66 66 66 	imul   $0x66666667,%rax,%rax
    11df:	48 c1 f8 22          	sar    $0x22,%rax
    11e3:	89 d1                	mov    %edx,%ecx
    11e5:	c1 f9 1f             	sar    $0x1f,%ecx
    11e8:	29 c8                	sub    %ecx,%eax
    11ea:	8d 0c 80             	lea    (%rax,%rax,4),%ecx
    11ed:	01 c9                	add    %ecx,%ecx
    11ef:	29 ca                	sub    %ecx,%edx
    11f1:	01 d6                	add    %edx,%esi
    11f3:	89 c2                	mov    %eax,%edx
    11f5:	85 c0                	test   %eax,%eax
    11f7:	75 dc                	jne    11d5 <main+0x4c>
    11f9:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%rsp)
    1200:	00 
    1201:	89 f2                	mov    %esi,%edx
    1203:	48 8d 35 0d 0e 00 00 	lea    0xe0d(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    120a:	bf 01 00 00 00       	mov    $0x1,%edi
    120f:	b8 00 00 00 00       	mov    $0x0,%eax
    1214:	e8 67 fe ff ff       	callq  1080 <__printf_chk@plt>
    1219:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    121e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1225:	00 00 
    1227:	75 0e                	jne    1237 <main+0xae>
    1229:	b8 00 00 00 00       	mov    $0x0,%eax
    122e:	48 83 c4 18          	add    $0x18,%rsp
    1232:	c3                   	retq   
    1233:	89 d6                	mov    %edx,%esi
    1235:	eb ca                	jmp    1201 <main+0x78>
