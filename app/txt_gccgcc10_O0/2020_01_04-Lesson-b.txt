...
/app/bin_gccgcc10_O0/2020_01_04-Lesson-b:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c8:	b9 0d 00 00 00       	mov    $0xd,%ecx
    11cd:	48 8d 15 30 0e 00 00 	lea    0xe30(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    11d4:	be 0c 00 00 00       	mov    $0xc,%esi
    11d9:	48 89 c7             	mov    %rax,%rdi
    11dc:	b8 00 00 00 00       	mov    $0x0,%eax
    11e1:	e8 ca fe ff ff       	callq  10b0 <snprintf@plt>
    11e6:	89 45 e8             	mov    %eax,-0x18(%rbp)
    11e9:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    11ed:	48 89 c7             	mov    %rax,%rdi
    11f0:	e8 8b fe ff ff       	callq  1080 <puts@plt>
    11f5:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11f8:	89 c6                	mov    %eax,%esi
    11fa:	48 8d 3d 14 0e 00 00 	lea    0xe14(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    1201:	b8 00 00 00 00       	mov    $0x0,%eax
    1206:	e8 95 fe ff ff       	callq  10a0 <printf@plt>
    120b:	b8 00 00 00 00       	mov    $0x0,%eax
    1210:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1214:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    121b:	00 00 
    121d:	74 05                	je     1224 <main+0x7b>
    121f:	e8 6c fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    1224:	c9                   	leaveq 
    1225:	c3                   	retq   
