...
/app/bin_gccgcc10_O0/2023_07_08-Lesson-b:     file format elf64-x86-64
...
0000000000001229 <main>:
    ...
    1257:	e8 b4 fe ff ff       	callq  1110 <__isoc99_scanf@plt>
    125c:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    1260:	48 89 c7             	mov    %rax,%rdi
    1263:	e8 78 fe ff ff       	callq  10e0 <strlen@plt>
    1268:	48 83 c0 01          	add    $0x1,%rax
    126c:	48 89 c7             	mov    %rax,%rdi
    126f:	e8 8c fe ff ff       	callq  1100 <malloc@plt>
    1274:	48 89 45 d8          	mov    %rax,-0x28(%rbp)
    1278:	48 83 7d d8 00       	cmpq   $0x0,-0x28(%rbp)
    127d:	75 2a                	jne    12a9 <main+0x80>
    127f:	48 8b 05 9a 2d 00 00 	mov    0x2d9a(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    1286:	48 89 c1             	mov    %rax,%rcx
    1289:	ba 18 00 00 00       	mov    $0x18,%edx
    128e:	be 01 00 00 00       	mov    $0x1,%esi
    1293:	48 8d 3d 6d 0d 00 00 	lea    0xd6d(%rip),%rdi        # 2007 <_IO_stdin_used+0x7>
    129a:	e8 91 fe ff ff       	callq  1130 <fwrite@plt>
    129f:	bf 01 00 00 00       	mov    $0x1,%edi
    12a4:	e8 77 fe ff ff       	callq  1120 <exit@plt>
    12a9:	48 8d 55 e0          	lea    -0x20(%rbp),%rdx
    12ad:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    12b1:	48 89 d6             	mov    %rdx,%rsi
    12b4:	48 89 c7             	mov    %rax,%rdi
    12b7:	e8 04 fe ff ff       	callq  10c0 <strcpy@plt>
    12bc:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    12c0:	48 89 c7             	mov    %rax,%rdi
    12c3:	e8 08 fe ff ff       	callq  10d0 <puts@plt>
    12c8:	b8 00 00 00 00       	mov    $0x0,%eax
    12cd:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    12d1:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    12d8:	00 00 
    12da:	74 05                	je     12e1 <main+0xb8>
