...
/app/bin_gccgcc10_O0/2020_12_19-Lesson-a:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	f3 0f 10 05 d3 0e 00 	movss  0xed3(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    115c:	00 
    115d:	f3 0f 11 45 fc       	movss  %xmm0,-0x4(%rbp)
    1162:	c7 45 f8 02 00 00 00 	movl   $0x2,-0x8(%rbp)
    1169:	eb 37                	jmp    11a2 <main+0x59>
    ...
    1185:	f2 0f 10 05 ab 0e 00 	movsd  0xeab(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    118c:	00 
    ...
    119e:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11a2:	81 7d f8 e8 03 00 00 	cmpl   $0x3e8,-0x8(%rbp)
    11a9:	7e c0                	jle    116b <main+0x22>
    11ab:	66 0f ef db          	pxor   %xmm3,%xmm3
    11af:	f3 0f 5a 5d fc       	cvtss2sd -0x4(%rbp),%xmm3
    11b4:	66 48 0f 7e d8       	movq   %xmm3,%rax
    ...
    11ca:	e8 81 fe ff ff       	callq  1050 <printf@plt>
