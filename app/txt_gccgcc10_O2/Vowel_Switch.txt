...
/app/bin_gccgcc10_O2/Vowel_Switch:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10dc:	0f be 54 24 07       	movsbl 0x7(%rsp),%edx
    10e1:	89 d0                	mov    %edx,%eax
    10e3:	83 e8 41             	sub    $0x41,%eax
    10e6:	3c 34                	cmp    $0x34,%al
    10e8:	77 14                	ja     10fe <main+0x5e>
    10ea:	48 8d 0d 53 0f 00 00 	lea    0xf53(%rip),%rcx        # 2044 <_IO_stdin_used+0x44>
    10f1:	0f b6 c0             	movzbl %al,%eax
    10f4:	48 63 04 81          	movslq (%rcx,%rax,4),%rax
    10f8:	48 01 c8             	add    %rcx,%rax
    10fb:	3e ff e0             	notrack jmpq *%rax
    10fe:	48 8d 35 27 0f 00 00 	lea    0xf27(%rip),%rsi        # 202c <_IO_stdin_used+0x2c>
    1105:	bf 01 00 00 00       	mov    $0x1,%edi
    110a:	31 c0                	xor    %eax,%eax
    110c:	e8 6f ff ff ff       	callq  1080 <__printf_chk@plt>
    1111:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1116:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    111d:	00 00 
    111f:	75 1c                	jne    113d <main+0x9d>
    1121:	31 c0                	xor    %eax,%eax
    1123:	48 83 c4 18          	add    $0x18,%rsp
    1127:	c3                   	retq   
    1128:	48 8d 35 ec 0e 00 00 	lea    0xeec(%rip),%rsi        # 201b <_IO_stdin_used+0x1b>
    112f:	bf 01 00 00 00       	mov    $0x1,%edi
    1134:	31 c0                	xor    %eax,%eax
    1136:	e8 45 ff ff ff       	callq  1080 <__printf_chk@plt>
    113b:	eb d4                	jmp    1111 <main+0x71>
