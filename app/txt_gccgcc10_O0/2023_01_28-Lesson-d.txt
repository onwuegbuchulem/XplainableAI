...
/app/bin_gccgcc10_O0/2023_01_28-Lesson-d:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11e8:	f3 0f 10 0d 64 0e 00 	movss  0xe64(%rip),%xmm1        # 2054 <_IO_stdin_used+0x54>
    11ef:	00 
    ...
    1272:	f3 0f 10 0d da 0d 00 	movss  0xdda(%rip),%xmm1        # 2054 <_IO_stdin_used+0x54>
    1279:	00 
    ...
    12a5:	f3 48 0f 2a 45 f8    	cvtsi2ssq -0x8(%rbp),%xmm0
    12ab:	66 0f ef c9          	pxor   %xmm1,%xmm1
    12af:	f3 48 0f 2a 4d f0    	cvtsi2ssq -0x10(%rbp),%xmm1
    12b5:	f3 0f 5c c1          	subss  %xmm1,%xmm0
    12b9:	f3 0f 10 0d 93 0d 00 	movss  0xd93(%rip),%xmm1        # 2054 <_IO_stdin_used+0x54>
    12c0:	00 
    12c1:	f3 0f 5e c1          	divss  %xmm1,%xmm0
    12c5:	66 0f ef e4          	pxor   %xmm4,%xmm4
    12c9:	f3 0f 5a e0          	cvtss2sd %xmm0,%xmm4
    12cd:	66 48 0f 7e e0       	movq   %xmm4,%rax
    12d2:	66 48 0f 6e c0       	movq   %rax,%xmm0
    12d7:	48 8d 3d 58 0d 00 00 	lea    0xd58(%rip),%rdi        # 2036 <_IO_stdin_used+0x36>
    12de:	b8 01 00 00 00       	mov    $0x1,%eax
    12e3:	e8 b8 fd ff ff       	callq  10a0 <printf@plt>
