...
/app/bin_gccgcc10_O0/01_structure:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 e0 9f 11 00 00 	movl   $0x119f,-0x20(%rbp)
    118b:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    118f:	48 83 c0 08          	add    $0x8,%rax
    1193:	c7 00 48 61 72 72    	movl   $0x72726148,(%rax)
    1199:	66 c7 40 04 79 00    	movw   $0x79,0x4(%rax)
    119f:	f3 0f 10 05 69 0e 00 	movss  0xe69(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    11a6:	00 
    11a7:	f3 0f 11 45 e4       	movss  %xmm0,-0x1c(%rbp)
    11ac:	f3 0f 10 45 e4       	movss  -0x1c(%rbp),%xmm0
    11b1:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11b5:	f3 0f 5a c8          	cvtss2sd %xmm0,%xmm1
    11b9:	66 48 0f 7e c9       	movq   %xmm1,%rcx
    11be:	8b 45 e0             	mov    -0x20(%rbp),%eax
    11c1:	48 8d 55 e0          	lea    -0x20(%rbp),%rdx
    11c5:	48 83 c2 08          	add    $0x8,%rdx
    11c9:	66 48 0f 6e c1       	movq   %rcx,%xmm0
    11ce:	89 c6                	mov    %eax,%esi
    11d0:	48 8d 3d 2d 0e 00 00 	lea    0xe2d(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11d7:	b8 01 00 00 00       	mov    $0x1,%eax
    11dc:	e8 8f fe ff ff       	callq  1070 <printf@plt>
    11e1:	b8 00 00 00 00       	mov    $0x0,%eax
    11e6:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    11ea:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    11f1:	00 00 
    11f3:	74 05                	je     11fa <main+0x91>
    11f5:	e8 66 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    11fa:	c9                   	leaveq 
    11fb:	c3                   	retq   
