...
/app/bin_gccgcc10_O0/2024_06-Exercise-b:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d3:	e8 d8 fe ff ff       	callq  10b0 <exit@plt>
    11d8:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    11dc:	48 83 c0 08          	add    $0x8,%rax
    11e0:	48 8b 00             	mov    (%rax),%rax
    11e3:	ba 0a 00 00 00       	mov    $0xa,%edx
    11e8:	be 00 00 00 00       	mov    $0x0,%esi
    11ed:	48 89 c7             	mov    %rax,%rdi
    11f0:	e8 ab fe ff ff       	callq  10a0 <strtol@plt>
    11f5:	89 45 f8             	mov    %eax,-0x8(%rbp)
    11f8:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    11fc:	48 83 c0 10          	add    $0x10,%rax
    1200:	48 8b 00             	mov    (%rax),%rax
    1203:	ba 0a 00 00 00       	mov    $0xa,%edx
    ...
    1218:	8b 55 f8             	mov    -0x8(%rbp),%edx
    121b:	8b 45 fc             	mov    -0x4(%rbp),%eax
    121e:	8d 0c 02             	lea    (%rdx,%rax,1),%ecx
    1221:	8b 55 fc             	mov    -0x4(%rbp),%edx
    1224:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1227:	89 c6                	mov    %eax,%esi
    1229:	48 8d 3d e5 0d 00 00 	lea    0xde5(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
