...
/app/bin_gccgcc10_O0/dynamicMemoryAllocation:     file format elf64-x86-64
...
0000000000001080 <snprintf@plt>:
    ...
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <snprintf@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    1195:	bf 00 01 00 00       	mov    $0x100,%edi
    119a:	e8 f1 fe ff ff       	callq  1090 <malloc@plt>
    119f:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11a3:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11a7:	48 8d 0d 56 0e 00 00 	lea    0xe56(%rip),%rcx        # 2004 <_IO_stdin_used+0x4>
    11ae:	48 8d 15 5b 0e 00 00 	lea    0xe5b(%rip),%rdx        # 2010 <_IO_stdin_used+0x10>
    11b5:	be 00 01 00 00       	mov    $0x100,%esi
    11ba:	48 89 c7             	mov    %rax,%rdi
    11bd:	b8 00 00 00 00       	mov    $0x0,%eax
    11c2:	e8 b9 fe ff ff       	callq  1080 <snprintf@plt>
    ...
    11da:	e8 91 fe ff ff       	callq  1070 <printf@plt>
    11df:	90                   	nop
    11e0:	c9                   	leaveq 
    11e1:	c3                   	retq   
