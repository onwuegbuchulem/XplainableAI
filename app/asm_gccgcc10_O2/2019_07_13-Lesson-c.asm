...
/app/bin_gccgcc10_O2/2019_07_13-Lesson-c:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10bf:	4c 8d 64 24 16       	lea    0x16(%rsp),%r12
    10c4:	b8 30 00 00 00       	mov    $0x30,%eax
    10c9:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    10ce:	4c 89 e7             	mov    %r12,%rdi
    10d1:	66 89 44 24 16       	mov    %ax,0x16(%rsp)
    10d6:	e8 a5 ff ff ff       	callq  1080 <strtol@plt>
    10db:	4c 89 e2             	mov    %r12,%rdx
    10de:	bf 01 00 00 00       	mov    $0x1,%edi
    10e3:	48 8d 35 1a 0f 00 00 	lea    0xf1a(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10ea:	48 89 c1             	mov    %rax,%rcx
    10ed:	31 c0                	xor    %eax,%eax
    10ef:	e8 9c ff ff ff       	callq  1090 <__printf_chk@plt>
    10f4:	4c 39 64 24 08       	cmp    %r12,0x8(%rsp)
    10f9:	74 19                	je     1114 <main+0x74>
    10fb:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1100:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1107:	00 00 
    1109:	75 21                	jne    112c <main+0x8c>
    110b:	48 83 c4 20          	add    $0x20,%rsp
    110f:	31 c0                	xor    %eax,%eax
    1111:	41 5c                	pop    %r12
    1113:	c3                   	retq   
    1114:	4c 89 e2             	mov    %r12,%rdx
    1117:	48 8d 35 02 0f 00 00 	lea    0xf02(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    111e:	bf 01 00 00 00       	mov    $0x1,%edi
    1123:	31 c0                	xor    %eax,%eax
    1125:	e8 66 ff ff ff       	callq  1090 <__printf_chk@plt>
    112a:	eb cf                	jmp    10fb <main+0x5b>
