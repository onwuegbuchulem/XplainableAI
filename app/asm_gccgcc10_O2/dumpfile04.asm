...
/app/bin_gccgcc10_O2/dumpfile04:     file format elf64-x86-64
...
00000000000011a0 <main>:
    ...
    1322:	e8 a9 02 00 00       	callq  15d0 <help>
...
0000000000001380 <_start>:
    ...
    1391:	50                   	push   %rax
    1392:	54                   	push   %rsp
    1393:	4c 8d 05 06 03 00 00 	lea    0x306(%rip),%r8        # 16a0 <__libc_csu_fini>
    139a:	48 8d 0d 8f 02 00 00 	lea    0x28f(%rip),%rcx        # 1630 <__libc_csu_init>
...
0000000000001470 <line_out>:
    ...
    15af:	48 8b 35 6a 2a 00 00 	mov    0x2a6a(%rip),%rsi        # 4020 <stdout@@GLIBC_2.2.5>
    15b6:	bf 20 00 00 00       	mov    $0x20,%edi
    15bb:	e8 70 fb ff ff       	callq  1130 <putc@plt>
    15c0:	eb a6                	jmp    1568 <line_out+0xf8>
    15c2:	66 66 2e 0f 1f 84 00 	data16 nopw %cs:0x0(%rax,%rax,1)
    15c9:	00 00 00 00 
    15cd:	0f 1f 00             	nopl   (%rax)

00000000000015d0 <help>:
    15d0:	f3 0f 1e fa          	endbr64 
    15d4:	50                   	push   %rax
    15d5:	58                   	pop    %rax
    15d6:	48 8d 3d b3 0a 00 00 	lea    0xab3(%rip),%rdi        # 2090 <_IO_stdin_used+0x90>
    15dd:	48 83 ec 08          	sub    $0x8,%rsp
    15e1:	e8 0a fb ff ff       	callq  10f0 <puts@plt>
    15e6:	48 8d 3d cb 0a 00 00 	lea    0xacb(%rip),%rdi        # 20b8 <_IO_stdin_used+0xb8>
    15ed:	e8 fe fa ff ff       	callq  10f0 <puts@plt>
    15f2:	48 8d 3d 1b 0a 00 00 	lea    0xa1b(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    15f9:	e8 f2 fa ff ff       	callq  10f0 <puts@plt>
    15fe:	48 8d 3d 18 0a 00 00 	lea    0xa18(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    1605:	e8 e6 fa ff ff       	callq  10f0 <puts@plt>
    160a:	48 8d 3d cf 0a 00 00 	lea    0xacf(%rip),%rdi        # 20e0 <_IO_stdin_used+0xe0>
    1611:	e8 da fa ff ff       	callq  10f0 <puts@plt>
    1616:	48 8d 3d 16 0a 00 00 	lea    0xa16(%rip),%rdi        # 2033 <_IO_stdin_used+0x33>
    161d:	e8 ce fa ff ff       	callq  10f0 <puts@plt>
    1622:	bf 01 00 00 00       	mov    $0x1,%edi
    1627:	e8 54 fb ff ff       	callq  1180 <exit@plt>
