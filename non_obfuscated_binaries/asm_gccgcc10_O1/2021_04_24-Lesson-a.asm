...
/app/bin_gccgcc10_O1/2021_04_24-Lesson-a:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11b4:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    ...
    11d0:	00 00 
    11d2:	48 89 84 24 08 20 00 	mov    %rax,0x2008(%rsp)
    11d9:	00 
    11da:	31 c0                	xor    %eax,%eax
    11dc:	48 89 e6             	mov    %rsp,%rsi
    11df:	48 8b 3d 2a 2e 00 00 	mov    0x2e2a(%rip),%rdi        # 4010 <stdout@@GLIBC_2.2.5>
    11e6:	e8 b5 fe ff ff       	callq  10a0 <setbuf@plt>
    11eb:	48 8d 3d 12 0e 00 00 	lea    0xe12(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11f2:	e8 89 fe ff ff       	callq  1080 <puts@plt>
    11f7:	48 8d 3d 06 0e 00 00 	lea    0xe06(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11fe:	e8 7d fe ff ff       	callq  1080 <puts@plt>
    1203:	48 8d 3d 03 0e 00 00 	lea    0xe03(%rip),%rdi        # 200d <_IO_stdin_used+0xd>
    120a:	e8 71 fe ff ff       	callq  1080 <puts@plt>
    120f:	48 8b 3d 0a 2e 00 00 	mov    0x2e0a(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    1216:	e8 95 fe ff ff       	callq  10b0 <getc@plt>
    121b:	48 8d 3d ef 0d 00 00 	lea    0xdef(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    1222:	e8 59 fe ff ff       	callq  1080 <puts@plt>
    1227:	48 8b 84 24 08 20 00 	mov    0x2008(%rsp),%rax
    122e:	00 
    122f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1236:	00 00 
    1238:	75 0d                	jne    1247 <main+0x9e>
    123a:	b8 00 00 00 00       	mov    $0x0,%eax
    123f:	48 81 c4 18 20 00 00 	add    $0x2018,%rsp
    1246:	c3                   	retq   
    1247:	e8 44 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
