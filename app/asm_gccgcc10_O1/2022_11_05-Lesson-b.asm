...
/app/bin_gccgcc10_O1/2022_11_05-Lesson-b:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11b3:	e8 d8 fe ff ff       	callq  1090 <time@plt>
    11b8:	48 89 c7             	mov    %rax,%rdi
    11bb:	e8 c0 fe ff ff       	callq  1080 <srand@plt>
    11c0:	e8 eb fe ff ff       	callq  10b0 <rand@plt>
    11c5:	99                   	cltd   
    11c6:	c1 ea 1a             	shr    $0x1a,%edx
    11c9:	8d 1c 10             	lea    (%rax,%rdx,1),%ebx
    11cc:	83 e3 3f             	and    $0x3f,%ebx
    11cf:	29 d3                	sub    %edx,%ebx
    11d1:	89 da                	mov    %ebx,%edx
    ...
    11e4:	e8 b7 fe ff ff       	callq  10a0 <__printf_chk@plt>
    11e9:	89 d8                	mov    %ebx,%eax
    11eb:	c1 f8 1f             	sar    $0x1f,%eax
    11ee:	c1 e8 1d             	shr    $0x1d,%eax
    11f1:	8d 0c 03             	lea    (%rbx,%rax,1),%ecx
    11f4:	83 e1 07             	and    $0x7,%ecx
    11f7:	29 c1                	sub    %eax,%ecx
    11f9:	29 cb                	sub    %ecx,%ebx
    11fb:	8d 53 07             	lea    0x7(%rbx),%edx
    11fe:	0f 49 d3             	cmovns %ebx,%edx
    1201:	c1 fa 03             	sar    $0x3,%edx
    1204:	48 8d 35 15 0e 00 00 	lea    0xe15(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
