...
/app/bin_gccgcc10_O2/07_problem7:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1064:	55                   	push   %rbp
    1065:	bd 01 00 00 00       	mov    $0x1,%ebp
    106a:	53                   	push   %rbx
    106b:	48 83 ec 08          	sub    $0x8,%rsp
    106f:	31 db                	xor    %ebx,%ebx
    1071:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    1078:	bf 2a 00 00 00       	mov    $0x2a,%edi
    107d:	83 c3 01             	add    $0x1,%ebx
    1080:	e8 cb ff ff ff       	callq  1050 <putchar@plt>
    1085:	39 eb                	cmp    %ebp,%ebx
    1087:	75 ef                	jne    1078 <main+0x18>
    1089:	bf 0a 00 00 00       	mov    $0xa,%edi
    108e:	8d 6b 02             	lea    0x2(%rbx),%ebp
    1091:	e8 ba ff ff ff       	callq  1050 <putchar@plt>
    1096:	83 fb 05             	cmp    $0x5,%ebx
    1099:	75 d4                	jne    106f <main+0xf>
