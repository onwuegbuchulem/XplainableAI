...
/app/bin_gccgcc10_O0/23_sr:     file format elf64-x86-64
...
0000000000001189 <babylonian>:
    ...
    119d:	f2 0f 10 05 93 0e 00 	movsd  0xe93(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    11a4:	00 
    ...
    11bb:	eb 2e                	jmp    11eb <babylonian+0x62>
    11bd:	f2 0f 10 45 f8       	movsd  -0x8(%rbp),%xmm0
    11c2:	f2 0f 58 45 f0       	addsd  -0x10(%rbp),%xmm0
    11c7:	f2 0f 10 0d 71 0e 00 	movsd  0xe71(%rip),%xmm1        # 2040 <_IO_stdin_used+0x40>
    11ce:	00 
    ...
    11f1:	7c ca                	jl     11bd <babylonian+0x34>
...
0000000000001204 <main>:
    ...
    125c:	eb 36                	jmp    1294 <main+0x90>
    125e:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1262:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1267:	e8 1d ff ff ff       	callq  1189 <babylonian>
    126c:	66 48 0f 7e c0       	movq   %xmm0,%rax
    1271:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    1275:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1279:	66 48 0f 6e c0       	movq   %rax,%xmm0
    127e:	48 8d 3d a0 0d 00 00 	lea    0xda0(%rip),%rdi        # 2025 <_IO_stdin_used+0x25>
    1285:	b8 01 00 00 00       	mov    $0x1,%eax
    128a:	e8 f1 fd ff ff       	callq  1080 <printf@plt>
    128f:	b8 00 00 00 00       	mov    $0x0,%eax
    1294:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1298:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    129f:	00 00 
    12a1:	74 05                	je     12a8 <main+0xa4>
    12a3:	e8 c8 fd ff ff       	callq  1070 <__stack_chk_fail@plt>
    12a8:	c9                   	leaveq 
    12a9:	c3                   	retq   
