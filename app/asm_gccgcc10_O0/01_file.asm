...
/app/bin_gccgcc10_O0/01_file:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11eb:	48 8d 3d 14 0e 00 00 	lea    0xe14(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    11f2:	e8 d9 fe ff ff       	callq  10d0 <fopen@plt>
    11f7:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11fb:	48 8d 55 ec          	lea    -0x14(%rbp),%rdx
    11ff:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1203:	48 8d 35 06 0e 00 00 	lea    0xe06(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    120a:	48 89 c7             	mov    %rax,%rdi
    120d:	b8 00 00 00 00       	mov    $0x0,%eax
    1212:	e8 79 fe ff ff       	callq  1090 <__isoc99_fscanf@plt>
    1217:	8b 45 ec             	mov    -0x14(%rbp),%eax
    121a:	89 c6                	mov    %eax,%esi
    121c:	48 8d 3d f0 0d 00 00 	lea    0xdf0(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    1223:	b8 00 00 00 00       	mov    $0x0,%eax
    1228:	e8 93 fe ff ff       	callq  10c0 <printf@plt>
    122d:	48 8d 55 ec          	lea    -0x14(%rbp),%rdx
    1231:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1235:	48 8d 35 d4 0d 00 00 	lea    0xdd4(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    123c:	48 89 c7             	mov    %rax,%rdi
    123f:	b8 00 00 00 00       	mov    $0x0,%eax
    1244:	e8 47 fe ff ff       	callq  1090 <__isoc99_fscanf@plt>
    1249:	8b 45 ec             	mov    -0x14(%rbp),%eax
    124c:	89 c6                	mov    %eax,%esi
    124e:	48 8d 3d be 0d 00 00 	lea    0xdbe(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    ...
    1266:	e8 35 fe ff ff       	callq  10a0 <fclose@plt>
    126b:	b8 00 00 00 00       	mov    $0x0,%eax
    1270:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1274:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    127b:	00 00 
    127d:	74 05                	je     1284 <main+0xbb>
    127f:	e8 2c fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
    1284:	c9                   	leaveq 
    1285:	c3                   	retq   
