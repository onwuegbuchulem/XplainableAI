...
/app/bin_gccgcc10_O1/25_phi:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d fe 00 00 00 	lea    0xfe(%rip),%rdi        # 1186 <main>
...
0000000000001149 <phi>:
    ...
    114d:	53                   	push   %rbx
    114e:	66 48 0f 7e c3       	movq   %xmm0,%rbx
    1153:	85 ff                	test   %edi,%edi
    1155:	75 07                	jne    115e <phi+0x15>
    1157:	66 48 0f 6e c3       	movq   %rbx,%xmm0
    115c:	5b                   	pop    %rbx
    115d:	c3                   	retq   
    115e:	83 ef 01             	sub    $0x1,%edi
    1161:	e8 e3 ff ff ff       	callq  1149 <phi>
    1166:	66 0f 28 c8          	movapd %xmm0,%xmm1
    116a:	f2 0f 10 05 9e 0e 00 	movsd  0xe9e(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    1171:	00 
    1172:	f2 0f 5e c1          	divsd  %xmm1,%xmm0
    1176:	66 48 0f 6e d3       	movq   %rbx,%xmm2
    117b:	f2 0f 58 d0          	addsd  %xmm0,%xmm2
    117f:	66 48 0f 7e d3       	movq   %xmm2,%rbx
    1184:	eb d1                	jmp    1157 <phi+0xe>

0000000000001186 <main>:
    1186:	f3 0f 1e fa          	endbr64 
    118a:	48 83 ec 08          	sub    $0x8,%rsp
    118e:	bf 0f 00 00 00       	mov    $0xf,%edi
    1193:	f2 0f 10 05 75 0e 00 	movsd  0xe75(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    119a:	00 
    119b:	e8 a9 ff ff ff       	callq  1149 <phi>
    ...
    11b1:	e8 9a fe ff ff       	callq  1050 <__printf_chk@plt>
