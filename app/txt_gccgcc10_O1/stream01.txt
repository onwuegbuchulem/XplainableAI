...
/app/bin_gccgcc10_O1/stream01:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    116d:	53                   	push   %rbx
    116e:	48 8d 35 8f 0e 00 00 	lea    0xe8f(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1175:	bf 01 00 00 00       	mov    $0x1,%edi
    117a:	b8 00 00 00 00       	mov    $0x0,%eax
    117f:	e8 dc fe ff ff       	callq  1060 <__printf_chk@plt>
    1184:	48 8b 3d 85 2e 00 00 	mov    0x2e85(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    118b:	e8 e0 fe ff ff       	callq  1070 <getc@plt>
    ...
    11a3:	e8 b8 fe ff ff       	callq  1060 <__printf_chk@plt>
    11a8:	48 8b 3d 61 2e 00 00 	mov    0x2e61(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    11af:	e8 bc fe ff ff       	callq  1070 <getc@plt>
    11b4:	89 c1                	mov    %eax,%ecx
    11b6:	89 da                	mov    %ebx,%edx
    11b8:	48 8d 35 54 0e 00 00 	lea    0xe54(%rip),%rsi        # 2013 <_IO_stdin_used+0x13>
    11bf:	bf 01 00 00 00       	mov    $0x1,%edi
    11c4:	b8 00 00 00 00       	mov    $0x0,%eax
    11c9:	e8 92 fe ff ff       	callq  1060 <__printf_chk@plt>
