...
/app/bin_gccgcc10_O1/Star_Pattern:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11f1:	4c 8d 25 27 0e 00 00 	lea    0xe27(%rip),%r12        # 201f <_IO_stdin_used+0x1f>
    11f8:	83 7c 24 04 00       	cmpl   $0x0,0x4(%rsp)
    11fd:	7f 4a                	jg     1249 <main+0xa0>
    11ff:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1204:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    120b:	00 00 
    120d:	75 45                	jne    1254 <main+0xab>
    ...
    122a:	e8 71 fe ff ff       	callq  10a0 <__printf_chk@plt>
    122f:	83 c3 01             	add    $0x1,%ebx
    1232:	39 eb                	cmp    %ebp,%ebx
    1234:	7e e7                	jle    121d <main+0x74>
    1236:	bf 0a 00 00 00       	mov    $0xa,%edi
    123b:	e8 40 fe ff ff       	callq  1080 <putchar@plt>
    1240:	83 c5 01             	add    $0x1,%ebp
    1243:	39 6c 24 04          	cmp    %ebp,0x4(%rsp)
    1247:	7c b6                	jl     11ff <main+0x56>
    1249:	bb 01 00 00 00       	mov    $0x1,%ebx
    124e:	85 ed                	test   %ebp,%ebp
    1250:	7f cb                	jg     121d <main+0x74>
    1252:	eb e2                	jmp    1236 <main+0x8d>
