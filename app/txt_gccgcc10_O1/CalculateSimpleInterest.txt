...
/app/bin_gccgcc10_O1/CalculateSimpleInterest:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a1:	8b 54 24 0c          	mov    0xc(%rsp),%edx
    11a5:	48 8d 35 58 0e 00 00 	lea    0xe58(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11ac:	bf 01 00 00 00       	mov    $0x1,%edi
    11b1:	e8 ca fe ff ff       	callq  1080 <__printf_chk@plt>
    11b6:	48 8d 74 24 0c       	lea    0xc(%rsp),%rsi
    11bb:	48 8d 3d 9a 0e 00 00 	lea    0xe9a(%rip),%rdi        # 205c <_IO_stdin_used+0x5c>
    11c2:	b8 00 00 00 00       	mov    $0x0,%eax
    11c7:	e8 c4 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cc:	8b 54 24 10          	mov    0x10(%rsp),%edx
    11d0:	48 8d 35 44 0e 00 00 	lea    0xe44(%rip),%rsi        # 201b <_IO_stdin_used+0x1b>
    11d7:	bf 01 00 00 00       	mov    $0x1,%edi
    11dc:	b8 00 00 00 00       	mov    $0x0,%eax
    11e1:	e8 9a fe ff ff       	callq  1080 <__printf_chk@plt>
    11e6:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    11eb:	48 8d 3d 6a 0e 00 00 	lea    0xe6a(%rip),%rdi        # 205c <_IO_stdin_used+0x5c>
    11f2:	b8 00 00 00 00       	mov    $0x0,%eax
    11f7:	e8 94 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11fc:	8b 54 24 14          	mov    0x14(%rsp),%edx
    1200:	48 8d 35 2a 0e 00 00 	lea    0xe2a(%rip),%rsi        # 2031 <_IO_stdin_used+0x31>
    1207:	bf 01 00 00 00       	mov    $0x1,%edi
    120c:	b8 00 00 00 00       	mov    $0x0,%eax
    1211:	e8 6a fe ff ff       	callq  1080 <__printf_chk@plt>
    1216:	48 8d 74 24 14       	lea    0x14(%rsp),%rsi
    121b:	48 8d 3d 3a 0e 00 00 	lea    0xe3a(%rip),%rdi        # 205c <_IO_stdin_used+0x5c>
    1222:	b8 00 00 00 00       	mov    $0x0,%eax
    1227:	e8 64 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    122c:	8b 44 24 0c          	mov    0xc(%rsp),%eax
    1230:	0f af 44 24 10       	imul   0x10(%rsp),%eax
    1235:	0f af 44 24 14       	imul   0x14(%rsp),%eax
    123a:	48 63 d0             	movslq %eax,%rdx
    123d:	48 69 d2 1f 85 eb 51 	imul   $0x51eb851f,%rdx,%rdx
    1244:	48 c1 fa 25          	sar    $0x25,%rdx
    1248:	c1 f8 1f             	sar    $0x1f,%eax
    124b:	29 c2                	sub    %eax,%edx
    124d:	48 8d 35 f5 0d 00 00 	lea    0xdf5(%rip),%rsi        # 2049 <_IO_stdin_used+0x49>
    1254:	bf 01 00 00 00       	mov    $0x1,%edi
    1259:	b8 00 00 00 00       	mov    $0x0,%eax
    125e:	e8 1d fe ff ff       	callq  1080 <__printf_chk@plt>
    1263:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1268:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    126f:	00 00 
    1271:	75 0a                	jne    127d <main+0xf4>
    1273:	b8 00 00 00 00       	mov    $0x0,%eax
    1278:	48 83 c4 28          	add    $0x28,%rsp
    127c:	c3                   	retq   
    127d:	e8 ee fd ff ff       	callq  1070 <__stack_chk_fail@plt>
