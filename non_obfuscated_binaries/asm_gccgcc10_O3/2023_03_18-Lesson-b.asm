...
/app/bin_gccgcc10_O3/2023_03_18-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	55                   	push   %rbp
    10a5:	53                   	push   %rbx
    10a6:	48 83 ec 18          	sub    $0x18,%rsp
    10aa:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10b1:	00 00 
    10b3:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10b8:	31 c0                	xor    %eax,%eax
    10ba:	48 89 e3             	mov    %rsp,%rbx
    10bd:	48 89 df             	mov    %rbx,%rdi
    10c0:	e8 bb ff ff ff       	callq  1080 <time@plt>
    10c5:	48 8b 2c 24          	mov    (%rsp),%rbp
    10c9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    10d0:	48 89 df             	mov    %rbx,%rdi
    10d3:	e8 a8 ff ff ff       	callq  1080 <time@plt>
    10d8:	48 8b 14 24          	mov    (%rsp),%rdx
    10dc:	48 39 ea             	cmp    %rbp,%rdx
    10df:	74 ef                	je     10d0 <main+0x30>
    ...
    10f4:	48 8b 2c 24          	mov    (%rsp),%rbp
    10f8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    10ff:	00 
    1100:	48 89 df             	mov    %rbx,%rdi
    1103:	e8 78 ff ff ff       	callq  1080 <time@plt>
    1108:	48 8b 14 24          	mov    (%rsp),%rdx
    110c:	48 39 ea             	cmp    %rbp,%rdx
    110f:	74 ef                	je     1100 <main+0x60>
    1111:	31 c0                	xor    %eax,%eax
    1113:	48 8d 35 ea 0e 00 00 	lea    0xeea(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    111a:	bf 01 00 00 00       	mov    $0x1,%edi
    111f:	e8 6c ff ff ff       	callq  1090 <__printf_chk@plt>
    1124:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1129:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1130:	00 00 
    1132:	75 09                	jne    113d <main+0x9d>
    1134:	48 83 c4 18          	add    $0x18,%rsp
    1138:	31 c0                	xor    %eax,%eax
    113a:	5b                   	pop    %rbx
    113b:	5d                   	pop    %rbp
    113c:	c3                   	retq   
    113d:	e8 2e ff ff ff       	callq  1070 <__stack_chk_fail@plt>
