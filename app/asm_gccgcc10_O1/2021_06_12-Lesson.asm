...
/app/bin_gccgcc10_O1/2021_06_12-Lesson:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    114f:	7e 4c                	jle    119d <main+0x54>
    1151:	41 55                	push   %r13
    1153:	41 54                	push   %r12
    1155:	55                   	push   %rbp
    1156:	53                   	push   %rbx
    1157:	48 83 ec 08          	sub    $0x8,%rsp
    115b:	49 89 f4             	mov    %rsi,%r12
    115e:	89 fd                	mov    %edi,%ebp
    1160:	bb 00 00 00 00       	mov    $0x0,%ebx
    1165:	4c 8d 2d 98 0e 00 00 	lea    0xe98(%rip),%r13        # 2004 <_IO_stdin_used+0x4>
    116c:	49 8b 0c dc          	mov    (%r12,%rbx,8),%rcx
    1170:	89 da                	mov    %ebx,%edx
    1172:	4c 89 ee             	mov    %r13,%rsi
    1175:	bf 01 00 00 00       	mov    $0x1,%edi
    117a:	b8 00 00 00 00       	mov    $0x0,%eax
    117f:	e8 cc fe ff ff       	callq  1050 <__printf_chk@plt>
    1184:	48 83 c3 01          	add    $0x1,%rbx
    1188:	48 39 eb             	cmp    %rbp,%rbx
    118b:	75 df                	jne    116c <main+0x23>
