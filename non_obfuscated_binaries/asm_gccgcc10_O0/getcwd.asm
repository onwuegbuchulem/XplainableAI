...
/app/bin_gccgcc10_O0/getcwd:     file format elf64-x86-64
...
0000000000001090 <getcwd@plt>:
    1090:	f3 0f 1e fa          	endbr64 
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <getcwd@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    11c3:	be 00 20 00 00       	mov    $0x2000,%esi
    11c8:	48 89 c7             	mov    %rax,%rdi
    11cb:	e8 c0 fe ff ff       	callq  1090 <getcwd@plt>
    11d0:	48 8d 85 f0 df ff ff 	lea    -0x2010(%rbp),%rax
    ...
    11e6:	e8 95 fe ff ff       	callq  1080 <printf@plt>
    11eb:	b8 00 00 00 00       	mov    $0x0,%eax
    11f0:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11f4:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11fb:	00 00 
    11fd:	74 05                	je     1204 <main+0x7b>
    11ff:	e8 6c fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1204:	c9                   	leaveq 
    1205:	c3                   	retq   
