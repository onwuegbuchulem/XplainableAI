...
/app/bin_gccgcc10_O0/2019_02_02-Lesson-c:     file format elf64-x86-64
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d 06 01 00 00 	lea    0x106(%rip),%rdi        # 11ee <main>
...
00000000000011c3 <output>:
    ...
    11e6:	e8 a5 fe ff ff       	callq  1090 <printf@plt>
    11eb:	90                   	nop
    11ec:	c9                   	leaveq 
    11ed:	c3                   	retq   

00000000000011ee <main>:
    11ee:	f3 0f 1e fa          	endbr64 
    11f2:	55                   	push   %rbp
    11f3:	48 89 e5             	mov    %rsp,%rbp
    11f6:	48 83 ec 10          	sub    $0x10,%rsp
    11fa:	bf 04 00 00 00       	mov    $0x4,%edi
    11ff:	e8 9c fe ff ff       	callq  10a0 <malloc@plt>
    1204:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1208:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
    120d:	75 16                	jne    1225 <main+0x37>
    120f:	48 8d 3d 02 0e 00 00 	lea    0xe02(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    1216:	e8 65 fe ff ff       	callq  1080 <puts@plt>
    121b:	bf 01 00 00 00       	mov    $0x1,%edi
    1220:	e8 8b fe ff ff       	callq  10b0 <exit@plt>
    1225:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1229:	c7 00 66 61 74 00    	movl   $0x746166,(%rax)
    122f:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1233:	48 89 c7             	mov    %rax,%rdi
    1236:	e8 88 ff ff ff       	callq  11c3 <output>
    123b:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    123f:	48 89 c7             	mov    %rax,%rdi
    1242:	e8 62 ff ff ff       	callq  11a9 <change>
    1247:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    124b:	48 89 c7             	mov    %rax,%rdi
    124e:	e8 70 ff ff ff       	callq  11c3 <output>
