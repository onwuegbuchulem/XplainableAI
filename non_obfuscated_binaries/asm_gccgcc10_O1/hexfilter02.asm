...
/app/bin_gccgcc10_O1/hexfilter02:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118f:	55                   	push   %rbp
    1190:	53                   	push   %rbx
    1191:	4c 8d 25 6c 0e 00 00 	lea    0xe6c(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    1198:	bd 00 00 00 00       	mov    $0x0,%ebp
    119d:	48 8b 3d 7c 2e 00 00 	mov    0x2e7c(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    11a4:	e8 e7 fe ff ff       	callq  1090 <getc@plt>
    11a9:	89 c3                	mov    %eax,%ebx
    11ab:	83 f8 ff             	cmp    $0xffffffff,%eax
    11ae:	74 34                	je     11e4 <main+0x5b>
    11b0:	89 da                	mov    %ebx,%edx
    11b2:	4c 89 e6             	mov    %r12,%rsi
    11b5:	bf 01 00 00 00       	mov    $0x1,%edi
    11ba:	b8 00 00 00 00       	mov    $0x0,%eax
    11bf:	e8 bc fe ff ff       	callq  1080 <__printf_chk@plt>
    11c4:	83 c5 03             	add    $0x3,%ebp
    11c7:	83 fd 4d             	cmp    $0x4d,%ebp
    11ca:	7f 05                	jg     11d1 <main+0x48>
    11cc:	83 fb 0a             	cmp    $0xa,%ebx
    11cf:	75 cc                	jne    119d <main+0x14>
    11d1:	48 8b 35 38 2e 00 00 	mov    0x2e38(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11d8:	bf 0a 00 00 00       	mov    $0xa,%edi
    11dd:	e8 8e fe ff ff       	callq  1070 <putc@plt>
    11e2:	eb b4                	jmp    1198 <main+0xf>
