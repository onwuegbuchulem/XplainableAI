...
/app/bin_gccgcc10_O0/04_fgetc_fputc:     file format elf64-x86-64
...
0000000000001060 <fputc@plt>:
    ...
    1064:	f2 ff 25 5d 2f 00 00 	bnd jmpq *0x2f5d(%rip)        # 3fc8 <fputc@GLIBC_2.2.5>
    106b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001070 <fopen@plt>:
    1070:	f3 0f 1e fa          	endbr64 
    1074:	f2 ff 25 55 2f 00 00 	bnd jmpq *0x2f55(%rip)        # 3fd0 <fopen@GLIBC_2.2.5>
...
0000000000001169 <main>:
    ...
    1175:	48 8d 35 88 0e 00 00 	lea    0xe88(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    117c:	48 8d 3d 83 0e 00 00 	lea    0xe83(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1183:	e8 e8 fe ff ff       	callq  1070 <fopen@plt>
    1188:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    118c:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1190:	48 89 c6             	mov    %rax,%rsi
    1193:	bf 63 00 00 00       	mov    $0x63,%edi
    1198:	e8 c3 fe ff ff       	callq  1060 <fputc@plt>
