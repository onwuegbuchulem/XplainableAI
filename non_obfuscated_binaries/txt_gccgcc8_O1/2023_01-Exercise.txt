...
/app/bin_gccgcc8_O1/2023_01-Exercise:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    120f:	55                   	push   %rbp
    1210:	53                   	push   %rbx
    1211:	83 ff 01             	cmp    $0x1,%edi
    1214:	7e 66                	jle    127c <main+0x73>
    1216:	4c 8b 66 08          	mov    0x8(%rsi),%r12
    121a:	48 8d 35 f6 0d 00 00 	lea    0xdf6(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    1221:	4c 89 e7             	mov    %r12,%rdi
    1224:	e8 d7 fe ff ff       	callq  1100 <fopen@plt>
    1229:	48 89 c3             	mov    %rax,%rbx
    122c:	48 85 c0             	test   %rax,%rax
    122f:	74 5e                	je     128f <main+0x86>
    1231:	ba 02 00 00 00       	mov    $0x2,%edx
    1236:	be 00 00 00 00       	mov    $0x0,%esi
    123b:	48 89 c7             	mov    %rax,%rdi
    123e:	e8 9d fe ff ff       	callq  10e0 <fseek@plt>
    1243:	48 89 df             	mov    %rbx,%rdi
    1246:	e8 85 fe ff ff       	callq  10d0 <ftell@plt>
    124b:	48 89 c5             	mov    %rax,%rbp
    124e:	48 89 df             	mov    %rbx,%rdi
    1251:	e8 6a fe ff ff       	callq  10c0 <fclose@plt>
    1256:	48 89 e9             	mov    %rbp,%rcx
    1259:	4c 89 e2             	mov    %r12,%rdx
    125c:	48 8d 35 c9 0d 00 00 	lea    0xdc9(%rip),%rsi        # 202c <_IO_stdin_used+0x2c>
    1263:	bf 01 00 00 00       	mov    $0x1,%edi
    1268:	b8 00 00 00 00       	mov    $0x0,%eax
    126d:	e8 7e fe ff ff       	callq  10f0 <__printf_chk@plt>
    ...
    1283:	e8 28 fe ff ff       	callq  10b0 <puts@plt>
    1288:	b8 01 00 00 00       	mov    $0x1,%eax
    128d:	eb e8                	jmp    1277 <main+0x6e>
    128f:	4c 89 e1             	mov    %r12,%rcx
    1292:	48 8d 15 80 0d 00 00 	lea    0xd80(%rip),%rdx        # 2019 <_IO_stdin_used+0x19>
    1299:	be 01 00 00 00       	mov    $0x1,%esi
    129e:	48 8b 3d 7b 2d 00 00 	mov    0x2d7b(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    12a5:	b8 00 00 00 00       	mov    $0x0,%eax
    12aa:	e8 61 fe ff ff       	callq  1110 <__fprintf_chk@plt>
    12af:	b8 01 00 00 00       	mov    $0x1,%eax
    12b4:	eb c1                	jmp    1277 <main+0x6e>
