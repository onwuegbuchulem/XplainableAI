...
/app/bin_gccgcc10_O0/2021_11_13-Lesson:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1159:	83 c8 01             	or     $0x1,%eax
    115c:	88 45 fc             	mov    %al,-0x4(%rbp)
    115f:	0f b6 45 fc          	movzbl -0x4(%rbp),%eax
    1163:	83 e0 01             	and    $0x1,%eax
    1166:	83 c8 1e             	or     $0x1e,%eax
    1169:	88 45 fc             	mov    %al,-0x4(%rbp)
    116c:	be 04 00 00 00       	mov    $0x4,%esi
    1171:	48 8d 3d 8c 0e 00 00 	lea    0xe8c(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1178:	b8 00 00 00 00       	mov    $0x0,%eax
    117d:	e8 ce fe ff ff       	callq  1050 <printf@plt>
    1182:	0f b6 45 fc          	movzbl -0x4(%rbp),%eax
    1186:	83 e0 01             	and    $0x1,%eax
    1189:	0f b6 c0             	movzbl %al,%eax
    118c:	89 c6                	mov    %eax,%esi
    118e:	48 8d 3d 84 0e 00 00 	lea    0xe84(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    1195:	b8 00 00 00 00       	mov    $0x0,%eax
    119a:	e8 b1 fe ff ff       	callq  1050 <printf@plt>
    119f:	0f b6 45 fc          	movzbl -0x4(%rbp),%eax
    11a3:	d0 e8                	shr    %al
    11a5:	0f b6 c0             	movzbl %al,%eax
    11a8:	89 c6                	mov    %eax,%esi
    11aa:	48 8d 3d 76 0e 00 00 	lea    0xe76(%rip),%rdi        # 2027 <_IO_stdin_used+0x27>
    11b1:	b8 00 00 00 00       	mov    $0x0,%eax
    11b6:	e8 95 fe ff ff       	callq  1050 <printf@plt>
