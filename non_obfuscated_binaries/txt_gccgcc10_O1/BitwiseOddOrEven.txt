...
/app/bin_gccgcc10_O1/BitwiseOddOrEven:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11ec:	83 e0 01             	and    $0x1,%eax
    11ef:	89 44 24 04          	mov    %eax,0x4(%rsp)
    11f3:	75 26                	jne    121b <main+0x72>
    ...
    120d:	00 00 
    120f:	75 18                	jne    1229 <main+0x80>
    1211:	b8 00 00 00 00       	mov    $0x0,%eax
    1216:	48 83 c4 18          	add    $0x18,%rsp
    121a:	c3                   	retq   
    121b:	48 8d 3d 02 0e 00 00 	lea    0xe02(%rip),%rdi        # 2024 <_IO_stdin_used+0x24>
    1222:	e8 59 fe ff ff       	callq  1080 <puts@plt>
    1227:	eb d8                	jmp    1201 <main+0x58>
    1229:	e8 62 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
