...
/app/bin_gccgcc10_O0/DiceRoll:     file format elf64-x86-64
...
0000000000001120 <_start>:
    ...
    1141:	48 8d 3d fd 00 00 00 	lea    0xfd(%rip),%rdi        # 1245 <main>
...
0000000000001209 <Diceroll>:
    ...
    1218:	bf 00 00 00 00       	mov    $0x0,%edi
    121d:	e8 ce fe ff ff       	callq  10f0 <time@plt>
    1222:	89 c7                	mov    %eax,%edi
    1224:	e8 b7 fe ff ff       	callq  10e0 <srand@plt>
    1229:	8b 45 ec             	mov    -0x14(%rbp),%eax
    122c:	89 45 f8             	mov    %eax,-0x8(%rbp)
    122f:	e8 dc fe ff ff       	callq  1110 <rand@plt>
    1234:	99                   	cltd   
    1235:	f7 7d f8             	idivl  -0x8(%rbp)
...
0000000000001245 <main>:
    ...
    126f:	e8 3c fe ff ff       	callq  10b0 <puts@plt>
    1274:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    1278:	48 89 c6             	mov    %rax,%rsi
    127b:	48 8d 3d af 0d 00 00 	lea    0xdaf(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    1282:	b8 00 00 00 00       	mov    $0x0,%eax
    1287:	e8 74 fe ff ff       	callq  1100 <__isoc99_scanf@plt>
    128c:	8b 45 f0             	mov    -0x10(%rbp),%eax
    128f:	89 c7                	mov    %eax,%edi
    1291:	e8 73 ff ff ff       	callq  1209 <Diceroll>
    1296:	89 45 f4             	mov    %eax,-0xc(%rbp)
    1299:	8b 45 f4             	mov    -0xc(%rbp),%eax
    129c:	89 c6                	mov    %eax,%esi
    129e:	48 8d 3d 8f 0d 00 00 	lea    0xd8f(%rip),%rdi        # 2034 <_IO_stdin_used+0x34>
    12a5:	b8 00 00 00 00       	mov    $0x0,%eax
    12aa:	e8 21 fe ff ff       	callq  10d0 <printf@plt>
    12af:	b8 00 00 00 00       	mov    $0x0,%eax
    12b4:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    12b8:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    12bf:	00 00 
    12c1:	74 05                	je     12c8 <main+0x83>
    12c3:	e8 f8 fd ff ff       	callq  10c0 <__stack_chk_fail@plt>
    12c8:	c9                   	leaveq 
    12c9:	c3                   	retq   
