...
/app/bin_gccgcc10_O2/Pointers:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1092:	48 83 ec 10          	sub    $0x10,%rsp
    1096:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    109d:	00 00 
    109f:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10a4:	31 c0                	xor    %eax,%eax
    10a6:	4c 8d 64 24 04       	lea    0x4(%rsp),%r12
    10ab:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%rsp)
    10b2:	00 
    10b3:	4c 89 e2             	mov    %r12,%rdx
    10b6:	e8 b5 ff ff ff       	callq  1070 <__printf_chk@plt>
    10bb:	8b 54 24 04          	mov    0x4(%rsp),%edx
    10bf:	bf 01 00 00 00       	mov    $0x1,%edi
    10c4:	31 c0                	xor    %eax,%eax
    10c6:	48 8d 35 49 0f 00 00 	lea    0xf49(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    10cd:	e8 9e ff ff ff       	callq  1070 <__printf_chk@plt>
    10d2:	4c 89 e2             	mov    %r12,%rdx
    10d5:	bf 01 00 00 00       	mov    $0x1,%edi
    10da:	31 c0                	xor    %eax,%eax
    10dc:	48 8d 35 21 0f 00 00 	lea    0xf21(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10e3:	e8 88 ff ff ff       	callq  1070 <__printf_chk@plt>
    10e8:	8b 54 24 04          	mov    0x4(%rsp),%edx
    10ec:	bf 01 00 00 00       	mov    $0x1,%edi
    10f1:	31 c0                	xor    %eax,%eax
    10f3:	48 8d 35 2d 0f 00 00 	lea    0xf2d(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    10fa:	e8 71 ff ff ff       	callq  1070 <__printf_chk@plt>
    ...
    1110:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%rsp)
    1117:	00 
    1118:	e8 53 ff ff ff       	callq  1070 <__printf_chk@plt>
    111d:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1121:	bf 01 00 00 00       	mov    $0x1,%edi
    1126:	31 c0                	xor    %eax,%eax
    1128:	48 8d 35 f8 0e 00 00 	lea    0xef8(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    112f:	e8 3c ff ff ff       	callq  1070 <__printf_chk@plt>
    1134:	4c 89 e2             	mov    %r12,%rdx
    1137:	bf 01 00 00 00       	mov    $0x1,%edi
    113c:	31 c0                	xor    %eax,%eax
    113e:	48 8d 35 bf 0e 00 00 	lea    0xebf(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1145:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%rsp)
    114c:	00 
    114d:	e8 1e ff ff ff       	callq  1070 <__printf_chk@plt>
    1152:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1156:	31 c0                	xor    %eax,%eax
    1158:	bf 01 00 00 00       	mov    $0x1,%edi
    115d:	48 8d 35 b2 0e 00 00 	lea    0xeb2(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    1164:	e8 07 ff ff ff       	callq  1070 <__printf_chk@plt>
    1169:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    116e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1175:	00 00 
    1177:	75 09                	jne    1182 <main+0x102>
    1179:	48 83 c4 10          	add    $0x10,%rsp
    117d:	31 c0                	xor    %eax,%eax
    117f:	41 5c                	pop    %r12
    1181:	c3                   	retq   
    1182:	e8 d9 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
