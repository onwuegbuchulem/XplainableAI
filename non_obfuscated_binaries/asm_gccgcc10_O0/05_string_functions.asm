...
/app/bin_gccgcc10_O0/05_string_functions:     file format elf64-x86-64
...
0000000000001080 <strcpy@plt>:
    ...
    1084:	f2 ff 25 2d 2f 00 00 	bnd jmpq *0x2f2d(%rip)        # 3fb8 <strcpy@GLIBC_2.2.5>
...
00000000000011a9 <main>:
    ...
    11c7:	c7 85 5a ff ff ff 48 	movl   $0x72726148,-0xa6(%rbp)
    11ce:	61 72 72 
    11d1:	66 c7 85 5e ff ff ff 	movw   $0x79,-0xa2(%rbp)
    11d8:	79 00 
    11da:	48 b8 48 61 72 72 79 	movabs $0x7972726148,%rax
    11e1:	00 00 00 
    11e4:	ba 00 00 00 00       	mov    $0x0,%edx
    11e9:	48 89 45 80          	mov    %rax,-0x80(%rbp)
    11ed:	48 89 55 88          	mov    %rdx,-0x78(%rbp)
    11f1:	48 c7 45 90 00 00 00 	movq   $0x0,-0x70(%rbp)
    11f8:	00 
    11f9:	48 c7 45 98 00 00 00 	movq   $0x0,-0x68(%rbp)
    1200:	00 
    1201:	48 c7 45 a0 00 00 00 	movq   $0x0,-0x60(%rbp)
    1208:	00 
    1209:	48 c7 45 a8 00 00 00 	movq   $0x0,-0x58(%rbp)
    1210:	00 
    1211:	48 c7 45 b0 00 00 00 	movq   $0x0,-0x50(%rbp)
    1218:	00 
    1219:	48 b8 20 62 68 61 69 	movabs $0x6961686220,%rax
    1220:	00 00 00 
    1223:	ba 00 00 00 00       	mov    $0x0,%edx
    1228:	48 89 45 c0          	mov    %rax,-0x40(%rbp)
    122c:	48 89 55 c8          	mov    %rdx,-0x38(%rbp)
    1230:	48 c7 45 d0 00 00 00 	movq   $0x0,-0x30(%rbp)
    1237:	00 
    1238:	48 c7 45 d8 00 00 00 	movq   $0x0,-0x28(%rbp)
    123f:	00 
    1240:	48 c7 45 e0 00 00 00 	movq   $0x0,-0x20(%rbp)
    1247:	00 
    1248:	48 c7 45 e8 00 00 00 	movq   $0x0,-0x18(%rbp)
    124f:	00 
    1250:	48 c7 45 f0 00 00 00 	movq   $0x0,-0x10(%rbp)
    1257:	00 
    1258:	48 8d 95 5a ff ff ff 	lea    -0xa6(%rbp),%rdx
    125f:	48 8d 85 60 ff ff ff 	lea    -0xa0(%rbp),%rax
    1266:	48 89 d6             	mov    %rdx,%rsi
    1269:	48 89 c7             	mov    %rax,%rdi
    126c:	e8 0f fe ff ff       	callq  1080 <strcpy@plt>
    1271:	48 8d 55 c0          	lea    -0x40(%rbp),%rdx
    1275:	48 8d 45 80          	lea    -0x80(%rbp),%rax
    1279:	48 89 d6             	mov    %rdx,%rsi
    127c:	48 89 c7             	mov    %rax,%rdi
    127f:	e8 2c fe ff ff       	callq  10b0 <strcat@plt>
    1284:	c7 85 54 ff ff ff ff 	movl   $0xffffffff,-0xac(%rbp)
    128b:	ff ff ff 
    128e:	8b 85 54 ff ff ff    	mov    -0xac(%rbp),%eax
    1294:	89 c6                	mov    %eax,%esi
    1296:	48 8d 3d 67 0d 00 00 	lea    0xd67(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    129d:	b8 00 00 00 00       	mov    $0x0,%eax
    12a2:	e8 f9 fd ff ff       	callq  10a0 <printf@plt>
    12a7:	b8 00 00 00 00       	mov    $0x0,%eax
    12ac:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    12b0:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    12b7:	00 00 
    12b9:	74 05                	je     12c0 <main+0x117>
    12bb:	e8 d0 fd ff ff       	callq  1090 <__stack_chk_fail@plt>
    12c0:	c9                   	leaveq 
    12c1:	c3                   	retq   
