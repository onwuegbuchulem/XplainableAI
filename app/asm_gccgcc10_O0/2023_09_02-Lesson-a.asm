...
/app/bin_gccgcc10_O0/2023_09_02-Lesson-a:     file format elf64-x86-64
...
0000000000001346 <main>:
    ...
    1352:	48 8d 3d b7 2c 00 00 	lea    0x2cb7(%rip),%rdi        # 4010 <name1.0>
    1359:	e8 eb fe ff ff       	callq  1249 <mem_open>
    135e:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1362:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
    1367:	75 2c                	jne    1395 <main+0x4f>
    1369:	48 8b 05 b0 2c 00 00 	mov    0x2cb0(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    1370:	48 8d 15 99 2c 00 00 	lea    0x2c99(%rip),%rdx        # 4010 <name1.0>
    ...
    1395:	48 8d 35 74 2c 00 00 	lea    0x2c74(%rip),%rsi        # 4010 <name1.0>
    ...
    13e6:	e8 2d ff ff ff       	callq  1318 <mem_close>
    13eb:	48 8d 35 1e 2c 00 00 	lea    0x2c1e(%rip),%rsi        # 4010 <name1.0>
    13f2:	48 8d 3d 58 0c 00 00 	lea    0xc58(%rip),%rdi        # 2051 <_IO_stdin_used+0x51>
    13f9:	b8 00 00 00 00       	mov    $0x0,%eax
    13fe:	e8 fd fc ff ff       	callq  1100 <printf@plt>
