...
/app/bin_gccgcc10_O0/TemperatureSwitch:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d0:	48 8d 3d 46 0e 00 00 	lea    0xe46(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    11d7:	e8 a4 fe ff ff       	callq  1080 <puts@plt>
    11dc:	48 8d 3d 53 0e 00 00 	lea    0xe53(%rip),%rdi        # 2036 <_IO_stdin_used+0x36>
    11e3:	e8 98 fe ff ff       	callq  1080 <puts@plt>
    11e8:	48 8d 3d 60 0e 00 00 	lea    0xe60(%rip),%rdi        # 204f <_IO_stdin_used+0x4f>
    11ef:	b8 00 00 00 00       	mov    $0x0,%eax
    11f4:	e8 a7 fe ff ff       	callq  10a0 <printf@plt>
    11f9:	48 8d 45 dc          	lea    -0x24(%rbp),%rax
    11fd:	48 89 c6             	mov    %rax,%rsi
    1200:	48 8d 3d 5c 0e 00 00 	lea    0xe5c(%rip),%rdi        # 2063 <_IO_stdin_used+0x63>
    1207:	b8 00 00 00 00       	mov    $0x0,%eax
    120c:	e8 9f fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1211:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1214:	83 f8 01             	cmp    $0x1,%eax
    1217:	74 0a                	je     1223 <main+0x7a>
    1219:	83 f8 02             	cmp    $0x2,%eax
    121c:	74 46                	je     1264 <main+0xbb>
    121e:	e9 8e 00 00 00       	jmpq   12b1 <main+0x108>
    1223:	48 8d 3d 3e 0e 00 00 	lea    0xe3e(%rip),%rdi        # 2068 <_IO_stdin_used+0x68>
    122a:	b8 00 00 00 00       	mov    $0x0,%eax
    122f:	e8 6c fe ff ff       	callq  10a0 <printf@plt>
    1234:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    1238:	48 89 c6             	mov    %rax,%rsi
    123b:	48 8d 3d 49 0e 00 00 	lea    0xe49(%rip),%rdi        # 208b <_IO_stdin_used+0x8b>
    1242:	b8 00 00 00 00       	mov    $0x0,%eax
    1247:	e8 64 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    124c:	f2 0f 10 4d e0       	movsd  -0x20(%rbp),%xmm1
    1251:	f2 0f 10 05 97 0e 00 	movsd  0xe97(%rip),%xmm0        # 20f0 <_IO_stdin_used+0xf0>
    1258:	00 
    1259:	f2 0f 58 c1          	addsd  %xmm1,%xmm0
    125d:	f2 0f 11 45 f0       	movsd  %xmm0,-0x10(%rbp)
    1262:	eb 59                	jmp    12bd <main+0x114>
    1264:	48 8d 3d 25 0e 00 00 	lea    0xe25(%rip),%rdi        # 2090 <_IO_stdin_used+0x90>
    126b:	b8 00 00 00 00       	mov    $0x0,%eax
    1270:	e8 2b fe ff ff       	callq  10a0 <printf@plt>
    1275:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    1279:	48 89 c6             	mov    %rax,%rsi
    127c:	48 8d 3d 08 0e 00 00 	lea    0xe08(%rip),%rdi        # 208b <_IO_stdin_used+0x8b>
    1283:	b8 00 00 00 00       	mov    $0x0,%eax
    1288:	e8 23 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    128d:	f2 0f 10 45 e8       	movsd  -0x18(%rbp),%xmm0
    1292:	f2 0f 10 15 56 0e 00 	movsd  0xe56(%rip),%xmm2        # 20f0 <_IO_stdin_used+0xf0>
    1299:	00 
    129a:	66 0f 28 c8          	movapd %xmm0,%xmm1
    129e:	f2 0f 5c ca          	subsd  %xmm2,%xmm1
    12a2:	66 0f ef c0          	pxor   %xmm0,%xmm0
    12a6:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    12aa:	f2 0f 11 45 f0       	movsd  %xmm0,-0x10(%rbp)
    12af:	eb 0c                	jmp    12bd <main+0x114>
    12b1:	48 8d 3d fe 0d 00 00 	lea    0xdfe(%rip),%rdi        # 20b6 <_IO_stdin_used+0xb6>
    12b8:	e8 c3 fd ff ff       	callq  1080 <puts@plt>
    12bd:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    12c1:	66 48 0f 6e c0       	movq   %rax,%xmm0
    12c6:	48 8d 3d fb 0d 00 00 	lea    0xdfb(%rip),%rdi        # 20c8 <_IO_stdin_used+0xc8>
    12cd:	b8 01 00 00 00       	mov    $0x1,%eax
    12d2:	e8 c9 fd ff ff       	callq  10a0 <printf@plt>
    12d7:	b8 00 00 00 00       	mov    $0x0,%eax
    12dc:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    12e0:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    12e7:	00 00 
    12e9:	74 05                	je     12f0 <main+0x147>
