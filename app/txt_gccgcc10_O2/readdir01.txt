...
/app/bin_gccgcc10_O2/readdir01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10cc:	e8 bf ff ff ff       	callq  1090 <opendir@plt>
    10d1:	48 85 c0             	test   %rax,%rax
    10d4:	74 27                	je     10fd <main+0x3d>
    10d6:	48 89 c5             	mov    %rax,%rbp
    10d9:	48 8d 3d 3f 0f 00 00 	lea    0xf3f(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    10e0:	e8 9b ff ff ff       	callq  1080 <puts@plt>
    10e5:	48 89 ef             	mov    %rbp,%rdi
    10e8:	e8 b3 ff ff ff       	callq  10a0 <closedir@plt>
    10ed:	48 8d 3d 40 0f 00 00 	lea    0xf40(%rip),%rdi        # 2034 <_IO_stdin_used+0x34>
    10f4:	e8 87 ff ff ff       	callq  1080 <puts@plt>
    10f9:	31 c0                	xor    %eax,%eax
    10fb:	5d                   	pop    %rbp
    10fc:	c3                   	retq   
    10fd:	48 8d 3d 02 0f 00 00 	lea    0xf02(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1104:	e8 77 ff ff ff       	callq  1080 <puts@plt>
    1109:	bf 01 00 00 00       	mov    $0x1,%edi
    110e:	e8 9d ff ff ff       	callq  10b0 <exit@plt>
