...
/app/bin_gccgcc10_O0/LowercaseToUppercase:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d0:	48 8d 45 f3          	lea    -0xd(%rbp),%rax
    11d4:	48 89 c6             	mov    %rax,%rsi
    11d7:	48 8d 3d 44 0e 00 00 	lea    0xe44(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 c8 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e8:	0f b6 45 f3          	movzbl -0xd(%rbp),%eax
    11ec:	0f be c0             	movsbl %al,%eax
    11ef:	83 e8 20             	sub    $0x20,%eax
    11f2:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11f5:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11f8:	89 c6                	mov    %eax,%esi
    11fa:	48 8d 3d 24 0e 00 00 	lea    0xe24(%rip),%rdi        # 2025 <_IO_stdin_used+0x25>
