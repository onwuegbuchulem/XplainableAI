...
/app/bin_gccgcc10_O3/2019_03_23-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	48 8d 35 8c 0f 00 00 	lea    0xf8c(%rip),%rsi        # 201b <_IO_stdin_used+0x1b>
    108f:	bf 06 00 00 00       	mov    $0x6,%edi
    1094:	e8 c7 ff ff ff       	callq  1060 <setlocale@plt>
    1099:	48 8d 35 64 0f 00 00 	lea    0xf64(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10a0:	bf 01 00 00 00       	mov    $0x1,%edi
    10a5:	48 89 c2             	mov    %rax,%rdx
    10a8:	31 c0                	xor    %eax,%eax
    10aa:	e8 c1 ff ff ff       	callq  1070 <__printf_chk@plt>
    10af:	31 c0                	xor    %eax,%eax
    10b1:	48 83 c4 08          	add    $0x8,%rsp
    10b5:	c3                   	retq   
