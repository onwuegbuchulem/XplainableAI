...
/app/bin_gccgcc10_O1/Positive_Negative_Number:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ce:	7f 1f                	jg     11ef <main+0x66>
    11d0:	78 4d                	js     121f <main+0x96>
    11d2:	ba 00 00 00 00       	mov    $0x0,%edx
    11d7:	48 8d 35 5c 0e 00 00 	lea    0xe5c(%rip),%rsi        # 203a <_IO_stdin_used+0x3a>
    11de:	bf 01 00 00 00       	mov    $0x1,%edi
    11e3:	b8 00 00 00 00       	mov    $0x0,%eax
    11e8:	e8 93 fe ff ff       	callq  1080 <__printf_chk@plt>
    11ed:	eb 16                	jmp    1205 <main+0x7c>
    11ef:	48 8d 35 24 0e 00 00 	lea    0xe24(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    11f6:	bf 01 00 00 00       	mov    $0x1,%edi
    11fb:	b8 00 00 00 00       	mov    $0x0,%eax
    1200:	e8 7b fe ff ff       	callq  1080 <__printf_chk@plt>
    1205:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    120a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1211:	00 00 
    1213:	75 22                	jne    1237 <main+0xae>
    1215:	b8 00 00 00 00       	mov    $0x0,%eax
    121a:	48 83 c4 18          	add    $0x18,%rsp
    121e:	c3                   	retq   
    121f:	48 8d 35 04 0e 00 00 	lea    0xe04(%rip),%rsi        # 202a <_IO_stdin_used+0x2a>
    1226:	bf 01 00 00 00       	mov    $0x1,%edi
    122b:	b8 00 00 00 00       	mov    $0x0,%eax
    1230:	e8 4b fe ff ff       	callq  1080 <__printf_chk@plt>
    1235:	eb ce                	jmp    1205 <main+0x7c>
