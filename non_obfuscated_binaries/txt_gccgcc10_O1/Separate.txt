...
/app/bin_gccgcc10_O1/Separate:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b3:	48 8d 74 24 14       	lea    0x14(%rsp),%rsi
    11b8:	48 8d 3d 81 0e 00 00 	lea    0xe81(%rip),%rdi        # 2040 <_IO_stdin_used+0x40>
    11bf:	b8 00 00 00 00       	mov    $0x0,%eax
    11c4:	e8 c7 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c9:	f3 0f 10 54 24 14    	movss  0x14(%rsp),%xmm2
    11cf:	f3 0f 11 54 24 0c    	movss  %xmm2,0xc(%rsp)
    11d5:	f3 0f 2c da          	cvttss2si %xmm2,%ebx
    11d9:	89 da                	mov    %ebx,%edx
    11db:	48 8d 35 36 0e 00 00 	lea    0xe36(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    11e2:	bf 01 00 00 00       	mov    $0x1,%edi
    11e7:	b8 00 00 00 00       	mov    $0x0,%eax
    11ec:	e8 8f fe ff ff       	callq  1080 <__printf_chk@plt>
    11f1:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11f5:	f3 0f 2a cb          	cvtsi2ss %ebx,%xmm1
    11f9:	f3 0f 10 44 24 0c    	movss  0xc(%rsp),%xmm0
    11ff:	f3 0f 5c c1          	subss  %xmm1,%xmm0
    1203:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1207:	48 8d 35 20 0e 00 00 	lea    0xe20(%rip),%rsi        # 202e <_IO_stdin_used+0x2e>
    120e:	bf 01 00 00 00       	mov    $0x1,%edi
    1213:	b8 01 00 00 00       	mov    $0x1,%eax
    1218:	e8 63 fe ff ff       	callq  1080 <__printf_chk@plt>
    121d:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1222:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1229:	00 00 
    122b:	75 06                	jne    1233 <main+0xaa>
    122d:	48 83 c4 20          	add    $0x20,%rsp
    1231:	5b                   	pop    %rbx
    1232:	c3                   	retq   
