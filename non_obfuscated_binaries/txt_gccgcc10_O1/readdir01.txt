...
/app/bin_gccgcc10_O1/readdir01:     file format elf64-x86-64
...
0000000000001090 <opendir@plt>:
    1090:	f3 0f 1e fa          	endbr64 
    1094:	f2 ff 25 25 2f 00 00 	bnd jmpq *0x2f25(%rip)        # 3fc0 <opendir@GLIBC_2.2.5>
    109b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010a0 <closedir@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 1d 2f 00 00 	bnd jmpq *0x2f1d(%rip)        # 3fc8 <closedir@GLIBC_2.2.5>
...
00000000000010c0 <_start>:
    ...
    10d1:	50                   	push   %rax
    10d2:	54                   	push   %rsp
    10d3:	4c 8d 05 96 01 00 00 	lea    0x196(%rip),%r8        # 1270 <__libc_csu_fini>
    10da:	48 8d 0d 1f 01 00 00 	lea    0x11f(%rip),%rcx        # 1200 <__libc_csu_init>
...
00000000000011a9 <main>:
    ...
    11b5:	e8 d6 fe ff ff       	callq  1090 <opendir@plt>
    11ba:	48 85 c0             	test   %rax,%rax
    11bd:	74 2a                	je     11e9 <main+0x40>
    11bf:	48 89 c3             	mov    %rax,%rbx
    11c2:	48 8d 3d 56 0e 00 00 	lea    0xe56(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    11c9:	e8 b2 fe ff ff       	callq  1080 <puts@plt>
    11ce:	48 89 df             	mov    %rbx,%rdi
    11d1:	e8 ca fe ff ff       	callq  10a0 <closedir@plt>
    ...
    11e7:	5b                   	pop    %rbx
    11e8:	c3                   	retq   
    11e9:	48 8d 3d 16 0e 00 00 	lea    0xe16(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    11f0:	e8 8b fe ff ff       	callq  1080 <puts@plt>
    11f5:	bf 01 00 00 00       	mov    $0x1,%edi
    11fa:	e8 b1 fe ff ff       	callq  10b0 <exit@plt>
    11ff:	90                   	nop

0000000000001200 <__libc_csu_init>:
    1200:	f3 0f 1e fa          	endbr64 
    1204:	41 57                	push   %r15
    1206:	4c 8d 3d 93 2b 00 00 	lea    0x2b93(%rip),%r15        # 3da0 <__frame_dummy_init_array_entry>
    120d:	41 56                	push   %r14
    ...
    121c:	55                   	push   %rbp
    121d:	48 8d 2d 84 2b 00 00 	lea    0x2b84(%rip),%rbp        # 3da8 <__do_global_dtors_aux_fini_array_entry>
    1224:	53                   	push   %rbx
