...
/app/bin_gccgcc10_O3/2019_02_16-Lesson-c:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1092:	55                   	push   %rbp
    1093:	48 8d 2d 6a 0f 00 00 	lea    0xf6a(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    109a:	53                   	push   %rbx
    109b:	bb 02 00 00 00       	mov    $0x2,%ebx
    10a0:	48 83 ec 10          	sub    $0x10,%rsp
    10a4:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10ab:	00 00 
    10ad:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10b2:	31 c0                	xor    %eax,%eax
    10b4:	8b 54 24 04          	mov    0x4(%rsp),%edx
    10b8:	4c 8d 64 24 04       	lea    0x4(%rsp),%r12
    10bd:	e8 ae ff ff ff       	callq  1070 <__printf_chk@plt>
    10c2:	8b 54 24 08          	mov    0x8(%rsp),%edx
    10c6:	bf 01 00 00 00       	mov    $0x1,%edi
    10cb:	31 c0                	xor    %eax,%eax
    10cd:	48 8d 35 30 0f 00 00 	lea    0xf30(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10d4:	e8 97 ff ff ff       	callq  1070 <__printf_chk@plt>
    10d9:	41 8b 14 9c          	mov    (%r12,%rbx,4),%edx
    10dd:	48 89 ee             	mov    %rbp,%rsi
    ...
    10f0:	48 83 fb 0a          	cmp    $0xa,%rbx
    10f4:	75 e3                	jne    10d9 <main+0x59>
    10f6:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10fb:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1102:	00 00 
    1104:	75 0b                	jne    1111 <main+0x91>
    1106:	48 83 c4 10          	add    $0x10,%rsp
    110a:	31 c0                	xor    %eax,%eax
    110c:	5b                   	pop    %rbx
    110d:	5d                   	pop    %rbp
    110e:	41 5c                	pop    %r12
    1110:	c3                   	retq   
    1111:	e8 4a ff ff ff       	callq  1060 <__stack_chk_fail@plt>
