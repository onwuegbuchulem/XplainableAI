...
/app/bin_gccgcc10_O2/ex8:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a6:	55                   	push   %rbp
    10a7:	53                   	push   %rbx
    10a8:	83 ff 01             	cmp    $0x1,%edi
    10ab:	74 5b                	je     1108 <main+0x68>
    10ad:	8d 47 fe             	lea    -0x2(%rdi),%eax
    10b0:	89 fd                	mov    %edi,%ebp
    10b2:	83 f8 01             	cmp    $0x1,%eax
    10b5:	76 0c                	jbe    10c3 <main+0x23>
    10b7:	83 ff 0a             	cmp    $0xa,%edi
    10ba:	7f 5a                	jg     1116 <main+0x76>
    10bc:	5b                   	pop    %rbx
    10bd:	31 c0                	xor    %eax,%eax
    10bf:	5d                   	pop    %rbp
    10c0:	41 5c                	pop    %r12
    10c2:	c3                   	retq   
    10c3:	48 8d 3d 8d 0f 00 00 	lea    0xf8d(%rip),%rdi        # 2057 <_IO_stdin_used+0x57>
    10ca:	48 89 f3             	mov    %rsi,%rbx
    10cd:	e8 ae ff ff ff       	callq  1080 <puts@plt>
    10d2:	8d 45 ff             	lea    -0x1(%rbp),%eax
    10d5:	48 8d 2d 92 0f 00 00 	lea    0xf92(%rip),%rbp        # 206e <_IO_stdin_used+0x6e>
    10dc:	4c 8d 64 c3 08       	lea    0x8(%rbx,%rax,8),%r12
    10e1:	48 8b 13             	mov    (%rbx),%rdx
    10e4:	48 89 ee             	mov    %rbp,%rsi
    10e7:	bf 01 00 00 00       	mov    $0x1,%edi
    10ec:	31 c0                	xor    %eax,%eax
    10ee:	48 83 c3 08          	add    $0x8,%rbx
    10f2:	e8 99 ff ff ff       	callq  1090 <__printf_chk@plt>
    10f7:	4c 39 e3             	cmp    %r12,%rbx
    10fa:	75 e5                	jne    10e1 <main+0x41>
    10fc:	bf 0a 00 00 00       	mov    $0xa,%edi
    1101:	e8 6a ff ff ff       	callq  1070 <putchar@plt>
    1106:	eb b4                	jmp    10bc <main+0x1c>
    1108:	48 8d 3d f9 0e 00 00 	lea    0xef9(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    110f:	e8 6c ff ff ff       	callq  1080 <puts@plt>
    1114:	eb a6                	jmp    10bc <main+0x1c>
    1116:	48 8d 3d 13 0f 00 00 	lea    0xf13(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    111d:	e8 5e ff ff ff       	callq  1080 <puts@plt>
    1122:	eb 98                	jmp    10bc <main+0x1c>
