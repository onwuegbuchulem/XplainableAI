...
/app/bin_gccgcc10_O1/assignment3-extra:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d7:	48 8d 3d 3e 0e 00 00 	lea    0xe3e(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 c8 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e8:	48 8d 35 31 0e 00 00 	lea    0xe31(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    11ef:	bf 01 00 00 00       	mov    $0x1,%edi
    11f4:	b8 00 00 00 00       	mov    $0x0,%eax
    11f9:	e8 a2 fe ff ff       	callq  10a0 <__printf_chk@plt>
    11fe:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    1203:	48 8d 3d 12 0e 00 00 	lea    0xe12(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    120a:	b8 00 00 00 00       	mov    $0x0,%eax
    120f:	e8 9c fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1214:	48 8b 4c 24 10       	mov    0x10(%rsp),%rcx
    1219:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    121e:	48 8d 35 12 0e 00 00 	lea    0xe12(%rip),%rsi        # 2037 <_IO_stdin_used+0x37>
    1225:	bf 01 00 00 00       	mov    $0x1,%edi
    122a:	b8 00 00 00 00       	mov    $0x0,%eax
    122f:	e8 6c fe ff ff       	callq  10a0 <__printf_chk@plt>
    1234:	48 8b 7c 24 08       	mov    0x8(%rsp),%rdi
    1239:	e8 42 fe ff ff       	callq  1080 <free@plt>
    123e:	48 8b 7c 24 10       	mov    0x10(%rsp),%rdi
    1243:	e8 38 fe ff ff       	callq  1080 <free@plt>
    1248:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    124d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1254:	00 00 
    1256:	75 0a                	jne    1262 <main+0xb9>
    1258:	b8 00 00 00 00       	mov    $0x0,%eax
    125d:	48 83 c4 28          	add    $0x28,%rsp
    1261:	c3                   	retq   
    1262:	e8 29 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
