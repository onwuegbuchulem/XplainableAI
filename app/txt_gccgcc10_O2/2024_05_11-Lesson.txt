...
/app/bin_gccgcc10_O2/2024_05_11-Lesson:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    1100:	48 b8 0a 00 00 00 14 	movabs $0x140000000a,%rax
    1107:	00 00 00 
    ...
    111d:	48 b8 1e 00 00 00 28 	movabs $0x280000001e,%rax
    1124:	00 00 00 
    1127:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    112c:	31 c0                	xor    %eax,%eax
    112e:	e8 8d ff ff ff       	callq  10c0 <__printf_chk@plt>
    1133:	ba 14 00 00 00       	mov    $0x14,%edx
    1138:	48 8d 35 c5 0e 00 00 	lea    0xec5(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    113f:	31 c0                	xor    %eax,%eax
    1141:	bf 01 00 00 00       	mov    $0x1,%edi
    1146:	e8 75 ff ff ff       	callq  10c0 <__printf_chk@plt>
    114b:	ba 1e 00 00 00       	mov    $0x1e,%edx
    1150:	48 8d 35 ad 0e 00 00 	lea    0xead(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1157:	31 c0                	xor    %eax,%eax
    1159:	bf 01 00 00 00       	mov    $0x1,%edi
    115e:	e8 5d ff ff ff       	callq  10c0 <__printf_chk@plt>
    1163:	ba 28 00 00 00       	mov    $0x28,%edx
    1168:	48 8d 35 95 0e 00 00 	lea    0xe95(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    116f:	31 c0                	xor    %eax,%eax
    1171:	bf 01 00 00 00       	mov    $0x1,%edi
    1176:	e8 45 ff ff ff       	callq  10c0 <__printf_chk@plt>
    117b:	ba 32 00 00 00       	mov    $0x32,%edx
    1180:	48 8d 35 7d 0e 00 00 	lea    0xe7d(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1187:	31 c0                	xor    %eax,%eax
    1189:	bf 01 00 00 00       	mov    $0x1,%edi
    118e:	e8 2d ff ff ff       	callq  10c0 <__printf_chk@plt>
    1193:	ba 28 00 00 00       	mov    $0x28,%edx
    1198:	48 8d 35 65 0e 00 00 	lea    0xe65(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    119f:	31 c0                	xor    %eax,%eax
    11a1:	bf 01 00 00 00       	mov    $0x1,%edi
    11a6:	e8 15 ff ff ff       	callq  10c0 <__printf_chk@plt>
    11ab:	31 ff                	xor    %edi,%edi
    11ad:	e8 fe fe ff ff       	callq  10b0 <time@plt>
    11b2:	48 89 c7             	mov    %rax,%rdi
    11b5:	e8 e6 fe ff ff       	callq  10a0 <srand@plt>
    11ba:	e8 11 ff ff ff       	callq  10d0 <rand@plt>
    11bf:	48 8d 35 3e 0e 00 00 	lea    0xe3e(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11c6:	bf 01 00 00 00       	mov    $0x1,%edi
    11cb:	48 63 d0             	movslq %eax,%rdx
    11ce:	89 c1                	mov    %eax,%ecx
    11d0:	48 69 d2 67 66 66 66 	imul   $0x66666667,%rdx,%rdx
    11d7:	c1 f9 1f             	sar    $0x1f,%ecx
    11da:	48 c1 fa 21          	sar    $0x21,%rdx
    11de:	29 ca                	sub    %ecx,%edx
    11e0:	8d 14 92             	lea    (%rdx,%rdx,4),%edx
    11e3:	29 d0                	sub    %edx,%eax
    11e5:	48 98                	cltq   
    11e7:	8b 14 84             	mov    (%rsp,%rax,4),%edx
    ...
    11fd:	00 00 
    11ff:	75 07                	jne    1208 <main+0x128>
    1201:	31 c0                	xor    %eax,%eax
    1203:	48 83 c4 28          	add    $0x28,%rsp
    1207:	c3                   	retq   
    1208:	e8 83 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
