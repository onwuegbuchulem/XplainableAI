...
/app/bin_gccgcc10_O3/NestedIfLeapYear:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e4:	e8 a7 ff ff ff       	callq  1090 <__printf_chk@plt>
    10e9:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    10ee:	48 8d 3d 1d 0f 00 00 	lea    0xf1d(%rip),%rdi        # 2012 <_IO_stdin_used+0x12>
    10f5:	31 c0                	xor    %eax,%eax
    10f7:	e8 a4 ff ff ff       	callq  10a0 <__isoc99_scanf@plt>
    10fc:	44 8b 44 24 04       	mov    0x4(%rsp),%r8d
    1101:	41 f6 c0 03          	test   $0x3,%r8b
    1105:	75 74                	jne    117b <main+0xbb>
    1107:	41 69 c0 29 5c 8f c2 	imul   $0xc28f5c29,%r8d,%eax
    110e:	05 50 b8 1e 05       	add    $0x51eb850,%eax
    1113:	c1 c8 02             	ror    $0x2,%eax
    1116:	3d 28 5c 8f 02       	cmp    $0x28f5c28,%eax
    111b:	77 33                	ja     1150 <main+0x90>
    111d:	44 89 c0             	mov    %r8d,%eax
    1120:	b9 90 01 00 00       	mov    $0x190,%ecx
    1125:	48 8d 35 e9 0e 00 00 	lea    0xee9(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    112c:	99                   	cltd   
    112d:	f7 f9                	idiv   %ecx
    112f:	85 d2                	test   %edx,%edx
    1131:	44 89 c2             	mov    %r8d,%edx
    1134:	74 07                	je     113d <main+0x7d>
    1136:	48 8d 35 eb 0e 00 00 	lea    0xeeb(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    113d:	bf 01 00 00 00       	mov    $0x1,%edi
    1142:	31 c0                	xor    %eax,%eax
    1144:	e8 47 ff ff ff       	callq  1090 <__printf_chk@plt>
    1149:	31 ff                	xor    %edi,%edi
    114b:	e8 60 ff ff ff       	callq  10b0 <exit@plt>
    1150:	44 89 c2             	mov    %r8d,%edx
    1153:	48 8d 35 bb 0e 00 00 	lea    0xebb(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    115a:	bf 01 00 00 00       	mov    $0x1,%edi
    115f:	31 c0                	xor    %eax,%eax
    1161:	e8 2a ff ff ff       	callq  1090 <__printf_chk@plt>
    1166:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    116b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1172:	00 00 
    1174:	75 1d                	jne    1193 <main+0xd3>
    1176:	48 83 c4 18          	add    $0x18,%rsp
    117a:	c3                   	retq   
    117b:	44 89 c2             	mov    %r8d,%edx
    117e:	48 8d 35 a3 0e 00 00 	lea    0xea3(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    1185:	bf 01 00 00 00       	mov    $0x1,%edi
    118a:	31 c0                	xor    %eax,%eax
    118c:	e8 ff fe ff ff       	callq  1090 <__printf_chk@plt>
    1191:	eb d3                	jmp    1166 <main+0xa6>
    1193:	e8 e8 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
