...
/app/bin_gccgcc10_O1/assignment14:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1181:	c7 44 24 04 15 00 00 	movl   $0x15,0x4(%rsp)
    1188:	00 
    1189:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    118e:	48 8d 35 73 0e 00 00 	lea    0xe73(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    1195:	bf 01 00 00 00       	mov    $0x1,%edi
    119a:	e8 d1 fe ff ff       	callq  1070 <__printf_chk@plt>
    119f:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11a4:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11ab:	00 00 
    11ad:	75 0a                	jne    11b9 <main+0x50>
    11af:	b8 00 00 00 00       	mov    $0x0,%eax
    11b4:	48 83 c4 18          	add    $0x18,%rsp
    11b8:	c3                   	retq   
    11b9:	e8 a2 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
