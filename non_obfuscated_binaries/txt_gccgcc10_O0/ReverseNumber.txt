...
/app/bin_gccgcc10_O0/ReverseNumber:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d7:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    11db:	48 89 c6             	mov    %rax,%rsi
    11de:	48 8d 3d 3d 0e 00 00 	lea    0xe3d(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    11e5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ea:	e8 c1 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11ef:	eb 5c                	jmp    124d <main+0xa4>
    11f1:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11f4:	89 d0                	mov    %edx,%eax
    11f6:	c1 e0 02             	shl    $0x2,%eax
    11f9:	01 d0                	add    %edx,%eax
    11fb:	01 c0                	add    %eax,%eax
    11fd:	89 45 f4             	mov    %eax,-0xc(%rbp)
    1200:	8b 4d f0             	mov    -0x10(%rbp),%ecx
    1203:	48 63 c1             	movslq %ecx,%rax
    1206:	48 69 c0 67 66 66 66 	imul   $0x66666667,%rax,%rax
    120d:	48 c1 e8 20          	shr    $0x20,%rax
    1211:	c1 f8 02             	sar    $0x2,%eax
    1214:	89 ce                	mov    %ecx,%esi
    1216:	c1 fe 1f             	sar    $0x1f,%esi
    1219:	29 f0                	sub    %esi,%eax
    121b:	89 c2                	mov    %eax,%edx
    121d:	89 d0                	mov    %edx,%eax
    121f:	c1 e0 02             	shl    $0x2,%eax
    1222:	01 d0                	add    %edx,%eax
    1224:	01 c0                	add    %eax,%eax
    1226:	29 c1                	sub    %eax,%ecx
    1228:	89 ca                	mov    %ecx,%edx
    122a:	01 55 f4             	add    %edx,-0xc(%rbp)
    122d:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1230:	48 63 d0             	movslq %eax,%rdx
    1233:	48 69 d2 67 66 66 66 	imul   $0x66666667,%rdx,%rdx
    123a:	48 c1 ea 20          	shr    $0x20,%rdx
    123e:	c1 fa 02             	sar    $0x2,%edx
    1241:	c1 f8 1f             	sar    $0x1f,%eax
    1244:	89 c1                	mov    %eax,%ecx
    1246:	89 d0                	mov    %edx,%eax
    1248:	29 c8                	sub    %ecx,%eax
    124a:	89 45 f0             	mov    %eax,-0x10(%rbp)
    124d:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1250:	85 c0                	test   %eax,%eax
    1252:	75 9d                	jne    11f1 <main+0x48>
    1254:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1257:	89 c6                	mov    %eax,%esi
    1259:	48 8d 3d c8 0d 00 00 	lea    0xdc8(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    1260:	b8 00 00 00 00       	mov    $0x0,%eax
    1265:	e8 36 fe ff ff       	callq  10a0 <printf@plt>
    126a:	b8 00 00 00 00       	mov    $0x0,%eax
    126f:	48 8b 7d f8          	mov    -0x8(%rbp),%rdi
