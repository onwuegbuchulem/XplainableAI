...
/app/bin_gccgcc10_O0/2023_06_01-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1217:	48 8d 3d 1d 0e 00 00 	lea    0xe1d(%rip),%rdi        # 203b <_IO_stdin_used+0x3b>
    121e:	b8 00 00 00 00       	mov    $0x0,%eax
    1223:	e8 58 fe ff ff       	callq  1080 <printf@plt>
    1228:	b8 00 00 00 00       	mov    $0x0,%eax
    122d:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1231:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1238:	00 00 
