...
/app/bin_gccgcc10_O1/filter02:     file format elf64-x86-64
...
00000000000010c0 <_start>:
    ...
    10d1:	50                   	push   %rax
    10d2:	54                   	push   %rsp
    10d3:	4c 8d 05 b6 01 00 00 	lea    0x1b6(%rip),%r8        # 1290 <__libc_csu_fini>
    10da:	48 8d 0d 3f 01 00 00 	lea    0x13f(%rip),%rcx        # 1220 <__libc_csu_init>
...
00000000000011a9 <main>:
    ...
    11b3:	eb 0e                	jmp    11c3 <main+0x1a>
    11b5:	48 8b 35 54 2e 00 00 	mov    0x2e54(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11bc:	89 df                	mov    %ebx,%edi
    11be:	e8 cd fe ff ff       	callq  1090 <putc@plt>
    11c3:	48 8b 3d 56 2e 00 00 	mov    0x2e56(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    11ca:	e8 d1 fe ff ff       	callq  10a0 <getc@plt>
    11cf:	89 c3                	mov    %eax,%ebx
    11d1:	83 f8 ff             	cmp    $0xffffffff,%eax
    11d4:	74 3c                	je     1212 <main+0x69>
    11d6:	e8 d5 fe ff ff       	callq  10b0 <__ctype_b_loc@plt>
    11db:	48 63 eb             	movslq %ebx,%rbp
    11de:	48 8b 00             	mov    (%rax),%rax
    11e1:	f6 44 68 01 02       	testb  $0x2,0x1(%rax,%rbp,2)
    11e6:	74 1a                	je     1202 <main+0x59>
    11e8:	8d 83 80 00 00 00    	lea    0x80(%rbx),%eax
    11ee:	3d 7f 01 00 00       	cmp    $0x17f,%eax
    11f3:	77 c0                	ja     11b5 <main+0xc>
    11f5:	e8 86 fe ff ff       	callq  1080 <__ctype_toupper_loc@plt>
    11fa:	48 8b 00             	mov    (%rax),%rax
    11fd:	8b 1c a8             	mov    (%rax,%rbp,4),%ebx
    1200:	eb b3                	jmp    11b5 <main+0xc>
    1202:	48 8b 35 07 2e 00 00 	mov    0x2e07(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1209:	89 df                	mov    %ebx,%edi
    120b:	e8 80 fe ff ff       	callq  1090 <putc@plt>
    1210:	eb b1                	jmp    11c3 <main+0x1a>
