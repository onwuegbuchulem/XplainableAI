...
/app/bin_gccgcc10_O0/ttt06:     file format elf64-x86-64
...
0000000000001140 <_start>:
    ...
    1151:	50                   	push   %rax
    1152:	54                   	push   %rsp
    1153:	4c 8d 05 66 08 00 00 	lea    0x866(%rip),%r8        # 19c0 <__libc_csu_fini>
    115a:	48 8d 0d ef 07 00 00 	lea    0x7ef(%rip),%rcx        # 1950 <__libc_csu_init>
...
000000000000174a <main>:
    ...
    17ba:	48 8d 45 c0          	lea    -0x40(%rbp),%rax
    ...
    17d2:	8b 45 c0             	mov    -0x40(%rbp),%eax
    17d5:	85 c0                	test   %eax,%eax
    17d7:	78 08                	js     17e1 <main+0x97>
    17d9:	8b 45 c0             	mov    -0x40(%rbp),%eax
    17dc:	83 f8 02             	cmp    $0x2,%eax
    17df:	7e 0a                	jle    17eb <main+0xa1>
    17e1:	b8 01 00 00 00       	mov    $0x1,%eax
    17e6:	e9 4f 01 00 00       	jmpq   193a <main+0x1f0>
    17eb:	8b 45 c0             	mov    -0x40(%rbp),%eax
    17ee:	83 f8 01             	cmp    $0x1,%eax
    17f1:	75 44                	jne    1837 <main+0xed>
    17f3:	48 8d 3d fe 08 00 00 	lea    0x8fe(%rip),%rdi        # 20f8 <_IO_stdin_used+0xf8>
    17fa:	b8 00 00 00 00       	mov    $0x0,%eax
    17ff:	e8 ec f8 ff ff       	callq  10f0 <printf@plt>
    1804:	e8 27 f9 ff ff       	callq  1130 <rand@plt>
    1809:	99                   	cltd   
    180a:	c1 ea 1f             	shr    $0x1f,%edx
    180d:	01 d0                	add    %edx,%eax
    180f:	83 e0 01             	and    $0x1,%eax
    1812:	29 d0                	sub    %edx,%eax
    1814:	89 45 cc             	mov    %eax,-0x34(%rbp)
    1817:	83 7d cc 00          	cmpl   $0x0,-0x34(%rbp)
    181b:	74 0e                	je     182b <main+0xe1>
    181d:	48 8d 3d f5 08 00 00 	lea    0x8f5(%rip),%rdi        # 2119 <_IO_stdin_used+0x119>
    1824:	e8 a7 f8 ff ff       	callq  10d0 <puts@plt>
    1829:	eb 0c                	jmp    1837 <main+0xed>
    182b:	48 8d 3d f5 08 00 00 	lea    0x8f5(%rip),%rdi        # 2127 <_IO_stdin_used+0x127>
    1832:	e8 99 f8 ff ff       	callq  10d0 <puts@plt>
    1837:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%rbp)
    183e:	e9 c4 00 00 00       	jmpq   1907 <main+0x1bd>
    1843:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    1847:	48 89 c7             	mov    %rax,%rdi
    184a:	e8 da f9 ff ff       	callq  1229 <showgrid>
    184f:	8b 45 c0             	mov    -0x40(%rbp),%eax
    1852:	85 c0                	test   %eax,%eax
    1854:	75 11                	jne    1867 <main+0x11d>
    1856:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    185a:	48 89 c7             	mov    %rax,%rdi
    185d:	e8 71 fe ff ff       	callq  16d3 <computer>
    1862:	89 45 c8             	mov    %eax,-0x38(%rbp)
    1865:	eb 64                	jmp    18cb <main+0x181>
    1867:	8b 45 c0             	mov    -0x40(%rbp),%eax
    186a:	83 f8 01             	cmp    $0x1,%eax
    186d:	75 41                	jne    18b0 <main+0x166>
    186f:	8b 45 c4             	mov    -0x3c(%rbp),%eax
    1872:	99                   	cltd   
    1873:	c1 ea 1f             	shr    $0x1f,%edx
    1876:	01 d0                	add    %edx,%eax
    1878:	83 e0 01             	and    $0x1,%eax
    187b:	29 d0                	sub    %edx,%eax
    187d:	39 45 cc             	cmp    %eax,-0x34(%rbp)
    1880:	75 11                	jne    1893 <main+0x149>
    1882:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    1886:	48 89 c7             	mov    %rax,%rdi
    1889:	e8 45 fe ff ff       	callq  16d3 <computer>
    188e:	89 45 c8             	mov    %eax,-0x38(%rbp)
    1891:	eb 38                	jmp    18cb <main+0x181>
    1893:	90                   	nop
    1894:	48 8d 55 d0          	lea    -0x30(%rbp),%rdx
    1898:	8b 45 c4             	mov    -0x3c(%rbp),%eax
    189b:	48 89 d6             	mov    %rdx,%rsi
    189e:	89 c7                	mov    %eax,%edi
    18a0:	e8 4d fd ff ff       	callq  15f2 <prompt>
    18a5:	89 45 c8             	mov    %eax,-0x38(%rbp)
    18a8:	83 7d c8 ff          	cmpl   $0xffffffff,-0x38(%rbp)
    18ac:	74 e6                	je     1894 <main+0x14a>
    18ae:	eb 1b                	jmp    18cb <main+0x181>
    18b0:	90                   	nop
    18b1:	48 8d 55 d0          	lea    -0x30(%rbp),%rdx
    18b5:	8b 45 c4             	mov    -0x3c(%rbp),%eax
    18b8:	48 89 d6             	mov    %rdx,%rsi
    18bb:	89 c7                	mov    %eax,%edi
    18bd:	e8 30 fd ff ff       	callq  15f2 <prompt>
    18c2:	89 45 c8             	mov    %eax,-0x38(%rbp)
    18c5:	83 7d c8 ff          	cmpl   $0xffffffff,-0x38(%rbp)
    18c9:	74 e6                	je     18b1 <main+0x167>
    18cb:	83 7d c8 00          	cmpl   $0x0,-0x38(%rbp)
    18cf:	74 42                	je     1913 <main+0x1c9>
    18d1:	8b 45 c4             	mov    -0x3c(%rbp),%eax
    18d4:	83 e0 01             	and    $0x1,%eax
    18d7:	85 c0                	test   %eax,%eax
    18d9:	74 07                	je     18e2 <main+0x198>
    18db:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    18e0:	eb 05                	jmp    18e7 <main+0x19d>
    18e2:	ba 01 00 00 00       	mov    $0x1,%edx
    18e7:	8b 45 c8             	mov    -0x38(%rbp),%eax
    18ea:	83 e8 01             	sub    $0x1,%eax
    18ed:	48 98                	cltq   
    18ef:	89 54 85 d0          	mov    %edx,-0x30(%rbp,%rax,4)
    18f3:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    18f7:	48 89 c7             	mov    %rax,%rdi
    18fa:	e8 30 fb ff ff       	callq  142f <winner>
    18ff:	85 c0                	test   %eax,%eax
    1901:	75 13                	jne    1916 <main+0x1cc>
    1903:	83 45 c4 01          	addl   $0x1,-0x3c(%rbp)
    1907:	83 7d c4 08          	cmpl   $0x8,-0x3c(%rbp)
    190b:	0f 8e 32 ff ff ff    	jle    1843 <main+0xf9>
    1911:	eb 04                	jmp    1917 <main+0x1cd>
    1913:	90                   	nop
    1914:	eb 01                	jmp    1917 <main+0x1cd>
    1916:	90                   	nop
    1917:	83 7d c4 09          	cmpl   $0x9,-0x3c(%rbp)
    191b:	75 18                	jne    1935 <main+0x1eb>
    191d:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    1921:	48 89 c7             	mov    %rax,%rdi
    1924:	e8 00 f9 ff ff       	callq  1229 <showgrid>
    1929:	48 8d 3d 10 08 00 00 	lea    0x810(%rip),%rdi        # 2140 <_IO_stdin_used+0x140>
    1930:	e8 9b f7 ff ff       	callq  10d0 <puts@plt>
    1935:	b8 00 00 00 00       	mov    $0x0,%eax
    193a:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    193e:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1945:	00 00 
    1947:	74 05                	je     194e <main+0x204>
    1949:	e8 92 f7 ff ff       	callq  10e0 <__stack_chk_fail@plt>
    194e:	c9                   	leaveq 
    194f:	c3                   	retq   
