...
/app/bin_gccgcc10_O1/2023_02_25-Lesson-a:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    121c:	4c 8d 6c 24 24       	lea    0x24(%rsp),%r13
    1221:	49 89 ec             	mov    %rbp,%r12
    1224:	eb 09                	jmp    122f <main+0x46>
    1226:	49 83 c4 0c          	add    $0xc,%r12
    122a:	4d 39 ec             	cmp    %r13,%r12
    122d:	74 39                	je     1268 <main+0x7f>
    122f:	bb 00 00 00 00       	mov    $0x0,%ebx
    1234:	e8 b7 fe ff ff       	callq  10f0 <rand@plt>
    1239:	48 63 d0             	movslq %eax,%rdx
    123c:	48 69 d2 67 66 66 66 	imul   $0x66666667,%rdx,%rdx
    1243:	48 c1 fa 22          	sar    $0x22,%rdx
    1247:	89 c1                	mov    %eax,%ecx
    1249:	c1 f9 1f             	sar    $0x1f,%ecx
    124c:	29 ca                	sub    %ecx,%edx
    124e:	8d 14 92             	lea    (%rdx,%rdx,4),%edx
    1251:	01 d2                	add    %edx,%edx
    1253:	29 d0                	sub    %edx,%eax
    1255:	83 c0 01             	add    $0x1,%eax
    1258:	41 89 04 9c          	mov    %eax,(%r12,%rbx,4)
    125c:	48 83 c3 01          	add    $0x1,%rbx
    1260:	48 83 fb 03          	cmp    $0x3,%rbx
    1264:	75 ce                	jne    1234 <main+0x4b>
    1266:	eb be                	jmp    1226 <main+0x3d>
    1268:	4c 8d 25 95 0d 00 00 	lea    0xd95(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    126f:	eb 1a                	jmp    128b <main+0xa2>
    1271:	48 8b 35 98 2d 00 00 	mov    0x2d98(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1278:	bf 0a 00 00 00       	mov    $0xa,%edi
    127d:	e8 3e fe ff ff       	callq  10c0 <putc@plt>
    1282:	48 83 c5 0c          	add    $0xc,%rbp
    1286:	4c 39 ed             	cmp    %r13,%rbp
    1289:	74 27                	je     12b2 <main+0xc9>
    128b:	bb 00 00 00 00       	mov    $0x0,%ebx
    1290:	8b 54 9d 00          	mov    0x0(%rbp,%rbx,4),%edx
    ...
    12a6:	48 83 c3 01          	add    $0x1,%rbx
    12aa:	48 83 fb 03          	cmp    $0x3,%rbx
    12ae:	75 e0                	jne    1290 <main+0xa7>
    12b0:	eb bf                	jmp    1271 <main+0x88>
    12b2:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    12b7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12be:	00 00 
    12c0:	75 10                	jne    12d2 <main+0xe9>
    12c2:	b8 00 00 00 00       	mov    $0x0,%eax
    12c7:	48 83 c4 38          	add    $0x38,%rsp
    12cb:	5b                   	pop    %rbx
    12cc:	5d                   	pop    %rbp
    12cd:	41 5c                	pop    %r12
    12cf:	41 5d                	pop    %r13
