...
/app/bin_gccgcc10_O1/Pointers:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1182:	c7 44 24 04 16 00 00 	movl   $0x16,0x4(%rsp)
    1189:	00 
    118a:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx
    118f:	48 89 da             	mov    %rbx,%rdx
    1192:	48 8d 35 6b 0e 00 00 	lea    0xe6b(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1199:	bf 01 00 00 00       	mov    $0x1,%edi
    119e:	e8 cd fe ff ff       	callq  1070 <__printf_chk@plt>
    11a3:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11a7:	48 8d 35 68 0e 00 00 	lea    0xe68(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    11ae:	bf 01 00 00 00       	mov    $0x1,%edi
    11b3:	b8 00 00 00 00       	mov    $0x0,%eax
    11b8:	e8 b3 fe ff ff       	callq  1070 <__printf_chk@plt>
    11bd:	48 89 da             	mov    %rbx,%rdx
    11c0:	48 8d 35 3d 0e 00 00 	lea    0xe3d(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11c7:	bf 01 00 00 00       	mov    $0x1,%edi
    11cc:	b8 00 00 00 00       	mov    $0x0,%eax
    11d1:	e8 9a fe ff ff       	callq  1070 <__printf_chk@plt>
    11d6:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11da:	48 8d 35 46 0e 00 00 	lea    0xe46(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    11e1:	bf 01 00 00 00       	mov    $0x1,%edi
    11e6:	b8 00 00 00 00       	mov    $0x0,%eax
    11eb:	e8 80 fe ff ff       	callq  1070 <__printf_chk@plt>
    11f0:	c7 44 24 04 0b 00 00 	movl   $0xb,0x4(%rsp)
    11f7:	00 
    11f8:	48 89 da             	mov    %rbx,%rdx
    11fb:	48 8d 35 02 0e 00 00 	lea    0xe02(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1202:	bf 01 00 00 00       	mov    $0x1,%edi
    1207:	b8 00 00 00 00       	mov    $0x0,%eax
    120c:	e8 5f fe ff ff       	callq  1070 <__printf_chk@plt>
    1211:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1215:	48 8d 35 0b 0e 00 00 	lea    0xe0b(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    121c:	bf 01 00 00 00       	mov    $0x1,%edi
    1221:	b8 00 00 00 00       	mov    $0x0,%eax
    1226:	e8 45 fe ff ff       	callq  1070 <__printf_chk@plt>
    122b:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%rsp)
    1232:	00 
    1233:	48 89 da             	mov    %rbx,%rdx
    ...
    1247:	e8 24 fe ff ff       	callq  1070 <__printf_chk@plt>
    124c:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1250:	48 8d 35 bf 0d 00 00 	lea    0xdbf(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    1257:	bf 01 00 00 00       	mov    $0x1,%edi
    125c:	b8 00 00 00 00       	mov    $0x0,%eax
    1261:	e8 0a fe ff ff       	callq  1070 <__printf_chk@plt>
    1266:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    126b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1272:	00 00 
    1274:	75 0b                	jne    1281 <main+0x118>
    1276:	b8 00 00 00 00       	mov    $0x0,%eax
    127b:	48 83 c4 10          	add    $0x10,%rsp
    127f:	5b                   	pop    %rbx
    1280:	c3                   	retq   
    1281:	e8 da fd ff ff       	callq  1060 <__stack_chk_fail@plt>
