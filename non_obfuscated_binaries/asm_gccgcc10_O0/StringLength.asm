...
/app/bin_gccgcc10_O0/StringLength:     file format elf64-x86-64
...
0000000000001189 <stringLength>:
    ...
    119c:	eb 04                	jmp    11a2 <stringLength+0x19>
    ...
    11b4:	75 e8                	jne    119e <stringLength+0x15>
...
00000000000011bb <main>:
    ...
    11ee:	48 8d 45 90          	lea    -0x70(%rbp),%rax
