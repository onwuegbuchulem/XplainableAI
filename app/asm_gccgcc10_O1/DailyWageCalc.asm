...
/app/bin_gccgcc10_O1/DailyWageCalc:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d2:	48 8d 3d 46 0e 00 00 	lea    0xe46(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	e8 cd fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e3:	8b 44 24 04          	mov    0x4(%rsp),%eax
    11e7:	8d 48 ff             	lea    -0x1(%rax),%ecx
    11ea:	ba 64 00 00 00       	mov    $0x64,%edx
    11ef:	83 f9 07             	cmp    $0x7,%ecx
    11f2:	76 11                	jbe    1205 <main+0x5c>
    11f4:	8d 48 f7             	lea    -0x9(%rax),%ecx
    11f7:	83 f9 03             	cmp    $0x3,%ecx
    11fa:	77 39                	ja     1235 <main+0x8c>
    11fc:	83 e8 08             	sub    $0x8,%eax
    11ff:	6b c0 14             	imul   $0x14,%eax,%eax
    1202:	8d 50 64             	lea    0x64(%rax),%edx
    1205:	48 8d 35 1c 0e 00 00 	lea    0xe1c(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    120c:	bf 01 00 00 00       	mov    $0x1,%edi
    1211:	b8 00 00 00 00       	mov    $0x0,%eax
    1216:	e8 85 fe ff ff       	callq  10a0 <__printf_chk@plt>
    121b:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1220:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1227:	00 00 
    1229:	75 4c                	jne    1277 <main+0xce>
    122b:	b8 00 00 00 00       	mov    $0x0,%eax
    1230:	48 83 c4 18          	add    $0x18,%rsp
    1234:	c3                   	retq   
    1235:	8d 48 f3             	lea    -0xd(%rax),%ecx
    1238:	83 f9 03             	cmp    $0x3,%ecx
    123b:	77 0e                	ja     124b <main+0xa2>
    123d:	83 e8 0c             	sub    $0xc,%eax
    1240:	6b c0 28             	imul   $0x28,%eax,%eax
    1243:	8d 90 b4 00 00 00    	lea    0xb4(%rax),%edx
    1249:	eb ba                	jmp    1205 <main+0x5c>
    124b:	8d 48 ef             	lea    -0x11(%rax),%ecx
    124e:	83 f9 03             	cmp    $0x3,%ecx
    1251:	77 0e                	ja     1261 <main+0xb8>
    1253:	83 e8 10             	sub    $0x10,%eax
    1256:	6b c0 3c             	imul   $0x3c,%eax,%eax
    1259:	8d 90 54 01 00 00    	lea    0x154(%rax),%edx
    125f:	eb a4                	jmp    1205 <main+0x5c>
    1261:	8d 48 eb             	lea    -0x15(%rax),%ecx
    1264:	83 f9 03             	cmp    $0x3,%ecx
    1267:	77 9c                	ja     1205 <main+0x5c>
    1269:	83 e8 14             	sub    $0x14,%eax
    126c:	6b c0 50             	imul   $0x50,%eax,%eax
    126f:	8d 90 44 02 00 00    	lea    0x244(%rax),%edx
    1275:	eb 8e                	jmp    1205 <main+0x5c>
