...
/app/bin_gccgcc10_O1/DynamicTwoDArrayUsingOnePointer:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1177:	bf 30 00 00 00       	mov    $0x30,%edi
    117c:	e8 df fe ff ff       	callq  1060 <malloc@plt>
    1181:	48 89 c5             	mov    %rax,%rbp
    1184:	be 00 00 00 00       	mov    $0x0,%esi
    1189:	b9 04 00 00 00       	mov    $0x4,%ecx
    118e:	89 f0                	mov    %esi,%eax
    1190:	48 8d 54 b5 00       	lea    0x0(%rbp,%rsi,4),%rdx
    1195:	83 c0 01             	add    $0x1,%eax
    1198:	89 02                	mov    %eax,(%rdx)
    119a:	48 83 c2 04          	add    $0x4,%rdx
    119e:	39 c8                	cmp    %ecx,%eax
    11a0:	75 f3                	jne    1195 <main+0x2c>
    11a2:	83 c1 04             	add    $0x4,%ecx
    11a5:	48 83 c6 04          	add    $0x4,%rsi
    11a9:	83 f9 10             	cmp    $0x10,%ecx
    11ac:	75 e0                	jne    118e <main+0x25>
    11ae:	48 83 c5 10          	add    $0x10,%rbp
    11b2:	41 bd 00 00 00 00    	mov    $0x0,%r13d
    11b8:	4c 8d 25 45 0e 00 00 	lea    0xe45(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    11bf:	48 8d 5d f0          	lea    -0x10(%rbp),%rbx
    11c3:	8b 13                	mov    (%rbx),%edx
    ...
    11d7:	48 83 c3 04          	add    $0x4,%rbx
    11db:	48 39 eb             	cmp    %rbp,%rbx
    11de:	75 e3                	jne    11c3 <main+0x5a>
    11e0:	49 83 c5 04          	add    $0x4,%r13
    11e4:	48 83 c5 10          	add    $0x10,%rbp
    11e8:	49 83 fd 0c          	cmp    $0xc,%r13
    11ec:	75 d1                	jne    11bf <main+0x56>
