...
/app/bin_gccgcc10_O3/2024_03_02-Lesson:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    1100:	83 f8 02             	cmp    $0x2,%eax
    1103:	74 2d                	je     1132 <main+0x72>
    1105:	83 f8 03             	cmp    $0x3,%eax
    1108:	74 44                	je     114e <main+0x8e>
    110a:	83 f8 01             	cmp    $0x1,%eax
    110d:	74 31                	je     1140 <main+0x80>
    110f:	48 8d 3d 00 0f 00 00 	lea    0xf00(%rip),%rdi        # 2016 <_IO_stdin_used+0x16>
    1116:	e8 65 ff ff ff       	callq  1080 <puts@plt>
    111b:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1120:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1127:	00 00 
    1129:	75 31                	jne    115c <main+0x9c>
    112b:	31 c0                	xor    %eax,%eax
    112d:	48 83 c4 18          	add    $0x18,%rsp
    1131:	c3                   	retq   
    1132:	48 8d 3d e6 0e 00 00 	lea    0xee6(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    1139:	e8 42 ff ff ff       	callq  1080 <puts@plt>
    113e:	eb db                	jmp    111b <main+0x5b>
    1140:	48 8d 3d ca 0e 00 00 	lea    0xeca(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    1147:	e8 34 ff ff ff       	callq  1080 <puts@plt>
    114c:	eb cd                	jmp    111b <main+0x5b>
    114e:	48 8d 3d cf 0e 00 00 	lea    0xecf(%rip),%rdi        # 2024 <_IO_stdin_used+0x24>
    1155:	e8 26 ff ff ff       	callq  1080 <puts@plt>
    115a:	eb bf                	jmp    111b <main+0x5b>
