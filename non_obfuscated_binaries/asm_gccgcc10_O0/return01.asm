...
/app/bin_gccgcc10_O0/return01:     file format elf64-x86-64
...
0000000000001060 <strtol@plt>:
    ...
    1064:	f2 ff 25 5d 2f 00 00 	bnd jmpq *0x2f5d(%rip)        # 3fc8 <strtol@GLIBC_2.2.5>
...
0000000000001169 <main>:
    ...
    1180:	7e 1f                	jle    11a1 <main+0x38>
    1182:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1186:	48 83 c0 08          	add    $0x8,%rax
    118a:	48 8b 00             	mov    (%rax),%rax
    118d:	ba 0a 00 00 00       	mov    $0xa,%edx
    1192:	be 00 00 00 00       	mov    $0x0,%esi
    1197:	48 89 c7             	mov    %rax,%rdi
    119a:	e8 c1 fe ff ff       	callq  1060 <strtol@plt>
    119f:	eb 0a                	jmp    11ab <main+0x42>
    11a1:	bf 00 00 00 00       	mov    $0x0,%edi
    11a6:	e8 c5 fe ff ff       	callq  1070 <exit@plt>
    11ab:	c9                   	leaveq 
    11ac:	c3                   	retq   
