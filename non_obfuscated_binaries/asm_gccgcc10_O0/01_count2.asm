...
/app/bin_gccgcc10_O0/01_count2:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	48 8b 05 cc 0e 00 00 	mov    0xecc(%rip),%rax        # 2028 <_IO_stdin_used+0x28>
    115c:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1161:	48 8d 3d a0 0e 00 00 	lea    0xea0(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    1168:	b8 01 00 00 00       	mov    $0x1,%eax
    ...
    117a:	48 8d 3d 8e 0e 00 00 	lea    0xe8e(%rip),%rdi        # 200f <_IO_stdin_used+0xf>
