...
/app/bin_gccgcc10_O1/2021_08-Exercise:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117d:	bb 00 00 00 00       	mov    $0x0,%ebx
    1182:	4c 8d 25 e0 0e 00 00 	lea    0xee0(%rip),%r12        # 2069 <_IO_stdin_used+0x69>
    1189:	8d 6b 40             	lea    0x40(%rbx),%ebp
    118c:	41 89 e9             	mov    %ebp,%r9d
    118f:	41 89 d8             	mov    %ebx,%r8d
    1192:	89 d9                	mov    %ebx,%ecx
    1194:	89 da                	mov    %ebx,%edx
    1196:	48 8d 35 b6 0e 00 00 	lea    0xeb6(%rip),%rsi        # 2053 <_IO_stdin_used+0x53>
    119d:	bf 01 00 00 00       	mov    $0x1,%edi
    11a2:	b8 00 00 00 00       	mov    $0x0,%eax
    11a7:	e8 c4 fe ff ff       	callq  1070 <__printf_chk@plt>
    11ac:	8d 53 20             	lea    0x20(%rbx),%edx
    11af:	41 89 d1             	mov    %edx,%r9d
    11b2:	41 89 d0             	mov    %edx,%r8d
    11b5:	89 d1                	mov    %edx,%ecx
    11b7:	4c 89 e6             	mov    %r12,%rsi
    11ba:	bf 01 00 00 00       	mov    $0x1,%edi
    11bf:	b8 00 00 00 00       	mov    $0x0,%eax
    11c4:	e8 a7 fe ff ff       	callq  1070 <__printf_chk@plt>
    11c9:	41 89 e9             	mov    %ebp,%r9d
    11cc:	41 89 e8             	mov    %ebp,%r8d
    11cf:	89 e9                	mov    %ebp,%ecx
    11d1:	89 ea                	mov    %ebp,%edx
    ...
    11e5:	8d 53 60             	lea    0x60(%rbx),%edx
    11e8:	41 89 d1             	mov    %edx,%r9d
    11eb:	41 89 d0             	mov    %edx,%r8d
    11ee:	89 d1                	mov    %edx,%ecx
    11f0:	48 8d 35 87 0e 00 00 	lea    0xe87(%rip),%rsi        # 207e <_IO_stdin_used+0x7e>
    11f7:	bf 01 00 00 00       	mov    $0x1,%edi
    11fc:	b8 00 00 00 00       	mov    $0x0,%eax
    1201:	e8 6a fe ff ff       	callq  1070 <__printf_chk@plt>
    1206:	83 c3 01             	add    $0x1,%ebx
    1209:	83 fb 20             	cmp    $0x20,%ebx
    120c:	0f 85 77 ff ff ff    	jne    1189 <main+0x20>
