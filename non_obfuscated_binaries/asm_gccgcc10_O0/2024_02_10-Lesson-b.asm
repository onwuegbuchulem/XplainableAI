...
/app/bin_gccgcc10_O0/2024_02_10-Lesson-b:     file format elf64-x86-64
...
0000000000001060 <strncmp@plt>:
    ...
    1064:	f2 ff 25 5d 2f 00 00 	bnd jmpq *0x2f5d(%rip)        # 3fc8 <strncmp@GLIBC_2.2.5>
    106b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001070 <puts@plt>:
    1070:	f3 0f 1e fa          	endbr64 
    1074:	f2 ff 25 55 2f 00 00 	bnd jmpq *0x2f55(%rip)        # 3fd0 <puts@GLIBC_2.2.5>
...
0000000000001169 <main>:
    ...
    117d:	eb 48                	jmp    11c7 <main+0x5e>
    117f:	48 8b 05 9a 2e 00 00 	mov    0x2e9a(%rip),%rax        # 4020 <__environ@@GLIBC_2.2.5>
    1186:	48 8b 00             	mov    (%rax),%rax
    1189:	ba 04 00 00 00       	mov    $0x4,%edx
    118e:	48 8d 35 7c 0e 00 00 	lea    0xe7c(%rip),%rsi        # 2011 <_IO_stdin_used+0x11>
    1195:	48 89 c7             	mov    %rax,%rdi
    1198:	e8 c3 fe ff ff       	callq  1060 <strncmp@plt>
    119d:	85 c0                	test   %eax,%eax
    119f:	75 14                	jne    11b5 <main+0x4c>
    11a1:	48 8b 05 78 2e 00 00 	mov    0x2e78(%rip),%rax        # 4020 <__environ@@GLIBC_2.2.5>
    11a8:	48 8b 00             	mov    (%rax),%rax
    11ab:	48 89 c7             	mov    %rax,%rdi
    11ae:	e8 bd fe ff ff       	callq  1070 <puts@plt>
    11b3:	eb 21                	jmp    11d6 <main+0x6d>
    11b5:	48 8b 05 64 2e 00 00 	mov    0x2e64(%rip),%rax        # 4020 <__environ@@GLIBC_2.2.5>
    11bc:	48 83 c0 08          	add    $0x8,%rax
    11c0:	48 89 05 59 2e 00 00 	mov    %rax,0x2e59(%rip)        # 4020 <__environ@@GLIBC_2.2.5>
    11c7:	48 8b 05 52 2e 00 00 	mov    0x2e52(%rip),%rax        # 4020 <__environ@@GLIBC_2.2.5>
    11ce:	48 8b 00             	mov    (%rax),%rax
    11d1:	48 85 c0             	test   %rax,%rax
    11d4:	75 a9                	jne    117f <main+0x16>
