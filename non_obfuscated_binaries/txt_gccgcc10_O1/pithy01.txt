...
/app/bin_gccgcc10_O1/pithy01:     file format elf64-x86-64
...
0000000000001229 <main>:
    ...
    122d:	55                   	push   %rbp
    122e:	53                   	push   %rbx
    122f:	48 81 ec 28 01 00 00 	sub    $0x128,%rsp
    1236:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    123d:	00 00 
    123f:	48 89 84 24 18 01 00 	mov    %rax,0x118(%rsp)
    1246:	00 
    1247:	31 c0                	xor    %eax,%eax
    1249:	48 b8 70 69 74 68 79 	movabs $0x78742e7968746970,%rax
    1250:	2e 74 78 
    1253:	48 89 44 24 06       	mov    %rax,0x6(%rsp)
    1258:	66 c7 44 24 0e 74 00 	movw   $0x74,0xe(%rsp)
    125f:	48 8d 7c 24 06       	lea    0x6(%rsp),%rdi
    1264:	48 8d 35 99 0d 00 00 	lea    0xd99(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    126b:	e8 a0 fe ff ff       	callq  1110 <fopen@plt>
    1270:	48 85 c0             	test   %rax,%rax
    1273:	74 44                	je     12b9 <main+0x90>
    1275:	48 89 c3             	mov    %rax,%rbx
    1278:	48 8d 6c 24 10       	lea    0x10(%rsp),%rbp
    127d:	48 89 df             	mov    %rbx,%rdi
    1280:	e8 6b fe ff ff       	callq  10f0 <feof@plt>
    1285:	85 c0                	test   %eax,%eax
    1287:	75 5c                	jne    12e5 <main+0xbc>
    1289:	48 89 da             	mov    %rbx,%rdx
    128c:	be 00 01 00 00       	mov    $0x100,%esi
    1291:	48 89 ef             	mov    %rbp,%rdi
    1294:	e8 47 fe ff ff       	callq  10e0 <fgets@plt>
    1299:	48 85 c0             	test   %rax,%rax
    129c:	74 47                	je     12e5 <main+0xbc>
    129e:	48 89 ea             	mov    %rbp,%rdx
    12a1:	48 8d 35 76 0d 00 00 	lea    0xd76(%rip),%rsi        # 201e <_IO_stdin_used+0x1e>
    12a8:	bf 01 00 00 00       	mov    $0x1,%edi
    12ad:	b8 00 00 00 00       	mov    $0x0,%eax
    12b2:	e8 49 fe ff ff       	callq  1100 <__printf_chk@plt>
    12b7:	eb c4                	jmp    127d <main+0x54>
    12b9:	48 8d 4c 24 06       	lea    0x6(%rsp),%rcx
    12be:	48 8d 15 41 0d 00 00 	lea    0xd41(%rip),%rdx        # 2006 <_IO_stdin_used+0x6>
    12c5:	be 01 00 00 00       	mov    $0x1,%esi
    12ca:	48 8b 3d 4f 2d 00 00 	mov    0x2d4f(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    12d1:	b8 00 00 00 00       	mov    $0x0,%eax
    12d6:	e8 55 fe ff ff       	callq  1130 <__fprintf_chk@plt>
    12db:	bf 01 00 00 00       	mov    $0x1,%edi
    12e0:	e8 3b fe ff ff       	callq  1120 <exit@plt>
    12e5:	48 89 df             	mov    %rbx,%rdi
    12e8:	e8 d3 fd ff ff       	callq  10c0 <fclose@plt>
    12ed:	48 8b 84 24 18 01 00 	mov    0x118(%rsp),%rax
    12f4:	00 
    12f5:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12fc:	00 00 
    12fe:	75 0f                	jne    130f <main+0xe6>
    1300:	b8 00 00 00 00       	mov    $0x0,%eax
    1305:	48 81 c4 28 01 00 00 	add    $0x128,%rsp
    130c:	5b                   	pop    %rbx
    130d:	5d                   	pop    %rbp
    130e:	c3                   	retq   
    130f:	e8 bc fd ff ff       	callq  10d0 <__stack_chk_fail@plt>
