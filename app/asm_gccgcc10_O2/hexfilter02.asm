...
/app/bin_gccgcc10_O2/hexfilter02:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ad:	55                   	push   %rbp
    10ae:	53                   	push   %rbx
    10af:	31 ed                	xor    %ebp,%ebp
    10b1:	eb 23                	jmp    10d6 <main+0x36>
    10b3:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10b8:	89 da                	mov    %ebx,%edx
    10ba:	4c 89 e6             	mov    %r12,%rsi
    10bd:	bf 01 00 00 00       	mov    $0x1,%edi
    10c2:	31 c0                	xor    %eax,%eax
    10c4:	e8 b7 ff ff ff       	callq  1080 <__printf_chk@plt>
    10c9:	83 c5 03             	add    $0x3,%ebp
    10cc:	83 fd 4d             	cmp    $0x4d,%ebp
    10cf:	7f 1f                	jg     10f0 <main+0x50>
    10d1:	83 fb 0a             	cmp    $0xa,%ebx
    10d4:	74 1a                	je     10f0 <main+0x50>
    10d6:	48 8b 3d 43 2f 00 00 	mov    0x2f43(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    10dd:	e8 ae ff ff ff       	callq  1090 <getc@plt>
    10e2:	89 c3                	mov    %eax,%ebx
    10e4:	83 f8 ff             	cmp    $0xffffffff,%eax
    10e7:	75 cf                	jne    10b8 <main+0x18>
    10e9:	5b                   	pop    %rbx
