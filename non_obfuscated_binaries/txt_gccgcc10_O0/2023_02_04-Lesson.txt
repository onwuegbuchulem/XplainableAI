...
/app/bin_gccgcc10_O0/2023_02_04-Lesson:     file format elf64-x86-64
...
0000000000001090 <ioctl@plt>:
    ...
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <ioctl@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    11ab:	be 13 54 00 00       	mov    $0x5413,%esi
    11b0:	bf 01 00 00 00       	mov    $0x1,%edi
    11b5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ba:	e8 d1 fe ff ff       	callq  1090 <ioctl@plt>
    11bf:	0f b7 45 f2          	movzwl -0xe(%rbp),%eax
    11c3:	0f b7 d0             	movzwl %ax,%edx
    11c6:	0f b7 45 f0          	movzwl -0x10(%rbp),%eax
    11ca:	0f b7 c0             	movzwl %ax,%eax
    ...
    11e9:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11f0:	00 00 
    11f2:	74 05                	je     11f9 <main+0x70>
    11f4:	e8 77 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    11f9:	c9                   	leaveq 
    11fa:	c3                   	retq   
