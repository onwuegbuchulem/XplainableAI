...
/app/bin_gccgcc10_O0/2023_02-Exercise:     file format elf64-x86-64
...
0000000000001090 <srand@plt>:
    ...
    1094:	f2 ff 25 25 2f 00 00 	bnd jmpq *0x2f25(%rip)        # 3fc0 <srand@GLIBC_2.2.5>
...
00000000000011a9 <main>:
    ...
    11ba:	e8 e1 fe ff ff       	callq  10a0 <time@plt>
    11bf:	89 c7                	mov    %eax,%edi
    11c1:	e8 ca fe ff ff       	callq  1090 <srand@plt>
    11c6:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    11cd:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%rbp)
    11d4:	eb 48                	jmp    121e <main+0x75>
    11d6:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    11da:	e8 d1 fe ff ff       	callq  10b0 <rand@plt>
    11df:	48 63 d0             	movslq %eax,%rdx
    11e2:	48 69 d2 1f 85 eb 51 	imul   $0x51eb851f,%rdx,%rdx
    11e9:	48 c1 ea 20          	shr    $0x20,%rdx
    11ed:	c1 fa 05             	sar    $0x5,%edx
    11f0:	89 c1                	mov    %eax,%ecx
    11f2:	c1 f9 1f             	sar    $0x1f,%ecx
    11f5:	29 ca                	sub    %ecx,%edx
    11f7:	89 55 f8             	mov    %edx,-0x8(%rbp)
    11fa:	8b 55 f8             	mov    -0x8(%rbp),%edx
    11fd:	6b d2 64             	imul   $0x64,%edx,%edx
    1200:	29 d0                	sub    %edx,%eax
    1202:	89 45 f8             	mov    %eax,-0x8(%rbp)
    1205:	8b 55 f8             	mov    -0x8(%rbp),%edx
    ...
    1219:	e8 62 fe ff ff       	callq  1080 <printf@plt>
    121e:	83 7d f8 63          	cmpl   $0x63,-0x8(%rbp)
    1222:	75 b2                	jne    11d6 <main+0x2d>
    1224:	8b 55 f8             	mov    -0x8(%rbp),%edx
