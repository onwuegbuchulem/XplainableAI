...
/app/bin_gccgcc10_O2/2020_09_19-Lesson:     file format elf64-x86-64
...
0000000000001120 <main>:
    ...
    1124:	55                   	push   %rbp
    1125:	53                   	push   %rbx
    1126:	48 83 ec 08          	sub    $0x8,%rsp
    112a:	83 ff 01             	cmp    $0x1,%edi
    112d:	7e 69                	jle    1198 <main+0x78>
    112f:	48 8b 7e 08          	mov    0x8(%rsi),%rdi
    1133:	48 89 f3             	mov    %rsi,%rbx
    1136:	48 8d 35 df 0e 00 00 	lea    0xedf(%rip),%rsi        # 201c <_IO_stdin_used+0x1c>
    113d:	e8 be ff ff ff       	callq  1100 <fopen@plt>
    1142:	48 89 c5             	mov    %rax,%rbp
    1145:	48 85 c0             	test   %rax,%rax
    1148:	74 64                	je     11ae <main+0x8e>
    114a:	48 8d 1d e0 0e 00 00 	lea    0xee0(%rip),%rbx        # 2031 <_IO_stdin_used+0x31>
    1151:	eb 14                	jmp    1167 <main+0x47>
    1153:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1158:	48 89 de             	mov    %rbx,%rsi
    115b:	bf 01 00 00 00       	mov    $0x1,%edi
    1160:	31 c0                	xor    %eax,%eax
    1162:	e8 89 ff ff ff       	callq  10f0 <__printf_chk@plt>
    1167:	48 89 ef             	mov    %rbp,%rdi
    116a:	e8 61 ff ff ff       	callq  10d0 <fgetc@plt>
    116f:	89 c2                	mov    %eax,%edx
    1171:	83 f8 ff             	cmp    $0xffffffff,%eax
    1174:	75 e2                	jne    1158 <main+0x38>
    1176:	48 8b 35 93 2e 00 00 	mov    0x2e93(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    117d:	bf 0a 00 00 00       	mov    $0xa,%edi
    1182:	e8 59 ff ff ff       	callq  10e0 <putc@plt>
    1187:	48 89 ef             	mov    %rbp,%rdi
    118a:	e8 31 ff ff ff       	callq  10c0 <fclose@plt>
    ...
    11a9:	e8 62 ff ff ff       	callq  1110 <exit@plt>
    11ae:	48 8b 53 08          	mov    0x8(%rbx),%rdx
    11b2:	bf 01 00 00 00       	mov    $0x1,%edi
    11b7:	48 8d 35 60 0e 00 00 	lea    0xe60(%rip),%rsi        # 201e <_IO_stdin_used+0x1e>
    11be:	31 c0                	xor    %eax,%eax
    11c0:	e8 2b ff ff ff       	callq  10f0 <__printf_chk@plt>
    11c5:	bf 02 00 00 00       	mov    $0x2,%edi
    11ca:	e8 41 ff ff ff       	callq  1110 <exit@plt>
    11cf:	90                   	nop
