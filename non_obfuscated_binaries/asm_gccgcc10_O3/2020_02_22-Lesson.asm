...
/app/bin_gccgcc10_O3/2020_02_22-Lesson:     file format elf64-x86-64
...
0000000000001070 <getpass@plt>:
    1070:	f3 0f 1e fa          	endbr64 
    1074:	f2 ff 25 55 2f 00 00 	bnd jmpq *0x2f55(%rip)        # 3fd0 <getpass@GLIBC_2.2.5>
...
0000000000001080 <main>:
    ...
    108f:	e8 dc ff ff ff       	callq  1070 <getpass@plt>
    1094:	48 8d 35 79 0f 00 00 	lea    0xf79(%rip),%rsi        # 2014 <_IO_stdin_used+0x14>
    109b:	bf 01 00 00 00       	mov    $0x1,%edi
    10a0:	48 89 c2             	mov    %rax,%rdx
    10a3:	31 c0                	xor    %eax,%eax
    10a5:	e8 b6 ff ff ff       	callq  1060 <__printf_chk@plt>
    10aa:	31 c0                	xor    %eax,%eax
    10ac:	48 83 c4 08          	add    $0x8,%rsp
    10b0:	c3                   	retq   
    10b1:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10b8:	00 00 00 
