...
/app/bin_gccgcc10_O2/2019_06_22-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10af:	00 
    10b0:	ba 39 30 00 00       	mov    $0x3039,%edx
    10b5:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10bc:	00 00 
    10be:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    10c3:	31 c0                	xor    %eax,%eax
    10c5:	b8 65 64 00 00       	mov    $0x6465,%eax
    10ca:	66 89 54 24 3c       	mov    %dx,0x3c(%rsp)
    10cf:	48 89 e6             	mov    %rsp,%rsi
    10d2:	0f 11 04 24          	movups %xmm0,(%rsp)
    10d6:	48 8d 7c 24 20       	lea    0x20(%rsp),%rdi
    10db:	ba 19 00 00 00       	mov    $0x19,%edx
    10e0:	66 0f 6f 05 38 0f 00 	movdqa 0xf38(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10e7:	00 
    10e8:	66 89 44 24 14       	mov    %ax,0x14(%rsp)
    10ed:	48 b8 37 38 39 30 31 	movabs $0x3433323130393837,%rax
    10f4:	32 33 34 
    10f7:	c7 44 24 10 63 6f 70 	movl   $0x69706f63,0x10(%rsp)
    10fe:	69 
    10ff:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
    1104:	48 89 44 24 30       	mov    %rax,0x30(%rsp)
    1109:	c7 44 24 38 35 36 37 	movl   $0x38373635,0x38(%rsp)
    1110:	38 
    1111:	c6 44 24 3e 00       	movb   $0x0,0x3e(%rsp)
    1116:	0f 11 44 24 20       	movups %xmm0,0x20(%rsp)
    111b:	e8 50 ff ff ff       	callq  1070 <strncpy@plt>
    1120:	48 89 c7             	mov    %rax,%rdi
    1123:	e8 58 ff ff ff       	callq  1080 <puts@plt>
    1128:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    112d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1134:	00 00 
    1136:	75 07                	jne    113f <main+0x9f>
    1138:	31 c0                	xor    %eax,%eax
    113a:	48 83 c4 58          	add    $0x58,%rsp
    113e:	c3                   	retq   
    113f:	e8 4c ff ff ff       	callq  1090 <__stack_chk_fail@plt>
