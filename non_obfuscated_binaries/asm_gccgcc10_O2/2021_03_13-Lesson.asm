...
/app/bin_gccgcc10_O2/2021_03_13-Lesson:     file format elf64-x86-64
...
0000000000001310 <test>:
    ...
    1319:	49 89 f4             	mov    %rsi,%r12
    131c:	48 89 fa             	mov    %rdi,%rdx
    131f:	55                   	push   %rbp
    1320:	48 8d 35 dd 0c 00 00 	lea    0xcdd(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1327:	48 89 fd             	mov    %rdi,%rbp
    132a:	31 c0                	xor    %eax,%eax
    132c:	bf 01 00 00 00       	mov    $0x1,%edi
    1331:	48 83 ec 08          	sub    $0x8,%rsp
    1335:	e8 76 fd ff ff       	callq  10b0 <__printf_chk@plt>
    133a:	4c 89 e6             	mov    %r12,%rsi
    133d:	48 89 ef             	mov    %rbp,%rdi
    1340:	e8 4b ff ff ff       	callq  1290 <strcasecmp>
    1345:	85 c0                	test   %eax,%eax
    1347:	75 17                	jne    1360 <test+0x50>
    1349:	48 83 c4 08          	add    $0x8,%rsp
    134d:	48 8d 3d bf 0c 00 00 	lea    0xcbf(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    1354:	5d                   	pop    %rbp
    1355:	41 5c                	pop    %r12
    1357:	e9 34 fd ff ff       	jmpq   1090 <puts@plt>
    135c:	0f 1f 40 00          	nopl   0x0(%rax)
    1360:	48 83 c4 08          	add    $0x8,%rsp
    1364:	48 8d 3d a5 0c 00 00 	lea    0xca5(%rip),%rdi        # 2010 <_IO_stdin_used+0x10>
    136b:	5d                   	pop    %rbp
    136c:	41 5c                	pop    %r12
    136e:	e9 1d fd ff ff       	jmpq   1090 <puts@plt>
