...
/app/bin_gccgcc10_O3/thefirst01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10d3:	66 48 0f 6e c7       	movq   %rdi,%xmm0
    10d8:	48 8d 3d 45 0f 00 00 	lea    0xf45(%rip),%rdi        # 2024 <_IO_stdin_used+0x24>
    10df:	48 83 ec 50          	sub    $0x50,%rsp
    10e3:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10ea:	00 00 
    10ec:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    10f1:	48 8d 05 13 0f 00 00 	lea    0xf13(%rip),%rax        # 200b <_IO_stdin_used+0xb>
    10f8:	48 8d 6c 24 08       	lea    0x8(%rsp),%rbp
    10fd:	66 48 0f 6e c8       	movq   %rax,%xmm1
    1102:	48 8d 05 11 0f 00 00 	lea    0xf11(%rip),%rax        # 201a <_IO_stdin_used+0x1a>
    1109:	66 0f 6c c1          	punpcklqdq %xmm1,%xmm0
    110d:	66 48 0f 6e d0       	movq   %rax,%xmm2
    1112:	48 8d 05 14 0f 00 00 	lea    0xf14(%rip),%rax        # 202d <_IO_stdin_used+0x2d>
    1119:	0f 29 44 24 10       	movaps %xmm0,0x10(%rsp)
    111e:	66 48 0f 6e c1       	movq   %rcx,%xmm0
    1123:	66 48 0f 6e d8       	movq   %rax,%xmm3
    1128:	48 8d 05 05 0f 00 00 	lea    0xf05(%rip),%rax        # 2034 <_IO_stdin_used+0x34>
    112f:	66 0f 6c c2          	punpcklqdq %xmm2,%xmm0
    1133:	48 89 44 24 40       	mov    %rax,0x40(%rsp)
    1138:	0f 29 44 24 20       	movaps %xmm0,0x20(%rsp)
    113d:	66 48 0f 6e c7       	movq   %rdi,%xmm0
    1142:	48 89 ef             	mov    %rbp,%rdi
    1145:	66 0f 6c c3          	punpcklqdq %xmm3,%xmm0
    1149:	0f 29 44 24 30       	movaps %xmm0,0x30(%rsp)
    114e:	e8 4d ff ff ff       	callq  10a0 <time@plt>
    1153:	48 89 ef             	mov    %rbp,%rdi
    1156:	e8 25 ff ff ff       	callq  1080 <localtime@plt>
    115b:	bf 01 00 00 00       	mov    $0x1,%edi
    1160:	48 89 c6             	mov    %rax,%rsi
    1163:	48 63 40 0c          	movslq 0xc(%rax),%rax
    1167:	8b 76 18             	mov    0x18(%rsi),%esi
    116a:	48 89 c1             	mov    %rax,%rcx
    116d:	48 69 c0 93 24 49 92 	imul   $0xffffffff92492493,%rax,%rax
    1174:	89 ca                	mov    %ecx,%edx
    1176:	c1 fa 1f             	sar    $0x1f,%edx
    1179:	48 c1 e8 20          	shr    $0x20,%rax
    117d:	01 c8                	add    %ecx,%eax
    117f:	c1 f8 02             	sar    $0x2,%eax
    1182:	29 d0                	sub    %edx,%eax
    1184:	8d 14 c5 00 00 00 00 	lea    0x0(,%rax,8),%edx
    118b:	29 c2                	sub    %eax,%edx
    118d:	89 d0                	mov    %edx,%eax
    118f:	29 c8                	sub    %ecx,%eax
    1191:	8d 44 30 01          	lea    0x1(%rax,%rsi,1),%eax
    1195:	48 8d 35 a4 0e 00 00 	lea    0xea4(%rip),%rsi        # 2040 <_IO_stdin_used+0x40>
    119c:	48 98                	cltq   
    119e:	48 8b 54 c4 10       	mov    0x10(%rsp,%rax,8),%rdx
    11a3:	31 c0                	xor    %eax,%eax
    11a5:	e8 06 ff ff ff       	callq  10b0 <__printf_chk@plt>
    11aa:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    11af:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11b6:	00 00 
    11b8:	75 08                	jne    11c2 <main+0x102>
    11ba:	48 83 c4 50          	add    $0x50,%rsp
    11be:	31 c0                	xor    %eax,%eax
    11c0:	5d                   	pop    %rbp
    11c1:	c3                   	retq   
    11c2:	e8 c9 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
