...
/app/bin_gccgcc10_O0/isInputLeapYear:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 3d 83 0e 00 00 	lea    0xe83(%rip),%rdi        # 2046 <_IO_stdin_used+0x46>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	e8 c3 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cd:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11d0:	83 e0 03             	and    $0x3,%eax
    11d3:	85 c0                	test   %eax,%eax
    11d5:	75 26                	jne    11fd <main+0x74>
    11d7:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11da:	48 63 c2             	movslq %edx,%rax
    11dd:	48 69 c0 1f 85 eb 51 	imul   $0x51eb851f,%rax,%rax
    11e4:	48 c1 e8 20          	shr    $0x20,%rax
    11e8:	c1 f8 05             	sar    $0x5,%eax
    11eb:	89 d1                	mov    %edx,%ecx
    11ed:	c1 f9 1f             	sar    $0x1f,%ecx
    11f0:	29 c8                	sub    %ecx,%eax
    11f2:	6b c8 64             	imul   $0x64,%eax,%ecx
    11f5:	89 d0                	mov    %edx,%eax
    11f7:	29 c8                	sub    %ecx,%eax
    11f9:	85 c0                	test   %eax,%eax
    11fb:	75 29                	jne    1226 <main+0x9d>
    11fd:	8b 55 f4             	mov    -0xc(%rbp),%edx
    1200:	48 63 c2             	movslq %edx,%rax
    1203:	48 69 c0 1f 85 eb 51 	imul   $0x51eb851f,%rax,%rax
    120a:	48 c1 e8 20          	shr    $0x20,%rax
    120e:	c1 f8 07             	sar    $0x7,%eax
    1211:	89 d1                	mov    %edx,%ecx
    1213:	c1 f9 1f             	sar    $0x1f,%ecx
    1216:	29 c8                	sub    %ecx,%eax
    1218:	69 c8 90 01 00 00    	imul   $0x190,%eax,%ecx
    121e:	89 d0                	mov    %edx,%eax
    1220:	29 c8                	sub    %ecx,%eax
    1222:	85 c0                	test   %eax,%eax
    1224:	75 18                	jne    123e <main+0xb5>
    1226:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1229:	89 c6                	mov    %eax,%esi
    122b:	48 8d 3d 1e 0e 00 00 	lea    0xe1e(%rip),%rdi        # 2050 <_IO_stdin_used+0x50>
    1232:	b8 00 00 00 00       	mov    $0x0,%eax
    1237:	e8 44 fe ff ff       	callq  1080 <printf@plt>
    123c:	eb 16                	jmp    1254 <main+0xcb>
    123e:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1241:	89 c6                	mov    %eax,%esi
    1243:	48 8d 3d 2e 0e 00 00 	lea    0xe2e(%rip),%rdi        # 2078 <_IO_stdin_used+0x78>
    124a:	b8 00 00 00 00       	mov    $0x0,%eax
    124f:	e8 2c fe ff ff       	callq  1080 <printf@plt>
    1254:	b8 00 00 00 00       	mov    $0x0,%eax
    1259:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    125d:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    1264:	00 00 
    1266:	74 05                	je     126d <main+0xe4>
