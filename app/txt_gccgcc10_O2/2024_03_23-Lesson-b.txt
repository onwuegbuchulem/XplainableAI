...
/app/bin_gccgcc10_O2/2024_03_23-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 54                	push   %r12
    1086:	41 bc 41 00 00 00    	mov    $0x41,%r12d
    108c:	55                   	push   %rbp
    108d:	53                   	push   %rbx
    108e:	bb 41 00 00 00       	mov    $0x41,%ebx
    1093:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1098:	0f be d3             	movsbl %bl,%edx
    109b:	bf 01 00 00 00       	mov    $0x1,%edi
    10a0:	8d 6b 01             	lea    0x1(%rbx),%ebp
    10a3:	31 c0                	xor    %eax,%eax
    10a5:	48 8d 35 58 0f 00 00 	lea    0xf58(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10ac:	89 eb                	mov    %ebp,%ebx
    10ae:	e8 ad ff ff ff       	callq  1060 <__printf_chk@plt>
    10b3:	48 8b 3d 56 2f 00 00 	mov    0x2f56(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    10ba:	40 80 fd 5a          	cmp    $0x5a,%bpl
    10be:	41 0f 44 dc          	cmove  %r12d,%ebx
    10c2:	e8 a9 ff ff ff       	callq  1070 <getc@plt>
    10c7:	85 c0                	test   %eax,%eax
    10c9:	74 cd                	je     1098 <main+0x18>
    10cb:	5b                   	pop    %rbx
