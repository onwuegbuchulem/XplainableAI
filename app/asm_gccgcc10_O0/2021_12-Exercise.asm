...
/app/bin_gccgcc10_O0/2021_12-Exercise:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11c5:	89 45 f8             	mov    %eax,-0x8(%rbp)
    11c8:	e8 c3 fe ff ff       	callq  1090 <getchar@plt>
    11cd:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11d0:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%rbp)
    11d4:	75 c8                	jne    119e <main+0x15>
    11d6:	bf 0a 00 00 00       	mov    $0xa,%edi
    11db:	e8 90 fe ff ff       	callq  1070 <putchar@plt>
