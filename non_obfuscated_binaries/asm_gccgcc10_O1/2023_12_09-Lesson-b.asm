...
/app/bin_gccgcc10_O1/2023_12_09-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1185:	48 c7 04 24 00 00 00 	movq   $0x0,(%rsp)
    118c:	00 
    118d:	48 c7 44 24 08 00 00 	movq   $0x0,0x8(%rsp)
    1194:	00 00 
    1196:	48 c7 44 24 10 00 00 	movq   $0x0,0x10(%rsp)
    119d:	00 00 
    119f:	c7 44 24 0c 28 00 00 	movl   $0x28,0xc(%rsp)
    11a6:	00 
    11a7:	c7 44 24 10 32 00 00 	movl   $0x32,0x10(%rsp)
    11ae:	00 
    11af:	48 89 e3             	mov    %rsp,%rbx
    11b2:	4c 8d 64 24 18       	lea    0x18(%rsp),%r12
    11b7:	48 8d 2d 46 0e 00 00 	lea    0xe46(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    11be:	8b 13                	mov    (%rbx),%edx
    ...
    11d6:	4c 39 e3             	cmp    %r12,%rbx
    11d9:	75 e3                	jne    11be <main+0x55>
    11db:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11e0:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11e7:	00 00 
    11e9:	75 0e                	jne    11f9 <main+0x90>
    11eb:	b8 00 00 00 00       	mov    $0x0,%eax
    11f0:	48 83 c4 20          	add    $0x20,%rsp
    11f4:	5b                   	pop    %rbx
    11f5:	5d                   	pop    %rbp
    11f6:	41 5c                	pop    %r12
    11f8:	c3                   	retq   
