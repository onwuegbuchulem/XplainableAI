...
/app/bin_gccgcc10_O2/2022_03_05-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	ba 40 9c 00 00       	mov    $0x9c40,%edx
    ...
    10a2:	44 8b 44 24 04       	mov    0x4(%rsp),%r8d
    10a7:	48 8d 4c 24 04       	lea    0x4(%rsp),%rcx
    10ac:	48 8d 35 55 0f 00 00 	lea    0xf55(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    10b3:	e8 b8 ff ff ff       	callq  1070 <__printf_chk@plt>
    10b8:	8b 54 24 04          	mov    0x4(%rsp),%edx
    10bc:	31 c0                	xor    %eax,%eax
    10be:	bf 01 00 00 00       	mov    $0x1,%edi
    10c3:	48 8d 35 6d 0f 00 00 	lea    0xf6d(%rip),%rsi        # 2037 <_IO_stdin_used+0x37>
    10ca:	e8 a1 ff ff ff       	callq  1070 <__printf_chk@plt>
    10cf:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10d4:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10db:	00 00 
    10dd:	75 07                	jne    10e6 <main+0x66>
    10df:	31 c0                	xor    %eax,%eax
    10e1:	48 83 c4 18          	add    $0x18,%rsp
    10e5:	c3                   	retq   
    10e6:	e8 75 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
