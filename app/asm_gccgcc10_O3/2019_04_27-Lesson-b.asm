...
/app/bin_gccgcc10_O3/2019_04_27-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 55                	push   %r13
    1086:	45 31 ed             	xor    %r13d,%r13d
    1089:	41 54                	push   %r12
    108b:	45 31 e4             	xor    %r12d,%r12d
    108e:	55                   	push   %rbp
    108f:	bd 01 00 00 00       	mov    $0x1,%ebp
    1094:	53                   	push   %rbx
    1095:	31 db                	xor    %ebx,%ebx
    1097:	48 83 ec 08          	sub    $0x8,%rsp
    109b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10a0:	48 8b 3d 69 2f 00 00 	mov    0x2f69(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    10a7:	e8 c4 ff ff ff       	callq  1070 <getc@plt>
    10ac:	83 f8 ff             	cmp    $0xffffffff,%eax
    10af:	74 27                	je     10d8 <main+0x58>
    10b1:	83 f8 0a             	cmp    $0xa,%eax
    10b4:	74 0a                	je     10c0 <main+0x40>
    10b6:	83 c3 01             	add    $0x1,%ebx
    10b9:	eb e5                	jmp    10a0 <main+0x20>
    10bb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10c0:	44 39 e3             	cmp    %r12d,%ebx
    10c3:	7e 06                	jle    10cb <main+0x4b>
    10c5:	41 89 ed             	mov    %ebp,%r13d
    10c8:	41 89 dc             	mov    %ebx,%r12d
    10cb:	83 c5 01             	add    $0x1,%ebp
    10ce:	31 db                	xor    %ebx,%ebx
    10d0:	eb ce                	jmp    10a0 <main+0x20>
    10d2:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    10d8:	44 89 e1             	mov    %r12d,%ecx
    10db:	44 89 ea             	mov    %r13d,%edx
    10de:	48 8d 35 1f 0f 00 00 	lea    0xf1f(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10e5:	31 c0                	xor    %eax,%eax
    10e7:	bf 01 00 00 00       	mov    $0x1,%edi
    10ec:	e8 6f ff ff ff       	callq  1060 <__printf_chk@plt>
