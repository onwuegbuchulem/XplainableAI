...
/app/bin_gccgcc10_O0/2023_05_01-Lesson:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    12df:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
    12e6:	8b 40 10             	mov    0x10(%rax),%eax
    12e9:	48 98                	cltq   
    12eb:	48 8b 4c c5 90       	mov    -0x70(%rbp,%rax,8),%rcx
    12f0:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
    12f7:	8b 50 0c             	mov    0xc(%rax),%edx
    12fa:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
