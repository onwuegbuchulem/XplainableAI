...
/app/bin_gccgcc10_O2/17_mod:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1064:	55                   	push   %rbp
    1065:	bd 02 00 00 00       	mov    $0x2,%ebp
    106a:	53                   	push   %rbx
    106b:	bb 01 00 00 00       	mov    $0x1,%ebx
    1070:	48 83 ec 08          	sub    $0x8,%rsp
    1074:	eb 25                	jmp    109b <main+0x3b>
    1076:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    107d:	00 00 00 
    1080:	48 8d 35 7d 0f 00 00 	lea    0xf7d(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1087:	bf 01 00 00 00       	mov    $0x1,%edi
    108c:	31 c0                	xor    %eax,%eax
    108e:	83 c3 01             	add    $0x1,%ebx
    1091:	e8 ba ff ff ff       	callq  1050 <__printf_chk@plt>
    1096:	83 fb 0a             	cmp    $0xa,%ebx
    1099:	74 26                	je     10c1 <main+0x61>
    109b:	89 e8                	mov    %ebp,%eax
    109d:	99                   	cltd   
    109e:	f7 fb                	idiv   %ebx
    10a0:	85 d2                	test   %edx,%edx
    10a2:	89 da                	mov    %ebx,%edx
    10a4:	75 da                	jne    1080 <main+0x20>
    10a6:	48 8d 35 61 0f 00 00 	lea    0xf61(%rip),%rsi        # 200e <_IO_stdin_used+0xe>
    10ad:	bf 01 00 00 00       	mov    $0x1,%edi
    10b2:	31 c0                	xor    %eax,%eax
    10b4:	83 c3 01             	add    $0x1,%ebx
    10b7:	e8 94 ff ff ff       	callq  1050 <__printf_chk@plt>
    10bc:	83 fb 0a             	cmp    $0xa,%ebx
    10bf:	75 da                	jne    109b <main+0x3b>
