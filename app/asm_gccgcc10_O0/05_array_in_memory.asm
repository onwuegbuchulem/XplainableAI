...
/app/bin_gccgcc10_O0/05_array_in_memory:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d0:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%rbp)
    11d7:	eb 28                	jmp    1201 <main+0x58>
    11d9:	48 8d 55 e0          	lea    -0x20(%rbp),%rdx
    11dd:	8b 45 d8             	mov    -0x28(%rbp),%eax
    11e0:	48 98                	cltq   
    11e2:	48 c1 e0 02          	shl    $0x2,%rax
    11e6:	48 01 d0             	add    %rdx,%rax
    11e9:	48 89 c6             	mov    %rax,%rsi
    11ec:	48 8d 3d 2f 0e 00 00 	lea    0xe2f(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    11f3:	b8 00 00 00 00       	mov    $0x0,%eax
    11f8:	e8 b3 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11fd:	83 45 d8 01          	addl   $0x1,-0x28(%rbp)
    1201:	83 7d d8 04          	cmpl   $0x4,-0x28(%rbp)
    1205:	7e d2                	jle    11d9 <main+0x30>
    1207:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
    120e:	eb 2a                	jmp    123a <main+0x91>
    1210:	48 8d 55 e0          	lea    -0x20(%rbp),%rdx
    1214:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1217:	48 98                	cltq   
    1219:	48 c1 e0 02          	shl    $0x2,%rax
    121d:	48 01 c2             	add    %rax,%rdx
    1220:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1223:	89 c6                	mov    %eax,%esi
    1225:	48 8d 3d fc 0d 00 00 	lea    0xdfc(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    122c:	b8 00 00 00 00       	mov    $0x0,%eax
    1231:	e8 6a fe ff ff       	callq  10a0 <printf@plt>
    1236:	83 45 dc 01          	addl   $0x1,-0x24(%rbp)
    123a:	83 7d dc 04          	cmpl   $0x4,-0x24(%rbp)
    123e:	7e d0                	jle    1210 <main+0x67>
    1240:	b8 00 00 00 00       	mov    $0x0,%eax
    1245:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1249:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1250:	00 00 
    1252:	74 05                	je     1259 <main+0xb0>
    1254:	e8 37 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    1259:	c9                   	leaveq 
    125a:	c3                   	retq   
