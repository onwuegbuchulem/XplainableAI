...
/app/bin_gccgcc10_O0/2021_01_02-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	f3 0f 10 05 80 0e 00 	movss  0xe80(%rip),%xmm0        # 200c <_IO_stdin_used+0xc>
    118b:	00 
    118c:	f3 0f 11 45 e0       	movss  %xmm0,-0x20(%rbp)
    1191:	f3 0f 10 05 77 0e 00 	movss  0xe77(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    1198:	00 
    1199:	f3 0f 11 45 e4       	movss  %xmm0,-0x1c(%rbp)
    119e:	f3 0f 10 05 6e 0e 00 	movss  0xe6e(%rip),%xmm0        # 2014 <_IO_stdin_used+0x14>
    11a5:	00 
    11a6:	f3 0f 11 45 e8       	movss  %xmm0,-0x18(%rbp)
    11ab:	f3 0f 10 05 65 0e 00 	movss  0xe65(%rip),%xmm0        # 2018 <_IO_stdin_used+0x18>
    11b2:	00 
    11b3:	f3 0f 11 45 ec       	movss  %xmm0,-0x14(%rbp)
    11b8:	f3 0f 10 05 5c 0e 00 	movss  0xe5c(%rip),%xmm0        # 201c <_IO_stdin_used+0x1c>
    11bf:	00 
    11c0:	f3 0f 11 45 f0       	movss  %xmm0,-0x10(%rbp)
    11c5:	c7 45 dc 05 00 00 00 	movl   $0x5,-0x24(%rbp)
    11cc:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%rbp)
    11d3:	eb 32                	jmp    1207 <main+0x9e>
    11d5:	8b 45 d8             	mov    -0x28(%rbp),%eax
    11d8:	48 98                	cltq   
    11da:	f3 0f 10 44 85 e0    	movss  -0x20(%rbp,%rax,4),%xmm0
    11e0:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11e4:	f3 0f 5a c8          	cvtss2sd %xmm0,%xmm1
    11e8:	66 48 0f 7e c8       	movq   %xmm1,%rax
    11ed:	66 48 0f 6e c0       	movq   %rax,%xmm0
    ...
    1203:	83 45 d8 01          	addl   $0x1,-0x28(%rbp)
    1207:	8b 45 d8             	mov    -0x28(%rbp),%eax
    120a:	3b 45 dc             	cmp    -0x24(%rbp),%eax
    120d:	7c c6                	jl     11d5 <main+0x6c>
    120f:	b8 00 00 00 00       	mov    $0x0,%eax
    1214:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1218:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    121f:	00 00 
    1221:	74 05                	je     1228 <main+0xbf>
    1223:	e8 38 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    1228:	c9                   	leaveq 
    1229:	c3                   	retq   
