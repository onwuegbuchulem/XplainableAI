...
/app/bin_gccgcc10_O0/2022_04_01-Lesson:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d d6 00 00 00 	lea    0xd6(%rip),%rdi        # 119e <main>
...
0000000000001189 <babylonian_sr>:
    ...
    1196:	90                   	nop
    1197:	66 48 0f 6e c0       	movq   %rax,%xmm0
    119c:	5d                   	pop    %rbp
    119d:	c3                   	retq   
...
000000000000119e <main>:
    ...
    11a6:	48 83 ec 20          	sub    $0x20,%rsp
    11aa:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11b1:	00 00 
    11b3:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11b7:	31 c0                	xor    %eax,%eax
    11b9:	48 8d 3d 48 0e 00 00 	lea    0xe48(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11c0:	b8 00 00 00 00       	mov    $0x0,%eax
    11c5:	e8 b6 fe ff ff       	callq  1080 <printf@plt>
    11ca:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    11ce:	48 89 c6             	mov    %rax,%rsi
    11d1:	48 8d 3d 49 0e 00 00 	lea    0xe49(%rip),%rdi        # 2021 <_IO_stdin_used+0x21>
    11d8:	b8 00 00 00 00       	mov    $0x0,%eax
    11dd:	e8 ae fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11e2:	f2 0f 10 4d e8       	movsd  -0x18(%rbp),%xmm1
    11e7:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11eb:	66 0f 2f c1          	comisd %xmm1,%xmm0
    11ef:	72 07                	jb     11f8 <main+0x5a>
    11f1:	b8 01 00 00 00       	mov    $0x1,%eax
    11f6:	eb 3f                	jmp    1237 <main+0x99>
    11f8:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    11fc:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1201:	e8 83 ff ff ff       	callq  1189 <babylonian_sr>
    1206:	66 48 0f 7e c0       	movq   %xmm0,%rax
    120b:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    120f:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1213:	f2 0f 10 45 f0       	movsd  -0x10(%rbp),%xmm0
    1218:	66 0f 28 c8          	movapd %xmm0,%xmm1
    121c:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1221:	48 8d 3d 00 0e 00 00 	lea    0xe00(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    1228:	b8 02 00 00 00       	mov    $0x2,%eax
    122d:	e8 4e fe ff ff       	callq  1080 <printf@plt>
    1232:	b8 00 00 00 00       	mov    $0x0,%eax
    1237:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    123b:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1242:	00 00 
    1244:	74 05                	je     124b <main+0xad>
    1246:	e8 25 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    124b:	c9                   	leaveq 
    124c:	c3                   	retq   
