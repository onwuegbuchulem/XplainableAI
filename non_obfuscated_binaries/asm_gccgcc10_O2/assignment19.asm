...
/app/bin_gccgcc10_O2/assignment19:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	55                   	push   %rbp
    10a5:	bf 0a 00 00 00       	mov    $0xa,%edi
    10aa:	e8 d1 ff ff ff       	callq  1080 <malloc@plt>
    10af:	48 85 c0             	test   %rax,%rax
    10b2:	74 22                	je     10d6 <main+0x36>
    10b4:	48 89 c5             	mov    %rax,%rbp
    10b7:	48 8d 35 6a 0f 00 00 	lea    0xf6a(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    10be:	bf 01 00 00 00       	mov    $0x1,%edi
    10c3:	31 c0                	xor    %eax,%eax
    10c5:	e8 c6 ff ff ff       	callq  1090 <__printf_chk@plt>
    10ca:	48 89 ef             	mov    %rbp,%rdi
    10cd:	e8 9e ff ff ff       	callq  1070 <free@plt>
    10d2:	31 c0                	xor    %eax,%eax
    10d4:	5d                   	pop    %rbp
    10d5:	c3                   	retq   
    10d6:	48 8d 35 2b 0f 00 00 	lea    0xf2b(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
