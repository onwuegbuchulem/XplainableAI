...
/app/bin_gccgcc10_O0/18_array:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 e0 02 00 00 00 	movl   $0x2,-0x20(%rbp)
    118b:	c7 45 e4 03 00 00 00 	movl   $0x3,-0x1c(%rbp)
    1192:	c7 45 e8 05 00 00 00 	movl   $0x5,-0x18(%rbp)
    1199:	c7 45 ec 08 00 00 00 	movl   $0x8,-0x14(%rbp)
    11a0:	c7 45 f0 0d 00 00 00 	movl   $0xd,-0x10(%rbp)
    11a7:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11ab:	48 89 45 d8          	mov    %rax,-0x28(%rbp)
    11af:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%rbp)
    11b6:	eb 36                	jmp    11ee <main+0x85>
    11b8:	8b 45 d4             	mov    -0x2c(%rbp),%eax
    11bb:	48 98                	cltq   
    11bd:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
    11c4:	00 
    11c5:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    11c9:	48 01 d0             	add    %rdx,%rax
    11cc:	8b 10                	mov    (%rax),%edx
    11ce:	8b 45 d4             	mov    -0x2c(%rbp),%eax
    11d1:	48 98                	cltq   
    11d3:	8b 44 85 e0          	mov    -0x20(%rbp,%rax,4),%eax
    ...
    11ea:	83 45 d4 01          	addl   $0x1,-0x2c(%rbp)
    11ee:	83 7d d4 04          	cmpl   $0x4,-0x2c(%rbp)
    11f2:	7e c4                	jle    11b8 <main+0x4f>
    11f4:	b8 00 00 00 00       	mov    $0x0,%eax
    11f9:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11fd:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1204:	00 00 
    1206:	74 05                	je     120d <main+0xa4>
    1208:	e8 53 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    120d:	c9                   	leaveq 
    120e:	c3                   	retq   
    120f:	90                   	nop
