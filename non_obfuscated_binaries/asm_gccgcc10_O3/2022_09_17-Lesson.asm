...
/app/bin_gccgcc10_O3/2022_09_17-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 56                	push   %r14
    1086:	4c 8d 35 77 0f 00 00 	lea    0xf77(%rip),%r14        # 2004 <_IO_stdin_used+0x4>
    108d:	41 55                	push   %r13
    108f:	41 bd 64 00 00 00    	mov    $0x64,%r13d
    1095:	41 54                	push   %r12
    1097:	41 bc 6c 00 00 00    	mov    $0x6c,%r12d
    109d:	55                   	push   %rbp
    109e:	bd 60 00 00 00       	mov    $0x60,%ebp
    10a3:	53                   	push   %rbx
    10a4:	0f 1f 40 00          	nopl   0x0(%rax)
    10a8:	8d 5d a0             	lea    -0x60(%rbp),%ebx
    10ab:	eb 15                	jmp    10c2 <main+0x42>
    10ad:	0f 1f 00             	nopl   (%rax)
    10b0:	bf 09 00 00 00       	mov    $0x9,%edi
    10b5:	83 c3 0c             	add    $0xc,%ebx
    10b8:	e8 a3 ff ff ff       	callq  1060 <putc@plt>
    10bd:	44 39 e3             	cmp    %r12d,%ebx
    10c0:	74 4d                	je     110f <main+0x8f>
    10c2:	83 fb 63             	cmp    $0x63,%ebx
    10c5:	7e 31                	jle    10f8 <main+0x78>
    10c7:	48 8b 35 42 2f 00 00 	mov    0x2f42(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10ce:	39 eb                	cmp    %ebp,%ebx
    10d0:	75 de                	jne    10b0 <main+0x30>
    10d2:	bf 0a 00 00 00       	mov    $0xa,%edi
    10d7:	83 c5 01             	add    $0x1,%ebp
    10da:	41 83 c4 01          	add    $0x1,%r12d
    10de:	e8 7d ff ff ff       	callq  1060 <putc@plt>
    10e3:	83 fd 6c             	cmp    $0x6c,%ebp
    10e6:	75 c0                	jne    10a8 <main+0x28>
    10e8:	5b                   	pop    %rbx
    ...
    10fa:	89 da                	mov    %ebx,%edx
    10fc:	4c 89 f6             	mov    %r14,%rsi
    10ff:	bf 01 00 00 00       	mov    $0x1,%edi
    1104:	e8 67 ff ff ff       	callq  1070 <__printf_chk@plt>
    1109:	41 83 ed 01          	sub    $0x1,%r13d
    110d:	75 b8                	jne    10c7 <main+0x47>
    110f:	48 8b 35 fa 2e 00 00 	mov    0x2efa(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1116:	eb ba                	jmp    10d2 <main+0x52>
