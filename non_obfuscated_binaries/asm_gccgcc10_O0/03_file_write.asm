...
/app/bin_gccgcc10_O0/03_file_write:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ac:	c7 45 f4 b0 01 00 00 	movl   $0x1b0,-0xc(%rbp)
    11b3:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11b6:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11ba:	48 8d 35 4f 0e 00 00 	lea    0xe4f(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    11c1:	48 89 c7             	mov    %rax,%rdi
    11c4:	b8 00 00 00 00       	mov    $0x0,%eax
    11c9:	e8 b2 fe ff ff       	callq  1080 <fprintf@plt>
    11ce:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11d2:	48 89 c7             	mov    %rax,%rdi
    11d5:	e8 96 fe ff ff       	callq  1070 <fclose@plt>
