...
/app/bin_gccgcc10_O3/SquareCubeNumber:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10cb:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    10d0:	48 8d 3d 40 0f 00 00 	lea    0xf40(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    10d7:	31 c0                	xor    %eax,%eax
    10d9:	e8 b2 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10de:	8b 5c 24 04          	mov    0x4(%rsp),%ebx
    10e2:	bf 01 00 00 00       	mov    $0x1,%edi
    10e7:	31 c0                	xor    %eax,%eax
    10e9:	48 8d 35 2a 0f 00 00 	lea    0xf2a(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    10f0:	89 dd                	mov    %ebx,%ebp
    10f2:	0f af eb             	imul   %ebx,%ebp
    10f5:	89 ea                	mov    %ebp,%edx
    10f7:	e8 84 ff ff ff       	callq  1080 <__printf_chk@plt>
    10fc:	89 da                	mov    %ebx,%edx
    10fe:	31 c0                	xor    %eax,%eax
    1100:	48 8d 35 20 0f 00 00 	lea    0xf20(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    1107:	0f af d5             	imul   %ebp,%edx
    110a:	bf 01 00 00 00       	mov    $0x1,%edi
    110f:	e8 6c ff ff ff       	callq  1080 <__printf_chk@plt>
    1114:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1119:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1120:	00 00 
    1122:	75 09                	jne    112d <main+0x8d>
    1124:	48 83 c4 18          	add    $0x18,%rsp
    1128:	31 c0                	xor    %eax,%eax
    112a:	5b                   	pop    %rbx
    112b:	5d                   	pop    %rbp
    112c:	c3                   	retq   
    112d:	e8 3e ff ff ff       	callq  1070 <__stack_chk_fail@plt>
    1132:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    1139:	00 00 00 
