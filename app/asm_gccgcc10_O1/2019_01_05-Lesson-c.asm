...
/app/bin_gccgcc10_O1/2019_01_05-Lesson-c:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a1:	48 b8 00 d8 2a 34 f1 	movabs $0xfffffff1342ad800,%rax
    11a8:	ff ff ff 
    11ab:	48 89 04 24          	mov    %rax,(%rsp)
    11af:	48 89 e7             	mov    %rsp,%rdi
    11b2:	e8 b9 fe ff ff       	callq  1070 <ctime@plt>
    ...
    11cb:	e8 c0 fe ff ff       	callq  1090 <__printf_chk@plt>
    11d0:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11d5:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11dc:	00 00 
    11de:	75 0a                	jne    11ea <main+0x61>
    11e0:	b8 00 00 00 00       	mov    $0x0,%eax
    11e5:	48 83 c4 18          	add    $0x18,%rsp
    11e9:	c3                   	retq   
    11ea:	e8 91 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    11ef:	90                   	nop
