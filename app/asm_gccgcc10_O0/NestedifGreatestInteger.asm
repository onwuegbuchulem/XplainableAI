...
/app/bin_gccgcc10_O0/NestedifGreatestInteger:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d0:	48 8d 4d f4          	lea    -0xc(%rbp),%rcx
    11d4:	48 8d 55 f0          	lea    -0x10(%rbp),%rdx
    11d8:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    11dc:	48 89 c6             	mov    %rax,%rsi
    11df:	48 8d 3d 39 0e 00 00 	lea    0xe39(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    11e6:	b8 00 00 00 00       	mov    $0x0,%eax
    11eb:	e8 c0 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11f0:	8b 55 ec             	mov    -0x14(%rbp),%edx
    11f3:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11f6:	39 c2                	cmp    %eax,%edx
    11f8:	7e 30                	jle    122a <main+0x81>
    11fa:	8b 55 ec             	mov    -0x14(%rbp),%edx
    11fd:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1200:	39 c2                	cmp    %eax,%edx
    1202:	7e 13                	jle    1217 <main+0x6e>
    1204:	48 8d 3d 1b 0e 00 00 	lea    0xe1b(%rip),%rdi        # 2026 <_IO_stdin_used+0x26>
    120b:	b8 00 00 00 00       	mov    $0x0,%eax
    1210:	e8 8b fe ff ff       	callq  10a0 <printf@plt>
    1215:	eb 41                	jmp    1258 <main+0xaf>
    1217:	48 8d 3d 16 0e 00 00 	lea    0xe16(%rip),%rdi        # 2034 <_IO_stdin_used+0x34>
    121e:	b8 00 00 00 00       	mov    $0x0,%eax
    1223:	e8 78 fe ff ff       	callq  10a0 <printf@plt>
    1228:	eb 2e                	jmp    1258 <main+0xaf>
    122a:	8b 55 f0             	mov    -0x10(%rbp),%edx
    122d:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1230:	39 c2                	cmp    %eax,%edx
    1232:	7e 13                	jle    1247 <main+0x9e>
    1234:	48 8d 3d 07 0e 00 00 	lea    0xe07(%rip),%rdi        # 2042 <_IO_stdin_used+0x42>
    123b:	b8 00 00 00 00       	mov    $0x0,%eax
    1240:	e8 5b fe ff ff       	callq  10a0 <printf@plt>
    1245:	eb 11                	jmp    1258 <main+0xaf>
    1247:	48 8d 3d e6 0d 00 00 	lea    0xde6(%rip),%rdi        # 2034 <_IO_stdin_used+0x34>
    124e:	b8 00 00 00 00       	mov    $0x0,%eax
    1253:	e8 48 fe ff ff       	callq  10a0 <printf@plt>
    1258:	b8 00 00 00 00       	mov    $0x0,%eax
    125d:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    1261:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    1268:	00 00 
