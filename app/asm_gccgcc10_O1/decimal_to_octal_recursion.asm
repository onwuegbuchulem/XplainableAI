...
/app/bin_gccgcc10_O1/decimal_to_octal_recursion:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d fd 00 00 00 	lea    0xfd(%rip),%rdi        # 11c5 <main>
...
0000000000001189 <decimal_to_octal>:
    1189:	f3 0f 1e fa          	endbr64 
    118d:	53                   	push   %rbx
    118e:	89 fb                	mov    %edi,%ebx
    1190:	8d 47 ff             	lea    -0x1(%rdi),%eax
    1193:	83 f8 06             	cmp    $0x6,%eax
    1196:	76 04                	jbe    119c <decimal_to_octal+0x13>
    1198:	85 ff                	test   %edi,%edi
    119a:	75 04                	jne    11a0 <decimal_to_octal+0x17>
    119c:	89 d8                	mov    %ebx,%eax
    119e:	5b                   	pop    %rbx
    119f:	c3                   	retq   
    11a0:	8d 7f 07             	lea    0x7(%rdi),%edi
    11a3:	0f 49 fb             	cmovns %ebx,%edi
    11a6:	c1 ff 03             	sar    $0x3,%edi
    11a9:	e8 db ff ff ff       	callq  1189 <decimal_to_octal>
    11ae:	8d 14 80             	lea    (%rax,%rax,4),%edx
    11b1:	89 d8                	mov    %ebx,%eax
    11b3:	c1 f8 1f             	sar    $0x1f,%eax
    11b6:	c1 e8 1d             	shr    $0x1d,%eax
    11b9:	01 c3                	add    %eax,%ebx
    11bb:	83 e3 07             	and    $0x7,%ebx
    11be:	29 c3                	sub    %eax,%ebx
    11c0:	8d 1c 53             	lea    (%rbx,%rdx,2),%ebx
    11c3:	eb d7                	jmp    119c <decimal_to_octal+0x13>
...
00000000000011c5 <main>:
    ...
    11d5:	00 00 
    11d7:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11dc:	31 c0                	xor    %eax,%eax
    11de:	48 8d 35 1f 0e 00 00 	lea    0xe1f(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11e5:	bf 01 00 00 00       	mov    $0x1,%edi
    11ea:	e8 91 fe ff ff       	callq  1080 <__printf_chk@plt>
    11ef:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11f4:	48 8d 3d 3d 0e 00 00 	lea    0xe3d(%rip),%rdi        # 2038 <_IO_stdin_used+0x38>
    11fb:	b8 00 00 00 00       	mov    $0x0,%eax
    1200:	e8 8b fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    1205:	8b 5c 24 04          	mov    0x4(%rsp),%ebx
    1209:	89 df                	mov    %ebx,%edi
    120b:	e8 79 ff ff ff       	callq  1189 <decimal_to_octal>
    1210:	89 c1                	mov    %eax,%ecx
    1212:	89 da                	mov    %ebx,%edx
    1214:	48 8d 35 07 0e 00 00 	lea    0xe07(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    121b:	bf 01 00 00 00       	mov    $0x1,%edi
    1220:	b8 00 00 00 00       	mov    $0x0,%eax
    1225:	e8 56 fe ff ff       	callq  1080 <__printf_chk@plt>
    122a:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    122f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1236:	00 00 
    1238:	75 0b                	jne    1245 <main+0x80>
    123a:	b8 00 00 00 00       	mov    $0x0,%eax
    123f:	48 83 c4 10          	add    $0x10,%rsp
    1243:	5b                   	pop    %rbx
    1244:	c3                   	retq   
    1245:	e8 26 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
