...
/app/bin_gccgcc10_O0/2022_04_23-Lesson-b:     file format elf64-x86-64
...
00000000000011e9 <memory>:
    ...
    11f5:	bf 00 00 00 40       	mov    $0x40000000,%edi
    11fa:	e8 d1 fe ff ff       	callq  10d0 <malloc@plt>
    11ff:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1203:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
    1208:	75 2a                	jne    1234 <memory+0x4b>
    120a:	48 8b 05 0f 2e 00 00 	mov    0x2e0f(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    ...
    123b:	e8 60 fe ff ff       	callq  10a0 <free@plt>
    1240:	90                   	nop
    1241:	c9                   	leaveq 
    1242:	c3                   	retq   
...
0000000000001243 <main>:
    ...
    124f:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
    1256:	eb 2b                	jmp    1283 <main+0x40>
    ...
    126e:	e8 76 ff ff ff       	callq  11e9 <memory>
    1273:	48 8d 3d bf 0d 00 00 	lea    0xdbf(%rip),%rdi        # 2039 <_IO_stdin_used+0x39>
    127a:	e8 31 fe ff ff       	callq  10b0 <puts@plt>
    127f:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    1283:	81 7d fc ff 03 00 00 	cmpl   $0x3ff,-0x4(%rbp)
    128a:	7e cc                	jle    1258 <main+0x15>
...
00000000000012a0 <__libc_csu_init>:
    ...
    12a4:	41 57                	push   %r15
    12a6:	4c 8d 3d e3 2a 00 00 	lea    0x2ae3(%rip),%r15        # 3d90 <__frame_dummy_init_array_entry>
    12ad:	41 56                	push   %r14
    ...
    12bc:	55                   	push   %rbp
    12bd:	48 8d 2d d4 2a 00 00 	lea    0x2ad4(%rip),%rbp        # 3d98 <__do_global_dtors_aux_fini_array_entry>
    12c4:	53                   	push   %rbx
