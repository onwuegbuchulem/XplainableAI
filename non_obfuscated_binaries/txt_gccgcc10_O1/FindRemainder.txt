...
/app/bin_gccgcc10_O1/FindRemainder:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a2:	48 8d 74 24 0c       	lea    0xc(%rsp),%rsi
    11a7:	48 8d 3d 58 0e 00 00 	lea    0xe58(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    11ae:	e8 dd fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11b3:	8b 44 24 0c          	mov    0xc(%rsp),%eax
    11b7:	8d 50 ff             	lea    -0x1(%rax),%edx
    11ba:	89 54 24 0c          	mov    %edx,0xc(%rsp)
    11be:	85 c0                	test   %eax,%eax
    11c0:	74 4c                	je     120e <main+0x85>
    11c2:	48 8d 5c 24 14       	lea    0x14(%rsp),%rbx
    11c7:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    11cc:	48 89 da             	mov    %rbx,%rdx
    ...
    11e0:	8b 44 24 10          	mov    0x10(%rsp),%eax
    11e4:	99                   	cltd   
    11e5:	f7 7c 24 14          	idivl  0x14(%rsp)
    11e9:	48 8d 35 19 0e 00 00 	lea    0xe19(%rip),%rsi        # 2009 <_IO_stdin_used+0x9>
    11f0:	bf 01 00 00 00       	mov    $0x1,%edi
    11f5:	b8 00 00 00 00       	mov    $0x0,%eax
    11fa:	e8 81 fe ff ff       	callq  1080 <__printf_chk@plt>
    11ff:	8b 44 24 0c          	mov    0xc(%rsp),%eax
    1203:	8d 50 ff             	lea    -0x1(%rax),%edx
    1206:	89 54 24 0c          	mov    %edx,0xc(%rsp)
    120a:	85 c0                	test   %eax,%eax
    120c:	75 b9                	jne    11c7 <main+0x3e>
    120e:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1213:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    121a:	00 00 
    121c:	75 0b                	jne    1229 <main+0xa0>
    121e:	b8 00 00 00 00       	mov    $0x0,%eax
    1223:	48 83 c4 20          	add    $0x20,%rsp
    1227:	5b                   	pop    %rbx
    1228:	c3                   	retq   
    1229:	e8 42 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
