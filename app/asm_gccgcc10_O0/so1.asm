...
/app/bin_gccgcc10_O0/so1:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%rbp)
    11ab:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%rbp)
    11b2:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%rbp)
    11b9:	c7 45 f0 02 00 00 00 	movl   $0x2,-0x10(%rbp)
    11c0:	48 8d 45 e4          	lea    -0x1c(%rbp),%rax
    ...
    1204:	39 45 f0             	cmp    %eax,-0x10(%rbp)
    1207:	7e d1                	jle    11da <main+0x51>
    1209:	8b 45 e8             	mov    -0x18(%rbp),%eax
    120c:	89 c6                	mov    %eax,%esi
    120e:	48 8d 3d f2 0d 00 00 	lea    0xdf2(%rip),%rdi        # 2007 <_IO_stdin_used+0x7>
    1215:	b8 00 00 00 00       	mov    $0x0,%eax
    121a:	e8 61 fe ff ff       	callq  1080 <printf@plt>
    121f:	b8 00 00 00 00       	mov    $0x0,%eax
    1224:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1228:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    122f:	00 00 
    1231:	74 05                	je     1238 <main+0xaf>
