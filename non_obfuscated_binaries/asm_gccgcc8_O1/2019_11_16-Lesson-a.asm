...
/app/bin_gccgcc8_O1/2019_11_16-Lesson-a:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    1225:	c7 04 24 22 00 00 00 	movl   $0x22,(%rsp)
    122c:	48 b8 47 65 6f 72 67 	movabs $0x6567726f6547,%rax
    1233:	65 00 00 
    1236:	48 89 44 24 04       	mov    %rax,0x4(%rsp)
    123b:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%rsp)
    1242:	00 
    1243:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    1248:	b9 22 00 00 00       	mov    $0x22,%ecx
    ...
    125e:	e8 8d fe ff ff       	callq  10f0 <__printf_chk@plt>
    1263:	bf 10 00 00 00       	mov    $0x10,%edi
    1268:	e8 73 fe ff ff       	callq  10e0 <malloc@plt>
    126d:	48 85 c0             	test   %rax,%rax
    1270:	74 72                	je     12e4 <main+0xdb>
    1272:	48 89 c5             	mov    %rax,%rbp
    1275:	66 0f 6f 04 24       	movdqa (%rsp),%xmm0
    127a:	0f 11 00             	movups %xmm0,(%rax)
    127d:	48 8d 3d af 0d 00 00 	lea    0xdaf(%rip),%rdi        # 2033 <_IO_stdin_used+0x33>
    1284:	e8 27 fe ff ff       	callq  10b0 <puts@plt>
    1289:	48 89 eb             	mov    %rbp,%rbx
    128c:	48 83 c5 10          	add    $0x10,%rbp
    1290:	4c 8d 25 a9 0d 00 00 	lea    0xda9(%rip),%r12        # 2040 <_IO_stdin_used+0x40>
    1297:	0f b6 13             	movzbl (%rbx),%edx
    129a:	4c 89 e6             	mov    %r12,%rsi
    129d:	bf 01 00 00 00       	mov    $0x1,%edi
    12a2:	b8 00 00 00 00       	mov    $0x0,%eax
    12a7:	e8 44 fe ff ff       	callq  10f0 <__printf_chk@plt>
    12ac:	48 83 c3 01          	add    $0x1,%rbx
    12b0:	48 39 eb             	cmp    %rbp,%rbx
    12b3:	75 e2                	jne    1297 <main+0x8e>
    12b5:	48 8b 35 64 2d 00 00 	mov    0x2d64(%rip),%rsi        # 4020 <stdout@@GLIBC_2.2.5>
    12bc:	bf 0a 00 00 00       	mov    $0xa,%edi
    12c1:	e8 0a fe ff ff       	callq  10d0 <putc@plt>
    12c6:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    12cb:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12d2:	00 00 
    12d4:	75 35                	jne    130b <main+0x102>
    12d6:	b8 00 00 00 00       	mov    $0x0,%eax
    12db:	48 83 c4 20          	add    $0x20,%rsp
    12df:	5b                   	pop    %rbx
    12e0:	5d                   	pop    %rbp
    12e1:	41 5c                	pop    %r12
    12e3:	c3                   	retq   
    12e4:	48 8b 0d 55 2d 00 00 	mov    0x2d55(%rip),%rcx        # 4040 <stderr@@GLIBC_2.2.5>
    12eb:	ba 1a 00 00 00       	mov    $0x1a,%edx
    12f0:	be 01 00 00 00       	mov    $0x1,%esi
    12f5:	48 8d 3d 1c 0d 00 00 	lea    0xd1c(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    12fc:	e8 0f fe ff ff       	callq  1110 <fwrite@plt>
    1301:	bf 01 00 00 00       	mov    $0x1,%edi
    1306:	e8 f5 fd ff ff       	callq  1100 <exit@plt>
    130b:	e8 b0 fd ff ff       	callq  10c0 <__stack_chk_fail@plt>
