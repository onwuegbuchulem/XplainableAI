...
/app/bin_gccgcc10_O1/assignment15:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1182:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%rsp)
    1189:	00 
    118a:	ba 0f 00 00 00       	mov    $0xf,%edx
    118f:	48 8d 35 72 0e 00 00 	lea    0xe72(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    1196:	bf 01 00 00 00       	mov    $0x1,%edi
    119b:	e8 d0 fe ff ff       	callq  1070 <__printf_chk@plt>
    11a0:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx
    11a5:	48 89 da             	mov    %rbx,%rdx
    11a8:	48 8d 35 81 0e 00 00 	lea    0xe81(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    11af:	bf 01 00 00 00       	mov    $0x1,%edi
    11b4:	b8 00 00 00 00       	mov    $0x0,%eax
    11b9:	e8 b2 fe ff ff       	callq  1070 <__printf_chk@plt>
    11be:	48 89 da             	mov    %rbx,%rdx
    11c1:	48 8d 35 a0 0e 00 00 	lea    0xea0(%rip),%rsi        # 2068 <_IO_stdin_used+0x68>
    ...
    11db:	48 8d 35 b6 0e 00 00 	lea    0xeb6(%rip),%rsi        # 2098 <_IO_stdin_used+0x98>
    ...
    11fd:	00 00 
    11ff:	75 0b                	jne    120c <main+0xa3>
    1201:	b8 00 00 00 00       	mov    $0x0,%eax
    1206:	48 83 c4 10          	add    $0x10,%rsp
    120a:	5b                   	pop    %rbx
    120b:	c3                   	retq   
    120c:	e8 4f fe ff ff       	callq  1060 <__stack_chk_fail@plt>
