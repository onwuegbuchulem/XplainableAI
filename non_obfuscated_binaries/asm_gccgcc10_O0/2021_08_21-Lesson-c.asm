...
/app/bin_gccgcc10_O0/2021_08_21-Lesson-c:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d 19 01 00 00 	lea    0x119(%rip),%rdi        # 11c1 <main>
...
0000000000001169 <output>:
    ...
    1180:	eb 1e                	jmp    11a0 <output+0x37>
    1182:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1185:	48 63 d0             	movslq %eax,%rdx
    1188:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    118c:	48 01 d0             	add    %rdx,%rax
    118f:	0f b6 00             	movzbl (%rax),%eax
    1192:	0f be c0             	movsbl %al,%eax
    1195:	89 c7                	mov    %eax,%edi
    1197:	e8 c4 fe ff ff       	callq  1060 <putchar@plt>
    119c:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    ...
    11b2:	75 ce                	jne    1182 <output+0x19>
...
00000000000011c1 <main>:
    ...
    11ee:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    11f2:	48 8d 05 37 0e 00 00 	lea    0xe37(%rip),%rax        # 2030 <_IO_stdin_used+0x30>
    11f9:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11fd:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
    1204:	eb 16                	jmp    121c <main+0x5b>
    1206:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1209:	48 98                	cltq   
    120b:	48 8b 44 c5 e0       	mov    -0x20(%rbp,%rax,8),%rax
    1210:	48 89 c7             	mov    %rax,%rdi
    1213:	e8 51 ff ff ff       	callq  1169 <output>
    1218:	83 45 dc 01          	addl   $0x1,-0x24(%rbp)
    121c:	83 7d dc 02          	cmpl   $0x2,-0x24(%rbp)
    1220:	7e e4                	jle    1206 <main+0x45>
    1222:	b8 00 00 00 00       	mov    $0x0,%eax
    1227:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    122b:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1232:	00 00 
    1234:	74 05                	je     123b <main+0x7a>
    1236:	e8 35 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    123b:	c9                   	leaveq 
    123c:	c3                   	retq   
