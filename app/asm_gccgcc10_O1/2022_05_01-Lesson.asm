...
/app/bin_gccgcc10_O1/2022_05_01-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11cc:	f3 0f 5a 44 24 04    	cvtss2sd 0x4(%rsp),%xmm0
    11d2:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11d6:	ba 00 00 00 00       	mov    $0x0,%edx
    11db:	48 8d 35 3e 0e 00 00 	lea    0xe3e(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    11e2:	bf 01 00 00 00       	mov    $0x1,%edi
    11e7:	b8 02 00 00 00       	mov    $0x2,%eax
