...
/app/bin_gccgcc10_O1/2024_03_16-Lesson-b:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    116c:	ba 19 00 00 00       	mov    $0x19,%edx
    1171:	48 8d 35 98 0e 00 00 	lea    0xe98(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    1178:	bf 01 00 00 00       	mov    $0x1,%edi
    117d:	b8 00 00 00 00       	mov    $0x0,%eax
    1182:	e8 c9 fe ff ff       	callq  1050 <__printf_chk@plt>
    1187:	f2 0f 10 05 b1 0e 00 	movsd  0xeb1(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    118e:	00 
    118f:	48 8d 35 8f 0e 00 00 	lea    0xe8f(%rip),%rsi        # 2025 <_IO_stdin_used+0x25>
    1196:	bf 01 00 00 00       	mov    $0x1,%edi
    119b:	b8 01 00 00 00       	mov    $0x1,%eax
    11a0:	e8 ab fe ff ff       	callq  1050 <__printf_chk@plt>
    11a5:	ba 19 00 00 00       	mov    $0x19,%edx
    11aa:	48 8d 35 5f 0e 00 00 	lea    0xe5f(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    11b1:	bf 01 00 00 00       	mov    $0x1,%edi
    11b6:	b8 00 00 00 00       	mov    $0x0,%eax
    11bb:	e8 90 fe ff ff       	callq  1050 <__printf_chk@plt>
