...
/app/bin_gccgcc10_O1/2020_09_05-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b2:	48 8d 4c 24 07       	lea    0x7(%rsp),%rcx
    11b7:	48 8d 54 24 06       	lea    0x6(%rsp),%rdx
    11bc:	48 8d 74 24 05       	lea    0x5(%rsp),%rsi
    11c1:	48 8d 3d 49 0e 00 00 	lea    0xe49(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    11c8:	b8 00 00 00 00       	mov    $0x0,%eax
    11cd:	e8 be fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11d2:	0f be 4c 24 06       	movsbl 0x6(%rsp),%ecx
    11d7:	0f be 54 24 05       	movsbl 0x5(%rsp),%edx
    11dc:	44 0f be 44 24 07    	movsbl 0x7(%rsp),%r8d
    11e2:	48 8d 35 2f 0e 00 00 	lea    0xe2f(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    ...
    1204:	00 00 
    1206:	75 0a                	jne    1212 <main+0x89>
    1208:	b8 00 00 00 00       	mov    $0x0,%eax
    120d:	48 83 c4 18          	add    $0x18,%rsp
    1211:	c3                   	retq   
    1212:	e8 59 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
