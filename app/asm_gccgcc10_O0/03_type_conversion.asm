...
/app/bin_gccgcc10_O0/03_type_conversion:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	f3 0f 10 05 d7 0e 00 	movss  0xed7(%rip),%xmm0        # 2034 <_IO_stdin_used+0x34>
    115c:	00 
    115d:	f3 0f 11 45 f0       	movss  %xmm0,-0x10(%rbp)
    1162:	c7 45 f4 02 00 00 00 	movl   $0x2,-0xc(%rbp)
    1169:	66 0f ef c9          	pxor   %xmm1,%xmm1
    116d:	f3 0f 2a 4d f4       	cvtsi2ssl -0xc(%rbp),%xmm1
    1172:	f3 0f 10 45 f0       	movss  -0x10(%rbp),%xmm0
    1177:	f3 0f 5e c1          	divss  %xmm1,%xmm0
    117b:	f3 0f 11 45 f8       	movss  %xmm0,-0x8(%rbp)
    1180:	c7 45 fc 06 00 00 00 	movl   $0x6,-0x4(%rbp)
    1187:	66 0f ef d2          	pxor   %xmm2,%xmm2
    118b:	f3 0f 5a 55 f8       	cvtss2sd -0x8(%rbp),%xmm2
    1190:	66 48 0f 7e d0       	movq   %xmm2,%rax
    1195:	66 48 0f 6e c0       	movq   %rax,%xmm0
    ...
    11b0:	48 8d 3d 65 0e 00 00 	lea    0xe65(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
