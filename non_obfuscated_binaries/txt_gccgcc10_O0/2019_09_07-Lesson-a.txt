...
/app/bin_gccgcc10_O0/2019_09_07-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <srand@plt>:
    ...
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <srand@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    1191:	48 81 ec f0 00 00 00 	sub    $0xf0,%rsp
    1198:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    119f:	00 00 
    11a1:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11a5:	31 c0                	xor    %eax,%eax
    11a7:	bf 00 00 00 00       	mov    $0x0,%edi
    11ac:	e8 df fe ff ff       	callq  1090 <time@plt>
    11b1:	89 c7                	mov    %eax,%edi
    11b3:	e8 c8 fe ff ff       	callq  1080 <srand@plt>
    11b8:	c7 85 1c ff ff ff 00 	movl   $0x0,-0xe4(%rbp)
    11bf:	00 00 00 
    11c2:	eb 1a                	jmp    11de <main+0x55>
    11c4:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
    11ca:	48 98                	cltq   
    11cc:	c7 84 85 20 ff ff ff 	movl   $0x0,-0xe0(%rbp,%rax,4)
    11d3:	00 00 00 00 
    11d7:	83 85 1c ff ff ff 01 	addl   $0x1,-0xe4(%rbp)
    11de:	83 bd 1c ff ff ff 33 	cmpl   $0x33,-0xe4(%rbp)
    11e5:	7e dd                	jle    11c4 <main+0x3b>
    11e7:	b8 00 00 00 00       	mov    $0x0,%eax
    11ec:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11f0:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11f7:	00 00 
    11f9:	74 05                	je     1200 <main+0x77>
    11fb:	e8 70 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1200:	c9                   	leaveq 
    1201:	c3                   	retq   
