...
/app/bin_gccgcc10_O2/2022_08-Exercise-e:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c8:	bf 35 00 00 00       	mov    $0x35,%edi
    10cd:	e8 be ff ff ff       	callq  1090 <malloc@plt>
    10d2:	48 85 c0             	test   %rax,%rax
    10d5:	74 4d                	je     1124 <main+0x64>
    10d7:	66 0f 6f 05 41 0f 00 	movdqa 0xf41(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10de:	00 
    10df:	c7 40 30 41 41 41 41 	movl   $0x41414141,0x30(%rax)
    10e6:	48 89 c7             	mov    %rax,%rdi
    10e9:	c6 40 34 41          	movb   $0x41,0x34(%rax)
    10ed:	0f 11 00             	movups %xmm0,(%rax)
    10f0:	0f 11 40 10          	movups %xmm0,0x10(%rax)
    10f4:	0f 11 40 20          	movups %xmm0,0x20(%rax)
    10f8:	31 c0                	xor    %eax,%eax
    10fa:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1100:	8d 50 20             	lea    0x20(%rax),%edx
    1103:	00 04 47             	add    %al,(%rdi,%rax,2)
    1106:	00 54 47 01          	add    %dl,0x1(%rdi,%rax,2)
    110a:	48 83 c0 01          	add    $0x1,%rax
    110e:	48 83 f8 1a          	cmp    $0x1a,%rax
    1112:	75 ec                	jne    1100 <main+0x40>
    1114:	c6 47 34 00          	movb   $0x0,0x34(%rdi)
    1118:	e8 63 ff ff ff       	callq  1080 <puts@plt>
    111d:	31 c0                	xor    %eax,%eax
    111f:	48 83 c4 08          	add    $0x8,%rsp
    1123:	c3                   	retq   
    1124:	48 8b 0d f5 2e 00 00 	mov    0x2ef5(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    112b:	ba 1a 00 00 00       	mov    $0x1a,%edx
    1130:	be 01 00 00 00       	mov    $0x1,%esi
    1135:	48 8d 3d c8 0e 00 00 	lea    0xec8(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    113c:	e8 6f ff ff ff       	callq  10b0 <fwrite@plt>
    1141:	bf 01 00 00 00       	mov    $0x1,%edi
    1146:	e8 55 ff ff ff       	callq  10a0 <exit@plt>
