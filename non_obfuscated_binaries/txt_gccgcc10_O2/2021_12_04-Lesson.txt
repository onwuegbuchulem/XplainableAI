...
/app/bin_gccgcc10_O2/2021_12_04-Lesson:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	41 54                	push   %r12
    10a6:	4c 8d 25 7b 0f 00 00 	lea    0xf7b(%rip),%r12        # 2028 <_IO_stdin_used+0x28>
    10ad:	55                   	push   %rbp
    10ae:	48 8d 2d 53 0f 00 00 	lea    0xf53(%rip),%rbp        # 2008 <_IO_stdin_used+0x8>
    10b5:	53                   	push   %rbx
    10b6:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10bd:	00 00 00 
    10c0:	48 89 ef             	mov    %rbp,%rdi
    10c3:	e8 a8 ff ff ff       	callq  1070 <puts@plt>
    10c8:	48 89 ef             	mov    %rbp,%rdi
    10cb:	4c 89 e6             	mov    %r12,%rsi
    10ce:	e8 bd ff ff ff       	callq  1090 <strspn@plt>
    10d3:	48 8d 6c 05 01       	lea    0x1(%rbp,%rax,1),%rbp
    10d8:	48 89 c3             	mov    %rax,%rbx
    10db:	48 89 ef             	mov    %rbp,%rdi
    10de:	e8 9d ff ff ff       	callq  1080 <strlen@plt>
    10e3:	48 39 d8             	cmp    %rbx,%rax
    10e6:	77 d8                	ja     10c0 <main+0x20>
    10e8:	48 89 ef             	mov    %rbp,%rdi
    10eb:	e8 80 ff ff ff       	callq  1070 <puts@plt>
    10f0:	5b                   	pop    %rbx
