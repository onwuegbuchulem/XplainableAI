...
/app/bin_gccgcc10_O1/2024_10_19-Lesson-a:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1152:	bb 10 00 00 00       	mov    $0x10,%ebx
    1157:	66 0f ef e4          	pxor   %xmm4,%xmm4
    115b:	f3 0f 11 64 24 0c    	movss  %xmm4,0xc(%rsp)
    1161:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1165:	f3 0f 5a 44 24 0c    	cvtss2sd 0xc(%rsp),%xmm0
    116b:	66 0f 28 c8          	movapd %xmm0,%xmm1
    116f:	f2 0f 5c 0d a1 0e 00 	subsd  0xea1(%rip),%xmm1        # 2018 <_IO_stdin_used+0x18>
    1176:	00 
    1177:	f2 0f 59 0d a1 0e 00 	mulsd  0xea1(%rip),%xmm1        # 2020 <_IO_stdin_used+0x20>
    117e:	00 
    117f:	f2 0f 5a c9          	cvtsd2ss %xmm1,%xmm1
    1183:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
    1187:	48 8d 3d 76 0e 00 00 	lea    0xe76(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    118e:	b8 02 00 00 00       	mov    $0x2,%eax
    1193:	e8 b8 fe ff ff       	callq  1050 <printf@plt>
    1198:	f3 0f 10 15 88 0e 00 	movss  0xe88(%rip),%xmm2        # 2028 <_IO_stdin_used+0x28>
    119f:	00 
    11a0:	f3 0f 58 54 24 0c    	addss  0xc(%rsp),%xmm2
    11a6:	f3 0f 11 54 24 0c    	movss  %xmm2,0xc(%rsp)
    11ac:	83 eb 01             	sub    $0x1,%ebx
    11af:	75 b0                	jne    1161 <main+0x18>
