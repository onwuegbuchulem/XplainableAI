...
/app/bin_gccgcc10_O1/2022_10_22-Lesson-c:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11d1:	55                   	push   %rbp
    11d2:	53                   	push   %rbx
    11d3:	48 83 ec 48          	sub    $0x48,%rsp
    11d7:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11de:	00 00 
    11e0:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    11e5:	31 c0                	xor    %eax,%eax
    11e7:	48 b8 2f 64 65 76 2f 	movabs $0x6e61722f7665642f,%rax
    11ee:	72 61 6e 
    11f1:	48 89 44 24 2c       	mov    %rax,0x2c(%rsp)
    11f6:	c7 44 24 34 64 6f 6d 	movl   $0x6d6f64,0x34(%rsp)
    11fd:	00 
    11fe:	48 8d 7c 24 2c       	lea    0x2c(%rsp),%rdi
    1203:	48 8d 35 fa 0d 00 00 	lea    0xdfa(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    120a:	e8 c1 fe ff ff       	callq  10d0 <fopen@plt>
    120f:	48 85 c0             	test   %rax,%rax
    1212:	74 4c                	je     1260 <main+0x97>
    1214:	49 89 c5             	mov    %rax,%r13
    1217:	48 89 e3             	mov    %rsp,%rbx
    121a:	48 89 c1             	mov    %rax,%rcx
    121d:	ba 0a 00 00 00       	mov    $0xa,%edx
    1222:	be 04 00 00 00       	mov    $0x4,%esi
    1227:	48 89 df             	mov    %rbx,%rdi
    122a:	e8 61 fe ff ff       	callq  1090 <fread@plt>
    122f:	4c 8d 64 24 28       	lea    0x28(%rsp),%r12
    1234:	48 8d 2d cb 0d 00 00 	lea    0xdcb(%rip),%rbp        # 2006 <_IO_stdin_used+0x6>
    123b:	8b 13                	mov    (%rbx),%edx
    123d:	48 89 ee             	mov    %rbp,%rsi
    1240:	bf 01 00 00 00       	mov    $0x1,%edi
    1245:	b8 00 00 00 00       	mov    $0x0,%eax
    124a:	e8 71 fe ff ff       	callq  10c0 <__printf_chk@plt>
    124f:	48 83 c3 04          	add    $0x4,%rbx
    1253:	4c 39 e3             	cmp    %r12,%rbx
    1256:	75 e3                	jne    123b <main+0x72>
    1258:	4c 89 ef             	mov    %r13,%rdi
    125b:	e8 40 fe ff ff       	callq  10a0 <fclose@plt>
    1260:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1265:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    126c:	00 00 
    126e:	75 10                	jne    1280 <main+0xb7>
    1270:	b8 00 00 00 00       	mov    $0x0,%eax
    1275:	48 83 c4 48          	add    $0x48,%rsp
    1279:	5b                   	pop    %rbx
    127a:	5d                   	pop    %rbp
    127b:	41 5c                	pop    %r12
    127d:	41 5d                	pop    %r13
    127f:	c3                   	retq   
    1280:	e8 2b fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
