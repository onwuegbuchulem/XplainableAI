...
/app/bin_gccgcc10_O0/2022_03_05-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	8b 55 f4             	mov    -0xc(%rbp),%edx
    1187:	48 8d 45 f4          	lea    -0xc(%rbp),%rax
    118b:	89 d1                	mov    %edx,%ecx
    118d:	48 89 c2             	mov    %rax,%rdx
    1190:	be 40 9c 00 00       	mov    $0x9c40,%esi
    1195:	48 8d 3d 6c 0e 00 00 	lea    0xe6c(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    119c:	b8 00 00 00 00       	mov    $0x0,%eax
    11a1:	e8 ca fe ff ff       	callq  1070 <printf@plt>
    11a6:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11a9:	89 c6                	mov    %eax,%esi
    11ab:	48 8d 3d 85 0e 00 00 	lea    0xe85(%rip),%rdi        # 2037 <_IO_stdin_used+0x37>
    ...
    11c5:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11cc:	00 00 
