...
/app/bin_gccgcc10_O1/2023_06_01-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    120f:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    1213:	8b 14 24             	mov    (%rsp),%edx
    1216:	48 8d 35 1e 0e 00 00 	lea    0xe1e(%rip),%rsi        # 203b <_IO_stdin_used+0x3b>
    121d:	bf 01 00 00 00       	mov    $0x1,%edi
    1222:	b8 00 00 00 00       	mov    $0x0,%eax
    1227:	e8 54 fe ff ff       	callq  1080 <__printf_chk@plt>
    122c:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1231:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1238:	00 00 
    123a:	75 0a                	jne    1246 <main+0xbd>
