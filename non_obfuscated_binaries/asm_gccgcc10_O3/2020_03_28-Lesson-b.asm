...
/app/bin_gccgcc10_O3/2020_03_28-Lesson-b:     file format elf64-x86-64
...
0000000000001120 <main>:
    ...
    113c:	48 b8 67 65 74 74 79 	movabs $0x7562737974746567,%rax
    1143:	73 62 75 
    1146:	4c 8d 64 24 09       	lea    0x9(%rsp),%r12
    114b:	c7 44 24 11 72 67 2e 	movl   $0x742e6772,0x11(%rsp)
    1152:	74 
    1153:	48 8d 5c 24 08       	lea    0x8(%rsp),%rbx
    1158:	4c 89 e7             	mov    %r12,%rdi
    115b:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    1160:	48 89 44 24 09       	mov    %rax,0x9(%rsp)
    1165:	b8 78 74 00 00       	mov    $0x7478,%eax
    116a:	66 89 44 24 15       	mov    %ax,0x15(%rsp)
    116f:	31 c0                	xor    %eax,%eax
    1171:	e8 7a ff ff ff       	callq  10f0 <open@plt>
    1176:	89 c5                	mov    %eax,%ebp
    1178:	83 f8 ff             	cmp    $0xffffffff,%eax
    117b:	75 1a                	jne    1197 <main+0x77>
    117d:	eb 6d                	jmp    11ec <main+0xcc>
    117f:	90                   	nop
    1180:	48 83 f8 ff          	cmp    $0xffffffffffffffff,%rax
    1184:	74 47                	je     11cd <main+0xad>
    1186:	0f be 7c 24 08       	movsbl 0x8(%rsp),%edi
    118b:	48 8b 35 8e 2e 00 00 	mov    0x2e8e(%rip),%rsi        # 4020 <stdout@@GLIBC_2.2.5>
    1192:	e8 49 ff ff ff       	callq  10e0 <putc@plt>
    1197:	ba 01 00 00 00       	mov    $0x1,%edx
    119c:	48 89 de             	mov    %rbx,%rsi
    119f:	89 ef                	mov    %ebp,%edi
    11a1:	e8 2a ff ff ff       	callq  10d0 <read@plt>
    11a6:	48 85 c0             	test   %rax,%rax
    11a9:	75 d5                	jne    1180 <main+0x60>
    11ab:	89 ef                	mov    %ebp,%edi
    11ad:	e8 0e ff ff ff       	callq  10c0 <close@plt>
    11b2:	31 c0                	xor    %eax,%eax
    11b4:	48 8b 4c 24 18       	mov    0x18(%rsp),%rcx
    11b9:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11c0:	00 00 
    11c2:	75 4c                	jne    1210 <main+0xf0>
    11c4:	48 83 c4 20          	add    $0x20,%rsp
    11c8:	5b                   	pop    %rbx
    11c9:	5d                   	pop    %rbp
    11ca:	41 5c                	pop    %r12
    11cc:	c3                   	retq   
    11cd:	48 8b 0d 6c 2e 00 00 	mov    0x2e6c(%rip),%rcx        # 4040 <stderr@@GLIBC_2.2.5>
    11d4:	ba 10 00 00 00       	mov    $0x10,%edx
    11d9:	be 01 00 00 00       	mov    $0x1,%esi
    11de:	48 8d 3d 32 0e 00 00 	lea    0xe32(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    11e5:	e8 16 ff ff ff       	callq  1100 <fwrite@plt>
    11ea:	eb bf                	jmp    11ab <main+0x8b>
    11ec:	48 8b 3d 4d 2e 00 00 	mov    0x2e4d(%rip),%rdi        # 4040 <stderr@@GLIBC_2.2.5>
    11f3:	4c 89 e1             	mov    %r12,%rcx
    11f6:	be 01 00 00 00       	mov    $0x1,%esi
    11fb:	31 c0                	xor    %eax,%eax
    11fd:	48 8d 15 00 0e 00 00 	lea    0xe00(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    1204:	e8 07 ff ff ff       	callq  1110 <__fprintf_chk@plt>
    1209:	b8 01 00 00 00       	mov    $0x1,%eax
    120e:	eb a4                	jmp    11b4 <main+0x94>
    1210:	e8 9b fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
