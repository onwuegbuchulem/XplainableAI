...
/app/bin_gccgcc10_O2/wordfilter01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c4:	41 54                	push   %r12
    10c6:	55                   	push   %rbp
    10c7:	31 ed                	xor    %ebp,%ebp
    10c9:	53                   	push   %rbx
    10ca:	48 83 ec 50          	sub    $0x50,%rsp
    10ce:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10d5:	00 00 
    10d7:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    10dc:	31 c0                	xor    %eax,%eax
    10de:	49 89 e4             	mov    %rsp,%r12
    10e1:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    10e8:	48 8b 3d 21 2f 00 00 	mov    0x2f21(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    10ef:	e8 ac ff ff ff       	callq  10a0 <getc@plt>
    10f4:	89 c3                	mov    %eax,%ebx
    10f6:	83 f8 ff             	cmp    $0xffffffff,%eax
    10f9:	74 55                	je     1150 <main+0x90>
    10fb:	e8 b0 ff ff ff       	callq  10b0 <__ctype_b_loc@plt>
    1100:	49 89 c0             	mov    %rax,%r8
    1103:	48 63 c3             	movslq %ebx,%rax
    1106:	49 8b 10             	mov    (%r8),%rdx
    1109:	f6 44 42 01 20       	testb  $0x20,0x1(%rdx,%rax,2)
    110e:	48 63 c5             	movslq %ebp,%rax
    1111:	74 1d                	je     1130 <main+0x70>
    1113:	c6 04 04 00          	movb   $0x0,(%rsp,%rax,1)
    1117:	85 ed                	test   %ebp,%ebp
    1119:	74 cd                	je     10e8 <main+0x28>
    111b:	4c 89 e7             	mov    %r12,%rdi
    111e:	31 ed                	xor    %ebp,%ebp
    1120:	e8 5b ff ff ff       	callq  1080 <puts@plt>
    1125:	eb c1                	jmp    10e8 <main+0x28>
    1127:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    112e:	00 00 
    1130:	83 c5 01             	add    $0x1,%ebp
    1133:	88 1c 04             	mov    %bl,(%rsp,%rax,1)
    1136:	83 fd 3f             	cmp    $0x3f,%ebp
    1139:	75 ad                	jne    10e8 <main+0x28>
    113b:	4c 89 e7             	mov    %r12,%rdi
    113e:	c6 44 24 3f 00       	movb   $0x0,0x3f(%rsp)
    1143:	31 ed                	xor    %ebp,%ebp
    1145:	e8 36 ff ff ff       	callq  1080 <puts@plt>
    114a:	eb 9c                	jmp    10e8 <main+0x28>
    114c:	0f 1f 40 00          	nopl   0x0(%rax)
    1150:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    1155:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    115c:	00 00 
    115e:	75 0b                	jne    116b <main+0xab>
