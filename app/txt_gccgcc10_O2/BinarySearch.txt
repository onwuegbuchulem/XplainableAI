...
/app/bin_gccgcc10_O2/BinarySearch:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	55                   	push   %rbp
    1085:	b9 05 00 00 00       	mov    $0x5,%ecx
    108a:	31 d2                	xor    %edx,%edx
    108c:	be 18 00 00 00       	mov    $0x18,%esi
    1091:	48 83 ec 20          	sub    $0x20,%rsp
    1095:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    109c:	00 00 
    109e:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10a3:	48 b8 05 00 00 00 0f 	movabs $0xf00000005,%rax
    10aa:	00 00 00 
    10ad:	48 89 e5             	mov    %rsp,%rbp
    10b0:	48 89 ef             	mov    %rbp,%rdi
    10b3:	48 89 04 24          	mov    %rax,(%rsp)
    10b7:	48 b8 18 00 00 00 20 	movabs $0x2000000018,%rax
    10be:	00 00 00 
    10c1:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10c6:	48 b8 38 00 00 00 59 	movabs $0x5900000038,%rax
    10cd:	00 00 00 
    10d0:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    10d5:	e8 56 01 00 00       	callq  1230 <binarySearch>
    ...
    10f1:	be 76 00 00 00       	mov    $0x76,%esi
    10f6:	48 89 ef             	mov    %rbp,%rdi
    10f9:	b9 05 00 00 00       	mov    $0x5,%ecx
    10fe:	e8 2d 01 00 00       	callq  1230 <binarySearch>
    ...
    1118:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    111d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1124:	00 00 
    1126:	75 08                	jne    1130 <main+0xb0>
    1128:	48 83 c4 20          	add    $0x20,%rsp
    112c:	31 c0                	xor    %eax,%eax
    112e:	5d                   	pop    %rbp
    112f:	c3                   	retq   
    1130:	e8 2b ff ff ff       	callq  1060 <__stack_chk_fail@plt>
