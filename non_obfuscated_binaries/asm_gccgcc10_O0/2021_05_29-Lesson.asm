...
/app/bin_gccgcc10_O0/2021_05_29-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119c:	83 7d ec 01          	cmpl   $0x1,-0x14(%rbp)
    11a0:	7e 0e                	jle    11b0 <main+0x27>
    11a2:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    11a6:	48 8b 40 08          	mov    0x8(%rax),%rax
    11aa:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11ae:	eb 2a                	jmp    11da <main+0x51>
    11b0:	48 8b 05 69 2e 00 00 	mov    0x2e69(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    11b7:	48 89 c1             	mov    %rax,%rcx
    11ba:	ba 1b 00 00 00       	mov    $0x1b,%edx
    11bf:	be 01 00 00 00       	mov    $0x1,%esi
    11c4:	48 8d 3d 39 0e 00 00 	lea    0xe39(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11cb:	e8 c0 fe ff ff       	callq  1090 <fwrite@plt>
    11d0:	bf 01 00 00 00       	mov    $0x1,%edi
    11d5:	e8 a6 fe ff ff       	callq  1080 <exit@plt>
    11da:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11de:	48 89 c6             	mov    %rax,%rsi
    11e1:	48 8d 3d 38 0e 00 00 	lea    0xe38(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
