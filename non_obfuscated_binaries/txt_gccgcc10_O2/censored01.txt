...
/app/bin_gccgcc10_O2/censored01:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10a1:	74 3d                	je     10e0 <main+0x60>
    10a3:	8d 47 bf             	lea    -0x41(%rdi),%eax
    10a6:	48 8b 35 63 2f 00 00 	mov    0x2f63(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10ad:	83 f8 34             	cmp    $0x34,%eax
    10b0:	77 0e                	ja     10c0 <main+0x40>
    10b2:	48 63 04 83          	movslq (%rbx,%rax,4),%rax
    10b6:	48 01 d8             	add    %rbx,%rax
    10b9:	3e ff e0             	notrack jmpq *%rax
    10bc:	0f 1f 40 00          	nopl   0x0(%rax)
    10c0:	e8 9b ff ff ff       	callq  1060 <putc@plt>
    10c5:	eb c9                	jmp    1090 <main+0x10>
    10c7:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    10ce:	00 00 
    10d0:	bf 2a 00 00 00       	mov    $0x2a,%edi
    10d5:	e8 86 ff ff ff       	callq  1060 <putc@plt>
    10da:	eb b4                	jmp    1090 <main+0x10>
...
0000000000001190 <__do_global_dtors_aux>:
    ...
    1194:	80 3d 8d 2e 00 00 00 	cmpb   $0x0,0x2e8d(%rip)        # 4028 <completed.0>
    ...
    11bc:	c6 05 65 2e 00 00 01 	movb   $0x1,0x2e65(%rip)        # 4028 <completed.0>
    11c3:	5d                   	pop    %rbp
    11c4:	c3                   	retq   
