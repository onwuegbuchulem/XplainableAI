...
/app/bin_gccgcc10_O0/2023_07_15-Lesson-a:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    121a:	e8 c1 fe ff ff       	callq  10e0 <malloc@plt>
    121f:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    1223:	bf 10 00 00 00       	mov    $0x10,%edi
    1228:	e8 b3 fe ff ff       	callq  10e0 <malloc@plt>
    122d:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1231:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
    1236:	74 07                	je     123f <main+0x36>
    1238:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
    123d:	75 2a                	jne    1269 <main+0x60>
    123f:	48 8b 05 da 2d 00 00 	mov    0x2dda(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    1246:	48 89 c1             	mov    %rax,%rcx
    1249:	ba 18 00 00 00       	mov    $0x18,%edx
    124e:	be 01 00 00 00       	mov    $0x1,%esi
    1253:	48 8d 3d aa 0d 00 00 	lea    0xdaa(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    125a:	e8 b1 fe ff ff       	callq  1110 <fwrite@plt>
    125f:	bf 01 00 00 00       	mov    $0x1,%edi
    1264:	e8 97 fe ff ff       	callq  1100 <exit@plt>
    1269:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    126d:	c6 00 00             	movb   $0x0,(%rax)
    1270:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1274:	0f b6 10             	movzbl (%rax),%edx
    1277:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    127b:	88 10                	mov    %dl,(%rax)
    127d:	48 8d 3d 99 0d 00 00 	lea    0xd99(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    1284:	b8 00 00 00 00       	mov    $0x0,%eax
    1289:	e8 42 fe ff ff       	callq  10d0 <printf@plt>
    128e:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1292:	48 89 c6             	mov    %rax,%rsi
    1295:	48 8d 3d 88 0d 00 00 	lea    0xd88(%rip),%rdi        # 2024 <_IO_stdin_used+0x24>
    129c:	b8 00 00 00 00       	mov    $0x0,%eax
    12a1:	e8 4a fe ff ff       	callq  10f0 <__isoc99_scanf@plt>
    12a6:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    12aa:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    12ae:	48 89 d6             	mov    %rdx,%rsi
    12b1:	48 89 c7             	mov    %rax,%rdi
    12b4:	e8 f7 fd ff ff       	callq  10b0 <strcpy@plt>
    12b9:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    12bd:	48 89 c7             	mov    %rax,%rdi
    12c0:	e8 fb fd ff ff       	callq  10c0 <puts@plt>
