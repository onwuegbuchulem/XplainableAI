...
/app/bin_gccgcc10_O0/AreaOfRectangle:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 3d 4e 0e 00 00 	lea    0xe4e(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	e8 c3 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cd:	48 8d 3d 40 0e 00 00 	lea    0xe40(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    ...
    11e5:	48 8d 3d 25 0e 00 00 	lea    0xe25(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    11ec:	b8 00 00 00 00       	mov    $0x0,%eax
    11f1:	e8 9a fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f6:	8b 55 ec             	mov    -0x14(%rbp),%edx
    11f9:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11fc:	0f af c2             	imul   %edx,%eax
    11ff:	89 45 f4             	mov    %eax,-0xc(%rbp)
    1202:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1205:	89 c6                	mov    %eax,%esi
    1207:	48 8d 3d 14 0e 00 00 	lea    0xe14(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
