...
/app/bin_gccgcc10_O1/2023_07-Exercise:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d f9 00 00 00 	lea    0xf9(%rip),%rdi        # 11c1 <main>
...
0000000000001189 <sum>:
    ...
    11b0:	29 d7                	sub    %edx,%edi
    11b2:	01 f9                	add    %edi,%ecx
    11b4:	89 c7                	mov    %eax,%edi
    11b6:	85 c0                	test   %eax,%eax
    11b8:	75 dc                	jne    1196 <sum+0xd>
    11ba:	89 c8                	mov    %ecx,%eax
    11bc:	c3                   	retq   
    11bd:	89 f9                	mov    %edi,%ecx
    11bf:	eb f9                	jmp    11ba <sum+0x31>
...
00000000000011c1 <main>:
    ...
    11ea:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11ef:	48 8d 3d 29 0e 00 00 	lea    0xe29(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    11f6:	b8 00 00 00 00       	mov    $0x0,%eax
    11fb:	e8 90 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    1200:	8b 7c 24 04          	mov    0x4(%rsp),%edi
    1204:	e8 80 ff ff ff       	callq  1189 <sum>
    1209:	89 c2                	mov    %eax,%edx
    120b:	48 8d 35 10 0e 00 00 	lea    0xe10(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
