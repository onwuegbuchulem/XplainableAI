...
/app/bin_gccgcc10_O0/Temperature:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 3d 69 0e 00 00 	lea    0xe69(%rip),%rdi        # 202c <_IO_stdin_used+0x2c>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	e8 c3 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cd:	f3 0f 10 4d f0       	movss  -0x10(%rbp),%xmm1
    11d2:	f3 0f 10 05 76 0e 00 	movss  0xe76(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    11d9:	00 
    11da:	f3 0f 58 c1          	addss  %xmm1,%xmm0
    11de:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    11e3:	66 0f ef d2          	pxor   %xmm2,%xmm2
    11e7:	f3 0f 5a 55 f4       	cvtss2sd -0xc(%rbp),%xmm2
    11ec:	66 48 0f 7e d0       	movq   %xmm2,%rax
