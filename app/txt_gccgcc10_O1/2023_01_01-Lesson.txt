...
/app/bin_gccgcc10_O1/2023_01_01-Lesson:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11ad:	53                   	push   %rbx
    11ae:	48 81 ec a0 00 00 00 	sub    $0xa0,%rsp
    11b5:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11bc:	00 00 
    11be:	48 89 84 24 98 00 00 	mov    %rax,0x98(%rsp)
    11c5:	00 
    11c6:	31 c0                	xor    %eax,%eax
    11c8:	83 ff 01             	cmp    $0x1,%edi
    11cb:	7e 58                	jle    1225 <main+0x7c>
    11cd:	48 8b 5e 08          	mov    0x8(%rsi),%rbx
    11d1:	48 89 e2             	mov    %rsp,%rdx
    11d4:	48 89 de             	mov    %rbx,%rsi
    11d7:	bf 01 00 00 00       	mov    $0x1,%edi
    11dc:	e8 bf fe ff ff       	callq  10a0 <__xstat@plt>
    11e1:	83 f8 ff             	cmp    $0xffffffff,%eax
    11e4:	74 52                	je     1238 <main+0x8f>
    11e6:	48 8b 4c 24 30       	mov    0x30(%rsp),%rcx
    11eb:	48 89 da             	mov    %rbx,%rdx
    11ee:	48 8d 35 35 0e 00 00 	lea    0xe35(%rip),%rsi        # 202a <_IO_stdin_used+0x2a>
    ...
    1209:	48 8b 8c 24 98 00 00 	mov    0x98(%rsp),%rcx
    1210:	00 
    1211:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1218:	00 00 
    121a:	75 3c                	jne    1258 <main+0xaf>
    121c:	48 81 c4 a0 00 00 00 	add    $0xa0,%rsp
    1223:	5b                   	pop    %rbx
    1224:	c3                   	retq   
    ...
    1236:	eb d1                	jmp    1209 <main+0x60>
    1238:	48 89 da             	mov    %rbx,%rdx
    123b:	48 8d 35 d5 0d 00 00 	lea    0xdd5(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    1242:	bf 01 00 00 00       	mov    $0x1,%edi
    1247:	b8 00 00 00 00       	mov    $0x0,%eax
    124c:	e8 5f fe ff ff       	callq  10b0 <__printf_chk@plt>
    1251:	b8 00 00 00 00       	mov    $0x0,%eax
    1256:	eb b1                	jmp    1209 <main+0x60>
