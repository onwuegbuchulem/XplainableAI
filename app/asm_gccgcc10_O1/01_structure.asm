...
/app/bin_gccgcc10_O1/01_structure:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1181:	c7 04 24 9f 11 00 00 	movl   $0x119f,(%rsp)
    1188:	48 8d 4c 24 08       	lea    0x8(%rsp),%rcx
    118d:	c7 44 24 08 48 61 72 	movl   $0x72726148,0x8(%rsp)
    1194:	72 
    1195:	66 c7 44 24 0c 79 00 	movw   $0x79,0xc(%rsp)
    119c:	c7 44 24 04 8f c2 59 	movl   $0x4259c28f,0x4(%rsp)
    11a3:	42 
    11a4:	f2 0f 10 05 64 0e 00 	movsd  0xe64(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    11ab:	00 
    11ac:	ba 9f 11 00 00       	mov    $0x119f,%edx
    ...
    11c7:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11cc:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11d3:	00 00 
    11d5:	75 0a                	jne    11e1 <main+0x78>
    11d7:	b8 00 00 00 00       	mov    $0x0,%eax
    11dc:	48 83 c4 28          	add    $0x28,%rsp
    11e0:	c3                   	retq   
