...
/app/bin_gccgcc10_O0/Area_of_Circle:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 3d 59 0e 00 00 	lea    0xe59(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	e8 c3 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cd:	f3 0f 10 45 f0       	movss  -0x10(%rbp),%xmm0
    11d2:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11d6:	f3 0f 5a c8          	cvtss2sd %xmm0,%xmm1
    11da:	f2 0f 10 05 4e 0e 00 	movsd  0xe4e(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    11e1:	00 
    11e2:	f2 0f 59 c8          	mulsd  %xmm0,%xmm1
    11e6:	f3 0f 10 45 f0       	movss  -0x10(%rbp),%xmm0
    11eb:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    11ef:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    11f3:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    11f7:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    11fc:	66 0f ef d2          	pxor   %xmm2,%xmm2
    1200:	f3 0f 5a 55 f4       	cvtss2sd -0xc(%rbp),%xmm2
    1205:	66 48 0f 7e d0       	movq   %xmm2,%rax
    120a:	66 48 0f 6e c0       	movq   %rax,%xmm0
    120f:	48 8d 3d 09 0e 00 00 	lea    0xe09(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
