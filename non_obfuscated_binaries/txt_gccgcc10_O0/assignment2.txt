...
/app/bin_gccgcc10_O0/assignment2:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    118b:	f3 0f 10 05 a5 0e 00 	movss  0xea5(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    1192:	00 
    1193:	f3 0f 11 45 e4       	movss  %xmm0,-0x1c(%rbp)
    1198:	48 b8 48 65 6c 6c 6f 	movabs $0x57202c6f6c6c6548,%rax
    119f:	2c 20 57 
    11a2:	48 89 45 ea          	mov    %rax,-0x16(%rbp)
    11a6:	c7 45 f2 6f 72 6c 64 	movl   $0x646c726f,-0xe(%rbp)
    11ad:	66 c7 45 f6 21 00    	movw   $0x21,-0xa(%rbp)
    11b3:	8b 45 e0             	mov    -0x20(%rbp),%eax
    11b6:	89 c6                	mov    %eax,%esi
    11b8:	48 8d 3d 45 0e 00 00 	lea    0xe45(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11bf:	b8 00 00 00 00       	mov    $0x0,%eax
    11c4:	e8 a7 fe ff ff       	callq  1070 <printf@plt>
    11c9:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11cd:	f3 0f 5a 4d e4       	cvtss2sd -0x1c(%rbp),%xmm1
    11d2:	66 48 0f 7e c8       	movq   %xmm1,%rax
    11d7:	66 48 0f 6e c0       	movq   %rax,%xmm0
    11dc:	48 8d 3d 34 0e 00 00 	lea    0xe34(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    11e3:	b8 01 00 00 00       	mov    $0x1,%eax
    11e8:	e8 83 fe ff ff       	callq  1070 <printf@plt>
    11ed:	48 8d 45 ea          	lea    -0x16(%rbp),%rax
    11f1:	48 89 c6             	mov    %rax,%rsi
    11f4:	48 8d 3d 2c 0e 00 00 	lea    0xe2c(%rip),%rdi        # 2027 <_IO_stdin_used+0x27>
