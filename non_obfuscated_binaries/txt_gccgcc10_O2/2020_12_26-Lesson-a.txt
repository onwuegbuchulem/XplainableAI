...
/app/bin_gccgcc10_O2/2020_12_26-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1094:	ba 04 00 00 00       	mov    $0x4,%edx
    1099:	48 8d 35 79 0f 00 00 	lea    0xf79(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    10a0:	31 c0                	xor    %eax,%eax
    10a2:	bf 01 00 00 00       	mov    $0x1,%edi
    10a7:	e8 c4 ff ff ff       	callq  1070 <__printf_chk@plt>
    10ac:	ba 02 00 00 00       	mov    $0x2,%edx
    10b1:	48 8d 35 6a 0f 00 00 	lea    0xf6a(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    10b8:	31 c0                	xor    %eax,%eax
    10ba:	bf 01 00 00 00       	mov    $0x1,%edi
    10bf:	e8 ac ff ff ff       	callq  1070 <__printf_chk@plt>
    10c4:	ba 05 00 00 00       	mov    $0x5,%edx
    10c9:	48 8d 35 5b 0f 00 00 	lea    0xf5b(%rip),%rsi        # 202b <_IO_stdin_used+0x2b>
    10d0:	31 c0                	xor    %eax,%eax
    10d2:	bf 01 00 00 00       	mov    $0x1,%edi
    10d7:	e8 94 ff ff ff       	callq  1070 <__printf_chk@plt>
    10dc:	ba 03 00 00 00       	mov    $0x3,%edx
    10e1:	48 8d 35 4c 0f 00 00 	lea    0xf4c(%rip),%rsi        # 2034 <_IO_stdin_used+0x34>
