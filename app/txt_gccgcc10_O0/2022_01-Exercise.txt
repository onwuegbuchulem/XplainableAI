...
/app/bin_gccgcc10_O0/2022_01-Exercise:     file format elf64-x86-64
...
0000000000001070 <getchar@plt>:
    ...
    1074:	f2 ff 25 55 2f 00 00 	bnd jmpq *0x2f55(%rip)        # 3fd0 <getchar@GLIBC_2.2.5>
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d ff 00 00 00 	lea    0xff(%rip),%rdi        # 11a7 <main>
...
0000000000001169 <hexdigit>:
    ...
    1171:	89 f8                	mov    %edi,%eax
    1173:	88 45 fc             	mov    %al,-0x4(%rbp)
    1176:	80 7d fc 40          	cmpb   $0x40,-0x4(%rbp)
    117a:	7e 0f                	jle    118b <hexdigit+0x22>
    117c:	80 7d fc 46          	cmpb   $0x46,-0x4(%rbp)
    1180:	7f 09                	jg     118b <hexdigit+0x22>
    1182:	0f be 45 fc          	movsbl -0x4(%rbp),%eax
    1186:	83 e8 37             	sub    $0x37,%eax
    1189:	eb 1a                	jmp    11a5 <hexdigit+0x3c>
    118b:	80 7d fc 2f          	cmpb   $0x2f,-0x4(%rbp)
    118f:	7e 0f                	jle    11a0 <hexdigit+0x37>
    1191:	80 7d fc 39          	cmpb   $0x39,-0x4(%rbp)
    1195:	7f 09                	jg     11a0 <hexdigit+0x37>
    1197:	0f be 45 fc          	movsbl -0x4(%rbp),%eax
    119b:	83 e8 30             	sub    $0x30,%eax
    119e:	eb 05                	jmp    11a5 <hexdigit+0x3c>
    11a0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    11a5:	5d                   	pop    %rbp
    11a6:	c3                   	retq   
...
00000000000011a7 <main>:
    ...
    11b3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%rbp)
    11ba:	e8 b1 fe ff ff       	callq  1070 <getchar@plt>
    11bf:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11c2:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%rbp)
    11c6:	74 56                	je     121e <main+0x77>
    11c8:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11cb:	0f be c0             	movsbl %al,%eax
    11ce:	89 c7                	mov    %eax,%edi
    11d0:	e8 94 ff ff ff       	callq  1169 <hexdigit>
    11d5:	89 45 f8             	mov    %eax,-0x8(%rbp)
    11d8:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
    11dc:	78 43                	js     1221 <main+0x7a>
    11de:	e8 8d fe ff ff       	callq  1070 <getchar@plt>
    11e3:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11e6:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%rbp)
    11ea:	74 38                	je     1224 <main+0x7d>
    11ec:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11ef:	0f be c0             	movsbl %al,%eax
    11f2:	89 c7                	mov    %eax,%edi
    11f4:	e8 70 ff ff ff       	callq  1169 <hexdigit>
    11f9:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11fc:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    1200:	78 25                	js     1227 <main+0x80>
    1202:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1205:	c1 e0 04             	shl    $0x4,%eax
    1208:	89 c2                	mov    %eax,%edx
    120a:	8b 45 fc             	mov    -0x4(%rbp),%eax
    120d:	01 d0                	add    %edx,%eax
    120f:	01 45 f0             	add    %eax,-0x10(%rbp)
    1212:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1215:	89 c7                	mov    %eax,%edi
    1217:	e8 44 fe ff ff       	callq  1060 <putchar@plt>
    121c:	eb 9c                	jmp    11ba <main+0x13>
    121e:	90                   	nop
    121f:	eb 07                	jmp    1228 <main+0x81>
    1221:	90                   	nop
    1222:	eb 04                	jmp    1228 <main+0x81>
    1224:	90                   	nop
    1225:	eb 01                	jmp    1228 <main+0x81>
    1227:	90                   	nop
