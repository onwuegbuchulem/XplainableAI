...
/app/bin_gccgcc10_O0/2024_07_06-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119c:	eb 0e                	jmp    11ac <main+0x23>
    119e:	bf 58 00 00 00       	mov    $0x58,%edi
    11a3:	e8 c8 fe ff ff       	callq  1070 <putchar@plt>
    11a8:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    11ac:	83 7d fc 13          	cmpl   $0x13,-0x4(%rbp)
    11b0:	7e ec                	jle    119e <main+0x15>
    11b2:	48 8b 05 57 2e 00 00 	mov    0x2e57(%rip),%rax        # 4010 <stdout@@GLIBC_2.2.5>
    11b9:	48 89 c7             	mov    %rax,%rdi
    11bc:	e8 bf fe ff ff       	callq  1080 <fflush@plt>
    11c1:	bf 01 00 00 00       	mov    $0x1,%edi
    11c6:	e8 c5 fe ff ff       	callq  1090 <sleep@plt>
    11cb:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
    11d2:	eb 0e                	jmp    11e2 <main+0x59>
    11d4:	bf 08 00 00 00       	mov    $0x8,%edi
    11d9:	e8 92 fe ff ff       	callq  1070 <putchar@plt>
    11de:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    11e2:	83 7d fc 13          	cmpl   $0x13,-0x4(%rbp)
    11e6:	7e ec                	jle    11d4 <main+0x4b>
    11e8:	bf 0a 00 00 00       	mov    $0xa,%edi
    11ed:	e8 7e fe ff ff       	callq  1070 <putchar@plt>
