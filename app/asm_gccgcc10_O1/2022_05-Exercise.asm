...
/app/bin_gccgcc10_O1/2022_05-Exercise:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ce:	f3 0f 2c d0          	cvttss2si %xmm0,%edx
    11d2:	66 0f ef d2          	pxor   %xmm2,%xmm2
    11d6:	f3 0f 2a d2          	cvtsi2ss %edx,%xmm2
    11da:	0f 28 c8             	movaps %xmm0,%xmm1
    11dd:	f3 0f 5c ca          	subss  %xmm2,%xmm1
    11e1:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    11e5:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
    11e9:	48 8d 35 30 0e 00 00 	lea    0xe30(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    11f0:	bf 01 00 00 00       	mov    $0x1,%edi
    11f5:	b8 02 00 00 00       	mov    $0x2,%eax
    ...
    120b:	00 00 
    120d:	75 0a                	jne    1219 <main+0x90>
    120f:	b8 00 00 00 00       	mov    $0x0,%eax
    1214:	48 83 c4 18          	add    $0x18,%rsp
    1218:	c3                   	retq   
