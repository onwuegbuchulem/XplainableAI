...
/app/bin_gccgcc10_O1/2020_12_26-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1182:	48 8d 35 90 0e 00 00 	lea    0xe90(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    1189:	bf 01 00 00 00       	mov    $0x1,%edi
    118e:	b8 00 00 00 00       	mov    $0x0,%eax
    1193:	e8 d8 fe ff ff       	callq  1070 <__printf_chk@plt>
    1198:	ba 02 00 00 00       	mov    $0x2,%edx
    119d:	48 8d 35 7e 0e 00 00 	lea    0xe7e(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    ...
    11b8:	48 8d 35 6c 0e 00 00 	lea    0xe6c(%rip),%rsi        # 202b <_IO_stdin_used+0x2b>
    11bf:	bf 01 00 00 00       	mov    $0x1,%edi
    11c4:	b8 00 00 00 00       	mov    $0x0,%eax
    11c9:	e8 a2 fe ff ff       	callq  1070 <__printf_chk@plt>
    11ce:	ba 03 00 00 00       	mov    $0x3,%edx
    11d3:	48 8d 35 5a 0e 00 00 	lea    0xe5a(%rip),%rsi        # 2034 <_IO_stdin_used+0x34>
