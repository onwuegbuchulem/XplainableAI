...
/app/bin_gccgcc10_O1/ttt06:     file format elf64-x86-64
...
0000000000001517 <prompt>:
    ...
    1541:	48 8d 35 60 0b 00 00 	lea    0xb60(%rip),%rsi        # 20a8 <_IO_stdin_used+0xa8>
    ...
    15aa:	48 8d 35 1f 0b 00 00 	lea    0xb1f(%rip),%rsi        # 20d0 <_IO_stdin_used+0xd0>
...
00000000000015cc <computer>:
    ...
    1604:	48 8d 35 ed 0a 00 00 	lea    0xaed(%rip),%rsi        # 20f8 <_IO_stdin_used+0xf8>
...
000000000000161e <main>:
    ...
    16b0:	8b 54 24 0c          	mov    0xc(%rsp),%edx
    16b4:	b8 01 00 00 00       	mov    $0x1,%eax
    16b9:	83 fa 02             	cmp    $0x2,%edx
    16bc:	0f 87 fa 00 00 00    	ja     17bc <main+0x19e>
    16c2:	83 fa 01             	cmp    $0x1,%edx
    16c5:	74 0f                	je     16d6 <main+0xb8>
    16c7:	bb 00 00 00 00       	mov    $0x0,%ebx
    16cc:	48 8d 6c 24 10       	lea    0x10(%rsp),%rbp
    16d1:	e9 86 00 00 00       	jmpq   175c <main+0x13e>
    16d6:	48 8d 35 43 0a 00 00 	lea    0xa43(%rip),%rsi        # 2120 <_IO_stdin_used+0x120>
    16dd:	bf 01 00 00 00       	mov    $0x1,%edi
    16e2:	b8 00 00 00 00       	mov    $0x0,%eax
    16e7:	e8 24 fa ff ff       	callq  1110 <__printf_chk@plt>
    16ec:	e8 3f fa ff ff       	callq  1130 <rand@plt>
    16f1:	89 c1                	mov    %eax,%ecx
    16f3:	be 02 00 00 00       	mov    $0x2,%esi
    16f8:	99                   	cltd   
    16f9:	f7 fe                	idiv   %esi
    16fb:	41 89 d4             	mov    %edx,%r12d
    16fe:	f6 c1 01             	test   $0x1,%cl
    1701:	74 0e                	je     1711 <main+0xf3>
    1703:	48 8d 3d 6b 09 00 00 	lea    0x96b(%rip),%rdi        # 2075 <_IO_stdin_used+0x75>
    170a:	e8 b1 f9 ff ff       	callq  10c0 <puts@plt>
    170f:	eb b6                	jmp    16c7 <main+0xa9>
    1711:	48 8d 3d 6b 09 00 00 	lea    0x96b(%rip),%rdi        # 2083 <_IO_stdin_used+0x83>
    1718:	e8 a3 f9 ff ff       	callq  10c0 <puts@plt>
    171d:	eb a8                	jmp    16c7 <main+0xa9>
    171f:	48 89 ef             	mov    %rbp,%rdi
    1722:	e8 a5 fe ff ff       	callq  15cc <computer>
    1727:	85 c0                	test   %eax,%eax
    1729:	0f 84 83 00 00 00    	je     17b2 <main+0x194>
    172f:	89 da                	mov    %ebx,%edx
    1731:	83 e2 01             	and    $0x1,%edx
    1734:	83 fa 01             	cmp    $0x1,%edx
    1737:	19 d2                	sbb    %edx,%edx
    1739:	83 e2 02             	and    $0x2,%edx
    173c:	83 ea 01             	sub    $0x1,%edx
    173f:	83 e8 01             	sub    $0x1,%eax
    1742:	48 98                	cltq   
    1744:	89 54 84 10          	mov    %edx,0x10(%rsp,%rax,4)
    1748:	48 89 ef             	mov    %rbp,%rdi
    174b:	e8 df fc ff ff       	callq  142f <winner>
    1750:	85 c0                	test   %eax,%eax
    1752:	75 5e                	jne    17b2 <main+0x194>
    1754:	83 c3 01             	add    $0x1,%ebx
    1757:	83 fb 09             	cmp    $0x9,%ebx
    175a:	74 79                	je     17d5 <main+0x1b7>
    175c:	48 89 ef             	mov    %rbp,%rdi
    175f:	e8 c5 fa ff ff       	callq  1229 <showgrid>
    1764:	8b 44 24 0c          	mov    0xc(%rsp),%eax
    1768:	85 c0                	test   %eax,%eax
    176a:	74 b3                	je     171f <main+0x101>
    176c:	83 f8 01             	cmp    $0x1,%eax
    176f:	75 2d                	jne    179e <main+0x180>
    1771:	89 da                	mov    %ebx,%edx
    1773:	c1 ea 1f             	shr    $0x1f,%edx
    1776:	8d 04 13             	lea    (%rbx,%rdx,1),%eax
    1779:	83 e0 01             	and    $0x1,%eax
    177c:	29 d0                	sub    %edx,%eax
    177e:	44 39 e0             	cmp    %r12d,%eax
    1781:	74 11                	je     1794 <main+0x176>
    1783:	48 89 ee             	mov    %rbp,%rsi
    1786:	89 df                	mov    %ebx,%edi
    1788:	e8 8a fd ff ff       	callq  1517 <prompt>
    178d:	83 f8 ff             	cmp    $0xffffffff,%eax
    1790:	74 f1                	je     1783 <main+0x165>
    1792:	eb 93                	jmp    1727 <main+0x109>
    1794:	48 89 ef             	mov    %rbp,%rdi
    1797:	e8 30 fe ff ff       	callq  15cc <computer>
    179c:	eb 89                	jmp    1727 <main+0x109>
    179e:	48 89 ee             	mov    %rbp,%rsi
    17a1:	89 df                	mov    %ebx,%edi
    17a3:	e8 6f fd ff ff       	callq  1517 <prompt>
    17a8:	83 f8 ff             	cmp    $0xffffffff,%eax
    17ab:	74 f1                	je     179e <main+0x180>
    17ad:	e9 75 ff ff ff       	jmpq   1727 <main+0x109>
    17b2:	b8 00 00 00 00       	mov    $0x0,%eax
    17b7:	83 fb 09             	cmp    $0x9,%ebx
    17ba:	74 19                	je     17d5 <main+0x1b7>
    17bc:	48 8b 4c 24 38       	mov    0x38(%rsp),%rcx
    17c1:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    17c8:	00 00 
    17ca:	75 26                	jne    17f2 <main+0x1d4>
    17cc:	48 83 c4 40          	add    $0x40,%rsp
    17d0:	5b                   	pop    %rbx
    17d1:	5d                   	pop    %rbp
    17d2:	41 5c                	pop    %r12
    17d4:	c3                   	retq   
    17d5:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
    17da:	e8 4a fa ff ff       	callq  1229 <showgrid>
    17df:	48 8d 3d b6 08 00 00 	lea    0x8b6(%rip),%rdi        # 209c <_IO_stdin_used+0x9c>
    17e6:	e8 d5 f8 ff ff       	callq  10c0 <puts@plt>
    17eb:	b8 00 00 00 00       	mov    $0x0,%eax
    17f0:	eb ca                	jmp    17bc <main+0x19e>
    17f2:	e8 d9 f8 ff ff       	callq  10d0 <__stack_chk_fail@plt>
