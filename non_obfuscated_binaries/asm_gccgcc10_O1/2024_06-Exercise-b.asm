...
/app/bin_gccgcc10_O1/2024_06-Exercise-b:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11b3:	83 ff 02             	cmp    $0x2,%edi
    11b6:	7e 57                	jle    120f <main+0x66>
    11b8:	48 89 f3             	mov    %rsi,%rbx
    11bb:	48 8b 7e 08          	mov    0x8(%rsi),%rdi
    11bf:	ba 0a 00 00 00       	mov    $0xa,%edx
    11c4:	be 00 00 00 00       	mov    $0x0,%esi
    11c9:	e8 c2 fe ff ff       	callq  1090 <strtol@plt>
    11ce:	48 89 c5             	mov    %rax,%rbp
    11d1:	48 8b 7b 10          	mov    0x10(%rbx),%rdi
    11d5:	ba 0a 00 00 00       	mov    $0xa,%edx
    11da:	be 00 00 00 00       	mov    $0x0,%esi
    11df:	e8 ac fe ff ff       	callq  1090 <strtol@plt>
    11e4:	48 89 c1             	mov    %rax,%rcx
    11e7:	44 8d 04 28          	lea    (%rax,%rbp,1),%r8d
    11eb:	89 ea                	mov    %ebp,%edx
    11ed:	48 8d 35 21 0e 00 00 	lea    0xe21(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    11f4:	bf 01 00 00 00       	mov    $0x1,%edi
    11f9:	b8 00 00 00 00       	mov    $0x0,%eax
    11fe:	e8 9d fe ff ff       	callq  10a0 <__printf_chk@plt>
