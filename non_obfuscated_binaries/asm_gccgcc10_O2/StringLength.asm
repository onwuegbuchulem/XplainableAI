...
/app/bin_gccgcc10_O2/StringLength:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10b2:	48 83 ec 70          	sub    $0x70,%rsp
    10b6:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10bd:	00 00 
    10bf:	48 89 44 24 68       	mov    %rax,0x68(%rsp)
    10c4:	31 c0                	xor    %eax,%eax
    10c6:	49 89 e4             	mov    %rsp,%r12
    10c9:	e8 b2 ff ff ff       	callq  1080 <__printf_chk@plt>
    10ce:	31 c0                	xor    %eax,%eax
    10d0:	4c 89 e6             	mov    %r12,%rsi
    10d3:	48 8d 3d 69 0f 00 00 	lea    0xf69(%rip),%rdi        # 2043 <_IO_stdin_used+0x43>
    10da:	e8 b1 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10df:	80 3c 24 00          	cmpb   $0x0,(%rsp)
    10e3:	74 46                	je     112b <main+0x8b>
    10e5:	b8 01 00 00 00       	mov    $0x1,%eax
    10ea:	48 8d 54 24 ff       	lea    -0x1(%rsp),%rdx
    10ef:	90                   	nop
    10f0:	89 c1                	mov    %eax,%ecx
    10f2:	48 83 c0 01          	add    $0x1,%rax
    10f6:	80 3c 02 00          	cmpb   $0x0,(%rdx,%rax,1)
    10fa:	75 f4                	jne    10f0 <main+0x50>
    10fc:	31 c0                	xor    %eax,%eax
    10fe:	4c 89 e2             	mov    %r12,%rdx
    1101:	bf 01 00 00 00       	mov    $0x1,%edi
    1106:	48 8d 35 39 0f 00 00 	lea    0xf39(%rip),%rsi        # 2046 <_IO_stdin_used+0x46>
    110d:	e8 6e ff ff ff       	callq  1080 <__printf_chk@plt>
    1112:	48 8b 44 24 68       	mov    0x68(%rsp),%rax
    1117:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    111e:	00 00 
    1120:	75 0d                	jne    112f <main+0x8f>
    1122:	48 83 c4 70          	add    $0x70,%rsp
    1126:	31 c0                	xor    %eax,%eax
    1128:	41 5c                	pop    %r12
    112a:	c3                   	retq   
    112b:	31 c9                	xor    %ecx,%ecx
    112d:	eb cd                	jmp    10fc <main+0x5c>
    112f:	e8 3c ff ff ff       	callq  1070 <__stack_chk_fail@plt>
...
0000000000001230 <stringLength>:
    1230:	f3 0f 1e fa          	endbr64 
    1234:	80 3f 00             	cmpb   $0x0,(%rdi)
    1237:	74 1f                	je     1258 <stringLength+0x28>
    1239:	b8 01 00 00 00       	mov    $0x1,%eax
    123e:	66 90                	xchg   %ax,%ax
    1240:	41 89 c0             	mov    %eax,%r8d
    1243:	48 83 c0 01          	add    $0x1,%rax
    1247:	80 7c 07 ff 00       	cmpb   $0x0,-0x1(%rdi,%rax,1)
    124c:	75 f2                	jne    1240 <stringLength+0x10>
    124e:	44 89 c0             	mov    %r8d,%eax
    1251:	c3                   	retq   
    1252:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1258:	45 31 c0             	xor    %r8d,%r8d
    125b:	44 89 c0             	mov    %r8d,%eax
    125e:	c3                   	retq   
    125f:	90                   	nop
