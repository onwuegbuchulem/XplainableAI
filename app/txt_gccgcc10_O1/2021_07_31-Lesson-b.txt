...
/app/bin_gccgcc10_O1/2021_07_31-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bf:	75 1a                	jne    11db <main+0x52>
    11c1:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11c6:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11cd:	00 00 
    11cf:	75 25                	jne    11f6 <main+0x6d>
    11d1:	b8 00 00 00 00       	mov    $0x0,%eax
    11d6:	48 83 c4 18          	add    $0x18,%rsp
    11da:	c3                   	retq   
    11db:	8b 14 24             	mov    (%rsp),%edx
    11de:	48 8d 35 23 0e 00 00 	lea    0xe23(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    ...
    11f6:	e8 75 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
