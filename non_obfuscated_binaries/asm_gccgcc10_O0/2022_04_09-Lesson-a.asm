...
/app/bin_gccgcc10_O0/2022_04_09-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    118b:	48 89 45 b0          	mov    %rax,-0x50(%rbp)
    118f:	48 8d 05 74 0e 00 00 	lea    0xe74(%rip),%rax        # 200a <_IO_stdin_used+0xa>
    1196:	48 89 45 b8          	mov    %rax,-0x48(%rbp)
    119a:	48 8d 05 6d 0e 00 00 	lea    0xe6d(%rip),%rax        # 200e <_IO_stdin_used+0xe>
    11a1:	48 89 45 c0          	mov    %rax,-0x40(%rbp)
    11a5:	48 8d 05 68 0e 00 00 	lea    0xe68(%rip),%rax        # 2014 <_IO_stdin_used+0x14>
    11ac:	48 89 45 c8          	mov    %rax,-0x38(%rbp)
    11b0:	48 8d 05 64 0e 00 00 	lea    0xe64(%rip),%rax        # 201b <_IO_stdin_used+0x1b>
    11b7:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    11bb:	48 8d 05 5e 0e 00 00 	lea    0xe5e(%rip),%rax        # 2020 <_IO_stdin_used+0x20>
    11c2:	48 89 45 d8          	mov    %rax,-0x28(%rbp)
    11c6:	48 8d 05 5b 0e 00 00 	lea    0xe5b(%rip),%rax        # 2028 <_IO_stdin_used+0x28>
    11cd:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    11d1:	48 8d 05 55 0e 00 00 	lea    0xe55(%rip),%rax        # 202d <_IO_stdin_used+0x2d>
    11d8:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    11dc:	c7 45 ac 00 00 00 00 	movl   $0x0,-0x54(%rbp)
    11e3:	eb 37                	jmp    121c <main+0xb3>
    11e5:	8b 45 ac             	mov    -0x54(%rbp),%eax
    11e8:	48 98                	cltq   
    11ea:	48 8b 54 c5 b0       	mov    -0x50(%rbp,%rax,8),%rdx
    11ef:	8b 45 ac             	mov    -0x54(%rbp),%eax
    11f2:	8d 70 30             	lea    0x30(%rax),%esi
    11f5:	8b 45 ac             	mov    -0x54(%rbp),%eax
    11f8:	48 98                	cltq   
    11fa:	48 8b 44 c5 b0       	mov    -0x50(%rbp,%rax,8),%rax
    11ff:	48 89 d1             	mov    %rdx,%rcx
    1202:	89 f2                	mov    %esi,%edx
    1204:	48 89 c6             	mov    %rax,%rsi
    1207:	48 8d 3d 25 0e 00 00 	lea    0xe25(%rip),%rdi        # 2033 <_IO_stdin_used+0x33>
    120e:	b8 00 00 00 00       	mov    $0x0,%eax
    1213:	e8 58 fe ff ff       	callq  1070 <printf@plt>
    1218:	83 45 ac 01          	addl   $0x1,-0x54(%rbp)
    121c:	83 7d ac 07          	cmpl   $0x7,-0x54(%rbp)
    1220:	7e c3                	jle    11e5 <main+0x7c>
    1222:	b8 00 00 00 00       	mov    $0x0,%eax
    1227:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    122b:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1232:	00 00 
    1234:	74 05                	je     123b <main+0xd2>
    1236:	e8 25 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    123b:	c9                   	leaveq 
    123c:	c3                   	retq   
