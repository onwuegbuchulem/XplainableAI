...
/app/bin_gccgcc10_O1/2023_07_15-Lesson-a:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    1218:	e8 a3 fe ff ff       	callq  10c0 <malloc@plt>
    121d:	48 89 c3             	mov    %rax,%rbx
    1220:	bf 10 00 00 00       	mov    $0x10,%edi
    1225:	e8 96 fe ff ff       	callq  10c0 <malloc@plt>
    122a:	48 85 db             	test   %rbx,%rbx
    122d:	74 5c                	je     128b <main+0x82>
    122f:	48 89 c5             	mov    %rax,%rbp
    1232:	48 85 c0             	test   %rax,%rax
    1235:	74 54                	je     128b <main+0x82>
    1237:	c6 00 00             	movb   $0x0,(%rax)
    123a:	c6 03 00             	movb   $0x0,(%rbx)
    123d:	48 8d 35 d9 0d 00 00 	lea    0xdd9(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    1244:	bf 01 00 00 00       	mov    $0x1,%edi
    1249:	b8 00 00 00 00       	mov    $0x0,%eax
    124e:	e8 8d fe ff ff       	callq  10e0 <__printf_chk@plt>
    1253:	48 89 de             	mov    %rbx,%rsi
    1256:	48 8d 3d c7 0d 00 00 	lea    0xdc7(%rip),%rdi        # 2024 <_IO_stdin_used+0x24>
    125d:	b8 00 00 00 00       	mov    $0x0,%eax
    1262:	e8 89 fe ff ff       	callq  10f0 <__isoc99_scanf@plt>
    1267:	ba 10 00 00 00       	mov    $0x10,%edx
    126c:	48 89 de             	mov    %rbx,%rsi
    126f:	48 89 ef             	mov    %rbp,%rdi
    1272:	e8 59 fe ff ff       	callq  10d0 <__strcpy_chk@plt>
    1277:	48 89 ef             	mov    %rbp,%rdi
    127a:	e8 31 fe ff ff       	callq  10b0 <puts@plt>
    127f:	b8 00 00 00 00       	mov    $0x0,%eax
    1284:	48 83 c4 08          	add    $0x8,%rsp
    1288:	5b                   	pop    %rbx
    1289:	5d                   	pop    %rbp
    128a:	c3                   	retq   
    128b:	48 8b 0d 8e 2d 00 00 	mov    0x2d8e(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1292:	ba 18 00 00 00       	mov    $0x18,%edx
    1297:	be 01 00 00 00       	mov    $0x1,%esi
    129c:	48 8d 3d 61 0d 00 00 	lea    0xd61(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    12a3:	e8 68 fe ff ff       	callq  1110 <fwrite@plt>
    12a8:	bf 01 00 00 00       	mov    $0x1,%edi
    12ad:	e8 4e fe ff ff       	callq  1100 <exit@plt>
