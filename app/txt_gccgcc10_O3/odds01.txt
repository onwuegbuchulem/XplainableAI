...
/app/bin_gccgcc10_O3/odds01:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10cc:	48 8d 3d 48 0f 00 00 	lea    0xf48(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    10d3:	31 c0                	xor    %eax,%eax
    10d5:	e8 b6 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10da:	48 8d 35 3d 0f 00 00 	lea    0xf3d(%rip),%rsi        # 201e <_IO_stdin_used+0x1e>
    ...
    10f2:	48 8d 3d 22 0f 00 00 	lea    0xf22(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    10f9:	31 c0                	xor    %eax,%eax
    10fb:	e8 90 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    1100:	8b 14 24             	mov    (%rsp),%edx
    1103:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    1107:	66 0f ef c0          	pxor   %xmm0,%xmm0
    110b:	66 0f ef c9          	pxor   %xmm1,%xmm1
    110f:	48 8d 35 2a 0f 00 00 	lea    0xf2a(%rip),%rsi        # 2040 <_IO_stdin_used+0x40>
    1116:	bf 01 00 00 00       	mov    $0x1,%edi
    111b:	f3 0f 2a c2          	cvtsi2ss %edx,%xmm0
    111f:	8d 04 11             	lea    (%rcx,%rdx,1),%eax
    1122:	f3 0f 2a c8          	cvtsi2ss %eax,%xmm1
    1126:	b8 01 00 00 00       	mov    $0x1,%eax
    112b:	f3 0f 5e c1          	divss  %xmm1,%xmm0
    112f:	f3 0f 59 05 35 0f 00 	mulss  0xf35(%rip),%xmm0        # 206c <_IO_stdin_used+0x6c>
    1136:	00 
    1137:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    113b:	e8 40 ff ff ff       	callq  1080 <__printf_chk@plt>
    1140:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1145:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    114c:	00 00 
    114e:	75 07                	jne    1157 <main+0xb7>
    1150:	31 c0                	xor    %eax,%eax
    1152:	48 83 c4 18          	add    $0x18,%rsp
    1156:	c3                   	retq   
