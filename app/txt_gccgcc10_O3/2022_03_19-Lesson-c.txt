...
/app/bin_gccgcc10_O3/2022_03_19-Lesson-c:     file format elf64-x86-64
...
0000000000001040 <main>:
    ...
    1044:	c7 44 24 fc 00 00 00 	movl   $0x0,-0x4(%rsp)
    104b:	00 
    104c:	8b 44 24 fc          	mov    -0x4(%rsp),%eax
    1050:	83 f8 27             	cmp    $0x27,%eax
    1053:	7f 1b                	jg     1070 <main+0x30>
    1055:	0f 1f 00             	nopl   (%rax)
    1058:	8b 44 24 fc          	mov    -0x4(%rsp),%eax
    105c:	8b 44 24 fc          	mov    -0x4(%rsp),%eax
    1060:	83 c0 01             	add    $0x1,%eax
    1063:	89 44 24 fc          	mov    %eax,-0x4(%rsp)
    1067:	8b 44 24 fc          	mov    -0x4(%rsp),%eax
    106b:	83 f8 27             	cmp    $0x27,%eax
    106e:	7e e8                	jle    1058 <main+0x18>
    1070:	31 c0                	xor    %eax,%eax
    1072:	c3                   	retq   
    1073:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    107a:	00 00 00 
...
0000000000001170 <memzero>:
    1170:	f3 0f 1e fa          	endbr64 
    1174:	c7 44 24 fc 00 00 00 	movl   $0x0,-0x4(%rsp)
    117b:	00 
    117c:	8b 44 24 fc          	mov    -0x4(%rsp),%eax
    1180:	39 c6                	cmp    %eax,%esi
    1182:	7e 20                	jle    11a4 <memzero+0x34>
    1184:	0f 1f 40 00          	nopl   0x0(%rax)
    1188:	48 63 44 24 fc       	movslq -0x4(%rsp),%rax
    118d:	c6 04 07 00          	movb   $0x0,(%rdi,%rax,1)
    1191:	8b 44 24 fc          	mov    -0x4(%rsp),%eax
    1195:	83 c0 01             	add    $0x1,%eax
    1198:	89 44 24 fc          	mov    %eax,-0x4(%rsp)
    119c:	8b 44 24 fc          	mov    -0x4(%rsp),%eax
    11a0:	39 f0                	cmp    %esi,%eax
    11a2:	7c e4                	jl     1188 <memzero+0x18>
    11a4:	c3                   	retq   
