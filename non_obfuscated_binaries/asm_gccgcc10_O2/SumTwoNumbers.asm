...
/app/bin_gccgcc10_O2/SumTwoNumbers:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10cc:	48 8d 3d 61 0f 00 00 	lea    0xf61(%rip),%rdi        # 2034 <_IO_stdin_used+0x34>
    10d3:	31 c0                	xor    %eax,%eax
    10d5:	e8 b6 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10da:	48 8d 35 37 0f 00 00 	lea    0xf37(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    ...
    10f2:	48 8d 3d 3b 0f 00 00 	lea    0xf3b(%rip),%rdi        # 2034 <_IO_stdin_used+0x34>
    10f9:	31 c0                	xor    %eax,%eax
    10fb:	e8 90 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    1100:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1104:	31 c0                	xor    %eax,%eax
    1106:	03 14 24             	add    (%rsp),%edx
    1109:	48 8d 35 1d 0f 00 00 	lea    0xf1d(%rip),%rsi        # 202d <_IO_stdin_used+0x2d>
