...
/app/bin_gccgcc10_O0/08_quick_quiz:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    11ab:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    ...
    11c8:	48 8d 3d 38 0e 00 00 	lea    0xe38(%rip),%rdi        # 2007 <_IO_stdin_used+0x7>
    11cf:	b8 00 00 00 00       	mov    $0x0,%eax
    11d4:	e8 a7 fe ff ff       	callq  1080 <printf@plt>
    11d9:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    11dd:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11e0:	39 45 f4             	cmp    %eax,-0xc(%rbp)
    11e3:	7e de                	jle    11c3 <main+0x3a>
    11e5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ea:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11ee:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11f5:	00 00 
