...
/app/bin_gccgcc10_O1/A_To_Z_Loops:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1153:	bb 61 00 00 00       	mov    $0x61,%ebx
    ...
    1176:	83 fb 7b             	cmp    $0x7b,%ebx
    1179:	75 e4                	jne    115f <main+0x16>
    117b:	bb 41 00 00 00       	mov    $0x41,%ebx
    1180:	48 8d 2d 7d 0e 00 00 	lea    0xe7d(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1187:	89 da                	mov    %ebx,%edx
    ...
    119e:	83 fb 5b             	cmp    $0x5b,%ebx
    11a1:	75 e4                	jne    1187 <main+0x3e>
