...
/app/bin_gccgcc10_O1/2020_10_03-Lesson-b:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11d8:	e8 c3 fe ff ff       	callq  10a0 <ttyname@plt>
    11dd:	48 89 c5             	mov    %rax,%rbp
    11e0:	48 8d 35 1d 0e 00 00 	lea    0xe1d(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11e7:	48 89 c7             	mov    %rax,%rdi
    11ea:	e8 c1 fe ff ff       	callq  10b0 <fopen@plt>
    11ef:	48 85 c0             	test   %rax,%rax
    11f2:	74 33                	je     1227 <main+0x5e>
    11f4:	48 89 c3             	mov    %rax,%rbx
    11f7:	48 89 e9             	mov    %rbp,%rcx
    11fa:	48 8d 15 18 0e 00 00 	lea    0xe18(%rip),%rdx        # 2019 <_IO_stdin_used+0x19>
    1201:	be 01 00 00 00       	mov    $0x1,%esi
    1206:	48 89 c7             	mov    %rax,%rdi
    1209:	b8 00 00 00 00       	mov    $0x0,%eax
    120e:	e8 bd fe ff ff       	callq  10d0 <__fprintf_chk@plt>
    1213:	48 89 df             	mov    %rbx,%rdi
    1216:	e8 75 fe ff ff       	callq  1090 <fclose@plt>
    121b:	b8 00 00 00 00       	mov    $0x0,%eax
    1220:	48 83 c4 08          	add    $0x8,%rsp
    1224:	5b                   	pop    %rbx
    1225:	5d                   	pop    %rbp
    1226:	c3                   	retq   
    1227:	48 89 e9             	mov    %rbp,%rcx
    122a:	48 8d 15 d5 0d 00 00 	lea    0xdd5(%rip),%rdx        # 2006 <_IO_stdin_used+0x6>
    1231:	be 01 00 00 00       	mov    $0x1,%esi
    1236:	48 8b 3d e3 2d 00 00 	mov    0x2de3(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    123d:	b8 00 00 00 00       	mov    $0x0,%eax
    1242:	e8 89 fe ff ff       	callq  10d0 <__fprintf_chk@plt>
    1247:	bf 01 00 00 00       	mov    $0x1,%edi
    124c:	e8 6f fe ff ff       	callq  10c0 <exit@plt>
