...
/app/bin_gccgcc10_O0/struct_funct:     file format elf64-x86-64
...
0000000000001060 <__stack_chk_fail@plt>:
    ...
    1064:	f2 ff 25 55 2f 00 00 	bnd jmpq *0x2f55(%rip)        # 3fc0 <__stack_chk_fail@GLIBC_2.4>
    106b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001070 <printf@plt>:
    1070:	f3 0f 1e fa          	endbr64 
    1074:	f2 ff 25 4d 2f 00 00 	bnd jmpq *0x2f4d(%rip)        # 3fc8 <printf@GLIBC_2.2.5>
...
00000000000010b0 <deregister_tm_clones>:
    ...
    10c3:	48 8b 05 06 2f 00 00 	mov    0x2f06(%rip),%rax        # 3fd0 <_ITM_deregisterTMCloneTable>
...
0000000000001169 <main>:
    ...
    1184:	c7 45 f1 48 65 72 65 	movl   $0x65726548,-0xf(%rbp)
    118b:	66 c7 45 f5 73 79    	movw   $0x7973,-0xb(%rbp)
    1191:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    1195:	48 8d 45 f1          	lea    -0xf(%rbp),%rax
    1199:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    119d:	48 8b 05 34 2e 00 00 	mov    0x2e34(%rip),%rax        # 3fd8 <strlen@GLIBC_2.2.5>
    ...
    11b3:	ff d2                	callq  *%rdx
    11b5:	48 89 c2             	mov    %rax,%rdx
    11b8:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    11bc:	48 89 c6             	mov    %rax,%rsi
    11bf:	48 8d 3d 42 0e 00 00 	lea    0xe42(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11c6:	b8 00 00 00 00       	mov    $0x0,%eax
    11cb:	e8 a0 fe ff ff       	callq  1070 <printf@plt>
    11d0:	b8 00 00 00 00       	mov    $0x0,%eax
    11d5:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11d9:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11e0:	00 00 
    11e2:	74 05                	je     11e9 <main+0x80>
    11e4:	e8 77 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    11e9:	c9                   	leaveq 
    11ea:	c3                   	retq   
