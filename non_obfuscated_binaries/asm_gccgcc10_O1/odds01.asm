...
/app/bin_gccgcc10_O1/odds01:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b5:	48 8d 3d 5f 0e 00 00 	lea    0xe5f(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    11bc:	b8 00 00 00 00       	mov    $0x0,%eax
    11c1:	e8 ca fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c6:	48 8d 35 51 0e 00 00 	lea    0xe51(%rip),%rsi        # 201e <_IO_stdin_used+0x1e>
    ...
    11e1:	48 8d 3d 33 0e 00 00 	lea    0xe33(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    11e8:	b8 00 00 00 00       	mov    $0x0,%eax
    11ed:	e8 9e fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f2:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    11f6:	8b 14 24             	mov    (%rsp),%edx
    11f9:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11fd:	f3 0f 2a c2          	cvtsi2ss %edx,%xmm0
    1201:	8d 04 11             	lea    (%rcx,%rdx,1),%eax
    1204:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1208:	f3 0f 2a c8          	cvtsi2ss %eax,%xmm1
    120c:	f3 0f 5e c1          	divss  %xmm1,%xmm0
    1210:	f3 0f 59 05 54 0e 00 	mulss  0xe54(%rip),%xmm0        # 206c <_IO_stdin_used+0x6c>
    1217:	00 
    1218:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    121c:	48 8d 35 1d 0e 00 00 	lea    0xe1d(%rip),%rsi        # 2040 <_IO_stdin_used+0x40>
    1223:	bf 01 00 00 00       	mov    $0x1,%edi
    1228:	b8 01 00 00 00       	mov    $0x1,%eax
    122d:	e8 4e fe ff ff       	callq  1080 <__printf_chk@plt>
    1232:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1237:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    123e:	00 00 
    1240:	75 0a                	jne    124c <main+0xc3>
    1242:	b8 00 00 00 00       	mov    $0x0,%eax
    1247:	48 83 c4 18          	add    $0x18,%rsp
    124b:	c3                   	retq   
    124c:	e8 1f fe ff ff       	callq  1070 <__stack_chk_fail@plt>
