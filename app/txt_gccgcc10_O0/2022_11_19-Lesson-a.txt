...
/app/bin_gccgcc10_O0/2022_11_19-Lesson-a:     file format elf64-x86-64
...
0000000000001100 <_start>:
    ...
    1111:	50                   	push   %rax
    1112:	54                   	push   %rsp
    1113:	4c 8d 05 06 05 00 00 	lea    0x506(%rip),%r8        # 1620 <__libc_csu_fini>
    111a:	48 8d 0d 8f 04 00 00 	lea    0x48f(%rip),%rcx        # 15b0 <__libc_csu_init>
    1121:	48 8d 3d 01 04 00 00 	lea    0x401(%rip),%rdi        # 1529 <main>
...
00000000000011e9 <chess_board>:
    ...
    12d4:	48 8d 35 29 0d 00 00 	lea    0xd29(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    12db:	48 8d 3d 2b 0d 00 00 	lea    0xd2b(%rip),%rdi        # 200d <_IO_stdin_used+0xd>
    ...
    1300:	48 8d 35 0c 0d 00 00 	lea    0xd0c(%rip),%rsi        # 2013 <_IO_stdin_used+0x13>
    1307:	48 8d 3d ff 0c 00 00 	lea    0xcff(%rip),%rdi        # 200d <_IO_stdin_used+0xd>
    ...
    1333:	48 8d 35 d9 0c 00 00 	lea    0xcd9(%rip),%rsi        # 2013 <_IO_stdin_used+0x13>
    133a:	48 8d 3d cc 0c 00 00 	lea    0xccc(%rip),%rdi        # 200d <_IO_stdin_used+0xd>
    ...
    135c:	48 8d 35 a1 0c 00 00 	lea    0xca1(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1363:	48 8d 3d a3 0c 00 00 	lea    0xca3(%rip),%rdi        # 200d <_IO_stdin_used+0xd>
    ...
    1382:	48 8d 35 93 0c 00 00 	lea    0xc93(%rip),%rsi        # 201c <_IO_stdin_used+0x1c>
    1389:	48 8d 3d 91 0c 00 00 	lea    0xc91(%rip),%rdi        # 2021 <_IO_stdin_used+0x21>
...
0000000000001529 <main>:
    ...
    1531:	48 83 ec 40          	sub    $0x40,%rsp
    1535:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    153c:	00 00 
    153e:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1542:	31 c0                	xor    %eax,%eax
    1544:	bf 00 00 00 00       	mov    $0x0,%edi
    1549:	e8 92 fb ff ff       	callq  10e0 <time@plt>
    154e:	89 c7                	mov    %eax,%edi
    1550:	e8 7b fb ff ff       	callq  10d0 <srand@plt>
    1555:	e8 96 fb ff ff       	callq  10f0 <rand@plt>
    155a:	99                   	cltd   
    155b:	c1 ea 1a             	shr    $0x1a,%edx
    155e:	01 d0                	add    %edx,%eax
    1560:	83 e0 3f             	and    $0x3f,%eax
    1563:	29 d0                	sub    %edx,%eax
    1565:	89 45 cc             	mov    %eax,-0x34(%rbp)
    1568:	48 8d 55 d0          	lea    -0x30(%rbp),%rdx
    156c:	8b 45 cc             	mov    -0x34(%rbp),%eax
    156f:	48 89 d6             	mov    %rdx,%rsi
    1572:	89 c7                	mov    %eax,%edi
    1574:	e8 50 fe ff ff       	callq  13c9 <moveto>
    1579:	48 8d 55 d0          	lea    -0x30(%rbp),%rdx
    157d:	8b 45 cc             	mov    -0x34(%rbp),%eax
    1580:	48 89 d6             	mov    %rdx,%rsi
    1583:	89 c7                	mov    %eax,%edi
    1585:	e8 5f fc ff ff       	callq  11e9 <chess_board>
    158a:	b8 00 00 00 00       	mov    $0x0,%eax
    158f:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1593:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    159a:	00 00 
    159c:	74 05                	je     15a3 <main+0x7a>
    159e:	e8 0d fb ff ff       	callq  10b0 <__stack_chk_fail@plt>
    15a3:	c9                   	leaveq 
    15a4:	c3                   	retq   
