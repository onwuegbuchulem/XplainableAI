...
/app/bin_gccgcc10_O1/03_input:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a2:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx
    11a7:	48 89 de             	mov    %rbx,%rsi
    11aa:	48 8d 3d 53 0e 00 00 	lea    0xe53(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11b1:	e8 da fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11b6:	48 89 da             	mov    %rbx,%rdx
    ...
    11ca:	e8 b1 fe ff ff       	callq  1080 <__printf_chk@plt>
    11cf:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11d4:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11db:	00 00 
    11dd:	75 0b                	jne    11ea <main+0x61>
    11df:	b8 00 00 00 00       	mov    $0x0,%eax
    11e4:	48 83 c4 10          	add    $0x10,%rsp
    11e8:	5b                   	pop    %rbx
    11e9:	c3                   	retq   
    11ea:	e8 81 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    11ef:	90                   	nop
