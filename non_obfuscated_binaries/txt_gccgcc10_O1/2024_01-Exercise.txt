...
/app/bin_gccgcc10_O1/2024_01-Exercise:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d c6 00 00 00 	lea    0xc6(%rip),%rdi        # 114e <main>
...
000000000000114e <main>:
    ...
    1152:	48 83 ec 08          	sub    $0x8,%rsp
    1156:	b9 0a 00 00 00       	mov    $0xa,%ecx
    115b:	ba 05 00 00 00       	mov    $0x5,%edx
    1160:	48 8d 35 9d 0e 00 00 	lea    0xe9d(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1167:	bf 01 00 00 00       	mov    $0x1,%edi
    116c:	b8 00 00 00 00       	mov    $0x0,%eax
    1171:	e8 da fe ff ff       	callq  1050 <__printf_chk@plt>
    1176:	b9 0a 00 00 00       	mov    $0xa,%ecx
    117b:	ba 05 00 00 00       	mov    $0x5,%edx
    1180:	48 8d 35 96 0e 00 00 	lea    0xe96(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    1187:	bf 01 00 00 00       	mov    $0x1,%edi
    118c:	b8 00 00 00 00       	mov    $0x0,%eax
    1191:	e8 ba fe ff ff       	callq  1050 <__printf_chk@plt>
