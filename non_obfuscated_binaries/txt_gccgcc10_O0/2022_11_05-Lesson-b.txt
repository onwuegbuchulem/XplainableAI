...
/app/bin_gccgcc10_O0/2022_11_05-Lesson-b:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c6:	e8 e5 fe ff ff       	callq  10b0 <rand@plt>
    11cb:	99                   	cltd   
    11cc:	c1 ea 1a             	shr    $0x1a,%edx
    11cf:	01 d0                	add    %edx,%eax
    11d1:	83 e0 3f             	and    $0x3f,%eax
    11d4:	29 d0                	sub    %edx,%eax
    ...
    11ea:	e8 91 fe ff ff       	callq  1080 <printf@plt>
    ...
    11fd:	89 45 f8             	mov    %eax,-0x8(%rbp)
    1200:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1203:	2b 45 f8             	sub    -0x8(%rbp),%eax
    1206:	8d 50 07             	lea    0x7(%rax),%edx
    1209:	85 c0                	test   %eax,%eax
    120b:	0f 48 c2             	cmovs  %edx,%eax
    120e:	c1 f8 03             	sar    $0x3,%eax
    1211:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1214:	8b 55 f8             	mov    -0x8(%rbp),%edx
    1217:	8b 45 fc             	mov    -0x4(%rbp),%eax
    121a:	89 c6                	mov    %eax,%esi
    121c:	48 8d 3d fd 0d 00 00 	lea    0xdfd(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    1223:	b8 00 00 00 00       	mov    $0x0,%eax
    1228:	e8 53 fe ff ff       	callq  1080 <printf@plt>
