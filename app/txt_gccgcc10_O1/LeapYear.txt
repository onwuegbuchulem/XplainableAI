...
/app/bin_gccgcc10_O1/LeapYear:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b7:	48 8d 3d 56 0e 00 00 	lea    0xe56(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11cc:	f6 c2 03             	test   $0x3,%dl
    11cf:	75 30                	jne    1201 <main+0x78>
    11d1:	48 8d 35 3f 0e 00 00 	lea    0xe3f(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    11d8:	bf 01 00 00 00       	mov    $0x1,%edi
    11dd:	b8 00 00 00 00       	mov    $0x0,%eax
    11e2:	e8 99 fe ff ff       	callq  1080 <__printf_chk@plt>
    11e7:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11ec:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f3:	00 00 
    11f5:	75 22                	jne    1219 <main+0x90>
    11f7:	b8 00 00 00 00       	mov    $0x0,%eax
    11fc:	48 83 c4 18          	add    $0x18,%rsp
    1200:	c3                   	retq   
    1201:	48 8d 35 22 0e 00 00 	lea    0xe22(%rip),%rsi        # 202a <_IO_stdin_used+0x2a>
    1208:	bf 01 00 00 00       	mov    $0x1,%edi
    120d:	b8 00 00 00 00       	mov    $0x0,%eax
    1212:	e8 69 fe ff ff       	callq  1080 <__printf_chk@plt>
    1217:	eb ce                	jmp    11e7 <main+0x5e>
