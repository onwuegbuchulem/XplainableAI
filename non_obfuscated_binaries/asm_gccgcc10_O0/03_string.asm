...
/app/bin_gccgcc10_O0/03_string:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	48 b8 67 72 65 65 74 	movabs $0x676e697465657267,%rax
    118b:	69 6e 67 
    118e:	48 ba 73 2c 20 68 75 	movabs $0x6e616d7568202c73,%rdx
    1195:	6d 61 6e 
    1198:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    119c:	48 89 55 e8          	mov    %rdx,-0x18(%rbp)
    11a0:	66 c7 45 dd 7f 81    	movw   $0x817f,-0x23(%rbp)
    11a6:	c6 45 df ff          	movb   $0xff,-0x21(%rbp)
    11aa:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11ae:	48 89 c7             	mov    %rax,%rdi
    11b1:	e8 aa fe ff ff       	callq  1060 <puts@plt>
    11b6:	b8 00 00 00 00       	mov    $0x0,%eax
    11bb:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11bf:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11c6:	00 00 
    11c8:	74 05                	je     11cf <main+0x66>
    11ca:	e8 a1 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    11cf:	c9                   	leaveq 
    11d0:	c3                   	retq   
