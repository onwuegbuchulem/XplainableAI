...
/app/bin_gccgcc10_O3/dynamicMemoryAllocation:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	41 54                	push   %r12
    10a6:	bf 00 01 00 00       	mov    $0x100,%edi
    10ab:	e8 d0 ff ff ff       	callq  1080 <malloc@plt>
    10b0:	ba 01 00 00 00       	mov    $0x1,%edx
    10b5:	be 00 01 00 00       	mov    $0x100,%esi
    10ba:	4c 8d 0d 43 0f 00 00 	lea    0xf43(%rip),%r9        # 2004 <_IO_stdin_used+0x4>
    10c1:	49 89 c4             	mov    %rax,%r12
    10c4:	48 89 c7             	mov    %rax,%rdi
    10c7:	b9 00 01 00 00       	mov    $0x100,%ecx
    10cc:	31 c0                	xor    %eax,%eax
    10ce:	4c 8d 05 3b 0f 00 00 	lea    0xf3b(%rip),%r8        # 2010 <_IO_stdin_used+0x10>
    10d5:	e8 96 ff ff ff       	callq  1070 <__snprintf_chk@plt>
    10da:	4c 89 e2             	mov    %r12,%rdx
    10dd:	bf 01 00 00 00       	mov    $0x1,%edi
    10e2:	31 c0                	xor    %eax,%eax
    10e4:	48 8d 35 30 0f 00 00 	lea    0xf30(%rip),%rsi        # 201b <_IO_stdin_used+0x1b>
    10eb:	41 5c                	pop    %r12
    10ed:	e9 9e ff ff ff       	jmpq   1090 <__printf_chk@plt>
