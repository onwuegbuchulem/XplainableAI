...
/app/bin_gccgcc10_O0/2022_09_17-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1175:	c7 45 f0 09 00 00 00 	movl   $0x9,-0x10(%rbp)
    117c:	c7 45 f4 64 00 00 00 	movl   $0x64,-0xc(%rbp)
    1183:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%rbp)
    118a:	8b 45 f4             	mov    -0xc(%rbp),%eax
    118d:	89 45 ec             	mov    %eax,-0x14(%rbp)
    1190:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1193:	99                   	cltd   
    1194:	f7 7d f0             	idivl  -0x10(%rbp)
    1197:	83 c0 01             	add    $0x1,%eax
    119a:	89 45 f8             	mov    %eax,-0x8(%rbp)
    119d:	eb 74                	jmp    1213 <main+0xaa>
    119f:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%rbp)
    11a6:	eb 52                	jmp    11fa <main+0x91>
    11a8:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11ab:	0f af 45 f8          	imul   -0x8(%rbp),%eax
    ...
    11bc:	3b 45 f4             	cmp    -0xc(%rbp),%eax
    11bf:	7d 20                	jge    11e1 <main+0x78>
    ...
    11d7:	83 6d ec 01          	subl   $0x1,-0x14(%rbp)
    11db:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
    11df:	74 23                	je     1204 <main+0x9b>
    11e1:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11e4:	83 e8 01             	sub    $0x1,%eax
    11e7:	39 45 e8             	cmp    %eax,-0x18(%rbp)
    11ea:	7d 0a                	jge    11f6 <main+0x8d>
    11ec:	bf 09 00 00 00       	mov    $0x9,%edi
    11f1:	e8 6a fe ff ff       	callq  1060 <putchar@plt>
    11f6:	83 45 e8 01          	addl   $0x1,-0x18(%rbp)
    11fa:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11fd:	3b 45 f0             	cmp    -0x10(%rbp),%eax
    1200:	7c a6                	jl     11a8 <main+0x3f>
    1202:	eb 01                	jmp    1205 <main+0x9c>
    1204:	90                   	nop
    1205:	83 45 e4 01          	addl   $0x1,-0x1c(%rbp)
    1209:	bf 0a 00 00 00       	mov    $0xa,%edi
    120e:	e8 4d fe ff ff       	callq  1060 <putchar@plt>
    1213:	8b 45 e4             	mov    -0x1c(%rbp),%eax
    1216:	3b 45 f8             	cmp    -0x8(%rbp),%eax
    1219:	7c 84                	jl     119f <main+0x36>
