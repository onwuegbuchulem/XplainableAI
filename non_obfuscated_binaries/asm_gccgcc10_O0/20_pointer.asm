...
/app/bin_gccgcc10_O0/20_pointer:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d db 00 00 00 	lea    0xdb(%rip),%rdi        # 1163 <main>
...
0000000000001163 <main>:
    ...
    1192:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1196:	48 89 c7             	mov    %rax,%rdi
    1199:	e8 ab ff ff ff       	callq  1149 <modify>
    119e:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11a2:	48 89 c6             	mov    %rax,%rsi
    11a5:	48 8d 3d 68 0e 00 00 	lea    0xe68(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
