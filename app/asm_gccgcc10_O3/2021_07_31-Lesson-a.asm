...
/app/bin_gccgcc10_O3/2021_07_31-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10d4:	8b 14 24             	mov    (%rsp),%edx
    10d7:	31 c0                	xor    %eax,%eax
    10d9:	bf 01 00 00 00       	mov    $0x1,%edi
    10de:	48 8d 35 22 0f 00 00 	lea    0xf22(%rip),%rsi        # 2007 <_IO_stdin_used+0x7>
    10e5:	e8 a6 ff ff ff       	callq  1090 <__printf_chk@plt>
    10ea:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10ef:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10f6:	00 00 
    10f8:	75 07                	jne    1101 <main+0x61>
    10fa:	31 c0                	xor    %eax,%eax
    10fc:	48 83 c4 18          	add    $0x18,%rsp
    1100:	c3                   	retq   
    1101:	e8 6a ff ff ff       	callq  1070 <__stack_chk_fail@plt>
