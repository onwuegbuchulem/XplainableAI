...
/app/bin_gccgcc10_O0/06_swap:     file format elf64-x86-64
...
000000000000119a <main>:
    ...
    11a6:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11ad:	00 00 
    11af:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11b3:	31 c0                	xor    %eax,%eax
    11b5:	c7 45 f0 04 00 00 00 	movl   $0x4,-0x10(%rbp)
    11bc:	c7 45 f4 06 00 00 00 	movl   $0x6,-0xc(%rbp)
    11c3:	48 8d 55 f4          	lea    -0xc(%rbp),%rdx
    11c7:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    11cb:	48 89 d6             	mov    %rdx,%rsi
    11ce:	48 89 c7             	mov    %rax,%rdi
    11d1:	e8 93 ff ff ff       	callq  1169 <swap>
    11d6:	8b 55 f4             	mov    -0xc(%rbp),%edx
    ...
    11f4:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11f8:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11ff:	00 00 
    1201:	74 05                	je     1208 <main+0x6e>
    1203:	e8 58 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    1208:	c9                   	leaveq 
    1209:	c3                   	retq   
