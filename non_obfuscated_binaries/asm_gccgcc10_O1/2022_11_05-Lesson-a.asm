...
/app/bin_gccgcc10_O1/2022_11_05-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    116f:	55                   	push   %rbp
    1170:	53                   	push   %rbx
    1171:	b9 00 00 00 00       	mov    $0x0,%ecx
    1176:	ba 00 00 00 00       	mov    $0x0,%edx
    ...
    1191:	bd 00 00 00 00       	mov    $0x0,%ebp
    1196:	4c 8d 25 67 0e 00 00 	lea    0xe67(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    119d:	83 c5 01             	add    $0x1,%ebp
    11a0:	83 fd 40             	cmp    $0x40,%ebp
    11a3:	74 4a                	je     11ef <main+0x86>
    11a5:	89 e8                	mov    %ebp,%eax
    11a7:	c1 f8 1f             	sar    $0x1f,%eax
    11aa:	c1 e8 1d             	shr    $0x1d,%eax
    11ad:	8d 5c 05 00          	lea    0x0(%rbp,%rax,1),%ebx
    11b1:	83 e3 07             	and    $0x7,%ebx
    11b4:	29 c3                	sub    %eax,%ebx
    11b6:	89 e8                	mov    %ebp,%eax
    11b8:	29 d8                	sub    %ebx,%eax
    11ba:	8d 50 07             	lea    0x7(%rax),%edx
    11bd:	0f 49 d0             	cmovns %eax,%edx
    11c0:	c1 fa 03             	sar    $0x3,%edx
    11c3:	89 d9                	mov    %ebx,%ecx
    11c5:	4c 89 e6             	mov    %r12,%rsi
    11c8:	bf 01 00 00 00       	mov    $0x1,%edi
    11cd:	b8 00 00 00 00       	mov    $0x0,%eax
    11d2:	e8 99 fe ff ff       	callq  1070 <__printf_chk@plt>
    11d7:	83 fb 07             	cmp    $0x7,%ebx
    11da:	75 c1                	jne    119d <main+0x34>
    11dc:	48 8b 35 2d 2e 00 00 	mov    0x2e2d(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11e3:	bf 0a 00 00 00       	mov    $0xa,%edi
    11e8:	e8 73 fe ff ff       	callq  1060 <putc@plt>
    11ed:	eb ae                	jmp    119d <main+0x34>
