...
/app/bin_gccgcc10_O1/2023_03_25-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119c:	00 00 
    119e:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11a3:	31 c0                	xor    %eax,%eax
    11a5:	48 89 e7             	mov    %rsp,%rdi
    11a8:	e8 d3 fe ff ff       	callq  1080 <time@plt>
    11ad:	4c 8b 24 24          	mov    (%rsp),%r12
    11b1:	48 89 e5             	mov    %rsp,%rbp
    11b4:	48 89 ef             	mov    %rbp,%rdi
    11b7:	e8 c4 fe ff ff       	callq  1080 <time@plt>
    11bc:	48 8b 1c 24          	mov    (%rsp),%rbx
    11c0:	4c 39 e3             	cmp    %r12,%rbx
    11c3:	74 ef                	je     11b4 <main+0x2b>
    11c5:	bd 00 00 00 00       	mov    $0x0,%ebp
    11ca:	49 89 e4             	mov    %rsp,%r12
    11cd:	48 83 c5 01          	add    $0x1,%rbp
    11d1:	4c 89 e7             	mov    %r12,%rdi
    11d4:	e8 a7 fe ff ff       	callq  1080 <time@plt>
    11d9:	48 3b 1c 24          	cmp    (%rsp),%rbx
    11dd:	74 ee                	je     11cd <main+0x44>
    11df:	48 89 ea             	mov    %rbp,%rdx
    ...
    11f3:	e8 98 fe ff ff       	callq  1090 <__printf_chk@plt>
    11f8:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11fd:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1204:	00 00 
    1206:	75 0e                	jne    1216 <main+0x8d>
    1208:	b8 00 00 00 00       	mov    $0x0,%eax
    120d:	48 83 c4 10          	add    $0x10,%rsp
    1211:	5b                   	pop    %rbx
    1212:	5d                   	pop    %rbp
    1213:	41 5c                	pop    %r12
    1215:	c3                   	retq   
    1216:	e8 55 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
