...
/app/bin_gccgcc10_O0/SwapWithOnlyTwoNumbers:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 3d 4f 0e 00 00 	lea    0xe4f(%rip),%rdi        # 2012 <_IO_stdin_used+0x12>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	e8 c3 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cd:	48 8d 3d 41 0e 00 00 	lea    0xe41(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    ...
    11e5:	48 8d 3d 26 0e 00 00 	lea    0xe26(%rip),%rdi        # 2012 <_IO_stdin_used+0x12>
    ...
    1204:	8b 55 f4             	mov    -0xc(%rbp),%edx
    1207:	29 d0                	sub    %edx,%eax
    1209:	89 45 f4             	mov    %eax,-0xc(%rbp)
    120c:	8b 45 f0             	mov    -0x10(%rbp),%eax
    120f:	8b 55 f4             	mov    -0xc(%rbp),%edx
    1212:	29 d0                	sub    %edx,%eax
    1214:	89 45 f0             	mov    %eax,-0x10(%rbp)
    1217:	8b 55 f4             	mov    -0xc(%rbp),%edx
    121a:	8b 45 f0             	mov    -0x10(%rbp),%eax
    121d:	89 c6                	mov    %eax,%esi
    121f:	48 8d 3d fa 0d 00 00 	lea    0xdfa(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
