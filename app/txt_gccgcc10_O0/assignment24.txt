...
/app/bin_gccgcc10_O0/assignment24:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1175:	ba c0 01 00 00       	mov    $0x1c0,%edx
    117a:	be 41 00 00 00       	mov    $0x41,%esi
    117f:	48 8d 3d 7e 0e 00 00 	lea    0xe7e(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1186:	b8 00 00 00 00       	mov    $0x0,%eax
    118b:	e8 e0 fe ff ff       	callq  1070 <open@plt>
    1190:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1193:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    1197:	79 18                	jns    11b1 <main+0x48>
    1199:	48 8d 3d 71 0e 00 00 	lea    0xe71(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    11a0:	b8 00 00 00 00       	mov    $0x0,%eax
    11a5:	e8 b6 fe ff ff       	callq  1060 <printf@plt>
    11aa:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    11af:	eb 16                	jmp    11c7 <main+0x5e>
    11b1:	48 8d 3d 76 0e 00 00 	lea    0xe76(%rip),%rdi        # 202e <_IO_stdin_used+0x2e>
    11b8:	b8 00 00 00 00       	mov    $0x0,%eax
    11bd:	e8 9e fe ff ff       	callq  1060 <printf@plt>
