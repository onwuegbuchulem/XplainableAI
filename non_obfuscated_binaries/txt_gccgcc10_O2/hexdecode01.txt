...
/app/bin_gccgcc10_O2/hexdecode01:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a6:	55                   	push   %rbp
    10a7:	53                   	push   %rbx
    10a8:	48 83 ec 40          	sub    $0x40,%rsp
    10ac:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10b3:	00 00 
    10b5:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    10ba:	31 c0                	xor    %eax,%eax
    10bc:	48 89 e5             	mov    %rsp,%rbp
    10bf:	48 89 eb             	mov    %rbp,%rbx
    10c2:	45 31 e4             	xor    %r12d,%r12d
    10c5:	eb 23                	jmp    10ea <main+0x4a>
    10c7:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    10ce:	00 00 
    10d0:	88 03                	mov    %al,(%rbx)
    10d2:	89 c1                	mov    %eax,%ecx
    10d4:	41 8d 54 24 01       	lea    0x1(%r12),%edx
    10d9:	48 83 c3 01          	add    $0x1,%rbx
    10dd:	83 f8 0a             	cmp    $0xa,%eax
    10e0:	74 3e                	je     1120 <main+0x80>
    10e2:	83 fa 37             	cmp    $0x37,%edx
    10e5:	74 39                	je     1120 <main+0x80>
    10e7:	4c 63 e2             	movslq %edx,%r12
    10ea:	48 8b 3d 1f 2f 00 00 	mov    0x2f1f(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    10f1:	e8 9a ff ff ff       	callq  1090 <getc@plt>
    10f6:	83 f8 ff             	cmp    $0xffffffff,%eax
    10f9:	75 d5                	jne    10d0 <main+0x30>
    10fb:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1100:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1107:	00 00 
    1109:	75 32                	jne    113d <main+0x9d>
    110b:	48 83 c4 40          	add    $0x40,%rsp
    ...
    111d:	00 00 00 
    1120:	80 f9 0a             	cmp    $0xa,%cl
    1123:	74 11                	je     1136 <main+0x96>
    1125:	48 63 d2             	movslq %edx,%rdx
    1128:	c6 04 14 00          	movb   $0x0,(%rsp,%rdx,1)
    112c:	48 89 ef             	mov    %rbp,%rdi
    112f:	e8 3c ff ff ff       	callq  1070 <puts@plt>
    1134:	eb 89                	jmp    10bf <main+0x1f>
    1136:	42 c6 04 24 00       	movb   $0x0,(%rsp,%r12,1)
    113b:	eb ef                	jmp    112c <main+0x8c>
    113d:	e8 3e ff ff ff       	callq  1080 <__stack_chk_fail@plt>
