...
/app/bin_gccgcc10_O2/2019_03_09-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	55                   	push   %rbp
    10a5:	ba 20 00 00 00       	mov    $0x20,%edx
    10aa:	be 01 00 00 00       	mov    $0x1,%esi
    10af:	48 8d 0d 4e 0f 00 00 	lea    0xf4e(%rip),%rcx        # 2004 <_IO_stdin_used+0x4>
    10b6:	48 83 ec 50          	sub    $0x50,%rsp
    10ba:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10c1:	00 00 
    10c3:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    10c8:	48 b8 4d 79 20 6e 61 	movabs $0x20656d616e20794d,%rax
    10cf:	6d 65 20 
    10d2:	48 8d 6c 24 20       	lea    0x20(%rsp),%rbp
    10d7:	4c 8d 4c 24 0d       	lea    0xd(%rsp),%r9
    10dc:	c7 44 24 1a 69 73 20 	movl   $0x25207369,0x1a(%rsp)
    10e3:	25 
    10e4:	48 89 ef             	mov    %rbp,%rdi
    10e7:	4c 8d 44 24 12       	lea    0x12(%rsp),%r8
    10ec:	c6 44 24 11 00       	movb   $0x0,0x11(%rsp)
    10f1:	c7 44 24 0d 20 25 73 	movl   $0xa732520,0xd(%rsp)
    10f8:	0a 
    10f9:	48 89 44 24 12       	mov    %rax,0x12(%rsp)
    10fe:	b8 73 00 00 00       	mov    $0x73,%eax
    1103:	66 89 44 24 1e       	mov    %ax,0x1e(%rsp)
    1108:	31 c0                	xor    %eax,%eax
    110a:	e8 81 ff ff ff       	callq  1090 <__sprintf_chk@plt>
    110f:	31 c0                	xor    %eax,%eax
    1111:	48 89 ee             	mov    %rbp,%rsi
    1114:	bf 01 00 00 00       	mov    $0x1,%edi
    1119:	48 8d 0d e9 0e 00 00 	lea    0xee9(%rip),%rcx        # 2009 <_IO_stdin_used+0x9>
    1120:	48 8d 15 e9 0e 00 00 	lea    0xee9(%rip),%rdx        # 2010 <_IO_stdin_used+0x10>
    1127:	e8 54 ff ff ff       	callq  1080 <__printf_chk@plt>
    112c:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    1131:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1138:	00 00 
    113a:	75 08                	jne    1144 <main+0xa4>
    113c:	48 83 c4 50          	add    $0x50,%rsp
