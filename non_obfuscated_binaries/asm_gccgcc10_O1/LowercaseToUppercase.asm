...
/app/bin_gccgcc10_O1/LowercaseToUppercase:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d2:	48 8d 3d 5e 0e 00 00 	lea    0xe5e(%rip),%rdi        # 2037 <_IO_stdin_used+0x37>
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	e8 cd fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e3:	0f be 54 24 07       	movsbl 0x7(%rsp),%edx
    11e8:	83 ea 20             	sub    $0x20,%edx
    11eb:	48 8d 35 30 0e 00 00 	lea    0xe30(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    ...
    120d:	00 00 
    120f:	75 0a                	jne    121b <main+0x72>
    1211:	b8 00 00 00 00       	mov    $0x0,%eax
    1216:	48 83 c4 18          	add    $0x18,%rsp
    121a:	c3                   	retq   
    121b:	e8 70 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
