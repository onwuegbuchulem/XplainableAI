...
/app/bin_gccgcc10_O0/03_input:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 45 f4          	lea    -0xc(%rbp),%rax
    ...
    11cf:	e8 ac fe ff ff       	callq  1080 <printf@plt>
    11d4:	b8 00 00 00 00       	mov    $0x0,%eax
    11d9:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11dd:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11e4:	00 00 
    11e6:	74 05                	je     11ed <main+0x64>
