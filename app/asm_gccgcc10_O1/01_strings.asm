...
/app/bin_gccgcc10_O1/01_strings:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1185:	c7 44 24 04 61 62 63 	movl   $0x636261,0x4(%rsp)
    118c:	00 
    118d:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx
    1192:	4c 8d 64 24 07       	lea    0x7(%rsp),%r12
    1197:	48 8d 2d 66 0e 00 00 	lea    0xe66(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    119e:	0f be 13             	movsbl (%rbx),%edx
    ...
    11b3:	48 83 c3 01          	add    $0x1,%rbx
    11b7:	4c 39 e3             	cmp    %r12,%rbx
    11ba:	75 e2                	jne    119e <main+0x35>
    11bc:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11c1:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11c8:	00 00 
    11ca:	75 0e                	jne    11da <main+0x71>
    11cc:	b8 00 00 00 00       	mov    $0x0,%eax
    11d1:	48 83 c4 10          	add    $0x10,%rsp
    11d5:	5b                   	pop    %rbx
    11d6:	5d                   	pop    %rbp
    11d7:	41 5c                	pop    %r12
    11d9:	c3                   	retq   
    11da:	e8 81 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    11df:	90                   	nop
