...
/app/bin_gccgcc10_O2/byte_values02:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1086:	55                   	push   %rbp
    1087:	53                   	push   %rbx
    1088:	48 81 ec 10 01 00 00 	sub    $0x110,%rsp
    108f:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1096:	00 00 
    1098:	48 89 84 24 08 01 00 	mov    %rax,0x108(%rsp)
    109f:	00 
    10a0:	31 c0                	xor    %eax,%eax
    10a2:	48 89 e3             	mov    %rsp,%rbx
    10a5:	0f 1f 00             	nopl   (%rax)
    10a8:	88 04 03             	mov    %al,(%rbx,%rax,1)
    10ab:	48 83 c0 01          	add    $0x1,%rax
    10af:	48 3d 00 01 00 00    	cmp    $0x100,%rax
    10b5:	75 f1                	jne    10a8 <main+0x28>
    10b7:	4c 8d a4 24 00 01 00 	lea    0x100(%rsp),%r12
    10be:	00 
    10bf:	48 8d 2d 3e 0f 00 00 	lea    0xf3e(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    10c6:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10cd:	00 00 00 
    10d0:	0f b6 13             	movzbl (%rbx),%edx
    10d3:	48 89 ee             	mov    %rbp,%rsi
    10d6:	bf 01 00 00 00       	mov    $0x1,%edi
    10db:	31 c0                	xor    %eax,%eax
    10dd:	48 83 c3 01          	add    $0x1,%rbx
    10e1:	e8 8a ff ff ff       	callq  1070 <__printf_chk@plt>
    10e6:	4c 39 e3             	cmp    %r12,%rbx
    10e9:	75 e5                	jne    10d0 <main+0x50>
    10eb:	48 8b 84 24 08 01 00 	mov    0x108(%rsp),%rax
    10f2:	00 
    10f3:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10fa:	00 00 
    10fc:	75 0e                	jne    110c <main+0x8c>
    10fe:	48 81 c4 10 01 00 00 	add    $0x110,%rsp
