...
/app/bin_gccgcc10_O0/2023_05_13-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b0:	e8 bb fe ff ff       	callq  1070 <clock_gettime@plt>
    11b5:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    11b9:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    11bd:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11c1:	48 89 c6             	mov    %rax,%rsi
    11c4:	bf 00 00 00 00       	mov    $0x0,%edi
    11c9:	e8 a2 fe ff ff       	callq  1070 <clock_gettime@plt>
    11ce:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    11d2:	48 89 45 d8          	mov    %rax,-0x28(%rbp)
    11d6:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    11da:	48 2b 45 d0          	sub    -0x30(%rbp),%rax
    ...
    11ed:	e8 9e fe ff ff       	callq  1090 <printf@plt>
    11f2:	b8 00 00 00 00       	mov    $0x0,%eax
    11f7:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11fb:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1202:	00 00 
    1204:	74 05                	je     120b <main+0x82>
    1206:	e8 75 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    120b:	c9                   	leaveq 
    120c:	c3                   	retq   
