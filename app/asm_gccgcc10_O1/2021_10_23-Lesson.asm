...
/app/bin_gccgcc10_O1/2021_10_23-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1181:	48 b8 48 65 6c 6c 6f 	movabs $0x540a216f6c6c6548,%rax
    1188:	21 0a 54 
    118b:	48 ba 68 69 73 20 69 	movabs $0x6120736920736968,%rdx
    1192:	73 20 61 
    1195:	48 89 04 24          	mov    %rax,(%rsp)
    1199:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    119e:	48 b8 20 6c 6f 6e 67 	movabs $0x747320676e6f6c20,%rax
    11a5:	20 73 74 
    11a8:	48 ba 72 69 6e 67 0a 	movabs $0x776f480a676e6972,%rdx
    11af:	48 6f 77 
    ...
    11da:	66 c7 44 24 30 0a 00 	movw   $0xa,0x30(%rsp)
    11e1:	48 89 e2             	mov    %rsp,%rdx
    ...
    1206:	00 00 
    1208:	75 0a                	jne    1214 <main+0xab>
    120a:	b8 00 00 00 00       	mov    $0x0,%eax
    120f:	48 83 c4 48          	add    $0x48,%rsp
    1213:	c3                   	retq   
