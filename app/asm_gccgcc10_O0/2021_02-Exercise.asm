...
/app/bin_gccgcc10_O0/2021_02-Exercise:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1171:	48 81 ec 90 00 00 00 	sub    $0x90,%rsp
    1178:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    117f:	00 00 
    1181:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1185:	31 c0                	xor    %eax,%eax
    1187:	c7 85 7c ff ff ff 00 	movl   $0x0,-0x84(%rbp)
    118e:	00 00 00 
    1191:	eb 35                	jmp    11c8 <main+0x5f>
    1193:	8b 85 7c ff ff ff    	mov    -0x84(%rbp),%eax
    1199:	83 c0 01             	add    $0x1,%eax
    119c:	89 c2                	mov    %eax,%edx
    119e:	8b 85 7c ff ff ff    	mov    -0x84(%rbp),%eax
    11a4:	48 98                	cltq   
    11a6:	88 54 05 80          	mov    %dl,-0x80(%rbp,%rax,1)
    11aa:	8b 85 7c ff ff ff    	mov    -0x84(%rbp),%eax
    11b0:	83 c0 33             	add    $0x33,%eax
    11b3:	89 c2                	mov    %eax,%edx
    11b5:	8b 85 7c ff ff ff    	mov    -0x84(%rbp),%eax
    11bb:	48 98                	cltq   
    11bd:	88 54 05 c0          	mov    %dl,-0x40(%rbp,%rax,1)
    11c1:	83 85 7c ff ff ff 01 	addl   $0x1,-0x84(%rbp)
    11c8:	83 bd 7c ff ff ff 31 	cmpl   $0x31,-0x84(%rbp)
    11cf:	7e c2                	jle    1193 <main+0x2a>
    11d1:	c7 85 7c ff ff ff 00 	movl   $0x0,-0x84(%rbp)
    11d8:	00 00 00 
    11db:	eb 3a                	jmp    1217 <main+0xae>
    11dd:	8b 85 7c ff ff ff    	mov    -0x84(%rbp),%eax
    11e3:	48 98                	cltq   
    11e5:	0f b6 44 05 c0       	movzbl -0x40(%rbp,%rax,1),%eax
    11ea:	0f be d0             	movsbl %al,%edx
    11ed:	8b 85 7c ff ff ff    	mov    -0x84(%rbp),%eax
    11f3:	48 98                	cltq   
    11f5:	0f b6 44 05 80       	movzbl -0x80(%rbp,%rax,1),%eax
    ...
    1210:	83 85 7c ff ff ff 01 	addl   $0x1,-0x84(%rbp)
    1217:	83 bd 7c ff ff ff 31 	cmpl   $0x31,-0x84(%rbp)
    121e:	7e bd                	jle    11dd <main+0x74>
    1220:	b8 00 00 00 00       	mov    $0x0,%eax
    1225:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1229:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1230:	00 00 
    1232:	74 05                	je     1239 <main+0xd0>
    1234:	e8 27 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    1239:	c9                   	leaveq 
    123a:	c3                   	retq   
