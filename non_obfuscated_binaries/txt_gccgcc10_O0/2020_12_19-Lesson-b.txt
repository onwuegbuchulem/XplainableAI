...
/app/bin_gccgcc10_O0/2020_12_19-Lesson-b:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	f3 0f 10 05 df 0e 00 	movss  0xedf(%rip),%xmm0        # 203c <_IO_stdin_used+0x3c>
    115c:	00 
    115d:	f3 0f 11 45 fc       	movss  %xmm0,-0x4(%rbp)
    1162:	c7 45 f8 02 00 00 00 	movl   $0x2,-0x8(%rbp)
    1169:	eb 5f                	jmp    11ca <main+0x81>
    116b:	66 0f ef c9          	pxor   %xmm1,%xmm1
    116f:	f3 0f 5a 4d fc       	cvtss2sd -0x4(%rbp),%xmm1
    1174:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1178:	f3 0f 2a 45 f8       	cvtsi2ssl -0x8(%rbp),%xmm0
    117d:	66 0f ef d2          	pxor   %xmm2,%xmm2
    1181:	f3 0f 5a d0          	cvtss2sd %xmm0,%xmm2
    1185:	f2 0f 10 05 b3 0e 00 	movsd  0xeb3(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    118c:	00 
    118d:	f2 0f 5e c2          	divsd  %xmm2,%xmm0
    1191:	f2 0f 58 c1          	addsd  %xmm1,%xmm0
    1195:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    1199:	f3 0f 11 45 fc       	movss  %xmm0,-0x4(%rbp)
    119e:	66 0f ef db          	pxor   %xmm3,%xmm3
    11a2:	f3 0f 5a 5d fc       	cvtss2sd -0x4(%rbp),%xmm3
    11a7:	66 48 0f 7e da       	movq   %xmm3,%rdx
    11ac:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11af:	66 48 0f 6e c2       	movq   %rdx,%xmm0
    11b4:	89 c6                	mov    %eax,%esi
    11b6:	48 8d 3d 4b 0e 00 00 	lea    0xe4b(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11bd:	b8 01 00 00 00       	mov    $0x1,%eax
    11c2:	e8 89 fe ff ff       	callq  1050 <printf@plt>
    11c7:	d1 65 f8             	shll   -0x8(%rbp)
    11ca:	81 7d f8 e8 03 00 00 	cmpl   $0x3e8,-0x8(%rbp)
    11d1:	7e 98                	jle    116b <main+0x22>
    11d3:	66 0f ef e4          	pxor   %xmm4,%xmm4
    11d7:	f3 0f 5a 65 fc       	cvtss2sd -0x4(%rbp),%xmm4
    11dc:	66 48 0f 7e e0       	movq   %xmm4,%rax
    11e1:	66 48 0f 6e c0       	movq   %rax,%xmm0
    11e6:	48 8d 3d 2b 0e 00 00 	lea    0xe2b(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
