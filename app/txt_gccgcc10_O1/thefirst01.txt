...
/app/bin_gccgcc10_O1/thefirst01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11ad:	53                   	push   %rbx
    11ae:	48 83 ec 50          	sub    $0x50,%rsp
    11b2:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11b9:	00 00 
    11bb:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    11c0:	31 c0                	xor    %eax,%eax
    11c2:	48 8d 05 3b 0e 00 00 	lea    0xe3b(%rip),%rax        # 2004 <_IO_stdin_used+0x4>
    11c9:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11ce:	48 8d 05 36 0e 00 00 	lea    0xe36(%rip),%rax        # 200b <_IO_stdin_used+0xb>
    11d5:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    11da:	48 8d 05 31 0e 00 00 	lea    0xe31(%rip),%rax        # 2012 <_IO_stdin_used+0x12>
    11e1:	48 89 44 24 20       	mov    %rax,0x20(%rsp)
    11e6:	48 8d 05 2d 0e 00 00 	lea    0xe2d(%rip),%rax        # 201a <_IO_stdin_used+0x1a>
    11ed:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    11f2:	48 8d 05 2b 0e 00 00 	lea    0xe2b(%rip),%rax        # 2024 <_IO_stdin_used+0x24>
    11f9:	48 89 44 24 30       	mov    %rax,0x30(%rsp)
    11fe:	48 8d 05 28 0e 00 00 	lea    0xe28(%rip),%rax        # 202d <_IO_stdin_used+0x2d>
    1205:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    120a:	48 8d 05 23 0e 00 00 	lea    0xe23(%rip),%rax        # 2034 <_IO_stdin_used+0x34>
    1211:	48 89 44 24 40       	mov    %rax,0x40(%rsp)
    1216:	48 8d 5c 24 08       	lea    0x8(%rsp),%rbx
    121b:	48 89 df             	mov    %rbx,%rdi
    121e:	e8 7d fe ff ff       	callq  10a0 <time@plt>
    1223:	48 89 df             	mov    %rbx,%rdi
    1226:	e8 55 fe ff ff       	callq  1080 <localtime@plt>
    122b:	48 89 c6             	mov    %rax,%rsi
    122e:	8b 48 0c             	mov    0xc(%rax),%ecx
    1231:	48 63 c1             	movslq %ecx,%rax
    1234:	48 69 c0 93 24 49 92 	imul   $0xffffffff92492493,%rax,%rax
    123b:	48 c1 e8 20          	shr    $0x20,%rax
    123f:	01 c8                	add    %ecx,%eax
    1241:	c1 f8 02             	sar    $0x2,%eax
    1244:	89 ca                	mov    %ecx,%edx
    1246:	c1 fa 1f             	sar    $0x1f,%edx
    1249:	29 d0                	sub    %edx,%eax
    124b:	8d 14 c5 00 00 00 00 	lea    0x0(,%rax,8),%edx
    1252:	29 c2                	sub    %eax,%edx
    1254:	8b 76 18             	mov    0x18(%rsi),%esi
    1257:	89 d0                	mov    %edx,%eax
    1259:	29 c8                	sub    %ecx,%eax
    125b:	8d 44 30 01          	lea    0x1(%rax,%rsi,1),%eax
    125f:	48 98                	cltq   
    1261:	48 8b 54 c4 10       	mov    0x10(%rsp,%rax,8),%rdx
    1266:	48 8d 35 d3 0d 00 00 	lea    0xdd3(%rip),%rsi        # 2040 <_IO_stdin_used+0x40>
    126d:	bf 01 00 00 00       	mov    $0x1,%edi
    1272:	b8 00 00 00 00       	mov    $0x0,%eax
    1277:	e8 34 fe ff ff       	callq  10b0 <__printf_chk@plt>
    127c:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    1281:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1288:	00 00 
    128a:	75 0b                	jne    1297 <main+0xee>
    128c:	b8 00 00 00 00       	mov    $0x0,%eax
    1291:	48 83 c4 50          	add    $0x50,%rsp
    1295:	5b                   	pop    %rbx
    1296:	c3                   	retq   
    1297:	e8 f4 fd ff ff       	callq  1090 <__stack_chk_fail@plt>
