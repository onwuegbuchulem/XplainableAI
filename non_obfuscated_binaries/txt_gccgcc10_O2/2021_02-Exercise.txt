...
/app/bin_gccgcc10_O2/2021_02-Exercise:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	55                   	push   %rbp
    1089:	53                   	push   %rbx
    108a:	48 81 ec 88 00 00 00 	sub    $0x88,%rsp
    1091:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1098:	00 00 
    109a:	48 89 44 24 78       	mov    %rax,0x78(%rsp)
    109f:	b8 01 00 00 00       	mov    $0x1,%eax
    10a4:	48 8d 74 24 ff       	lea    -0x1(%rsp),%rsi
    10a9:	48 8d 4c 24 3f       	lea    0x3f(%rsp),%rcx
    10ae:	66 90                	xchg   %ax,%ax
    10b0:	8d 50 32             	lea    0x32(%rax),%edx
    10b3:	88 04 06             	mov    %al,(%rsi,%rax,1)
    10b6:	88 14 01             	mov    %dl,(%rcx,%rax,1)
    10b9:	48 83 c0 01          	add    $0x1,%rax
    10bd:	48 83 f8 33          	cmp    $0x33,%rax
    10c1:	75 ed                	jne    10b0 <main+0x30>
    10c3:	31 db                	xor    %ebx,%ebx
    10c5:	4c 8d 6c 24 40       	lea    0x40(%rsp),%r13
    10ca:	49 89 e4             	mov    %rsp,%r12
    10cd:	48 8d 2d 30 0f 00 00 	lea    0xf30(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    10d4:	0f 1f 40 00          	nopl   0x0(%rax)
    10d8:	41 0f be 4c 1d 00    	movsbl 0x0(%r13,%rbx,1),%ecx
    10de:	41 0f be 14 1c       	movsbl (%r12,%rbx,1),%edx
    10e3:	48 89 ee             	mov    %rbp,%rsi
    10e6:	31 c0                	xor    %eax,%eax
    10e8:	bf 01 00 00 00       	mov    $0x1,%edi
    10ed:	48 83 c3 01          	add    $0x1,%rbx
    10f1:	e8 7a ff ff ff       	callq  1070 <__printf_chk@plt>
    10f6:	48 83 fb 32          	cmp    $0x32,%rbx
    10fa:	75 dc                	jne    10d8 <main+0x58>
    10fc:	48 8b 44 24 78       	mov    0x78(%rsp),%rax
    1101:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1108:	00 00 
    110a:	75 10                	jne    111c <main+0x9c>
    110c:	48 81 c4 88 00 00 00 	add    $0x88,%rsp
