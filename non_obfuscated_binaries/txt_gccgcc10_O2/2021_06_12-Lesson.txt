...
/app/bin_gccgcc10_O2/2021_06_12-Lesson:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1064:	85 ff                	test   %edi,%edi
    1066:	7e 4b                	jle    10b3 <main+0x53>
    1068:	41 55                	push   %r13
    106a:	4c 8d 2d 93 0f 00 00 	lea    0xf93(%rip),%r13        # 2004 <_IO_stdin_used+0x4>
    1071:	41 54                	push   %r12
    1073:	49 89 f4             	mov    %rsi,%r12
    1076:	55                   	push   %rbp
    1077:	48 63 ef             	movslq %edi,%rbp
    107a:	53                   	push   %rbx
    107b:	31 db                	xor    %ebx,%ebx
    107d:	48 83 ec 08          	sub    $0x8,%rsp
    1081:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    1088:	49 8b 0c dc          	mov    (%r12,%rbx,8),%rcx
    108c:	89 da                	mov    %ebx,%edx
    108e:	4c 89 ee             	mov    %r13,%rsi
    1091:	bf 01 00 00 00       	mov    $0x1,%edi
    1096:	31 c0                	xor    %eax,%eax
    1098:	48 83 c3 01          	add    $0x1,%rbx
    109c:	e8 af ff ff ff       	callq  1050 <__printf_chk@plt>
    10a1:	48 39 eb             	cmp    %rbp,%rbx
    10a4:	75 e2                	jne    1088 <main+0x28>
