...
/app/bin_gccgcc10_O2/2021_04_24-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <setbuf@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 1d 2f 00 00 	bnd jmpq *0x2f1d(%rip)        # 3fc8 <setbuf@GLIBC_2.2.5>
...
00000000000010c0 <main>:
    ...
    10c4:	48 81 ec 00 10 00 00 	sub    $0x1000,%rsp
    10cb:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    10d0:	48 81 ec 00 10 00 00 	sub    $0x1000,%rsp
    10d7:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    10dc:	48 83 ec 18          	sub    $0x18,%rsp
    10e0:	48 8b 3d 29 2f 00 00 	mov    0x2f29(%rip),%rdi        # 4010 <stdout@@GLIBC_2.2.5>
    10e7:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10ee:	00 00 
    10f0:	48 89 84 24 08 20 00 	mov    %rax,0x2008(%rsp)
    10f7:	00 
    10f8:	31 c0                	xor    %eax,%eax
    10fa:	48 89 e6             	mov    %rsp,%rsi
    10fd:	e8 9e ff ff ff       	callq  10a0 <setbuf@plt>
    1102:	48 8d 3d fb 0e 00 00 	lea    0xefb(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1109:	e8 72 ff ff ff       	callq  1080 <puts@plt>
    110e:	48 8d 3d ef 0e 00 00 	lea    0xeef(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1115:	e8 66 ff ff ff       	callq  1080 <puts@plt>
    111a:	48 8d 3d ec 0e 00 00 	lea    0xeec(%rip),%rdi        # 200d <_IO_stdin_used+0xd>
    1121:	e8 5a ff ff ff       	callq  1080 <puts@plt>
    1126:	48 8b 3d f3 2e 00 00 	mov    0x2ef3(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    112d:	e8 7e ff ff ff       	callq  10b0 <getc@plt>
    1132:	48 8d 3d d8 0e 00 00 	lea    0xed8(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    1139:	e8 42 ff ff ff       	callq  1080 <puts@plt>
    113e:	48 8b 84 24 08 20 00 	mov    0x2008(%rsp),%rax
    1145:	00 
    1146:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    114d:	00 00 
    114f:	75 0a                	jne    115b <main+0x9b>
    1151:	31 c0                	xor    %eax,%eax
    1153:	48 81 c4 18 20 00 00 	add    $0x2018,%rsp
    115a:	c3                   	retq   
    115b:	e8 30 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
