...
/app/bin_gccgcc10_O0/03_struct_arrays:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1171:	48 81 ec 00 08 00 00 	sub    $0x800,%rsp
    1178:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    117f:	00 00 
    1181:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1185:	31 c0                	xor    %eax,%eax
    1187:	c7 85 20 f8 ff ff 64 	movl   $0x64,-0x7e0(%rbp)
    118e:	00 00 00 
    1191:	c7 85 34 f8 ff ff 4d 	movl   $0x4d,-0x7cc(%rbp)
    1198:	00 00 00 
    119b:	c7 85 00 f8 ff ff 64 	movl   $0x64,-0x800(%rbp)
    11a2:	00 00 00 
    11a5:	f3 0f 10 05 63 0e 00 	movss  0xe63(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    11ac:	00 
    11ad:	f3 0f 11 85 04 f8 ff 	movss  %xmm0,-0x7fc(%rbp)
    11b4:	ff 
    11b5:	48 b8 68 61 72 72 79 	movabs $0x7972726168,%rax
    11bc:	00 00 00 
    11bf:	48 89 85 08 f8 ff ff 	mov    %rax,-0x7f8(%rbp)
    11c6:	66 c7 85 10 f8 ff ff 	movw   $0x0,-0x7f0(%rbp)
    11cd:	00 00 
    11cf:	f3 0f 10 85 04 f8 ff 	movss  -0x7fc(%rbp),%xmm0
    11d6:	ff 
    11d7:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11db:	f3 0f 5a c8          	cvtss2sd %xmm0,%xmm1
    11df:	66 48 0f 7e c9       	movq   %xmm1,%rcx
    11e4:	8b 85 00 f8 ff ff    	mov    -0x800(%rbp),%eax
    11ea:	48 8d 95 00 f8 ff ff 	lea    -0x800(%rbp),%rdx
    11f1:	48 83 c2 08          	add    $0x8,%rdx
    11f5:	66 48 0f 6e c1       	movq   %rcx,%xmm0
    ...
    1212:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    1216:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    121d:	00 00 
    121f:	74 05                	je     1226 <main+0xbd>
