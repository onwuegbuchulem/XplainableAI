...
/app/bin_gccgcc10_O0/2020_07-Exercise:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	c7 45 e0 05 00 00 00 	movl   $0x5,-0x20(%rbp)
    11ab:	c7 45 e4 03 00 00 00 	movl   $0x3,-0x1c(%rbp)
    11b2:	c7 45 e8 08 00 00 00 	movl   $0x8,-0x18(%rbp)
    11b9:	c7 45 ec 07 00 00 00 	movl   $0x7,-0x14(%rbp)
    11c0:	c7 45 f0 02 00 00 00 	movl   $0x2,-0x10(%rbp)
    11c7:	c7 45 d8 00 00 00 00 	movl   $0x0,-0x28(%rbp)
    11ce:	eb 5e                	jmp    122e <main+0xa5>
    11d0:	8b 45 d8             	mov    -0x28(%rbp),%eax
    ...
    11e4:	e8 a7 fe ff ff       	callq  1090 <printf@plt>
    11e9:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
    11f0:	eb 0e                	jmp    1200 <main+0x77>
    11f2:	bf 2a 00 00 00       	mov    $0x2a,%edi
    11f7:	e8 74 fe ff ff       	callq  1070 <putchar@plt>
    11fc:	83 45 dc 01          	addl   $0x1,-0x24(%rbp)
    1200:	8b 45 d8             	mov    -0x28(%rbp),%eax
    1203:	48 98                	cltq   
    1205:	8b 44 85 e0          	mov    -0x20(%rbp,%rax,4),%eax
    1209:	39 45 dc             	cmp    %eax,-0x24(%rbp)
    120c:	7c e4                	jl     11f2 <main+0x69>
    120e:	8b 45 d8             	mov    -0x28(%rbp),%eax
    1211:	48 98                	cltq   
    1213:	8b 44 85 e0          	mov    -0x20(%rbp,%rax,4),%eax
    1217:	89 c6                	mov    %eax,%esi
    1219:	48 8d 3d e9 0d 00 00 	lea    0xde9(%rip),%rdi        # 2009 <_IO_stdin_used+0x9>
    1220:	b8 00 00 00 00       	mov    $0x0,%eax
    1225:	e8 66 fe ff ff       	callq  1090 <printf@plt>
    122a:	83 45 d8 01          	addl   $0x1,-0x28(%rbp)
    122e:	83 7d d8 04          	cmpl   $0x4,-0x28(%rbp)
    1232:	7e 9c                	jle    11d0 <main+0x47>
    1234:	b8 00 00 00 00       	mov    $0x0,%eax
    1239:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    123d:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1244:	00 00 
    1246:	74 05                	je     124d <main+0xc4>
