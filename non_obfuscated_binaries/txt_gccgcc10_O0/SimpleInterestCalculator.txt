...
/app/bin_gccgcc10_O0/SimpleInterestCalculator:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11df:	48 8d 3d 61 0e 00 00 	lea    0xe61(%rip),%rdi        # 2047 <_IO_stdin_used+0x47>
    11e6:	b8 00 00 00 00       	mov    $0x0,%eax
    11eb:	e8 c0 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11f0:	f3 0f 10 4d e8       	movss  -0x18(%rbp),%xmm1
    11f5:	f3 0f 10 45 ec       	movss  -0x14(%rbp),%xmm0
    11fa:	f3 0f 59 c8          	mulss  %xmm0,%xmm1
    11fe:	f3 0f 10 45 f0       	movss  -0x10(%rbp),%xmm0
    1203:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    1207:	f3 0f 10 0d 59 0e 00 	movss  0xe59(%rip),%xmm1        # 2068 <_IO_stdin_used+0x68>
    120e:	00 
    120f:	f3 0f 5e c1          	divss  %xmm1,%xmm0
    1213:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    1218:	66 0f ef d2          	pxor   %xmm2,%xmm2
    121c:	f3 0f 5a 55 f4       	cvtss2sd -0xc(%rbp),%xmm2
    1221:	66 48 0f 7e d0       	movq   %xmm2,%rax
    1226:	66 48 0f 6e c0       	movq   %rax,%xmm0
    122b:	48 8d 3d 1c 0e 00 00 	lea    0xe1c(%rip),%rdi        # 204e <_IO_stdin_used+0x4e>
    1232:	b8 01 00 00 00       	mov    $0x1,%eax
    1237:	e8 64 fe ff ff       	callq  10a0 <printf@plt>
    123c:	b8 00 00 00 00       	mov    $0x0,%eax
    1241:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    1245:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    124c:	00 00 
    124e:	74 05                	je     1255 <main+0xac>
    1250:	e8 3b fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    1255:	c9                   	leaveq 
    1256:	c3                   	retq   
