...
/app/bin_gccgcc10_O1/2023_03_18-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ab:	48 8b 14 24          	mov    (%rsp),%rdx
    11af:	48 8d 35 4e 0e 00 00 	lea    0xe4e(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11b6:	bf 01 00 00 00       	mov    $0x1,%edi
    11bb:	b8 00 00 00 00       	mov    $0x0,%eax
    11c0:	e8 cb fe ff ff       	callq  1090 <__printf_chk@plt>
    11c5:	48 8b 2c 24          	mov    (%rsp),%rbp
    11c9:	48 89 e3             	mov    %rsp,%rbx
    11cc:	48 89 df             	mov    %rbx,%rdi
    11cf:	e8 ac fe ff ff       	callq  1080 <time@plt>
    11d4:	48 8b 14 24          	mov    (%rsp),%rdx
    11d8:	48 39 ea             	cmp    %rbp,%rdx
    11db:	74 ef                	je     11cc <main+0x43>
    11dd:	48 8d 35 20 0e 00 00 	lea    0xe20(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11e4:	bf 01 00 00 00       	mov    $0x1,%edi
    11e9:	b8 00 00 00 00       	mov    $0x0,%eax
    11ee:	e8 9d fe ff ff       	callq  1090 <__printf_chk@plt>
    11f3:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11f8:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11ff:	00 00 
    1201:	75 0c                	jne    120f <main+0x86>
    1203:	b8 00 00 00 00       	mov    $0x0,%eax
    1208:	48 83 c4 18          	add    $0x18,%rsp
    120c:	5b                   	pop    %rbx
    120d:	5d                   	pop    %rbp
    120e:	c3                   	retq   
    120f:	e8 5c fe ff ff       	callq  1070 <__stack_chk_fail@plt>
