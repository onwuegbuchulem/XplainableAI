...
/app/bin_gccgcc10_O1/Recursion:     file format elf64-x86-64
...
0000000000001189 <sum>:
    ...
    1192:	75 04                	jne    1198 <sum+0xf>
    1194:	89 d8                	mov    %ebx,%eax
    1196:	5b                   	pop    %rbx
    1197:	c3                   	retq   
    1198:	8d 7f ff             	lea    -0x1(%rdi),%edi
    119b:	e8 e9 ff ff ff       	callq  1189 <sum>
    11a0:	01 c3                	add    %eax,%ebx
    11a2:	eb f0                	jmp    1194 <sum+0xb>

00000000000011a4 <main>:
    11a4:	f3 0f 1e fa          	endbr64 
    11a8:	48 83 ec 18          	sub    $0x18,%rsp
    11ac:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11b3:	00 00 
    11b5:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11ba:	31 c0                	xor    %eax,%eax
    11bc:	48 8d 35 41 0e 00 00 	lea    0xe41(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11c3:	bf 01 00 00 00       	mov    $0x1,%edi
    11c8:	e8 b3 fe ff ff       	callq  1080 <__printf_chk@plt>
    11cd:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11d2:	48 8d 3d 4c 0e 00 00 	lea    0xe4c(%rip),%rdi        # 2025 <_IO_stdin_used+0x25>
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	e8 ad fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11e3:	8b 7c 24 04          	mov    0x4(%rsp),%edi
    11e7:	e8 9d ff ff ff       	callq  1189 <sum>
    ...
    11ff:	e8 7c fe ff ff       	callq  1080 <__printf_chk@plt>
    1204:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1209:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1210:	00 00 
    1212:	75 0a                	jne    121e <main+0x7a>
    1214:	b8 00 00 00 00       	mov    $0x0,%eax
    1219:	48 83 c4 18          	add    $0x18,%rsp
    121d:	c3                   	retq   
    121e:	e8 4d fe ff ff       	callq  1070 <__stack_chk_fail@plt>
