...
/app/bin_gccgcc10_O0/2023_04_29-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119c:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11a0:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    11a4:	48 89 c7             	mov    %rax,%rdi
    11a7:	e8 c4 fe ff ff       	callq  1070 <strlen@plt>
    11ac:	48 83 c0 01          	add    $0x1,%rax
    11b0:	48 89 c7             	mov    %rax,%rdi
    11b3:	e8 d8 fe ff ff       	callq  1090 <malloc@plt>
    11b8:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11bc:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11c0:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    11c4:	90                   	nop
    11c5:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    11c9:	48 8d 42 01          	lea    0x1(%rdx),%rax
    11cd:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11d1:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    11d5:	48 8d 48 01          	lea    0x1(%rax),%rcx
    11d9:	48 89 4d e8          	mov    %rcx,-0x18(%rbp)
    11dd:	0f b6 12             	movzbl (%rdx),%edx
    11e0:	88 10                	mov    %dl,(%rax)
    11e2:	0f b6 00             	movzbl (%rax),%eax
    11e5:	84 c0                	test   %al,%al
    11e7:	75 dc                	jne    11c5 <main+0x3c>
    11e9:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11ed:	48 89 c6             	mov    %rax,%rsi
    11f0:	48 8d 3d 15 0e 00 00 	lea    0xe15(%rip),%rdi        # 200c <_IO_stdin_used+0xc>
