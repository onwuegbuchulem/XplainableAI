...
/app/bin_gccgcc10_O1/2020_06_06-Lesson:     file format elf64-x86-64
...
00000000000010e0 <_start>:
    ...
    1101:	48 8d 3d 09 01 00 00 	lea    0x109(%rip),%rdi        # 1211 <main>
...
00000000000011c9 <ternary_out>:
    ...
    11cd:	81 ff ff ff 00 00    	cmp    $0xffff,%edi
    11d3:	77 0f                	ja     11e4 <ternary_out+0x1b>
    11d5:	c6 05 54 2e 00 00 00 	movb   $0x0,0x2e54(%rip)        # 4030 <tstring.0>
    11dc:	48 8d 05 4d 2e 00 00 	lea    0x2e4d(%rip),%rax        # 4030 <tstring.0>
    11e3:	c3                   	retq   
    11e4:	48 83 ec 08          	sub    $0x8,%rsp
    11e8:	89 f9                	mov    %edi,%ecx
    11ea:	48 8d 15 13 0e 00 00 	lea    0xe13(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    11f1:	be 01 00 00 00       	mov    $0x1,%esi
    11f6:	48 8b 3d 23 2e 00 00 	mov    0x2e23(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    11fd:	b8 00 00 00 00       	mov    $0x0,%eax
    1202:	e8 c9 fe ff ff       	callq  10d0 <__fprintf_chk@plt>
    1207:	bf 01 00 00 00       	mov    $0x1,%edi
    120c:	e8 af fe ff ff       	callq  10c0 <exit@plt>

0000000000001211 <main>:
    1211:	f3 0f 1e fa          	endbr64 
    1215:	48 83 ec 18          	sub    $0x18,%rsp
    ...
    1235:	e8 66 fe ff ff       	callq  10a0 <__printf_chk@plt>
    123a:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    123f:	48 8d 3d e2 0d 00 00 	lea    0xde2(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    1246:	b8 00 00 00 00       	mov    $0x0,%eax
    124b:	e8 60 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1250:	8b 7c 24 04          	mov    0x4(%rsp),%edi
    1254:	e8 70 ff ff ff       	callq  11c9 <ternary_out>
    1259:	48 89 c1             	mov    %rax,%rcx
    125c:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1260:	48 8d 35 c4 0d 00 00 	lea    0xdc4(%rip),%rsi        # 202b <_IO_stdin_used+0x2b>
