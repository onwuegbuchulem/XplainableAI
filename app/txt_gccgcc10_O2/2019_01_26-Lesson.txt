...
/app/bin_gccgcc10_O2/2019_01_26-Lesson:     file format elf64-x86-64
...
0000000000001090 <access@plt>:
    1090:	f3 0f 1e fa          	endbr64 
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <access@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10a8:	48 83 ec 20          	sub    $0x20,%rsp
    10ac:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10b3:	00 00 
    10b5:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10ba:	48 b8 67 65 74 74 79 	movabs $0x7562737974746567,%rax
    10c1:	73 62 75 
    10c4:	4c 8d 64 24 09       	lea    0x9(%rsp),%r12
    10c9:	c7 44 24 11 72 67 2e 	movl   $0x742e6772,0x11(%rsp)
    10d0:	74 
    10d1:	4c 89 e7             	mov    %r12,%rdi
    10d4:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    10d9:	48 89 44 24 09       	mov    %rax,0x9(%rsp)
    10de:	b8 78 74 00 00       	mov    $0x7478,%eax
    10e3:	66 89 44 24 15       	mov    %ax,0x15(%rsp)
    10e8:	e8 a3 ff ff ff       	callq  1090 <access@plt>
    10ed:	4c 89 e2             	mov    %r12,%rdx
    10f0:	85 c0                	test   %eax,%eax
    10f2:	75 2a                	jne    111e <main+0x7e>
    10f4:	48 8d 35 09 0f 00 00 	lea    0xf09(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    ...
    1111:	00 00 
    1113:	75 1e                	jne    1133 <main+0x93>
    1115:	48 83 c4 20          	add    $0x20,%rsp
    1119:	31 c0                	xor    %eax,%eax
    111b:	41 5c                	pop    %r12
    111d:	c3                   	retq   
    111e:	48 8d 35 f1 0e 00 00 	lea    0xef1(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    1125:	bf 01 00 00 00       	mov    $0x1,%edi
    112a:	31 c0                	xor    %eax,%eax
    112c:	e8 4f ff ff ff       	callq  1080 <__printf_chk@plt>
    1131:	eb d2                	jmp    1105 <main+0x65>
    1133:	e8 38 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
