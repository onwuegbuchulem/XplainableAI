...
/app/bin_gccgcc10_O0/2024_03_23-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1175:	c6 45 ff 41          	movb   $0x41,-0x1(%rbp)
    1179:	0f b6 45 ff          	movzbl -0x1(%rbp),%eax
    117d:	89 c2                	mov    %eax,%edx
    117f:	83 c2 01             	add    $0x1,%edx
    1182:	88 55 ff             	mov    %dl,-0x1(%rbp)
    ...
    1196:	e8 c5 fe ff ff       	callq  1060 <printf@plt>
    119b:	80 7d ff 5a          	cmpb   $0x5a,-0x1(%rbp)
    119f:	75 04                	jne    11a5 <main+0x3c>
    11a1:	c6 45 ff 41          	movb   $0x41,-0x1(%rbp)
    11a5:	e8 c6 fe ff ff       	callq  1070 <getchar@plt>
    11aa:	85 c0                	test   %eax,%eax
    11ac:	75 02                	jne    11b0 <main+0x47>
    11ae:	eb c9                	jmp    1179 <main+0x10>
    11b0:	90                   	nop
