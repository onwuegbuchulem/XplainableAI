...
/app/bin_gccgcc10_O3/empty-null:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10d8:	80 7c 24 13 00       	cmpb   $0x0,0x13(%rsp)
    10dd:	c7 44 24 0e 00 00 00 	movl   $0x0,0xe(%rsp)
    10e4:	00 
    10e5:	c6 44 24 12 00       	movb   $0x0,0x12(%rsp)
    10ea:	74 62                	je     114e <main+0x8e>
    10ec:	48 8d 3d 26 0f 00 00 	lea    0xf26(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    10f3:	e8 88 ff ff ff       	callq  1080 <puts@plt>
    10f8:	48 8d 7c 24 13       	lea    0x13(%rsp),%rdi
    10fd:	e8 8e ff ff ff       	callq  1090 <strlen@plt>
    1102:	31 d2                	xor    %edx,%edx
    1104:	bf 01 00 00 00       	mov    $0x1,%edi
    1109:	48 8d 35 22 0f 00 00 	lea    0xf22(%rip),%rsi        # 2032 <_IO_stdin_used+0x32>
    1110:	48 89 c1             	mov    %rax,%rcx
    1113:	31 c0                	xor    %eax,%eax
    1115:	e8 96 ff ff ff       	callq  10b0 <__printf_chk@plt>
    111a:	31 c0                	xor    %eax,%eax
    111c:	b9 05 00 00 00       	mov    $0x5,%ecx
    1121:	ba 05 00 00 00       	mov    $0x5,%edx
    1126:	48 8d 35 1a 0f 00 00 	lea    0xf1a(%rip),%rsi        # 2047 <_IO_stdin_used+0x47>
    112d:	bf 01 00 00 00       	mov    $0x1,%edi
    1132:	e8 79 ff ff ff       	callq  10b0 <__printf_chk@plt>
    1137:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    113c:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1143:	00 00 
    1145:	75 15                	jne    115c <main+0x9c>
    1147:	31 c0                	xor    %eax,%eax
    1149:	48 83 c4 28          	add    $0x28,%rsp
    114d:	c3                   	retq   
    114e:	48 8d 3d af 0e 00 00 	lea    0xeaf(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1155:	e8 26 ff ff ff       	callq  1080 <puts@plt>
    115a:	eb 9c                	jmp    10f8 <main+0x38>
    115c:	e8 3f ff ff ff       	callq  10a0 <__stack_chk_fail@plt>
