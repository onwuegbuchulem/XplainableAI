...
/app/bin_gccgcc10_O3/2020_03_14-Lesson:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10cc:	48 8d 3d 41 0f 00 00 	lea    0xf41(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    10d3:	31 c0                	xor    %eax,%eax
    10d5:	e8 b6 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10da:	48 8d 35 36 0f 00 00 	lea    0xf36(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    ...
    10f2:	48 8d 3d 1b 0f 00 00 	lea    0xf1b(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    10f9:	31 c0                	xor    %eax,%eax
    10fb:	e8 90 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    1100:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    1104:	8b 14 24             	mov    (%rsp),%edx
    1107:	39 d1                	cmp    %edx,%ecx
    1109:	7f 41                	jg     114c <main+0xac>
    110b:	7c 2a                	jl     1137 <main+0x97>
    110d:	48 8d 35 27 0f 00 00 	lea    0xf27(%rip),%rsi        # 203b <_IO_stdin_used+0x3b>
    ...
    112c:	00 00 
    112e:	75 31                	jne    1161 <main+0xc1>
    1130:	31 c0                	xor    %eax,%eax
    1132:	48 83 c4 18          	add    $0x18,%rsp
    1136:	c3                   	retq   
    1137:	48 8d 35 12 0f 00 00 	lea    0xf12(%rip),%rsi        # 2050 <_IO_stdin_used+0x50>
    113e:	bf 01 00 00 00       	mov    $0x1,%edi
    1143:	31 c0                	xor    %eax,%eax
    1145:	e8 36 ff ff ff       	callq  1080 <__printf_chk@plt>
    114a:	eb d4                	jmp    1120 <main+0x80>
    114c:	48 8d 35 d4 0e 00 00 	lea    0xed4(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    1153:	bf 01 00 00 00       	mov    $0x1,%edi
    1158:	31 c0                	xor    %eax,%eax
    115a:	e8 21 ff ff ff       	callq  1080 <__printf_chk@plt>
    115f:	eb bf                	jmp    1120 <main+0x80>
    1161:	e8 0a ff ff ff       	callq  1070 <__stack_chk_fail@plt>
...
0000000000001170 <_start>:
    ...
    1181:	50                   	push   %rax
    1182:	54                   	push   %rsp
    1183:	4c 8d 05 66 01 00 00 	lea    0x166(%rip),%r8        # 12f0 <__libc_csu_fini>
    118a:	48 8d 0d ef 00 00 00 	lea    0xef(%rip),%rcx        # 1280 <__libc_csu_init>
...
0000000000001260 <tweval>:
    1260:	f3 0f 1e fa          	endbr64 
    1264:	31 c0                	xor    %eax,%eax
    1266:	39 f7                	cmp    %esi,%edi
    1268:	ba ff ff ff ff       	mov    $0xffffffff,%edx
    126d:	0f 9f c0             	setg   %al
    1270:	0f 4c c2             	cmovl  %edx,%eax
    1273:	c3                   	retq   
