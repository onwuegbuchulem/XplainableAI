...
/app/bin_gccgcc10_O1/2021_10_30-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1181:	48 b8 53 65 65 20 50 	movabs $0x676f725020656553,%rax
    1188:	72 6f 67 
    118b:	48 ba 72 61 6d 6d 65 	movabs $0x72656d6d6172,%rdx
    1192:	72 00 00 
    1195:	48 89 04 24          	mov    %rax,(%rsp)
    1199:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    119e:	48 c7 44 24 10 00 00 	movq   $0x0,0x10(%rsp)
    11a5:	00 00 
    11a7:	48 c7 44 24 18 00 00 	movq   $0x0,0x18(%rsp)
    11ae:	00 00 
    11b0:	c7 44 24 20 1d 00 00 	movl   $0x1d,0x20(%rsp)
    11b7:	00 
    11b8:	c7 44 24 24 9a 99 3d 	movl   $0x433d999a,0x24(%rsp)
    11bf:	43 
    11c0:	48 89 e2             	mov    %rsp,%rdx
    11c3:	f2 0f 10 05 5d 0e 00 	movsd  0xe5d(%rip),%xmm0        # 2028 <_IO_stdin_used+0x28>
    11ca:	00 
    11cb:	b9 1d 00 00 00       	mov    $0x1d,%ecx
    11d0:	48 8d 35 2d 0e 00 00 	lea    0xe2d(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11d7:	bf 01 00 00 00       	mov    $0x1,%edi
    11dc:	b8 01 00 00 00       	mov    $0x1,%eax
    11e1:	e8 8a fe ff ff       	callq  1070 <__printf_chk@plt>
    11e6:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    11eb:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f2:	00 00 
    11f4:	75 0a                	jne    1200 <main+0x97>
    11f6:	b8 00 00 00 00       	mov    $0x0,%eax
    11fb:	48 83 c4 38          	add    $0x38,%rsp
    11ff:	c3                   	retq   
