...
/app/bin_gccgcc10_O1/2024_03_23-Lesson-a:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1153:	ba 41 00 00 00       	mov    $0x41,%edx
    1158:	48 8d 35 a5 0e 00 00 	lea    0xea5(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    115f:	bf 01 00 00 00       	mov    $0x1,%edi
    1164:	b8 00 00 00 00       	mov    $0x0,%eax
    1169:	e8 e2 fe ff ff       	callq  1050 <__printf_chk@plt>
    116e:	ba 42 00 00 00       	mov    $0x42,%edx
    1173:	bd 41 00 00 00       	mov    $0x41,%ebp
    1178:	8d 5a 01             	lea    0x1(%rdx),%ebx
    117b:	0f be d2             	movsbl %dl,%edx
    117e:	48 8d 35 7f 0e 00 00 	lea    0xe7f(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1185:	bf 01 00 00 00       	mov    $0x1,%edi
    118a:	b8 00 00 00 00       	mov    $0x0,%eax
    118f:	e8 bc fe ff ff       	callq  1050 <__printf_chk@plt>
    1194:	80 fb 5a             	cmp    $0x5a,%bl
    1197:	0f 44 dd             	cmove  %ebp,%ebx
    119a:	89 da                	mov    %ebx,%edx
    119c:	eb da                	jmp    1178 <main+0x2f>
