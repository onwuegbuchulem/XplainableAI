...
/app/bin_gccgcc10_O1/2022_03_05-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1181:	48 8d 4c 24 04       	lea    0x4(%rsp),%rcx
    1186:	44 8b 44 24 04       	mov    0x4(%rsp),%r8d
    118b:	ba 40 9c 00 00       	mov    $0x9c40,%edx
    1190:	48 8d 35 71 0e 00 00 	lea    0xe71(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    1197:	bf 01 00 00 00       	mov    $0x1,%edi
    119c:	e8 cf fe ff ff       	callq  1070 <__printf_chk@plt>
    11a1:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11a5:	48 8d 35 8b 0e 00 00 	lea    0xe8b(%rip),%rsi        # 2037 <_IO_stdin_used+0x37>
    11ac:	bf 01 00 00 00       	mov    $0x1,%edi
    11b1:	b8 00 00 00 00       	mov    $0x0,%eax
    11b6:	e8 b5 fe ff ff       	callq  1070 <__printf_chk@plt>
    11bb:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11c0:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11c7:	00 00 
    11c9:	75 0a                	jne    11d5 <main+0x6c>
    11cb:	b8 00 00 00 00       	mov    $0x0,%eax
    11d0:	48 83 c4 18          	add    $0x18,%rsp
    11d4:	c3                   	retq   
    11d5:	e8 86 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
