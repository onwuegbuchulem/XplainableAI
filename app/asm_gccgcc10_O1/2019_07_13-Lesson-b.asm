...
/app/bin_gccgcc10_O1/2019_07_13-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a2:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    11a7:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    11ac:	48 8d 5c 24 17       	lea    0x17(%rsp),%rbx
    11b1:	ba 0a 00 00 00       	mov    $0xa,%edx
    11b6:	48 89 df             	mov    %rbx,%rdi
    11b9:	e8 c2 fe ff ff       	callq  1080 <strtol@plt>
    11be:	48 89 c1             	mov    %rax,%rcx
    11c1:	48 89 da             	mov    %rbx,%rdx
    11c4:	48 8d 35 39 0e 00 00 	lea    0xe39(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11cb:	bf 01 00 00 00       	mov    $0x1,%edi
    11d0:	b8 00 00 00 00       	mov    $0x0,%eax
    11d5:	e8 b6 fe ff ff       	callq  1090 <__printf_chk@plt>
    11da:	48 39 5c 24 08       	cmp    %rbx,0x8(%rsp)
    11df:	74 1b                	je     11fc <main+0x73>
    11e1:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11e6:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11ed:	00 00 
    11ef:	75 26                	jne    1217 <main+0x8e>
    11f1:	b8 00 00 00 00       	mov    $0x0,%eax
    11f6:	48 83 c4 20          	add    $0x20,%rsp
    11fa:	5b                   	pop    %rbx
    11fb:	c3                   	retq   
    11fc:	48 89 da             	mov    %rbx,%rdx
    11ff:	48 8d 35 1a 0e 00 00 	lea    0xe1a(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    1206:	bf 01 00 00 00       	mov    $0x1,%edi
    120b:	b8 00 00 00 00       	mov    $0x0,%eax
    1210:	e8 7b fe ff ff       	callq  1090 <__printf_chk@plt>
    1215:	eb ca                	jmp    11e1 <main+0x58>
