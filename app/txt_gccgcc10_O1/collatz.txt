...
/app/bin_gccgcc10_O1/collatz:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c5:	83 ff 02             	cmp    $0x2,%edi
    11c8:	74 42                	je     120c <main+0x63>
    11ca:	48 8d 35 33 0e 00 00 	lea    0xe33(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11d1:	bf 01 00 00 00       	mov    $0x1,%edi
    11d6:	b8 00 00 00 00       	mov    $0x0,%eax
    11db:	e8 c0 fe ff ff       	callq  10a0 <__printf_chk@plt>
    11e0:	48 89 e6             	mov    %rsp,%rsi
    11e3:	48 8d 3d 32 0e 00 00 	lea    0xe32(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    11ea:	b8 00 00 00 00       	mov    $0x0,%eax
    11ef:	e8 bc fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11f4:	48 8b 1c 24          	mov    (%rsp),%rbx
    11f8:	48 83 fb 01          	cmp    $0x1,%rbx
    11fc:	74 55                	je     1253 <main+0xaa>
    11fe:	bd 00 00 00 00       	mov    $0x0,%ebp
    1203:	4c 8d 25 16 0e 00 00 	lea    0xe16(%rip),%r12        # 2020 <_IO_stdin_used+0x20>
    120a:	eb 24                	jmp    1230 <main+0x87>
    120c:	48 8b 7e 08          	mov    0x8(%rsi),%rdi
    1210:	ba 0a 00 00 00       	mov    $0xa,%edx
    1215:	be 00 00 00 00       	mov    $0x0,%esi
    121a:	e8 71 fe ff ff       	callq  1090 <strtoull@plt>
    121f:	48 89 04 24          	mov    %rax,(%rsp)
    1223:	eb cf                	jmp    11f4 <main+0x4b>
    1225:	48 8d 5c 5b 01       	lea    0x1(%rbx,%rbx,2),%rbx
    122a:	48 83 fb 01          	cmp    $0x1,%rbx
    122e:	74 28                	je     1258 <main+0xaf>
    1230:	48 83 c5 01          	add    $0x1,%rbp
    1234:	48 89 da             	mov    %rbx,%rdx
    1237:	4c 89 e6             	mov    %r12,%rsi
    123a:	bf 01 00 00 00       	mov    $0x1,%edi
    123f:	b8 00 00 00 00       	mov    $0x0,%eax
    1244:	e8 57 fe ff ff       	callq  10a0 <__printf_chk@plt>
    1249:	f6 c3 01             	test   $0x1,%bl
    124c:	75 d7                	jne    1225 <main+0x7c>
    124e:	48 d1 eb             	shr    %rbx
    1251:	eb d7                	jmp    122a <main+0x81>
    1253:	bd 00 00 00 00       	mov    $0x0,%ebp
    1258:	48 89 ea             	mov    %rbp,%rdx
    125b:	48 8d 35 c5 0d 00 00 	lea    0xdc5(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    1262:	bf 01 00 00 00       	mov    $0x1,%edi
    1267:	b8 00 00 00 00       	mov    $0x0,%eax
    126c:	e8 2f fe ff ff       	callq  10a0 <__printf_chk@plt>
    1271:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1276:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    127d:	00 00 
    127f:	75 0e                	jne    128f <main+0xe6>
    ...
    128c:	41 5c                	pop    %r12
    128e:	c3                   	retq   
    128f:	e8 ec fd ff ff       	callq  1080 <__stack_chk_fail@plt>
