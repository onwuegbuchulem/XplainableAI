...
/app/bin_gccgcc10_O1/Male_Female_MF:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b2:	48 8d 74 24 07       	lea    0x7(%rsp),%rsi
    11b7:	48 8d 3d 5a 0e 00 00 	lea    0xe5a(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	0f b6 44 24 07       	movzbl 0x7(%rsp),%eax
    11cd:	3c 66                	cmp    $0x66,%al
    11cf:	74 56                	je     1227 <main+0x9e>
    11d1:	7f 38                	jg     120b <main+0x82>
    11d3:	3c 46                	cmp    $0x46,%al
    11d5:	74 50                	je     1227 <main+0x9e>
    11d7:	3c 4d                	cmp    $0x4d,%al
    11d9:	75 34                	jne    120f <main+0x86>
    11db:	48 8d 35 39 0e 00 00 	lea    0xe39(%rip),%rsi        # 201b <_IO_stdin_used+0x1b>
    11e2:	bf 01 00 00 00       	mov    $0x1,%edi
    11e7:	b8 00 00 00 00       	mov    $0x0,%eax
    11ec:	e8 8f fe ff ff       	callq  1080 <__printf_chk@plt>
    11f1:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11f6:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11fd:	00 00 
    11ff:	75 3e                	jne    123f <main+0xb6>
    1201:	b8 00 00 00 00       	mov    $0x0,%eax
    1206:	48 83 c4 18          	add    $0x18,%rsp
    120a:	c3                   	retq   
    120b:	3c 6d                	cmp    $0x6d,%al
    120d:	74 cc                	je     11db <main+0x52>
    120f:	48 8d 35 13 0e 00 00 	lea    0xe13(%rip),%rsi        # 2029 <_IO_stdin_used+0x29>
    1216:	bf 01 00 00 00       	mov    $0x1,%edi
    121b:	b8 00 00 00 00       	mov    $0x0,%eax
    1220:	e8 5b fe ff ff       	callq  1080 <__printf_chk@plt>
    1225:	eb ca                	jmp    11f1 <main+0x68>
    1227:	48 8d 35 f3 0d 00 00 	lea    0xdf3(%rip),%rsi        # 2021 <_IO_stdin_used+0x21>
    122e:	bf 01 00 00 00       	mov    $0x1,%edi
    1233:	b8 00 00 00 00       	mov    $0x0,%eax
    1238:	e8 43 fe ff ff       	callq  1080 <__printf_chk@plt>
    123d:	eb b2                	jmp    11f1 <main+0x68>
