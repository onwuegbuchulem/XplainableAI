...
/app/bin_gccgcc10_O1/greet03:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11d7:	48 89 f5             	mov    %rsi,%rbp
    11da:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11e1:	00 00 
    11e3:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11e8:	31 c0                	xor    %eax,%eax
    11ea:	49 89 e4             	mov    %rsp,%r12
    11ed:	4c 89 e7             	mov    %r12,%rdi
    11f0:	e8 cb fe ff ff       	callq  10c0 <time@plt>
    11f5:	4c 89 e7             	mov    %r12,%rdi
    11f8:	e8 93 fe ff ff       	callq  1090 <localtime@plt>
    11fd:	44 8b 60 08          	mov    0x8(%rax),%r12d
    1201:	48 8d 35 fc 0d 00 00 	lea    0xdfc(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1208:	bf 01 00 00 00       	mov    $0x1,%edi
    120d:	b8 00 00 00 00       	mov    $0x0,%eax
    1212:	e8 b9 fe ff ff       	callq  10d0 <__printf_chk@plt>
    1217:	41 83 fc 0b          	cmp    $0xb,%r12d
    121b:	7e 50                	jle    126d <main+0xa4>
    121d:	41 83 fc 10          	cmp    $0x10,%r12d
    1221:	7f 62                	jg     1285 <main+0xbc>
    1223:	48 8d 35 e8 0d 00 00 	lea    0xde8(%rip),%rsi        # 2012 <_IO_stdin_used+0x12>
    122a:	bf 01 00 00 00       	mov    $0x1,%edi
    122f:	b8 00 00 00 00       	mov    $0x0,%eax
    1234:	e8 97 fe ff ff       	callq  10d0 <__printf_chk@plt>
    1239:	83 fb 01             	cmp    $0x1,%ebx
    123c:	7f 5f                	jg     129d <main+0xd4>
    123e:	48 8b 35 cb 2d 00 00 	mov    0x2dcb(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1245:	bf 0a 00 00 00       	mov    $0xa,%edi
    124a:	e8 61 fe ff ff       	callq  10b0 <putc@plt>
    124f:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1254:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    125b:	00 00 
    125d:	75 5a                	jne    12b9 <main+0xf0>
    125f:	b8 00 00 00 00       	mov    $0x0,%eax
    1264:	48 83 c4 10          	add    $0x10,%rsp
    1268:	5b                   	pop    %rbx
    1269:	5d                   	pop    %rbp
    126a:	41 5c                	pop    %r12
    126c:	c3                   	retq   
    126d:	48 8d 35 96 0d 00 00 	lea    0xd96(%rip),%rsi        # 200a <_IO_stdin_used+0xa>
    1274:	bf 01 00 00 00       	mov    $0x1,%edi
    1279:	b8 00 00 00 00       	mov    $0x0,%eax
    127e:	e8 4d fe ff ff       	callq  10d0 <__printf_chk@plt>
    1283:	eb b4                	jmp    1239 <main+0x70>
    1285:	48 8d 35 90 0d 00 00 	lea    0xd90(%rip),%rsi        # 201c <_IO_stdin_used+0x1c>
    128c:	bf 01 00 00 00       	mov    $0x1,%edi
    1291:	b8 00 00 00 00       	mov    $0x0,%eax
    1296:	e8 35 fe ff ff       	callq  10d0 <__printf_chk@plt>
    129b:	eb 9c                	jmp    1239 <main+0x70>
    129d:	48 8b 55 08          	mov    0x8(%rbp),%rdx
    12a1:	48 8d 35 7c 0d 00 00 	lea    0xd7c(%rip),%rsi        # 2024 <_IO_stdin_used+0x24>
    12a8:	bf 01 00 00 00       	mov    $0x1,%edi
    12ad:	b8 00 00 00 00       	mov    $0x0,%eax
    12b2:	e8 19 fe ff ff       	callq  10d0 <__printf_chk@plt>
    12b7:	eb 85                	jmp    123e <main+0x75>
    12b9:	e8 e2 fd ff ff       	callq  10a0 <__stack_chk_fail@plt>
