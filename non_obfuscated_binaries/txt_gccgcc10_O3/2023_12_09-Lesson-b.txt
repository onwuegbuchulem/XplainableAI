...
/app/bin_gccgcc10_O3/2023_12_09-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108a:	55                   	push   %rbp
    108b:	48 8d 2d 72 0f 00 00 	lea    0xf72(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1092:	53                   	push   %rbx
    1093:	48 83 ec 20          	sub    $0x20,%rsp
    1097:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    109e:	00 00 
    10a0:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10a5:	31 c0                	xor    %eax,%eax
    10a7:	48 8b 05 5a 0f 00 00 	mov    0xf5a(%rip),%rax        # 2008 <_IO_stdin_used+0x8>
    10ae:	0f 11 04 24          	movups %xmm0,(%rsp)
    10b2:	48 89 e3             	mov    %rsp,%rbx
    10b5:	48 c7 44 24 10 00 00 	movq   $0x0,0x10(%rsp)
    10bc:	00 00 
    10be:	4c 8d 64 24 18       	lea    0x18(%rsp),%r12
    10c3:	48 89 44 24 0c       	mov    %rax,0xc(%rsp)
    10c8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    10cf:	00 
    10d0:	8b 13                	mov    (%rbx),%edx
    10d2:	48 89 ee             	mov    %rbp,%rsi
    10d5:	bf 01 00 00 00       	mov    $0x1,%edi
    10da:	31 c0                	xor    %eax,%eax
    10dc:	48 83 c3 04          	add    $0x4,%rbx
    10e0:	e8 8b ff ff ff       	callq  1070 <__printf_chk@plt>
    10e5:	4c 39 e3             	cmp    %r12,%rbx
    10e8:	75 e6                	jne    10d0 <main+0x50>
    10ea:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10ef:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10f6:	00 00 
    10f8:	75 0b                	jne    1105 <main+0x85>
    10fa:	48 83 c4 20          	add    $0x20,%rsp
    10fe:	31 c0                	xor    %eax,%eax
    1100:	5b                   	pop    %rbx
    1101:	5d                   	pop    %rbp
    1102:	41 5c                	pop    %r12
    1104:	c3                   	retq   
    1105:	e8 56 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
