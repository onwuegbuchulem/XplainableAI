...
/app/bin_gccgcc10_O0/EvenOdd_If_Else:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11f0:	83 e0 01             	and    $0x1,%eax
    11f3:	85 c0                	test   %eax,%eax
    11f5:	75 0e                	jne    1205 <main+0x5c>
    11f7:	48 8d 3d 23 0e 00 00 	lea    0xe23(%rip),%rdi        # 2021 <_IO_stdin_used+0x21>
    11fe:	e8 7d fe ff ff       	callq  1080 <puts@plt>
    1203:	eb 0c                	jmp    1211 <main+0x68>
    1205:	48 8d 3d 26 0e 00 00 	lea    0xe26(%rip),%rdi        # 2032 <_IO_stdin_used+0x32>
    120c:	e8 6f fe ff ff       	callq  1080 <puts@plt>
    1211:	b8 00 00 00 00       	mov    $0x0,%eax
    1216:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    121a:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1221:	00 00 
    1223:	74 05                	je     122a <main+0x81>
