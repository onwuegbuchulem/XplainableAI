...
/app/bin_gccgcc10_O1/03_other_array_init_ways:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1183:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%rsp)
    118a:	00 
    118b:	c7 44 24 10 08 00 00 	movl   $0x8,0x10(%rsp)
    1192:	00 
    1193:	c7 44 24 14 08 00 00 	movl   $0x8,0x14(%rsp)
    119a:	00 
    119b:	bb 00 00 00 00       	mov    $0x0,%ebx
    11a0:	48 8d 2d 61 0e 00 00 	lea    0xe61(%rip),%rbp        # 2008 <_IO_stdin_used+0x8>
    11a7:	8b 4c 9c 0c          	mov    0xc(%rsp,%rbx,4),%ecx
    11ab:	89 da                	mov    %ebx,%edx
    ...
    11bf:	48 83 c3 01          	add    $0x1,%rbx
    11c3:	48 83 fb 03          	cmp    $0x3,%rbx
    11c7:	75 de                	jne    11a7 <main+0x3e>
    11c9:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11ce:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11d5:	00 00 
    11d7:	75 0c                	jne    11e5 <main+0x7c>
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	48 83 c4 28          	add    $0x28,%rsp
    11e2:	5b                   	pop    %rbx
    11e3:	5d                   	pop    %rbp
    11e4:	c3                   	retq   
