...
/app/bin_gccgcc10_O1/2020_03_28-Lesson-a:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    11ef:	55                   	push   %rbp
    11f0:	53                   	push   %rbx
    11f1:	48 81 ec 20 08 00 00 	sub    $0x820,%rsp
    11f8:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11ff:	00 00 
    1201:	48 89 84 24 18 08 00 	mov    %rax,0x818(%rsp)
    1208:	00 
    1209:	31 c0                	xor    %eax,%eax
    120b:	48 b8 67 65 74 74 79 	movabs $0x7562737974746567,%rax
    1212:	73 62 75 
    1215:	48 89 44 24 01       	mov    %rax,0x1(%rsp)
    121a:	c7 44 24 09 72 67 2e 	movl   $0x742e6772,0x9(%rsp)
    1221:	74 
    1222:	66 c7 44 24 0d 78 74 	movw   $0x7478,0xd(%rsp)
    1229:	c6 44 24 0f 00       	movb   $0x0,0xf(%rsp)
    122e:	48 8d 7c 24 01       	lea    0x1(%rsp),%rdi
    1233:	be 00 00 00 00       	mov    $0x0,%esi
    1238:	b8 00 00 00 00       	mov    $0x0,%eax
    123d:	e8 9e fe ff ff       	callq  10e0 <open@plt>
    1242:	83 f8 ff             	cmp    $0xffffffff,%eax
    1245:	74 66                	je     12ad <main+0xc4>
    1247:	41 89 c4             	mov    %eax,%r12d
    124a:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    124f:	ba 00 08 00 00       	mov    $0x800,%edx
    1254:	89 c7                	mov    %eax,%edi
    1256:	e8 65 fe ff ff       	callq  10c0 <read@plt>
    125b:	48 85 c0             	test   %rax,%rax
    125e:	74 21                	je     1281 <main+0x98>
    1260:	48 8d 5c 24 10       	lea    0x10(%rsp),%rbx
    1265:	48 8d 2c 18          	lea    (%rax,%rbx,1),%rbp
    1269:	0f be 3b             	movsbl (%rbx),%edi
    126c:	48 8b 35 ad 2d 00 00 	mov    0x2dad(%rip),%rsi        # 4020 <stdout@@GLIBC_2.2.5>
    1273:	e8 58 fe ff ff       	callq  10d0 <putc@plt>
    1278:	48 83 c3 01          	add    $0x1,%rbx
    127c:	48 39 eb             	cmp    %rbp,%rbx
    127f:	75 e8                	jne    1269 <main+0x80>
    1281:	44 89 e7             	mov    %r12d,%edi
    1284:	e8 27 fe ff ff       	callq  10b0 <close@plt>
    1289:	b8 00 00 00 00       	mov    $0x0,%eax
    128e:	48 8b 8c 24 18 08 00 	mov    0x818(%rsp),%rcx
    1295:	00 
    1296:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    129d:	00 00 
    129f:	75 35                	jne    12d6 <main+0xed>
    12a1:	48 81 c4 20 08 00 00 	add    $0x820,%rsp
    12a8:	5b                   	pop    %rbx
    12a9:	5d                   	pop    %rbp
    12aa:	41 5c                	pop    %r12
    12ac:	c3                   	retq   
    12ad:	48 8d 4c 24 01       	lea    0x1(%rsp),%rcx
    12b2:	48 8d 15 4b 0d 00 00 	lea    0xd4b(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    12b9:	be 01 00 00 00       	mov    $0x1,%esi
    12be:	48 8b 3d 7b 2d 00 00 	mov    0x2d7b(%rip),%rdi        # 4040 <stderr@@GLIBC_2.2.5>
    12c5:	b8 00 00 00 00       	mov    $0x0,%eax
    12ca:	e8 21 fe ff ff       	callq  10f0 <__fprintf_chk@plt>
    12cf:	b8 01 00 00 00       	mov    $0x1,%eax
    12d4:	eb b8                	jmp    128e <main+0xa5>
    12d6:	e8 c5 fd ff ff       	callq  10a0 <__stack_chk_fail@plt>
