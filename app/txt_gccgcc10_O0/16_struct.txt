...
/app/bin_gccgcc10_O0/16_struct:     file format elf64-x86-64
...
0000000000001140 <_start>:
    ...
    1151:	50                   	push   %rax
    1152:	54                   	push   %rsp
    1153:	4c 8d 05 26 02 00 00 	lea    0x226(%rip),%r8        # 1380 <__libc_csu_fini>
    115a:	48 8d 0d af 01 00 00 	lea    0x1af(%rip),%rcx        # 1310 <__libc_csu_init>
...
0000000000001229 <main>:
    ...
    1244:	bf 24 00 00 00       	mov    $0x24,%edi
    1249:	e8 b2 fe ff ff       	callq  1100 <malloc@plt>
    124e:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    1252:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1256:	c7 00 3c 00 00 00    	movl   $0x3c,(%rax)
    125c:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1260:	48 83 c0 04          	add    $0x4,%rax
    1264:	48 be 54 68 69 73 20 	movabs $0x2073692073696854,%rsi
    126b:	69 73 20 
    126e:	48 bf 61 20 73 74 72 	movabs $0x676e697274732061,%rdi
    1275:	69 6e 67 
    1278:	48 89 30             	mov    %rsi,(%rax)
    127b:	48 89 78 08          	mov    %rdi,0x8(%rax)
    127f:	66 c7 40 10 0a 00    	movw   $0xa,0x10(%rax)
    1285:	48 8d 35 78 0d 00 00 	lea    0xd78(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    128c:	48 8d 3d 73 0d 00 00 	lea    0xd73(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1293:	e8 78 fe ff ff       	callq  1110 <fopen@plt>
    1298:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    129c:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
    12a1:	75 0a                	jne    12ad <main+0x84>
    12a3:	bf 01 00 00 00       	mov    $0x1,%edi
    12a8:	e8 73 fe ff ff       	callq  1120 <exit@plt>
    12ad:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    12b1:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    12b5:	48 89 d1             	mov    %rdx,%rcx
    12b8:	ba 01 00 00 00       	mov    $0x1,%edx
    12bd:	be 08 00 00 00       	mov    $0x8,%esi
    12c2:	48 89 c7             	mov    %rax,%rdi
    12c5:	e8 66 fe ff ff       	callq  1130 <fwrite@plt>
    12ca:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    12ce:	48 89 c7             	mov    %rax,%rdi
    12d1:	e8 0a fe ff ff       	callq  10e0 <fclose@plt>
    12d6:	48 8d 3d 32 0d 00 00 	lea    0xd32(%rip),%rdi        # 200f <_IO_stdin_used+0xf>
    12dd:	e8 ee fd ff ff       	callq  10d0 <puts@plt>
    12e2:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    12e6:	48 89 c7             	mov    %rax,%rdi
    12e9:	e8 d2 fd ff ff       	callq  10c0 <free@plt>
    12ee:	b8 00 00 00 00       	mov    $0x0,%eax
    12f3:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    12f7:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    12fe:	00 00 
    1300:	74 05                	je     1307 <main+0xde>
    1302:	e8 e9 fd ff ff       	callq  10f0 <__stack_chk_fail@plt>
    1307:	c9                   	leaveq 
    1308:	c3                   	retq   
...
0000000000001310 <__libc_csu_init>:
    ...
    1314:	41 57                	push   %r15
    1316:	4c 8d 3d 63 2a 00 00 	lea    0x2a63(%rip),%r15        # 3d80 <__frame_dummy_init_array_entry>
    131d:	41 56                	push   %r14
    ...
    132c:	55                   	push   %rbp
    132d:	48 8d 2d 54 2a 00 00 	lea    0x2a54(%rip),%rbp        # 3d88 <__do_global_dtors_aux_fini_array_entry>
    1334:	53                   	push   %rbx
