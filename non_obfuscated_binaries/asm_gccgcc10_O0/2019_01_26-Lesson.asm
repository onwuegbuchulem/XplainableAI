...
/app/bin_gccgcc10_O0/2019_01_26-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	48 b8 67 65 74 74 79 	movabs $0x7562737974746567,%rax
    11ab:	73 62 75 
    11ae:	48 89 45 e9          	mov    %rax,-0x17(%rbp)
    11b2:	c7 45 f1 72 67 2e 74 	movl   $0x742e6772,-0xf(%rbp)
    11b9:	66 c7 45 f5 78 74    	movw   $0x7478,-0xb(%rbp)
    11bf:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    11c3:	48 8d 45 e9          	lea    -0x17(%rbp),%rax
    11c7:	be 00 00 00 00       	mov    $0x0,%esi
    11cc:	48 89 c7             	mov    %rax,%rdi
    11cf:	e8 bc fe ff ff       	callq  1090 <access@plt>
    11d4:	89 45 e4             	mov    %eax,-0x1c(%rbp)
    11d7:	83 7d e4 00          	cmpl   $0x0,-0x1c(%rbp)
    11db:	75 1a                	jne    11f7 <main+0x6e>
    11dd:	48 8d 45 e9          	lea    -0x17(%rbp),%rax
    ...
    11f5:	eb 18                	jmp    120f <main+0x86>
    11f7:	48 8d 45 e9          	lea    -0x17(%rbp),%rax
    11fb:	48 89 c6             	mov    %rax,%rsi
    11fe:	48 8d 3d 11 0e 00 00 	lea    0xe11(%rip),%rdi        # 2016 <_IO_stdin_used+0x16>
    ...
    1223:	e8 48 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1228:	c9                   	leaveq 
    1229:	c3                   	retq   
