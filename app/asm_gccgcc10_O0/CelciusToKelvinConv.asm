...
/app/bin_gccgcc10_O0/CelciusToKelvinConv:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d7:	48 8d 3d 54 0e 00 00 	lea    0xe54(%rip),%rdi        # 2032 <_IO_stdin_used+0x32>
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 c8 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e8:	f2 0f 10 4d e8       	movsd  -0x18(%rbp),%xmm1
    11ed:	f2 0f 10 05 5b 0e 00 	movsd  0xe5b(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    11f4:	00 
    11f5:	f2 0f 58 c1          	addsd  %xmm1,%xmm0
    11f9:	f2 0f 11 45 f0       	movsd  %xmm0,-0x10(%rbp)
    11fe:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1202:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1207:	48 8d 3d 27 0e 00 00 	lea    0xe27(%rip),%rdi        # 2035 <_IO_stdin_used+0x35>
    120e:	b8 01 00 00 00       	mov    $0x1,%eax
    1213:	e8 88 fe ff ff       	callq  10a0 <printf@plt>
    1218:	b8 00 00 00 00       	mov    $0x0,%eax
    121d:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1221:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1228:	00 00 
    122a:	74 05                	je     1231 <main+0x88>
    122c:	e8 5f fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    1231:	c9                   	leaveq 
    1232:	c3                   	retq   
