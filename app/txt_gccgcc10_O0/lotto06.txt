...
/app/bin_gccgcc10_O0/lotto06:     file format elf64-x86-64
...
0000000000001100 <_start>:
    ...
    1111:	50                   	push   %rax
    1112:	54                   	push   %rsp
    1113:	4c 8d 05 b6 03 00 00 	lea    0x3b6(%rip),%r8        # 14d0 <__libc_csu_fini>
    111a:	48 8d 0d 3f 03 00 00 	lea    0x33f(%rip),%rcx        # 1460 <__libc_csu_init>
...
0000000000001339 <main>:
    ...
    1376:	48 8d 45 c0          	lea    -0x40(%rbp),%rax
    137a:	48 89 c7             	mov    %rax,%rdi
    137d:	e8 67 fe ff ff       	callq  11e9 <lotto>
    1382:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%rbp)
    1389:	eb 3a                	jmp    13c5 <main+0x8c>
    138b:	8b 45 bc             	mov    -0x44(%rbp),%eax
    138e:	48 98                	cltq   
    1390:	8b 44 85 c0          	mov    -0x40(%rbp,%rax,4),%eax
    ...
    13aa:	83 7d bc 03          	cmpl   $0x3,-0x44(%rbp)
    ...
    13c1:	83 45 bc 01          	addl   $0x1,-0x44(%rbp)
    13c5:	83 7d bc 04          	cmpl   $0x4,-0x44(%rbp)
    13c9:	7e c0                	jle    138b <main+0x52>
    13cb:	bf 0a 00 00 00       	mov    $0xa,%edi
    13d0:	e8 cb fc ff ff       	callq  10a0 <putchar@plt>
    13d5:	48 8d 3d 40 0c 00 00 	lea    0xc40(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    13dc:	b8 00 00 00 00       	mov    $0x0,%eax
    13e1:	e8 da fc ff ff       	callq  10c0 <printf@plt>
    13e6:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    13ea:	48 89 c7             	mov    %rax,%rdi
    13ed:	e8 f7 fd ff ff       	callq  11e9 <lotto>
    13f2:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%rbp)
    13f9:	eb 3a                	jmp    1435 <main+0xfc>
    13fb:	8b 45 bc             	mov    -0x44(%rbp),%eax
    13fe:	48 98                	cltq   
    1400:	8b 44 85 e0          	mov    -0x20(%rbp,%rax,4),%eax
    1404:	83 c0 01             	add    $0x1,%eax
    1407:	89 c6                	mov    %eax,%esi
    1409:	48 8d 3d 05 0c 00 00 	lea    0xc05(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    1410:	b8 00 00 00 00       	mov    $0x0,%eax
    1415:	e8 a6 fc ff ff       	callq  10c0 <printf@plt>
    141a:	83 7d bc 03          	cmpl   $0x3,-0x44(%rbp)
    141e:	7f 11                	jg     1431 <main+0xf8>
    1420:	48 8d 3d f2 0b 00 00 	lea    0xbf2(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    1427:	b8 00 00 00 00       	mov    $0x0,%eax
    142c:	e8 8f fc ff ff       	callq  10c0 <printf@plt>
    1431:	83 45 bc 01          	addl   $0x1,-0x44(%rbp)
    1435:	83 7d bc 04          	cmpl   $0x4,-0x44(%rbp)
    1439:	7e c0                	jle    13fb <main+0xc2>
    143b:	bf 0a 00 00 00       	mov    $0xa,%edi
    1440:	e8 5b fc ff ff       	callq  10a0 <putchar@plt>
    1445:	b8 00 00 00 00       	mov    $0x0,%eax
    144a:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    144e:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1455:	00 00 
    1457:	74 05                	je     145e <main+0x125>
    1459:	e8 52 fc ff ff       	callq  10b0 <__stack_chk_fail@plt>
    145e:	c9                   	leaveq 
    145f:	c3                   	retq   
