...
/app/bin_gccgcc10_O3/greek_read02:     file format elf64-x86-64
...
0000000000001100 <main>:
    ...
    110c:	48 8d 3d f3 0e 00 00 	lea    0xef3(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1113:	e8 b8 ff ff ff       	callq  10d0 <fopen@plt>
    1118:	31 ff                	xor    %edi,%edi
    111a:	48 8d 35 f4 0e 00 00 	lea    0xef4(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    1121:	48 89 c5             	mov    %rax,%rbp
    1124:	e8 97 ff ff ff       	callq  10c0 <setlocale@plt>
    1129:	48 8d 15 d6 0e 00 00 	lea    0xed6(%rip),%rdx        # 2006 <_IO_stdin_used+0x6>
    1130:	48 8d 35 f1 0e 00 00 	lea    0xef1(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    1137:	31 c0                	xor    %eax,%eax
    1139:	bf 01 00 00 00       	mov    $0x1,%edi
    113e:	e8 9d ff ff ff       	callq  10e0 <__wprintf_chk@plt>
    1143:	eb 08                	jmp    114d <main+0x4d>
    1145:	0f 1f 00             	nopl   (%rax)
    1148:	e8 a3 ff ff ff       	callq  10f0 <putwchar@plt>
    114d:	48 89 ef             	mov    %rbp,%rdi
    1150:	e8 4b ff ff ff       	callq  10a0 <fgetwc@plt>
    1155:	89 c7                	mov    %eax,%edi
    1157:	83 f8 ff             	cmp    $0xffffffff,%eax
    115a:	75 ec                	jne    1148 <main+0x48>
    115c:	bf 0a 00 00 00       	mov    $0xa,%edi
    1161:	e8 8a ff ff ff       	callq  10f0 <putwchar@plt>
    1166:	48 89 ef             	mov    %rbp,%rdi
    1169:	e8 42 ff ff ff       	callq  10b0 <fclose@plt>
