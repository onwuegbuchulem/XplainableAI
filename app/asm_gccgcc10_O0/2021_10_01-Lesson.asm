...
/app/bin_gccgcc10_O0/2021_10_01-Lesson:     file format elf64-x86-64
...
0000000000001090 <strcmp@plt>:
    ...
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <strcmp@GLIBC_2.2.5>
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d ff 00 00 00 	lea    0xff(%rip),%rdi        # 11c7 <main>
...
0000000000001189 <inc>:
    ...
    11a5:	88 10                	mov    %dl,(%rax)
    11a7:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11ab:	0f b6 00             	movzbl (%rax),%eax
    11ae:	3c 5a                	cmp    $0x5a,%al
    11b0:	7e 0e                	jle    11c0 <inc+0x37>
    11b2:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11b6:	c6 00 41             	movb   $0x41,(%rax)
    11b9:	b8 01 00 00 00       	mov    $0x1,%eax
    11be:	eb 05                	jmp    11c5 <inc+0x3c>
...
00000000000011c7 <main>:
    ...
    11e2:	c7 45 f3 41 41 41 41 	movl   $0x41414141,-0xd(%rbp)
    11e9:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    11ed:	eb 54                	jmp    1243 <main+0x7c>
    11ef:	48 8d 45 f3          	lea    -0xd(%rbp),%rax
    11f3:	48 89 c7             	mov    %rax,%rdi
    11f6:	e8 75 fe ff ff       	callq  1070 <puts@plt>
    11fb:	48 8d 45 f3          	lea    -0xd(%rbp),%rax
    11ff:	48 83 c0 03          	add    $0x3,%rax
    1203:	48 89 c7             	mov    %rax,%rdi
    1206:	e8 7e ff ff ff       	callq  1189 <inc>
    120b:	85 c0                	test   %eax,%eax
    120d:	74 34                	je     1243 <main+0x7c>
    120f:	48 8d 45 f3          	lea    -0xd(%rbp),%rax
    1213:	48 83 c0 02          	add    $0x2,%rax
    1217:	48 89 c7             	mov    %rax,%rdi
    121a:	e8 6a ff ff ff       	callq  1189 <inc>
    121f:	85 c0                	test   %eax,%eax
    1221:	74 20                	je     1243 <main+0x7c>
    1223:	48 8d 45 f3          	lea    -0xd(%rbp),%rax
    1227:	48 83 c0 01          	add    $0x1,%rax
    122b:	48 89 c7             	mov    %rax,%rdi
    122e:	e8 56 ff ff ff       	callq  1189 <inc>
    1233:	85 c0                	test   %eax,%eax
    1235:	74 0c                	je     1243 <main+0x7c>
    1237:	48 8d 45 f3          	lea    -0xd(%rbp),%rax
    123b:	48 89 c7             	mov    %rax,%rdi
    123e:	e8 46 ff ff ff       	callq  1189 <inc>
    1243:	48 8d 45 f3          	lea    -0xd(%rbp),%rax
    1247:	48 8d 35 b6 0d 00 00 	lea    0xdb6(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    124e:	48 89 c7             	mov    %rax,%rdi
    1251:	e8 3a fe ff ff       	callq  1090 <strcmp@plt>
    1256:	85 c0                	test   %eax,%eax
    1258:	75 95                	jne    11ef <main+0x28>
    125a:	48 8d 45 f3          	lea    -0xd(%rbp),%rax
    125e:	48 89 c7             	mov    %rax,%rdi
    1261:	e8 0a fe ff ff       	callq  1070 <puts@plt>
    1266:	b8 00 00 00 00       	mov    $0x0,%eax
    126b:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    126f:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1276:	00 00 
    1278:	74 05                	je     127f <main+0xb8>
