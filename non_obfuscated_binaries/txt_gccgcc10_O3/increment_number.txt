...
/app/bin_gccgcc10_O3/increment_number:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10a0:	e8 cb ff ff ff       	callq  1070 <sleep@plt>
    10a5:	31 c0                	xor    %eax,%eax
    10a7:	89 da                	mov    %ebx,%edx
    10a9:	48 89 ee             	mov    %rbp,%rsi
    10ac:	bf 01 00 00 00       	mov    $0x1,%edi
    10b1:	e8 aa ff ff ff       	callq  1060 <__printf_chk@plt>
    10b6:	83 fb 64             	cmp    $0x64,%ebx
    10b9:	75 dd                	jne    1098 <main+0x18>
