...
/app/bin_gccgcc10_O3/assignment14:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10a9:	c7 44 24 04 15 00 00 	movl   $0x15,0x4(%rsp)
    10b0:	00 
    10b1:	e8 ba ff ff ff       	callq  1070 <__printf_chk@plt>
    10b6:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10bb:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10c2:	00 00 
    10c4:	75 07                	jne    10cd <main+0x4d>
    10c6:	31 c0                	xor    %eax,%eax
    10c8:	48 83 c4 18          	add    $0x18,%rsp
    10cc:	c3                   	retq   
    10cd:	e8 8e ff ff ff       	callq  1060 <__stack_chk_fail@plt>
    10d2:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10d9:	00 00 00 
