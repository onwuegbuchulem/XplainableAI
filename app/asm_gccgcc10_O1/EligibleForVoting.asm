...
/app/bin_gccgcc10_O1/EligibleForVoting:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11cc:	83 f8 11             	cmp    $0x11,%eax
    11cf:	7f 34                	jg     1205 <main+0x7c>
    11d1:	85 c0                	test   %eax,%eax
    11d3:	7e 48                	jle    121d <main+0x94>
    11d5:	48 8d 35 74 0e 00 00 	lea    0xe74(%rip),%rsi        # 2050 <_IO_stdin_used+0x50>
    ...
    11f7:	00 00 
    11f9:	75 3a                	jne    1235 <main+0xac>
    11fb:	b8 00 00 00 00       	mov    $0x0,%eax
    1200:	48 83 c4 18          	add    $0x18,%rsp
    1204:	c3                   	retq   
    1205:	48 8d 35 0c 0e 00 00 	lea    0xe0c(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    120c:	bf 01 00 00 00       	mov    $0x1,%edi
    1211:	b8 00 00 00 00       	mov    $0x0,%eax
    1216:	e8 65 fe ff ff       	callq  1080 <__printf_chk@plt>
    121b:	eb ce                	jmp    11eb <main+0x62>
    121d:	48 8d 35 11 0e 00 00 	lea    0xe11(%rip),%rsi        # 2035 <_IO_stdin_used+0x35>
    1224:	bf 01 00 00 00       	mov    $0x1,%edi
    1229:	b8 00 00 00 00       	mov    $0x0,%eax
    122e:	e8 4d fe ff ff       	callq  1080 <__printf_chk@plt>
    1233:	eb b6                	jmp    11eb <main+0x62>
