...
/app/bin_gccgcc10_O2/GoTo_Program:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108c:	53                   	push   %rbx
    108d:	bb 0a 00 00 00       	mov    $0xa,%ebx
    1092:	48 83 ec 08          	sub    $0x8,%rsp
    1096:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    109d:	00 00 00 
    10a0:	48 89 ef             	mov    %rbp,%rdi
    10a3:	e8 b8 ff ff ff       	callq  1060 <puts@plt>
    10a8:	83 eb 01             	sub    $0x1,%ebx
    10ab:	75 f3                	jne    10a0 <main+0x20>
    10ad:	bb 01 00 00 00       	mov    $0x1,%ebx
    10b2:	48 8d 2d 59 0f 00 00 	lea    0xf59(%rip),%rbp        # 2012 <_IO_stdin_used+0x12>
    10b9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    10c0:	89 da                	mov    %ebx,%edx
    ...
    10d4:	83 fb 0b             	cmp    $0xb,%ebx
    10d7:	75 e7                	jne    10c0 <main+0x40>
