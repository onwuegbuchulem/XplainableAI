...
/app/bin_gccgcc10_O2/2019_01_05-Lesson-c:     file format elf64-x86-64
...
0000000000001070 <ctime@plt>:
    1070:	f3 0f 1e fa          	endbr64 
    1074:	f2 ff 25 45 2f 00 00 	bnd jmpq *0x2f45(%rip)        # 3fc0 <ctime@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10b6:	48 b8 00 d8 2a 34 f1 	movabs $0xfffffff1342ad800,%rax
    10bd:	ff ff ff 
    10c0:	48 89 e7             	mov    %rsp,%rdi
    10c3:	48 89 04 24          	mov    %rax,(%rsp)
    10c7:	e8 a4 ff ff ff       	callq  1070 <ctime@plt>
    ...
    10dd:	e8 ae ff ff ff       	callq  1090 <__printf_chk@plt>
    10e2:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10e7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10ee:	00 00 
    10f0:	75 07                	jne    10f9 <main+0x59>
    10f2:	31 c0                	xor    %eax,%eax
    10f4:	48 83 c4 18          	add    $0x18,%rsp
    10f8:	c3                   	retq   
    10f9:	e8 82 ff ff ff       	callq  1080 <__stack_chk_fail@plt>
