...
/app/bin_gccgcc10_O1/RecursiveFactorial:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d de 00 00 00 	lea    0xde(%rip),%rdi        # 11a6 <main>
...
0000000000001189 <factorial>:
    ...
    1193:	75 04                	jne    1199 <factorial+0x10>
    1195:	89 d8                	mov    %ebx,%eax
    1197:	5b                   	pop    %rbx
    1198:	c3                   	retq   
    1199:	8d 7f ff             	lea    -0x1(%rdi),%edi
    119c:	e8 e8 ff ff ff       	callq  1189 <factorial>
    11a1:	0f af d8             	imul   %eax,%ebx
    11a4:	eb ef                	jmp    1195 <factorial+0xc>

00000000000011a6 <main>:
    11a6:	f3 0f 1e fa          	endbr64 
    11aa:	53                   	push   %rbx
    11ab:	48 83 ec 10          	sub    $0x10,%rsp
    11af:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11b6:	00 00 
    11b8:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    ...
    11d0:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11d5:	48 8d 3d 51 0e 00 00 	lea    0xe51(%rip),%rdi        # 202d <_IO_stdin_used+0x2d>
    11dc:	b8 00 00 00 00       	mov    $0x0,%eax
    11e1:	e8 aa fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11e6:	8b 5c 24 04          	mov    0x4(%rsp),%ebx
    11ea:	89 df                	mov    %ebx,%edi
    11ec:	e8 98 ff ff ff       	callq  1189 <factorial>
    11f1:	89 c1                	mov    %eax,%ecx
    11f3:	89 da                	mov    %ebx,%edx
    11f5:	48 8d 35 21 0e 00 00 	lea    0xe21(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    ...
    1217:	00 00 
    1219:	75 0b                	jne    1226 <main+0x80>
    121b:	b8 00 00 00 00       	mov    $0x0,%eax
    1220:	48 83 c4 10          	add    $0x10,%rsp
    1224:	5b                   	pop    %rbx
    1225:	c3                   	retq   
    1226:	e8 45 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
