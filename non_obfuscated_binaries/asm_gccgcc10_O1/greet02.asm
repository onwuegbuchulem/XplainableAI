...
/app/bin_gccgcc10_O1/greet02:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1174:	7e 24                	jle    119a <main+0x31>
    1176:	48 8b 56 08          	mov    0x8(%rsi),%rdx
    117a:	48 8d 35 9e 0e 00 00 	lea    0xe9e(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    1181:	bf 01 00 00 00       	mov    $0x1,%edi
    1186:	b8 00 00 00 00       	mov    $0x0,%eax
    118b:	e8 e0 fe ff ff       	callq  1070 <__printf_chk@plt>
