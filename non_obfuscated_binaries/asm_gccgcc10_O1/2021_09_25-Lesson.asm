...
/app/bin_gccgcc10_O1/2021_09_25-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119a:	e8 d1 fe ff ff       	callq  1070 <puts@plt>
    119f:	83 3d 0a 2c 00 00 01 	cmpl   $0x1,0x2c0a(%rip)        # 3db0 <sys_nerr@@GLIBC_2.12>
    11a6:	7e 35                	jle    11dd <main+0x54>
    11a8:	bb 01 00 00 00       	mov    $0x1,%ebx
    11ad:	48 8d 2d 67 0e 00 00 	lea    0xe67(%rip),%rbp        # 201b <_IO_stdin_used+0x1b>
    11b4:	89 df                	mov    %ebx,%edi
    11b6:	e8 d5 fe ff ff       	callq  1090 <strerror@plt>
    11bb:	48 89 c1             	mov    %rax,%rcx
    11be:	89 da                	mov    %ebx,%edx
    11c0:	48 89 ee             	mov    %rbp,%rsi
    11c3:	bf 01 00 00 00       	mov    $0x1,%edi
    11c8:	b8 00 00 00 00       	mov    $0x0,%eax
    11cd:	e8 ae fe ff ff       	callq  1080 <__printf_chk@plt>
    11d2:	83 c3 01             	add    $0x1,%ebx
    11d5:	39 1d d5 2b 00 00    	cmp    %ebx,0x2bd5(%rip)        # 3db0 <sys_nerr@@GLIBC_2.12>
    11db:	7f d7                	jg     11b4 <main+0x2b>
    11dd:	b8 00 00 00 00       	mov    $0x0,%eax
    11e2:	48 83 c4 08          	add    $0x8,%rsp
    11e6:	5b                   	pop    %rbx
    11e7:	5d                   	pop    %rbp
    11e8:	c3                   	retq   
