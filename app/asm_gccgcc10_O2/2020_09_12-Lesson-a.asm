...
/app/bin_gccgcc10_O2/2020_09_12-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ce:	4c 89 e6             	mov    %r12,%rsi
    10d1:	48 8d 3d 33 0f 00 00 	lea    0xf33(%rip),%rdi        # 200b <_IO_stdin_used+0xb>
    ...
    10e9:	48 8d 35 22 0f 00 00 	lea    0xf22(%rip),%rsi        # 2012 <_IO_stdin_used+0x12>
    10f0:	e8 8b ff ff ff       	callq  1080 <__printf_chk@plt>
    10f5:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    10fa:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1101:	00 00 
    1103:	75 09                	jne    110e <main+0x6e>
    1105:	48 83 c4 30          	add    $0x30,%rsp
    1109:	31 c0                	xor    %eax,%eax
    110b:	41 5c                	pop    %r12
    110d:	c3                   	retq   
    110e:	e8 5d ff ff ff       	callq  1070 <__stack_chk_fail@plt>
