...
/app/bin_gccgcc10_O0/hexdecode01:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	c7 45 b8 00 00 00 00 	movl   $0x0,-0x48(%rbp)
    11ab:	eb 5b                	jmp    1208 <main+0x7f>
    11ad:	8b 45 bc             	mov    -0x44(%rbp),%eax
    11b0:	89 c2                	mov    %eax,%edx
    11b2:	8b 45 b8             	mov    -0x48(%rbp),%eax
    11b5:	48 98                	cltq   
    11b7:	88 54 05 c0          	mov    %dl,-0x40(%rbp,%rax,1)
    11bb:	83 45 b8 01          	addl   $0x1,-0x48(%rbp)
    11bf:	83 7d bc 0a          	cmpl   $0xa,-0x44(%rbp)
    11c3:	74 06                	je     11cb <main+0x42>
    11c5:	83 7d b8 37          	cmpl   $0x37,-0x48(%rbp)
    11c9:	75 3d                	jne    1208 <main+0x7f>
    11cb:	8b 45 b8             	mov    -0x48(%rbp),%eax
    11ce:	83 e8 01             	sub    $0x1,%eax
    11d1:	48 98                	cltq   
    11d3:	0f b6 44 05 c0       	movzbl -0x40(%rbp,%rax,1),%eax
    11d8:	3c 0a                	cmp    $0xa,%al
    11da:	75 0f                	jne    11eb <main+0x62>
    11dc:	8b 45 b8             	mov    -0x48(%rbp),%eax
    11df:	83 e8 01             	sub    $0x1,%eax
    11e2:	48 98                	cltq   
    11e4:	c6 44 05 c0 00       	movb   $0x0,-0x40(%rbp,%rax,1)
    11e9:	eb 0a                	jmp    11f5 <main+0x6c>
    11eb:	8b 45 b8             	mov    -0x48(%rbp),%eax
    11ee:	48 98                	cltq   
    11f0:	c6 44 05 c0 00       	movb   $0x0,-0x40(%rbp,%rax,1)
    11f5:	48 8d 45 c0          	lea    -0x40(%rbp),%rax
    11f9:	48 89 c7             	mov    %rax,%rdi
    11fc:	e8 6f fe ff ff       	callq  1070 <puts@plt>
    1201:	c7 45 b8 00 00 00 00 	movl   $0x0,-0x48(%rbp)
    1208:	e8 83 fe ff ff       	callq  1090 <getchar@plt>
    120d:	89 45 bc             	mov    %eax,-0x44(%rbp)
    1210:	83 7d bc ff          	cmpl   $0xffffffff,-0x44(%rbp)
    1214:	75 97                	jne    11ad <main+0x24>
    1216:	b8 00 00 00 00       	mov    $0x0,%eax
    121b:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    121f:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1226:	00 00 
    1228:	74 05                	je     122f <main+0xa6>
    122a:	e8 51 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    122f:	c9                   	leaveq 
    1230:	c3                   	retq   
