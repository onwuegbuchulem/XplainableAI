...
/app/bin_gccgcc10_O1/getcwd:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b1:	00 00 
    11b3:	48 89 84 24 08 20 00 	mov    %rax,0x2008(%rsp)
    11ba:	00 
    11bb:	31 c0                	xor    %eax,%eax
    11bd:	48 89 e3             	mov    %rsp,%rbx
    11c0:	be 00 20 00 00       	mov    $0x2000,%esi
    11c5:	48 89 df             	mov    %rbx,%rdi
    11c8:	e8 b3 fe ff ff       	callq  1080 <getcwd@plt>
    ...
    11e6:	48 8b 84 24 08 20 00 	mov    0x2008(%rsp),%rax
    11ed:	00 
    11ee:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f5:	00 00 
    11f7:	75 0e                	jne    1207 <main+0x7e>
    11f9:	b8 00 00 00 00       	mov    $0x0,%eax
    11fe:	48 81 c4 10 20 00 00 	add    $0x2010,%rsp
    1205:	5b                   	pop    %rbx
    1206:	c3                   	retq   
