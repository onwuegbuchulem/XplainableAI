...
/app/bin_gccgcc10_O2/2023_08_01-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108c:	53                   	push   %rbx
    108d:	48 83 ec 48          	sub    $0x48,%rsp
    1091:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1098:	00 00 
    109a:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    109f:	48 8d 05 6d 0f 00 00 	lea    0xf6d(%rip),%rax        # 2013 <_IO_stdin_used+0x13>
    10a6:	48 8d 5c 24 08       	lea    0x8(%rsp),%rbx
    10ab:	48 8d 6c 24 38       	lea    0x38(%rsp),%rbp
    10b0:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10b5:	48 8d 05 71 0f 00 00 	lea    0xf71(%rip),%rax        # 202d <_IO_stdin_used+0x2d>
    10bc:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    10c1:	48 8d 05 6f 0f 00 00 	lea    0xf6f(%rip),%rax        # 2037 <_IO_stdin_used+0x37>
    10c8:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10cd:	48 8d 05 73 0f 00 00 	lea    0xf73(%rip),%rax        # 2047 <_IO_stdin_used+0x47>
    10d4:	48 89 44 24 20       	mov    %rax,0x20(%rsp)
    10d9:	48 8d 05 76 0f 00 00 	lea    0xf76(%rip),%rax        # 2056 <_IO_stdin_used+0x56>
    10e0:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    10e5:	48 8d 05 7c 0f 00 00 	lea    0xf7c(%rip),%rax        # 2068 <_IO_stdin_used+0x68>
    10ec:	48 89 44 24 30       	mov    %rax,0x30(%rsp)
    10f1:	eb 0c                	jmp    10ff <main+0x7f>
    10f3:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10f8:	48 8b 3b             	mov    (%rbx),%rdi
    10fb:	48 83 c3 08          	add    $0x8,%rbx
    10ff:	e8 5c ff ff ff       	callq  1060 <puts@plt>
    1104:	48 39 eb             	cmp    %rbp,%rbx
    1107:	75 ef                	jne    10f8 <main+0x78>
    1109:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    110e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1115:	00 00 
    1117:	75 09                	jne    1122 <main+0xa2>
    1119:	48 83 c4 48          	add    $0x48,%rsp
    111d:	31 c0                	xor    %eax,%eax
    111f:	5b                   	pop    %rbx
    1120:	5d                   	pop    %rbp
    1121:	c3                   	retq   
    1122:	e8 49 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
