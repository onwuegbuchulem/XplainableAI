...
/app/bin_gccgcc10_O2/binary_to_hexadecimal:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10cc:	48 8d 3d 4b 0f 00 00 	lea    0xf4b(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    10d3:	31 c0                	xor    %eax,%eax
    10d5:	e8 b6 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10da:	48 8b 0c 24          	mov    (%rsp),%rcx
    10de:	48 85 c9             	test   %rcx,%rcx
    10e1:	74 7a                	je     115d <main+0xbd>
    10e3:	be 01 00 00 00       	mov    $0x1,%esi
    10e8:	45 31 c0             	xor    %r8d,%r8d
    10eb:	48 bf 67 66 66 66 66 	movabs $0x6666666666666667,%rdi
    10f2:	66 66 66 
    10f5:	0f 1f 00             	nopl   (%rax)
    10f8:	48 89 c8             	mov    %rcx,%rax
    10fb:	48 f7 ef             	imul   %rdi
    10fe:	48 89 c8             	mov    %rcx,%rax
    1101:	48 c1 f8 3f          	sar    $0x3f,%rax
    1105:	48 c1 fa 02          	sar    $0x2,%rdx
    1109:	48 29 c2             	sub    %rax,%rdx
    110c:	48 8d 04 92          	lea    (%rdx,%rdx,4),%rax
    1110:	48 01 c0             	add    %rax,%rax
    1113:	48 29 c1             	sub    %rax,%rcx
    1116:	48 0f af ce          	imul   %rsi,%rcx
    111a:	48 01 f6             	add    %rsi,%rsi
    111d:	49 01 c8             	add    %rcx,%r8
    1120:	48 89 d1             	mov    %rdx,%rcx
    1123:	48 85 d2             	test   %rdx,%rdx
    1126:	75 d0                	jne    10f8 <main+0x58>
    1128:	48 c7 04 24 00 00 00 	movq   $0x0,(%rsp)
    112f:	00 
    1130:	31 c0                	xor    %eax,%eax
    1132:	4c 89 c2             	mov    %r8,%rdx
    1135:	bf 01 00 00 00       	mov    $0x1,%edi
    113a:	48 8d 35 e7 0e 00 00 	lea    0xee7(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    ...
    1152:	00 00 
    1154:	75 0c                	jne    1162 <main+0xc2>
    1156:	31 c0                	xor    %eax,%eax
    1158:	48 83 c4 18          	add    $0x18,%rsp
    115c:	c3                   	retq   
    115d:	45 31 c0             	xor    %r8d,%r8d
    1160:	eb ce                	jmp    1130 <main+0x90>
