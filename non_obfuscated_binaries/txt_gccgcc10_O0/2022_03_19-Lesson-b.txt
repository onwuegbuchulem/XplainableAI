...
/app/bin_gccgcc10_O0/2022_03_19-Lesson-b:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1164:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    1168:	48 89 45 c8          	mov    %rax,-0x38(%rbp)
    116c:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%rbp)
    1173:	eb 14                	jmp    1189 <main+0x40>
    1175:	8b 45 c4             	mov    -0x3c(%rbp),%eax
    1178:	48 63 d0             	movslq %eax,%rdx
    117b:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    117f:	48 01 d0             	add    %rdx,%rax
    1182:	c6 00 00             	movb   $0x0,(%rax)
    1185:	83 45 c4 01          	addl   $0x1,-0x3c(%rbp)
    1189:	8b 45 c4             	mov    -0x3c(%rbp),%eax
    118c:	83 f8 27             	cmp    $0x27,%eax
    118f:	76 e4                	jbe    1175 <main+0x2c>
    1191:	b8 00 00 00 00       	mov    $0x0,%eax
    1196:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    119a:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11a1:	00 00 
    11a3:	74 05                	je     11aa <main+0x61>
    11a5:	e8 a6 fe ff ff       	callq  1050 <__stack_chk_fail@plt>
    11aa:	c9                   	leaveq 
    11ab:	c3                   	retq   
