...
/app/bin_gccgcc10_O0/07_switch:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11dc:	48 8d 3d 2b 0e 00 00 	lea    0xe2b(%rip),%rdi        # 200e <_IO_stdin_used+0xe>
    ...
    11f3:	74 45                	je     123a <main+0x91>
    11f5:	83 f8 04             	cmp    $0x4,%eax
    11f8:	7f 4e                	jg     1248 <main+0x9f>
    11fa:	83 f8 03             	cmp    $0x3,%eax
    11fd:	74 2d                	je     122c <main+0x83>
    11ff:	83 f8 03             	cmp    $0x3,%eax
    1202:	7f 44                	jg     1248 <main+0x9f>
    1204:	83 f8 01             	cmp    $0x1,%eax
    1207:	74 07                	je     1210 <main+0x67>
    1209:	83 f8 02             	cmp    $0x2,%eax
    120c:	74 10                	je     121e <main+0x75>
    120e:	eb 38                	jmp    1248 <main+0x9f>
    1210:	48 8d 3d fa 0d 00 00 	lea    0xdfa(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    1217:	e8 64 fe ff ff       	callq  1080 <puts@plt>
    121c:	eb 3b                	jmp    1259 <main+0xb0>
    121e:	48 8d 3d fa 0d 00 00 	lea    0xdfa(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    1225:	e8 56 fe ff ff       	callq  1080 <puts@plt>
    122a:	eb 2d                	jmp    1259 <main+0xb0>
    122c:	48 8d 3d fa 0d 00 00 	lea    0xdfa(%rip),%rdi        # 202d <_IO_stdin_used+0x2d>
    1233:	e8 48 fe ff ff       	callq  1080 <puts@plt>
    1238:	eb 1f                	jmp    1259 <main+0xb0>
    123a:	48 8d 3d fa 0d 00 00 	lea    0xdfa(%rip),%rdi        # 203b <_IO_stdin_used+0x3b>
    1241:	e8 3a fe ff ff       	callq  1080 <puts@plt>
    1246:	eb 11                	jmp    1259 <main+0xb0>
    1248:	48 8d 3d fa 0d 00 00 	lea    0xdfa(%rip),%rdi        # 2049 <_IO_stdin_used+0x49>
    124f:	b8 00 00 00 00       	mov    $0x0,%eax
    1254:	e8 47 fe ff ff       	callq  10a0 <printf@plt>
    1259:	b8 00 00 00 00       	mov    $0x0,%eax
    125e:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1262:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1269:	00 00 
    126b:	74 05                	je     1272 <main+0xc9>
    126d:	e8 1e fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    1272:	c9                   	leaveq 
    1273:	c3                   	retq   
