...
/app/bin_gccgcc10_O1/so1:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ba:	8b 7c 24 04          	mov    0x4(%rsp),%edi
    11be:	83 ff 01             	cmp    $0x1,%edi
    11c1:	7e 54                	jle    1217 <main+0x8e>
    11c3:	b8 02 00 00 00       	mov    $0x2,%eax
    11c8:	be 01 00 00 00       	mov    $0x1,%esi
    11cd:	ba 00 00 00 00       	mov    $0x0,%edx
    11d2:	eb 02                	jmp    11d6 <main+0x4d>
    11d4:	89 c8                	mov    %ecx,%eax
    11d6:	8d 0c 02             	lea    (%rdx,%rax,1),%ecx
    11d9:	a8 01                	test   $0x1,%al
    11db:	0f 44 d1             	cmove  %ecx,%edx
    11de:	8d 0c 06             	lea    (%rsi,%rax,1),%ecx
    11e1:	89 c6                	mov    %eax,%esi
    11e3:	39 f9                	cmp    %edi,%ecx
    11e5:	7e ed                	jle    11d4 <main+0x4b>
    11e7:	48 8d 35 19 0e 00 00 	lea    0xe19(%rip),%rsi        # 2007 <_IO_stdin_used+0x7>
    11ee:	bf 01 00 00 00       	mov    $0x1,%edi
    11f3:	b8 00 00 00 00       	mov    $0x0,%eax
    11f8:	e8 83 fe ff ff       	callq  1080 <__printf_chk@plt>
    11fd:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1202:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1209:	00 00 
    120b:	75 11                	jne    121e <main+0x95>
    120d:	b8 00 00 00 00       	mov    $0x0,%eax
    1212:	48 83 c4 18          	add    $0x18,%rsp
    1216:	c3                   	retq   
    1217:	ba 00 00 00 00       	mov    $0x0,%edx
    121c:	eb c9                	jmp    11e7 <main+0x5e>
