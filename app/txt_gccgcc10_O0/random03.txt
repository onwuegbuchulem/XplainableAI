...
/app/bin_gccgcc10_O0/random03:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11d5:	c7 45 f8 05 00 00 00 	movl   $0x5,-0x8(%rbp)
    11dc:	bf 00 00 00 00       	mov    $0x0,%edi
    11e1:	e8 da fe ff ff       	callq  10c0 <time@plt>
    11e6:	89 c7                	mov    %eax,%edi
    11e8:	e8 c3 fe ff ff       	callq  10b0 <srand@plt>
    11ed:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%rbp)
    11f4:	eb 63                	jmp    1259 <main+0x90>
    11f6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
    11fd:	eb 44                	jmp    1243 <main+0x7a>
    11ff:	e8 cc fe ff ff       	callq  10d0 <rand@plt>
    1204:	48 63 d0             	movslq %eax,%rdx
    1207:	48 69 d2 1f 85 eb 51 	imul   $0x51eb851f,%rdx,%rdx
    120e:	48 c1 ea 20          	shr    $0x20,%rdx
    1212:	c1 fa 05             	sar    $0x5,%edx
    1215:	89 c1                	mov    %eax,%ecx
    1217:	c1 f9 1f             	sar    $0x1f,%ecx
    121a:	29 ca                	sub    %ecx,%edx
    121c:	6b ca 64             	imul   $0x64,%edx,%ecx
    121f:	29 c8                	sub    %ecx,%eax
    1221:	89 c2                	mov    %eax,%edx
    1223:	8d 42 01             	lea    0x1(%rdx),%eax
    ...
    123a:	e8 61 fe ff ff       	callq  10a0 <printf@plt>
    123f:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    1243:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1246:	3b 45 f8             	cmp    -0x8(%rbp),%eax
    1249:	7c b4                	jl     11ff <main+0x36>
    124b:	bf 0a 00 00 00       	mov    $0xa,%edi
    1250:	e8 3b fe ff ff       	callq  1090 <putchar@plt>
    1255:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    1259:	8b 45 f0             	mov    -0x10(%rbp),%eax
    125c:	3b 45 f8             	cmp    -0x8(%rbp),%eax
    125f:	7c 95                	jl     11f6 <main+0x2d>
