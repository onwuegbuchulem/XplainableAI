...
/app/bin_gccgcc10_O1/05_recursion:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d e0 00 00 00 	lea    0xe0(%rip),%rdi        # 1168 <main>
...
0000000000001149 <factorial>:
    ...
    1152:	83 ff 01             	cmp    $0x1,%edi
    1155:	76 10                	jbe    1167 <factorial+0x1e>
    1157:	53                   	push   %rbx
    1158:	89 fb                	mov    %edi,%ebx
    115a:	8d 7f ff             	lea    -0x1(%rdi),%edi
    115d:	e8 e7 ff ff ff       	callq  1149 <factorial>
    1162:	0f af c3             	imul   %ebx,%eax
    1165:	5b                   	pop    %rbx
    1166:	c3                   	retq   
    1167:	c3                   	retq   
...
0000000000001168 <main>:
    ...
    1175:	e8 cf ff ff ff       	callq  1149 <factorial>
    117a:	89 c1                	mov    %eax,%ecx
    117c:	ba 06 00 00 00       	mov    $0x6,%edx
    ...
    1192:	e8 b9 fe ff ff       	callq  1050 <__printf_chk@plt>
