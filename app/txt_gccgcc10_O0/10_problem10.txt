...
/app/bin_gccgcc10_O0/10_problem10:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1163:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    1167:	74 06                	je     116f <main+0x26>
    1169:	83 7d fc 01          	cmpl   $0x1,-0x4(%rbp)
    116d:	75 09                	jne    1178 <main+0x2f>
    116f:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    1176:	eb 31                	jmp    11a9 <main+0x60>
    1178:	c7 45 f8 02 00 00 00 	movl   $0x2,-0x8(%rbp)
    117f:	eb 20                	jmp    11a1 <main+0x58>
    1181:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1184:	99                   	cltd   
    1185:	f7 7d f8             	idivl  -0x8(%rbp)
    1188:	89 d0                	mov    %edx,%eax
    118a:	85 c0                	test   %eax,%eax
    118c:	75 0f                	jne    119d <main+0x54>
    118e:	83 7d fc 02          	cmpl   $0x2,-0x4(%rbp)
    1192:	74 09                	je     119d <main+0x54>
    1194:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    119b:	eb 0c                	jmp    11a9 <main+0x60>
    119d:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11a1:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11a4:	3b 45 fc             	cmp    -0x4(%rbp),%eax
    11a7:	7c d8                	jl     1181 <main+0x38>
    11a9:	83 7d f4 00          	cmpl   $0x0,-0xc(%rbp)
    11ad:	74 18                	je     11c7 <main+0x7e>
    ...
    11c5:	eb 16                	jmp    11dd <main+0x94>
    11c7:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11ca:	89 c6                	mov    %eax,%esi
    11cc:	48 8d 3d 42 0e 00 00 	lea    0xe42(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    11d3:	b8 00 00 00 00       	mov    $0x0,%eax
    11d8:	e8 73 fe ff ff       	callq  1050 <printf@plt>
