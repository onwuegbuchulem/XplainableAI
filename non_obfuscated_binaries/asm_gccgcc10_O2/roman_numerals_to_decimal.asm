...
/app/bin_gccgcc10_O2/roman_numerals_to_decimal:     file format elf64-x86-64
...
0000000000001310 <_start>:
    ...
    1321:	50                   	push   %rax
    1322:	54                   	push   %rsp
    1323:	4c 8d 05 06 02 00 00 	lea    0x206(%rip),%r8        # 1530 <__libc_csu_fini>
    132a:	48 8d 0d 8f 01 00 00 	lea    0x18f(%rip),%rcx        # 14c0 <__libc_csu_init>
...
0000000000001420 <roman_to_decimal>:
    ...
    142f:	45 31 c9             	xor    %r9d,%r9d
    1432:	4c 8d 15 67 0c 00 00 	lea    0xc67(%rip),%r10        # 20a0 <CSWTCH.2>
    1439:	48 89 c7             	mov    %rax,%rdi
    143c:	0f 1f 40 00          	nopl   0x0(%rax)
    1440:	48 63 d1             	movslq %ecx,%rdx
    1443:	48 39 fa             	cmp    %rdi,%rdx
    1446:	73 49                	jae    1491 <roman_to_decimal+0x71>
    1448:	0f b6 04 13          	movzbl (%rbx,%rdx,1),%eax
    144c:	8d 71 01             	lea    0x1(%rcx),%esi
    144f:	4c 63 c6             	movslq %esi,%r8
    1452:	83 e8 43             	sub    $0x43,%eax
    1455:	49 39 f8             	cmp    %rdi,%r8
    1458:	73 46                	jae    14a0 <roman_to_decimal+0x80>
    145a:	45 31 c0             	xor    %r8d,%r8d
    145d:	3c 15                	cmp    $0x15,%al
    145f:	77 07                	ja     1468 <roman_to_decimal+0x48>
    1461:	0f b6 c0             	movzbl %al,%eax
    1464:	45 8b 04 82          	mov    (%r10,%rax,4),%r8d
    1468:	0f b6 44 13 01       	movzbl 0x1(%rbx,%rdx,1),%eax
    146d:	83 e8 43             	sub    $0x43,%eax
    1470:	3c 15                	cmp    $0x15,%al
    1472:	77 3c                	ja     14b0 <roman_to_decimal+0x90>
    1474:	0f b6 c0             	movzbl %al,%eax
    1477:	41 8b 04 82          	mov    (%r10,%rax,4),%eax
    147b:	44 39 c0             	cmp    %r8d,%eax
    147e:	7e 30                	jle    14b0 <roman_to_decimal+0x90>
    1480:	83 c1 02             	add    $0x2,%ecx
    1483:	44 29 c0             	sub    %r8d,%eax
    1486:	48 63 d1             	movslq %ecx,%rdx
    1489:	41 01 c1             	add    %eax,%r9d
    148c:	48 39 fa             	cmp    %rdi,%rdx
    148f:	72 b7                	jb     1448 <roman_to_decimal+0x28>
    1491:	44 89 c8             	mov    %r9d,%eax
    1494:	5b                   	pop    %rbx
    1495:	c3                   	retq   
    1496:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    149d:	00 00 00 
    14a0:	3c 15                	cmp    $0x15,%al
    14a2:	77 07                	ja     14ab <roman_to_decimal+0x8b>
    14a4:	0f b6 c0             	movzbl %al,%eax
    14a7:	45 03 0c 82          	add    (%r10,%rax,4),%r9d
    14ab:	89 f1                	mov    %esi,%ecx
    14ad:	eb 91                	jmp    1440 <roman_to_decimal+0x20>
    14af:	90                   	nop
    14b0:	45 01 c1             	add    %r8d,%r9d
    14b3:	89 f1                	mov    %esi,%ecx
    14b5:	eb 89                	jmp    1440 <roman_to_decimal+0x20>
