...
/app/bin_gccgcc10_O2/yen01:     file format elf64-x86-64
...
0000000000001060 <setlocale@plt>:
    1060:	f3 0f 1e fa          	endbr64 
    1064:	f2 ff 25 5d 2f 00 00 	bnd jmpq *0x2f5d(%rip)        # 3fc8 <setlocale@GLIBC_2.2.5>
...
0000000000001080 <main>:
    ...
    108f:	31 ff                	xor    %edi,%edi
    1091:	e8 ca ff ff ff       	callq  1060 <setlocale@plt>
    1096:	ba a5 00 00 00       	mov    $0xa5,%edx
    109b:	48 8d 35 6e 0f 00 00 	lea    0xf6e(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    10a2:	31 c0                	xor    %eax,%eax
    10a4:	bf 01 00 00 00       	mov    $0x1,%edi
    10a9:	e8 c2 ff ff ff       	callq  1070 <__wprintf_chk@plt>
    10ae:	31 c0                	xor    %eax,%eax
    10b0:	48 83 c4 08          	add    $0x8,%rsp
    10b4:	c3                   	retq   
    10b5:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10bc:	00 00 00 
    10bf:	90                   	nop
