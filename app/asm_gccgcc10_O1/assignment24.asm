...
/app/bin_gccgcc10_O1/assignment24:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1171:	ba c0 01 00 00       	mov    $0x1c0,%edx
    1176:	be 41 00 00 00       	mov    $0x41,%esi
    117b:	48 8d 3d 82 0e 00 00 	lea    0xe82(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1182:	b8 00 00 00 00       	mov    $0x0,%eax
    1187:	e8 e4 fe ff ff       	callq  1070 <open@plt>
    118c:	85 c0                	test   %eax,%eax
    118e:	78 20                	js     11b0 <main+0x47>
    1190:	48 8d 35 97 0e 00 00 	lea    0xe97(%rip),%rsi        # 202e <_IO_stdin_used+0x2e>
    1197:	bf 01 00 00 00       	mov    $0x1,%edi
    119c:	b8 00 00 00 00       	mov    $0x0,%eax
    11a1:	e8 ba fe ff ff       	callq  1060 <__printf_chk@plt>
    11a6:	b8 00 00 00 00       	mov    $0x0,%eax
    11ab:	48 83 c4 08          	add    $0x8,%rsp
    11af:	c3                   	retq   
    11b0:	48 8d 35 5a 0e 00 00 	lea    0xe5a(%rip),%rsi        # 2011 <_IO_stdin_used+0x11>
    11b7:	bf 01 00 00 00       	mov    $0x1,%edi
    11bc:	b8 00 00 00 00       	mov    $0x0,%eax
    11c1:	e8 9a fe ff ff       	callq  1060 <__printf_chk@plt>
    11c6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    11cb:	eb de                	jmp    11ab <main+0x42>
