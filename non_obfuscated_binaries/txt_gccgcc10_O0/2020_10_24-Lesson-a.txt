...
/app/bin_gccgcc10_O0/2020_10_24-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1175:	c7 45 f8 02 00 00 00 	movl   $0x2,-0x8(%rbp)
    117c:	eb 5c                	jmp    11da <main+0x71>
    117e:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1181:	89 c6                	mov    %eax,%esi
    1183:	48 8d 3d 7a 0e 00 00 	lea    0xe7a(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    118a:	b8 00 00 00 00       	mov    $0x0,%eax
    118f:	e8 dc fe ff ff       	callq  1070 <printf@plt>
    1194:	c7 45 fc 02 00 00 00 	movl   $0x2,-0x4(%rbp)
    119b:	eb 27                	jmp    11c4 <main+0x5b>
    119d:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11a0:	99                   	cltd   
    11a1:	f7 7d fc             	idivl  -0x4(%rbp)
    11a4:	89 d0                	mov    %edx,%eax
    11a6:	85 c0                	test   %eax,%eax
    11a8:	75 16                	jne    11c0 <main+0x57>
    ...
    11bb:	e8 b0 fe ff ff       	callq  1070 <printf@plt>
    11c0:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    11c4:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11c7:	3b 45 f8             	cmp    -0x8(%rbp),%eax
    11ca:	7c d1                	jl     119d <main+0x34>
    11cc:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11d0:	bf 0a 00 00 00       	mov    $0xa,%edi
    11d5:	e8 86 fe ff ff       	callq  1060 <putchar@plt>
    11da:	83 7d f8 63          	cmpl   $0x63,-0x8(%rbp)
    11de:	7e 9e                	jle    117e <main+0x15>
