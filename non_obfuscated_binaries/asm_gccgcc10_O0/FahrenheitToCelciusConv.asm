...
/app/bin_gccgcc10_O0/FahrenheitToCelciusConv:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d7:	48 8d 3d 41 0e 00 00 	lea    0xe41(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 c8 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e8:	f3 0f 10 45 f0       	movss  -0x10(%rbp),%xmm0
    11ed:	f3 0f 10 15 47 0e 00 	movss  0xe47(%rip),%xmm2        # 203c <_IO_stdin_used+0x3c>
    11f4:	00 
    11f5:	0f 28 c8             	movaps %xmm0,%xmm1
    11f8:	f3 0f 5c ca          	subss  %xmm2,%xmm1
    11fc:	f3 0f 10 05 3c 0e 00 	movss  0xe3c(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    1203:	00 
    1204:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    1208:	f3 0f 10 0d 34 0e 00 	movss  0xe34(%rip),%xmm1        # 2044 <_IO_stdin_used+0x44>
    120f:	00 
    1210:	f3 0f 5e c1          	divss  %xmm1,%xmm0
    1214:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    1219:	66 0f ef db          	pxor   %xmm3,%xmm3
    121d:	f3 0f 5a 5d f4       	cvtss2sd -0xc(%rbp),%xmm3
    1222:	66 48 0f 7e d8       	movq   %xmm3,%rax
    1227:	66 48 0f 6e c0       	movq   %rax,%xmm0
    122c:	48 8d 3d ef 0d 00 00 	lea    0xdef(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    1233:	b8 01 00 00 00       	mov    $0x1,%eax
    1238:	e8 63 fe ff ff       	callq  10a0 <printf@plt>
