...
/app/bin_gccgcc10_O1/other_binary_search:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d 0a 01 00 00 	lea    0x10a(%rip),%rdi        # 11b2 <main>
...
0000000000001169 <binarySearch>:
    ...
    116d:	49 89 f8             	mov    %rdi,%r8
    1170:	89 d7                	mov    %edx,%edi
    1172:	83 ee 01             	sub    $0x1,%esi
    1175:	78 35                	js     11ac <binarySearch+0x43>
    1177:	ba 00 00 00 00       	mov    $0x0,%edx
    117c:	eb 07                	jmp    1185 <binarySearch+0x1c>
    117e:	8d 50 01             	lea    0x1(%rax),%edx
    1181:	39 d6                	cmp    %edx,%esi
    1183:	7c 21                	jl     11a6 <binarySearch+0x3d>
    1185:	89 f1                	mov    %esi,%ecx
    1187:	29 d1                	sub    %edx,%ecx
    1189:	89 c8                	mov    %ecx,%eax
    118b:	c1 e8 1f             	shr    $0x1f,%eax
    118e:	01 c8                	add    %ecx,%eax
    1190:	d1 f8                	sar    %eax
    1192:	01 d0                	add    %edx,%eax
    1194:	48 63 c8             	movslq %eax,%rcx
    1197:	41 8b 0c 88          	mov    (%r8,%rcx,4),%ecx
    119b:	39 f9                	cmp    %edi,%ecx
    119d:	74 12                	je     11b1 <binarySearch+0x48>
    119f:	7e dd                	jle    117e <binarySearch+0x15>
    11a1:	8d 70 ff             	lea    -0x1(%rax),%esi
    11a4:	eb db                	jmp    1181 <binarySearch+0x18>
    11a6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    11ab:	c3                   	retq   
...
00000000000011b2 <main>:
    ...
    11ca:	c7 04 24 05 00 00 00 	movl   $0x5,(%rsp)
    11d1:	c7 44 24 04 08 00 00 	movl   $0x8,0x4(%rsp)
    11d8:	00 
    11d9:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%rsp)
    11e0:	00 
    11e1:	c7 44 24 0c 0e 00 00 	movl   $0xe,0xc(%rsp)
    11e8:	00 
    11e9:	c7 44 24 10 10 00 00 	movl   $0x10,0x10(%rsp)
    11f0:	00 
    11f1:	48 89 e7             	mov    %rsp,%rdi
    11f4:	ba 05 00 00 00       	mov    $0x5,%edx
    11f9:	be 05 00 00 00       	mov    $0x5,%esi
    11fe:	e8 66 ff ff ff       	callq  1169 <binarySearch>
    1203:	85 c0                	test   %eax,%eax
    1205:	78 37                	js     123e <main+0x8c>
    1207:	89 c1                	mov    %eax,%ecx
    1209:	ba 05 00 00 00       	mov    $0x5,%edx
    120e:	48 8d 35 1b 0e 00 00 	lea    0xe1b(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    1215:	bf 01 00 00 00       	mov    $0x1,%edi
    121a:	b8 00 00 00 00       	mov    $0x0,%eax
    121f:	e8 4c fe ff ff       	callq  1070 <__printf_chk@plt>
    1224:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1229:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1230:	00 00 
    1232:	75 27                	jne    125b <main+0xa9>
    1234:	b8 00 00 00 00       	mov    $0x0,%eax
    1239:	48 83 c4 28          	add    $0x28,%rsp
    123d:	c3                   	retq   
    123e:	ba 05 00 00 00       	mov    $0x5,%edx
    1243:	48 8d 35 be 0d 00 00 	lea    0xdbe(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    124a:	bf 01 00 00 00       	mov    $0x1,%edi
    124f:	b8 00 00 00 00       	mov    $0x0,%eax
    1254:	e8 17 fe ff ff       	callq  1070 <__printf_chk@plt>
    1259:	eb c9                	jmp    1224 <main+0x72>
