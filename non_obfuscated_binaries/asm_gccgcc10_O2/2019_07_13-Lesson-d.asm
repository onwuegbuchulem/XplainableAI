...
/app/bin_gccgcc10_O2/2019_07_13-Lesson-d:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10bd:	48 b8 20 20 20 20 20 	movabs $0x372b202020202020,%rax
    10c4:	20 2b 37 
    10c7:	4c 8d 64 24 0d       	lea    0xd(%rsp),%r12
    10cc:	48 89 e6             	mov    %rsp,%rsi
    10cf:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    10d4:	4c 89 e7             	mov    %r12,%rdi
    10d7:	48 89 44 24 0d       	mov    %rax,0xd(%rsp)
    10dc:	b8 38 39 00 00       	mov    $0x3938,%eax
    10e1:	66 89 44 24 15       	mov    %ax,0x15(%rsp)
    10e6:	e8 95 ff ff ff       	callq  1080 <strtol@plt>
    10eb:	4c 89 e2             	mov    %r12,%rdx
    10ee:	bf 01 00 00 00       	mov    $0x1,%edi
    10f3:	48 8d 35 0a 0f 00 00 	lea    0xf0a(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10fa:	48 89 c1             	mov    %rax,%rcx
    10fd:	31 c0                	xor    %eax,%eax
    10ff:	e8 8c ff ff ff       	callq  1090 <__printf_chk@plt>
    1104:	4c 39 24 24          	cmp    %r12,(%rsp)
    1108:	74 19                	je     1123 <main+0x83>
    110a:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    110f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1116:	00 00 
    1118:	75 21                	jne    113b <main+0x9b>
    111a:	48 83 c4 20          	add    $0x20,%rsp
    111e:	31 c0                	xor    %eax,%eax
    1120:	41 5c                	pop    %r12
    1122:	c3                   	retq   
    1123:	4c 89 e2             	mov    %r12,%rdx
    1126:	48 8d 35 f3 0e 00 00 	lea    0xef3(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    112d:	bf 01 00 00 00       	mov    $0x1,%edi
    1132:	31 c0                	xor    %eax,%eax
    1134:	e8 57 ff ff ff       	callq  1090 <__printf_chk@plt>
    1139:	eb cf                	jmp    110a <main+0x6a>
    113b:	e8 30 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
