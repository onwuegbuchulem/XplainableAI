...
/app/bin_gccgcc10_O3/2021_12-Exercise:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c4:	29 ea                	sub    %ebp,%edx
    10c6:	89 dd                	mov    %ebx,%ebp
    10c8:	0f b6 d2             	movzbl %dl,%edx
    10cb:	e8 b0 ff ff ff       	callq  1080 <__printf_chk@plt>
    10d0:	48 8b 3d 49 2f 00 00 	mov    0x2f49(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    10d7:	e8 b4 ff ff ff       	callq  1090 <getc@plt>
    10dc:	89 c3                	mov    %eax,%ebx
    10de:	83 f8 ff             	cmp    $0xffffffff,%eax
    10e1:	75 d5                	jne    10b8 <main+0x18>
    10e3:	48 8b 35 26 2f 00 00 	mov    0x2f26(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10ea:	bf 0a 00 00 00       	mov    $0xa,%edi
    10ef:	e8 7c ff ff ff       	callq  1070 <putc@plt>
    10f4:	5b                   	pop    %rbx
