...
/app/bin_gccgcc10_O1/2024_02_10-Lesson-a:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    114d:	48 8b 05 cc 2e 00 00 	mov    0x2ecc(%rip),%rax        # 4020 <__environ@@GLIBC_2.2.5>
    1154:	48 8b 38             	mov    (%rax),%rdi
    1157:	48 85 ff             	test   %rdi,%rdi
    115a:	74 2e                	je     118a <main+0x41>
    ...
    1170:	48 89 15 a9 2e 00 00 	mov    %rdx,0x2ea9(%rip)        # 4020 <__environ@@GLIBC_2.2.5>
    1177:	48 8b 78 08          	mov    0x8(%rax),%rdi
    117b:	48 85 ff             	test   %rdi,%rdi
    117e:	75 e0                	jne    1160 <main+0x17>
