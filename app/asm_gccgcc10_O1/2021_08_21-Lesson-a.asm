...
/app/bin_gccgcc10_O1/2021_08_21-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d 05 01 00 00 	lea    0x105(%rip),%rdi        # 11ad <main>
...
0000000000001169 <output>:
    ...
    1171:	0f b6 3f             	movzbl (%rdi),%edi
    1174:	40 84 ff             	test   %dil,%dil
    1177:	74 21                	je     119a <output+0x31>
    1179:	48 83 c3 01          	add    $0x1,%rbx
    117d:	40 0f be ff          	movsbl %dil,%edi
    1181:	48 8b 35 88 2e 00 00 	mov    0x2e88(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1188:	e8 e3 fe ff ff       	callq  1070 <putc@plt>
    118d:	48 83 c3 01          	add    $0x1,%rbx
    1191:	0f b6 7b ff          	movzbl -0x1(%rbx),%edi
    1195:	40 84 ff             	test   %dil,%dil
    1198:	75 e3                	jne    117d <output+0x14>
    119a:	48 8b 35 6f 2e 00 00 	mov    0x2e6f(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11a1:	bf 0a 00 00 00       	mov    $0xa,%edi
    11a6:	e8 c5 fe ff ff       	callq  1070 <putc@plt>
    11ab:	5b                   	pop    %rbx
    11ac:	c3                   	retq   
...
00000000000011ad <main>:
    ...
    11c5:	48 b8 48 65 6c 6c 6f 	movabs $0x77202c6f6c6c6548,%rax
    11cc:	2c 20 77 
    11cf:	48 89 44 24 0a       	mov    %rax,0xa(%rsp)
    11d4:	c7 44 24 12 6f 72 6c 	movl   $0x646c726f,0x12(%rsp)
    11db:	64 
    11dc:	66 c7 44 24 16 21 00 	movw   $0x21,0x16(%rsp)
    11e3:	48 8d 7c 24 0a       	lea    0xa(%rsp),%rdi
    11e8:	e8 7c ff ff ff       	callq  1169 <output>
    11ed:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11f2:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f9:	00 00 
    11fb:	75 0a                	jne    1207 <main+0x5a>
