...
/app/bin_gccgcc10_O3/assignment5:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10dc:	f3 0f 10 44 24 04    	movss  0x4(%rsp),%xmm0
    10e2:	f3 0f 10 15 8a 0f 00 	movss  0xf8a(%rip),%xmm2        # 2074 <_IO_stdin_used+0x74>
    10e9:	00 
    10ea:	48 8d 35 37 0f 00 00 	lea    0xf37(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    10f1:	f3 0f 10 25 7f 0f 00 	movss  0xf7f(%rip),%xmm4        # 2078 <_IO_stdin_used+0x78>
    10f8:	00 
    10f9:	bf 01 00 00 00       	mov    $0x1,%edi
    10fe:	0f 28 c8             	movaps %xmm0,%xmm1
    1101:	0f 28 d8             	movaps %xmm0,%xmm3
    1104:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1108:	f3 0f 5e ca          	divss  %xmm2,%xmm1
    110c:	f3 0f 2c c1          	cvttss2si %xmm1,%eax
    1110:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1114:	f3 0f 2a c8          	cvtsi2ss %eax,%xmm1
    1118:	f3 0f 59 d1          	mulss  %xmm1,%xmm2
    111c:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
    1120:	f3 0f 5c da          	subss  %xmm2,%xmm3
    1124:	0f 28 d3             	movaps %xmm3,%xmm2
    1127:	f3 0f 5e d4          	divss  %xmm4,%xmm2
    112b:	f3 0f 2c c2          	cvttss2si %xmm2,%eax
    112f:	66 0f ef d2          	pxor   %xmm2,%xmm2
    1133:	f3 0f 2a d0          	cvtsi2ss %eax,%xmm2
    1137:	b8 04 00 00 00       	mov    $0x4,%eax
    113c:	f3 0f 59 e2          	mulss  %xmm2,%xmm4
    1140:	f3 0f 5a d2          	cvtss2sd %xmm2,%xmm2
    1144:	f3 0f 5c dc          	subss  %xmm4,%xmm3
    1148:	f3 0f 5a db          	cvtss2sd %xmm3,%xmm3
    114c:	e8 2f ff ff ff       	callq  1080 <__printf_chk@plt>
    1151:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1156:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    115d:	00 00 
    115f:	75 07                	jne    1168 <main+0xc8>
    1161:	31 c0                	xor    %eax,%eax
    1163:	48 83 c4 18          	add    $0x18,%rsp
    1167:	c3                   	retq   
    1168:	e8 03 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
