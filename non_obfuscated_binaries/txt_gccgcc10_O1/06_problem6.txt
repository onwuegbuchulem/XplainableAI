...
/app/bin_gccgcc10_O1/06_problem6:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d dc 00 00 00 	lea    0xdc(%rip),%rdi        # 1164 <main>
...
0000000000001149 <sum_natural>:
    1149:	f3 0f 1e fa          	endbr64 
    114d:	89 f8                	mov    %edi,%eax
    114f:	83 ff 01             	cmp    $0x1,%edi
    1152:	74 0f                	je     1163 <sum_natural+0x1a>
    1154:	53                   	push   %rbx
    1155:	89 fb                	mov    %edi,%ebx
    1157:	8d 7f ff             	lea    -0x1(%rdi),%edi
    115a:	e8 ea ff ff ff       	callq  1149 <sum_natural>
    115f:	01 d8                	add    %ebx,%eax
    1161:	5b                   	pop    %rbx
    1162:	c3                   	retq   
    1163:	c3                   	retq   
...
0000000000001164 <main>:
    ...
    116c:	bf 05 00 00 00       	mov    $0x5,%edi
    1171:	e8 d3 ff ff ff       	callq  1149 <sum_natural>
    ...
    1189:	e8 c2 fe ff ff       	callq  1050 <__printf_chk@plt>
