...
/app/bin_gccgcc10_O1/lotto05:     file format elf64-x86-64
...
00000000000012b4 <main>:
    ...
    1363:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1368:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    136f:	00 00 
    1371:	75 0e                	jne    1381 <main+0xcd>
    1373:	b8 00 00 00 00       	mov    $0x0,%eax
    1378:	48 83 c4 20          	add    $0x20,%rsp
    137c:	5b                   	pop    %rbx
    137d:	5d                   	pop    %rbp
    137e:	41 5c                	pop    %r12
    1380:	c3                   	retq   
    1381:	e8 1a fd ff ff       	callq  10a0 <__stack_chk_fail@plt>
