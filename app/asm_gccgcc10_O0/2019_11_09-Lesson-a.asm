...
/app/bin_gccgcc10_O0/2019_11_09-Lesson-a:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11e4:	c7 45 e0 22 00 00 00 	movl   $0x22,-0x20(%rbp)
    11eb:	48 b8 47 65 6f 72 67 	movabs $0x6567726f6547,%rax
    11f2:	65 00 00 
    11f5:	48 89 45 e4          	mov    %rax,-0x1c(%rbp)
    11f9:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
    1200:	8b 45 e0             	mov    -0x20(%rbp),%eax
    1203:	48 8d 55 e0          	lea    -0x20(%rbp),%rdx
    1207:	48 8d 4a 04          	lea    0x4(%rdx),%rcx
    120b:	89 c2                	mov    %eax,%edx
    120d:	48 89 ce             	mov    %rcx,%rsi
    1210:	48 8d 3d ed 0d 00 00 	lea    0xded(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1217:	b8 00 00 00 00       	mov    $0x0,%eax
    121c:	e8 7f fe ff ff       	callq  10a0 <printf@plt>
    1221:	bf 10 00 00 00       	mov    $0x10,%edi
    1226:	e8 85 fe ff ff       	callq  10b0 <malloc@plt>
    122b:	48 89 45 d8          	mov    %rax,-0x28(%rbp)
    122f:	48 83 7d d8 00       	cmpq   $0x0,-0x28(%rbp)
    1234:	75 2a                	jne    1260 <main+0x97>
    1236:	48 8b 05 e3 2d 00 00 	mov    0x2de3(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    123d:	48 89 c1             	mov    %rax,%rcx
    1240:	ba 1a 00 00 00       	mov    $0x1a,%edx
    1245:	be 01 00 00 00       	mov    $0x1,%esi
    124a:	48 8d 3d c7 0d 00 00 	lea    0xdc7(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    1251:	e8 7a fe ff ff       	callq  10d0 <fwrite@plt>
    1256:	bf 01 00 00 00       	mov    $0x1,%edi
    125b:	e8 60 fe ff ff       	callq  10c0 <exit@plt>
    1260:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1264:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx
    1268:	48 8b 4d d8          	mov    -0x28(%rbp),%rcx
    126c:	48 89 01             	mov    %rax,(%rcx)
    126f:	48 89 51 08          	mov    %rdx,0x8(%rcx)
    1273:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    1277:	8b 00                	mov    (%rax),%eax
    1279:	48 8b 55 d8          	mov    -0x28(%rbp),%rdx
    127d:	48 8d 4a 04          	lea    0x4(%rdx),%rcx
    1281:	89 c2                	mov    %eax,%edx
    1283:	48 89 ce             	mov    %rcx,%rsi
    1286:	48 8d 3d 77 0d 00 00 	lea    0xd77(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    128d:	b8 00 00 00 00       	mov    $0x0,%eax
    1292:	e8 09 fe ff ff       	callq  10a0 <printf@plt>
    1297:	b8 00 00 00 00       	mov    $0x0,%eax
    129c:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    12a0:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    12a7:	00 00 
