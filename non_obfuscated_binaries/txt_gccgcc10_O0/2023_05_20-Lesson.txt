...
/app/bin_gccgcc10_O0/2023_05_20-Lesson:     file format elf64-x86-64
...
0000000000001189 <nano_delay>:
    ...
    11ad:	7e 47                	jle    11f6 <nano_delay+0x6d>
    11af:	48 81 7d c8 ff c9 9a 	cmpq   $0x3b9ac9ff,-0x38(%rbp)
    11b6:	3b 
    11b7:	7f 3d                	jg     11f6 <nano_delay+0x6d>
    11b9:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11bd:	48 89 c6             	mov    %rax,%rsi
    11c0:	bf 00 00 00 00       	mov    $0x0,%edi
    11c5:	e8 a6 fe ff ff       	callq  1070 <clock_gettime@plt>
    11ca:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx
    11ce:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    11d2:	48 01 d0             	add    %rdx,%rax
    11d5:	48 89 45 d8          	mov    %rax,-0x28(%rbp)
    11d9:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11dd:	48 89 c6             	mov    %rax,%rsi
    11e0:	bf 00 00 00 00       	mov    $0x0,%edi
    11e5:	e8 86 fe ff ff       	callq  1070 <clock_gettime@plt>
    11ea:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    11ee:	48 39 45 d8          	cmp    %rax,-0x28(%rbp)
    11f2:	7c 05                	jl     11f9 <nano_delay+0x70>
    11f4:	eb e3                	jmp    11d9 <nano_delay+0x50>
    11f6:	90                   	nop
    11f7:	eb 01                	jmp    11fa <nano_delay+0x71>
    11f9:	90                   	nop
    11fa:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11fe:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1205:	00 00 
    1207:	74 05                	je     120e <nano_delay+0x85>
    1209:	e8 72 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    120e:	c9                   	leaveq 
    120f:	c3                   	retq   
...
0000000000001210 <main>:
    ...
    121c:	48 c7 45 f8 0a 00 00 	movq   $0xa,-0x8(%rbp)
    1223:	00 
    1224:	eb 39                	jmp    125f <main+0x4f>
    ...
    1245:	e8 3f ff ff ff       	callq  1189 <nano_delay>
    124a:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    124e:	48 89 d0             	mov    %rdx,%rax
    1251:	48 c1 e0 02          	shl    $0x2,%rax
    1255:	48 01 d0             	add    %rdx,%rax
    1258:	48 01 c0             	add    %rax,%rax
    125b:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    125f:	48 81 7d f8 fe c9 9a 	cmpq   $0x3b9ac9fe,-0x8(%rbp)
    1266:	3b 
    1267:	7e bd                	jle    1226 <main+0x16>
