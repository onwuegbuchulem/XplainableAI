...
/app/bin_gccgcc10_O1/2023_05_13-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a6:	48 89 de             	mov    %rbx,%rsi
    11a9:	bf 00 00 00 00       	mov    $0x0,%edi
    11ae:	e8 bd fe ff ff       	callq  1070 <clock_gettime@plt>
    11b3:	48 8b 6c 24 08       	mov    0x8(%rsp),%rbp
    11b8:	48 89 de             	mov    %rbx,%rsi
    11bb:	bf 00 00 00 00       	mov    $0x0,%edi
    11c0:	e8 ab fe ff ff       	callq  1070 <clock_gettime@plt>
    11c5:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    11ca:	48 29 ea             	sub    %rbp,%rdx
    ...
    11ef:	00 00 
    11f1:	75 0c                	jne    11ff <main+0x76>
    11f3:	b8 00 00 00 00       	mov    $0x0,%eax
    11f8:	48 83 c4 28          	add    $0x28,%rsp
    11fc:	5b                   	pop    %rbx
    11fd:	5d                   	pop    %rbp
    11fe:	c3                   	retq   
    11ff:	e8 7c fe ff ff       	callq  1080 <__stack_chk_fail@plt>
