...
/app/bin_gccgcc10_O0/2019_04_20-Lesson:     file format elf64-x86-64
...
0000000000001080 <strchr@plt>:
    1080:	f3 0f 1e fa          	endbr64 
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <strchr@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    11a4:	c7 45 f1 61 62 63 64 	movl   $0x64636261,-0xf(%rbp)
    11ab:	66 c7 45 f5 65 66    	movw   $0x6665,-0xb(%rbp)
    11b1:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    11b5:	0f b6 45 f1          	movzbl -0xf(%rbp),%eax
    11b9:	0f be c0             	movsbl %al,%eax
    11bc:	89 c6                	mov    %eax,%esi
    11be:	48 8d 3d 43 0e 00 00 	lea    0xe43(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11c5:	e8 b6 fe ff ff       	callq  1080 <strchr@plt>
    11ca:	48 85 c0             	test   %rax,%rax
    11cd:	74 1a                	je     11e9 <main+0x60>
    11cf:	48 8d 45 f1          	lea    -0xf(%rbp),%rax
    11d3:	48 89 c6             	mov    %rax,%rsi
    11d6:	48 8d 3d 36 0e 00 00 	lea    0xe36(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    11dd:	b8 00 00 00 00       	mov    $0x0,%eax
    11e2:	e8 a9 fe ff ff       	callq  1090 <printf@plt>
    11e7:	eb 18                	jmp    1201 <main+0x78>
    11e9:	48 8d 45 f1          	lea    -0xf(%rbp),%rax
    11ed:	48 89 c6             	mov    %rax,%rsi
    11f0:	48 8d 3d 39 0e 00 00 	lea    0xe39(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    11f7:	b8 00 00 00 00       	mov    $0x0,%eax
    11fc:	e8 8f fe ff ff       	callq  1090 <printf@plt>
    1201:	b8 00 00 00 00       	mov    $0x0,%eax
    1206:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    120a:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1211:	00 00 
    1213:	74 05                	je     121a <main+0x91>
    1215:	e8 56 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    121a:	c9                   	leaveq 
    121b:	c3                   	retq   
