...
/app/bin_gccgcc10_O3/21_series:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108d:	41 54                	push   %r12
    108f:	41 bc 0a 00 00 00    	mov    $0xa,%r12d
    1095:	55                   	push   %rbp
    1096:	bd 01 00 00 00       	mov    $0x1,%ebp
    109b:	53                   	push   %rbx
    109c:	bb 01 00 00 00       	mov    $0x1,%ebx
    ...
    10b9:	01 eb                	add    %ebp,%ebx
    10bb:	89 ea                	mov    %ebp,%edx
    10bd:	4c 89 ee             	mov    %r13,%rsi
    10c0:	bf 01 00 00 00       	mov    $0x1,%edi
    10c5:	31 c0                	xor    %eax,%eax
    10c7:	01 dd                	add    %ebx,%ebp
    10c9:	e8 a2 ff ff ff       	callq  1070 <__printf_chk@plt>
    10ce:	41 83 ec 01          	sub    $0x1,%r12d
    10d2:	75 d4                	jne    10a8 <main+0x28>
    10d4:	48 8b 35 35 2f 00 00 	mov    0x2f35(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10db:	bf 0a 00 00 00       	mov    $0xa,%edi
    10e0:	e8 7b ff ff ff       	callq  1060 <putc@plt>
