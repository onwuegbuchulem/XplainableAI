...
/app/bin_gccgcc10_O2/thefirst01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c4:	55                   	push   %rbp
    10c5:	48 83 ec 50          	sub    $0x50,%rsp
    10c9:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10d0:	00 00 
    10d2:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    ...
    10eb:	48 8d 05 19 0f 00 00 	lea    0xf19(%rip),%rax        # 200b <_IO_stdin_used+0xb>
    10f2:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10f7:	48 8d 05 14 0f 00 00 	lea    0xf14(%rip),%rax        # 2012 <_IO_stdin_used+0x12>
    10fe:	48 89 44 24 20       	mov    %rax,0x20(%rsp)
    1103:	48 8d 05 10 0f 00 00 	lea    0xf10(%rip),%rax        # 201a <_IO_stdin_used+0x1a>
    110a:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    110f:	48 8d 05 0e 0f 00 00 	lea    0xf0e(%rip),%rax        # 2024 <_IO_stdin_used+0x24>
    1116:	48 89 44 24 30       	mov    %rax,0x30(%rsp)
    111b:	48 8d 05 0b 0f 00 00 	lea    0xf0b(%rip),%rax        # 202d <_IO_stdin_used+0x2d>
    1122:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    1127:	48 8d 05 06 0f 00 00 	lea    0xf06(%rip),%rax        # 2034 <_IO_stdin_used+0x34>
    112e:	48 89 44 24 40       	mov    %rax,0x40(%rsp)
    1133:	e8 68 ff ff ff       	callq  10a0 <time@plt>
    1138:	48 89 ef             	mov    %rbp,%rdi
    113b:	e8 40 ff ff ff       	callq  1080 <localtime@plt>
    1140:	bf 01 00 00 00       	mov    $0x1,%edi
    1145:	48 89 c6             	mov    %rax,%rsi
    1148:	48 63 40 0c          	movslq 0xc(%rax),%rax
    114c:	8b 76 18             	mov    0x18(%rsi),%esi
    114f:	48 89 c1             	mov    %rax,%rcx
    1152:	48 69 c0 93 24 49 92 	imul   $0xffffffff92492493,%rax,%rax
    1159:	89 ca                	mov    %ecx,%edx
    115b:	c1 fa 1f             	sar    $0x1f,%edx
    115e:	48 c1 e8 20          	shr    $0x20,%rax
    1162:	01 c8                	add    %ecx,%eax
    1164:	c1 f8 02             	sar    $0x2,%eax
    1167:	29 d0                	sub    %edx,%eax
    1169:	8d 14 c5 00 00 00 00 	lea    0x0(,%rax,8),%edx
    1170:	29 c2                	sub    %eax,%edx
    1172:	89 d0                	mov    %edx,%eax
    1174:	29 c8                	sub    %ecx,%eax
    1176:	8d 44 30 01          	lea    0x1(%rax,%rsi,1),%eax
    117a:	48 8d 35 bf 0e 00 00 	lea    0xebf(%rip),%rsi        # 2040 <_IO_stdin_used+0x40>
    1181:	48 98                	cltq   
    1183:	48 8b 54 c4 10       	mov    0x10(%rsp,%rax,8),%rdx
    1188:	31 c0                	xor    %eax,%eax
    118a:	e8 21 ff ff ff       	callq  10b0 <__printf_chk@plt>
    118f:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    1194:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    119b:	00 00 
    119d:	75 08                	jne    11a7 <main+0xe7>
    119f:	48 83 c4 50          	add    $0x50,%rsp
