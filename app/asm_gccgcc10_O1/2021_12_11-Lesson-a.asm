...
/app/bin_gccgcc10_O1/2021_12_11-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    116d:	48 81 ec 98 02 00 00 	sub    $0x298,%rsp
    1174:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    117b:	00 00 
    117d:	48 89 84 24 88 02 00 	mov    %rax,0x288(%rsp)
    1184:	00 
    1185:	31 c0                	xor    %eax,%eax
    1187:	48 89 e7             	mov    %rsp,%rdi
    118a:	48 8d 35 77 0e 00 00 	lea    0xe77(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    1191:	b9 4f 00 00 00       	mov    $0x4f,%ecx
    1196:	f3 48 a5             	rep movsq %ds:(%rsi),%es:(%rdi)
    1199:	8b 06                	mov    (%rsi),%eax
    119b:	89 07                	mov    %eax,(%rdi)
    119d:	0f b6 05 e0 10 00 00 	movzbl 0x10e0(%rip),%eax        # 2284 <_IO_stdin_used+0x284>
    11a4:	88 47 04             	mov    %al,0x4(%rdi)
    11a7:	48 89 e2             	mov    %rsp,%rdx
    ...
    11bb:	e8 b0 fe ff ff       	callq  1070 <__printf_chk@plt>
    11c0:	48 8b 84 24 88 02 00 	mov    0x288(%rsp),%rax
    11c7:	00 
    11c8:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11cf:	00 00 
    11d1:	75 0d                	jne    11e0 <main+0x77>
    11d3:	b8 00 00 00 00       	mov    $0x0,%eax
    11d8:	48 81 c4 98 02 00 00 	add    $0x298,%rsp
    11df:	c3                   	retq   
    11e0:	e8 7b fe ff ff       	callq  1060 <__stack_chk_fail@plt>
