...
/app/bin_gccgcc10_O0/EligibleForVoting:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11d0:	83 f8 11             	cmp    $0x11,%eax
    11d3:	7e 13                	jle    11e8 <main+0x5f>
    11d5:	48 8d 3d 40 0e 00 00 	lea    0xe40(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    11dc:	b8 00 00 00 00       	mov    $0x0,%eax
    11e1:	e8 9a fe ff ff       	callq  1080 <printf@plt>
    11e6:	eb 2b                	jmp    1213 <main+0x8a>
    11e8:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11eb:	85 c0                	test   %eax,%eax
    11ed:	7e 13                	jle    1202 <main+0x79>
    11ef:	48 8d 3d 4a 0e 00 00 	lea    0xe4a(%rip),%rdi        # 2040 <_IO_stdin_used+0x40>
    11f6:	b8 00 00 00 00       	mov    $0x0,%eax
    11fb:	e8 80 fe ff ff       	callq  1080 <printf@plt>
    1200:	eb 11                	jmp    1213 <main+0x8a>
    1202:	48 8d 3d 58 0e 00 00 	lea    0xe58(%rip),%rdi        # 2061 <_IO_stdin_used+0x61>
