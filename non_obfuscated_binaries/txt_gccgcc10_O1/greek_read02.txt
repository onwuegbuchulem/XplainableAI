...
/app/bin_gccgcc10_O1/greek_read02:     file format elf64-x86-64
...
00000000000010a0 <fgetwc@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 fd 2e 00 00 	bnd jmpq *0x2efd(%rip)        # 3fa8 <fgetwc@GLIBC_2.2.5>
...
00000000000010c0 <setlocale@plt>:
    ...
    10c4:	f2 ff 25 ed 2e 00 00 	bnd jmpq *0x2eed(%rip)        # 3fb8 <setlocale@GLIBC_2.2.5>
    10cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010d0 <fopen@plt>:
    10d0:	f3 0f 1e fa          	endbr64 
    10d4:	f2 ff 25 e5 2e 00 00 	bnd jmpq *0x2ee5(%rip)        # 3fc0 <fopen@GLIBC_2.2.5>
    10db:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010e0 <__wprintf_chk@plt>:
    10e0:	f3 0f 1e fa          	endbr64 
    10e4:	f2 ff 25 dd 2e 00 00 	bnd jmpq *0x2edd(%rip)        # 3fc8 <__wprintf_chk@GLIBC_2.4>
    10eb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010f0 <putwchar@plt>:
    10f0:	f3 0f 1e fa          	endbr64 
    10f4:	f2 ff 25 d5 2e 00 00 	bnd jmpq *0x2ed5(%rip)        # 3fd0 <putwchar@GLIBC_2.2.5>
...
0000000000001100 <_start>:
    ...
    1111:	50                   	push   %rax
    1112:	54                   	push   %rsp
    1113:	4c 8d 05 c6 01 00 00 	lea    0x1c6(%rip),%r8        # 12e0 <__libc_csu_fini>
    111a:	48 8d 0d 4f 01 00 00 	lea    0x14f(%rip),%rcx        # 1270 <__libc_csu_init>
...
00000000000011e9 <main>:
    ...
    11fc:	e8 cf fe ff ff       	callq  10d0 <fopen@plt>
    1201:	48 89 c3             	mov    %rax,%rbx
    1204:	48 8d 35 0a 0e 00 00 	lea    0xe0a(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    120b:	bf 00 00 00 00       	mov    $0x0,%edi
    1210:	e8 ab fe ff ff       	callq  10c0 <setlocale@plt>
    1215:	48 8d 15 ea 0d 00 00 	lea    0xdea(%rip),%rdx        # 2006 <_IO_stdin_used+0x6>
    121c:	48 8d 35 05 0e 00 00 	lea    0xe05(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    1223:	bf 01 00 00 00       	mov    $0x1,%edi
    1228:	b8 00 00 00 00       	mov    $0x0,%eax
    122d:	e8 ae fe ff ff       	callq  10e0 <__wprintf_chk@plt>
    1232:	eb 05                	jmp    1239 <main+0x50>
    1234:	e8 b7 fe ff ff       	callq  10f0 <putwchar@plt>
    1239:	48 89 df             	mov    %rbx,%rdi
    123c:	e8 5f fe ff ff       	callq  10a0 <fgetwc@plt>
    1241:	89 c7                	mov    %eax,%edi
    1243:	83 f8 ff             	cmp    $0xffffffff,%eax
    1246:	75 ec                	jne    1234 <main+0x4b>
    1248:	bf 0a 00 00 00       	mov    $0xa,%edi
    124d:	e8 9e fe ff ff       	callq  10f0 <putwchar@plt>
    1252:	48 89 df             	mov    %rbx,%rdi
    1255:	e8 56 fe ff ff       	callq  10b0 <fclose@plt>
...
0000000000001270 <__libc_csu_init>:
    ...
    128c:	55                   	push   %rbp
    128d:	48 8d 2d 04 2b 00 00 	lea    0x2b04(%rip),%rbp        # 3d98 <__do_global_dtors_aux_fini_array_entry>
    1294:	53                   	push   %rbx
