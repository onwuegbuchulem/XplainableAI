...
/app/bin_gccgcc10_O3/DynamicTwoDArrayUsingOnePointer:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108e:	41 54                	push   %r12
    1090:	4c 8d 25 6d 0f 00 00 	lea    0xf6d(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    1097:	55                   	push   %rbp
    1098:	53                   	push   %rbx
    1099:	48 83 ec 08          	sub    $0x8,%rsp
    109d:	e8 be ff ff ff       	callq  1060 <malloc@plt>
    10a2:	66 0f 6f 05 66 0f 00 	movdqa 0xf66(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    10a9:	00 
    10aa:	48 8d 68 10          	lea    0x10(%rax),%rbp
    10ae:	0f 11 00             	movups %xmm0,(%rax)
    10b1:	66 0f 6f 05 67 0f 00 	movdqa 0xf67(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10b8:	00 
    10b9:	0f 11 40 10          	movups %xmm0,0x10(%rax)
    10bd:	66 0f 6f 05 6b 0f 00 	movdqa 0xf6b(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    10c4:	00 
    10c5:	0f 11 40 20          	movups %xmm0,0x20(%rax)
    10c9:	48 8d 5d f0          	lea    -0x10(%rbp),%rbx
    10cd:	8b 13                	mov    (%rbx),%edx
    10cf:	4c 89 e6             	mov    %r12,%rsi
    10d2:	bf 01 00 00 00       	mov    $0x1,%edi
    10d7:	31 c0                	xor    %eax,%eax
    10d9:	48 83 c3 04          	add    $0x4,%rbx
    10dd:	e8 8e ff ff ff       	callq  1070 <__printf_chk@plt>
    10e2:	48 39 dd             	cmp    %rbx,%rbp
    10e5:	75 e6                	jne    10cd <main+0x4d>
    10e7:	49 83 c5 04          	add    $0x4,%r13
    10eb:	48 83 c5 10          	add    $0x10,%rbp
    10ef:	49 83 fd 0c          	cmp    $0xc,%r13
    10f3:	75 d4                	jne    10c9 <main+0x49>
    10f5:	48 83 c4 08          	add    $0x8,%rsp
