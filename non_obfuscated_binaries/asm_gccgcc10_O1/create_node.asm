...
/app/bin_gccgcc10_O1/create_node:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d e6 00 00 00 	lea    0xe6(%rip),%rdi        # 116e <main>
...
0000000000001149 <newNode>:
    1149:	f3 0f 1e fa          	endbr64 
    114d:	53                   	push   %rbx
    114e:	89 fb                	mov    %edi,%ebx
    1150:	bf 18 00 00 00       	mov    $0x18,%edi
    1155:	e8 f6 fe ff ff       	callq  1050 <malloc@plt>
    115a:	48 c7 00 00 00 00 00 	movq   $0x0,(%rax)
    1161:	89 58 08             	mov    %ebx,0x8(%rax)
    1164:	48 c7 40 10 00 00 00 	movq   $0x0,0x10(%rax)
    116b:	00 
    116c:	5b                   	pop    %rbx
    116d:	c3                   	retq   
