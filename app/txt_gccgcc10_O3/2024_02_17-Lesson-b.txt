...
/app/bin_gccgcc10_O3/2024_02_17-Lesson-b:     file format elf64-x86-64
...
0000000000001100 <main>:
    ...
    1112:	55                   	push   %rbp
    1113:	48 83 ec 28          	sub    $0x28,%rsp
    1117:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    111e:	00 00 
    1120:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    1125:	48 b8 6c 61 6e 67 61 	movabs $0x65677561676e616c,%rax
    112c:	75 67 65 
    112f:	48 8d 6c 24 0f       	lea    0xf(%rsp),%rbp
    1134:	4c 8d 64 24 0d       	lea    0xd(%rsp),%r12
    1139:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    113e:	4c 89 e1             	mov    %r12,%rcx
    1141:	48 89 ea             	mov    %rbp,%rdx
    1144:	48 89 44 24 0f       	mov    %rax,0xf(%rsp)
    1149:	b8 43 00 00 00       	mov    $0x43,%eax
    114e:	66 89 44 24 0d       	mov    %ax,0xd(%rsp)
    1153:	31 c0                	xor    %eax,%eax
    1155:	e8 86 ff ff ff       	callq  10e0 <__printf_chk@plt>
    115a:	31 d2                	xor    %edx,%edx
    115c:	4c 89 e6             	mov    %r12,%rsi
    115f:	48 89 ef             	mov    %rbp,%rdi
    1162:	e8 59 ff ff ff       	callq  10c0 <setenv@plt>
    1167:	48 89 ef             	mov    %rbp,%rdi
    116a:	e8 31 ff ff ff       	callq  10a0 <getenv@plt>
    116f:	48 8d 35 b1 0e 00 00 	lea    0xeb1(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    ...
    1185:	48 89 ea             	mov    %rbp,%rdx
    1188:	bf 01 00 00 00       	mov    $0x1,%edi
    118d:	31 c0                	xor    %eax,%eax
    118f:	48 8d 35 9f 0e 00 00 	lea    0xe9f(%rip),%rsi        # 2035 <_IO_stdin_used+0x35>
    1196:	e8 45 ff ff ff       	callq  10e0 <__printf_chk@plt>
    119b:	48 89 ef             	mov    %rbp,%rdi
    119e:	e8 4d ff ff ff       	callq  10f0 <unsetenv@plt>
    11a3:	48 8d 3d 9b 0e 00 00 	lea    0xe9b(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    11aa:	e8 01 ff ff ff       	callq  10b0 <puts@plt>
    11af:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11b4:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11bb:	00 00 
    11bd:	75 0a                	jne    11c9 <main+0xc9>
    11bf:	48 83 c4 28          	add    $0x28,%rsp
    11c3:	31 c0                	xor    %eax,%eax
    11c5:	5d                   	pop    %rbp
    11c6:	41 5c                	pop    %r12
    11c8:	c3                   	retq   
    11c9:	e8 02 ff ff ff       	callq  10d0 <__stack_chk_fail@plt>
