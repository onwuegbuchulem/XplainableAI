...
/app/bin_gccgcc10_O2/Simple_Interest:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ce:	48 8d 3d 70 0f 00 00 	lea    0xf70(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	e8 b4 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10dc:	48 8d 35 38 0f 00 00 	lea    0xf38(%rip),%rsi        # 201b <_IO_stdin_used+0x1b>
    ...
    10f4:	48 8d 3d 4a 0f 00 00 	lea    0xf4a(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    10fb:	31 c0                	xor    %eax,%eax
    10fd:	e8 8e ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    1102:	48 8d 35 24 0f 00 00 	lea    0xf24(%rip),%rsi        # 202d <_IO_stdin_used+0x2d>
    ...
    111a:	48 8d 3d 24 0f 00 00 	lea    0xf24(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    1121:	31 c0                	xor    %eax,%eax
    1123:	e8 68 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    1128:	f3 0f 10 44 24 0c    	movss  0xc(%rsp),%xmm0
    112e:	f3 0f 59 44 24 10    	mulss  0x10(%rsp),%xmm0
    1134:	48 8d 35 04 0f 00 00 	lea    0xf04(%rip),%rsi        # 203f <_IO_stdin_used+0x3f>
    113b:	f3 0f 59 44 24 14    	mulss  0x14(%rsp),%xmm0
    1141:	bf 01 00 00 00       	mov    $0x1,%edi
    1146:	b8 01 00 00 00       	mov    $0x1,%eax
    114b:	f3 0f 5e 05 f5 0e 00 	divss  0xef5(%rip),%xmm0        # 2048 <_IO_stdin_used+0x48>
    1152:	00 
    1153:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1157:	e8 24 ff ff ff       	callq  1080 <__printf_chk@plt>
    115c:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1161:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1168:	00 00 
    116a:	75 05                	jne    1171 <main+0xd1>
    116c:	48 83 c4 28          	add    $0x28,%rsp
    1170:	c3                   	retq   
    1171:	e8 fa fe ff ff       	callq  1070 <__stack_chk_fail@plt>
