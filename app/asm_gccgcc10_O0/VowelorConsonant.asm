...
/app/bin_gccgcc10_O0/VowelorConsonant:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11ef:	83 e8 41             	sub    $0x41,%eax
    11f2:	83 f8 34             	cmp    $0x34,%eax
    11f5:	77 36                	ja     122d <main+0x84>
    11f7:	89 c0                	mov    %eax,%eax
    11f9:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
    1200:	00 
    1201:	48 8d 05 5c 0e 00 00 	lea    0xe5c(%rip),%rax        # 2064 <_IO_stdin_used+0x64>
    1208:	8b 04 02             	mov    (%rdx,%rax,1),%eax
    120b:	48 98                	cltq   
    120d:	48 8d 15 50 0e 00 00 	lea    0xe50(%rip),%rdx        # 2064 <_IO_stdin_used+0x64>
    1214:	48 01 d0             	add    %rdx,%rax
    1217:	3e ff e0             	notrack jmpq *%rax
    121a:	48 8d 3d fc 0d 00 00 	lea    0xdfc(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    1221:	b8 00 00 00 00       	mov    $0x0,%eax
    1226:	e8 75 fe ff ff       	callq  10a0 <printf@plt>
    122b:	eb 11                	jmp    123e <main+0x95>
    122d:	48 8d 3d 0c 0e 00 00 	lea    0xe0c(%rip),%rdi        # 2040 <_IO_stdin_used+0x40>
