...
/app/bin_gccgcc10_O2/2024_02_17-Lesson-a:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e5:	48 b8 6c 61 6e 67 75 	movabs $0x65676175676e616c,%rax
    10ec:	61 67 65 
    10ef:	48 8d 6c 24 0f       	lea    0xf(%rsp),%rbp
    10f4:	4c 8d 64 24 0d       	lea    0xd(%rsp),%r12
    10f9:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    10fe:	4c 89 e1             	mov    %r12,%rcx
    1101:	48 89 ea             	mov    %rbp,%rdx
    1104:	48 89 44 24 0f       	mov    %rax,0xf(%rsp)
    1109:	b8 43 00 00 00       	mov    $0x43,%eax
    110e:	66 89 44 24 0d       	mov    %ax,0xd(%rsp)
    1113:	31 c0                	xor    %eax,%eax
    1115:	e8 96 ff ff ff       	callq  10b0 <__printf_chk@plt>
    111a:	31 d2                	xor    %edx,%edx
    111c:	4c 89 e6             	mov    %r12,%rsi
    111f:	48 89 ef             	mov    %rbp,%rdi
    1122:	e8 69 ff ff ff       	callq  1090 <setenv@plt>
    1127:	48 89 ef             	mov    %rbp,%rdi
    112a:	e8 51 ff ff ff       	callq  1080 <getenv@plt>
    112f:	48 8d 35 f1 0e 00 00 	lea    0xef1(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    1136:	bf 01 00 00 00       	mov    $0x1,%edi
    113b:	48 89 c2             	mov    %rax,%rdx
    113e:	31 c0                	xor    %eax,%eax
    1140:	e8 6b ff ff ff       	callq  10b0 <__printf_chk@plt>
    1145:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    114a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1151:	00 00 
    1153:	75 0a                	jne    115f <main+0x9f>
    1155:	48 83 c4 28          	add    $0x28,%rsp
    1159:	31 c0                	xor    %eax,%eax
    115b:	5d                   	pop    %rbp
    115c:	41 5c                	pop    %r12
    115e:	c3                   	retq   
    115f:	e8 3c ff ff ff       	callq  10a0 <__stack_chk_fail@plt>
