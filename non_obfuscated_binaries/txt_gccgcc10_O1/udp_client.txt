...
/app/bin_gccgcc10_O1/udp_client:     file format elf64-x86-64
...
0000000000001249 <main>:
    ...
    125f:	00 00 
    1261:	48 89 84 24 28 04 00 	mov    %rax,0x428(%rsp)
    1268:	00 
    1269:	31 c0                	xor    %eax,%eax
    126b:	ba 00 00 00 00       	mov    $0x0,%edx
    1270:	be 02 00 00 00       	mov    $0x2,%esi
    1275:	bf 02 00 00 00       	mov    $0x2,%edi
    127a:	e8 d1 fe ff ff       	callq  1150 <socket@plt>
    127f:	85 c0                	test   %eax,%eax
    1281:	0f 88 c0 00 00 00    	js     1347 <main+0xfe>
    1287:	89 c3                	mov    %eax,%ebx
    1289:	4c 8d 64 24 10       	lea    0x10(%rsp),%r12
    128e:	48 c7 44 24 10 00 00 	movq   $0x0,0x10(%rsp)
    1295:	00 00 
    1297:	48 c7 44 24 18 00 00 	movq   $0x0,0x18(%rsp)
    129e:	00 00 
    12a0:	66 c7 44 24 10 02 00 	movw   $0x2,0x10(%rsp)
    12a7:	66 c7 44 24 12 1f 90 	movw   $0x901f,0x12(%rsp)
    12ae:	41 b9 10 00 00 00    	mov    $0x10,%r9d
    12b4:	4d 89 e0             	mov    %r12,%r8
    12b7:	b9 00 00 00 00       	mov    $0x0,%ecx
    12bc:	ba 11 00 00 00       	mov    $0x11,%edx
    12c1:	48 8d 35 53 0d 00 00 	lea    0xd53(%rip),%rsi        # 201b <_IO_stdin_used+0x1b>
    12c8:	89 c7                	mov    %eax,%edi
    12ca:	e8 21 fe ff ff       	callq  10f0 <sendto@plt>
    12cf:	48 8d 3d 57 0d 00 00 	lea    0xd57(%rip),%rdi        # 202d <_IO_stdin_used+0x2d>
    12d6:	e8 f5 fd ff ff       	callq  10d0 <puts@plt>
    12db:	48 8d 6c 24 20       	lea    0x20(%rsp),%rbp
    12e0:	4c 8d 4c 24 0c       	lea    0xc(%rsp),%r9
    12e5:	4d 89 e0             	mov    %r12,%r8
    12e8:	b9 00 01 00 00       	mov    $0x100,%ecx
    12ed:	ba 00 04 00 00       	mov    $0x400,%edx
    12f2:	48 89 ee             	mov    %rbp,%rsi
    12f5:	89 df                	mov    %ebx,%edi
    12f7:	e8 14 fe ff ff       	callq  1110 <recvfrom@plt>
    12fc:	48 98                	cltq   
    12fe:	c6 44 04 20 00       	movb   $0x0,0x20(%rsp,%rax,1)
    1303:	48 89 ea             	mov    %rbp,%rdx
    1306:	48 8d 35 34 0d 00 00 	lea    0xd34(%rip),%rsi        # 2041 <_IO_stdin_used+0x41>
    130d:	bf 01 00 00 00       	mov    $0x1,%edi
    1312:	b8 00 00 00 00       	mov    $0x0,%eax
    1317:	e8 04 fe ff ff       	callq  1120 <__printf_chk@plt>
    131c:	89 df                	mov    %ebx,%edi
    131e:	e8 dd fd ff ff       	callq  1100 <close@plt>
    1323:	48 8b 84 24 28 04 00 	mov    0x428(%rsp),%rax
    132a:	00 
    132b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1332:	00 00 
    1334:	75 27                	jne    135d <main+0x114>
    1336:	b8 00 00 00 00       	mov    $0x0,%eax
    133b:	48 81 c4 30 04 00 00 	add    $0x430,%rsp
    1342:	5b                   	pop    %rbx
    1343:	5d                   	pop    %rbp
    1344:	41 5c                	pop    %r12
    1346:	c3                   	retq   
    1347:	48 8d 3d b6 0c 00 00 	lea    0xcb6(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    134e:	e8 dd fd ff ff       	callq  1130 <perror@plt>
    1353:	bf 01 00 00 00       	mov    $0x1,%edi
    1358:	e8 e3 fd ff ff       	callq  1140 <exit@plt>
    135d:	e8 7e fd ff ff       	callq  10e0 <__stack_chk_fail@plt>
