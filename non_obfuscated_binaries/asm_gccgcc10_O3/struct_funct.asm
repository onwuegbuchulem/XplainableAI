...
/app/bin_gccgcc10_O3/struct_funct:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	ba 73 79 00 00       	mov    $0x7973,%edx
    108d:	b9 06 00 00 00       	mov    $0x6,%ecx
    1092:	bf 01 00 00 00       	mov    $0x1,%edi
    1097:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    109e:	00 00 
    10a0:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10a5:	31 c0                	xor    %eax,%eax
    10a7:	48 8d 35 5a 0f 00 00 	lea    0xf5a(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    10ae:	66 89 54 24 05       	mov    %dx,0x5(%rsp)
    10b3:	48 8d 54 24 01       	lea    0x1(%rsp),%rdx
    10b8:	c7 44 24 01 48 65 72 	movl   $0x65726548,0x1(%rsp)
    10bf:	65 
    10c0:	c6 44 24 07 00       	movb   $0x0,0x7(%rsp)
    10c5:	e8 a6 ff ff ff       	callq  1070 <__printf_chk@plt>
    10ca:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10cf:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10d6:	00 00 
    10d8:	75 07                	jne    10e1 <main+0x61>
    10da:	31 c0                	xor    %eax,%eax
    10dc:	48 83 c4 18          	add    $0x18,%rsp
    10e0:	c3                   	retq   
    10e1:	e8 7a ff ff ff       	callq  1060 <__stack_chk_fail@plt>
