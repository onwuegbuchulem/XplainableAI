...
/app/bin_gccgcc10_O0/Pattern-1:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117c:	eb 34                	jmp    11b2 <main+0x49>
    117e:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%rbp)
    1185:	eb 15                	jmp    119c <main+0x33>
    1187:	48 8d 3d 76 0e 00 00 	lea    0xe76(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    118e:	b8 00 00 00 00       	mov    $0x0,%eax
    1193:	e8 d8 fe ff ff       	callq  1070 <printf@plt>
    1198:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    119c:	8b 45 fc             	mov    -0x4(%rbp),%eax
    119f:	3b 45 f8             	cmp    -0x8(%rbp),%eax
    11a2:	7e e3                	jle    1187 <main+0x1e>
    11a4:	bf 0a 00 00 00       	mov    $0xa,%edi
    11a9:	e8 b2 fe ff ff       	callq  1060 <putchar@plt>
    11ae:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11b2:	83 7d f8 05          	cmpl   $0x5,-0x8(%rbp)
    11b6:	7e c6                	jle    117e <main+0x15>
