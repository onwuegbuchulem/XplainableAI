...
/app/bin_gccgcc10_O0/word_parse02:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11f0:	e8 bb fe ff ff       	callq  10b0 <printf@plt>
    11f5:	48 8b 15 14 2e 00 00 	mov    0x2e14(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    11fc:	48 8d 45 b0          	lea    -0x50(%rbp),%rax
    1200:	be 40 00 00 00       	mov    $0x40,%esi
    1205:	48 89 c7             	mov    %rax,%rdi
    1208:	e8 b3 fe ff ff       	callq  10c0 <fgets@plt>
    120d:	48 8d 45 b0          	lea    -0x50(%rbp),%rax
    1211:	48 8d 35 fd 0d 00 00 	lea    0xdfd(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    1218:	48 89 c7             	mov    %rax,%rdi
    121b:	e8 b0 fe ff ff       	callq  10d0 <strtok@plt>
    1220:	48 89 45 a8          	mov    %rax,-0x58(%rbp)
    1224:	eb 21                	jmp    1247 <main+0x7e>
    1226:	48 8b 45 a8          	mov    -0x58(%rbp),%rax
    122a:	48 89 c7             	mov    %rax,%rdi
    122d:	e8 5e fe ff ff       	callq  1090 <puts@plt>
    1232:	48 8d 35 dc 0d 00 00 	lea    0xddc(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    1239:	bf 00 00 00 00       	mov    $0x0,%edi
    123e:	e8 8d fe ff ff       	callq  10d0 <strtok@plt>
    1243:	48 89 45 a8          	mov    %rax,-0x58(%rbp)
    1247:	48 83 7d a8 00       	cmpq   $0x0,-0x58(%rbp)
    124c:	75 d8                	jne    1226 <main+0x5d>
    124e:	b8 00 00 00 00       	mov    $0x0,%eax
    1253:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1257:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    125e:	00 00 
    1260:	74 05                	je     1267 <main+0x9e>
    1262:	e8 39 fe ff ff       	callq  10a0 <__stack_chk_fail@plt>
    1267:	c9                   	leaveq 
    1268:	c3                   	retq   
