...
/app/bin_gccgcc10_O0/2022_08-Exercise-c:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1159:	eb 23                	jmp    117e <main+0x35>
    115b:	0f be 45 ff          	movsbl -0x1(%rbp),%eax
    115f:	89 c7                	mov    %eax,%edi
    1161:	e8 ea fe ff ff       	callq  1050 <putchar@plt>
    1166:	0f be 45 ff          	movsbl -0x1(%rbp),%eax
    116a:	83 c0 20             	add    $0x20,%eax
    116d:	89 c7                	mov    %eax,%edi
    116f:	e8 dc fe ff ff       	callq  1050 <putchar@plt>
    1174:	0f b6 45 ff          	movzbl -0x1(%rbp),%eax
    1178:	83 c0 01             	add    $0x1,%eax
    117b:	88 45 ff             	mov    %al,-0x1(%rbp)
    117e:	80 7d ff 5b          	cmpb   $0x5b,-0x1(%rbp)
    1182:	75 d7                	jne    115b <main+0x12>
