...
/app/bin_gccgcc10_O3/2024_03_23-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	53                   	push   %rbx
    1085:	ba 41 00 00 00       	mov    $0x41,%edx
    108a:	eb 10                	jmp    109c <main+0x1c>
    108c:	0f 1f 40 00          	nopl   0x0(%rax)
    1090:	e8 db ff ff ff       	callq  1070 <getc@plt>
    1095:	85 c0                	test   %eax,%eax
    1097:	75 37                	jne    10d0 <main+0x50>
    1099:	0f be d3             	movsbl %bl,%edx
    109c:	bf 01 00 00 00       	mov    $0x1,%edi
    10a1:	8d 5a 01             	lea    0x1(%rdx),%ebx
    10a4:	48 8d 35 59 0f 00 00 	lea    0xf59(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10ab:	31 c0                	xor    %eax,%eax
    10ad:	e8 ae ff ff ff       	callq  1060 <__printf_chk@plt>
    10b2:	48 8b 3d 57 2f 00 00 	mov    0x2f57(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    10b9:	80 fb 5a             	cmp    $0x5a,%bl
    10bc:	75 d2                	jne    1090 <main+0x10>
    10be:	e8 ad ff ff ff       	callq  1070 <getc@plt>
    10c3:	85 c0                	test   %eax,%eax
    10c5:	75 09                	jne    10d0 <main+0x50>
    10c7:	bb 41 00 00 00       	mov    $0x41,%ebx
    10cc:	eb cb                	jmp    1099 <main+0x19>
    10ce:	66 90                	xchg   %ax,%ax
    10d0:	31 c0                	xor    %eax,%eax
    10d2:	5b                   	pop    %rbx
    10d3:	c3                   	retq   
    10d4:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10db:	00 00 00 
