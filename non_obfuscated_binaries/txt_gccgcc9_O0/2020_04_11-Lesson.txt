...
/app/bin_gccgcc9_O0/2020_04_11-Lesson:     file format elf64-x86-64
...
0000000000001110 <fgetc@plt>:
    ...
    1114:	f2 ff 25 85 2e 00 00 	bnd jmpq *0x2e85(%rip)        # 3fa0 <fgetc@GLIBC_2.2.5>
    111b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001120 <close@plt>:
    1120:	f3 0f 1e fa          	endbr64 
    1124:	f2 ff 25 7d 2e 00 00 	bnd jmpq *0x2e7d(%rip)        # 3fa8 <close@GLIBC_2.2.5>
...
0000000000001150 <fdopen@plt>:
    1150:	f3 0f 1e fa          	endbr64 
    1154:	f2 ff 25 65 2e 00 00 	bnd jmpq *0x2e65(%rip)        # 3fc0 <fdopen@GLIBC_2.2.5>
    115b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001160 <open@plt>:
    1160:	f3 0f 1e fa          	endbr64 
    1164:	f2 ff 25 5d 2e 00 00 	bnd jmpq *0x2e5d(%rip)        # 3fc8 <open@GLIBC_2.2.5>
...
0000000000001180 <_start>:
    ...
    1191:	50                   	push   %rax
    1192:	54                   	push   %rsp
    1193:	4c 8d 05 76 02 00 00 	lea    0x276(%rip),%r8        # 1410 <__libc_csu_fini>
    119a:	48 8d 0d ff 01 00 00 	lea    0x1ff(%rip),%rcx        # 13a0 <__libc_csu_init>
...
0000000000001269 <main>:
    ...
    1284:	48 b8 67 65 74 74 79 	movabs $0x7562737974746567,%rax
    128b:	73 62 75 
    128e:	48 89 45 e9          	mov    %rax,-0x17(%rbp)
    1292:	c7 45 f1 72 67 2e 74 	movl   $0x742e6772,-0xf(%rbp)
    1299:	66 c7 45 f5 78 74    	movw   $0x7478,-0xb(%rbp)
    129f:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    12a3:	48 8d 45 e9          	lea    -0x17(%rbp),%rax
    12a7:	be 00 00 00 00       	mov    $0x0,%esi
    12ac:	48 89 c7             	mov    %rax,%rdi
    12af:	b8 00 00 00 00       	mov    $0x0,%eax
    12b4:	e8 a7 fe ff ff       	callq  1160 <open@plt>
    12b9:	89 45 d8             	mov    %eax,-0x28(%rbp)
    12bc:	83 7d d8 ff          	cmpl   $0xffffffff,-0x28(%rbp)
    12c0:	75 29                	jne    12eb <main+0x82>
    12c2:	48 8b 05 57 2d 00 00 	mov    0x2d57(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    12c9:	48 8d 55 e9          	lea    -0x17(%rbp),%rdx
    ...
    12dc:	e8 4f fe ff ff       	callq  1130 <fprintf@plt>
    12e1:	bf 01 00 00 00       	mov    $0x1,%edi
    12e6:	e8 85 fe ff ff       	callq  1170 <exit@plt>
    12eb:	8b 45 d8             	mov    -0x28(%rbp),%eax
    12ee:	48 8d 35 3c 0d 00 00 	lea    0xd3c(%rip),%rsi        # 2031 <_IO_stdin_used+0x31>
    12f5:	89 c7                	mov    %eax,%edi
    12f7:	e8 54 fe ff ff       	callq  1150 <fdopen@plt>
    12fc:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    1300:	48 83 7d e0 00       	cmpq   $0x0,-0x20(%rbp)
    1305:	75 48                	jne    134f <main+0xe6>
    1307:	48 8b 05 12 2d 00 00 	mov    0x2d12(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    130e:	48 8d 55 e9          	lea    -0x17(%rbp),%rdx
    1312:	48 8d 35 1f 0d 00 00 	lea    0xd1f(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    1319:	48 89 c7             	mov    %rax,%rdi
    131c:	b8 00 00 00 00       	mov    $0x0,%eax
    1321:	e8 0a fe ff ff       	callq  1130 <fprintf@plt>
    1326:	bf 01 00 00 00       	mov    $0x1,%edi
    132b:	e8 40 fe ff ff       	callq  1170 <exit@plt>
    1330:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1334:	48 89 c7             	mov    %rax,%rdi
    1337:	e8 d4 fd ff ff       	callq  1110 <fgetc@plt>
    133c:	89 45 dc             	mov    %eax,-0x24(%rbp)
    133f:	83 7d dc ff          	cmpl   $0xffffffff,-0x24(%rbp)
    1343:	74 1c                	je     1361 <main+0xf8>
    1345:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1348:	89 c7                	mov    %eax,%edi
    134a:	e8 91 fd ff ff       	callq  10e0 <putchar@plt>
    134f:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1353:	48 89 c7             	mov    %rax,%rdi
    1356:	e8 e5 fd ff ff       	callq  1140 <feof@plt>
    135b:	85 c0                	test   %eax,%eax
    135d:	74 d1                	je     1330 <main+0xc7>
    135f:	eb 01                	jmp    1362 <main+0xf9>
    1361:	90                   	nop
    1362:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1366:	48 89 c7             	mov    %rax,%rdi
    1369:	e8 82 fd ff ff       	callq  10f0 <fclose@plt>
    136e:	8b 45 d8             	mov    -0x28(%rbp),%eax
    1371:	89 c7                	mov    %eax,%edi
    1373:	e8 a8 fd ff ff       	callq  1120 <close@plt>
    1378:	b8 00 00 00 00       	mov    $0x0,%eax
    137d:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1381:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1388:	00 00 
    138a:	74 05                	je     1391 <main+0x128>
    138c:	e8 6f fd ff ff       	callq  1100 <__stack_chk_fail@plt>
    1391:	c9                   	leaveq 
    1392:	c3                   	retq   
...
00000000000013a0 <__libc_csu_init>:
    ...
    13a4:	41 57                	push   %r15
    13a6:	4c 8d 3d c3 29 00 00 	lea    0x29c3(%rip),%r15        # 3d70 <__frame_dummy_init_array_entry>
    13ad:	41 56                	push   %r14
