...
/app/bin_gccgcc10_O3/Temperature:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ce:	48 8d 3d 7b 0f 00 00 	lea    0xf7b(%rip),%rdi        # 2050 <_IO_stdin_used+0x50>
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	e8 b4 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10dc:	bf 01 00 00 00       	mov    $0x1,%edi
    10e1:	b8 01 00 00 00       	mov    $0x1,%eax
    10e6:	f3 0f 10 05 66 0f 00 	movss  0xf66(%rip),%xmm0        # 2054 <_IO_stdin_used+0x54>
    10ed:	00 
    10ee:	f3 0f 58 44 24 04    	addss  0x4(%rsp),%xmm0
    10f4:	48 8d 35 35 0f 00 00 	lea    0xf35(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    10fb:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
