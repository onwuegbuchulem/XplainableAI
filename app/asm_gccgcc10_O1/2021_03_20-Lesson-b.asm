...
/app/bin_gccgcc10_O1/2021_03_20-Lesson-b:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11f6:	74 47                	je     123f <main+0x76>
    11f8:	48 89 e3             	mov    %rsp,%rbx
    11fb:	f2 0f 10 05 2d 0e 00 	movsd  0xe2d(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    1202:	00 
    1203:	48 8d 15 1c 0e 00 00 	lea    0xe1c(%rip),%rdx        # 2026 <_IO_stdin_used+0x26>
    120a:	be 20 00 00 00       	mov    $0x20,%esi
    120f:	48 89 df             	mov    %rbx,%rdi
    1212:	b8 01 00 00 00       	mov    $0x1,%eax
    1217:	e8 a4 fe ff ff       	callq  10c0 <strfmon@plt>
    121c:	48 89 df             	mov    %rbx,%rdi
    121f:	e8 6c fe ff ff       	callq  1090 <puts@plt>
    1224:	b8 00 00 00 00       	mov    $0x0,%eax
    1229:	48 8b 4c 24 28       	mov    0x28(%rsp),%rcx
    122e:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1235:	00 00 
    1237:	75 2a                	jne    1263 <main+0x9a>
    1239:	48 83 c4 30          	add    $0x30,%rsp
    123d:	5b                   	pop    %rbx
    123e:	c3                   	retq   
    123f:	48 8b 0d da 2d 00 00 	mov    0x2dda(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1246:	ba 15 00 00 00       	mov    $0x15,%edx
    124b:	be 01 00 00 00       	mov    $0x1,%esi
    1250:	48 8d 3d b9 0d 00 00 	lea    0xdb9(%rip),%rdi        # 2010 <_IO_stdin_used+0x10>
    1257:	e8 74 fe ff ff       	callq  10d0 <fwrite@plt>
    125c:	b8 01 00 00 00       	mov    $0x1,%eax
    1261:	eb c6                	jmp    1229 <main+0x60>
    1263:	e8 38 fe ff ff       	callq  10a0 <__stack_chk_fail@plt>
