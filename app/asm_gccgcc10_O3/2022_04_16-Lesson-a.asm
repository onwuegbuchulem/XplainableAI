...
/app/bin_gccgcc10_O3/2022_04_16-Lesson-a:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c8:	bf 00 04 00 00       	mov    $0x400,%edi
    10cd:	e8 be ff ff ff       	callq  1090 <malloc@plt>
    10d2:	48 85 c0             	test   %rax,%rax
    10d5:	74 13                	je     10ea <main+0x2a>
    10d7:	48 8d 3d 41 0f 00 00 	lea    0xf41(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    10de:	e8 9d ff ff ff       	callq  1080 <puts@plt>
    10e3:	31 c0                	xor    %eax,%eax
    10e5:	48 83 c4 08          	add    $0x8,%rsp
    10e9:	c3                   	retq   
    10ea:	48 8b 0d 2f 2f 00 00 	mov    0x2f2f(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    10f1:	ba 1a 00 00 00       	mov    $0x1a,%edx
    10f6:	be 01 00 00 00       	mov    $0x1,%esi
    10fb:	48 8d 3d 02 0f 00 00 	lea    0xf02(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1102:	e8 a9 ff ff ff       	callq  10b0 <fwrite@plt>
    1107:	bf 01 00 00 00       	mov    $0x1,%edi
    110c:	e8 8f ff ff ff       	callq  10a0 <exit@plt>
