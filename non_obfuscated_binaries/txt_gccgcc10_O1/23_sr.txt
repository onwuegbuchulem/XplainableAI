...
/app/bin_gccgcc10_O1/23_sr:     file format elf64-x86-64
...
0000000000001189 <babylonian>:
    1189:	f3 0f 1e fa          	endbr64 
    118d:	66 0f 28 d0          	movapd %xmm0,%xmm2
    1191:	b8 07 00 00 00       	mov    $0x7,%eax
    1196:	f2 0f 10 0d 9a 0e 00 	movsd  0xe9a(%rip),%xmm1        # 2038 <_IO_stdin_used+0x38>
    119d:	00 
    119e:	f2 0f 10 1d 9a 0e 00 	movsd  0xe9a(%rip),%xmm3        # 2040 <_IO_stdin_used+0x40>
    11a5:	00 
    ...
    11b9:	75 eb                	jne    11a6 <babylonian+0x1d>
...
00000000000011c0 <main>:
    ...
    11e9:	48 89 e6             	mov    %rsp,%rsi
    11ec:	48 8d 3d 2a 0e 00 00 	lea    0xe2a(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    11f3:	b8 00 00 00 00       	mov    $0x0,%eax
    11f8:	e8 93 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11fd:	f2 0f 10 04 24       	movsd  (%rsp),%xmm0
    1202:	b8 01 00 00 00       	mov    $0x1,%eax
    1207:	66 0f ef c9          	pxor   %xmm1,%xmm1
    120b:	66 0f 2f c8          	comisd %xmm0,%xmm1
    120f:	73 20                	jae    1231 <main+0x71>
    1211:	e8 73 ff ff ff       	callq  1189 <babylonian>
    1216:	48 8d 35 04 0e 00 00 	lea    0xe04(%rip),%rsi        # 2021 <_IO_stdin_used+0x21>
    121d:	bf 01 00 00 00       	mov    $0x1,%edi
    1222:	b8 01 00 00 00       	mov    $0x1,%eax
    1227:	e8 54 fe ff ff       	callq  1080 <__printf_chk@plt>
    122c:	b8 00 00 00 00       	mov    $0x0,%eax
    1231:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    1236:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    123d:	00 00 
    123f:	75 05                	jne    1246 <main+0x86>
