...
/app/bin_gccgcc10_O1/assignment20:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1162:	c7 05 b4 2e 00 00 c3 	movl   $0x4048f5c3,0x2eb4(%rip)        # 4020 <example+0x8>
    1169:	f5 48 40 
    116c:	ba 32 00 00 00       	mov    $0x32,%edx
    ...
    1182:	e8 c9 fe ff ff       	callq  1050 <__printf_chk@plt>
    1187:	0f be 15 8e 2e 00 00 	movsbl 0x2e8e(%rip),%edx        # 401c <example+0x4>
    118e:	48 8d 35 83 0e 00 00 	lea    0xe83(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    1195:	bf 01 00 00 00       	mov    $0x1,%edi
    119a:	b8 00 00 00 00       	mov    $0x0,%eax
    119f:	e8 ac fe ff ff       	callq  1050 <__printf_chk@plt>
    11a4:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11a8:	f3 0f 5a 05 70 2e 00 	cvtss2sd 0x2e70(%rip),%xmm0        # 4020 <example+0x8>
    11af:	00 
    11b0:	48 8d 35 78 0e 00 00 	lea    0xe78(%rip),%rsi        # 202f <_IO_stdin_used+0x2f>
    11b7:	bf 01 00 00 00       	mov    $0x1,%edi
    11bc:	b8 01 00 00 00       	mov    $0x1,%eax
    11c1:	e8 8a fe ff ff       	callq  1050 <__printf_chk@plt>
    11c6:	b8 00 00 00 00       	mov    $0x0,%eax
    11cb:	48 83 c4 08          	add    $0x8,%rsp
    11cf:	c3                   	retq   
