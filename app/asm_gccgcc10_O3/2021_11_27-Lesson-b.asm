...
/app/bin_gccgcc10_O3/2021_11_27-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <strcspn@plt>:
    ...
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <strcspn@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10af:	00 00 
    10b1:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10b6:	48 b8 48 65 6c 6c 6f 	movabs $0x77202c6f6c6c6548,%rax
    10bd:	2c 20 77 
    10c0:	48 8d 74 24 06       	lea    0x6(%rsp),%rsi
    10c5:	48 8d 7c 24 0a       	lea    0xa(%rsp),%rdi
    10ca:	c7 44 24 12 6f 72 6c 	movl   $0x646c726f,0x12(%rsp)
    10d1:	64 
    10d2:	c7 44 24 06 20 2c 21 	movl   $0x212c20,0x6(%rsp)
    10d9:	00 
    10da:	48 89 44 24 0a       	mov    %rax,0xa(%rsp)
    10df:	b8 21 00 00 00       	mov    $0x21,%eax
    10e4:	66 89 44 24 16       	mov    %ax,0x16(%rsp)
    10e9:	e8 92 ff ff ff       	callq  1080 <strcspn@plt>
    10ee:	48 8d 35 0f 0f 00 00 	lea    0xf0f(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10f5:	bf 01 00 00 00       	mov    $0x1,%edi
    10fa:	0f be 4c 04 0a       	movsbl 0xa(%rsp,%rax,1),%ecx
    10ff:	48 89 c2             	mov    %rax,%rdx
    1102:	31 c0                	xor    %eax,%eax
    1104:	e8 87 ff ff ff       	callq  1090 <__printf_chk@plt>
    1109:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    110e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1115:	00 00 
    1117:	75 07                	jne    1120 <main+0x80>
    1119:	31 c0                	xor    %eax,%eax
    111b:	48 83 c4 28          	add    $0x28,%rsp
    111f:	c3                   	retq   
