...
/app/bin_gccgcc10_O1/2024_02_03-Lesson:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	41 b8 01 00 00 00    	mov    $0x1,%r8d
    1157:	b9 07 00 00 00       	mov    $0x7,%ecx
    115c:	ba 07 00 00 00       	mov    $0x7,%edx
    1161:	48 8d 35 9c 0e 00 00 	lea    0xe9c(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
