...
/app/bin_gccgcc10_O1/2020_08_22-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a3:	48 89 e0             	mov    %rsp,%rax
    11a6:	48 8d 54 24 28       	lea    0x28(%rsp),%rdx
    11ab:	c7 00 ff ff ff ff    	movl   $0xffffffff,(%rax)
    11b1:	48 83 c0 04          	add    $0x4,%rax
    11b5:	48 39 d0             	cmp    %rdx,%rax
    11b8:	75 f1                	jne    11ab <main+0x22>
    11ba:	48 8d 3d 43 0e 00 00 	lea    0xe43(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11c1:	e8 aa fe ff ff       	callq  1070 <puts@plt>
    11c6:	bb 01 00 00 00       	mov    $0x1,%ebx
    11cb:	48 8d 2d 3d 0e 00 00 	lea    0xe3d(%rip),%rbp        # 200f <_IO_stdin_used+0xf>
    11d2:	8b 4c 9c fc          	mov    -0x4(%rsp,%rbx,4),%ecx
    11d6:	89 da                	mov    %ebx,%edx
    11d8:	48 89 ee             	mov    %rbp,%rsi
    11db:	bf 01 00 00 00       	mov    $0x1,%edi
    11e0:	b8 00 00 00 00       	mov    $0x0,%eax
    11e5:	e8 a6 fe ff ff       	callq  1090 <__printf_chk@plt>
    11ea:	48 83 c3 01          	add    $0x1,%rbx
    11ee:	48 83 fb 0b          	cmp    $0xb,%rbx
    11f2:	75 de                	jne    11d2 <main+0x49>
    11f4:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    11f9:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1200:	00 00 
    1202:	75 0c                	jne    1210 <main+0x87>
    1204:	b8 00 00 00 00       	mov    $0x0,%eax
    1209:	48 83 c4 38          	add    $0x38,%rsp
    120d:	5b                   	pop    %rbx
    120e:	5d                   	pop    %rbp
    120f:	c3                   	retq   
