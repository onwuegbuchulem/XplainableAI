...
/app/bin_gccgcc10_O3/2021_03_27-Lesson-a:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    110d:	74 71                	je     1180 <main+0xa0>
    110f:	48 89 e5             	mov    %rsp,%rbp
    1112:	be 20 00 00 00       	mov    $0x20,%esi
    1117:	b8 01 00 00 00       	mov    $0x1,%eax
    111c:	f2 0f 10 05 34 0f 00 	movsd  0xf34(%rip),%xmm0        # 2058 <_IO_stdin_used+0x58>
    1123:	00 
    1124:	48 8d 15 fb 0e 00 00 	lea    0xefb(%rip),%rdx        # 2026 <_IO_stdin_used+0x26>
    112b:	48 89 ef             	mov    %rbp,%rdi
    112e:	e8 8d ff ff ff       	callq  10c0 <strfmon@plt>
    1133:	48 89 ef             	mov    %rbp,%rdi
    1136:	e8 55 ff ff ff       	callq  1090 <puts@plt>
    113b:	48 8b 05 16 0f 00 00 	mov    0xf16(%rip),%rax        # 2058 <_IO_stdin_used+0x58>
    1142:	be 20 00 00 00       	mov    $0x20,%esi
    1147:	48 89 ef             	mov    %rbp,%rdi
    114a:	48 8d 15 ee 0e 00 00 	lea    0xeee(%rip),%rdx        # 203f <_IO_stdin_used+0x3f>
    1151:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1156:	b8 01 00 00 00       	mov    $0x1,%eax
    115b:	e8 60 ff ff ff       	callq  10c0 <strfmon@plt>
    1160:	48 89 ef             	mov    %rbp,%rdi
    1163:	e8 28 ff ff ff       	callq  1090 <puts@plt>
    1168:	31 c0                	xor    %eax,%eax
    116a:	48 8b 4c 24 28       	mov    0x28(%rsp),%rcx
    116f:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1176:	00 00 
    1178:	75 2a                	jne    11a4 <main+0xc4>
    117a:	48 83 c4 30          	add    $0x30,%rsp
    117e:	5d                   	pop    %rbp
    117f:	c3                   	retq   
    1180:	48 8b 0d 99 2e 00 00 	mov    0x2e99(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1187:	ba 15 00 00 00       	mov    $0x15,%edx
