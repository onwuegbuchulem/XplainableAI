...
/app/bin_gccgcc10_O1/ex13:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1187:	85 ff                	test   %edi,%edi
    1189:	7e 32                	jle    11bd <main+0x54>
    118b:	49 89 f4             	mov    %rsi,%r12
    118e:	89 fd                	mov    %edi,%ebp
    1190:	bb 00 00 00 00       	mov    $0x0,%ebx
    1195:	4c 8d 2d 68 0e 00 00 	lea    0xe68(%rip),%r13        # 2004 <_IO_stdin_used+0x4>
    119c:	49 8b 0c dc          	mov    (%r12,%rbx,8),%rcx
    11a0:	89 da                	mov    %ebx,%edx
    ...
    11b8:	48 39 eb             	cmp    %rbp,%rbx
    11bb:	75 df                	jne    119c <main+0x33>
    11bd:	48 8d 05 4c 0e 00 00 	lea    0xe4c(%rip),%rax        # 2010 <_IO_stdin_used+0x10>
    11c4:	48 89 04 24          	mov    %rax,(%rsp)
    11c8:	48 8d 05 4c 0e 00 00 	lea    0xe4c(%rip),%rax        # 201b <_IO_stdin_used+0x1b>
    11cf:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11d4:	48 8d 05 47 0e 00 00 	lea    0xe47(%rip),%rax        # 2022 <_IO_stdin_used+0x22>
    11db:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11e0:	48 8d 05 46 0e 00 00 	lea    0xe46(%rip),%rax        # 202d <_IO_stdin_used+0x2d>
    11e7:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    11ec:	bb 00 00 00 00       	mov    $0x0,%ebx
    11f1:	48 8d 2d 3b 0e 00 00 	lea    0xe3b(%rip),%rbp        # 2033 <_IO_stdin_used+0x33>
    11f8:	48 8b 0c dc          	mov    (%rsp,%rbx,8),%rcx
    11fc:	89 da                	mov    %ebx,%edx
    ...
    1214:	48 83 fb 05          	cmp    $0x5,%rbx
    1218:	75 de                	jne    11f8 <main+0x8f>
    121a:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    121f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1226:	00 00 
    1228:	75 10                	jne    123a <main+0xd1>
    122a:	b8 00 00 00 00       	mov    $0x0,%eax
    122f:	48 83 c4 38          	add    $0x38,%rsp
    1233:	5b                   	pop    %rbx
    1234:	5d                   	pop    %rbp
    1235:	41 5c                	pop    %r12
    1237:	41 5d                	pop    %r13
    1239:	c3                   	retq   
    123a:	e8 21 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    123f:	90                   	nop
