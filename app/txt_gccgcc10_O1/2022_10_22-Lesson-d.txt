...
/app/bin_gccgcc10_O1/2022_10_22-Lesson-d:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    120d:	74 3a                	je     1249 <main+0x80>
    120f:	48 89 c3             	mov    %rax,%rbx
    1212:	48 89 e7             	mov    %rsp,%rdi
    1215:	48 89 c1             	mov    %rax,%rcx
    1218:	ba 01 00 00 00       	mov    $0x1,%edx
    121d:	be 08 00 00 00       	mov    $0x8,%esi
    1222:	e8 69 fe ff ff       	callq  1090 <fread@plt>
    1227:	48 8b 14 24          	mov    (%rsp),%rdx
    122b:	48 8d 35 d4 0d 00 00 	lea    0xdd4(%rip),%rsi        # 2006 <_IO_stdin_used+0x6>
    1232:	bf 01 00 00 00       	mov    $0x1,%edi
    1237:	b8 00 00 00 00       	mov    $0x0,%eax
    123c:	e8 7f fe ff ff       	callq  10c0 <__printf_chk@plt>
    1241:	48 89 df             	mov    %rbx,%rdi
    1244:	e8 57 fe ff ff       	callq  10a0 <fclose@plt>
    1249:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    124e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1255:	00 00 
    1257:	75 0b                	jne    1264 <main+0x9b>
    1259:	b8 00 00 00 00       	mov    $0x0,%eax
    125e:	48 83 c4 20          	add    $0x20,%rsp
    1262:	5b                   	pop    %rbx
    1263:	c3                   	retq   
    1264:	e8 47 fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
