...
/app/bin_gccgcc10_O0/2019_07_13-Lesson-c:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	66 c7 45 f6 30 00    	movw   $0x30,-0xa(%rbp)
    11aa:	48 8d 4d e8          	lea    -0x18(%rbp),%rcx
    11ae:	48 8d 45 f6          	lea    -0xa(%rbp),%rax
    11b2:	ba 0a 00 00 00       	mov    $0xa,%edx
    11b7:	48 89 ce             	mov    %rcx,%rsi
    11ba:	48 89 c7             	mov    %rax,%rdi
    11bd:	e8 ce fe ff ff       	callq  1090 <strtol@plt>
    11c2:	89 45 e4             	mov    %eax,-0x1c(%rbp)
    11c5:	8b 55 e4             	mov    -0x1c(%rbp),%edx
    11c8:	48 8d 45 f6          	lea    -0xa(%rbp),%rax
    11cc:	48 89 c6             	mov    %rax,%rsi
    11cf:	48 8d 3d 32 0e 00 00 	lea    0xe32(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11d6:	b8 00 00 00 00       	mov    $0x0,%eax
    11db:	e8 a0 fe ff ff       	callq  1080 <printf@plt>
    11e0:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx
    11e4:	48 8d 45 f6          	lea    -0xa(%rbp),%rax
    11e8:	48 39 c2             	cmp    %rax,%rdx
    11eb:	75 18                	jne    1205 <main+0x7c>
    11ed:	48 8d 45 f6          	lea    -0xa(%rbp),%rax
    ...
    1200:	e8 7b fe ff ff       	callq  1080 <printf@plt>
    1205:	b8 00 00 00 00       	mov    $0x0,%eax
    120a:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    120e:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1215:	00 00 
    1217:	74 05                	je     121e <main+0x95>
    1219:	e8 52 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    121e:	c9                   	leaveq 
    121f:	c3                   	retq   
