...
/app/bin_gccgcc10_O1/2022_11_19-Lesson-a:     file format elf64-x86-64
...
0000000000001100 <_start>:
    ...
    1121:	48 8d 3d 5a 03 00 00 	lea    0x35a(%rip),%rdi        # 1482 <main>
...
0000000000001482 <main>:
    ...
    1493:	00 00 
    1495:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    149a:	31 c0                	xor    %eax,%eax
    149c:	bf 00 00 00 00       	mov    $0x0,%edi
    14a1:	e8 2a fc ff ff       	callq  10d0 <time@plt>
    14a6:	48 89 c7             	mov    %rax,%rdi
    14a9:	e8 02 fc ff ff       	callq  10b0 <srand@plt>
    14ae:	e8 3d fc ff ff       	callq  10f0 <rand@plt>
    14b3:	99                   	cltd   
    14b4:	c1 ea 1a             	shr    $0x1a,%edx
    14b7:	8d 1c 10             	lea    (%rax,%rdx,1),%ebx
    14ba:	83 e3 3f             	and    $0x3f,%ebx
    14bd:	29 d3                	sub    %edx,%ebx
    14bf:	48 89 e5             	mov    %rsp,%rbp
    14c2:	48 89 ee             	mov    %rbp,%rsi
    14c5:	89 df                	mov    %ebx,%edi
    14c7:	e8 a8 fe ff ff       	callq  1374 <moveto>
    14cc:	48 89 ee             	mov    %rbp,%rsi
    14cf:	89 df                	mov    %ebx,%edi
    14d1:	e8 13 fd ff ff       	callq  11e9 <chess_board>
    14d6:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    14db:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    14e2:	00 00 
    14e4:	75 0c                	jne    14f2 <main+0x70>
    14e6:	b8 00 00 00 00       	mov    $0x0,%eax
    14eb:	48 83 c4 38          	add    $0x38,%rsp
    14ef:	5b                   	pop    %rbx
    14f0:	5d                   	pop    %rbp
    14f1:	c3                   	retq   
    14f2:	e8 a9 fb ff ff       	callq  10a0 <__stack_chk_fail@plt>
