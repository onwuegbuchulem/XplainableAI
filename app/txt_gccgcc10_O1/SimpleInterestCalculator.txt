...
/app/bin_gccgcc10_O1/SimpleInterestCalculator:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11dc:	48 8d 3d 64 0e 00 00 	lea    0xe64(%rip),%rdi        # 2047 <_IO_stdin_used+0x47>
    11e3:	b8 00 00 00 00       	mov    $0x0,%eax
    11e8:	e8 c3 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11ed:	f3 0f 10 44 24 0c    	movss  0xc(%rsp),%xmm0
    11f3:	f3 0f 59 44 24 10    	mulss  0x10(%rsp),%xmm0
    11f9:	f3 0f 59 44 24 14    	mulss  0x14(%rsp),%xmm0
    11ff:	f3 0f 5e 05 61 0e 00 	divss  0xe61(%rip),%xmm0        # 2068 <_IO_stdin_used+0x68>
    1206:	00 
    1207:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    120b:	48 8d 35 3c 0e 00 00 	lea    0xe3c(%rip),%rsi        # 204e <_IO_stdin_used+0x4e>
