...
/app/bin_gccgcc10_O0/2021_10_09-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	c7 45 f3 41 42 43 44 	movl   $0x44434241,-0xd(%rbp)
    11ab:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    11af:	48 8d 45 f3          	lea    -0xd(%rbp),%rax
    11b3:	48 89 c7             	mov    %rax,%rdi
    11b6:	e8 b5 fe ff ff       	callq  1070 <puts@plt>
    11bb:	48 8d 45 f3          	lea    -0xd(%rbp),%rax
    ...
    11ce:	e8 bd fe ff ff       	callq  1090 <printf@plt>
    11d3:	48 8d 45 f3          	lea    -0xd(%rbp),%rax
