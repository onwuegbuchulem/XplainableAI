...
/app/bin_gccgcc10_O0/2020_10-Exercise-recursive:     file format elf64-x86-64
...
00000000000011b7 <main>:
    ...
    11e3:	48 8d 45 f4          	lea    -0xc(%rbp),%rax
    11e7:	48 89 c6             	mov    %rax,%rsi
    11ea:	48 8d 3d 37 0e 00 00 	lea    0xe37(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    11f1:	b8 00 00 00 00       	mov    $0x0,%eax
    11f6:	e8 95 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11fb:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11fe:	89 c7                	mov    %eax,%edi
    1200:	e8 84 ff ff ff       	callq  1189 <cumulative>
    1205:	89 c2                	mov    %eax,%edx
    1207:	8b 45 f4             	mov    -0xc(%rbp),%eax
    120a:	89 c6                	mov    %eax,%esi
    120c:	48 8d 3d 1d 0e 00 00 	lea    0xe1d(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    ...
    1226:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    122d:	00 00 
    122f:	74 05                	je     1236 <main+0x7f>
