...
/app/bin_gccgcc10_O0/2023_05_06-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	c7 45 dc 14 00 00 00 	movl   $0x14,-0x24(%rbp)
    11ab:	eb 29                	jmp    11d6 <main+0x4d>
    11ad:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11b1:	48 89 c6             	mov    %rax,%rsi
    11b4:	bf 00 00 00 00       	mov    $0x0,%edi
    11b9:	e8 b2 fe ff ff       	callq  1070 <clock_gettime@plt>
    ...
    11d1:	e8 ba fe ff ff       	callq  1090 <printf@plt>
    11d6:	8b 45 dc             	mov    -0x24(%rbp),%eax
    11d9:	8d 50 ff             	lea    -0x1(%rax),%edx
    11dc:	89 55 dc             	mov    %edx,-0x24(%rbp)
    11df:	85 c0                	test   %eax,%eax
    11e1:	75 ca                	jne    11ad <main+0x24>
    11e3:	b8 00 00 00 00       	mov    $0x0,%eax
    11e8:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11ec:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11f3:	00 00 
