...
/app/bin_gccgcc10_O0/2020_10_24-Lesson-b:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    115c:	eb 5d                	jmp    11bb <main+0x72>
    115e:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
    ...
    1176:	e8 d5 fe ff ff       	callq  1050 <printf@plt>
    117b:	c7 45 f8 02 00 00 00 	movl   $0x2,-0x8(%rbp)
    1182:	eb 15                	jmp    1199 <main+0x50>
    1184:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1187:	99                   	cltd   
    1188:	f7 7d f8             	idivl  -0x8(%rbp)
    118b:	89 d0                	mov    %edx,%eax
    118d:	85 c0                	test   %eax,%eax
    118f:	75 04                	jne    1195 <main+0x4c>
    1191:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    1195:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    1199:	8b 45 f8             	mov    -0x8(%rbp),%eax
    119c:	3b 45 f4             	cmp    -0xc(%rbp),%eax
    119f:	7c e3                	jl     1184 <main+0x3b>
    ...
    11b2:	e8 99 fe ff ff       	callq  1050 <printf@plt>
    11b7:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    11bb:	83 7d f4 63          	cmpl   $0x63,-0xc(%rbp)
    11bf:	7e 9d                	jle    115e <main+0x15>
