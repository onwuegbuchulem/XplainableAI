...
/app/bin_gccgcc10_O2/01_strings:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1068:	ba 61 00 00 00       	mov    $0x61,%edx
    ...
    1080:	ba 62 00 00 00       	mov    $0x62,%edx
    ...
    1098:	ba 63 00 00 00       	mov    $0x63,%edx
