...
/app/bin_gccgcc10_O2/2020_09_05-Lesson-c:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c8:	4c 8d 6c 24 10       	lea    0x10(%rsp),%r13
    10cd:	49 89 e4             	mov    %rsp,%r12
    10d0:	e8 ab ff ff ff       	callq  1080 <__printf_chk@plt>
    10d5:	4c 89 ea             	mov    %r13,%rdx
    10d8:	4c 89 e6             	mov    %r12,%rsi
    10db:	31 c0                	xor    %eax,%eax
    10dd:	48 8d 3d 3e 0f 00 00 	lea    0xf3e(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    10e4:	e8 a7 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10e9:	31 c0                	xor    %eax,%eax
    10eb:	4c 89 e9             	mov    %r13,%rcx
    10ee:	4c 89 e2             	mov    %r12,%rdx
    10f1:	48 8d 35 30 0f 00 00 	lea    0xf30(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    10f8:	bf 01 00 00 00       	mov    $0x1,%edi
    10fd:	e8 7e ff ff ff       	callq  1080 <__printf_chk@plt>
    1102:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    1107:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    110e:	00 00 
    1110:	75 0b                	jne    111d <main+0x7d>
    1112:	48 83 c4 38          	add    $0x38,%rsp
