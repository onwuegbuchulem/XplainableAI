...
/app/bin_gccgcc10_O1/2022_10_22-Lesson-b:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11e5:	48 b8 2f 64 65 76 2f 	movabs $0x6e61722f7665642f,%rax
    11ec:	72 61 6e 
    11ef:	48 89 44 24 0c       	mov    %rax,0xc(%rsp)
    11f4:	c7 44 24 14 64 6f 6d 	movl   $0x6d6f64,0x14(%rsp)
    11fb:	00 
    11fc:	48 8d 7c 24 0c       	lea    0xc(%rsp),%rdi
    1201:	48 8d 35 fc 0d 00 00 	lea    0xdfc(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1208:	e8 c3 fe ff ff       	callq  10d0 <fopen@plt>
    120d:	48 85 c0             	test   %rax,%rax
    1210:	74 38                	je     124a <main+0x81>
    1212:	48 89 c5             	mov    %rax,%rbp
    1215:	bb 0a 00 00 00       	mov    $0xa,%ebx
    121a:	4c 8d 25 e5 0d 00 00 	lea    0xde5(%rip),%r12        # 2006 <_IO_stdin_used+0x6>
    1221:	48 89 ef             	mov    %rbp,%rdi
    1224:	e8 87 fe ff ff       	callq  10b0 <fgetc@plt>
    1229:	89 c2                	mov    %eax,%edx
    122b:	4c 89 e6             	mov    %r12,%rsi
    122e:	bf 01 00 00 00       	mov    $0x1,%edi
    1233:	b8 00 00 00 00       	mov    $0x0,%eax
    1238:	e8 83 fe ff ff       	callq  10c0 <__printf_chk@plt>
    123d:	83 eb 01             	sub    $0x1,%ebx
    1240:	75 df                	jne    1221 <main+0x58>
    1242:	48 89 ef             	mov    %rbp,%rdi
    1245:	e8 46 fe ff ff       	callq  1090 <fclose@plt>
    124a:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    124f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1256:	00 00 
    1258:	75 0e                	jne    1268 <main+0x9f>
