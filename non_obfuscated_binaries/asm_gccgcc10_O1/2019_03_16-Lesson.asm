...
/app/bin_gccgcc10_O1/2019_03_16-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1175:	e8 e6 fe ff ff       	callq  1060 <getenv@plt>
    117a:	48 89 c3             	mov    %rax,%rbx
    117d:	0f b6 38             	movzbl (%rax),%edi
    1180:	40 84 ff             	test   %dil,%dil
    1183:	75 35                	jne    11ba <main+0x51>
    1185:	48 8b 35 84 2e 00 00 	mov    0x2e84(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    118c:	bf 0a 00 00 00       	mov    $0xa,%edi
    1191:	e8 da fe ff ff       	callq  1070 <putc@plt>
    1196:	b8 00 00 00 00       	mov    $0x0,%eax
    119b:	5b                   	pop    %rbx
    119c:	c3                   	retq   
    119d:	48 8b 35 6c 2e 00 00 	mov    0x2e6c(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11a4:	bf 0a 00 00 00       	mov    $0xa,%edi
    11a9:	e8 c2 fe ff ff       	callq  1070 <putc@plt>
    11ae:	48 83 c3 01          	add    $0x1,%rbx
    11b2:	0f b6 3b             	movzbl (%rbx),%edi
    11b5:	40 84 ff             	test   %dil,%dil
    11b8:	74 cb                	je     1185 <main+0x1c>
    11ba:	40 80 ff 3a          	cmp    $0x3a,%dil
    11be:	74 dd                	je     119d <main+0x34>
    11c0:	40 0f be ff          	movsbl %dil,%edi
    11c4:	48 8b 35 45 2e 00 00 	mov    0x2e45(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11cb:	e8 a0 fe ff ff       	callq  1070 <putc@plt>
    11d0:	eb dc                	jmp    11ae <main+0x45>
