...
/app/bin_gccgcc10_O1/2022_04_30-Lesson-c:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1181:	c6 04 24 41          	movb   $0x41,(%rsp)
    1185:	c6 44 24 01 42       	movb   $0x42,0x1(%rsp)
    118a:	c6 44 24 02 43       	movb   $0x43,0x2(%rsp)
    118f:	c6 44 24 03 44       	movb   $0x44,0x3(%rsp)
    1194:	c6 44 24 04 45       	movb   $0x45,0x4(%rsp)
    1199:	c6 44 24 05 46       	movb   $0x46,0x5(%rsp)
    119e:	c6 44 24 06 47       	movb   $0x47,0x6(%rsp)
    11a3:	c6 44 24 07 48       	movb   $0x48,0x7(%rsp)
    11a8:	c6 44 24 08 49       	movb   $0x49,0x8(%rsp)
    11ad:	c6 44 24 09 4a       	movb   $0x4a,0x9(%rsp)
    11b2:	c6 44 24 0a 00       	movb   $0x0,0xa(%rsp)
    11b7:	48 89 e7             	mov    %rsp,%rdi
    11ba:	e8 a1 fe ff ff       	callq  1060 <puts@plt>
    11bf:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11c4:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11cb:	00 00 
    11cd:	75 0a                	jne    11d9 <main+0x70>
    11cf:	b8 00 00 00 00       	mov    $0x0,%eax
    11d4:	48 83 c4 28          	add    $0x28,%rsp
    11d8:	c3                   	retq   
    11d9:	e8 92 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
