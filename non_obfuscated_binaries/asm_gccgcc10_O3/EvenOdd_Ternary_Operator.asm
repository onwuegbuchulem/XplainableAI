...
/app/bin_gccgcc10_O3/EvenOdd_Ternary_Operator:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10f0:	48 8d 3d 1e 0f 00 00 	lea    0xf1e(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    10f7:	e8 b4 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10fc:	f6 44 24 04 01       	testb  $0x1,0x4(%rsp)
    1101:	75 23                	jne    1126 <main+0x66>
    1103:	48 8d 3d 0e 0f 00 00 	lea    0xf0e(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    110a:	e8 71 ff ff ff       	callq  1080 <puts@plt>
    110f:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1114:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    111b:	00 00 
    111d:	75 15                	jne    1134 <main+0x74>
    111f:	31 c0                	xor    %eax,%eax
    1121:	48 83 c4 18          	add    $0x18,%rsp
    1125:	c3                   	retq   
    1126:	48 8d 3d f6 0e 00 00 	lea    0xef6(%rip),%rdi        # 2023 <_IO_stdin_used+0x23>
    112d:	e8 4e ff ff ff       	callq  1080 <puts@plt>
    1132:	eb db                	jmp    110f <main+0x4f>
    1134:	e8 57 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
