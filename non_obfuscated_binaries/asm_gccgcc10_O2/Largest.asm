...
/app/bin_gccgcc10_O2/Largest:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    1132:	0f 8e 86 00 00 00    	jle    11be <main+0xfe>
    ...
    1158:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    115c:	48 83 c5 04          	add    $0x4,%rbp
    1160:	39 d9                	cmp    %ebx,%ecx
    1162:	7f e4                	jg     1148 <main+0x88>
    1164:	41 8b 14 24          	mov    (%r12),%edx
    1168:	83 f9 01             	cmp    $0x1,%ecx
    116b:	7e 23                	jle    1190 <main+0xd0>
    116d:	83 e9 02             	sub    $0x2,%ecx
    1170:	49 8d 44 24 04       	lea    0x4(%r12),%rax
    1175:	49 8d 74 8c 08       	lea    0x8(%r12,%rcx,4),%rsi
    117a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1180:	8b 08                	mov    (%rax),%ecx
    1182:	39 ca                	cmp    %ecx,%edx
    1184:	0f 4c d1             	cmovl  %ecx,%edx
    1187:	48 83 c0 04          	add    $0x4,%rax
    118b:	48 39 f0             	cmp    %rsi,%rax
    118e:	75 f0                	jne    1180 <main+0xc0>
    1190:	31 c0                	xor    %eax,%eax
    1192:	48 8d 35 9c 0e 00 00 	lea    0xe9c(%rip),%rsi        # 2035 <_IO_stdin_used+0x35>
    1199:	bf 01 00 00 00       	mov    $0x1,%edi
    119e:	e8 fd fe ff ff       	callq  10a0 <__printf_chk@plt>
    11a3:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11a8:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11af:	00 00 
    11b1:	75 11                	jne    11c4 <main+0x104>
    ...
    11bb:	41 5d                	pop    %r13
    11bd:	c3                   	retq   
    11be:	41 8b 14 24          	mov    (%r12),%edx
    11c2:	eb cc                	jmp    1190 <main+0xd0>
    11c4:	e8 b7 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
