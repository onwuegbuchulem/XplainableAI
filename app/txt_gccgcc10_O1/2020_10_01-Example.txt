...
/app/bin_gccgcc10_O1/2020_10_01-Example:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11cc:	83 fa 01             	cmp    $0x1,%edx
    11cf:	7e 4c                	jle    121d <main+0x94>
    11d1:	f3 0f 10 05 77 0e 00 	movss  0xe77(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    11d8:	00 
    11d9:	b8 01 00 00 00       	mov    $0x1,%eax
    11de:	f3 0f 58 c0          	addss  %xmm0,%xmm0
    11e2:	83 c0 01             	add    $0x1,%eax
    11e5:	39 d0                	cmp    %edx,%eax
    11e7:	75 f5                	jne    11de <main+0x55>
    11e9:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    11ed:	48 8d 35 34 0e 00 00 	lea    0xe34(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    11f4:	bf 01 00 00 00       	mov    $0x1,%edi
    11f9:	b8 01 00 00 00       	mov    $0x1,%eax
    11fe:	e8 7d fe ff ff       	callq  1080 <__printf_chk@plt>
    1203:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1208:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    120f:	00 00 
    1211:	75 14                	jne    1227 <main+0x9e>
    1213:	b8 00 00 00 00       	mov    $0x0,%eax
    1218:	48 83 c4 18          	add    $0x18,%rsp
    121c:	c3                   	retq   
    121d:	f3 0f 10 05 2b 0e 00 	movss  0xe2b(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    1224:	00 
    1225:	eb c2                	jmp    11e9 <main+0x60>
