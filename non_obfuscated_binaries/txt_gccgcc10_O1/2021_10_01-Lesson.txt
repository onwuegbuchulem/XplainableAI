...
/app/bin_gccgcc10_O1/2021_10_01-Lesson:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d e5 00 00 00 	lea    0xe5(%rip),%rdi        # 118d <main>
...
0000000000001169 <inc>:
    1169:	f3 0f 1e fa          	endbr64 
    116d:	0f b6 07             	movzbl (%rdi),%eax
    1170:	83 c0 01             	add    $0x1,%eax
    1173:	ba 00 00 00 00       	mov    $0x0,%edx
    1178:	3c 5a                	cmp    $0x5a,%al
    117a:	7f 05                	jg     1181 <inc+0x18>
    117c:	88 07                	mov    %al,(%rdi)
    117e:	89 d0                	mov    %edx,%eax
    1180:	c3                   	retq   
    1181:	b8 41 00 00 00       	mov    $0x41,%eax
    1186:	ba 01 00 00 00       	mov    $0x1,%edx
    118b:	eb ef                	jmp    117c <inc+0x13>
...
000000000000118d <main>:
    ...
    11a6:	c7 44 24 03 41 41 41 	movl   $0x41414141,0x3(%rsp)
    11ad:	41 
    11ae:	c6 44 24 07 00       	movb   $0x0,0x7(%rsp)
    11b3:	48 8d 1d 4a 0e 00 00 	lea    0xe4a(%rip),%rbx        # 2004 <_IO_stdin_used+0x4>
    11ba:	48 8d 74 24 03       	lea    0x3(%rsp),%rsi
    11bf:	b9 05 00 00 00       	mov    $0x5,%ecx
    11c4:	48 89 df             	mov    %rbx,%rdi
    11c7:	f3 a6                	repz cmpsb %es:(%rdi),%ds:(%rsi)
    11c9:	0f 97 c0             	seta   %al
    11cc:	1c 00                	sbb    $0x0,%al
    11ce:	84 c0                	test   %al,%al
    11d0:	74 40                	je     1212 <main+0x85>
    11d2:	48 8d 7c 24 03       	lea    0x3(%rsp),%rdi
    11d7:	e8 84 fe ff ff       	callq  1060 <puts@plt>
    11dc:	48 8d 7c 24 06       	lea    0x6(%rsp),%rdi
    11e1:	e8 83 ff ff ff       	callq  1169 <inc>
    11e6:	85 c0                	test   %eax,%eax
    11e8:	74 d0                	je     11ba <main+0x2d>
    11ea:	48 8d 7c 24 05       	lea    0x5(%rsp),%rdi
    11ef:	e8 75 ff ff ff       	callq  1169 <inc>
    11f4:	85 c0                	test   %eax,%eax
    11f6:	74 c2                	je     11ba <main+0x2d>
    11f8:	48 8d 7c 24 04       	lea    0x4(%rsp),%rdi
    11fd:	e8 67 ff ff ff       	callq  1169 <inc>
    1202:	85 c0                	test   %eax,%eax
    1204:	74 b4                	je     11ba <main+0x2d>
    1206:	48 8d 7c 24 03       	lea    0x3(%rsp),%rdi
    120b:	e8 59 ff ff ff       	callq  1169 <inc>
    1210:	eb a8                	jmp    11ba <main+0x2d>
    1212:	48 8d 7c 24 03       	lea    0x3(%rsp),%rdi
    1217:	e8 44 fe ff ff       	callq  1060 <puts@plt>
    121c:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1221:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1228:	00 00 
    122a:	75 0b                	jne    1237 <main+0xaa>
    122c:	b8 00 00 00 00       	mov    $0x0,%eax
    1231:	48 83 c4 10          	add    $0x10,%rsp
    1235:	5b                   	pop    %rbx
    1236:	c3                   	retq   
    1237:	e8 34 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
