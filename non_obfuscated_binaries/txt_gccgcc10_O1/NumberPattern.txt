...
/app/bin_gccgcc10_O1/NumberPattern:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11df:	48 8d 3d 35 0e 00 00 	lea    0xe35(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    11e6:	b8 00 00 00 00       	mov    $0x0,%eax
    11eb:	e8 c0 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11f0:	41 be 01 00 00 00    	mov    $0x1,%r14d
    11f6:	bd 01 00 00 00       	mov    $0x1,%ebp
    11fb:	41 bc 01 00 00 00    	mov    $0x1,%r12d
    1201:	83 7c 24 04 00       	cmpl   $0x0,0x4(%rsp)
    1206:	7f 5a                	jg     1262 <main+0xb9>
    1208:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    120d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1214:	00 00 
    1216:	75 59                	jne    1271 <main+0xc8>
    ...
    1227:	41 5e                	pop    %r14
    1229:	c3                   	retq   
    122a:	89 da                	mov    %ebx,%edx
    122c:	48 8d 35 eb 0d 00 00 	lea    0xdeb(%rip),%rsi        # 201e <_IO_stdin_used+0x1e>
    1233:	44 89 e7             	mov    %r12d,%edi
    1236:	b8 00 00 00 00       	mov    $0x0,%eax
    123b:	e8 60 fe ff ff       	callq  10a0 <__printf_chk@plt>
    1240:	83 c3 01             	add    $0x1,%ebx
    1243:	41 8d 44 1d 00       	lea    0x0(%r13,%rbx,1),%eax
    1248:	39 e8                	cmp    %ebp,%eax
    124a:	7e de                	jle    122a <main+0x81>
    124c:	41 89 de             	mov    %ebx,%r14d
    124f:	bf 0a 00 00 00       	mov    $0xa,%edi
    1254:	e8 27 fe ff ff       	callq  1080 <putchar@plt>
    1259:	83 c5 01             	add    $0x1,%ebp
    125c:	39 6c 24 04          	cmp    %ebp,0x4(%rsp)
    1260:	7c a6                	jl     1208 <main+0x5f>
    1262:	44 89 f3             	mov    %r14d,%ebx
    1265:	45 89 e5             	mov    %r12d,%r13d
    1268:	45 29 f5             	sub    %r14d,%r13d
    126b:	85 ed                	test   %ebp,%ebp
    126d:	7f bb                	jg     122a <main+0x81>
    126f:	eb de                	jmp    124f <main+0xa6>
