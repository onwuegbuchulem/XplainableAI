...
/app/bin_gccgcc10_O1/22_pi:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d 22 01 00 00 	lea    0x122(%rip),%rdi        # 11aa <main>
...
0000000000001149 <p>:
    ...
    1151:	f3 0f 11 44 24 08    	movss  %xmm0,0x8(%rsp)
    1157:	f3 0f 10 05 ad 0e 00 	movss  0xead(%rip),%xmm0        # 200c <_IO_stdin_used+0xc>
    115e:	00 
    115f:	0f 2f c1             	comiss %xmm1,%xmm0
    1162:	77 0c                	ja     1170 <p+0x27>
    1164:	f3 0f 59 c9          	mulss  %xmm1,%xmm1
    1168:	0f 28 c1             	movaps %xmm1,%xmm0
    116b:	48 83 c4 18          	add    $0x18,%rsp
    116f:	c3                   	retq   
    1170:	0f 28 d1             	movaps %xmm1,%xmm2
    1173:	f3 0f 59 d1          	mulss  %xmm1,%xmm2
    1177:	f3 0f 11 54 24 0c    	movss  %xmm2,0xc(%rsp)
    117d:	f3 0f 10 44 24 08    	movss  0x8(%rsp),%xmm0
    1183:	f3 0f 58 05 89 0e 00 	addss  0xe89(%rip),%xmm0        # 2014 <_IO_stdin_used+0x14>
    118a:	00 
    118b:	f3 0f 58 0d 7d 0e 00 	addss  0xe7d(%rip),%xmm1        # 2010 <_IO_stdin_used+0x10>
    1192:	00 
    1193:	e8 b1 ff ff ff       	callq  1149 <p>
    1198:	f3 0f 10 4c 24 0c    	movss  0xc(%rsp),%xmm1
    119e:	f3 0f 5e c8          	divss  %xmm0,%xmm1
    11a2:	f3 0f 58 4c 24 08    	addss  0x8(%rsp),%xmm1
    11a8:	eb be                	jmp    1168 <p+0x1f>

00000000000011aa <main>:
    11aa:	f3 0f 1e fa          	endbr64 
    11ae:	48 83 ec 08          	sub    $0x8,%rsp
    11b2:	f3 0f 10 0d 56 0e 00 	movss  0xe56(%rip),%xmm1        # 2010 <_IO_stdin_used+0x10>
    11b9:	00 
    11ba:	0f 28 c1             	movaps %xmm1,%xmm0
    11bd:	e8 87 ff ff ff       	callq  1149 <p>
    11c2:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11c6:	f3 0f 5a c8          	cvtss2sd %xmm0,%xmm1
    11ca:	f2 0f 10 05 46 0e 00 	movsd  0xe46(%rip),%xmm0        # 2018 <_IO_stdin_used+0x18>
    11d1:	00 
    ...
    11e7:	e8 64 fe ff ff       	callq  1050 <__printf_chk@plt>
    11ec:	b8 00 00 00 00       	mov    $0x0,%eax
    11f1:	48 83 c4 08          	add    $0x8,%rsp
    11f5:	c3                   	retq   
