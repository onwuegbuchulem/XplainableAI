...
/app/bin_gccgcc10_O1/Gross_Salary:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11cd:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    11d2:	48 8d 3d 84 0e 00 00 	lea    0xe84(%rip),%rdi        # 205d <_IO_stdin_used+0x5d>
    ...
    11f4:	48 8d 3d 62 0e 00 00 	lea    0xe62(%rip),%rdi        # 205d <_IO_stdin_used+0x5d>
    11fb:	b8 00 00 00 00       	mov    $0x0,%eax
    1200:	e8 ab fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1205:	48 8d 3d 23 0e 00 00 	lea    0xe23(%rip),%rdi        # 202f <_IO_stdin_used+0x2f>
    120c:	e8 6f fe ff ff       	callq  1080 <puts@plt>
    1211:	48 8d 74 24 14       	lea    0x14(%rsp),%rsi
    ...
    1227:	f3 0f 10 44 24 10    	movss  0x10(%rsp),%xmm0
    122d:	0f 28 c8             	movaps %xmm0,%xmm1
    1230:	f3 0f 58 4c 24 0c    	addss  0xc(%rsp),%xmm1
    1236:	f3 0f 10 44 24 14    	movss  0x14(%rsp),%xmm0
    123c:	f3 0f 5e 05 1c 0e 00 	divss  0xe1c(%rip),%xmm0        # 2060 <_IO_stdin_used+0x60>
    1243:	00 
    1244:	f3 0f 58 05 18 0e 00 	addss  0xe18(%rip),%xmm0        # 2064 <_IO_stdin_used+0x64>
    124b:	00 
    124c:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    1250:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1254:	48 8d 35 f2 0d 00 00 	lea    0xdf2(%rip),%rsi        # 204d <_IO_stdin_used+0x4d>
    125b:	bf 01 00 00 00       	mov    $0x1,%edi
    1260:	b8 01 00 00 00       	mov    $0x1,%eax
    1265:	e8 36 fe ff ff       	callq  10a0 <__printf_chk@plt>
    126a:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    126f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1276:	00 00 
    1278:	75 05                	jne    127f <main+0xd6>
    127a:	48 83 c4 28          	add    $0x28,%rsp
    127e:	c3                   	retq   
    127f:	e8 0c fe ff ff       	callq  1090 <__stack_chk_fail@plt>
