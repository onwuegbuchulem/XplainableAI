...
/app/bin_gccgcc10_O0/2020_09_05-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b5:	48 8d 55 dc          	lea    -0x24(%rbp),%rdx
    11b9:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11bd:	48 89 c6             	mov    %rax,%rsi
    11c0:	48 8d 3d 59 0e 00 00 	lea    0xe59(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    ...
    11db:	48 8d 3d 44 0e 00 00 	lea    0xe44(%rip),%rdi        # 2026 <_IO_stdin_used+0x26>
    ...
    11f5:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11fc:	00 00 
    11fe:	74 05                	je     1205 <main+0x7c>
    1200:	e8 6b fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1205:	c9                   	leaveq 
    1206:	c3                   	retq   
