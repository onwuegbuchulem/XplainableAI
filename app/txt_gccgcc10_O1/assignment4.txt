...
/app/bin_gccgcc10_O1/assignment4:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ce:	f3 0f 59 c0          	mulss  %xmm0,%xmm0
    11d2:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    11d6:	f2 0f 59 05 6a 0e 00 	mulsd  0xe6a(%rip),%xmm0        # 2048 <_IO_stdin_used+0x48>
    11dd:	00 
    11de:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    11e2:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    11e6:	48 8d 35 3d 0e 00 00 	lea    0xe3d(%rip),%rsi        # 202a <_IO_stdin_used+0x2a>
    11ed:	bf 01 00 00 00       	mov    $0x1,%edi
    11f2:	b8 01 00 00 00       	mov    $0x1,%eax
    11f7:	e8 84 fe ff ff       	callq  1080 <__printf_chk@plt>
    11fc:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1201:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1208:	00 00 
    120a:	75 0a                	jne    1216 <main+0x8d>
    120c:	b8 00 00 00 00       	mov    $0x0,%eax
    1211:	48 83 c4 18          	add    $0x18,%rsp
    1215:	c3                   	retq   
