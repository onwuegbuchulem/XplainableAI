...
/app/bin_gccgcc10_O0/2019_11_09-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 d0 22 00 00 00 	movl   $0x22,-0x30(%rbp)
    118b:	48 b8 47 65 6f 72 67 	movabs $0x6567726f6547,%rax
    1192:	65 00 00 
    1195:	48 89 45 d4          	mov    %rax,-0x2c(%rbp)
    1199:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
    11a0:	8b 45 d0             	mov    -0x30(%rbp),%eax
    11a3:	48 8d 55 d0          	lea    -0x30(%rbp),%rdx
    11a7:	48 8d 4a 04          	lea    0x4(%rdx),%rcx
    11ab:	89 c2                	mov    %eax,%edx
    11ad:	48 89 ce             	mov    %rcx,%rsi
    11b0:	48 8d 3d 4d 0e 00 00 	lea    0xe4d(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11b7:	b8 00 00 00 00       	mov    $0x0,%eax
    11bc:	e8 af fe ff ff       	callq  1070 <printf@plt>
    11c1:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
    11c5:	48 8b 55 d8          	mov    -0x28(%rbp),%rdx
    11c9:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    11cd:	48 89 55 e8          	mov    %rdx,-0x18(%rbp)
    11d1:	8b 45 e0             	mov    -0x20(%rbp),%eax
    11d4:	48 8d 55 e0          	lea    -0x20(%rbp),%rdx
    11d8:	48 8d 4a 04          	lea    0x4(%rdx),%rcx
    ...
    11f7:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    11fb:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    1202:	00 00 
