...
/app/bin_gccgcc10_O0/2020_10_03-Lesson-b:     file format elf64-x86-64
...
00000000000010b0 <ttyname@plt>:
    10b0:	f3 0f 1e fa          	endbr64 
    10b4:	f2 ff 25 05 2f 00 00 	bnd jmpq *0x2f05(%rip)        # 3fc0 <ttyname@GLIBC_2.2.5>
...
00000000000011c9 <main>:
    ...
    11da:	e8 d1 fe ff ff       	callq  10b0 <ttyname@plt>
    11df:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    ...
    11f1:	e8 ca fe ff ff       	callq  10c0 <fopen@plt>
    11f6:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11fa:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
    11ff:	75 29                	jne    122a <main+0x61>
    1201:	48 8b 05 18 2e 00 00 	mov    0x2e18(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    1208:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    120c:	48 8d 35 f3 0d 00 00 	lea    0xdf3(%rip),%rsi        # 2006 <_IO_stdin_used+0x6>
    1213:	48 89 c7             	mov    %rax,%rdi
    1216:	b8 00 00 00 00       	mov    $0x0,%eax
    121b:	e8 80 fe ff ff       	callq  10a0 <fprintf@plt>
    1220:	bf 01 00 00 00       	mov    $0x1,%edi
    1225:	e8 a6 fe ff ff       	callq  10d0 <exit@plt>
    122a:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    ...
    1241:	e8 5a fe ff ff       	callq  10a0 <fprintf@plt>
    1246:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    124a:	48 89 c7             	mov    %rax,%rdi
    124d:	e8 3e fe ff ff       	callq  1090 <fclose@plt>
