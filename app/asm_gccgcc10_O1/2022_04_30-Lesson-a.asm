...
/app/bin_gccgcc10_O1/2022_04_30-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1183:	c6 04 24 41          	movb   $0x41,(%rsp)
    1187:	c6 44 24 01 42       	movb   $0x42,0x1(%rsp)
    118c:	c6 44 24 02 43       	movb   $0x43,0x2(%rsp)
    1191:	c6 44 24 03 44       	movb   $0x44,0x3(%rsp)
    1196:	c6 44 24 04 45       	movb   $0x45,0x4(%rsp)
    119b:	c6 44 24 05 46       	movb   $0x46,0x5(%rsp)
    11a0:	c6 44 24 06 47       	movb   $0x47,0x6(%rsp)
    11a5:	c6 44 24 07 48       	movb   $0x48,0x7(%rsp)
    11aa:	c6 44 24 08 49       	movb   $0x49,0x8(%rsp)
    11af:	c6 44 24 09 4a       	movb   $0x4a,0x9(%rsp)
    11b4:	48 89 e3             	mov    %rsp,%rbx
    11b7:	48 8d 6c 24 0a       	lea    0xa(%rsp),%rbp
    11bc:	0f be 3b             	movsbl (%rbx),%edi
    11bf:	48 8b 35 4a 2e 00 00 	mov    0x2e4a(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11c6:	e8 a5 fe ff ff       	callq  1070 <putc@plt>
    11cb:	48 83 c3 01          	add    $0x1,%rbx
    11cf:	48 39 eb             	cmp    %rbp,%rbx
    11d2:	75 e8                	jne    11bc <main+0x53>
    11d4:	48 8b 35 35 2e 00 00 	mov    0x2e35(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11db:	bf 0a 00 00 00       	mov    $0xa,%edi
    11e0:	e8 8b fe ff ff       	callq  1070 <putc@plt>
    11e5:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11ea:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f1:	00 00 
    11f3:	75 0c                	jne    1201 <main+0x98>
