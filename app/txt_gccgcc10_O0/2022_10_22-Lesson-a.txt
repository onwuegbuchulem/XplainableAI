...
/app/bin_gccgcc10_O0/2022_10_22-Lesson-a:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    1215:	74 31                	je     1248 <main+0x7f>
    1217:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    121b:	48 89 c7             	mov    %rax,%rdi
    121e:	e8 9d fe ff ff       	callq  10c0 <fgetc@plt>
    1223:	89 45 dc             	mov    %eax,-0x24(%rbp)
    1226:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1229:	89 c6                	mov    %eax,%esi
    122b:	48 8d 3d d4 0d 00 00 	lea    0xdd4(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1232:	b8 00 00 00 00       	mov    $0x0,%eax
    1237:	e8 74 fe ff ff       	callq  10b0 <printf@plt>
    123c:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1240:	48 89 c7             	mov    %rax,%rdi
    1243:	e8 48 fe ff ff       	callq  1090 <fclose@plt>
    1248:	b8 00 00 00 00       	mov    $0x0,%eax
    124d:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1251:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1258:	00 00 
    125a:	74 05                	je     1261 <main+0x98>
