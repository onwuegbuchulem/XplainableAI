...
/app/bin_gccgcc10_O2/CheckCharacterType:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e9:	48 8d 3d 26 0f 00 00 	lea    0xf26(%rip),%rdi        # 2016 <_IO_stdin_used+0x16>
    10f0:	31 c0                	xor    %eax,%eax
    10f2:	e8 b9 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10f7:	0f b6 44 24 07       	movzbl 0x7(%rsp),%eax
    10fc:	89 c2                	mov    %eax,%edx
    10fe:	83 e2 df             	and    $0xffffffdf,%edx
    1101:	83 ea 41             	sub    $0x41,%edx
    1104:	80 fa 19             	cmp    $0x19,%dl
    1107:	76 46                	jbe    114f <main+0x8f>
    1109:	83 e8 30             	sub    $0x30,%eax
    110c:	3c 09                	cmp    $0x9,%al
    110e:	76 2a                	jbe    113a <main+0x7a>
    1110:	48 8d 35 49 0f 00 00 	lea    0xf49(%rip),%rsi        # 2060 <_IO_stdin_used+0x60>
    ...
    112f:	00 00 
    1131:	75 31                	jne    1164 <main+0xa4>
    1133:	31 c0                	xor    %eax,%eax
    1135:	48 83 c4 18          	add    $0x18,%rsp
    1139:	c3                   	retq   
    113a:	48 8d 35 d8 0e 00 00 	lea    0xed8(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    1141:	bf 01 00 00 00       	mov    $0x1,%edi
    1146:	31 c0                	xor    %eax,%eax
    1148:	e8 53 ff ff ff       	callq  10a0 <__printf_chk@plt>
    114d:	eb d4                	jmp    1123 <main+0x63>
    114f:	48 8d 35 e2 0e 00 00 	lea    0xee2(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    1156:	bf 01 00 00 00       	mov    $0x1,%edi
    115b:	31 c0                	xor    %eax,%eax
    115d:	e8 3e ff ff ff       	callq  10a0 <__printf_chk@plt>
    1162:	eb bf                	jmp    1123 <main+0x63>
