...
/app/bin_gccgcc10_O3/2020_01_11-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <asprintf@plt>:
    1080:	f3 0f 1e fa          	endbr64 
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <asprintf@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10a4:	41 54                	push   %r12
    10a6:	ba 0d 00 00 00       	mov    $0xd,%edx
    10ab:	48 8d 35 52 0f 00 00 	lea    0xf52(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10b2:	31 c0                	xor    %eax,%eax
    10b4:	53                   	push   %rbx
    10b5:	31 db                	xor    %ebx,%ebx
    10b7:	48 89 df             	mov    %rbx,%rdi
    10ba:	48 83 ec 08          	sub    $0x8,%rsp
    10be:	e8 bd ff ff ff       	callq  1080 <asprintf@plt>
    10c3:	48 8b 3b             	mov    (%rbx),%rdi
    10c6:	41 89 c4             	mov    %eax,%r12d
    10c9:	e8 a2 ff ff ff       	callq  1070 <puts@plt>
    10ce:	44 89 e2             	mov    %r12d,%edx
    10d1:	bf 01 00 00 00       	mov    $0x1,%edi
    10d6:	31 c0                	xor    %eax,%eax
    10d8:	48 8d 35 36 0f 00 00 	lea    0xf36(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    10df:	e8 ac ff ff ff       	callq  1090 <__printf_chk@plt>
    10e4:	48 83 c4 08          	add    $0x8,%rsp
