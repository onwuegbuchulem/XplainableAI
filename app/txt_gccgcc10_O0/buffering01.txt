...
/app/bin_gccgcc10_O0/buffering01:     file format elf64-x86-64
...
00000000000010b0 <getchar@plt>:
    ...
    10b4:	f2 ff 25 15 2f 00 00 	bnd jmpq *0x2f15(%rip)        # 3fd0 <getchar@GLIBC_2.2.5>
...
00000000000011a9 <main>:
    ...
    11cd:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11d4:	00 00 
    11d6:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11da:	31 c0                	xor    %eax,%eax
    11dc:	48 8b 05 2d 2e 00 00 	mov    0x2e2d(%rip),%rax        # 4010 <stdout@@GLIBC_2.2.5>
    11e3:	48 8d 95 f0 df ff ff 	lea    -0x2010(%rbp),%rdx
    11ea:	48 89 d6             	mov    %rdx,%rsi
    11ed:	48 89 c7             	mov    %rax,%rdi
    11f0:	e8 9b fe ff ff       	callq  1090 <setbuf@plt>
    11f5:	48 8d 3d 08 0e 00 00 	lea    0xe08(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11fc:	b8 00 00 00 00       	mov    $0x0,%eax
    1201:	e8 9a fe ff ff       	callq  10a0 <printf@plt>
    1206:	e8 a5 fe ff ff       	callq  10b0 <getchar@plt>
    120b:	89 85 e8 df ff ff    	mov    %eax,-0x2018(%rbp)
    ...
    1222:	e8 89 fe ff ff       	callq  10b0 <getchar@plt>
    1227:	89 85 ec df ff ff    	mov    %eax,-0x2014(%rbp)
    122d:	8b 95 ec df ff ff    	mov    -0x2014(%rbp),%edx
    1233:	8b 85 e8 df ff ff    	mov    -0x2018(%rbp),%eax
    1239:	89 c6                	mov    %eax,%esi
    123b:	48 8d 3d d1 0d 00 00 	lea    0xdd1(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    1242:	b8 00 00 00 00       	mov    $0x0,%eax
    1247:	e8 54 fe ff ff       	callq  10a0 <printf@plt>
    124c:	b8 00 00 00 00       	mov    $0x0,%eax
    1251:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1255:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    125c:	00 00 
    125e:	74 05                	je     1265 <main+0xbc>
    1260:	e8 1b fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    1265:	c9                   	leaveq 
    1266:	c3                   	retq   
