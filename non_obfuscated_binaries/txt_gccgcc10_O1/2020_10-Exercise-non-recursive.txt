...
/app/bin_gccgcc10_O1/2020_10-Exercise-non-recursive:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d e3 00 00 00 	lea    0xe3(%rip),%rdi        # 11ab <main>
...
0000000000001189 <cumulative>:
    ...
    118f:	74 16                	je     11a7 <cumulative+0x1e>
    1191:	ba 00 00 00 00       	mov    $0x0,%edx
    1196:	b8 01 00 00 00       	mov    $0x1,%eax
    119b:	01 c2                	add    %eax,%edx
    119d:	83 c0 01             	add    $0x1,%eax
    11a0:	39 c7                	cmp    %eax,%edi
    11a2:	73 f7                	jae    119b <cumulative+0x12>
    11a4:	89 d0                	mov    %edx,%eax
    11a6:	c3                   	retq   
    11a7:	89 fa                	mov    %edi,%edx
    11a9:	eb f9                	jmp    11a4 <cumulative+0x1b>
...
00000000000011ab <main>:
    ...
    11d0:	e8 ab fe ff ff       	callq  1080 <__printf_chk@plt>
    11d5:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11da:	48 8d 3d 74 0e 00 00 	lea    0xe74(%rip),%rdi        # 2055 <_IO_stdin_used+0x55>
    11e1:	b8 00 00 00 00       	mov    $0x0,%eax
    11e6:	e8 a5 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11eb:	8b 5c 24 04          	mov    0x4(%rsp),%ebx
    11ef:	89 df                	mov    %ebx,%edi
    11f1:	e8 93 ff ff ff       	callq  1189 <cumulative>
    11f6:	89 c1                	mov    %eax,%ecx
    11f8:	89 da                	mov    %ebx,%edx
    11fa:	48 8d 35 27 0e 00 00 	lea    0xe27(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    1201:	bf 01 00 00 00       	mov    $0x1,%edi
    1206:	b8 00 00 00 00       	mov    $0x0,%eax
    120b:	e8 70 fe ff ff       	callq  1080 <__printf_chk@plt>
    1210:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1215:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    121c:	00 00 
    121e:	75 0b                	jne    122b <main+0x80>
