...
/app/bin_gccgcc10_O1/Subtraction:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ba:	48 8d 3d 58 0e 00 00 	lea    0xe58(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    11c1:	b8 00 00 00 00       	mov    $0x0,%eax
    11c6:	e8 c5 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cb:	8b 14 24             	mov    (%rsp),%edx
    11ce:	2b 54 24 04          	sub    0x4(%rsp),%edx
    11d2:	48 8d 35 46 0e 00 00 	lea    0xe46(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    11d9:	bf 01 00 00 00       	mov    $0x1,%edi
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 98 fe ff ff       	callq  1080 <__printf_chk@plt>
    11e8:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11ed:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f4:	00 00 
    11f6:	75 05                	jne    11fd <main+0x74>
    11f8:	48 83 c4 18          	add    $0x18,%rsp
    11fc:	c3                   	retq   
    11fd:	e8 6e fe ff ff       	callq  1070 <__stack_chk_fail@plt>
