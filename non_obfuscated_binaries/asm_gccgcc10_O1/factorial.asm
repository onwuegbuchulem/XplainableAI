...
/app/bin_gccgcc10_O1/Factorial:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b7:	48 8d 3d 57 0e 00 00 	lea    0xe57(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	8b 74 24 04          	mov    0x4(%rsp),%esi
    11cc:	85 f6                	test   %esi,%esi
    11ce:	78 53                	js     1223 <main+0x9a>
    11d0:	b9 01 00 00 00       	mov    $0x1,%ecx
    11d5:	7e 1a                	jle    11f1 <main+0x68>
    11d7:	8d 56 01             	lea    0x1(%rsi),%edx
    11da:	b8 01 00 00 00       	mov    $0x1,%eax
    11df:	b9 01 00 00 00       	mov    $0x1,%ecx
    11e4:	48 0f af c8          	imul   %rax,%rcx
    11e8:	48 83 c0 01          	add    $0x1,%rax
    11ec:	48 39 d0             	cmp    %rdx,%rax
    11ef:	75 f3                	jne    11e4 <main+0x5b>
    11f1:	89 f2                	mov    %esi,%edx
    11f3:	48 8d 35 1e 0e 00 00 	lea    0xe1e(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    ...
    1215:	00 00 
    1217:	75 22                	jne    123b <main+0xb2>
    1219:	b8 00 00 00 00       	mov    $0x0,%eax
    121e:	48 83 c4 18          	add    $0x18,%rsp
    1222:	c3                   	retq   
    1223:	48 8d 35 06 0e 00 00 	lea    0xe06(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    122a:	bf 01 00 00 00       	mov    $0x1,%edi
    122f:	b8 00 00 00 00       	mov    $0x0,%eax
    1234:	e8 47 fe ff ff       	callq  1080 <__printf_chk@plt>
    1239:	eb ce                	jmp    1209 <main+0x80>
