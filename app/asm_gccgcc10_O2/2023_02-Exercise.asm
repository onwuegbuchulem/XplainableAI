...
/app/bin_gccgcc10_O2/2023_02-Exercise:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c4:	41 54                	push   %r12
    10c6:	31 ff                	xor    %edi,%edi
    10c8:	41 bc 01 00 00 00    	mov    $0x1,%r12d
    10ce:	55                   	push   %rbp
    10cf:	48 8d 2d 2e 0f 00 00 	lea    0xf2e(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    10d6:	53                   	push   %rbx
    10d7:	e8 b4 ff ff ff       	callq  1090 <time@plt>
    10dc:	48 89 c7             	mov    %rax,%rdi
    10df:	e8 9c ff ff ff       	callq  1080 <srand@plt>
    10e4:	0f 1f 40 00          	nopl   0x0(%rax)
    10e8:	e8 c3 ff ff ff       	callq  10b0 <rand@plt>
    10ed:	41 83 c4 01          	add    $0x1,%r12d
    10f1:	48 89 ee             	mov    %rbp,%rsi
    10f4:	bf 01 00 00 00       	mov    $0x1,%edi
    10f9:	48 63 d8             	movslq %eax,%rbx
    10fc:	99                   	cltd   
    10fd:	48 69 db 1f 85 eb 51 	imul   $0x51eb851f,%rbx,%rbx
    1104:	48 c1 fb 25          	sar    $0x25,%rbx
    1108:	29 d3                	sub    %edx,%ebx
    110a:	6b d3 64             	imul   $0x64,%ebx,%edx
    110d:	29 d0                	sub    %edx,%eax
    110f:	44 89 e2             	mov    %r12d,%edx
    1112:	89 c3                	mov    %eax,%ebx
    1114:	89 c1                	mov    %eax,%ecx
    1116:	31 c0                	xor    %eax,%eax
    1118:	e8 83 ff ff ff       	callq  10a0 <__printf_chk@plt>
    111d:	83 fb 63             	cmp    $0x63,%ebx
    1120:	75 c6                	jne    10e8 <main+0x28>
    1122:	44 89 e2             	mov    %r12d,%edx
    1125:	b9 63 00 00 00       	mov    $0x63,%ecx
    112a:	bf 01 00 00 00       	mov    $0x1,%edi
    112f:	31 c0                	xor    %eax,%eax
    1131:	48 8d 35 cc 0e 00 00 	lea    0xecc(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1138:	e8 63 ff ff ff       	callq  10a0 <__printf_chk@plt>
    113d:	5b                   	pop    %rbx
