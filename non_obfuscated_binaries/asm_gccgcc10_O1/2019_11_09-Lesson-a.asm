...
/app/bin_gccgcc10_O1/2019_11_09-Lesson-a:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11e1:	c7 04 24 22 00 00 00 	movl   $0x22,(%rsp)
    11e8:	48 b8 47 65 6f 72 67 	movabs $0x6567726f6547,%rax
    11ef:	65 00 00 
    11f2:	48 89 44 24 04       	mov    %rax,0x4(%rsp)
    11f7:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%rsp)
    11fe:	00 
    11ff:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    1204:	b9 22 00 00 00       	mov    $0x22,%ecx
    ...
    121f:	bf 10 00 00 00       	mov    $0x10,%edi
    1224:	e8 77 fe ff ff       	callq  10a0 <malloc@plt>
    1229:	48 85 c0             	test   %rax,%rax
    122c:	74 44                	je     1272 <main+0xa9>
    122e:	48 8b 0c 24          	mov    (%rsp),%rcx
    1232:	48 89 08             	mov    %rcx,(%rax)
    1235:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    123a:	48 89 50 08          	mov    %rdx,0x8(%rax)
    123e:	48 8d 50 04          	lea    0x4(%rax),%rdx
    ...
    1264:	00 00 
    1266:	75 31                	jne    1299 <main+0xd0>
    1268:	b8 00 00 00 00       	mov    $0x0,%eax
    126d:	48 83 c4 28          	add    $0x28,%rsp
    1271:	c3                   	retq   
    1272:	48 8b 0d a7 2d 00 00 	mov    0x2da7(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1279:	ba 1a 00 00 00       	mov    $0x1a,%edx
    127e:	be 01 00 00 00       	mov    $0x1,%esi
    1283:	48 8d 3d 8e 0d 00 00 	lea    0xd8e(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    128a:	e8 41 fe ff ff       	callq  10d0 <fwrite@plt>
    128f:	bf 01 00 00 00       	mov    $0x1,%edi
    1294:	e8 27 fe ff ff       	callq  10c0 <exit@plt>
    1299:	e8 f2 fd ff ff       	callq  1090 <__stack_chk_fail@plt>
