...
/app/bin_gccgcc10_O2/2019_05_25-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	55                   	push   %rbp
    1085:	bf 48 00 00 00       	mov    $0x48,%edi
    108a:	48 8d 2d 73 0f 00 00 	lea    0xf73(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1091:	53                   	push   %rbx
    1092:	48 83 ec 38          	sub    $0x38,%rsp
    1096:	66 0f 6f 05 42 10 00 	movdqa 0x1042(%rip),%xmm0        # 20e0 <_IO_stdin_used+0xe0>
    109d:	00 
    109e:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10a5:	00 00 
    10a7:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    10ac:	31 c0                	xor    %eax,%eax
    10ae:	b8 74 0a 00 00       	mov    $0xa74,%eax
    10b3:	c6 44 24 22 00       	movb   $0x0,0x22(%rsp)
    10b8:	48 8d 5c 24 01       	lea    0x1(%rsp),%rbx
    10bd:	0f 11 04 24          	movups %xmm0,(%rsp)
    10c1:	66 0f 6f 05 27 10 00 	movdqa 0x1027(%rip),%xmm0        # 20f0 <_IO_stdin_used+0xf0>
    10c8:	00 
    10c9:	66 89 44 24 20       	mov    %ax,0x20(%rsp)
    10ce:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10d3:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10d8:	8d 47 f6             	lea    -0xa(%rdi),%eax
    10db:	48 8b 35 2e 2f 00 00 	mov    0x2f2e(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10e2:	3c 35                	cmp    $0x35,%al
    10e4:	77 12                	ja     10f8 <main+0x78>
    10e6:	0f b6 c0             	movzbl %al,%eax
    10e9:	48 63 44 85 00       	movslq 0x0(%rbp,%rax,4),%rax
    10ee:	48 01 e8             	add    %rbp,%rax
    10f1:	3e ff e0             	notrack jmpq *%rax
    10f4:	0f 1f 40 00          	nopl   0x0(%rax)
    10f8:	e8 73 ff ff ff       	callq  1070 <putc@plt>
    10fd:	0f be 3b             	movsbl (%rbx),%edi
    1100:	48 83 c3 01          	add    $0x1,%rbx
    1104:	40 84 ff             	test   %dil,%dil
    1107:	75 cf                	jne    10d8 <main+0x58>
    1109:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    110e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1115:	00 00 
    1117:	75 1b                	jne    1134 <main+0xb4>
    1119:	48 83 c4 38          	add    $0x38,%rsp
    111d:	31 c0                	xor    %eax,%eax
    111f:	5b                   	pop    %rbx
    1120:	5d                   	pop    %rbp
    1121:	c3                   	retq   
    1122:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1128:	bf 0a 00 00 00       	mov    $0xa,%edi
    112d:	e8 3e ff ff ff       	callq  1070 <putc@plt>
    1132:	eb c9                	jmp    10fd <main+0x7d>
    1134:	e8 27 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
