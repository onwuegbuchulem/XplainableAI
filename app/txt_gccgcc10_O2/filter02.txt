...
/app/bin_gccgcc10_O2/filter02:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c4:	55                   	push   %rbp
    10c5:	53                   	push   %rbx
    10c6:	48 83 ec 18          	sub    $0x18,%rsp
    10ca:	eb 46                	jmp    1112 <main+0x52>
    10cc:	0f 1f 40 00          	nopl   0x0(%rax)
    10d0:	e8 db ff ff ff       	callq  10b0 <__ctype_b_loc@plt>
    10d5:	48 63 dd             	movslq %ebp,%rbx
    10d8:	48 8b 35 31 2f 00 00 	mov    0x2f31(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10df:	48 8b 00             	mov    (%rax),%rax
    10e2:	f6 44 58 01 02       	testb  $0x2,0x1(%rax,%rbx,2)
    10e7:	74 22                	je     110b <main+0x4b>
    10e9:	8d 85 80 00 00 00    	lea    0x80(%rbp),%eax
    10ef:	3d 7f 01 00 00       	cmp    $0x17f,%eax
    10f4:	77 15                	ja     110b <main+0x4b>
    10f6:	48 89 74 24 08       	mov    %rsi,0x8(%rsp)
    10fb:	e8 80 ff ff ff       	callq  1080 <__ctype_toupper_loc@plt>
    1100:	48 8b 74 24 08       	mov    0x8(%rsp),%rsi
    1105:	48 8b 00             	mov    (%rax),%rax
    1108:	8b 2c 98             	mov    (%rax,%rbx,4),%ebp
    110b:	89 ef                	mov    %ebp,%edi
    110d:	e8 7e ff ff ff       	callq  1090 <putc@plt>
    1112:	48 8b 3d 07 2f 00 00 	mov    0x2f07(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    1119:	e8 82 ff ff ff       	callq  10a0 <getc@plt>
    111e:	89 c5                	mov    %eax,%ebp
    1120:	83 f8 ff             	cmp    $0xffffffff,%eax
    1123:	75 ab                	jne    10d0 <main+0x10>
    1125:	48 83 c4 18          	add    $0x18,%rsp
