...
/app/bin_gccgcc10_O0/pithy01:     file format elf64-x86-64
...
0000000000001229 <main>:
    ...
    1231:	48 81 ec 30 01 00 00 	sub    $0x130,%rsp
    1238:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    123f:	00 00 
    1241:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1245:	31 c0                	xor    %eax,%eax
    1247:	48 b8 70 69 74 68 79 	movabs $0x78742e7968746970,%rax
    124e:	2e 74 78 
    1251:	48 89 85 e6 fe ff ff 	mov    %rax,-0x11a(%rbp)
    1258:	66 c7 85 ee fe ff ff 	movw   $0x74,-0x112(%rbp)
    125f:	74 00 
    1261:	48 8d 85 e6 fe ff ff 	lea    -0x11a(%rbp),%rax
    1268:	48 8d 35 95 0d 00 00 	lea    0xd95(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    126f:	48 89 c7             	mov    %rax,%rdi
    1272:	e8 a9 fe ff ff       	callq  1120 <fopen@plt>
    1277:	48 89 85 d0 fe ff ff 	mov    %rax,-0x130(%rbp)
    127e:	48 83 bd d0 fe ff ff 	cmpq   $0x0,-0x130(%rbp)
    1285:	00 
    1286:	75 73                	jne    12fb <main+0xd2>
    1288:	48 8b 05 91 2d 00 00 	mov    0x2d91(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    128f:	48 8d 95 e6 fe ff ff 	lea    -0x11a(%rbp),%rdx
    1296:	48 8d 35 69 0d 00 00 	lea    0xd69(%rip),%rsi        # 2006 <_IO_stdin_used+0x6>
    129d:	48 89 c7             	mov    %rax,%rdi
    12a0:	b8 00 00 00 00       	mov    $0x0,%eax
    12a5:	e8 56 fe ff ff       	callq  1100 <fprintf@plt>
    12aa:	bf 01 00 00 00       	mov    $0x1,%edi
    12af:	e8 7c fe ff ff       	callq  1130 <exit@plt>
    12b4:	48 8b 95 d0 fe ff ff 	mov    -0x130(%rbp),%rdx
    12bb:	48 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%rax
    12c2:	be 00 01 00 00       	mov    $0x100,%esi
    12c7:	48 89 c7             	mov    %rax,%rdi
    12ca:	e8 21 fe ff ff       	callq  10f0 <fgets@plt>
    12cf:	48 89 85 d8 fe ff ff 	mov    %rax,-0x128(%rbp)
    12d6:	48 83 bd d8 fe ff ff 	cmpq   $0x0,-0x128(%rbp)
    12dd:	00 
    12de:	74 30                	je     1310 <main+0xe7>
    12e0:	48 8d 85 f0 fe ff ff 	lea    -0x110(%rbp),%rax
    12e7:	48 89 c6             	mov    %rax,%rsi
    12ea:	48 8d 3d 2d 0d 00 00 	lea    0xd2d(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    12f1:	b8 00 00 00 00       	mov    $0x0,%eax
    12f6:	e8 e5 fd ff ff       	callq  10e0 <printf@plt>
    12fb:	48 8b 85 d0 fe ff ff 	mov    -0x130(%rbp),%rax
    1302:	48 89 c7             	mov    %rax,%rdi
    1305:	e8 06 fe ff ff       	callq  1110 <feof@plt>
    130a:	85 c0                	test   %eax,%eax
    130c:	74 a6                	je     12b4 <main+0x8b>
    130e:	eb 01                	jmp    1311 <main+0xe8>
    1310:	90                   	nop
    1311:	48 8b 85 d0 fe ff ff 	mov    -0x130(%rbp),%rax
    1318:	48 89 c7             	mov    %rax,%rdi
    131b:	e8 a0 fd ff ff       	callq  10c0 <fclose@plt>
    1320:	b8 00 00 00 00       	mov    $0x0,%eax
    1325:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1329:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1330:	00 00 
    1332:	74 05                	je     1339 <main+0x110>
    1334:	e8 97 fd ff ff       	callq  10d0 <__stack_chk_fail@plt>
    1339:	c9                   	leaveq 
    133a:	c3                   	retq   
