...
/app/bin_gccgcc10_O1/SumTwoNumbers:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b5:	48 8d 3d 78 0e 00 00 	lea    0xe78(%rip),%rdi        # 2034 <_IO_stdin_used+0x34>
    11bc:	b8 00 00 00 00       	mov    $0x0,%eax
    11c1:	e8 ca fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c6:	48 8d 35 4b 0e 00 00 	lea    0xe4b(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    ...
    11e1:	48 8d 3d 4c 0e 00 00 	lea    0xe4c(%rip),%rdi        # 2034 <_IO_stdin_used+0x34>
    11e8:	b8 00 00 00 00       	mov    $0x0,%eax
    11ed:	e8 9e fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f2:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11f6:	03 14 24             	add    (%rsp),%edx
    11f9:	48 8d 35 2d 0e 00 00 	lea    0xe2d(%rip),%rsi        # 202d <_IO_stdin_used+0x2d>
    1200:	bf 01 00 00 00       	mov    $0x1,%edi
    1205:	b8 00 00 00 00       	mov    $0x0,%eax
    120a:	e8 71 fe ff ff       	callq  1080 <__printf_chk@plt>
    120f:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1214:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    121b:	00 00 
    121d:	75 0a                	jne    1229 <main+0xa0>
    121f:	b8 00 00 00 00       	mov    $0x0,%eax
    1224:	48 83 c4 18          	add    $0x18,%rsp
    1228:	c3                   	retq   
