...
/app/bin_gccgcc10_O0/ansi02:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117c:	eb 51                	jmp    11cf <main+0x66>
    117e:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
    1185:	eb 32                	jmp    11b9 <main+0x50>
    1187:	8b 45 f8             	mov    -0x8(%rbp),%eax
    118a:	8d 70 28             	lea    0x28(%rax),%esi
    118d:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1190:	8d 48 1e             	lea    0x1e(%rax),%ecx
    1193:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1196:	8d 50 28             	lea    0x28(%rax),%edx
    1199:	8b 45 fc             	mov    -0x4(%rbp),%eax
    119c:	83 c0 1e             	add    $0x1e,%eax
    119f:	41 89 f0             	mov    %esi,%r8d
    ...
    11b9:	83 7d fc 07          	cmpl   $0x7,-0x4(%rbp)
    11bd:	7e c8                	jle    1187 <main+0x1e>
    11bf:	48 8d 3d 4e 0e 00 00 	lea    0xe4e(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    11c6:	e8 95 fe ff ff       	callq  1060 <puts@plt>
    11cb:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11cf:	83 7d f8 07          	cmpl   $0x7,-0x8(%rbp)
    11d3:	7e a9                	jle    117e <main+0x15>
