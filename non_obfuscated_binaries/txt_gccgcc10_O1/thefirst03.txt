...
/app/bin_gccgcc10_O1/thefirst03:     file format elf64-x86-64
...
0000000000001149 <thefirst>:
    1149:	f3 0f 1e fa          	endbr64 
    114d:	48 63 c6             	movslq %esi,%rax
    1150:	48 69 c0 93 24 49 92 	imul   $0xffffffff92492493,%rax,%rax
    1157:	48 c1 e8 20          	shr    $0x20,%rax
    115b:	01 f0                	add    %esi,%eax
    115d:	c1 f8 02             	sar    $0x2,%eax
    1160:	89 f2                	mov    %esi,%edx
    1162:	c1 fa 1f             	sar    $0x1f,%edx
    1165:	29 d0                	sub    %edx,%eax
    1167:	8d 14 c5 00 00 00 00 	lea    0x0(,%rax,8),%edx
    116e:	29 c2                	sub    %eax,%edx
    1170:	29 d6                	sub    %edx,%esi
    1172:	89 f8                	mov    %edi,%eax
    1174:	29 f0                	sub    %esi,%eax
    1176:	8d 50 08             	lea    0x8(%rax),%edx
    1179:	83 c0 01             	add    $0x1,%eax
    117c:	0f 48 c2             	cmovs  %edx,%eax
    117f:	c3                   	retq   

0000000000001180 <main>:
    1180:	f3 0f 1e fa          	endbr64 
    1184:	48 83 ec 08          	sub    $0x8,%rsp
    1188:	4c 8d 05 75 0e 00 00 	lea    0xe75(%rip),%r8        # 2004 <_IO_stdin_used+0x4>
    118f:	48 8d 0d 78 0e 00 00 	lea    0xe78(%rip),%rcx        # 200e <_IO_stdin_used+0xe>
    1196:	ba 19 00 00 00       	mov    $0x19,%edx
    119b:	48 8d 35 76 0e 00 00 	lea    0xe76(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    11a2:	bf 01 00 00 00       	mov    $0x1,%edi
    11a7:	b8 00 00 00 00       	mov    $0x0,%eax
    11ac:	e8 9f fe ff ff       	callq  1050 <__printf_chk@plt>
