...
/app/bin_gccgcc10_O2/01_problem1:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e4:	48 89 e6             	mov    %rsp,%rsi
    10e7:	48 8d 3d 23 0f 00 00 	lea    0xf23(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    10ee:	31 c0                	xor    %eax,%eax
    10f0:	e8 bb ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10f5:	48 8d 3d 18 0f 00 00 	lea    0xf18(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    10fc:	e8 7f ff ff ff       	callq  1080 <puts@plt>
    1101:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    1106:	48 8d 3d 04 0f 00 00 	lea    0xf04(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    110d:	31 c0                	xor    %eax,%eax
    110f:	e8 9c ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1114:	8b 14 24             	mov    (%rsp),%edx
    1117:	0f af 54 24 04       	imul   0x4(%rsp),%edx
    111c:	31 c0                	xor    %eax,%eax
    111e:	48 8d 35 03 0f 00 00 	lea    0xf03(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    1125:	bf 01 00 00 00       	mov    $0x1,%edi
    112a:	e8 71 ff ff ff       	callq  10a0 <__printf_chk@plt>
    112f:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1134:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    113b:	00 00 
    113d:	75 07                	jne    1146 <main+0x86>
    113f:	31 c0                	xor    %eax,%eax
    1141:	48 83 c4 18          	add    $0x18,%rsp
    1145:	c3                   	retq   
    1146:	e8 45 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
