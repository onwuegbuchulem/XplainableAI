...
/app/bin_gccgcc10_O2/main:     file format elf64-x86-64
...
0000000000001120 <main>:
    ...
    112d:	55                   	push   %rbp
    112e:	48 8d 2d cf 0e 00 00 	lea    0xecf(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1135:	53                   	push   %rbx
    ...
    114a:	4c 8d 6c 24 04       	lea    0x4(%rsp),%r13
    ...
    1163:	48 98                	cltq   
    1165:	48 69 c0 1f 85 eb 51 	imul   $0x51eb851f,%rax,%rax
    116c:	89 da                	mov    %ebx,%edx
    116e:	c1 fa 1f             	sar    $0x1f,%edx
    1171:	48 c1 f8 25          	sar    $0x25,%rax
    1175:	29 d0                	sub    %edx,%eax
    1177:	6b c0 64             	imul   $0x64,%eax,%eax
    117a:	29 c3                	sub    %eax,%ebx
    117c:	83 c3 01             	add    $0x1,%ebx
    117f:	eb 1d                	jmp    119e <main+0x7e>
    1181:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    1188:	48 8d 3d 9e 0e 00 00 	lea    0xe9e(%rip),%rdi        # 202d <_IO_stdin_used+0x2d>
    118f:	e8 1c ff ff ff       	callq  10b0 <puts@plt>
    1194:	41 83 c4 01          	add    $0x1,%r12d
    1198:	39 5c 24 04          	cmp    %ebx,0x4(%rsp)
    119c:	74 3e                	je     11dc <main+0xbc>
    119e:	48 89 ee             	mov    %rbp,%rsi
    ...
    11af:	4c 89 ee             	mov    %r13,%rsi
    11b2:	48 8d 3d 5c 0e 00 00 	lea    0xe5c(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    11b9:	e8 42 ff ff ff       	callq  1100 <__isoc99_scanf@plt>
    11be:	39 5c 24 04          	cmp    %ebx,0x4(%rsp)
    11c2:	7f 4c                	jg     1210 <main+0xf0>
    11c4:	7c c2                	jl     1188 <main+0x68>
    11c6:	48 8d 3d 76 0e 00 00 	lea    0xe76(%rip),%rdi        # 2043 <_IO_stdin_used+0x43>
    11cd:	41 83 c4 01          	add    $0x1,%r12d
    11d1:	e8 da fe ff ff       	callq  10b0 <puts@plt>
    11d6:	39 5c 24 04          	cmp    %ebx,0x4(%rsp)
    11da:	75 c2                	jne    119e <main+0x7e>
    11dc:	31 c0                	xor    %eax,%eax
    11de:	44 89 e2             	mov    %r12d,%edx
    11e1:	bf 01 00 00 00       	mov    $0x1,%edi
    11e6:	48 8d 35 63 0e 00 00 	lea    0xe63(%rip),%rsi        # 2050 <_IO_stdin_used+0x50>
    11ed:	e8 fe fe ff ff       	callq  10f0 <__printf_chk@plt>
    11f2:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11f7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11fe:	00 00 
    1200:	75 1f                	jne    1221 <main+0x101>
    1202:	48 83 c4 18          	add    $0x18,%rsp
    ...
    120e:	c3                   	retq   
    120f:	90                   	nop
    1210:	48 8d 3d 01 0e 00 00 	lea    0xe01(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    1217:	e8 94 fe ff ff       	callq  10b0 <puts@plt>
    121c:	e9 73 ff ff ff       	jmpq   1194 <main+0x74>
    1221:	e8 9a fe ff ff       	callq  10c0 <__stack_chk_fail@plt>
