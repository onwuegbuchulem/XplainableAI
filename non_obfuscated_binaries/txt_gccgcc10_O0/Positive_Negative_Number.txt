...
/app/bin_gccgcc10_O0/Positive_Negative_Number:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 3d 54 0e 00 00 	lea    0xe54(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    ...
    11d2:	7e 18                	jle    11ec <main+0x63>
    11d4:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11d7:	89 c6                	mov    %eax,%esi
    11d9:	48 8d 3d 3a 0e 00 00 	lea    0xe3a(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    11e0:	b8 00 00 00 00       	mov    $0x0,%eax
    11e5:	e8 96 fe ff ff       	callq  1080 <printf@plt>
    11ea:	eb 35                	jmp    1221 <main+0x98>
    11ec:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11ef:	85 c0                	test   %eax,%eax
    11f1:	79 18                	jns    120b <main+0x82>
    11f3:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11f6:	89 c6                	mov    %eax,%esi
    11f8:	48 8d 3d 2b 0e 00 00 	lea    0xe2b(%rip),%rdi        # 202a <_IO_stdin_used+0x2a>
    11ff:	b8 00 00 00 00       	mov    $0x0,%eax
    1204:	e8 77 fe ff ff       	callq  1080 <printf@plt>
    1209:	eb 16                	jmp    1221 <main+0x98>
    120b:	8b 45 f4             	mov    -0xc(%rbp),%eax
    120e:	89 c6                	mov    %eax,%esi
    1210:	48 8d 3d 23 0e 00 00 	lea    0xe23(%rip),%rdi        # 203a <_IO_stdin_used+0x3a>
