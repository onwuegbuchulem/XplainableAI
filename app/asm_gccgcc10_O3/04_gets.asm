...
/app/bin_gccgcc10_O3/04_gets:     file format elf64-x86-64
...
0000000000001080 <gets@plt>:
    ...
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <gets@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10ba:	49 89 e4             	mov    %rsp,%r12
    10bd:	4c 89 e7             	mov    %r12,%rdi
    10c0:	e8 bb ff ff ff       	callq  1080 <gets@plt>
    10c5:	bf 01 00 00 00       	mov    $0x1,%edi
    10ca:	31 c0                	xor    %eax,%eax
    10cc:	4c 89 e2             	mov    %r12,%rdx
    10cf:	48 8d 35 2e 0f 00 00 	lea    0xf2e(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10d6:	e8 b5 ff ff ff       	callq  1090 <__printf_chk@plt>
    10db:	31 c0                	xor    %eax,%eax
    10dd:	bf 01 00 00 00       	mov    $0x1,%edi
    10e2:	48 8d 35 1e 0f 00 00 	lea    0xf1e(%rip),%rsi        # 2007 <_IO_stdin_used+0x7>
    10e9:	e8 a2 ff ff ff       	callq  1090 <__printf_chk@plt>
    10ee:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    10f3:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10fa:	00 00 
    10fc:	75 09                	jne    1107 <main+0x67>
    10fe:	48 83 c4 30          	add    $0x30,%rsp
