...
/app/bin_gccgcc10_O3/assignment6:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10cc:	48 8d 3d 45 0f 00 00 	lea    0xf45(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    10d3:	31 c0                	xor    %eax,%eax
    10d5:	e8 b6 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10da:	48 8d 35 3a 0f 00 00 	lea    0xf3a(%rip),%rsi        # 201b <_IO_stdin_used+0x1b>
    ...
    10f2:	48 8d 3d 1f 0f 00 00 	lea    0xf1f(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    10f9:	31 c0                	xor    %eax,%eax
    10fb:	e8 90 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    1100:	8b 04 24             	mov    (%rsp),%eax
    1103:	99                   	cltd   
    1104:	f7 7c 24 04          	idivl  0x4(%rsp)
    1108:	85 d2                	test   %edx,%edx
    110a:	75 2a                	jne    1136 <main+0x96>
    110c:	48 8d 35 1e 0f 00 00 	lea    0xf1e(%rip),%rsi        # 2031 <_IO_stdin_used+0x31>
    1113:	bf 01 00 00 00       	mov    $0x1,%edi
    1118:	31 c0                	xor    %eax,%eax
    111a:	e8 61 ff ff ff       	callq  1080 <__printf_chk@plt>
    111f:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1124:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    112b:	00 00 
    112d:	75 1c                	jne    114b <main+0xab>
    112f:	31 c0                	xor    %eax,%eax
    1131:	48 83 c4 18          	add    $0x18,%rsp
    1135:	c3                   	retq   
    1136:	48 8d 35 0e 0f 00 00 	lea    0xf0e(%rip),%rsi        # 204b <_IO_stdin_used+0x4b>
    113d:	bf 01 00 00 00       	mov    $0x1,%edi
    1142:	31 c0                	xor    %eax,%eax
    1144:	e8 37 ff ff ff       	callq  1080 <__printf_chk@plt>
    1149:	eb d4                	jmp    111f <main+0x7f>
    114b:	e8 20 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
