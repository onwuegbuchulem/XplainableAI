...
/app/bin_gccgcc10_O2/2019_02_16-Lesson-c:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10a3:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx
    10a8:	4c 8d 64 24 2c       	lea    0x2c(%rsp),%r12
    10ad:	0f 1f 00             	nopl   (%rax)
    10b0:	8b 13                	mov    (%rbx),%edx
    10b2:	48 89 ee             	mov    %rbp,%rsi
    10b5:	bf 01 00 00 00       	mov    $0x1,%edi
    10ba:	31 c0                	xor    %eax,%eax
    10bc:	48 83 c3 04          	add    $0x4,%rbx
    10c0:	e8 ab ff ff ff       	callq  1070 <__printf_chk@plt>
    10c5:	4c 39 e3             	cmp    %r12,%rbx
    10c8:	75 e6                	jne    10b0 <main+0x30>
    10ca:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10cf:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10d6:	00 00 
    10d8:	75 0b                	jne    10e5 <main+0x65>
    10da:	48 83 c4 10          	add    $0x10,%rsp
    10de:	31 c0                	xor    %eax,%eax
    10e0:	5b                   	pop    %rbx
    10e1:	5d                   	pop    %rbp
    10e2:	41 5c                	pop    %r12
    10e4:	c3                   	retq   
    10e5:	e8 76 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
