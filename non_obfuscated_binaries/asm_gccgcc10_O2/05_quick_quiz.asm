...
/app/bin_gccgcc10_O2/05_quick_quiz:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1078:	83 c3 01             	add    $0x1,%ebx
    107b:	83 fb 15             	cmp    $0x15,%ebx
    107e:	74 1e                	je     109e <main+0x3e>
    1080:	83 fb 09             	cmp    $0x9,%ebx
    1083:	7e f3                	jle    1078 <main+0x18>
    1085:	89 da                	mov    %ebx,%edx
    1087:	48 89 ee             	mov    %rbp,%rsi
    108a:	bf 01 00 00 00       	mov    $0x1,%edi
    108f:	31 c0                	xor    %eax,%eax
    1091:	e8 ba ff ff ff       	callq  1050 <__printf_chk@plt>
    1096:	83 c3 01             	add    $0x1,%ebx
    1099:	83 fb 15             	cmp    $0x15,%ebx
    109c:	75 e2                	jne    1080 <main+0x20>
    109e:	48 83 c4 08          	add    $0x8,%rsp
