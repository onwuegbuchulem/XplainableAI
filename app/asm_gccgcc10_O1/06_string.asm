...
/app/bin_gccgcc10_O1/06_string:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    116d:	48 83 ec 38          	sub    $0x38,%rsp
    1171:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1178:	00 00 
    117a:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    117f:	31 c0                	xor    %eax,%eax
    1181:	48 b8 75 70 64 61 74 	movabs $0x742e657461647075,%rax
    1188:	65 2e 74 
    118b:	48 89 44 24 05       	mov    %rax,0x5(%rsp)
    1190:	66 c7 44 24 0d 78 74 	movw   $0x7478,0xd(%rsp)
    1197:	c6 44 24 0f 00       	movb   $0x0,0xf(%rsp)
    119c:	48 8d 44 24 10       	lea    0x10(%rsp),%rax
    11a1:	48 8d 54 24 20       	lea    0x20(%rsp),%rdx
    11a6:	c6 00 2e             	movb   $0x2e,(%rax)
    11a9:	48 83 c0 01          	add    $0x1,%rax
    11ad:	48 39 d0             	cmp    %rdx,%rax
    11b0:	75 f4                	jne    11a6 <main+0x3d>
    11b2:	0f b6 54 24 05       	movzbl 0x5(%rsp),%edx
    11b7:	80 fa 2e             	cmp    $0x2e,%dl
    11ba:	74 17                	je     11d3 <main+0x6a>
    11bc:	b8 00 00 00 00       	mov    $0x0,%eax
    11c1:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)
    11c5:	48 83 c0 01          	add    $0x1,%rax
    11c9:	0f b6 54 04 05       	movzbl 0x5(%rsp,%rax,1),%edx
    11ce:	80 fa 2e             	cmp    $0x2e,%dl
    11d1:	75 ee                	jne    11c1 <main+0x58>
    11d3:	48 8d 4c 24 05       	lea    0x5(%rsp),%rcx
    11d8:	48 8d 54 24 10       	lea    0x10(%rsp),%rdx
    11dd:	48 8d 35 24 0e 00 00 	lea    0xe24(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    11e4:	bf 01 00 00 00       	mov    $0x1,%edi
    11e9:	b8 00 00 00 00       	mov    $0x0,%eax
    11ee:	e8 7d fe ff ff       	callq  1070 <__printf_chk@plt>
    11f3:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    11f8:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11ff:	00 00 
    1201:	75 0a                	jne    120d <main+0xa4>
    1203:	b8 00 00 00 00       	mov    $0x0,%eax
    1208:	48 83 c4 38          	add    $0x38,%rsp
    120c:	c3                   	retq   
    120d:	e8 4e fe ff ff       	callq  1060 <__stack_chk_fail@plt>
