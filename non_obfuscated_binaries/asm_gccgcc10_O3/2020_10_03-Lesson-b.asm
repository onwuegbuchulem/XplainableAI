...
/app/bin_gccgcc10_O3/2020_10_03-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <ttyname@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 0d 2f 00 00 	bnd jmpq *0x2f0d(%rip)        # 3fb8 <ttyname@GLIBC_2.2.5>
    10ab:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010b0 <fopen@plt>:
    10b0:	f3 0f 1e fa          	endbr64 
    10b4:	f2 ff 25 05 2f 00 00 	bnd jmpq *0x2f05(%rip)        # 3fc0 <fopen@GLIBC_2.2.5>
...
00000000000010e0 <main>:
    ...
    10e8:	55                   	push   %rbp
    10e9:	48 83 ec 08          	sub    $0x8,%rsp
    10ed:	e8 ae ff ff ff       	callq  10a0 <ttyname@plt>
    10f2:	48 8d 35 0b 0f 00 00 	lea    0xf0b(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10f9:	48 89 c7             	mov    %rax,%rdi
    10fc:	49 89 c4             	mov    %rax,%r12
    10ff:	e8 ac ff ff ff       	callq  10b0 <fopen@plt>
    1104:	48 85 c0             	test   %rax,%rax
    1107:	74 2e                	je     1137 <main+0x57>
    1109:	48 89 c5             	mov    %rax,%rbp
    110c:	4c 89 e1             	mov    %r12,%rcx
    110f:	48 89 c7             	mov    %rax,%rdi
    1112:	be 01 00 00 00       	mov    $0x1,%esi
    1117:	48 8d 15 fb 0e 00 00 	lea    0xefb(%rip),%rdx        # 2019 <_IO_stdin_used+0x19>
    111e:	31 c0                	xor    %eax,%eax
    1120:	e8 ab ff ff ff       	callq  10d0 <__fprintf_chk@plt>
    1125:	48 89 ef             	mov    %rbp,%rdi
    1128:	e8 63 ff ff ff       	callq  1090 <fclose@plt>
    112d:	48 83 c4 08          	add    $0x8,%rsp
    1131:	31 c0                	xor    %eax,%eax
    1133:	5d                   	pop    %rbp
    1134:	41 5c                	pop    %r12
    1136:	c3                   	retq   
    1137:	48 8b 3d e2 2e 00 00 	mov    0x2ee2(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    ...
    114f:	e8 7c ff ff ff       	callq  10d0 <__fprintf_chk@plt>
    1154:	bf 01 00 00 00       	mov    $0x1,%edi
    1159:	e8 62 ff ff ff       	callq  10c0 <exit@plt>
