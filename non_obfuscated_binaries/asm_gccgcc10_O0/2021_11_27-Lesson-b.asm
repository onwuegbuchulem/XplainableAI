...
/app/bin_gccgcc10_O0/2021_11_27-Lesson-b:     file format elf64-x86-64
...
0000000000001090 <strcspn@plt>:
    ...
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <strcspn@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    11a4:	48 b8 48 65 6c 6c 6f 	movabs $0x77202c6f6c6c6548,%rax
    11ab:	2c 20 77 
    11ae:	48 89 45 ea          	mov    %rax,-0x16(%rbp)
    11b2:	c7 45 f2 6f 72 6c 64 	movl   $0x646c726f,-0xe(%rbp)
    11b9:	66 c7 45 f6 21 00    	movw   $0x21,-0xa(%rbp)
    11bf:	c7 45 e6 20 2c 21 00 	movl   $0x212c20,-0x1a(%rbp)
    11c6:	48 8d 55 e6          	lea    -0x1a(%rbp),%rdx
    11ca:	48 8d 45 ea          	lea    -0x16(%rbp),%rax
    11ce:	48 89 d6             	mov    %rdx,%rsi
    11d1:	48 89 c7             	mov    %rax,%rdi
    11d4:	e8 b7 fe ff ff       	callq  1090 <strcspn@plt>
    11d9:	48 89 45 d8          	mov    %rax,-0x28(%rbp)
    11dd:	48 8d 55 ea          	lea    -0x16(%rbp),%rdx
    11e1:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    11e5:	48 01 d0             	add    %rdx,%rax
    11e8:	0f b6 00             	movzbl (%rax),%eax
    11eb:	0f be d0             	movsbl %al,%edx
    11ee:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    ...
    120b:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    120f:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1216:	00 00 
    1218:	74 05                	je     121f <main+0x96>
    121a:	e8 51 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    121f:	c9                   	leaveq 
    1220:	c3                   	retq   
