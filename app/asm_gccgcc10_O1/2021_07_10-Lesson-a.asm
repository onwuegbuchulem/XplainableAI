...
/app/bin_gccgcc10_O1/2021_07_10-Lesson-a:     file format elf64-x86-64
...
0000000000001140 <__do_global_dtors_aux>:
    ...
    1144:	80 3d d9 2e 00 00 00 	cmpb   $0x0,0x2ed9(%rip)        # 4024 <completed.0>
    ...
    116c:	c6 05 b1 2e 00 00 01 	movb   $0x1,0x2eb1(%rip)        # 4024 <completed.0>
    1173:	5d                   	pop    %rbp
    1174:	c3                   	retq   
...
0000000000001189 <main>:
    ...
    1197:	41 89 fc             	mov    %edi,%r12d
    119a:	48 89 f5             	mov    %rsi,%rbp
    119d:	c7 05 79 2e 00 00 00 	movl   $0x0,0x2e79(%rip)        # 4020 <opterr@@GLIBC_2.2.5>
    11a4:	00 00 00 
    11a7:	bb 00 00 00 00       	mov    $0x0,%ebx
    11ac:	4c 8d 2d 7d 0e 00 00 	lea    0xe7d(%rip),%r13        # 2030 <_IO_stdin_used+0x30>
    11b3:	eb 0f                	jmp    11c4 <main+0x3b>
    ...
    11c4:	4c 89 ea             	mov    %r13,%rdx
    11c7:	48 89 ee             	mov    %rbp,%rsi
    11ca:	44 89 e7             	mov    %r12d,%edi
    11cd:	e8 be fe ff ff       	callq  1090 <getopt@plt>
    11d2:	83 f8 ff             	cmp    $0xffffffff,%eax
    11d5:	74 1f                	je     11f6 <main+0x6d>
    11d7:	83 f8 3f             	cmp    $0x3f,%eax
    11da:	74 d9                	je     11b5 <main+0x2c>
    11dc:	89 c2                	mov    %eax,%edx
    11de:	48 8d 35 38 0e 00 00 	lea    0xe38(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    11e5:	bf 01 00 00 00       	mov    $0x1,%edi
    11ea:	b8 00 00 00 00       	mov    $0x0,%eax
    11ef:	e8 8c fe ff ff       	callq  1080 <__printf_chk@plt>
    11f4:	eb cb                	jmp    11c1 <main+0x38>
    11f6:	89 da                	mov    %ebx,%edx
    11f8:	48 8d 35 35 0e 00 00 	lea    0xe35(%rip),%rsi        # 2034 <_IO_stdin_used+0x34>
