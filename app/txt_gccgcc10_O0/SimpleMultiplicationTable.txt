...
/app/bin_gccgcc10_O0/SimpleMultiplicationTable:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11de:	48 8d 3d 62 0e 00 00 	lea    0xe62(%rip),%rdi        # 2047 <_IO_stdin_used+0x47>
    11e5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ea:	e8 c1 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11ef:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    11f6:	eb 26                	jmp    121e <main+0x75>
    11f8:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11fb:	0f af 45 f4          	imul   -0xc(%rbp),%eax
    11ff:	89 c1                	mov    %eax,%ecx
    1201:	8b 55 f0             	mov    -0x10(%rbp),%edx
    1204:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1207:	89 c6                	mov    %eax,%esi
    1209:	48 8d 3d 3a 0e 00 00 	lea    0xe3a(%rip),%rdi        # 204a <_IO_stdin_used+0x4a>
    1210:	b8 00 00 00 00       	mov    $0x0,%eax
    1215:	e8 86 fe ff ff       	callq  10a0 <printf@plt>
    121a:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    121e:	83 7d f4 0a          	cmpl   $0xa,-0xc(%rbp)
    1222:	7e d4                	jle    11f8 <main+0x4f>
    1224:	b8 00 00 00 00       	mov    $0x0,%eax
    1229:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    122d:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    1234:	00 00 
    1236:	74 05                	je     123d <main+0x94>
