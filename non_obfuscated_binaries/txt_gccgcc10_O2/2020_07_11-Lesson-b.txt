...
/app/bin_gccgcc10_O2/2020_07_11-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <gettimeofday@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 1d 2f 00 00 	bnd jmpq *0x2f1d(%rip)        # 3fc8 <gettimeofday@GLIBC_2.2.5>
...
00000000000010c0 <main>:
    ...
    10c4:	55                   	push   %rbp
    10c5:	48 83 ec 30          	sub    $0x30,%rsp
    10c9:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10d0:	00 00 
    10d2:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    10d7:	31 c0                	xor    %eax,%eax
    10d9:	48 8d 6c 24 10       	lea    0x10(%rsp),%rbp
    10de:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    10e3:	48 89 ef             	mov    %rbp,%rdi
    10e6:	e8 b5 ff ff ff       	callq  10a0 <gettimeofday@plt>
    10eb:	48 89 ef             	mov    %rbp,%rdi
    10ee:	e8 8d ff ff ff       	callq  1080 <localtime@plt>
    10f3:	4c 8b 4c 24 18       	mov    0x18(%rsp),%r9
    10f8:	bf 01 00 00 00       	mov    $0x1,%edi
    10fd:	48 8d 35 00 0f 00 00 	lea    0xf00(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1104:	8b 48 04             	mov    0x4(%rax),%ecx
    1107:	8b 50 08             	mov    0x8(%rax),%edx
    110a:	44 8b 00             	mov    (%rax),%r8d
    110d:	31 c0                	xor    %eax,%eax
    110f:	e8 9c ff ff ff       	callq  10b0 <__printf_chk@plt>
    1114:	48 63 54 24 08       	movslq 0x8(%rsp),%rdx
    1119:	bf 01 00 00 00       	mov    $0x1,%edi
    111e:	48 8d 35 f3 0e 00 00 	lea    0xef3(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    1125:	48 89 d0             	mov    %rdx,%rax
    1128:	48 69 d2 89 88 88 88 	imul   $0xffffffff88888889,%rdx,%rdx
    112f:	89 c1                	mov    %eax,%ecx
    1131:	c1 f9 1f             	sar    $0x1f,%ecx
    1134:	48 c1 ea 20          	shr    $0x20,%rdx
    1138:	01 c2                	add    %eax,%edx
    113a:	c1 fa 05             	sar    $0x5,%edx
    113d:	29 ca                	sub    %ecx,%edx
    113f:	3d 0b 03 00 00       	cmp    $0x30b,%eax
    1144:	8d 4a e8             	lea    -0x18(%rdx),%ecx
    1147:	0f 4f d1             	cmovg  %ecx,%edx
    114a:	31 c0                	xor    %eax,%eax
    114c:	e8 5f ff ff ff       	callq  10b0 <__printf_chk@plt>
    1151:	8b 54 24 0c          	mov    0xc(%rsp),%edx
    1155:	31 c0                	xor    %eax,%eax
    1157:	bf 01 00 00 00       	mov    $0x1,%edi
    115c:	48 8d 35 cd 0e 00 00 	lea    0xecd(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    1163:	e8 48 ff ff ff       	callq  10b0 <__printf_chk@plt>
    1168:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    116d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1174:	00 00 
    1176:	75 08                	jne    1180 <main+0xc0>
    1178:	48 83 c4 30          	add    $0x30,%rsp
    117c:	31 c0                	xor    %eax,%eax
    117e:	5d                   	pop    %rbp
    117f:	c3                   	retq   
    1180:	e8 0b ff ff ff       	callq  1090 <__stack_chk_fail@plt>
