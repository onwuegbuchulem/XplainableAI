...
/app/bin_gccgcc10_O1/2023_07_08-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a2:	48 89 e3             	mov    %rsp,%rbx
    11a5:	48 89 de             	mov    %rbx,%rsi
    11a8:	48 8d 3d 55 0e 00 00 	lea    0xe55(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11af:	e8 dc fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11b4:	48 89 df             	mov    %rbx,%rdi
    11b7:	e8 b4 fe ff ff       	callq  1070 <puts@plt>
    11bc:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11c1:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11c8:	00 00 
    11ca:	75 0b                	jne    11d7 <main+0x4e>
    11cc:	b8 00 00 00 00       	mov    $0x0,%eax
    11d1:	48 83 c4 20          	add    $0x20,%rsp
    11d5:	5b                   	pop    %rbx
    11d6:	c3                   	retq   
    11d7:	e8 a4 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
