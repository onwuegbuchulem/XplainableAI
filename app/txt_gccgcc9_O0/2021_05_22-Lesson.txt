...
/app/bin_gccgcc9_O0/2021_05_22-Lesson:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11b5:	bf 0c 00 00 00       	mov    $0xc,%edi
    11ba:	e8 d1 fe ff ff       	callq  1090 <malloc@plt>
    11bf:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11c3:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
    11c8:	75 2a                	jne    11f4 <main+0x4b>
    11ca:	48 8b 05 4f 2e 00 00 	mov    0x2e4f(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    11d1:	48 89 c1             	mov    %rax,%rcx
    11d4:	ba 18 00 00 00       	mov    $0x18,%edx
    11d9:	be 01 00 00 00       	mov    $0x1,%esi
    11de:	48 8d 3d 1f 0e 00 00 	lea    0xe1f(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11e5:	e8 c6 fe ff ff       	callq  10b0 <fwrite@plt>
    11ea:	bf 01 00 00 00       	mov    $0x1,%edi
    11ef:	e8 ac fe ff ff       	callq  10a0 <exit@plt>
    11f4:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
    11fb:	eb 20                	jmp    121d <main+0x74>
    ...
    1217:	89 10                	mov    %edx,(%rax)
    1219:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    121d:	83 7d f4 02          	cmpl   $0x2,-0xc(%rbp)
    1221:	7e da                	jle    11fd <main+0x54>
    1223:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1227:	48 83 c0 08          	add    $0x8,%rax
    122b:	8b 08                	mov    (%rax),%ecx
    122d:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1231:	48 83 c0 04          	add    $0x4,%rax
    1235:	8b 10                	mov    (%rax),%edx
    1237:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    123b:	8b 00                	mov    (%rax),%eax
    123d:	89 c6                	mov    %eax,%esi
    123f:	48 8d 3d d7 0d 00 00 	lea    0xdd7(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    1246:	b8 00 00 00 00       	mov    $0x0,%eax
    124b:	e8 30 fe ff ff       	callq  1080 <printf@plt>
