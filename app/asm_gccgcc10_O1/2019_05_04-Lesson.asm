...
/app/bin_gccgcc10_O1/2019_05_04-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117c:	00 00 
    117e:	48 89 44 24 68       	mov    %rax,0x68(%rsp)
    1183:	31 c0                	xor    %eax,%eax
    1185:	c7 04 24 48 00 00 00 	movl   $0x48,(%rsp)
    118c:	c7 44 24 04 1d 00 00 	movl   $0x1d,0x4(%rsp)
    1193:	00 
    1194:	c7 44 24 08 07 00 00 	movl   $0x7,0x8(%rsp)
    119b:	00 
    119c:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%rsp)
    11a3:	00 
    11a4:	c7 44 24 10 03 00 00 	movl   $0x3,0x10(%rsp)
    11ab:	00 
    11ac:	c7 44 24 14 b1 ff ff 	movl   $0xffffffb1,0x14(%rsp)
    11b3:	ff 
    11b4:	c7 44 24 18 46 00 00 	movl   $0x46,0x18(%rsp)
    11bb:	00 
    11bc:	c7 44 24 1c 0c 00 00 	movl   $0xc,0x1c(%rsp)
    11c3:	00 
    11c4:	c7 44 24 20 fd ff ff 	movl   $0xfffffffd,0x20(%rsp)
    11cb:	ff 
    11cc:	c7 44 24 24 fe ff ff 	movl   $0xfffffffe,0x24(%rsp)
    11d3:	ff 
    11d4:	c7 44 24 28 b3 ff ff 	movl   $0xffffffb3,0x28(%rsp)
    11db:	ff 
    11dc:	c7 44 24 2c 24 00 00 	movl   $0x24,0x2c(%rsp)
    11e3:	00 
    11e4:	c7 44 24 30 1d 00 00 	movl   $0x1d,0x30(%rsp)
    11eb:	00 
    11ec:	c7 44 24 34 0d 00 00 	movl   $0xd,0x34(%rsp)
    11f3:	00 
    11f4:	c7 44 24 38 b2 ff ff 	movl   $0xffffffb2,0x38(%rsp)
    11fb:	ff 
    11fc:	c7 44 24 3c 27 00 00 	movl   $0x27,0x3c(%rsp)
    1203:	00 
    1204:	c7 44 24 40 28 00 00 	movl   $0x28,0x40(%rsp)
    120b:	00 
    120c:	c7 44 24 44 00 00 00 	movl   $0x0,0x44(%rsp)
    1213:	00 
    1214:	c7 44 24 48 fc ff ff 	movl   $0xfffffffc,0x48(%rsp)
    121b:	ff 
    121c:	c7 44 24 4c fe ff ff 	movl   $0xfffffffe,0x4c(%rsp)
    1223:	ff 
    1224:	c7 44 24 50 05 00 00 	movl   $0x5,0x50(%rsp)
    122b:	00 
    122c:	c7 44 24 54 b3 ff ff 	movl   $0xffffffb3,0x54(%rsp)
    1233:	ff 
    1234:	c7 44 24 58 e9 ff ff 	movl   $0xffffffe9,0x58(%rsp)
    123b:	ff 
    123c:	c7 44 24 5c f6 ff ff 	movl   $0xfffffff6,0x5c(%rsp)
    1243:	ff 
    1244:	48 89 e3             	mov    %rsp,%rbx
    1247:	4c 8d 64 24 60       	lea    0x60(%rsp),%r12
    124c:	bd 00 00 00 00       	mov    $0x0,%ebp
    1251:	89 ef                	mov    %ebp,%edi
    1253:	03 3b                	add    (%rbx),%edi
    1255:	89 fd                	mov    %edi,%ebp
    1257:	48 8b 35 b2 2d 00 00 	mov    0x2db2(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    125e:	e8 0d fe ff ff       	callq  1070 <putc@plt>
    1263:	48 83 c3 04          	add    $0x4,%rbx
    1267:	4c 39 e3             	cmp    %r12,%rbx
    126a:	75 e5                	jne    1251 <main+0xe8>
    126c:	48 8b 44 24 68       	mov    0x68(%rsp),%rax
    1271:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1278:	00 00 
    127a:	75 0e                	jne    128a <main+0x121>
    127c:	b8 00 00 00 00       	mov    $0x0,%eax
    1281:	48 83 c4 70          	add    $0x70,%rsp
    1285:	5b                   	pop    %rbx
    1286:	5d                   	pop    %rbp
    1287:	41 5c                	pop    %r12
    1289:	c3                   	retq   
    128a:	e8 d1 fd ff ff       	callq  1060 <__stack_chk_fail@plt>
    128f:	90                   	nop
