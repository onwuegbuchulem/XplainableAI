...
/app/bin_gccgcc10_O0/strwords2:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d 42 01 00 00 	lea    0x142(%rip),%rdi        # 120a <main>
...
0000000000001189 <strwords>:
    ...
    11fb:	83 7d f8 01          	cmpl   $0x1,-0x8(%rbp)
    11ff:	75 04                	jne    1205 <strwords+0x7c>
...
000000000000120a <main>:
    ...
    1225:	48 b8 54 68 69 73 20 	movabs $0x6e73692073696854,%rax
    122c:	69 73 6e 
    122f:	48 ba 27 74 20 61 20 	movabs $0x6d61732061207427,%rdx
    1236:	73 61 6d 
    1239:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    123d:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
    1241:	48 b8 70 6c 65 20 73 	movabs $0x6972747320656c70,%rax
    1248:	74 72 69 
    124b:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    124f:	66 c7 45 e8 6e 67    	movw   $0x676e,-0x18(%rbp)
    1255:	c6 45 ea 00          	movb   $0x0,-0x16(%rbp)
    1259:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    125d:	48 89 c7             	mov    %rax,%rdi
    1260:	e8 24 ff ff ff       	callq  1189 <strwords>
    1265:	89 c2                	mov    %eax,%edx
    1267:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    126b:	48 89 c6             	mov    %rax,%rsi
    126e:	48 8d 3d 93 0d 00 00 	lea    0xd93(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    ...
    1288:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    128f:	00 00 
    1291:	74 05                	je     1298 <main+0x8e>
    1293:	e8 d8 fd ff ff       	callq  1070 <__stack_chk_fail@plt>
    1298:	c9                   	leaveq 
    1299:	c3                   	retq   
