...
/app/bin_gccgcc10_O3/2020_10_17-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10eb:	74 1c                	je     1109 <main+0x89>
    10ed:	4c 89 e2             	mov    %r12,%rdx
    10f0:	8d 48 9f             	lea    -0x61(%rax),%ecx
    10f3:	80 f9 19             	cmp    $0x19,%cl
    10f6:	77 48                	ja     1140 <main+0xc0>
    10f8:	83 e0 df             	and    $0xffffffdf,%eax
    10fb:	48 83 c2 01          	add    $0x1,%rdx
    10ff:	88 42 ff             	mov    %al,-0x1(%rdx)
    1102:	0f b6 02             	movzbl (%rdx),%eax
    1105:	84 c0                	test   %al,%al
    1107:	75 e7                	jne    10f0 <main+0x70>
    1109:	31 c0                	xor    %eax,%eax
    110b:	4c 89 e2             	mov    %r12,%rdx
    110e:	bf 01 00 00 00       	mov    $0x1,%edi
    1113:	48 8d 35 f5 0e 00 00 	lea    0xef5(%rip),%rsi        # 200f <_IO_stdin_used+0xf>
    111a:	e8 51 ff ff ff       	callq  1070 <__printf_chk@plt>
    111f:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    1124:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    112b:	00 00 
    112d:	75 1f                	jne    114e <main+0xce>
    112f:	48 83 c4 30          	add    $0x30,%rsp
    1133:	31 c0                	xor    %eax,%eax
    1135:	41 5c                	pop    %r12
    1137:	c3                   	retq   
    1138:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    113f:	00 
    1140:	0f b6 42 01          	movzbl 0x1(%rdx),%eax
    1144:	48 83 c2 01          	add    $0x1,%rdx
    1148:	84 c0                	test   %al,%al
    114a:	75 a4                	jne    10f0 <main+0x70>
    114c:	eb bb                	jmp    1109 <main+0x89>
    114e:	e8 0d ff ff ff       	callq  1060 <__stack_chk_fail@plt>
...
0000000000001250 <str_toupper>:
    1250:	f3 0f 1e fa          	endbr64 
    1254:	0f b6 07             	movzbl (%rdi),%eax
    1257:	84 c0                	test   %al,%al
    1259:	74 31                	je     128c <str_toupper+0x3c>
    125b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1260:	8d 50 9f             	lea    -0x61(%rax),%edx
    1263:	80 fa 19             	cmp    $0x19,%dl
    1266:	77 18                	ja     1280 <str_toupper+0x30>
    1268:	83 e0 df             	and    $0xffffffdf,%eax
    126b:	48 83 c7 01          	add    $0x1,%rdi
    126f:	88 47 ff             	mov    %al,-0x1(%rdi)
    1272:	0f b6 07             	movzbl (%rdi),%eax
    1275:	84 c0                	test   %al,%al
    1277:	75 e7                	jne    1260 <str_toupper+0x10>
    1279:	c3                   	retq   
    127a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1280:	0f b6 47 01          	movzbl 0x1(%rdi),%eax
    1284:	48 83 c7 01          	add    $0x1,%rdi
    1288:	84 c0                	test   %al,%al
    128a:	75 d4                	jne    1260 <str_toupper+0x10>
    128c:	c3                   	retq   
