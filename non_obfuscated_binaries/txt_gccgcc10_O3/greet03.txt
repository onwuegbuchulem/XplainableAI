...
/app/bin_gccgcc10_O3/greet03:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    10e4:	41 54                	push   %r12
    10e6:	55                   	push   %rbp
    10e7:	48 89 f5             	mov    %rsi,%rbp
    10ea:	53                   	push   %rbx
    10eb:	89 fb                	mov    %edi,%ebx
    10ed:	48 83 ec 10          	sub    $0x10,%rsp
    10f1:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10f8:	00 00 
    10fa:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10ff:	31 c0                	xor    %eax,%eax
    1101:	49 89 e4             	mov    %rsp,%r12
    1104:	4c 89 e7             	mov    %r12,%rdi
    1107:	e8 b4 ff ff ff       	callq  10c0 <time@plt>
    110c:	4c 89 e7             	mov    %r12,%rdi
    110f:	e8 7c ff ff ff       	callq  1090 <localtime@plt>
    1114:	48 8d 35 e9 0e 00 00 	lea    0xee9(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    111b:	bf 01 00 00 00       	mov    $0x1,%edi
    1120:	44 8b 60 08          	mov    0x8(%rax),%r12d
    1124:	31 c0                	xor    %eax,%eax
    1126:	e8 a5 ff ff ff       	callq  10d0 <__printf_chk@plt>
    112b:	41 83 fc 0b          	cmp    $0xb,%r12d
    112f:	7e 76                	jle    11a7 <main+0xc7>
    1131:	41 83 fc 10          	cmp    $0x10,%r12d
    1135:	7e 5b                	jle    1192 <main+0xb2>
    1137:	48 8d 35 de 0e 00 00 	lea    0xede(%rip),%rsi        # 201c <_IO_stdin_used+0x1c>
    113e:	bf 01 00 00 00       	mov    $0x1,%edi
    1143:	31 c0                	xor    %eax,%eax
    1145:	e8 86 ff ff ff       	callq  10d0 <__printf_chk@plt>
    114a:	83 fb 01             	cmp    $0x1,%ebx
    114d:	7e 17                	jle    1166 <main+0x86>
    114f:	48 8b 55 08          	mov    0x8(%rbp),%rdx
    1153:	48 8d 35 ca 0e 00 00 	lea    0xeca(%rip),%rsi        # 2024 <_IO_stdin_used+0x24>
    115a:	bf 01 00 00 00       	mov    $0x1,%edi
    115f:	31 c0                	xor    %eax,%eax
    1161:	e8 6a ff ff ff       	callq  10d0 <__printf_chk@plt>
    1166:	48 8b 35 a3 2e 00 00 	mov    0x2ea3(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    116d:	bf 0a 00 00 00       	mov    $0xa,%edi
    1172:	e8 39 ff ff ff       	callq  10b0 <putc@plt>
    1177:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    117c:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1183:	00 00 
    1185:	75 35                	jne    11bc <main+0xdc>
    1187:	48 83 c4 10          	add    $0x10,%rsp
    118b:	31 c0                	xor    %eax,%eax
    118d:	5b                   	pop    %rbx
    118e:	5d                   	pop    %rbp
    118f:	41 5c                	pop    %r12
    1191:	c3                   	retq   
    1192:	48 8d 35 79 0e 00 00 	lea    0xe79(%rip),%rsi        # 2012 <_IO_stdin_used+0x12>
    1199:	bf 01 00 00 00       	mov    $0x1,%edi
    119e:	31 c0                	xor    %eax,%eax
    11a0:	e8 2b ff ff ff       	callq  10d0 <__printf_chk@plt>
    11a5:	eb a3                	jmp    114a <main+0x6a>
    11a7:	48 8d 35 5c 0e 00 00 	lea    0xe5c(%rip),%rsi        # 200a <_IO_stdin_used+0xa>
    11ae:	bf 01 00 00 00       	mov    $0x1,%edi
    11b3:	31 c0                	xor    %eax,%eax
    11b5:	e8 16 ff ff ff       	callq  10d0 <__printf_chk@plt>
    11ba:	eb 8e                	jmp    114a <main+0x6a>
    11bc:	e8 df fe ff ff       	callq  10a0 <__stack_chk_fail@plt>
