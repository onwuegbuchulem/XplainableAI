...
/app/bin_gccgcc10_O3/2023_04_08-Lesson:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10bc:	83 f8 ff             	cmp    $0xffffffff,%eax
    10bf:	74 4f                	je     1110 <main+0x70>
    10c1:	83 f8 09             	cmp    $0x9,%eax
    10c4:	74 1a                	je     10e0 <main+0x40>
    10c6:	83 f8 20             	cmp    $0x20,%eax
    10c9:	75 2d                	jne    10f8 <main+0x58>
    10cb:	48 8d 35 44 0f 00 00 	lea    0xf44(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    10d2:	bf 01 00 00 00       	mov    $0x1,%edi
    10d7:	31 c0                	xor    %eax,%eax
    10d9:	e8 a2 ff ff ff       	callq  1080 <__printf_chk@plt>
    10de:	eb d0                	jmp    10b0 <main+0x10>
    ...
    1101:	e8 6a ff ff ff       	callq  1070 <putc@plt>
    1106:	eb a8                	jmp    10b0 <main+0x10>
