...
/app/bin_gccgcc10_O1/2024_07-Exercise:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d e4 00 00 00 	lea    0xe4(%rip),%rdi        # 118c <main>
...
0000000000001169 <cls>:
    ...
    1182:	e8 d9 fe ff ff       	callq  1060 <__printf_chk@plt>
    1187:	48 83 c4 08          	add    $0x8,%rsp
    118b:	c3                   	retq   

000000000000118c <main>:
    118c:	f3 0f 1e fa          	endbr64 
    1190:	48 83 ec 08          	sub    $0x8,%rsp
    1194:	48 8d 35 75 0e 00 00 	lea    0xe75(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    119b:	bf 01 00 00 00       	mov    $0x1,%edi
    11a0:	b8 00 00 00 00       	mov    $0x0,%eax
    11a5:	e8 b6 fe ff ff       	callq  1060 <__printf_chk@plt>
    11aa:	48 8b 3d 5f 2e 00 00 	mov    0x2e5f(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    11b1:	e8 ba fe ff ff       	callq  1070 <getc@plt>
    11b6:	e8 ae ff ff ff       	callq  1169 <cls>
