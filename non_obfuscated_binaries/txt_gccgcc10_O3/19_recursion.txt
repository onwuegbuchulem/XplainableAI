...
/app/bin_gccgcc10_O3/19_recursion:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10cc:	48 8d 3d 4c 0f 00 00 	lea    0xf4c(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    10d3:	31 c0                	xor    %eax,%eax
    10d5:	e8 b6 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10da:	48 8b 14 24          	mov    (%rsp),%rdx
    10de:	b8 01 00 00 00       	mov    $0x1,%eax
    10e3:	48 83 fa 01          	cmp    $0x1,%rdx
    10e7:	7e 18                	jle    1101 <main+0x61>
    10e9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    10f0:	48 89 d1             	mov    %rdx,%rcx
    10f3:	48 83 ea 01          	sub    $0x1,%rdx
    10f7:	48 0f af c1          	imul   %rcx,%rax
    10fb:	48 83 fa 01          	cmp    $0x1,%rdx
    10ff:	75 ef                	jne    10f0 <main+0x50>
    1101:	48 0f af d0          	imul   %rax,%rdx
    1105:	48 8d 35 17 0f 00 00 	lea    0xf17(%rip),%rsi        # 2023 <_IO_stdin_used+0x23>
    110c:	31 c0                	xor    %eax,%eax
    110e:	bf 01 00 00 00       	mov    $0x1,%edi
    1113:	e8 68 ff ff ff       	callq  1080 <__printf_chk@plt>
    1118:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    111d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1124:	00 00 
    1126:	75 07                	jne    112f <main+0x8f>
    1128:	31 c0                	xor    %eax,%eax
    112a:	48 83 c4 18          	add    $0x18,%rsp
    112e:	c3                   	retq   
...
0000000000001230 <result>:
    1230:	f3 0f 1e fa          	endbr64 
    1234:	48 83 ff 01          	cmp    $0x1,%rdi
    1238:	7e 1e                	jle    1258 <result+0x28>
    ...
    124f:	75 ef                	jne    1240 <result+0x10>
    1251:	c3                   	retq   
    1252:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1258:	48 89 f8             	mov    %rdi,%rax
    125b:	c3                   	retq   
