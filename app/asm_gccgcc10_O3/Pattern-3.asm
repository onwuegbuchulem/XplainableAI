...
/app/bin_gccgcc10_O3/Pattern-3:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10ad:	39 eb                	cmp    %ebp,%ebx
    10af:	75 e8                	jne    1099 <main+0x19>
    10b1:	bf 0a 00 00 00       	mov    $0xa,%edi
    10b6:	8d 6b 01             	lea    0x1(%rbx),%ebp
    10b9:	e8 a2 ff ff ff       	callq  1060 <putchar@plt>
    10be:	83 fb 06             	cmp    $0x6,%ebx
    10c1:	75 d1                	jne    1094 <main+0x14>
    10c3:	5b                   	pop    %rbx
