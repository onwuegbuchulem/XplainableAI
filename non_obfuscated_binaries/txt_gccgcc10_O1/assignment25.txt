...
/app/bin_gccgcc10_O1/assignment25:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11cd:	53                   	push   %rbx
    11ce:	ba c0 01 00 00       	mov    $0x1c0,%edx
    11d3:	be 41 00 00 00       	mov    $0x41,%esi
    11d8:	48 8d 3d 25 0e 00 00 	lea    0xe25(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11df:	b8 00 00 00 00       	mov    $0x0,%eax
    11e4:	e8 e7 fe ff ff       	callq  10d0 <open@plt>
    11e9:	85 c0                	test   %eax,%eax
    11eb:	78 49                	js     1236 <main+0x6d>
    11ed:	89 c3                	mov    %eax,%ebx
    11ef:	48 8d 3d 38 0e 00 00 	lea    0xe38(%rip),%rdi        # 202e <_IO_stdin_used+0x2e>
    11f6:	e8 95 fe ff ff       	callq  1090 <puts@plt>
    11fb:	ba 1e 00 00 00       	mov    $0x1e,%edx
    1200:	48 8d 35 45 0e 00 00 	lea    0xe45(%rip),%rsi        # 204c <_IO_stdin_used+0x4c>
    1207:	89 df                	mov    %ebx,%edi
    1209:	e8 92 fe ff ff       	callq  10a0 <write@plt>
    120e:	83 f8 1e             	cmp    $0x1e,%eax
    1211:	75 40                	jne    1253 <main+0x8a>
    1213:	48 8d 35 8e 0e 00 00 	lea    0xe8e(%rip),%rsi        # 20a8 <_IO_stdin_used+0xa8>
    ...
    122b:	e8 80 fe ff ff       	callq  10b0 <close@plt>
    1230:	85 c0                	test   %eax,%eax
    1232:	75 3c                	jne    1270 <main+0xa7>
    1234:	5b                   	pop    %rbx
    1235:	c3                   	retq   
    1236:	48 8d 35 d4 0d 00 00 	lea    0xdd4(%rip),%rsi        # 2011 <_IO_stdin_used+0x11>
    123d:	bf 01 00 00 00       	mov    $0x1,%edi
    1242:	b8 00 00 00 00       	mov    $0x0,%eax
    1247:	e8 74 fe ff ff       	callq  10c0 <__printf_chk@plt>
    124c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    1251:	eb e1                	jmp    1234 <main+0x6b>
    1253:	48 8d 35 10 0e 00 00 	lea    0xe10(%rip),%rsi        # 206a <_IO_stdin_used+0x6a>
    125a:	bf 01 00 00 00       	mov    $0x1,%edi
    125f:	b8 00 00 00 00       	mov    $0x0,%eax
    1264:	e8 57 fe ff ff       	callq  10c0 <__printf_chk@plt>
    1269:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    126e:	eb c4                	jmp    1234 <main+0x6b>
    1270:	48 8d 35 11 0e 00 00 	lea    0xe11(%rip),%rsi        # 2088 <_IO_stdin_used+0x88>
    1277:	bf 01 00 00 00       	mov    $0x1,%edi
    127c:	b8 00 00 00 00       	mov    $0x0,%eax
    1281:	e8 3a fe ff ff       	callq  10c0 <__printf_chk@plt>
    1286:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    128b:	eb a7                	jmp    1234 <main+0x6b>
