...
/app/bin_gccgcc10_O2/2022_09_10-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 56                	push   %r14
    1086:	45 31 f6             	xor    %r14d,%r14d
    1089:	41 55                	push   %r13
    108b:	4c 8d 2d 72 0f 00 00 	lea    0xf72(%rip),%r13        # 2004 <_IO_stdin_used+0x4>
    1092:	41 54                	push   %r12
    1094:	55                   	push   %rbp
    1095:	53                   	push   %rbx
    1096:	bb 64 00 00 00       	mov    $0x64,%ebx
    109b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10a0:	44 8d 63 f7          	lea    -0x9(%rbx),%r12d
    10a4:	41 8d 2c 1e          	lea    (%r14,%rbx,1),%ebp
    10a8:	eb 10                	jmp    10ba <main+0x3a>
    10aa:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    10b0:	bf 09 00 00 00       	mov    $0x9,%edi
    10b5:	e8 a6 ff ff ff       	callq  1060 <putc@plt>
    10ba:	89 ea                	mov    %ebp,%edx
    10bc:	4c 89 ee             	mov    %r13,%rsi
    10bf:	bf 01 00 00 00       	mov    $0x1,%edi
    10c4:	31 c0                	xor    %eax,%eax
    10c6:	29 da                	sub    %ebx,%edx
    10c8:	e8 a3 ff ff ff       	callq  1070 <__printf_chk@plt>
    10cd:	48 8b 35 3c 2f 00 00 	mov    0x2f3c(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10d4:	83 eb 01             	sub    $0x1,%ebx
    10d7:	74 17                	je     10f0 <main+0x70>
    10d9:	44 39 e3             	cmp    %r12d,%ebx
    10dc:	75 d2                	jne    10b0 <main+0x30>
    10de:	bf 0a 00 00 00       	mov    $0xa,%edi
    10e3:	41 83 c6 09          	add    $0x9,%r14d
    10e7:	e8 74 ff ff ff       	callq  1060 <putc@plt>
    10ec:	eb b2                	jmp    10a0 <main+0x20>
    10ee:	66 90                	xchg   %ax,%ax
    10f0:	bf 0a 00 00 00       	mov    $0xa,%edi
    10f5:	e8 66 ff ff ff       	callq  1060 <putc@plt>
    10fa:	5b                   	pop    %rbx
