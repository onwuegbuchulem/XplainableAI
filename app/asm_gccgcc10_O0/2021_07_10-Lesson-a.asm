...
/app/bin_gccgcc10_O0/2021_07_10-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119c:	c7 05 7a 2e 00 00 00 	movl   $0x0,0x2e7a(%rip)        # 4020 <opterr@@GLIBC_2.2.5>
    11a3:	00 00 00 
    11a6:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    11ad:	eb 2e                	jmp    11dd <main+0x54>
    11af:	83 7d fc 3f          	cmpl   $0x3f,-0x4(%rbp)
    11b3:	75 0e                	jne    11c3 <main+0x3a>
    11b5:	48 8d 3d 48 0e 00 00 	lea    0xe48(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11bc:	e8 af fe ff ff       	callq  1070 <puts@plt>
    11c1:	eb 16                	jmp    11d9 <main+0x50>
    11c3:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11c6:	89 c6                	mov    %eax,%esi
    11c8:	48 8d 3d 4e 0e 00 00 	lea    0xe4e(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    11cf:	b8 00 00 00 00       	mov    $0x0,%eax
    11d4:	e8 a7 fe ff ff       	callq  1080 <printf@plt>
    11d9:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11dd:	48 8b 4d e0          	mov    -0x20(%rbp),%rcx
    11e1:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11e4:	48 8d 15 45 0e 00 00 	lea    0xe45(%rip),%rdx        # 2030 <_IO_stdin_used+0x30>
    11eb:	48 89 ce             	mov    %rcx,%rsi
    11ee:	89 c7                	mov    %eax,%edi
    11f0:	e8 9b fe ff ff       	callq  1090 <getopt@plt>
    11f5:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11f8:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%rbp)
    11fc:	75 b1                	jne    11af <main+0x26>
    ...
    120f:	e8 6c fe ff ff       	callq  1080 <printf@plt>
