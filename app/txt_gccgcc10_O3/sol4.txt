...
/app/bin_gccgcc10_O3/sol4:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	55                   	push   %rbp
    10a5:	48 8d 35 5c 0f 00 00 	lea    0xf5c(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    10ac:	bf 01 00 00 00       	mov    $0x1,%edi
    10b1:	53                   	push   %rbx
    10b2:	48 83 ec 28          	sub    $0x28,%rsp
    ...
    10cb:	48 8d 74 24 0c       	lea    0xc(%rsp),%rsi
    10d0:	48 8d 3d 57 0f 00 00 	lea    0xf57(%rip),%rdi        # 202e <_IO_stdin_used+0x2e>
    10d7:	31 c0                	xor    %eax,%eax
    10d9:	e8 b2 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10de:	8b 44 24 0c          	mov    0xc(%rsp),%eax
    10e2:	8d 50 ff             	lea    -0x1(%rax),%edx
    10e5:	89 54 24 0c          	mov    %edx,0xc(%rsp)
    10e9:	85 c0                	test   %eax,%eax
    10eb:	0f 84 8c 00 00 00    	je     117d <main+0xdd>
    10f1:	48 8d 6c 24 10       	lea    0x10(%rsp),%rbp
    10f6:	48 8d 1d 34 0f 00 00 	lea    0xf34(%rip),%rbx        # 2031 <_IO_stdin_used+0x31>
    10fd:	0f 1f 00             	nopl   (%rax)
    1100:	48 89 de             	mov    %rbx,%rsi
    1103:	bf 01 00 00 00       	mov    $0x1,%edi
    1108:	31 c0                	xor    %eax,%eax
    110a:	e8 71 ff ff ff       	callq  1080 <__printf_chk@plt>
    110f:	48 89 ee             	mov    %rbp,%rsi
    1112:	48 8d 3d 2e 0f 00 00 	lea    0xf2e(%rip),%rdi        # 2047 <_IO_stdin_used+0x47>
    1119:	31 c0                	xor    %eax,%eax
    111b:	e8 70 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    1120:	48 8b 4c 24 10       	mov    0x10(%rsp),%rcx
    1125:	45 31 c0             	xor    %r8d,%r8d
    1128:	48 85 c9             	test   %rcx,%rcx
    112b:	74 2b                	je     1158 <main+0xb8>
    112d:	31 c0                	xor    %eax,%eax
    112f:	90                   	nop
    1130:	69 d0 ab aa aa aa    	imul   $0xaaaaaaab,%eax,%edx
    1136:	81 fa 55 55 55 55    	cmp    $0x55555555,%edx
    113c:	76 0e                	jbe    114c <main+0xac>
    113e:	69 d0 cd cc cc cc    	imul   $0xcccccccd,%eax,%edx
    1144:	81 fa 33 33 33 33    	cmp    $0x33333333,%edx
    114a:	77 03                	ja     114f <main+0xaf>
    114c:	49 01 c0             	add    %rax,%r8
    114f:	48 83 c0 01          	add    $0x1,%rax
    1153:	48 39 c1             	cmp    %rax,%rcx
    1156:	75 d8                	jne    1130 <main+0x90>
    1158:	4c 89 c2             	mov    %r8,%rdx
    115b:	48 8d 35 ea 0e 00 00 	lea    0xeea(%rip),%rsi        # 204c <_IO_stdin_used+0x4c>
    ...
    1172:	8d 50 ff             	lea    -0x1(%rax),%edx
    1175:	89 54 24 0c          	mov    %edx,0xc(%rsp)
    1179:	85 c0                	test   %eax,%eax
    117b:	75 83                	jne    1100 <main+0x60>
    117d:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1182:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1189:	00 00 
    118b:	75 09                	jne    1196 <main+0xf6>
    118d:	48 83 c4 28          	add    $0x28,%rsp
