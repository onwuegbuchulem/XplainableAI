...
/app/bin_gccgcc10_O1/12_break_continue:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    114f:	55                   	push   %rbp
    1150:	53                   	push   %rbx
    1151:	bd 01 00 00 00       	mov    $0x1,%ebp
    1156:	bb 00 00 00 00       	mov    $0x0,%ebx
    115b:	4c 8d 25 a2 0e 00 00 	lea    0xea2(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    1162:	eb 06                	jmp    116a <main+0x21>
    1164:	83 c3 01             	add    $0x1,%ebx
    1167:	83 c5 01             	add    $0x1,%ebp
    116a:	83 fb 05             	cmp    $0x5,%ebx
    116d:	74 f5                	je     1164 <main+0x1b>
    116f:	89 da                	mov    %ebx,%edx
    1171:	4c 89 e6             	mov    %r12,%rsi
    1174:	bf 01 00 00 00       	mov    $0x1,%edi
    1179:	b8 00 00 00 00       	mov    $0x0,%eax
    117e:	e8 cd fe ff ff       	callq  1050 <__printf_chk@plt>
    1183:	83 fd 0e             	cmp    $0xe,%ebp
    1186:	7e dc                	jle    1164 <main+0x1b>
    1188:	48 8d 35 7e 0e 00 00 	lea    0xe7e(%rip),%rsi        # 200d <_IO_stdin_used+0xd>
    118f:	bf 01 00 00 00       	mov    $0x1,%edi
    1194:	b8 00 00 00 00       	mov    $0x0,%eax
    1199:	e8 b2 fe ff ff       	callq  1050 <__printf_chk@plt>
