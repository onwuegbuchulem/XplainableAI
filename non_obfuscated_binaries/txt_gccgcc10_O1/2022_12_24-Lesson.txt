...
/app/bin_gccgcc10_O1/2022_12_24-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1177:	41 bc 14 00 00 00    	mov    $0x14,%r12d
    117d:	bd 01 00 00 00       	mov    $0x1,%ebp
    1182:	4c 8d 2d 7b 0e 00 00 	lea    0xe7b(%rip),%r13        # 2004 <_IO_stdin_used+0x4>
    1189:	eb 1a                	jmp    11a5 <main+0x3c>
    118b:	48 8b 35 7e 2e 00 00 	mov    0x2e7e(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1192:	bf 0a 00 00 00       	mov    $0xa,%edi
    1197:	e8 c4 fe ff ff       	callq  1060 <putc@plt>
    119c:	83 c5 02             	add    $0x2,%ebp
    119f:	41 83 ec 01          	sub    $0x1,%r12d
    11a3:	74 3d                	je     11e2 <main+0x79>
    11a5:	b9 20 00 00 00       	mov    $0x20,%ecx
    11aa:	44 89 e2             	mov    %r12d,%edx
    ...
    11bf:	85 ed                	test   %ebp,%ebp
    11c1:	7e c8                	jle    118b <main+0x22>
    11c3:	bb 00 00 00 00       	mov    $0x0,%ebx
    11c8:	48 8b 35 41 2e 00 00 	mov    0x2e41(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11cf:	bf 2a 00 00 00       	mov    $0x2a,%edi
    11d4:	e8 87 fe ff ff       	callq  1060 <putc@plt>
    11d9:	83 c3 01             	add    $0x1,%ebx
    11dc:	39 eb                	cmp    %ebp,%ebx
    11de:	75 e8                	jne    11c8 <main+0x5f>
    11e0:	eb a9                	jmp    118b <main+0x22>
