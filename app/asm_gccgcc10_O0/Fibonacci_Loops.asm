...
/app/bin_gccgcc10_O0/Fibonacci_Loops:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	c7 45 e8 01 00 00 00 	movl   $0x1,-0x18(%rbp)
    ...
    11c3:	48 8d 45 e4          	lea    -0x1c(%rbp),%rax
    11c7:	48 89 c6             	mov    %rax,%rsi
    11ca:	48 8d 3d 46 0e 00 00 	lea    0xe46(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    ...
    11e0:	48 8d 3d 33 0e 00 00 	lea    0xe33(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    11e7:	b8 00 00 00 00       	mov    $0x0,%eax
    11ec:	e8 8f fe ff ff       	callq  1080 <printf@plt>
    11f1:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%rbp)
    11f8:	eb 31                	jmp    122b <main+0xa2>
    11fa:	8b 55 e8             	mov    -0x18(%rbp),%edx
    11fd:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1200:	01 d0                	add    %edx,%eax
    1202:	89 45 f4             	mov    %eax,-0xc(%rbp)
    ...
    1216:	e8 65 fe ff ff       	callq  1080 <printf@plt>
    121b:	8b 45 ec             	mov    -0x14(%rbp),%eax
    121e:	89 45 e8             	mov    %eax,-0x18(%rbp)
    1221:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1224:	89 45 ec             	mov    %eax,-0x14(%rbp)
    1227:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    122b:	8b 45 e4             	mov    -0x1c(%rbp),%eax
    122e:	39 45 f0             	cmp    %eax,-0x10(%rbp)
    1231:	7c c7                	jl     11fa <main+0x71>
