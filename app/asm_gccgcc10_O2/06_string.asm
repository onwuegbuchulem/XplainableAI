...
/app/bin_gccgcc10_O2/06_string:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	48 83 ec 38          	sub    $0x38,%rsp
    1088:	ba 70 00 00 00       	mov    $0x70,%edx
    108d:	b9 75 00 00 00       	mov    $0x75,%ecx
    1092:	66 0f 6f 05 96 0f 00 	movdqa 0xf96(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    1099:	00 
    109a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10a1:	00 00 
    10a3:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    10a8:	48 b8 75 70 64 61 74 	movabs $0x742e657461647075,%rax
    10af:	65 2e 74 
    10b2:	4c 8d 44 24 10       	lea    0x10(%rsp),%r8
    10b7:	c6 44 24 0f 00       	movb   $0x0,0xf(%rsp)
    10bc:	48 8d 74 24 06       	lea    0x6(%rsp),%rsi
    10c1:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10c6:	48 89 44 24 05       	mov    %rax,0x5(%rsp)
    10cb:	b8 78 74 00 00       	mov    $0x7478,%eax
    10d0:	66 89 44 24 0d       	mov    %ax,0xd(%rsp)
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	eb 0d                	jmp    10e6 <main+0x66>
    10d9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    10e0:	89 d1                	mov    %edx,%ecx
    10e2:	0f b6 14 06          	movzbl (%rsi,%rax,1),%edx
    10e6:	41 88 0c 00          	mov    %cl,(%r8,%rax,1)
    10ea:	48 83 c0 01          	add    $0x1,%rax
    10ee:	80 fa 2e             	cmp    $0x2e,%dl
    10f1:	75 ed                	jne    10e0 <main+0x60>
    10f3:	31 c0                	xor    %eax,%eax
    10f5:	48 8d 4c 24 05       	lea    0x5(%rsp),%rcx
    10fa:	4c 89 c2             	mov    %r8,%rdx
    10fd:	bf 01 00 00 00       	mov    $0x1,%edi
    1102:	48 8d 35 ff 0e 00 00 	lea    0xeff(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    1109:	e8 62 ff ff ff       	callq  1070 <__printf_chk@plt>
    110e:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    1113:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    111a:	00 00 
    111c:	75 07                	jne    1125 <main+0xa5>
    111e:	31 c0                	xor    %eax,%eax
    1120:	48 83 c4 38          	add    $0x38,%rsp
    1124:	c3                   	retq   
    1125:	e8 36 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
