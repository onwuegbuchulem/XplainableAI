...
/app/bin_gccgcc10_O2/2023_01-Exercise:     file format elf64-x86-64
...
00000000000010d0 <ftell@plt>:
    10d0:	f3 0f 1e fa          	endbr64 
    10d4:	f2 ff 25 d5 2e 00 00 	bnd jmpq *0x2ed5(%rip)        # 3fb0 <ftell@GLIBC_2.2.5>
    10db:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010e0 <fseek@plt>:
    10e0:	f3 0f 1e fa          	endbr64 
    10e4:	f2 ff 25 cd 2e 00 00 	bnd jmpq *0x2ecd(%rip)        # 3fb8 <fseek@GLIBC_2.2.5>
...
0000000000001120 <main>:
    ...
    1126:	41 54                	push   %r12
    1128:	55                   	push   %rbp
    1129:	83 ff 01             	cmp    $0x1,%edi
    112c:	7e 5e                	jle    118c <main+0x6c>
    112e:	4c 8b 6e 08          	mov    0x8(%rsi),%r13
    1132:	48 8d 35 de 0e 00 00 	lea    0xede(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    1139:	4c 89 ef             	mov    %r13,%rdi
    113c:	e8 bf ff ff ff       	callq  1100 <fopen@plt>
    1141:	48 89 c5             	mov    %rax,%rbp
    1144:	48 85 c0             	test   %rax,%rax
    1147:	74 56                	je     119f <main+0x7f>
    1149:	ba 02 00 00 00       	mov    $0x2,%edx
    114e:	31 f6                	xor    %esi,%esi
    1150:	48 89 c7             	mov    %rax,%rdi
    1153:	e8 88 ff ff ff       	callq  10e0 <fseek@plt>
    1158:	48 89 ef             	mov    %rbp,%rdi
    115b:	e8 70 ff ff ff       	callq  10d0 <ftell@plt>
    1160:	48 89 ef             	mov    %rbp,%rdi
    1163:	49 89 c4             	mov    %rax,%r12
    1166:	e8 55 ff ff ff       	callq  10c0 <fclose@plt>
    116b:	4c 89 e1             	mov    %r12,%rcx
    116e:	4c 89 ea             	mov    %r13,%rdx
    1171:	bf 01 00 00 00       	mov    $0x1,%edi
    1176:	48 8d 35 af 0e 00 00 	lea    0xeaf(%rip),%rsi        # 202c <_IO_stdin_used+0x2c>
    117d:	31 c0                	xor    %eax,%eax
    117f:	e8 6c ff ff ff       	callq  10f0 <__printf_chk@plt>
    ...
    1193:	e8 18 ff ff ff       	callq  10b0 <puts@plt>
    1198:	b8 01 00 00 00       	mov    $0x1,%eax
    119d:	eb e7                	jmp    1186 <main+0x66>
    119f:	48 8b 3d 7a 2e 00 00 	mov    0x2e7a(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    11a6:	4c 89 e9             	mov    %r13,%rcx
    11a9:	be 01 00 00 00       	mov    $0x1,%esi
    11ae:	31 c0                	xor    %eax,%eax
    11b0:	48 8d 15 62 0e 00 00 	lea    0xe62(%rip),%rdx        # 2019 <_IO_stdin_used+0x19>
    11b7:	e8 54 ff ff ff       	callq  1110 <__fprintf_chk@plt>
    11bc:	b8 01 00 00 00       	mov    $0x1,%eax
    11c1:	eb c3                	jmp    1186 <main+0x66>
