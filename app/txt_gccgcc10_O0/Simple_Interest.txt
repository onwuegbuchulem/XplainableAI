...
/app/bin_gccgcc10_O0/Simple_Interest:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11de:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    ...
    11f6:	48 8d 3d 33 0e 00 00 	lea    0xe33(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    11fd:	b8 00 00 00 00       	mov    $0x0,%eax
    1202:	e8 79 fe ff ff       	callq  1080 <printf@plt>
    1207:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    120b:	48 89 c6             	mov    %rax,%rsi
    120e:	48 8d 3d 06 0e 00 00 	lea    0xe06(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    1215:	b8 00 00 00 00       	mov    $0x0,%eax
    121a:	e8 71 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    121f:	f3 0f 10 4d e8       	movss  -0x18(%rbp),%xmm1
    1224:	f3 0f 10 45 ec       	movss  -0x14(%rbp),%xmm0
    1229:	f3 0f 59 c8          	mulss  %xmm0,%xmm1
    122d:	f3 0f 10 45 f0       	movss  -0x10(%rbp),%xmm0
    1232:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    1236:	f3 0f 10 0d 0e 0e 00 	movss  0xe0e(%rip),%xmm1        # 204c <_IO_stdin_used+0x4c>
    123d:	00 
    123e:	f3 0f 5e c1          	divss  %xmm1,%xmm0
    1242:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    1247:	66 0f ef d2          	pxor   %xmm2,%xmm2
    124b:	f3 0f 5a 55 f4       	cvtss2sd -0xc(%rbp),%xmm2
    1250:	66 48 0f 7e d0       	movq   %xmm2,%rax
    1255:	66 48 0f 6e c0       	movq   %rax,%xmm0
    125a:	48 8d 3d e1 0d 00 00 	lea    0xde1(%rip),%rdi        # 2042 <_IO_stdin_used+0x42>
