...
/app/bin_gccgcc10_O1/2019_11_23-Lesson:     file format elf64-x86-64
...
0000000000001162 <right>:
    1162:	f3 0f 1e fa          	endbr64 
    1166:	48 83 ec 08          	sub    $0x8,%rsp
    116a:	48 8d 3d 98 0e 00 00 	lea    0xe98(%rip),%rdi        # 2009 <_IO_stdin_used+0x9>
...
000000000000117b <main>:
    ...
    1188:	e8 bc ff ff ff       	callq  1149 <left>
    118d:	b8 00 00 00 00       	mov    $0x0,%eax
    1192:	e8 cb ff ff ff       	callq  1162 <right>
