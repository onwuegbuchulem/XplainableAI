...
/app/bin_gccgcc10_O1/wscanf:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11cd:	e8 ce fe ff ff       	callq  10a0 <setlocale@plt>
    11d2:	48 8d 35 37 0e 00 00 	lea    0xe37(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    11d9:	bf 01 00 00 00       	mov    $0x1,%edi
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 c8 fe ff ff       	callq  10b0 <__wprintf_chk@plt>
    11e8:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11ed:	48 8d 3d e4 0e 00 00 	lea    0xee4(%rip),%rdi        # 20d8 <_IO_stdin_used+0xd8>
    11f4:	b8 00 00 00 00       	mov    $0x0,%eax
    11f9:	e8 92 fe ff ff       	callq  1090 <__isoc99_wscanf@plt>
    11fe:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1202:	f2 0f 2a 44 24 04    	cvtsi2sdl 0x4(%rsp),%xmm0
    1208:	f2 0f 59 05 d8 0e 00 	mulsd  0xed8(%rip),%xmm0        # 20e8 <_IO_stdin_used+0xe8>
    120f:	00 
    1210:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    1214:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1218:	ba a3 00 00 00       	mov    $0xa3,%edx
    121d:	48 8d 35 64 0e 00 00 	lea    0xe64(%rip),%rsi        # 2088 <_IO_stdin_used+0x88>
    1224:	bf 01 00 00 00       	mov    $0x1,%edi
    1229:	b8 01 00 00 00       	mov    $0x1,%eax
    122e:	e8 7d fe ff ff       	callq  10b0 <__wprintf_chk@plt>
    1233:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1238:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    123f:	00 00 
    1241:	75 0a                	jne    124d <main+0xa4>
    1243:	b8 00 00 00 00       	mov    $0x0,%eax
    1248:	48 83 c4 18          	add    $0x18,%rsp
    124c:	c3                   	retq   
    124d:	e8 2e fe ff ff       	callq  1080 <__stack_chk_fail@plt>
