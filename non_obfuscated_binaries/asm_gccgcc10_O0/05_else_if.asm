...
/app/bin_gccgcc10_O0/05_else_if:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	c7 45 fc 2d 00 00 00 	movl   $0x2d,-0x4(%rbp)
    115c:	83 7d fc 3c          	cmpl   $0x3c,-0x4(%rbp)
    1160:	7e 13                	jle    1175 <main+0x2c>
    1162:	48 8d 3d 9f 0e 00 00 	lea    0xe9f(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    1169:	b8 00 00 00 00       	mov    $0x0,%eax
    116e:	e8 dd fe ff ff       	callq  1050 <printf@plt>
    1173:	eb 43                	jmp    11b8 <main+0x6f>
    1175:	83 7d fc 28          	cmpl   $0x28,-0x4(%rbp)
    1179:	7e 13                	jle    118e <main+0x45>
    117b:	48 8d 3d b6 0e 00 00 	lea    0xeb6(%rip),%rdi        # 2038 <_IO_stdin_used+0x38>
    1182:	b8 00 00 00 00       	mov    $0x0,%eax
    1187:	e8 c4 fe ff ff       	callq  1050 <printf@plt>
    118c:	eb 2a                	jmp    11b8 <main+0x6f>
    118e:	83 7d fc 12          	cmpl   $0x12,-0x4(%rbp)
    1192:	7e 13                	jle    11a7 <main+0x5e>
    1194:	48 8d 3d bd 0e 00 00 	lea    0xebd(%rip),%rdi        # 2058 <_IO_stdin_used+0x58>
    119b:	b8 00 00 00 00       	mov    $0x0,%eax
    11a0:	e8 ab fe ff ff       	callq  1050 <printf@plt>
    11a5:	eb 11                	jmp    11b8 <main+0x6f>
    11a7:	48 8d 3d b8 0e 00 00 	lea    0xeb8(%rip),%rdi        # 2066 <_IO_stdin_used+0x66>
