...
/app/bin_gccgcc10_O1/2019_08_24-Lesson-a:     file format elf64-x86-64
...
0000000000001229 <main>:
    ...
    1237:	bf 48 00 00 00       	mov    $0x48,%edi
    123c:	e8 af fe ff ff       	callq  10f0 <malloc@plt>
    1241:	48 85 c0             	test   %rax,%rax
    1244:	0f 84 cc 00 00 00    	je     1316 <main+0xed>
    ...
    1274:	e8 67 fe ff ff       	callq  10e0 <time@plt>
    1279:	48 89 c7             	mov    %rax,%rdi
    127c:	e8 3f fe ff ff       	callq  10c0 <srand@plt>
    1281:	49 8d 5d 20          	lea    0x20(%r13),%rbx
    1285:	4d 8d 65 48          	lea    0x48(%r13),%r12
    1289:	48 89 dd             	mov    %rbx,%rbp
    ...
    12ac:	89 55 00             	mov    %edx,0x0(%rbp)
    12af:	48 83 c5 04          	add    $0x4,%rbp
    12b3:	4c 39 e5             	cmp    %r12,%rbp
    12b6:	75 d4                	jne    128c <main+0x63>
    12b8:	4c 89 ea             	mov    %r13,%rdx
    12bb:	48 8d 35 60 0d 00 00 	lea    0xd60(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    12c2:	bf 01 00 00 00       	mov    $0x1,%edi
    12c7:	b8 00 00 00 00       	mov    $0x0,%eax
    12cc:	e8 2f fe ff ff       	callq  1100 <__printf_chk@plt>
    12d1:	48 8d 2d 58 0d 00 00 	lea    0xd58(%rip),%rbp        # 2030 <_IO_stdin_used+0x30>
    12d8:	8b 13                	mov    (%rbx),%edx
    12da:	48 89 ee             	mov    %rbp,%rsi
    ...
    12f0:	4c 39 e3             	cmp    %r12,%rbx
    12f3:	75 e3                	jne    12d8 <main+0xaf>
    12f5:	48 8b 35 24 2d 00 00 	mov    0x2d24(%rip),%rsi        # 4020 <stdout@@GLIBC_2.2.5>
    12fc:	bf 0a 00 00 00       	mov    $0xa,%edi
    1301:	e8 ca fd ff ff       	callq  10d0 <putc@plt>
    ...
    1313:	41 5d                	pop    %r13
    1315:	c3                   	retq   
    1316:	48 8b 0d 23 2d 00 00 	mov    0x2d23(%rip),%rcx        # 4040 <stderr@@GLIBC_2.2.5>
    131d:	ba 1d 00 00 00       	mov    $0x1d,%edx
    1322:	be 01 00 00 00       	mov    $0x1,%esi
    1327:	48 8d 3d d6 0c 00 00 	lea    0xcd6(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    132e:	e8 ed fd ff ff       	callq  1120 <fwrite@plt>
    1333:	bf 01 00 00 00       	mov    $0x1,%edi
    1338:	e8 d3 fd ff ff       	callq  1110 <exit@plt>
