...
/app/bin_gccgcc10_O0/month01:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1195:	c7 45 f4 1f 00 00 00 	movl   $0x1f,-0xc(%rbp)
    119c:	c7 45 f8 1b 00 00 00 	movl   $0x1b,-0x8(%rbp)
    11a3:	c7 45 fc 03 00 00 00 	movl   $0x3,-0x4(%rbp)
    11aa:	48 8d 3d 53 0e 00 00 	lea    0xe53(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11b1:	e8 ca fe ff ff       	callq  1080 <puts@plt>
    11b6:	48 8d 3d 55 0e 00 00 	lea    0xe55(%rip),%rdi        # 2012 <_IO_stdin_used+0x12>
    11bd:	e8 be fe ff ff       	callq  1080 <puts@plt>
    11c2:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%rbp)
    11c9:	e9 83 00 00 00       	jmpq   1251 <main+0xc8>
    11ce:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%rbp)
    11d5:	eb 67                	jmp    123e <main+0xb5>
    11d7:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11da:	3b 45 fc             	cmp    -0x4(%rbp),%eax
    11dd:	7d 19                	jge    11f8 <main+0x6f>
    11df:	83 7d ec 01          	cmpl   $0x1,-0x14(%rbp)
    11e3:	75 13                	jne    11f8 <main+0x6f>
    11e5:	48 8d 3d 42 0e 00 00 	lea    0xe42(%rip),%rdi        # 202e <_IO_stdin_used+0x2e>
    11ec:	b8 00 00 00 00       	mov    $0x0,%eax
    11f1:	e8 9a fe ff ff       	callq  1090 <printf@plt>
    11f6:	eb 42                	jmp    123a <main+0xb1>
    11f8:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11fb:	3b 45 f8             	cmp    -0x8(%rbp),%eax
    11fe:	75 18                	jne    1218 <main+0x8f>
    1200:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1203:	89 c6                	mov    %eax,%esi
    1205:	48 8d 3d 27 0e 00 00 	lea    0xe27(%rip),%rdi        # 2033 <_IO_stdin_used+0x33>
    120c:	b8 00 00 00 00       	mov    $0x0,%eax
    1211:	e8 7a fe ff ff       	callq  1090 <printf@plt>
    1216:	eb 16                	jmp    122e <main+0xa5>
    1218:	8b 45 ec             	mov    -0x14(%rbp),%eax
    121b:	89 c6                	mov    %eax,%esi
    121d:	48 8d 3d 15 0e 00 00 	lea    0xe15(%rip),%rdi        # 2039 <_IO_stdin_used+0x39>
    1224:	b8 00 00 00 00       	mov    $0x0,%eax
    1229:	e8 62 fe ff ff       	callq  1090 <printf@plt>
    122e:	83 45 ec 01          	addl   $0x1,-0x14(%rbp)
    1232:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1235:	3b 45 f4             	cmp    -0xc(%rbp),%eax
    1238:	7f 0c                	jg     1246 <main+0xbd>
    123a:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    123e:	83 7d f0 06          	cmpl   $0x6,-0x10(%rbp)
    1242:	7e 93                	jle    11d7 <main+0x4e>
    1244:	eb 01                	jmp    1247 <main+0xbe>
    1246:	90                   	nop
    1247:	bf 0a 00 00 00       	mov    $0xa,%edi
    124c:	e8 1f fe ff ff       	callq  1070 <putchar@plt>
    1251:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1254:	3b 45 f4             	cmp    -0xc(%rbp),%eax
    1257:	0f 8e 71 ff ff ff    	jle    11ce <main+0x45>
