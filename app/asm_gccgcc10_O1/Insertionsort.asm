...
/app/bin_gccgcc10_O1/Insertionsort:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11bf:	00 00 
    11c1:	48 89 84 24 b8 0f 00 	mov    %rax,0xfb8(%rsp)
    11c8:	00 
    ...
    1207:	44 8b 44 24 0c       	mov    0xc(%rsp),%r8d
    120c:	45 85 c0             	test   %r8d,%r8d
    120f:	7e 32                	jle    1243 <main+0x9a>
    1211:	48 8d 6c 24 10       	lea    0x10(%rsp),%rbp
    1216:	bb 00 00 00 00       	mov    $0x0,%ebx
    121b:	4c 8d 25 fb 0d 00 00 	lea    0xdfb(%rip),%r12        # 201d <_IO_stdin_used+0x1d>
    ...
    1235:	44 8b 44 24 0c       	mov    0xc(%rsp),%r8d
    123a:	48 83 c5 04          	add    $0x4,%rbp
    123e:	41 39 d8             	cmp    %ebx,%r8d
    1241:	7f df                	jg     1222 <main+0x79>
    1243:	41 83 f8 01          	cmp    $0x1,%r8d
    1247:	7e 3d                	jle    1286 <main+0xdd>
    1249:	4c 8d 4c 24 14       	lea    0x14(%rsp),%r9
    124e:	bf 01 00 00 00       	mov    $0x1,%edi
    1253:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    1258:	eb 0c                	jmp    1266 <main+0xbd>
    125a:	83 c7 01             	add    $0x1,%edi
    125d:	49 83 c1 04          	add    $0x4,%r9
    1261:	44 39 c7             	cmp    %r8d,%edi
    1264:	74 20                	je     1286 <main+0xdd>
    1266:	85 ff                	test   %edi,%edi
    1268:	7e f0                	jle    125a <main+0xb1>
    126a:	4c 89 c8             	mov    %r9,%rax
    126d:	8b 48 fc             	mov    -0x4(%rax),%ecx
    1270:	8b 10                	mov    (%rax),%edx
    1272:	39 d1                	cmp    %edx,%ecx
    1274:	7e e4                	jle    125a <main+0xb1>
    1276:	89 08                	mov    %ecx,(%rax)
    1278:	89 50 fc             	mov    %edx,-0x4(%rax)
    127b:	48 83 e8 04          	sub    $0x4,%rax
    127f:	48 39 f0             	cmp    %rsi,%rax
    1282:	75 e9                	jne    126d <main+0xc4>
    1284:	eb d4                	jmp    125a <main+0xb1>
    1286:	48 8d 3d ab 0d 00 00 	lea    0xdab(%rip),%rdi        # 2038 <_IO_stdin_used+0x38>
    128d:	e8 ee fd ff ff       	callq  1080 <puts@plt>
    1292:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
    1297:	7e 2c                	jle    12c5 <main+0x11c>
    1299:	bb 00 00 00 00       	mov    $0x0,%ebx
    129e:	48 8d 2d 8e 0d 00 00 	lea    0xd8e(%rip),%rbp        # 2033 <_IO_stdin_used+0x33>
    12a5:	8b 54 9c 10          	mov    0x10(%rsp,%rbx,4),%edx
    ...
    12bb:	48 83 c3 01          	add    $0x1,%rbx
    12bf:	39 5c 24 0c          	cmp    %ebx,0xc(%rsp)
    12c3:	7f e0                	jg     12a5 <main+0xfc>
    12c5:	48 8b 84 24 b8 0f 00 	mov    0xfb8(%rsp),%rax
    12cc:	00 
    12cd:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12d4:	00 00 
    12d6:	75 11                	jne    12e9 <main+0x140>
    12d8:	b8 00 00 00 00       	mov    $0x0,%eax
    12dd:	48 81 c4 c0 0f 00 00 	add    $0xfc0,%rsp
    12e4:	5b                   	pop    %rbx
    12e5:	5d                   	pop    %rbp
    12e6:	41 5c                	pop    %r12
    12e8:	c3                   	retq   
    12e9:	e8 a2 fd ff ff       	callq  1090 <__stack_chk_fail@plt>
