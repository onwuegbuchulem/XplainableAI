...
/app/bin_gccgcc10_O3/palindrome:     file format elf64-x86-64
...
0000000000001140 <isPalindrome>:
    1140:	f3 0f 1e fa          	endbr64 
    1144:	85 ff                	test   %edi,%edi
    1146:	74 38                	je     1180 <isPalindrome+0x40>
    1148:	89 fa                	mov    %edi,%edx
    114a:	31 c9                	xor    %ecx,%ecx
    114c:	0f 1f 40 00          	nopl   0x0(%rax)
    1150:	48 63 c2             	movslq %edx,%rax
    1153:	8d 34 89             	lea    (%rcx,%rcx,4),%esi
    1156:	89 d1                	mov    %edx,%ecx
    1158:	48 69 c0 67 66 66 66 	imul   $0x66666667,%rax,%rax
    115f:	c1 f9 1f             	sar    $0x1f,%ecx
    1162:	48 c1 f8 22          	sar    $0x22,%rax
    1166:	29 c8                	sub    %ecx,%eax
    1168:	8d 0c 80             	lea    (%rax,%rax,4),%ecx
    116b:	01 c9                	add    %ecx,%ecx
    116d:	29 ca                	sub    %ecx,%edx
    116f:	8d 0c 72             	lea    (%rdx,%rsi,2),%ecx
    1172:	89 c2                	mov    %eax,%edx
    1174:	85 c0                	test   %eax,%eax
    1176:	75 d8                	jne    1150 <isPalindrome+0x10>
    1178:	39 cf                	cmp    %ecx,%edi
    117a:	0f 94 c0             	sete   %al
    117d:	c3                   	retq   
    117e:	66 90                	xchg   %ax,%ax
    1180:	31 c9                	xor    %ecx,%ecx
    1182:	39 cf                	cmp    %ecx,%edi
