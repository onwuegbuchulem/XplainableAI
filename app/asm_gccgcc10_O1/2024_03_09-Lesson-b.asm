...
/app/bin_gccgcc10_O1/2024_03_09-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d 70 01 00 00 	lea    0x170(%rip),%rdi        # 1238 <main>
...
0000000000001189 <astring>:
    ...
    11a8:	48 39 c4             	cmp    %rax,%rsp
    11ab:	74 12                	je     11bf <astring+0x36>
    11ad:	48 81 ec 00 10 00 00 	sub    $0x1000,%rsp
    11b4:	48 83 8c 24 f8 0f 00 	orq    $0x0,0xff8(%rsp)
    11bb:	00 00 
    11bd:	eb e9                	jmp    11a8 <astring+0x1f>
    11bf:	48 83 ec 20          	sub    $0x20,%rsp
    11c3:	48 83 4c 24 18 00    	orq    $0x0,0x18(%rsp)
    11c9:	48 8d 5c 24 0f       	lea    0xf(%rsp),%rbx
    11ce:	48 83 e3 f0          	and    $0xfffffffffffffff0,%rbx
    11d2:	48 89 d8             	mov    %rbx,%rax
    11d5:	48 8d 53 0c          	lea    0xc(%rbx),%rdx
    11d9:	c6 00 41             	movb   $0x41,(%rax)
    11dc:	48 83 c0 01          	add    $0x1,%rax
    11e0:	48 39 d0             	cmp    %rdx,%rax
    11e3:	75 f4                	jne    11d9 <astring+0x50>
    11e5:	c6 43 0c 00          	movb   $0x0,0xc(%rbx)
    11e9:	48 89 da             	mov    %rbx,%rdx
    ...
    11fd:	e8 8e fe ff ff       	callq  1090 <__printf_chk@plt>
    1202:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1206:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    120d:	00 00 
    120f:	75 09                	jne    121a <astring+0x91>
    1211:	48 89 d8             	mov    %rbx,%rax
    1214:	48 8b 5d f8          	mov    -0x8(%rbp),%rbx
    1218:	c9                   	leaveq 
    1219:	c3                   	retq   
    121a:	e8 61 fe ff ff       	callq  1080 <__stack_chk_fail@plt>

000000000000121f <header>:
    121f:	f3 0f 1e fa          	endbr64 
    1223:	48 83 ec 08          	sub    $0x8,%rsp
    1227:	48 8d 3d ee 0d 00 00 	lea    0xdee(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
...
0000000000001238 <main>:
    ...
    123c:	53                   	push   %rbx
    123d:	48 8d 3d f3 0d 00 00 	lea    0xdf3(%rip),%rdi        # 2037 <_IO_stdin_used+0x37>
    1244:	e8 27 fe ff ff       	callq  1070 <puts@plt>
    1249:	e8 3b ff ff ff       	callq  1189 <astring>
    124e:	48 89 c3             	mov    %rax,%rbx
    1251:	e8 c9 ff ff ff       	callq  121f <header>
    1256:	48 89 da             	mov    %rbx,%rdx
    ...
    126a:	e8 21 fe ff ff       	callq  1090 <__printf_chk@plt>
