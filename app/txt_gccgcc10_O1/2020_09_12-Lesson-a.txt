...
/app/bin_gccgcc10_O1/2020_09_12-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b3:	48 89 e3             	mov    %rsp,%rbx
    11b6:	48 89 de             	mov    %rbx,%rsi
    11b9:	48 8d 3d 4b 0e 00 00 	lea    0xe4b(%rip),%rdi        # 200b <_IO_stdin_used+0xb>
    11c0:	b8 00 00 00 00       	mov    $0x0,%eax
    11c5:	e8 c6 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11ca:	48 89 da             	mov    %rbx,%rdx
    11cd:	48 8d 35 3e 0e 00 00 	lea    0xe3e(%rip),%rsi        # 2012 <_IO_stdin_used+0x12>
    11d4:	bf 01 00 00 00       	mov    $0x1,%edi
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	e8 9d fe ff ff       	callq  1080 <__printf_chk@plt>
    11e3:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    11e8:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11ef:	00 00 
    11f1:	75 0b                	jne    11fe <main+0x75>
    11f3:	b8 00 00 00 00       	mov    $0x0,%eax
    11f8:	48 83 c4 30          	add    $0x30,%rsp
    11fc:	5b                   	pop    %rbx
    11fd:	c3                   	retq   
    11fe:	e8 6d fe ff ff       	callq  1070 <__stack_chk_fail@plt>
