...
/app/bin_gccgcc10_O1/code_love:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	48 83 ec 48          	sub    $0x48,%rsp
    1191:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1198:	00 00 
    119a:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    119f:	31 c0                	xor    %eax,%eax
    11a1:	48 b8 49 00 00 00 20 	movabs $0x2000000049,%rax
    11a8:	00 00 00 
    11ab:	48 ba 2a 00 00 00 20 	movabs $0x200000002a,%rdx
    11b2:	00 00 00 
    11b5:	48 89 04 24          	mov    %rax,(%rsp)
    11b9:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    11be:	48 b8 74 00 00 00 6f 	movabs $0x6f00000074,%rax
    11c5:	00 00 00 
    11c8:	48 ba 20 00 00 00 63 	movabs $0x6300000020,%rdx
    11cf:	00 00 00 
    11d2:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11d7:	48 89 54 24 18       	mov    %rdx,0x18(%rsp)
    11dc:	48 b8 6f 00 00 00 64 	movabs $0x640000006f,%rax
    11e3:	00 00 00 
    11e6:	48 ba 65 00 00 00 0a 	movabs $0xa00000065,%rdx
    11ed:	00 00 00 
    11f0:	48 89 44 24 20       	mov    %rax,0x20(%rsp)
    11f5:	48 89 54 24 28       	mov    %rdx,0x28(%rsp)
    11fa:	c7 44 24 30 00 00 00 	movl   $0x0,0x30(%rsp)
    1201:	00 
    1202:	48 8d 35 fb 0d 00 00 	lea    0xdfb(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1209:	bf 06 00 00 00       	mov    $0x6,%edi
    120e:	e8 7d fe ff ff       	callq  1090 <setlocale@plt>
    1213:	c7 44 24 08 65 26 00 	movl   $0x2665,0x8(%rsp)
    121a:	00 
    121b:	48 89 e7             	mov    %rsp,%rdi
    121e:	48 8b 35 eb 2d 00 00 	mov    0x2deb(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1225:	e8 56 fe ff ff       	callq  1080 <fputws@plt>
    122a:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    122f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1236:	00 00 
    1238:	75 0a                	jne    1244 <main+0xbb>
    123a:	b8 00 00 00 00       	mov    $0x0,%eax
    123f:	48 83 c4 48          	add    $0x48,%rsp
    1243:	c3                   	retq   
    1244:	e8 27 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
