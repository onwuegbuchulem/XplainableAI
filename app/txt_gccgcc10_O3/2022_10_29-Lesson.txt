...
/app/bin_gccgcc10_O3/2022_10_29-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108e:	53                   	push   %rbx
    108f:	48 83 ec 50          	sub    $0x50,%rsp
    1093:	66 0f 6f 05 75 0f 00 	movdqa 0xf75(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    109a:	00 
    109b:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10a2:	00 00 
    10a4:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    10a9:	31 c0                	xor    %eax,%eax
    10ab:	48 89 e3             	mov    %rsp,%rbx
    10ae:	4c 8d 64 24 40       	lea    0x40(%rsp),%r12
    10b3:	0f 29 04 24          	movaps %xmm0,(%rsp)
    10b7:	66 0f 6f 05 61 0f 00 	movdqa 0xf61(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10be:	00 
    10bf:	0f 29 44 24 10       	movaps %xmm0,0x10(%rsp)
    10c4:	66 0f 6f 05 64 0f 00 	movdqa 0xf64(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    10cb:	00 
    10cc:	0f 29 44 24 20       	movaps %xmm0,0x20(%rsp)
    10d1:	66 0f 6f 05 67 0f 00 	movdqa 0xf67(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    10d8:	00 
    10d9:	0f 29 44 24 30       	movaps %xmm0,0x30(%rsp)
    10de:	66 90                	xchg   %ax,%ax
    10e0:	8b 4b 04             	mov    0x4(%rbx),%ecx
    10e3:	8b 13                	mov    (%rbx),%edx
    10e5:	48 89 ee             	mov    %rbp,%rsi
    10e8:	bf 01 00 00 00       	mov    $0x1,%edi
    10ed:	31 c0                	xor    %eax,%eax
    10ef:	48 83 c3 08          	add    $0x8,%rbx
    10f3:	e8 78 ff ff ff       	callq  1070 <__printf_chk@plt>
    10f8:	49 39 dc             	cmp    %rbx,%r12
    10fb:	75 e3                	jne    10e0 <main+0x60>
    10fd:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    1102:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1109:	00 00 
    110b:	75 0b                	jne    1118 <main+0x98>
    110d:	48 83 c4 50          	add    $0x50,%rsp
