...
/app/bin_gccgcc10_O1/2019_02_16-Lesson-c:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1185:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx
    118a:	4c 8d 64 24 2c       	lea    0x2c(%rsp),%r12
    118f:	48 8d 2d 6e 0e 00 00 	lea    0xe6e(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1196:	8b 13                	mov    (%rbx),%edx
    1198:	48 89 ee             	mov    %rbp,%rsi
    119b:	bf 01 00 00 00       	mov    $0x1,%edi
    11a0:	b8 00 00 00 00       	mov    $0x0,%eax
    11a5:	e8 c6 fe ff ff       	callq  1070 <__printf_chk@plt>
    11aa:	48 83 c3 04          	add    $0x4,%rbx
    11ae:	4c 39 e3             	cmp    %r12,%rbx
    11b1:	75 e3                	jne    1196 <main+0x2d>
    11b3:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11b8:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11bf:	00 00 
    11c1:	75 0e                	jne    11d1 <main+0x68>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	48 83 c4 10          	add    $0x10,%rsp
    11cc:	5b                   	pop    %rbx
    11cd:	5d                   	pop    %rbp
    11ce:	41 5c                	pop    %r12
    11d0:	c3                   	retq   
    11d1:	e8 8a fe ff ff       	callq  1060 <__stack_chk_fail@plt>
