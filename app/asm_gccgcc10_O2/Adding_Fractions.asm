...
/app/bin_gccgcc10_O2/Adding_Fractions:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e4:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    10e9:	48 8d 3d e8 0f 00 00 	lea    0xfe8(%rip),%rdi        # 20d8 <_IO_stdin_used+0xd8>
    10f0:	31 c0                	xor    %eax,%eax
    10f2:	e8 b9 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10f7:	48 8d 3d 32 0f 00 00 	lea    0xf32(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    10fe:	e8 7d ff ff ff       	callq  1080 <puts@plt>
    1103:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    1108:	48 8d 3d c9 0f 00 00 	lea    0xfc9(%rip),%rdi        # 20d8 <_IO_stdin_used+0xd8>
    110f:	31 c0                	xor    %eax,%eax
    1111:	e8 9a ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1116:	48 8d 3d 3b 0f 00 00 	lea    0xf3b(%rip),%rdi        # 2058 <_IO_stdin_used+0x58>
    111d:	e8 5e ff ff ff       	callq  1080 <puts@plt>
    1122:	48 8d 74 24 0c       	lea    0xc(%rsp),%rsi
    1127:	48 8d 3d aa 0f 00 00 	lea    0xfaa(%rip),%rdi        # 20d8 <_IO_stdin_used+0xd8>
    112e:	31 c0                	xor    %eax,%eax
    1130:	e8 7b ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1135:	48 8d 3d 44 0f 00 00 	lea    0xf44(%rip),%rdi        # 2080 <_IO_stdin_used+0x80>
    113c:	e8 3f ff ff ff       	callq  1080 <puts@plt>
    1141:	48 8d 74 24 14       	lea    0x14(%rsp),%rsi
    1146:	48 8d 3d 8b 0f 00 00 	lea    0xf8b(%rip),%rdi        # 20d8 <_IO_stdin_used+0xd8>
    114d:	31 c0                	xor    %eax,%eax
    114f:	e8 5c ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1154:	8b 4c 24 10          	mov    0x10(%rsp),%ecx
    1158:	44 8b 4c 24 14       	mov    0x14(%rsp),%r9d
    115d:	44 39 c9             	cmp    %r9d,%ecx
    1160:	74 4e                	je     11b0 <main+0xf0>
    1162:	8b 44 24 08          	mov    0x8(%rsp),%eax
    1166:	8b 54 24 0c          	mov    0xc(%rsp),%edx
    116a:	89 ce                	mov    %ecx,%esi
    116c:	41 0f af f1          	imul   %r9d,%esi
    1170:	44 8b 44 24 0c       	mov    0xc(%rsp),%r8d
    1175:	0f af d1             	imul   %ecx,%edx
    1178:	41 0f af c1          	imul   %r9d,%eax
    117c:	01 d0                	add    %edx,%eax
    117e:	8b 54 24 08          	mov    0x8(%rsp),%edx
    1182:	56                   	push   %rsi
    1183:	bf 01 00 00 00       	mov    $0x1,%edi
    1188:	48 8d 35 19 0f 00 00 	lea    0xf19(%rip),%rsi        # 20a8 <_IO_stdin_used+0xa8>
    118f:	50                   	push   %rax
    ...
    11a5:	00 00 
    11a7:	75 18                	jne    11c1 <main+0x101>
    11a9:	31 c0                	xor    %eax,%eax
    11ab:	48 83 c4 28          	add    $0x28,%rsp
    11af:	c3                   	retq   
    11b0:	8b 54 24 08          	mov    0x8(%rsp),%edx
    11b4:	44 8b 44 24 0c       	mov    0xc(%rsp),%r8d
    11b9:	89 ce                	mov    %ecx,%esi
    11bb:	42 8d 04 02          	lea    (%rdx,%r8,1),%eax
    11bf:	eb c1                	jmp    1182 <main+0xc2>
