...
/app/bin_gccgcc10_O1/2020_12_19-Lesson-b:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	bd 09 00 00 00       	mov    $0x9,%ebp
    115a:	f3 0f 10 25 da 0e 00 	movss  0xeda(%rip),%xmm4        # 203c <_IO_stdin_used+0x3c>
    1161:	00 
    1162:	f3 0f 11 64 24 0c    	movss  %xmm4,0xc(%rsp)
    1168:	bb 02 00 00 00       	mov    $0x2,%ebx
    116d:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1171:	f3 0f 2a cb          	cvtsi2ss %ebx,%xmm1
    1175:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
    1179:	f2 0f 10 05 bf 0e 00 	movsd  0xebf(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    1180:	00 
    1181:	f2 0f 5e c1          	divsd  %xmm1,%xmm0
    1185:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1189:	f3 0f 5a 4c 24 0c    	cvtss2sd 0xc(%rsp),%xmm1
    118f:	f2 0f 58 c1          	addsd  %xmm1,%xmm0
    1193:	66 0f ef d2          	pxor   %xmm2,%xmm2
    1197:	f2 0f 5a d0          	cvtsd2ss %xmm0,%xmm2
    119b:	f3 0f 11 54 24 0c    	movss  %xmm2,0xc(%rsp)
    11a1:	66 0f ef db          	pxor   %xmm3,%xmm3
    11a5:	f3 0f 5a da          	cvtss2sd %xmm2,%xmm3
    11a9:	66 49 0f 7e de       	movq   %xmm3,%r14
    11ae:	66 0f 28 c3          	movapd %xmm3,%xmm0
    11b2:	89 da                	mov    %ebx,%edx
    ...
    11c5:	e8 86 fe ff ff       	callq  1050 <__printf_chk@plt>
    11ca:	01 db                	add    %ebx,%ebx
    11cc:	83 ed 01             	sub    $0x1,%ebp
    11cf:	75 9c                	jne    116d <main+0x24>
    11d1:	66 49 0f 6e c6       	movq   %r14,%xmm0
    11d6:	48 8d 35 3b 0e 00 00 	lea    0xe3b(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
