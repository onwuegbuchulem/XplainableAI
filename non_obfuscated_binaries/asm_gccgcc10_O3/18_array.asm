...
/app/bin_gccgcc10_O3/18_array:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10ab:	c7 44 24 10 0d 00 00 	movl   $0xd,0x10(%rsp)
    10b2:	00 
    10b3:	48 89 e3             	mov    %rsp,%rbx
    10b6:	4c 8d 64 24 14       	lea    0x14(%rsp),%r12
    10bb:	0f 29 04 24          	movaps %xmm0,(%rsp)
    10bf:	8b 13                	mov    (%rbx),%edx
    10c1:	48 89 ee             	mov    %rbp,%rsi
    10c4:	bf 01 00 00 00       	mov    $0x1,%edi
    10c9:	31 c0                	xor    %eax,%eax
    10cb:	48 83 c3 04          	add    $0x4,%rbx
    10cf:	89 d1                	mov    %edx,%ecx
    10d1:	e8 9a ff ff ff       	callq  1070 <__printf_chk@plt>
    10d6:	4c 39 e3             	cmp    %r12,%rbx
    10d9:	75 e4                	jne    10bf <main+0x3f>
    10db:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10e0:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10e7:	00 00 
    10e9:	75 0b                	jne    10f6 <main+0x76>
    10eb:	48 83 c4 20          	add    $0x20,%rsp
    10ef:	31 c0                	xor    %eax,%eax
    10f1:	5b                   	pop    %rbx
    10f2:	5d                   	pop    %rbp
    10f3:	41 5c                	pop    %r12
    10f5:	c3                   	retq   
    10f6:	e8 65 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
