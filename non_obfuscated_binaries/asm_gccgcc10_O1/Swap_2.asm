...
/app/bin_gccgcc10_O1/Swap_2:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ba:	48 8d 3d 60 0e 00 00 	lea    0xe60(%rip),%rdi        # 2021 <_IO_stdin_used+0x21>
    11c1:	b8 00 00 00 00       	mov    $0x0,%eax
    11c6:	e8 c5 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cb:	8b 0c 24             	mov    (%rsp),%ecx
    11ce:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11d2:	89 4c 24 04          	mov    %ecx,0x4(%rsp)
    11d6:	89 14 24             	mov    %edx,(%rsp)
    11d9:	48 8d 35 39 0e 00 00 	lea    0xe39(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    11e0:	bf 01 00 00 00       	mov    $0x1,%edi
    11e5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ea:	e8 91 fe ff ff       	callq  1080 <__printf_chk@plt>
    11ef:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11f4:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11fb:	00 00 
    11fd:	75 05                	jne    1204 <main+0x7b>
    11ff:	48 83 c4 18          	add    $0x18,%rsp
    1203:	c3                   	retq   
