...
/app/bin_gccgcc10_O1/RussianPeasantMultiplication:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11cd:	48 8d 54 24 10       	lea    0x10(%rsp),%rdx
    11d2:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    ...
    11e8:	48 8b 7c 24 08       	mov    0x8(%rsp),%rdi
    11ed:	4c 8b 4c 24 10       	mov    0x10(%rsp),%r9
    11f2:	48 85 ff             	test   %rdi,%rdi
    11f5:	7e 74                	jle    126b <main+0xc2>
    11f7:	4c 89 c9             	mov    %r9,%rcx
    11fa:	48 89 fa             	mov    %rdi,%rdx
    11fd:	41 b8 00 00 00 00    	mov    $0x0,%r8d
    1203:	48 89 d6             	mov    %rdx,%rsi
    1206:	48 c1 ee 3f          	shr    $0x3f,%rsi
    120a:	48 8d 04 32          	lea    (%rdx,%rsi,1),%rax
    120e:	83 e0 01             	and    $0x1,%eax
    1211:	48 29 f0             	sub    %rsi,%rax
    1214:	49 8d 34 08          	lea    (%r8,%rcx,1),%rsi
    1218:	48 83 f8 01          	cmp    $0x1,%rax
    121c:	4c 0f 44 c6          	cmove  %rsi,%r8
    1220:	48 d1 fa             	sar    %rdx
    1223:	48 01 c9             	add    %rcx,%rcx
    1226:	48 85 d2             	test   %rdx,%rdx
    1229:	7f d8                	jg     1203 <main+0x5a>
    122b:	48 89 4c 24 10       	mov    %rcx,0x10(%rsp)
    1230:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    1235:	4c 89 c9             	mov    %r9,%rcx
    1238:	48 89 fa             	mov    %rdi,%rdx
    123b:	48 8d 35 e6 0d 00 00 	lea    0xde6(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    1242:	bf 01 00 00 00       	mov    $0x1,%edi
    1247:	b8 00 00 00 00       	mov    $0x0,%eax
    124c:	e8 4f fe ff ff       	callq  10a0 <__printf_chk@plt>
    1251:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1256:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    125d:	00 00 
    125f:	75 12                	jne    1273 <main+0xca>
    1261:	b8 00 00 00 00       	mov    $0x0,%eax
    1266:	48 83 c4 28          	add    $0x28,%rsp
    126a:	c3                   	retq   
    126b:	41 b8 00 00 00 00    	mov    $0x0,%r8d
    1271:	eb c2                	jmp    1235 <main+0x8c>
    1273:	e8 18 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
