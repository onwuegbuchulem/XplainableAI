...
/app/bin_gccgcc10_O1/AreaOfCircle:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b2:	48 8d 74 24 14       	lea    0x14(%rsp),%rsi
    11b7:	48 8d 3d 5c 0e 00 00 	lea    0xe5c(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11cc:	f3 0f 2a 4c 24 14    	cvtsi2ssl 0x14(%rsp),%xmm1
    11d2:	0f 28 c1             	movaps %xmm1,%xmm0
    11d5:	f3 0f 59 05 6f 0e 00 	mulss  0xe6f(%rip),%xmm0        # 204c <_IO_stdin_used+0x4c>
    11dc:	00 
    11dd:	f3 0f 11 4c 24 0c    	movss  %xmm1,0xc(%rsp)
    11e3:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    11e7:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    11eb:	48 8d 35 2b 0e 00 00 	lea    0xe2b(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    11f2:	bf 01 00 00 00       	mov    $0x1,%edi
    11f7:	b8 01 00 00 00       	mov    $0x1,%eax
    11fc:	e8 7f fe ff ff       	callq  1080 <__printf_chk@plt>
    1201:	f3 0f 10 4c 24 0c    	movss  0xc(%rsp),%xmm1
    1207:	f3 0f 59 0d 41 0e 00 	mulss  0xe41(%rip),%xmm1        # 2050 <_IO_stdin_used+0x50>
    120e:	00 
    120f:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1213:	f3 0f 5a c1          	cvtss2sd %xmm1,%xmm0
    1217:	48 8d 35 13 0e 00 00 	lea    0xe13(%rip),%rsi        # 2031 <_IO_stdin_used+0x31>
    121e:	bf 01 00 00 00       	mov    $0x1,%edi
    1223:	b8 01 00 00 00       	mov    $0x1,%eax
    1228:	e8 53 fe ff ff       	callq  1080 <__printf_chk@plt>
    122d:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1232:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1239:	00 00 
    123b:	75 0a                	jne    1247 <main+0xbe>
