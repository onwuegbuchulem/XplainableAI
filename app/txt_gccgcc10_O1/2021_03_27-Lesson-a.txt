...
/app/bin_gccgcc10_O1/2021_03_27-Lesson-a:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11f6:	74 78                	je     1270 <main+0xa7>
    11f8:	48 89 e3             	mov    %rsp,%rbx
    11fb:	48 8b 05 56 0e 00 00 	mov    0xe56(%rip),%rax        # 2058 <_IO_stdin_used+0x58>
    1202:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1207:	48 8d 15 18 0e 00 00 	lea    0xe18(%rip),%rdx        # 2026 <_IO_stdin_used+0x26>
    120e:	be 20 00 00 00       	mov    $0x20,%esi
    1213:	48 89 df             	mov    %rbx,%rdi
    1216:	b8 01 00 00 00       	mov    $0x1,%eax
    121b:	e8 a0 fe ff ff       	callq  10c0 <strfmon@plt>
    1220:	48 89 df             	mov    %rbx,%rdi
    1223:	e8 68 fe ff ff       	callq  1090 <puts@plt>
    1228:	48 8b 05 29 0e 00 00 	mov    0xe29(%rip),%rax        # 2058 <_IO_stdin_used+0x58>
    122f:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1234:	48 8d 15 04 0e 00 00 	lea    0xe04(%rip),%rdx        # 203f <_IO_stdin_used+0x3f>
    123b:	be 20 00 00 00       	mov    $0x20,%esi
    1240:	48 89 df             	mov    %rbx,%rdi
    1243:	b8 01 00 00 00       	mov    $0x1,%eax
    1248:	e8 73 fe ff ff       	callq  10c0 <strfmon@plt>
    124d:	48 89 df             	mov    %rbx,%rdi
    1250:	e8 3b fe ff ff       	callq  1090 <puts@plt>
    1255:	b8 00 00 00 00       	mov    $0x0,%eax
    125a:	48 8b 4c 24 28       	mov    0x28(%rsp),%rcx
    125f:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1266:	00 00 
    1268:	75 2a                	jne    1294 <main+0xcb>
    126a:	48 83 c4 30          	add    $0x30,%rsp
    126e:	5b                   	pop    %rbx
    126f:	c3                   	retq   
    1270:	48 8b 0d a9 2d 00 00 	mov    0x2da9(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1277:	ba 15 00 00 00       	mov    $0x15,%edx
    127c:	be 01 00 00 00       	mov    $0x1,%esi
    1281:	48 8d 3d 88 0d 00 00 	lea    0xd88(%rip),%rdi        # 2010 <_IO_stdin_used+0x10>
    1288:	e8 43 fe ff ff       	callq  10d0 <fwrite@plt>
    128d:	b8 01 00 00 00       	mov    $0x1,%eax
    1292:	eb c6                	jmp    125a <main+0x91>
    1294:	e8 07 fe ff ff       	callq  10a0 <__stack_chk_fail@plt>
