...
/app/bin_gccgcc10_O2/2020_09_12-Lesson-c:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10b2:	48 81 ec 90 00 00 00 	sub    $0x90,%rsp
    ...
    10d4:	4c 89 e6             	mov    %r12,%rsi
    10d7:	48 8d 3d 2d 0f 00 00 	lea    0xf2d(%rip),%rdi        # 200b <_IO_stdin_used+0xb>
    ...
    10ef:	48 8d 35 1b 0f 00 00 	lea    0xf1b(%rip),%rsi        # 2011 <_IO_stdin_used+0x11>
    10f6:	e8 85 ff ff ff       	callq  1080 <__printf_chk@plt>
    10fb:	48 8b 84 24 88 00 00 	mov    0x88(%rsp),%rax
    1102:	00 
    1103:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    110a:	00 00 
    110c:	75 0c                	jne    111a <main+0x7a>
    110e:	48 81 c4 90 00 00 00 	add    $0x90,%rsp
