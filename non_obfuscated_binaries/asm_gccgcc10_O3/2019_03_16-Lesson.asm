...
/app/bin_gccgcc10_O3/2019_03_16-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1094:	48 89 c3             	mov    %rax,%rbx
    1097:	40 84 ff             	test   %dil,%dil
    109a:	74 28                	je     10c4 <main+0x44>
    109c:	0f 1f 40 00          	nopl   0x0(%rax)
    10a0:	48 8b 35 69 2f 00 00 	mov    0x2f69(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10a7:	40 80 ff 3a          	cmp    $0x3a,%dil
    10ab:	75 05                	jne    10b2 <main+0x32>
    10ad:	bf 0a 00 00 00       	mov    $0xa,%edi
    10b2:	e8 b9 ff ff ff       	callq  1070 <putc@plt>
    10b7:	0f be 7b 01          	movsbl 0x1(%rbx),%edi
    10bb:	48 83 c3 01          	add    $0x1,%rbx
    10bf:	40 84 ff             	test   %dil,%dil
    10c2:	75 dc                	jne    10a0 <main+0x20>
    10c4:	48 8b 35 45 2f 00 00 	mov    0x2f45(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10cb:	bf 0a 00 00 00       	mov    $0xa,%edi
    10d0:	e8 9b ff ff ff       	callq  1070 <putc@plt>
