...
/app/bin_gccgcc10_O3/byte_values01:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1067:	48 8d 35 96 0f 00 00 	lea    0xf96(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    106e:	bf 01 00 00 00       	mov    $0x1,%edi
    1073:	53                   	push   %rbx
    1074:	31 c0                	xor    %eax,%eax
    1076:	31 db                	xor    %ebx,%ebx
    1078:	48 8d 2d 85 0f 00 00 	lea    0xf85(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    107f:	48 83 ec 08          	sub    $0x8,%rsp
    1083:	e8 c8 ff ff ff       	callq  1050 <__printf_chk@plt>
    1088:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    108f:	00 
    1090:	83 c3 01             	add    $0x1,%ebx
    1093:	31 c0                	xor    %eax,%eax
    1095:	48 89 ee             	mov    %rbp,%rsi
    1098:	bf 01 00 00 00       	mov    $0x1,%edi
    109d:	0f b6 d3             	movzbl %bl,%edx
    10a0:	e8 ab ff ff ff       	callq  1050 <__printf_chk@plt>
    10a5:	80 fb ff             	cmp    $0xff,%bl
    10a8:	75 e6                	jne    1090 <main+0x30>
    10aa:	48 83 c4 08          	add    $0x8,%rsp
