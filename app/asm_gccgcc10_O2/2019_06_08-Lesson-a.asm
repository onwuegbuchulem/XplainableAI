...
/app/bin_gccgcc10_O2/2019_06_08-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	53                   	push   %rbx
    1085:	bf 4f 00 00 00       	mov    $0x4f,%edi
    108a:	48 83 ec 30          	sub    $0x30,%rsp
    ...
    10a6:	b8 2e 0a 00 00       	mov    $0xa2e,%eax
    10ab:	c7 44 24 20 6c 64 2e 	movl   $0x2e2e646c,0x20(%rsp)
    10b2:	2e 
    10b3:	48 8d 5c 24 01       	lea    0x1(%rsp),%rbx
    10b8:	0f 11 04 24          	movups %xmm0,(%rsp)
    10bc:	66 0f 6f 05 5c 0f 00 	movdqa 0xf5c(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10c3:	00 
    10c4:	66 89 44 24 24       	mov    %ax,0x24(%rsp)
    10c9:	c6 44 24 26 00       	movb   $0x0,0x26(%rsp)
    ...
    10df:	48 83 c3 01          	add    $0x1,%rbx
    10e3:	e8 88 ff ff ff       	callq  1070 <putc@plt>
    10e8:	0f be 7b ff          	movsbl -0x1(%rbx),%edi
    10ec:	40 84 ff             	test   %dil,%dil
    10ef:	75 e7                	jne    10d8 <main+0x58>
    10f1:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    10f6:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10fd:	00 00 
    10ff:	75 08                	jne    1109 <main+0x89>
    1101:	48 83 c4 30          	add    $0x30,%rsp
    1105:	31 c0                	xor    %eax,%eax
    1107:	5b                   	pop    %rbx
    1108:	c3                   	retq   
    1109:	e8 52 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
