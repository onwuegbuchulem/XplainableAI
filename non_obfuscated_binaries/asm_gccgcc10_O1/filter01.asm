...
/app/bin_gccgcc10_O1/filter01:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1171:	eb 0c                	jmp    117f <main+0x16>
    1173:	48 8b 35 96 2e 00 00 	mov    0x2e96(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    117a:	e8 e1 fe ff ff       	callq  1060 <putc@plt>
    117f:	48 8b 3d 9a 2e 00 00 	mov    0x2e9a(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    1186:	e8 e5 fe ff ff       	callq  1070 <getc@plt>
    118b:	89 c7                	mov    %eax,%edi
    118d:	83 f8 ff             	cmp    $0xffffffff,%eax
    1190:	75 e1                	jne    1173 <main+0xa>
