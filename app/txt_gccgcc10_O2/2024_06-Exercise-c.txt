...
/app/bin_gccgcc10_O2/2024_06-Exercise-c:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10d1:	53                   	push   %rbx
    10d2:	48 83 ec 38          	sub    $0x38,%rsp
    10d6:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10dd:	00 00 
    10df:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    10e4:	31 c0                	xor    %eax,%eax
    10e6:	48 8d 6c 24 10       	lea    0x10(%rsp),%rbp
    10eb:	e8 c0 ff ff ff       	callq  10b0 <__printf_chk@plt>
    10f0:	48 8b 15 19 2f 00 00 	mov    0x2f19(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    10f7:	be 10 00 00 00       	mov    $0x10,%esi
    10fc:	48 89 ef             	mov    %rbp,%rdi
    10ff:	e8 8c ff ff ff       	callq  1090 <fgets@plt>
    1104:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    1109:	ba 0a 00 00 00       	mov    $0xa,%edx
    110e:	48 89 ef             	mov    %rbp,%rdi
    1111:	e8 8a ff ff ff       	callq  10a0 <strtol@plt>
    1116:	48 8b 7c 24 08       	mov    0x8(%rsp),%rdi
    111b:	31 f6                	xor    %esi,%esi
    111d:	ba 0a 00 00 00       	mov    $0xa,%edx
    1122:	48 89 c3             	mov    %rax,%rbx
    1125:	e8 76 ff ff ff       	callq  10a0 <strtol@plt>
    112a:	89 da                	mov    %ebx,%edx
    ...
    113b:	44 8d 04 18          	lea    (%rax,%rbx,1),%r8d
    113f:	31 c0                	xor    %eax,%eax
    1141:	e8 6a ff ff ff       	callq  10b0 <__printf_chk@plt>
    1146:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    114b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1152:	00 00 
    1154:	75 09                	jne    115f <main+0x9f>
    1156:	48 83 c4 38          	add    $0x38,%rsp
