...
/app/bin_gccgcc10_O2/2019_11_16-Lesson-a:     file format elf64-x86-64
...
0000000000001120 <main>:
    ...
    114d:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    1152:	48 b8 47 65 6f 72 67 	movabs $0x6567726f6547,%rax
    1159:	65 00 00 
    115c:	c7 04 24 22 00 00 00 	movl   $0x22,(%rsp)
    1163:	48 89 44 24 04       	mov    %rax,0x4(%rsp)
    1168:	31 c0                	xor    %eax,%eax
    116a:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%rsp)
    1171:	00 
    1172:	e8 79 ff ff ff       	callq  10f0 <__printf_chk@plt>
    1177:	bf 10 00 00 00       	mov    $0x10,%edi
    117c:	e8 5f ff ff ff       	callq  10e0 <malloc@plt>
    1181:	48 85 c0             	test   %rax,%rax
    1184:	74 71                	je     11f7 <main+0xd7>
    1186:	66 0f 6f 04 24       	movdqa (%rsp),%xmm0
    118b:	48 89 c3             	mov    %rax,%rbx
    118e:	48 8d 3d 9e 0e 00 00 	lea    0xe9e(%rip),%rdi        # 2033 <_IO_stdin_used+0x33>
    1195:	48 8d 2d a4 0e 00 00 	lea    0xea4(%rip),%rbp        # 2040 <_IO_stdin_used+0x40>
    119c:	4c 8d 63 10          	lea    0x10(%rbx),%r12
    11a0:	0f 11 00             	movups %xmm0,(%rax)
    11a3:	e8 08 ff ff ff       	callq  10b0 <puts@plt>
    11a8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    11af:	00 
    11b0:	0f b6 13             	movzbl (%rbx),%edx
    11b3:	48 89 ee             	mov    %rbp,%rsi
    11b6:	bf 01 00 00 00       	mov    $0x1,%edi
    11bb:	31 c0                	xor    %eax,%eax
    11bd:	48 83 c3 01          	add    $0x1,%rbx
    11c1:	e8 2a ff ff ff       	callq  10f0 <__printf_chk@plt>
    11c6:	4c 39 e3             	cmp    %r12,%rbx
    11c9:	75 e5                	jne    11b0 <main+0x90>
    ...
    11dc:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11e1:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11e8:	00 00 
    11ea:	75 32                	jne    121e <main+0xfe>
    ...
    11f4:	41 5c                	pop    %r12
    11f6:	c3                   	retq   
    11f7:	48 8b 0d 42 2e 00 00 	mov    0x2e42(%rip),%rcx        # 4040 <stderr@@GLIBC_2.2.5>
    11fe:	ba 1a 00 00 00       	mov    $0x1a,%edx
    1203:	be 01 00 00 00       	mov    $0x1,%esi
    1208:	48 8d 3d 09 0e 00 00 	lea    0xe09(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    120f:	e8 fc fe ff ff       	callq  1110 <fwrite@plt>
    1214:	bf 01 00 00 00       	mov    $0x1,%edi
    1219:	e8 e2 fe ff ff       	callq  1100 <exit@plt>
