...
/app/bin_gccgcc10_O0/04_pointer_arithmetic:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c6 45 ef 41          	movb   $0x41,-0x11(%rbp)
    1188:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    118c:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    1190:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    ...
    11a3:	e8 c8 fe ff ff       	callq  1070 <printf@plt>
    11a8:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    11ac:	48 89 c6             	mov    %rax,%rsi
    11af:	48 8d 3d 4e 0e 00 00 	lea    0xe4e(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11b6:	b8 00 00 00 00       	mov    $0x0,%eax
    11bb:	e8 b0 fe ff ff       	callq  1070 <printf@plt>
    11c0:	48 83 45 f0 01       	addq   $0x1,-0x10(%rbp)
