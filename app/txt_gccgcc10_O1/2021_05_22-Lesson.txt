...
/app/bin_gccgcc10_O1/2021_05_22-Lesson:     file format elf64-x86-64
...
0000000000001080 <malloc@plt>:
    ...
    1084:	f2 ff 25 2d 2f 00 00 	bnd jmpq *0x2f2d(%rip)        # 3fb8 <malloc@GLIBC_2.2.5>
...
00000000000011a9 <main>:
    ...
    11b1:	bf 0c 00 00 00       	mov    $0xc,%edi
    11b6:	e8 c5 fe ff ff       	callq  1080 <malloc@plt>
    11bb:	48 85 c0             	test   %rax,%rax
    11be:	74 44                	je     1204 <main+0x5b>
    11c0:	c7 00 01 00 00 00    	movl   $0x1,(%rax)
    11c6:	c7 40 04 02 00 00 00 	movl   $0x2,0x4(%rax)
    11cd:	c7 40 08 03 00 00 00 	movl   $0x3,0x8(%rax)
    11d4:	41 b8 03 00 00 00    	mov    $0x3,%r8d
    11da:	b9 02 00 00 00       	mov    $0x2,%ecx
    11df:	ba 01 00 00 00       	mov    $0x1,%edx
    11e4:	48 8d 35 32 0e 00 00 	lea    0xe32(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    ...
    1226:	e8 75 fe ff ff       	callq  10a0 <exit@plt>
