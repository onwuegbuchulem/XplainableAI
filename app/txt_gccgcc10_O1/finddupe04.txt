...
/app/bin_gccgcc10_O1/finddupe04:     file format elf64-x86-64
...
0000000000001240 <_start>:
    ...
    1251:	50                   	push   %rax
    1252:	54                   	push   %rsp
    1253:	4c 8d 05 b6 05 00 00 	lea    0x5b6(%rip),%r8        # 1810 <__libc_csu_fini>
    125a:	48 8d 0d 3f 05 00 00 	lea    0x53f(%rip),%rcx        # 17a0 <__libc_csu_init>
...
0000000000001544 <main>:
    ...
    16a4:	75 5b                	jne    1701 <main+0x1bd>
    ...
    16f2:	eb c8                	jmp    16bc <main+0x178>
    16f4:	4d 8b a4 24 08 30 00 	mov    0x3008(%r12),%r12
    16fb:	00 
    16fc:	4d 85 e4             	test   %r12,%r12
    16ff:	74 65                	je     1766 <main+0x222>
    1701:	41 83 3c 24 00       	cmpl   $0x0,(%r12)
    1706:	7e ec                	jle    16f4 <main+0x1b0>
    1708:	41 8b 54 24 04       	mov    0x4(%r12),%edx
    170d:	83 fa 01             	cmp    $0x1,%edx
    1710:	7e e2                	jle    16f4 <main+0x1b0>
    1712:	4d 8d 6c 24 08       	lea    0x8(%r12),%r13
    1717:	4c 89 e9             	mov    %r13,%rcx
    171a:	4c 89 f6             	mov    %r14,%rsi
    171d:	bf 01 00 00 00       	mov    $0x1,%edi
    1722:	b8 00 00 00 00       	mov    $0x0,%eax
    1727:	e8 d4 fa ff ff       	callq  1200 <__printf_chk@plt>
    172c:	49 8d 94 24 08 20 00 	lea    0x2008(%r12),%rdx
    1733:	00 
    1734:	4c 89 e9             	mov    %r13,%rcx
    1737:	48 8d 35 dd 09 00 00 	lea    0x9dd(%rip),%rsi        # 211b <_IO_stdin_used+0x11b>
    173e:	bf 01 00 00 00       	mov    $0x1,%edi
    1743:	b8 00 00 00 00       	mov    $0x0,%eax
    1748:	e8 b3 fa ff ff       	callq  1200 <__printf_chk@plt>
    174d:	49 8b 9c 24 08 30 00 	mov    0x3008(%r12),%rbx
    1754:	00 
    1755:	48 85 db             	test   %rbx,%rbx
    1758:	74 36                	je     1790 <main+0x24c>
    175a:	4c 8d 3d ba 09 00 00 	lea    0x9ba(%rip),%r15        # 211b <_IO_stdin_used+0x11b>
    1761:	e9 62 ff ff ff       	jmpq   16c8 <main+0x184>
    1766:	b8 00 00 00 00       	mov    $0x0,%eax
    176b:	48 8b 8c 24 18 10 00 	mov    0x1018(%rsp),%rcx
    1772:	00 
    1773:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    177a:	00 00 
    177c:	75 19                	jne    1797 <main+0x253>
    177e:	48 81 c4 28 10 00 00 	add    $0x1028,%rsp
    1785:	5b                   	pop    %rbx
    1786:	5d                   	pop    %rbp
    1787:	41 5c                	pop    %r12
    1789:	41 5d                	pop    %r13
    ...
    1795:	eb d4                	jmp    176b <main+0x227>
...
00000000000017a0 <__libc_csu_init>:
    ...
    17a4:	41 57                	push   %r15
    17a6:	4c 8d 3d 93 25 00 00 	lea    0x2593(%rip),%r15        # 3d40 <__frame_dummy_init_array_entry>
    17ad:	41 56                	push   %r14
    ...
    17bc:	55                   	push   %rbp
    17bd:	48 8d 2d 84 25 00 00 	lea    0x2584(%rip),%rbp        # 3d48 <__do_global_dtors_aux_fini_array_entry>
    17c4:	53                   	push   %rbx
