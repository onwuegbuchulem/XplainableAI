...
/app/bin_gccgcc10_O0/2019_08_17-Lesson-a:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    1208:	48 be 42 69 6c 6c 79 	movabs $0x6c5a20796c6c6942,%rsi
    120f:	20 5a 6c 
    1212:	48 89 30             	mov    %rsi,(%rax)
    1215:	c7 40 08 6f 74 6e 69 	movl   $0x696e746f,0x8(%rax)
    121c:	66 c7 40 0c 63 6b    	movw   $0x6b63,0xc(%rax)
    1222:	c6 40 0e 00          	movb   $0x0,0xe(%rax)
    ...
    1237:	c7 45 ac 00 00 00 00 	movl   $0x0,-0x54(%rbp)
    123e:	eb 35                	jmp    1275 <main+0x8c>
    1240:	e8 ab fe ff ff       	callq  10f0 <rand@plt>
    1245:	48 63 d0             	movslq %eax,%rdx
    1248:	48 69 d2 1f 85 eb 51 	imul   $0x51eb851f,%rdx,%rdx
    124f:	48 c1 ea 20          	shr    $0x20,%rdx
    1253:	c1 fa 05             	sar    $0x5,%edx
    1256:	89 c1                	mov    %eax,%ecx
    1258:	c1 f9 1f             	sar    $0x1f,%ecx
    125b:	29 ca                	sub    %ecx,%edx
    125d:	6b ca 64             	imul   $0x64,%edx,%ecx
    1260:	29 c8                	sub    %ecx,%eax
    1262:	89 c2                	mov    %eax,%edx
    1264:	8b 45 ac             	mov    -0x54(%rbp),%eax
    1267:	48 98                	cltq   
    1269:	48 83 c0 08          	add    $0x8,%rax
    126d:	89 54 85 b0          	mov    %edx,-0x50(%rbp,%rax,4)
    1271:	83 45 ac 01          	addl   $0x1,-0x54(%rbp)
    1275:	83 7d ac 09          	cmpl   $0x9,-0x54(%rbp)
    1279:	7e c5                	jle    1240 <main+0x57>
    127b:	48 8d 45 b0          	lea    -0x50(%rbp),%rax
    ...
    1293:	c7 45 ac 00 00 00 00 	movl   $0x0,-0x54(%rbp)
    129a:	eb 24                	jmp    12c0 <main+0xd7>
    129c:	8b 45 ac             	mov    -0x54(%rbp),%eax
    129f:	48 98                	cltq   
    12a1:	48 83 c0 08          	add    $0x8,%rax
    12a5:	8b 44 85 b0          	mov    -0x50(%rbp,%rax,4),%eax
    12a9:	89 c6                	mov    %eax,%esi
    12ab:	48 8d 3d 60 0d 00 00 	lea    0xd60(%rip),%rdi        # 2012 <_IO_stdin_used+0x12>
    12b2:	b8 00 00 00 00       	mov    $0x0,%eax
    12b7:	e8 04 fe ff ff       	callq  10c0 <printf@plt>
    12bc:	83 45 ac 01          	addl   $0x1,-0x54(%rbp)
    12c0:	83 7d ac 09          	cmpl   $0x9,-0x54(%rbp)
    12c4:	7e d6                	jle    129c <main+0xb3>
    12c6:	bf 0a 00 00 00       	mov    $0xa,%edi
    12cb:	e8 d0 fd ff ff       	callq  10a0 <putchar@plt>
    12d0:	b8 00 00 00 00       	mov    $0x0,%eax
    12d5:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    12d9:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    12e0:	00 00 
    12e2:	74 05                	je     12e9 <main+0x100>
    12e4:	e8 c7 fd ff ff       	callq  10b0 <__stack_chk_fail@plt>
    12e9:	c9                   	leaveq 
    12ea:	c3                   	retq   
