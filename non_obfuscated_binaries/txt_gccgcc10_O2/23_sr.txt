...
/app/bin_gccgcc10_O2/23_sr:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ee:	f2 0f 10 0d 42 0f 00 	movsd  0xf42(%rip),%xmm1        # 2038 <_IO_stdin_used+0x38>
    10f5:	00 
    10f6:	66 0f 28 c2          	movapd %xmm2,%xmm0
    10fa:	b8 07 00 00 00       	mov    $0x7,%eax
    10ff:	f2 0f 10 1d 39 0f 00 	movsd  0xf39(%rip),%xmm3        # 2040 <_IO_stdin_used+0x40>
    1106:	00 
    ...
    1125:	66 0f 28 c1          	movapd %xmm1,%xmm0
    1129:	bf 01 00 00 00       	mov    $0x1,%edi
    112e:	b8 01 00 00 00       	mov    $0x1,%eax
    1133:	48 8d 35 e7 0e 00 00 	lea    0xee7(%rip),%rsi        # 2021 <_IO_stdin_used+0x21>
...
0000000000001250 <babylonian>:
    1250:	f3 0f 1e fa          	endbr64 
    1254:	f2 0f 10 0d dc 0d 00 	movsd  0xddc(%rip),%xmm1        # 2038 <_IO_stdin_used+0x38>
    125b:	00 
    125c:	66 0f 28 d0          	movapd %xmm0,%xmm2
    1260:	b8 07 00 00 00       	mov    $0x7,%eax
    1265:	f2 0f 10 1d d3 0d 00 	movsd  0xdd3(%rip),%xmm3        # 2040 <_IO_stdin_used+0x40>
    126c:	00 
    ...
    1283:	75 eb                	jne    1270 <babylonian+0x20>
