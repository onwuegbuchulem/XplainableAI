...
/app/bin_gccgcc10_O1/2024_09_14-Lesson:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11ef:	e8 cc fe ff ff       	callq  10c0 <__printf_chk@plt>
    11f4:	48 8d 74 24 0c       	lea    0xc(%rsp),%rsi
    11f9:	48 8d 3d 0c 0e 00 00 	lea    0xe0c(%rip),%rdi        # 200c <_IO_stdin_used+0xc>
    1200:	b8 00 00 00 00       	mov    $0x0,%eax
    1205:	e8 c6 fe ff ff       	callq  10d0 <__isoc99_scanf@plt>
    120a:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
    120f:	44 8b 4c 24 0c       	mov    0xc(%rsp),%r9d
    1214:	4c 8d 05 f1 0d 00 00 	lea    0xdf1(%rip),%r8        # 200c <_IO_stdin_used+0xc>
    121b:	b9 20 00 00 00       	mov    $0x20,%ecx
    1220:	ba 01 00 00 00       	mov    $0x1,%edx
    1225:	be 20 00 00 00       	mov    $0x20,%esi
    122a:	b8 00 00 00 00       	mov    $0x0,%eax
    122f:	e8 5c fe ff ff       	callq  1090 <__snprintf_chk@plt>
    1234:	0f b6 4c 24 10       	movzbl 0x10(%rsp),%ecx
    1239:	48 8d 5c 24 10       	lea    0x10(%rsp),%rbx
    123e:	bd 01 00 00 00       	mov    $0x1,%ebp
    1243:	84 c9                	test   %cl,%cl
    1245:	75 58                	jne    129f <main+0xd6>
    1247:	48 8b 35 c2 2d 00 00 	mov    0x2dc2(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    124e:	bf 0a 00 00 00       	mov    $0xa,%edi
    1253:	e8 58 fe ff ff       	callq  10b0 <putc@plt>
    1258:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    125d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1264:	00 00 
    1266:	75 49                	jne    12b1 <main+0xe8>
    1268:	b8 00 00 00 00       	mov    $0x0,%eax
    126d:	48 83 c4 48          	add    $0x48,%rsp
    1271:	5b                   	pop    %rbx
    1272:	5d                   	pop    %rbp
    1273:	c3                   	retq   
    1274:	8d 14 06             	lea    (%rsi,%rax,1),%edx
    1277:	48 83 c0 01          	add    $0x1,%rax
    127b:	38 08                	cmp    %cl,(%rax)
    127d:	74 f5                	je     1274 <main+0xab>
    127f:	48 89 c3             	mov    %rax,%rbx
    1282:	0f be c9             	movsbl %cl,%ecx
    1285:	48 8d 35 83 0d 00 00 	lea    0xd83(%rip),%rsi        # 200f <_IO_stdin_used+0xf>
    128c:	89 ef                	mov    %ebp,%edi
    128e:	b8 00 00 00 00       	mov    $0x0,%eax
    1293:	e8 28 fe ff ff       	callq  10c0 <__printf_chk@plt>
    1298:	0f b6 0b             	movzbl (%rbx),%ecx
    129b:	84 c9                	test   %cl,%cl
    129d:	74 a8                	je     1247 <main+0x7e>
    129f:	48 89 d8             	mov    %rbx,%rax
    12a2:	89 ee                	mov    %ebp,%esi
    12a4:	29 de                	sub    %ebx,%esi
    12a6:	ba 00 00 00 00       	mov    $0x0,%edx
    12ab:	38 0b                	cmp    %cl,(%rbx)
    12ad:	74 c5                	je     1274 <main+0xab>
    12af:	eb d1                	jmp    1282 <main+0xb9>
    12b1:	e8 ea fd ff ff       	callq  10a0 <__stack_chk_fail@plt>
