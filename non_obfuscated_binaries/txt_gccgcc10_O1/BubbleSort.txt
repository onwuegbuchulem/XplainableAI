...
/app/bin_gccgcc10_O1/BubbleSort:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11bf:	00 00 
    11c1:	48 89 84 24 a8 01 00 	mov    %rax,0x1a8(%rsp)
    11c8:	00 
    ...
    11d7:	48 8d 74 24 0c       	lea    0xc(%rsp),%rsi
    ...
    11ed:	8b 54 24 0c          	mov    0xc(%rsp),%edx
    11f1:	48 8d 35 28 0e 00 00 	lea    0xe28(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    11f8:	bf 01 00 00 00       	mov    $0x1,%edi
    11fd:	b8 00 00 00 00       	mov    $0x0,%eax
    1202:	e8 99 fe ff ff       	callq  10a0 <__printf_chk@plt>
    1207:	8b 44 24 0c          	mov    0xc(%rsp),%eax
    120b:	85 c0                	test   %eax,%eax
    120d:	7e 30                	jle    123f <main+0x96>
    120f:	48 8d 6c 24 10       	lea    0x10(%rsp),%rbp
    1214:	bb 00 00 00 00       	mov    $0x0,%ebx
    1219:	4c 8d 25 fd 0d 00 00 	lea    0xdfd(%rip),%r12        # 201d <_IO_stdin_used+0x1d>
    ...
    1230:	83 c3 01             	add    $0x1,%ebx
    1233:	8b 44 24 0c          	mov    0xc(%rsp),%eax
    1237:	48 83 c5 04          	add    $0x4,%rbp
    123b:	39 d8                	cmp    %ebx,%eax
    123d:	7f e1                	jg     1220 <main+0x77>
    123f:	8d 78 ff             	lea    -0x1(%rax),%edi
    1242:	85 ff                	test   %edi,%edi
    1244:	7e 37                	jle    127d <main+0xd4>
    1246:	4c 8d 44 24 14       	lea    0x14(%rsp),%r8
    124b:	eb 1e                	jmp    126b <main+0xc2>
    124d:	48 83 c0 04          	add    $0x4,%rax
    1251:	48 39 f0             	cmp    %rsi,%rax
    1254:	74 10                	je     1266 <main+0xbd>
    1256:	8b 10                	mov    (%rax),%edx
    1258:	8b 48 04             	mov    0x4(%rax),%ecx
    125b:	39 ca                	cmp    %ecx,%edx
    125d:	7e ee                	jle    124d <main+0xa4>
    125f:	89 08                	mov    %ecx,(%rax)
    1261:	89 50 04             	mov    %edx,0x4(%rax)
    1264:	eb e7                	jmp    124d <main+0xa4>
    1266:	83 ef 01             	sub    $0x1,%edi
    1269:	74 12                	je     127d <main+0xd4>
    126b:	85 ff                	test   %edi,%edi
    126d:	7e f7                	jle    1266 <main+0xbd>
    126f:	48 8d 44 24 10       	lea    0x10(%rsp),%rax
    1274:	8d 57 ff             	lea    -0x1(%rdi),%edx
    1277:	49 8d 34 90          	lea    (%r8,%rdx,4),%rsi
    127b:	eb d9                	jmp    1256 <main+0xad>
    127d:	48 8d 3d b4 0d 00 00 	lea    0xdb4(%rip),%rdi        # 2038 <_IO_stdin_used+0x38>
    1284:	e8 f7 fd ff ff       	callq  1080 <puts@plt>
    1289:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
    128e:	7e 2c                	jle    12bc <main+0x113>
    1290:	bb 00 00 00 00       	mov    $0x0,%ebx
    1295:	48 8d 2d 97 0d 00 00 	lea    0xd97(%rip),%rbp        # 2033 <_IO_stdin_used+0x33>
    129c:	8b 54 9c 10          	mov    0x10(%rsp,%rbx,4),%edx
    ...
    12b6:	39 5c 24 0c          	cmp    %ebx,0xc(%rsp)
    12ba:	7f e0                	jg     129c <main+0xf3>
    12bc:	48 8b 84 24 a8 01 00 	mov    0x1a8(%rsp),%rax
    12c3:	00 
    12c4:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12cb:	00 00 
    12cd:	75 11                	jne    12e0 <main+0x137>
    12cf:	b8 00 00 00 00       	mov    $0x0,%eax
    12d4:	48 81 c4 b0 01 00 00 	add    $0x1b0,%rsp
    12db:	5b                   	pop    %rbx
    12dc:	5d                   	pop    %rbp
    12dd:	41 5c                	pop    %r12
    12df:	c3                   	retq   
