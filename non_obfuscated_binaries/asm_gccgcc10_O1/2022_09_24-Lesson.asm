...
/app/bin_gccgcc10_O1/2022_09_24-Lesson:     file format elf64-x86-64
...
00000000000011a9 <strrev>:
    ...
    11af:	55                   	push   %rbp
    11b0:	53                   	push   %rbx
    11b1:	48 89 fd             	mov    %rdi,%rbp
    11b4:	e8 c7 fe ff ff       	callq  1080 <strlen@plt>
    11b9:	48 89 c3             	mov    %rax,%rbx
    11bc:	4c 63 e0             	movslq %eax,%r12
    11bf:	49 8d 7c 24 01       	lea    0x1(%r12),%rdi
    11c4:	e8 d7 fe ff ff       	callq  10a0 <malloc@plt>
    11c9:	48 89 c7             	mov    %rax,%rdi
    11cc:	48 85 c0             	test   %rax,%rax
    11cf:	74 2e                	je     11ff <strrev+0x56>
    11d1:	4a 8d 44 25 ff       	lea    -0x1(%rbp,%r12,1),%rax
    11d6:	85 db                	test   %ebx,%ebx
    11d8:	74 1e                	je     11f8 <strrev+0x4f>
    11da:	48 89 fa             	mov    %rdi,%rdx
    11dd:	8d 73 ff             	lea    -0x1(%rbx),%esi
    11e0:	48 f7 d6             	not    %rsi
    11e3:	48 01 c6             	add    %rax,%rsi
    11e6:	0f b6 08             	movzbl (%rax),%ecx
    11e9:	88 0a                	mov    %cl,(%rdx)
    11eb:	48 83 e8 01          	sub    $0x1,%rax
    11ef:	48 83 c2 01          	add    $0x1,%rdx
    11f3:	48 39 f0             	cmp    %rsi,%rax
    11f6:	75 ee                	jne    11e6 <strrev+0x3d>
    11f8:	48 63 db             	movslq %ebx,%rbx
    11fb:	c6 04 1f 00          	movb   $0x0,(%rdi,%rbx,1)
    11ff:	48 89 f8             	mov    %rdi,%rax
    1202:	5b                   	pop    %rbx
    1203:	5d                   	pop    %rbp
    1204:	41 5c                	pop    %r12
    1206:	c3                   	retq   
...
0000000000001207 <main>:
    ...
    120b:	53                   	push   %rbx
    120c:	48 83 ec 30          	sub    $0x30,%rsp
    1210:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1217:	00 00 
    1219:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    121e:	31 c0                	xor    %eax,%eax
    1220:	48 b8 48 65 72 65 20 	movabs $0x2073692065726548,%rax
    1227:	69 73 20 
    122a:	48 ba 79 6f 75 72 20 	movabs $0x6d61732072756f79,%rdx
    1231:	73 61 6d 
    1234:	48 89 04 24          	mov    %rax,(%rsp)
    1238:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    123d:	48 b8 70 6c 65 20 73 	movabs $0x6972747320656c70,%rax
    1244:	74 72 69 
    1247:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    124c:	66 c7 44 24 18 6e 67 	movw   $0x676e,0x18(%rsp)
    1253:	c6 44 24 1a 00       	movb   $0x0,0x1a(%rsp)
    1258:	48 89 e3             	mov    %rsp,%rbx
    125b:	48 89 da             	mov    %rbx,%rdx
    ...
    126f:	e8 3c fe ff ff       	callq  10b0 <__printf_chk@plt>
    1274:	48 89 df             	mov    %rbx,%rdi
    1277:	e8 2d ff ff ff       	callq  11a9 <strrev>
    127c:	48 89 c2             	mov    %rax,%rdx
    127f:	48 8d 35 8c 0d 00 00 	lea    0xd8c(%rip),%rsi        # 2012 <_IO_stdin_used+0x12>
    1286:	bf 01 00 00 00       	mov    $0x1,%edi
    128b:	b8 00 00 00 00       	mov    $0x0,%eax
    1290:	e8 1b fe ff ff       	callq  10b0 <__printf_chk@plt>
    1295:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    129a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12a1:	00 00 
    12a3:	75 0b                	jne    12b0 <main+0xa9>
    12a5:	b8 00 00 00 00       	mov    $0x0,%eax
    12aa:	48 83 c4 30          	add    $0x30,%rsp
    12ae:	5b                   	pop    %rbx
    12af:	c3                   	retq   
