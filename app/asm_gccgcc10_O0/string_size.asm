...
/app/bin_gccgcc10_O0/string_size:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	48 b8 30 31 32 33 34 	movabs $0x3736353433323130,%rax
    11ab:	35 36 37 
    ...
    11c3:	e8 a8 fe ff ff       	callq  1070 <strlen@plt>
    11c8:	48 89 c2             	mov    %rax,%rdx
    11cb:	48 8d 45 ed          	lea    -0x13(%rbp),%rax
    ...
    11e3:	48 8d 45 ed          	lea    -0x13(%rbp),%rax
    11e7:	ba 0b 00 00 00       	mov    $0xb,%edx
    11ec:	48 89 c6             	mov    %rax,%rsi
    11ef:	48 8d 3d 32 0e 00 00 	lea    0xe32(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    11f6:	b8 00 00 00 00       	mov    $0x0,%eax
    11fb:	e8 90 fe ff ff       	callq  1090 <printf@plt>
    1200:	b8 00 00 00 00       	mov    $0x0,%eax
    1205:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1209:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1210:	00 00 
    1212:	74 05                	je     1219 <main+0x90>
    1214:	e8 67 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    1219:	c9                   	leaveq 
    121a:	c3                   	retq   
