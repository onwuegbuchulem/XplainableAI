...
/app/bin_gccgcc10_O0/2022_10_22-Lesson-b:     file format elf64-x86-64
...
00000000000010c0 <fgetc@plt>:
    ...
    10c4:	f2 ff 25 fd 2e 00 00 	bnd jmpq *0x2efd(%rip)        # 3fc8 <fgetc@GLIBC_2.2.5>
...
00000000000011c9 <main>:
    ...
    11f9:	c7 45 d8 0a 00 00 00 	movl   $0xa,-0x28(%rbp)
    1200:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    1204:	48 8d 35 f9 0d 00 00 	lea    0xdf9(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    120b:	48 89 c7             	mov    %rax,%rdi
    120e:	e8 bd fe ff ff       	callq  10d0 <fopen@plt>
    1213:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    1217:	48 83 7d e0 00       	cmpq   $0x0,-0x20(%rbp)
    121c:	74 46                	je     1264 <main+0x9b>
    121e:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%rbp)
    1225:	eb 29                	jmp    1250 <main+0x87>
    1227:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    122b:	48 89 c7             	mov    %rax,%rdi
    122e:	e8 8d fe ff ff       	callq  10c0 <fgetc@plt>
    1233:	89 45 dc             	mov    %eax,-0x24(%rbp)
    1236:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1239:	89 c6                	mov    %eax,%esi
    123b:	48 8d 3d c4 0d 00 00 	lea    0xdc4(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1242:	b8 00 00 00 00       	mov    $0x0,%eax
    1247:	e8 64 fe ff ff       	callq  10b0 <printf@plt>
    124c:	83 45 d4 01          	addl   $0x1,-0x2c(%rbp)
    1250:	8b 45 d4             	mov    -0x2c(%rbp),%eax
    1253:	3b 45 d8             	cmp    -0x28(%rbp),%eax
    1256:	7c cf                	jl     1227 <main+0x5e>
    1258:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    125c:	48 89 c7             	mov    %rax,%rdi
    125f:	e8 2c fe ff ff       	callq  1090 <fclose@plt>
    1264:	b8 00 00 00 00       	mov    $0x0,%eax
    1269:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    126d:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1274:	00 00 
    1276:	74 05                	je     127d <main+0xb4>
    1278:	e8 23 fe ff ff       	callq  10a0 <__stack_chk_fail@plt>
    127d:	c9                   	leaveq 
    127e:	c3                   	retq   
    127f:	90                   	nop
