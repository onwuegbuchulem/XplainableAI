...
/app/bin_gccgcc10_O1/mood:     file format elf64-x86-64
...
0000000000001070 <getwchar@plt>:
    1070:	f3 0f 1e fa          	endbr64 
    1074:	f2 ff 25 45 2f 00 00 	bnd jmpq *0x2f45(%rip)        # 3fc0 <getwchar@GLIBC_2.2.5>
...
00000000000010a0 <_start>:
    ...
    10b1:	50                   	push   %rax
    10b2:	54                   	push   %rsp
    10b3:	4c 8d 05 96 01 00 00 	lea    0x196(%rip),%r8        # 1250 <__libc_csu_fini>
    10ba:	48 8d 0d 1f 01 00 00 	lea    0x11f(%rip),%rcx        # 11e0 <__libc_csu_init>
...
0000000000001189 <main>:
    ...
    119d:	e8 de fe ff ff       	callq  1080 <setlocale@plt>
    11a2:	48 8d 35 67 0e 00 00 	lea    0xe67(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    11a9:	bf 01 00 00 00       	mov    $0x1,%edi
    11ae:	b8 00 00 00 00       	mov    $0x0,%eax
    11b3:	e8 d8 fe ff ff       	callq  1090 <__wprintf_chk@plt>
    11b8:	e8 b3 fe ff ff       	callq  1070 <getwchar@plt>
    11bd:	89 c2                	mov    %eax,%edx
    11bf:	48 8d 35 9a 0e 00 00 	lea    0xe9a(%rip),%rsi        # 2060 <_IO_stdin_used+0x60>
    11c6:	bf 01 00 00 00       	mov    $0x1,%edi
    11cb:	b8 00 00 00 00       	mov    $0x0,%eax
    11d0:	e8 bb fe ff ff       	callq  1090 <__wprintf_chk@plt>
    11d5:	b8 00 00 00 00       	mov    $0x0,%eax
    11da:	48 83 c4 08          	add    $0x8,%rsp
    11de:	c3                   	retq   
    11df:	90                   	nop
