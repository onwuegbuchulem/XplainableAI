...
/app/bin_gccgcc10_O0/SegmentationFaultorBusErrorDemo:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1164:	0f b6 40 02          	movzbl 0x2(%rax),%eax
    1168:	88 45 f7             	mov    %al,-0x9(%rbp)
    116b:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    116f:	48 8d 50 02          	lea    0x2(%rax),%rdx
    1173:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1177:	0f b6 40 01          	movzbl 0x1(%rax),%eax
    117b:	88 02                	mov    %al,(%rdx)
    117d:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1181:	48 8d 50 01          	lea    0x1(%rax),%rdx
    1185:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1189:	0f b6 00             	movzbl (%rax),%eax
    118c:	88 02                	mov    %al,(%rdx)
    118e:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1192:	0f b6 50 02          	movzbl 0x2(%rax),%edx
    1196:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    119a:	88 10                	mov    %dl,(%rax)
    119c:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11a0:	48 8d 50 02          	lea    0x2(%rax),%rdx
    11a4:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11a8:	0f b6 40 01          	movzbl 0x1(%rax),%eax
    11ac:	88 02                	mov    %al,(%rdx)
    11ae:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11b2:	48 8d 50 01          	lea    0x1(%rax),%rdx
    11b6:	0f b6 45 f7          	movzbl -0x9(%rbp),%eax
    11ba:	88 02                	mov    %al,(%rdx)
    11bc:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11c0:	48 89 c7             	mov    %rax,%rdi
    11c3:	e8 88 fe ff ff       	callq  1050 <puts@plt>
