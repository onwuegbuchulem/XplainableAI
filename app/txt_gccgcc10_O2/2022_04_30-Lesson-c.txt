...
/app/bin_gccgcc10_O2/2022_04_30-Lesson-c:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1096:	48 b8 41 42 43 44 45 	movabs $0x4847464544434241,%rax
    109d:	46 47 48 
    10a0:	48 89 e7             	mov    %rsp,%rdi
    10a3:	c6 44 24 0a 00       	movb   $0x0,0xa(%rsp)
    10a8:	48 89 04 24          	mov    %rax,(%rsp)
    10ac:	b8 49 4a 00 00       	mov    $0x4a49,%eax
    10b1:	66 89 44 24 08       	mov    %ax,0x8(%rsp)
    10b6:	e8 a5 ff ff ff       	callq  1060 <puts@plt>
    10bb:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10c0:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10c7:	00 00 
    10c9:	75 07                	jne    10d2 <main+0x52>
    10cb:	31 c0                	xor    %eax,%eax
    10cd:	48 83 c4 28          	add    $0x28,%rsp
    10d1:	c3                   	retq   
    10d2:	e8 99 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
