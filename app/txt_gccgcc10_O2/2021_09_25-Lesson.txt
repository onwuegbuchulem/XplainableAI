...
/app/bin_gccgcc10_O2/2021_09_25-Lesson:     file format elf64-x86-64
...
0000000000001090 <strerror@plt>:
    1090:	f3 0f 1e fa          	endbr64 
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <strerror@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10b1:	e8 ba ff ff ff       	callq  1070 <puts@plt>
    10b6:	83 3d f3 2c 00 00 01 	cmpl   $0x1,0x2cf3(%rip)        # 3db0 <sys_nerr@@GLIBC_2.12>
    10bd:	7e 37                	jle    10f6 <main+0x56>
    10bf:	bb 01 00 00 00       	mov    $0x1,%ebx
    10c4:	48 8d 2d 50 0f 00 00 	lea    0xf50(%rip),%rbp        # 201b <_IO_stdin_used+0x1b>
    10cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10d0:	89 df                	mov    %ebx,%edi
    10d2:	e8 b9 ff ff ff       	callq  1090 <strerror@plt>
    10d7:	89 da                	mov    %ebx,%edx
    10d9:	48 89 ee             	mov    %rbp,%rsi
    10dc:	bf 01 00 00 00       	mov    $0x1,%edi
    10e1:	48 89 c1             	mov    %rax,%rcx
    10e4:	31 c0                	xor    %eax,%eax
    10e6:	83 c3 01             	add    $0x1,%ebx
    10e9:	e8 92 ff ff ff       	callq  1080 <__printf_chk@plt>
    10ee:	39 1d bc 2c 00 00    	cmp    %ebx,0x2cbc(%rip)        # 3db0 <sys_nerr@@GLIBC_2.12>
    10f4:	7f da                	jg     10d0 <main+0x30>
    10f6:	48 83 c4 08          	add    $0x8,%rsp
...
00000000000011f0 <__libc_csu_init>:
    ...
    11f4:	41 57                	push   %r15
    11f6:	4c 8d 3d a3 2b 00 00 	lea    0x2ba3(%rip),%r15        # 3da0 <__frame_dummy_init_array_entry>
    11fd:	41 56                	push   %r14
    ...
    120c:	55                   	push   %rbp
    120d:	48 8d 2d 94 2b 00 00 	lea    0x2b94(%rip),%rbp        # 3da8 <__do_global_dtors_aux_fini_array_entry>
    1214:	53                   	push   %rbx
