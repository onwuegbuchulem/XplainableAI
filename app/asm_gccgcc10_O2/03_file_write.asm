...
/app/bin_gccgcc10_O2/03_file_write:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10b3:	e8 c8 ff ff ff       	callq  1080 <fopen@plt>
    10b8:	b9 b0 01 00 00       	mov    $0x1b0,%ecx
    10bd:	be 01 00 00 00       	mov    $0x1,%esi
    10c2:	48 8d 15 47 0f 00 00 	lea    0xf47(%rip),%rdx        # 2010 <_IO_stdin_used+0x10>
    10c9:	48 89 c5             	mov    %rax,%rbp
    10cc:	48 89 c7             	mov    %rax,%rdi
    10cf:	31 c0                	xor    %eax,%eax
    10d1:	e8 ba ff ff ff       	callq  1090 <__fprintf_chk@plt>
    10d6:	48 89 ef             	mov    %rbp,%rdi
    10d9:	e8 92 ff ff ff       	callq  1070 <fclose@plt>
