...
/app/bin_gccgcc10_O0/2019_07_13-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	48 b8 6e 6f 6e 73 65 	movabs $0x65736e65736e6f6e,%rax
    11ab:	6e 73 65 
    11ae:	48 89 45 ef          	mov    %rax,-0x11(%rbp)
    11b2:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    11b6:	48 8d 4d e0          	lea    -0x20(%rbp),%rcx
    11ba:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    11be:	ba 0a 00 00 00       	mov    $0xa,%edx
    11c3:	48 89 ce             	mov    %rcx,%rsi
    11c6:	48 89 c7             	mov    %rax,%rdi
    11c9:	e8 c2 fe ff ff       	callq  1090 <strtol@plt>
    11ce:	89 45 dc             	mov    %eax,-0x24(%rbp)
    11d1:	8b 55 dc             	mov    -0x24(%rbp),%edx
    11d4:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    11d8:	48 89 c6             	mov    %rax,%rsi
    11db:	48 8d 3d 26 0e 00 00 	lea    0xe26(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11e2:	b8 00 00 00 00       	mov    $0x0,%eax
    11e7:	e8 94 fe ff ff       	callq  1080 <printf@plt>
    11ec:	48 8b 55 e0          	mov    -0x20(%rbp),%rdx
    11f0:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    11f4:	48 39 c2             	cmp    %rax,%rdx
    11f7:	75 18                	jne    1211 <main+0x88>
    11f9:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    11fd:	48 89 c6             	mov    %rax,%rsi
    1200:	48 8d 3d 19 0e 00 00 	lea    0xe19(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    ...
    121a:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1221:	00 00 
    1223:	74 05                	je     122a <main+0xa1>
    1225:	e8 46 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    122a:	c9                   	leaveq 
    122b:	c3                   	retq   
