...
/app/bin_gccgcc10_O3/greek_read01:     file format elf64-x86-64
...
00000000000010a0 <fgetws@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 fd 2e 00 00 	bnd jmpq *0x2efd(%rip)        # 3fa8 <fgetws@GLIBC_2.2.5>
...
00000000000010d0 <setlocale@plt>:
    10d0:	f3 0f 1e fa          	endbr64 
    10d4:	f2 ff 25 e5 2e 00 00 	bnd jmpq *0x2ee5(%rip)        # 3fc0 <setlocale@GLIBC_2.2.5>
...
00000000000010f0 <__wprintf_chk@plt>:
    ...
    10f4:	f2 ff 25 d5 2e 00 00 	bnd jmpq *0x2ed5(%rip)        # 3fd0 <__wprintf_chk@GLIBC_2.4>
...
0000000000001100 <main>:
    ...
    110d:	48 8d 3d f2 0e 00 00 	lea    0xef2(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1114:	55                   	push   %rbp
    1115:	48 81 ec 18 01 00 00 	sub    $0x118,%rsp
    111c:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1123:	00 00 
    1125:	48 89 84 24 08 01 00 	mov    %rax,0x108(%rsp)
    112c:	00 
    112d:	31 c0                	xor    %eax,%eax
    112f:	49 89 e4             	mov    %rsp,%r12
    1132:	e8 a9 ff ff ff       	callq  10e0 <fopen@plt>
    1137:	31 ff                	xor    %edi,%edi
    1139:	48 8d 35 d5 0e 00 00 	lea    0xed5(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    1140:	48 89 c5             	mov    %rax,%rbp
    1143:	e8 88 ff ff ff       	callq  10d0 <setlocale@plt>
    1148:	48 8d 15 b7 0e 00 00 	lea    0xeb7(%rip),%rdx        # 2006 <_IO_stdin_used+0x6>
    114f:	48 8d 35 d2 0e 00 00 	lea    0xed2(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    1156:	31 c0                	xor    %eax,%eax
    1158:	bf 01 00 00 00       	mov    $0x1,%edi
    115d:	e8 8e ff ff ff       	callq  10f0 <__wprintf_chk@plt>
    1162:	48 89 ea             	mov    %rbp,%rdx
    1165:	be 40 00 00 00       	mov    $0x40,%esi
    116a:	4c 89 e7             	mov    %r12,%rdi
    116d:	e8 2e ff ff ff       	callq  10a0 <fgetws@plt>
    1172:	bf 01 00 00 00       	mov    $0x1,%edi
    1177:	31 c0                	xor    %eax,%eax
    1179:	4c 89 e2             	mov    %r12,%rdx
    117c:	48 8d 35 ed 0e 00 00 	lea    0xeed(%rip),%rsi        # 2070 <_IO_stdin_used+0x70>
    1183:	e8 68 ff ff ff       	callq  10f0 <__wprintf_chk@plt>
    1188:	48 89 ef             	mov    %rbp,%rdi
    118b:	e8 20 ff ff ff       	callq  10b0 <fclose@plt>
    1190:	48 8b 84 24 08 01 00 	mov    0x108(%rsp),%rax
    1197:	00 
    1198:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    119f:	00 00 
    11a1:	75 0d                	jne    11b0 <main+0xb0>
    11a3:	48 81 c4 18 01 00 00 	add    $0x118,%rsp
    11aa:	31 c0                	xor    %eax,%eax
    11ac:	5d                   	pop    %rbp
    11ad:	41 5c                	pop    %r12
    11af:	c3                   	retq   
    11b0:	e8 0b ff ff ff       	callq  10c0 <__stack_chk_fail@plt>
...
00000000000012b0 <__libc_csu_init>:
    ...
    12b4:	41 57                	push   %r15
    12b6:	4c 8d 3d d3 2a 00 00 	lea    0x2ad3(%rip),%r15        # 3d90 <__frame_dummy_init_array_entry>
    12bd:	41 56                	push   %r14
    ...
    12cc:	55                   	push   %rbp
    12cd:	48 8d 2d c4 2a 00 00 	lea    0x2ac4(%rip),%rbp        # 3d98 <__do_global_dtors_aux_fini_array_entry>
    12d4:	53                   	push   %rbx
