...
/app/bin_gccgcc10_O3/time01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10df:	e8 bc ff ff ff       	callq  10a0 <time@plt>
    10e4:	48 8b 14 24          	mov    (%rsp),%rdx
    ...
    10fe:	e8 7d ff ff ff       	callq  1080 <ctime@plt>
    1103:	48 8d 35 18 0f 00 00 	lea    0xf18(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    110a:	bf 01 00 00 00       	mov    $0x1,%edi
    110f:	48 89 c2             	mov    %rax,%rdx
    1112:	31 c0                	xor    %eax,%eax
    1114:	e8 97 ff ff ff       	callq  10b0 <__printf_chk@plt>
    1119:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    111e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1125:	00 00 
    1127:	75 08                	jne    1131 <main+0x71>
    1129:	48 83 c4 10          	add    $0x10,%rsp
