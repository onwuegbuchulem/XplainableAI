...
/app/bin_gccgcc10_O1/extended_ascii:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1177:	48 8d 35 86 0e 00 00 	lea    0xe86(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    117e:	bf 01 00 00 00       	mov    $0x1,%edi
    1183:	b8 00 00 00 00       	mov    $0x0,%eax
    1188:	e8 e3 fe ff ff       	callq  1070 <__printf_chk@plt>
    118d:	bb 00 00 00 00       	mov    $0x0,%ebx
    1192:	48 8d 2d 72 0e 00 00 	lea    0xe72(%rip),%rbp        # 200b <_IO_stdin_used+0xb>
    1199:	89 da                	mov    %ebx,%edx
    119b:	48 89 ee             	mov    %rbp,%rsi
    ...
    11b0:	83 fb 10             	cmp    $0x10,%ebx
    11b3:	75 e4                	jne    1199 <main+0x30>
    11b5:	48 8b 35 54 2e 00 00 	mov    0x2e54(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11bc:	bf 0a 00 00 00       	mov    $0xa,%edi
    11c1:	e8 9a fe ff ff       	callq  1060 <putc@plt>
    11c6:	bd 90 00 00 00       	mov    $0x90,%ebp
    11cb:	41 bd 80 00 00 00    	mov    $0x80,%r13d
    11d1:	4c 8d 25 40 0e 00 00 	lea    0xe40(%rip),%r12        # 2018 <_IO_stdin_used+0x18>
    11d8:	44 89 ea             	mov    %r13d,%edx
    11db:	48 8d 35 2e 0e 00 00 	lea    0xe2e(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    11e2:	bf 01 00 00 00       	mov    $0x1,%edi
    11e7:	b8 00 00 00 00       	mov    $0x0,%eax
    11ec:	e8 7f fe ff ff       	callq  1070 <__printf_chk@plt>
    11f1:	44 89 eb             	mov    %r13d,%ebx
    11f4:	89 da                	mov    %ebx,%edx
    11f6:	4c 89 e6             	mov    %r12,%rsi
    11f9:	bf 01 00 00 00       	mov    $0x1,%edi
    11fe:	b8 00 00 00 00       	mov    $0x0,%eax
    1203:	e8 68 fe ff ff       	callq  1070 <__printf_chk@plt>
    1208:	83 c3 01             	add    $0x1,%ebx
    120b:	39 eb                	cmp    %ebp,%ebx
    120d:	75 e5                	jne    11f4 <main+0x8b>
    ...
    1220:	41 83 c5 10          	add    $0x10,%r13d
    1224:	83 c5 10             	add    $0x10,%ebp
    1227:	41 81 fd 00 01 00 00 	cmp    $0x100,%r13d
    122e:	75 a8                	jne    11d8 <main+0x6f>
