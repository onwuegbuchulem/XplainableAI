...
/app/bin_gccgcc10_O0/2022_08-Exercise-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1175:	c7 45 f8 41 00 00 00 	movl   $0x41,-0x8(%rbp)
    117c:	c7 45 fc 61 00 00 00 	movl   $0x61,-0x4(%rbp)
    1183:	eb 21                	jmp    11a6 <main+0x3d>
    1185:	8b 55 fc             	mov    -0x4(%rbp),%edx
    1188:	8b 45 f8             	mov    -0x8(%rbp),%eax
    118b:	89 c6                	mov    %eax,%esi
    118d:	48 8d 3d 70 0e 00 00 	lea    0xe70(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1194:	b8 00 00 00 00       	mov    $0x0,%eax
    1199:	e8 d2 fe ff ff       	callq  1070 <printf@plt>
    119e:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11a2:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    11a6:	83 7d f8 5a          	cmpl   $0x5a,-0x8(%rbp)
    11aa:	7e d9                	jle    1185 <main+0x1c>
    11ac:	bf 0a 00 00 00       	mov    $0xa,%edi
    11b1:	e8 aa fe ff ff       	callq  1060 <putchar@plt>
