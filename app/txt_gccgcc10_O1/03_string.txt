...
/app/bin_gccgcc10_O1/03_string:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1181:	48 b8 67 72 65 65 74 	movabs $0x676e697465657267,%rax
    1188:	69 6e 67 
    118b:	48 ba 73 2c 20 68 75 	movabs $0x6e616d7568202c73,%rdx
    1192:	6d 61 6e 
    1195:	48 89 04 24          	mov    %rax,(%rsp)
    1199:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    119e:	48 89 e7             	mov    %rsp,%rdi
    11a1:	e8 ba fe ff ff       	callq  1060 <puts@plt>
    11a6:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11ab:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11b2:	00 00 
    11b4:	75 0a                	jne    11c0 <main+0x57>
    11b6:	b8 00 00 00 00       	mov    $0x0,%eax
    11bb:	48 83 c4 28          	add    $0x28,%rsp
    11bf:	c3                   	retq   
    11c0:	e8 ab fe ff ff       	callq  1070 <__stack_chk_fail@plt>
