...
/app/bin_gccgcc10_O1/getdate01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c1:	bf 00 00 00 00       	mov    $0x0,%edi
    11c6:	e8 d5 fe ff ff       	callq  10a0 <time@plt>
    11cb:	48 89 04 24          	mov    %rax,(%rsp)
    11cf:	48 89 e7             	mov    %rsp,%rdi
    11d2:	e8 a9 fe ff ff       	callq  1080 <localtime@plt>
    11d7:	8b 70 14             	mov    0x14(%rax),%esi
    11da:	8b 50 10             	mov    0x10(%rax),%edx
    11dd:	8d 4a 01             	lea    0x1(%rdx),%ecx
    11e0:	8b 50 18             	mov    0x18(%rax),%edx
    11e3:	44 8d 8e 6c 07 00 00 	lea    0x76c(%rsi),%r9d
    11ea:	44 8b 40 0c          	mov    0xc(%rax),%r8d
    ...
    1210:	00 00 
    1212:	75 0a                	jne    121e <main+0x75>
    1214:	b8 00 00 00 00       	mov    $0x0,%eax
    1219:	48 83 c4 18          	add    $0x18,%rsp
    121d:	c3                   	retq   
    121e:	e8 6d fe ff ff       	callq  1090 <__stack_chk_fail@plt>
