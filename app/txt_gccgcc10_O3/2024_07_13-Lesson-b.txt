...
/app/bin_gccgcc10_O3/2024_07_13-Lesson-b:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10d3:	bb 14 00 00 00       	mov    $0x14,%ebx
    10d8:	e8 c3 ff ff ff       	callq  10a0 <__printf_chk@plt>
    10dd:	48 8d 35 29 0f 00 00 	lea    0xf29(%rip),%rsi        # 200d <_IO_stdin_used+0xd>
    10e4:	bf 01 00 00 00       	mov    $0x1,%edi
    10e9:	31 c0                	xor    %eax,%eax
    10eb:	e8 b0 ff ff ff       	callq  10a0 <__printf_chk@plt>
    10f0:	48 8b 35 19 2f 00 00 	mov    0x2f19(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10f7:	bf 58 00 00 00       	mov    $0x58,%edi
    10fc:	e8 7f ff ff ff       	callq  1080 <putc@plt>
    1101:	83 eb 01             	sub    $0x1,%ebx
    1104:	75 ea                	jne    10f0 <main+0x30>
    1106:	48 8b 3d 03 2f 00 00 	mov    0x2f03(%rip),%rdi        # 4010 <stdout@@GLIBC_2.2.5>
    110d:	bb 14 00 00 00       	mov    $0x14,%ebx
    1112:	e8 79 ff ff ff       	callq  1090 <fflush@plt>
    1117:	bf 01 00 00 00       	mov    $0x1,%edi
    111c:	e8 8f ff ff ff       	callq  10b0 <sleep@plt>
    1121:	48 8d 35 e8 0e 00 00 	lea    0xee8(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    1128:	bf 01 00 00 00       	mov    $0x1,%edi
    112d:	31 c0                	xor    %eax,%eax
    112f:	e8 6c ff ff ff       	callq  10a0 <__printf_chk@plt>
    1134:	48 8d 35 d2 0e 00 00 	lea    0xed2(%rip),%rsi        # 200d <_IO_stdin_used+0xd>
    113b:	bf 01 00 00 00       	mov    $0x1,%edi
    1140:	31 c0                	xor    %eax,%eax
    1142:	e8 59 ff ff ff       	callq  10a0 <__printf_chk@plt>
    1147:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    114e:	00 00 
    1150:	48 8b 35 b9 2e 00 00 	mov    0x2eb9(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1157:	bf 20 00 00 00       	mov    $0x20,%edi
    115c:	e8 1f ff ff ff       	callq  1080 <putc@plt>
    1161:	83 eb 01             	sub    $0x1,%ebx
    1164:	75 ea                	jne    1150 <main+0x90>
    1166:	48 8b 3d a3 2e 00 00 	mov    0x2ea3(%rip),%rdi        # 4010 <stdout@@GLIBC_2.2.5>
    116d:	bb 14 00 00 00       	mov    $0x14,%ebx
    1172:	e8 19 ff ff ff       	callq  1090 <fflush@plt>
    1177:	bf 01 00 00 00       	mov    $0x1,%edi
    117c:	e8 2f ff ff ff       	callq  10b0 <sleep@plt>
    1181:	48 8d 35 88 0e 00 00 	lea    0xe88(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    1188:	bf 01 00 00 00       	mov    $0x1,%edi
    118d:	31 c0                	xor    %eax,%eax
    118f:	e8 0c ff ff ff       	callq  10a0 <__printf_chk@plt>
    1194:	0f 1f 40 00          	nopl   0x0(%rax)
    1198:	48 8b 35 71 2e 00 00 	mov    0x2e71(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    119f:	bf 5a 00 00 00       	mov    $0x5a,%edi
    11a4:	e8 d7 fe ff ff       	callq  1080 <putc@plt>
    11a9:	83 eb 01             	sub    $0x1,%ebx
    11ac:	75 ea                	jne    1198 <main+0xd8>
    11ae:	48 8b 35 5b 2e 00 00 	mov    0x2e5b(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11b5:	bf 0a 00 00 00       	mov    $0xa,%edi
    11ba:	e8 c1 fe ff ff       	callq  1080 <putc@plt>
