...
/app/bin_gccgcc10_O0/wscanf:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c4:	c7 45 f0 a3 00 00 00 	movl   $0xa3,-0x10(%rbp)
    11cb:	48 8d 35 36 0e 00 00 	lea    0xe36(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    11d2:	bf 00 00 00 00       	mov    $0x0,%edi
    11d7:	e8 d4 fe ff ff       	callq  10b0 <setlocale@plt>
    11dc:	48 8d 3d 35 0e 00 00 	lea    0xe35(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    11e3:	b8 00 00 00 00       	mov    $0x0,%eax
    11e8:	e8 b3 fe ff ff       	callq  10a0 <wprintf@plt>
    11ed:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    11f1:	48 89 c6             	mov    %rax,%rsi
    11f4:	48 8d 3d 95 0e 00 00 	lea    0xe95(%rip),%rdi        # 2090 <_IO_stdin_used+0x90>
    11fb:	b8 00 00 00 00       	mov    $0x0,%eax
    1200:	e8 8b fe ff ff       	callq  1090 <__isoc99_wscanf@plt>
    1205:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1208:	66 0f ef c9          	pxor   %xmm1,%xmm1
    120c:	f2 0f 2a c8          	cvtsi2sd %eax,%xmm1
    1210:	f2 0f 10 05 d8 0e 00 	movsd  0xed8(%rip),%xmm0        # 20f0 <_IO_stdin_used+0xf0>
    1217:	00 
    ...
    122e:	66 48 0f 7e d2       	movq   %xmm2,%rdx
    1233:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1236:	66 48 0f 6e c2       	movq   %rdx,%xmm0
    123b:	89 c6                	mov    %eax,%esi
    123d:	48 8d 3d 5c 0e 00 00 	lea    0xe5c(%rip),%rdi        # 20a0 <_IO_stdin_used+0xa0>
    1244:	b8 01 00 00 00       	mov    $0x1,%eax
    1249:	e8 52 fe ff ff       	callq  10a0 <wprintf@plt>
