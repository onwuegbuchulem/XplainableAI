...
/app/bin_gccgcc10_O0/2024_08_31-Lesson-b:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    120c:	e8 af fe ff ff       	callq  10c0 <time@plt>
    1211:	89 c7                	mov    %eax,%edi
    1213:	e8 98 fe ff ff       	callq  10b0 <srand@plt>
    1218:	e8 b3 fe ff ff       	callq  10d0 <rand@plt>
    121d:	48 63 d0             	movslq %eax,%rdx
    1220:	48 69 d2 67 66 66 66 	imul   $0x66666667,%rdx,%rdx
    1227:	48 c1 ea 20          	shr    $0x20,%rdx
    122b:	d1 fa                	sar    %edx
    ...
    1239:	01 d1                	add    %edx,%ecx
    123b:	29 c8                	sub    %ecx,%eax
    123d:	89 c2                	mov    %eax,%edx
    123f:	48 63 c2             	movslq %edx,%rax
    1242:	8b 44 85 e0          	mov    -0x20(%rbp,%rax,4),%eax
