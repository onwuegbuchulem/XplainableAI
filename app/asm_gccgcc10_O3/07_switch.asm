...
/app/bin_gccgcc10_O3/07_switch:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10ee:	48 8d 3d 19 0f 00 00 	lea    0xf19(%rip),%rdi        # 200e <_IO_stdin_used+0xe>
    10f5:	31 c0                	xor    %eax,%eax
    10f7:	e8 b4 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10fc:	8b 44 24 04          	mov    0x4(%rsp),%eax
    1100:	83 f8 03             	cmp    $0x3,%eax
    1103:	74 46                	je     114b <main+0x8b>
    1105:	7f 31                	jg     1138 <main+0x78>
    1107:	83 f8 01             	cmp    $0x1,%eax
    110a:	74 62                	je     116e <main+0xae>
    110c:	83 f8 02             	cmp    $0x2,%eax
    110f:	75 48                	jne    1159 <main+0x99>
    1111:	48 8d 3d 07 0f 00 00 	lea    0xf07(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    1118:	e8 63 ff ff ff       	callq  1080 <puts@plt>
    111d:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1122:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1129:	00 00 
    112b:	75 4f                	jne    117c <main+0xbc>
    112d:	31 c0                	xor    %eax,%eax
    112f:	48 83 c4 18          	add    $0x18,%rsp
    1133:	c3                   	retq   
    1134:	0f 1f 40 00          	nopl   0x0(%rax)
    1138:	83 f8 04             	cmp    $0x4,%eax
    113b:	75 1c                	jne    1159 <main+0x99>
    113d:	48 8d 3d f7 0e 00 00 	lea    0xef7(%rip),%rdi        # 203b <_IO_stdin_used+0x3b>
    1144:	e8 37 ff ff ff       	callq  1080 <puts@plt>
    1149:	eb d2                	jmp    111d <main+0x5d>
    114b:	48 8d 3d db 0e 00 00 	lea    0xedb(%rip),%rdi        # 202d <_IO_stdin_used+0x2d>
    1152:	e8 29 ff ff ff       	callq  1080 <puts@plt>
    1157:	eb c4                	jmp    111d <main+0x5d>
    1159:	48 8d 35 e9 0e 00 00 	lea    0xee9(%rip),%rsi        # 2049 <_IO_stdin_used+0x49>
    1160:	bf 01 00 00 00       	mov    $0x1,%edi
    1165:	31 c0                	xor    %eax,%eax
    1167:	e8 34 ff ff ff       	callq  10a0 <__printf_chk@plt>
    116c:	eb af                	jmp    111d <main+0x5d>
    116e:	48 8d 3d 9c 0e 00 00 	lea    0xe9c(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    1175:	e8 06 ff ff ff       	callq  1080 <puts@plt>
    117a:	eb a1                	jmp    111d <main+0x5d>
