...
/app/bin_gccgcc10_O3/Pattern-2:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 54                	push   %r12
    1086:	41 bc 01 00 00 00    	mov    $0x1,%r12d
    108c:	55                   	push   %rbp
    108d:	48 8d 2d 70 0f 00 00 	lea    0xf70(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1094:	53                   	push   %rbx
    1095:	44 89 e3             	mov    %r12d,%ebx
    1098:	48 89 ee             	mov    %rbp,%rsi
    ...
    10aa:	83 fb 06             	cmp    $0x6,%ebx
    10ad:	75 e9                	jne    1098 <main+0x18>
    10af:	bf 0a 00 00 00       	mov    $0xa,%edi
    10b4:	41 83 c4 01          	add    $0x1,%r12d
    10b8:	e8 a3 ff ff ff       	callq  1060 <putchar@plt>
    10bd:	41 83 fc 06          	cmp    $0x6,%r12d
    10c1:	75 d2                	jne    1095 <main+0x15>
    10c3:	5b                   	pop    %rbx
