...
/app/bin_gccgcc10_O2/VowelorConsonant:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10fc:	83 e8 41             	sub    $0x41,%eax
    10ff:	3c 34                	cmp    $0x34,%al
    1101:	77 14                	ja     1117 <main+0x57>
    1103:	48 8d 15 52 0f 00 00 	lea    0xf52(%rip),%rdx        # 205c <_IO_stdin_used+0x5c>
    110a:	0f b6 c0             	movzbl %al,%eax
    110d:	48 63 04 82          	movslq (%rdx,%rax,4),%rax
    1111:	48 01 d0             	add    %rdx,%rax
    1114:	3e ff e0             	notrack jmpq *%rax
    1117:	48 8d 35 1a 0f 00 00 	lea    0xf1a(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    111e:	bf 01 00 00 00       	mov    $0x1,%edi
    1123:	31 c0                	xor    %eax,%eax
    1125:	e8 76 ff ff ff       	callq  10a0 <__printf_chk@plt>
    112a:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    112f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1136:	00 00 
    1138:	75 1c                	jne    1156 <main+0x96>
    113a:	31 c0                	xor    %eax,%eax
    113c:	48 83 c4 18          	add    $0x18,%rsp
    1140:	c3                   	retq   
    1141:	48 8d 35 d1 0e 00 00 	lea    0xed1(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    1148:	bf 01 00 00 00       	mov    $0x1,%edi
    114d:	31 c0                	xor    %eax,%eax
    114f:	e8 4c ff ff ff       	callq  10a0 <__printf_chk@plt>
    1154:	eb d4                	jmp    112a <main+0x6a>
