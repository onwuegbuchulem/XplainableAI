...
/app/bin_gccgcc10_O0/2019_06_08-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    11d4:	eb 18                	jmp    11ee <main+0x85>
    11d6:	8b 45 cc             	mov    -0x34(%rbp),%eax
    11d9:	48 98                	cltq   
    11db:	0f b6 44 05 d0       	movzbl -0x30(%rbp,%rax,1),%eax
    11e0:	0f be c0             	movsbl %al,%eax
    11e3:	89 c7                	mov    %eax,%edi
    11e5:	e8 76 fe ff ff       	callq  1060 <putchar@plt>
    11ea:	83 45 cc 01          	addl   $0x1,-0x34(%rbp)
    11ee:	8b 45 cc             	mov    -0x34(%rbp),%eax
    11f1:	48 98                	cltq   
    11f3:	0f b6 44 05 d0       	movzbl -0x30(%rbp,%rax,1),%eax
    11f8:	84 c0                	test   %al,%al
    11fa:	75 da                	jne    11d6 <main+0x6d>
    11fc:	b8 00 00 00 00       	mov    $0x0,%eax
    1201:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1205:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    120c:	00 00 
    120e:	74 05                	je     1215 <main+0xac>
    1210:	e8 5b fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1215:	c9                   	leaveq 
    1216:	c3                   	retq   
