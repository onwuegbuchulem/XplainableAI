...
/app/bin_gccgcc10_O0/urlencoder01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11b5:	eb 78                	jmp    122f <main+0x86>
    11b7:	83 7d fc 2d          	cmpl   $0x2d,-0x4(%rbp)
    11bb:	74 12                	je     11cf <main+0x26>
    11bd:	83 7d fc 2e          	cmpl   $0x2e,-0x4(%rbp)
    11c1:	74 0c                	je     11cf <main+0x26>
    11c3:	83 7d fc 5f          	cmpl   $0x5f,-0x4(%rbp)
    11c7:	74 06                	je     11cf <main+0x26>
    11c9:	83 7d fc 2a          	cmpl   $0x2a,-0x4(%rbp)
    11cd:	75 0c                	jne    11db <main+0x32>
    11cf:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11d2:	89 c7                	mov    %eax,%edi
    11d4:	e8 a7 fe ff ff       	callq  1080 <putchar@plt>
    11d9:	eb 54                	jmp    122f <main+0x86>
    11db:	83 7d fc 20          	cmpl   $0x20,-0x4(%rbp)
    11df:	75 0c                	jne    11ed <main+0x44>
    11e1:	bf 2b 00 00 00       	mov    $0x2b,%edi
    11e6:	e8 95 fe ff ff       	callq  1080 <putchar@plt>
    11eb:	eb 42                	jmp    122f <main+0x86>
    11ed:	e8 be fe ff ff       	callq  10b0 <__ctype_b_loc@plt>
    11f2:	48 8b 10             	mov    (%rax),%rdx
    11f5:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11f8:	48 98                	cltq   
    11fa:	48 01 c0             	add    %rax,%rax
    11fd:	48 01 d0             	add    %rdx,%rax
    1200:	0f b7 00             	movzwl (%rax),%eax
    1203:	0f b7 c0             	movzwl %ax,%eax
    1206:	83 e0 08             	and    $0x8,%eax
    1209:	85 c0                	test   %eax,%eax
    120b:	74 0c                	je     1219 <main+0x70>
    120d:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1210:	89 c7                	mov    %eax,%edi
    1212:	e8 69 fe ff ff       	callq  1080 <putchar@plt>
    1217:	eb 16                	jmp    122f <main+0x86>
    ...
    122f:	e8 6c fe ff ff       	callq  10a0 <getchar@plt>
    1234:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1237:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%rbp)
    123b:	0f 85 76 ff ff ff    	jne    11b7 <main+0xe>
