...
/app/bin_gccgcc10_O0/create_node:     file format elf64-x86-64
...
0000000000001149 <newNode>:
    ...
    1158:	bf 18 00 00 00       	mov    $0x18,%edi
    115d:	e8 ee fe ff ff       	callq  1050 <malloc@plt>
    1162:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1166:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    116a:	48 c7 00 00 00 00 00 	movq   $0x0,(%rax)
    1171:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1175:	8b 55 ec             	mov    -0x14(%rbp),%edx
    1178:	89 50 08             	mov    %edx,0x8(%rax)
    117b:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    117f:	48 c7 40 10 00 00 00 	movq   $0x0,0x10(%rax)
    1186:	00 
