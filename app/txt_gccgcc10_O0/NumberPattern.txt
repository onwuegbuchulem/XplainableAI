...
/app/bin_gccgcc10_O0/NumberPattern:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c4:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    ...
    11dc:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    11e0:	48 89 c6             	mov    %rax,%rsi
    11e3:	48 8d 3d 31 0e 00 00 	lea    0xe31(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    11ea:	b8 00 00 00 00       	mov    $0x0,%eax
    11ef:	e8 bc fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11f4:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%rbp)
    11fb:	eb 3d                	jmp    123a <main+0x91>
    11fd:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%rbp)
    1204:	eb 1e                	jmp    1224 <main+0x7b>
    1206:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1209:	89 c6                	mov    %eax,%esi
    120b:	48 8d 3d 0c 0e 00 00 	lea    0xe0c(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    1212:	b8 00 00 00 00       	mov    $0x0,%eax
    1217:	e8 84 fe ff ff       	callq  10a0 <printf@plt>
    121c:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    1220:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    1224:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1227:	3b 45 ec             	cmp    -0x14(%rbp),%eax
    122a:	7e da                	jle    1206 <main+0x5d>
    122c:	bf 0a 00 00 00       	mov    $0xa,%edi
    1231:	e8 4a fe ff ff       	callq  1080 <putchar@plt>
    1236:	83 45 ec 01          	addl   $0x1,-0x14(%rbp)
    123a:	8b 45 e8             	mov    -0x18(%rbp),%eax
    123d:	39 45 ec             	cmp    %eax,-0x14(%rbp)
    1240:	7e bb                	jle    11fd <main+0x54>
    1242:	b8 00 00 00 00       	mov    $0x0,%eax
    1247:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    124b:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1252:	00 00 
    1254:	74 05                	je     125b <main+0xb2>
