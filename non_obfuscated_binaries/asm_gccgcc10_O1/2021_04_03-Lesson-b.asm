...
/app/bin_gccgcc10_O1/2021_04_03-Lesson-b:     file format elf64-x86-64
...
000000000000117c <main>:
    ...
    1180:	55                   	push   %rbp
    1181:	53                   	push   %rbx
    1182:	48 83 ec 08          	sub    $0x8,%rsp
    1186:	bb 00 00 00 00       	mov    $0x0,%ebx
    118b:	48 8d 2d 72 0e 00 00 	lea    0xe72(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1192:	0f b6 fb             	movzbl %bl,%edi
    1195:	e8 af ff ff ff       	callq  1149 <binbin>
    119a:	48 89 c1             	mov    %rax,%rcx
    119d:	0f be d3             	movsbl %bl,%edx
    11a0:	48 89 ee             	mov    %rbp,%rsi
    11a3:	bf 01 00 00 00       	mov    $0x1,%edi
    11a8:	b8 00 00 00 00       	mov    $0x0,%eax
    11ad:	e8 9e fe ff ff       	callq  1050 <__printf_chk@plt>
    11b2:	83 c3 01             	add    $0x1,%ebx
    11b5:	81 fb 00 01 00 00    	cmp    $0x100,%ebx
    11bb:	75 d5                	jne    1192 <main+0x16>
