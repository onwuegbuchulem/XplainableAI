...
/app/bin_gccgcc10_O1/05_quick_quiz:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1162:	83 fb 15             	cmp    $0x15,%ebx
    1165:	74 1b                	je     1182 <main+0x39>
    1167:	83 fb 09             	cmp    $0x9,%ebx
    116a:	7e f3                	jle    115f <main+0x16>
    116c:	89 da                	mov    %ebx,%edx
    116e:	48 89 ee             	mov    %rbp,%rsi
    1171:	bf 01 00 00 00       	mov    $0x1,%edi
    1176:	b8 00 00 00 00       	mov    $0x0,%eax
    117b:	e8 d0 fe ff ff       	callq  1050 <__printf_chk@plt>
    1180:	eb dd                	jmp    115f <main+0x16>
