...
/app/bin_gccgcc10_O1/2023_01_28-Lesson-d:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11cd:	48 83 ec 18          	sub    $0x18,%rsp
    11d1:	e8 ba fe ff ff       	callq  1090 <clock@plt>
    11d6:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11da:	f3 48 0f 2a c8       	cvtsi2ss %rax,%xmm1
    11df:	f3 0f 11 4c 24 08    	movss  %xmm1,0x8(%rsp)
    11e5:	0f 28 c1             	movaps %xmm1,%xmm0
    11e8:	f3 0f 5e 05 64 0e 00 	divss  0xe64(%rip),%xmm0        # 2054 <_IO_stdin_used+0x54>
    11ef:	00 
    11f0:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    11f4:	48 8d 35 09 0e 00 00 	lea    0xe09(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11fb:	bf 01 00 00 00       	mov    $0x1,%edi
    1200:	b8 01 00 00 00       	mov    $0x1,%eax
    1205:	e8 b6 fe ff ff       	callq  10c0 <__printf_chk@plt>
    120a:	bf 00 00 00 00       	mov    $0x0,%edi
    120f:	e8 9c fe ff ff       	callq  10b0 <time@plt>
    1214:	48 89 c7             	mov    %rax,%rdi
    1217:	e8 84 fe ff ff       	callq  10a0 <srand@plt>
    121c:	e8 af fe ff ff       	callq  10d0 <rand@plt>
    1221:	89 c2                	mov    %eax,%edx
    1223:	48 98                	cltq   
    1225:	48 69 c0 d3 4d 62 10 	imul   $0x10624dd3,%rax,%rax
    122c:	48 c1 f8 26          	sar    $0x26,%rax
    1230:	89 d1                	mov    %edx,%ecx
    1232:	c1 f9 1f             	sar    $0x1f,%ecx
    1235:	29 c8                	sub    %ecx,%eax
    1237:	69 c0 e8 03 00 00    	imul   $0x3e8,%eax,%eax
    123d:	29 c2                	sub    %eax,%edx
    123f:	83 fa 01             	cmp    $0x1,%edx
    1242:	75 d8                	jne    121c <main+0x53>
    1244:	e8 47 fe ff ff       	callq  1090 <clock@plt>
    1249:	66 0f ef c0          	pxor   %xmm0,%xmm0
    124d:	f3 48 0f 2a c0       	cvtsi2ss %rax,%xmm0
    1252:	f3 0f 11 44 24 0c    	movss  %xmm0,0xc(%rsp)
    1258:	f3 0f 5e 05 f4 0d 00 	divss  0xdf4(%rip),%xmm0        # 2054 <_IO_stdin_used+0x54>
    125f:	00 
    1260:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1264:	48 8d 35 b3 0d 00 00 	lea    0xdb3(%rip),%rsi        # 201e <_IO_stdin_used+0x1e>
    126b:	bf 01 00 00 00       	mov    $0x1,%edi
    1270:	b8 01 00 00 00       	mov    $0x1,%eax
    1275:	e8 46 fe ff ff       	callq  10c0 <__printf_chk@plt>
    127a:	f3 0f 10 44 24 0c    	movss  0xc(%rsp),%xmm0
    1280:	f3 0f 5c 44 24 08    	subss  0x8(%rsp),%xmm0
    1286:	f3 0f 5e 05 c6 0d 00 	divss  0xdc6(%rip),%xmm0        # 2054 <_IO_stdin_used+0x54>
    128d:	00 
    128e:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1292:	48 8d 35 9d 0d 00 00 	lea    0xd9d(%rip),%rsi        # 2036 <_IO_stdin_used+0x36>
    1299:	bf 01 00 00 00       	mov    $0x1,%edi
    129e:	b8 01 00 00 00       	mov    $0x1,%eax
    12a3:	e8 18 fe ff ff       	callq  10c0 <__printf_chk@plt>
