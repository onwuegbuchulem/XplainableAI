...
/app/bin_gccgcc10_O1/2024_01_01-Lesson:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	b9 0a 00 00 00       	mov    $0xa,%ecx
    1156:	ba 05 00 00 00       	mov    $0x5,%edx
    115b:	48 8d 35 a2 0e 00 00 	lea    0xea2(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1162:	bf 01 00 00 00       	mov    $0x1,%edi
    1167:	b8 00 00 00 00       	mov    $0x0,%eax
    116c:	e8 df fe ff ff       	callq  1050 <__printf_chk@plt>
    1171:	b9 0a 00 00 00       	mov    $0xa,%ecx
    1176:	ba 05 00 00 00       	mov    $0x5,%edx
    117b:	48 8d 35 9b 0e 00 00 	lea    0xe9b(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    1182:	bf 01 00 00 00       	mov    $0x1,%edi
    1187:	b8 00 00 00 00       	mov    $0x0,%eax
    118c:	e8 bf fe ff ff       	callq  1050 <__printf_chk@plt>
