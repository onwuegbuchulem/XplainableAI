...
/app/bin_gccgcc10_O0/catalan:     file format elf64-x86-64
...
0000000000001189 <factorial>:
    ...
    119d:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    11a4:	eb 18                	jmp    11be <factorial+0x35>
    11a6:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11a9:	2b 45 f4             	sub    -0xc(%rbp),%eax
    11ac:	48 98                	cltq   
    11ae:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11b2:	48 0f af c2          	imul   %rdx,%rax
    11b6:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11ba:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    11be:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11c1:	3b 45 ec             	cmp    -0x14(%rbp),%eax
    11c4:	7c e0                	jl     11a6 <factorial+0x1d>
...
00000000000011cc <main>:
    ...
    11e7:	48 8d 45 d8          	lea    -0x28(%rbp),%rax
    ...
    11fa:	e8 91 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11ff:	8b 45 d8             	mov    -0x28(%rbp),%eax
    1202:	01 c0                	add    %eax,%eax
    1204:	89 c7                	mov    %eax,%edi
    1206:	e8 7e ff ff ff       	callq  1189 <factorial>
    120b:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    120f:	8b 45 d8             	mov    -0x28(%rbp),%eax
    1212:	83 c0 01             	add    $0x1,%eax
    1215:	89 c7                	mov    %eax,%edi
    1217:	e8 6d ff ff ff       	callq  1189 <factorial>
    121c:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    1220:	8b 45 d8             	mov    -0x28(%rbp),%eax
    1223:	89 c7                	mov    %eax,%edi
    1225:	e8 5f ff ff ff       	callq  1189 <factorial>
    122a:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    122e:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    1232:	48 0f af 45 f0       	imul   -0x10(%rbp),%rax
    1237:	48 89 c1             	mov    %rax,%rcx
    123a:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    123e:	48 99                	cqto   
    1240:	48 f7 f9             	idiv   %rcx
    1243:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1247:	f3 48 0f 2a c0       	cvtsi2ss %rax,%xmm0
    124c:	f3 0f 11 45 dc       	movss  %xmm0,-0x24(%rbp)
    1251:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1255:	f3 0f 5a 4d dc       	cvtss2sd -0x24(%rbp),%xmm1
    125a:	66 48 0f 7e c8       	movq   %xmm1,%rax
    125f:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1264:	48 8d 3d 9c 0d 00 00 	lea    0xd9c(%rip),%rdi        # 2007 <_IO_stdin_used+0x7>
    126b:	b8 01 00 00 00       	mov    $0x1,%eax
    1270:	e8 0b fe ff ff       	callq  1080 <printf@plt>
    1275:	b8 00 00 00 00       	mov    $0x0,%eax
    127a:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    127e:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1285:	00 00 
    1287:	74 05                	je     128e <main+0xc2>
