...
/app/bin_gccgcc10_O0/2020_07_11-Lesson-a:     file format elf64-x86-64
...
0000000000001090 <gettimeofday@plt>:
    ...
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <gettimeofday@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    11ca:	e8 b1 fe ff ff       	callq  1080 <printf@plt>
    11cf:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    11d3:	48 89 c6             	mov    %rax,%rsi
    11d6:	48 8d 3d 48 0e 00 00 	lea    0xe48(%rip),%rdi        # 2025 <_IO_stdin_used+0x25>
    11dd:	b8 00 00 00 00       	mov    $0x0,%eax
    11e2:	e8 99 fe ff ff       	callq  1080 <printf@plt>
    11e7:	8b 45 d8             	mov    -0x28(%rbp),%eax
    11ea:	89 c6                	mov    %eax,%esi
    11ec:	48 8d 3d 45 0e 00 00 	lea    0xe45(%rip),%rdi        # 2038 <_IO_stdin_used+0x38>
    11f3:	b8 00 00 00 00       	mov    $0x0,%eax
    11f8:	e8 83 fe ff ff       	callq  1080 <printf@plt>
    11fd:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1200:	89 c6                	mov    %eax,%esi
    1202:	48 8d 3d 4f 0e 00 00 	lea    0xe4f(%rip),%rdi        # 2058 <_IO_stdin_used+0x58>
    1209:	b8 00 00 00 00       	mov    $0x0,%eax
    120e:	e8 6d fe ff ff       	callq  1080 <printf@plt>
    1213:	b8 00 00 00 00       	mov    $0x0,%eax
    1218:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    121c:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1223:	00 00 
    1225:	74 05                	je     122c <main+0xa3>
    1227:	e8 44 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    122c:	c9                   	leaveq 
    122d:	c3                   	retq   
