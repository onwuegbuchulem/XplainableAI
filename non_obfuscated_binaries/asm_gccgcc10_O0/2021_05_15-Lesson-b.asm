...
/app/bin_gccgcc10_O0/2021_05_15-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%rbp)
    118b:	c7 45 f0 02 00 00 00 	movl   $0x2,-0x10(%rbp)
    1192:	c7 45 f4 03 00 00 00 	movl   $0x3,-0xc(%rbp)
    1199:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    119d:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    11a1:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    11a5:	48 83 c0 08          	add    $0x8,%rax
    11a9:	8b 08                	mov    (%rax),%ecx
    11ab:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    11af:	48 83 c0 04          	add    $0x4,%rax
    11b3:	8b 10                	mov    (%rax),%edx
    ...
    11d3:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    11d7:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    11de:	00 00 
    11e0:	74 05                	je     11e7 <main+0x7e>
    11e2:	e8 79 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    11e7:	c9                   	leaveq 
    11e8:	c3                   	retq   
