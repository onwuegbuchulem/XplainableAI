...
/app/bin_gccgcc10_O0/getPIDs:     file format elf64-x86-64
...
0000000000001080 <getpid@plt>:
    ...
    1084:	f2 ff 25 2d 2f 00 00 	bnd jmpq *0x2f2d(%rip)        # 3fb8 <getpid@GLIBC_2.2.5>
...
00000000000010a0 <getppid@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 1d 2f 00 00 	bnd jmpq *0x2f1d(%rip)        # 3fc8 <getppid@GLIBC_2.2.5>
...
00000000000011a9 <main>:
    ...
    11b5:	bf 05 00 00 00       	mov    $0x5,%edi
    11ba:	e8 f1 fe ff ff       	callq  10b0 <sleep@plt>
    11bf:	e8 bc fe ff ff       	callq  1080 <getpid@plt>
    11c4:	89 45 f8             	mov    %eax,-0x8(%rbp)
    11c7:	e8 d4 fe ff ff       	callq  10a0 <getppid@plt>
    11cc:	89 45 fc             	mov    %eax,-0x4(%rbp)
    ...
    11e0:	e8 ab fe ff ff       	callq  1090 <printf@plt>
    11e5:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11e8:	89 c6                	mov    %eax,%esi
    11ea:	48 8d 3d 2f 0e 00 00 	lea    0xe2f(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    11f1:	b8 00 00 00 00       	mov    $0x0,%eax
    11f6:	e8 95 fe ff ff       	callq  1090 <printf@plt>
    11fb:	90                   	nop
    11fc:	c9                   	leaveq 
    11fd:	c3                   	retq   
