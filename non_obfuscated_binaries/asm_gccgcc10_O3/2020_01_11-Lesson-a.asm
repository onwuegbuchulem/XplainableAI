...
/app/bin_gccgcc10_O3/2020_01_11-Lesson-a:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c4:	41 54                	push   %r12
    10c6:	ba 0d 00 00 00       	mov    $0xd,%edx
    10cb:	48 8d 35 32 0f 00 00 	lea    0xf32(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    ...
    10e6:	48 89 e7             	mov    %rsp,%rdi
    10e9:	e8 b2 ff ff ff       	callq  10a0 <asprintf@plt>
    10ee:	48 8b 3c 24          	mov    (%rsp),%rdi
    10f2:	41 89 c4             	mov    %eax,%r12d
    10f5:	e8 86 ff ff ff       	callq  1080 <puts@plt>
    10fa:	31 c0                	xor    %eax,%eax
    10fc:	44 89 e2             	mov    %r12d,%edx
    10ff:	bf 01 00 00 00       	mov    $0x1,%edi
    1104:	48 8d 35 0a 0f 00 00 	lea    0xf0a(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    110b:	e8 a0 ff ff ff       	callq  10b0 <__printf_chk@plt>
    1110:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1115:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    111c:	00 00 
    111e:	75 09                	jne    1129 <main+0x69>
    1120:	48 83 c4 10          	add    $0x10,%rsp
    1124:	31 c0                	xor    %eax,%eax
    1126:	41 5c                	pop    %r12
    1128:	c3                   	retq   
    1129:	e8 62 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
