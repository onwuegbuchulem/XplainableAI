...
/app/bin_gccgcc10_O2/03_string:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1097:	00 00 
    1099:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    109e:	31 c0                	xor    %eax,%eax
    10a0:	48 89 e7             	mov    %rsp,%rdi
    10a3:	0f 11 04 24          	movups %xmm0,(%rsp)
    10a7:	e8 b4 ff ff ff       	callq  1060 <puts@plt>
    10ac:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10b1:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10b8:	00 00 
    10ba:	75 07                	jne    10c3 <main+0x43>
    10bc:	31 c0                	xor    %eax,%eax
    10be:	48 83 c4 28          	add    $0x28,%rsp
    10c2:	c3                   	retq   
    10c3:	e8 a8 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
