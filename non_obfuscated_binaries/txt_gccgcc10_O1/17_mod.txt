...
/app/bin_gccgcc10_O1/17_mod:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1158:	bd 02 00 00 00       	mov    $0x2,%ebp
    115d:	eb 20                	jmp    117f <main+0x36>
    115f:	89 da                	mov    %ebx,%edx
    1161:	48 8d 35 a6 0e 00 00 	lea    0xea6(%rip),%rsi        # 200e <_IO_stdin_used+0xe>
    1168:	bf 01 00 00 00       	mov    $0x1,%edi
    116d:	b8 00 00 00 00       	mov    $0x0,%eax
    1172:	e8 d9 fe ff ff       	callq  1050 <__printf_chk@plt>
    1177:	83 c3 01             	add    $0x1,%ebx
    117a:	83 fb 0a             	cmp    $0xa,%ebx
    117d:	74 23                	je     11a2 <main+0x59>
    117f:	89 e8                	mov    %ebp,%eax
    1181:	99                   	cltd   
    1182:	f7 fb                	idiv   %ebx
    1184:	85 d2                	test   %edx,%edx
    1186:	74 d7                	je     115f <main+0x16>
    1188:	89 da                	mov    %ebx,%edx
    118a:	48 8d 35 73 0e 00 00 	lea    0xe73(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1191:	bf 01 00 00 00       	mov    $0x1,%edi
    1196:	b8 00 00 00 00       	mov    $0x0,%eax
    119b:	e8 b0 fe ff ff       	callq  1050 <__printf_chk@plt>
    11a0:	eb d5                	jmp    1177 <main+0x2e>
