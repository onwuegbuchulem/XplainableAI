...
/app/bin_gccgcc10_O2/2023_04_29-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	bf 08 00 00 00       	mov    $0x8,%edi
    108d:	e8 ce ff ff ff       	callq  1060 <malloc@plt>
    1092:	b9 73 00 00 00       	mov    $0x73,%ecx
    1097:	48 8d 15 66 0f 00 00 	lea    0xf66(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    109e:	49 89 c0             	mov    %rax,%r8
    10a1:	eb 08                	jmp    10ab <main+0x2b>
    10a3:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10a8:	0f b6 0a             	movzbl (%rdx),%ecx
    10ab:	48 83 c0 01          	add    $0x1,%rax
    10af:	48 83 c2 01          	add    $0x1,%rdx
    10b3:	88 48 ff             	mov    %cl,-0x1(%rax)
    10b6:	84 c9                	test   %cl,%cl
    10b8:	75 ee                	jne    10a8 <main+0x28>
    10ba:	4c 89 c2             	mov    %r8,%rdx
    10bd:	48 8d 35 48 0f 00 00 	lea    0xf48(%rip),%rsi        # 200c <_IO_stdin_used+0xc>
