...
/app/bin_gccgcc10_O1/2023_12_09-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1185:	c7 04 24 0a 00 00 00 	movl   $0xa,(%rsp)
    118c:	c7 44 24 04 14 00 00 	movl   $0x14,0x4(%rsp)
    1193:	00 
    1194:	c7 44 24 08 1e 00 00 	movl   $0x1e,0x8(%rsp)
    119b:	00 
    119c:	c7 44 24 0c 28 00 00 	movl   $0x28,0xc(%rsp)
    11a3:	00 
    11a4:	c7 44 24 10 32 00 00 	movl   $0x32,0x10(%rsp)
    11ab:	00 
    11ac:	c7 44 24 14 3c 00 00 	movl   $0x3c,0x14(%rsp)
    11b3:	00 
    11b4:	48 89 e3             	mov    %rsp,%rbx
    11b7:	4c 8d 64 24 18       	lea    0x18(%rsp),%r12
    11bc:	48 8d 2d 41 0e 00 00 	lea    0xe41(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
