...
/app/bin_gccgcc10_O1/subdir01:     file format elf64-x86-64
...
0000000000001249 <main>:
    ...
    124f:	55                   	push   %rbp
    1250:	53                   	push   %rbx
    1251:	48 81 ec a0 00 00 00 	sub    $0xa0,%rsp
    1258:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    125f:	00 00 
    1261:	48 89 84 24 98 00 00 	mov    %rax,0x98(%rsp)
    1268:	00 
    1269:	31 c0                	xor    %eax,%eax
    126b:	83 ff 01             	cmp    $0x1,%edi
    126e:	7e 6c                	jle    12dc <main+0x93>
    1270:	48 8b 5e 08          	mov    0x8(%rsi),%rbx
    1274:	48 89 df             	mov    %rbx,%rdi
    1277:	e8 54 fe ff ff       	callq  10d0 <opendir@plt>
    127c:	48 89 c5             	mov    %rax,%rbp
    127f:	48 85 c0             	test   %rax,%rax
    1282:	74 7f                	je     1303 <main+0xba>
    1284:	49 89 e4             	mov    %rsp,%r12
    1287:	48 89 ef             	mov    %rbp,%rdi
    128a:	e8 81 fe ff ff       	callq  1110 <readdir@plt>
    128f:	48 85 c0             	test   %rax,%rax
    1292:	0f 84 bf 00 00 00    	je     1357 <main+0x10e>
    1298:	48 8d 58 13          	lea    0x13(%rax),%rbx
    129c:	4c 89 e2             	mov    %r12,%rdx
    129f:	48 89 de             	mov    %rbx,%rsi
    12a2:	bf 01 00 00 00       	mov    $0x1,%edi
    12a7:	e8 54 fe ff ff       	callq  1100 <__xstat@plt>
    12ac:	83 f8 ff             	cmp    $0xffffffff,%eax
    12af:	74 7c                	je     132d <main+0xe4>
    12b1:	8b 44 24 18          	mov    0x18(%rsp),%eax
    12b5:	25 00 f0 00 00       	and    $0xf000,%eax
    12ba:	3d 00 40 00 00       	cmp    $0x4000,%eax
    12bf:	75 c6                	jne    1287 <main+0x3e>
    12c1:	48 89 da             	mov    %rbx,%rdx
    12c4:	48 8d 35 60 0d 00 00 	lea    0xd60(%rip),%rsi        # 202b <_IO_stdin_used+0x2b>
    12cb:	bf 01 00 00 00       	mov    $0x1,%edi
    12d0:	b8 00 00 00 00       	mov    $0x0,%eax
    12d5:	e8 46 fe ff ff       	callq  1120 <__printf_chk@plt>
    12da:	eb ab                	jmp    1287 <main+0x3e>
    12dc:	48 8b 0d 3d 2d 00 00 	mov    0x2d3d(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    12e3:	ba 17 00 00 00       	mov    $0x17,%edx
    12e8:	be 01 00 00 00       	mov    $0x1,%esi
    12ed:	48 8d 3d 10 0d 00 00 	lea    0xd10(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    12f4:	e8 47 fe ff ff       	callq  1140 <fwrite@plt>
    12f9:	bf 01 00 00 00       	mov    $0x1,%edi
    12fe:	e8 2d fe ff ff       	callq  1130 <exit@plt>
    1303:	48 89 d9             	mov    %rbx,%rcx
    1306:	48 8d 15 33 0d 00 00 	lea    0xd33(%rip),%rdx        # 2040 <_IO_stdin_used+0x40>
    130d:	be 01 00 00 00       	mov    $0x1,%esi
    1312:	48 8b 3d 07 2d 00 00 	mov    0x2d07(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    1319:	b8 00 00 00 00       	mov    $0x0,%eax
    131e:	e8 2d fe ff ff       	callq  1150 <__fprintf_chk@plt>
    1323:	bf 01 00 00 00       	mov    $0x1,%edi
    1328:	e8 03 fe ff ff       	callq  1130 <exit@plt>
    132d:	48 89 d9             	mov    %rbx,%rcx
    1330:	48 8d 15 e5 0c 00 00 	lea    0xce5(%rip),%rdx        # 201c <_IO_stdin_used+0x1c>
    ...
    1348:	e8 03 fe ff ff       	callq  1150 <__fprintf_chk@plt>
    134d:	bf 01 00 00 00       	mov    $0x1,%edi
    1352:	e8 d9 fd ff ff       	callq  1130 <exit@plt>
    1357:	48 89 ef             	mov    %rbp,%rdi
    135a:	e8 91 fd ff ff       	callq  10f0 <closedir@plt>
    135f:	48 8b 84 24 98 00 00 	mov    0x98(%rsp),%rax
    1366:	00 
    1367:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    136e:	00 00 
    1370:	75 11                	jne    1383 <main+0x13a>
    1372:	b8 00 00 00 00       	mov    $0x0,%eax
    1377:	48 81 c4 a0 00 00 00 	add    $0xa0,%rsp
    137e:	5b                   	pop    %rbx
    137f:	5d                   	pop    %rbp
    1380:	41 5c                	pop    %r12
    1382:	c3                   	retq   
    1383:	e8 58 fd ff ff       	callq  10e0 <__stack_chk_fail@plt>
