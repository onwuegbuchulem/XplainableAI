...
/app/bin_gccgcc10_O0/04_logical:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1175:	c7 45 f8 01 00 00 00 	movl   $0x1,-0x8(%rbp)
    117c:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%rbp)
    1183:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
    1187:	74 0d                	je     1196 <main+0x2d>
    1189:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    118d:	74 07                	je     1196 <main+0x2d>
    118f:	b8 01 00 00 00       	mov    $0x1,%eax
    1194:	eb 05                	jmp    119b <main+0x32>
    ...
    11ae:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
    11b2:	75 06                	jne    11ba <main+0x51>
    11b4:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    11b8:	74 07                	je     11c1 <main+0x58>
    11ba:	b8 01 00 00 00       	mov    $0x1,%eax
    11bf:	eb 05                	jmp    11c6 <main+0x5d>
    11c1:	b8 00 00 00 00       	mov    $0x0,%eax
    11c6:	89 c6                	mov    %eax,%esi
    11c8:	48 8d 3d 51 0e 00 00 	lea    0xe51(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    11cf:	b8 00 00 00 00       	mov    $0x0,%eax
    11d4:	e8 97 fe ff ff       	callq  1070 <printf@plt>
    11d9:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
    11dd:	0f 94 c0             	sete   %al
    11e0:	0f b6 c0             	movzbl %al,%eax
    11e3:	89 c6                	mov    %eax,%esi
    11e5:	48 8d 3d 4f 0e 00 00 	lea    0xe4f(%rip),%rdi        # 203b <_IO_stdin_used+0x3b>
    11ec:	b8 00 00 00 00       	mov    $0x0,%eax
    11f1:	e8 7a fe ff ff       	callq  1070 <printf@plt>
    11f6:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
    11fa:	74 12                	je     120e <main+0xa5>
    11fc:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    1200:	74 0c                	je     120e <main+0xa5>
    1202:	48 8d 3d 4d 0e 00 00 	lea    0xe4d(%rip),%rdi        # 2056 <_IO_stdin_used+0x56>
    1209:	e8 52 fe ff ff       	callq  1060 <puts@plt>
    120e:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
    1212:	74 17                	je     122b <main+0xc2>
    1214:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    1218:	74 11                	je     122b <main+0xc2>
    121a:	48 8d 3d 35 0e 00 00 	lea    0xe35(%rip),%rdi        # 2056 <_IO_stdin_used+0x56>
