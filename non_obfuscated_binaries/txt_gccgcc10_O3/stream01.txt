...
/app/bin_gccgcc10_O3/stream01:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1094:	e8 c7 ff ff ff       	callq  1060 <__printf_chk@plt>
    1099:	48 8b 3d 70 2f 00 00 	mov    0x2f70(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    10a0:	e8 cb ff ff ff       	callq  1070 <getc@plt>
    10a5:	48 8d 35 58 0f 00 00 	lea    0xf58(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10ac:	bf 01 00 00 00       	mov    $0x1,%edi
    10b1:	41 89 c4             	mov    %eax,%r12d
    10b4:	31 c0                	xor    %eax,%eax
    10b6:	e8 a5 ff ff ff       	callq  1060 <__printf_chk@plt>
    10bb:	48 8b 3d 4e 2f 00 00 	mov    0x2f4e(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    10c2:	e8 a9 ff ff ff       	callq  1070 <getc@plt>
    10c7:	44 89 e2             	mov    %r12d,%edx
    10ca:	bf 01 00 00 00       	mov    $0x1,%edi
    10cf:	48 8d 35 3d 0f 00 00 	lea    0xf3d(%rip),%rsi        # 2013 <_IO_stdin_used+0x13>
    10d6:	89 c1                	mov    %eax,%ecx
    10d8:	31 c0                	xor    %eax,%eax
    10da:	e8 81 ff ff ff       	callq  1060 <__printf_chk@plt>
    10df:	31 c0                	xor    %eax,%eax
    10e1:	41 5c                	pop    %r12
    10e3:	c3                   	retq   
    10e4:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10eb:	00 00 00 
...
0000000000001120 <deregister_tm_clones>:
    ...
    1127:	48 8d 05 e2 2e 00 00 	lea    0x2ee2(%rip),%rax        # 4010 <stdin@@GLIBC_2.2.5>
...
0000000000001150 <register_tm_clones>:
    ...
    1157:	48 8d 35 b2 2e 00 00 	lea    0x2eb2(%rip),%rsi        # 4010 <stdin@@GLIBC_2.2.5>
