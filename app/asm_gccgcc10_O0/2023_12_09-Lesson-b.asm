...
/app/bin_gccgcc10_O0/2023_12_09-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	48 c7 45 e0 00 00 00 	movq   $0x0,-0x20(%rbp)
    118b:	00 
    118c:	48 c7 45 e8 00 00 00 	movq   $0x0,-0x18(%rbp)
    1193:	00 
    1194:	48 c7 45 f0 00 00 00 	movq   $0x0,-0x10(%rbp)
    119b:	00 
    119c:	c7 45 ec 28 00 00 00 	movl   $0x28,-0x14(%rbp)
    11a3:	c7 45 f0 32 00 00 00 	movl   $0x32,-0x10(%rbp)
    11aa:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
    11b1:	eb 20                	jmp    11d3 <main+0x6a>
    11b3:	8b 45 dc             	mov    -0x24(%rbp),%eax
    11b6:	48 98                	cltq   
    11b8:	8b 44 85 e0          	mov    -0x20(%rbp,%rax,4),%eax
    11bc:	89 c6                	mov    %eax,%esi
    11be:	48 8d 3d 3f 0e 00 00 	lea    0xe3f(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11c5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ca:	e8 a1 fe ff ff       	callq  1070 <printf@plt>
    11cf:	83 45 dc 01          	addl   $0x1,-0x24(%rbp)
    11d3:	83 7d dc 05          	cmpl   $0x5,-0x24(%rbp)
    11d7:	7e da                	jle    11b3 <main+0x4a>
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11e2:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11e9:	00 00 
    11eb:	74 05                	je     11f2 <main+0x89>
    11ed:	e8 6e fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    11f2:	c9                   	leaveq 
    11f3:	c3                   	retq   
