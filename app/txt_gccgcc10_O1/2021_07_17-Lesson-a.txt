...
/app/bin_gccgcc10_O1/2021_07_17-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119d:	00 00 00 
    11a0:	4c 8d 25 b9 0e 00 00 	lea    0xeb9(%rip),%r12        # 2060 <_IO_stdin_used+0x60>
    11a7:	eb 0c                	jmp    11b5 <main+0x2c>
    11a9:	48 8d 3d 54 0e 00 00 	lea    0xe54(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11b0:	e8 bb fe ff ff       	callq  1070 <puts@plt>
    11b5:	4c 89 e2             	mov    %r12,%rdx
    11b8:	48 89 de             	mov    %rbx,%rsi
    11bb:	89 ef                	mov    %ebp,%edi
    11bd:	e8 ce fe ff ff       	callq  1090 <getopt@plt>
    11c2:	83 f8 ff             	cmp    $0xffffffff,%eax
    11c5:	74 49                	je     1210 <main+0x87>
    11c7:	83 f8 61             	cmp    $0x61,%eax
    11ca:	74 dd                	je     11a9 <main+0x20>
    11cc:	83 f8 7a             	cmp    $0x7a,%eax
    11cf:	74 13                	je     11e4 <main+0x5b>
    11d1:	83 f8 3f             	cmp    $0x3f,%eax
    11d4:	74 1c                	je     11f2 <main+0x69>
    11d6:	48 8d 3d 72 0e 00 00 	lea    0xe72(%rip),%rdi        # 204f <_IO_stdin_used+0x4f>
    11dd:	e8 8e fe ff ff       	callq  1070 <puts@plt>
    11e2:	eb d1                	jmp    11b5 <main+0x2c>
    11e4:	48 8d 3d 30 0e 00 00 	lea    0xe30(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    11eb:	e8 80 fe ff ff       	callq  1070 <puts@plt>
    11f0:	eb c3                	jmp    11b5 <main+0x2c>
    11f2:	8b 15 28 2e 00 00    	mov    0x2e28(%rip),%edx        # 4020 <optopt@@GLIBC_2.2.5>
    11f8:	48 8d 35 33 0e 00 00 	lea    0xe33(%rip),%rsi        # 2032 <_IO_stdin_used+0x32>
    11ff:	bf 01 00 00 00       	mov    $0x1,%edi
    1204:	b8 00 00 00 00       	mov    $0x0,%eax
    1209:	e8 72 fe ff ff       	callq  1080 <__printf_chk@plt>
    120e:	eb a5                	jmp    11b5 <main+0x2c>
