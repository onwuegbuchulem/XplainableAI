...
/app/bin_gccgcc10_O2/2020_03_21-Lesson-a:     file format elf64-x86-64
...
0000000000001120 <main>:
    ...
    112d:	55                   	push   %rbp
    112e:	48 83 ec 28          	sub    $0x28,%rsp
    1132:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1139:	00 00 
    113b:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    1140:	48 b8 67 65 74 74 79 	movabs $0x7562737974746567,%rax
    1147:	73 62 75 
    114a:	4c 8d 64 24 09       	lea    0x9(%rsp),%r12
    114f:	c7 44 24 11 72 67 2e 	movl   $0x742e6772,0x11(%rsp)
    1156:	74 
    1157:	4c 89 e7             	mov    %r12,%rdi
    115a:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    115f:	48 89 44 24 09       	mov    %rax,0x9(%rsp)
    1164:	b8 78 74 00 00       	mov    $0x7478,%eax
    1169:	66 89 44 24 15       	mov    %ax,0x15(%rsp)
    116e:	e8 8d ff ff ff       	callq  1100 <fopen@plt>
    1173:	48 89 c5             	mov    %rax,%rbp
    1176:	48 85 c0             	test   %rax,%rax
    1179:	75 20                	jne    119b <main+0x7b>
    117b:	eb 4c                	jmp    11c9 <main+0xa9>
    117d:	0f 1f 00             	nopl   (%rax)
    1180:	48 89 ef             	mov    %rbp,%rdi
    1183:	e8 48 ff ff ff       	callq  10d0 <fgetc@plt>
    1188:	89 c7                	mov    %eax,%edi
    118a:	83 f8 ff             	cmp    $0xffffffff,%eax
    118d:	74 18                	je     11a7 <main+0x87>
    118f:	48 8b 35 8a 2e 00 00 	mov    0x2e8a(%rip),%rsi        # 4020 <stdout@@GLIBC_2.2.5>
    1196:	e8 45 ff ff ff       	callq  10e0 <fputc@plt>
    119b:	48 89 ef             	mov    %rbp,%rdi
    119e:	e8 4d ff ff ff       	callq  10f0 <feof@plt>
    11a3:	85 c0                	test   %eax,%eax
    11a5:	74 d9                	je     1180 <main+0x60>
    11a7:	48 89 ef             	mov    %rbp,%rdi
    11aa:	e8 01 ff ff ff       	callq  10b0 <fclose@plt>
    11af:	31 c0                	xor    %eax,%eax
    11b1:	48 8b 54 24 18       	mov    0x18(%rsp),%rdx
    11b6:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11bd:	00 00 
    11bf:	75 2c                	jne    11ed <main+0xcd>
    11c1:	48 83 c4 28          	add    $0x28,%rsp
    11c5:	5d                   	pop    %rbp
    11c6:	41 5c                	pop    %r12
    11c8:	c3                   	retq   
    11c9:	48 8b 3d 70 2e 00 00 	mov    0x2e70(%rip),%rdi        # 4040 <stderr@@GLIBC_2.2.5>
    11d0:	4c 89 e1             	mov    %r12,%rcx
    11d3:	be 01 00 00 00       	mov    $0x1,%esi
    11d8:	31 c0                	xor    %eax,%eax
    11da:	48 8d 15 25 0e 00 00 	lea    0xe25(%rip),%rdx        # 2006 <_IO_stdin_used+0x6>
    11e1:	e8 2a ff ff ff       	callq  1110 <__fprintf_chk@plt>
    11e6:	b8 01 00 00 00       	mov    $0x1,%eax
    11eb:	eb c4                	jmp    11b1 <main+0x91>
    11ed:	e8 ce fe ff ff       	callq  10c0 <__stack_chk_fail@plt>
