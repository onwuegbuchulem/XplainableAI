...
/app/bin_gccgcc10_O3/Positive_Negative_Number:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e2:	7f 43                	jg     1127 <main+0x87>
    10e4:	75 2c                	jne    1112 <main+0x72>
    10e6:	31 d2                	xor    %edx,%edx
    10e8:	48 8d 35 4b 0f 00 00 	lea    0xf4b(%rip),%rsi        # 203a <_IO_stdin_used+0x3a>
    10ef:	bf 01 00 00 00       	mov    $0x1,%edi
    10f4:	31 c0                	xor    %eax,%eax
    10f6:	e8 85 ff ff ff       	callq  1080 <__printf_chk@plt>
    10fb:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1100:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1107:	00 00 
    1109:	75 31                	jne    113c <main+0x9c>
    110b:	31 c0                	xor    %eax,%eax
    110d:	48 83 c4 18          	add    $0x18,%rsp
    1111:	c3                   	retq   
    1112:	48 8d 35 11 0f 00 00 	lea    0xf11(%rip),%rsi        # 202a <_IO_stdin_used+0x2a>
    1119:	bf 01 00 00 00       	mov    $0x1,%edi
    111e:	31 c0                	xor    %eax,%eax
    1120:	e8 5b ff ff ff       	callq  1080 <__printf_chk@plt>
    1125:	eb d4                	jmp    10fb <main+0x5b>
    1127:	48 8d 35 ec 0e 00 00 	lea    0xeec(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    112e:	bf 01 00 00 00       	mov    $0x1,%edi
    1133:	31 c0                	xor    %eax,%eax
    1135:	e8 46 ff ff ff       	callq  1080 <__printf_chk@plt>
    113a:	eb bf                	jmp    10fb <main+0x5b>
