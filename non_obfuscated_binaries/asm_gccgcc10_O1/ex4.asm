...
/app/bin_gccgcc10_O1/ex4:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	48 8d 35 ac 0e 00 00 	lea    0xeac(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1158:	bf 01 00 00 00       	mov    $0x1,%edi
    115d:	b8 00 00 00 00       	mov    $0x0,%eax
    1162:	e8 e9 fe ff ff       	callq  1050 <__printf_chk@plt>
    1167:	ba 00 00 00 00       	mov    $0x0,%edx
    116c:	48 8d 35 a5 0e 00 00 	lea    0xea5(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    1173:	bf 01 00 00 00       	mov    $0x1,%edi
    1178:	b8 00 00 00 00       	mov    $0x0,%eax
    117d:	e8 ce fe ff ff       	callq  1050 <__printf_chk@plt>
