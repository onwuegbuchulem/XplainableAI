...
/app/bin_gccgcc10_O1/05_reading_cbyc:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119a:	48 8d 3d 65 0e 00 00 	lea    0xe65(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    11a1:	e8 ea fe ff ff       	callq  1090 <fopen@plt>
    11a6:	48 89 c5             	mov    %rax,%rbp
    11a9:	48 89 ef             	mov    %rbp,%rdi
    11ac:	e8 cf fe ff ff       	callq  1080 <fgetc@plt>
    11b1:	89 c3                	mov    %eax,%ebx
    11b3:	0f be f8             	movsbl %al,%edi
    11b6:	e8 b5 fe ff ff       	callq  1070 <putchar@plt>
    11bb:	80 fb ff             	cmp    $0xff,%bl
    11be:	75 e9                	jne    11a9 <main+0x20>
