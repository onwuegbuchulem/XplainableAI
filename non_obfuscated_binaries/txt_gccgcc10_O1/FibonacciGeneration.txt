...
/app/bin_gccgcc10_O1/FibonacciGeneration:     file format elf64-x86-64
...
0000000000001149 <fib>:
    ...
    1152:	7e 23                	jle    1177 <fib+0x2e>
    1154:	55                   	push   %rbp
    1155:	53                   	push   %rbx
    1156:	48 83 ec 08          	sub    $0x8,%rsp
    115a:	89 fb                	mov    %edi,%ebx
    115c:	8d 7f ff             	lea    -0x1(%rdi),%edi
    115f:	e8 e5 ff ff ff       	callq  1149 <fib>
    1164:	89 c5                	mov    %eax,%ebp
    1166:	8d 7b fe             	lea    -0x2(%rbx),%edi
    1169:	e8 db ff ff ff       	callq  1149 <fib>
    116e:	01 e8                	add    %ebp,%eax
...
0000000000001178 <main>:
    ...
    1180:	bf 0b 00 00 00       	mov    $0xb,%edi
    1185:	e8 bf ff ff ff       	callq  1149 <fib>
