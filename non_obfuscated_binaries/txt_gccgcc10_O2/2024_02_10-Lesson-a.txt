...
/app/bin_gccgcc10_O2/2024_02_10-Lesson-a:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1064:	48 8b 05 b5 2f 00 00 	mov    0x2fb5(%rip),%rax        # 4020 <__environ@@GLIBC_2.2.5>
    106b:	48 8b 38             	mov    (%rax),%rdi
    106e:	48 85 ff             	test   %rdi,%rdi
    1071:	74 34                	je     10a7 <main+0x47>
    1073:	48 83 ec 08          	sub    $0x8,%rsp
    1077:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    107e:	00 00 
    1080:	e8 cb ff ff ff       	callq  1050 <puts@plt>
    1085:	48 8b 05 94 2f 00 00 	mov    0x2f94(%rip),%rax        # 4020 <__environ@@GLIBC_2.2.5>
    108c:	48 8b 78 08          	mov    0x8(%rax),%rdi
    1090:	48 8d 50 08          	lea    0x8(%rax),%rdx
    1094:	48 89 15 85 2f 00 00 	mov    %rdx,0x2f85(%rip)        # 4020 <__environ@@GLIBC_2.2.5>
    109b:	48 85 ff             	test   %rdi,%rdi
    109e:	75 e0                	jne    1080 <main+0x20>
...
0000000000001150 <__do_global_dtors_aux>:
    ...
    1154:	80 3d cd 2e 00 00 00 	cmpb   $0x0,0x2ecd(%rip)        # 4028 <completed.0>
    ...
    117c:	c6 05 a5 2e 00 00 01 	movb   $0x1,0x2ea5(%rip)        # 4028 <completed.0>
    1183:	5d                   	pop    %rbp
    1184:	c3                   	retq   
