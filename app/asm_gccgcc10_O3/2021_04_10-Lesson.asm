...
/app/bin_gccgcc10_O3/2021_04_10-Lesson:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1068:	66 0f ef c0          	pxor   %xmm0,%xmm0
    106c:	bf 01 00 00 00       	mov    $0x1,%edi
    1071:	b8 01 00 00 00       	mov    $0x1,%eax
    1076:	48 8d 35 87 0f 00 00 	lea    0xf87(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    107d:	e8 ce ff ff ff       	callq  1050 <__printf_chk@plt>
    1082:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1086:	bf 01 00 00 00       	mov    $0x1,%edi
    108b:	48 8d 35 8e 0f 00 00 	lea    0xf8e(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    1092:	b8 01 00 00 00       	mov    $0x1,%eax
    1097:	e8 b4 ff ff ff       	callq  1050 <__printf_chk@plt>
    109c:	66 0f ef c0          	pxor   %xmm0,%xmm0
    10a0:	bf 01 00 00 00       	mov    $0x1,%edi
    10a5:	48 8d 35 94 0f 00 00 	lea    0xf94(%rip),%rsi        # 2040 <_IO_stdin_used+0x40>
    10ac:	b8 01 00 00 00       	mov    $0x1,%eax
