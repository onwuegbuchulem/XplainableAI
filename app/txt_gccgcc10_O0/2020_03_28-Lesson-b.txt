...
/app/bin_gccgcc10_O0/2020_03_28-Lesson-b:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    127c:	e8 6f fe ff ff       	callq  10f0 <fprintf@plt>
    1281:	b8 01 00 00 00       	mov    $0x1,%eax
    1286:	eb 6a                	jmp    12f2 <main+0xe9>
    1288:	48 8d 4d e8          	lea    -0x18(%rbp),%rcx
    128c:	8b 45 dc             	mov    -0x24(%rbp),%eax
    128f:	ba 01 00 00 00       	mov    $0x1,%edx
    1294:	48 89 ce             	mov    %rcx,%rsi
    1297:	89 c7                	mov    %eax,%edi
    1299:	e8 42 fe ff ff       	callq  10e0 <read@plt>
    129e:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    12a2:	48 83 7d e0 00       	cmpq   $0x0,-0x20(%rbp)
    12a7:	74 39                	je     12e2 <main+0xd9>
    12a9:	48 83 7d e0 ff       	cmpq   $0xffffffffffffffff,-0x20(%rbp)
    12ae:	75 22                	jne    12d2 <main+0xc9>
    12b0:	48 8b 05 69 2d 00 00 	mov    0x2d69(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    12b7:	48 89 c1             	mov    %rax,%rcx
    12ba:	ba 10 00 00 00       	mov    $0x10,%edx
    12bf:	be 01 00 00 00       	mov    $0x1,%esi
    12c4:	48 8d 3d 4c 0d 00 00 	lea    0xd4c(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    12cb:	e8 40 fe ff ff       	callq  1110 <fwrite@plt>
    12d0:	eb 11                	jmp    12e3 <main+0xda>
    12d2:	0f b6 45 e8          	movzbl -0x18(%rbp),%eax
    12d6:	0f be c0             	movsbl %al,%eax
    12d9:	89 c7                	mov    %eax,%edi
    12db:	e8 d0 fd ff ff       	callq  10b0 <putchar@plt>
    12e0:	eb a6                	jmp    1288 <main+0x7f>
    12e2:	90                   	nop
    12e3:	8b 45 dc             	mov    -0x24(%rbp),%eax
    12e6:	89 c7                	mov    %eax,%edi
    12e8:	e8 e3 fd ff ff       	callq  10d0 <close@plt>
    12ed:	b8 00 00 00 00       	mov    $0x0,%eax
    12f2:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    12f6:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    12fd:	00 00 
    12ff:	74 05                	je     1306 <main+0xfd>
