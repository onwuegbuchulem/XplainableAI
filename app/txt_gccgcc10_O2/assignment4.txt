...
/app/bin_gccgcc10_O2/assignment4:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e7:	48 8d 35 3c 0f 00 00 	lea    0xf3c(%rip),%rsi        # 202a <_IO_stdin_used+0x2a>
    10ee:	b8 01 00 00 00       	mov    $0x1,%eax
    10f3:	f3 0f 59 c0          	mulss  %xmm0,%xmm0
    10f7:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    10fb:	f2 0f 59 05 45 0f 00 	mulsd  0xf45(%rip),%xmm0        # 2048 <_IO_stdin_used+0x48>
    1102:	00 
    1103:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    1107:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
