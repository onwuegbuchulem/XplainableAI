...
/app/bin_gccgcc10_O0/SquareCubeNumber:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11cd:	8b 55 ec             	mov    -0x14(%rbp),%edx
    11d0:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11d3:	0f af c2             	imul   %edx,%eax
    11d6:	89 45 f0             	mov    %eax,-0x10(%rbp)
    11d9:	8b 55 ec             	mov    -0x14(%rbp),%edx
    11dc:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11df:	0f af d0             	imul   %eax,%edx
    11e2:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11e5:	0f af c2             	imul   %edx,%eax
    11e8:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11eb:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11ee:	89 c6                	mov    %eax,%esi
    11f0:	48 8d 3d 23 0e 00 00 	lea    0xe23(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    11f7:	b8 00 00 00 00       	mov    $0x0,%eax
    11fc:	e8 7f fe ff ff       	callq  1080 <printf@plt>
