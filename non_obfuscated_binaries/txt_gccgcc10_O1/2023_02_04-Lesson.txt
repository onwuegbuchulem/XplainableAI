...
/app/bin_gccgcc10_O1/2023_02_04-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a1:	48 89 e2             	mov    %rsp,%rdx
    11a4:	be 13 54 00 00       	mov    $0x5413,%esi
    11a9:	bf 01 00 00 00       	mov    $0x1,%edi
    11ae:	e8 cd fe ff ff       	callq  1080 <ioctl@plt>
    11b3:	0f b7 4c 24 02       	movzwl 0x2(%rsp),%ecx
    11b8:	0f b7 14 24          	movzwl (%rsp),%edx
    11bc:	48 8d 35 45 0e 00 00 	lea    0xe45(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    11c3:	bf 01 00 00 00       	mov    $0x1,%edi
    11c8:	b8 00 00 00 00       	mov    $0x0,%eax
    11cd:	e8 be fe ff ff       	callq  1090 <__printf_chk@plt>
    11d2:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11d7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11de:	00 00 
    11e0:	75 0a                	jne    11ec <main+0x63>
    11e2:	b8 00 00 00 00       	mov    $0x0,%eax
    11e7:	48 83 c4 18          	add    $0x18,%rsp
    11eb:	c3                   	retq   
    11ec:	e8 7f fe ff ff       	callq  1070 <__stack_chk_fail@plt>
