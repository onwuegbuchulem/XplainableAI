...
/app/bin_gccgcc10_O1/AreaAndCircumference:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11e3:	66 0f ef d2          	pxor   %xmm2,%xmm2
    11e7:	f3 0f 5a 54 24 04    	cvtss2sd 0x4(%rsp),%xmm2
    11ed:	66 0f 28 ca          	movapd %xmm2,%xmm1
    11f1:	f2 0f 59 0d 3f 0e 00 	mulsd  0xe3f(%rip),%xmm1        # 2038 <_IO_stdin_used+0x38>
    11f8:	00 
    11f9:	f2 0f 5a c9          	cvtsd2ss %xmm1,%xmm1
    11fd:	66 0f 28 c2          	movapd %xmm2,%xmm0
    1201:	f2 0f 59 05 37 0e 00 	mulsd  0xe37(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    1208:	00 
    1209:	f2 0f 59 c2          	mulsd  %xmm2,%xmm0
    120d:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    1211:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1215:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
    1219:	48 8d 35 f8 0d 00 00 	lea    0xdf8(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    1220:	bf 01 00 00 00       	mov    $0x1,%edi
    1225:	b8 02 00 00 00       	mov    $0x2,%eax
    ...
    123b:	00 00 
    123d:	75 0a                	jne    1249 <main+0xa0>
    123f:	b8 00 00 00 00       	mov    $0x0,%eax
    1244:	48 83 c4 18          	add    $0x18,%rsp
    1248:	c3                   	retq   
    1249:	e8 42 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
