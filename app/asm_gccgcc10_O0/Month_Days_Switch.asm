...
/app/bin_gccgcc10_O0/Month_Days_Switch:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11dc:	48 8d 3d 44 0e 00 00 	lea    0xe44(%rip),%rdi        # 2027 <_IO_stdin_used+0x27>
    11e3:	b8 00 00 00 00       	mov    $0x0,%eax
    11e8:	e8 c3 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11ed:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11f0:	83 f8 0c             	cmp    $0xc,%eax
    11f3:	77 5c                	ja     1251 <main+0xa8>
    11f5:	89 c0                	mov    %eax,%eax
    11f7:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
    11fe:	00 
    11ff:	48 8d 05 72 0e 00 00 	lea    0xe72(%rip),%rax        # 2078 <_IO_stdin_used+0x78>
    1206:	8b 04 02             	mov    (%rdx,%rax,1),%eax
    1209:	48 98                	cltq   
    120b:	48 8d 15 66 0e 00 00 	lea    0xe66(%rip),%rdx        # 2078 <_IO_stdin_used+0x78>
    1212:	48 01 d0             	add    %rdx,%rax
    1215:	3e ff e0             	notrack jmpq *%rax
    1218:	48 8d 3d 0b 0e 00 00 	lea    0xe0b(%rip),%rdi        # 202a <_IO_stdin_used+0x2a>
    121f:	b8 00 00 00 00       	mov    $0x0,%eax
    1224:	e8 77 fe ff ff       	callq  10a0 <printf@plt>
    1229:	eb 32                	jmp    125d <main+0xb4>
    122b:	48 8d 3d 01 0e 00 00 	lea    0xe01(%rip),%rdi        # 2033 <_IO_stdin_used+0x33>
    1232:	b8 00 00 00 00       	mov    $0x0,%eax
    1237:	e8 64 fe ff ff       	callq  10a0 <printf@plt>
    123c:	eb 1f                	jmp    125d <main+0xb4>
    123e:	48 8d 3d f7 0d 00 00 	lea    0xdf7(%rip),%rdi        # 203c <_IO_stdin_used+0x3c>
    1245:	b8 00 00 00 00       	mov    $0x0,%eax
    124a:	e8 51 fe ff ff       	callq  10a0 <printf@plt>
    124f:	eb 0c                	jmp    125d <main+0xb4>
    1251:	48 8d 3d f0 0d 00 00 	lea    0xdf0(%rip),%rdi        # 2048 <_IO_stdin_used+0x48>
    1258:	e8 23 fe ff ff       	callq  1080 <puts@plt>
    125d:	b8 00 00 00 00       	mov    $0x0,%eax
    1262:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1266:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    126d:	00 00 
    126f:	74 05                	je     1276 <main+0xcd>
    1271:	e8 1a fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    1276:	c9                   	leaveq 
    1277:	c3                   	retq   
