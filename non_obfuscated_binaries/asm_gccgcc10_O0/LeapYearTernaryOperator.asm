...
/app/bin_gccgcc10_O0/LeapYearTernaryOperator:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d7:	48 8d 3d 53 0e 00 00 	lea    0xe53(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 c8 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e8:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11eb:	48 63 c2             	movslq %edx,%rax
    11ee:	48 69 c0 1f 85 eb 51 	imul   $0x51eb851f,%rax,%rax
    11f5:	48 c1 e8 20          	shr    $0x20,%rax
    11f9:	c1 f8 05             	sar    $0x5,%eax
    11fc:	89 d1                	mov    %edx,%ecx
    11fe:	c1 f9 1f             	sar    $0x1f,%ecx
    1201:	29 c8                	sub    %ecx,%eax
    1203:	6b c8 64             	imul   $0x64,%eax,%ecx
    1206:	89 d0                	mov    %edx,%eax
    1208:	29 c8                	sub    %ecx,%eax
    120a:	85 c0                	test   %eax,%eax
    120c:	74 0a                	je     1218 <main+0x6f>
    120e:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1211:	83 e0 03             	and    $0x3,%eax
    1214:	85 c0                	test   %eax,%eax
    1216:	74 29                	je     1241 <main+0x98>
    1218:	8b 55 f4             	mov    -0xc(%rbp),%edx
    121b:	48 63 c2             	movslq %edx,%rax
    121e:	48 69 c0 1f 85 eb 51 	imul   $0x51eb851f,%rax,%rax
    1225:	48 c1 e8 20          	shr    $0x20,%rax
    1229:	c1 f8 07             	sar    $0x7,%eax
    122c:	89 d1                	mov    %edx,%ecx
    122e:	c1 f9 1f             	sar    $0x1f,%ecx
    1231:	29 c8                	sub    %ecx,%eax
    1233:	69 c8 90 01 00 00    	imul   $0x190,%eax,%ecx
    1239:	89 d0                	mov    %edx,%eax
    123b:	29 c8                	sub    %ecx,%eax
    123d:	85 c0                	test   %eax,%eax
    123f:	75 18                	jne    1259 <main+0xb0>
    ...
    1257:	eb 16                	jmp    126f <main+0xc6>
    1259:	8b 45 f4             	mov    -0xc(%rbp),%eax
    125c:	89 c6                	mov    %eax,%esi
    125e:	48 8d 3d df 0d 00 00 	lea    0xddf(%rip),%rdi        # 2044 <_IO_stdin_used+0x44>
    1265:	b8 00 00 00 00       	mov    $0x0,%eax
    126a:	e8 31 fe ff ff       	callq  10a0 <printf@plt>
    126f:	b8 00 00 00 00       	mov    $0x0,%eax
    1274:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    1278:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    127f:	00 00 
    1281:	74 05                	je     1288 <main+0xdf>
    1283:	e8 08 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    1288:	c9                   	leaveq 
    1289:	c3                   	retq   
