...
/app/bin_gccgcc10_O1/2019_07_27-Lesson:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c1:	48 89 e6             	mov    %rsp,%rsi
    11c4:	bf 02 00 00 00       	mov    $0x2,%edi
    11c9:	e8 e2 fe ff ff       	callq  10b0 <getrlimit@plt>
    11ce:	83 f8 ff             	cmp    $0xffffffff,%eax
    11d1:	74 4f                	je     1222 <main+0x79>
    11d3:	48 8b 14 24          	mov    (%rsp),%rdx
    11d7:	48 8d 35 3a 0e 00 00 	lea    0xe3a(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    11de:	bf 01 00 00 00       	mov    $0x1,%edi
    11e3:	b8 00 00 00 00       	mov    $0x0,%eax
    11e8:	e8 a3 fe ff ff       	callq  1090 <__printf_chk@plt>
    11ed:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    11f2:	48 8d 35 47 0e 00 00 	lea    0xe47(%rip),%rsi        # 2040 <_IO_stdin_used+0x40>
    11f9:	bf 01 00 00 00       	mov    $0x1,%edi
    11fe:	b8 00 00 00 00       	mov    $0x0,%eax
    1203:	e8 88 fe ff ff       	callq  1090 <__printf_chk@plt>
    1208:	b8 00 00 00 00       	mov    $0x0,%eax
    120d:	48 8b 4c 24 18       	mov    0x18(%rsp),%rcx
    1212:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1219:	00 00 
    121b:	75 29                	jne    1246 <main+0x9d>
    121d:	48 83 c4 28          	add    $0x28,%rsp
    1221:	c3                   	retq   
    1222:	48 8b 0d f7 2d 00 00 	mov    0x2df7(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1229:	ba 11 00 00 00       	mov    $0x11,%edx
    122e:	be 01 00 00 00       	mov    $0x1,%esi
    1233:	48 8d 3d ca 0d 00 00 	lea    0xdca(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    123a:	e8 61 fe ff ff       	callq  10a0 <fwrite@plt>
    123f:	b8 01 00 00 00       	mov    $0x1,%eax
    1244:	eb c7                	jmp    120d <main+0x64>
