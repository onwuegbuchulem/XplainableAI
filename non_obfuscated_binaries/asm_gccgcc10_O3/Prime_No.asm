...
/app/bin_gccgcc10_O3/Prime_No:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e1:	41 83 f8 02          	cmp    $0x2,%r8d
    10e5:	7e 23                	jle    110a <main+0x6a>
    10e7:	41 f6 c0 01          	test   $0x1,%r8b
    10eb:	74 48                	je     1135 <main+0x95>
    10ed:	b9 02 00 00 00       	mov    $0x2,%ecx
    10f2:	eb 0e                	jmp    1102 <main+0x62>
    10f4:	0f 1f 40 00          	nopl   0x0(%rax)
    10f8:	44 89 c0             	mov    %r8d,%eax
    10fb:	99                   	cltd   
    10fc:	f7 f9                	idiv   %ecx
    10fe:	85 d2                	test   %edx,%edx
    1100:	74 33                	je     1135 <main+0x95>
    1102:	83 c1 01             	add    $0x1,%ecx
    1105:	44 39 c1             	cmp    %r8d,%ecx
    1108:	75 ee                	jne    10f8 <main+0x58>
    110a:	44 89 c2             	mov    %r8d,%edx
    110d:	48 8d 35 18 0f 00 00 	lea    0xf18(%rip),%rsi        # 202c <_IO_stdin_used+0x2c>
    ...
    112c:	00 00 
    112e:	75 1a                	jne    114a <main+0xaa>
    1130:	48 83 c4 18          	add    $0x18,%rsp
    1134:	c3                   	retq   
    1135:	48 8d 35 dd 0e 00 00 	lea    0xedd(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    113c:	bf 01 00 00 00       	mov    $0x1,%edi
    1141:	31 c0                	xor    %eax,%eax
    1143:	e8 38 ff ff ff       	callq  1080 <__printf_chk@plt>
    1148:	eb d6                	jmp    1120 <main+0x80>
    114a:	e8 21 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
    114f:	90                   	nop
