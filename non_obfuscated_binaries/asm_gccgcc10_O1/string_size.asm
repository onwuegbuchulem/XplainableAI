...
/app/bin_gccgcc10_O1/string_size:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a2:	48 b8 30 31 32 33 34 	movabs $0x3736353433323130,%rax
    11a9:	35 36 37 
    11ac:	48 89 44 24 0d       	mov    %rax,0xd(%rsp)
    11b1:	66 c7 44 24 15 38 39 	movw   $0x3938,0x15(%rsp)
    11b8:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    11bd:	48 8d 5c 24 0d       	lea    0xd(%rsp),%rbx
    11c2:	48 89 df             	mov    %rbx,%rdi
    11c5:	e8 a6 fe ff ff       	callq  1070 <strlen@plt>
    11ca:	48 89 c1             	mov    %rax,%rcx
    11cd:	48 89 da             	mov    %rbx,%rdx
    ...
    11e6:	b9 0b 00 00 00       	mov    $0xb,%ecx
    11eb:	48 89 da             	mov    %rbx,%rdx
    11ee:	48 8d 35 2b 0e 00 00 	lea    0xe2b(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    11f5:	bf 01 00 00 00       	mov    $0x1,%edi
    11fa:	b8 00 00 00 00       	mov    $0x0,%eax
    11ff:	e8 8c fe ff ff       	callq  1090 <__printf_chk@plt>
    1204:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1209:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1210:	00 00 
    1212:	75 0b                	jne    121f <main+0x96>
    1214:	b8 00 00 00 00       	mov    $0x0,%eax
    1219:	48 83 c4 20          	add    $0x20,%rsp
    121d:	5b                   	pop    %rbx
    121e:	c3                   	retq   
    121f:	e8 5c fe ff ff       	callq  1080 <__stack_chk_fail@plt>
