...
/app/bin_gccgcc10_O0/2021_01_30-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11c7:	e8 b4 fe ff ff       	callq  1080 <exit@plt>
    11cc:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    11d0:	48 8b 40 08          	mov    0x8(%rax),%rax
