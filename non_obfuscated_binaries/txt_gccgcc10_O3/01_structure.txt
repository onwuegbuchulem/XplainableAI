...
/app/bin_gccgcc10_O3/01_structure:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	ba 9f 11 00 00       	mov    $0x119f,%edx
    108d:	bf 01 00 00 00       	mov    $0x1,%edi
    1092:	f2 0f 10 05 76 0f 00 	movsd  0xf76(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    1099:	00 
    109a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10a1:	00 00 
    10a3:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10a8:	31 c0                	xor    %eax,%eax
    10aa:	b8 79 00 00 00       	mov    $0x79,%eax
    10af:	48 8d 4c 24 08       	lea    0x8(%rsp),%rcx
    10b4:	48 8d 35 49 0f 00 00 	lea    0xf49(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10bb:	66 89 44 24 0c       	mov    %ax,0xc(%rsp)
    10c0:	48 b8 9f 11 00 00 8f 	movabs $0x4259c28f0000119f,%rax
    10c7:	c2 59 42 
    10ca:	48 89 04 24          	mov    %rax,(%rsp)
    10ce:	b8 01 00 00 00       	mov    $0x1,%eax
    10d3:	c7 44 24 08 48 61 72 	movl   $0x72726148,0x8(%rsp)
    10da:	72 
    10db:	e8 90 ff ff ff       	callq  1070 <__printf_chk@plt>
    10e0:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10e5:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10ec:	00 00 
    10ee:	75 07                	jne    10f7 <main+0x77>
    10f0:	31 c0                	xor    %eax,%eax
    10f2:	48 83 c4 28          	add    $0x28,%rsp
    10f6:	c3                   	retq   
    10f7:	e8 64 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
