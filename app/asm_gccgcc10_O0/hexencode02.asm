...
/app/bin_gccgcc10_O0/hexencode02:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1195:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    ...
    11ae:	eb 54                	jmp    1204 <main+0x7b>
    11b0:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11b3:	89 c6                	mov    %eax,%esi
    11b5:	48 8d 3d 58 0e 00 00 	lea    0xe58(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    11bc:	b8 00 00 00 00       	mov    $0x0,%eax
    11c1:	e8 ba fe ff ff       	callq  1080 <printf@plt>
    11c6:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11c9:	01 45 f8             	add    %eax,-0x8(%rbp)
    11cc:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    11d0:	83 7d f4 12          	cmpl   $0x12,-0xc(%rbp)
    11d4:	75 2e                	jne    1204 <main+0x7b>
    11d6:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11d9:	99                   	cltd   
    11da:	c1 ea 18             	shr    $0x18,%edx
    11dd:	01 d0                	add    %edx,%eax
    11df:	0f b6 c0             	movzbl %al,%eax
    11e2:	29 d0                	sub    %edx,%eax
    11e4:	89 c6                	mov    %eax,%esi
    11e6:	48 8d 3d 2d 0e 00 00 	lea    0xe2d(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    11ed:	b8 00 00 00 00       	mov    $0x0,%eax
    11f2:	e8 89 fe ff ff       	callq  1080 <printf@plt>
    11f7:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    11fe:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1201:	89 45 f4             	mov    %eax,-0xc(%rbp)
    1204:	e8 87 fe ff ff       	callq  1090 <getchar@plt>
    1209:	89 45 fc             	mov    %eax,-0x4(%rbp)
    120c:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%rbp)
    1210:	75 9e                	jne    11b0 <main+0x27>
    1212:	83 7d f4 00          	cmpl   $0x0,-0xc(%rbp)
    1216:	7e 21                	jle    1239 <main+0xb0>
    1218:	8b 45 f8             	mov    -0x8(%rbp),%eax
    121b:	99                   	cltd   
    121c:	c1 ea 18             	shr    $0x18,%edx
    ...
    1234:	e8 47 fe ff ff       	callq  1080 <printf@plt>
    1239:	48 8d 3d e1 0d 00 00 	lea    0xde1(%rip),%rdi        # 2021 <_IO_stdin_used+0x21>
    1240:	e8 2b fe ff ff       	callq  1070 <puts@plt>
