...
/app/bin_gccgcc10_O1/2020_01_04-Lesson-a:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c3:	48 8d 6c 24 0c       	lea    0xc(%rsp),%rbp
    11c8:	41 b8 0d 00 00 00    	mov    $0xd,%r8d
    11ce:	48 8d 0d 2f 0e 00 00 	lea    0xe2f(%rip),%rcx        # 2004 <_IO_stdin_used+0x4>
    11d5:	ba 0c 00 00 00       	mov    $0xc,%edx
    11da:	be 01 00 00 00       	mov    $0x1,%esi
    11df:	48 89 ef             	mov    %rbp,%rdi
    11e2:	e8 c9 fe ff ff       	callq  10b0 <__sprintf_chk@plt>
    11e7:	89 c3                	mov    %eax,%ebx
    11e9:	48 89 ef             	mov    %rbp,%rdi
    11ec:	e8 8f fe ff ff       	callq  1080 <puts@plt>
    11f1:	89 da                	mov    %ebx,%edx
    11f3:	48 8d 35 1b 0e 00 00 	lea    0xe1b(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    11fa:	bf 01 00 00 00       	mov    $0x1,%edi
    11ff:	b8 00 00 00 00       	mov    $0x0,%eax
    1204:	e8 97 fe ff ff       	callq  10a0 <__printf_chk@plt>
    1209:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    120e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1215:	00 00 
    1217:	75 0c                	jne    1225 <main+0x7c>
    1219:	b8 00 00 00 00       	mov    $0x0,%eax
    121e:	48 83 c4 28          	add    $0x28,%rsp
    1222:	5b                   	pop    %rbx
    1223:	5d                   	pop    %rbp
    1224:	c3                   	retq   
