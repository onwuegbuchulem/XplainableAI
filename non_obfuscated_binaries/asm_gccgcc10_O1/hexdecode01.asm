...
/app/bin_gccgcc10_O1/hexdecode01:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a5:	bd 00 00 00 00       	mov    $0x0,%ebp
    11aa:	48 89 e3             	mov    %rsp,%rbx
    11ad:	41 89 ec             	mov    %ebp,%r12d
    11b0:	48 8b 3d 59 2e 00 00 	mov    0x2e59(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    11b7:	e8 d4 fe ff ff       	callq  1090 <getc@plt>
    11bc:	83 f8 ff             	cmp    $0xffffffff,%eax
    11bf:	74 3c                	je     11fd <main+0x74>
    11c1:	89 c1                	mov    %eax,%ecx
    11c3:	88 03                	mov    %al,(%rbx)
    11c5:	41 8d 54 24 01       	lea    0x1(%r12),%edx
    11ca:	48 83 c3 01          	add    $0x1,%rbx
    11ce:	83 f8 0a             	cmp    $0xa,%eax
    11d1:	74 0a                	je     11dd <main+0x54>
    11d3:	83 fa 37             	cmp    $0x37,%edx
    11d6:	74 05                	je     11dd <main+0x54>
    11d8:	41 89 d4             	mov    %edx,%r12d
    11db:	eb d3                	jmp    11b0 <main+0x27>
    11dd:	80 f9 0a             	cmp    $0xa,%cl
    11e0:	74 11                	je     11f3 <main+0x6a>
    11e2:	48 63 d2             	movslq %edx,%rdx
    11e5:	c6 04 14 00          	movb   $0x0,(%rsp,%rdx,1)
    11e9:	48 89 e7             	mov    %rsp,%rdi
    11ec:	e8 7f fe ff ff       	callq  1070 <puts@plt>
    11f1:	eb b7                	jmp    11aa <main+0x21>
    11f3:	4d 63 e4             	movslq %r12d,%r12
    11f6:	42 c6 04 24 00       	movb   $0x0,(%rsp,%r12,1)
    11fb:	eb ec                	jmp    11e9 <main+0x60>
    11fd:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1202:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1209:	00 00 
    120b:	75 0e                	jne    121b <main+0x92>
    120d:	b8 00 00 00 00       	mov    $0x0,%eax
    1212:	48 83 c4 40          	add    $0x40,%rsp
    1216:	5b                   	pop    %rbx
    1217:	5d                   	pop    %rbp
    1218:	41 5c                	pop    %r12
    121a:	c3                   	retq   
