...
/app/bin_gccgcc10_O2/2024_04-Exercise:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e2:	79 06                	jns    10ea <main+0x4a>
    10e4:	f7 da                	neg    %edx
    10e6:	89 54 24 04          	mov    %edx,0x4(%rsp)
    10ea:	31 c0                	xor    %eax,%eax
    10ec:	48 8d 35 27 0f 00 00 	lea    0xf27(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
