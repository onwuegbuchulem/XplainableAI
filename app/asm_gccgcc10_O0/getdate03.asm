...
/app/bin_gccgcc10_O0/getdate03:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1217:	48 8d 85 70 ff ff ff 	lea    -0x90(%rbp),%rax
    121e:	48 89 c7             	mov    %rax,%rdi
    1221:	e8 6a fe ff ff       	callq  1090 <mktime@plt>
    1226:	8b 45 88             	mov    -0x78(%rbp),%eax
    1229:	48 98                	cltq   
    122b:	48 8b 7c c5 b0       	mov    -0x50(%rbp,%rax,8),%rdi
    1230:	8b 45 84             	mov    -0x7c(%rbp),%eax
    1233:	8d 90 6c 07 00 00    	lea    0x76c(%rax),%edx
    1239:	8b 85 7c ff ff ff    	mov    -0x84(%rbp),%eax
    123f:	8b 4d 80             	mov    -0x80(%rbp),%ecx
    1242:	8d 71 01             	lea    0x1(%rcx),%esi
    1245:	49 89 f8             	mov    %rdi,%r8
    1248:	89 d1                	mov    %edx,%ecx
    124a:	89 c2                	mov    %eax,%edx
    124c:	48 8d 3d ea 0d 00 00 	lea    0xdea(%rip),%rdi        # 203d <_IO_stdin_used+0x3d>
    ...
    1266:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    126d:	00 00 
    126f:	74 05                	je     1276 <main+0xed>
