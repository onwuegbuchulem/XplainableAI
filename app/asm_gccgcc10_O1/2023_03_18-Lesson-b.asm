...
/app/bin_gccgcc10_O1/2023_03_18-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a3:	48 89 e7             	mov    %rsp,%rdi
    11a6:	e8 d5 fe ff ff       	callq  1080 <time@plt>
    11ab:	48 8b 2c 24          	mov    (%rsp),%rbp
    11af:	48 89 e3             	mov    %rsp,%rbx
    11b2:	48 89 df             	mov    %rbx,%rdi
    11b5:	e8 c6 fe ff ff       	callq  1080 <time@plt>
    11ba:	48 8b 14 24          	mov    (%rsp),%rdx
    11be:	48 39 ea             	cmp    %rbp,%rdx
    11c1:	74 ef                	je     11b2 <main+0x29>
    ...
    11d4:	e8 b7 fe ff ff       	callq  1090 <__printf_chk@plt>
    11d9:	48 8b 2c 24          	mov    (%rsp),%rbp
    11dd:	48 89 e3             	mov    %rsp,%rbx
    11e0:	48 89 df             	mov    %rbx,%rdi
    11e3:	e8 98 fe ff ff       	callq  1080 <time@plt>
    11e8:	48 8b 14 24          	mov    (%rsp),%rdx
    11ec:	48 39 ea             	cmp    %rbp,%rdx
    11ef:	74 ef                	je     11e0 <main+0x57>
    ...
    1202:	e8 89 fe ff ff       	callq  1090 <__printf_chk@plt>
    1207:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    120c:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1213:	00 00 
    1215:	75 0c                	jne    1223 <main+0x9a>
    1217:	b8 00 00 00 00       	mov    $0x0,%eax
    121c:	48 83 c4 18          	add    $0x18,%rsp
    1220:	5b                   	pop    %rbx
    1221:	5d                   	pop    %rbp
    1222:	c3                   	retq   
