...
/app/bin_gccgcc10_O1/2019_09_07-Lesson-b:     file format elf64-x86-64
...
00000000000010e0 <_start>:
    ...
    1101:	48 8d 3d ff 00 00 00 	lea    0xff(%rip),%rdi        # 1207 <main>
...
00000000000011c9 <draw>:
    11c9:	f3 0f 1e fa          	endbr64 
    11cd:	53                   	push   %rbx
    11ce:	48 89 fb             	mov    %rdi,%rbx
    11d1:	e8 fa fe ff ff       	callq  10d0 <rand@plt>
    11d6:	89 c2                	mov    %eax,%edx
    11d8:	48 98                	cltq   
    11da:	48 69 c0 4f ec c4 4e 	imul   $0x4ec4ec4f,%rax,%rax
    11e1:	48 c1 f8 24          	sar    $0x24,%rax
    11e5:	89 d1                	mov    %edx,%ecx
    11e7:	c1 f9 1f             	sar    $0x1f,%ecx
    11ea:	29 c8                	sub    %ecx,%eax
    11ec:	6b c8 34             	imul   $0x34,%eax,%ecx
    11ef:	89 d0                	mov    %edx,%eax
    11f1:	29 c8                	sub    %ecx,%eax
    11f3:	48 63 d0             	movslq %eax,%rdx
    11f6:	48 8d 14 93          	lea    (%rbx,%rdx,4),%rdx
    11fa:	83 3a 00             	cmpl   $0x0,(%rdx)
    11fd:	75 d2                	jne    11d1 <draw+0x8>
    11ff:	c7 02 01 00 00 00    	movl   $0x1,(%rdx)
    1205:	5b                   	pop    %rbx
    1206:	c3                   	retq   

0000000000001207 <main>:
    1207:	f3 0f 1e fa          	endbr64 
    120b:	48 81 ec e8 00 00 00 	sub    $0xe8,%rsp
    1212:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1219:	00 00 
    121b:	48 89 84 24 d8 00 00 	mov    %rax,0xd8(%rsp)
    1222:	00 
    1223:	31 c0                	xor    %eax,%eax
    1225:	bf 00 00 00 00       	mov    $0x0,%edi
    122a:	e8 81 fe ff ff       	callq  10b0 <time@plt>
    122f:	48 89 c7             	mov    %rax,%rdi
    1232:	e8 69 fe ff ff       	callq  10a0 <srand@plt>
    1237:	48 89 e0             	mov    %rsp,%rax
    123a:	48 8d 94 24 d0 00 00 	lea    0xd0(%rsp),%rdx
    1241:	00 
    1242:	c7 00 00 00 00 00    	movl   $0x0,(%rax)
    1248:	48 83 c0 04          	add    $0x4,%rax
    124c:	48 39 d0             	cmp    %rdx,%rax
    124f:	75 f1                	jne    1242 <main+0x3b>
    1251:	48 89 e7             	mov    %rsp,%rdi
    1254:	e8 70 ff ff ff       	callq  11c9 <draw>
    1259:	89 c2                	mov    %eax,%edx
    125b:	48 8d 35 a2 0d 00 00 	lea    0xda2(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1262:	bf 01 00 00 00       	mov    $0x1,%edi
    1267:	b8 00 00 00 00       	mov    $0x0,%eax
    126c:	e8 4f fe ff ff       	callq  10c0 <__printf_chk@plt>
    1271:	48 8b 84 24 d8 00 00 	mov    0xd8(%rsp),%rax
    1278:	00 
    1279:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1280:	00 00 
    1282:	75 0d                	jne    1291 <main+0x8a>
    1284:	b8 00 00 00 00       	mov    $0x0,%eax
    1289:	48 81 c4 e8 00 00 00 	add    $0xe8,%rsp
    1290:	c3                   	retq   
    1291:	e8 fa fd ff ff       	callq  1090 <__stack_chk_fail@plt>
