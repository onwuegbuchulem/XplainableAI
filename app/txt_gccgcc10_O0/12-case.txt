...
/app/bin_gccgcc10_O0/12-case:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1159:	eb 1b                	jmp    1176 <main+0x2d>
    115b:	0f b6 45 ff          	movzbl -0x1(%rbp),%eax
    115f:	83 c8 20             	or     $0x20,%eax
    1162:	0f be c0             	movsbl %al,%eax
    1165:	89 c7                	mov    %eax,%edi
    1167:	e8 e4 fe ff ff       	callq  1050 <putchar@plt>
    116c:	0f b6 45 ff          	movzbl -0x1(%rbp),%eax
    1170:	83 c0 01             	add    $0x1,%eax
    1173:	88 45 ff             	mov    %al,-0x1(%rbp)
    1176:	80 7d ff 5a          	cmpb   $0x5a,-0x1(%rbp)
    117a:	7e df                	jle    115b <main+0x12>
    117c:	bf 0a 00 00 00       	mov    $0xa,%edi
    1181:	e8 ca fe ff ff       	callq  1050 <putchar@plt>
    1186:	c6 45 ff 61          	movb   $0x61,-0x1(%rbp)
    118a:	eb 1a                	jmp    11a6 <main+0x5d>
    118c:	0f be 45 ff          	movsbl -0x1(%rbp),%eax
    1190:	25 df 00 00 00       	and    $0xdf,%eax
    1195:	89 c7                	mov    %eax,%edi
    1197:	e8 b4 fe ff ff       	callq  1050 <putchar@plt>
    119c:	0f b6 45 ff          	movzbl -0x1(%rbp),%eax
    11a0:	83 c0 01             	add    $0x1,%eax
    11a3:	88 45 ff             	mov    %al,-0x1(%rbp)
    11a6:	80 7d ff 7a          	cmpb   $0x7a,-0x1(%rbp)
    11aa:	7e e0                	jle    118c <main+0x43>
    11ac:	bf 0a 00 00 00       	mov    $0xa,%edi
    11b1:	e8 9a fe ff ff       	callq  1050 <putchar@plt>
