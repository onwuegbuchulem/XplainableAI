...
/app/bin_gccgcc10_O2/2019_07_06-Lesson:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	41 57                	push   %r15
    10a6:	ba 32 34 00 00       	mov    $0x3432,%edx
    10ab:	b9 32 42 00 00       	mov    $0x4232,%ecx
    ...
    10ce:	4c 8d 7c 24 03       	lea    0x3(%rsp),%r15
    10d3:	66 89 54 24 0e       	mov    %dx,0xe(%rsp)
    10d8:	b8 35 36 00 00       	mov    $0x3635,%eax
    10dd:	ba 0a 00 00 00       	mov    $0xa,%edx
    10e2:	4c 89 ff             	mov    %r15,%rdi
    10e5:	4c 8d 74 24 0a       	lea    0xa(%rsp),%r14
    10ea:	66 89 4c 24 15       	mov    %cx,0x15(%rsp)
    10ef:	4c 8d 6c 24 11       	lea    0x11(%rsp),%r13
    10f4:	c7 44 24 03 31 32 33 	movl   $0x34333231,0x3(%rsp)
    10fb:	34 
    10fc:	66 89 44 24 07       	mov    %ax,0x7(%rsp)
    1101:	c6 44 24 09 00       	movb   $0x0,0x9(%rsp)
    1106:	c7 44 24 0a 30 30 33 	movl   $0x32333030,0xa(%rsp)
    110d:	32 
    110e:	c6 44 24 10 00       	movb   $0x0,0x10(%rsp)
    1113:	c7 44 24 11 30 78 41 	movl   $0x37417830,0x11(%rsp)
    111a:	37 
    111b:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    1120:	e8 5b ff ff ff       	callq  1080 <strtol@plt>
    1125:	31 f6                	xor    %esi,%esi
    1127:	ba 08 00 00 00       	mov    $0x8,%edx
    112c:	4c 89 f7             	mov    %r14,%rdi
    112f:	49 89 c4             	mov    %rax,%r12
    1132:	e8 49 ff ff ff       	callq  1080 <strtol@plt>
    1137:	31 f6                	xor    %esi,%esi
    1139:	ba 10 00 00 00       	mov    $0x10,%edx
    113e:	4c 89 ef             	mov    %r13,%rdi
    1141:	48 89 c5             	mov    %rax,%rbp
    1144:	e8 37 ff ff ff       	callq  1080 <strtol@plt>
    1149:	44 89 e1             	mov    %r12d,%ecx
    114c:	4c 89 fa             	mov    %r15,%rdx
    114f:	bf 01 00 00 00       	mov    $0x1,%edi
    1154:	48 89 c3             	mov    %rax,%rbx
    ...
    1165:	89 e9                	mov    %ebp,%ecx
    1167:	4c 89 f2             	mov    %r14,%rdx
    116a:	bf 01 00 00 00       	mov    $0x1,%edi
    116f:	48 8d 35 a1 0e 00 00 	lea    0xea1(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    1176:	31 c0                	xor    %eax,%eax
    1178:	e8 13 ff ff ff       	callq  1090 <__printf_chk@plt>
    117d:	31 c0                	xor    %eax,%eax
    117f:	89 d9                	mov    %ebx,%ecx
    1181:	4c 89 ea             	mov    %r13,%rdx
    1184:	48 8d 35 9e 0e 00 00 	lea    0xe9e(%rip),%rsi        # 2029 <_IO_stdin_used+0x29>
    118b:	bf 01 00 00 00       	mov    $0x1,%edi
    1190:	e8 fb fe ff ff       	callq  1090 <__printf_chk@plt>
    1195:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    119a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11a1:	00 00 
    11a3:	75 11                	jne    11b6 <main+0x116>
    11a5:	48 83 c4 28          	add    $0x28,%rsp
    ...
    11b3:	41 5f                	pop    %r15
    11b5:	c3                   	retq   
    11b6:	e8 b5 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
