...
/app/bin_gccgcc10_O1/Simple_Interest:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b7:	48 8d 3d 87 0e 00 00 	lea    0xe87(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	48 8d 35 4c 0e 00 00 	lea    0xe4c(%rip),%rsi        # 201b <_IO_stdin_used+0x1b>
    ...
    11e3:	48 8d 3d 5b 0e 00 00 	lea    0xe5b(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    11ea:	b8 00 00 00 00       	mov    $0x0,%eax
    11ef:	e8 9c fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f4:	48 8d 35 32 0e 00 00 	lea    0xe32(%rip),%rsi        # 202d <_IO_stdin_used+0x2d>
    ...
    120f:	48 8d 3d 2f 0e 00 00 	lea    0xe2f(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    1216:	b8 00 00 00 00       	mov    $0x0,%eax
    121b:	e8 70 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    1220:	f3 0f 10 44 24 0c    	movss  0xc(%rsp),%xmm0
    1226:	f3 0f 59 44 24 10    	mulss  0x10(%rsp),%xmm0
    122c:	f3 0f 59 44 24 14    	mulss  0x14(%rsp),%xmm0
    1232:	f3 0f 5e 05 0e 0e 00 	divss  0xe0e(%rip),%xmm0        # 2048 <_IO_stdin_used+0x48>
    1239:	00 
    123a:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    123e:	48 8d 35 fa 0d 00 00 	lea    0xdfa(%rip),%rsi        # 203f <_IO_stdin_used+0x3f>
    ...
    1260:	00 00 
    1262:	75 05                	jne    1269 <main+0xe0>
    1264:	48 83 c4 28          	add    $0x28,%rsp
    1268:	c3                   	retq   
