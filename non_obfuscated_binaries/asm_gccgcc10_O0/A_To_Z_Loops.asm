...
/app/bin_gccgcc10_O0/A_To_Z_Loops:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	c6 45 fe 61          	movb   $0x61,-0x2(%rbp)
    1159:	eb 21                	jmp    117c <main+0x33>
    115b:	0f be 45 fe          	movsbl -0x2(%rbp),%eax
    ...
    1172:	0f b6 45 fe          	movzbl -0x2(%rbp),%eax
    1176:	83 c0 01             	add    $0x1,%eax
    1179:	88 45 fe             	mov    %al,-0x2(%rbp)
    117c:	80 7d fe 7a          	cmpb   $0x7a,-0x2(%rbp)
    1180:	7e d9                	jle    115b <main+0x12>
    1182:	c6 45 ff 41          	movb   $0x41,-0x1(%rbp)
    1186:	eb 21                	jmp    11a9 <main+0x60>
    1188:	0f be 45 ff          	movsbl -0x1(%rbp),%eax
    ...
    119f:	0f b6 45 ff          	movzbl -0x1(%rbp),%eax
    11a3:	83 c0 01             	add    $0x1,%eax
    11a6:	88 45 ff             	mov    %al,-0x1(%rbp)
    11a9:	80 7d ff 5a          	cmpb   $0x5a,-0x1(%rbp)
    11ad:	7e d9                	jle    1188 <main+0x3f>
