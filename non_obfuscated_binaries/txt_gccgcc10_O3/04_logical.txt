...
/app/bin_gccgcc10_O3/04_logical:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1094:	48 8d 35 69 0f 00 00 	lea    0xf69(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    109b:	e8 d0 ff ff ff       	callq  1070 <__printf_chk@plt>
    10a0:	ba 01 00 00 00       	mov    $0x1,%edx
    10a5:	48 8d 35 74 0f 00 00 	lea    0xf74(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    ...
    10ba:	48 8d 35 7a 0f 00 00 	lea    0xf7a(%rip),%rsi        # 203b <_IO_stdin_used+0x3b>
    10c1:	31 c0                	xor    %eax,%eax
    10c3:	bf 01 00 00 00       	mov    $0x1,%edi
    10c8:	e8 a3 ff ff ff       	callq  1070 <__printf_chk@plt>
    10cd:	48 8d 3d 82 0f 00 00 	lea    0xf82(%rip),%rdi        # 2056 <_IO_stdin_used+0x56>
    10d4:	e8 87 ff ff ff       	callq  1060 <puts@plt>
    10d9:	48 8d 35 76 0f 00 00 	lea    0xf76(%rip),%rsi        # 2056 <_IO_stdin_used+0x56>
    10e0:	bf 01 00 00 00       	mov    $0x1,%edi
    10e5:	31 c0                	xor    %eax,%eax
    10e7:	e8 84 ff ff ff       	callq  1070 <__printf_chk@plt>
    10ec:	31 c0                	xor    %eax,%eax
    10ee:	48 83 c4 08          	add    $0x8,%rsp
    10f2:	c3                   	retq   
