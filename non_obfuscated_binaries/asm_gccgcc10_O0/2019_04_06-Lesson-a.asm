...
/app/bin_gccgcc10_O0/2019_04_06-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d e1 00 00 00 	lea    0xe1(%rip),%rdi        # 11a9 <main>
...
0000000000001189 <max>:
    ...
    119d:	7e 05                	jle    11a4 <max+0x1b>
    119f:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11a2:	eb 03                	jmp    11a7 <max+0x1e>
...
00000000000011a9 <main>:
    ...
    11d0:	e8 ab fe ff ff       	callq  1080 <printf@plt>
    11d5:	48 8d 55 f4          	lea    -0xc(%rbp),%rdx
    11d9:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    11dd:	48 89 c6             	mov    %rax,%rsi
    11e0:	48 8d 3d 4a 0e 00 00 	lea    0xe4a(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    11e7:	b8 00 00 00 00       	mov    $0x0,%eax
    11ec:	e8 9f fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f1:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11f4:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11f7:	89 d6                	mov    %edx,%esi
    11f9:	89 c7                	mov    %eax,%edi
    11fb:	b8 00 00 00 00       	mov    $0x0,%eax
    1200:	e8 84 ff ff ff       	callq  1189 <max>
    1205:	89 c6                	mov    %eax,%esi
    1207:	48 8d 3d 29 0e 00 00 	lea    0xe29(%rip),%rdi        # 2037 <_IO_stdin_used+0x37>
    ...
    1221:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1228:	00 00 
    122a:	74 05                	je     1231 <main+0x88>
    122c:	e8 3f fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1231:	c9                   	leaveq 
    1232:	c3                   	retq   
