...
/app/bin_gccgcc10_O0/2024_02_17-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <getenv@plt>:
    1080:	f3 0f 1e fa          	endbr64 
    1084:	f2 ff 25 2d 2f 00 00 	bnd jmpq *0x2f2d(%rip)        # 3fb8 <getenv@GLIBC_2.2.5>
    108b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001090 <setenv@plt>:
    1090:	f3 0f 1e fa          	endbr64 
    1094:	f2 ff 25 25 2f 00 00 	bnd jmpq *0x2f25(%rip)        # 3fc0 <setenv@GLIBC_2.2.5>
...
00000000000011a9 <main>:
    ...
    11c4:	48 b8 6c 61 6e 67 75 	movabs $0x65676175676e616c,%rax
    11cb:	61 67 65 
    11ce:	48 89 45 ef          	mov    %rax,-0x11(%rbp)
    11d2:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    11d6:	66 c7 45 ed 43 00    	movw   $0x43,-0x13(%rbp)
    11dc:	48 8d 55 ed          	lea    -0x13(%rbp),%rdx
    11e0:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    ...
    11f3:	e8 b8 fe ff ff       	callq  10b0 <printf@plt>
    11f8:	48 8d 4d ed          	lea    -0x13(%rbp),%rcx
    11fc:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    1200:	ba 00 00 00 00       	mov    $0x0,%edx
    1205:	48 89 ce             	mov    %rcx,%rsi
    1208:	48 89 c7             	mov    %rax,%rdi
    120b:	e8 80 fe ff ff       	callq  1090 <setenv@plt>
    1210:	48 8d 45 ef          	lea    -0x11(%rbp),%rax
    1214:	48 89 c7             	mov    %rax,%rdi
    1217:	e8 64 fe ff ff       	callq  1080 <getenv@plt>
    121c:	48 89 c6             	mov    %rax,%rsi
    121f:	48 8d 3d 01 0e 00 00 	lea    0xe01(%rip),%rdi        # 2027 <_IO_stdin_used+0x27>
    1226:	b8 00 00 00 00       	mov    $0x0,%eax
    122b:	e8 80 fe ff ff       	callq  10b0 <printf@plt>
    1230:	b8 00 00 00 00       	mov    $0x0,%eax
    1235:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1239:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1240:	00 00 
    1242:	74 05                	je     1249 <main+0xa0>
    1244:	e8 57 fe ff ff       	callq  10a0 <__stack_chk_fail@plt>
    1249:	c9                   	leaveq 
    124a:	c3                   	retq   
