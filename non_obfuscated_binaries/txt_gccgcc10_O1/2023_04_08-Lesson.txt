...
/app/bin_gccgcc10_O1/2023_04_08-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	53                   	push   %rbx
    118e:	48 8d 1d 6f 0e 00 00 	lea    0xe6f(%rip),%rbx        # 2004 <_IO_stdin_used+0x4>
    1195:	eb 12                	jmp    11a9 <main+0x20>
    1197:	48 89 de             	mov    %rbx,%rsi
    119a:	bf 01 00 00 00       	mov    $0x1,%edi
    119f:	b8 00 00 00 00       	mov    $0x0,%eax
    11a4:	e8 d7 fe ff ff       	callq  1080 <__printf_chk@plt>
    11a9:	48 8b 3d 70 2e 00 00 	mov    0x2e70(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    11b0:	e8 db fe ff ff       	callq  1090 <getc@plt>
    11b5:	83 f8 ff             	cmp    $0xffffffff,%eax
    11b8:	74 32                	je     11ec <main+0x63>
    11ba:	83 f8 09             	cmp    $0x9,%eax
    11bd:	74 d8                	je     1197 <main+0xe>
    11bf:	83 f8 20             	cmp    $0x20,%eax
    11c2:	75 18                	jne    11dc <main+0x53>
    11c4:	48 8d 35 4b 0e 00 00 	lea    0xe4b(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    11cb:	bf 01 00 00 00       	mov    $0x1,%edi
    11d0:	b8 00 00 00 00       	mov    $0x0,%eax
    11d5:	e8 a6 fe ff ff       	callq  1080 <__printf_chk@plt>
    11da:	eb cd                	jmp    11a9 <main+0x20>
    11dc:	48 8b 35 2d 2e 00 00 	mov    0x2e2d(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11e3:	89 c7                	mov    %eax,%edi
    11e5:	e8 86 fe ff ff       	callq  1070 <putc@plt>
    11ea:	eb bd                	jmp    11a9 <main+0x20>
