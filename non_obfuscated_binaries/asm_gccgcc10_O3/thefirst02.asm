...
/app/bin_gccgcc10_O3/thefirst02:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    106f:	48 8d 35 9a 0f 00 00 	lea    0xf9a(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
