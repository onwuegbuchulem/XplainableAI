...
/app/bin_gccgcc10_O3/2021_11_27-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a8:	66 0f 6f 05 60 0f 00 	movdqa 0xf60(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    10af:	00 
    10b0:	ba 59 5a 00 00       	mov    $0x5a59,%edx
    10b5:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10bc:	00 00 
    10be:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    10c3:	48 b8 48 45 4c 4c 4f 	movabs $0x57202c4f4c4c4548,%rax
    10ca:	2c 20 57 
    10cd:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    10d2:	48 8d 7c 24 02       	lea    0x2(%rsp),%rdi
    10d7:	66 89 54 24 28       	mov    %dx,0x28(%rsp)
    10dc:	c7 44 24 0a 4f 52 4c 	movl   $0x444c524f,0xa(%rsp)
    10e3:	44 
    10e4:	c6 44 24 2a 00       	movb   $0x0,0x2a(%rsp)
    10e9:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10ee:	48 89 44 24 02       	mov    %rax,0x2(%rsp)
    10f3:	b8 21 00 00 00       	mov    $0x21,%eax
    10f8:	66 89 44 24 0e       	mov    %ax,0xe(%rsp)
    10fd:	48 b8 51 52 53 54 55 	movabs $0x5857565554535251,%rax
    1104:	56 57 58 
    1107:	48 89 44 24 20       	mov    %rax,0x20(%rsp)
    110c:	e8 6f ff ff ff       	callq  1080 <strspn@plt>
    1111:	48 8d 35 ec 0e 00 00 	lea    0xeec(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1118:	bf 01 00 00 00       	mov    $0x1,%edi
    111d:	0f be 4c 04 02       	movsbl 0x2(%rsp,%rax,1),%ecx
    1122:	48 89 c2             	mov    %rax,%rdx
    1125:	31 c0                	xor    %eax,%eax
    1127:	e8 64 ff ff ff       	callq  1090 <__printf_chk@plt>
    112c:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1131:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1138:	00 00 
    113a:	75 07                	jne    1143 <main+0xa3>
    113c:	31 c0                	xor    %eax,%eax
    113e:	48 83 c4 48          	add    $0x48,%rsp
    1142:	c3                   	retq   
    1143:	e8 28 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
