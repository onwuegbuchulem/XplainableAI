...
/app/bin_gccgcc10_O2/2021_06-Exercise:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	55                   	push   %rbp
    1085:	41 b8 08 00 00 00    	mov    $0x8,%r8d
    108b:	ba 09 00 00 00       	mov    $0x9,%edx
    1090:	48 8d 2d 6d 0f 00 00 	lea    0xf6d(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1097:	53                   	push   %rbx
    1098:	bb 01 00 00 00       	mov    $0x1,%ebx
    109d:	48 83 ec 58          	sub    $0x58,%rsp
    10a1:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10a8:	00 00 
    10aa:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    10af:	48 b8 09 00 00 00 07 	movabs $0x700000009,%rax
    10b6:	00 00 00 
    10b9:	48 89 44 24 04       	mov    %rax,0x4(%rsp)
    10be:	48 b8 06 00 00 00 08 	movabs $0x800000006,%rax
    10c5:	00 00 00 
    10c8:	48 89 44 24 0c       	mov    %rax,0xc(%rsp)
    10cd:	48 b8 0a 00 00 00 0c 	movabs $0xc0000000a,%rax
    10d4:	00 00 00 
    10d7:	48 89 44 24 14       	mov    %rax,0x14(%rsp)
    10dc:	48 b8 0b 00 00 00 0a 	movabs $0xa0000000b,%rax
    10e3:	00 00 00 
    10e6:	48 89 44 24 1c       	mov    %rax,0x1c(%rsp)
    10eb:	48 b8 0d 00 00 00 0b 	movabs $0xb0000000d,%rax
    10f2:	00 00 00 
    10f5:	48 89 44 24 24       	mov    %rax,0x24(%rsp)
    10fa:	48 b8 05 00 00 00 08 	movabs $0x800000005,%rax
    1101:	00 00 00 
    1104:	48 89 44 24 2c       	mov    %rax,0x2c(%rsp)
    1109:	48 b8 09 00 00 00 0b 	movabs $0xb00000009,%rax
    1110:	00 00 00 
    1113:	48 89 44 24 34       	mov    %rax,0x34(%rsp)
    1118:	eb 1e                	jmp    1138 <main+0xb8>
    111a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1120:	89 d8                	mov    %ebx,%eax
    1122:	44 8b 04 9c          	mov    (%rsp,%rbx,4),%r8d
    1126:	d1 f8                	sar    %eax
    1128:	8d 50 09             	lea    0x9(%rax),%edx
    112b:	83 e8 03             	sub    $0x3,%eax
    112e:	83 fa 0c             	cmp    $0xc,%edx
    1131:	0f 4f d0             	cmovg  %eax,%edx
    1134:	48 83 c3 01          	add    $0x1,%rbx
    1138:	8d 4b ff             	lea    -0x1(%rbx),%ecx
    113b:	31 c0                	xor    %eax,%eax
    113d:	48 89 ee             	mov    %rbp,%rsi
    1140:	83 e1 01             	and    $0x1,%ecx
    1143:	bf 01 00 00 00       	mov    $0x1,%edi
    1148:	f7 d9                	neg    %ecx
    114a:	83 e1 1e             	and    $0x1e,%ecx
    114d:	e8 1e ff ff ff       	callq  1070 <__printf_chk@plt>
    1152:	48 83 fb 0f          	cmp    $0xf,%rbx
    1156:	75 c8                	jne    1120 <main+0xa0>
    1158:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    115d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1164:	00 00 
    1166:	75 09                	jne    1171 <main+0xf1>
    1168:	48 83 c4 58          	add    $0x58,%rsp
