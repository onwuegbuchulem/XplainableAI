...
/app/bin_gccgcc10_O1/random02:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118f:	55                   	push   %rbp
    1190:	53                   	push   %rbx
    1191:	41 bc 05 00 00 00    	mov    $0x5,%r12d
    1197:	48 8d 2d 66 0e 00 00 	lea    0xe66(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    119e:	bb 05 00 00 00       	mov    $0x5,%ebx
    11a3:	e8 e8 fe ff ff       	callq  1090 <rand@plt>
    11a8:	48 63 d0             	movslq %eax,%rdx
    11ab:	48 69 d2 1f 85 eb 51 	imul   $0x51eb851f,%rdx,%rdx
    11b2:	48 c1 fa 25          	sar    $0x25,%rdx
    11b6:	89 c1                	mov    %eax,%ecx
    11b8:	c1 f9 1f             	sar    $0x1f,%ecx
    11bb:	29 ca                	sub    %ecx,%edx
    11bd:	6b d2 64             	imul   $0x64,%edx,%edx
    11c0:	29 d0                	sub    %edx,%eax
    11c2:	8d 50 01             	lea    0x1(%rax),%edx
    11c5:	48 89 ee             	mov    %rbp,%rsi
    11c8:	bf 01 00 00 00       	mov    $0x1,%edi
    11cd:	b8 00 00 00 00       	mov    $0x0,%eax
    11d2:	e8 a9 fe ff ff       	callq  1080 <__printf_chk@plt>
    11d7:	83 eb 01             	sub    $0x1,%ebx
    11da:	75 c7                	jne    11a3 <main+0x1a>
    11dc:	48 8b 35 2d 2e 00 00 	mov    0x2e2d(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11e3:	bf 0a 00 00 00       	mov    $0xa,%edi
    11e8:	e8 83 fe ff ff       	callq  1070 <putc@plt>
    11ed:	41 83 ec 01          	sub    $0x1,%r12d
    11f1:	75 ab                	jne    119e <main+0x15>
