...
/app/bin_gccgcc10_O1/Prime_No:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11cc:	83 fe 02             	cmp    $0x2,%esi
    11cf:	7e 33                	jle    1204 <main+0x7b>
    11d1:	40 f6 c6 01          	test   $0x1,%sil
    11d5:	74 15                	je     11ec <main+0x63>
    11d7:	b9 02 00 00 00       	mov    $0x2,%ecx
    11dc:	83 c1 01             	add    $0x1,%ecx
    11df:	39 f1                	cmp    %esi,%ecx
    11e1:	74 21                	je     1204 <main+0x7b>
    11e3:	89 f0                	mov    %esi,%eax
    11e5:	99                   	cltd   
    11e6:	f7 f9                	idiv   %ecx
    11e8:	85 d2                	test   %edx,%edx
    11ea:	75 f0                	jne    11dc <main+0x53>
    ...
    11fd:	e8 7e fe ff ff       	callq  1080 <__printf_chk@plt>
    1202:	eb 18                	jmp    121c <main+0x93>
    1204:	89 f2                	mov    %esi,%edx
    1206:	48 8d 35 1f 0e 00 00 	lea    0xe1f(%rip),%rsi        # 202c <_IO_stdin_used+0x2c>
    120d:	bf 01 00 00 00       	mov    $0x1,%edi
    1212:	b8 00 00 00 00       	mov    $0x0,%eax
    1217:	e8 64 fe ff ff       	callq  1080 <__printf_chk@plt>
    121c:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1221:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1228:	00 00 
    122a:	75 05                	jne    1231 <main+0xa8>
