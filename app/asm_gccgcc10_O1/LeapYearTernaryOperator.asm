...
/app/bin_gccgcc10_O1/LeapYearTernaryOperator:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d2:	48 8d 3d 58 0e 00 00 	lea    0xe58(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	e8 cd fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e3:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11e7:	48 63 c2             	movslq %edx,%rax
    11ea:	48 69 c0 1f 85 eb 51 	imul   $0x51eb851f,%rax,%rax
    11f1:	48 c1 f8 25          	sar    $0x25,%rax
    11f5:	89 d1                	mov    %edx,%ecx
    11f7:	c1 f9 1f             	sar    $0x1f,%ecx
    11fa:	29 c8                	sub    %ecx,%eax
    11fc:	6b c0 64             	imul   $0x64,%eax,%eax
    11ff:	39 c2                	cmp    %eax,%edx
    1201:	74 05                	je     1208 <main+0x5f>
    1203:	f6 c2 03             	test   $0x3,%dl
    1206:	74 1f                	je     1227 <main+0x7e>
    1208:	48 63 c2             	movslq %edx,%rax
    120b:	48 69 c0 1f 85 eb 51 	imul   $0x51eb851f,%rax,%rax
    1212:	48 c1 f8 27          	sar    $0x27,%rax
    1216:	89 d1                	mov    %edx,%ecx
    1218:	c1 f9 1f             	sar    $0x1f,%ecx
    121b:	29 c8                	sub    %ecx,%eax
    121d:	69 c0 90 01 00 00    	imul   $0x190,%eax,%eax
    1223:	39 c2                	cmp    %eax,%edx
    1225:	75 30                	jne    1257 <main+0xae>
    1227:	48 8d 35 06 0e 00 00 	lea    0xe06(%rip),%rsi        # 2034 <_IO_stdin_used+0x34>
    ...
    1249:	00 00 
    124b:	75 22                	jne    126f <main+0xc6>
    124d:	b8 00 00 00 00       	mov    $0x0,%eax
    1252:	48 83 c4 18          	add    $0x18,%rsp
    1256:	c3                   	retq   
    1257:	48 8d 35 e6 0d 00 00 	lea    0xde6(%rip),%rsi        # 2044 <_IO_stdin_used+0x44>
    125e:	bf 01 00 00 00       	mov    $0x1,%edi
    1263:	b8 00 00 00 00       	mov    $0x0,%eax
    1268:	e8 33 fe ff ff       	callq  10a0 <__printf_chk@plt>
    126d:	eb ce                	jmp    123d <main+0x94>
