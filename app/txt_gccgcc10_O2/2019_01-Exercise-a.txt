...
/app/bin_gccgcc10_O2/2019_01-Exercise-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 54                	push   %r12
    1086:	41 bc cd cc cc cc    	mov    $0xcccccccd,%r12d
    108c:	55                   	push   %rbp
    108d:	bd 01 00 00 00       	mov    $0x1,%ebp
    1092:	53                   	push   %rbx
    1093:	eb 33                	jmp    10c8 <main+0x48>
    1095:	0f 1f 00             	nopl   (%rax)
    1098:	85 db                	test   %ebx,%ebx
    109a:	75 64                	jne    1100 <main+0x80>
    109c:	48 8d 35 66 0f 00 00 	lea    0xf66(%rip),%rsi        # 2009 <_IO_stdin_used+0x9>
    10a3:	bf 01 00 00 00       	mov    $0x1,%edi
    10a8:	31 c0                	xor    %eax,%eax
    10aa:	e8 c1 ff ff ff       	callq  1070 <__printf_chk@plt>
    10af:	48 8b 35 5a 2f 00 00 	mov    0x2f5a(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10b6:	bf 0a 00 00 00       	mov    $0xa,%edi
    10bb:	83 c5 01             	add    $0x1,%ebp
    10be:	e8 9d ff ff ff       	callq  1060 <putc@plt>
    10c3:	83 fd 65             	cmp    $0x65,%ebp
    10c6:	74 4f                	je     1117 <main+0x97>
    10c8:	89 eb                	mov    %ebp,%ebx
    10ca:	49 0f af dc          	imul   %r12,%rbx
    10ce:	48 c1 eb 22          	shr    $0x22,%rbx
    10d2:	8d 04 9b             	lea    (%rbx,%rbx,4),%eax
    10d5:	89 eb                	mov    %ebp,%ebx
    10d7:	29 c3                	sub    %eax,%ebx
    10d9:	69 c5 ab aa aa aa    	imul   $0xaaaaaaab,%ebp,%eax
    10df:	3d 55 55 55 55       	cmp    $0x55555555,%eax
    10e4:	77 b2                	ja     1098 <main+0x18>
    10e6:	31 c0                	xor    %eax,%eax
    10e8:	48 8d 35 15 0f 00 00 	lea    0xf15(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10ef:	bf 01 00 00 00       	mov    $0x1,%edi
    10f4:	e8 77 ff ff ff       	callq  1070 <__printf_chk@plt>
    10f9:	85 db                	test   %ebx,%ebx
    10fb:	75 b2                	jne    10af <main+0x2f>
    10fd:	eb 9d                	jmp    109c <main+0x1c>
    10ff:	90                   	nop
    1100:	89 ea                	mov    %ebp,%edx
    1102:	48 8d 35 05 0f 00 00 	lea    0xf05(%rip),%rsi        # 200e <_IO_stdin_used+0xe>
    1109:	bf 01 00 00 00       	mov    $0x1,%edi
    110e:	31 c0                	xor    %eax,%eax
    1110:	e8 5b ff ff ff       	callq  1070 <__printf_chk@plt>
    1115:	eb 98                	jmp    10af <main+0x2f>
    1117:	5b                   	pop    %rbx
