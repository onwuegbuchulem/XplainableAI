...
/app/bin_gccgcc10_O2/2019_02_02-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10ab:	c7 44 24 04 66 61 74 	movl   $0x746166,0x4(%rsp)
    10b2:	00 
    ...
    10cc:	c6 44 24 05 69       	movb   $0x69,0x5(%rsp)
    10d1:	e8 9a ff ff ff       	callq  1070 <__printf_chk@plt>
    10d6:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10db:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10e2:	00 00 
    10e4:	75 09                	jne    10ef <main+0x6f>
    10e6:	48 83 c4 10          	add    $0x10,%rsp
    10ea:	31 c0                	xor    %eax,%eax
    10ec:	41 5c                	pop    %r12
    10ee:	c3                   	retq   
    10ef:	e8 6c ff ff ff       	callq  1060 <__stack_chk_fail@plt>
...
00000000000011f0 <change>:
    11f0:	f3 0f 1e fa          	endbr64 
    11f4:	c6 47 01 69          	movb   $0x69,0x1(%rdi)
    11f8:	c3                   	retq   
    11f9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)

0000000000001200 <output>:
    1200:	f3 0f 1e fa          	endbr64 
    1204:	48 89 fa             	mov    %rdi,%rdx
    1207:	48 8d 35 f6 0d 00 00 	lea    0xdf6(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    120e:	bf 01 00 00 00       	mov    $0x1,%edi
    1213:	31 c0                	xor    %eax,%eax
    1215:	e9 56 fe ff ff       	jmpq   1070 <__printf_chk@plt>
