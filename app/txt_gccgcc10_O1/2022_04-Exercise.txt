...
/app/bin_gccgcc10_O1/2022_04-Exercise:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d f8 00 00 00 	lea    0xf8(%rip),%rdi        # 11c0 <main>
...
0000000000001189 <babylonian_sr>:
    ...
    118d:	66 0f 28 d0          	movapd %xmm0,%xmm2
    1191:	b8 07 00 00 00       	mov    $0x7,%eax
    1196:	f2 0f 10 0d aa 0e 00 	movsd  0xeaa(%rip),%xmm1        # 2048 <_IO_stdin_used+0x48>
    119d:	00 
    119e:	f2 0f 10 1d aa 0e 00 	movsd  0xeaa(%rip),%xmm3        # 2050 <_IO_stdin_used+0x50>
    11a5:	00 
    11a6:	f2 0f 58 c1          	addsd  %xmm1,%xmm0
    11aa:	f2 0f 59 c3          	mulsd  %xmm3,%xmm0
    11ae:	66 0f 28 ca          	movapd %xmm2,%xmm1
    11b2:	f2 0f 5e c8          	divsd  %xmm0,%xmm1
    11b6:	83 e8 01             	sub    $0x1,%eax
    11b9:	75 eb                	jne    11a6 <babylonian_sr+0x1d>
...
00000000000011c0 <main>:
    ...
    11d0:	00 00 
    11d2:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11d7:	31 c0                	xor    %eax,%eax
    11d9:	48 8d 35 24 0e 00 00 	lea    0xe24(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11e0:	bf 01 00 00 00       	mov    $0x1,%edi
    11e5:	e8 96 fe ff ff       	callq  1080 <__printf_chk@plt>
    ...
    11f9:	e8 92 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11fe:	48 8b 1c 24          	mov    (%rsp),%rbx
    1202:	b8 01 00 00 00       	mov    $0x1,%eax
    1207:	66 0f ef c0          	pxor   %xmm0,%xmm0
    120b:	66 48 0f 6e d3       	movq   %rbx,%xmm2
    1210:	66 0f 2f c2          	comisd %xmm2,%xmm0
    1214:	73 2e                	jae    1244 <main+0x84>
    1216:	66 48 0f 6e c3       	movq   %rbx,%xmm0
    121b:	e8 69 ff ff ff       	callq  1189 <babylonian_sr>
    1220:	66 0f 28 c8          	movapd %xmm0,%xmm1
    1224:	66 48 0f 6e c3       	movq   %rbx,%xmm0
    1229:	48 8d 35 f8 0d 00 00 	lea    0xdf8(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    1230:	bf 01 00 00 00       	mov    $0x1,%edi
    1235:	b8 02 00 00 00       	mov    $0x2,%eax
    123a:	e8 41 fe ff ff       	callq  1080 <__printf_chk@plt>
    123f:	b8 00 00 00 00       	mov    $0x0,%eax
    1244:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    1249:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1250:	00 00 
    1252:	75 06                	jne    125a <main+0x9a>
    1254:	48 83 c4 10          	add    $0x10,%rsp
    1258:	5b                   	pop    %rbx
    1259:	c3                   	retq   
