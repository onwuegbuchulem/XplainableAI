...
/app/bin_gccgcc10_O1/2024_04_27-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	53                   	push   %rbx
    118e:	bf 04 00 00 00       	mov    $0x4,%edi
    1193:	e8 d8 fe ff ff       	callq  1070 <malloc@plt>
    1198:	48 89 c3             	mov    %rax,%rbx
    119b:	48 8d 35 62 0e 00 00 	lea    0xe62(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11a2:	bf 01 00 00 00       	mov    $0x1,%edi
    11a7:	b8 00 00 00 00       	mov    $0x0,%eax
    11ac:	e8 cf fe ff ff       	callq  1080 <__printf_chk@plt>
    11b1:	48 89 de             	mov    %rbx,%rsi
    11b4:	48 8d 3d 5c 0e 00 00 	lea    0xe5c(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    11bb:	b8 00 00 00 00       	mov    $0x0,%eax
    11c0:	e8 cb fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c5:	8b 13                	mov    (%rbx),%edx
