...
/app/bin_gccgcc10_O1/2021_03_20-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a5:	f2 0f 10 05 5b 0e 00 	movsd  0xe5b(%rip),%xmm0        # 2008 <_IO_stdin_used+0x8>
    11ac:	00 
    11ad:	48 8d 15 50 0e 00 00 	lea    0xe50(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    11b4:	be 20 00 00 00       	mov    $0x20,%esi
    11b9:	48 89 df             	mov    %rbx,%rdi
    11bc:	b8 01 00 00 00       	mov    $0x1,%eax
    11c1:	e8 ca fe ff ff       	callq  1090 <strfmon@plt>
    11c6:	48 89 df             	mov    %rbx,%rdi
    11c9:	e8 a2 fe ff ff       	callq  1070 <puts@plt>
    11ce:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    11d3:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11da:	00 00 
    11dc:	75 0b                	jne    11e9 <main+0x60>
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	48 83 c4 30          	add    $0x30,%rsp
    11e7:	5b                   	pop    %rbx
    11e8:	c3                   	retq   
    11e9:	e8 92 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
