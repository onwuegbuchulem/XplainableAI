...
/app/bin_gccgcc10_O1/2021_07_31-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <__isoc99_sscanf@plt>:
    ...
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <__isoc99_sscanf@GLIBC_2.7>
...
0000000000001189 <main>:
    ...
    11a1:	c7 44 24 04 38 32 37 	movl   $0x373238,0x4(%rsp)
    11a8:	00 
    11a9:	48 89 e2             	mov    %rsp,%rdx
    11ac:	48 8d 7c 24 04       	lea    0x4(%rsp),%rdi
    11b1:	48 8d 35 4c 0e 00 00 	lea    0xe4c(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11b8:	e8 c3 fe ff ff       	callq  1080 <__isoc99_sscanf@plt>
    11bd:	8b 14 24             	mov    (%rsp),%edx
    11c0:	48 8d 35 40 0e 00 00 	lea    0xe40(%rip),%rsi        # 2007 <_IO_stdin_used+0x7>
    11c7:	bf 01 00 00 00       	mov    $0x1,%edi
    11cc:	b8 00 00 00 00       	mov    $0x0,%eax
    11d1:	e8 ba fe ff ff       	callq  1090 <__printf_chk@plt>
    11d6:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11db:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11e2:	00 00 
    11e4:	75 0a                	jne    11f0 <main+0x67>
