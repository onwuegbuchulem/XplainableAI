...
/app/bin_gccgcc10_O0/2021_07_17-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a3:	00 00 00 
    11a6:	eb 5b                	jmp    1203 <main+0x7a>
    11a8:	83 7d fc 7a          	cmpl   $0x7a,-0x4(%rbp)
    11ac:	74 20                	je     11ce <main+0x45>
    11ae:	83 7d fc 7a          	cmpl   $0x7a,-0x4(%rbp)
    11b2:	7f 43                	jg     11f7 <main+0x6e>
    11b4:	83 7d fc 3f          	cmpl   $0x3f,-0x4(%rbp)
    11b8:	74 22                	je     11dc <main+0x53>
    11ba:	83 7d fc 61          	cmpl   $0x61,-0x4(%rbp)
    11be:	75 37                	jne    11f7 <main+0x6e>
    11c0:	48 8d 3d 3d 0e 00 00 	lea    0xe3d(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11c7:	e8 a4 fe ff ff       	callq  1070 <puts@plt>
    11cc:	eb 35                	jmp    1203 <main+0x7a>
    11ce:	48 8d 3d 46 0e 00 00 	lea    0xe46(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    11d5:	e8 96 fe ff ff       	callq  1070 <puts@plt>
    11da:	eb 27                	jmp    1203 <main+0x7a>
    11dc:	8b 05 3e 2e 00 00    	mov    0x2e3e(%rip),%eax        # 4020 <optopt@@GLIBC_2.2.5>
    11e2:	89 c6                	mov    %eax,%esi
    11e4:	48 8d 3d 47 0e 00 00 	lea    0xe47(%rip),%rdi        # 2032 <_IO_stdin_used+0x32>
    11eb:	b8 00 00 00 00       	mov    $0x0,%eax
    11f0:	e8 8b fe ff ff       	callq  1080 <printf@plt>
    11f5:	eb 0c                	jmp    1203 <main+0x7a>
    11f7:	48 8d 3d 51 0e 00 00 	lea    0xe51(%rip),%rdi        # 204f <_IO_stdin_used+0x4f>
    11fe:	e8 6d fe ff ff       	callq  1070 <puts@plt>
    1203:	48 8b 4d e0          	mov    -0x20(%rbp),%rcx
    1207:	8b 45 ec             	mov    -0x14(%rbp),%eax
    120a:	48 8d 15 4f 0e 00 00 	lea    0xe4f(%rip),%rdx        # 2060 <_IO_stdin_used+0x60>
    1211:	48 89 ce             	mov    %rcx,%rsi
    1214:	89 c7                	mov    %eax,%edi
    1216:	e8 75 fe ff ff       	callq  1090 <getopt@plt>
    121b:	89 45 fc             	mov    %eax,-0x4(%rbp)
    121e:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%rbp)
    1222:	75 84                	jne    11a8 <main+0x1f>
