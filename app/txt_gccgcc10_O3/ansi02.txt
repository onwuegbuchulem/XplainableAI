...
/app/bin_gccgcc10_O3/ansi02:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108d:	55                   	push   %rbp
    108e:	bd 28 00 00 00       	mov    $0x28,%ebp
    1093:	53                   	push   %rbx
    1094:	0f 1f 40 00          	nopl   0x0(%rax)
    1098:	bb 1e 00 00 00       	mov    $0x1e,%ebx
    109d:	0f 1f 00             	nopl   (%rax)
    10a0:	41 89 d8             	mov    %ebx,%r8d
    10a3:	89 da                	mov    %ebx,%edx
    10a5:	41 89 e9             	mov    %ebp,%r9d
    10a8:	89 e9                	mov    %ebp,%ecx
    10aa:	4c 89 e6             	mov    %r12,%rsi
    10ad:	bf 01 00 00 00       	mov    $0x1,%edi
    10b2:	31 c0                	xor    %eax,%eax
    10b4:	83 c3 01             	add    $0x1,%ebx
    10b7:	e8 b4 ff ff ff       	callq  1070 <__printf_chk@plt>
    10bc:	83 fb 26             	cmp    $0x26,%ebx
    10bf:	75 df                	jne    10a0 <main+0x20>
    10c1:	48 8d 3d 4c 0f 00 00 	lea    0xf4c(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    10c8:	83 c5 01             	add    $0x1,%ebp
    10cb:	e8 90 ff ff ff       	callq  1060 <puts@plt>
    10d0:	83 fd 30             	cmp    $0x30,%ebp
    10d3:	75 c3                	jne    1098 <main+0x18>
    10d5:	5b                   	pop    %rbx
