...
/app/bin_gccgcc10_O1/2019_06_08-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1182:	48 b8 4f 66 20 61 6c 	movabs $0x74206c6c6120664f,%rax
    1189:	6c 20 74 
    118c:	48 ba 68 65 20 67 69 	movabs $0x6a206e6967206568,%rdx
    1193:	6e 20 6a 
    1196:	48 89 04 24          	mov    %rax,(%rsp)
    119a:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    119f:	48 b8 6f 69 6e 74 73 	movabs $0x6e692073746e696f,%rax
    11a6:	20 69 6e 
    11a9:	48 ba 20 74 68 65 20 	movabs $0x726f772065687420,%rdx
    11b0:	77 6f 72 
    11b3:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11b8:	48 89 54 24 18       	mov    %rdx,0x18(%rsp)
    11bd:	c7 44 24 20 6c 64 2e 	movl   $0x2e2e646c,0x20(%rsp)
    11c4:	2e 
    11c5:	66 c7 44 24 24 2e 0a 	movw   $0xa2e,0x24(%rsp)
    11cc:	c6 44 24 26 00       	movb   $0x0,0x26(%rsp)
    11d1:	bf 4f 00 00 00       	mov    $0x4f,%edi
    11d6:	48 8d 5c 24 01       	lea    0x1(%rsp),%rbx
    11db:	40 0f be ff          	movsbl %dil,%edi
    11df:	48 8b 35 2a 2e 00 00 	mov    0x2e2a(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11e6:	e8 85 fe ff ff       	callq  1070 <putc@plt>
    11eb:	48 83 c3 01          	add    $0x1,%rbx
    11ef:	0f b6 7b ff          	movzbl -0x1(%rbx),%edi
    11f3:	40 84 ff             	test   %dil,%dil
    11f6:	75 e3                	jne    11db <main+0x72>
    11f8:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    11fd:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1204:	00 00 
    1206:	75 0b                	jne    1213 <main+0xaa>
    1208:	b8 00 00 00 00       	mov    $0x0,%eax
    120d:	48 83 c4 30          	add    $0x30,%rsp
    1211:	5b                   	pop    %rbx
    1212:	c3                   	retq   
    1213:	e8 48 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
