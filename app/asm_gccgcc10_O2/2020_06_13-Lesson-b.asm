...
/app/bin_gccgcc10_O2/2020_06_13-Lesson-b:     file format elf64-x86-64
...
0000000000001160 <_start>:
    ...
    1171:	50                   	push   %rax
    1172:	54                   	push   %rsp
    1173:	4c 8d 05 46 02 00 00 	lea    0x246(%rip),%r8        # 13c0 <__libc_csu_fini>
    117a:	48 8d 0d cf 01 00 00 	lea    0x1cf(%rip),%rcx        # 1350 <__libc_csu_init>
...
0000000000001250 <ternary_out>:
    ...
    126e:	0f 87 aa 00 00 00    	ja     131e <ternary_out+0xce>
    ...
    12e1:	80 3d 48 2d 00 00 30 	cmpb   $0x30,0x2d48(%rip)        # 4030 <tstring.0>
    12e8:	48 8d 05 41 2d 00 00 	lea    0x2d41(%rip),%rax        # 4030 <tstring.0>
    12ef:	75 18                	jne    1309 <ternary_out+0xb9>
    12f1:	31 d2                	xor    %edx,%edx
    12f3:	eb 08                	jmp    12fd <ternary_out+0xad>
    12f5:	0f 1f 00             	nopl   (%rax)
    12f8:	83 fa 0a             	cmp    $0xa,%edx
    12fb:	74 0c                	je     1309 <ternary_out+0xb9>
    12fd:	48 83 c0 01          	add    $0x1,%rax
    1301:	83 c2 01             	add    $0x1,%edx
    1304:	80 38 30             	cmpb   $0x30,(%rax)
    1307:	74 ef                	je     12f8 <ternary_out+0xa8>
    1309:	48 8b 7c 24 38       	mov    0x38(%rsp),%rdi
    130e:	64 48 2b 3c 25 28 00 	sub    %fs:0x28,%rdi
    1315:	00 00 
    1317:	75 29                	jne    1342 <ternary_out+0xf2>
    1319:	48 83 c4 48          	add    $0x48,%rsp
    131d:	c3                   	retq   
    131e:	89 f9                	mov    %edi,%ecx
    1320:	48 8b 3d f9 2c 00 00 	mov    0x2cf9(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    1327:	48 8d 15 d6 0c 00 00 	lea    0xcd6(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    132e:	be 01 00 00 00       	mov    $0x1,%esi
    1333:	e8 98 fd ff ff       	callq  10d0 <__fprintf_chk@plt>
    1338:	bf 01 00 00 00       	mov    $0x1,%edi
    133d:	e8 7e fd ff ff       	callq  10c0 <exit@plt>
    1342:	e8 49 fd ff ff       	callq  1090 <__stack_chk_fail@plt>
