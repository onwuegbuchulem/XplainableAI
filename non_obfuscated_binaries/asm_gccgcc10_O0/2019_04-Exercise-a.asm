...
/app/bin_gccgcc10_O0/2019_04-Exercise-a:     file format elf64-x86-64
...
0000000000001189 <interesting>:
    ...
    11a7:	8b 55 ec             	mov    -0x14(%rbp),%edx
    11aa:	48 8d 45 f4          	lea    -0xc(%rbp),%rax
    ...
    11bd:	e8 ce fe ff ff       	callq  1090 <sprintf@plt>
    11c2:	0f b6 55 f4          	movzbl -0xc(%rbp),%edx
    11c6:	0f b6 45 f5          	movzbl -0xb(%rbp),%eax
    11ca:	38 c2                	cmp    %al,%dl
    11cc:	75 13                	jne    11e1 <interesting+0x58>
    11ce:	0f b6 55 f5          	movzbl -0xb(%rbp),%edx
    11d2:	0f b6 45 f6          	movzbl -0xa(%rbp),%eax
    11d6:	38 c2                	cmp    %al,%dl
    11d8:	75 07                	jne    11e1 <interesting+0x58>
    11da:	b8 01 00 00 00       	mov    $0x1,%eax
    11df:	eb 05                	jmp    11e6 <interesting+0x5d>
    11e1:	b8 00 00 00 00       	mov    $0x0,%eax
    11e6:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11ea:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11f1:	00 00 
    11f3:	74 05                	je     11fa <interesting+0x71>
    11f5:	e8 76 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    11fa:	c9                   	leaveq 
    11fb:	c3                   	retq   
...
00000000000011fc <main>:
    ...
    1208:	c7 45 fc 64 00 00 00 	movl   $0x64,-0x4(%rbp)
    120f:	eb 28                	jmp    1239 <main+0x3d>
    1211:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1214:	89 c7                	mov    %eax,%edi
    1216:	e8 6e ff ff ff       	callq  1189 <interesting>
    121b:	85 c0                	test   %eax,%eax
    121d:	74 16                	je     1235 <main+0x39>
    121f:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1222:	89 c6                	mov    %eax,%esi
    1224:	48 8d 3d dc 0d 00 00 	lea    0xddc(%rip),%rdi        # 2007 <_IO_stdin_used+0x7>
    122b:	b8 00 00 00 00       	mov    $0x0,%eax
    1230:	e8 4b fe ff ff       	callq  1080 <printf@plt>
    1235:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    1239:	81 7d fc e7 03 00 00 	cmpl   $0x3e7,-0x4(%rbp)
    1240:	7e cf                	jle    1211 <main+0x15>
