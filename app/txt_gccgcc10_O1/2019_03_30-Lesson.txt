...
/app/bin_gccgcc10_O1/2019_03_30-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    116d:	53                   	push   %rbx
    116e:	e8 ed fe ff ff       	callq  1060 <localeconv@plt>
    1173:	48 89 c3             	mov    %rax,%rbx
    1176:	48 8b 10             	mov    (%rax),%rdx
    ...
    118f:	48 8b 53 08          	mov    0x8(%rbx),%rdx
    1193:	48 8d 35 7d 0e 00 00 	lea    0xe7d(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    119a:	bf 01 00 00 00       	mov    $0x1,%edi
    119f:	b8 00 00 00 00       	mov    $0x0,%eax
    11a4:	e8 c7 fe ff ff       	callq  1070 <__printf_chk@plt>
    11a9:	48 8b 53 20          	mov    0x20(%rbx),%rdx
    11ad:	48 8d 35 7c 0e 00 00 	lea    0xe7c(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    11b4:	bf 01 00 00 00       	mov    $0x1,%edi
    11b9:	b8 00 00 00 00       	mov    $0x0,%eax
    11be:	e8 ad fe ff ff       	callq  1070 <__printf_chk@plt>
