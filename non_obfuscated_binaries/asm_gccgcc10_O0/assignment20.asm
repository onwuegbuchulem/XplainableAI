...
/app/bin_gccgcc10_O0/assignment20:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	c7 05 bd 2e 00 00 32 	movl   $0x32,0x2ebd(%rip)        # 4018 <example>
    1158:	00 00 00 
    115b:	c6 05 ba 2e 00 00 57 	movb   $0x57,0x2eba(%rip)        # 401c <example+0x4>
    1162:	f3 0f 10 05 e2 0e 00 	movss  0xee2(%rip),%xmm0        # 204c <_IO_stdin_used+0x4c>
    1169:	00 
    116a:	f3 0f 11 05 ae 2e 00 	movss  %xmm0,0x2eae(%rip)        # 4020 <example+0x8>
    1171:	00 
    1172:	8b 05 a0 2e 00 00    	mov    0x2ea0(%rip),%eax        # 4018 <example>
    ...
    118b:	0f b6 05 8a 2e 00 00 	movzbl 0x2e8a(%rip),%eax        # 401c <example+0x4>
    1192:	0f be c0             	movsbl %al,%eax
    1195:	89 c6                	mov    %eax,%esi
    1197:	48 8d 3d 7a 0e 00 00 	lea    0xe7a(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    119e:	b8 00 00 00 00       	mov    $0x0,%eax
    11a3:	e8 a8 fe ff ff       	callq  1050 <printf@plt>
    11a8:	f3 0f 10 05 70 2e 00 	movss  0x2e70(%rip),%xmm0        # 4020 <example+0x8>
    11af:	00 
    11b0:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11b4:	f3 0f 5a c8          	cvtss2sd %xmm0,%xmm1
    11b8:	66 48 0f 7e c8       	movq   %xmm1,%rax
    11bd:	66 48 0f 6e c0       	movq   %rax,%xmm0
    11c2:	48 8d 3d 66 0e 00 00 	lea    0xe66(%rip),%rdi        # 202f <_IO_stdin_used+0x2f>
    11c9:	b8 01 00 00 00       	mov    $0x1,%eax
    11ce:	e8 7d fe ff ff       	callq  1050 <printf@plt>
