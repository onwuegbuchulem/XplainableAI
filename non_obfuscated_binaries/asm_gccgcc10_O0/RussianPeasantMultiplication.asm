...
/app/bin_gccgcc10_O0/RussianPeasantMultiplication:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c4:	48 c7 45 d8 00 00 00 	movq   $0x0,-0x28(%rbp)
    11cb:	00 
    11cc:	48 c7 45 e0 00 00 00 	movq   $0x0,-0x20(%rbp)
    11d3:	00 
    11d4:	48 8d 3d 2d 0e 00 00 	lea    0xe2d(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11db:	e8 a0 fe ff ff       	callq  1080 <puts@plt>
    11e0:	48 8d 55 d0          	lea    -0x30(%rbp),%rdx
    11e4:	48 8d 45 c8          	lea    -0x38(%rbp),%rax
    11e8:	48 89 c6             	mov    %rax,%rsi
    11eb:	48 8d 3d 29 0e 00 00 	lea    0xe29(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    11f2:	b8 00 00 00 00       	mov    $0x0,%eax
    11f7:	e8 b4 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11fc:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1200:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    1204:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
    1208:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    120c:	eb 3c                	jmp    124a <main+0xa1>
    120e:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1212:	48 99                	cqto   
    1214:	48 c1 ea 3f          	shr    $0x3f,%rdx
    1218:	48 01 d0             	add    %rdx,%rax
    121b:	83 e0 01             	and    $0x1,%eax
    121e:	48 29 d0             	sub    %rdx,%rax
    1221:	48 83 f8 01          	cmp    $0x1,%rax
    1225:	75 08                	jne    122f <main+0x86>
    1227:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
    122b:	48 01 45 d8          	add    %rax,-0x28(%rbp)
    122f:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1233:	48 d1 f8             	sar    %rax
    1236:	48 89 45 c8          	mov    %rax,-0x38(%rbp)
    123a:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
    123e:	48 01 c0             	add    %rax,%rax
    1241:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    1245:	48 83 45 e0 01       	addq   $0x1,-0x20(%rbp)
    124a:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    124e:	48 85 c0             	test   %rax,%rax
    1251:	7f bb                	jg     120e <main+0x65>
    1253:	48 8b 4d d8          	mov    -0x28(%rbp),%rcx
    1257:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    125b:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    125f:	48 89 c6             	mov    %rax,%rsi
    1262:	48 8d 3d bf 0d 00 00 	lea    0xdbf(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    1269:	b8 00 00 00 00       	mov    $0x0,%eax
    126e:	e8 2d fe ff ff       	callq  10a0 <printf@plt>
    1273:	b8 00 00 00 00       	mov    $0x0,%eax
    1278:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    127c:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    1283:	00 00 
    1285:	74 05                	je     128c <main+0xe3>
    1287:	e8 04 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    128c:	c9                   	leaveq 
    128d:	c3                   	retq   
