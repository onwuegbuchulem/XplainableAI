...
/app/bin_gccgcc10_O1/censored01:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    116d:	53                   	push   %rbx
    116e:	48 8d 1d 8f 0e 00 00 	lea    0xe8f(%rip),%rbx        # 2004 <_IO_stdin_used+0x4>
    1175:	eb 11                	jmp    1188 <main+0x1f>
    1177:	48 8b 35 92 2e 00 00 	mov    0x2e92(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    117e:	bf 2a 00 00 00       	mov    $0x2a,%edi
    1183:	e8 d8 fe ff ff       	callq  1060 <putc@plt>
    1188:	48 8b 3d 91 2e 00 00 	mov    0x2e91(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    118f:	e8 dc fe ff ff       	callq  1070 <getc@plt>
    1194:	89 c7                	mov    %eax,%edi
    1196:	83 f8 ff             	cmp    $0xffffffff,%eax
    1199:	74 22                	je     11bd <main+0x54>
    119b:	8d 47 bf             	lea    -0x41(%rdi),%eax
    119e:	83 f8 34             	cmp    $0x34,%eax
    11a1:	77 0c                	ja     11af <main+0x46>
    11a3:	89 c0                	mov    %eax,%eax
    11a5:	48 63 04 83          	movslq (%rbx,%rax,4),%rax
    11a9:	48 01 d8             	add    %rbx,%rax
    11ac:	3e ff e0             	notrack jmpq *%rax
    11af:	48 8b 35 5a 2e 00 00 	mov    0x2e5a(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11b6:	e8 a5 fe ff ff       	callq  1060 <putc@plt>
    11bb:	eb cb                	jmp    1188 <main+0x1f>
