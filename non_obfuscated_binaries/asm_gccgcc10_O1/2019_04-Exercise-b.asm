...
/app/bin_gccgcc10_O1/2019_04-Exercise-b:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1153:	bb 64 00 00 00       	mov    $0x64,%ebx
    1158:	48 8d 2d a5 0e 00 00 	lea    0xea5(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    115f:	83 c3 01             	add    $0x1,%ebx
    1162:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
    1168:	74 37                	je     11a1 <main+0x58>
    116a:	48 63 c3             	movslq %ebx,%rax
    116d:	48 69 c0 c5 85 9a 93 	imul   $0xffffffff939a85c5,%rax,%rax
    1174:	48 c1 e8 20          	shr    $0x20,%rax
    1178:	01 d8                	add    %ebx,%eax
    117a:	c1 f8 06             	sar    $0x6,%eax
    117d:	89 da                	mov    %ebx,%edx
    117f:	c1 fa 1f             	sar    $0x1f,%edx
    1182:	29 d0                	sub    %edx,%eax
    1184:	6b c0 6f             	imul   $0x6f,%eax,%eax
    1187:	39 c3                	cmp    %eax,%ebx
    1189:	75 d4                	jne    115f <main+0x16>
    118b:	89 da                	mov    %ebx,%edx
    118d:	48 89 ee             	mov    %rbp,%rsi
    1190:	bf 01 00 00 00       	mov    $0x1,%edi
    1195:	b8 00 00 00 00       	mov    $0x0,%eax
    119a:	e8 b1 fe ff ff       	callq  1050 <__printf_chk@plt>
    119f:	eb be                	jmp    115f <main+0x16>
