...
/app/bin_gccgcc10_O1/2019_04-Exercise-a:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d 2d 01 00 00 	lea    0x12d(%rip),%rdi        # 11f5 <main>
...
0000000000001189 <interesting>:
    1189:	f3 0f 1e fa          	endbr64 
    118d:	48 83 ec 18          	sub    $0x18,%rsp
    1191:	41 89 f8             	mov    %edi,%r8d
    1194:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    119b:	00 00 
    119d:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11a2:	31 c0                	xor    %eax,%eax
    11a4:	48 8d 7c 24 04       	lea    0x4(%rsp),%rdi
    11a9:	48 8d 0d 54 0e 00 00 	lea    0xe54(%rip),%rcx        # 2004 <_IO_stdin_used+0x4>
    11b0:	ba 04 00 00 00       	mov    $0x4,%edx
    11b5:	be 01 00 00 00       	mov    $0x1,%esi
    11ba:	e8 d1 fe ff ff       	callq  1090 <__sprintf_chk@plt>
    11bf:	0f b6 44 24 05       	movzbl 0x5(%rsp),%eax
    11c4:	ba 00 00 00 00       	mov    $0x0,%edx
    11c9:	38 44 24 04          	cmp    %al,0x4(%rsp)
    11cd:	75 0a                	jne    11d9 <interesting+0x50>
    11cf:	38 44 24 06          	cmp    %al,0x6(%rsp)
    11d3:	0f 94 c2             	sete   %dl
    11d6:	0f b6 d2             	movzbl %dl,%edx
    11d9:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11de:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11e5:	00 00 
    11e7:	75 07                	jne    11f0 <interesting+0x67>
    11e9:	89 d0                	mov    %edx,%eax
    11eb:	48 83 c4 18          	add    $0x18,%rsp
    11ef:	c3                   	retq   
    11f0:	e8 7b fe ff ff       	callq  1070 <__stack_chk_fail@plt>

00000000000011f5 <main>:
    11f5:	f3 0f 1e fa          	endbr64 
    11f9:	55                   	push   %rbp
    11fa:	53                   	push   %rbx
    11fb:	48 83 ec 08          	sub    $0x8,%rsp
    11ff:	bb 64 00 00 00       	mov    $0x64,%ebx
    1204:	48 8d 2d fc 0d 00 00 	lea    0xdfc(%rip),%rbp        # 2007 <_IO_stdin_used+0x7>
    120b:	eb 0b                	jmp    1218 <main+0x23>
    120d:	83 c3 01             	add    $0x1,%ebx
    1210:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
    1216:	74 21                	je     1239 <main+0x44>
    1218:	89 df                	mov    %ebx,%edi
    121a:	e8 6a ff ff ff       	callq  1189 <interesting>
    121f:	85 c0                	test   %eax,%eax
    1221:	74 ea                	je     120d <main+0x18>
    1223:	89 da                	mov    %ebx,%edx
    1225:	48 89 ee             	mov    %rbp,%rsi
    1228:	bf 01 00 00 00       	mov    $0x1,%edi
    122d:	b8 00 00 00 00       	mov    $0x0,%eax
    1232:	e8 49 fe ff ff       	callq  1080 <__printf_chk@plt>
    1237:	eb d4                	jmp    120d <main+0x18>
