...
/app/bin_gccgcc10_O0/oddandeven:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11f0:	75 18                	jne    120a <main+0x61>
    11f2:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11f5:	89 c6                	mov    %eax,%esi
    11f7:	48 8d 3d 21 0e 00 00 	lea    0xe21(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    11fe:	b8 00 00 00 00       	mov    $0x0,%eax
    1203:	e8 98 fe ff ff       	callq  10a0 <printf@plt>
    1208:	eb 16                	jmp    1220 <main+0x77>
    120a:	8b 45 f4             	mov    -0xc(%rbp),%eax
    120d:	89 c6                	mov    %eax,%esi
    120f:	48 8d 3d 20 0e 00 00 	lea    0xe20(%rip),%rdi        # 2036 <_IO_stdin_used+0x36>
    1216:	b8 00 00 00 00       	mov    $0x0,%eax
    121b:	e8 80 fe ff ff       	callq  10a0 <printf@plt>
    1220:	b8 00 00 00 00       	mov    $0x0,%eax
    1225:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1229:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1230:	00 00 
    1232:	74 05                	je     1239 <main+0x90>
