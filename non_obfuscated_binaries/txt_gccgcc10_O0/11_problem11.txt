...
/app/bin_gccgcc10_O0/11_problem11:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	c7 45 fc 04 00 00 00 	movl   $0x4,-0x4(%rbp)
    ...
    1176:	eb 2f                	jmp    11a7 <main+0x5e>
    1178:	c7 45 f8 02 00 00 00 	movl   $0x2,-0x8(%rbp)
    117f:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1182:	99                   	cltd   
    1183:	f7 7d f8             	idivl  -0x8(%rbp)
    1186:	89 d0                	mov    %edx,%eax
    1188:	85 c0                	test   %eax,%eax
    118a:	75 0f                	jne    119b <main+0x52>
    118c:	83 7d fc 02          	cmpl   $0x2,-0x4(%rbp)
    1190:	74 09                	je     119b <main+0x52>
    1192:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    1199:	eb 0c                	jmp    11a7 <main+0x5e>
    119b:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    119f:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11a2:	3b 45 fc             	cmp    -0x4(%rbp),%eax
    11a5:	7c d8                	jl     117f <main+0x36>
    11a7:	83 7d f4 00          	cmpl   $0x0,-0xc(%rbp)
    11ab:	74 18                	je     11c5 <main+0x7c>
    ...
    11c3:	eb 16                	jmp    11db <main+0x92>
    11c5:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11c8:	89 c6                	mov    %eax,%esi
    11ca:	48 8d 3d 44 0e 00 00 	lea    0xe44(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
