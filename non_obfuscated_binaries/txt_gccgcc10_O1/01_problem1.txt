...
/app/bin_gccgcc10_O1/01_problem1:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d0:	48 8d 3d 3a 0e 00 00 	lea    0xe3a(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    11d7:	b8 00 00 00 00       	mov    $0x0,%eax
    11dc:	e8 cf fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e1:	48 8d 3d 2c 0e 00 00 	lea    0xe2c(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    11e8:	e8 93 fe ff ff       	callq  1080 <puts@plt>
    11ed:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11f2:	48 8d 3d 18 0e 00 00 	lea    0xe18(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    11f9:	b8 00 00 00 00       	mov    $0x0,%eax
    11fe:	e8 ad fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1203:	8b 14 24             	mov    (%rsp),%edx
    1206:	0f af 54 24 04       	imul   0x4(%rsp),%edx
    120b:	48 8d 35 16 0e 00 00 	lea    0xe16(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    ...
    122d:	00 00 
    122f:	75 0a                	jne    123b <main+0x92>
    1231:	b8 00 00 00 00       	mov    $0x0,%eax
    1236:	48 83 c4 18          	add    $0x18,%rsp
    123a:	c3                   	retq   
    123b:	e8 50 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
