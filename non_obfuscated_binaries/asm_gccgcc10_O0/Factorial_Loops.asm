...
/app/bin_gccgcc10_O0/Factorial_Loops:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	f2 0f 10 05 94 0e 00 	movsd  0xe94(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    11ab:	00 
    11ac:	f2 0f 11 45 f0       	movsd  %xmm0,-0x10(%rbp)
    ...
    11c9:	48 8d 3d 4b 0e 00 00 	lea    0xe4b(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    11d0:	b8 00 00 00 00       	mov    $0x0,%eax
    11d5:	e8 b6 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11da:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11dd:	89 45 ec             	mov    %eax,-0x14(%rbp)
    11e0:	eb 1b                	jmp    11fd <main+0x74>
    11e2:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11e6:	f2 0f 2a 45 ec       	cvtsi2sdl -0x14(%rbp),%xmm0
    11eb:	f2 0f 10 4d f0       	movsd  -0x10(%rbp),%xmm1
    11f0:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    11f4:	f2 0f 11 45 f0       	movsd  %xmm0,-0x10(%rbp)
    11f9:	83 6d ec 01          	subl   $0x1,-0x14(%rbp)
    11fd:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
    1201:	7f df                	jg     11e2 <main+0x59>
    1203:	8b 45 e8             	mov    -0x18(%rbp),%eax
    1206:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    120a:	66 48 0f 6e c2       	movq   %rdx,%xmm0
    120f:	89 c6                	mov    %eax,%esi
    1211:	48 8d 3d 06 0e 00 00 	lea    0xe06(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    1218:	b8 01 00 00 00       	mov    $0x1,%eax
    121d:	e8 5e fe ff ff       	callq  1080 <printf@plt>
