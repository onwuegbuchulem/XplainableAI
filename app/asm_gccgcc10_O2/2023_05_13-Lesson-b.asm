...
/app/bin_gccgcc10_O2/2023_05_13-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c4:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    10c9:	e8 a2 ff ff ff       	callq  1070 <clock_gettime@plt>
    10ce:	48 8b 54 24 18       	mov    0x18(%rsp),%rdx
    10d3:	31 c0                	xor    %eax,%eax
    10d5:	48 2b 54 24 08       	sub    0x8(%rsp),%rdx
    ...
    10eb:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    10f0:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10f7:	00 00 
    10f9:	75 07                	jne    1102 <main+0x62>
    10fb:	31 c0                	xor    %eax,%eax
    10fd:	48 83 c4 38          	add    $0x38,%rsp
    1101:	c3                   	retq   
    1102:	e8 79 ff ff ff       	callq  1080 <__stack_chk_fail@plt>
