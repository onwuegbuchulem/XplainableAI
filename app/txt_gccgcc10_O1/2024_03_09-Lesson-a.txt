...
/app/bin_gccgcc10_O1/2024_03_09-Lesson-a:     file format elf64-x86-64
...
00000000000011a9 <astring>:
    ...
    11ad:	53                   	push   %rbx
    11ae:	bf 0d 00 00 00       	mov    $0xd,%edi
    11b3:	e8 e8 fe ff ff       	callq  10a0 <malloc@plt>
    11b8:	48 89 c3             	mov    %rax,%rbx
    11bb:	48 8d 50 0c          	lea    0xc(%rax),%rdx
    11bf:	c6 00 41             	movb   $0x41,(%rax)
    11c2:	48 83 c0 01          	add    $0x1,%rax
    11c6:	48 39 d0             	cmp    %rdx,%rax
    11c9:	75 f4                	jne    11bf <astring+0x16>
    11cb:	c6 43 0c 00          	movb   $0x0,0xc(%rbx)
    11cf:	48 89 da             	mov    %rbx,%rdx
    11d2:	48 8d 35 2b 0e 00 00 	lea    0xe2b(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11d9:	bf 01 00 00 00       	mov    $0x1,%edi
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 c8 fe ff ff       	callq  10b0 <__printf_chk@plt>
    11e8:	48 89 d8             	mov    %rbx,%rax
    11eb:	5b                   	pop    %rbx
    11ec:	c3                   	retq   

00000000000011ed <header>:
    11ed:	f3 0f 1e fa          	endbr64 
    11f1:	48 83 ec 08          	sub    $0x8,%rsp
    11f5:	48 8d 3d 20 0e 00 00 	lea    0xe20(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    11fc:	e8 8f fe ff ff       	callq  1090 <puts@plt>
...
0000000000001206 <main>:
    ...
    120a:	53                   	push   %rbx
    120b:	48 8d 3d 25 0e 00 00 	lea    0xe25(%rip),%rdi        # 2037 <_IO_stdin_used+0x37>
    1212:	e8 79 fe ff ff       	callq  1090 <puts@plt>
    1217:	e8 8d ff ff ff       	callq  11a9 <astring>
    121c:	48 89 c3             	mov    %rax,%rbx
    121f:	e8 c9 ff ff ff       	callq  11ed <header>
    1224:	48 89 da             	mov    %rbx,%rdx
    ...
    1240:	e8 3b fe ff ff       	callq  1080 <free@plt>
