...
/app/bin_gccgcc10_O3/word_parse02:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    110e:	48 8b 15 fb 2e 00 00 	mov    0x2efb(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    1115:	be 40 00 00 00       	mov    $0x40,%esi
    111a:	48 89 ef             	mov    %rbp,%rdi
    111d:	e8 8e ff ff ff       	callq  10b0 <fgets@plt>
    1122:	48 8d 35 ec 0e 00 00 	lea    0xeec(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    1129:	48 89 ef             	mov    %rbp,%rdi
    112c:	e8 9f ff ff ff       	callq  10d0 <strtok@plt>
    1131:	48 85 c0             	test   %rax,%rax
    1134:	74 21                	je     1157 <main+0x77>
    1136:	48 89 c7             	mov    %rax,%rdi
    1139:	48 8d 1d d5 0e 00 00 	lea    0xed5(%rip),%rbx        # 2015 <_IO_stdin_used+0x15>
    1140:	e8 4b ff ff ff       	callq  1090 <puts@plt>
    1145:	31 ff                	xor    %edi,%edi
    1147:	48 89 de             	mov    %rbx,%rsi
    114a:	e8 81 ff ff ff       	callq  10d0 <strtok@plt>
    114f:	48 89 c7             	mov    %rax,%rdi
    1152:	48 85 c0             	test   %rax,%rax
    1155:	75 e9                	jne    1140 <main+0x60>
    1157:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    115c:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1163:	00 00 
    1165:	75 09                	jne    1170 <main+0x90>
    1167:	48 83 c4 58          	add    $0x58,%rsp
    116b:	31 c0                	xor    %eax,%eax
    116d:	5b                   	pop    %rbx
    116e:	5d                   	pop    %rbp
    116f:	c3                   	retq   
    1170:	e8 2b ff ff ff       	callq  10a0 <__stack_chk_fail@plt>
