...
/app/bin_gccgcc10_O1/2022_08-Exercise-c:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    115a:	89 df                	mov    %ebx,%edi
    115c:	e8 ef fe ff ff       	callq  1050 <putc@plt>
    1161:	8d 7b 20             	lea    0x20(%rbx),%edi
    1164:	48 8b 35 a5 2e 00 00 	mov    0x2ea5(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    116b:	e8 e0 fe ff ff       	callq  1050 <putc@plt>
    1170:	83 c3 01             	add    $0x1,%ebx
    1173:	83 fb 5b             	cmp    $0x5b,%ebx
    1176:	75 db                	jne    1153 <main+0xa>
    1178:	48 8b 35 91 2e 00 00 	mov    0x2e91(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    117f:	bf 0a 00 00 00       	mov    $0xa,%edi
    1184:	e8 c7 fe ff ff       	callq  1050 <putc@plt>
