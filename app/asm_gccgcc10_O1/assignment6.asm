...
/app/bin_gccgcc10_O1/assignment6:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b5:	48 8d 3d 5c 0e 00 00 	lea    0xe5c(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    11bc:	b8 00 00 00 00       	mov    $0x0,%eax
    11c1:	e8 ca fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c6:	48 8d 35 4e 0e 00 00 	lea    0xe4e(%rip),%rsi        # 201b <_IO_stdin_used+0x1b>
    ...
    11e1:	48 8d 3d 30 0e 00 00 	lea    0xe30(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    11e8:	b8 00 00 00 00       	mov    $0x0,%eax
    11ed:	e8 9e fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f2:	8b 04 24             	mov    (%rsp),%eax
    11f5:	99                   	cltd   
    11f6:	f7 7c 24 04          	idivl  0x4(%rsp)
    11fa:	85 d2                	test   %edx,%edx
    11fc:	75 30                	jne    122e <main+0xa5>
    11fe:	48 8d 35 2c 0e 00 00 	lea    0xe2c(%rip),%rsi        # 2031 <_IO_stdin_used+0x31>
