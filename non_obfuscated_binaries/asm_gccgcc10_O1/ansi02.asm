...
/app/bin_gccgcc10_O1/ansi02:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    116f:	55                   	push   %rbp
    1170:	53                   	push   %rbx
    1171:	bd 28 00 00 00       	mov    $0x28,%ebp
    1176:	4c 8d 25 87 0e 00 00 	lea    0xe87(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    117d:	bb 1e 00 00 00       	mov    $0x1e,%ebx
    1182:	41 89 e9             	mov    %ebp,%r9d
    1185:	41 89 d8             	mov    %ebx,%r8d
    1188:	89 e9                	mov    %ebp,%ecx
    118a:	89 da                	mov    %ebx,%edx
    118c:	4c 89 e6             	mov    %r12,%rsi
    118f:	bf 01 00 00 00       	mov    $0x1,%edi
    1194:	b8 00 00 00 00       	mov    $0x0,%eax
    1199:	e8 d2 fe ff ff       	callq  1070 <__printf_chk@plt>
    119e:	83 c3 01             	add    $0x1,%ebx
    11a1:	83 fb 26             	cmp    $0x26,%ebx
    11a4:	75 dc                	jne    1182 <main+0x19>
    11a6:	48 8d 3d 67 0e 00 00 	lea    0xe67(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    11ad:	e8 ae fe ff ff       	callq  1060 <puts@plt>
    11b2:	83 c5 01             	add    $0x1,%ebp
    11b5:	83 fd 30             	cmp    $0x30,%ebp
    11b8:	75 c3                	jne    117d <main+0x14>
