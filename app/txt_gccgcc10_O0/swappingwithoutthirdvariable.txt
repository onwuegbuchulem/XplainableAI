...
/app/bin_gccgcc10_O0/swappingwithoutthirdvariable:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d0:	48 8d 55 f4          	lea    -0xc(%rbp),%rdx
    11d4:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    11d8:	48 89 c6             	mov    %rax,%rsi
    11db:	48 8d 3d 38 0e 00 00 	lea    0xe38(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    ...
    11f4:	89 45 f0             	mov    %eax,-0x10(%rbp)
    11f7:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11fa:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11fd:	29 d0                	sub    %edx,%eax
    11ff:	89 45 f4             	mov    %eax,-0xc(%rbp)
    1202:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1205:	8b 55 f4             	mov    -0xc(%rbp),%edx
    1208:	29 d0                	sub    %edx,%eax
    120a:	89 45 f0             	mov    %eax,-0x10(%rbp)
    120d:	8b 55 f4             	mov    -0xc(%rbp),%edx
    1210:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1213:	89 c6                	mov    %eax,%esi
    1215:	48 8d 3d 04 0e 00 00 	lea    0xe04(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    ...
    123a:	e8 51 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    123f:	c9                   	leaveq 
    1240:	c3                   	retq   
