...
/app/bin_gccgcc10_O0/UppercaseToLowercase:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d0:	48 8d 45 f6          	lea    -0xa(%rbp),%rax
    11d4:	48 89 c6             	mov    %rax,%rsi
    11d7:	48 8d 3d 3f 0e 00 00 	lea    0xe3f(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 c8 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e8:	0f b6 45 f6          	movzbl -0xa(%rbp),%eax
    11ec:	83 c0 20             	add    $0x20,%eax
    11ef:	88 45 f7             	mov    %al,-0x9(%rbp)
    11f2:	0f be 45 f7          	movsbl -0x9(%rbp),%eax
    11f6:	89 c6                	mov    %eax,%esi
    11f8:	48 8d 3d 21 0e 00 00 	lea    0xe21(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    11ff:	b8 00 00 00 00       	mov    $0x0,%eax
    1204:	e8 97 fe ff ff       	callq  10a0 <printf@plt>
    1209:	b8 00 00 00 00       	mov    $0x0,%eax
    120e:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1212:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1219:	00 00 
    121b:	74 05                	je     1222 <main+0x79>
