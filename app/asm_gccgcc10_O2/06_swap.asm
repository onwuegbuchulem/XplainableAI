...
/app/bin_gccgcc10_O2/06_swap:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1068:	b9 04 00 00 00       	mov    $0x4,%ecx
...
0000000000001180 <swap>:
    1180:	f3 0f 1e fa          	endbr64 
    1184:	8b 07                	mov    (%rdi),%eax
    1186:	8b 16                	mov    (%rsi),%edx
    1188:	89 17                	mov    %edx,(%rdi)
    118a:	89 06                	mov    %eax,(%rsi)
    118c:	c3                   	retq   
