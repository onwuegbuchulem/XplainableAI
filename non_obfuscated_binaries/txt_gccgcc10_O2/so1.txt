...
/app/bin_gccgcc10_O2/so1:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10d1:	8b 7c 24 04          	mov    0x4(%rsp),%edi
    10d5:	83 ff 01             	cmp    $0x1,%edi
    10d8:	7e 53                	jle    112d <main+0x8d>
    10da:	b8 02 00 00 00       	mov    $0x2,%eax
    10df:	be 01 00 00 00       	mov    $0x1,%esi
    10e4:	31 d2                	xor    %edx,%edx
    10e6:	eb 0a                	jmp    10f2 <main+0x52>
    10e8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    10ef:	00 
    10f0:	89 c8                	mov    %ecx,%eax
    10f2:	8d 0c 02             	lea    (%rdx,%rax,1),%ecx
    10f5:	a8 01                	test   $0x1,%al
    10f7:	0f 44 d1             	cmove  %ecx,%edx
    10fa:	8d 0c 06             	lea    (%rsi,%rax,1),%ecx
    10fd:	89 c6                	mov    %eax,%esi
    10ff:	39 f9                	cmp    %edi,%ecx
    1101:	7e ed                	jle    10f0 <main+0x50>
    1103:	31 c0                	xor    %eax,%eax
    1105:	48 8d 35 fb 0e 00 00 	lea    0xefb(%rip),%rsi        # 2007 <_IO_stdin_used+0x7>
