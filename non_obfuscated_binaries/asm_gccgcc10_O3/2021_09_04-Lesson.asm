...
/app/bin_gccgcc10_O3/2021_09_04-Lesson:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ea:	0f 29 44 24 30       	movaps %xmm0,0x30(%rsp)
    10ef:	66 0f 6f 05 29 0f 00 	movdqa 0xf29(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10f6:	00 
    10f7:	c7 44 24 2a 6f 72 6c 	movl   $0x646c726f,0x2a(%rsp)
    10fe:	64 
    10ff:	0f 29 44 24 50       	movaps %xmm0,0x50(%rsp)
    1104:	66 0f 6f 05 24 0f 00 	movdqa 0xf24(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    110b:	00 
    110c:	c7 44 24 40 20 74 65 	movl   $0x73657420,0x40(%rsp)
    1113:	73 
    1114:	0f 29 44 24 60       	movaps %xmm0,0x60(%rsp)
    1119:	48 89 44 24 22       	mov    %rax,0x22(%rsp)
    111e:	b8 21 00 00 00       	mov    $0x21,%eax
    1123:	66 89 44 24 2e       	mov    %ax,0x2e(%rsp)
    1128:	48 8d 44 24 22       	lea    0x22(%rsp),%rax
    112d:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1132:	48 8d 44 24 30       	lea    0x30(%rsp),%rax
    1137:	c6 44 24 74 00       	movb   $0x0,0x74(%rsp)
    113c:	66 48 0f 6e c8       	movq   %rax,%xmm1
    1141:	48 8d 44 24 50       	lea    0x50(%rsp),%rax
    1146:	c7 44 24 70 72 69 6e 	movl   $0x676e6972,0x70(%rsp)
    114d:	67 
    114e:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    1153:	66 0f 6c c1          	punpcklqdq %xmm1,%xmm0
    1157:	0f 29 04 24          	movaps %xmm0,(%rsp)
    115b:	4c 8b 2b             	mov    (%rbx),%r13
    115e:	48 89 ee             	mov    %rbp,%rsi
    1161:	bf 01 00 00 00       	mov    $0x1,%edi
    1166:	31 c0                	xor    %eax,%eax
    1168:	4c 89 ea             	mov    %r13,%rdx
    116b:	e8 20 ff ff ff       	callq  1090 <__printf_chk@plt>
    1170:	41 0f b6 45 00       	movzbl 0x0(%r13),%eax
    1175:	84 c0                	test   %al,%al
    1177:	74 18                	je     1191 <main+0xf1>
    1179:	4c 89 ea             	mov    %r13,%rdx
    117c:	0f 1f 40 00          	nopl   0x0(%rax)
    1180:	83 c0 01             	add    $0x1,%eax
    1183:	48 83 c2 01          	add    $0x1,%rdx
    1187:	88 42 ff             	mov    %al,-0x1(%rdx)
    118a:	0f b6 02             	movzbl (%rdx),%eax
    118d:	84 c0                	test   %al,%al
    118f:	75 ef                	jne    1180 <main+0xe0>
    1191:	4c 89 ef             	mov    %r13,%rdi
    1194:	48 83 c3 08          	add    $0x8,%rbx
    1198:	e8 d3 fe ff ff       	callq  1070 <puts@plt>
    119d:	4c 39 e3             	cmp    %r12,%rbx
    11a0:	75 b9                	jne    115b <main+0xbb>
    11a2:	48 8b 44 24 78       	mov    0x78(%rsp),%rax
    11a7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11ae:	00 00 
    11b0:	75 10                	jne    11c2 <main+0x122>
    11b2:	48 81 c4 88 00 00 00 	add    $0x88,%rsp
