...
/app/bin_gccgcc10_O3/ex18:     file format elf64-x86-64
...
0000000000001160 <main>:
    ...
    1173:	0f 8e dd 00 00 00    	jle    1256 <main+0xf6>
    ...
    1193:	0f 84 c9 00 00 00    	je     1262 <main+0x102>
    ...
    121b:	bf 0a 00 00 00       	mov    $0xa,%edi
    1220:	c6 05 39 01 00 00 00 	movb   $0x0,0x139(%rip)        # 1360 <sorted_order>
    1227:	e8 b4 fe ff ff       	callq  10e0 <putchar@plt>
    122c:	48 8d 35 27 0e 00 00 	lea    0xe27(%rip),%rsi        # 205a <_IO_stdin_used+0x5a>
    1233:	bf 01 00 00 00       	mov    $0x1,%edi
    1238:	31 c0                	xor    %eax,%eax
    123a:	e8 f1 fe ff ff       	callq  1130 <__printf_chk@plt>
    123f:	48 8d 3d 1a 01 00 00 	lea    0x11a(%rip),%rdi        # 1360 <sorted_order>
    1246:	e8 f5 02 00 00       	callq  1540 <dump>
    124b:	5b                   	pop    %rbx
    ...
    1253:	41 5e                	pop    %r14
    1255:	c3                   	retq   
    1256:	48 8d 3d e7 0d 00 00 	lea    0xde7(%rip),%rdi        # 2044 <_IO_stdin_used+0x44>
    125d:	e8 4e 01 00 00       	callq  13b0 <die>
    1262:	48 8d 3d a6 0d 00 00 	lea    0xda6(%rip),%rdi        # 200f <_IO_stdin_used+0xf>
    1269:	e8 42 01 00 00       	callq  13b0 <die>
...
00000000000013f0 <bubble_sort>:
    ...
    141d:	74 6a                	je     1489 <bubble_sort+0x99>
    ...
    1430:	41 83 ff 01          	cmp    $0x1,%r15d
    1434:	7e 41                	jle    1477 <bubble_sort+0x87>
    1436:	41 8d 47 fe          	lea    -0x2(%r15),%eax
    143a:	45 31 ed             	xor    %r13d,%r13d
    143d:	4d 8d 64 86 04       	lea    0x4(%r14,%rax,4),%r12
    1442:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1448:	4c 89 f3             	mov    %r14,%rbx
    144b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1450:	8b 73 04             	mov    0x4(%rbx),%esi
    1453:	8b 3b                	mov    (%rbx),%edi
    1455:	ff d5                	callq  *%rbp
    1457:	85 c0                	test   %eax,%eax
    1459:	7e 0a                	jle    1465 <bubble_sort+0x75>
    145b:	8b 43 04             	mov    0x4(%rbx),%eax
    145e:	8b 13                	mov    (%rbx),%edx
    1460:	89 03                	mov    %eax,(%rbx)
    1462:	89 53 04             	mov    %edx,0x4(%rbx)
    1465:	48 83 c3 04          	add    $0x4,%rbx
    1469:	4c 39 e3             	cmp    %r12,%rbx
    146c:	75 e2                	jne    1450 <bubble_sort+0x60>
    146e:	41 83 c5 01          	add    $0x1,%r13d
    1472:	45 39 ef             	cmp    %r13d,%r15d
    1475:	75 d1                	jne    1448 <bubble_sort+0x58>
    1477:	48 83 c4 08          	add    $0x8,%rsp
    147b:	4c 89 f0             	mov    %r14,%rax
    147e:	5b                   	pop    %rbx
    147f:	5d                   	pop    %rbp
    1480:	41 5c                	pop    %r12
    1482:	41 5d                	pop    %r13
    ...
    1486:	41 5f                	pop    %r15
    1488:	c3                   	retq   
    1489:	48 8d 3d 7f 0b 00 00 	lea    0xb7f(%rip),%rdi        # 200f <_IO_stdin_used+0xf>
    1490:	e8 1b ff ff ff       	callq  13b0 <die>
