...
/app/bin_gccgcc10_O2/2024_08_17-Lesson-a:     file format elf64-x86-64
...
0000000000001160 <main>:
    ...
    1185:	48 b8 48 65 6c 6c 6f 	movabs $0x6874206f6c6c6548,%rax
    118c:	20 74 68 
    118f:	4c 8d 64 24 0b       	lea    0xb(%rsp),%r12
    1194:	c7 44 24 13 65 72 65 	movl   $0x21657265,0x13(%rsp)
    119b:	21 
    119c:	4c 89 e2             	mov    %r12,%rdx
    119f:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    11a4:	48 89 44 24 0b       	mov    %rax,0xb(%rsp)
    11a9:	31 c0                	xor    %eax,%eax
    11ab:	e8 80 ff ff ff       	callq  1130 <__printf_chk@plt>
    11b0:	bf 00 08 00 00       	mov    $0x800,%edi
    11b5:	e8 46 ff ff ff       	callq  1100 <malloc@plt>
    11ba:	48 85 c0             	test   %rax,%rax
    11bd:	74 7d                	je     123c <main+0xdc>
    11bf:	48 89 c5             	mov    %rax,%rbp
    11c2:	ba 00 08 00 00       	mov    $0x800,%edx
    11c7:	4c 89 e6             	mov    %r12,%rsi
    11ca:	48 89 c7             	mov    %rax,%rdi
    11cd:	e8 4e ff ff ff       	callq  1120 <__strcpy_chk@plt>
    11d2:	48 89 ea             	mov    %rbp,%rdx
    11d5:	bf 01 00 00 00       	mov    $0x1,%edi
    11da:	31 c0                	xor    %eax,%eax
    11dc:	48 8d 35 36 0e 00 00 	lea    0xe36(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    11e3:	e8 48 ff ff ff       	callq  1130 <__printf_chk@plt>
    11e8:	4c 89 e7             	mov    %r12,%rdi
    11eb:	e8 f0 fe ff ff       	callq  10e0 <strlen@plt>
    11f0:	48 89 ef             	mov    %rbp,%rdi
    11f3:	48 8d 70 01          	lea    0x1(%rax),%rsi
    11f7:	e8 14 ff ff ff       	callq  1110 <realloc@plt>
    11fc:	48 89 c5             	mov    %rax,%rbp
    11ff:	48 85 c0             	test   %rax,%rax
    1202:	74 64                	je     1268 <main+0x108>
    1204:	48 89 c2             	mov    %rax,%rdx
    1207:	bf 01 00 00 00       	mov    $0x1,%edi
    120c:	48 8d 35 39 0e 00 00 	lea    0xe39(%rip),%rsi        # 204c <_IO_stdin_used+0x4c>
    1213:	31 c0                	xor    %eax,%eax
    1215:	e8 16 ff ff ff       	callq  1130 <__printf_chk@plt>
    121a:	48 89 ef             	mov    %rbp,%rdi
    121d:	e8 ae fe ff ff       	callq  10d0 <free@plt>
    1222:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1227:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    122e:	00 00 
    1230:	75 31                	jne    1263 <main+0x103>
    1232:	48 83 c4 28          	add    $0x28,%rsp
    1236:	31 c0                	xor    %eax,%eax
    1238:	5d                   	pop    %rbp
    1239:	41 5c                	pop    %r12
    123b:	c3                   	retq   
    123c:	48 8b 0d dd 2d 00 00 	mov    0x2ddd(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1243:	ba 28 00 00 00       	mov    $0x28,%edx
    1248:	be 01 00 00 00       	mov    $0x1,%esi
    124d:	48 8d 3d 14 0e 00 00 	lea    0xe14(%rip),%rdi        # 2068 <_IO_stdin_used+0x68>
    1254:	e8 f7 fe ff ff       	callq  1150 <fwrite@plt>
    1259:	bf 01 00 00 00       	mov    $0x1,%edi
    125e:	e8 dd fe ff ff       	callq  1140 <exit@plt>
    1263:	e8 88 fe ff ff       	callq  10f0 <__stack_chk_fail@plt>
    1268:	48 8b 0d b1 2d 00 00 	mov    0x2db1(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    126f:	ba 1d 00 00 00       	mov    $0x1d,%edx
    1274:	be 01 00 00 00       	mov    $0x1,%esi
    1279:	48 8d 3d ae 0d 00 00 	lea    0xdae(%rip),%rdi        # 202e <_IO_stdin_used+0x2e>
    1280:	e8 cb fe ff ff       	callq  1150 <fwrite@plt>
    1285:	bf 01 00 00 00       	mov    $0x1,%edi
    128a:	e8 b1 fe ff ff       	callq  1140 <exit@plt>
    128f:	90                   	nop
