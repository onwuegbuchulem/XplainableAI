...
/app/bin_gccgcc10_O2/2020_09_05-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10b2:	48 83 ec 30          	sub    $0x30,%rsp
    10b6:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10bd:	00 00 
    10bf:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    10c4:	31 c0                	xor    %eax,%eax
    10c6:	4c 8d 64 24 10       	lea    0x10(%rsp),%r12
    10cb:	e8 b0 ff ff ff       	callq  1080 <__printf_chk@plt>
    10d0:	48 8d 54 24 0c       	lea    0xc(%rsp),%rdx
    10d5:	4c 89 e6             	mov    %r12,%rsi
    10d8:	31 c0                	xor    %eax,%eax
    10da:	48 8d 3d 3f 0f 00 00 	lea    0xf3f(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    10e1:	e8 aa ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10e6:	8b 4c 24 0c          	mov    0xc(%rsp),%ecx
    10ea:	31 c0                	xor    %eax,%eax
    10ec:	4c 89 e2             	mov    %r12,%rdx
    10ef:	48 8d 35 30 0f 00 00 	lea    0xf30(%rip),%rsi        # 2026 <_IO_stdin_used+0x26>
    10f6:	bf 01 00 00 00       	mov    $0x1,%edi
    10fb:	e8 80 ff ff ff       	callq  1080 <__printf_chk@plt>
    1100:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    1105:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    110c:	00 00 
    110e:	75 09                	jne    1119 <main+0x79>
    1110:	48 83 c4 30          	add    $0x30,%rsp
    1114:	31 c0                	xor    %eax,%eax
    1116:	41 5c                	pop    %r12
    1118:	c3                   	retq   
    1119:	e8 52 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
