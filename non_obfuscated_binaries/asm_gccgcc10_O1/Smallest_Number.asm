...
/app/bin_gccgcc10_O1/Smallest_Number:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    122a:	7d 5b                	jge    1287 <main+0xfe>
    122c:	3b 54 24 14          	cmp    0x14(%rsp),%edx
    1230:	7c 3d                	jl     126f <main+0xe6>
    1232:	8b 4c 24 14          	mov    0x14(%rsp),%ecx
    1236:	39 c2                	cmp    %eax,%edx
    1238:	0f 4f d0             	cmovg  %eax,%edx
    123b:	39 d1                	cmp    %edx,%ecx
    123d:	7c 6a                	jl     12a9 <main+0x120>
    123f:	48 8d 35 01 0e 00 00 	lea    0xe01(%rip),%rsi        # 2047 <_IO_stdin_used+0x47>
    ...
    126e:	c3                   	retq   
    126f:	48 8d 35 f2 0d 00 00 	lea    0xdf2(%rip),%rsi        # 2068 <_IO_stdin_used+0x68>
    ...
    1287:	7e a9                	jle    1232 <main+0xa9>
    1289:	3b 44 24 14          	cmp    0x14(%rsp),%eax
    128d:	7d a3                	jge    1232 <main+0xa9>
    128f:	89 c2                	mov    %eax,%edx
    1291:	48 8d 35 f0 0d 00 00 	lea    0xdf0(%rip),%rsi        # 2088 <_IO_stdin_used+0x88>
    ...
    12ab:	48 8d 35 f6 0d 00 00 	lea    0xdf6(%rip),%rsi        # 20a8 <_IO_stdin_used+0xa8>
