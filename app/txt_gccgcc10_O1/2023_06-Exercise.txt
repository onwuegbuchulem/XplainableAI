...
/app/bin_gccgcc10_O1/2023_06-Exercise:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11c6:	48 8d 35 4a 0e 00 00 	lea    0xe4a(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    ...
    11f9:	48 8d 35 27 0e 00 00 	lea    0xe27(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    1200:	bf 01 00 00 00       	mov    $0x1,%edi
    1205:	b8 00 00 00 00       	mov    $0x0,%eax
    120a:	e8 71 fe ff ff       	callq  1080 <__printf_chk@plt>
    120f:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1213:	8b 0c 24             	mov    (%rsp),%ecx
    1216:	89 14 24             	mov    %edx,(%rsp)
    1219:	89 4c 24 04          	mov    %ecx,0x4(%rsp)
    121d:	48 8d 35 17 0e 00 00 	lea    0xe17(%rip),%rsi        # 203b <_IO_stdin_used+0x3b>
    1224:	bf 01 00 00 00       	mov    $0x1,%edi
    1229:	b8 00 00 00 00       	mov    $0x0,%eax
    122e:	e8 4d fe ff ff       	callq  1080 <__printf_chk@plt>
    1233:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1238:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    123f:	00 00 
    1241:	75 0a                	jne    124d <main+0xc4>
