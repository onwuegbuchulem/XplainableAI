...
/app/bin_gccgcc10_O2/hello_wworld02:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1094:	66 0f 6f 05 84 0f 00 	movdqa 0xf84(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    109b:	00 
    109c:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10a3:	00 00 
    10a5:	48 89 44 24 58       	mov    %rax,0x58(%rsp)
    10aa:	31 c0                	xor    %eax,%eax
    10ac:	48 89 e2             	mov    %rsp,%rdx
    10af:	0f 11 04 24          	movups %xmm0,(%rsp)
    10b3:	66 0f 6f 05 75 0f 00 	movdqa 0xf75(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    10ba:	00 
    10bb:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10c0:	66 0f 6f 05 78 0f 00 	movdqa 0xf78(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    10c7:	00 
    10c8:	0f 11 44 24 20       	movups %xmm0,0x20(%rsp)
    10cd:	66 0f 6f 05 7b 0f 00 	movdqa 0xf7b(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    10d4:	00 
    10d5:	0f 11 44 24 30       	movups %xmm0,0x30(%rsp)
    10da:	66 0f 6f 05 7e 0f 00 	movdqa 0xf7e(%rip),%xmm0        # 2060 <_IO_stdin_used+0x60>
    10e1:	00 
    10e2:	0f 11 44 24 40       	movups %xmm0,0x40(%rsp)
    10e7:	e8 84 ff ff ff       	callq  1070 <__wprintf_chk@plt>
    10ec:	48 8b 44 24 58       	mov    0x58(%rsp),%rax
    10f1:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10f8:	00 00 
    10fa:	75 07                	jne    1103 <main+0x83>
    10fc:	31 c0                	xor    %eax,%eax
    10fe:	48 83 c4 68          	add    $0x68,%rsp
    1102:	c3                   	retq   
    1103:	e8 58 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
