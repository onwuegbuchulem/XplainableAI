...
/app/bin_gccgcc10_O1/2020_09_05-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b3:	48 8d 54 24 0c       	lea    0xc(%rsp),%rdx
    11b8:	48 8d 5c 24 10       	lea    0x10(%rsp),%rbx
    ...
    11d1:	8b 4c 24 0c          	mov    0xc(%rsp),%ecx
    11d5:	48 89 da             	mov    %rbx,%rdx
    11d8:	48 8d 35 47 0e 00 00 	lea    0xe47(%rip),%rsi        # 2026 <_IO_stdin_used+0x26>
    11df:	bf 01 00 00 00       	mov    $0x1,%edi
    11e4:	b8 00 00 00 00       	mov    $0x0,%eax
    11e9:	e8 92 fe ff ff       	callq  1080 <__printf_chk@plt>
    11ee:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    ...
    1207:	5b                   	pop    %rbx
    1208:	c3                   	retq   
    1209:	e8 62 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
