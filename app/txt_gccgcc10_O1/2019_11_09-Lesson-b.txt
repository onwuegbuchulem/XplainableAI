...
/app/bin_gccgcc10_O1/2019_11_09-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1181:	c7 04 24 22 00 00 00 	movl   $0x22,(%rsp)
    1188:	48 b8 47 65 6f 72 67 	movabs $0x6567726f6547,%rax
    118f:	65 00 00 
    1192:	48 89 44 24 04       	mov    %rax,0x4(%rsp)
    1197:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%rsp)
    119e:	00 
    119f:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    11a4:	b9 22 00 00 00       	mov    $0x22,%ecx
    ...
    11bf:	48 8b 04 24          	mov    (%rsp),%rax
    11c3:	89 c1                	mov    %eax,%ecx
    11c5:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11ca:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11cf:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    11d4:	48 8d 54 24 14       	lea    0x14(%rsp),%rdx
    ...
    11ef:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    11f4:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11fb:	00 00 
    11fd:	75 0a                	jne    1209 <main+0xa0>
    11ff:	b8 00 00 00 00       	mov    $0x0,%eax
    1204:	48 83 c4 38          	add    $0x38,%rsp
    1208:	c3                   	retq   
