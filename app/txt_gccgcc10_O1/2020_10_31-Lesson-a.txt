...
/app/bin_gccgcc10_O1/2020_10_31-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1173:	bb 02 00 00 00       	mov    $0x2,%ebx
    1178:	48 8d 2d 85 0e 00 00 	lea    0xe85(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    117f:	eb 14                	jmp    1195 <main+0x2c>
    1181:	48 8d 3d 80 0e 00 00 	lea    0xe80(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    1188:	e8 d3 fe ff ff       	callq  1060 <puts@plt>
    118d:	83 c3 01             	add    $0x1,%ebx
    1190:	83 fb 64             	cmp    $0x64,%ebx
    1193:	74 41                	je     11d6 <main+0x6d>
    1195:	89 da                	mov    %ebx,%edx
    ...
    11a9:	83 fb 02             	cmp    $0x2,%ebx
    11ac:	7e d3                	jle    1181 <main+0x18>
    11ae:	f6 c3 01             	test   $0x1,%bl
    11b1:	74 15                	je     11c8 <main+0x5f>
    11b3:	b9 02 00 00 00       	mov    $0x2,%ecx
    11b8:	83 c1 01             	add    $0x1,%ecx
    11bb:	39 d9                	cmp    %ebx,%ecx
    11bd:	74 c2                	je     1181 <main+0x18>
    11bf:	89 d8                	mov    %ebx,%eax
    11c1:	99                   	cltd   
    11c2:	f7 f9                	idiv   %ecx
    11c4:	85 d2                	test   %edx,%edx
    11c6:	75 f0                	jne    11b8 <main+0x4f>
    11c8:	48 8d 3d 3f 0e 00 00 	lea    0xe3f(%rip),%rdi        # 200e <_IO_stdin_used+0xe>
    11cf:	e8 8c fe ff ff       	callq  1060 <puts@plt>
    11d4:	eb b7                	jmp    118d <main+0x24>
    11d6:	b8 00 00 00 00       	mov    $0x0,%eax
    11db:	48 83 c4 08          	add    $0x8,%rsp
    11df:	5b                   	pop    %rbx
    11e0:	5d                   	pop    %rbp
    11e1:	c3                   	retq   
