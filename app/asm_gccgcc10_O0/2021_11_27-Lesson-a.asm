...
/app/bin_gccgcc10_O0/2021_11_27-Lesson-a:     file format elf64-x86-64
...
0000000000001090 <strspn@plt>:
    1090:	f3 0f 1e fa          	endbr64 
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <strspn@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    11a4:	48 b8 48 45 4c 4c 4f 	movabs $0x57202c4f4c4c4548,%rax
    11ab:	2c 20 57 
    11ae:	48 89 45 c2          	mov    %rax,-0x3e(%rbp)
    11b2:	c7 45 ca 4f 52 4c 44 	movl   $0x444c524f,-0x36(%rbp)
    11b9:	66 c7 45 ce 21 00    	movw   $0x21,-0x32(%rbp)
    11bf:	48 b8 41 42 43 44 45 	movabs $0x4847464544434241,%rax
    11c6:	46 47 48 
    11c9:	48 ba 49 4a 4b 4c 4d 	movabs $0x504f4e4d4c4b4a49,%rdx
    11d0:	4e 4f 50 
    11d3:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    11d7:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
    11db:	48 b8 51 52 53 54 55 	movabs $0x5857565554535251,%rax
    11e2:	56 57 58 
    11e5:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    11e9:	66 c7 45 e8 59 5a    	movw   $0x5a59,-0x18(%rbp)
    11ef:	c6 45 ea 00          	movb   $0x0,-0x16(%rbp)
    11f3:	48 8d 55 d0          	lea    -0x30(%rbp),%rdx
    11f7:	48 8d 45 c2          	lea    -0x3e(%rbp),%rax
    11fb:	48 89 d6             	mov    %rdx,%rsi
    11fe:	48 89 c7             	mov    %rax,%rdi
    1201:	e8 8a fe ff ff       	callq  1090 <strspn@plt>
    1206:	48 89 45 b8          	mov    %rax,-0x48(%rbp)
    120a:	48 8d 55 c2          	lea    -0x3e(%rbp),%rdx
    120e:	48 8b 45 b8          	mov    -0x48(%rbp),%rax
    1212:	48 01 d0             	add    %rdx,%rax
    1215:	0f b6 00             	movzbl (%rax),%eax
    1218:	0f be d0             	movsbl %al,%edx
    121b:	48 8b 45 b8          	mov    -0x48(%rbp),%rax
    ...
    1238:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    123c:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1243:	00 00 
    1245:	74 05                	je     124c <main+0xc3>
    1247:	e8 24 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    124c:	c9                   	leaveq 
    124d:	c3                   	retq   
