...
/app/bin_gccgcc10_O3/LeapYearTernaryOperator:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e9:	48 8d 3d 41 0f 00 00 	lea    0xf41(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    10f0:	31 c0                	xor    %eax,%eax
    10f2:	e8 b9 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10f7:	8b 54 24 04          	mov    0x4(%rsp),%edx
    10fb:	69 c2 29 5c 8f c2    	imul   $0xc28f5c29,%edx,%eax
    1101:	05 50 b8 1e 05       	add    $0x51eb850,%eax
    1106:	c1 c8 02             	ror    $0x2,%eax
    1109:	3d 28 5c 8f 02       	cmp    $0x28f5c28,%eax
    110e:	76 30                	jbe    1140 <main+0x80>
    1110:	f6 c2 03             	test   $0x3,%dl
    1113:	75 2b                	jne    1140 <main+0x80>
    1115:	48 8d 35 18 0f 00 00 	lea    0xf18(%rip),%rsi        # 2034 <_IO_stdin_used+0x34>
    111c:	bf 01 00 00 00       	mov    $0x1,%edi
    1121:	31 c0                	xor    %eax,%eax
    1123:	e8 78 ff ff ff       	callq  10a0 <__printf_chk@plt>
    1128:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    112d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1134:	00 00 
    1136:	75 32                	jne    116a <main+0xaa>
    1138:	31 c0                	xor    %eax,%eax
    113a:	48 83 c4 18          	add    $0x18,%rsp
    113e:	c3                   	retq   
    113f:	90                   	nop
    1140:	69 c2 29 5c 8f c2    	imul   $0xc28f5c29,%edx,%eax
    1146:	05 50 b8 1e 05       	add    $0x51eb850,%eax
    114b:	c1 c8 04             	ror    $0x4,%eax
    114e:	3d 0a d7 a3 00       	cmp    $0xa3d70a,%eax
    1153:	76 c0                	jbe    1115 <main+0x55>
    1155:	48 8d 35 e8 0e 00 00 	lea    0xee8(%rip),%rsi        # 2044 <_IO_stdin_used+0x44>
    115c:	bf 01 00 00 00       	mov    $0x1,%edi
    1161:	31 c0                	xor    %eax,%eax
    1163:	e8 38 ff ff ff       	callq  10a0 <__printf_chk@plt>
    1168:	eb be                	jmp    1128 <main+0x68>
    116a:	e8 21 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
    116f:	90                   	nop
