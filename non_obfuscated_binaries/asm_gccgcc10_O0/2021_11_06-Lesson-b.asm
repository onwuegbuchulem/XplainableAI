...
/app/bin_gccgcc10_O0/2021_11_06-Lesson-b:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	0f b6 45 fc          	movzbl -0x4(%rbp),%eax
    1159:	83 e0 e0             	and    $0xffffffe0,%eax
    115c:	88 45 fc             	mov    %al,-0x4(%rbp)
    115f:	eb 3b                	jmp    119c <main+0x53>
    1161:	0f b6 45 fc          	movzbl -0x4(%rbp),%eax
    1165:	83 e0 1f             	and    $0x1f,%eax
    1168:	0f b6 c0             	movzbl %al,%eax
    116b:	89 c6                	mov    %eax,%esi
    116d:	48 8d 3d 90 0e 00 00 	lea    0xe90(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1174:	b8 00 00 00 00       	mov    $0x0,%eax
    1179:	e8 d2 fe ff ff       	callq  1050 <printf@plt>
    117e:	0f b6 45 fc          	movzbl -0x4(%rbp),%eax
    1182:	83 e0 1f             	and    $0x1f,%eax
    1185:	83 c0 01             	add    $0x1,%eax
    1188:	83 e0 1f             	and    $0x1f,%eax
    118b:	83 e0 1f             	and    $0x1f,%eax
    118e:	89 c2                	mov    %eax,%edx
    1190:	0f b6 45 fc          	movzbl -0x4(%rbp),%eax
    1194:	83 e0 e0             	and    $0xffffffe0,%eax
    1197:	09 d0                	or     %edx,%eax
    1199:	88 45 fc             	mov    %al,-0x4(%rbp)
    119c:	0f b6 45 fc          	movzbl -0x4(%rbp),%eax
    11a0:	83 e0 1f             	and    $0x1f,%eax
    11a3:	3c 0f                	cmp    $0xf,%al
    11a5:	76 ba                	jbe    1161 <main+0x18>
