...
/app/bin_gccgcc10_O3/2021_01_02-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108e:	53                   	push   %rbx
    108f:	48 83 ec 20          	sub    $0x20,%rsp
    1093:	0f 28 05 76 0f 00 00 	movaps 0xf76(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    109a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10a1:	00 00 
    10a3:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10a8:	31 c0                	xor    %eax,%eax
    10aa:	c7 44 24 10 9a 99 b1 	movl   $0x42b1999a,0x10(%rsp)
    10b1:	42 
    10b2:	48 89 e3             	mov    %rsp,%rbx
    10b5:	4c 8d 64 24 14       	lea    0x14(%rsp),%r12
    10ba:	0f 29 04 24          	movaps %xmm0,(%rsp)
    10be:	66 90                	xchg   %ax,%ax
    10c0:	66 0f ef c0          	pxor   %xmm0,%xmm0
    10c4:	48 89 ee             	mov    %rbp,%rsi
    10c7:	bf 01 00 00 00       	mov    $0x1,%edi
    10cc:	48 83 c3 04          	add    $0x4,%rbx
    10d0:	b8 01 00 00 00       	mov    $0x1,%eax
    10d5:	f3 0f 5a 43 fc       	cvtss2sd -0x4(%rbx),%xmm0
    10da:	e8 91 ff ff ff       	callq  1070 <__printf_chk@plt>
    10df:	4c 39 e3             	cmp    %r12,%rbx
    10e2:	75 dc                	jne    10c0 <main+0x40>
    10e4:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10e9:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10f0:	00 00 
    10f2:	75 0b                	jne    10ff <main+0x7f>
    10f4:	48 83 c4 20          	add    $0x20,%rsp
