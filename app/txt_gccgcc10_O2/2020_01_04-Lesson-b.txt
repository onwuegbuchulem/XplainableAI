...
/app/bin_gccgcc10_O2/2020_01_04-Lesson-b:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c4:	55                   	push   %rbp
    10c5:	ba 01 00 00 00       	mov    $0x1,%edx
    10ca:	be 0c 00 00 00       	mov    $0xc,%esi
    10cf:	b9 0c 00 00 00       	mov    $0xc,%ecx
    10d4:	41 b9 0d 00 00 00    	mov    $0xd,%r9d
    10da:	4c 8d 05 23 0f 00 00 	lea    0xf23(%rip),%r8        # 2004 <_IO_stdin_used+0x4>
    10e1:	48 83 ec 20          	sub    $0x20,%rsp
    10e5:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10ec:	00 00 
    10ee:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10f3:	31 c0                	xor    %eax,%eax
    10f5:	48 8d 6c 24 0c       	lea    0xc(%rsp),%rbp
    10fa:	48 89 ef             	mov    %rbp,%rdi
    10fd:	e8 7e ff ff ff       	callq  1080 <__snprintf_chk@plt>
    1102:	48 89 ef             	mov    %rbp,%rdi
    1105:	e8 86 ff ff ff       	callq  1090 <puts@plt>
    110a:	31 c0                	xor    %eax,%eax
    110c:	ba 10 00 00 00       	mov    $0x10,%edx
    1111:	48 8d 35 fd 0e 00 00 	lea    0xefd(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    1118:	bf 01 00 00 00       	mov    $0x1,%edi
    111d:	e8 8e ff ff ff       	callq  10b0 <__printf_chk@plt>
    1122:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1127:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    112e:	00 00 
    1130:	75 08                	jne    113a <main+0x7a>
    1132:	48 83 c4 20          	add    $0x20,%rsp
    1136:	31 c0                	xor    %eax,%eax
    1138:	5d                   	pop    %rbp
    1139:	c3                   	retq   
    113a:	e8 61 ff ff ff       	callq  10a0 <__stack_chk_fail@plt>
    113f:	90                   	nop
