...
/app/bin_gccgcc10_O1/2021_11_27-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a1:	48 b8 48 65 6c 6c 6f 	movabs $0x77202c6f6c6c6548,%rax
    11a8:	2c 20 77 
    11ab:	48 89 44 24 0a       	mov    %rax,0xa(%rsp)
    11b0:	c7 44 24 12 6f 72 6c 	movl   $0x646c726f,0x12(%rsp)
    11b7:	64 
    11b8:	66 c7 44 24 16 21 00 	movw   $0x21,0x16(%rsp)
    11bf:	c7 44 24 06 20 2c 21 	movl   $0x212c20,0x6(%rsp)
    11c6:	00 
    11c7:	48 8d 74 24 06       	lea    0x6(%rsp),%rsi
    11cc:	48 8d 7c 24 0a       	lea    0xa(%rsp),%rdi
    11d1:	e8 aa fe ff ff       	callq  1080 <strcspn@plt>
    11d6:	48 89 c2             	mov    %rax,%rdx
    11d9:	0f be 4c 04 0a       	movsbl 0xa(%rsp,%rax,1),%ecx
