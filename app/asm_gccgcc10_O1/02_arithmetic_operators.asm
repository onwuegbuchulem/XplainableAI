...
/app/bin_gccgcc10_O1/02_arithmetic_operators:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	41 b8 08 00 00 00    	mov    $0x8,%r8d
    1157:	b9 03 00 00 00       	mov    $0x3,%ecx
    115c:	ba 05 00 00 00       	mov    $0x5,%edx
    ...
    117c:	48 8d 35 c5 0e 00 00 	lea    0xec5(%rip),%rsi        # 2048 <_IO_stdin_used+0x48>
