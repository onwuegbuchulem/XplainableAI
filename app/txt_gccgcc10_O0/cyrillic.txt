...
/app/bin_gccgcc10_O0/cyrillic:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    1215:	c7 45 e8 10 04 00 00 	movl   $0x410,-0x18(%rbp)
    121c:	c7 45 ec 2f 04 00 00 	movl   $0x42f,-0x14(%rbp)
    1223:	48 8d 05 de 0d 00 00 	lea    0xdde(%rip),%rax        # 2008 <_IO_stdin_used+0x8>
    122a:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    122e:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1232:	48 8d 35 dd 0d 00 00 	lea    0xddd(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    1239:	48 89 c7             	mov    %rax,%rdi
    123c:	e8 bf fe ff ff       	callq  1100 <fopen@plt>
    1241:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1245:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
    124a:	75 29                	jne    1275 <main+0x6c>
    124c:	48 8b 05 ed 2d 00 00 	mov    0x2ded(%rip),%rax        # 4040 <stderr@@GLIBC_2.2.5>
    1253:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    1257:	48 8d 35 ba 0d 00 00 	lea    0xdba(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    125e:	48 89 c7             	mov    %rax,%rdi
    1261:	b8 00 00 00 00       	mov    $0x0,%eax
    1266:	e8 65 fe ff ff       	callq  10d0 <fprintf@plt>
    126b:	bf 01 00 00 00       	mov    $0x1,%edi
    1270:	e8 9b fe ff ff       	callq  1110 <exit@plt>
    1275:	48 8d 35 b1 0d 00 00 	lea    0xdb1(%rip),%rsi        # 202d <_IO_stdin_used+0x2d>
    127c:	bf 00 00 00 00       	mov    $0x0,%edi
    1281:	e8 6a fe ff ff       	callq  10f0 <setlocale@plt>
    1286:	48 8d 3d b3 0d 00 00 	lea    0xdb3(%rip),%rdi        # 2040 <_IO_stdin_used+0x40>
    128d:	b8 00 00 00 00       	mov    $0x0,%eax
    1292:	e8 49 fe ff ff       	callq  10e0 <wprintf@plt>
    1297:	8b 45 e8             	mov    -0x18(%rbp),%eax
    129a:	89 45 e4             	mov    %eax,-0x1c(%rbp)
    129d:	eb 29                	jmp    12c8 <main+0xbf>
    129f:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    12a3:	8b 45 e4             	mov    -0x1c(%rbp),%eax
    12a6:	48 89 d6             	mov    %rdx,%rsi
    12a9:	89 c7                	mov    %eax,%edi
    12ab:	e8 10 fe ff ff       	callq  10c0 <fputwc@plt>
    12b0:	48 8b 15 69 2d 00 00 	mov    0x2d69(%rip),%rdx        # 4020 <stdout@@GLIBC_2.2.5>
    12b7:	8b 45 e4             	mov    -0x1c(%rbp),%eax
    12ba:	48 89 d6             	mov    %rdx,%rsi
    12bd:	89 c7                	mov    %eax,%edi
    12bf:	e8 fc fd ff ff       	callq  10c0 <fputwc@plt>
    12c4:	83 45 e4 01          	addl   $0x1,-0x1c(%rbp)
    12c8:	8b 45 e4             	mov    -0x1c(%rbp),%eax
    12cb:	3b 45 ec             	cmp    -0x14(%rbp),%eax
    12ce:	7e cf                	jle    129f <main+0x96>
    12d0:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    12d4:	48 89 c6             	mov    %rax,%rsi
    12d7:	bf 00 00 00 00       	mov    $0x0,%edi
    12dc:	e8 df fd ff ff       	callq  10c0 <fputwc@plt>
    12e1:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    12e5:	48 89 c7             	mov    %rax,%rdi
    12e8:	e8 c3 fd ff ff       	callq  10b0 <fclose@plt>
    12ed:	48 8d 3d d4 0d 00 00 	lea    0xdd4(%rip),%rdi        # 20c8 <_IO_stdin_used+0xc8>
    12f4:	b8 00 00 00 00       	mov    $0x0,%eax
    12f9:	e8 e2 fd ff ff       	callq  10e0 <wprintf@plt>
