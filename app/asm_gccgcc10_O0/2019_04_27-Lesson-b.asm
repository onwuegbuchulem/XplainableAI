...
/app/bin_gccgcc10_O0/2019_04_27-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117f:	89 45 f0             	mov    %eax,-0x10(%rbp)
    1182:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1185:	89 45 ec             	mov    %eax,-0x14(%rbp)
    1188:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    118f:	e8 dc fe ff ff       	callq  1070 <getchar@plt>
    1194:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1197:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%rbp)
    119b:	74 2d                	je     11ca <main+0x61>
    119d:	83 7d fc 0a          	cmpl   $0xa,-0x4(%rbp)
    11a1:	75 21                	jne    11c4 <main+0x5b>
    11a3:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11a6:	3b 45 f0             	cmp    -0x10(%rbp),%eax
    11a9:	7e 0c                	jle    11b7 <main+0x4e>
    11ab:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11ae:	89 45 f0             	mov    %eax,-0x10(%rbp)
    11b1:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11b4:	89 45 f8             	mov    %eax,-0x8(%rbp)
    11b7:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
    11be:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    11c2:	eb cb                	jmp    118f <main+0x26>
    11c4:	83 45 ec 01          	addl   $0x1,-0x14(%rbp)
    11c8:	eb c5                	jmp    118f <main+0x26>
    11ca:	90                   	nop
