...
/app/bin_gccgcc8_O2/decimal_to_octal_recursion:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10dc:	44 8b 4c 24 04       	mov    0x4(%rsp),%r9d
    10e1:	48 8d 35 3a 0f 00 00 	lea    0xf3a(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    10e8:	44 89 cf             	mov    %r9d,%edi
    10eb:	e8 20 01 00 00       	callq  1210 <decimal_to_octal>
    10f0:	44 89 ca             	mov    %r9d,%edx
    10f3:	bf 01 00 00 00       	mov    $0x1,%edi
    10f8:	89 c1                	mov    %eax,%ecx
    10fa:	31 c0                	xor    %eax,%eax
    10fc:	e8 7f ff ff ff       	callq  1080 <__printf_chk@plt>
    1101:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1106:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    110d:	00 00 
    110f:	75 07                	jne    1118 <main+0x78>
    1111:	31 c0                	xor    %eax,%eax
    1113:	48 83 c4 18          	add    $0x18,%rsp
    1117:	c3                   	retq   
    1118:	e8 53 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
...
0000000000001120 <_start>:
    ...
    1131:	50                   	push   %rax
    1132:	54                   	push   %rsp
    1133:	4c 8d 05 b6 01 00 00 	lea    0x1b6(%rip),%r8        # 12f0 <__libc_csu_fini>
    113a:	48 8d 0d 3f 01 00 00 	lea    0x13f(%rip),%rcx        # 1280 <__libc_csu_init>
...
0000000000001210 <decimal_to_octal>:
    1210:	f3 0f 1e fa          	endbr64 
    1214:	8d 47 ff             	lea    -0x1(%rdi),%eax
    1217:	83 f8 06             	cmp    $0x6,%eax
    121a:	76 51                	jbe    126d <decimal_to_octal+0x5d>
    121c:	85 ff                	test   %edi,%edi
    121e:	74 52                	je     1272 <decimal_to_octal+0x62>
    1220:	ba 01 00 00 00       	mov    $0x1,%edx
    1225:	45 31 c0             	xor    %r8d,%r8d
    1228:	eb 0a                	jmp    1234 <decimal_to_octal+0x24>
    122a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1230:	85 ff                	test   %edi,%edi
    1232:	74 35                	je     1269 <decimal_to_octal+0x59>
    1234:	89 f8                	mov    %edi,%eax
    1236:	8d 7f 07             	lea    0x7(%rdi),%edi
    1239:	85 c0                	test   %eax,%eax
    123b:	89 c1                	mov    %eax,%ecx
    123d:	0f 49 f8             	cmovns %eax,%edi
    1240:	c1 f9 1f             	sar    $0x1f,%ecx
    1243:	c1 e9 1d             	shr    $0x1d,%ecx
    1246:	01 c8                	add    %ecx,%eax
    1248:	c1 ff 03             	sar    $0x3,%edi
    124b:	83 e0 07             	and    $0x7,%eax
    124e:	29 c8                	sub    %ecx,%eax
    1250:	0f af c2             	imul   %edx,%eax
    1253:	8d 14 92             	lea    (%rdx,%rdx,4),%edx
    1256:	01 d2                	add    %edx,%edx
    1258:	41 01 c0             	add    %eax,%r8d
    125b:	8d 47 ff             	lea    -0x1(%rdi),%eax
    125e:	83 f8 06             	cmp    $0x6,%eax
    1261:	77 cd                	ja     1230 <decimal_to_octal+0x20>
    1263:	0f af fa             	imul   %edx,%edi
    1266:	41 01 f8             	add    %edi,%r8d
    1269:	44 89 c0             	mov    %r8d,%eax
    126c:	c3                   	retq   
    126d:	41 89 f8             	mov    %edi,%r8d
    1270:	eb f7                	jmp    1269 <decimal_to_octal+0x59>
    1272:	45 31 c0             	xor    %r8d,%r8d
    1275:	eb f2                	jmp    1269 <decimal_to_octal+0x59>
