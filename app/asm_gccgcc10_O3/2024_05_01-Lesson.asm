...
/app/bin_gccgcc10_O3/2024_05_01-Lesson:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10d7:	48 89 e3             	mov    %rsp,%rbx
    10da:	4c 8d 64 24 20       	lea    0x20(%rsp),%r12
    10df:	0f 29 04 24          	movaps %xmm0,(%rsp)
    10e3:	66 0f 6f 05 65 0f 00 	movdqa 0xf65(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    10ea:	00 
    10eb:	0f 29 44 24 10       	movaps %xmm0,0x10(%rsp)
    10f0:	e8 9b ff ff ff       	callq  1090 <__printf_chk@plt>
    10f5:	0f 1f 00             	nopl   (%rax)
    10f8:	8b 13                	mov    (%rbx),%edx
    10fa:	48 89 ee             	mov    %rbp,%rsi
    10fd:	bf 01 00 00 00       	mov    $0x1,%edi
    1102:	31 c0                	xor    %eax,%eax
    1104:	48 83 c3 04          	add    $0x4,%rbx
    1108:	e8 83 ff ff ff       	callq  1090 <__printf_chk@plt>
    110d:	49 39 dc             	cmp    %rbx,%r12
    1110:	75 e6                	jne    10f8 <main+0x58>
    1112:	48 8b 35 f7 2e 00 00 	mov    0x2ef7(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1119:	bf 0a 00 00 00       	mov    $0xa,%edi
    111e:	e8 5d ff ff ff       	callq  1080 <putc@plt>
    1123:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1127:	bf 01 00 00 00       	mov    $0x1,%edi
    112c:	48 8d 35 e5 0e 00 00 	lea    0xee5(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    1133:	b8 01 00 00 00       	mov    $0x1,%eax
    1138:	e8 53 ff ff ff       	callq  1090 <__printf_chk@plt>
    113d:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    1142:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1149:	00 00 
    114b:	75 0b                	jne    1158 <main+0xb8>
    114d:	48 83 c4 30          	add    $0x30,%rsp
