...
/app/bin_gccgcc10_O0/2021_07_03-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117c:	48 8b 4d e0          	mov    -0x20(%rbp),%rcx
    1180:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1183:	48 8d 15 7e 0e 00 00 	lea    0xe7e(%rip),%rdx        # 2008 <_IO_stdin_used+0x8>
    118a:	48 89 ce             	mov    %rcx,%rsi
    118d:	89 c7                	mov    %eax,%edi
    118f:	e8 dc fe ff ff       	callq  1070 <getopt@plt>
    1194:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1197:	8b 45 fc             	mov    -0x4(%rbp),%eax
    119a:	89 c6                	mov    %eax,%esi
    119c:	48 8d 3d 6d 0e 00 00 	lea    0xe6d(%rip),%rdi        # 2010 <_IO_stdin_used+0x10>
    11a3:	b8 00 00 00 00       	mov    $0x0,%eax
    11a8:	e8 b3 fe ff ff       	callq  1060 <printf@plt>
