...
/app/bin_gccgcc10_O0/2024_03_30-Lesson:     file format elf64-x86-64
...
00000000000010a0 <ioctl@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 1d 2f 00 00 	bnd jmpq *0x2f1d(%rip)        # 3fc8 <ioctl@GLIBC_2.2.5>
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d 10 01 00 00 	lea    0x110(%rip),%rdi        # 11f8 <main>
...
00000000000011a9 <kbhit>:
    ...
    11c4:	48 8d 45 f4          	lea    -0xc(%rbp),%rax
    11c8:	48 89 c2             	mov    %rax,%rdx
    11cb:	be 1b 54 00 00       	mov    $0x541b,%esi
    11d0:	bf 00 00 00 00       	mov    $0x0,%edi
    11d5:	b8 00 00 00 00       	mov    $0x0,%eax
    11da:	e8 c1 fe ff ff       	callq  10a0 <ioctl@plt>
    11df:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11e2:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11e6:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11ed:	00 00 
    11ef:	74 05                	je     11f6 <kbhit+0x4d>
    11f1:	e8 8a fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    11f6:	c9                   	leaveq 
    11f7:	c3                   	retq   
...
00000000000011f8 <main>:
    ...
    1200:	48 83 ec 10          	sub    $0x10,%rsp
    1204:	c6 45 ff 41          	movb   $0x41,-0x1(%rbp)
    1208:	0f b6 45 ff          	movzbl -0x1(%rbp),%eax
    120c:	89 c2                	mov    %eax,%edx
    120e:	83 c2 01             	add    $0x1,%edx
    1211:	88 55 ff             	mov    %dl,-0x1(%rbp)
    ...
    122a:	80 7d ff 5a          	cmpb   $0x5a,-0x1(%rbp)
    122e:	75 04                	jne    1234 <main+0x3c>
    1230:	c6 45 ff 41          	movb   $0x41,-0x1(%rbp)
    1234:	e8 70 ff ff ff       	callq  11a9 <kbhit>
    1239:	85 c0                	test   %eax,%eax
    123b:	74 cb                	je     1208 <main+0x10>
    123d:	e8 6e fe ff ff       	callq  10b0 <getchar@plt>
    1242:	90                   	nop
