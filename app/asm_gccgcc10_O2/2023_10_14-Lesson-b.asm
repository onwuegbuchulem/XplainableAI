...
/app/bin_gccgcc10_O2/2023_10_14-Lesson-b:     file format elf64-x86-64
...
00000000000010c0 <fgetc@plt>:
    10c0:	f3 0f 1e fa          	endbr64 
    10c4:	f2 ff 25 dd 2e 00 00 	bnd jmpq *0x2edd(%rip)        # 3fa8 <fgetc@GLIBC_2.2.5>
    10cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010d0 <feof@plt>:
    10d0:	f3 0f 1e fa          	endbr64 
    10d4:	f2 ff 25 d5 2e 00 00 	bnd jmpq *0x2ed5(%rip)        # 3fb0 <feof@GLIBC_2.2.5>
...
0000000000001120 <main>:
    ...
    112d:	48 8d 3d d2 0e 00 00 	lea    0xed2(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1134:	55                   	push   %rbp
    1135:	48 83 ec 08          	sub    $0x8,%rsp
    1139:	e8 b2 ff ff ff       	callq  10f0 <fopen@plt>
    113e:	48 85 c0             	test   %rax,%rax
    1141:	74 54                	je     1197 <main+0x77>
    1143:	48 89 c5             	mov    %rax,%rbp
    1146:	45 31 e4             	xor    %r12d,%r12d
    1149:	eb 18                	jmp    1163 <main+0x43>
    114b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1150:	48 89 ef             	mov    %rbp,%rdi
    1153:	e8 68 ff ff ff       	callq  10c0 <fgetc@plt>
    1158:	3c 0a                	cmp    $0xa,%al
    115a:	0f 94 c0             	sete   %al
    115d:	0f b6 c0             	movzbl %al,%eax
    1160:	41 01 c4             	add    %eax,%r12d
    1163:	48 89 ef             	mov    %rbp,%rdi
    1166:	e8 65 ff ff ff       	callq  10d0 <feof@plt>
    116b:	85 c0                	test   %eax,%eax
    116d:	74 e1                	je     1150 <main+0x30>
    116f:	44 89 e2             	mov    %r12d,%edx
    1172:	48 8d 35 b7 0e 00 00 	lea    0xeb7(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    1179:	bf 01 00 00 00       	mov    $0x1,%edi
    117e:	31 c0                	xor    %eax,%eax
    1180:	e8 5b ff ff ff       	callq  10e0 <__printf_chk@plt>
    1185:	48 89 ef             	mov    %rbp,%rdi
    1188:	e8 23 ff ff ff       	callq  10b0 <fclose@plt>
    118d:	48 83 c4 08          	add    $0x8,%rsp
    1191:	31 c0                	xor    %eax,%eax
    1193:	5d                   	pop    %rbp
    1194:	41 5c                	pop    %r12
    1196:	c3                   	retq   
    1197:	48 8b 3d 82 2e 00 00 	mov    0x2e82(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    119e:	48 8d 0d 61 0e 00 00 	lea    0xe61(%rip),%rcx        # 2006 <_IO_stdin_used+0x6>
    11a5:	48 8d 15 70 0e 00 00 	lea    0xe70(%rip),%rdx        # 201c <_IO_stdin_used+0x1c>
    11ac:	31 c0                	xor    %eax,%eax
    11ae:	be 01 00 00 00       	mov    $0x1,%esi
    11b3:	e8 58 ff ff ff       	callq  1110 <__fprintf_chk@plt>
    11b8:	bf 01 00 00 00       	mov    $0x1,%edi
    11bd:	e8 3e ff ff ff       	callq  1100 <exit@plt>
