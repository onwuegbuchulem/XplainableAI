...
/app/bin_gccgcc10_O2/Factorial:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e4:	78 54                	js     113a <main+0x9a>
    10e6:	b9 01 00 00 00       	mov    $0x1,%ecx
    10eb:	74 20                	je     110d <main+0x6d>
    10ed:	41 8d 50 01          	lea    0x1(%r8),%edx
    10f1:	b8 01 00 00 00       	mov    $0x1,%eax
    10f6:	b9 01 00 00 00       	mov    $0x1,%ecx
    10fb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1100:	48 0f af c8          	imul   %rax,%rcx
    1104:	48 83 c0 01          	add    $0x1,%rax
    1108:	48 39 d0             	cmp    %rdx,%rax
    110b:	75 f3                	jne    1100 <main+0x60>
    110d:	44 89 c2             	mov    %r8d,%edx
    1110:	48 8d 35 01 0f 00 00 	lea    0xf01(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    1117:	bf 01 00 00 00       	mov    $0x1,%edi
    111c:	31 c0                	xor    %eax,%eax
    111e:	e8 5d ff ff ff       	callq  1080 <__printf_chk@plt>
    1123:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1128:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    112f:	00 00 
    1131:	75 1c                	jne    114f <main+0xaf>
    1133:	31 c0                	xor    %eax,%eax
    1135:	48 83 c4 18          	add    $0x18,%rsp
    1139:	c3                   	retq   
    113a:	48 8d 35 ef 0e 00 00 	lea    0xeef(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    1141:	bf 01 00 00 00       	mov    $0x1,%edi
    1146:	31 c0                	xor    %eax,%eax
    1148:	e8 33 ff ff ff       	callq  1080 <__printf_chk@plt>
    114d:	eb d4                	jmp    1123 <main+0x83>
    114f:	e8 1c ff ff ff       	callq  1070 <__stack_chk_fail@plt>
    1154:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    115b:	00 00 00 
