...
/app/bin_gccgcc10_O3/2019_06_08-Lesson-c:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1089:	66 0f 6f 05 7f 0f 00 	movdqa 0xf7f(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    1090:	00 
    1091:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1098:	00 00 
    109a:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    109f:	31 c0                	xor    %eax,%eax
    10a1:	b8 2e 0a 00 00       	mov    $0xa2e,%eax
    10a6:	c6 44 24 26 00       	movb   $0x0,0x26(%rsp)
    10ab:	48 89 e3             	mov    %rsp,%rbx
    10ae:	0f 11 04 24          	movups %xmm0,(%rsp)
    10b2:	66 0f 6f 05 66 0f 00 	movdqa 0xf66(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10b9:	00 
    10ba:	c7 44 24 20 6c 64 2e 	movl   $0x2e2e646c,0x20(%rsp)
    10c1:	2e 
    10c2:	66 89 44 24 24       	mov    %ax,0x24(%rsp)
    10c7:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10cc:	0f 1f 40 00          	nopl   0x0(%rax)
    10d0:	0f be 3b             	movsbl (%rbx),%edi
    10d3:	48 8b 35 36 2f 00 00 	mov    0x2f36(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10da:	48 83 c3 01          	add    $0x1,%rbx
    10de:	e8 8d ff ff ff       	callq  1070 <putc@plt>
    10e3:	85 c0                	test   %eax,%eax
    10e5:	75 e9                	jne    10d0 <main+0x50>
    10e7:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    10ec:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10f3:	00 00 
    10f5:	75 08                	jne    10ff <main+0x7f>
    10f7:	48 83 c4 30          	add    $0x30,%rsp
    10fb:	31 c0                	xor    %eax,%eax
    10fd:	5b                   	pop    %rbx
    10fe:	c3                   	retq   
    10ff:	e8 5c ff ff ff       	callq  1060 <__stack_chk_fail@plt>
