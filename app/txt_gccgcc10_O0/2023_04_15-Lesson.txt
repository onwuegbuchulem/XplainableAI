...
/app/bin_gccgcc10_O0/2023_04_15-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a8:	0f 84 be 00 00 00    	je     126c <main+0xe3>
    11ae:	83 7d f8 20          	cmpl   $0x20,-0x8(%rbp)
    11b2:	74 24                	je     11d8 <main+0x4f>
    11b4:	83 7d f8 20          	cmpl   $0x20,-0x8(%rbp)
    11b8:	0f 8f 8a 00 00 00    	jg     1248 <main+0xbf>
    11be:	83 7d f8 0d          	cmpl   $0xd,-0x8(%rbp)
    11c2:	74 71                	je     1235 <main+0xac>
    11c4:	83 7d f8 0d          	cmpl   $0xd,-0x8(%rbp)
    11c8:	7f 7e                	jg     1248 <main+0xbf>
    11ca:	83 7d f8 09          	cmpl   $0x9,-0x8(%rbp)
    11ce:	74 1f                	je     11ef <main+0x66>
    11d0:	83 7d f8 0a          	cmpl   $0xa,-0x8(%rbp)
    11d4:	74 5f                	je     1235 <main+0xac>
    11d6:	eb 70                	jmp    1248 <main+0xbf>
    11d8:	48 8d 3d 25 0e 00 00 	lea    0xe25(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11df:	b8 00 00 00 00       	mov    $0x0,%eax
    11e4:	e8 97 fe ff ff       	callq  1080 <printf@plt>
    11e9:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    11ed:	eb 67                	jmp    1256 <main+0xcd>
    11ef:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11f2:	99                   	cltd   
    11f3:	c1 ea 1d             	shr    $0x1d,%edx
    11f6:	01 d0                	add    %edx,%eax
    11f8:	83 e0 07             	and    $0x7,%eax
    11fb:	29 d0                	sub    %edx,%eax
    11fd:	89 c2                	mov    %eax,%edx
    11ff:	b8 08 00 00 00       	mov    $0x8,%eax
    1204:	29 d0                	sub    %edx,%eax
    1206:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1209:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
    1210:	eb 19                	jmp    122b <main+0xa2>
    1212:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    1216:	48 8d 3d e7 0d 00 00 	lea    0xde7(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    121d:	b8 00 00 00 00       	mov    $0x0,%eax
    1222:	e8 59 fe ff ff       	callq  1080 <printf@plt>
    1227:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    122b:	8b 45 f4             	mov    -0xc(%rbp),%eax
    122e:	3b 45 fc             	cmp    -0x4(%rbp),%eax
    1231:	7c df                	jl     1212 <main+0x89>
    1233:	eb 21                	jmp    1256 <main+0xcd>
    1235:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1238:	89 c7                	mov    %eax,%edi
    123a:	e8 31 fe ff ff       	callq  1070 <putchar@plt>
    123f:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%rbp)
    1246:	eb 0e                	jmp    1256 <main+0xcd>
    1248:	8b 45 f8             	mov    -0x8(%rbp),%eax
    124b:	89 c7                	mov    %eax,%edi
    124d:	e8 1e fe ff ff       	callq  1070 <putchar@plt>
    1252:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    1256:	83 7d f0 50          	cmpl   $0x50,-0x10(%rbp)
    125a:	0f 85 3c ff ff ff    	jne    119c <main+0x13>
    1260:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%rbp)
    1267:	e9 30 ff ff ff       	jmpq   119c <main+0x13>
    126c:	90                   	nop
