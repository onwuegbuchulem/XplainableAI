...
/app/bin_gccgcc10_O0/2021_08_21-Lesson-a:     file format elf64-x86-64
...
00000000000011c1 <main>:
    ...
    11dc:	48 b8 48 65 6c 6c 6f 	movabs $0x77202c6f6c6c6548,%rax
    11e3:	2c 20 77 
    11e6:	48 89 45 ea          	mov    %rax,-0x16(%rbp)
    11ea:	c7 45 f2 6f 72 6c 64 	movl   $0x646c726f,-0xe(%rbp)
    11f1:	66 c7 45 f6 21 00    	movw   $0x21,-0xa(%rbp)
    11f7:	48 8d 45 ea          	lea    -0x16(%rbp),%rax
    11fb:	48 89 c7             	mov    %rax,%rdi
    11fe:	e8 66 ff ff ff       	callq  1169 <output>
    1203:	b8 00 00 00 00       	mov    $0x0,%eax
    1208:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    120c:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1213:	00 00 
    1215:	74 05                	je     121c <main+0x5b>
