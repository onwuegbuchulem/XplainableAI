...
/app/bin_gccgcc10_O2/assignment15:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 54                	push   %r12
    1086:	ba 0f 00 00 00       	mov    $0xf,%edx
    108b:	bf 01 00 00 00       	mov    $0x1,%edi
    1090:	48 8d 35 71 0f 00 00 	lea    0xf71(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    1097:	48 83 ec 10          	sub    $0x10,%rsp
    109b:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10a2:	00 00 
    10a4:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10a9:	31 c0                	xor    %eax,%eax
    10ab:	4c 8d 64 24 04       	lea    0x4(%rsp),%r12
    10b0:	c7 44 24 04 0f 00 00 	movl   $0xf,0x4(%rsp)
    10b7:	00 
    10b8:	e8 b3 ff ff ff       	callq  1070 <__printf_chk@plt>
    10bd:	4c 89 e2             	mov    %r12,%rdx
    10c0:	bf 01 00 00 00       	mov    $0x1,%edi
    10c5:	31 c0                	xor    %eax,%eax
    10c7:	48 8d 35 62 0f 00 00 	lea    0xf62(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    10ce:	e8 9d ff ff ff       	callq  1070 <__printf_chk@plt>
    10d3:	4c 89 e2             	mov    %r12,%rdx
    ...
    10e4:	e8 87 ff ff ff       	callq  1070 <__printf_chk@plt>
    10e9:	8b 54 24 04          	mov    0x4(%rsp),%edx
    10ed:	31 c0                	xor    %eax,%eax
    10ef:	bf 01 00 00 00       	mov    $0x1,%edi
    10f4:	48 8d 35 9d 0f 00 00 	lea    0xf9d(%rip),%rsi        # 2098 <_IO_stdin_used+0x98>
    10fb:	e8 70 ff ff ff       	callq  1070 <__printf_chk@plt>
    1100:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1105:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    110c:	00 00 
    110e:	75 09                	jne    1119 <main+0x99>
    1110:	48 83 c4 10          	add    $0x10,%rsp
    1114:	31 c0                	xor    %eax,%eax
    1116:	41 5c                	pop    %r12
    1118:	c3                   	retq   
    1119:	e8 42 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
