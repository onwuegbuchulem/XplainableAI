...
/app/bin_gccgcc10_O1/2023_02-Exercise:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11af:	55                   	push   %rbp
    11b0:	53                   	push   %rbx
    11b1:	bf 00 00 00 00       	mov    $0x0,%edi
    11b6:	e8 d5 fe ff ff       	callq  1090 <time@plt>
    11bb:	48 89 c7             	mov    %rax,%rdi
    11be:	e8 bd fe ff ff       	callq  1080 <srand@plt>
    11c3:	bd 01 00 00 00       	mov    $0x1,%ebp
    11c8:	4c 8d 25 35 0e 00 00 	lea    0xe35(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    11cf:	83 c5 01             	add    $0x1,%ebp
    11d2:	e8 d9 fe ff ff       	callq  10b0 <rand@plt>
    11d7:	48 63 d8             	movslq %eax,%rbx
    11da:	48 69 db 1f 85 eb 51 	imul   $0x51eb851f,%rbx,%rbx
    11e1:	48 c1 fb 25          	sar    $0x25,%rbx
    11e5:	99                   	cltd   
    11e6:	29 d3                	sub    %edx,%ebx
    11e8:	6b d3 64             	imul   $0x64,%ebx,%edx
    11eb:	29 d0                	sub    %edx,%eax
    11ed:	89 c3                	mov    %eax,%ebx
    11ef:	89 c1                	mov    %eax,%ecx
    11f1:	89 ea                	mov    %ebp,%edx
    11f3:	4c 89 e6             	mov    %r12,%rsi
    11f6:	bf 01 00 00 00       	mov    $0x1,%edi
    11fb:	b8 00 00 00 00       	mov    $0x0,%eax
    1200:	e8 9b fe ff ff       	callq  10a0 <__printf_chk@plt>
    1205:	83 fb 63             	cmp    $0x63,%ebx
    1208:	75 c5                	jne    11cf <main+0x26>
    120a:	b9 63 00 00 00       	mov    $0x63,%ecx
    120f:	89 ea                	mov    %ebp,%edx
    1211:	48 8d 35 ec 0d 00 00 	lea    0xdec(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1218:	bf 01 00 00 00       	mov    $0x1,%edi
    121d:	b8 00 00 00 00       	mov    $0x0,%eax
    1222:	e8 79 fe ff ff       	callq  10a0 <__printf_chk@plt>
