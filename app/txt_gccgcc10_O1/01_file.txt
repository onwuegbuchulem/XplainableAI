...
/app/bin_gccgcc10_O1/01_file:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11cd:	55                   	push   %rbp
    11ce:	53                   	push   %rbx
    11cf:	48 83 ec 18          	sub    $0x18,%rsp
    11d3:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11da:	00 00 
    11dc:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    ...
    11f1:	e8 da fe ff ff       	callq  10d0 <fopen@plt>
    11f6:	48 89 c3             	mov    %rax,%rbx
    11f9:	48 8d 6c 24 04       	lea    0x4(%rsp),%rbp
    11fe:	48 89 ea             	mov    %rbp,%rdx
    1201:	48 8d 35 08 0e 00 00 	lea    0xe08(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    1208:	48 89 c7             	mov    %rax,%rdi
    120b:	b8 00 00 00 00       	mov    $0x0,%eax
    1210:	e8 7b fe ff ff       	callq  1090 <__isoc99_fscanf@plt>
    1215:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1219:	48 8d 35 f3 0d 00 00 	lea    0xdf3(%rip),%rsi        # 2013 <_IO_stdin_used+0x13>
    1220:	bf 01 00 00 00       	mov    $0x1,%edi
    1225:	b8 00 00 00 00       	mov    $0x0,%eax
    122a:	e8 91 fe ff ff       	callq  10c0 <__printf_chk@plt>
    122f:	48 89 ea             	mov    %rbp,%rdx
    1232:	48 8d 35 d7 0d 00 00 	lea    0xdd7(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    1239:	48 89 df             	mov    %rbx,%rdi
    123c:	b8 00 00 00 00       	mov    $0x0,%eax
    1241:	e8 4a fe ff ff       	callq  1090 <__isoc99_fscanf@plt>
    1246:	8b 54 24 04          	mov    0x4(%rsp),%edx
    124a:	48 8d 35 c2 0d 00 00 	lea    0xdc2(%rip),%rsi        # 2013 <_IO_stdin_used+0x13>
    1251:	bf 01 00 00 00       	mov    $0x1,%edi
    1256:	b8 00 00 00 00       	mov    $0x0,%eax
    125b:	e8 60 fe ff ff       	callq  10c0 <__printf_chk@plt>
    1260:	48 89 df             	mov    %rbx,%rdi
    1263:	e8 38 fe ff ff       	callq  10a0 <fclose@plt>
    1268:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    126d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1274:	00 00 
    1276:	75 0c                	jne    1284 <main+0xbb>
    1278:	b8 00 00 00 00       	mov    $0x0,%eax
    127d:	48 83 c4 18          	add    $0x18,%rsp
    1281:	5b                   	pop    %rbx
    1282:	5d                   	pop    %rbp
    1283:	c3                   	retq   
    1284:	e8 27 fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
