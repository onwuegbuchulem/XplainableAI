...
/app/bin_gccgcc10_O1/13_complement:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b7:	48 8d 3d 61 0e 00 00 	lea    0xe61(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11cc:	f7 da                	neg    %edx
    11ce:	48 8d 35 4d 0e 00 00 	lea    0xe4d(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    ...
    11e9:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f0:	00 00 
    11f2:	75 0a                	jne    11fe <main+0x75>
    11f4:	b8 00 00 00 00       	mov    $0x0,%eax
    11f9:	48 83 c4 18          	add    $0x18,%rsp
    11fd:	c3                   	retq   
