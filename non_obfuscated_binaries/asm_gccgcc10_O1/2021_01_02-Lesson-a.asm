...
/app/bin_gccgcc10_O1/2021_01_02-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117c:	00 00 
    117e:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    1183:	31 c0                	xor    %eax,%eax
    1185:	c7 04 24 33 33 b3 3f 	movl   $0x3fb33333,(%rsp)
    118c:	c7 44 24 04 66 66 b6 	movl   $0x40b66666,0x4(%rsp)
    1193:	40 
    1194:	c7 44 24 08 00 00 10 	movl   $0x41100000,0x8(%rsp)
    119b:	41 
    119c:	c7 44 24 0c 9a 99 b5 	movl   $0x41b5999a,0xc(%rsp)
    11a3:	41 
    11a4:	c7 44 24 10 9a 99 b1 	movl   $0x42b1999a,0x10(%rsp)
    11ab:	42 
    11ac:	48 89 e3             	mov    %rsp,%rbx
    11af:	4c 8d 64 24 14       	lea    0x14(%rsp),%r12
    11b4:	48 8d 2d 49 0e 00 00 	lea    0xe49(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    11bb:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11bf:	f3 0f 5a 03          	cvtss2sd (%rbx),%xmm0
    11c3:	48 89 ee             	mov    %rbp,%rsi
    11c6:	bf 01 00 00 00       	mov    $0x1,%edi
    11cb:	b8 01 00 00 00       	mov    $0x1,%eax
    11d0:	e8 9b fe ff ff       	callq  1070 <__printf_chk@plt>
    11d5:	48 83 c3 04          	add    $0x4,%rbx
    11d9:	4c 39 e3             	cmp    %r12,%rbx
    11dc:	75 dd                	jne    11bb <main+0x52>
    11de:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11e3:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11ea:	00 00 
    11ec:	75 0e                	jne    11fc <main+0x93>
    ...
    11f9:	41 5c                	pop    %r12
    11fb:	c3                   	retq   
    11fc:	e8 5f fe ff ff       	callq  1060 <__stack_chk_fail@plt>
