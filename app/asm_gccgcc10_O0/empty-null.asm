...
/app/bin_gccgcc10_O0/empty-null:     file format elf64-x86-64
...
00000000000010d0 <strcmp@plt>:
    ...
    10d4:	f2 ff 25 f5 2e 00 00 	bnd jmpq *0x2ef5(%rip)        # 3fd0 <strcmp@GLIBC_2.2.5>
...
00000000000011c9 <main>:
    ...
    11e5:	c7 45 de 00 00 00 00 	movl   $0x0,-0x22(%rbp)
    11ec:	c6 45 e2 00          	movb   $0x0,-0x1e(%rbp)
    11f0:	48 8d 55 e3          	lea    -0x1d(%rbp),%rdx
    11f4:	48 8d 45 de          	lea    -0x22(%rbp),%rax
    11f8:	48 89 d6             	mov    %rdx,%rsi
    11fb:	48 89 c7             	mov    %rax,%rdi
    11fe:	e8 cd fe ff ff       	callq  10d0 <strcmp@plt>
    1203:	85 c0                	test   %eax,%eax
    1205:	75 0e                	jne    1215 <main+0x4c>
    1207:	48 8d 3d f6 0d 00 00 	lea    0xdf6(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    120e:	e8 7d fe ff ff       	callq  1090 <puts@plt>
    1213:	eb 0c                	jmp    1221 <main+0x58>
    1215:	48 8d 3d fd 0d 00 00 	lea    0xdfd(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    121c:	e8 6f fe ff ff       	callq  1090 <puts@plt>
    1221:	48 8d 45 e3          	lea    -0x1d(%rbp),%rax
    1225:	48 89 c7             	mov    %rax,%rdi
    1228:	e8 73 fe ff ff       	callq  10a0 <strlen@plt>
    122d:	48 89 c3             	mov    %rax,%rbx
    1230:	48 8d 45 de          	lea    -0x22(%rbp),%rax
    1234:	48 89 c7             	mov    %rax,%rdi
    1237:	e8 64 fe ff ff       	callq  10a0 <strlen@plt>
    123c:	48 89 da             	mov    %rbx,%rdx
    123f:	48 89 c6             	mov    %rax,%rsi
    1242:	48 8d 3d e9 0d 00 00 	lea    0xde9(%rip),%rdi        # 2032 <_IO_stdin_used+0x32>
    1249:	b8 00 00 00 00       	mov    $0x0,%eax
    124e:	e8 6d fe ff ff       	callq  10c0 <printf@plt>
    1253:	ba 05 00 00 00       	mov    $0x5,%edx
    1258:	be 05 00 00 00       	mov    $0x5,%esi
    125d:	48 8d 3d e3 0d 00 00 	lea    0xde3(%rip),%rdi        # 2047 <_IO_stdin_used+0x47>
    1264:	b8 00 00 00 00       	mov    $0x0,%eax
    1269:	e8 52 fe ff ff       	callq  10c0 <printf@plt>
    126e:	b8 00 00 00 00       	mov    $0x0,%eax
    1273:	48 8b 4d e8          	mov    -0x18(%rbp),%rcx
    1277:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    127e:	00 00 
    1280:	74 05                	je     1287 <main+0xbe>
    1282:	e8 29 fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
    1287:	48 8b 5d f8          	mov    -0x8(%rbp),%rbx
    128b:	c9                   	leaveq 
    128c:	c3                   	retq   
