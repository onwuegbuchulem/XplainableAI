...
/app/bin_gccgcc10_O2/2020_10_01-Example:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e0:	f3 0f 10 05 68 0f 00 	movss  0xf68(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    10e7:	00 
    10e8:	83 fa 01             	cmp    $0x1,%edx
    10eb:	7e 16                	jle    1103 <main+0x63>
    10ed:	b8 01 00 00 00       	mov    $0x1,%eax
    10f2:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    10f8:	83 c0 01             	add    $0x1,%eax
    10fb:	f3 0f 58 c0          	addss  %xmm0,%xmm0
    10ff:	39 d0                	cmp    %edx,%eax
    1101:	75 f5                	jne    10f8 <main+0x58>
    1103:	48 8d 35 1e 0f 00 00 	lea    0xf1e(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    110a:	bf 01 00 00 00       	mov    $0x1,%edi
    110f:	b8 01 00 00 00       	mov    $0x1,%eax
    1114:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    ...
    1129:	00 00 
    112b:	75 07                	jne    1134 <main+0x94>
    112d:	31 c0                	xor    %eax,%eax
    112f:	48 83 c4 18          	add    $0x18,%rsp
    1133:	c3                   	retq   
    1134:	e8 37 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
