...
/app/bin_gccgcc10_O3/SimpleInterestCalculator:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e4:	48 8d 74 24 0c       	lea    0xc(%rsp),%rsi
    10e9:	31 c0                	xor    %eax,%eax
    10eb:	48 8d 3d 55 0f 00 00 	lea    0xf55(%rip),%rdi        # 2047 <_IO_stdin_used+0x47>
    10f2:	48 8d 4c 24 14       	lea    0x14(%rsp),%rcx
    10f7:	48 8d 54 24 10       	lea    0x10(%rsp),%rdx
    10fc:	e8 af ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1101:	f3 0f 10 44 24 0c    	movss  0xc(%rsp),%xmm0
    1107:	f3 0f 59 44 24 10    	mulss  0x10(%rsp),%xmm0
    110d:	48 8d 35 3a 0f 00 00 	lea    0xf3a(%rip),%rsi        # 204e <_IO_stdin_used+0x4e>
    1114:	f3 0f 59 44 24 14    	mulss  0x14(%rsp),%xmm0
    111a:	bf 01 00 00 00       	mov    $0x1,%edi
    111f:	b8 01 00 00 00       	mov    $0x1,%eax
    1124:	f3 0f 5e 05 3c 0f 00 	divss  0xf3c(%rip),%xmm0        # 2068 <_IO_stdin_used+0x68>
    112b:	00 
    ...
    1141:	00 00 
    1143:	75 07                	jne    114c <main+0x8c>
    1145:	31 c0                	xor    %eax,%eax
    1147:	48 83 c4 28          	add    $0x28,%rsp
    114b:	c3                   	retq   
    114c:	e8 3f ff ff ff       	callq  1090 <__stack_chk_fail@plt>
