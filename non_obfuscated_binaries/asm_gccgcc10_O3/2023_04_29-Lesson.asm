...
/app/bin_gccgcc10_O3/2023_04_29-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1092:	49 89 c0             	mov    %rax,%r8
    1095:	48 89 c2             	mov    %rax,%rdx
    1098:	48 8d 05 65 0f 00 00 	lea    0xf65(%rip),%rax        # 2004 <_IO_stdin_used+0x4>
    109f:	90                   	nop
    10a0:	0f b6 08             	movzbl (%rax),%ecx
    10a3:	48 83 c0 01          	add    $0x1,%rax
    10a7:	48 83 c2 01          	add    $0x1,%rdx
    10ab:	88 4a ff             	mov    %cl,-0x1(%rdx)
    10ae:	84 c9                	test   %cl,%cl
    10b0:	75 ee                	jne    10a0 <main+0x20>
    10b2:	4c 89 c2             	mov    %r8,%rdx
    10b5:	48 8d 35 50 0f 00 00 	lea    0xf50(%rip),%rsi        # 200c <_IO_stdin_used+0xc>
