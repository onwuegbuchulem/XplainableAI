...
/app/bin_gccgcc10_O3/dumpfile02:     file format elf64-x86-64
...
0000000000001390 <line_out>:
    ...
    141e:	49 39 de             	cmp    %rbx,%r14
    1421:	75 cd                	jne    13f0 <line_out+0x60>
    1423:	41 83 fc 0f          	cmp    $0xf,%r12d
    1427:	0f 8f a3 00 00 00    	jg     14d0 <line_out+0x140>
    142d:	44 89 e3             	mov    %r12d,%ebx
    1430:	4c 8d 2d d9 0b 00 00 	lea    0xbd9(%rip),%r13        # 2010 <_IO_stdin_used+0x10>
    1437:	eb 1d                	jmp    1456 <line_out+0xc6>
    1439:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    1440:	48 8b 35 d9 2b 00 00 	mov    0x2bd9(%rip),%rsi        # 4020 <stdout@@GLIBC_2.2.5>
    1447:	bf 20 00 00 00       	mov    $0x20,%edi
    144c:	e8 bf fc ff ff       	callq  1110 <putc@plt>
    1451:	83 fb 10             	cmp    $0x10,%ebx
    1454:	74 1c                	je     1472 <line_out+0xe2>
    1456:	4c 89 ee             	mov    %r13,%rsi
    1459:	bf 01 00 00 00       	mov    $0x1,%edi
    145e:	31 c0                	xor    %eax,%eax
    1460:	83 c3 01             	add    $0x1,%ebx
    1463:	e8 c8 fc ff ff       	callq  1130 <__printf_chk@plt>
    1468:	f6 c3 07             	test   $0x7,%bl
    146b:	74 d3                	je     1440 <line_out+0xb0>
    146d:	83 fb 10             	cmp    $0x10,%ebx
    1470:	75 e4                	jne    1456 <line_out+0xc6>
    ...
    14cf:	90                   	nop
    14d0:	48 8b 35 49 2b 00 00 	mov    0x2b49(%rip),%rsi        # 4020 <stdout@@GLIBC_2.2.5>
    14d7:	bf 20 00 00 00       	mov    $0x20,%edi
    14dc:	e8 2f fc ff ff       	callq  1110 <putc@plt>
    14e1:	eb a5                	jmp    1488 <line_out+0xf8>
    14e3:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    14e8:	bb 01 00 00 00       	mov    $0x1,%ebx
    14ed:	e9 3e ff ff ff       	jmpq   1430 <line_out+0xa0>
