...
/app/bin_gccgcc10_O3/2021_08_14-Lesson:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1068:	48 c7 c2 d8 ff ff ff 	mov    $0xffffffffffffffd8,%rdx
    ...
    1082:	48 8d 35 ad 0f 00 00 	lea    0xfad(%rip),%rsi        # 2036 <_IO_stdin_used+0x36>
    1089:	bf 01 00 00 00       	mov    $0x1,%edi
    108e:	31 c0                	xor    %eax,%eax
    1090:	48 ba f6 ff ff ff ff 	movabs $0x3ffffffffffffff6,%rdx
    1097:	ff ff 3f 
    109a:	e8 b1 ff ff ff       	callq  1050 <__printf_chk@plt>
    109f:	31 c0                	xor    %eax,%eax
    10a1:	48 83 c4 08          	add    $0x8,%rsp
    10a5:	c3                   	retq   
