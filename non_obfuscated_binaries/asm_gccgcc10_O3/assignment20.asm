...
/app/bin_gccgcc10_O3/assignment20:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    107b:	c7 05 93 2f 00 00 32 	movl   $0x32,0x2f93(%rip)        # 4018 <example>
    1082:	00 00 00 
    1085:	c6 05 90 2f 00 00 57 	movb   $0x57,0x2f90(%rip)        # 401c <example+0x4>
    108c:	c7 05 8a 2f 00 00 c3 	movl   $0x4048f5c3,0x2f8a(%rip)        # 4020 <example+0x8>
    1093:	f5 48 40 
    1096:	e8 b5 ff ff ff       	callq  1050 <__printf_chk@plt>
    109b:	0f be 15 7a 2f 00 00 	movsbl 0x2f7a(%rip),%edx        # 401c <example+0x4>
    10a2:	48 8d 35 6f 0f 00 00 	lea    0xf6f(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    10a9:	31 c0                	xor    %eax,%eax
    10ab:	bf 01 00 00 00       	mov    $0x1,%edi
    10b0:	e8 9b ff ff ff       	callq  1050 <__printf_chk@plt>
    10b5:	66 0f ef c0          	pxor   %xmm0,%xmm0
    10b9:	bf 01 00 00 00       	mov    $0x1,%edi
    10be:	48 8d 35 6a 0f 00 00 	lea    0xf6a(%rip),%rsi        # 202f <_IO_stdin_used+0x2f>
    10c5:	b8 01 00 00 00       	mov    $0x1,%eax
    10ca:	f3 0f 5a 05 4e 2f 00 	cvtss2sd 0x2f4e(%rip),%xmm0        # 4020 <example+0x8>
    10d1:	00 
    10d2:	e8 79 ff ff ff       	callq  1050 <__printf_chk@plt>
