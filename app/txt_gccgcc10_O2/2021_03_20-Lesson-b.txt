...
/app/bin_gccgcc10_O2/2021_03_20-Lesson-b:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    110d:	74 44                	je     1153 <main+0x73>
    110f:	f2 0f 10 05 19 0f 00 	movsd  0xf19(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    1116:	00 
    1117:	48 89 e5             	mov    %rsp,%rbp
    111a:	be 20 00 00 00       	mov    $0x20,%esi
    111f:	48 8d 15 00 0f 00 00 	lea    0xf00(%rip),%rdx        # 2026 <_IO_stdin_used+0x26>
    ...
    113d:	48 8b 4c 24 28       	mov    0x28(%rsp),%rcx
    1142:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1149:	00 00 
    114b:	75 2a                	jne    1177 <main+0x97>
    114d:	48 83 c4 30          	add    $0x30,%rsp
    1151:	5d                   	pop    %rbp
    1152:	c3                   	retq   
    1153:	48 8b 0d c6 2e 00 00 	mov    0x2ec6(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    115a:	ba 15 00 00 00       	mov    $0x15,%edx
    115f:	be 01 00 00 00       	mov    $0x1,%esi
    1164:	48 8d 3d a5 0e 00 00 	lea    0xea5(%rip),%rdi        # 2010 <_IO_stdin_used+0x10>
    116b:	e8 60 ff ff ff       	callq  10d0 <fwrite@plt>
    1170:	b8 01 00 00 00       	mov    $0x1,%eax
    1175:	eb c6                	jmp    113d <main+0x5d>
    1177:	e8 24 ff ff ff       	callq  10a0 <__stack_chk_fail@plt>
