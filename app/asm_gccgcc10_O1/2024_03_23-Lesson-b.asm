...
/app/bin_gccgcc10_O1/2024_03_23-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    116f:	55                   	push   %rbp
    1170:	53                   	push   %rbx
    1171:	ba 41 00 00 00       	mov    $0x41,%edx
    ...
    1187:	e8 d4 fe ff ff       	callq  1060 <__printf_chk@plt>
    118c:	bb 42 00 00 00       	mov    $0x42,%ebx
    1191:	41 bc 41 00 00 00    	mov    $0x41,%r12d
    1197:	eb 26                	jmp    11bf <main+0x56>
    1199:	8d 6b 01             	lea    0x1(%rbx),%ebp
    119c:	0f be d3             	movsbl %bl,%edx
    119f:	48 8d 35 5e 0e 00 00 	lea    0xe5e(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11a6:	bf 01 00 00 00       	mov    $0x1,%edi
    11ab:	b8 00 00 00 00       	mov    $0x0,%eax
    11b0:	e8 ab fe ff ff       	callq  1060 <__printf_chk@plt>
    11b5:	40 80 fd 5a          	cmp    $0x5a,%bpl
    11b9:	89 eb                	mov    %ebp,%ebx
    11bb:	41 0f 44 dc          	cmove  %r12d,%ebx
    11bf:	48 8b 3d 4a 2e 00 00 	mov    0x2e4a(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    11c6:	e8 a5 fe ff ff       	callq  1070 <getc@plt>
    11cb:	85 c0                	test   %eax,%eax
    11cd:	74 ca                	je     1199 <main+0x30>
