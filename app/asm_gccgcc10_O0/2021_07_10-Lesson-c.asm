...
/app/bin_gccgcc10_O0/2021_07_10-Lesson-c:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    118d:	eb 3b                	jmp    11ca <main+0x61>
    118f:	83 7d fc 3f          	cmpl   $0x3f,-0x4(%rbp)
    1193:	75 1b                	jne    11b0 <main+0x47>
    1195:	8b 05 85 2e 00 00    	mov    0x2e85(%rip),%eax        # 4020 <optopt@@GLIBC_2.2.5>
    119b:	89 c6                	mov    %eax,%esi
    119d:	48 8d 3d 64 0e 00 00 	lea    0xe64(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11a4:	b8 00 00 00 00       	mov    $0x0,%eax
    11a9:	e8 b2 fe ff ff       	callq  1060 <printf@plt>
    11ae:	eb 16                	jmp    11c6 <main+0x5d>
    11b0:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11b3:	89 c6                	mov    %eax,%esi
    11b5:	48 8d 3d 6b 0e 00 00 	lea    0xe6b(%rip),%rdi        # 2027 <_IO_stdin_used+0x27>
    11bc:	b8 00 00 00 00       	mov    $0x0,%eax
    11c1:	e8 9a fe ff ff       	callq  1060 <printf@plt>
    11c6:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11ca:	48 8b 4d e0          	mov    -0x20(%rbp),%rcx
    11ce:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11d1:	48 8d 15 62 0e 00 00 	lea    0xe62(%rip),%rdx        # 203a <_IO_stdin_used+0x3a>
    11d8:	48 89 ce             	mov    %rcx,%rsi
    11db:	89 c7                	mov    %eax,%edi
    11dd:	e8 8e fe ff ff       	callq  1070 <getopt@plt>
    11e2:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11e5:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%rbp)
    11e9:	75 a4                	jne    118f <main+0x26>
    11eb:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11ee:	89 c6                	mov    %eax,%esi
    11f0:	48 8d 3d 47 0e 00 00 	lea    0xe47(%rip),%rdi        # 203e <_IO_stdin_used+0x3e>
    11f7:	b8 00 00 00 00       	mov    $0x0,%eax
    11fc:	e8 5f fe ff ff       	callq  1060 <printf@plt>
