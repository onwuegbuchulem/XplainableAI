...
/app/bin_gccgcc10_O1/2021_01_30-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1194:	7e 24                	jle    11ba <main+0x31>
    1196:	48 8b 56 08          	mov    0x8(%rsi),%rdx
    119a:	48 8d 35 7e 0e 00 00 	lea    0xe7e(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    11a1:	bf 01 00 00 00       	mov    $0x1,%edi
    11a6:	b8 00 00 00 00       	mov    $0x0,%eax
    11ab:	e8 c0 fe ff ff       	callq  1070 <__printf_chk@plt>
    11b0:	b8 00 00 00 00       	mov    $0x0,%eax
    11b5:	48 83 c4 08          	add    $0x8,%rsp
    11b9:	c3                   	retq   
    11ba:	48 8b 0d 5f 2e 00 00 	mov    0x2e5f(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    11c1:	ba 1a 00 00 00       	mov    $0x1a,%edx
    11c6:	be 01 00 00 00       	mov    $0x1,%esi
    11cb:	48 8d 3d 32 0e 00 00 	lea    0xe32(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11d2:	e8 b9 fe ff ff       	callq  1090 <fwrite@plt>
    11d7:	bf 01 00 00 00       	mov    $0x1,%edi
    11dc:	e8 9f fe ff ff       	callq  1080 <exit@plt>
