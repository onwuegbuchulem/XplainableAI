...
/app/bin_gccgcc10_O3/options01:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ab:	00 00 00 
    10ae:	41 54                	push   %r12
    10b0:	4c 8d 25 a8 0f 00 00 	lea    0xfa8(%rip),%r12        # 205f <_IO_stdin_used+0x5f>
    10b7:	55                   	push   %rbp
    ...
    10d0:	74 7e                	je     1150 <main+0xb0>
    10d2:	83 f8 62             	cmp    $0x62,%eax
    10d5:	74 39                	je     1110 <main+0x70>
    10d7:	7f 1f                	jg     10f8 <main+0x58>
    10d9:	83 f8 3f             	cmp    $0x3f,%eax
    10dc:	74 52                	je     1130 <main+0x90>
    10de:	83 f8 61             	cmp    $0x61,%eax
    10e1:	75 3d                	jne    1120 <main+0x80>
    10e3:	48 8d 3d 1a 0f 00 00 	lea    0xf1a(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    10ea:	e8 81 ff ff ff       	callq  1070 <puts@plt>
    10ef:	eb cf                	jmp    10c0 <main+0x20>
    10f1:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    10f8:	83 f8 63             	cmp    $0x63,%eax
    10fb:	75 23                	jne    1120 <main+0x80>
    10fd:	48 8d 3d 21 0f 00 00 	lea    0xf21(%rip),%rdi        # 2025 <_IO_stdin_used+0x25>
    1104:	e8 67 ff ff ff       	callq  1070 <puts@plt>
    1109:	eb b5                	jmp    10c0 <main+0x20>
    110b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1110:	48 8d 3d fd 0e 00 00 	lea    0xefd(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    1117:	e8 54 ff ff ff       	callq  1070 <puts@plt>
    111c:	eb a2                	jmp    10c0 <main+0x20>
    111e:	66 90                	xchg   %ax,%ax
    1120:	48 8d 3d 29 0f 00 00 	lea    0xf29(%rip),%rdi        # 2050 <_IO_stdin_used+0x50>
    1127:	e8 44 ff ff ff       	callq  1070 <puts@plt>
    112c:	eb 92                	jmp    10c0 <main+0x20>
    112e:	66 90                	xchg   %ax,%ax
    1130:	8b 15 ea 2e 00 00    	mov    0x2eea(%rip),%edx        # 4020 <optopt@@GLIBC_2.2.5>
    1136:	48 8d 35 fb 0e 00 00 	lea    0xefb(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    113d:	bf 01 00 00 00       	mov    $0x1,%edi
    1142:	31 c0                	xor    %eax,%eax
    1144:	e8 37 ff ff ff       	callq  1080 <__printf_chk@plt>
    1149:	e9 72 ff ff ff       	jmpq   10c0 <main+0x20>
...
0000000000001200 <__do_global_dtors_aux>:
    ...
    1204:	80 3d 39 2e 00 00 00 	cmpb   $0x0,0x2e39(%rip)        # 4044 <completed.0>
    ...
    122c:	c6 05 11 2e 00 00 01 	movb   $0x1,0x2e11(%rip)        # 4044 <completed.0>
    1233:	5d                   	pop    %rbp
    1234:	c3                   	retq   
