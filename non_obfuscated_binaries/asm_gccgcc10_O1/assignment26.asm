...
/app/bin_gccgcc10_O1/assignment26:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    122c:	bf 02 00 00 00       	mov    $0x2,%edi
    1231:	e8 da fe ff ff       	callq  1110 <socket@plt>
    1236:	89 c3                	mov    %eax,%ebx
    1238:	66 c7 04 24 02 00    	movw   $0x2,(%rsp)
    123e:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%rsp)
    1245:	00 
    1246:	66 c7 44 24 02 15 b3 	movw   $0xb315,0x2(%rsp)
    124d:	48 89 e6             	mov    %rsp,%rsi
    1250:	ba 10 00 00 00       	mov    $0x10,%edx
    1255:	89 c7                	mov    %eax,%edi
    1257:	e8 94 fe ff ff       	callq  10f0 <bind@plt>
    125c:	be 00 00 00 00       	mov    $0x0,%esi
    1261:	89 df                	mov    %ebx,%edi
    1263:	e8 78 fe ff ff       	callq  10e0 <listen@plt>
    1268:	ba 00 00 00 00       	mov    $0x0,%edx
    126d:	be 00 00 00 00       	mov    $0x0,%esi
    1272:	89 df                	mov    %ebx,%edi
    1274:	e8 87 fe ff ff       	callq  1100 <accept@plt>
    1279:	89 c3                	mov    %eax,%ebx
    127b:	be 00 00 00 00       	mov    $0x0,%esi
    1280:	89 c7                	mov    %eax,%edi
    1282:	b8 00 00 00 00       	mov    $0x0,%eax
    1287:	e8 34 fe ff ff       	callq  10c0 <dup2@plt>
    128c:	be 01 00 00 00       	mov    $0x1,%esi
    1291:	89 df                	mov    %ebx,%edi
    1293:	b8 00 00 00 00       	mov    $0x0,%eax
    1298:	e8 23 fe ff ff       	callq  10c0 <dup2@plt>
    129d:	be 02 00 00 00       	mov    $0x2,%esi
    12a2:	89 df                	mov    %ebx,%edi
    12a4:	b8 00 00 00 00       	mov    $0x0,%eax
    12a9:	e8 12 fe ff ff       	callq  10c0 <dup2@plt>
    12ae:	ba 00 00 00 00       	mov    $0x0,%edx
    12b3:	be 00 00 00 00       	mov    $0x0,%esi
    12b8:	48 8d 3d 45 0d 00 00 	lea    0xd45(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    12bf:	e8 0c fe ff ff       	callq  10d0 <execve@plt>
    12c4:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    12c9:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12d0:	00 00 
    12d2:	75 0b                	jne    12df <main+0xd6>
    12d4:	b8 00 00 00 00       	mov    $0x0,%eax
    12d9:	48 83 c4 20          	add    $0x20,%rsp
    12dd:	5b                   	pop    %rbx
    12de:	c3                   	retq   
    12df:	e8 cc fd ff ff       	callq  10b0 <__stack_chk_fail@plt>
