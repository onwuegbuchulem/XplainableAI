...
/app/bin_gccgcc10_O2/2023_12_09-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108c:	55                   	push   %rbp
    108d:	48 8d 2d 70 0f 00 00 	lea    0xf70(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1094:	53                   	push   %rbx
    1095:	48 83 ec 20          	sub    $0x20,%rsp
    1099:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10a0:	00 00 
    10a2:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10a7:	31 c0                	xor    %eax,%eax
    10a9:	48 89 e3             	mov    %rsp,%rbx
    10ac:	0f 11 04 24          	movups %xmm0,(%rsp)
    10b0:	4c 8d 64 24 18       	lea    0x18(%rsp),%r12
    10b5:	48 b8 28 00 00 00 32 	movabs $0x3200000028,%rax
    10bc:	00 00 00 
    10bf:	48 c7 44 24 10 00 00 	movq   $0x0,0x10(%rsp)
    10c6:	00 00 
    10c8:	48 89 44 24 0c       	mov    %rax,0xc(%rsp)
    10cd:	eb 03                	jmp    10d2 <main+0x52>
    10cf:	90                   	nop
