...
/app/bin_gccgcc10_O1/2022_07_23-Lesson-b:     file format elf64-x86-64
...
00000000000010e0 <_start>:
    ...
    1101:	48 8d 3d 06 01 00 00 	lea    0x106(%rip),%rdi        # 120e <main>
...
00000000000011c9 <binString>:
    ...
    11d0:	bf 09 00 00 00       	mov    $0x9,%edi
    11d5:	e8 c6 fe ff ff       	callq  10a0 <malloc@plt>
    11da:	48 85 c0             	test   %rax,%rax
    11dd:	74 25                	je     1204 <binString+0x3b>
    ...
    11ee:	88 10                	mov    %dl,(%rax)
    11f0:	01 db                	add    %ebx,%ebx
    11f2:	48 83 c0 01          	add    $0x1,%rax
    11f6:	48 39 c8             	cmp    %rcx,%rax
    11f9:	75 eb                	jne    11e6 <binString+0x1d>
    11fb:	c6 46 08 00          	movb   $0x0,0x8(%rsi)
    11ff:	48 89 f0             	mov    %rsi,%rax
    1202:	5b                   	pop    %rbx
    1203:	c3                   	retq   
    1204:	bf 01 00 00 00       	mov    $0x1,%edi
    1209:	e8 c2 fe ff ff       	callq  10d0 <exit@plt>
...
000000000000120e <main>:
    ...
    1226:	48 8d 35 db 0d 00 00 	lea    0xddb(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    122d:	bf 01 00 00 00       	mov    $0x1,%edi
    1232:	e8 79 fe ff ff       	callq  10b0 <__printf_chk@plt>
    1237:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    123c:	48 8d 3d e8 0d 00 00 	lea    0xde8(%rip),%rdi        # 202b <_IO_stdin_used+0x2b>
    1243:	b8 00 00 00 00       	mov    $0x0,%eax
    1248:	e8 73 fe ff ff       	callq  10c0 <__isoc99_scanf@plt>
    124d:	0f b6 7c 24 04       	movzbl 0x4(%rsp),%edi
    1252:	e8 72 ff ff ff       	callq  11c9 <binString>
    1257:	48 89 c2             	mov    %rax,%rdx
    125a:	48 8d 35 cd 0d 00 00 	lea    0xdcd(%rip),%rsi        # 202e <_IO_stdin_used+0x2e>
