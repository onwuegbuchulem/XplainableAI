...
/app/bin_gccgcc10_O2/Area_of_Triangle:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10cc:	48 8d 3d 5f 0f 00 00 	lea    0xf5f(%rip),%rdi        # 2032 <_IO_stdin_used+0x32>
    10d3:	31 c0                	xor    %eax,%eax
    10d5:	e8 b6 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10da:	48 8d 35 35 0f 00 00 	lea    0xf35(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    ...
    10f2:	48 8d 3d 39 0f 00 00 	lea    0xf39(%rip),%rdi        # 2032 <_IO_stdin_used+0x32>
    10f9:	31 c0                	xor    %eax,%eax
    10fb:	e8 90 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    1100:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1104:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1108:	48 8d 35 1b 0f 00 00 	lea    0xf1b(%rip),%rsi        # 202a <_IO_stdin_used+0x2a>
    110f:	f3 0f 5a 04 24       	cvtss2sd (%rsp),%xmm0
    1114:	f3 0f 5a 4c 24 04    	cvtss2sd 0x4(%rsp),%xmm1
    111a:	bf 01 00 00 00       	mov    $0x1,%edi
    111f:	b8 01 00 00 00       	mov    $0x1,%eax
    1124:	f2 0f 59 05 0c 0f 00 	mulsd  0xf0c(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    112b:	00 
    112c:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    1130:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    1134:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    ...
    1149:	00 00 
    114b:	75 05                	jne    1152 <main+0xb2>
    114d:	48 83 c4 18          	add    $0x18,%rsp
    1151:	c3                   	retq   
    1152:	e8 19 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
