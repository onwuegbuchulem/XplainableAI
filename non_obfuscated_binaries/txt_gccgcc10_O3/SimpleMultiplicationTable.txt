...
/app/bin_gccgcc10_O3/SimpleMultiplicationTable:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10cc:	48 8d 2d 77 0f 00 00 	lea    0xf77(%rip),%rbp        # 204a <_IO_stdin_used+0x4a>
    10d3:	53                   	push   %rbx
    10d4:	bb 01 00 00 00       	mov    $0x1,%ebx
    10d9:	48 83 ec 18          	sub    $0x18,%rsp
    10dd:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10e4:	00 00 
    10e6:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10eb:	31 c0                	xor    %eax,%eax
    10ed:	e8 8e ff ff ff       	callq  1080 <puts@plt>
    10f2:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    10f7:	48 8d 3d 49 0f 00 00 	lea    0xf49(%rip),%rdi        # 2047 <_IO_stdin_used+0x47>
    10fe:	31 c0                	xor    %eax,%eax
    1100:	e8 ab ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1105:	0f 1f 00             	nopl   (%rax)
    1108:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    110c:	89 da                	mov    %ebx,%edx
    110e:	48 89 ee             	mov    %rbp,%rsi
    1111:	bf 01 00 00 00       	mov    $0x1,%edi
    1116:	31 c0                	xor    %eax,%eax
    1118:	41 89 c8             	mov    %ecx,%r8d
    111b:	44 0f af c3          	imul   %ebx,%r8d
    111f:	83 c3 01             	add    $0x1,%ebx
    1122:	e8 79 ff ff ff       	callq  10a0 <__printf_chk@plt>
    1127:	83 fb 0b             	cmp    $0xb,%ebx
    112a:	75 dc                	jne    1108 <main+0x48>
    112c:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1131:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1138:	00 00 
    113a:	75 09                	jne    1145 <main+0x85>
    113c:	48 83 c4 18          	add    $0x18,%rsp
