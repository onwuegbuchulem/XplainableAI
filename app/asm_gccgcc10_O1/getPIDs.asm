...
/app/bin_gccgcc10_O1/getPIDs:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11b3:	bf 05 00 00 00       	mov    $0x5,%edi
    11b8:	e8 f3 fe ff ff       	callq  10b0 <sleep@plt>
    11bd:	e8 be fe ff ff       	callq  1080 <getpid@plt>
    11c2:	89 c5                	mov    %eax,%ebp
    11c4:	e8 d7 fe ff ff       	callq  10a0 <getppid@plt>
    11c9:	89 c3                	mov    %eax,%ebx
    11cb:	89 ea                	mov    %ebp,%edx
    11cd:	48 8d 35 30 0e 00 00 	lea    0xe30(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11d4:	bf 01 00 00 00       	mov    $0x1,%edi
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	e8 ad fe ff ff       	callq  1090 <__printf_chk@plt>
    11e3:	89 da                	mov    %ebx,%edx
    11e5:	48 8d 35 34 0e 00 00 	lea    0xe34(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    11ec:	bf 01 00 00 00       	mov    $0x1,%edi
    11f1:	b8 00 00 00 00       	mov    $0x0,%eax
    11f6:	e8 95 fe ff ff       	callq  1090 <__printf_chk@plt>
