...
/app/bin_gccgcc10_O1/byte_values04:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1191:	55                   	push   %rbp
    1192:	53                   	push   %rbx
    1193:	48 81 ec 18 01 00 00 	sub    $0x118,%rsp
    119a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11a1:	00 00 
    11a3:	48 89 84 24 08 01 00 	mov    %rax,0x108(%rsp)
    11aa:	00 
    11ab:	31 c0                	xor    %eax,%eax
    11ad:	88 04 04             	mov    %al,(%rsp,%rax,1)
    11b0:	48 83 c0 01          	add    $0x1,%rax
    11b4:	48 3d 00 01 00 00    	cmp    $0x100,%rax
    11ba:	75 f1                	jne    11ad <main+0x24>
    11bc:	48 89 e5             	mov    %rsp,%rbp
    11bf:	bb 00 00 00 00       	mov    $0x0,%ebx
    11c4:	4c 8d 2d 39 0e 00 00 	lea    0xe39(%rip),%r13        # 2004 <_IO_stdin_used+0x4>
    11cb:	eb 35                	jmp    1202 <main+0x79>
    11cd:	89 da                	mov    %ebx,%edx
    11cf:	4c 89 ee             	mov    %r13,%rsi
    11d2:	bf 01 00 00 00       	mov    $0x1,%edi
    11d7:	b8 00 00 00 00       	mov    $0x0,%eax
    11dc:	e8 af fe ff ff       	callq  1090 <__printf_chk@plt>
    11e1:	eb 24                	jmp    1207 <main+0x7e>
    11e3:	48 8b 35 26 2e 00 00 	mov    0x2e26(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11ea:	bf 20 00 00 00       	mov    $0x20,%edi
    11ef:	e8 8c fe ff ff       	callq  1080 <putc@plt>
    11f4:	eb 36                	jmp    122c <main+0xa3>
    11f6:	48 83 c5 01          	add    $0x1,%rbp
    11fa:	81 fb 00 01 00 00    	cmp    $0x100,%ebx
    1200:	74 43                	je     1245 <main+0xbc>
    1202:	f6 c3 0f             	test   $0xf,%bl
    1205:	74 c6                	je     11cd <main+0x44>
    1207:	0f b6 55 00          	movzbl 0x0(%rbp),%edx
    120b:	48 8d 35 f8 0d 00 00 	lea    0xdf8(%rip),%rsi        # 200a <_IO_stdin_used+0xa>
    ...
    1224:	41 89 dc             	mov    %ebx,%r12d
    1227:	f6 c3 07             	test   $0x7,%bl
    122a:	74 b7                	je     11e3 <main+0x5a>
    122c:	41 f6 c4 0f          	test   $0xf,%r12b
    1230:	75 c4                	jne    11f6 <main+0x6d>
    1232:	48 8b 35 d7 2d 00 00 	mov    0x2dd7(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1239:	bf 0a 00 00 00       	mov    $0xa,%edi
    123e:	e8 3d fe ff ff       	callq  1080 <putc@plt>
    1243:	eb b1                	jmp    11f6 <main+0x6d>
    1245:	48 8b 84 24 08 01 00 	mov    0x108(%rsp),%rax
    124c:	00 
    124d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1254:	00 00 
    1256:	75 13                	jne    126b <main+0xe2>
    1258:	b8 00 00 00 00       	mov    $0x0,%eax
    125d:	48 81 c4 18 01 00 00 	add    $0x118,%rsp
    1264:	5b                   	pop    %rbx
    1265:	5d                   	pop    %rbp
    1266:	41 5c                	pop    %r12
    1268:	41 5d                	pop    %r13
    126a:	c3                   	retq   
    126b:	e8 00 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
