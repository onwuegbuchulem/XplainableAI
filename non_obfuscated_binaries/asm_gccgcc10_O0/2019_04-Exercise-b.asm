...
/app/bin_gccgcc10_O0/2019_04-Exercise-b:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	c7 45 fc 64 00 00 00 	movl   $0x64,-0x4(%rbp)
    115c:	eb 42                	jmp    11a0 <main+0x57>
    115e:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1161:	48 63 d0             	movslq %eax,%rdx
    1164:	48 69 d2 c5 85 9a 93 	imul   $0xffffffff939a85c5,%rdx,%rdx
    116b:	48 c1 ea 20          	shr    $0x20,%rdx
    116f:	01 c2                	add    %eax,%edx
    1171:	c1 fa 06             	sar    $0x6,%edx
    1174:	89 c1                	mov    %eax,%ecx
    1176:	c1 f9 1f             	sar    $0x1f,%ecx
    1179:	29 ca                	sub    %ecx,%edx
    117b:	6b ca 6f             	imul   $0x6f,%edx,%ecx
    117e:	29 c8                	sub    %ecx,%eax
    1180:	89 c2                	mov    %eax,%edx
    1182:	85 d2                	test   %edx,%edx
    1184:	75 16                	jne    119c <main+0x53>
    ...
    11a0:	81 7d fc e7 03 00 00 	cmpl   $0x3e7,-0x4(%rbp)
    11a7:	7e b5                	jle    115e <main+0x15>
