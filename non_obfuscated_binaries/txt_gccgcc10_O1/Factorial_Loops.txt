...
/app/bin_gccgcc10_O1/Factorial_Loops:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ce:	7e 4b                	jle    121b <main+0x92>
    11d0:	89 d0                	mov    %edx,%eax
    11d2:	f2 0f 10 05 5e 0e 00 	movsd  0xe5e(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    11d9:	00 
    11da:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11de:	f2 0f 2a c8          	cvtsi2sd %eax,%xmm1
    11e2:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    11e6:	83 e8 01             	sub    $0x1,%eax
    11e9:	75 ef                	jne    11da <main+0x51>
    11eb:	48 8d 35 28 0e 00 00 	lea    0xe28(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    ...
    120d:	00 00 
    120f:	75 14                	jne    1225 <main+0x9c>
    1211:	b8 00 00 00 00       	mov    $0x0,%eax
    1216:	48 83 c4 18          	add    $0x18,%rsp
    121a:	c3                   	retq   
    121b:	f2 0f 10 05 15 0e 00 	movsd  0xe15(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    1222:	00 
    1223:	eb c6                	jmp    11eb <main+0x62>
