...
/app/bin_gccgcc10_O1/VowelorConsonant:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11e8:	83 e8 41             	sub    $0x41,%eax
    11eb:	3c 34                	cmp    $0x34,%al
    11ed:	77 44                	ja     1233 <main+0x8a>
    11ef:	0f b6 c0             	movzbl %al,%eax
    11f2:	48 8d 15 63 0e 00 00 	lea    0xe63(%rip),%rdx        # 205c <_IO_stdin_used+0x5c>
