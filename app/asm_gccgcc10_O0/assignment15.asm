...
/app/bin_gccgcc10_O0/assignment15:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    11b0:	48 8d 3d 79 0e 00 00 	lea    0xe79(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    11b7:	b8 00 00 00 00       	mov    $0x0,%eax
    11bc:	e8 af fe ff ff       	callq  1070 <printf@plt>
    11c1:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    11c5:	48 89 c6             	mov    %rax,%rsi
    11c8:	48 8d 3d 99 0e 00 00 	lea    0xe99(%rip),%rdi        # 2068 <_IO_stdin_used+0x68>
    ...
    11e1:	48 8d 3d b0 0e 00 00 	lea    0xeb0(%rip),%rdi        # 2098 <_IO_stdin_used+0x98>
    11e8:	b8 00 00 00 00       	mov    $0x0,%eax
    11ed:	e8 7e fe ff ff       	callq  1070 <printf@plt>
    11f2:	b8 00 00 00 00       	mov    $0x0,%eax
    11f7:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11fb:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1202:	00 00 
