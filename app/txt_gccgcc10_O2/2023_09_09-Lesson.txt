...
/app/bin_gccgcc10_O2/2023_09_09-Lesson:     file format elf64-x86-64
...
0000000000001160 <main>:
    ...
    1174:	0f 84 c0 00 00 00    	je     123a <main+0xda>
    ...
    1212:	e8 79 02 00 00       	callq  1490 <mem_close>
    1217:	48 8d 15 f2 2d 00 00 	lea    0x2df2(%rip),%rdx        # 4010 <name1.0>
    121e:	48 8d 35 1e 0e 00 00 	lea    0xe1e(%rip),%rsi        # 2043 <_IO_stdin_used+0x43>
    1225:	31 c0                	xor    %eax,%eax
    1227:	bf 01 00 00 00       	mov    $0x1,%edi
    122c:	e8 ff fe ff ff       	callq  1130 <__printf_chk@plt>
    1231:	31 c0                	xor    %eax,%eax
    1233:	5d                   	pop    %rbp
    1234:	c3                   	retq   
    1235:	83 ca ff             	or     $0xffffffff,%edx
    1238:	eb bb                	jmp    11f5 <main+0x95>
    123a:	48 8b 3d df 2d 00 00 	mov    0x2ddf(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    1241:	48 8d 0d c8 2d 00 00 	lea    0x2dc8(%rip),%rcx        # 4010 <name1.0>
    1248:	48 8d 15 b5 0d 00 00 	lea    0xdb5(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    124f:	31 c0                	xor    %eax,%eax
    1251:	be 01 00 00 00       	mov    $0x1,%esi
    1256:	e8 f5 fe ff ff       	callq  1150 <__fprintf_chk@plt>
    125b:	bf 01 00 00 00       	mov    $0x1,%edi
    1260:	e8 db fe ff ff       	callq  1140 <exit@plt>
