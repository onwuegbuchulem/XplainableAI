...
/app/bin_gccgcc10_O1/2019_01_12-Lesson:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11ed:	e8 ce fe ff ff       	callq  10c0 <__printf_chk@plt>
    11f2:	48 8d 74 24 07       	lea    0x7(%rsp),%rsi
    11f7:	48 8d 3d 16 0e 00 00 	lea    0xe16(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    11fe:	b8 00 00 00 00       	mov    $0x0,%eax
    1203:	e8 c8 fe ff ff       	callq  10d0 <__isoc99_scanf@plt>
    1208:	80 7c 24 07 4d       	cmpb   $0x4d,0x7(%rsp)
    120d:	7f 26                	jg     1235 <main+0x6c>
    120f:	48 8d 3d 01 0e 00 00 	lea    0xe01(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    1216:	e8 85 fe ff ff       	callq  10a0 <puts@plt>
    121b:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1220:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1227:	00 00 
    1229:	75 0f                	jne    123a <main+0x71>
    122b:	b8 00 00 00 00       	mov    $0x0,%eax
    1230:	48 83 c4 18          	add    $0x18,%rsp
    1234:	c3                   	retq   
    1235:	e8 56 fe ff ff       	callq  1090 <abort@plt>
    123a:	e8 71 fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
    123f:	90                   	nop
