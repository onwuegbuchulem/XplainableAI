...
/app/bin_gccgcc10_O3/TernaryOperator:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e6:	48 8d 4c 24 14       	lea    0x14(%rsp),%rcx
    10eb:	48 8d 54 24 10       	lea    0x10(%rsp),%rdx
    10f0:	48 8d 74 24 0c       	lea    0xc(%rsp),%rsi
    10f5:	48 8d 3d 1c 0f 00 00 	lea    0xf1c(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    10fc:	e8 af ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1101:	f3 0f 10 4c 24 0c    	movss  0xc(%rsp),%xmm1
    1107:	f3 0f 10 44 24 10    	movss  0x10(%rsp),%xmm0
    110d:	0f 2f c8             	comiss %xmm0,%xmm1
    1110:	76 3a                	jbe    114c <main+0x8c>
    1112:	f3 0f 5f 4c 24 14    	maxss  0x14(%rsp),%xmm1
    1118:	0f 28 c1             	movaps %xmm1,%xmm0
    111b:	48 8d 35 fd 0e 00 00 	lea    0xefd(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    1122:	bf 01 00 00 00       	mov    $0x1,%edi
    1127:	b8 01 00 00 00       	mov    $0x1,%eax
    112c:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1130:	e8 6b ff ff ff       	callq  10a0 <__printf_chk@plt>
    1135:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    113a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1141:	00 00 
    1143:	75 0f                	jne    1154 <main+0x94>
    1145:	31 c0                	xor    %eax,%eax
    1147:	48 83 c4 28          	add    $0x28,%rsp
    114b:	c3                   	retq   
    114c:	f3 0f 5f 44 24 14    	maxss  0x14(%rsp),%xmm0
    1152:	eb c7                	jmp    111b <main+0x5b>
    1154:	e8 37 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
