...
/app/bin_gccgcc10_O1/readdir03:     file format elf64-x86-64
...
00000000000010b0 <opendir@plt>:
    ...
    10b4:	f2 ff 25 f5 2e 00 00 	bnd jmpq *0x2ef5(%rip)        # 3fb0 <opendir@GLIBC_2.2.5>
    10bb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010c0 <closedir@plt>:
    10c0:	f3 0f 1e fa          	endbr64 
    10c4:	f2 ff 25 ed 2e 00 00 	bnd jmpq *0x2eed(%rip)        # 3fb8 <closedir@GLIBC_2.2.5>
    10cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010d0 <readdir@plt>:
    10d0:	f3 0f 1e fa          	endbr64 
    10d4:	f2 ff 25 e5 2e 00 00 	bnd jmpq *0x2ee5(%rip)        # 3fc0 <readdir@GLIBC_2.2.5>
...
0000000000001100 <_start>:
    ...
    1111:	50                   	push   %rax
    1112:	54                   	push   %rsp
    1113:	4c 8d 05 b6 01 00 00 	lea    0x1b6(%rip),%r8        # 12d0 <__libc_csu_fini>
    111a:	48 8d 0d 3f 01 00 00 	lea    0x13f(%rip),%rcx        # 1260 <__libc_csu_init>
...
00000000000011e9 <main>:
    ...
    11fa:	e8 b1 fe ff ff       	callq  10b0 <opendir@plt>
    11ff:	48 85 c0             	test   %rax,%rax
    1202:	74 0c                	je     1210 <main+0x27>
    1204:	48 89 c3             	mov    %rax,%rbx
    1207:	48 8d 2d 11 0e 00 00 	lea    0xe11(%rip),%rbp        # 201f <_IO_stdin_used+0x1f>
    120e:	eb 2c                	jmp    123c <main+0x53>
    ...
    1221:	e8 ca fe ff ff       	callq  10f0 <exit@plt>
    1226:	48 8d 50 13          	lea    0x13(%rax),%rdx
    122a:	48 89 ee             	mov    %rbp,%rsi
    122d:	bf 01 00 00 00       	mov    $0x1,%edi
    1232:	b8 00 00 00 00       	mov    $0x0,%eax
    1237:	e8 a4 fe ff ff       	callq  10e0 <__printf_chk@plt>
    123c:	48 89 df             	mov    %rbx,%rdi
    123f:	e8 8c fe ff ff       	callq  10d0 <readdir@plt>
    1244:	48 85 c0             	test   %rax,%rax
    1247:	75 dd                	jne    1226 <main+0x3d>
    1249:	48 89 df             	mov    %rbx,%rdi
    124c:	e8 6f fe ff ff       	callq  10c0 <closedir@plt>
...
0000000000001260 <__libc_csu_init>:
    ...
    1264:	41 57                	push   %r15
    1266:	4c 8d 3d 23 2b 00 00 	lea    0x2b23(%rip),%r15        # 3d90 <__frame_dummy_init_array_entry>
    126d:	41 56                	push   %r14
    ...
    127c:	55                   	push   %rbp
    127d:	48 8d 2d 14 2b 00 00 	lea    0x2b14(%rip),%rbp        # 3d98 <__do_global_dtors_aux_fini_array_entry>
    1284:	53                   	push   %rbx
