...
/app/bin_gccgcc10_O0/2020_10_31-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1175:	c7 45 f4 02 00 00 00 	movl   $0x2,-0xc(%rbp)
    117c:	eb 6c                	jmp    11ea <main+0x81>
    117e:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%rbp)
    ...
    1196:	e8 d5 fe ff ff       	callq  1070 <printf@plt>
    119b:	c7 45 f8 02 00 00 00 	movl   $0x2,-0x8(%rbp)
    11a2:	eb 1a                	jmp    11be <main+0x55>
    11a4:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11a7:	99                   	cltd   
    11a8:	f7 7d f8             	idivl  -0x8(%rbp)
    11ab:	89 d0                	mov    %edx,%eax
    11ad:	85 c0                	test   %eax,%eax
    11af:	75 09                	jne    11ba <main+0x51>
    11b1:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
    11b8:	eb 0c                	jmp    11c6 <main+0x5d>
    11ba:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11be:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11c1:	3b 45 f4             	cmp    -0xc(%rbp),%eax
    11c4:	7c de                	jl     11a4 <main+0x3b>
    11c6:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    11ca:	74 0e                	je     11da <main+0x71>
    11cc:	48 8d 3d 35 0e 00 00 	lea    0xe35(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11d3:	e8 88 fe ff ff       	callq  1060 <puts@plt>
    11d8:	eb 0c                	jmp    11e6 <main+0x7d>
    11da:	48 8d 3d 2d 0e 00 00 	lea    0xe2d(%rip),%rdi        # 200e <_IO_stdin_used+0xe>
    11e1:	e8 7a fe ff ff       	callq  1060 <puts@plt>
    11e6:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    11ea:	83 7d f4 63          	cmpl   $0x63,-0xc(%rbp)
    11ee:	7e 8e                	jle    117e <main+0x15>
