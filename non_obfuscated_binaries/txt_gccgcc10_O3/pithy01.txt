...
/app/bin_gccgcc10_O3/pithy01:     file format elf64-x86-64
...
0000000000001140 <main>:
    ...
    114d:	55                   	push   %rbp
    114e:	53                   	push   %rbx
    114f:	48 81 ec 20 01 00 00 	sub    $0x120,%rsp
    1156:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    115d:	00 00 
    115f:	48 89 84 24 18 01 00 	mov    %rax,0x118(%rsp)
    1166:	00 
    1167:	48 b8 70 69 74 68 79 	movabs $0x78742e7968746970,%rax
    116e:	2e 74 78 
    1171:	4c 8d 64 24 06       	lea    0x6(%rsp),%r12
    1176:	4c 89 e7             	mov    %r12,%rdi
    1179:	48 89 44 24 06       	mov    %rax,0x6(%rsp)
    117e:	b8 74 00 00 00       	mov    $0x74,%eax
    1183:	66 89 44 24 0e       	mov    %ax,0xe(%rsp)
    1188:	e8 83 ff ff ff       	callq  1110 <fopen@plt>
    118d:	48 85 c0             	test   %rax,%rax
    1190:	74 6e                	je     1200 <main+0xc0>
    1192:	48 89 c5             	mov    %rax,%rbp
    1195:	48 8d 5c 24 10       	lea    0x10(%rsp),%rbx
    119a:	eb 2f                	jmp    11cb <main+0x8b>
    119c:	0f 1f 40 00          	nopl   0x0(%rax)
    11a0:	48 89 ea             	mov    %rbp,%rdx
    11a3:	be 00 01 00 00       	mov    $0x100,%esi
    11a8:	48 89 df             	mov    %rbx,%rdi
    11ab:	e8 30 ff ff ff       	callq  10e0 <fgets@plt>
    11b0:	48 85 c0             	test   %rax,%rax
    11b3:	74 22                	je     11d7 <main+0x97>
    11b5:	48 89 da             	mov    %rbx,%rdx
    11b8:	48 8d 35 5f 0e 00 00 	lea    0xe5f(%rip),%rsi        # 201e <_IO_stdin_used+0x1e>
    11bf:	bf 01 00 00 00       	mov    $0x1,%edi
    11c4:	31 c0                	xor    %eax,%eax
    11c6:	e8 35 ff ff ff       	callq  1100 <__printf_chk@plt>
    11cb:	48 89 ef             	mov    %rbp,%rdi
    11ce:	e8 1d ff ff ff       	callq  10f0 <feof@plt>
    11d3:	85 c0                	test   %eax,%eax
    11d5:	74 c9                	je     11a0 <main+0x60>
    11d7:	48 89 ef             	mov    %rbp,%rdi
    11da:	e8 e1 fe ff ff       	callq  10c0 <fclose@plt>
    11df:	48 8b 84 24 18 01 00 	mov    0x118(%rsp),%rax
    11e6:	00 
    11e7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11ee:	00 00 
    11f0:	75 35                	jne    1227 <main+0xe7>
    11f2:	48 81 c4 20 01 00 00 	add    $0x120,%rsp
    11f9:	31 c0                	xor    %eax,%eax
    11fb:	5b                   	pop    %rbx
    11fc:	5d                   	pop    %rbp
    11fd:	41 5c                	pop    %r12
    11ff:	c3                   	retq   
    1200:	48 8b 3d 19 2e 00 00 	mov    0x2e19(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    1207:	4c 89 e1             	mov    %r12,%rcx
    120a:	be 01 00 00 00       	mov    $0x1,%esi
    120f:	31 c0                	xor    %eax,%eax
    1211:	48 8d 15 ee 0d 00 00 	lea    0xdee(%rip),%rdx        # 2006 <_IO_stdin_used+0x6>
