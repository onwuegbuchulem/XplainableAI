...
/app/bin_gccgcc10_O2/ex20_obo:     file format elf64-x86-64
...
00000000000013a0 <bubble_sort>:
    ...
    13cd:	74 72                	je     1441 <bubble_sort+0xa1>
    13cf:	4c 89 e2             	mov    %r12,%rdx
    13d2:	4c 89 ee             	mov    %r13,%rsi
    13d5:	48 89 c7             	mov    %rax,%rdi
    13d8:	49 89 c7             	mov    %rax,%r15
    13db:	e8 30 fd ff ff       	callq  1110 <memcpy@plt>
    13e0:	45 85 f6             	test   %r14d,%r14d
    13e3:	7e 4a                	jle    142f <bubble_sort+0x8f>
    13e5:	41 8d 46 fe          	lea    -0x2(%r14),%eax
    13e9:	45 31 ed             	xor    %r13d,%r13d
    13ec:	4d 8d 64 87 04       	lea    0x4(%r15,%rax,4),%r12
    13f1:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    13f8:	4c 89 fb             	mov    %r15,%rbx
    13fb:	41 83 fe 01          	cmp    $0x1,%r14d
    13ff:	74 25                	je     1426 <bubble_sort+0x86>
    1401:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    1408:	8b 73 04             	mov    0x4(%rbx),%esi
    140b:	8b 3b                	mov    (%rbx),%edi
    140d:	ff d5                	callq  *%rbp
    140f:	85 c0                	test   %eax,%eax
    1411:	7e 0a                	jle    141d <bubble_sort+0x7d>
    1413:	8b 43 04             	mov    0x4(%rbx),%eax
    1416:	8b 13                	mov    (%rbx),%edx
    1418:	89 03                	mov    %eax,(%rbx)
    141a:	89 53 04             	mov    %edx,0x4(%rbx)
    141d:	48 83 c3 04          	add    $0x4,%rbx
    1421:	4c 39 e3             	cmp    %r12,%rbx
    1424:	75 e2                	jne    1408 <bubble_sort+0x68>
    1426:	41 83 c5 01          	add    $0x1,%r13d
    142a:	45 39 ee             	cmp    %r13d,%r14d
    142d:	75 c9                	jne    13f8 <bubble_sort+0x58>
    142f:	48 83 c4 08          	add    $0x8,%rsp
    1433:	4c 89 f8             	mov    %r15,%rax
    1436:	5b                   	pop    %rbx
    1437:	5d                   	pop    %rbp
    1438:	41 5c                	pop    %r12
    143a:	41 5d                	pop    %r13
    ...
    143e:	41 5f                	pop    %r15
    1440:	c3                   	retq   
    1441:	48 8d 3d c7 0b 00 00 	lea    0xbc7(%rip),%rdi        # 200f <_IO_stdin_used+0xf>
    1448:	e8 13 ff ff ff       	callq  1360 <die>
