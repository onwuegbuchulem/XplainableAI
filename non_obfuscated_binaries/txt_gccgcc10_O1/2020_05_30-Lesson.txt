...
/app/bin_gccgcc10_O1/2020_05_30-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1183:	c7 04 24 01 00 00 00 	movl   $0x1,(%rsp)
    118a:	48 89 e0             	mov    %rsp,%rax
    118d:	48 8d 4c 24 28       	lea    0x28(%rsp),%rcx
    1192:	8b 10                	mov    (%rax),%edx
    1194:	8d 14 52             	lea    (%rdx,%rdx,2),%edx
    1197:	89 50 04             	mov    %edx,0x4(%rax)
    119a:	48 83 c0 04          	add    $0x4,%rax
    119e:	48 39 c8             	cmp    %rcx,%rax
    11a1:	75 ef                	jne    1192 <main+0x29>
    11a3:	bb 00 00 00 00       	mov    $0x0,%ebx
    11a8:	48 8d 2d 55 0e 00 00 	lea    0xe55(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    11af:	44 8b 04 9c          	mov    (%rsp,%rbx,4),%r8d
    11b3:	89 d9                	mov    %ebx,%ecx
    11b5:	ba 03 00 00 00       	mov    $0x3,%edx
    11ba:	48 89 ee             	mov    %rbp,%rsi
    ...
    11d0:	48 83 fb 0b          	cmp    $0xb,%rbx
    11d4:	75 d9                	jne    11af <main+0x46>
