...
/app/bin_gccgcc10_O1/greek_read01:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    11ed:	55                   	push   %rbp
    11ee:	53                   	push   %rbx
    11ef:	48 81 ec 18 01 00 00 	sub    $0x118,%rsp
    11f6:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11fd:	00 00 
    11ff:	48 89 84 24 08 01 00 	mov    %rax,0x108(%rsp)
    1206:	00 
    1207:	31 c0                	xor    %eax,%eax
    1209:	48 8d 35 f4 0d 00 00 	lea    0xdf4(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1210:	48 8d 3d ef 0d 00 00 	lea    0xdef(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1217:	e8 c4 fe ff ff       	callq  10e0 <fopen@plt>
    121c:	48 89 c3             	mov    %rax,%rbx
    121f:	48 8d 35 ef 0d 00 00 	lea    0xdef(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    1226:	bf 00 00 00 00       	mov    $0x0,%edi
    122b:	e8 a0 fe ff ff       	callq  10d0 <setlocale@plt>
    1230:	48 8d 15 cf 0d 00 00 	lea    0xdcf(%rip),%rdx        # 2006 <_IO_stdin_used+0x6>
    1237:	48 8d 35 ea 0d 00 00 	lea    0xdea(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    123e:	bf 01 00 00 00       	mov    $0x1,%edi
    1243:	b8 00 00 00 00       	mov    $0x0,%eax
    1248:	e8 a3 fe ff ff       	callq  10f0 <__wprintf_chk@plt>
    124d:	48 89 e5             	mov    %rsp,%rbp
    1250:	48 89 da             	mov    %rbx,%rdx
    1253:	be 40 00 00 00       	mov    $0x40,%esi
    1258:	48 89 ef             	mov    %rbp,%rdi
    125b:	e8 40 fe ff ff       	callq  10a0 <fgetws@plt>
    1260:	48 89 ea             	mov    %rbp,%rdx
    1263:	48 8d 35 06 0e 00 00 	lea    0xe06(%rip),%rsi        # 2070 <_IO_stdin_used+0x70>
    126a:	bf 01 00 00 00       	mov    $0x1,%edi
    126f:	b8 00 00 00 00       	mov    $0x0,%eax
    1274:	e8 77 fe ff ff       	callq  10f0 <__wprintf_chk@plt>
    1279:	48 89 df             	mov    %rbx,%rdi
    127c:	e8 2f fe ff ff       	callq  10b0 <fclose@plt>
    1281:	48 8b 84 24 08 01 00 	mov    0x108(%rsp),%rax
    1288:	00 
    1289:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1290:	00 00 
    1292:	75 0f                	jne    12a3 <main+0xba>
    1294:	b8 00 00 00 00       	mov    $0x0,%eax
    1299:	48 81 c4 18 01 00 00 	add    $0x118,%rsp
    12a0:	5b                   	pop    %rbx
    12a1:	5d                   	pop    %rbp
    12a2:	c3                   	retq   
    12a3:	e8 18 fe ff ff       	callq  10c0 <__stack_chk_fail@plt>
