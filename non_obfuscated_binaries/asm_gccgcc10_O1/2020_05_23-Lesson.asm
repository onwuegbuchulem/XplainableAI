...
/app/bin_gccgcc10_O1/2020_05_23-Lesson:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	f2 0f 10 05 ef 0e 00 	movsd  0xeef(%rip),%xmm0        # 2048 <_IO_stdin_used+0x48>
    1158:	00 
    1159:	48 8d 35 a8 0e 00 00 	lea    0xea8(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    1160:	bf 01 00 00 00       	mov    $0x1,%edi
    1165:	b8 01 00 00 00       	mov    $0x1,%eax
    116a:	e8 e1 fe ff ff       	callq  1050 <__printf_chk@plt>
    116f:	f2 0f 10 05 d9 0e 00 	movsd  0xed9(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    1176:	00 
    1177:	48 8d 35 aa 0e 00 00 	lea    0xeaa(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
