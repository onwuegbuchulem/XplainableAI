...
/app/bin_gccgcc10_O0/2019_07_13-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    11a8:	48 8d 4d e8          	lea    -0x18(%rbp),%rcx
    11ac:	48 8d 45 f7          	lea    -0x9(%rbp),%rax
    11b0:	ba 0a 00 00 00       	mov    $0xa,%edx
    11b5:	48 89 ce             	mov    %rcx,%rsi
    11b8:	48 89 c7             	mov    %rax,%rdi
    11bb:	e8 d0 fe ff ff       	callq  1090 <strtol@plt>
    11c0:	89 45 e4             	mov    %eax,-0x1c(%rbp)
    11c3:	8b 55 e4             	mov    -0x1c(%rbp),%edx
    11c6:	48 8d 45 f7          	lea    -0x9(%rbp),%rax
    ...
    11de:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx
    11e2:	48 8d 45 f7          	lea    -0x9(%rbp),%rax
    11e6:	48 39 c2             	cmp    %rax,%rdx
    11e9:	75 18                	jne    1203 <main+0x7a>
    11eb:	48 8d 45 f7          	lea    -0x9(%rbp),%rax
    11ef:	48 89 c6             	mov    %rax,%rsi
    11f2:	48 8d 3d 27 0e 00 00 	lea    0xe27(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    ...
    1213:	00 00 
    1215:	74 05                	je     121c <main+0x93>
    1217:	e8 54 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    121c:	c9                   	leaveq 
    121d:	c3                   	retq   
