...
/app/bin_gccgcc10_O0/04_associativity:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1163:	c7 45 fc 09 00 00 00 	movl   $0x9,-0x4(%rbp)
    116a:	8b 45 f4             	mov    -0xc(%rbp),%eax
    116d:	0f af 45 f8          	imul   -0x8(%rbp),%eax
    1171:	99                   	cltd   
    1172:	f7 7d fc             	idivl  -0x4(%rbp)
    1175:	83 c0 07             	add    $0x7,%eax
    ...
    1190:	01 c0                	add    %eax,%eax
    1192:	01 d0                	add    %edx,%eax
    1194:	89 c2                	mov    %eax,%edx
    1196:	c1 ea 1f             	shr    $0x1f,%edx
    1199:	01 d0                	add    %edx,%eax
    119b:	d1 f8                	sar    %eax
    119d:	0f af 45 fc          	imul   -0x4(%rbp),%eax
    11a1:	89 c1                	mov    %eax,%ecx
    11a3:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11a6:	89 d0                	mov    %edx,%eax
    11a8:	c1 e0 03             	shl    $0x3,%eax
    11ab:	29 d0                	sub    %edx,%eax
    11ad:	01 c8                	add    %ecx,%eax
    11af:	89 c6                	mov    %eax,%esi
    11b1:	48 8d 3d 5d 0e 00 00 	lea    0xe5d(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    11b8:	b8 00 00 00 00       	mov    $0x0,%eax
    11bd:	e8 8e fe ff ff       	callq  1050 <printf@plt>
