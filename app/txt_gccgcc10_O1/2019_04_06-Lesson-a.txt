...
/app/bin_gccgcc10_O1/2019_04_06-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d cd 00 00 00 	lea    0xcd(%rip),%rdi        # 1195 <main>
...
0000000000001189 <max>:
    ...
    118d:	39 f7                	cmp    %esi,%edi
    118f:	89 f0                	mov    %esi,%eax
    1191:	0f 4d c7             	cmovge %edi,%eax
    1194:	c3                   	retq   

0000000000001195 <main>:
    1195:	f3 0f 1e fa          	endbr64 
    1199:	48 83 ec 18          	sub    $0x18,%rsp
    119d:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11a4:	00 00 
    11a6:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11ab:	31 c0                	xor    %eax,%eax
    11ad:	48 8d 35 54 0e 00 00 	lea    0xe54(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    11b4:	bf 01 00 00 00       	mov    $0x1,%edi
    11b9:	e8 c2 fe ff ff       	callq  1080 <__printf_chk@plt>
    11be:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    11c3:	48 89 e6             	mov    %rsp,%rsi
    11c6:	48 8d 3d 64 0e 00 00 	lea    0xe64(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    11cd:	b8 00 00 00 00       	mov    $0x0,%eax
    11d2:	e8 b9 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11d7:	8b 14 24             	mov    (%rsp),%edx
    11da:	39 54 24 04          	cmp    %edx,0x4(%rsp)
    11de:	0f 4d 54 24 04       	cmovge 0x4(%rsp),%edx
    11e3:	48 8d 35 4d 0e 00 00 	lea    0xe4d(%rip),%rsi        # 2037 <_IO_stdin_used+0x37>
    11ea:	bf 01 00 00 00       	mov    $0x1,%edi
    11ef:	b8 00 00 00 00       	mov    $0x0,%eax
    11f4:	e8 87 fe ff ff       	callq  1080 <__printf_chk@plt>
    11f9:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11fe:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1205:	00 00 
    1207:	75 0a                	jne    1213 <main+0x7e>
