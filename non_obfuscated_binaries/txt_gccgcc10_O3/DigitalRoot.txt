...
/app/bin_gccgcc10_O3/DigitalRoot:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c9:	48 8d 3d 4e 0f 00 00 	lea    0xf4e(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    ...
    10e1:	bf cd cc cc cc       	mov    $0xcccccccd,%edi
    10e6:	44 89 ca             	mov    %r9d,%edx
    10e9:	45 31 c0             	xor    %r8d,%r8d
    10ec:	85 d2                	test   %edx,%edx
    10ee:	74 27                	je     1117 <main+0x77>
    10f0:	89 d0                	mov    %edx,%eax
    10f2:	89 d6                	mov    %edx,%esi
    10f4:	48 0f af c7          	imul   %rdi,%rax
    10f8:	48 c1 e8 23          	shr    $0x23,%rax
    10fc:	8d 0c 80             	lea    (%rax,%rax,4),%ecx
    10ff:	01 c9                	add    %ecx,%ecx
    1101:	29 ce                	sub    %ecx,%esi
    1103:	41 01 f0             	add    %esi,%r8d
    1106:	83 fa 09             	cmp    $0x9,%edx
    1109:	77 06                	ja     1111 <main+0x71>
    110b:	41 83 f8 09          	cmp    $0x9,%r8d
    110f:	77 3f                	ja     1150 <main+0xb0>
    1111:	89 c2                	mov    %eax,%edx
    1113:	85 d2                	test   %edx,%edx
    1115:	75 d9                	jne    10f0 <main+0x50>
    1117:	31 c0                	xor    %eax,%eax
    1119:	44 89 c1             	mov    %r8d,%ecx
    111c:	44 89 ca             	mov    %r9d,%edx
    111f:	bf 01 00 00 00       	mov    $0x1,%edi
    1124:	48 8d 35 f6 0e 00 00 	lea    0xef6(%rip),%rsi        # 2021 <_IO_stdin_used+0x21>
