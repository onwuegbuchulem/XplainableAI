...
/app/bin_gccgcc10_O1/2022_07_30-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	53                   	push   %rbx
    118e:	48 8d 1d f7 0e 00 00 	lea    0xef7(%rip),%rbx        # 208c <_IO_stdin_used+0x8c>
    1195:	48 8d 35 b9 0e 00 00 	lea    0xeb9(%rip),%rsi        # 2055 <_IO_stdin_used+0x55>
    119c:	bf 01 00 00 00       	mov    $0x1,%edi
    11a1:	b8 00 00 00 00       	mov    $0x0,%eax
    11a6:	e8 d5 fe ff ff       	callq  1080 <__printf_chk@plt>
    11ab:	48 8b 3d 5e 2e 00 00 	mov    0x2e5e(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    11b2:	e8 d9 fe ff ff       	callq  1090 <getc@plt>
    11b7:	83 e8 41             	sub    $0x41,%eax
    11ba:	83 f8 22             	cmp    $0x22,%eax
    11bd:	77 47                	ja     1206 <main+0x7d>
    11bf:	89 c0                	mov    %eax,%eax
    11c1:	48 63 04 83          	movslq (%rbx,%rax,4),%rax
    11c5:	48 01 d8             	add    %rbx,%rax
    11c8:	3e ff e0             	notrack jmpq *%rax
    11cb:	48 8d 3d 32 0e 00 00 	lea    0xe32(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11d2:	e8 99 fe ff ff       	callq  1070 <puts@plt>
    11d7:	48 8d 3d 94 0e 00 00 	lea    0xe94(%rip),%rdi        # 2072 <_IO_stdin_used+0x72>
    11de:	e8 8d fe ff ff       	callq  1070 <puts@plt>
    11e3:	b8 00 00 00 00       	mov    $0x0,%eax
    11e8:	5b                   	pop    %rbx
    11e9:	c3                   	retq   
    11ea:	48 8d 3d 29 0e 00 00 	lea    0xe29(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    11f1:	e8 7a fe ff ff       	callq  1070 <puts@plt>
    11f6:	eb df                	jmp    11d7 <main+0x4e>
    11f8:	48 8d 3d 31 0e 00 00 	lea    0xe31(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    11ff:	e8 6c fe ff ff       	callq  1070 <puts@plt>
    1204:	eb d1                	jmp    11d7 <main+0x4e>
    1206:	48 8d 3d 39 0e 00 00 	lea    0xe39(%rip),%rdi        # 2046 <_IO_stdin_used+0x46>
    120d:	e8 5e fe ff ff       	callq  1070 <puts@plt>
    1212:	48 8b 3d f7 2d 00 00 	mov    0x2df7(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    1219:	e8 72 fe ff ff       	callq  1090 <getc@plt>
    121e:	83 f8 0a             	cmp    $0xa,%eax
    1221:	75 ef                	jne    1212 <main+0x89>
    1223:	e9 6d ff ff ff       	jmpq   1195 <main+0xc>
