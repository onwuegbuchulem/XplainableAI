...
/app/bin_gccgcc10_O1/02_problem2:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	f2 0f 10 05 1f 0f 00 	movsd  0xf1f(%rip),%xmm0        # 2078 <_IO_stdin_used+0x78>
    1158:	00 
    1159:	ba 06 00 00 00       	mov    $0x6,%edx
    115e:	48 8d 35 a3 0e 00 00 	lea    0xea3(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    1165:	bf 01 00 00 00       	mov    $0x1,%edi
    116a:	b8 01 00 00 00       	mov    $0x1,%eax
    116f:	e8 dc fe ff ff       	callq  1050 <__printf_chk@plt>
    1174:	f2 0f 10 05 04 0f 00 	movsd  0xf04(%rip),%xmm0        # 2080 <_IO_stdin_used+0x80>
    117b:	00 
    117c:	b9 0a 00 00 00       	mov    $0xa,%ecx
    1181:	ba 06 00 00 00       	mov    $0x6,%edx
    1186:	48 8d 35 ab 0e 00 00 	lea    0xeab(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
