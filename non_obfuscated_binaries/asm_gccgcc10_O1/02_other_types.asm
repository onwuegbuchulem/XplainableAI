...
/app/bin_gccgcc10_O1/02_other_types:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1182:	c6 44 24 03 41       	movb   $0x41,0x3(%rsp)
    1187:	c7 44 24 04 8b 6c a7 	movl   $0x40a76c8b,0x4(%rsp)
    118e:	40 
    118f:	48 8d 5c 24 03       	lea    0x3(%rsp),%rbx
    1194:	48 89 da             	mov    %rbx,%rdx
    ...
    11d7:	e8 94 fe ff ff       	callq  1070 <__printf_chk@plt>
    11dc:	0f be 54 24 03       	movsbl 0x3(%rsp),%edx
    11e1:	48 8d 35 34 0e 00 00 	lea    0xe34(%rip),%rsi        # 201c <_IO_stdin_used+0x1c>
    11e8:	bf 01 00 00 00       	mov    $0x1,%edi
    11ed:	b8 00 00 00 00       	mov    $0x0,%eax
    11f2:	e8 79 fe ff ff       	callq  1070 <__printf_chk@plt>
    11f7:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11fc:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1203:	00 00 
    1205:	75 0b                	jne    1212 <main+0xa9>
    1207:	b8 00 00 00 00       	mov    $0x0,%eax
    120c:	48 83 c4 10          	add    $0x10,%rsp
    1210:	5b                   	pop    %rbx
    1211:	c3                   	retq   
    1212:	e8 49 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
