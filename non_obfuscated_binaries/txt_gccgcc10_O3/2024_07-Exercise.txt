...
/app/bin_gccgcc10_O3/2024_07-Exercise:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	48 8d 35 81 0f 00 00 	lea    0xf81(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    ...
    10a7:	48 8d 35 56 0f 00 00 	lea    0xf56(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10ae:	bf 01 00 00 00       	mov    $0x1,%edi
    10b3:	31 c0                	xor    %eax,%eax
    10b5:	e8 a6 ff ff ff       	callq  1060 <__printf_chk@plt>
...
00000000000010d0 <_start>:
    ...
    10e1:	50                   	push   %rax
    10e2:	54                   	push   %rsp
    10e3:	4c 8d 05 66 01 00 00 	lea    0x166(%rip),%r8        # 1250 <__libc_csu_fini>
    10ea:	48 8d 0d ef 00 00 00 	lea    0xef(%rip),%rcx        # 11e0 <__libc_csu_init>
...
0000000000001100 <deregister_tm_clones>:
    ...
    1107:	48 8d 05 02 2f 00 00 	lea    0x2f02(%rip),%rax        # 4010 <stdin@@GLIBC_2.2.5>
...
0000000000001130 <register_tm_clones>:
    ...
    1137:	48 8d 35 d2 2e 00 00 	lea    0x2ed2(%rip),%rsi        # 4010 <stdin@@GLIBC_2.2.5>
...
0000000000001170 <__do_global_dtors_aux>:
    ...
    1174:	80 3d 9d 2e 00 00 00 	cmpb   $0x0,0x2e9d(%rip)        # 4018 <completed.0>
    ...
    119c:	c6 05 75 2e 00 00 01 	movb   $0x1,0x2e75(%rip)        # 4018 <completed.0>
    11a3:	5d                   	pop    %rbp
    11a4:	c3                   	retq   
...
00000000000011c0 <cls>:
    ...
    11d2:	e9 89 fe ff ff       	jmpq   1060 <__printf_chk@plt>
