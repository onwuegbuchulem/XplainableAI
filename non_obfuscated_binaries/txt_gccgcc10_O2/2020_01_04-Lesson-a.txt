...
/app/bin_gccgcc10_O2/2020_01_04-Lesson-a:     file format elf64-x86-64
...
00000000000010b0 <__sprintf_chk@plt>:
    10b0:	f3 0f 1e fa          	endbr64 
    10b4:	f2 ff 25 15 2f 00 00 	bnd jmpq *0x2f15(%rip)        # 3fd0 <__sprintf_chk@GLIBC_2.3.4>
...
00000000000010c0 <main>:
    ...
    10c4:	41 54                	push   %r12
    10c6:	ba 0c 00 00 00       	mov    $0xc,%edx
    10cb:	be 01 00 00 00       	mov    $0x1,%esi
    10d0:	41 b8 0d 00 00 00    	mov    $0xd,%r8d
    10d6:	55                   	push   %rbp
    10d7:	48 8d 0d 26 0f 00 00 	lea    0xf26(%rip),%rcx        # 2004 <_IO_stdin_used+0x4>
    10de:	48 83 ec 28          	sub    $0x28,%rsp
    10e2:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10e9:	00 00 
    10eb:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10f0:	31 c0                	xor    %eax,%eax
    10f2:	48 8d 6c 24 0c       	lea    0xc(%rsp),%rbp
    10f7:	48 89 ef             	mov    %rbp,%rdi
    10fa:	e8 b1 ff ff ff       	callq  10b0 <__sprintf_chk@plt>
    10ff:	48 89 ef             	mov    %rbp,%rdi
    1102:	41 89 c4             	mov    %eax,%r12d
    1105:	e8 76 ff ff ff       	callq  1080 <puts@plt>
    110a:	31 c0                	xor    %eax,%eax
    110c:	44 89 e2             	mov    %r12d,%edx
    110f:	bf 01 00 00 00       	mov    $0x1,%edi
    1114:	48 8d 35 fa 0e 00 00 	lea    0xefa(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    111b:	e8 80 ff ff ff       	callq  10a0 <__printf_chk@plt>
    1120:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1125:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    112c:	00 00 
    112e:	75 0a                	jne    113a <main+0x7a>
    1130:	48 83 c4 28          	add    $0x28,%rsp
    1134:	31 c0                	xor    %eax,%eax
    1136:	5d                   	pop    %rbp
    1137:	41 5c                	pop    %r12
    1139:	c3                   	retq   
    113a:	e8 51 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
    113f:	90                   	nop
