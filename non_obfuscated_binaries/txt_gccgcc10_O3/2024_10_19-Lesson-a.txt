...
/app/bin_gccgcc10_O3/2024_10_19-Lesson-a:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1064:	55                   	push   %rbp
    1065:	66 0f ef d2          	pxor   %xmm2,%xmm2
    1069:	48 8d 2d 94 0f 00 00 	lea    0xf94(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1070:	53                   	push   %rbx
    1071:	bb 10 00 00 00       	mov    $0x10,%ebx
    1076:	48 83 ec 18          	sub    $0x18,%rsp
    107a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1080:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1084:	48 89 ef             	mov    %rbp,%rdi
    1087:	b8 02 00 00 00       	mov    $0x2,%eax
    108c:	f3 0f 11 54 24 0c    	movss  %xmm2,0xc(%rsp)
    1092:	f3 0f 5a c2          	cvtss2sd %xmm2,%xmm0
    1096:	66 0f 28 c8          	movapd %xmm0,%xmm1
    109a:	f2 0f 5c 0d 76 0f 00 	subsd  0xf76(%rip),%xmm1        # 2018 <_IO_stdin_used+0x18>
    10a1:	00 
    10a2:	f2 0f 59 0d 76 0f 00 	mulsd  0xf76(%rip),%xmm1        # 2020 <_IO_stdin_used+0x20>
    10a9:	00 
    10aa:	f2 0f 5a c9          	cvtsd2ss %xmm1,%xmm1
    10ae:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
    10b2:	e8 99 ff ff ff       	callq  1050 <printf@plt>
    10b7:	f3 0f 10 54 24 0c    	movss  0xc(%rsp),%xmm2
    10bd:	f3 0f 58 15 63 0f 00 	addss  0xf63(%rip),%xmm2        # 2028 <_IO_stdin_used+0x28>
    10c4:	00 
    10c5:	83 eb 01             	sub    $0x1,%ebx
    10c8:	75 b6                	jne    1080 <main+0x20>
    10ca:	48 83 c4 18          	add    $0x18,%rsp
    10ce:	31 c0                	xor    %eax,%eax
    10d0:	5b                   	pop    %rbx
    10d1:	5d                   	pop    %rbp
    10d2:	c3                   	retq   
    10d3:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10da:	00 00 00 
