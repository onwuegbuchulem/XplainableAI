...
/app/bin_gccgcc10_O1/isInputLeapYear:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b7:	48 8d 3d d8 0e 00 00 	lea    0xed8(%rip),%rdi        # 2096 <_IO_stdin_used+0x96>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    11cc:	f6 c1 03             	test   $0x3,%cl
    11cf:	75 0e                	jne    11df <main+0x56>
    11d1:	be 64 00 00 00       	mov    $0x64,%esi
    11d6:	89 c8                	mov    %ecx,%eax
    11d8:	99                   	cltd   
    11d9:	f7 fe                	idiv   %esi
    11db:	85 d2                	test   %edx,%edx
    11dd:	75 1f                	jne    11fe <main+0x75>
    11df:	48 63 c1             	movslq %ecx,%rax
    11e2:	48 69 c0 1f 85 eb 51 	imul   $0x51eb851f,%rax,%rax
    11e9:	48 c1 f8 27          	sar    $0x27,%rax
    11ed:	89 ca                	mov    %ecx,%edx
    11ef:	c1 fa 1f             	sar    $0x1f,%edx
    11f2:	29 d0                	sub    %edx,%eax
    11f4:	69 c0 90 01 00 00    	imul   $0x190,%eax,%eax
    11fa:	39 c1                	cmp    %eax,%ecx
    11fc:	75 32                	jne    1230 <main+0xa7>
    11fe:	89 ca                	mov    %ecx,%edx
    1200:	48 8d 35 41 0e 00 00 	lea    0xe41(%rip),%rsi        # 2048 <_IO_stdin_used+0x48>
    1207:	bf 01 00 00 00       	mov    $0x1,%edi
    120c:	b8 00 00 00 00       	mov    $0x0,%eax
    1211:	e8 6a fe ff ff       	callq  1080 <__printf_chk@plt>
    1216:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    121b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1222:	00 00 
    1224:	75 24                	jne    124a <main+0xc1>
    1226:	b8 00 00 00 00       	mov    $0x0,%eax
    122b:	48 83 c4 18          	add    $0x18,%rsp
    122f:	c3                   	retq   
    ...
    1243:	e8 38 fe ff ff       	callq  1080 <__printf_chk@plt>
    1248:	eb cc                	jmp    1216 <main+0x8d>
    124a:	e8 21 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    124f:	90                   	nop
