...
/app/bin_gccgcc10_O0/2020_03_28-Lesson-a:     file format elf64-x86-64
...
00000000000010c0 <close@plt>:
    ...
    10c4:	f2 ff 25 ed 2e 00 00 	bnd jmpq *0x2eed(%rip)        # 3fb8 <close@GLIBC_2.2.5>
...
00000000000010f0 <open@plt>:
    ...
    10f4:	f2 ff 25 d5 2e 00 00 	bnd jmpq *0x2ed5(%rip)        # 3fd0 <open@GLIBC_2.2.5>
...
00000000000011e9 <main>:
    ...
    1207:	48 b8 67 65 74 74 79 	movabs $0x7562737974746567,%rax
    120e:	73 62 75 
    1211:	48 89 85 e1 f7 ff ff 	mov    %rax,-0x81f(%rbp)
    1218:	c7 85 e9 f7 ff ff 72 	movl   $0x742e6772,-0x817(%rbp)
    121f:	67 2e 74 
    1222:	66 c7 85 ed f7 ff ff 	movw   $0x7478,-0x813(%rbp)
    1229:	78 74 
    122b:	c6 85 ef f7 ff ff 00 	movb   $0x0,-0x811(%rbp)
    1232:	48 8d 85 e1 f7 ff ff 	lea    -0x81f(%rbp),%rax
    1239:	be 00 00 00 00       	mov    $0x0,%esi
    123e:	48 89 c7             	mov    %rax,%rdi
    1241:	b8 00 00 00 00       	mov    $0x0,%eax
    1246:	e8 a5 fe ff ff       	callq  10f0 <open@plt>
    124b:	89 85 d4 f7 ff ff    	mov    %eax,-0x82c(%rbp)
    1251:	83 bd d4 f7 ff ff ff 	cmpl   $0xffffffff,-0x82c(%rbp)
    1258:	75 29                	jne    1283 <main+0x9a>
    125a:	48 8b 05 bf 2d 00 00 	mov    0x2dbf(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    1261:	48 8d 95 e1 f7 ff ff 	lea    -0x81f(%rbp),%rdx
    ...
    1277:	e8 64 fe ff ff       	callq  10e0 <fprintf@plt>
    127c:	b8 01 00 00 00       	mov    $0x1,%eax
    1281:	eb 73                	jmp    12f6 <main+0x10d>
    1283:	48 8d 8d f0 f7 ff ff 	lea    -0x810(%rbp),%rcx
    128a:	8b 85 d4 f7 ff ff    	mov    -0x82c(%rbp),%eax
    1290:	ba 00 08 00 00       	mov    $0x800,%edx
    1295:	48 89 ce             	mov    %rcx,%rsi
    1298:	89 c7                	mov    %eax,%edi
    129a:	e8 31 fe ff ff       	callq  10d0 <read@plt>
    129f:	48 89 85 d8 f7 ff ff 	mov    %rax,-0x828(%rbp)
    12a6:	c7 85 d0 f7 ff ff 00 	movl   $0x0,-0x830(%rbp)
    12ad:	00 00 00 
    12b0:	eb 21                	jmp    12d3 <main+0xea>
    12b2:	8b 85 d0 f7 ff ff    	mov    -0x830(%rbp),%eax
    12b8:	48 98                	cltq   
    12ba:	0f b6 84 05 f0 f7 ff 	movzbl -0x810(%rbp,%rax,1),%eax
    12c1:	ff 
    12c2:	0f be c0             	movsbl %al,%eax
    12c5:	89 c7                	mov    %eax,%edi
    12c7:	e8 d4 fd ff ff       	callq  10a0 <putchar@plt>
    12cc:	83 85 d0 f7 ff ff 01 	addl   $0x1,-0x830(%rbp)
    12d3:	8b 85 d0 f7 ff ff    	mov    -0x830(%rbp),%eax
    12d9:	48 98                	cltq   
    12db:	48 39 85 d8 f7 ff ff 	cmp    %rax,-0x828(%rbp)
    12e2:	77 ce                	ja     12b2 <main+0xc9>
    12e4:	8b 85 d4 f7 ff ff    	mov    -0x82c(%rbp),%eax
    12ea:	89 c7                	mov    %eax,%edi
    12ec:	e8 cf fd ff ff       	callq  10c0 <close@plt>
    12f1:	b8 00 00 00 00       	mov    $0x0,%eax
    12f6:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    12fa:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1301:	00 00 
    1303:	74 05                	je     130a <main+0x121>
