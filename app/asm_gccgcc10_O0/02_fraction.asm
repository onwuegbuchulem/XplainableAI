...
/app/bin_gccgcc10_O0/02_fraction:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1167:	f3 0f 2a 45 f8       	cvtsi2ssl -0x8(%rbp),%xmm0
    116c:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1170:	f3 0f 2a 4d fc       	cvtsi2ssl -0x4(%rbp),%xmm1
    1175:	f3 0f 5e c1          	divss  %xmm1,%xmm0
    1179:	66 0f ef d2          	pxor   %xmm2,%xmm2
    117d:	f3 0f 5a d0          	cvtss2sd %xmm0,%xmm2
    1181:	66 48 0f 7e d1       	movq   %xmm2,%rcx
    1186:	8b 55 fc             	mov    -0x4(%rbp),%edx
    1189:	8b 45 f8             	mov    -0x8(%rbp),%eax
    118c:	66 48 0f 6e c1       	movq   %rcx,%xmm0
