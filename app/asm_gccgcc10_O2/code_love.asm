...
/app/bin_gccgcc10_O2/code_love:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10cc:	c7 44 24 30 00 00 00 	movl   $0x0,0x30(%rsp)
    10d3:	00 
    10d4:	0f 11 04 24          	movups %xmm0,(%rsp)
    10d8:	66 0f 6f 05 40 0f 00 	movdqa 0xf40(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10df:	00 
    10e0:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10e5:	66 0f 6f 05 43 0f 00 	movdqa 0xf43(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    10ec:	00 
    10ed:	0f 11 44 24 20       	movups %xmm0,0x20(%rsp)
    10f2:	e8 99 ff ff ff       	callq  1090 <setlocale@plt>
    10f7:	48 8b 35 12 2f 00 00 	mov    0x2f12(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10fe:	48 89 e7             	mov    %rsp,%rdi
    1101:	c7 44 24 08 65 26 00 	movl   $0x2665,0x8(%rsp)
    1108:	00 
    1109:	e8 72 ff ff ff       	callq  1080 <fputws@plt>
    110e:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1113:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    111a:	00 00 
    111c:	75 07                	jne    1125 <main+0x85>
    111e:	31 c0                	xor    %eax,%eax
    1120:	48 83 c4 48          	add    $0x48,%rsp
    1124:	c3                   	retq   
    1125:	e8 46 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
