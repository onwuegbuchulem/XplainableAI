...
/app/bin_gccgcc10_O0/03_data_types:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    115c:	f3 0f 10 05 e4 0e 00 	movss  0xee4(%rip),%xmm0        # 2048 <_IO_stdin_used+0x48>
    1163:	00 
    1164:	f3 0f 11 45 fc       	movss  %xmm0,-0x4(%rbp)
    1169:	c6 45 f7 61          	movb   $0x61,-0x9(%rbp)
    ...
    117e:	e8 cd fe ff ff       	callq  1050 <printf@plt>
    1183:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1187:	f3 0f 5a 4d fc       	cvtss2sd -0x4(%rbp),%xmm1
    118c:	66 48 0f 7e c8       	movq   %xmm1,%rax
    1191:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1196:	48 8d 3d 7d 0e 00 00 	lea    0xe7d(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    119d:	b8 01 00 00 00       	mov    $0x1,%eax
    11a2:	e8 a9 fe ff ff       	callq  1050 <printf@plt>
    11a7:	0f be 45 f7          	movsbl -0x9(%rbp),%eax
    11ab:	89 c6                	mov    %eax,%esi
    11ad:	48 8d 3d 7c 0e 00 00 	lea    0xe7c(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
