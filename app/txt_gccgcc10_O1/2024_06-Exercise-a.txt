...
/app/bin_gccgcc10_O1/2024_06-Exercise-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ba:	48 8d 3d 56 0e 00 00 	lea    0xe56(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    11c1:	b8 00 00 00 00       	mov    $0x0,%eax
    11c6:	e8 c5 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cb:	8b 14 24             	mov    (%rsp),%edx
    11ce:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    11d2:	44 8d 04 0a          	lea    (%rdx,%rcx,1),%r8d
    11d6:	48 8d 35 40 0e 00 00 	lea    0xe40(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    11dd:	bf 01 00 00 00       	mov    $0x1,%edi
    11e2:	b8 00 00 00 00       	mov    $0x0,%eax
    11e7:	e8 94 fe ff ff       	callq  1080 <__printf_chk@plt>
    11ec:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11f1:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f8:	00 00 
    11fa:	75 0a                	jne    1206 <main+0x7d>
