...
/app/bin_gccgcc10_O0/04_problem4:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	f3 0f 10 05 cf 0e 00 	movss  0xecf(%rip),%xmm0        # 202c <_IO_stdin_used+0x2c>
    115c:	00 
    115d:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    1162:	c7 45 f8 08 00 00 00 	movl   $0x8,-0x8(%rbp)
    1169:	c7 45 fc 05 00 00 00 	movl   $0x5,-0x4(%rbp)
    1170:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1174:	f3 0f 2a 45 f8       	cvtsi2ssl -0x8(%rbp),%xmm0
    1179:	0f 28 c8             	movaps %xmm0,%xmm1
    117c:	f3 0f 59 4d f4       	mulss  -0xc(%rbp),%xmm1
    1181:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1185:	f3 0f 2a 45 fc       	cvtsi2ssl -0x4(%rbp),%xmm0
    118a:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    118e:	f3 0f 10 0d 9a 0e 00 	movss  0xe9a(%rip),%xmm1        # 2030 <_IO_stdin_used+0x30>
    1195:	00 
    1196:	f3 0f 5e c1          	divss  %xmm1,%xmm0
    119a:	66 0f ef d2          	pxor   %xmm2,%xmm2
    119e:	f3 0f 5a d0          	cvtss2sd %xmm0,%xmm2
    11a2:	66 48 0f 7e d0       	movq   %xmm2,%rax
    11a7:	66 48 0f 6e c0       	movq   %rax,%xmm0
    11ac:	48 8d 3d 55 0e 00 00 	lea    0xe55(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11b3:	b8 01 00 00 00       	mov    $0x1,%eax
