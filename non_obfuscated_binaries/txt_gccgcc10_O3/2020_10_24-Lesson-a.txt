...
/app/bin_gccgcc10_O3/2020_10_24-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 55                	push   %r13
    1086:	ba 02 00 00 00       	mov    $0x2,%edx
    108b:	48 8d 35 72 0f 00 00 	lea    0xf72(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1092:	31 c0                	xor    %eax,%eax
    1094:	41 54                	push   %r12
    1096:	bf 01 00 00 00       	mov    $0x1,%edi
    109b:	41 bc 02 00 00 00    	mov    $0x2,%r12d
    10a1:	4c 8d 2d 60 0f 00 00 	lea    0xf60(%rip),%r13        # 2008 <_IO_stdin_used+0x8>
    10a8:	55                   	push   %rbp
    10a9:	53                   	push   %rbx
    10aa:	48 83 ec 08          	sub    $0x8,%rsp
    10ae:	e8 bd ff ff ff       	callq  1070 <__printf_chk@plt>
    10b3:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10b8:	48 8b 35 51 2f 00 00 	mov    0x2f51(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10bf:	44 89 e5             	mov    %r12d,%ebp
    10c2:	bf 0a 00 00 00       	mov    $0xa,%edi
    10c7:	41 83 c4 01          	add    $0x1,%r12d
    10cb:	e8 90 ff ff ff       	callq  1060 <putc@plt>
    10d0:	41 83 fc 64          	cmp    $0x64,%r12d
    10d4:	74 48                	je     111e <main+0x9e>
    10d6:	44 89 e2             	mov    %r12d,%edx
    10d9:	bf 01 00 00 00       	mov    $0x1,%edi
    10de:	31 c0                	xor    %eax,%eax
    10e0:	bb 02 00 00 00       	mov    $0x2,%ebx
    10e5:	48 8d 35 18 0f 00 00 	lea    0xf18(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10ec:	e8 7f ff ff ff       	callq  1070 <__printf_chk@plt>
    10f1:	eb 0e                	jmp    1101 <main+0x81>
    10f3:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10f8:	8d 43 01             	lea    0x1(%rbx),%eax
    10fb:	39 dd                	cmp    %ebx,%ebp
    10fd:	74 b9                	je     10b8 <main+0x38>
    10ff:	89 c3                	mov    %eax,%ebx
    1101:	44 89 e0             	mov    %r12d,%eax
    1104:	99                   	cltd   
    1105:	f7 fb                	idiv   %ebx
    1107:	85 d2                	test   %edx,%edx
    1109:	75 ed                	jne    10f8 <main+0x78>
    110b:	89 da                	mov    %ebx,%edx
    110d:	4c 89 ee             	mov    %r13,%rsi
    1110:	bf 01 00 00 00       	mov    $0x1,%edi
    1115:	31 c0                	xor    %eax,%eax
    1117:	e8 54 ff ff ff       	callq  1070 <__printf_chk@plt>
    111c:	eb da                	jmp    10f8 <main+0x78>
