...
/app/bin_gccgcc10_O3/DiceRoll:     file format elf64-x86-64
...
0000000000001120 <main>:
    ...
    1124:	48 83 ec 18          	sub    $0x18,%rsp
    1128:	48 8d 3d d9 0e 00 00 	lea    0xed9(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    112f:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1136:	00 00 
    1138:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    113d:	31 c0                	xor    %eax,%eax
    113f:	e8 6c ff ff ff       	callq  10b0 <puts@plt>
    1144:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    1149:	48 8d 3d e1 0e 00 00 	lea    0xee1(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    1150:	31 c0                	xor    %eax,%eax
    1152:	e8 a9 ff ff ff       	callq  1100 <__isoc99_scanf@plt>
    1157:	8b 7c 24 04          	mov    0x4(%rsp),%edi
    115b:	e8 30 01 00 00       	callq  1290 <Diceroll>
    1160:	48 8d 35 cd 0e 00 00 	lea    0xecd(%rip),%rsi        # 2034 <_IO_stdin_used+0x34>
    ...
    1175:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    117a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1181:	00 00 
    1183:	75 07                	jne    118c <main+0x6c>
    1185:	31 c0                	xor    %eax,%eax
    1187:	48 83 c4 18          	add    $0x18,%rsp
    118b:	c3                   	retq   
    118c:	e8 2f ff ff ff       	callq  10c0 <__stack_chk_fail@plt>
...
00000000000011a0 <_start>:
    ...
    11c1:	48 8d 3d 58 ff ff ff 	lea    -0xa8(%rip),%rdi        # 1120 <main>
...
0000000000001240 <__do_global_dtors_aux>:
    ...
    1262:	e8 39 fe ff ff       	callq  10a0 <__cxa_finalize@plt>
...
0000000000001290 <Diceroll>:
    1290:	f3 0f 1e fa          	endbr64 
    1294:	53                   	push   %rbx
    1295:	89 fb                	mov    %edi,%ebx
    1297:	31 ff                	xor    %edi,%edi
    1299:	e8 42 fe ff ff       	callq  10e0 <time@plt>
    129e:	48 89 c7             	mov    %rax,%rdi
    12a1:	e8 2a fe ff ff       	callq  10d0 <srand@plt>
    12a6:	e8 65 fe ff ff       	callq  1110 <rand@plt>
    12ab:	99                   	cltd   
    12ac:	f7 fb                	idiv   %ebx
    12ae:	5b                   	pop    %rbx
    12af:	8d 42 01             	lea    0x1(%rdx),%eax
    12b2:	c3                   	retq   
