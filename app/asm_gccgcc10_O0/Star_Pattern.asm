...
/app/bin_gccgcc10_O0/Star_Pattern:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d5:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    ...
    11ed:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%rbp)
    11f4:	eb 34                	jmp    122a <main+0x81>
    11f6:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    11fd:	eb 15                	jmp    1214 <main+0x6b>
    11ff:	48 8d 3d 19 0e 00 00 	lea    0xe19(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    1206:	b8 00 00 00 00       	mov    $0x0,%eax
    120b:	e8 90 fe ff ff       	callq  10a0 <printf@plt>
    1210:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    1214:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1217:	3b 45 f0             	cmp    -0x10(%rbp),%eax
    121a:	7e e3                	jle    11ff <main+0x56>
    121c:	bf 0a 00 00 00       	mov    $0xa,%edi
    1221:	e8 5a fe ff ff       	callq  1080 <putchar@plt>
    1226:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    122a:	8b 45 ec             	mov    -0x14(%rbp),%eax
    122d:	39 45 f0             	cmp    %eax,-0x10(%rbp)
    1230:	7e c4                	jle    11f6 <main+0x4d>
    1232:	b8 00 00 00 00       	mov    $0x0,%eax
    1237:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    123b:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1242:	00 00 
    1244:	74 05                	je     124b <main+0xa2>
    1246:	e8 45 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    124b:	c9                   	leaveq 
    124c:	c3                   	retq   
