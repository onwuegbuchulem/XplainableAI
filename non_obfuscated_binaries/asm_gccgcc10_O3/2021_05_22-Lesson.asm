...
/app/bin_gccgcc10_O3/2021_05_22-Lesson:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c8:	bf 0c 00 00 00       	mov    $0xc,%edi
    10cd:	e8 ae ff ff ff       	callq  1080 <malloc@plt>
    10d2:	48 85 c0             	test   %rax,%rax
    10d5:	74 2a                	je     1101 <main+0x41>
    10d7:	41 b8 03 00 00 00    	mov    $0x3,%r8d
    10dd:	b9 02 00 00 00       	mov    $0x2,%ecx
    10e2:	31 c0                	xor    %eax,%eax
    10e4:	ba 01 00 00 00       	mov    $0x1,%edx
    ...
    1100:	c3                   	retq   
    1101:	48 8b 0d 18 2f 00 00 	mov    0x2f18(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1108:	ba 18 00 00 00       	mov    $0x18,%edx
    110d:	be 01 00 00 00       	mov    $0x1,%esi
    1112:	48 8d 3d f5 0e 00 00 	lea    0xef5(%rip),%rdi        # 200e <_IO_stdin_used+0xe>
    1119:	e8 92 ff ff ff       	callq  10b0 <fwrite@plt>
    111e:	bf 01 00 00 00       	mov    $0x1,%edi
    1123:	e8 78 ff ff ff       	callq  10a0 <exit@plt>
