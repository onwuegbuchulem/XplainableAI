...
/app/bin_gccgcc10_O1/2023_09_01-Lesson:     file format elf64-x86-64
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d c6 00 00 00 	lea    0xc6(%rip),%rdi        # 11ae <main>
...
00000000000011ae <main>:
    ...
    11b2:	53                   	push   %rbx
    11b3:	48 83 ec 60          	sub    $0x60,%rsp
    11b7:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11be:	00 00 
    11c0:	48 89 44 24 58       	mov    %rax,0x58(%rsp)
    ...
    11d8:	48 8d 5c 24 10       	lea    0x10(%rsp),%rbx
    11dd:	48 8b 15 2c 2e 00 00 	mov    0x2e2c(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    11e4:	be 40 00 00 00       	mov    $0x40,%esi
    11e9:	48 89 df             	mov    %rbx,%rdi
    11ec:	e8 9f fe ff ff       	callq  1090 <fgets@plt>
    11f1:	48 8d 35 1d 0e 00 00 	lea    0xe1d(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    11f8:	bf 01 00 00 00       	mov    $0x1,%edi
    11fd:	b8 00 00 00 00       	mov    $0x0,%eax
    1202:	e8 99 fe ff ff       	callq  10a0 <__printf_chk@plt>
    1207:	48 8d 74 24 0f       	lea    0xf(%rsp),%rsi
    120c:	48 8d 3d 1e 0e 00 00 	lea    0xe1e(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    1213:	b8 00 00 00 00       	mov    $0x0,%eax
    1218:	e8 93 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    121d:	0f be 4c 24 0f       	movsbl 0xf(%rsp),%ecx
    1222:	49 89 d8             	mov    %rbx,%r8
    1225:	ba 00 00 00 00       	mov    $0x0,%edx
    122a:	48 8d 35 07 0e 00 00 	lea    0xe07(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    1231:	bf 01 00 00 00       	mov    $0x1,%edi
    1236:	b8 00 00 00 00       	mov    $0x0,%eax
    123b:	e8 60 fe ff ff       	callq  10a0 <__printf_chk@plt>
    1240:	48 8b 44 24 58       	mov    0x58(%rsp),%rax
    1245:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    124c:	00 00 
    124e:	75 0b                	jne    125b <main+0xad>
    1250:	b8 00 00 00 00       	mov    $0x0,%eax
    1255:	48 83 c4 60          	add    $0x60,%rsp
    1259:	5b                   	pop    %rbx
    125a:	c3                   	retq   
    125b:	e8 20 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
