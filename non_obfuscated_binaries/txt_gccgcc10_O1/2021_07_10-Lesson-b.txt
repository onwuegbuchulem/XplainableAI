...
/app/bin_gccgcc10_O1/2021_07_10-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1193:	eb 25                	jmp    11ba <main+0x51>
    1195:	48 63 05 84 2e 00 00 	movslq 0x2e84(%rip),%rax        # 4020 <optind@@GLIBC_2.2.5>
    119c:	48 8b 54 c5 f8       	mov    -0x8(%rbp,%rax,8),%rdx
    ...
    11b2:	e8 a9 fe ff ff       	callq  1060 <__printf_chk@plt>
    11b7:	83 c3 01             	add    $0x1,%ebx
    11ba:	4c 89 ea             	mov    %r13,%rdx
    11bd:	48 89 ee             	mov    %rbp,%rsi
    11c0:	44 89 e7             	mov    %r12d,%edi
    11c3:	e8 a8 fe ff ff       	callq  1070 <getopt@plt>
    11c8:	83 f8 ff             	cmp    $0xffffffff,%eax
    11cb:	74 1f                	je     11ec <main+0x83>
    11cd:	83 f8 3f             	cmp    $0x3f,%eax
    11d0:	74 c3                	je     1195 <main+0x2c>
    11d2:	89 c2                	mov    %eax,%edx
    11d4:	48 8d 35 4c 0e 00 00 	lea    0xe4c(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    11db:	bf 01 00 00 00       	mov    $0x1,%edi
    11e0:	b8 00 00 00 00       	mov    $0x0,%eax
    11e5:	e8 76 fe ff ff       	callq  1060 <__printf_chk@plt>
    11ea:	eb cb                	jmp    11b7 <main+0x4e>
    11ec:	89 da                	mov    %ebx,%edx
    11ee:	48 8d 35 49 0e 00 00 	lea    0xe49(%rip),%rsi        # 203e <_IO_stdin_used+0x3e>
    11f5:	bf 01 00 00 00       	mov    $0x1,%edi
    11fa:	b8 00 00 00 00       	mov    $0x0,%eax
    11ff:	e8 5c fe ff ff       	callq  1060 <__printf_chk@plt>
