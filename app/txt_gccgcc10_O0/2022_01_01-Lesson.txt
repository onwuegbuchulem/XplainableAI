...
/app/bin_gccgcc10_O0/2022_01_01-Lesson:     file format elf64-x86-64
...
0000000000001318 <main>:
    ...
    13eb:	c7 45 ac 00 00 00 00 	movl   $0x0,-0x54(%rbp)
    ...
    1410:	8b 45 ac             	mov    -0x54(%rbp),%eax
    ...
    1422:	83 45 ac 01          	addl   $0x1,-0x54(%rbp)
    1426:	8b 45 ac             	mov    -0x54(%rbp),%eax
    1429:	25 ff 1f 00 00       	and    $0x1fff,%eax
    142e:	85 c0                	test   %eax,%eax
    1430:	75 4f                	jne    1481 <main+0x169>
    1432:	8b 45 ac             	mov    -0x54(%rbp),%eax
    ...
    1497:	90                   	nop
    1498:	8b 45 ac             	mov    -0x54(%rbp),%eax
    ...
    14fa:	c7 45 b0 00 00 00 00 	movl   $0x0,-0x50(%rbp)
    ...
    151d:	8b 45 b0             	mov    -0x50(%rbp),%eax
    1520:	48 98                	cltq   
    ...
    15bf:	8b 45 b0             	mov    -0x50(%rbp),%eax
    ...
    15dd:	c7 45 b4 00 00 00 00 	movl   $0x0,-0x4c(%rbp)
    15e4:	eb 37                	jmp    161d <main+0x305>
    15e6:	8b 45 b4             	mov    -0x4c(%rbp),%eax
    15e9:	48 98                	cltq   
    15eb:	48 8d 14 c5 00 00 00 	lea    0x0(,%rax,8),%rdx
    15f2:	00 
    15f3:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
    15f7:	48 01 d0             	add    %rdx,%rax
    15fa:	48 8b 00             	mov    (%rax),%rax
    15fd:	8b 55 b4             	mov    -0x4c(%rbp),%edx
    1600:	8d 4a 01             	lea    0x1(%rdx),%ecx
    1603:	48 89 c2             	mov    %rax,%rdx
    1606:	89 ce                	mov    %ecx,%esi
    1608:	48 8d 3d 5b 0a 00 00 	lea    0xa5b(%rip),%rdi        # 206a <_IO_stdin_used+0x6a>
    160f:	b8 00 00 00 00       	mov    $0x0,%eax
    1614:	e8 47 fb ff ff       	callq  1160 <printf@plt>
    1619:	83 45 b4 01          	addl   $0x1,-0x4c(%rbp)
    161d:	8b 45 b4             	mov    -0x4c(%rbp),%eax
    1620:	3b 45 b0             	cmp    -0x50(%rbp),%eax
    1623:	7c c1                	jl     15e6 <main+0x2ce>
    1625:	b8 00 00 00 00       	mov    $0x0,%eax
    162a:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    162e:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1635:	00 00 
    1637:	74 05                	je     163e <main+0x326>
    1639:	e8 12 fb ff ff       	callq  1150 <__stack_chk_fail@plt>
    163e:	c9                   	leaveq 
    163f:	c3                   	retq   
