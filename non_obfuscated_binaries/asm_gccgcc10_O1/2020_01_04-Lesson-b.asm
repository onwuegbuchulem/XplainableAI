...
/app/bin_gccgcc10_O1/2020_01_04-Lesson-b:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c2:	48 8d 5c 24 0c       	lea    0xc(%rsp),%rbx
    11c7:	41 b9 0d 00 00 00    	mov    $0xd,%r9d
    11cd:	4c 8d 05 30 0e 00 00 	lea    0xe30(%rip),%r8        # 2004 <_IO_stdin_used+0x4>
    11d4:	b9 0c 00 00 00       	mov    $0xc,%ecx
    11d9:	ba 01 00 00 00       	mov    $0x1,%edx
    11de:	be 0c 00 00 00       	mov    $0xc,%esi
    11e3:	48 89 df             	mov    %rbx,%rdi
    11e6:	e8 95 fe ff ff       	callq  1080 <__snprintf_chk@plt>
    11eb:	48 89 df             	mov    %rbx,%rdi
    11ee:	e8 9d fe ff ff       	callq  1090 <puts@plt>
    11f3:	ba 10 00 00 00       	mov    $0x10,%edx
    11f8:	48 8d 35 16 0e 00 00 	lea    0xe16(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    ...
    121a:	00 00 
    121c:	75 0b                	jne    1229 <main+0x80>
    121e:	b8 00 00 00 00       	mov    $0x0,%eax
    1223:	48 83 c4 20          	add    $0x20,%rsp
    1227:	5b                   	pop    %rbx
    1228:	c3                   	retq   
    1229:	e8 72 fe ff ff       	callq  10a0 <__stack_chk_fail@plt>
