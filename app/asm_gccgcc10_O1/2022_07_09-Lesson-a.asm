...
/app/bin_gccgcc10_O1/2022_07_09-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a1:	48 c7 44 24 08 00 00 	movq   $0x0,0x8(%rsp)
    11a8:	00 00 
    11aa:	48 c7 44 24 10 20 00 	movq   $0x20,0x10(%rsp)
    11b1:	00 00 
    ...
    11c4:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    11c9:	48 8d 7c 24 08       	lea    0x8(%rsp),%rdi
    11ce:	48 8b 15 3b 2e 00 00 	mov    0x2e3b(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    11d5:	e8 b6 fe ff ff       	callq  1090 <getline@plt>
    ...
    11f3:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    11f8:	48 8d 35 31 0e 00 00 	lea    0xe31(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    ...
    121a:	00 00 
    121c:	75 0a                	jne    1228 <main+0x9f>
    121e:	b8 00 00 00 00       	mov    $0x0,%eax
    1223:	48 83 c4 28          	add    $0x28,%rsp
    1227:	c3                   	retq   
