...
/app/bin_gccgcc10_O1/GoTo_Program:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1173:	bb 0a 00 00 00       	mov    $0xa,%ebx
    1178:	48 8d 2d 85 0e 00 00 	lea    0xe85(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    117f:	48 89 ef             	mov    %rbp,%rdi
    1182:	e8 d9 fe ff ff       	callq  1060 <puts@plt>
    1187:	83 eb 01             	sub    $0x1,%ebx
    118a:	75 f3                	jne    117f <main+0x16>
    118c:	bb 01 00 00 00       	mov    $0x1,%ebx
    1191:	48 8d 2d 7a 0e 00 00 	lea    0xe7a(%rip),%rbp        # 2012 <_IO_stdin_used+0x12>
    1198:	89 da                	mov    %ebx,%edx
    119a:	48 89 ee             	mov    %rbp,%rsi
    119d:	bf 01 00 00 00       	mov    $0x1,%edi
    11a2:	b8 00 00 00 00       	mov    $0x0,%eax
    11a7:	e8 c4 fe ff ff       	callq  1070 <__printf_chk@plt>
    11ac:	83 c3 01             	add    $0x1,%ebx
    11af:	83 fb 0b             	cmp    $0xb,%ebx
    11b2:	75 e4                	jne    1198 <main+0x2f>
