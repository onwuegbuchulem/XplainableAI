...
/app/bin_gccgcc10_O1/strcat:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d d3 00 00 00 	lea    0xd3(%rip),%rdi        # 119b <main>
...
0000000000001189 <strappend>:
    ...
    1191:	e8 fa fe ff ff       	callq  1090 <strcat@plt>
    1196:	48 83 c4 08          	add    $0x8,%rsp
    119a:	c3                   	retq   

000000000000119b <main>:
    119b:	f3 0f 1e fa          	endbr64 
    119f:	48 83 ec 48          	sub    $0x48,%rsp
    11a3:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11aa:	00 00 
    11ac:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    11b1:	31 c0                	xor    %eax,%eax
    11b3:	48 b8 54 68 69 73 20 	movabs $0x2073692073696854,%rax
    11ba:	69 73 20 
    11bd:	48 ba 61 6e 6f 74 68 	movabs $0x20726568746f6e61,%rdx
    11c4:	65 72 20 
    11c7:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11cc:	48 89 54 24 18       	mov    %rdx,0x18(%rsp)
    11d1:	48 c7 44 24 20 00 00 	movq   $0x0,0x20(%rsp)
    11d8:	00 00 
    11da:	48 c7 44 24 28 00 00 	movq   $0x0,0x28(%rsp)
    11e1:	00 00 
    11e3:	48 b8 66 69 6e 65 20 	movabs $0x73656d20656e6966,%rax
    11ea:	6d 65 73 
    11ed:	48 89 44 24 05       	mov    %rax,0x5(%rsp)
    11f2:	66 c7 44 24 0d 73 21 	movw   $0x2173,0xd(%rsp)
    11f9:	c6 44 24 0f 00       	movb   $0x0,0xf(%rsp)
    11fe:	48 8d 74 24 05       	lea    0x5(%rsp),%rsi
    1203:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
    1208:	e8 7c ff ff ff       	callq  1189 <strappend>
    120d:	48 89 c7             	mov    %rax,%rdi
    1210:	e8 5b fe ff ff       	callq  1070 <puts@plt>
    1215:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    121a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1221:	00 00 
    1223:	75 0a                	jne    122f <main+0x94>
    1225:	b8 00 00 00 00       	mov    $0x0,%eax
    122a:	48 83 c4 48          	add    $0x48,%rsp
    122e:	c3                   	retq   
    122f:	e8 4c fe ff ff       	callq  1080 <__stack_chk_fail@plt>
