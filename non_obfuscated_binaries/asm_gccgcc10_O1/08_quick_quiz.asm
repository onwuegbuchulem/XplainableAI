...
/app/bin_gccgcc10_O1/08_quick_quiz:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a3:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11a8:	48 8d 3d 55 0e 00 00 	lea    0xe55(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11af:	e8 dc fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11b4:	bb 01 00 00 00       	mov    $0x1,%ebx
    11b9:	48 8d 2d 47 0e 00 00 	lea    0xe47(%rip),%rbp        # 2007 <_IO_stdin_used+0x7>
    11c0:	89 da                	mov    %ebx,%edx
    11c2:	48 89 ee             	mov    %rbp,%rsi
    ...
    11d7:	39 5c 24 04          	cmp    %ebx,0x4(%rsp)
    11db:	7d e3                	jge    11c0 <main+0x37>
    11dd:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11e2:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11e9:	00 00 
    11eb:	75 0c                	jne    11f9 <main+0x70>
    11ed:	b8 00 00 00 00       	mov    $0x0,%eax
    11f2:	48 83 c4 18          	add    $0x18,%rsp
    11f6:	5b                   	pop    %rbx
    11f7:	5d                   	pop    %rbp
    11f8:	c3                   	retq   
