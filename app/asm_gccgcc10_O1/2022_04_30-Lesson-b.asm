...
/app/bin_gccgcc10_O1/2022_04_30-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    11b5:	ba 0a 00 00 00       	mov    $0xa,%edx
    ...
    11d7:	00 00 
    11d9:	75 0a                	jne    11e5 <main+0x7c>
    11db:	b8 00 00 00 00       	mov    $0x0,%eax
    11e0:	48 83 c4 28          	add    $0x28,%rsp
    11e4:	c3                   	retq   
    11e5:	e8 76 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
