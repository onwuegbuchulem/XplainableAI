...
/app/bin_gccgcc10_O0/2022_02_12-Lesson:     file format elf64-x86-64
...
00000000000010d0 <execl@plt>:
    10d0:	f3 0f 1e fa          	endbr64 
    10d4:	f2 ff 25 e5 2e 00 00 	bnd jmpq *0x2ee5(%rip)        # 3fc0 <execl@GLIBC_2.2.5>
    10db:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010e0 <wait@plt>:
    10e0:	f3 0f 1e fa          	endbr64 
    10e4:	f2 ff 25 dd 2e 00 00 	bnd jmpq *0x2edd(%rip)        # 3fc8 <wait@GLIBC_2.2.5>
...
0000000000001100 <_start>:
    ...
    1111:	50                   	push   %rax
    1112:	54                   	push   %rsp
    1113:	4c 8d 05 e6 01 00 00 	lea    0x1e6(%rip),%r8        # 1300 <__libc_csu_fini>
    111a:	48 8d 0d 6f 01 00 00 	lea    0x16f(%rip),%rcx        # 1290 <__libc_csu_init>
...
00000000000011e9 <main>:
    ...
    1204:	e8 e7 fe ff ff       	callq  10f0 <fork@plt>
    1209:	89 45 f4             	mov    %eax,-0xc(%rbp)
    120c:	83 7d f4 00          	cmpl   $0x0,-0xc(%rbp)
    1210:	75 18                	jne    122a <main+0x41>
    1212:	be 00 00 00 00       	mov    $0x0,%esi
    1217:	48 8d 3d ea 0d 00 00 	lea    0xdea(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    121e:	b8 00 00 00 00       	mov    $0x0,%eax
    1223:	e8 a8 fe ff ff       	callq  10d0 <execl@plt>
    1228:	eb 40                	jmp    126a <main+0x81>
    122a:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    122e:	48 89 c7             	mov    %rax,%rdi
    1231:	e8 aa fe ff ff       	callq  10e0 <wait@plt>
    1236:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1239:	83 e0 7f             	and    $0x7f,%eax
    123c:	85 c0                	test   %eax,%eax
    123e:	75 1e                	jne    125e <main+0x75>
    1240:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1243:	c1 f8 08             	sar    $0x8,%eax
    1246:	0f b6 c0             	movzbl %al,%eax
    1249:	89 c6                	mov    %eax,%esi
    124b:	48 8d 3d be 0d 00 00 	lea    0xdbe(%rip),%rdi        # 2010 <_IO_stdin_used+0x10>
    1252:	b8 00 00 00 00       	mov    $0x0,%eax
    1257:	e8 64 fe ff ff       	callq  10c0 <printf@plt>
    125c:	eb 0c                	jmp    126a <main+0x81>
    125e:	48 8d 3d cb 0d 00 00 	lea    0xdcb(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    1265:	e8 36 fe ff ff       	callq  10a0 <puts@plt>
    126a:	b8 00 00 00 00       	mov    $0x0,%eax
    126f:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1273:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    127a:	00 00 
    127c:	74 05                	je     1283 <main+0x9a>
    127e:	e8 2d fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
    1283:	c9                   	leaveq 
    1284:	c3                   	retq   
...
0000000000001290 <__libc_csu_init>:
    ...
    1294:	41 57                	push   %r15
    1296:	4c 8d 3d f3 2a 00 00 	lea    0x2af3(%rip),%r15        # 3d90 <__frame_dummy_init_array_entry>
    129d:	41 56                	push   %r14
    ...
    12ac:	55                   	push   %rbp
    12ad:	48 8d 2d e4 2a 00 00 	lea    0x2ae4(%rip),%rbp        # 3d98 <__do_global_dtors_aux_fini_array_entry>
    12b4:	53                   	push   %rbx
