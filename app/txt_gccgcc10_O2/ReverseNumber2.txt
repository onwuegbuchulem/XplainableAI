...
/app/bin_gccgcc10_O2/ReverseNumber2:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10fb:	45 31 c0             	xor    %r8d,%r8d
    10fe:	85 d2                	test   %edx,%edx
    1100:	74 38                	je     113a <main+0x7a>
    1102:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1108:	48 63 c2             	movslq %edx,%rax
    110b:	89 d1                	mov    %edx,%ecx
    110d:	43 8d 34 80          	lea    (%r8,%r8,4),%esi
    1111:	48 69 c0 67 66 66 66 	imul   $0x66666667,%rax,%rax
    1118:	c1 f9 1f             	sar    $0x1f,%ecx
    111b:	48 c1 f8 22          	sar    $0x22,%rax
    111f:	29 c8                	sub    %ecx,%eax
    1121:	8d 0c 80             	lea    (%rax,%rax,4),%ecx
    1124:	01 c9                	add    %ecx,%ecx
    1126:	29 ca                	sub    %ecx,%edx
    1128:	44 8d 04 72          	lea    (%rdx,%rsi,2),%r8d
    112c:	89 c2                	mov    %eax,%edx
    112e:	85 c0                	test   %eax,%eax
    1130:	75 d6                	jne    1108 <main+0x48>
    1132:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%rsp)
    1139:	00 
    113a:	31 c0                	xor    %eax,%eax
    113c:	44 89 c2             	mov    %r8d,%edx
    113f:	bf 01 00 00 00       	mov    $0x1,%edi
    1144:	48 8d 35 cd 0e 00 00 	lea    0xecd(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    114b:	e8 50 ff ff ff       	callq  10a0 <__printf_chk@plt>
    1150:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1155:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    115c:	00 00 
    115e:	75 07                	jne    1167 <main+0xa7>
