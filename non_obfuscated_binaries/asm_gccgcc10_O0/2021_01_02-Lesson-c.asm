...
/app/bin_gccgcc10_O0/2021_01_02-Lesson-c:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	48 b8 61 62 63 64 65 	movabs $0x67666564636261,%rax
    118b:	66 67 00 
    118e:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    1192:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%rbp)
    1199:	eb 10                	jmp    11ab <main+0x42>
    119b:	48 8d 3d 62 0e 00 00 	lea    0xe62(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11a2:	e8 b9 fe ff ff       	callq  1060 <puts@plt>
    11a7:	83 45 ec 01          	addl   $0x1,-0x14(%rbp)
    11ab:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11ae:	83 f8 07             	cmp    $0x7,%eax
    11b1:	76 e8                	jbe    119b <main+0x32>
    11b3:	b8 00 00 00 00       	mov    $0x0,%eax
    11b8:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11bc:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11c3:	00 00 
    11c5:	74 05                	je     11cc <main+0x63>
    11c7:	e8 a4 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    11cc:	c9                   	leaveq 
    11cd:	c3                   	retq   
