...
/app/bin_gccgcc10_O3/randomp01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c7:	bb 0a 00 00 00       	mov    $0xa,%ebx
    10cc:	e8 cf ff ff ff       	callq  10a0 <time@plt>
    10d1:	48 89 c7             	mov    %rax,%rdi
    10d4:	e8 a7 ff ff ff       	callq  1080 <srand@plt>
    10d9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    10e0:	e8 cb ff ff ff       	callq  10b0 <rand@plt>
    10e5:	48 8b 35 24 2f 00 00 	mov    0x2f24(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10ec:	89 c7                	mov    %eax,%edi
    10ee:	48 98                	cltq   
    10f0:	48 69 c0 5d 41 4c ae 	imul   $0xffffffffae4c415d,%rax,%rax
    10f7:	89 fa                	mov    %edi,%edx
    10f9:	c1 fa 1f             	sar    $0x1f,%edx
    10fc:	48 c1 e8 20          	shr    $0x20,%rax
    1100:	01 f8                	add    %edi,%eax
    1102:	c1 f8 06             	sar    $0x6,%eax
    1105:	29 d0                	sub    %edx,%eax
    1107:	6b c0 5e             	imul   $0x5e,%eax,%eax
    110a:	29 c7                	sub    %eax,%edi
    110c:	83 c7 21             	add    $0x21,%edi
    110f:	e8 7c ff ff ff       	callq  1090 <putc@plt>
    1114:	83 eb 01             	sub    $0x1,%ebx
    1117:	75 c7                	jne    10e0 <main+0x20>
    1119:	48 8b 35 f0 2e 00 00 	mov    0x2ef0(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1120:	bf 0a 00 00 00       	mov    $0xa,%edi
    1125:	e8 66 ff ff ff       	callq  1090 <putc@plt>
