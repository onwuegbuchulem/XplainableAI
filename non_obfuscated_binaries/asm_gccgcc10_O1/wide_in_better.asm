...
/app/bin_gccgcc10_O1/wide_in_better:     file format elf64-x86-64
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d e2 00 00 00 	lea    0xe2(%rip),%rdi        # 11ca <main>
...
00000000000011a9 <newline_strip>:
    ...
    11ad:	8b 07                	mov    (%rdi),%eax
    11af:	85 c0                	test   %eax,%eax
    11b1:	74 0f                	je     11c2 <newline_strip+0x19>
    11b3:	83 f8 0a             	cmp    $0xa,%eax
    11b6:	74 0b                	je     11c3 <newline_strip+0x1a>
    11b8:	48 83 c7 04          	add    $0x4,%rdi
    11bc:	8b 07                	mov    (%rdi),%eax
    11be:	85 c0                	test   %eax,%eax
    11c0:	75 f1                	jne    11b3 <newline_strip+0xa>
    11c2:	c3                   	retq   
    11c3:	c7 07 00 00 00 00    	movl   $0x0,(%rdi)
    11c9:	c3                   	retq   

00000000000011ca <main>:
    11ca:	f3 0f 1e fa          	endbr64 
    11ce:	53                   	push   %rbx
    11cf:	48 81 ec 90 00 00 00 	sub    $0x90,%rsp
    ...
    11f5:	e8 a6 fe ff ff       	callq  10a0 <setlocale@plt>
    11fa:	48 8d 35 0f 0e 00 00 	lea    0xe0f(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    1201:	bf 01 00 00 00       	mov    $0x1,%edi
    1206:	b8 00 00 00 00       	mov    $0x0,%eax
    120b:	e8 a0 fe ff ff       	callq  10b0 <__wprintf_chk@plt>
    1210:	48 89 e3             	mov    %rsp,%rbx
    1213:	48 8b 15 f6 2d 00 00 	mov    0x2df6(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    121a:	be 20 00 00 00       	mov    $0x20,%esi
    121f:	48 89 df             	mov    %rbx,%rdi
    1222:	e8 59 fe ff ff       	callq  1080 <fgetws@plt>
    1227:	48 89 df             	mov    %rbx,%rdi
    122a:	e8 7a ff ff ff       	callq  11a9 <newline_strip>
    122f:	48 89 da             	mov    %rbx,%rdx
    1232:	48 8d 35 37 0e 00 00 	lea    0xe37(%rip),%rsi        # 2070 <_IO_stdin_used+0x70>
    1239:	bf 01 00 00 00       	mov    $0x1,%edi
    123e:	b8 00 00 00 00       	mov    $0x0,%eax
    1243:	e8 68 fe ff ff       	callq  10b0 <__wprintf_chk@plt>
    1248:	48 8b 84 24 88 00 00 	mov    0x88(%rsp),%rax
    124f:	00 
    1250:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1257:	00 00 
    1259:	75 0e                	jne    1269 <main+0x9f>
    125b:	b8 00 00 00 00       	mov    $0x0,%eax
    1260:	48 81 c4 90 00 00 00 	add    $0x90,%rsp
    1267:	5b                   	pop    %rbx
    1268:	c3                   	retq   
