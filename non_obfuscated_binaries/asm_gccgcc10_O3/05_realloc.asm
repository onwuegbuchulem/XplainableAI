...
/app/bin_gccgcc10_O3/05_realloc:     file format elf64-x86-64
...
0000000000001070 <malloc@plt>:
    ...
    1074:	f2 ff 25 45 2f 00 00 	bnd jmpq *0x2f45(%rip)        # 3fc0 <malloc@GLIBC_2.2.5>
    107b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001080 <realloc@plt>:
    1080:	f3 0f 1e fa          	endbr64 
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <realloc@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10a4:	55                   	push   %rbp
    10a5:	bf 14 00 00 00       	mov    $0x14,%edi
    10aa:	e8 c1 ff ff ff       	callq  1070 <malloc@plt>
    10af:	ba 03 00 00 00       	mov    $0x3,%edx
    10b4:	bf 01 00 00 00       	mov    $0x1,%edi
    10b9:	48 8d 35 44 0f 00 00 	lea    0xf44(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10c0:	c7 00 03 00 00 00    	movl   $0x3,(%rax)
    10c6:	48 89 c5             	mov    %rax,%rbp
    10c9:	31 c0                	xor    %eax,%eax
    10cb:	e8 c0 ff ff ff       	callq  1090 <__printf_chk@plt>
    10d0:	48 89 ef             	mov    %rbp,%rdi
    10d3:	be 28 00 00 00       	mov    $0x28,%esi
    10d8:	e8 a3 ff ff ff       	callq  1080 <realloc@plt>
    10dd:	48 8d 35 20 0f 00 00 	lea    0xf20(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10e4:	bf 01 00 00 00       	mov    $0x1,%edi
    10e9:	8b 10                	mov    (%rax),%edx
    10eb:	31 c0                	xor    %eax,%eax
    10ed:	e8 9e ff ff ff       	callq  1090 <__printf_chk@plt>
