...
/app/bin_gccgcc10_O1/2021_11_13-Lesson:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	ba 04 00 00 00       	mov    $0x4,%edx
    ...
    1171:	48 8d 35 a1 0e 00 00 	lea    0xea1(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    1178:	bf 01 00 00 00       	mov    $0x1,%edi
    117d:	b8 00 00 00 00       	mov    $0x0,%eax
    1182:	e8 c9 fe ff ff       	callq  1050 <__printf_chk@plt>
    1187:	ba 0f 00 00 00       	mov    $0xf,%edx
    118c:	48 8d 35 94 0e 00 00 	lea    0xe94(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
