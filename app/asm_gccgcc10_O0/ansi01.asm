...
/app/bin_gccgcc10_O0/ansi01:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	48 8d 15 ac 0e 00 00 	lea    0xeac(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    1158:	48 8d 35 aa 0e 00 00 	lea    0xeaa(%rip),%rsi        # 2009 <_IO_stdin_used+0x9>
    115f:	48 8d 3d a8 0e 00 00 	lea    0xea8(%rip),%rdi        # 200e <_IO_stdin_used+0xe>
    1166:	b8 00 00 00 00       	mov    $0x0,%eax
    116b:	e8 e0 fe ff ff       	callq  1050 <printf@plt>
    1170:	48 8d 15 8d 0e 00 00 	lea    0xe8d(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    1177:	48 8d 35 9f 0e 00 00 	lea    0xe9f(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    117e:	48 8d 3d 9d 0e 00 00 	lea    0xe9d(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    1185:	b8 00 00 00 00       	mov    $0x0,%eax
    118a:	e8 c1 fe ff ff       	callq  1050 <printf@plt>
    118f:	48 8d 15 6e 0e 00 00 	lea    0xe6e(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    1196:	48 8d 35 95 0e 00 00 	lea    0xe95(%rip),%rsi        # 2032 <_IO_stdin_used+0x32>
    119d:	48 8d 3d 93 0e 00 00 	lea    0xe93(%rip),%rdi        # 2037 <_IO_stdin_used+0x37>
    11a4:	b8 00 00 00 00       	mov    $0x0,%eax
    11a9:	e8 a2 fe ff ff       	callq  1050 <printf@plt>
    11ae:	48 8d 15 4f 0e 00 00 	lea    0xe4f(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    11b5:	48 8d 35 8f 0e 00 00 	lea    0xe8f(%rip),%rsi        # 204b <_IO_stdin_used+0x4b>
    11bc:	48 8d 3d 8d 0e 00 00 	lea    0xe8d(%rip),%rdi        # 2050 <_IO_stdin_used+0x50>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	e8 83 fe ff ff       	callq  1050 <printf@plt>
    11cd:	48 8d 15 30 0e 00 00 	lea    0xe30(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    11d4:	48 8d 35 88 0e 00 00 	lea    0xe88(%rip),%rsi        # 2063 <_IO_stdin_used+0x63>
    11db:	48 8d 3d 86 0e 00 00 	lea    0xe86(%rip),%rdi        # 2068 <_IO_stdin_used+0x68>
    11e2:	b8 00 00 00 00       	mov    $0x0,%eax
    11e7:	e8 64 fe ff ff       	callq  1050 <printf@plt>
