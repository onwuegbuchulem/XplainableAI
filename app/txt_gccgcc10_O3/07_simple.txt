...
/app/bin_gccgcc10_O3/07_simple:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10d3:	48 8d 3d 45 0f 00 00 	lea    0xf45(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    10da:	e8 b1 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10df:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    10e3:	8b 14 24             	mov    (%rsp),%edx
    10e6:	31 c0                	xor    %eax,%eax
    10e8:	48 8d 35 36 0f 00 00 	lea    0xf36(%rip),%rsi        # 2025 <_IO_stdin_used+0x25>
    10ef:	bf 01 00 00 00       	mov    $0x1,%edi
    10f4:	e8 87 ff ff ff       	callq  1080 <__printf_chk@plt>
    10f9:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    10fd:	44 8b 0c 24          	mov    (%rsp),%r9d
    1101:	44 39 c9             	cmp    %r9d,%ecx
    1104:	44 89 c8             	mov    %r9d,%eax
    1107:	44 89 cf             	mov    %r9d,%edi
    110a:	0f 4d c1             	cmovge %ecx,%eax
    110d:	0f 4e f9             	cmovle %ecx,%edi
    1110:	89 c6                	mov    %eax,%esi
    1112:	29 fe                	sub    %edi,%esi
    1114:	39 f0                	cmp    %esi,%eax
    1116:	74 1e                	je     1136 <main+0x96>
    1118:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    111f:	00 
    1120:	39 f7                	cmp    %esi,%edi
    1122:	41 89 f0             	mov    %esi,%r8d
    1125:	44 0f 4d c7          	cmovge %edi,%r8d
    1129:	0f 4f fe             	cmovg  %esi,%edi
    112c:	44 89 c6             	mov    %r8d,%esi
    112f:	29 fe                	sub    %edi,%esi
    1131:	41 39 f0             	cmp    %esi,%r8d
    1134:	75 ea                	jne    1120 <main+0x80>
    1136:	83 fe 01             	cmp    $0x1,%esi
    1139:	7e 10                	jle    114b <main+0xab>
    113b:	89 c8                	mov    %ecx,%eax
    113d:	99                   	cltd   
    113e:	f7 fe                	idiv   %esi
    1140:	89 c1                	mov    %eax,%ecx
    1142:	44 89 c8             	mov    %r9d,%eax
    1145:	99                   	cltd   
    1146:	f7 fe                	idiv   %esi
    1148:	41 89 c1             	mov    %eax,%r9d
    114b:	31 c0                	xor    %eax,%eax
    114d:	44 89 ca             	mov    %r9d,%edx
    1150:	bf 01 00 00 00       	mov    $0x1,%edi
    1155:	48 8d 35 d2 0e 00 00 	lea    0xed2(%rip),%rsi        # 202e <_IO_stdin_used+0x2e>
    115c:	e8 1f ff ff ff       	callq  1080 <__printf_chk@plt>
    1161:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1166:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    116d:	00 00 
    116f:	75 07                	jne    1178 <main+0xd8>
    1171:	31 c0                	xor    %eax,%eax
    1173:	48 83 c4 18          	add    $0x18,%rsp
    1177:	c3                   	retq   
    1178:	e8 f3 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
