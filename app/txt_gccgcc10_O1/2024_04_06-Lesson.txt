...
/app/bin_gccgcc10_O1/2024_04_06-Lesson:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11d1:	55                   	push   %rbp
    11d2:	53                   	push   %rbx
    11d3:	48 81 ec a8 00 00 00 	sub    $0xa8,%rsp
    11da:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11e1:	00 00 
    11e3:	48 89 84 24 98 00 00 	mov    %rax,0x98(%rsp)
    11ea:	00 
    ...
    11fc:	00 00 
    11fe:	bb 41 00 00 00       	mov    $0x41,%ebx
    1203:	41 bc 00 00 00 00    	mov    $0x0,%r12d
    1209:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    120e:	b9 10 00 00 00       	mov    $0x10,%ecx
    1213:	48 89 f7             	mov    %rsi,%rdi
    1216:	44 89 e0             	mov    %r12d,%eax
    1219:	fc                   	cld    
    121a:	f3 48 ab             	rep stos %rax,%es:(%rdi)
    121d:	48 83 4c 24 10 01    	orq    $0x1,0x10(%rsp)
    1223:	49 89 e0             	mov    %rsp,%r8
    1226:	b9 00 00 00 00       	mov    $0x0,%ecx
    122b:	ba 00 00 00 00       	mov    $0x0,%edx
    1230:	bf 01 00 00 00       	mov    $0x1,%edi
    1235:	e8 66 fe ff ff       	callq  10a0 <select@plt>
    123a:	89 c5                	mov    %eax,%ebp
    123c:	83 f8 ff             	cmp    $0xffffffff,%eax
    123f:	74 48                	je     1289 <main+0xc0>
    1241:	44 8d 6b 01          	lea    0x1(%rbx),%r13d
    1245:	0f be d3             	movsbl %bl,%edx
    1248:	48 8d 35 bc 0d 00 00 	lea    0xdbc(%rip),%rsi        # 200b <_IO_stdin_used+0xb>
    124f:	bf 01 00 00 00       	mov    $0x1,%edi
    1254:	b8 00 00 00 00       	mov    $0x0,%eax
    1259:	e8 52 fe ff ff       	callq  10b0 <__printf_chk@plt>
    125e:	41 80 fd 5a          	cmp    $0x5a,%r13b
    1262:	bb 41 00 00 00       	mov    $0x41,%ebx
    1267:	41 0f 45 dd          	cmovne %r13d,%ebx
    126b:	85 ed                	test   %ebp,%ebp
    126d:	7e 9a                	jle    1209 <main+0x40>
    126f:	f6 44 24 10 01       	testb  $0x1,0x10(%rsp)
    1274:	74 93                	je     1209 <main+0x40>
    1276:	48 8b 3d 93 2d 00 00 	mov    0x2d93(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    127d:	e8 4e fe ff ff       	callq  10d0 <getc@plt>
    1282:	b8 00 00 00 00       	mov    $0x0,%eax
    1287:	eb 11                	jmp    129a <main+0xd1>
    1289:	48 8d 3d 74 0d 00 00 	lea    0xd74(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1290:	e8 2b fe ff ff       	callq  10c0 <perror@plt>
    1295:	b8 01 00 00 00       	mov    $0x1,%eax
    129a:	48 8b 94 24 98 00 00 	mov    0x98(%rsp),%rdx
    12a1:	00 
    12a2:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    12a9:	00 00 
    12ab:	75 0e                	jne    12bb <main+0xf2>
    12ad:	48 81 c4 a8 00 00 00 	add    $0xa8,%rsp
    12b4:	5b                   	pop    %rbx
    12b5:	5d                   	pop    %rbp
    12b6:	41 5c                	pop    %r12
    12b8:	41 5d                	pop    %r13
