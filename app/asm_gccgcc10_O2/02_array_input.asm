...
/app/bin_gccgcc10_O2/02_array_input:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10cd:	41 54                	push   %r12
    10cf:	4c 8d 25 48 0f 00 00 	lea    0xf48(%rip),%r12        # 201e <_IO_stdin_used+0x1e>
    10d6:	55                   	push   %rbp
    10d7:	53                   	push   %rbx
    ...
    10ef:	4c 8d 6c 24 14       	lea    0x14(%rsp),%r13
    10f4:	e8 87 ff ff ff       	callq  1080 <puts@plt>
    10f9:	48 89 eb             	mov    %rbp,%rbx
    10fc:	48 89 de             	mov    %rbx,%rsi
    10ff:	4c 89 e7             	mov    %r12,%rdi
    1102:	31 c0                	xor    %eax,%eax
    1104:	48 83 c3 04          	add    $0x4,%rbx
    1108:	e8 a3 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    110d:	4c 39 eb             	cmp    %r13,%rbx
    1110:	75 ea                	jne    10fc <main+0x3c>
    1112:	31 db                	xor    %ebx,%ebx
    1114:	4c 8d 25 0d 0f 00 00 	lea    0xf0d(%rip),%r12        # 2028 <_IO_stdin_used+0x28>
    111b:	8b 4c 9d 00          	mov    0x0(%rbp,%rbx,4),%ecx
    111f:	89 da                	mov    %ebx,%edx
    1121:	4c 89 e6             	mov    %r12,%rsi
    1124:	bf 01 00 00 00       	mov    $0x1,%edi
    1129:	31 c0                	xor    %eax,%eax
    112b:	48 83 c3 01          	add    $0x1,%rbx
    112f:	e8 6c ff ff ff       	callq  10a0 <__printf_chk@plt>
    1134:	48 83 fb 05          	cmp    $0x5,%rbx
    1138:	75 e1                	jne    111b <main+0x5b>
    113a:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    113f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1146:	00 00 
    1148:	75 0d                	jne    1157 <main+0x97>
    114a:	48 83 c4 28          	add    $0x28,%rsp
