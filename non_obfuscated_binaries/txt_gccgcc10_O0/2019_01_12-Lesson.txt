...
/app/bin_gccgcc10_O0/2019_01_12-Lesson:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11f0:	e8 cb fe ff ff       	callq  10c0 <printf@plt>
    11f5:	48 8d 45 f7          	lea    -0x9(%rbp),%rax
    11f9:	48 89 c6             	mov    %rax,%rsi
    11fc:	48 8d 3d 11 0e 00 00 	lea    0xe11(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    1203:	b8 00 00 00 00       	mov    $0x0,%eax
    1208:	e8 c3 fe ff ff       	callq  10d0 <__isoc99_scanf@plt>
    120d:	0f b6 45 f7          	movzbl -0x9(%rbp),%eax
    1211:	3c 4d                	cmp    $0x4d,%al
    1213:	7e 05                	jle    121a <main+0x51>
    1215:	e8 76 fe ff ff       	callq  1090 <abort@plt>
    121a:	48 8d 3d f6 0d 00 00 	lea    0xdf6(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    1221:	e8 7a fe ff ff       	callq  10a0 <puts@plt>
    1226:	b8 00 00 00 00       	mov    $0x0,%eax
    122b:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    122f:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1236:	00 00 
    1238:	74 05                	je     123f <main+0x76>
