...
/app/bin_gccgcc10_O3/Pattern-4:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108d:	55                   	push   %rbp
    108e:	bd 05 00 00 00       	mov    $0x5,%ebp
    1093:	53                   	push   %rbx
    ...
    10aa:	83 c3 01             	add    $0x1,%ebx
    10ad:	39 dd                	cmp    %ebx,%ebp
    10af:	7d e8                	jge    1099 <main+0x19>
    10b1:	bf 0a 00 00 00       	mov    $0xa,%edi
    10b6:	e8 a5 ff ff ff       	callq  1060 <putchar@plt>
    10bb:	83 ed 01             	sub    $0x1,%ebp
    10be:	75 d4                	jne    1094 <main+0x14>
    10c0:	5b                   	pop    %rbx
