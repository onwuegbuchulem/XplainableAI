...
/app/bin_gccgcc10_O1/2021_04_10-Lesson:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	48 8d 35 a8 0e 00 00 	lea    0xea8(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    115c:	bf 01 00 00 00       	mov    $0x1,%edi
    1161:	b8 01 00 00 00       	mov    $0x1,%eax
    1166:	e8 e5 fe ff ff       	callq  1050 <__printf_chk@plt>
    116b:	66 0f ef c0          	pxor   %xmm0,%xmm0
    116f:	48 8d 35 aa 0e 00 00 	lea    0xeaa(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    1176:	bf 01 00 00 00       	mov    $0x1,%edi
    117b:	b8 01 00 00 00       	mov    $0x1,%eax
    1180:	e8 cb fe ff ff       	callq  1050 <__printf_chk@plt>
    1185:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1189:	48 8d 35 b0 0e 00 00 	lea    0xeb0(%rip),%rsi        # 2040 <_IO_stdin_used+0x40>
