...
/app/bin_gccgcc10_O0/hexdefilter01:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d fb 00 00 00 	lea    0xfb(%rip),%rdi        # 11a3 <main>
...
0000000000001169 <tohex>:
    ...
    1186:	eb 19                	jmp    11a1 <tohex+0x38>
    ...
    119a:	eb 05                	jmp    11a1 <tohex+0x38>
    119c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    11a1:	5d                   	pop    %rbp
    11a2:	c3                   	retq   
...
00000000000011a3 <main>:
    ...
    11af:	e8 bc fe ff ff       	callq  1070 <getchar@plt>
    11b4:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11b7:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%rbp)
    11bb:	74 53                	je     1210 <main+0x6d>
    11bd:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11c0:	89 c7                	mov    %eax,%edi
    11c2:	b8 00 00 00 00       	mov    $0x0,%eax
    11c7:	e8 9d ff ff ff       	callq  1169 <tohex>
    11cc:	89 45 f8             	mov    %eax,-0x8(%rbp)
    11cf:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
    11d3:	78 3e                	js     1213 <main+0x70>
    11d5:	c1 65 f8 04          	shll   $0x4,-0x8(%rbp)
    11d9:	e8 92 fe ff ff       	callq  1070 <getchar@plt>
    11de:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11e1:	83 7d f4 ff          	cmpl   $0xffffffff,-0xc(%rbp)
    11e5:	74 2f                	je     1216 <main+0x73>
    11e7:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11ea:	89 c7                	mov    %eax,%edi
    11ec:	b8 00 00 00 00       	mov    $0x0,%eax
    11f1:	e8 73 ff ff ff       	callq  1169 <tohex>
    11f6:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11f9:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    11fd:	78 1a                	js     1219 <main+0x76>
    11ff:	8b 55 f8             	mov    -0x8(%rbp),%edx
    1202:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1205:	01 d0                	add    %edx,%eax
    1207:	89 c7                	mov    %eax,%edi
    1209:	e8 52 fe ff ff       	callq  1060 <putchar@plt>
    120e:	eb 9f                	jmp    11af <main+0xc>
    1210:	90                   	nop
    1211:	eb 07                	jmp    121a <main+0x77>
    1213:	90                   	nop
    1214:	eb 04                	jmp    121a <main+0x77>
    1216:	90                   	nop
    1217:	eb 01                	jmp    121a <main+0x77>
    1219:	90                   	nop
    121a:	bf 0a 00 00 00       	mov    $0xa,%edi
    121f:	e8 3c fe ff ff       	callq  1060 <putchar@plt>
