...
/app/bin_gccgcc10_O1/2024_02_17-Lesson-a:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11ba:	00 00 
    11bc:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    11c1:	31 c0                	xor    %eax,%eax
    11c3:	48 b8 6c 61 6e 67 75 	movabs $0x65676175676e616c,%rax
    11ca:	61 67 65 
    11cd:	48 89 44 24 0f       	mov    %rax,0xf(%rsp)
    11d2:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    11d7:	66 c7 44 24 0d 43 00 	movw   $0x43,0xd(%rsp)
    11de:	48 8d 6c 24 0d       	lea    0xd(%rsp),%rbp
    11e3:	48 8d 5c 24 0f       	lea    0xf(%rsp),%rbx
    11e8:	48 89 e9             	mov    %rbp,%rcx
    ...
    1209:	48 89 ee             	mov    %rbp,%rsi
    120c:	48 89 df             	mov    %rbx,%rdi
    120f:	e8 7c fe ff ff       	callq  1090 <setenv@plt>
    1214:	48 89 df             	mov    %rbx,%rdi
    1217:	e8 64 fe ff ff       	callq  1080 <getenv@plt>
    121c:	48 89 c2             	mov    %rax,%rdx
    121f:	48 8d 35 01 0e 00 00 	lea    0xe01(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    ...
    1241:	00 00 
    1243:	75 0c                	jne    1251 <main+0xa8>
    1245:	b8 00 00 00 00       	mov    $0x0,%eax
    124a:	48 83 c4 28          	add    $0x28,%rsp
    124e:	5b                   	pop    %rbx
    124f:	5d                   	pop    %rbp
    1250:	c3                   	retq   
