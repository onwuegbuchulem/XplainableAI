...
/app/bin_gccgcc10_O0/2023_08_01-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 bc 07 00 00 00 	movl   $0x7,-0x44(%rbp)
    118b:	48 8d 05 72 0e 00 00 	lea    0xe72(%rip),%rax        # 2004 <_IO_stdin_used+0x4>
    1192:	48 89 45 c0          	mov    %rax,-0x40(%rbp)
    1196:	48 8d 05 76 0e 00 00 	lea    0xe76(%rip),%rax        # 2013 <_IO_stdin_used+0x13>
    119d:	48 89 45 c8          	mov    %rax,-0x38(%rbp)
    11a1:	48 8d 05 85 0e 00 00 	lea    0xe85(%rip),%rax        # 202d <_IO_stdin_used+0x2d>
    11a8:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    11ac:	48 8d 05 84 0e 00 00 	lea    0xe84(%rip),%rax        # 2037 <_IO_stdin_used+0x37>
    11b3:	48 89 45 d8          	mov    %rax,-0x28(%rbp)
    11b7:	48 8d 05 89 0e 00 00 	lea    0xe89(%rip),%rax        # 2047 <_IO_stdin_used+0x47>
    11be:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    11c2:	48 8d 05 8d 0e 00 00 	lea    0xe8d(%rip),%rax        # 2056 <_IO_stdin_used+0x56>
    11c9:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    11cd:	48 8d 05 94 0e 00 00 	lea    0xe94(%rip),%rax        # 2068 <_IO_stdin_used+0x68>
    11d4:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11d8:	c7 45 b8 00 00 00 00 	movl   $0x0,-0x48(%rbp)
    11df:	eb 16                	jmp    11f7 <main+0x8e>
    11e1:	8b 45 b8             	mov    -0x48(%rbp),%eax
    11e4:	48 98                	cltq   
    11e6:	48 8b 44 c5 c0       	mov    -0x40(%rbp,%rax,8),%rax
    11eb:	48 89 c7             	mov    %rax,%rdi
    11ee:	e8 6d fe ff ff       	callq  1060 <puts@plt>
    11f3:	83 45 b8 01          	addl   $0x1,-0x48(%rbp)
    11f7:	8b 45 b8             	mov    -0x48(%rbp),%eax
    11fa:	3b 45 bc             	cmp    -0x44(%rbp),%eax
    11fd:	7c e2                	jl     11e1 <main+0x78>
    11ff:	b8 00 00 00 00       	mov    $0x0,%eax
    1204:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1208:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    120f:	00 00 
    1211:	74 05                	je     1218 <main+0xaf>
    1213:	e8 58 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1218:	c9                   	leaveq 
    1219:	c3                   	retq   
