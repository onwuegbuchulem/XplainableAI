...
/app/bin_gccgcc10_O1/NestedIfLeapYear:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d7:	48 8d 3d 34 0e 00 00 	lea    0xe34(%rip),%rdi        # 2012 <_IO_stdin_used+0x12>
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 b8 fe ff ff       	callq  10a0 <__isoc99_scanf@plt>
    11e8:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    11ec:	f6 c1 03             	test   $0x3,%cl
    11ef:	0f 85 88 00 00 00    	jne    127d <main+0xd4>
    11f5:	48 63 c1             	movslq %ecx,%rax
    11f8:	48 69 c0 1f 85 eb 51 	imul   $0x51eb851f,%rax,%rax
    11ff:	48 c1 f8 25          	sar    $0x25,%rax
    1203:	89 ca                	mov    %ecx,%edx
    1205:	c1 fa 1f             	sar    $0x1f,%edx
    1208:	29 d0                	sub    %edx,%eax
    120a:	6b c0 64             	imul   $0x64,%eax,%eax
    120d:	39 c1                	cmp    %eax,%ecx
    120f:	75 52                	jne    1263 <main+0xba>
    1211:	be 90 01 00 00       	mov    $0x190,%esi
    1216:	89 c8                	mov    %ecx,%eax
    1218:	99                   	cltd   
    1219:	f7 fe                	idiv   %esi
    121b:	85 d2                	test   %edx,%edx
    121d:	75 22                	jne    1241 <main+0x98>
    121f:	89 ca                	mov    %ecx,%edx
    1221:	48 8d 35 ed 0d 00 00 	lea    0xded(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    1228:	bf 01 00 00 00       	mov    $0x1,%edi
    122d:	b8 00 00 00 00       	mov    $0x0,%eax
    1232:	e8 59 fe ff ff       	callq  1090 <__printf_chk@plt>
    1237:	bf 00 00 00 00       	mov    $0x0,%edi
    123c:	e8 6f fe ff ff       	callq  10b0 <exit@plt>
    1241:	89 ca                	mov    %ecx,%edx
    1243:	48 8d 35 de 0d 00 00 	lea    0xdde(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    124a:	bf 01 00 00 00       	mov    $0x1,%edi
    124f:	b8 00 00 00 00       	mov    $0x0,%eax
    1254:	e8 37 fe ff ff       	callq  1090 <__printf_chk@plt>
    1259:	bf 00 00 00 00       	mov    $0x0,%edi
    125e:	e8 4d fe ff ff       	callq  10b0 <exit@plt>
    1263:	89 ca                	mov    %ecx,%edx
    1265:	48 8d 35 a9 0d 00 00 	lea    0xda9(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    126c:	bf 01 00 00 00       	mov    $0x1,%edi
    1271:	b8 00 00 00 00       	mov    $0x0,%eax
    1276:	e8 15 fe ff ff       	callq  1090 <__printf_chk@plt>
    127b:	eb 18                	jmp    1295 <main+0xec>
    127d:	89 ca                	mov    %ecx,%edx
    127f:	48 8d 35 a2 0d 00 00 	lea    0xda2(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    1286:	bf 01 00 00 00       	mov    $0x1,%edi
    128b:	b8 00 00 00 00       	mov    $0x0,%eax
    1290:	e8 fb fd ff ff       	callq  1090 <__printf_chk@plt>
    1295:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    129a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12a1:	00 00 
    12a3:	75 05                	jne    12aa <main+0x101>
    12a5:	48 83 c4 18          	add    $0x18,%rsp
    12a9:	c3                   	retq   
