...
/app/bin_gccgcc10_O3/2021_01_30-Lesson:     file format elf64-x86-64
...
0000000000001070 <__printf_chk@plt>:
    ...
    1074:	f2 ff 25 45 2f 00 00 	bnd jmpq *0x2f45(%rip)        # 3fc0 <__printf_chk@GLIBC_2.3.4>
    107b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001080 <exit@plt>:
    1080:	f3 0f 1e fa          	endbr64 
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <exit@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10ab:	7e 1e                	jle    10cb <main+0x2b>
    10ad:	48 8b 56 08          	mov    0x8(%rsi),%rdx
    10b1:	bf 01 00 00 00       	mov    $0x1,%edi
    10b6:	31 c0                	xor    %eax,%eax
    10b8:	48 8d 35 60 0f 00 00 	lea    0xf60(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    10bf:	e8 ac ff ff ff       	callq  1070 <__printf_chk@plt>
    10c4:	31 c0                	xor    %eax,%eax
    10c6:	48 83 c4 08          	add    $0x8,%rsp
    10ca:	c3                   	retq   
    10cb:	48 8b 0d 4e 2f 00 00 	mov    0x2f4e(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    10d2:	ba 1a 00 00 00       	mov    $0x1a,%edx
    10d7:	be 01 00 00 00       	mov    $0x1,%esi
    10dc:	48 8d 3d 21 0f 00 00 	lea    0xf21(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    10e3:	e8 a8 ff ff ff       	callq  1090 <fwrite@plt>
    10e8:	bf 01 00 00 00       	mov    $0x1,%edi
    10ed:	e8 8e ff ff ff       	callq  1080 <exit@plt>
    10f2:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10f9:	00 00 00 
