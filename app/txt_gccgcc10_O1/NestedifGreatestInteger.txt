...
/app/bin_gccgcc10_O1/NestedifGreatestInteger:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11cd:	48 8d 4c 24 14       	lea    0x14(%rsp),%rcx
    11d2:	48 8d 54 24 10       	lea    0x10(%rsp),%rdx
    ...
    11f1:	8b 44 24 10          	mov    0x10(%rsp),%eax
    11f5:	39 c2                	cmp    %eax,%edx
    11f7:	7e 4e                	jle    1247 <main+0x9e>
    11f9:	3b 54 24 14          	cmp    0x14(%rsp),%edx
    11fd:	7e 30                	jle    122f <main+0x86>
    11ff:	48 8d 35 20 0e 00 00 	lea    0xe20(%rip),%rsi        # 2026 <_IO_stdin_used+0x26>
    1206:	bf 01 00 00 00       	mov    $0x1,%edi
    120b:	b8 00 00 00 00       	mov    $0x0,%eax
    1210:	e8 8b fe ff ff       	callq  10a0 <__printf_chk@plt>
    1215:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    121a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1221:	00 00 
    1223:	75 58                	jne    127d <main+0xd4>
    1225:	b8 00 00 00 00       	mov    $0x0,%eax
    122a:	48 83 c4 28          	add    $0x28,%rsp
    122e:	c3                   	retq   
    122f:	48 8d 35 fe 0d 00 00 	lea    0xdfe(%rip),%rsi        # 2034 <_IO_stdin_used+0x34>
    1236:	bf 01 00 00 00       	mov    $0x1,%edi
    123b:	b8 00 00 00 00       	mov    $0x0,%eax
    1240:	e8 5b fe ff ff       	callq  10a0 <__printf_chk@plt>
    1245:	eb ce                	jmp    1215 <main+0x6c>
    1247:	3b 44 24 14          	cmp    0x14(%rsp),%eax
    124b:	7e 18                	jle    1265 <main+0xbc>
    124d:	48 8d 35 ee 0d 00 00 	lea    0xdee(%rip),%rsi        # 2042 <_IO_stdin_used+0x42>
    1254:	bf 01 00 00 00       	mov    $0x1,%edi
    1259:	b8 00 00 00 00       	mov    $0x0,%eax
    125e:	e8 3d fe ff ff       	callq  10a0 <__printf_chk@plt>
    1263:	eb b0                	jmp    1215 <main+0x6c>
    1265:	48 8d 35 c8 0d 00 00 	lea    0xdc8(%rip),%rsi        # 2034 <_IO_stdin_used+0x34>
    126c:	bf 01 00 00 00       	mov    $0x1,%edi
    1271:	b8 00 00 00 00       	mov    $0x0,%eax
    1276:	e8 25 fe ff ff       	callq  10a0 <__printf_chk@plt>
    127b:	eb 98                	jmp    1215 <main+0x6c>
    127d:	e8 0e fe ff ff       	callq  1090 <__stack_chk_fail@plt>
