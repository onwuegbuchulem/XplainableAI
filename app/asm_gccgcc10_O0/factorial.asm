...
/app/bin_gccgcc10_O0/Factorial:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	48 c7 45 f0 01 00 00 	movq   $0x1,-0x10(%rbp)
    11ab:	00 
    11ac:	48 8d 3d 55 0e 00 00 	lea    0xe55(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11b3:	b8 00 00 00 00       	mov    $0x0,%eax
    11b8:	e8 c3 fe ff ff       	callq  1080 <printf@plt>
    11bd:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    11c1:	48 89 c6             	mov    %rax,%rsi
    11c4:	48 8d 3d 4e 0e 00 00 	lea    0xe4e(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    ...
    11ed:	eb 40                	jmp    122f <main+0xa6>
    11ef:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%rbp)
    11f6:	eb 15                	jmp    120d <main+0x84>
    11f8:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11fb:	48 98                	cltq   
    11fd:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    1201:	48 0f af c2          	imul   %rdx,%rax
    1205:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    1209:	83 45 ec 01          	addl   $0x1,-0x14(%rbp)
    120d:	8b 45 e8             	mov    -0x18(%rbp),%eax
    1210:	39 45 ec             	cmp    %eax,-0x14(%rbp)
    1213:	7e e3                	jle    11f8 <main+0x6f>
    1215:	8b 45 e8             	mov    -0x18(%rbp),%eax
    1218:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    121c:	89 c6                	mov    %eax,%esi
    121e:	48 8d 3d 30 0e 00 00 	lea    0xe30(%rip),%rdi        # 2055 <_IO_stdin_used+0x55>
    1225:	b8 00 00 00 00       	mov    $0x0,%eax
    122a:	e8 51 fe ff ff       	callq  1080 <printf@plt>
    122f:	b8 00 00 00 00       	mov    $0x0,%eax
    1234:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1238:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    123f:	00 00 
    1241:	74 05                	je     1248 <main+0xbf>
