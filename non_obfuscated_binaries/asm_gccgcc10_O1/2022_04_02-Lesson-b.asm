...
/app/bin_gccgcc10_O1/2022_04_02-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117d:	48 8d 0d 8c 0e 00 00 	lea    0xe8c(%rip),%rcx        # 2010 <_IO_stdin_used+0x10>
    1184:	48 8d 15 89 0e 00 00 	lea    0xe89(%rip),%rdx        # 2014 <_IO_stdin_used+0x14>
    118b:	48 8d 35 88 0e 00 00 	lea    0xe88(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    1192:	bf 01 00 00 00       	mov    $0x1,%edi
    1197:	b8 00 00 00 00       	mov    $0x0,%eax
    119c:	e8 cf fe ff ff       	callq  1070 <__printf_chk@plt>
    11a1:	48 8d 3d 88 0e 00 00 	lea    0xe88(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
