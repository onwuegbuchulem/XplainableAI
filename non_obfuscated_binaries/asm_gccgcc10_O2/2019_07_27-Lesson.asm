...
/app/bin_gccgcc10_O2/2019_07_27-Lesson:     file format elf64-x86-64
...
00000000000010b0 <getrlimit@plt>:
    10b0:	f3 0f 1e fa          	endbr64 
    10b4:	f2 ff 25 15 2f 00 00 	bnd jmpq *0x2f15(%rip)        # 3fd0 <getrlimit@GLIBC_2.2.5>
...
00000000000010c0 <main>:
    ...
    10c8:	bf 02 00 00 00       	mov    $0x2,%edi
    10cd:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10d4:	00 00 
    10d6:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10db:	31 c0                	xor    %eax,%eax
    10dd:	48 89 e6             	mov    %rsp,%rsi
    10e0:	e8 cb ff ff ff       	callq  10b0 <getrlimit@plt>
    10e5:	83 f8 ff             	cmp    $0xffffffff,%eax
    10e8:	74 46                	je     1130 <main+0x70>
    10ea:	48 8b 14 24          	mov    (%rsp),%rdx
    10ee:	48 8d 35 23 0f 00 00 	lea    0xf23(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    10f5:	bf 01 00 00 00       	mov    $0x1,%edi
    10fa:	31 c0                	xor    %eax,%eax
    10fc:	e8 8f ff ff ff       	callq  1090 <__printf_chk@plt>
    1101:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    1106:	48 8d 35 33 0f 00 00 	lea    0xf33(%rip),%rsi        # 2040 <_IO_stdin_used+0x40>
    110d:	31 c0                	xor    %eax,%eax
    110f:	bf 01 00 00 00       	mov    $0x1,%edi
    1114:	e8 77 ff ff ff       	callq  1090 <__printf_chk@plt>
    1119:	31 c0                	xor    %eax,%eax
    111b:	48 8b 4c 24 18       	mov    0x18(%rsp),%rcx
    1120:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1127:	00 00 
    1129:	75 29                	jne    1154 <main+0x94>
    112b:	48 83 c4 28          	add    $0x28,%rsp
    112f:	c3                   	retq   
    1130:	48 8b 0d e9 2e 00 00 	mov    0x2ee9(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1137:	ba 11 00 00 00       	mov    $0x11,%edx
    113c:	be 01 00 00 00       	mov    $0x1,%esi
    1141:	48 8d 3d bc 0e 00 00 	lea    0xebc(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1148:	e8 53 ff ff ff       	callq  10a0 <fwrite@plt>
    114d:	b8 01 00 00 00       	mov    $0x1,%eax
    1152:	eb c7                	jmp    111b <main+0x5b>
    1154:	e8 27 ff ff ff       	callq  1080 <__stack_chk_fail@plt>
