...
/app/bin_gccgcc10_O0/filter03:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    121a:	e8 d1 fe ff ff       	callq  10f0 <time@plt>
    121f:	89 c7                	mov    %eax,%edi
    1221:	e8 aa fe ff ff       	callq  10d0 <srand@plt>
    1226:	eb 3d                	jmp    1265 <main+0x5c>
    1228:	e8 e3 fe ff ff       	callq  1110 <rand@plt>
    122d:	99                   	cltd   
    122e:	c1 ea 1f             	shr    $0x1f,%edx
    1231:	01 d0                	add    %edx,%eax
    1233:	83 e0 01             	and    $0x1,%eax
    1236:	29 d0                	sub    %edx,%eax
    1238:	89 45 fc             	mov    %eax,-0x4(%rbp)
    123b:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    123f:	74 13                	je     1254 <main+0x4b>
    1241:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1244:	89 c7                	mov    %eax,%edi
    1246:	e8 75 fe ff ff       	callq  10c0 <toupper@plt>
    124b:	89 c7                	mov    %eax,%edi
    124d:	e8 5e fe ff ff       	callq  10b0 <putchar@plt>
    1252:	eb 11                	jmp    1265 <main+0x5c>
    1254:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1257:	89 c7                	mov    %eax,%edi
    1259:	e8 a2 fe ff ff       	callq  1100 <tolower@plt>
    125e:	89 c7                	mov    %eax,%edi
    1260:	e8 4b fe ff ff       	callq  10b0 <putchar@plt>
    1265:	e8 76 fe ff ff       	callq  10e0 <getchar@plt>
    126a:	89 45 f8             	mov    %eax,-0x8(%rbp)
    126d:	83 7d f8 ff          	cmpl   $0xffffffff,-0x8(%rbp)
    1271:	75 b5                	jne    1228 <main+0x1f>
...
0000000000001280 <__libc_csu_init>:
    ...
    1284:	41 57                	push   %r15
    1286:	4c 8d 3d fb 2a 00 00 	lea    0x2afb(%rip),%r15        # 3d88 <__frame_dummy_init_array_entry>
    128d:	41 56                	push   %r14
