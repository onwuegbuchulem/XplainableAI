...
/app/bin_gccgcc10_O1/greek_write:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11d8:	48 8d 3d 27 0e 00 00 	lea    0xe27(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    11df:	e8 dc fe ff ff       	callq  10c0 <fopen@plt>
    11e4:	49 89 c4             	mov    %rax,%r12
    11e7:	48 8d 35 27 0e 00 00 	lea    0xe27(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    11ee:	bf 00 00 00 00       	mov    $0x0,%edi
    11f3:	e8 b8 fe ff ff       	callq  10b0 <setlocale@plt>
    11f8:	48 8d 35 29 0e 00 00 	lea    0xe29(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    11ff:	bf 01 00 00 00       	mov    $0x1,%edi
    1204:	b8 00 00 00 00       	mov    $0x0,%eax
    1209:	e8 c2 fe ff ff       	callq  10d0 <__wprintf_chk@plt>
    120e:	bb 92 03 00 00       	mov    $0x392,%ebx
    1213:	eb 03                	jmp    1218 <main+0x4f>
    1215:	83 c3 01             	add    $0x1,%ebx
    1218:	8d 6b ff             	lea    -0x1(%rbx),%ebp
    121b:	81 fb a3 03 00 00    	cmp    $0x3a3,%ebx
    1221:	74 f2                	je     1215 <main+0x4c>
    1223:	4c 89 e6             	mov    %r12,%rsi
    1226:	89 ef                	mov    %ebp,%edi
    1228:	e8 73 fe ff ff       	callq  10a0 <fputwc@plt>
    122d:	48 8b 35 dc 2d 00 00 	mov    0x2ddc(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1234:	89 ef                	mov    %ebp,%edi
    1236:	e8 65 fe ff ff       	callq  10a0 <fputwc@plt>
    123b:	81 fb a9 03 00 00    	cmp    $0x3a9,%ebx
    1241:	7e d2                	jle    1215 <main+0x4c>
    1243:	4c 89 e6             	mov    %r12,%rsi
    1246:	bf 00 00 00 00       	mov    $0x0,%edi
    124b:	e8 50 fe ff ff       	callq  10a0 <fputwc@plt>
    1250:	4c 89 e7             	mov    %r12,%rdi
    1253:	e8 38 fe ff ff       	callq  1090 <fclose@plt>
    1258:	48 8d 35 45 0e 00 00 	lea    0xe45(%rip),%rsi        # 20a4 <_IO_stdin_used+0xa4>
    125f:	bf 01 00 00 00       	mov    $0x1,%edi
    1264:	b8 00 00 00 00       	mov    $0x0,%eax
    1269:	e8 62 fe ff ff       	callq  10d0 <__wprintf_chk@plt>
