...
/app/bin_gccgcc10_O3/GotoStatementEvenOrOdd:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e9:	48 8d 3d 23 0f 00 00 	lea    0xf23(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    10f0:	31 c0                	xor    %eax,%eax
    10f2:	e8 b9 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10f7:	8b 44 24 04          	mov    0x4(%rsp),%eax
    10fb:	a8 01                	test   $0x1,%al
    10fd:	74 2e                	je     112d <main+0x6d>
    10ff:	85 c0                	test   %eax,%eax
    1101:	78 45                	js     1148 <main+0x88>
    1103:	48 8d 35 5f 0f 00 00 	lea    0xf5f(%rip),%rsi        # 2069 <_IO_stdin_used+0x69>
    ...
    111b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1122:	00 00 
    1124:	75 61                	jne    1187 <main+0xc7>
    1126:	31 c0                	xor    %eax,%eax
    1128:	48 83 c4 18          	add    $0x18,%rsp
    112c:	c3                   	retq   
    112d:	85 c0                	test   %eax,%eax
    112f:	7f 2c                	jg     115d <main+0x9d>
    1131:	75 3f                	jne    1172 <main+0xb2>
    1133:	48 8d 35 4a 0f 00 00 	lea    0xf4a(%rip),%rsi        # 2084 <_IO_stdin_used+0x84>
    113a:	bf 01 00 00 00       	mov    $0x1,%edi
    113f:	31 c0                	xor    %eax,%eax
    1141:	e8 5a ff ff ff       	callq  10a0 <__printf_chk@plt>
    1146:	eb ce                	jmp    1116 <main+0x56>
    1148:	48 8d 35 e3 0e 00 00 	lea    0xee3(%rip),%rsi        # 2032 <_IO_stdin_used+0x32>
    114f:	bf 01 00 00 00       	mov    $0x1,%edi
    1154:	31 c0                	xor    %eax,%eax
    1156:	e8 45 ff ff ff       	callq  10a0 <__printf_chk@plt>
    115b:	eb b9                	jmp    1116 <main+0x56>
    ...
    116b:	e8 30 ff ff ff       	callq  10a0 <__printf_chk@plt>
    1170:	eb a4                	jmp    1116 <main+0x56>
    1172:	48 8d 35 d4 0e 00 00 	lea    0xed4(%rip),%rsi        # 204d <_IO_stdin_used+0x4d>
    1179:	bf 01 00 00 00       	mov    $0x1,%edi
    117e:	31 c0                	xor    %eax,%eax
    1180:	e8 1b ff ff ff       	callq  10a0 <__printf_chk@plt>
    1185:	eb 8f                	jmp    1116 <main+0x56>
    1187:	e8 04 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
