...
/app/bin_gccgcc10_O2/05_reading_cbyc:     file format elf64-x86-64
...
0000000000001080 <fgetc@plt>:
    ...
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <fgetc@GLIBC_2.2.5>
    108b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001090 <fopen@plt>:
    1090:	f3 0f 1e fa          	endbr64 
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <fopen@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10b8:	e8 d3 ff ff ff       	callq  1090 <fopen@plt>
    10bd:	48 89 c5             	mov    %rax,%rbp
    10c0:	48 89 ef             	mov    %rbp,%rdi
    10c3:	e8 b8 ff ff ff       	callq  1080 <fgetc@plt>
    10c8:	89 c3                	mov    %eax,%ebx
    10ca:	0f be f8             	movsbl %al,%edi
    10cd:	e8 9e ff ff ff       	callq  1070 <putchar@plt>
    10d2:	80 fb ff             	cmp    $0xff,%bl
    10d5:	75 e9                	jne    10c0 <main+0x20>
    10d7:	48 83 c4 08          	add    $0x8,%rsp
...
00000000000010e0 <_start>:
    ...
    1101:	48 8d 3d 98 ff ff ff 	lea    -0x68(%rip),%rdi        # 10a0 <main>
...
0000000000001180 <__do_global_dtors_aux>:
    ...
    11a2:	e8 b9 fe ff ff       	callq  1060 <__cxa_finalize@plt>
...
00000000000011d0 <__libc_csu_init>:
    ...
    11d4:	41 57                	push   %r15
    11d6:	4c 8d 3d cb 2b 00 00 	lea    0x2bcb(%rip),%r15        # 3da8 <__frame_dummy_init_array_entry>
    11dd:	41 56                	push   %r14
    ...
    11ec:	55                   	push   %rbp
    11ed:	48 8d 2d bc 2b 00 00 	lea    0x2bbc(%rip),%rbp        # 3db0 <__do_global_dtors_aux_fini_array_entry>
    11f4:	53                   	push   %rbx
