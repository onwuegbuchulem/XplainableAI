...
/app/bin_gccgcc10_O1/2020_07_11-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	48 83 ec 38          	sub    $0x38,%rsp
    1191:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1198:	00 00 
    119a:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    119f:	31 c0                	xor    %eax,%eax
    11a1:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    11a6:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
    11ab:	e8 d0 fe ff ff       	callq  1080 <gettimeofday@plt>
    11b0:	48 8b 54 24 10       	mov    0x10(%rsp),%rdx
    ...
    11c6:	e8 c5 fe ff ff       	callq  1090 <__printf_chk@plt>
    11cb:	48 8b 54 24 18       	mov    0x18(%rsp),%rdx
    11d0:	48 8d 35 4a 0e 00 00 	lea    0xe4a(%rip),%rsi        # 2021 <_IO_stdin_used+0x21>
    11d7:	bf 01 00 00 00       	mov    $0x1,%edi
    11dc:	b8 00 00 00 00       	mov    $0x0,%eax
    11e1:	e8 aa fe ff ff       	callq  1090 <__printf_chk@plt>
    11e6:	8b 54 24 08          	mov    0x8(%rsp),%edx
    11ea:	48 8d 35 47 0e 00 00 	lea    0xe47(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    11f1:	bf 01 00 00 00       	mov    $0x1,%edi
    11f6:	b8 00 00 00 00       	mov    $0x0,%eax
    11fb:	e8 90 fe ff ff       	callq  1090 <__printf_chk@plt>
    1200:	8b 54 24 0c          	mov    0xc(%rsp),%edx
    1204:	48 8d 35 4d 0e 00 00 	lea    0xe4d(%rip),%rsi        # 2058 <_IO_stdin_used+0x58>
    120b:	bf 01 00 00 00       	mov    $0x1,%edi
    1210:	b8 00 00 00 00       	mov    $0x0,%eax
    1215:	e8 76 fe ff ff       	callq  1090 <__printf_chk@plt>
    121a:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    121f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1226:	00 00 
    1228:	75 0a                	jne    1234 <main+0xab>
