...
/app/bin_gccgcc8_O0/2023_07_15-Lesson-b:     file format elf64-x86-64
...
00000000000010c0 <strlen@plt>:
    ...
    10c4:	f2 ff 25 cd 2e 00 00 	bnd jmpq *0x2ecd(%rip)        # 3f98 <strlen@GLIBC_2.2.5>
...
0000000000001100 <__isoc99_scanf@plt>:
    ...
    1104:	f2 ff 25 ad 2e 00 00 	bnd jmpq *0x2ead(%rip)        # 3fb8 <__isoc99_scanf@GLIBC_2.7>
    110b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001110 <strcat@plt>:
    1110:	f3 0f 1e fa          	endbr64 
    1114:	f2 ff 25 a5 2e 00 00 	bnd jmpq *0x2ea5(%rip)        # 3fc0 <strcat@GLIBC_2.2.5>
...
0000000000001140 <_start>:
    ...
    1151:	50                   	push   %rax
    1152:	54                   	push   %rsp
    1153:	4c 8d 05 76 02 00 00 	lea    0x276(%rip),%r8        # 13d0 <__libc_csu_fini>
    115a:	48 8d 0d ff 01 00 00 	lea    0x1ff(%rip),%rcx        # 1360 <__libc_csu_init>
...
0000000000001229 <main>:
    ...
    1236:	bf 10 00 00 00       	mov    $0x10,%edi
    123b:	e8 a0 fe ff ff       	callq  10e0 <malloc@plt>
    1240:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    1244:	bf 01 00 00 00       	mov    $0x1,%edi
    1249:	e8 92 fe ff ff       	callq  10e0 <malloc@plt>
    124e:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    1252:	48 83 7d e8 00       	cmpq   $0x0,-0x18(%rbp)
    1257:	74 07                	je     1260 <main+0x37>
    1259:	48 83 7d e0 00       	cmpq   $0x0,-0x20(%rbp)
    125e:	75 2a                	jne    128a <main+0x61>
    1260:	48 8b 05 b9 2d 00 00 	mov    0x2db9(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    1267:	48 89 c1             	mov    %rax,%rcx
    126a:	ba 18 00 00 00       	mov    $0x18,%edx
    126f:	be 01 00 00 00       	mov    $0x1,%esi
    1274:	48 8d 3d 89 0d 00 00 	lea    0xd89(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    127b:	e8 b0 fe ff ff       	callq  1130 <fwrite@plt>
    1280:	bf 01 00 00 00       	mov    $0x1,%edi
    1285:	e8 96 fe ff ff       	callq  1120 <exit@plt>
    128a:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    128e:	c6 00 00             	movb   $0x0,(%rax)
    1291:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1295:	0f b6 10             	movzbl (%rax),%edx
    1298:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    129c:	88 10                	mov    %dl,(%rax)
    129e:	48 8d 3d 78 0d 00 00 	lea    0xd78(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    12a5:	b8 00 00 00 00       	mov    $0x0,%eax
    12aa:	e8 21 fe ff ff       	callq  10d0 <printf@plt>
    12af:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    12b3:	48 89 c6             	mov    %rax,%rsi
    12b6:	48 8d 3d 67 0d 00 00 	lea    0xd67(%rip),%rdi        # 2024 <_IO_stdin_used+0x24>
    12bd:	b8 00 00 00 00       	mov    $0x0,%eax
    12c2:	e8 39 fe ff ff       	callq  1100 <__isoc99_scanf@plt>
    12c7:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    12cb:	48 89 c7             	mov    %rax,%rdi
    12ce:	e8 ed fd ff ff       	callq  10c0 <strlen@plt>
    12d3:	48 89 c3             	mov    %rax,%rbx
    12d6:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    12da:	48 89 c7             	mov    %rax,%rdi
    12dd:	e8 de fd ff ff       	callq  10c0 <strlen@plt>
    12e2:	48 01 d8             	add    %rbx,%rax
    12e5:	48 8d 50 02          	lea    0x2(%rax),%rdx
    12e9:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    12ed:	48 89 d6             	mov    %rdx,%rsi
    12f0:	48 89 c7             	mov    %rax,%rdi
    12f3:	e8 f8 fd ff ff       	callq  10f0 <realloc@plt>
    12f8:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    12fc:	48 83 7d e0 00       	cmpq   $0x0,-0x20(%rbp)
    1301:	75 2a                	jne    132d <main+0x104>
    1303:	48 8b 05 16 2d 00 00 	mov    0x2d16(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    130a:	48 89 c1             	mov    %rax,%rcx
    130d:	ba 13 00 00 00       	mov    $0x13,%edx
    1312:	be 01 00 00 00       	mov    $0x1,%esi
    1317:	48 8d 3d 09 0d 00 00 	lea    0xd09(%rip),%rdi        # 2027 <_IO_stdin_used+0x27>
    131e:	e8 0d fe ff ff       	callq  1130 <fwrite@plt>
    1323:	bf 01 00 00 00       	mov    $0x1,%edi
    1328:	e8 f3 fd ff ff       	callq  1120 <exit@plt>
    132d:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx
    1331:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1335:	48 89 d6             	mov    %rdx,%rsi
    1338:	48 89 c7             	mov    %rax,%rdi
    133b:	e8 d0 fd ff ff       	callq  1110 <strcat@plt>
    1340:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1344:	48 89 c7             	mov    %rax,%rdi
    1347:	e8 74 fd ff ff       	callq  10c0 <strlen@plt>
    134c:	48 89 c2             	mov    %rax,%rdx
    134f:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1353:	48 01 d0             	add    %rdx,%rax
    1356:	66 c7 00 20 00       	movw   $0x20,(%rax)
    135b:	e9 3e ff ff ff       	jmpq   129e <main+0x75>
