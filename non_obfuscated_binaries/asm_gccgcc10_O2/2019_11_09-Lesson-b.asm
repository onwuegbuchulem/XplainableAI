...
/app/bin_gccgcc10_O2/2019_11_09-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	b9 22 00 00 00       	mov    $0x22,%ecx
    108d:	bf 01 00 00 00       	mov    $0x1,%edi
    1092:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1099:	00 00 
    109b:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    10a0:	31 c0                	xor    %eax,%eax
    10a2:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    10a7:	48 b8 47 65 6f 72 67 	movabs $0x6567726f6547,%rax
    10ae:	65 00 00 
    ...
    10bf:	c7 04 24 22 00 00 00 	movl   $0x22,(%rsp)
    10c6:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%rsp)
    10cd:	00 
    10ce:	e8 9d ff ff ff       	callq  1070 <__printf_chk@plt>
    10d3:	f3 0f 6f 04 24       	movdqu (%rsp),%xmm0
    10d8:	8b 0c 24             	mov    (%rsp),%ecx
    10db:	31 c0                	xor    %eax,%eax
    10dd:	48 8d 54 24 14       	lea    0x14(%rsp),%rdx
    10e2:	48 8d 35 1b 0f 00 00 	lea    0xf1b(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10e9:	bf 01 00 00 00       	mov    $0x1,%edi
    10ee:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10f3:	e8 78 ff ff ff       	callq  1070 <__printf_chk@plt>
    10f8:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    10fd:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1104:	00 00 
    1106:	75 07                	jne    110f <main+0x8f>
    1108:	31 c0                	xor    %eax,%eax
    110a:	48 83 c4 38          	add    $0x38,%rsp
    110e:	c3                   	retq   
    110f:	e8 4c ff ff ff       	callq  1060 <__stack_chk_fail@plt>
