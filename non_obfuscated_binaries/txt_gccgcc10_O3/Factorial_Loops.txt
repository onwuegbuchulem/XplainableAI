...
/app/bin_gccgcc10_O3/Factorial_Loops:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e2:	7e 4a                	jle    112e <main+0x8e>
    10e4:	f2 0f 10 05 4c 0f 00 	movsd  0xf4c(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    10eb:	00 
    10ec:	89 d0                	mov    %edx,%eax
    10ee:	66 90                	xchg   %ax,%ax
    10f0:	66 0f ef c9          	pxor   %xmm1,%xmm1
    10f4:	f2 0f 2a c8          	cvtsi2sd %eax,%xmm1
    10f8:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    10fc:	83 e8 01             	sub    $0x1,%eax
    10ff:	75 ef                	jne    10f0 <main+0x50>
    1101:	48 8d 35 12 0f 00 00 	lea    0xf12(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    1108:	bf 01 00 00 00       	mov    $0x1,%edi
    110d:	b8 01 00 00 00       	mov    $0x1,%eax
    1112:	e8 69 ff ff ff       	callq  1080 <__printf_chk@plt>
    1117:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    111c:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1123:	00 00 
    1125:	75 11                	jne    1138 <main+0x98>
    1127:	31 c0                	xor    %eax,%eax
    1129:	48 83 c4 18          	add    $0x18,%rsp
    112d:	c3                   	retq   
    112e:	f2 0f 10 05 02 0f 00 	movsd  0xf02(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    1135:	00 
    1136:	eb c9                	jmp    1101 <main+0x61>
    1138:	e8 33 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
