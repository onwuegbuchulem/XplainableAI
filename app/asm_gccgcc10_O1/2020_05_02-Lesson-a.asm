...
/app/bin_gccgcc10_O1/2020_05_02-Lesson-a:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    120b:	7e 6f                	jle    127c <main+0x93>
    120d:	48 8b 5e 08          	mov    0x8(%rsi),%rbx
    1211:	48 89 da             	mov    %rbx,%rdx
    1214:	48 8d 35 2d 0e 00 00 	lea    0xe2d(%rip),%rsi        # 2048 <_IO_stdin_used+0x48>
    ...
    123d:	74 53                	je     1292 <main+0xa9>
    123f:	8b 44 24 18          	mov    0x18(%rsp),%eax
    1243:	25 00 f0 00 00       	and    $0xf000,%eax
    1248:	3d 00 80 00 00       	cmp    $0x8000,%eax
    124d:	74 6a                	je     12b9 <main+0xd0>
    124f:	48 8d 3d d9 0d 00 00 	lea    0xdd9(%rip),%rdi        # 202f <_IO_stdin_used+0x2f>
    1256:	e8 45 fe ff ff       	callq  10a0 <puts@plt>
    125b:	48 8b 84 24 98 00 00 	mov    0x98(%rsp),%rax
    1262:	00 
    1263:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    126a:	00 00 
    126c:	75 59                	jne    12c7 <main+0xde>
    126e:	b8 00 00 00 00       	mov    $0x0,%eax
    1273:	48 81 c4 a0 00 00 00 	add    $0xa0,%rsp
    127a:	5b                   	pop    %rbx
    127b:	c3                   	retq   
    127c:	48 8d 3d 81 0d 00 00 	lea    0xd81(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1283:	e8 18 fe ff ff       	callq  10a0 <puts@plt>
    1288:	bf 01 00 00 00       	mov    $0x1,%edi
    128d:	e8 4e fe ff ff       	callq  10e0 <exit@plt>
    1292:	48 8b 0d 87 2d 00 00 	mov    0x2d87(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1299:	ba 0b 00 00 00       	mov    $0xb,%edx
    129e:	be 01 00 00 00       	mov    $0x1,%esi
    12a3:	48 8d 3d 6c 0d 00 00 	lea    0xd6c(%rip),%rdi        # 2016 <_IO_stdin_used+0x16>
    12aa:	e8 41 fe ff ff       	callq  10f0 <fwrite@plt>
    12af:	bf 01 00 00 00       	mov    $0x1,%edi
    12b4:	e8 27 fe ff ff       	callq  10e0 <exit@plt>
    12b9:	48 8d 3d 62 0d 00 00 	lea    0xd62(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    12c0:	e8 db fd ff ff       	callq  10a0 <puts@plt>
    12c5:	eb 94                	jmp    125b <main+0x72>
