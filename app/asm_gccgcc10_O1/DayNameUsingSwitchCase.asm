...
/app/bin_gccgcc10_O1/DayNameUsingSwitchCase:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d2:	48 8d 3d 40 0e 00 00 	lea    0xe40(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	e8 cd fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e3:	83 7c 24 04 07       	cmpl   $0x7,0x4(%rsp)
    11e8:	0f 87 df 00 00 00    	ja     12cd <main+0x124>
    11ee:	8b 44 24 04          	mov    0x4(%rsp),%eax
    11f2:	48 8d 15 9b 0e 00 00 	lea    0xe9b(%rip),%rdx        # 2094 <_IO_stdin_used+0x94>
    11f9:	48 63 04 82          	movslq (%rdx,%rax,4),%rax
    11fd:	48 01 d0             	add    %rdx,%rax
    1200:	3e ff e0             	notrack jmpq *%rax
    1203:	48 8d 35 12 0e 00 00 	lea    0xe12(%rip),%rsi        # 201c <_IO_stdin_used+0x1c>
    120a:	bf 01 00 00 00       	mov    $0x1,%edi
    120f:	b8 00 00 00 00       	mov    $0x0,%eax
    1214:	e8 87 fe ff ff       	callq  10a0 <__printf_chk@plt>
    1219:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    121e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1225:	00 00 
    1227:	0f 85 bb 00 00 00    	jne    12e8 <main+0x13f>
    122d:	b8 00 00 00 00       	mov    $0x0,%eax
    1232:	48 83 c4 18          	add    $0x18,%rsp
    1236:	c3                   	retq   
    1237:	48 8d 35 ec 0d 00 00 	lea    0xdec(%rip),%rsi        # 202a <_IO_stdin_used+0x2a>
    123e:	bf 01 00 00 00       	mov    $0x1,%edi
    1243:	b8 00 00 00 00       	mov    $0x0,%eax
    1248:	e8 53 fe ff ff       	callq  10a0 <__printf_chk@plt>
    124d:	eb ca                	jmp    1219 <main+0x70>
    124f:	48 8d 35 e3 0d 00 00 	lea    0xde3(%rip),%rsi        # 2039 <_IO_stdin_used+0x39>
    1256:	bf 01 00 00 00       	mov    $0x1,%edi
    125b:	b8 00 00 00 00       	mov    $0x0,%eax
    1260:	e8 3b fe ff ff       	callq  10a0 <__printf_chk@plt>
    1265:	eb b2                	jmp    1219 <main+0x70>
    1267:	48 8d 35 dc 0d 00 00 	lea    0xddc(%rip),%rsi        # 204a <_IO_stdin_used+0x4a>
    126e:	bf 01 00 00 00       	mov    $0x1,%edi
    1273:	b8 00 00 00 00       	mov    $0x0,%eax
    1278:	e8 23 fe ff ff       	callq  10a0 <__printf_chk@plt>
    127d:	eb 9a                	jmp    1219 <main+0x70>
    127f:	48 8d 35 d4 0d 00 00 	lea    0xdd4(%rip),%rsi        # 205a <_IO_stdin_used+0x5a>
    1286:	bf 01 00 00 00       	mov    $0x1,%edi
    128b:	b8 00 00 00 00       	mov    $0x0,%eax
    1290:	e8 0b fe ff ff       	callq  10a0 <__printf_chk@plt>
    1295:	eb 82                	jmp    1219 <main+0x70>
    1297:	48 8d 35 ca 0d 00 00 	lea    0xdca(%rip),%rsi        # 2068 <_IO_stdin_used+0x68>
    129e:	bf 01 00 00 00       	mov    $0x1,%edi
    12a3:	b8 00 00 00 00       	mov    $0x0,%eax
    12a8:	e8 f3 fd ff ff       	callq  10a0 <__printf_chk@plt>
    12ad:	e9 67 ff ff ff       	jmpq   1219 <main+0x70>
    12b2:	48 8d 35 bf 0d 00 00 	lea    0xdbf(%rip),%rsi        # 2078 <_IO_stdin_used+0x78>
    12b9:	bf 01 00 00 00       	mov    $0x1,%edi
    12be:	b8 00 00 00 00       	mov    $0x0,%eax
    12c3:	e8 d8 fd ff ff       	callq  10a0 <__printf_chk@plt>
    12c8:	e9 4c ff ff ff       	jmpq   1219 <main+0x70>
    12cd:	48 8d 35 b2 0d 00 00 	lea    0xdb2(%rip),%rsi        # 2086 <_IO_stdin_used+0x86>
    12d4:	bf 01 00 00 00       	mov    $0x1,%edi
    12d9:	b8 00 00 00 00       	mov    $0x0,%eax
    12de:	e8 bd fd ff ff       	callq  10a0 <__printf_chk@plt>
    12e3:	e9 31 ff ff ff       	jmpq   1219 <main+0x70>
    12e8:	e8 a3 fd ff ff       	callq  1090 <__stack_chk_fail@plt>
