...
/app/bin_gccgcc10_O2/string_object:     file format elf64-x86-64
...
00000000000010a0 <strcpy@plt>:
    ...
    10a4:	f2 ff 25 0d 2f 00 00 	bnd jmpq *0x2f0d(%rip)        # 3fb8 <strcpy@GLIBC_2.2.5>
    10ab:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010b0 <strlen@plt>:
    10b0:	f3 0f 1e fa          	endbr64 
    10b4:	f2 ff 25 05 2f 00 00 	bnd jmpq *0x2f05(%rip)        # 3fc0 <strlen@GLIBC_2.2.5>
...
00000000000010e0 <main>:
    ...
    10e4:	55                   	push   %rbp
    10e5:	bf 19 00 00 00       	mov    $0x19,%edi
    10ea:	e8 d1 ff ff ff       	callq  10c0 <malloc@plt>
    10ef:	48 89 c5             	mov    %rax,%rbp
    10f2:	48 85 c0             	test   %rax,%rax
    10f5:	74 1d                	je     1114 <main+0x34>
    10f7:	66 0f 6f 05 31 0f 00 	movdqa 0xf31(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    10fe:	00 
    10ff:	0f 11 00             	movups %xmm0,(%rax)
    1102:	48 b8 67 20 6f 62 6a 	movabs $0x7463656a626f2067,%rax
    1109:	65 63 74 
    110c:	48 89 45 10          	mov    %rax,0x10(%rbp)
    1110:	c6 45 18 00          	movb   $0x0,0x18(%rbp)
    1114:	48 89 ea             	mov    %rbp,%rdx
    1117:	b9 18 00 00 00       	mov    $0x18,%ecx
    111c:	bf 01 00 00 00       	mov    $0x1,%edi
    1121:	31 c0                	xor    %eax,%eax
    1123:	48 8d 35 de 0e 00 00 	lea    0xede(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    112a:	e8 a1 ff ff ff       	callq  10d0 <__printf_chk@plt>
    112f:	48 89 ef             	mov    %rbp,%rdi
    1132:	e8 59 ff ff ff       	callq  1090 <free@plt>
...
0000000000001140 <_start>:
    ...
    1151:	50                   	push   %rax
    1152:	54                   	push   %rsp
    1153:	4c 8d 05 c6 01 00 00 	lea    0x1c6(%rip),%r8        # 1320 <__libc_csu_fini>
    115a:	48 8d 0d 4f 01 00 00 	lea    0x14f(%rip),%rcx        # 12b0 <__libc_csu_init>
...
0000000000001230 <string_create>:
    1230:	f3 0f 1e fa          	endbr64 
    1234:	48 85 ff             	test   %rdi,%rdi
    1237:	74 4f                	je     1288 <string_create+0x58>
    1239:	55                   	push   %rbp
    123a:	48 89 f5             	mov    %rsi,%rbp
    123d:	53                   	push   %rbx
    123e:	48 89 fb             	mov    %rdi,%rbx
    1241:	48 89 f7             	mov    %rsi,%rdi
    1244:	48 83 ec 08          	sub    $0x8,%rsp
    1248:	e8 63 fe ff ff       	callq  10b0 <strlen@plt>
    124d:	89 43 08             	mov    %eax,0x8(%rbx)
    1250:	48 98                	cltq   
    1252:	48 8d 78 01          	lea    0x1(%rax),%rdi
    1256:	e8 65 fe ff ff       	callq  10c0 <malloc@plt>
    125b:	48 89 03             	mov    %rax,(%rbx)
    125e:	48 89 c7             	mov    %rax,%rdi
    1261:	48 85 c0             	test   %rax,%rax
    1264:	74 14                	je     127a <string_create+0x4a>
    1266:	48 89 ee             	mov    %rbp,%rsi
    1269:	e8 32 fe ff ff       	callq  10a0 <strcpy@plt>
    126e:	48 83 c4 08          	add    $0x8,%rsp
    1272:	b8 01 00 00 00       	mov    $0x1,%eax
    1277:	5b                   	pop    %rbx
    1278:	5d                   	pop    %rbp
    1279:	c3                   	retq   
    127a:	48 83 c4 08          	add    $0x8,%rsp
...
0000000000001290 <string_destroy>:
    1290:	f3 0f 1e fa          	endbr64 
    1294:	53                   	push   %rbx
    1295:	48 89 fb             	mov    %rdi,%rbx
    1298:	48 8b 3f             	mov    (%rdi),%rdi
    129b:	e8 f0 fd ff ff       	callq  1090 <free@plt>
    12a0:	48 c7 03 00 00 00 00 	movq   $0x0,(%rbx)
    12a7:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%rbx)
    12ae:	5b                   	pop    %rbx
    12af:	c3                   	retq   
