...
/app/bin_gccgcc10_O0/2019_07_06-Lesson:     file format elf64-x86-64
...
0000000000001090 <strtol@plt>:
    ...
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <strtol@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    11a4:	c7 45 e3 31 32 33 34 	movl   $0x34333231,-0x1d(%rbp)
    11ab:	66 c7 45 e7 35 36    	movw   $0x3635,-0x19(%rbp)
    11b1:	c6 45 e9 00          	movb   $0x0,-0x17(%rbp)
    11b5:	c7 45 ea 30 30 33 32 	movl   $0x32333030,-0x16(%rbp)
    11bc:	66 c7 45 ee 32 34    	movw   $0x3432,-0x12(%rbp)
    11c2:	c6 45 f0 00          	movb   $0x0,-0x10(%rbp)
    11c6:	c7 45 f1 30 78 41 37 	movl   $0x37417830,-0xf(%rbp)
    11cd:	66 c7 45 f5 32 42    	movw   $0x4232,-0xb(%rbp)
    11d3:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    11d7:	48 8d 45 e3          	lea    -0x1d(%rbp),%rax
    11db:	ba 0a 00 00 00       	mov    $0xa,%edx
    11e0:	be 00 00 00 00       	mov    $0x0,%esi
    11e5:	48 89 c7             	mov    %rax,%rdi
    11e8:	e8 a3 fe ff ff       	callq  1090 <strtol@plt>
    11ed:	89 45 d4             	mov    %eax,-0x2c(%rbp)
    11f0:	48 8d 45 ea          	lea    -0x16(%rbp),%rax
    11f4:	ba 08 00 00 00       	mov    $0x8,%edx
    11f9:	be 00 00 00 00       	mov    $0x0,%esi
    11fe:	48 89 c7             	mov    %rax,%rdi
    1201:	e8 8a fe ff ff       	callq  1090 <strtol@plt>
    1206:	89 45 d8             	mov    %eax,-0x28(%rbp)
    1209:	48 8d 45 f1          	lea    -0xf(%rbp),%rax
    120d:	ba 10 00 00 00       	mov    $0x10,%edx
    1212:	be 00 00 00 00       	mov    $0x0,%esi
    1217:	48 89 c7             	mov    %rax,%rdi
    121a:	e8 71 fe ff ff       	callq  1090 <strtol@plt>
    121f:	89 45 dc             	mov    %eax,-0x24(%rbp)
    1222:	8b 55 d4             	mov    -0x2c(%rbp),%edx
    1225:	48 8d 45 e3          	lea    -0x1d(%rbp),%rax
    ...
    1238:	e8 43 fe ff ff       	callq  1080 <printf@plt>
    123d:	8b 55 d8             	mov    -0x28(%rbp),%edx
    1240:	48 8d 45 ea          	lea    -0x16(%rbp),%rax
    1244:	48 89 c6             	mov    %rax,%rsi
    1247:	48 8d 3d c9 0d 00 00 	lea    0xdc9(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    124e:	b8 00 00 00 00       	mov    $0x0,%eax
    1253:	e8 28 fe ff ff       	callq  1080 <printf@plt>
    1258:	8b 55 dc             	mov    -0x24(%rbp),%edx
    125b:	48 8d 45 f1          	lea    -0xf(%rbp),%rax
    125f:	48 89 c6             	mov    %rax,%rsi
    1262:	48 8d 3d c0 0d 00 00 	lea    0xdc0(%rip),%rdi        # 2029 <_IO_stdin_used+0x29>
    1269:	b8 00 00 00 00       	mov    $0x0,%eax
    126e:	e8 0d fe ff ff       	callq  1080 <printf@plt>
    1273:	b8 00 00 00 00       	mov    $0x0,%eax
    1278:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    127c:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1283:	00 00 
    1285:	74 05                	je     128c <main+0x103>
    1287:	e8 e4 fd ff ff       	callq  1070 <__stack_chk_fail@plt>
    128c:	c9                   	leaveq 
    128d:	c3                   	retq   
