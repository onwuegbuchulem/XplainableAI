...
/app/bin_gccgcc10_O1/2022_04_16-Lesson-a:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d1:	48 83 c4 08          	add    $0x8,%rsp
    11d5:	c3                   	retq   
    11d6:	48 8b 0d 43 2e 00 00 	mov    0x2e43(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    11dd:	ba 1a 00 00 00       	mov    $0x1a,%edx
    11e2:	be 01 00 00 00       	mov    $0x1,%esi
    11e7:	48 8d 3d 16 0e 00 00 	lea    0xe16(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11ee:	e8 bd fe ff ff       	callq  10b0 <fwrite@plt>
    11f3:	bf 01 00 00 00       	mov    $0x1,%edi
    11f8:	e8 a3 fe ff ff       	callq  10a0 <exit@plt>
