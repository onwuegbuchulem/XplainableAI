...
/app/bin_gccgcc10_O0/readdir02:     file format elf64-x86-64
...
00000000000010d0 <closedir@plt>:
    10d0:	f3 0f 1e fa          	endbr64 
    10d4:	f2 ff 25 e5 2e 00 00 	bnd jmpq *0x2ee5(%rip)        # 3fc0 <closedir@GLIBC_2.2.5>
    10db:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010e0 <readdir@plt>:
    10e0:	f3 0f 1e fa          	endbr64 
    10e4:	f2 ff 25 dd 2e 00 00 	bnd jmpq *0x2edd(%rip)        # 3fc8 <readdir@GLIBC_2.2.5>
...
00000000000011e9 <main>:
    ...
    11fc:	e8 af fe ff ff       	callq  10b0 <opendir@plt>
    1201:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    1205:	48 83 7d f0 00       	cmpq   $0x0,-0x10(%rbp)
    120a:	75 16                	jne    1222 <main+0x39>
    120c:	48 8d 3d f3 0d 00 00 	lea    0xdf3(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1213:	e8 88 fe ff ff       	callq  10a0 <puts@plt>
    1218:	bf 01 00 00 00       	mov    $0x1,%edi
    121d:	e8 ce fe ff ff       	callq  10f0 <exit@plt>
    1222:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1226:	48 89 c7             	mov    %rax,%rdi
    1229:	e8 b2 fe ff ff       	callq  10e0 <readdir@plt>
    122e:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1232:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1236:	48 83 c0 13          	add    $0x13,%rax
    123a:	48 89 c6             	mov    %rax,%rsi
    123d:	48 8d 3d db 0d 00 00 	lea    0xddb(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    ...
    1255:	e8 76 fe ff ff       	callq  10d0 <closedir@plt>
