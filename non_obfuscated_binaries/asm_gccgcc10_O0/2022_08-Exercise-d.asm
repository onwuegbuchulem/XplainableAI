...
/app/bin_gccgcc10_O0/2022_08-Exercise-d:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c6 45 bb 41          	movb   $0x41,-0x45(%rbp)
    1188:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%rbp)
    118f:	eb 1b                	jmp    11ac <main+0x43>
    1191:	8b 45 bc             	mov    -0x44(%rbp),%eax
    1194:	48 98                	cltq   
    1196:	0f b6 55 bb          	movzbl -0x45(%rbp),%edx
    119a:	88 54 05 c0          	mov    %dl,-0x40(%rbp,%rax,1)
    119e:	0f b6 45 bb          	movzbl -0x45(%rbp),%eax
    11a2:	83 c0 01             	add    $0x1,%eax
    11a5:	88 45 bb             	mov    %al,-0x45(%rbp)
    11a8:	83 45 bc 02          	addl   $0x2,-0x44(%rbp)
    11ac:	83 7d bc 33          	cmpl   $0x33,-0x44(%rbp)
    11b0:	7e df                	jle    1191 <main+0x28>
    11b2:	c6 45 bb 61          	movb   $0x61,-0x45(%rbp)
    11b6:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%rbp)
    11bd:	eb 1e                	jmp    11dd <main+0x74>
    11bf:	8b 45 bc             	mov    -0x44(%rbp),%eax
    11c2:	83 c0 01             	add    $0x1,%eax
    11c5:	48 98                	cltq   
    11c7:	0f b6 55 bb          	movzbl -0x45(%rbp),%edx
    11cb:	88 54 05 c0          	mov    %dl,-0x40(%rbp,%rax,1)
    11cf:	0f b6 45 bb          	movzbl -0x45(%rbp),%eax
    11d3:	83 c0 01             	add    $0x1,%eax
    11d6:	88 45 bb             	mov    %al,-0x45(%rbp)
    11d9:	83 45 bc 02          	addl   $0x2,-0x44(%rbp)
    11dd:	83 7d bc 33          	cmpl   $0x33,-0x44(%rbp)
    11e1:	7e dc                	jle    11bf <main+0x56>
    11e3:	c6 45 f4 00          	movb   $0x0,-0xc(%rbp)
    11e7:	48 8d 45 c0          	lea    -0x40(%rbp),%rax
    ...
    11fc:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1203:	00 00 
