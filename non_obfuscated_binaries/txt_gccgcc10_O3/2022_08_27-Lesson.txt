...
/app/bin_gccgcc10_O3/2022_08_27-Lesson:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1078:	41 89 d8             	mov    %ebx,%r8d
    107b:	89 d9                	mov    %ebx,%ecx
    107d:	89 da                	mov    %ebx,%edx
    107f:	48 89 ee             	mov    %rbp,%rsi
    1082:	41 f7 d8             	neg    %r8d
    1085:	bf 01 00 00 00       	mov    $0x1,%edi
    108a:	31 c0                	xor    %eax,%eax
    108c:	41 21 d8             	and    %ebx,%r8d
    108f:	83 c3 01             	add    $0x1,%ebx
    1092:	e8 b9 ff ff ff       	callq  1050 <__printf_chk@plt>
    1097:	81 fb 1a 04 00 00    	cmp    $0x41a,%ebx
    109d:	75 d9                	jne    1078 <main+0x18>
