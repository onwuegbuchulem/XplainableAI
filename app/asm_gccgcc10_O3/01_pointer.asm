...
/app/bin_gccgcc10_O3/01_pointer:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10a6:	49 89 e4             	mov    %rsp,%r12
    10a9:	c7 04 24 48 00 00 00 	movl   $0x48,(%rsp)
    10b0:	4c 89 e2             	mov    %r12,%rdx
    10b3:	c7 44 24 04 43 00 00 	movl   $0x43,0x4(%rsp)
    10ba:	00 
    ...
    10d6:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    10db:	48 8d 35 22 0f 00 00 	lea    0xf22(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10e2:	31 c0                	xor    %eax,%eax
    10e4:	bf 01 00 00 00       	mov    $0x1,%edi
    10e9:	e8 82 ff ff ff       	callq  1070 <__printf_chk@plt>
    10ee:	8b 14 24             	mov    (%rsp),%edx
    10f1:	31 c0                	xor    %eax,%eax
    10f3:	bf 01 00 00 00       	mov    $0x1,%edi
    10f8:	48 8d 35 1d 0f 00 00 	lea    0xf1d(%rip),%rsi        # 201c <_IO_stdin_used+0x1c>
    10ff:	e8 6c ff ff ff       	callq  1070 <__printf_chk@plt>
    1104:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1109:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1110:	00 00 
    1112:	75 09                	jne    111d <main+0x9d>
    1114:	48 83 c4 10          	add    $0x10,%rsp
