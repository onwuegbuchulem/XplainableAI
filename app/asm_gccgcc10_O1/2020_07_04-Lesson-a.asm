...
/app/bin_gccgcc10_O1/2020_07_04-Lesson-a:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	ba 08 00 00 00       	mov    $0x8,%edx
    ...
    116c:	ba 10 00 00 00       	mov    $0x10,%edx
    1171:	48 8d 35 9e 0e 00 00 	lea    0xe9e(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    1178:	bf 01 00 00 00       	mov    $0x1,%edi
    117d:	b8 00 00 00 00       	mov    $0x0,%eax
    1182:	e8 c9 fe ff ff       	callq  1050 <__printf_chk@plt>
    1187:	ba 20 00 00 00       	mov    $0x20,%edx
    118c:	48 8d 35 96 0e 00 00 	lea    0xe96(%rip),%rsi        # 2029 <_IO_stdin_used+0x29>
    1193:	bf 01 00 00 00       	mov    $0x1,%edi
    1198:	b8 00 00 00 00       	mov    $0x0,%eax
    119d:	e8 ae fe ff ff       	callq  1050 <__printf_chk@plt>
    11a2:	ba 40 00 00 00       	mov    $0x40,%edx
    11a7:	48 8d 35 91 0e 00 00 	lea    0xe91(%rip),%rsi        # 203f <_IO_stdin_used+0x3f>
    11ae:	bf 01 00 00 00       	mov    $0x1,%edi
    11b3:	b8 00 00 00 00       	mov    $0x0,%eax
    11b8:	e8 93 fe ff ff       	callq  1050 <__printf_chk@plt>
    11bd:	ba 40 00 00 00       	mov    $0x40,%edx
    11c2:	48 8d 35 71 0e 00 00 	lea    0xe71(%rip),%rsi        # 203a <_IO_stdin_used+0x3a>
    11c9:	bf 01 00 00 00       	mov    $0x1,%edi
    11ce:	b8 00 00 00 00       	mov    $0x0,%eax
    11d3:	e8 78 fe ff ff       	callq  1050 <__printf_chk@plt>
