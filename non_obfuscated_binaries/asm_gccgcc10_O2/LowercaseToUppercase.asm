...
/app/bin_gccgcc10_O2/LowercaseToUppercase:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e9:	48 8d 3d 47 0f 00 00 	lea    0xf47(%rip),%rdi        # 2037 <_IO_stdin_used+0x37>
    10f0:	31 c0                	xor    %eax,%eax
    10f2:	e8 b9 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10f7:	0f be 54 24 07       	movsbl 0x7(%rsp),%edx
    10fc:	31 c0                	xor    %eax,%eax
    10fe:	48 8d 35 1d 0f 00 00 	lea    0xf1d(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    1105:	bf 01 00 00 00       	mov    $0x1,%edi
    110a:	83 ea 20             	sub    $0x20,%edx
    110d:	e8 8e ff ff ff       	callq  10a0 <__printf_chk@plt>
    1112:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1117:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    111e:	00 00 
    1120:	75 07                	jne    1129 <main+0x69>
