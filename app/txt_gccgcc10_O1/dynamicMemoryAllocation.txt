...
/app/bin_gccgcc10_O1/dynamicMemoryAllocation:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	53                   	push   %rbx
    118e:	bf 00 01 00 00       	mov    $0x100,%edi
    1193:	e8 e8 fe ff ff       	callq  1080 <malloc@plt>
    1198:	48 89 c3             	mov    %rax,%rbx
    119b:	4c 8d 0d 62 0e 00 00 	lea    0xe62(%rip),%r9        # 2004 <_IO_stdin_used+0x4>
    11a2:	4c 8d 05 67 0e 00 00 	lea    0xe67(%rip),%r8        # 2010 <_IO_stdin_used+0x10>
    11a9:	b9 00 01 00 00       	mov    $0x100,%ecx
    11ae:	ba 01 00 00 00       	mov    $0x1,%edx
    11b3:	be 00 01 00 00       	mov    $0x100,%esi
    11b8:	48 89 c7             	mov    %rax,%rdi
    11bb:	b8 00 00 00 00       	mov    $0x0,%eax
    11c0:	e8 ab fe ff ff       	callq  1070 <__snprintf_chk@plt>
    11c5:	48 89 da             	mov    %rbx,%rdx
    ...
    11d9:	e8 b2 fe ff ff       	callq  1090 <__printf_chk@plt>
    11de:	5b                   	pop    %rbx
    11df:	c3                   	retq   
