...
/app/bin_gccgcc10_O0/2022_07_30-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1195:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    119c:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    11a3:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11a6:	89 45 f0             	mov    %eax,-0x10(%rbp)
    11a9:	e9 9a 00 00 00       	jmpq   1248 <main+0xbf>
    11ae:	48 8d 3d 4f 0e 00 00 	lea    0xe4f(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11b5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ba:	e8 c1 fe ff ff       	callq  1080 <printf@plt>
    11bf:	e8 cc fe ff ff       	callq  1090 <getchar@plt>
    11c4:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11c7:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11ca:	83 e8 41             	sub    $0x41,%eax
    11cd:	83 f8 22             	cmp    $0x22,%eax
    11d0:	77 5f                	ja     1231 <main+0xa8>
    11d2:	89 c0                	mov    %eax,%eax
    11d4:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
    11db:	00 
    11dc:	48 8d 05 a9 0e 00 00 	lea    0xea9(%rip),%rax        # 208c <_IO_stdin_used+0x8c>
    11e3:	8b 04 02             	mov    (%rdx,%rax,1),%eax
    11e6:	48 98                	cltq   
    11e8:	48 8d 15 9d 0e 00 00 	lea    0xe9d(%rip),%rdx        # 208c <_IO_stdin_used+0x8c>
    11ef:	48 01 d0             	add    %rdx,%rax
    11f2:	3e ff e0             	notrack jmpq *%rax
    11f5:	48 8d 3d 25 0e 00 00 	lea    0xe25(%rip),%rdi        # 2021 <_IO_stdin_used+0x21>
    11fc:	e8 6f fe ff ff       	callq  1070 <puts@plt>
    1201:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1204:	89 45 f0             	mov    %eax,-0x10(%rbp)
    1207:	eb 3f                	jmp    1248 <main+0xbf>
    1209:	48 8d 3d 27 0e 00 00 	lea    0xe27(%rip),%rdi        # 2037 <_IO_stdin_used+0x37>
    1210:	e8 5b fe ff ff       	callq  1070 <puts@plt>
    1215:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1218:	89 45 f0             	mov    %eax,-0x10(%rbp)
    121b:	eb 2b                	jmp    1248 <main+0xbf>
    121d:	48 8d 3d 29 0e 00 00 	lea    0xe29(%rip),%rdi        # 204d <_IO_stdin_used+0x4d>
    1224:	e8 47 fe ff ff       	callq  1070 <puts@plt>
    1229:	8b 45 f4             	mov    -0xc(%rbp),%eax
    122c:	89 45 f0             	mov    %eax,-0x10(%rbp)
    122f:	eb 17                	jmp    1248 <main+0xbf>
    1231:	48 8d 3d 2b 0e 00 00 	lea    0xe2b(%rip),%rdi        # 2063 <_IO_stdin_used+0x63>
    1238:	e8 33 fe ff ff       	callq  1070 <puts@plt>
    123d:	90                   	nop
    123e:	e8 4d fe ff ff       	callq  1090 <getchar@plt>
    1243:	83 f8 0a             	cmp    $0xa,%eax
    1246:	75 f6                	jne    123e <main+0xb5>
    1248:	83 7d f0 00          	cmpl   $0x0,-0x10(%rbp)
    124c:	0f 84 5c ff ff ff    	je     11ae <main+0x25>
    1252:	48 8d 3d 19 0e 00 00 	lea    0xe19(%rip),%rdi        # 2072 <_IO_stdin_used+0x72>
    1259:	e8 12 fe ff ff       	callq  1070 <puts@plt>
