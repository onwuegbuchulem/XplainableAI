...
/app/bin_gccgcc10_O2/2021_09-Exercise:     file format elf64-x86-64
...
0000000000001320 <scramble>:
    ...
    1324:	41 55                	push   %r13
    1326:	49 89 fd             	mov    %rdi,%r13
    1329:	8d 7e 01             	lea    0x1(%rsi),%edi
    132c:	41 54                	push   %r12
    132e:	48 63 ff             	movslq %edi,%rdi
    1331:	55                   	push   %rbp
    1332:	53                   	push   %rbx
    1333:	89 f3                	mov    %esi,%ebx
    1335:	be 01 00 00 00       	mov    $0x1,%esi
    133a:	48 83 ec 08          	sub    $0x8,%rsp
    133e:	e8 dd fd ff ff       	callq  1120 <calloc@plt>
    1343:	48 85 c0             	test   %rax,%rax
    1346:	74 46                	je     138e <scramble+0x6e>
    1348:	48 89 c5             	mov    %rax,%rbp
    134b:	45 31 e4             	xor    %r12d,%r12d
    134e:	eb 13                	jmp    1363 <scramble+0x43>
    1350:	e8 1b fe ff ff       	callq  1170 <rand@plt>
    1355:	99                   	cltd   
    1356:	f7 fb                	idiv   %ebx
    1358:	48 63 d2             	movslq %edx,%rdx
    135b:	48 01 ea             	add    %rbp,%rdx
    135e:	80 3a 00             	cmpb   $0x0,(%rdx)
    1361:	74 1d                	je     1380 <scramble+0x60>
    1363:	44 39 e3             	cmp    %r12d,%ebx
    1366:	7f e8                	jg     1350 <scramble+0x30>
    1368:	48 83 c4 08          	add    $0x8,%rsp
    136c:	48 89 ee             	mov    %rbp,%rsi
    136f:	4c 89 ef             	mov    %r13,%rdi
    1372:	5b                   	pop    %rbx
    1373:	5d                   	pop    %rbp
    1374:	41 5c                	pop    %r12
    1376:	41 5d                	pop    %r13
    1378:	e9 63 fd ff ff       	jmpq   10e0 <strcpy@plt>
    137d:	0f 1f 00             	nopl   (%rax)
    1380:	43 0f b6 44 25 00    	movzbl 0x0(%r13,%r12,1),%eax
    1386:	49 83 c4 01          	add    $0x1,%r12
    138a:	88 02                	mov    %al,(%rdx)
    138c:	eb d5                	jmp    1363 <scramble+0x43>
    138e:	48 8b 0d 8b 2c 00 00 	mov    0x2c8b(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1395:	ba 18 00 00 00       	mov    $0x18,%edx
    139a:	be 01 00 00 00       	mov    $0x1,%esi
    139f:	48 8d 3d 5e 0c 00 00 	lea    0xc5e(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    13a6:	e8 b5 fd ff ff       	callq  1160 <fwrite@plt>
    13ab:	bf 01 00 00 00       	mov    $0x1,%edi
    13b0:	e8 9b fd ff ff       	callq  1150 <exit@plt>
