...
/app/bin_gccgcc9_O0/Gross_Salary:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d0:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    ...
    11e8:	48 8d 3d 32 0e 00 00 	lea    0xe32(%rip),%rdi        # 2021 <_IO_stdin_used+0x21>
    11ef:	e8 8c fe ff ff       	callq  1080 <puts@plt>
    11f4:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    11f8:	48 89 c6             	mov    %rax,%rsi
    11fb:	48 8d 3d 1c 0e 00 00 	lea    0xe1c(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    1202:	b8 00 00 00 00       	mov    $0x0,%eax
    1207:	e8 a4 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    120c:	48 8d 3d 1f 0e 00 00 	lea    0xe1f(%rip),%rdi        # 2032 <_IO_stdin_used+0x32>
    1213:	e8 68 fe ff ff       	callq  1080 <puts@plt>
    1218:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    121c:	48 89 c6             	mov    %rax,%rsi
    121f:	48 8d 3d f8 0d 00 00 	lea    0xdf8(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    1226:	b8 00 00 00 00       	mov    $0x0,%eax
    122b:	e8 80 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1230:	f3 0f 10 4d ec       	movss  -0x14(%rbp),%xmm1
    1235:	f3 0f 10 45 e8       	movss  -0x18(%rbp),%xmm0
    123a:	f3 0f 58 c8          	addss  %xmm0,%xmm1
    123e:	f3 0f 10 45 f0       	movss  -0x10(%rbp),%xmm0
    1243:	f3 0f 10 1d 19 0e 00 	movss  0xe19(%rip),%xmm3        # 2064 <_IO_stdin_used+0x64>
    124a:	00 
    124b:	0f 28 d0             	movaps %xmm0,%xmm2
    124e:	f3 0f 5e d3          	divss  %xmm3,%xmm2
    1252:	f3 0f 10 05 0e 0e 00 	movss  0xe0e(%rip),%xmm0        # 2068 <_IO_stdin_used+0x68>
    1259:	00 
    125a:	f3 0f 58 c2          	addss  %xmm2,%xmm0
    125e:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    1262:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    1267:	66 0f ef e4          	pxor   %xmm4,%xmm4
    126b:	f3 0f 5a 65 f4       	cvtss2sd -0xc(%rbp),%xmm4
    1270:	66 48 0f 7e e0       	movq   %xmm4,%rax
    1275:	66 48 0f 6e c0       	movq   %rax,%xmm0
    127a:	48 8d 3d cf 0d 00 00 	lea    0xdcf(%rip),%rdi        # 2050 <_IO_stdin_used+0x50>
    1281:	b8 01 00 00 00       	mov    $0x1,%eax
    1286:	e8 15 fe ff ff       	callq  10a0 <printf@plt>
    128b:	90                   	nop
    128c:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1290:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1297:	00 00 
    1299:	74 05                	je     12a0 <main+0xf7>
    129b:	e8 f0 fd ff ff       	callq  1090 <__stack_chk_fail@plt>
    12a0:	c9                   	leaveq 
    12a1:	c3                   	retq   
