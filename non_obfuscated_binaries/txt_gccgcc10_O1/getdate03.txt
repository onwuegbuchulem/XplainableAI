...
/app/bin_gccgcc10_O1/getdate03:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1217:	00 
    1218:	48 89 e7             	mov    %rsp,%rdi
    121b:	e8 60 fe ff ff       	callq  1080 <mktime@plt>
    1220:	48 63 44 24 18       	movslq 0x18(%rsp),%rax
    1225:	8b 54 24 10          	mov    0x10(%rsp),%edx
    1229:	83 c2 01             	add    $0x1,%edx
    122c:	4c 8b 4c c4 40       	mov    0x40(%rsp,%rax,8),%r9
    1231:	8b 44 24 14          	mov    0x14(%rsp),%eax
    1235:	44 8d 80 6c 07 00 00 	lea    0x76c(%rax),%r8d
    123c:	8b 4c 24 0c          	mov    0xc(%rsp),%ecx
    1240:	48 8d 35 f6 0d 00 00 	lea    0xdf6(%rip),%rsi        # 203d <_IO_stdin_used+0x3d>
    1247:	bf 01 00 00 00       	mov    $0x1,%edi
    124c:	b8 00 00 00 00       	mov    $0x0,%eax
    1251:	e8 3a fe ff ff       	callq  1090 <__printf_chk@plt>
    1256:	48 8b 84 24 88 00 00 	mov    0x88(%rsp),%rax
    125d:	00 
    125e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1265:	00 00 
    1267:	75 0d                	jne    1276 <main+0xed>
    1269:	b8 00 00 00 00       	mov    $0x0,%eax
    126e:	48 81 c4 98 00 00 00 	add    $0x98,%rsp
    1275:	c3                   	retq   
    1276:	e8 f5 fd ff ff       	callq  1070 <__stack_chk_fail@plt>
