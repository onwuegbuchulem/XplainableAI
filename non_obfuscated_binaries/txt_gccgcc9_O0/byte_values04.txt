...
/app/bin_gccgcc9_O0/byte_values04:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1191:	48 81 ec 20 01 00 00 	sub    $0x120,%rsp
    1198:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    119f:	00 00 
    11a1:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11a5:	31 c0                	xor    %eax,%eax
    11a7:	c7 85 ec fe ff ff 00 	movl   $0x0,-0x114(%rbp)
    11ae:	00 00 00 
    11b1:	eb 1e                	jmp    11d1 <main+0x48>
    11b3:	8b 85 ec fe ff ff    	mov    -0x114(%rbp),%eax
    11b9:	89 c2                	mov    %eax,%edx
    11bb:	8b 85 ec fe ff ff    	mov    -0x114(%rbp),%eax
    11c1:	48 98                	cltq   
    11c3:	88 94 05 f0 fe ff ff 	mov    %dl,-0x110(%rbp,%rax,1)
    11ca:	83 85 ec fe ff ff 01 	addl   $0x1,-0x114(%rbp)
    11d1:	81 bd ec fe ff ff ff 	cmpl   $0xff,-0x114(%rbp)
    11d8:	00 00 00 
    11db:	7e d6                	jle    11b3 <main+0x2a>
    11dd:	c7 85 ec fe ff ff 00 	movl   $0x0,-0x114(%rbp)
    11e4:	00 00 00 
    11e7:	e9 87 00 00 00       	jmpq   1273 <main+0xea>
    11ec:	8b 85 ec fe ff ff    	mov    -0x114(%rbp),%eax
    11f2:	83 e0 0f             	and    $0xf,%eax
    11f5:	85 c0                	test   %eax,%eax
    11f7:	75 19                	jne    1212 <main+0x89>
    11f9:	8b 85 ec fe ff ff    	mov    -0x114(%rbp),%eax
    ...
    1212:	8b 85 ec fe ff ff    	mov    -0x114(%rbp),%eax
    1218:	48 98                	cltq   
    121a:	0f b6 84 05 f0 fe ff 	movzbl -0x110(%rbp,%rax,1),%eax
    1221:	ff 
    1222:	0f b6 c0             	movzbl %al,%eax
    1225:	89 c6                	mov    %eax,%esi
    1227:	48 8d 3d dc 0d 00 00 	lea    0xddc(%rip),%rdi        # 200a <_IO_stdin_used+0xa>
    122e:	b8 00 00 00 00       	mov    $0x0,%eax
    1233:	e8 58 fe ff ff       	callq  1090 <printf@plt>
    1238:	8b 85 ec fe ff ff    	mov    -0x114(%rbp),%eax
    123e:	83 c0 01             	add    $0x1,%eax
    1241:	83 e0 07             	and    $0x7,%eax
    1244:	85 c0                	test   %eax,%eax
    1246:	75 0a                	jne    1252 <main+0xc9>
    1248:	bf 20 00 00 00       	mov    $0x20,%edi
    124d:	e8 1e fe ff ff       	callq  1070 <putchar@plt>
    1252:	8b 85 ec fe ff ff    	mov    -0x114(%rbp),%eax
    1258:	83 c0 01             	add    $0x1,%eax
    125b:	83 e0 0f             	and    $0xf,%eax
    125e:	85 c0                	test   %eax,%eax
    1260:	75 0a                	jne    126c <main+0xe3>
    1262:	bf 0a 00 00 00       	mov    $0xa,%edi
    1267:	e8 04 fe ff ff       	callq  1070 <putchar@plt>
    126c:	83 85 ec fe ff ff 01 	addl   $0x1,-0x114(%rbp)
    1273:	81 bd ec fe ff ff ff 	cmpl   $0xff,-0x114(%rbp)
    127a:	00 00 00 
    127d:	0f 8e 69 ff ff ff    	jle    11ec <main+0x63>
    1283:	b8 00 00 00 00       	mov    $0x0,%eax
    1288:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    128c:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1293:	00 00 
