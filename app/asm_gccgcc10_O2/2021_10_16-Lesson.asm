...
/app/bin_gccgcc10_O2/2021_10_16-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1097:	00 00 
    1099:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    109e:	31 c0                	xor    %eax,%eax
    10a0:	48 89 e7             	mov    %rsp,%rdi
    10a3:	c7 44 24 20 3f 3f 2d 	movl   $0x2d3f3f,0x20(%rsp)
    10aa:	00 
    10ab:	0f 11 04 24          	movups %xmm0,(%rsp)
    10af:	66 0f 6f 05 69 0f 00 	movdqa 0xf69(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10b6:	00 
    10b7:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10bc:	e8 9f ff ff ff       	callq  1060 <puts@plt>
    10c1:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    10c6:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10cd:	00 00 
    10cf:	75 07                	jne    10d8 <main+0x58>
    10d1:	31 c0                	xor    %eax,%eax
    10d3:	48 83 c4 38          	add    $0x38,%rsp
    10d7:	c3                   	retq   
    10d8:	e8 93 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
