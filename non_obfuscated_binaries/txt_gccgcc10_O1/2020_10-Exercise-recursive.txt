...
/app/bin_gccgcc10_O1/2020_10-Exercise-recursive:     file format elf64-x86-64
...
0000000000001189 <cumulative>:
    1189:	f3 0f 1e fa          	endbr64 
    118d:	53                   	push   %rbx
    118e:	89 fb                	mov    %edi,%ebx
    1190:	85 ff                	test   %edi,%edi
    1192:	75 04                	jne    1198 <cumulative+0xf>
    1194:	89 d8                	mov    %ebx,%eax
    1196:	5b                   	pop    %rbx
    1197:	c3                   	retq   
    1198:	8d 7f ff             	lea    -0x1(%rdi),%edi
    119b:	e8 e9 ff ff ff       	callq  1189 <cumulative>
    11a0:	01 c3                	add    %eax,%ebx
    11a2:	eb f0                	jmp    1194 <cumulative+0xb>
...
00000000000011a4 <main>:
    ...
    11bd:	48 8d 35 44 0e 00 00 	lea    0xe44(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    11c4:	bf 01 00 00 00       	mov    $0x1,%edi
    11c9:	e8 b2 fe ff ff       	callq  1080 <__printf_chk@plt>
    11ce:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11d3:	48 8d 3d 7b 0e 00 00 	lea    0xe7b(%rip),%rdi        # 2055 <_IO_stdin_used+0x55>
    11da:	b8 00 00 00 00       	mov    $0x0,%eax
    11df:	e8 ac fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11e4:	8b 5c 24 04          	mov    0x4(%rsp),%ebx
    11e8:	89 df                	mov    %ebx,%edi
    11ea:	e8 9a ff ff ff       	callq  1189 <cumulative>
    11ef:	89 c1                	mov    %eax,%ecx
    11f1:	89 da                	mov    %ebx,%edx
    11f3:	48 8d 35 2e 0e 00 00 	lea    0xe2e(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    11fa:	bf 01 00 00 00       	mov    $0x1,%edi
    11ff:	b8 00 00 00 00       	mov    $0x0,%eax
    1204:	e8 77 fe ff ff       	callq  1080 <__printf_chk@plt>
    1209:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    120e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1215:	00 00 
    1217:	75 0b                	jne    1224 <main+0x80>
    1219:	b8 00 00 00 00       	mov    $0x0,%eax
    121e:	48 83 c4 10          	add    $0x10,%rsp
    1222:	5b                   	pop    %rbx
    1223:	c3                   	retq   
    1224:	e8 47 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
