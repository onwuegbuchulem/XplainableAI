...
/app/bin_gccgcc10_O0/2024_05_01-Lesson:     file format elf64-x86-64
...
0000000000001189 <stddev>:
    1189:	f3 0f 1e fa          	endbr64 
    118d:	55                   	push   %rbp
    118e:	48 89 e5             	mov    %rsp,%rbp
    1191:	48 89 7d f8          	mov    %rdi,-0x8(%rbp)
    1195:	89 75 f4             	mov    %esi,-0xc(%rbp)
    1198:	90                   	nop
    1199:	66 48 0f 6e c0       	movq   %rax,%xmm0
    119e:	5d                   	pop    %rbp
    119f:	c3                   	retq   
...
00000000000011a0 <main>:
    ...
    11a8:	48 83 ec 40          	sub    $0x40,%rsp
    11ac:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11b3:	00 00 
    11b5:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11b9:	31 c0                	xor    %eax,%eax
    11bb:	c7 45 d0 0a 00 00 00 	movl   $0xa,-0x30(%rbp)
    11c2:	c7 45 d4 0c 00 00 00 	movl   $0xc,-0x2c(%rbp)
    11c9:	c7 45 d8 17 00 00 00 	movl   $0x17,-0x28(%rbp)
    11d0:	c7 45 dc 17 00 00 00 	movl   $0x17,-0x24(%rbp)
    11d7:	c7 45 e0 10 00 00 00 	movl   $0x10,-0x20(%rbp)
    11de:	c7 45 e4 17 00 00 00 	movl   $0x17,-0x1c(%rbp)
    11e5:	c7 45 e8 15 00 00 00 	movl   $0x15,-0x18(%rbp)
    11ec:	c7 45 ec 10 00 00 00 	movl   $0x10,-0x14(%rbp)
    11f3:	c7 45 cc 08 00 00 00 	movl   $0x8,-0x34(%rbp)
    11fa:	48 8d 3d 07 0e 00 00 	lea    0xe07(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    1201:	b8 00 00 00 00       	mov    $0x0,%eax
    1206:	e8 85 fe ff ff       	callq  1090 <printf@plt>
    120b:	c7 45 c8 00 00 00 00 	movl   $0x0,-0x38(%rbp)
    1212:	eb 20                	jmp    1234 <main+0x94>
    1214:	8b 45 c8             	mov    -0x38(%rbp),%eax
    1217:	48 98                	cltq   
    1219:	8b 44 85 d0          	mov    -0x30(%rbp,%rax,4),%eax
    121d:	89 c6                	mov    %eax,%esi
    121f:	48 8d 3d ea 0d 00 00 	lea    0xdea(%rip),%rdi        # 2010 <_IO_stdin_used+0x10>
    1226:	b8 00 00 00 00       	mov    $0x0,%eax
    122b:	e8 60 fe ff ff       	callq  1090 <printf@plt>
    1230:	83 45 c8 01          	addl   $0x1,-0x38(%rbp)
    1234:	8b 45 c8             	mov    -0x38(%rbp),%eax
    1237:	3b 45 cc             	cmp    -0x34(%rbp),%eax
    123a:	7c d8                	jl     1214 <main+0x74>
    123c:	bf 0a 00 00 00       	mov    $0xa,%edi
    1241:	e8 2a fe ff ff       	callq  1070 <putchar@plt>
    1246:	8b 55 cc             	mov    -0x34(%rbp),%edx
    1249:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    124d:	89 d6                	mov    %edx,%esi
    124f:	48 89 c7             	mov    %rax,%rdi
    1252:	e8 32 ff ff ff       	callq  1189 <stddev>
    1257:	66 48 0f 7e c0       	movq   %xmm0,%rax
    125c:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1261:	48 8d 3d b0 0d 00 00 	lea    0xdb0(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    1268:	b8 01 00 00 00       	mov    $0x1,%eax
    126d:	e8 1e fe ff ff       	callq  1090 <printf@plt>
    1272:	b8 00 00 00 00       	mov    $0x0,%eax
    1277:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    127b:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1282:	00 00 
    1284:	74 05                	je     128b <main+0xeb>
    1286:	e8 f5 fd ff ff       	callq  1080 <__stack_chk_fail@plt>
    128b:	c9                   	leaveq 
    128c:	c3                   	retq   
