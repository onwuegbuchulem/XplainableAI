...
/app/bin_gccgcc10_O2/create_node:     file format elf64-x86-64
...
0000000000001050 <malloc@plt>:
    ...
    1054:	f2 ff 25 75 2f 00 00 	bnd jmpq *0x2f75(%rip)        # 3fd0 <malloc@GLIBC_2.2.5>
...
0000000000001070 <_start>:
    ...
    1081:	50                   	push   %rax
    1082:	54                   	push   %rsp
    1083:	4c 8d 05 76 01 00 00 	lea    0x176(%rip),%r8        # 1200 <__libc_csu_fini>
    108a:	48 8d 0d ff 00 00 00 	lea    0xff(%rip),%rcx        # 1190 <__libc_csu_init>
    1091:	48 8d 3d c8 ff ff ff 	lea    -0x38(%rip),%rdi        # 1060 <main>
...
0000000000001110 <__do_global_dtors_aux>:
    ...
    1132:	e8 09 ff ff ff       	callq  1040 <__cxa_finalize@plt>
...
0000000000001160 <newNode>:
    1160:	f3 0f 1e fa          	endbr64 
    1164:	53                   	push   %rbx
    1165:	89 fb                	mov    %edi,%ebx
    1167:	bf 18 00 00 00       	mov    $0x18,%edi
    116c:	e8 df fe ff ff       	callq  1050 <malloc@plt>
    1171:	48 c7 00 00 00 00 00 	movq   $0x0,(%rax)
    1178:	89 58 08             	mov    %ebx,0x8(%rax)
    117b:	48 c7 40 10 00 00 00 	movq   $0x0,0x10(%rax)
    1182:	00 
    1183:	5b                   	pop    %rbx
    1184:	c3                   	retq   
