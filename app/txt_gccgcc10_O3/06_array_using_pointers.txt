...
/app/bin_gccgcc10_O3/06_array_using_pointers:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10b0:	0f 29 04 24          	movaps %xmm0,(%rsp)
    10b4:	41 8b 0c 9c          	mov    (%r12,%rbx,4),%ecx
    10b8:	89 da                	mov    %ebx,%edx
    10ba:	48 89 ee             	mov    %rbp,%rsi
    ...
    10cd:	48 83 fb 04          	cmp    $0x4,%rbx
    10d1:	75 e1                	jne    10b4 <main+0x34>
    10d3:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10d8:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10df:	00 00 
    10e1:	75 0b                	jne    10ee <main+0x6e>
    ...
    10eb:	41 5c                	pop    %r12
    10ed:	c3                   	retq   
    10ee:	e8 6d ff ff ff       	callq  1060 <__stack_chk_fail@plt>
