...
/app/bin_gccgcc10_O2/2024_04_27-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10af:	48 8d 35 4e 0f 00 00 	lea    0xf4e(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10b6:	bf 01 00 00 00       	mov    $0x1,%edi
    10bb:	48 89 c3             	mov    %rax,%rbx
    10be:	31 c0                	xor    %eax,%eax
    10c0:	e8 bb ff ff ff       	callq  1080 <__printf_chk@plt>
    10c5:	48 89 de             	mov    %rbx,%rsi
    10c8:	48 8d 3d 48 0f 00 00 	lea    0xf48(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    10cf:	31 c0                	xor    %eax,%eax
    10d1:	e8 ba ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10d6:	8b 13                	mov    (%rbx),%edx
    10d8:	48 8d 35 3b 0f 00 00 	lea    0xf3b(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
