...
/app/bin_gccgcc10_O2/02_other_types:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10a6:	4c 8d 64 24 03       	lea    0x3(%rsp),%r12
    10ab:	c6 44 24 03 41       	movb   $0x41,0x3(%rsp)
    10b0:	4c 89 e2             	mov    %r12,%rdx
    10b3:	c7 44 24 04 8b 6c a7 	movl   $0x40a76c8b,0x4(%rsp)
    10ba:	40 
    ...
    10ee:	0f be 54 24 03       	movsbl 0x3(%rsp),%edx
    10f3:	31 c0                	xor    %eax,%eax
    10f5:	48 8d 35 20 0f 00 00 	lea    0xf20(%rip),%rsi        # 201c <_IO_stdin_used+0x1c>
    10fc:	bf 01 00 00 00       	mov    $0x1,%edi
    1101:	e8 6a ff ff ff       	callq  1070 <__printf_chk@plt>
    1106:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    110b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1112:	00 00 
    1114:	75 09                	jne    111f <main+0x9f>
    1116:	48 83 c4 10          	add    $0x10,%rsp
    111a:	31 c0                	xor    %eax,%eax
    111c:	41 5c                	pop    %r12
    111e:	c3                   	retq   
    111f:	e8 3c ff ff ff       	callq  1060 <__stack_chk_fail@plt>
