...
/app/bin_gccgcc10_O2/2022_04_09-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1092:	53                   	push   %rbx
    1093:	48 83 ec 08          	sub    $0x8,%rsp
    1097:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    109e:	00 00 
    10a0:	44 8d 65 30          	lea    0x30(%rbp),%r12d
    10a4:	31 db                	xor    %ebx,%ebx
    10a6:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10ad:	00 00 00 
    10b0:	8d 4b 30             	lea    0x30(%rbx),%ecx
    10b3:	41 89 d9             	mov    %ebx,%r9d
    10b6:	41 89 e8             	mov    %ebp,%r8d
    10b9:	44 89 e2             	mov    %r12d,%edx
    ...
    10ce:	83 fb 08             	cmp    $0x8,%ebx
    10d1:	75 dd                	jne    10b0 <main+0x30>
    10d3:	48 8d 3d 40 0f 00 00 	lea    0xf40(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    10da:	83 c5 01             	add    $0x1,%ebp
    10dd:	e8 7e ff ff ff       	callq  1060 <puts@plt>
    10e2:	83 fd 08             	cmp    $0x8,%ebp
    10e5:	75 b9                	jne    10a0 <main+0x20>
    10e7:	48 83 c4 08          	add    $0x8,%rsp
