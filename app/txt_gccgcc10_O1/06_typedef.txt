...
/app/bin_gccgcc10_O1/06_typedef:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1182:	c7 04 24 9f 11 00 00 	movl   $0x119f,(%rsp)
    1189:	48 8d 5c 24 08       	lea    0x8(%rsp),%rbx
    118e:	c7 44 24 08 48 61 72 	movl   $0x72726148,0x8(%rsp)
    1195:	72 
    1196:	66 c7 44 24 0c 79 00 	movw   $0x79,0xc(%rsp)
    119d:	c7 44 24 04 8f c2 59 	movl   $0x4259c28f,0x4(%rsp)
    11a4:	42 
    11a5:	48 89 d9             	mov    %rbx,%rcx
    11a8:	f2 0f 10 05 60 0e 00 	movsd  0xe60(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    11af:	00 
    11b0:	ba 9f 11 00 00       	mov    $0x119f,%edx
    ...
    11c6:	e8 a5 fe ff ff       	callq  1070 <__printf_chk@plt>
    11cb:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11cf:	f3 0f 5a 44 24 04    	cvtss2sd 0x4(%rsp),%xmm0
    11d5:	48 89 d9             	mov    %rbx,%rcx
    11d8:	8b 14 24             	mov    (%rsp),%edx
