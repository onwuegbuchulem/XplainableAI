...
/app/bin_gccgcc10_O1/2020_11-Exercise:     file format elf64-x86-64
...
00000000000010c0 <_start>:
    ...
    10d1:	50                   	push   %rax
    10d2:	54                   	push   %rsp
    10d3:	4c 8d 05 d6 01 00 00 	lea    0x1d6(%rip),%r8        # 12b0 <__libc_csu_fini>
    10da:	48 8d 0d 5f 01 00 00 	lea    0x15f(%rip),%rcx        # 1240 <__libc_csu_init>
    10e1:	48 8d 3d ee 00 00 00 	lea    0xee(%rip),%rdi        # 11d6 <main>
...
00000000000011a9 <monthcount>:
    11a9:	f3 0f 1e fa          	endbr64 
    11ad:	48 83 ec 18          	sub    $0x18,%rsp
    11b1:	48 89 7c 24 08       	mov    %rdi,0x8(%rsp)
    11b6:	48 8d 7c 24 08       	lea    0x8(%rsp),%rdi
    11bb:	e8 c0 fe ff ff       	callq  1080 <localtime@plt>
    11c0:	8b 50 14             	mov    0x14(%rax),%edx
    11c3:	8d 94 52 44 16 00 00 	lea    0x1644(%rdx,%rdx,2),%edx
    11ca:	8b 40 10             	mov    0x10(%rax),%eax
    11cd:	8d 44 90 01          	lea    0x1(%rax,%rdx,4),%eax
    11d1:	48 83 c4 18          	add    $0x18,%rsp
    11d5:	c3                   	retq   

00000000000011d6 <main>:
    ...
    11ee:	48 89 e7             	mov    %rsp,%rdi
    11f1:	e8 aa fe ff ff       	callq  10a0 <time@plt>
    11f6:	48 8b 3c 24          	mov    (%rsp),%rdi
    11fa:	e8 aa ff ff ff       	callq  11a9 <monthcount>
    ...
    1212:	e8 99 fe ff ff       	callq  10b0 <__printf_chk@plt>
    1217:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    121c:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1223:	00 00 
    1225:	75 0a                	jne    1231 <main+0x5b>
    1227:	b8 00 00 00 00       	mov    $0x0,%eax
    122c:	48 83 c4 18          	add    $0x18,%rsp
    1230:	c3                   	retq   
    1231:	e8 5a fe ff ff       	callq  1090 <__stack_chk_fail@plt>
