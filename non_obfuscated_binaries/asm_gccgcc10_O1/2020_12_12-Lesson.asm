...
/app/bin_gccgcc10_O1/2020_12_12-Lesson:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1153:	bb 32 00 00 00       	mov    $0x32,%ebx
    1158:	f2 0f 10 1d b0 0e 00 	movsd  0xeb0(%rip),%xmm3        # 2010 <_IO_stdin_used+0x10>
    115f:	00 
    1160:	f2 0f 11 5c 24 08    	movsd  %xmm3,0x8(%rsp)
    1166:	f2 0f 11 1c 24       	movsd  %xmm3,(%rsp)
    116b:	48 8d 2d 92 0e 00 00 	lea    0xe92(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1172:	f2 0f 10 04 24       	movsd  (%rsp),%xmm0
    1177:	48 89 ee             	mov    %rbp,%rsi
    117a:	bf 01 00 00 00       	mov    $0x1,%edi
    117f:	b8 01 00 00 00       	mov    $0x1,%eax
    1184:	e8 c7 fe ff ff       	callq  1050 <__printf_chk@plt>
    1189:	f2 0f 10 0c 24       	movsd  (%rsp),%xmm1
    118e:	f2 0f 10 54 24 08    	movsd  0x8(%rsp),%xmm2
    1194:	f2 0f 58 ca          	addsd  %xmm2,%xmm1
    1198:	f2 0f 11 0c 24       	movsd  %xmm1,(%rsp)
    119d:	66 0f 28 c2          	movapd %xmm2,%xmm0
    11a1:	48 89 ee             	mov    %rbp,%rsi
    11a4:	bf 01 00 00 00       	mov    $0x1,%edi
    11a9:	b8 01 00 00 00       	mov    $0x1,%eax
    11ae:	e8 9d fe ff ff       	callq  1050 <__printf_chk@plt>
    11b3:	f2 0f 10 54 24 08    	movsd  0x8(%rsp),%xmm2
    11b9:	f2 0f 58 14 24       	addsd  (%rsp),%xmm2
    11be:	f2 0f 11 54 24 08    	movsd  %xmm2,0x8(%rsp)
    11c4:	83 eb 01             	sub    $0x1,%ebx
    11c7:	75 a9                	jne    1172 <main+0x29>
    11c9:	b8 00 00 00 00       	mov    $0x0,%eax
    11ce:	48 83 c4 18          	add    $0x18,%rsp
    11d2:	5b                   	pop    %rbx
    11d3:	5d                   	pop    %rbp
    11d4:	c3                   	retq   
