...
/app/bin_gccgcc10_O2/2021_12_11-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	48 81 ec 98 02 00 00 	sub    $0x298,%rsp
    108b:	48 8d 35 76 0f 00 00 	lea    0xf76(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    1092:	b9 4f 00 00 00       	mov    $0x4f,%ecx
    1097:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    109e:	00 00 
    10a0:	48 89 84 24 88 02 00 	mov    %rax,0x288(%rsp)
    10a7:	00 
    10a8:	31 c0                	xor    %eax,%eax
    10aa:	48 89 e7             	mov    %rsp,%rdi
    10ad:	48 89 e2             	mov    %rsp,%rdx
    10b0:	f3 48 a5             	rep movsq %ds:(%rsi),%es:(%rdi)
    10b3:	8b 06                	mov    (%rsi),%eax
    10b5:	48 8d 35 48 0f 00 00 	lea    0xf48(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10bc:	89 07                	mov    %eax,(%rdi)
    10be:	0f b6 05 bf 11 00 00 	movzbl 0x11bf(%rip),%eax        # 2284 <_IO_stdin_used+0x284>
    10c5:	88 47 04             	mov    %al,0x4(%rdi)
    10c8:	31 c0                	xor    %eax,%eax
    10ca:	bf 01 00 00 00       	mov    $0x1,%edi
    10cf:	e8 9c ff ff ff       	callq  1070 <__printf_chk@plt>
    10d4:	48 8b 84 24 88 02 00 	mov    0x288(%rsp),%rax
    10db:	00 
    10dc:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10e3:	00 00 
    10e5:	75 0a                	jne    10f1 <main+0x71>
    10e7:	31 c0                	xor    %eax,%eax
    10e9:	48 81 c4 98 02 00 00 	add    $0x298,%rsp
    10f0:	c3                   	retq   
    10f1:	e8 6a ff ff ff       	callq  1060 <__stack_chk_fail@plt>
