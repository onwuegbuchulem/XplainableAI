...
/app/bin_gccgcc10_O0/Vowel_Switch:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11d4:	83 e8 41             	sub    $0x41,%eax
    11d7:	83 f8 34             	cmp    $0x34,%eax
    11da:	77 3f                	ja     121b <main+0x92>
    11dc:	89 c0                	mov    %eax,%eax
    11de:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
    11e5:	00 
    11e6:	48 8d 05 57 0e 00 00 	lea    0xe57(%rip),%rax        # 2044 <_IO_stdin_used+0x44>
    11ed:	8b 04 02             	mov    (%rdx,%rax,1),%eax
    11f0:	48 98                	cltq   
    11f2:	48 8d 15 4b 0e 00 00 	lea    0xe4b(%rip),%rdx        # 2044 <_IO_stdin_used+0x44>
    11f9:	48 01 d0             	add    %rdx,%rax
    11fc:	3e ff e0             	notrack jmpq *%rax
    11ff:	0f b6 45 f7          	movzbl -0x9(%rbp),%eax
    1203:	0f be c0             	movsbl %al,%eax
    1206:	89 c6                	mov    %eax,%esi
    1208:	48 8d 3d 0c 0e 00 00 	lea    0xe0c(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    120f:	b8 00 00 00 00       	mov    $0x0,%eax
    1214:	e8 67 fe ff ff       	callq  1080 <printf@plt>
    1219:	eb 1a                	jmp    1235 <main+0xac>
    121b:	0f b6 45 f7          	movzbl -0x9(%rbp),%eax
    121f:	0f be c0             	movsbl %al,%eax
    1222:	89 c6                	mov    %eax,%esi
    1224:	48 8d 3d 01 0e 00 00 	lea    0xe01(%rip),%rdi        # 202c <_IO_stdin_used+0x2c>
