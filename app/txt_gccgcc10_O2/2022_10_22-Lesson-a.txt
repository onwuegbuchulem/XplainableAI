...
/app/bin_gccgcc10_O2/2022_10_22-Lesson-a:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    1122:	74 28                	je     114c <main+0x6c>
    1124:	48 89 c7             	mov    %rax,%rdi
    1127:	48 89 c5             	mov    %rax,%rbp
    112a:	e8 81 ff ff ff       	callq  10b0 <fgetc@plt>
    112f:	bf 01 00 00 00       	mov    $0x1,%edi
    1134:	48 8d 35 cb 0e 00 00 	lea    0xecb(%rip),%rsi        # 2006 <_IO_stdin_used+0x6>
    113b:	89 c2                	mov    %eax,%edx
    113d:	31 c0                	xor    %eax,%eax
    113f:	e8 7c ff ff ff       	callq  10c0 <__printf_chk@plt>
    1144:	48 89 ef             	mov    %rbp,%rdi
    1147:	e8 44 ff ff ff       	callq  1090 <fclose@plt>
    114c:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1151:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1158:	00 00 
    115a:	75 08                	jne    1164 <main+0x84>
    115c:	48 83 c4 20          	add    $0x20,%rsp
    1160:	31 c0                	xor    %eax,%eax
    1162:	5d                   	pop    %rbp
    1163:	c3                   	retq   
    1164:	e8 37 ff ff ff       	callq  10a0 <__stack_chk_fail@plt>
