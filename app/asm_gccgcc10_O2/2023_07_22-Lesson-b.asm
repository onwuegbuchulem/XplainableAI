...
/app/bin_gccgcc10_O2/2023_07_22-Lesson-b:     file format elf64-x86-64
...
0000000000001160 <main>:
    ...
    119b:	48 8d 35 7b 0e 00 00 	lea    0xe7b(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    11a2:	31 c0                	xor    %eax,%eax
    11a4:	bf 01 00 00 00       	mov    $0x1,%edi
    11a9:	41 c6 04 24 00       	movb   $0x0,(%r12)
    11ae:	4c 8d 2d 7c 0e 00 00 	lea    0xe7c(%rip),%r13        # 2031 <_IO_stdin_used+0x31>
    11b5:	48 8d 1d 72 0e 00 00 	lea    0xe72(%rip),%rbx        # 202e <_IO_stdin_used+0x2e>
