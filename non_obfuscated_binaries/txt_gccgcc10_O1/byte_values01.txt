...
/app/bin_gccgcc10_O1/byte_values01:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    116e:	bb 00 00 00 00       	mov    $0x0,%ebx
    1173:	48 8d 2d 8a 0e 00 00 	lea    0xe8a(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    117a:	83 c3 01             	add    $0x1,%ebx
    117d:	0f b6 d3             	movzbl %bl,%edx
    1180:	48 89 ee             	mov    %rbp,%rsi
    1183:	bf 01 00 00 00       	mov    $0x1,%edi
    1188:	b8 00 00 00 00       	mov    $0x0,%eax
    118d:	e8 be fe ff ff       	callq  1050 <__printf_chk@plt>
    1192:	80 fb ff             	cmp    $0xff,%bl
    1195:	75 e3                	jne    117a <main+0x31>
