...
/app/bin_gccgcc10_O0/2020_11-Exercise:     file format elf64-x86-64
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d 0c 01 00 00 	lea    0x10c(%rip),%rdi        # 11f4 <main>
...
00000000000011f4 <main>:
    ...
    1216:	e8 95 fe ff ff       	callq  10b0 <time@plt>
    121b:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    121f:	48 89 c7             	mov    %rax,%rdi
    1222:	e8 82 ff ff ff       	callq  11a9 <monthcount>
    1227:	89 45 ec             	mov    %eax,-0x14(%rbp)
