...
/app/bin_gccgcc10_O0/2021_11_06-Lesson-a:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1159:	83 e0 f0             	and    $0xfffffff0,%eax
    115c:	83 c8 05             	or     $0x5,%eax
    115f:	88 45 fc             	mov    %al,-0x4(%rbp)
    1162:	0f b6 45 fc          	movzbl -0x4(%rbp),%eax
    1166:	c1 e0 04             	shl    $0x4,%eax
    1169:	c0 f8 04             	sar    $0x4,%al
