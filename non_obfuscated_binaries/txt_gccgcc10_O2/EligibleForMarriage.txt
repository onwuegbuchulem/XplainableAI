...
/app/bin_gccgcc10_O2/EligibleForMarriage:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10cc:	48 8d 3d 44 0f 00 00 	lea    0xf44(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    10d3:	31 c0                	xor    %eax,%eax
    10d5:	e8 b6 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10da:	48 8d 35 39 0f 00 00 	lea    0xf39(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    10e1:	bf 01 00 00 00       	mov    $0x1,%edi
    10e6:	31 c0                	xor    %eax,%eax
    10e8:	e8 93 ff ff ff       	callq  1080 <__printf_chk@plt>
    10ed:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    10f2:	48 8d 3d 1e 0f 00 00 	lea    0xf1e(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    10f9:	31 c0                	xor    %eax,%eax
    10fb:	e8 90 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    1100:	8b 04 24             	mov    (%rsp),%eax
    1103:	85 c0                	test   %eax,%eax
    1105:	78 2c                	js     1133 <main+0x93>
    1107:	8b 54 24 04          	mov    0x4(%rsp),%edx
    110b:	85 d2                	test   %edx,%edx
    110d:	78 24                	js     1133 <main+0x93>
    110f:	83 fa 14             	cmp    $0x14,%edx
    1112:	7f 73                	jg     1187 <main+0xe7>
    1114:	83 f8 14             	cmp    $0x14,%eax
    1117:	7e 59                	jle    1172 <main+0xd2>
    1119:	83 fa 14             	cmp    $0x14,%edx
    111c:	7f 3f                	jg     115d <main+0xbd>
    111e:	48 8d 35 8b 0f 00 00 	lea    0xf8b(%rip),%rsi        # 20b0 <_IO_stdin_used+0xb0>
    1125:	bf 01 00 00 00       	mov    $0x1,%edi
    112a:	31 c0                	xor    %eax,%eax
    112c:	e8 4f ff ff ff       	callq  1080 <__printf_chk@plt>
    1131:	eb 13                	jmp    1146 <main+0xa6>
    1133:	48 8d 35 f6 0e 00 00 	lea    0xef6(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    113a:	bf 01 00 00 00       	mov    $0x1,%edi
    113f:	31 c0                	xor    %eax,%eax
    1141:	e8 3a ff ff ff       	callq  1080 <__printf_chk@plt>
    1146:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    114b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1152:	00 00 
    1154:	75 4b                	jne    11a1 <main+0x101>
    1156:	31 c0                	xor    %eax,%eax
    1158:	48 83 c4 18          	add    $0x18,%rsp
    115c:	c3                   	retq   
    115d:	48 8d 35 74 0f 00 00 	lea    0xf74(%rip),%rsi        # 20d8 <_IO_stdin_used+0xd8>
    1164:	bf 01 00 00 00       	mov    $0x1,%edi
    1169:	31 c0                	xor    %eax,%eax
    116b:	e8 10 ff ff ff       	callq  1080 <__printf_chk@plt>
    1170:	eb d4                	jmp    1146 <main+0xa6>
    1172:	48 8d 35 e7 0e 00 00 	lea    0xee7(%rip),%rsi        # 2060 <_IO_stdin_used+0x60>
    1179:	bf 01 00 00 00       	mov    $0x1,%edi
    117e:	31 c0                	xor    %eax,%eax
    1180:	e8 fb fe ff ff       	callq  1080 <__printf_chk@plt>
    1185:	eb bf                	jmp    1146 <main+0xa6>
    1187:	83 f8 14             	cmp    $0x14,%eax
    118a:	7f 8d                	jg     1119 <main+0x79>
    118c:	48 8d 35 f5 0e 00 00 	lea    0xef5(%rip),%rsi        # 2088 <_IO_stdin_used+0x88>
    1193:	bf 01 00 00 00       	mov    $0x1,%edi
    1198:	31 c0                	xor    %eax,%eax
    119a:	e8 e1 fe ff ff       	callq  1080 <__printf_chk@plt>
    119f:	eb a5                	jmp    1146 <main+0xa6>
    11a1:	e8 ca fe ff ff       	callq  1070 <__stack_chk_fail@plt>
