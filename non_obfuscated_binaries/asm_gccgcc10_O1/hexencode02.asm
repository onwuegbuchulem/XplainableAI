...
/app/bin_gccgcc10_O1/hexencode02:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1197:	48 8d 3d 66 0e 00 00 	lea    0xe66(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    119e:	e8 cd fe ff ff       	callq  1070 <puts@plt>
    11a3:	4c 8d 2d 6a 0e 00 00 	lea    0xe6a(%rip),%r13        # 2014 <_IO_stdin_used+0x14>
    11aa:	41 bc 00 00 00 00    	mov    $0x0,%r12d
    11b0:	bd 00 00 00 00       	mov    $0x0,%ebp
    11b5:	48 8b 3d 54 2e 00 00 	mov    0x2e54(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    11bc:	e8 cf fe ff ff       	callq  1090 <getc@plt>
    11c1:	89 c3                	mov    %eax,%ebx
    11c3:	83 f8 ff             	cmp    $0xffffffff,%eax
    11c6:	74 49                	je     1211 <main+0x88>
    11c8:	89 da                	mov    %ebx,%edx
    11ca:	4c 89 ee             	mov    %r13,%rsi
    11cd:	bf 01 00 00 00       	mov    $0x1,%edi
    11d2:	b8 00 00 00 00       	mov    $0x0,%eax
    11d7:	e8 a4 fe ff ff       	callq  1080 <__printf_chk@plt>
    11dc:	41 01 dc             	add    %ebx,%r12d
    11df:	83 c5 01             	add    $0x1,%ebp
    11e2:	83 fd 12             	cmp    $0x12,%ebp
    11e5:	75 ce                	jne    11b5 <main+0x2c>
    11e7:	44 89 e0             	mov    %r12d,%eax
    11ea:	c1 f8 1f             	sar    $0x1f,%eax
    11ed:	c1 e8 18             	shr    $0x18,%eax
    11f0:	41 8d 14 04          	lea    (%r12,%rax,1),%edx
    11f4:	0f b6 d2             	movzbl %dl,%edx
    11f7:	29 c2                	sub    %eax,%edx
    11f9:	48 8d 35 1a 0e 00 00 	lea    0xe1a(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    1200:	bf 01 00 00 00       	mov    $0x1,%edi
    1205:	b8 00 00 00 00       	mov    $0x0,%eax
    120a:	e8 71 fe ff ff       	callq  1080 <__printf_chk@plt>
    120f:	eb 99                	jmp    11aa <main+0x21>
    1211:	85 ed                	test   %ebp,%ebp
    1213:	7f 1c                	jg     1231 <main+0xa8>
    1215:	48 8d 3d 05 0e 00 00 	lea    0xe05(%rip),%rdi        # 2021 <_IO_stdin_used+0x21>
    121c:	e8 4f fe ff ff       	callq  1070 <puts@plt>
    ...
    122e:	41 5d                	pop    %r13
    1230:	c3                   	retq   
    1231:	b9 00 01 00 00       	mov    $0x100,%ecx
    1236:	44 89 e0             	mov    %r12d,%eax
    1239:	99                   	cltd   
    123a:	f7 f9                	idiv   %ecx
    123c:	48 8d 35 d1 0d 00 00 	lea    0xdd1(%rip),%rsi        # 2014 <_IO_stdin_used+0x14>
    1243:	bf 01 00 00 00       	mov    $0x1,%edi
    1248:	b8 00 00 00 00       	mov    $0x0,%eax
    124d:	e8 2e fe ff ff       	callq  1080 <__printf_chk@plt>
    1252:	eb c1                	jmp    1215 <main+0x8c>
