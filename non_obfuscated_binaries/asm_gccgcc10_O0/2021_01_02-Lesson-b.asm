...
/app/bin_gccgcc10_O0/2021_01_02-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    11c5:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
    11cc:	eb 32                	jmp    1200 <main+0x97>
    11ce:	8b 45 dc             	mov    -0x24(%rbp),%eax
    11d1:	48 98                	cltq   
    11d3:	f3 0f 10 44 85 e0    	movss  -0x20(%rbp,%rax,4),%xmm0
    11d9:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11dd:	f3 0f 5a c8          	cvtss2sd %xmm0,%xmm1
    11e1:	66 48 0f 7e c8       	movq   %xmm1,%rax
    ...
    1200:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1203:	83 f8 04             	cmp    $0x4,%eax
    1206:	76 c6                	jbe    11ce <main+0x65>
    1208:	b8 00 00 00 00       	mov    $0x0,%eax
    120d:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1211:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1218:	00 00 
    121a:	74 05                	je     1221 <main+0xb8>
    121c:	e8 3f fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    1221:	c9                   	leaveq 
    1222:	c3                   	retq   
