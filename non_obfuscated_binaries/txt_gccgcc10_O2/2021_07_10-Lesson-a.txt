...
/app/bin_gccgcc10_O2/2021_07_10-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	41 55                	push   %r13
    10a6:	4c 8d 2d 83 0f 00 00 	lea    0xf83(%rip),%r13        # 2030 <_IO_stdin_used+0x30>
    10ad:	41 54                	push   %r12
    10af:	45 31 e4             	xor    %r12d,%r12d
    10b2:	55                   	push   %rbp
    10b3:	89 fd                	mov    %edi,%ebp
    10b5:	53                   	push   %rbx
    10b6:	48 89 f3             	mov    %rsi,%rbx
    10b9:	48 83 ec 08          	sub    $0x8,%rsp
    10bd:	c7 05 59 2f 00 00 00 	movl   $0x0,0x2f59(%rip)        # 4020 <opterr@@GLIBC_2.2.5>
    10c4:	00 00 00 
    10c7:	eb 1e                	jmp    10e7 <main+0x47>
    10c9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    10d0:	48 8d 35 46 0f 00 00 	lea    0xf46(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    10d7:	bf 01 00 00 00       	mov    $0x1,%edi
    10dc:	31 c0                	xor    %eax,%eax
    10de:	e8 9d ff ff ff       	callq  1080 <__printf_chk@plt>
    10e3:	41 83 c4 01          	add    $0x1,%r12d
    10e7:	4c 89 ea             	mov    %r13,%rdx
    10ea:	48 89 de             	mov    %rbx,%rsi
    10ed:	89 ef                	mov    %ebp,%edi
    10ef:	e8 9c ff ff ff       	callq  1090 <getopt@plt>
    10f4:	89 c2                	mov    %eax,%edx
    10f6:	83 f8 ff             	cmp    $0xffffffff,%eax
    10f9:	74 15                	je     1110 <main+0x70>
    10fb:	83 fa 3f             	cmp    $0x3f,%edx
    10fe:	75 d0                	jne    10d0 <main+0x30>
    1100:	48 8d 3d fd 0e 00 00 	lea    0xefd(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1107:	e8 64 ff ff ff       	callq  1070 <puts@plt>
    110c:	eb d5                	jmp    10e3 <main+0x43>
    110e:	66 90                	xchg   %ax,%ax
    1110:	44 89 e2             	mov    %r12d,%edx
    ...
    1121:	e8 5a ff ff ff       	callq  1080 <__printf_chk@plt>
...
00000000000011e0 <__do_global_dtors_aux>:
    ...
    11e4:	80 3d 39 2e 00 00 00 	cmpb   $0x0,0x2e39(%rip)        # 4024 <completed.0>
    ...
    120c:	c6 05 11 2e 00 00 01 	movb   $0x1,0x2e11(%rip)        # 4024 <completed.0>
    1213:	5d                   	pop    %rbp
    1214:	c3                   	retq   
