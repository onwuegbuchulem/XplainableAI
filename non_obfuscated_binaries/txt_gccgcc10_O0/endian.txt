...
/app/bin_gccgcc10_O0/endian:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    119a:	84 c0                	test   %al,%al
    119c:	74 0e                	je     11ac <main+0x43>
    119e:	48 8d 3d 5f 0e 00 00 	lea    0xe5f(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11a5:	e8 b6 fe ff ff       	callq  1060 <puts@plt>
    11aa:	eb 0c                	jmp    11b8 <main+0x4f>
    11ac:	48 8d 3d 5f 0e 00 00 	lea    0xe5f(%rip),%rdi        # 2012 <_IO_stdin_used+0x12>
    11b3:	e8 a8 fe ff ff       	callq  1060 <puts@plt>
    11b8:	b8 00 00 00 00       	mov    $0x0,%eax
    11bd:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11c1:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11c8:	00 00 
    11ca:	74 05                	je     11d1 <main+0x68>
