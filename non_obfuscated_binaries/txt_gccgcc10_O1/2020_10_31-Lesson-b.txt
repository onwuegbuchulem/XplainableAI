...
/app/bin_gccgcc10_O1/2020_10_31-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117f:	eb 1c                	jmp    119d <main+0x34>
    1181:	89 da                	mov    %ebx,%edx
    1183:	48 89 ee             	mov    %rbp,%rsi
    1186:	bf 01 00 00 00       	mov    $0x1,%edi
    118b:	b8 00 00 00 00       	mov    $0x0,%eax
    1190:	e8 db fe ff ff       	callq  1070 <__printf_chk@plt>
    1195:	83 c3 01             	add    $0x1,%ebx
    1198:	83 fb 64             	cmp    $0x64,%ebx
    119b:	74 21                	je     11be <main+0x55>
    119d:	83 fb 02             	cmp    $0x2,%ebx
    11a0:	7e df                	jle    1181 <main+0x18>
    11a2:	f6 c3 01             	test   $0x1,%bl
    11a5:	74 ee                	je     1195 <main+0x2c>
    11a7:	b9 02 00 00 00       	mov    $0x2,%ecx
    11ac:	83 c1 01             	add    $0x1,%ecx
    11af:	39 d9                	cmp    %ebx,%ecx
    11b1:	74 ce                	je     1181 <main+0x18>
    11b3:	89 d8                	mov    %ebx,%eax
    11b5:	99                   	cltd   
    11b6:	f7 f9                	idiv   %ecx
    11b8:	85 d2                	test   %edx,%edx
    11ba:	75 f0                	jne    11ac <main+0x43>
    11bc:	eb d7                	jmp    1195 <main+0x2c>
    11be:	48 8b 35 4b 2e 00 00 	mov    0x2e4b(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11c5:	bf 0a 00 00 00       	mov    $0xa,%edi
    11ca:	e8 91 fe ff ff       	callq  1060 <putc@plt>
