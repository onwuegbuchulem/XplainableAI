...
/app/bin_gccgcc10_O0/SimpleInterest:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b5:	48 8d 45 e4          	lea    -0x1c(%rbp),%rax
    ...
    11de:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    ...
    11f6:	48 8d 3d 3c 0e 00 00 	lea    0xe3c(%rip),%rdi        # 2039 <_IO_stdin_used+0x39>
    11fd:	b8 00 00 00 00       	mov    $0x0,%eax
    1202:	e8 79 fe ff ff       	callq  1080 <printf@plt>
    1207:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    ...
    121f:	f3 0f 10 4d e4       	movss  -0x1c(%rbp),%xmm1
    1224:	f3 0f 10 45 e8       	movss  -0x18(%rbp),%xmm0
    1229:	f3 0f 59 c8          	mulss  %xmm0,%xmm1
    122d:	f3 0f 10 45 ec       	movss  -0x14(%rbp),%xmm0
    1232:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    1236:	f3 0f 10 0d 42 0e 00 	movss  0xe42(%rip),%xmm1        # 2080 <_IO_stdin_used+0x80>
    123d:	00 
    123e:	f3 0f 5e c1          	divss  %xmm1,%xmm0
    1242:	f3 0f 11 45 f0       	movss  %xmm0,-0x10(%rbp)
    1247:	f3 0f 10 45 e4       	movss  -0x1c(%rbp),%xmm0
    124c:	f3 0f 10 4d f0       	movss  -0x10(%rbp),%xmm1
    1251:	f3 0f 58 c1          	addss  %xmm1,%xmm0
    1255:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    125a:	66 0f ef d2          	pxor   %xmm2,%xmm2
    125e:	f3 0f 5a 55 f0       	cvtss2sd -0x10(%rbp),%xmm2
    1263:	66 48 0f 7e d0       	movq   %xmm2,%rax
    1268:	66 48 0f 6e c0       	movq   %rax,%xmm0
    126d:	48 8d 3d e1 0d 00 00 	lea    0xde1(%rip),%rdi        # 2055 <_IO_stdin_used+0x55>
    1274:	b8 01 00 00 00       	mov    $0x1,%eax
    1279:	e8 02 fe ff ff       	callq  1080 <printf@plt>
    127e:	66 0f ef db          	pxor   %xmm3,%xmm3
    1282:	f3 0f 5a 5d f4       	cvtss2sd -0xc(%rbp),%xmm3
    1287:	66 48 0f 7e d8       	movq   %xmm3,%rax
    128c:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1291:	48 8d 3d d5 0d 00 00 	lea    0xdd5(%rip),%rdi        # 206d <_IO_stdin_used+0x6d>
    1298:	b8 01 00 00 00       	mov    $0x1,%eax
    129d:	e8 de fd ff ff       	callq  1080 <printf@plt>
    12a2:	b8 00 00 00 00       	mov    $0x0,%eax
    12a7:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    12ab:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    12b2:	00 00 
    12b4:	74 05                	je     12bb <main+0x132>
    12b6:	e8 b5 fd ff ff       	callq  1070 <__stack_chk_fail@plt>
    12bb:	c9                   	leaveq 
    12bc:	c3                   	retq   
