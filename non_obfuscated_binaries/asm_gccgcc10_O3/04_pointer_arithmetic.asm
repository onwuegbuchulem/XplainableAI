...
/app/bin_gccgcc10_O3/04_pointer_arithmetic:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10a6:	4c 8d 64 24 07       	lea    0x7(%rsp),%r12
    10ab:	c6 44 24 07 41       	movb   $0x41,0x7(%rsp)
    10b0:	4c 89 e2             	mov    %r12,%rdx
    10b3:	e8 b8 ff ff ff       	callq  1070 <__printf_chk@plt>
    10b8:	4c 89 e2             	mov    %r12,%rdx
    10bb:	bf 01 00 00 00       	mov    $0x1,%edi
    10c0:	31 c0                	xor    %eax,%eax
    10c2:	48 8d 35 3b 0f 00 00 	lea    0xf3b(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10c9:	e8 a2 ff ff ff       	callq  1070 <__printf_chk@plt>
    10ce:	31 c0                	xor    %eax,%eax
    10d0:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx
    10d5:	48 8d 35 40 0f 00 00 	lea    0xf40(%rip),%rsi        # 201c <_IO_stdin_used+0x1c>
    10dc:	bf 01 00 00 00       	mov    $0x1,%edi
    10e1:	e8 8a ff ff ff       	callq  1070 <__printf_chk@plt>
    10e6:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10eb:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10f2:	00 00 
    10f4:	75 09                	jne    10ff <main+0x7f>
    10f6:	48 83 c4 10          	add    $0x10,%rsp
