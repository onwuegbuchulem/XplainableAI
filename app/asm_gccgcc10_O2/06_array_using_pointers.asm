...
/app/bin_gccgcc10_O2/06_array_using_pointers:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	55                   	push   %rbp
    1085:	b9 0c 00 00 00       	mov    $0xc,%ecx
    ...
    10a6:	48 b8 0c 00 00 00 22 	movabs $0x220000000c,%rax
    10ad:	00 00 00 
    10b0:	48 89 04 24          	mov    %rax,(%rsp)
    10b4:	48 b8 35 00 00 00 42 	movabs $0x4200000035,%rax
    10bb:	00 00 00 
    10be:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10c3:	89 da                	mov    %ebx,%edx
    10c5:	48 89 ee             	mov    %rbp,%rsi
    10c8:	bf 01 00 00 00       	mov    $0x1,%edi
    10cd:	31 c0                	xor    %eax,%eax
    10cf:	e8 9c ff ff ff       	callq  1070 <__printf_chk@plt>
    10d4:	48 83 c3 01          	add    $0x1,%rbx
    10d8:	48 83 fb 04          	cmp    $0x4,%rbx
    10dc:	74 0a                	je     10e8 <main+0x68>
    10de:	8b 0c 9c             	mov    (%rsp,%rbx,4),%ecx
    10e1:	eb e0                	jmp    10c3 <main+0x43>
    ...
    10ff:	5d                   	pop    %rbp
    1100:	c3                   	retq   
    1101:	e8 5a ff ff ff       	callq  1060 <__stack_chk_fail@plt>
