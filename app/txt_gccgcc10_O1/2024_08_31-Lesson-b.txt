...
/app/bin_gccgcc10_O1/2024_08_31-Lesson-b:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    120d:	e8 9e fe ff ff       	callq  10b0 <time@plt>
    1212:	48 89 c7             	mov    %rax,%rdi
    1215:	e8 86 fe ff ff       	callq  10a0 <srand@plt>
    121a:	e8 b1 fe ff ff       	callq  10d0 <rand@plt>
    121f:	48 63 d0             	movslq %eax,%rdx
    1222:	48 69 d2 67 66 66 66 	imul   $0x66666667,%rdx,%rdx
    1229:	48 c1 fa 21          	sar    $0x21,%rdx
    122d:	89 c1                	mov    %eax,%ecx
    122f:	c1 f9 1f             	sar    $0x1f,%ecx
    1232:	29 ca                	sub    %ecx,%edx
    1234:	8d 14 92             	lea    (%rdx,%rdx,4),%edx
    1237:	29 d0                	sub    %edx,%eax
    1239:	48 98                	cltq   
    123b:	8b 14 84             	mov    (%rsp,%rax,4),%edx
    ...
    1260:	00 00 
    1262:	75 0a                	jne    126e <main+0xa5>
    1264:	b8 00 00 00 00       	mov    $0x0,%eax
    1269:	48 83 c4 28          	add    $0x28,%rsp
    126d:	c3                   	retq   
    126e:	e8 1d fe ff ff       	callq  1090 <__stack_chk_fail@plt>
