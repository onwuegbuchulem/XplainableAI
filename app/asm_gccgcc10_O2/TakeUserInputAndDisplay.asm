...
/app/bin_gccgcc10_O2/TakeUserInputAndDisplay:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e7:	48 8d 35 2c 0f 00 00 	lea    0xf2c(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    10ee:	e8 8d ff ff ff       	callq  1080 <__printf_chk@plt>
    10f3:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10f8:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10ff:	00 00 
    1101:	75 07                	jne    110a <main+0x6a>
    1103:	31 c0                	xor    %eax,%eax
    1105:	48 83 c4 18          	add    $0x18,%rsp
    1109:	c3                   	retq   
    110a:	e8 61 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
    110f:	90                   	nop
