...
/app/bin_gccgcc10_O2/2024_02-Exercise-b:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    106a:	48 8d 2d 93 0f 00 00 	lea    0xf93(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    1071:	53                   	push   %rbx
    1072:	31 db                	xor    %ebx,%ebx
    1074:	48 83 ec 08          	sub    $0x8,%rsp
    1078:	eb 16                	jmp    1090 <main+0x30>
    107a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1080:	89 d8                	mov    %ebx,%eax
    1082:	83 e0 01             	and    $0x1,%eax
    1085:	83 f8 01             	cmp    $0x1,%eax
    1088:	19 d2                	sbb    %edx,%edx
    108a:	83 e2 02             	and    $0x2,%edx
    108d:	83 ea 01             	sub    $0x1,%edx
    1090:	48 89 ee             	mov    %rbp,%rsi
    1093:	bf 01 00 00 00       	mov    $0x1,%edi
    1098:	31 c0                	xor    %eax,%eax
    109a:	83 c3 01             	add    $0x1,%ebx
    109d:	e8 ae ff ff ff       	callq  1050 <__printf_chk@plt>
    10a2:	83 fb 0e             	cmp    $0xe,%ebx
    10a5:	75 d9                	jne    1080 <main+0x20>
    10a7:	48 83 c4 08          	add    $0x8,%rsp
