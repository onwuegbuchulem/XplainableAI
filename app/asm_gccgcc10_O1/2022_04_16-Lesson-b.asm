...
/app/bin_gccgcc10_O1/2022_04_16-Lesson-b:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11cd:	53                   	push   %rbx
    11ce:	bf 00 04 00 00       	mov    $0x400,%edi
    11d3:	e8 d8 fe ff ff       	callq  10b0 <malloc@plt>
    11d8:	48 85 c0             	test   %rax,%rax
    11db:	74 2a                	je     1207 <main+0x3e>
    11dd:	48 89 c3             	mov    %rax,%rbx
    11e0:	48 8d 3d 38 0e 00 00 	lea    0xe38(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    11e7:	e8 b4 fe ff ff       	callq  10a0 <puts@plt>
    11ec:	48 89 df             	mov    %rbx,%rdi
    11ef:	e8 9c fe ff ff       	callq  1090 <free@plt>
    11f4:	48 8d 3d 35 0e 00 00 	lea    0xe35(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    11fb:	e8 a0 fe ff ff       	callq  10a0 <puts@plt>
    1200:	b8 00 00 00 00       	mov    $0x0,%eax
    1205:	5b                   	pop    %rbx
    1206:	c3                   	retq   
    1207:	48 8b 0d 12 2e 00 00 	mov    0x2e12(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    120e:	ba 1a 00 00 00       	mov    $0x1a,%edx
    1213:	be 01 00 00 00       	mov    $0x1,%esi
    1218:	48 8d 3d e5 0d 00 00 	lea    0xde5(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    121f:	e8 ac fe ff ff       	callq  10d0 <fwrite@plt>
    1224:	bf 01 00 00 00       	mov    $0x1,%edi
    1229:	e8 92 fe ff ff       	callq  10c0 <exit@plt>
