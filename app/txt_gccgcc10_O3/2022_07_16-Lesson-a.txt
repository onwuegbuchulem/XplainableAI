...
/app/bin_gccgcc10_O3/2022_07_16-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10b0:	53                   	push   %rbx
    10b1:	48 83 ec 28          	sub    $0x28,%rsp
    10b5:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10bc:	00 00 
    10be:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10c3:	31 c0                	xor    %eax,%eax
    10c5:	4c 8d 6c 24 10       	lea    0x10(%rsp),%r13
    10ca:	4c 8d 64 24 08       	lea    0x8(%rsp),%r12
    10cf:	48 c7 44 24 08 00 00 	movq   $0x0,0x8(%rsp)
    10d6:	00 00 
    10d8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    10df:	00 
    10e0:	48 89 ee             	mov    %rbp,%rsi
    ...
    10f6:	4c 89 ee             	mov    %r13,%rsi
    10f9:	4c 89 e7             	mov    %r12,%rdi
    10fc:	e8 8f ff ff ff       	callq  1090 <getline@plt>
    1101:	48 8b 4c 24 08       	mov    0x8(%rsp),%rcx
    1106:	bf 01 00 00 00       	mov    $0x1,%edi
    110b:	48 8d 35 f9 0e 00 00 	lea    0xef9(%rip),%rsi        # 200b <_IO_stdin_used+0xb>
    1112:	48 89 c3             	mov    %rax,%rbx
    1115:	89 c2                	mov    %eax,%edx
    1117:	31 c0                	xor    %eax,%eax
    1119:	e8 62 ff ff ff       	callq  1080 <__printf_chk@plt>
    111e:	83 fb 01             	cmp    $0x1,%ebx
    1121:	7f bd                	jg     10e0 <main+0x40>
    1123:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1128:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    112f:	00 00 
    1131:	75 0d                	jne    1140 <main+0xa0>
    1133:	48 83 c4 28          	add    $0x28,%rsp
    ...
    113d:	41 5d                	pop    %r13
    113f:	c3                   	retq   
    1140:	e8 2b ff ff ff       	callq  1070 <__stack_chk_fail@plt>
