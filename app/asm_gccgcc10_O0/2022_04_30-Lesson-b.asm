...
/app/bin_gccgcc10_O0/2022_04_30-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1274:	89 c6                	mov    %eax,%esi
    1276:	48 8d 3d 87 0d 00 00 	lea    0xd87(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    127d:	b8 00 00 00 00       	mov    $0x0,%eax
    1282:	e8 e9 fd ff ff       	callq  1070 <printf@plt>
    1287:	b8 00 00 00 00       	mov    $0x0,%eax
    128c:	48 89 dc             	mov    %rbx,%rsp
    128f:	48 8b 7d e8          	mov    -0x18(%rbp),%rdi
    1293:	64 48 2b 3c 25 28 00 	sub    %fs:0x28,%rdi
    129a:	00 00 
    129c:	74 05                	je     12a3 <main+0x13a>
    129e:	e8 bd fd ff ff       	callq  1060 <__stack_chk_fail@plt>
    12a3:	48 8b 5d f8          	mov    -0x8(%rbp),%rbx
    12a7:	c9                   	leaveq 
    12a8:	c3                   	retq   
