...
/app/bin_gccgcc10_O3/2021_09_11-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	bf 00 04 00 00       	mov    $0x400,%edi
    108d:	e8 de ff ff ff       	callq  1070 <malloc@plt>
    1092:	48 85 c0             	test   %rax,%rax
    1095:	74 13                	je     10aa <main+0x2a>
    1097:	48 8d 3d 76 0f 00 00 	lea    0xf76(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    109e:	e8 bd ff ff ff       	callq  1060 <puts@plt>
    10a3:	31 c0                	xor    %eax,%eax
    10a5:	48 83 c4 08          	add    $0x8,%rsp
    10a9:	c3                   	retq   
    10aa:	48 8d 3d 53 0f 00 00 	lea    0xf53(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    10b1:	e8 aa ff ff ff       	callq  1060 <puts@plt>
    10b6:	eb eb                	jmp    10a3 <main+0x23>
