...
/app/bin_gccgcc10_O3/2023_03_18-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10dc:	48 8b 2c 24          	mov    (%rsp),%rbp
    10e0:	48 89 df             	mov    %rbx,%rdi
    10e3:	e8 98 ff ff ff       	callq  1080 <time@plt>
    10e8:	48 8b 14 24          	mov    (%rsp),%rdx
    10ec:	48 39 ea             	cmp    %rbp,%rdx
    10ef:	74 ef                	je     10e0 <main+0x40>
    10f1:	31 c0                	xor    %eax,%eax
    10f3:	48 8d 35 0a 0f 00 00 	lea    0xf0a(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10fa:	bf 01 00 00 00       	mov    $0x1,%edi
