...
/app/bin_gccgcc10_O3/08_quick_quiz:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ac:	48 8d 2d 54 0f 00 00 	lea    0xf54(%rip),%rbp        # 2007 <_IO_stdin_used+0x7>
    10b3:	53                   	push   %rbx
    10b4:	bb 01 00 00 00       	mov    $0x1,%ebx
    10b9:	48 83 ec 18          	sub    $0x18,%rsp
    10bd:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10c4:	00 00 
    10c6:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10cb:	31 c0                	xor    %eax,%eax
    10cd:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    10d2:	e8 b9 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10d7:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    10de:	00 00 
    10e0:	89 da                	mov    %ebx,%edx
    10e2:	48 89 ee             	mov    %rbp,%rsi
    10e5:	bf 01 00 00 00       	mov    $0x1,%edi
    10ea:	31 c0                	xor    %eax,%eax
    10ec:	e8 8f ff ff ff       	callq  1080 <__printf_chk@plt>
    10f1:	83 c3 01             	add    $0x1,%ebx
    10f4:	39 5c 24 04          	cmp    %ebx,0x4(%rsp)
    10f8:	7d e6                	jge    10e0 <main+0x40>
    10fa:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10ff:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1106:	00 00 
    1108:	75 09                	jne    1113 <main+0x73>
    110a:	48 83 c4 18          	add    $0x18,%rsp
    110e:	31 c0                	xor    %eax,%eax
    1110:	5b                   	pop    %rbx
    1111:	5d                   	pop    %rbp
    1112:	c3                   	retq   
    1113:	e8 58 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
