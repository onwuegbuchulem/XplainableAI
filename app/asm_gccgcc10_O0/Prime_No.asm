...
/app/bin_gccgcc10_O0/Prime_No:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    11c0:	48 89 c6             	mov    %rax,%rsi
    11c3:	48 8d 3d 4c 0e 00 00 	lea    0xe4c(%rip),%rdi        # 2016 <_IO_stdin_used+0x16>
    11ca:	b8 00 00 00 00       	mov    $0x0,%eax
    11cf:	e8 bc fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11d4:	c7 45 f0 02 00 00 00 	movl   $0x2,-0x10(%rbp)
    11db:	eb 28                	jmp    1205 <main+0x7c>
    11dd:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11e0:	99                   	cltd   
    11e1:	f7 7d f0             	idivl  -0x10(%rbp)
    11e4:	89 d0                	mov    %edx,%eax
    11e6:	85 c0                	test   %eax,%eax
    11e8:	75 17                	jne    1201 <main+0x78>
    11ea:	48 8d 3d 28 0e 00 00 	lea    0xe28(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    11f1:	b8 00 00 00 00       	mov    $0x0,%eax
    11f6:	e8 85 fe ff ff       	callq  1080 <printf@plt>
    11fb:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    11ff:	eb 0c                	jmp    120d <main+0x84>
    1201:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    1205:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1208:	39 45 f0             	cmp    %eax,-0x10(%rbp)
    120b:	7c d0                	jl     11dd <main+0x54>
    120d:	83 7d f4 00          	cmpl   $0x0,-0xc(%rbp)
    1211:	75 16                	jne    1229 <main+0xa0>
    1213:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1216:	89 c6                	mov    %eax,%esi
    1218:	48 8d 3d 0d 0e 00 00 	lea    0xe0d(%rip),%rdi        # 202c <_IO_stdin_used+0x2c>
