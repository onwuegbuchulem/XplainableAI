...
/app/bin_gccgcc10_O2/2023_06-Exercise:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    1109:	48 8d 35 17 0f 00 00 	lea    0xf17(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    1110:	bf 01 00 00 00       	mov    $0x1,%edi
    1115:	e8 66 ff ff ff       	callq  1080 <__printf_chk@plt>
    111a:	8b 54 24 04          	mov    0x4(%rsp),%edx
    111e:	8b 0c 24             	mov    (%rsp),%ecx
    1121:	31 c0                	xor    %eax,%eax
    1123:	48 8d 35 11 0f 00 00 	lea    0xf11(%rip),%rsi        # 203b <_IO_stdin_used+0x3b>
    112a:	bf 01 00 00 00       	mov    $0x1,%edi
    112f:	89 14 24             	mov    %edx,(%rsp)
    1132:	89 4c 24 04          	mov    %ecx,0x4(%rsp)
    1136:	e8 45 ff ff ff       	callq  1080 <__printf_chk@plt>
    113b:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1140:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1147:	00 00 
    1149:	75 07                	jne    1152 <main+0xb2>
