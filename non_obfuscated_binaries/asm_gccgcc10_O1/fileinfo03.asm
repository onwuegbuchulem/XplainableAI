...
/app/bin_gccgcc10_O1/fileinfo03:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    120b:	0f 8e ad 00 00 00    	jle    12be <main+0xd5>
    ...
    1241:	0f 84 9e 00 00 00    	je     12e5 <main+0xfc>
    ...
    126f:	0f 84 9a 00 00 00    	je     130f <main+0x126>
    1275:	3d 00 40 00 00       	cmp    $0x4000,%eax
    127a:	0f 84 ad 00 00 00    	je     132d <main+0x144>
    1280:	48 89 da             	mov    %rbx,%rdx
    1283:	48 8d 35 f6 0d 00 00 	lea    0xdf6(%rip),%rsi        # 2080 <_IO_stdin_used+0x80>
    128a:	bf 01 00 00 00       	mov    $0x1,%edi
    128f:	b8 00 00 00 00       	mov    $0x0,%eax
    1294:	e8 27 fe ff ff       	callq  10c0 <__printf_chk@plt>
    1299:	48 8b 84 24 98 00 00 	mov    0x98(%rsp),%rax
    12a0:	00 
    12a1:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12a8:	00 00 
    12aa:	0f 85 9b 00 00 00    	jne    134b <main+0x162>
    12b0:	b8 00 00 00 00       	mov    $0x0,%eax
    12b5:	48 81 c4 a0 00 00 00 	add    $0xa0,%rsp
    12bc:	5b                   	pop    %rbx
    12bd:	c3                   	retq   
    12be:	48 8b 0d 5b 2d 00 00 	mov    0x2d5b(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    12c5:	ba 13 00 00 00       	mov    $0x13,%edx
    12ca:	be 01 00 00 00       	mov    $0x1,%esi
    12cf:	48 8d 3d 2e 0d 00 00 	lea    0xd2e(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    12d6:	e8 05 fe ff ff       	callq  10e0 <fwrite@plt>
    12db:	bf 01 00 00 00       	mov    $0x1,%edi
    12e0:	e8 eb fd ff ff       	callq  10d0 <exit@plt>
    12e5:	48 89 d9             	mov    %rbx,%rcx
    12e8:	48 8d 15 3d 0d 00 00 	lea    0xd3d(%rip),%rdx        # 202c <_IO_stdin_used+0x2c>
    12ef:	be 01 00 00 00       	mov    $0x1,%esi
    12f4:	48 8b 3d 25 2d 00 00 	mov    0x2d25(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    12fb:	b8 00 00 00 00       	mov    $0x0,%eax
    1300:	e8 eb fd ff ff       	callq  10f0 <__fprintf_chk@plt>
    1305:	bf 01 00 00 00       	mov    $0x1,%edi
    130a:	e8 c1 fd ff ff       	callq  10d0 <exit@plt>
    130f:	48 89 da             	mov    %rbx,%rdx
    1312:	48 8d 35 3a 0d 00 00 	lea    0xd3a(%rip),%rsi        # 2053 <_IO_stdin_used+0x53>
    1319:	bf 01 00 00 00       	mov    $0x1,%edi
    131e:	b8 00 00 00 00       	mov    $0x0,%eax
    1323:	e8 98 fd ff ff       	callq  10c0 <__printf_chk@plt>
    1328:	e9 6c ff ff ff       	jmpq   1299 <main+0xb0>
    132d:	48 89 da             	mov    %rbx,%rdx
    1330:	48 8d 35 32 0d 00 00 	lea    0xd32(%rip),%rsi        # 2069 <_IO_stdin_used+0x69>
    1337:	bf 01 00 00 00       	mov    $0x1,%edi
    133c:	b8 00 00 00 00       	mov    $0x0,%eax
    1341:	e8 7a fd ff ff       	callq  10c0 <__printf_chk@plt>
    1346:	e9 4e ff ff ff       	jmpq   1299 <main+0xb0>
    134b:	e8 50 fd ff ff       	callq  10a0 <__stack_chk_fail@plt>
