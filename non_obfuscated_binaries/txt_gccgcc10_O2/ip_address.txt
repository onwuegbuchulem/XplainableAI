...
/app/bin_gccgcc10_O2/ip_address:     file format elf64-x86-64
...
0000000000001330 <extractIpAddress>:
    ...
    1373:	89 c5                	mov    %eax,%ebp
    1375:	45 31 ed             	xor    %r13d,%r13d
    1378:	45 31 f6             	xor    %r14d,%r14d
    137b:	31 d2                	xor    %edx,%edx
    137d:	4c 8d 64 24 23       	lea    0x23(%rsp),%r12
    1382:	83 eb 01             	sub    $0x1,%ebx
    1385:	eb 29                	jmp    13b0 <extractIpAddress+0x80>
    ...
    139d:	0f 84 9d 00 00 00    	je     1440 <extractIpAddress+0x110>
    13a3:	41 83 c5 01          	add    $0x1,%r13d
    13a7:	41 0f b6 c5          	movzbl %r13b,%eax
    13ab:	66 39 e8             	cmp    %bp,%ax
    13ae:	73 3f                	jae    13ef <extractIpAddress+0xbf>
    13b0:	41 0f b6 c5          	movzbl %r13b,%eax
    13b4:	41 0f b6 0c 07       	movzbl (%r15,%rax,1),%ecx
    13b9:	0f b6 c2             	movzbl %dl,%eax
    13bc:	80 f9 2e             	cmp    $0x2e,%cl
    13bf:	75 cf                	jne    1390 <extractIpAddress+0x60>
    13c1:	c6 44 04 23 00       	movb   $0x0,0x23(%rsp,%rax,1)
    13c6:	4c 89 e7             	mov    %r12,%rdi
    13c9:	31 c0                	xor    %eax,%eax
    13cb:	41 83 c5 01          	add    $0x1,%r13d
    13cf:	e8 0c fd ff ff       	callq  10e0 <atoi@plt>
    13d4:	31 d2                	xor    %edx,%edx
    13d6:	41 89 c0             	mov    %eax,%r8d
    13d9:	41 0f b6 c6          	movzbl %r14b,%eax
    13dd:	41 83 c6 01          	add    $0x1,%r14d
    13e1:	44 88 44 04 1f       	mov    %r8b,0x1f(%rsp,%rax,1)
    13e6:	41 0f b6 c5          	movzbl %r13b,%eax
    13ea:	66 39 e8             	cmp    %bp,%ax
    13ed:	72 c1                	jb     13b0 <extractIpAddress+0x80>
    13ef:	0f b6 74 24 1f       	movzbl 0x1f(%rsp),%esi
    13f4:	0f b6 4c 24 20       	movzbl 0x20(%rsp),%ecx
    13f9:	0f b6 54 24 21       	movzbl 0x21(%rsp),%edx
    13fe:	0f b6 44 24 22       	movzbl 0x22(%rsp),%eax
    1403:	48 8b 7c 24 08       	mov    0x8(%rsp),%rdi
    1408:	66 89 37             	mov    %si,(%rdi)
    140b:	66 89 4f 02          	mov    %cx,0x2(%rdi)
    140f:	66 89 57 04          	mov    %dx,0x4(%rdi)
    1413:	66 89 47 06          	mov    %ax,0x6(%rdi)
    1417:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    141c:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1423:	00 00 
    1425:	75 33                	jne    145a <extractIpAddress+0x12a>
    1427:	48 83 c4 38          	add    $0x38,%rsp
    142b:	5b                   	pop    %rbx
    142c:	5d                   	pop    %rbp
    142d:	41 5c                	pop    %r12
    142f:	41 5d                	pop    %r13
    ...
    143d:	00 00 00 
    1440:	0f b6 c2             	movzbl %dl,%eax
    1443:	e9 79 ff ff ff       	jmpq   13c1 <extractIpAddress+0x91>
    ...
    1458:	eb a9                	jmp    1403 <extractIpAddress+0xd3>
