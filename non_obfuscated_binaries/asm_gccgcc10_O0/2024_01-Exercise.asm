...
/app/bin_gccgcc10_O0/2024_01-Exercise:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d ec 00 00 00 	lea    0xec(%rip),%rdi        # 1194 <main>
...
0000000000001169 <swap>:
    ...
    1185:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    1189:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    118d:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    1191:	90                   	nop
    1192:	5d                   	pop    %rbp
    1193:	c3                   	retq   
...
0000000000001194 <main>:
    ...
    11af:	c7 45 f0 05 00 00 00 	movl   $0x5,-0x10(%rbp)
    11b6:	c7 45 f4 0a 00 00 00 	movl   $0xa,-0xc(%rbp)
    11bd:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11c0:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11c3:	89 c6                	mov    %eax,%esi
    11c5:	48 8d 3d 38 0e 00 00 	lea    0xe38(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11cc:	b8 00 00 00 00       	mov    $0x0,%eax
    11d1:	e8 9a fe ff ff       	callq  1070 <printf@plt>
    11d6:	48 8d 55 f4          	lea    -0xc(%rbp),%rdx
    11da:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    11de:	48 89 d6             	mov    %rdx,%rsi
    11e1:	48 89 c7             	mov    %rax,%rdi
    11e4:	e8 80 ff ff ff       	callq  1169 <swap>
    11e9:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11ec:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11ef:	89 c6                	mov    %eax,%esi
    11f1:	48 8d 3d 25 0e 00 00 	lea    0xe25(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
