...
/app/bin_gccgcc10_O2/grade:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10eb:	00 
    10ec:	e8 af ff ff ff       	callq  10a0 <__printf_chk@plt>
    10f1:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    10f6:	48 8d 3d 1c 0f 00 00 	lea    0xf1c(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    10fd:	31 c0                	xor    %eax,%eax
    10ff:	e8 ac ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1104:	8b 44 24 04          	mov    0x4(%rsp),%eax
    1108:	83 f8 59             	cmp    $0x59,%eax
    110b:	7f 40                	jg     114d <main+0x8d>
    110d:	83 f8 4f             	cmp    $0x4f,%eax
    1110:	7f 18                	jg     112a <main+0x6a>
    1112:	83 f8 45             	cmp    $0x45,%eax
    1115:	7f 52                	jg     1169 <main+0xa9>
    1117:	83 f8 3b             	cmp    $0x3b,%eax
    111a:	7e 3f                	jle    115b <main+0x9b>
    111c:	48 8d 3d ff 0e 00 00 	lea    0xeff(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    1123:	e8 58 ff ff ff       	callq  1080 <puts@plt>
    1128:	eb 0c                	jmp    1136 <main+0x76>
    112a:	48 8d 3d ed 0e 00 00 	lea    0xeed(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    1131:	e8 4a ff ff ff       	callq  1080 <puts@plt>
    1136:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    113b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1142:	00 00 
    1144:	75 31                	jne    1177 <main+0xb7>
    1146:	31 c0                	xor    %eax,%eax
    1148:	48 83 c4 18          	add    $0x18,%rsp
    114c:	c3                   	retq   
    114d:	48 8d 3d c8 0e 00 00 	lea    0xec8(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    1154:	e8 27 ff ff ff       	callq  1080 <puts@plt>
    1159:	eb db                	jmp    1136 <main+0x76>
    115b:	48 8d 3d c2 0e 00 00 	lea    0xec2(%rip),%rdi        # 2024 <_IO_stdin_used+0x24>
    1162:	e8 19 ff ff ff       	callq  1080 <puts@plt>
    1167:	eb cd                	jmp    1136 <main+0x76>
    1169:	48 8d 3d b0 0e 00 00 	lea    0xeb0(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    1170:	e8 0b ff ff ff       	callq  1080 <puts@plt>
    1175:	eb bf                	jmp    1136 <main+0x76>
    1177:	e8 14 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
