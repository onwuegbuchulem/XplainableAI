...
/app/bin_gccgcc10_O3/urlencoder01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10d8:	48 8b 3d 41 2f 00 00 	mov    0x2f41(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    10df:	e8 bc ff ff ff       	callq  10a0 <getc@plt>
    10e4:	89 c5                	mov    %eax,%ebp
    10e6:	83 f8 ff             	cmp    $0xffffffff,%eax
    10e9:	74 55                	je     1140 <main+0x80>
    10eb:	8d 45 d6             	lea    -0x2a(%rbp),%eax
    10ee:	83 f8 35             	cmp    $0x35,%eax
    10f1:	76 35                	jbe    1128 <main+0x68>
    10f3:	83 fd 20             	cmp    $0x20,%ebp
    10f6:	74 58                	je     1150 <main+0x90>
    10f8:	e8 b3 ff ff ff       	callq  10b0 <__ctype_b_loc@plt>
    10fd:	49 89 c0             	mov    %rax,%r8
    1100:	48 63 c5             	movslq %ebp,%rax
    1103:	49 8b 10             	mov    (%r8),%rdx
    1106:	f6 04 42 08          	testb  $0x8,(%rdx,%rax,2)
    110a:	75 22                	jne    112e <main+0x6e>
    110c:	89 ea                	mov    %ebp,%edx
    ...
    1121:	eb b5                	jmp    10d8 <main+0x18>
    1123:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1128:	48 0f a3 c3          	bt     %rax,%rbx
    112c:	73 ca                	jae    10f8 <main+0x38>
    112e:	48 8b 35 db 2e 00 00 	mov    0x2edb(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1135:	89 ef                	mov    %ebp,%edi
    1137:	e8 44 ff ff ff       	callq  1080 <putc@plt>
    113c:	eb 9a                	jmp    10d8 <main+0x18>
    ...
    1157:	bf 2b 00 00 00       	mov    $0x2b,%edi
    115c:	e8 1f ff ff ff       	callq  1080 <putc@plt>
    1161:	e9 72 ff ff ff       	jmpq   10d8 <main+0x18>
