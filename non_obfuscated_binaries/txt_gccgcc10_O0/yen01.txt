...
/app/bin_gccgcc10_O0/yen01:     file format elf64-x86-64
...
0000000000001060 <wprintf@plt>:
    1060:	f3 0f 1e fa          	endbr64 
    1064:	f2 ff 25 5d 2f 00 00 	bnd jmpq *0x2f5d(%rip)        # 3fc8 <wprintf@GLIBC_2.2.5>
    106b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001070 <setlocale@plt>:
    1070:	f3 0f 1e fa          	endbr64 
    1074:	f2 ff 25 55 2f 00 00 	bnd jmpq *0x2f55(%rip)        # 3fd0 <setlocale@GLIBC_2.2.5>
...
0000000000001169 <main>:
    ...
    1175:	c7 45 fc a5 00 00 00 	movl   $0xa5,-0x4(%rbp)
    117c:	48 8d 35 85 0e 00 00 	lea    0xe85(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    1183:	bf 00 00 00 00       	mov    $0x0,%edi
    1188:	e8 e3 fe ff ff       	callq  1070 <setlocale@plt>
    118d:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1190:	89 c6                	mov    %eax,%esi
    1192:	48 8d 3d 7f 0e 00 00 	lea    0xe7f(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    1199:	b8 00 00 00 00       	mov    $0x0,%eax
    119e:	e8 bd fe ff ff       	callq  1060 <wprintf@plt>
