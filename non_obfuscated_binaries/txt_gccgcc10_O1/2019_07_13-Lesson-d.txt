...
/app/bin_gccgcc10_O1/2019_07_13-Lesson-d:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a2:	48 b8 20 20 20 20 20 	movabs $0x372b202020202020,%rax
    11a9:	20 2b 37 
    11ac:	48 89 44 24 0d       	mov    %rax,0xd(%rsp)
    11b1:	66 c7 44 24 15 38 39 	movw   $0x3938,0x15(%rsp)
    11b8:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    11bd:	48 89 e6             	mov    %rsp,%rsi
    11c0:	48 8d 5c 24 0d       	lea    0xd(%rsp),%rbx
    11c5:	ba 0a 00 00 00       	mov    $0xa,%edx
    11ca:	48 89 df             	mov    %rbx,%rdi
    11cd:	e8 ae fe ff ff       	callq  1080 <strtol@plt>
    11d2:	48 89 c1             	mov    %rax,%rcx
    11d5:	48 89 da             	mov    %rbx,%rdx
    ...
    11e9:	e8 a2 fe ff ff       	callq  1090 <__printf_chk@plt>
    11ee:	48 39 1c 24          	cmp    %rbx,(%rsp)
    11f2:	74 1b                	je     120f <main+0x86>
    11f4:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11f9:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1200:	00 00 
    1202:	75 26                	jne    122a <main+0xa1>
    1204:	b8 00 00 00 00       	mov    $0x0,%eax
    1209:	48 83 c4 20          	add    $0x20,%rsp
    120d:	5b                   	pop    %rbx
    120e:	c3                   	retq   
    120f:	48 89 da             	mov    %rbx,%rdx
    1212:	48 8d 35 07 0e 00 00 	lea    0xe07(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    1219:	bf 01 00 00 00       	mov    $0x1,%edi
    121e:	b8 00 00 00 00       	mov    $0x0,%eax
    1223:	e8 68 fe ff ff       	callq  1090 <__printf_chk@plt>
    1228:	eb ca                	jmp    11f4 <main+0x6b>
    122a:	e8 41 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    122f:	90                   	nop
