...
/app/bin_gccgcc10_O1/greet04:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11e1:	00 00 
    11e3:	48 89 44 24 58       	mov    %rax,0x58(%rsp)
    11e8:	31 c0                	xor    %eax,%eax
    11ea:	4c 8d 64 24 08       	lea    0x8(%rsp),%r12
    11ef:	4c 89 e7             	mov    %r12,%rdi
    11f2:	e8 b9 fe ff ff       	callq  10b0 <time@plt>
    11f7:	4c 89 e7             	mov    %r12,%rdi
    11fa:	e8 91 fe ff ff       	callq  1090 <localtime@plt>
    11ff:	48 89 c1             	mov    %rax,%rcx
    1202:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
    1207:	48 8d 15 fa 0d 00 00 	lea    0xdfa(%rip),%rdx        # 2008 <_IO_stdin_used+0x8>
    120e:	be 40 00 00 00       	mov    $0x40,%esi
    1213:	e8 b8 fe ff ff       	callq  10d0 <strftime@plt>
    1218:	48 8d 35 0c 0e 00 00 	lea    0xe0c(%rip),%rsi        # 202b <_IO_stdin_used+0x2b>
    121f:	bf 01 00 00 00       	mov    $0x1,%edi
    1224:	b8 00 00 00 00       	mov    $0x0,%eax
    1229:	e8 92 fe ff ff       	callq  10c0 <__printf_chk@plt>
    122e:	83 fb 01             	cmp    $0x1,%ebx
    1231:	7f 39                	jg     126c <main+0xa3>
    1233:	48 8d 54 24 10       	lea    0x10(%rsp),%rdx
    1238:	48 8d 35 fb 0d 00 00 	lea    0xdfb(%rip),%rsi        # 203a <_IO_stdin_used+0x3a>
    123f:	bf 01 00 00 00       	mov    $0x1,%edi
    1244:	b8 00 00 00 00       	mov    $0x0,%eax
    1249:	e8 72 fe ff ff       	callq  10c0 <__printf_chk@plt>
    124e:	48 8b 44 24 58       	mov    0x58(%rsp),%rax
    1253:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    125a:	00 00 
    125c:	75 2a                	jne    1288 <main+0xbf>
    125e:	b8 00 00 00 00       	mov    $0x0,%eax
    1263:	48 83 c4 60          	add    $0x60,%rsp
    1267:	5b                   	pop    %rbx
    1268:	5d                   	pop    %rbp
    1269:	41 5c                	pop    %r12
    126b:	c3                   	retq   
    126c:	48 8b 55 08          	mov    0x8(%rbp),%rdx
    1270:	48 8d 35 be 0d 00 00 	lea    0xdbe(%rip),%rsi        # 2035 <_IO_stdin_used+0x35>
    1277:	bf 01 00 00 00       	mov    $0x1,%edi
    127c:	b8 00 00 00 00       	mov    $0x0,%eax
    1281:	e8 3a fe ff ff       	callq  10c0 <__printf_chk@plt>
    1286:	eb ab                	jmp    1233 <main+0x6a>
