...
/app/bin_gccgcc10_O0/2023_10_14-Lesson-b:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    1215:	48 8d 35 ec 0d 00 00 	lea    0xdec(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    121c:	48 8d 3d e7 0d 00 00 	lea    0xde7(%rip),%rdi        # 200a <_IO_stdin_used+0xa>
    1223:	e8 d8 fe ff ff       	callq  1100 <fopen@plt>
    1228:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    122c:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
    1231:	75 2c                	jne    125f <main+0x56>
    1233:	48 8b 05 e6 2d 00 00 	mov    0x2de6(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    123a:	48 8d 15 c9 0d 00 00 	lea    0xdc9(%rip),%rdx        # 200a <_IO_stdin_used+0xa>
    1241:	48 8d 35 d8 0d 00 00 	lea    0xdd8(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    1248:	48 89 c7             	mov    %rax,%rdi
    124b:	b8 00 00 00 00       	mov    $0x0,%eax
    1250:	e8 8b fe ff ff       	callq  10e0 <fprintf@plt>
    1255:	bf 01 00 00 00       	mov    $0x1,%edi
    125a:	e8 b1 fe ff ff       	callq  1110 <exit@plt>
    125f:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%rbp)
    1266:	eb 19                	jmp    1281 <main+0x78>
    1268:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    126c:	48 89 c7             	mov    %rax,%rdi
    126f:	e8 5c fe ff ff       	callq  10d0 <fgetc@plt>
    1274:	88 45 f3             	mov    %al,-0xd(%rbp)
    1277:	80 7d f3 0a          	cmpb   $0xa,-0xd(%rbp)
    127b:	75 04                	jne    1281 <main+0x78>
    127d:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    1281:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1285:	48 89 c7             	mov    %rax,%rdi
    1288:	e8 63 fe ff ff       	callq  10f0 <feof@plt>
    128d:	85 c0                	test   %eax,%eax
    128f:	74 d7                	je     1268 <main+0x5f>
    1291:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1294:	89 c6                	mov    %eax,%esi
    1296:	48 8d 3d 9b 0d 00 00 	lea    0xd9b(%rip),%rdi        # 2038 <_IO_stdin_used+0x38>
    ...
    12ae:	e8 fd fd ff ff       	callq  10b0 <fclose@plt>
