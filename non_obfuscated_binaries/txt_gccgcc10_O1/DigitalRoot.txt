...
/app/bin_gccgcc10_O1/DigitalRoot:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b7:	48 8d 3d 60 0e 00 00 	lea    0xe60(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	44 8b 4c 24 04       	mov    0x4(%rsp),%r9d
    11cd:	44 89 ca             	mov    %r9d,%edx
    11d0:	41 b8 cd cc cc cc    	mov    $0xcccccccd,%r8d
    11d6:	be 00 00 00 00       	mov    $0x0,%esi
    11db:	eb 02                	jmp    11df <main+0x56>
    11dd:	89 c2                	mov    %eax,%edx
    11df:	85 d2                	test   %edx,%edx
    11e1:	74 23                	je     1206 <main+0x7d>
    11e3:	89 d0                	mov    %edx,%eax
    11e5:	49 0f af c0          	imul   %r8,%rax
    11e9:	48 c1 e8 23          	shr    $0x23,%rax
    11ed:	8d 0c 80             	lea    (%rax,%rax,4),%ecx
    11f0:	01 c9                	add    %ecx,%ecx
    11f2:	89 d7                	mov    %edx,%edi
    11f4:	29 cf                	sub    %ecx,%edi
    11f6:	01 fe                	add    %edi,%esi
    11f8:	83 fa 09             	cmp    $0x9,%edx
    11fb:	77 e0                	ja     11dd <main+0x54>
    11fd:	83 fe 09             	cmp    $0x9,%esi
    1200:	76 db                	jbe    11dd <main+0x54>
    1202:	89 f2                	mov    %esi,%edx
    1204:	eb d0                	jmp    11d6 <main+0x4d>
    1206:	89 f1                	mov    %esi,%ecx
    1208:	44 89 ca             	mov    %r9d,%edx
    120b:	48 8d 35 0f 0e 00 00 	lea    0xe0f(%rip),%rsi        # 2021 <_IO_stdin_used+0x21>
    1212:	bf 01 00 00 00       	mov    $0x1,%edi
    1217:	b8 00 00 00 00       	mov    $0x0,%eax
    121c:	e8 5f fe ff ff       	callq  1080 <__printf_chk@plt>
    1221:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1226:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    122d:	00 00 
    122f:	75 0a                	jne    123b <main+0xb2>
    1231:	b8 00 00 00 00       	mov    $0x0,%eax
    1236:	48 83 c4 18          	add    $0x18,%rsp
    123a:	c3                   	retq   
    123b:	e8 30 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
