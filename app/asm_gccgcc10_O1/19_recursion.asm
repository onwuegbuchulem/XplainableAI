...
/app/bin_gccgcc10_O1/19_recursion:     file format elf64-x86-64
...
0000000000001189 <result>:
    1189:	f3 0f 1e fa          	endbr64 
    118d:	53                   	push   %rbx
    118e:	48 89 fb             	mov    %rdi,%rbx
    1191:	48 83 ff 01          	cmp    $0x1,%rdi
    1195:	7f 05                	jg     119c <result+0x13>
    1197:	48 89 d8             	mov    %rbx,%rax
    119a:	5b                   	pop    %rbx
    119b:	c3                   	retq   
    119c:	48 8d 7f ff          	lea    -0x1(%rdi),%rdi
    11a0:	e8 e4 ff ff ff       	callq  1189 <result>
    11a5:	48 0f af d8          	imul   %rax,%rbx
    11a9:	eb ec                	jmp    1197 <result+0xe>
...
00000000000011ab <main>:
    ...
    11e3:	e8 a8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11e8:	48 8b 3c 24          	mov    (%rsp),%rdi
    11ec:	e8 98 ff ff ff       	callq  1189 <result>
    11f1:	48 89 c2             	mov    %rax,%rdx
    11f4:	48 8d 35 28 0e 00 00 	lea    0xe28(%rip),%rsi        # 2023 <_IO_stdin_used+0x23>
    11fb:	bf 01 00 00 00       	mov    $0x1,%edi
    1200:	b8 00 00 00 00       	mov    $0x0,%eax
    1205:	e8 76 fe ff ff       	callq  1080 <__printf_chk@plt>
    120a:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    120f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1216:	00 00 
    1218:	75 0a                	jne    1224 <main+0x79>
    121a:	b8 00 00 00 00       	mov    $0x0,%eax
    121f:	48 83 c4 18          	add    $0x18,%rsp
    1223:	c3                   	retq   
