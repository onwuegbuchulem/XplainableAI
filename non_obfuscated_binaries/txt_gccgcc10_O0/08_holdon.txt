...
/app/bin_gccgcc10_O0/08_holdon:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    1215:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
    121c:	eb 4d                	jmp    126b <main+0x82>
    ...
    1242:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1245:	48 98                	cltq   
    1247:	89 54 85 e0          	mov    %edx,-0x20(%rbp,%rax,4)
    124b:	8b 45 dc             	mov    -0x24(%rbp),%eax
    124e:	48 98                	cltq   
    1250:	8b 44 85 e0          	mov    -0x20(%rbp,%rax,4),%eax
    1254:	89 c6                	mov    %eax,%esi
    1256:	48 8d 3d a7 0d 00 00 	lea    0xda7(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    125d:	b8 00 00 00 00       	mov    $0x0,%eax
    1262:	e8 59 fe ff ff       	callq  10c0 <printf@plt>
    1267:	83 45 dc 01          	addl   $0x1,-0x24(%rbp)
    126b:	83 7d dc 0b          	cmpl   $0xb,-0x24(%rbp)
    126f:	7e ad                	jle    121e <main+0x35>
    1271:	bf 0a 00 00 00       	mov    $0xa,%edi
    1276:	e8 25 fe ff ff       	callq  10a0 <putchar@plt>
    127b:	b8 00 00 00 00       	mov    $0x0,%eax
    1280:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    1284:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    128b:	00 00 
    128d:	74 05                	je     1294 <main+0xab>
    128f:	e8 1c fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
    1294:	c9                   	leaveq 
    1295:	c3                   	retq   
