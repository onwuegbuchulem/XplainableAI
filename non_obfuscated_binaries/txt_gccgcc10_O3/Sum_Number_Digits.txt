...
/app/bin_gccgcc10_O3/Sum_Number_Digits:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ce:	48 8d 3d 49 0f 00 00 	lea    0xf49(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    ...
    1115:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%rsp)
    111c:	00 
    111d:	31 c0                	xor    %eax,%eax
    111f:	44 89 c2             	mov    %r8d,%edx
    1122:	bf 01 00 00 00       	mov    $0x1,%edi
    1127:	48 8d 35 e9 0e 00 00 	lea    0xee9(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    112e:	e8 4d ff ff ff       	callq  1080 <__printf_chk@plt>
    1133:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1138:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    113f:	00 00 
    1141:	75 07                	jne    114a <main+0xaa>
