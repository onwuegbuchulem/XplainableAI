...
/app/bin_gccgcc10_O3/Month_Days_Switch:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c8:	48 8d 35 39 0f 00 00 	lea    0xf39(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    ...
    10f0:	48 8d 3d 5f 0f 00 00 	lea    0xf5f(%rip),%rdi        # 2056 <_IO_stdin_used+0x56>
    10f7:	e8 b4 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10fc:	83 7c 24 04 0c       	cmpl   $0xc,0x4(%rsp)
    1101:	77 69                	ja     116c <main+0xac>
    1103:	8b 44 24 04          	mov    0x4(%rsp),%eax
    1107:	48 8d 15 6a 0f 00 00 	lea    0xf6a(%rip),%rdx        # 2078 <_IO_stdin_used+0x78>
    110e:	48 63 04 82          	movslq (%rdx,%rax,4),%rax
    1112:	48 01 d0             	add    %rdx,%rax
    1115:	3e ff e0             	notrack jmpq *%rax
    1118:	48 8d 35 3a 0f 00 00 	lea    0xf3a(%rip),%rsi        # 2059 <_IO_stdin_used+0x59>
    111f:	bf 01 00 00 00       	mov    $0x1,%edi
    1124:	31 c0                	xor    %eax,%eax
    1126:	e8 75 ff ff ff       	callq  10a0 <__printf_chk@plt>
    112b:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1130:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1137:	00 00 
    1139:	75 3f                	jne    117a <main+0xba>
    113b:	31 c0                	xor    %eax,%eax
    113d:	48 83 c4 18          	add    $0x18,%rsp
    1141:	c3                   	retq   
    1142:	48 8d 35 19 0f 00 00 	lea    0xf19(%rip),%rsi        # 2062 <_IO_stdin_used+0x62>
    1149:	bf 01 00 00 00       	mov    $0x1,%edi
    114e:	31 c0                	xor    %eax,%eax
    1150:	e8 4b ff ff ff       	callq  10a0 <__printf_chk@plt>
    1155:	eb d4                	jmp    112b <main+0x6b>
    1157:	48 8d 35 0d 0f 00 00 	lea    0xf0d(%rip),%rsi        # 206b <_IO_stdin_used+0x6b>
    115e:	bf 01 00 00 00       	mov    $0x1,%edi
    1163:	31 c0                	xor    %eax,%eax
    1165:	e8 36 ff ff ff       	callq  10a0 <__printf_chk@plt>
    116a:	eb bf                	jmp    112b <main+0x6b>
    116c:	48 8d 3d b5 0e 00 00 	lea    0xeb5(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    1173:	e8 08 ff ff ff       	callq  1080 <puts@plt>
    1178:	eb b1                	jmp    112b <main+0x6b>
