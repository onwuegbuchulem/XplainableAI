...
/app/bin_gccgcc10_O3/Zero_User_Input_Loop:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	55                   	push   %rbp
    10a5:	53                   	push   %rbx
    10a6:	48 8d 1d 57 0f 00 00 	lea    0xf57(%rip),%rbx        # 2004 <_IO_stdin_used+0x4>
    10ad:	48 83 ec 18          	sub    $0x18,%rsp
    10b1:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10b8:	00 00 
    10ba:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10bf:	31 c0                	xor    %eax,%eax
    10c1:	48 8d 6c 24 04       	lea    0x4(%rsp),%rbp
    10c6:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10cd:	00 00 00 
    10d0:	48 89 de             	mov    %rbx,%rsi
    10d3:	bf 01 00 00 00       	mov    $0x1,%edi
    10d8:	31 c0                	xor    %eax,%eax
    10da:	e8 a1 ff ff ff       	callq  1080 <__printf_chk@plt>
    10df:	48 89 ee             	mov    %rbp,%rsi
    10e2:	48 8d 3d 2e 0f 00 00 	lea    0xf2e(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    10e9:	31 c0                	xor    %eax,%eax
    10eb:	e8 a0 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10f0:	8b 54 24 04          	mov    0x4(%rsp),%edx
    10f4:	bf 01 00 00 00       	mov    $0x1,%edi
    10f9:	31 c0                	xor    %eax,%eax
    10fb:	48 8d 35 18 0f 00 00 	lea    0xf18(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    1102:	e8 79 ff ff ff       	callq  1080 <__printf_chk@plt>
    1107:	8b 44 24 04          	mov    0x4(%rsp),%eax
    110b:	85 c0                	test   %eax,%eax
    110d:	75 c1                	jne    10d0 <main+0x30>
    110f:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1114:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    111b:	00 00 
    111d:	75 09                	jne    1128 <main+0x88>
    111f:	48 83 c4 18          	add    $0x18,%rsp
    1123:	31 c0                	xor    %eax,%eax
    1125:	5b                   	pop    %rbx
    1126:	5d                   	pop    %rbp
    1127:	c3                   	retq   
    1128:	e8 43 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
