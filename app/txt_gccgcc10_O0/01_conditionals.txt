...
/app/bin_gccgcc10_O0/01_conditionals:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    115c:	83 7d fc 0a          	cmpl   $0xa,-0x4(%rbp)
    1160:	7e 18                	jle    117a <main+0x31>
    1162:	48 8d 3d 9b 0e 00 00 	lea    0xe9b(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1169:	e8 e2 fe ff ff       	callq  1050 <puts@plt>
    116e:	48 8d 3d a0 0e 00 00 	lea    0xea0(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    1175:	e8 d6 fe ff ff       	callq  1050 <puts@plt>
    117a:	8b 55 fc             	mov    -0x4(%rbp),%edx
    117d:	48 63 c2             	movslq %edx,%rax
    1180:	48 69 c0 67 66 66 66 	imul   $0x66666667,%rax,%rax
    1187:	48 c1 e8 20          	shr    $0x20,%rax
    118b:	d1 f8                	sar    %eax
    118d:	89 d1                	mov    %edx,%ecx
    118f:	c1 f9 1f             	sar    $0x1f,%ecx
    1192:	29 c8                	sub    %ecx,%eax
    1194:	89 c1                	mov    %eax,%ecx
    1196:	c1 e1 02             	shl    $0x2,%ecx
    1199:	01 c1                	add    %eax,%ecx
    119b:	89 d0                	mov    %edx,%eax
    119d:	29 c8                	sub    %ecx,%eax
    119f:	85 c0                	test   %eax,%eax
    11a1:	75 18                	jne    11bb <main+0x72>
    11a3:	48 8d 3d 87 0e 00 00 	lea    0xe87(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    11aa:	e8 a1 fe ff ff       	callq  1050 <puts@plt>
    11af:	48 8d 3d 94 0e 00 00 	lea    0xe94(%rip),%rdi        # 204a <_IO_stdin_used+0x4a>
    11b6:	e8 95 fe ff ff       	callq  1050 <puts@plt>
