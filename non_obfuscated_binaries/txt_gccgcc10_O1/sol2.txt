...
/app/bin_gccgcc10_O1/sol2:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ad:	e8 de fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11b2:	44 8b 54 24 04       	mov    0x4(%rsp),%r10d
    11b7:	41 b8 03 00 00 00    	mov    $0x3,%r8d
    11bd:	be 02 00 00 00       	mov    $0x2,%esi
    11c2:	41 b9 00 00 00 00    	mov    $0x0,%r9d
    11c8:	eb 07                	jmp    11d1 <main+0x48>
    11ca:	83 c6 01             	add    $0x1,%esi
    11cd:	41 83 c0 01          	add    $0x1,%r8d
    11d1:	85 f6                	test   %esi,%esi
    11d3:	7e f5                	jle    11ca <main+0x41>
    11d5:	b9 01 00 00 00       	mov    $0x1,%ecx
    11da:	bf 00 00 00 00       	mov    $0x0,%edi
    11df:	89 f0                	mov    %esi,%eax
    11e1:	99                   	cltd   
    11e2:	f7 f9                	idiv   %ecx
    11e4:	83 fa 01             	cmp    $0x1,%edx
    11e7:	83 d7 00             	adc    $0x0,%edi
    11ea:	83 c1 01             	add    $0x1,%ecx
    11ed:	44 39 c1             	cmp    %r8d,%ecx
    11f0:	75 ed                	jne    11df <main+0x56>
    11f2:	83 ff 02             	cmp    $0x2,%edi
    11f5:	75 d3                	jne    11ca <main+0x41>
    11f7:	41 83 c1 01          	add    $0x1,%r9d
    11fb:	45 39 ca             	cmp    %r9d,%r10d
    11fe:	75 ca                	jne    11ca <main+0x41>
    1200:	89 f2                	mov    %esi,%edx
    ...
    1218:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    121d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1224:	00 00 
    1226:	75 0a                	jne    1232 <main+0xa9>
