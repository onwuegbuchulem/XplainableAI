...
/app/bin_gccgcc10_O3/2019_03_30-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	53                   	push   %rbx
    1085:	e8 d6 ff ff ff       	callq  1060 <localeconv@plt>
    108a:	48 8d 35 73 0f 00 00 	lea    0xf73(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1091:	bf 01 00 00 00       	mov    $0x1,%edi
    1096:	48 8b 10             	mov    (%rax),%rdx
    1099:	48 89 c3             	mov    %rax,%rbx
    109c:	31 c0                	xor    %eax,%eax
    109e:	e8 cd ff ff ff       	callq  1070 <__printf_chk@plt>
    10a3:	48 8b 53 08          	mov    0x8(%rbx),%rdx
    10a7:	bf 01 00 00 00       	mov    $0x1,%edi
    10ac:	31 c0                	xor    %eax,%eax
    10ae:	48 8d 35 62 0f 00 00 	lea    0xf62(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    10b5:	e8 b6 ff ff ff       	callq  1070 <__printf_chk@plt>
    10ba:	48 8b 53 20          	mov    0x20(%rbx),%rdx
    10be:	bf 01 00 00 00       	mov    $0x1,%edi
    10c3:	31 c0                	xor    %eax,%eax
    10c5:	48 8d 35 64 0f 00 00 	lea    0xf64(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
