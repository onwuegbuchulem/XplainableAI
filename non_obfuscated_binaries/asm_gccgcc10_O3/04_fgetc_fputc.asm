...
/app/bin_gccgcc10_O3/04_fgetc_fputc:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108f:	48 8d 3d 70 0f 00 00 	lea    0xf70(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1096:	e8 d5 ff ff ff       	callq  1070 <fopen@plt>
    109b:	bf 63 00 00 00       	mov    $0x63,%edi
    10a0:	48 89 c6             	mov    %rax,%rsi
    10a3:	e8 b8 ff ff ff       	callq  1060 <fputc@plt>
