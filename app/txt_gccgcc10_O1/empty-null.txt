...
/app/bin_gccgcc10_O1/empty-null:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11e2:	c7 44 24 0e 00 00 00 	movl   $0x0,0xe(%rsp)
    11e9:	00 
    11ea:	c6 44 24 12 00       	movb   $0x0,0x12(%rsp)
    11ef:	48 8d 74 24 13       	lea    0x13(%rsp),%rsi
    11f4:	48 8d 7c 24 0e       	lea    0xe(%rsp),%rdi
    11f9:	e8 c2 fe ff ff       	callq  10c0 <strcmp@plt>
    11fe:	85 c0                	test   %eax,%eax
    1200:	75 7a                	jne    127c <main+0xb3>
    1202:	48 8d 3d fb 0d 00 00 	lea    0xdfb(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1209:	e8 82 fe ff ff       	callq  1090 <puts@plt>
    120e:	48 8d 7c 24 13       	lea    0x13(%rsp),%rdi
    1213:	e8 88 fe ff ff       	callq  10a0 <strlen@plt>
    1218:	48 89 c3             	mov    %rax,%rbx
    121b:	48 8d 7c 24 0e       	lea    0xe(%rsp),%rdi
    1220:	e8 7b fe ff ff       	callq  10a0 <strlen@plt>
    1225:	48 89 c2             	mov    %rax,%rdx
    1228:	48 89 d9             	mov    %rbx,%rcx
    ...
    123c:	e8 8f fe ff ff       	callq  10d0 <__printf_chk@plt>
    1241:	b9 05 00 00 00       	mov    $0x5,%ecx
    1246:	ba 05 00 00 00       	mov    $0x5,%edx
    124b:	48 8d 35 f5 0d 00 00 	lea    0xdf5(%rip),%rsi        # 2047 <_IO_stdin_used+0x47>
    1252:	bf 01 00 00 00       	mov    $0x1,%edi
    1257:	b8 00 00 00 00       	mov    $0x0,%eax
    125c:	e8 6f fe ff ff       	callq  10d0 <__printf_chk@plt>
    1261:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1266:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    126d:	00 00 
    126f:	75 19                	jne    128a <main+0xc1>
    1271:	b8 00 00 00 00       	mov    $0x0,%eax
    1276:	48 83 c4 20          	add    $0x20,%rsp
    127a:	5b                   	pop    %rbx
    127b:	c3                   	retq   
    127c:	48 8d 3d 96 0d 00 00 	lea    0xd96(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    1283:	e8 08 fe ff ff       	callq  1090 <puts@plt>
    1288:	eb 84                	jmp    120e <main+0x45>
    128a:	e8 21 fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
    128f:	90                   	nop
