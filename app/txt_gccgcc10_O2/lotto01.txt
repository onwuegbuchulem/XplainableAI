...
/app/bin_gccgcc10_O2/lotto01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c7:	48 8d 2d 5d 0f 00 00 	lea    0xf5d(%rip),%rbp        # 202b <_IO_stdin_used+0x2b>
    10ce:	53                   	push   %rbx
    10cf:	bb 05 00 00 00       	mov    $0x5,%ebx
    10d4:	48 83 ec 08          	sub    $0x8,%rsp
    10d8:	e8 b3 ff ff ff       	callq  1090 <time@plt>
    10dd:	48 89 c7             	mov    %rax,%rdi
    10e0:	e8 9b ff ff ff       	callq  1080 <srand@plt>
    10e5:	b9 45 00 00 00       	mov    $0x45,%ecx
    10ea:	ba 05 00 00 00       	mov    $0x5,%edx
    10ef:	31 c0                	xor    %eax,%eax
    10f1:	48 8d 35 10 0f 00 00 	lea    0xf10(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    10f8:	bf 01 00 00 00       	mov    $0x1,%edi
    10fd:	e8 9e ff ff ff       	callq  10a0 <__printf_chk@plt>
    1102:	e8 a9 ff ff ff       	callq  10b0 <rand@plt>
    1107:	48 89 ee             	mov    %rbp,%rsi
    110a:	bf 01 00 00 00       	mov    $0x1,%edi
    110f:	48 63 d0             	movslq %eax,%rdx
    1112:	89 c1                	mov    %eax,%ecx
    1114:	48 69 d2 db 81 b9 76 	imul   $0x76b981db,%rdx,%rdx
    111b:	c1 f9 1f             	sar    $0x1f,%ecx
    111e:	48 c1 fa 25          	sar    $0x25,%rdx
    1122:	29 ca                	sub    %ecx,%edx
    1124:	6b d2 45             	imul   $0x45,%edx,%edx
    1127:	29 d0                	sub    %edx,%eax
    1129:	8d 50 01             	lea    0x1(%rax),%edx
    112c:	31 c0                	xor    %eax,%eax
    112e:	e8 6d ff ff ff       	callq  10a0 <__printf_chk@plt>
    1133:	83 eb 01             	sub    $0x1,%ebx
    1136:	75 ca                	jne    1102 <main+0x42>
