...
/app/bin_gccgcc10_O1/05_realloc:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	53                   	push   %rbx
    118e:	bf 14 00 00 00       	mov    $0x14,%edi
    1193:	e8 d8 fe ff ff       	callq  1070 <malloc@plt>
    1198:	48 89 c3             	mov    %rax,%rbx
    119b:	c7 00 03 00 00 00    	movl   $0x3,(%rax)
    11a1:	ba 03 00 00 00       	mov    $0x3,%edx
    ...
    11b7:	e8 d4 fe ff ff       	callq  1090 <__printf_chk@plt>
    11bc:	be 28 00 00 00       	mov    $0x28,%esi
    11c1:	48 89 df             	mov    %rbx,%rdi
    11c4:	e8 b7 fe ff ff       	callq  1080 <realloc@plt>
    11c9:	8b 10                	mov    (%rax),%edx
