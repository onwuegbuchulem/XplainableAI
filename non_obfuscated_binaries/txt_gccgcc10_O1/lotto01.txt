...
/app/bin_gccgcc10_O1/lotto01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11b8:	e8 d3 fe ff ff       	callq  1090 <time@plt>
    11bd:	48 89 c7             	mov    %rax,%rdi
    11c0:	e8 bb fe ff ff       	callq  1080 <srand@plt>
    11c5:	b9 45 00 00 00       	mov    $0x45,%ecx
    11ca:	ba 05 00 00 00       	mov    $0x5,%edx
    ...
    11e0:	e8 bb fe ff ff       	callq  10a0 <__printf_chk@plt>
    11e5:	bb 05 00 00 00       	mov    $0x5,%ebx
    11ea:	48 8d 2d 3a 0e 00 00 	lea    0xe3a(%rip),%rbp        # 202b <_IO_stdin_used+0x2b>
    11f1:	e8 ba fe ff ff       	callq  10b0 <rand@plt>
    11f6:	48 63 d0             	movslq %eax,%rdx
    11f9:	48 69 d2 db 81 b9 76 	imul   $0x76b981db,%rdx,%rdx
    1200:	48 c1 fa 25          	sar    $0x25,%rdx
    1204:	89 c1                	mov    %eax,%ecx
    1206:	c1 f9 1f             	sar    $0x1f,%ecx
    1209:	29 ca                	sub    %ecx,%edx
    120b:	6b d2 45             	imul   $0x45,%edx,%edx
    120e:	29 d0                	sub    %edx,%eax
    1210:	8d 50 01             	lea    0x1(%rax),%edx
    1213:	48 89 ee             	mov    %rbp,%rsi
    1216:	bf 01 00 00 00       	mov    $0x1,%edi
    121b:	b8 00 00 00 00       	mov    $0x0,%eax
    1220:	e8 7b fe ff ff       	callq  10a0 <__printf_chk@plt>
    1225:	83 eb 01             	sub    $0x1,%ebx
    1228:	75 c7                	jne    11f1 <main+0x48>
