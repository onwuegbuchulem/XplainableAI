...
/app/bin_gccgcc10_O0/Even_DoWhile:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    118b:	83 e0 01             	and    $0x1,%eax
    118e:	85 c0                	test   %eax,%eax
    1190:	75 16                	jne    11a8 <main+0x3f>
    1192:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1195:	89 c6                	mov    %eax,%esi
    1197:	48 8d 3d 82 0e 00 00 	lea    0xe82(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    119e:	b8 00 00 00 00       	mov    $0x0,%eax
    11a3:	e8 c8 fe ff ff       	callq  1070 <printf@plt>
    11a8:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    11ac:	83 7d fc 32          	cmpl   $0x32,-0x4(%rbp)
    11b0:	7e d6                	jle    1188 <main+0x1f>
