...
/app/bin_gccgcc10_O0/2022_05_01-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11d1:	f3 0f 5a 45 f0       	cvtss2sd -0x10(%rbp),%xmm0
    11d6:	f3 0f 10 4d ec       	movss  -0x14(%rbp),%xmm1
    11db:	66 0f ef d2          	pxor   %xmm2,%xmm2
    11df:	f3 0f 5a d1          	cvtss2sd %xmm1,%xmm2
    11e3:	66 48 0f 7e d0       	movq   %xmm2,%rax
    11e8:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11eb:	66 0f 28 c8          	movapd %xmm0,%xmm1
    11ef:	89 d6                	mov    %edx,%esi
    11f1:	66 48 0f 6e c0       	movq   %rax,%xmm0
    11f6:	48 8d 3d 2b 0e 00 00 	lea    0xe2b(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    ...
    1210:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1217:	00 00 
    1219:	74 05                	je     1220 <main+0x97>
    121b:	e8 50 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1220:	c9                   	leaveq 
    1221:	c3                   	retq   
