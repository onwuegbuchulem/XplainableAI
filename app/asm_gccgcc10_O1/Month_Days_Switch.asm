...
/app/bin_gccgcc10_O1/Month_Days_Switch:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c1:	48 8d 35 40 0e 00 00 	lea    0xe40(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    11c8:	bf 01 00 00 00       	mov    $0x1,%edi
    11cd:	e8 ce fe ff ff       	callq  10a0 <__printf_chk@plt>
    11d2:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11d7:	48 8d 3d 78 0e 00 00 	lea    0xe78(%rip),%rdi        # 2056 <_IO_stdin_used+0x56>
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	e8 c8 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e8:	83 7c 24 04 0c       	cmpl   $0xc,0x4(%rsp)
    11ed:	77 75                	ja     1264 <main+0xbb>
    11ef:	8b 44 24 04          	mov    0x4(%rsp),%eax
    11f3:	48 8d 15 7e 0e 00 00 	lea    0xe7e(%rip),%rdx        # 2078 <_IO_stdin_used+0x78>
    11fa:	48 63 04 82          	movslq (%rdx,%rax,4),%rax
    11fe:	48 01 d0             	add    %rdx,%rax
    1201:	3e ff e0             	notrack jmpq *%rax
    1204:	48 8d 35 4e 0e 00 00 	lea    0xe4e(%rip),%rsi        # 2059 <_IO_stdin_used+0x59>
    ...
    1226:	00 00 
    1228:	75 48                	jne    1272 <main+0xc9>
    122a:	b8 00 00 00 00       	mov    $0x0,%eax
    122f:	48 83 c4 18          	add    $0x18,%rsp
    1233:	c3                   	retq   
    1234:	48 8d 35 27 0e 00 00 	lea    0xe27(%rip),%rsi        # 2062 <_IO_stdin_used+0x62>
    123b:	bf 01 00 00 00       	mov    $0x1,%edi
    1240:	b8 00 00 00 00       	mov    $0x0,%eax
    1245:	e8 56 fe ff ff       	callq  10a0 <__printf_chk@plt>
    124a:	eb ce                	jmp    121a <main+0x71>
    124c:	48 8d 35 18 0e 00 00 	lea    0xe18(%rip),%rsi        # 206b <_IO_stdin_used+0x6b>
    1253:	bf 01 00 00 00       	mov    $0x1,%edi
    1258:	b8 00 00 00 00       	mov    $0x0,%eax
    125d:	e8 3e fe ff ff       	callq  10a0 <__printf_chk@plt>
    1262:	eb b6                	jmp    121a <main+0x71>
    1264:	48 8d 3d bd 0d 00 00 	lea    0xdbd(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    126b:	e8 10 fe ff ff       	callq  1080 <puts@plt>
    1270:	eb a8                	jmp    121a <main+0x71>
    1272:	e8 19 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
