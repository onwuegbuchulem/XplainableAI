...
/app/bin_gccgcc10_O1/pattern:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c9:	48 8d 3d 38 0e 00 00 	lea    0xe38(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11d0:	e8 bb fe ff ff       	callq  1090 <puts@plt>
    11d5:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11da:	48 8d 3d 64 0e 00 00 	lea    0xe64(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    11e1:	b8 00 00 00 00       	mov    $0x0,%eax
    11e6:	e8 c5 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11eb:	8b 44 24 04          	mov    0x4(%rsp),%eax
    11ef:	89 c5                	mov    %eax,%ebp
    11f1:	41 bd 02 00 00 00    	mov    $0x2,%r13d
    11f7:	44 8d 70 01          	lea    0x1(%rax),%r14d
    11fb:	85 c0                	test   %eax,%eax
    11fd:	7f 6f                	jg     126e <main+0xc5>
    11ff:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1204:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    120b:	00 00 
    120d:	75 6b                	jne    127a <main+0xd1>
    120f:	b8 00 00 00 00       	mov    $0x0,%eax
    1214:	48 83 c4 10          	add    $0x10,%rsp
    1218:	5b                   	pop    %rbx
    1219:	5d                   	pop    %rbp
    121a:	41 5c                	pop    %r12
    121c:	41 5d                	pop    %r13
    ...
    1226:	e8 55 fe ff ff       	callq  1080 <putchar@plt>
    122b:	83 c3 01             	add    $0x1,%ebx
    122e:	39 eb                	cmp    %ebp,%ebx
    1230:	75 ef                	jne    1221 <main+0x78>
    1232:	83 ed 01             	sub    $0x1,%ebp
    1235:	45 89 ec             	mov    %r13d,%r12d
    1238:	41 83 fd 01          	cmp    $0x1,%r13d
    123c:	7e 17                	jle    1255 <main+0xac>
    123e:	bb 01 00 00 00       	mov    $0x1,%ebx
    1243:	bf 2a 00 00 00       	mov    $0x2a,%edi
    1248:	e8 33 fe ff ff       	callq  1080 <putchar@plt>
    124d:	83 c3 01             	add    $0x1,%ebx
    1250:	44 39 e3             	cmp    %r12d,%ebx
    1253:	75 ee                	jne    1243 <main+0x9a>
    1255:	bf 0a 00 00 00       	mov    $0xa,%edi
    125a:	e8 21 fe ff ff       	callq  1080 <putchar@plt>
    125f:	41 83 c5 02          	add    $0x2,%r13d
    1263:	44 89 f0             	mov    %r14d,%eax
    1266:	29 e8                	sub    %ebp,%eax
    1268:	39 44 24 04          	cmp    %eax,0x4(%rsp)
    126c:	7c 91                	jl     11ff <main+0x56>
    126e:	bb 01 00 00 00       	mov    $0x1,%ebx
    1273:	83 fd 01             	cmp    $0x1,%ebp
    1276:	7f a9                	jg     1221 <main+0x78>
    1278:	eb b8                	jmp    1232 <main+0x89>
