...
/app/bin_gccgcc10_O3/03_type_conversion:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1072:	f2 0f 10 05 be 0f 00 	movsd  0xfbe(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    1079:	00 
    107a:	48 8d 35 83 0f 00 00 	lea    0xf83(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1081:	e8 ca ff ff ff       	callq  1050 <__printf_chk@plt>
    1086:	ba 06 00 00 00       	mov    $0x6,%edx
    108b:	48 8d 35 8a 0f 00 00 	lea    0xf8a(%rip),%rsi        # 201c <_IO_stdin_used+0x1c>
    1092:	31 c0                	xor    %eax,%eax
    1094:	bf 01 00 00 00       	mov    $0x1,%edi
    1099:	e8 b2 ff ff ff       	callq  1050 <__printf_chk@plt>
    109e:	31 c0                	xor    %eax,%eax
    10a0:	48 83 c4 08          	add    $0x8,%rsp
    10a4:	c3                   	retq   
    10a5:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10ac:	00 00 00 
    10af:	90                   	nop
