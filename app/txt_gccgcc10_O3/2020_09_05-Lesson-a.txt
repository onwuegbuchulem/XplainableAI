...
/app/bin_gccgcc10_O3/2020_09_05-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c9:	48 8d 4c 24 07       	lea    0x7(%rsp),%rcx
    10ce:	31 c0                	xor    %eax,%eax
    10d0:	48 8d 54 24 06       	lea    0x6(%rsp),%rdx
    10d5:	48 8d 74 24 05       	lea    0x5(%rsp),%rsi
    10da:	48 8d 3d 30 0f 00 00 	lea    0xf30(%rip),%rdi        # 2011 <_IO_stdin_used+0x11>
    10e1:	e8 aa ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10e6:	0f be 4c 24 06       	movsbl 0x6(%rsp),%ecx
    10eb:	0f be 54 24 05       	movsbl 0x5(%rsp),%edx
    10f0:	31 c0                	xor    %eax,%eax
    10f2:	44 0f be 44 24 07    	movsbl 0x7(%rsp),%r8d
    10f8:	48 8d 35 19 0f 00 00 	lea    0xf19(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    10ff:	bf 01 00 00 00       	mov    $0x1,%edi
    1104:	e8 77 ff ff ff       	callq  1080 <__printf_chk@plt>
    1109:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    110e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1115:	00 00 
    1117:	75 07                	jne    1120 <main+0x80>
    1119:	31 c0                	xor    %eax,%eax
    111b:	48 83 c4 18          	add    $0x18,%rsp
    111f:	c3                   	retq   
