...
/app/bin_gccgcc10_O1/NaiveModularInverse:     file format elf64-x86-64
...
0000000000001189 <naiveModInv>:
    ...
    118f:	99                   	cltd   
    1190:	f7 fe                	idiv   %esi
    1192:	41 89 d0             	mov    %edx,%r8d
    1195:	89 d7                	mov    %edx,%edi
    1197:	83 fe 01             	cmp    $0x1,%esi
    119a:	7e 21                	jle    11bd <naiveModInv+0x34>
    119c:	83 fa 01             	cmp    $0x1,%edx
    119f:	74 1c                	je     11bd <naiveModInv+0x34>
    11a1:	8d 0c 12             	lea    (%rdx,%rdx,1),%ecx
    11a4:	bf 01 00 00 00       	mov    $0x1,%edi
    11a9:	83 c7 01             	add    $0x1,%edi
    11ac:	39 fe                	cmp    %edi,%esi
    11ae:	74 0d                	je     11bd <naiveModInv+0x34>
    11b0:	89 c8                	mov    %ecx,%eax
    11b2:	99                   	cltd   
    11b3:	f7 fe                	idiv   %esi
    11b5:	44 01 c1             	add    %r8d,%ecx
    11b8:	83 fa 01             	cmp    $0x1,%edx
    11bb:	75 ec                	jne    11a9 <naiveModInv+0x20>
    11bd:	89 f8                	mov    %edi,%eax
    11bf:	c3                   	retq   

00000000000011c0 <main>:
    11c0:	f3 0f 1e fa          	endbr64 
    11c4:	48 83 ec 18          	sub    $0x18,%rsp
    11c8:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11cf:	00 00 
    11d1:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    ...
    11e9:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    11ee:	48 89 e6             	mov    %rsp,%rsi
    11f1:	48 8d 3d 1c 0e 00 00 	lea    0xe1c(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    11f8:	b8 00 00 00 00       	mov    $0x0,%eax
    11fd:	e8 8e fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    1202:	8b 74 24 04          	mov    0x4(%rsp),%esi
    1206:	8b 3c 24             	mov    (%rsp),%edi
    1209:	e8 7b ff ff ff       	callq  1189 <naiveModInv>
    120e:	89 c2                	mov    %eax,%edx
    1210:	48 8d 35 02 0e 00 00 	lea    0xe02(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    1217:	bf 01 00 00 00       	mov    $0x1,%edi
    121c:	b8 00 00 00 00       	mov    $0x0,%eax
    1221:	e8 5a fe ff ff       	callq  1080 <__printf_chk@plt>
    1226:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    122b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1232:	00 00 
    1234:	75 0a                	jne    1240 <main+0x80>
    1236:	b8 00 00 00 00       	mov    $0x0,%eax
    123b:	48 83 c4 18          	add    $0x18,%rsp
    123f:	c3                   	retq   
    1240:	e8 2b fe ff ff       	callq  1070 <__stack_chk_fail@plt>
