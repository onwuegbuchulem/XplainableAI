...
/app/bin_gccgcc10_O0/stream01:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1181:	e8 da fe ff ff       	callq  1060 <printf@plt>
    1186:	e8 e5 fe ff ff       	callq  1070 <getchar@plt>
    118b:	89 45 f8             	mov    %eax,-0x8(%rbp)
    118e:	48 8d 3d 6f 0e 00 00 	lea    0xe6f(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1195:	b8 00 00 00 00       	mov    $0x0,%eax
    119a:	e8 c1 fe ff ff       	callq  1060 <printf@plt>
    119f:	e8 cc fe ff ff       	callq  1070 <getchar@plt>
    11a4:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11a7:	8b 55 fc             	mov    -0x4(%rbp),%edx
    11aa:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11ad:	89 c6                	mov    %eax,%esi
    11af:	48 8d 3d 5d 0e 00 00 	lea    0xe5d(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    11b6:	b8 00 00 00 00       	mov    $0x0,%eax
    11bb:	e8 a0 fe ff ff       	callq  1060 <printf@plt>
