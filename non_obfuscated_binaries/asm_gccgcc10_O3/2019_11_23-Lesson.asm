...
/app/bin_gccgcc10_O3/2019_11_23-Lesson:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    106a:	e8 01 01 00 00       	callq  1170 <left>
    106f:	31 c0                	xor    %eax,%eax
    1071:	e8 0a 01 00 00       	callq  1180 <right>
...
0000000000001170 <left>:
    1170:	f3 0f 1e fa          	endbr64 
    1174:	48 8d 3d 89 0e 00 00 	lea    0xe89(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    117b:	e9 d0 fe ff ff       	jmpq   1050 <puts@plt>

0000000000001180 <right>:
    1180:	f3 0f 1e fa          	endbr64 
    1184:	48 8d 3d 7e 0e 00 00 	lea    0xe7e(%rip),%rdi        # 2009 <_IO_stdin_used+0x9>
    118b:	e9 c0 fe ff ff       	jmpq   1050 <puts@plt>
