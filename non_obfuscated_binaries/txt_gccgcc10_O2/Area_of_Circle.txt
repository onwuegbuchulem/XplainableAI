...
/app/bin_gccgcc10_O2/Area_of_Circle:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ce:	48 8d 3d 4b 0f 00 00 	lea    0xf4b(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    ...
    10e5:	f2 0f 10 05 3b 0f 00 	movsd  0xf3b(%rip),%xmm0        # 2028 <_IO_stdin_used+0x28>
    10ec:	00 
    10ed:	f3 0f 5a 4c 24 04    	cvtss2sd 0x4(%rsp),%xmm1
    10f3:	48 8d 35 1e 0f 00 00 	lea    0xf1e(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    10fa:	b8 01 00 00 00       	mov    $0x1,%eax
    10ff:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    1103:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    1107:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    110b:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    ...
    1120:	00 00 
    1122:	75 05                	jne    1129 <main+0x89>
    1124:	48 83 c4 18          	add    $0x18,%rsp
    1128:	c3                   	retq   
    1129:	e8 42 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
