...
/app/bin_gccgcc10_O1/binary_to_hexadecimal:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b5:	48 8d 3d 62 0e 00 00 	lea    0xe62(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    11bc:	b8 00 00 00 00       	mov    $0x0,%eax
    11c1:	e8 ca fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c6:	48 8b 0c 24          	mov    (%rsp),%rcx
    11ca:	48 85 c9             	test   %rcx,%rcx
    11cd:	74 7f                	je     124e <main+0xc5>
    11cf:	be 01 00 00 00       	mov    $0x1,%esi
    11d4:	bf 00 00 00 00       	mov    $0x0,%edi
    11d9:	49 b8 67 66 66 66 66 	movabs $0x6666666666666667,%r8
    11e0:	66 66 66 
    11e3:	48 89 c8             	mov    %rcx,%rax
    11e6:	49 f7 e8             	imul   %r8
    11e9:	48 c1 fa 02          	sar    $0x2,%rdx
    11ed:	48 89 c8             	mov    %rcx,%rax
    11f0:	48 c1 f8 3f          	sar    $0x3f,%rax
    11f4:	48 29 c2             	sub    %rax,%rdx
    11f7:	48 8d 04 92          	lea    (%rdx,%rdx,4),%rax
    11fb:	48 01 c0             	add    %rax,%rax
    11fe:	48 29 c1             	sub    %rax,%rcx
    1201:	48 0f af ce          	imul   %rsi,%rcx
    1205:	48 01 cf             	add    %rcx,%rdi
    1208:	48 01 f6             	add    %rsi,%rsi
    120b:	48 89 d1             	mov    %rdx,%rcx
    120e:	48 85 d2             	test   %rdx,%rdx
    1211:	75 d0                	jne    11e3 <main+0x5a>
    1213:	48 c7 04 24 00 00 00 	movq   $0x0,(%rsp)
    121a:	00 
    121b:	48 89 fa             	mov    %rdi,%rdx
    121e:	48 8d 35 03 0e 00 00 	lea    0xe03(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    ...
    1240:	00 00 
    1242:	75 0f                	jne    1253 <main+0xca>
    1244:	b8 00 00 00 00       	mov    $0x0,%eax
    1249:	48 83 c4 18          	add    $0x18,%rsp
    124d:	c3                   	retq   
    124e:	48 89 cf             	mov    %rcx,%rdi
    1251:	eb c8                	jmp    121b <main+0x92>
