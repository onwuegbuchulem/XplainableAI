...
/app/bin_gccgcc10_O0/casetricks01:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	48 b8 41 53 43 49 49 	movabs $0x616d204949435341,%rax
    118b:	20 6d 61 
    118e:	48 ba 6b 65 73 20 6d 	movabs $0x6820796d2073656b,%rdx
    1195:	79 20 68 
    ...
    11bc:	66 c7 45 f0 0a 00    	movw   $0xa,-0x10(%rbp)
    11c2:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    11c6:	48 89 45 c8          	mov    %rax,-0x38(%rbp)
    11ca:	eb 42                	jmp    120e <main+0xa5>
    11cc:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    11d0:	0f b6 00             	movzbl (%rax),%eax
    11d3:	3c 40                	cmp    $0x40,%al
    11d5:	7e 21                	jle    11f8 <main+0x8f>
    11d7:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    11db:	0f b6 00             	movzbl (%rax),%eax
    11de:	3c 5a                	cmp    $0x5a,%al
    11e0:	7f 16                	jg     11f8 <main+0x8f>
    11e2:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    11e6:	0f b6 00             	movzbl (%rax),%eax
    11e9:	83 c8 20             	or     $0x20,%eax
    11ec:	0f be c0             	movsbl %al,%eax
    11ef:	89 c7                	mov    %eax,%edi
    11f1:	e8 6a fe ff ff       	callq  1060 <putchar@plt>
    11f6:	eb 11                	jmp    1209 <main+0xa0>
    11f8:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    11fc:	0f b6 00             	movzbl (%rax),%eax
    11ff:	0f be c0             	movsbl %al,%eax
    1202:	89 c7                	mov    %eax,%edi
    1204:	e8 57 fe ff ff       	callq  1060 <putchar@plt>
    1209:	48 83 45 c8 01       	addq   $0x1,-0x38(%rbp)
    120e:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1212:	0f b6 00             	movzbl (%rax),%eax
    1215:	84 c0                	test   %al,%al
    1217:	75 b3                	jne    11cc <main+0x63>
    1219:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    121d:	48 89 45 c8          	mov    %rax,-0x38(%rbp)
    1221:	eb 44                	jmp    1267 <main+0xfe>
    1223:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1227:	0f b6 00             	movzbl (%rax),%eax
    122a:	3c 60                	cmp    $0x60,%al
    122c:	7e 23                	jle    1251 <main+0xe8>
    122e:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1232:	0f b6 00             	movzbl (%rax),%eax
    1235:	3c 7a                	cmp    $0x7a,%al
    1237:	7f 18                	jg     1251 <main+0xe8>
    1239:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    123d:	0f b6 00             	movzbl (%rax),%eax
    1240:	0f be c0             	movsbl %al,%eax
    1243:	25 df 00 00 00       	and    $0xdf,%eax
    1248:	89 c7                	mov    %eax,%edi
    124a:	e8 11 fe ff ff       	callq  1060 <putchar@plt>
    124f:	eb 11                	jmp    1262 <main+0xf9>
    1251:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    1255:	0f b6 00             	movzbl (%rax),%eax
    1258:	0f be c0             	movsbl %al,%eax
    125b:	89 c7                	mov    %eax,%edi
    125d:	e8 fe fd ff ff       	callq  1060 <putchar@plt>
    1262:	48 83 45 c8 01       	addq   $0x1,-0x38(%rbp)
    1267:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    126b:	0f b6 00             	movzbl (%rax),%eax
    126e:	84 c0                	test   %al,%al
    1270:	75 b1                	jne    1223 <main+0xba>
    1272:	b8 00 00 00 00       	mov    $0x0,%eax
    1277:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    127b:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1282:	00 00 
    1284:	74 05                	je     128b <main+0x122>
