...
/app/bin_gccgcc10_O1/2020_08_01-Lesson:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d 68 01 00 00 	lea    0x168(%rip),%rdi        # 1230 <main>
...
0000000000001189 <significance>:
    ...
    118d:	53                   	push   %rbx
    118e:	48 83 ec 40          	sub    $0x40,%rsp
    1192:	66 48 0f 7e cb       	movq   %xmm1,%rbx
    1197:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    119e:	00 00 
    11a0:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    11a5:	31 c0                	xor    %eax,%eax
    11a7:	48 89 e7             	mov    %rsp,%rdi
    11aa:	4c 8d 05 53 0e 00 00 	lea    0xe53(%rip),%r8        # 2004 <_IO_stdin_used+0x4>
    11b1:	b9 11 00 00 00       	mov    $0x11,%ecx
    11b6:	ba 01 00 00 00       	mov    $0x1,%edx
    11bb:	be 11 00 00 00       	mov    $0x11,%esi
    11c0:	b8 01 00 00 00       	mov    $0x1,%eax
    11c5:	e8 a6 fe ff ff       	callq  1070 <__snprintf_chk@plt>
    11ca:	48 8d 7c 24 20       	lea    0x20(%rsp),%rdi
    11cf:	66 48 0f 6e c3       	movq   %rbx,%xmm0
    11d4:	4c 8d 05 29 0e 00 00 	lea    0xe29(%rip),%r8        # 2004 <_IO_stdin_used+0x4>
    11db:	b9 11 00 00 00       	mov    $0x11,%ecx
    11e0:	ba 01 00 00 00       	mov    $0x1,%edx
    11e5:	be 11 00 00 00       	mov    $0x11,%esi
    11ea:	b8 01 00 00 00       	mov    $0x1,%eax
    11ef:	e8 7c fe ff ff       	callq  1070 <__snprintf_chk@plt>
    11f4:	b8 00 00 00 00       	mov    $0x0,%eax
    11f9:	48 8d 74 24 1f       	lea    0x1f(%rsp),%rsi
    11fe:	eb 09                	jmp    1209 <significance+0x80>
    1200:	48 83 c0 01          	add    $0x1,%rax
    1204:	38 14 06             	cmp    %dl,(%rsi,%rax,1)
    1207:	75 0a                	jne    1213 <significance+0x8a>
    1209:	89 c1                	mov    %eax,%ecx
    120b:	0f b6 14 04          	movzbl (%rsp,%rax,1),%edx
    120f:	84 d2                	test   %dl,%dl
    1211:	75 ed                	jne    1200 <significance+0x77>
    1213:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1218:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    121f:	00 00 
    1221:	75 08                	jne    122b <significance+0xa2>
    1223:	89 c8                	mov    %ecx,%eax
    1225:	48 83 c4 40          	add    $0x40,%rsp
    1229:	5b                   	pop    %rbx
    122a:	c3                   	retq   
    122b:	e8 50 fe ff ff       	callq  1080 <__stack_chk_fail@plt>

0000000000001230 <main>:
    1230:	f3 0f 1e fa          	endbr64 
    1234:	48 83 ec 08          	sub    $0x8,%rsp
    1238:	48 8b 05 f9 0d 00 00 	mov    0xdf9(%rip),%rax        # 2038 <_IO_stdin_used+0x38>
    123f:	66 48 0f 6e c8       	movq   %rax,%xmm1
    1244:	48 8b 05 f5 0d 00 00 	mov    0xdf5(%rip),%rax        # 2040 <_IO_stdin_used+0x40>
    124b:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1250:	e8 34 ff ff ff       	callq  1189 <significance>
    1255:	89 c2                	mov    %eax,%edx
    1257:	48 8b 05 da 0d 00 00 	mov    0xdda(%rip),%rax        # 2038 <_IO_stdin_used+0x38>
    125e:	66 48 0f 6e c8       	movq   %rax,%xmm1
    1263:	48 8b 05 d6 0d 00 00 	mov    0xdd6(%rip),%rax        # 2040 <_IO_stdin_used+0x40>
    126a:	66 48 0f 6e c0       	movq   %rax,%xmm0
    126f:	48 8d 35 92 0d 00 00 	lea    0xd92(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
