...
/app/bin_gccgcc10_O0/2023_10_07-Lesson:     file format elf64-x86-64
...
0000000000001070 <access@plt>:
    1070:	f3 0f 1e fa          	endbr64 
    1074:	f2 ff 25 55 2f 00 00 	bnd jmpq *0x2f55(%rip)        # 3fd0 <access@GLIBC_2.2.5>
...
0000000000001169 <main>:
    ...
    1175:	be 00 00 00 00       	mov    $0x0,%esi
    117a:	48 8d 3d 87 0e 00 00 	lea    0xe87(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    1181:	e8 ea fe ff ff       	callq  1070 <access@plt>
    1186:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1189:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%rbp)
    118d:	75 0e                	jne    119d <main+0x34>
    118f:	48 8d 3d 8a 0e 00 00 	lea    0xe8a(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    1196:	e8 c5 fe ff ff       	callq  1060 <puts@plt>
    119b:	eb 0c                	jmp    11a9 <main+0x40>
    119d:	48 8d 3d 9d 0e 00 00 	lea    0xe9d(%rip),%rdi        # 2041 <_IO_stdin_used+0x41>
    11a4:	e8 b7 fe ff ff       	callq  1060 <puts@plt>
