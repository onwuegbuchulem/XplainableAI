...
/app/bin_gccgcc10_O0/assignment23:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    118c:	c7 45 ec 05 00 00 00 	movl   $0x5,-0x14(%rbp)
    ...
    11ad:	c7 00 06 00 00 00    	movl   $0x6,(%rax)
    ...
    11c9:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    11cd:	c7 00 07 00 00 00    	movl   $0x7,(%rax)
    11d3:	8b 45 ec             	mov    -0x14(%rbp),%eax
    ...
    11ee:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11f2:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11f9:	00 00 
    11fb:	74 05                	je     1202 <main+0x99>
    11fd:	e8 5e fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    1202:	c9                   	leaveq 
    1203:	c3                   	retq   
