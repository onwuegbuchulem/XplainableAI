...
/app/bin_gccgcc10_O0/Pattern-3:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117c:	eb 39                	jmp    11b7 <main+0x4e>
    117e:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%rbp)
    1185:	eb 1a                	jmp    11a1 <main+0x38>
    ...
    1198:	e8 d3 fe ff ff       	callq  1070 <printf@plt>
    119d:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    11a1:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11a4:	3b 45 f8             	cmp    -0x8(%rbp),%eax
    11a7:	7e de                	jle    1187 <main+0x1e>
    11a9:	bf 0a 00 00 00       	mov    $0xa,%edi
    11ae:	e8 ad fe ff ff       	callq  1060 <putchar@plt>
    11b3:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11b7:	83 7d f8 05          	cmpl   $0x5,-0x8(%rbp)
    11bb:	7e c1                	jle    117e <main+0x15>
