...
/app/bin_gccgcc10_O1/21_series:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1177:	41 bc 0a 00 00 00    	mov    $0xa,%r12d
    117d:	bd 01 00 00 00       	mov    $0x1,%ebp
    1182:	bb 01 00 00 00       	mov    $0x1,%ebx
    ...
    119d:	e8 ce fe ff ff       	callq  1070 <__printf_chk@plt>
    11a2:	01 eb                	add    %ebp,%ebx
    11a4:	89 ea                	mov    %ebp,%edx
    11a6:	4c 89 ee             	mov    %r13,%rsi
    11a9:	bf 01 00 00 00       	mov    $0x1,%edi
    11ae:	b8 00 00 00 00       	mov    $0x0,%eax
    11b3:	e8 b8 fe ff ff       	callq  1070 <__printf_chk@plt>
    11b8:	01 dd                	add    %ebx,%ebp
    11ba:	41 83 ec 01          	sub    $0x1,%r12d
    11be:	75 ce                	jne    118e <main+0x25>
    11c0:	48 8b 35 49 2e 00 00 	mov    0x2e49(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11c7:	bf 0a 00 00 00       	mov    $0xa,%edi
    11cc:	e8 8f fe ff ff       	callq  1060 <putc@plt>
