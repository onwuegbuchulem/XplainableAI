...
/app/bin_gccgcc10_O2/2022_04-Exercise:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ec:	73 53                	jae    1141 <main+0xa1>
    10ee:	f2 0f 10 0d 52 0f 00 	movsd  0xf52(%rip),%xmm1        # 2048 <_IO_stdin_used+0x48>
    10f5:	00 
    10f6:	66 0f 28 c2          	movapd %xmm2,%xmm0
    10fa:	b8 07 00 00 00       	mov    $0x7,%eax
    10ff:	f2 0f 10 1d 49 0f 00 	movsd  0xf49(%rip),%xmm3        # 2050 <_IO_stdin_used+0x50>
    1106:	00 
    1107:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    110e:	00 00 
    1110:	f2 0f 58 c1          	addsd  %xmm1,%xmm0
    1114:	66 0f 28 ca          	movapd %xmm2,%xmm1
    1118:	f2 0f 59 c3          	mulsd  %xmm3,%xmm0
    111c:	f2 0f 5e c8          	divsd  %xmm0,%xmm1
    1120:	83 e8 01             	sub    $0x1,%eax
    1123:	75 eb                	jne    1110 <main+0x70>
    1125:	66 0f 28 c2          	movapd %xmm2,%xmm0
    1129:	bf 01 00 00 00       	mov    $0x1,%edi
    112e:	b8 02 00 00 00       	mov    $0x2,%eax
    1133:	48 8d 35 ee 0e 00 00 	lea    0xeee(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    113a:	e8 41 ff ff ff       	callq  1080 <__printf_chk@plt>
    113f:	31 c0                	xor    %eax,%eax
    1141:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    1146:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    114d:	00 00 
    114f:	75 05                	jne    1156 <main+0xb6>
    1151:	48 83 c4 18          	add    $0x18,%rsp
    1155:	c3                   	retq   
    1156:	e8 15 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
...
0000000000001250 <babylonian_sr>:
    1250:	f3 0f 1e fa          	endbr64 
    1254:	f2 0f 10 0d ec 0d 00 	movsd  0xdec(%rip),%xmm1        # 2048 <_IO_stdin_used+0x48>
    125b:	00 
    125c:	66 0f 28 d0          	movapd %xmm0,%xmm2
    1260:	b8 07 00 00 00       	mov    $0x7,%eax
    1265:	f2 0f 10 1d e3 0d 00 	movsd  0xde3(%rip),%xmm3        # 2050 <_IO_stdin_used+0x50>
    126c:	00 
    126d:	0f 1f 00             	nopl   (%rax)
    1270:	f2 0f 58 c1          	addsd  %xmm1,%xmm0
    1274:	66 0f 28 ca          	movapd %xmm2,%xmm1
    1278:	f2 0f 59 c3          	mulsd  %xmm3,%xmm0
    127c:	f2 0f 5e c8          	divsd  %xmm0,%xmm1
    1280:	83 e8 01             	sub    $0x1,%eax
    1283:	75 eb                	jne    1270 <babylonian_sr+0x20>
