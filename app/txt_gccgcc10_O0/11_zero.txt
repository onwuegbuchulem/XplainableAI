...
/app/bin_gccgcc10_O0/11_zero:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	f3 0f 10 05 ff 0e 00 	movss  0xeff(%rip),%xmm0        # 205c <_IO_stdin_used+0x5c>
    115c:	00 
    115d:	f3 0f 11 45 f8       	movss  %xmm0,-0x8(%rbp)
    1162:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1166:	f3 0f 11 45 fc       	movss  %xmm0,-0x4(%rbp)
    116b:	f3 0f 10 45 f8       	movss  -0x8(%rbp),%xmm0
    1170:	0f 2e 45 fc          	ucomiss -0x4(%rbp),%xmm0
    1174:	7a 19                	jp     118f <main+0x46>
    1176:	f3 0f 10 45 f8       	movss  -0x8(%rbp),%xmm0
    117b:	0f 2e 45 fc          	ucomiss -0x4(%rbp),%xmm0
    117f:	75 0e                	jne    118f <main+0x46>
    1181:	48 8d 3d 80 0e 00 00 	lea    0xe80(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    1188:	e8 c3 fe ff ff       	callq  1050 <puts@plt>
    118d:	eb 0c                	jmp    119b <main+0x52>
    118f:	48 8d 3d 9a 0e 00 00 	lea    0xe9a(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    1196:	e8 b5 fe ff ff       	callq  1050 <puts@plt>
