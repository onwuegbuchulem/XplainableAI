...
/app/bin_gccgcc10_O2/03_other_array_init_ways:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	55                   	push   %rbp
    1085:	b9 09 00 00 00       	mov    $0x9,%ecx
    108a:	48 8d 2d 77 0f 00 00 	lea    0xf77(%rip),%rbp        # 2008 <_IO_stdin_used+0x8>
    1091:	53                   	push   %rbx
    1092:	31 db                	xor    %ebx,%ebx
    1094:	48 83 ec 28          	sub    $0x28,%rsp
    1098:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    109f:	00 00 
    10a1:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10a6:	48 b8 08 00 00 00 08 	movabs $0x800000008,%rax
    10ad:	00 00 00 
    10b0:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    10b5:	89 da                	mov    %ebx,%edx
    10b7:	48 89 ee             	mov    %rbp,%rsi
    10ba:	bf 01 00 00 00       	mov    $0x1,%edi
    10bf:	31 c0                	xor    %eax,%eax
    10c1:	e8 aa ff ff ff       	callq  1070 <__printf_chk@plt>
    10c6:	48 83 c3 01          	add    $0x1,%rbx
    10ca:	48 83 fb 03          	cmp    $0x3,%rbx
    10ce:	74 10                	je     10e0 <main+0x60>
    10d0:	8b 4c 9c 0c          	mov    0xc(%rsp,%rbx,4),%ecx
    10d4:	eb df                	jmp    10b5 <main+0x35>
    ...
    10ec:	00 00 
    10ee:	75 09                	jne    10f9 <main+0x79>
    10f0:	48 83 c4 28          	add    $0x28,%rsp
