...
/app/bin_gccgcc10_O0/2021_05_15-Lesson-a:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1161:	48 83 c0 08          	add    $0x8,%rax
    1165:	8b 08                	mov    (%rax),%ecx
    1167:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    116b:	48 83 c0 04          	add    $0x4,%rax
    116f:	8b 10                	mov    (%rax),%edx
    1171:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1175:	8b 00                	mov    (%rax),%eax
    1177:	89 c6                	mov    %eax,%esi
    1179:	48 8d 3d 84 0e 00 00 	lea    0xe84(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1180:	b8 00 00 00 00       	mov    $0x0,%eax
    1185:	e8 c6 fe ff ff       	callq  1050 <printf@plt>
