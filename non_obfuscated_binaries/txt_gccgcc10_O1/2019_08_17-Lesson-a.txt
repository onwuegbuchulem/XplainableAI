...
/app/bin_gccgcc10_O1/2019_08_17-Lesson-a:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    1205:	48 b8 42 69 6c 6c 79 	movabs $0x6c5a20796c6c6942,%rax
    120c:	20 5a 6c 
    120f:	48 89 04 24          	mov    %rax,(%rsp)
    1213:	c7 44 24 08 6f 74 6e 	movl   $0x696e746f,0x8(%rsp)
    121a:	69 
    121b:	66 c7 44 24 0c 63 6b 	movw   $0x6b63,0xc(%rsp)
    1222:	c6 44 24 0e 00       	movb   $0x0,0xe(%rsp)
    1227:	bf 00 00 00 00       	mov    $0x0,%edi
    122c:	e8 9f fe ff ff       	callq  10d0 <time@plt>
    1231:	48 89 c7             	mov    %rax,%rdi
    1234:	e8 77 fe ff ff       	callq  10b0 <srand@plt>
    1239:	48 8d 5c 24 20       	lea    0x20(%rsp),%rbx
    123e:	4c 8d 64 24 48       	lea    0x48(%rsp),%r12
    1243:	48 89 dd             	mov    %rbx,%rbp
    1246:	e8 a5 fe ff ff       	callq  10f0 <rand@plt>
    124b:	89 c2                	mov    %eax,%edx
    124d:	48 98                	cltq   
    124f:	48 69 c0 1f 85 eb 51 	imul   $0x51eb851f,%rax,%rax
    1256:	48 c1 f8 25          	sar    $0x25,%rax
    125a:	89 d1                	mov    %edx,%ecx
    125c:	c1 f9 1f             	sar    $0x1f,%ecx
    125f:	29 c8                	sub    %ecx,%eax
    1261:	6b c0 64             	imul   $0x64,%eax,%eax
    1264:	29 c2                	sub    %eax,%edx
    1266:	89 55 00             	mov    %edx,0x0(%rbp)
    1269:	48 83 c5 04          	add    $0x4,%rbp
    126d:	4c 39 e5             	cmp    %r12,%rbp
    1270:	75 d4                	jne    1246 <main+0x5d>
    1272:	48 89 e2             	mov    %rsp,%rdx
    ...
    1286:	e8 55 fe ff ff       	callq  10e0 <__printf_chk@plt>
    128b:	48 8d 2d 80 0d 00 00 	lea    0xd80(%rip),%rbp        # 2012 <_IO_stdin_used+0x12>
    ...
    12c0:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    12c5:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12cc:	00 00 
    12ce:	75 0e                	jne    12de <main+0xf5>
    12d0:	b8 00 00 00 00       	mov    $0x0,%eax
    12d5:	48 83 c4 50          	add    $0x50,%rsp
    12d9:	5b                   	pop    %rbx
    12da:	5d                   	pop    %rbp
    12db:	41 5c                	pop    %r12
    12dd:	c3                   	retq   
    12de:	e8 bd fd ff ff       	callq  10a0 <__stack_chk_fail@plt>
