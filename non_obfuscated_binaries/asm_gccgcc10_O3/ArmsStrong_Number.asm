...
/app/bin_gccgcc10_O3/ArmsStrong_Number:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ce:	48 8d 3d 42 0f 00 00 	lea    0xf42(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	e8 b4 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10dc:	44 8b 4c 24 04       	mov    0x4(%rsp),%r9d
    10e1:	45 85 c9             	test   %r9d,%r9d
    10e4:	0f 8e 81 00 00 00    	jle    116b <main+0xcb>
    10ea:	44 89 ca             	mov    %r9d,%edx
    10ed:	31 ff                	xor    %edi,%edi
    10ef:	41 b8 cd cc cc cc    	mov    $0xcccccccd,%r8d
    10f5:	0f 1f 00             	nopl   (%rax)
    10f8:	89 d0                	mov    %edx,%eax
    10fa:	49 0f af c0          	imul   %r8,%rax
    10fe:	48 c1 e8 23          	shr    $0x23,%rax
    1102:	8d 34 80             	lea    (%rax,%rax,4),%esi
    1105:	89 c1                	mov    %eax,%ecx
    1107:	89 d0                	mov    %edx,%eax
    1109:	01 f6                	add    %esi,%esi
    110b:	29 f0                	sub    %esi,%eax
    110d:	89 c6                	mov    %eax,%esi
    110f:	0f af f0             	imul   %eax,%esi
    1112:	0f af c6             	imul   %esi,%eax
    1115:	01 c7                	add    %eax,%edi
    1117:	89 d0                	mov    %edx,%eax
    1119:	89 ca                	mov    %ecx,%edx
    111b:	83 f8 09             	cmp    $0x9,%eax
    111e:	7f d8                	jg     10f8 <main+0x58>
    1120:	89 4c 24 04          	mov    %ecx,0x4(%rsp)
    1124:	44 89 ca             	mov    %r9d,%edx
    1127:	41 39 f9             	cmp    %edi,%r9d
    112a:	74 2a                	je     1156 <main+0xb6>
    112c:	48 8d 35 05 0f 00 00 	lea    0xf05(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    ...
    114b:	00 00 
    114d:	75 20                	jne    116f <main+0xcf>
    114f:	31 c0                	xor    %eax,%eax
    1151:	48 83 c4 18          	add    $0x18,%rsp
    1155:	c3                   	retq   
    1156:	48 8d 35 bd 0e 00 00 	lea    0xebd(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    115d:	bf 01 00 00 00       	mov    $0x1,%edi
    1162:	31 c0                	xor    %eax,%eax
    1164:	e8 17 ff ff ff       	callq  1080 <__printf_chk@plt>
    1169:	eb d4                	jmp    113f <main+0x9f>
    116b:	31 ff                	xor    %edi,%edi
    116d:	eb b5                	jmp    1124 <main+0x84>
    116f:	e8 fc fe ff ff       	callq  1070 <__stack_chk_fail@plt>
