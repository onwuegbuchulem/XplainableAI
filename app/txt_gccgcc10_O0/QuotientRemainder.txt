...
/app/bin_gccgcc10_O0/QuotientRemainder:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 3d 52 0e 00 00 	lea    0xe52(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	e8 c3 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cd:	48 8d 3d 44 0e 00 00 	lea    0xe44(%rip),%rdi        # 2018 <_IO_stdin_used+0x18>
    ...
    11e5:	48 8d 3d 29 0e 00 00 	lea    0xe29(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    11ec:	b8 00 00 00 00       	mov    $0x0,%eax
    11f1:	e8 9a fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f6:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11f9:	8b 4d ec             	mov    -0x14(%rbp),%ecx
    11fc:	99                   	cltd   
    11fd:	f7 f9                	idiv   %ecx
    11ff:	89 45 f0             	mov    %eax,-0x10(%rbp)
    1202:	8b 45 e8             	mov    -0x18(%rbp),%eax
    1205:	8b 4d ec             	mov    -0x14(%rbp),%ecx
    1208:	99                   	cltd   
    1209:	f7 f9                	idiv   %ecx
    120b:	89 55 f4             	mov    %edx,-0xc(%rbp)
    120e:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1211:	89 c6                	mov    %eax,%esi
    1213:	48 8d 3d 0f 0e 00 00 	lea    0xe0f(%rip),%rdi        # 2029 <_IO_stdin_used+0x29>
    ...
    1229:	48 8d 3d 08 0e 00 00 	lea    0xe08(%rip),%rdi        # 2038 <_IO_stdin_used+0x38>
    1230:	b8 00 00 00 00       	mov    $0x0,%eax
    1235:	e8 46 fe ff ff       	callq  1080 <printf@plt>
    123a:	b8 00 00 00 00       	mov    $0x0,%eax
    123f:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1243:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    124a:	00 00 
    124c:	74 05                	je     1253 <main+0xca>
    124e:	e8 1d fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1253:	c9                   	leaveq 
    1254:	c3                   	retq   
