...
/app/bin_gccgcc10_O0/yen02:     file format elf64-x86-64
...
0000000000001080 <wprintf@plt>:
    1080:	f3 0f 1e fa          	endbr64 
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <wprintf@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    11a4:	48 b8 54 00 00 00 68 	movabs $0x6800000054,%rax
    11ab:	00 00 00 
    11ae:	48 ba 61 00 00 00 74 	movabs $0x7400000061,%rdx
    11b5:	00 00 00 
    11b8:	48 89 45 a0          	mov    %rax,-0x60(%rbp)
    11bc:	48 89 55 a8          	mov    %rdx,-0x58(%rbp)
    11c0:	48 b8 20 00 00 00 77 	movabs $0x7700000020,%rax
    11c7:	00 00 00 
    11ca:	48 ba 69 00 00 00 6c 	movabs $0x6c00000069,%rdx
    11d1:	00 00 00 
    11d4:	48 89 45 b0          	mov    %rax,-0x50(%rbp)
    11d8:	48 89 55 b8          	mov    %rdx,-0x48(%rbp)
    11dc:	48 b8 6c 00 00 00 20 	movabs $0x200000006c,%rax
    11e3:	00 00 00 
    11e6:	48 ba 62 00 00 00 65 	movabs $0x6500000062,%rdx
    11ed:	00 00 00 
    11f0:	48 89 45 c0          	mov    %rax,-0x40(%rbp)
    11f4:	48 89 55 c8          	mov    %rdx,-0x38(%rbp)
    11f8:	48 b8 20 00 00 00 24 	movabs $0x2400000020,%rax
    11ff:	00 00 00 
    1202:	48 ba 35 00 00 00 30 	movabs $0x3000000035,%rdx
    1209:	00 00 00 
    120c:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    1210:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
    1214:	48 b8 30 00 00 00 0a 	movabs $0xa00000030,%rax
    121b:	00 00 00 
    ...
    1235:	e8 56 fe ff ff       	callq  1090 <setlocale@plt>
    123a:	c7 45 d4 a5 00 00 00 	movl   $0xa5,-0x2c(%rbp)
    1241:	48 8d 45 a0          	lea    -0x60(%rbp),%rax
    1245:	48 89 c6             	mov    %rax,%rsi
    1248:	48 8d 3d c1 0d 00 00 	lea    0xdc1(%rip),%rdi        # 2010 <_IO_stdin_used+0x10>
    124f:	b8 00 00 00 00       	mov    $0x0,%eax
    1254:	e8 27 fe ff ff       	callq  1080 <wprintf@plt>
