...
/app/bin_gccgcc10_O2/readdir03:     file format elf64-x86-64
...
0000000000001100 <main>:
    ...
    1111:	e8 9a ff ff ff       	callq  10b0 <opendir@plt>
    1116:	48 85 c0             	test   %rax,%rax
    1119:	74 46                	je     1161 <main+0x61>
    111b:	48 89 c5             	mov    %rax,%rbp
    111e:	48 8d 1d fa 0e 00 00 	lea    0xefa(%rip),%rbx        # 201f <_IO_stdin_used+0x1f>
    1125:	eb 1c                	jmp    1143 <main+0x43>
    1127:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    112e:	00 00 
    1130:	48 8d 50 13          	lea    0x13(%rax),%rdx
    1134:	48 89 de             	mov    %rbx,%rsi
    1137:	bf 01 00 00 00       	mov    $0x1,%edi
    113c:	31 c0                	xor    %eax,%eax
    113e:	e8 9d ff ff ff       	callq  10e0 <__printf_chk@plt>
    1143:	48 89 ef             	mov    %rbp,%rdi
    1146:	e8 85 ff ff ff       	callq  10d0 <readdir@plt>
    114b:	48 85 c0             	test   %rax,%rax
    114e:	75 e0                	jne    1130 <main+0x30>
    1150:	48 89 ef             	mov    %rbp,%rdi
    1153:	e8 68 ff ff ff       	callq  10c0 <closedir@plt>
    1158:	48 83 c4 08          	add    $0x8,%rsp
    115c:	31 c0                	xor    %eax,%eax
    115e:	5b                   	pop    %rbx
    115f:	5d                   	pop    %rbp
    1160:	c3                   	retq   
    1161:	48 8d 3d 9e 0e 00 00 	lea    0xe9e(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1168:	e8 33 ff ff ff       	callq  10a0 <puts@plt>
    116d:	bf 01 00 00 00       	mov    $0x1,%edi
    1172:	e8 79 ff ff ff       	callq  10f0 <exit@plt>
