...
/app/bin_gccgcc10_O2/2023_01_28-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	e8 d3 ff ff ff       	callq  1060 <clock@plt>
    108d:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1091:	bf 01 00 00 00       	mov    $0x1,%edi
    1096:	48 8d 35 67 0f 00 00 	lea    0xf67(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    109d:	f2 48 0f 2a c0       	cvtsi2sd %rax,%xmm0
    10a2:	b8 01 00 00 00       	mov    $0x1,%eax
    10a7:	f2 0f 5e 05 71 0f 00 	divsd  0xf71(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10ae:	00 
    10af:	e8 bc ff ff ff       	callq  1070 <__printf_chk@plt>
    10b4:	31 c0                	xor    %eax,%eax
    10b6:	48 83 c4 08          	add    $0x8,%rsp
    10ba:	c3                   	retq   
