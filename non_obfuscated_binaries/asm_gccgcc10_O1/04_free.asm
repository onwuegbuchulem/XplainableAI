...
/app/bin_gccgcc10_O1/04_free:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11e2:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11e7:	48 8d 3d 16 0e 00 00 	lea    0xe16(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11ee:	e8 dd fe ff ff       	callq  10d0 <__isoc99_scanf@plt>
    11f3:	48 63 7c 24 04       	movslq 0x4(%rsp),%rdi
    11f8:	48 c1 e7 02          	shl    $0x2,%rdi
    11fc:	e8 af fe ff ff       	callq  10b0 <malloc@plt>
    1201:	48 89 c3             	mov    %rax,%rbx
    1204:	48 89 c7             	mov    %rax,%rdi
    1207:	e8 84 fe ff ff       	callq  1090 <free@plt>
    120c:	8b 13                	mov    (%rbx),%edx
    ...
    1224:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1229:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1230:	00 00 
    1232:	75 0b                	jne    123f <main+0x76>
    1234:	b8 00 00 00 00       	mov    $0x0,%eax
    1239:	48 83 c4 10          	add    $0x10,%rsp
    123d:	5b                   	pop    %rbx
    123e:	c3                   	retq   
    123f:	e8 5c fe ff ff       	callq  10a0 <__stack_chk_fail@plt>
