...
/app/bin_gccgcc10_O2/2024_03_30-Lesson:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10c4:	41 55                	push   %r13
    10c6:	41 54                	push   %r12
    10c8:	41 bc 41 00 00 00    	mov    $0x41,%r12d
    10ce:	55                   	push   %rbp
    10cf:	53                   	push   %rbx
    10d0:	bb 41 00 00 00       	mov    $0x41,%ebx
    ...
    10e9:	4c 8d 6c 24 04       	lea    0x4(%rsp),%r13
    10ee:	66 90                	xchg   %ax,%ax
    10f0:	0f be d3             	movsbl %bl,%edx
    10f3:	8d 6b 01             	lea    0x1(%rbx),%ebp
    10f6:	48 8d 35 07 0f 00 00 	lea    0xf07(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10fd:	31 c0                	xor    %eax,%eax
    10ff:	bf 01 00 00 00       	mov    $0x1,%edi
    1104:	89 eb                	mov    %ebp,%ebx
    1106:	e8 95 ff ff ff       	callq  10a0 <__printf_chk@plt>
    110b:	40 80 fd 5a          	cmp    $0x5a,%bpl
    110f:	4c 89 ea             	mov    %r13,%rdx
    1112:	be 1b 54 00 00       	mov    $0x541b,%esi
    1117:	41 0f 44 dc          	cmove  %r12d,%ebx
    111b:	31 ff                	xor    %edi,%edi
    111d:	31 c0                	xor    %eax,%eax
    111f:	e8 6c ff ff ff       	callq  1090 <ioctl@plt>
    1124:	8b 44 24 04          	mov    0x4(%rsp),%eax
    1128:	85 c0                	test   %eax,%eax
    112a:	74 c4                	je     10f0 <main+0x30>
    112c:	48 8b 3d dd 2e 00 00 	mov    0x2edd(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    1133:	e8 78 ff ff ff       	callq  10b0 <getc@plt>
    1138:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    113d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1144:	00 00 
    1146:	75 0d                	jne    1155 <main+0x95>
    ...
    1152:	41 5d                	pop    %r13
    1154:	c3                   	retq   
    1155:	e8 26 ff ff ff       	callq  1080 <__stack_chk_fail@plt>
...
0000000000001250 <kbhit>:
    1250:	f3 0f 1e fa          	endbr64 
    1254:	48 83 ec 18          	sub    $0x18,%rsp
    1258:	be 1b 54 00 00       	mov    $0x541b,%esi
    125d:	31 ff                	xor    %edi,%edi
    125f:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1266:	00 00 
    1268:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    126d:	31 c0                	xor    %eax,%eax
    126f:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    1274:	e8 17 fe ff ff       	callq  1090 <ioctl@plt>
    1279:	8b 44 24 04          	mov    0x4(%rsp),%eax
    127d:	48 8b 4c 24 08       	mov    0x8(%rsp),%rcx
    1282:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1289:	00 00 
    128b:	75 05                	jne    1292 <kbhit+0x42>
    128d:	48 83 c4 18          	add    $0x18,%rsp
    1291:	c3                   	retq   
