...
/app/bin_gccgcc10_O0/2021_08_28-Lesson-b:     file format elf64-x86-64
...
00000000000011bd <main>:
    ...
    11d8:	48 8d 05 29 0e 00 00 	lea    0xe29(%rip),%rax        # 2008 <_IO_stdin_used+0x8>
    11df:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    11e3:	48 8d 05 2c 0e 00 00 	lea    0xe2c(%rip),%rax        # 2016 <_IO_stdin_used+0x16>
    11ea:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    11ee:	48 8d 05 3b 0e 00 00 	lea    0xe3b(%rip),%rax        # 2030 <_IO_stdin_used+0x30>
    11f5:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11f9:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
    1200:	eb 46                	jmp    1248 <main+0x8b>
    1202:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1205:	48 98                	cltq   
    1207:	48 8b 44 c5 e0       	mov    -0x20(%rbp,%rax,8),%rax
    120c:	48 89 c6             	mov    %rax,%rsi
    120f:	48 8d 3d 3f 0e 00 00 	lea    0xe3f(%rip),%rdi        # 2055 <_IO_stdin_used+0x55>
    1216:	b8 00 00 00 00       	mov    $0x0,%eax
    121b:	e8 70 fe ff ff       	callq  1090 <printf@plt>
    1220:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1223:	48 98                	cltq   
    1225:	48 8b 44 c5 e0       	mov    -0x20(%rbp,%rax,8),%rax
    122a:	48 89 c7             	mov    %rax,%rdi
    122d:	e8 57 ff ff ff       	callq  1189 <increase>
    1232:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1235:	48 98                	cltq   
    1237:	48 8b 44 c5 e0       	mov    -0x20(%rbp,%rax,8),%rax
    123c:	48 89 c7             	mov    %rax,%rdi
    123f:	e8 2c fe ff ff       	callq  1070 <puts@plt>
    1244:	83 45 dc 01          	addl   $0x1,-0x24(%rbp)
    1248:	83 7d dc 02          	cmpl   $0x2,-0x24(%rbp)
    124c:	7e b4                	jle    1202 <main+0x45>
    124e:	b8 00 00 00 00       	mov    $0x0,%eax
    1253:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1257:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    125e:	00 00 
    1260:	74 05                	je     1267 <main+0xaa>
    1262:	e8 19 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    1267:	c9                   	leaveq 
    1268:	c3                   	retq   
