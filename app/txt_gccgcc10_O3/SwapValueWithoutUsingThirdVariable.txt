...
/app/bin_gccgcc10_O3/SwapValueWithoutUsingThirdVariable:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e4:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    10e9:	48 89 e6             	mov    %rsp,%rsi
    10ec:	31 c0                	xor    %eax,%eax
    10ee:	48 8d 3d 1e 0f 00 00 	lea    0xf1e(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    10f5:	e8 b6 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10fa:	8b 0c 24             	mov    (%rsp),%ecx
    10fd:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1101:	31 c0                	xor    %eax,%eax
    1103:	48 8d 35 0e 0f 00 00 	lea    0xf0e(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    110a:	bf 01 00 00 00       	mov    $0x1,%edi
    110f:	89 4c 24 04          	mov    %ecx,0x4(%rsp)
    1113:	89 14 24             	mov    %edx,(%rsp)
    1116:	e8 85 ff ff ff       	callq  10a0 <__printf_chk@plt>
    111b:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1120:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1127:	00 00 
    1129:	75 07                	jne    1132 <main+0x72>
    112b:	31 c0                	xor    %eax,%eax
    112d:	48 83 c4 18          	add    $0x18,%rsp
    1131:	c3                   	retq   
    1132:	e8 59 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
