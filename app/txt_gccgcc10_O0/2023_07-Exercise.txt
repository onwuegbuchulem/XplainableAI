...
/app/bin_gccgcc10_O0/2023_07-Exercise:     file format elf64-x86-64
...
00000000000011f5 <main>:
    ...
    1221:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    1225:	48 89 c6             	mov    %rax,%rsi
    1228:	48 8d 3d f0 0d 00 00 	lea    0xdf0(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    122f:	b8 00 00 00 00       	mov    $0x0,%eax
    1234:	e8 57 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    1239:	8b 45 f0             	mov    -0x10(%rbp),%eax
    123c:	89 c7                	mov    %eax,%edi
    123e:	e8 46 ff ff ff       	callq  1189 <sum>
    1243:	89 45 f4             	mov    %eax,-0xc(%rbp)
    1246:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1249:	89 c6                	mov    %eax,%esi
    124b:	48 8d 3d d0 0d 00 00 	lea    0xdd0(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    1252:	b8 00 00 00 00       	mov    $0x0,%eax
    1257:	e8 24 fe ff ff       	callq  1080 <printf@plt>
    125c:	b8 00 00 00 00       	mov    $0x0,%eax
    1261:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1265:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    126c:	00 00 
    126e:	74 05                	je     1275 <main+0x80>
