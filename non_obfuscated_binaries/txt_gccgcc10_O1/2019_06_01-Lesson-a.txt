...
/app/bin_gccgcc10_O1/2019_06_01-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119c:	00 00 
    119e:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    11a3:	31 c0                	xor    %eax,%eax
    11a5:	48 b8 48 65 6c 6c 6f 	movabs $0x6874206f6c6c6548,%rax
    11ac:	20 74 68 
    11af:	48 ba 65 72 65 2c 20 	movabs $0x727473202c657265,%rdx
    11b6:	73 74 72 
    11b9:	48 89 04 24          	mov    %rax,(%rsp)
    11bd:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    11c2:	48 b8 61 6e 67 65 2e 	movabs $0x202e2e2e65676e61,%rax
    11c9:	2e 2e 20 
    11cc:	48 ba 6c 69 74 74 6c 	movabs $0x7020656c7474696c,%rdx
    11d3:	65 20 70 
    11d6:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11db:	48 89 54 24 18       	mov    %rdx,0x18(%rsp)
    11e0:	c7 44 24 20 6c 61 6e 	movl   $0x656e616c,0x20(%rsp)
    11e7:	65 
    11e8:	66 c7 44 24 24 74 0a 	movw   $0xa74,0x24(%rsp)
    11ef:	c6 44 24 26 00       	movb   $0x0,0x26(%rsp)
    11f4:	bb 48 00 00 00       	mov    $0x48,%ebx
    11f9:	bd 00 00 00 00       	mov    $0x0,%ebp
    11fe:	4c 8d 25 ff 0d 00 00 	lea    0xdff(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    1205:	eb 54                	jmp    125b <main+0xd2>
    1207:	48 8b 35 02 2e 00 00 	mov    0x2e02(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    120e:	bf 0a 00 00 00       	mov    $0xa,%edi
    1213:	e8 68 fe ff ff       	callq  1080 <putc@plt>
    1218:	83 c5 01             	add    $0x1,%ebp
    121b:	48 63 c5             	movslq %ebp,%rax
    121e:	0f b6 1c 04          	movzbl (%rsp,%rax,1),%ebx
    1222:	84 db                	test   %bl,%bl
    1224:	74 49                	je     126f <main+0xe6>
    1226:	e8 65 fe ff ff       	callq  1090 <__ctype_b_loc@plt>
    122b:	48 89 c2             	mov    %rax,%rdx
    122e:	48 0f be c3          	movsbq %bl,%rax
    1232:	48 8b 12             	mov    (%rdx),%rdx
    1235:	f6 44 42 01 04       	testb  $0x4,0x1(%rdx,%rax,2)
    123a:	74 11                	je     124d <main+0xc4>
    123c:	eb 1d                	jmp    125b <main+0xd2>
    123e:	0f be fb             	movsbl %bl,%edi
    1241:	48 8b 35 c8 2d 00 00 	mov    0x2dc8(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1248:	e8 33 fe ff ff       	callq  1080 <putc@plt>
    124d:	83 c5 01             	add    $0x1,%ebp
    1250:	48 63 c5             	movslq %ebp,%rax
    1253:	0f b6 1c 04          	movzbl (%rsp,%rax,1),%ebx
    1257:	84 db                	test   %bl,%bl
    1259:	74 14                	je     126f <main+0xe6>
    125b:	8d 43 f6             	lea    -0xa(%rbx),%eax
    125e:	3c 35                	cmp    $0x35,%al
    1260:	77 dc                	ja     123e <main+0xb5>
    1262:	0f b6 c0             	movzbl %al,%eax
    1265:	49 63 04 84          	movslq (%r12,%rax,4),%rax
    1269:	4c 01 e0             	add    %r12,%rax
    126c:	3e ff e0             	notrack jmpq *%rax
    126f:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    1274:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    127b:	00 00 
    127d:	75 0e                	jne    128d <main+0x104>
    127f:	b8 00 00 00 00       	mov    $0x0,%eax
    1284:	48 83 c4 30          	add    $0x30,%rsp
    1288:	5b                   	pop    %rbx
    1289:	5d                   	pop    %rbp
    128a:	41 5c                	pop    %r12
    128c:	c3                   	retq   
