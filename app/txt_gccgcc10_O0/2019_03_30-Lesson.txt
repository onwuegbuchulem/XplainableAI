...
/app/bin_gccgcc10_O0/2019_03_30-Lesson:     file format elf64-x86-64
...
0000000000001060 <localeconv@plt>:
    1060:	f3 0f 1e fa          	endbr64 
    1064:	f2 ff 25 5d 2f 00 00 	bnd jmpq *0x2f5d(%rip)        # 3fc8 <localeconv@GLIBC_2.2.5>
...
0000000000001169 <main>:
    ...
    1175:	e8 e6 fe ff ff       	callq  1060 <localeconv@plt>
    117a:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    117e:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1182:	48 8b 00             	mov    (%rax),%rax
    ...
    1194:	e8 d7 fe ff ff       	callq  1070 <printf@plt>
    1199:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    119d:	48 8b 40 08          	mov    0x8(%rax),%rax
    11a1:	48 89 c6             	mov    %rax,%rsi
    11a4:	48 8d 3d 6c 0e 00 00 	lea    0xe6c(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    11ab:	b8 00 00 00 00       	mov    $0x0,%eax
    11b0:	e8 bb fe ff ff       	callq  1070 <printf@plt>
    11b5:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11b9:	48 8b 40 20          	mov    0x20(%rax),%rax
    11bd:	48 89 c6             	mov    %rax,%rsi
    11c0:	48 8d 3d 69 0e 00 00 	lea    0xe69(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    11c7:	b8 00 00 00 00       	mov    $0x0,%eax
    11cc:	e8 9f fe ff ff       	callq  1070 <printf@plt>
