...
/app/bin_gccgcc10_O1/2020_03_28-Lesson-b:     file format elf64-x86-64
...
00000000000010c0 <close@plt>:
    ...
    10c4:	f2 ff 25 dd 2e 00 00 	bnd jmpq *0x2edd(%rip)        # 3fa8 <close@GLIBC_2.2.5>
    10cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010d0 <read@plt>:
    10d0:	f3 0f 1e fa          	endbr64 
    10d4:	f2 ff 25 d5 2e 00 00 	bnd jmpq *0x2ed5(%rip)        # 3fb0 <read@GLIBC_2.2.5>
...
0000000000001209 <main>:
    ...
    121a:	00 00 
    121c:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    1221:	31 c0                	xor    %eax,%eax
    1223:	48 b8 67 65 74 74 79 	movabs $0x7562737974746567,%rax
    122a:	73 62 75 
    122d:	48 89 44 24 09       	mov    %rax,0x9(%rsp)
    1232:	c7 44 24 11 72 67 2e 	movl   $0x742e6772,0x11(%rsp)
    1239:	74 
    123a:	66 c7 44 24 15 78 74 	movw   $0x7478,0x15(%rsp)
    1241:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    1246:	48 8d 7c 24 09       	lea    0x9(%rsp),%rdi
    124b:	be 00 00 00 00       	mov    $0x0,%esi
    1250:	b8 00 00 00 00       	mov    $0x0,%eax
    1255:	e8 96 fe ff ff       	callq  10f0 <open@plt>
    125a:	89 c3                	mov    %eax,%ebx
    125c:	48 8d 6c 24 08       	lea    0x8(%rsp),%rbp
    1261:	83 f8 ff             	cmp    $0xffffffff,%eax
    1264:	74 2d                	je     1293 <main+0x8a>
    1266:	ba 01 00 00 00       	mov    $0x1,%edx
    126b:	48 89 ee             	mov    %rbp,%rsi
    126e:	89 df                	mov    %ebx,%edi
    1270:	e8 5b fe ff ff       	callq  10d0 <read@plt>
    1275:	48 85 c0             	test   %rax,%rax
    1278:	74 5f                	je     12d9 <main+0xd0>
    127a:	48 83 f8 ff          	cmp    $0xffffffffffffffff,%rax
    127e:	74 3c                	je     12bc <main+0xb3>
    1280:	0f be 7c 24 08       	movsbl 0x8(%rsp),%edi
    1285:	48 8b 35 94 2d 00 00 	mov    0x2d94(%rip),%rsi        # 4020 <stdout@@GLIBC_2.2.5>
    128c:	e8 4f fe ff ff       	callq  10e0 <putc@plt>
    1291:	eb d3                	jmp    1266 <main+0x5d>
    1293:	48 8d 4c 24 09       	lea    0x9(%rsp),%rcx
    1298:	48 8d 15 65 0d 00 00 	lea    0xd65(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    129f:	be 01 00 00 00       	mov    $0x1,%esi
    12a4:	48 8b 3d 95 2d 00 00 	mov    0x2d95(%rip),%rdi        # 4040 <stderr@@GLIBC_2.2.5>
    12ab:	b8 00 00 00 00       	mov    $0x0,%eax
    12b0:	e8 5b fe ff ff       	callq  1110 <__fprintf_chk@plt>
    12b5:	b8 01 00 00 00       	mov    $0x1,%eax
    12ba:	eb 29                	jmp    12e5 <main+0xdc>
    12bc:	48 8b 0d 7d 2d 00 00 	mov    0x2d7d(%rip),%rcx        # 4040 <stderr@@GLIBC_2.2.5>
    12c3:	ba 10 00 00 00       	mov    $0x10,%edx
    12c8:	be 01 00 00 00       	mov    $0x1,%esi
    12cd:	48 8d 3d 43 0d 00 00 	lea    0xd43(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    12d4:	e8 27 fe ff ff       	callq  1100 <fwrite@plt>
    12d9:	89 df                	mov    %ebx,%edi
    12db:	e8 e0 fd ff ff       	callq  10c0 <close@plt>
    12e0:	b8 00 00 00 00       	mov    $0x0,%eax
    12e5:	48 8b 4c 24 18       	mov    0x18(%rsp),%rcx
    12ea:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    12f1:	00 00 
    12f3:	75 07                	jne    12fc <main+0xf3>
    12f5:	48 83 c4 28          	add    $0x28,%rsp
    12f9:	5b                   	pop    %rbx
    12fa:	5d                   	pop    %rbp
    12fb:	c3                   	retq   
    12fc:	e8 af fd ff ff       	callq  10b0 <__stack_chk_fail@plt>
