...
/app/bin_gccgcc10_O2/AreaAndCircumference:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10f7:	66 0f ef d2          	pxor   %xmm2,%xmm2
    10fb:	f2 0f 10 05 3d 0f 00 	movsd  0xf3d(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    1102:	00 
    1103:	f2 0f 10 0d 2d 0f 00 	movsd  0xf2d(%rip),%xmm1        # 2038 <_IO_stdin_used+0x38>
    110a:	00 
    110b:	f3 0f 5a 54 24 04    	cvtss2sd 0x4(%rsp),%xmm2
    1111:	bf 01 00 00 00       	mov    $0x1,%edi
    1116:	b8 02 00 00 00       	mov    $0x2,%eax
    111b:	48 8d 35 f6 0e 00 00 	lea    0xef6(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    1122:	f2 0f 59 c2          	mulsd  %xmm2,%xmm0
    1126:	f2 0f 59 ca          	mulsd  %xmm2,%xmm1
    112a:	f2 0f 59 c2          	mulsd  %xmm2,%xmm0
    112e:	f2 0f 5a c9          	cvtsd2ss %xmm1,%xmm1
    1132:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
    1136:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    113a:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    ...
    114f:	00 00 
    1151:	75 07                	jne    115a <main+0x9a>
    1153:	31 c0                	xor    %eax,%eax
    1155:	48 83 c4 18          	add    $0x18,%rsp
    1159:	c3                   	retq   
    115a:	e8 31 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
    115f:	90                   	nop
