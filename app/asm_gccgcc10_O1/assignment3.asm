...
/app/bin_gccgcc10_O1/assignment3:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	55                   	push   %rbp
    118e:	53                   	push   %rbx
    118f:	48 83 ec 48          	sub    $0x48,%rsp
    1193:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    119a:	00 00 
    119c:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    ...
    11b4:	48 89 e3             	mov    %rsp,%rbx
    11b7:	48 89 de             	mov    %rbx,%rsi
    11ba:	48 8d 3d 5b 0e 00 00 	lea    0xe5b(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    11c1:	b8 00 00 00 00       	mov    $0x0,%eax
    11c6:	e8 c5 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cb:	48 8d 35 4d 0e 00 00 	lea    0xe4d(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    11d2:	bf 01 00 00 00       	mov    $0x1,%edi
    11d7:	b8 00 00 00 00       	mov    $0x0,%eax
    11dc:	e8 9f fe ff ff       	callq  1080 <__printf_chk@plt>
    11e1:	48 8d 6c 24 20       	lea    0x20(%rsp),%rbp
    11e6:	48 89 ee             	mov    %rbp,%rsi
    11e9:	48 8d 3d 2c 0e 00 00 	lea    0xe2c(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    11f0:	b8 00 00 00 00       	mov    $0x0,%eax
    11f5:	e8 96 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11fa:	48 89 e9             	mov    %rbp,%rcx
    11fd:	48 89 da             	mov    %rbx,%rdx
    1200:	48 8d 35 2f 0e 00 00 	lea    0xe2f(%rip),%rsi        # 2036 <_IO_stdin_used+0x36>
    1207:	bf 01 00 00 00       	mov    $0x1,%edi
    120c:	b8 00 00 00 00       	mov    $0x0,%eax
    1211:	e8 6a fe ff ff       	callq  1080 <__printf_chk@plt>
    1216:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    121b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1222:	00 00 
    1224:	75 0c                	jne    1232 <main+0xa9>
    1226:	b8 00 00 00 00       	mov    $0x0,%eax
    122b:	48 83 c4 48          	add    $0x48,%rsp
    122f:	5b                   	pop    %rbx
    1230:	5d                   	pop    %rbp
    1231:	c3                   	retq   
    1232:	e8 39 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
