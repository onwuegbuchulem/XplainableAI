...
/app/bin_gccgcc10_O0/2021_12_04-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1195:	48 8d 05 6c 0e 00 00 	lea    0xe6c(%rip),%rax        # 2008 <_IO_stdin_used+0x8>
    119c:	48 89 45 e8          	mov    %rax,-0x18(%rbp)
    11a0:	48 8d 05 81 0e 00 00 	lea    0xe81(%rip),%rax        # 2028 <_IO_stdin_used+0x28>
    11a7:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11ab:	48 c7 45 f8 00 00 00 	movq   $0x0,-0x8(%rbp)
    11b2:	00 
    11b3:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    11b7:	48 89 c7             	mov    %rax,%rdi
    11ba:	e8 b1 fe ff ff       	callq  1070 <puts@plt>
    11bf:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    11c3:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    11c7:	48 89 d6             	mov    %rdx,%rsi
    11ca:	48 89 c7             	mov    %rax,%rdi
    11cd:	e8 be fe ff ff       	callq  1090 <strspn@plt>
    11d2:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11d6:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11da:	48 83 c0 01          	add    $0x1,%rax
    11de:	48 01 45 e8          	add    %rax,-0x18(%rbp)
    11e2:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    11e6:	48 89 c7             	mov    %rax,%rdi
    11e9:	e8 92 fe ff ff       	callq  1080 <strlen@plt>
    11ee:	48 39 45 f8          	cmp    %rax,-0x8(%rbp)
    11f2:	72 bf                	jb     11b3 <main+0x2a>
    11f4:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    11f8:	48 89 c7             	mov    %rax,%rdi
    11fb:	e8 70 fe ff ff       	callq  1070 <puts@plt>
