...
/app/bin_gccgcc10_O0/2024_02_10-Lesson-a:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1151:	eb 24                	jmp    1177 <main+0x2e>
    1153:	48 8b 05 c6 2e 00 00 	mov    0x2ec6(%rip),%rax        # 4020 <__environ@@GLIBC_2.2.5>
    115a:	48 8b 00             	mov    (%rax),%rax
    115d:	48 89 c7             	mov    %rax,%rdi
    1160:	e8 eb fe ff ff       	callq  1050 <puts@plt>
    1165:	48 8b 05 b4 2e 00 00 	mov    0x2eb4(%rip),%rax        # 4020 <__environ@@GLIBC_2.2.5>
    116c:	48 83 c0 08          	add    $0x8,%rax
    1170:	48 89 05 a9 2e 00 00 	mov    %rax,0x2ea9(%rip)        # 4020 <__environ@@GLIBC_2.2.5>
    1177:	48 8b 05 a2 2e 00 00 	mov    0x2ea2(%rip),%rax        # 4020 <__environ@@GLIBC_2.2.5>
    117e:	48 8b 00             	mov    (%rax),%rax
    1181:	48 85 c0             	test   %rax,%rax
    1184:	75 cd                	jne    1153 <main+0xa>
