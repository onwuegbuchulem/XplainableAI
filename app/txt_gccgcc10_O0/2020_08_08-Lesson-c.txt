...
/app/bin_gccgcc10_O0/2020_08_08-Lesson-c:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1175:	c7 45 f8 0a 00 00 00 	movl   $0xa,-0x8(%rbp)
    117c:	c7 45 fc f6 ff ff ff 	movl   $0xfffffff6,-0x4(%rbp)
    1183:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1186:	3b 45 fc             	cmp    -0x4(%rbp),%eax
    1189:	0f 9f c0             	setg   %al
    118c:	0f b6 c0             	movzbl %al,%eax
    118f:	85 c0                	test   %eax,%eax
    1191:	74 20                	je     11b3 <main+0x4a>
    1193:	83 f8 01             	cmp    $0x1,%eax
    1196:	75 36                	jne    11ce <main+0x65>
    ...
    11b1:	eb 27                	jmp    11da <main+0x71>
    11b3:	8b 55 fc             	mov    -0x4(%rbp),%edx
    11b6:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11b9:	89 c6                	mov    %eax,%esi
    11bb:	48 8d 3d 59 0e 00 00 	lea    0xe59(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    11c2:	b8 00 00 00 00       	mov    $0x0,%eax
    11c7:	e8 a4 fe ff ff       	callq  1070 <printf@plt>
    11cc:	eb 0c                	jmp    11da <main+0x71>
    11ce:	48 8d 3d 61 0e 00 00 	lea    0xe61(%rip),%rdi        # 2036 <_IO_stdin_used+0x36>
