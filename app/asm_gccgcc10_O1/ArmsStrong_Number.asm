...
/app/bin_gccgcc10_O1/ArmsStrong_Number:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b7:	48 8d 3d 59 0e 00 00 	lea    0xe59(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	44 8b 44 24 04       	mov    0x4(%rsp),%r8d
    11cd:	45 85 c0             	test   %r8d,%r8d
    11d0:	7e 77                	jle    1249 <main+0xc0>
    11d2:	44 89 c2             	mov    %r8d,%edx
    11d5:	be 00 00 00 00       	mov    $0x0,%esi
    ...
    11f1:	8d 0c 80             	lea    (%rax,%rax,4),%ecx
    11f4:	01 c9                	add    %ecx,%ecx
    11f6:	89 d0                	mov    %edx,%eax
    11f8:	29 c8                	sub    %ecx,%eax
    11fa:	89 c1                	mov    %eax,%ecx
    11fc:	0f af c8             	imul   %eax,%ecx
    11ff:	0f af c1             	imul   %ecx,%eax
    1202:	01 c6                	add    %eax,%esi
    1204:	89 d0                	mov    %edx,%eax
    1206:	89 fa                	mov    %edi,%edx
    1208:	83 f8 09             	cmp    $0x9,%eax
    120b:	7f cd                	jg     11da <main+0x51>
    120d:	89 7c 24 04          	mov    %edi,0x4(%rsp)
    1211:	41 39 f0             	cmp    %esi,%r8d
    1214:	74 3a                	je     1250 <main+0xc7>
    1216:	44 89 c2             	mov    %r8d,%edx
    1219:	48 8d 35 18 0e 00 00 	lea    0xe18(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    ...
    123b:	00 00 
    123d:	75 2c                	jne    126b <main+0xe2>
    123f:	b8 00 00 00 00       	mov    $0x0,%eax
    1244:	48 83 c4 18          	add    $0x18,%rsp
    1248:	c3                   	retq   
    1249:	be 00 00 00 00       	mov    $0x0,%esi
    124e:	eb c1                	jmp    1211 <main+0x88>
    1250:	44 89 c2             	mov    %r8d,%edx
    1253:	48 8d 35 c0 0d 00 00 	lea    0xdc0(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    125a:	bf 01 00 00 00       	mov    $0x1,%edi
    125f:	b8 00 00 00 00       	mov    $0x0,%eax
    1264:	e8 17 fe ff ff       	callq  1080 <__printf_chk@plt>
    1269:	eb c4                	jmp    122f <main+0xa6>
