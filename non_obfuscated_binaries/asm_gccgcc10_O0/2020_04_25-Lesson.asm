...
/app/bin_gccgcc10_O0/2020_04_25-Lesson:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    1274:	e8 f7 00 00 00       	callq  1370 <__stat>
    ...
    12b8:	89 c6                	mov    %eax,%esi
    12ba:	48 8d 3d 90 0d 00 00 	lea    0xd90(%rip),%rdi        # 2051 <_IO_stdin_used+0x51>
    12c1:	b8 00 00 00 00       	mov    $0x0,%eax
    12c6:	e8 f5 fd ff ff       	callq  10c0 <printf@plt>
    12cb:	b8 00 00 00 00       	mov    $0x0,%eax
    12d0:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    12d4:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    12db:	00 00 
    12dd:	74 05                	je     12e4 <main+0xfb>
...
0000000000001370 <__stat>:
    1370:	f3 0f 1e fa          	endbr64 
    1374:	48 89 f2             	mov    %rsi,%rdx
    1377:	48 89 fe             	mov    %rdi,%rsi
    137a:	bf 01 00 00 00       	mov    $0x1,%edi
    137f:	e9 4c fd ff ff       	jmpq   10d0 <__xstat@plt>
