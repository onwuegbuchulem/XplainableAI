...
/app/bin_gccgcc10_O1/2023_10_07-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117d:	e8 ee fe ff ff       	callq  1070 <access@plt>
    1182:	83 f8 ff             	cmp    $0xffffffff,%eax
    1185:	74 16                	je     119d <main+0x34>
    1187:	48 8d 3d 8c 0e 00 00 	lea    0xe8c(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    118e:	e8 cd fe ff ff       	callq  1060 <puts@plt>
    1193:	b8 00 00 00 00       	mov    $0x0,%eax
    1198:	48 83 c4 08          	add    $0x8,%rsp
    119c:	c3                   	retq   
    119d:	48 8d 3d 94 0e 00 00 	lea    0xe94(%rip),%rdi        # 2038 <_IO_stdin_used+0x38>
    11a4:	e8 b7 fe ff ff       	callq  1060 <puts@plt>
    11a9:	eb e8                	jmp    1193 <main+0x2a>
