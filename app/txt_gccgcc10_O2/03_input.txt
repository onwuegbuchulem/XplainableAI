...
/app/bin_gccgcc10_O2/03_input:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c1:	4c 8d 64 24 04       	lea    0x4(%rsp),%r12
    10c6:	4c 89 e6             	mov    %r12,%rsi
    10c9:	e8 c2 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10ce:	31 c0                	xor    %eax,%eax
    10d0:	4c 89 e2             	mov    %r12,%rdx
    10d3:	bf 01 00 00 00       	mov    $0x1,%edi
    10d8:	48 8d 35 25 0f 00 00 	lea    0xf25(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10df:	e8 9c ff ff ff       	callq  1080 <__printf_chk@plt>
    10e4:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10e9:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10f0:	00 00 
    10f2:	75 09                	jne    10fd <main+0x5d>
    10f4:	48 83 c4 10          	add    $0x10,%rsp
