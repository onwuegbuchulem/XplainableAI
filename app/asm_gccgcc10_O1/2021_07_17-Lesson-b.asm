...
/app/bin_gccgcc10_O1/2021_07_17-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119d:	00 00 00 
    11a0:	4c 8d 25 be 0e 00 00 	lea    0xebe(%rip),%r12        # 2065 <_IO_stdin_used+0x65>
    11a7:	eb 1d                	jmp    11c6 <main+0x3d>
    11a9:	48 8b 15 70 2e 00 00 	mov    0x2e70(%rip),%rdx        # 4020 <optarg@@GLIBC_2.2.5>
    ...
    11c9:	48 89 de             	mov    %rbx,%rsi
    11cc:	89 ef                	mov    %ebp,%edi
    11ce:	e8 bd fe ff ff       	callq  1090 <getopt@plt>
    11d3:	83 f8 ff             	cmp    $0xffffffff,%eax
    11d6:	74 49                	je     1221 <main+0x98>
    11d8:	83 f8 61             	cmp    $0x61,%eax
    11db:	74 cc                	je     11a9 <main+0x20>
    11dd:	83 f8 7a             	cmp    $0x7a,%eax
    11e0:	74 13                	je     11f5 <main+0x6c>
    11e2:	83 f8 3f             	cmp    $0x3f,%eax
    11e5:	74 1c                	je     1203 <main+0x7a>
    11e7:	48 8d 3d 66 0e 00 00 	lea    0xe66(%rip),%rdi        # 2054 <_IO_stdin_used+0x54>
    11ee:	e8 7d fe ff ff       	callq  1070 <puts@plt>
    11f3:	eb d1                	jmp    11c6 <main+0x3d>
    11f5:	48 8d 3d 24 0e 00 00 	lea    0xe24(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    11fc:	e8 6f fe ff ff       	callq  1070 <puts@plt>
    1201:	eb c3                	jmp    11c6 <main+0x3d>
    1203:	8b 15 1f 2e 00 00    	mov    0x2e1f(%rip),%edx        # 4028 <optopt@@GLIBC_2.2.5>
    1209:	48 8d 35 27 0e 00 00 	lea    0xe27(%rip),%rsi        # 2037 <_IO_stdin_used+0x37>
    1210:	bf 01 00 00 00       	mov    $0x1,%edi
    1215:	b8 00 00 00 00       	mov    $0x0,%eax
    121a:	e8 61 fe ff ff       	callq  1080 <__printf_chk@plt>
    121f:	eb a5                	jmp    11c6 <main+0x3d>
