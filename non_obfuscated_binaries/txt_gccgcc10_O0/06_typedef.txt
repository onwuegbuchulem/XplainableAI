...
/app/bin_gccgcc10_O0/06_typedef:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1188:	48 89 45 d8          	mov    %rax,-0x28(%rbp)
    118c:	c7 45 e0 9f 11 00 00 	movl   $0x119f,-0x20(%rbp)
    1193:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    1197:	48 83 c0 08          	add    $0x8,%rax
    119b:	c7 00 48 61 72 72    	movl   $0x72726148,(%rax)
    11a1:	66 c7 40 04 79 00    	movw   $0x79,0x4(%rax)
    11a7:	f3 0f 10 05 61 0e 00 	movss  0xe61(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    11ae:	00 
    11af:	f3 0f 11 45 e4       	movss  %xmm0,-0x1c(%rbp)
    11b4:	f3 0f 10 45 e4       	movss  -0x1c(%rbp),%xmm0
    11b9:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11bd:	f3 0f 5a c8          	cvtss2sd %xmm0,%xmm1
    11c1:	66 48 0f 7e c9       	movq   %xmm1,%rcx
    11c6:	8b 45 e0             	mov    -0x20(%rbp),%eax
    11c9:	48 8d 55 e0          	lea    -0x20(%rbp),%rdx
    11cd:	48 83 c2 08          	add    $0x8,%rdx
    ...
    11df:	b8 01 00 00 00       	mov    $0x1,%eax
    11e4:	e8 87 fe ff ff       	callq  1070 <printf@plt>
    11e9:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    11ed:	48 8d 50 08          	lea    0x8(%rax),%rdx
    11f1:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    11f5:	f3 0f 10 40 04       	movss  0x4(%rax),%xmm0
    11fa:	66 0f ef d2          	pxor   %xmm2,%xmm2
    11fe:	f3 0f 5a d0          	cvtss2sd %xmm0,%xmm2
    1202:	66 48 0f 7e d1       	movq   %xmm2,%rcx
    1207:	48 8b 45 d8          	mov    -0x28(%rbp),%rax
    120b:	8b 00                	mov    (%rax),%eax
    ...
    122a:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    122e:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    1235:	00 00 
    1237:	74 05                	je     123e <main+0xd5>
    1239:	e8 22 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    123e:	c9                   	leaveq 
    123f:	c3                   	retq   
