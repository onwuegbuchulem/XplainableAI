...
/app/bin_gccgcc10_O1/2022_04_01-Lesson:     file format elf64-x86-64
...
000000000000118e <main>:
    ...
    11b2:	e8 c9 fe ff ff       	callq  1080 <__printf_chk@plt>
    11b7:	48 89 e6             	mov    %rsp,%rsi
    11ba:	48 8d 3d 5c 0e 00 00 	lea    0xe5c(%rip),%rdi        # 201d <_IO_stdin_used+0x1d>
    11c1:	b8 00 00 00 00       	mov    $0x0,%eax
    11c6:	e8 c5 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cb:	f2 0f 10 04 24       	movsd  (%rsp),%xmm0
    11d0:	b8 01 00 00 00       	mov    $0x1,%eax
    11d5:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11d9:	66 0f 2f c8          	comisd %xmm0,%xmm1
    11dd:	73 1b                	jae    11fa <main+0x6c>
    11df:	48 8d 35 42 0e 00 00 	lea    0xe42(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    11e6:	bf 01 00 00 00       	mov    $0x1,%edi
    11eb:	b8 02 00 00 00       	mov    $0x2,%eax
    11f0:	e8 8b fe ff ff       	callq  1080 <__printf_chk@plt>
    11f5:	b8 00 00 00 00       	mov    $0x0,%eax
    11fa:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    11ff:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1206:	00 00 
    1208:	75 05                	jne    120f <main+0x81>
    120a:	48 83 c4 18          	add    $0x18,%rsp
    120e:	c3                   	retq   
