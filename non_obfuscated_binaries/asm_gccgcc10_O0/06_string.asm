...
/app/bin_gccgcc10_O0/06_string:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	48 b8 75 70 64 61 74 	movabs $0x742e657461647075,%rax
    118b:	65 2e 74 
    118e:	48 89 45 d5          	mov    %rax,-0x2b(%rbp)
    1192:	66 c7 45 dd 78 74    	movw   $0x7478,-0x23(%rbp)
    1198:	c6 45 df 00          	movb   $0x0,-0x21(%rbp)
    119c:	c7 45 d0 00 00 00 00 	movl   $0x0,-0x30(%rbp)
    11a3:	eb 0e                	jmp    11b3 <main+0x4a>
    11a5:	8b 45 d0             	mov    -0x30(%rbp),%eax
    11a8:	48 98                	cltq   
    11aa:	c6 44 05 e0 2e       	movb   $0x2e,-0x20(%rbp,%rax,1)
    11af:	83 45 d0 01          	addl   $0x1,-0x30(%rbp)
    11b3:	83 7d d0 0f          	cmpl   $0xf,-0x30(%rbp)
    11b7:	7e ec                	jle    11a5 <main+0x3c>
    11b9:	c7 45 d0 00 00 00 00 	movl   $0x0,-0x30(%rbp)
    11c0:	eb 17                	jmp    11d9 <main+0x70>
    11c2:	8b 45 d0             	mov    -0x30(%rbp),%eax
    11c5:	48 98                	cltq   
    11c7:	0f b6 54 05 d5       	movzbl -0x2b(%rbp,%rax,1),%edx
    11cc:	8b 45 d0             	mov    -0x30(%rbp),%eax
    11cf:	48 98                	cltq   
    11d1:	88 54 05 e0          	mov    %dl,-0x20(%rbp,%rax,1)
    11d5:	83 45 d0 01          	addl   $0x1,-0x30(%rbp)
    11d9:	8b 45 d0             	mov    -0x30(%rbp),%eax
    11dc:	48 98                	cltq   
    11de:	0f b6 44 05 d5       	movzbl -0x2b(%rbp,%rax,1),%eax
    11e3:	3c 2e                	cmp    $0x2e,%al
    11e5:	75 db                	jne    11c2 <main+0x59>
    11e7:	48 8d 55 d5          	lea    -0x2b(%rbp),%rdx
    ...
    1208:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    120c:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1213:	00 00 
    1215:	74 05                	je     121c <main+0xb3>
    1217:	e8 44 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    121c:	c9                   	leaveq 
    121d:	c3                   	retq   
