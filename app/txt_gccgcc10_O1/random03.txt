...
/app/bin_gccgcc10_O1/random03:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11de:	e8 ad fe ff ff       	callq  1090 <srand@plt>
    11e3:	41 bc 05 00 00 00    	mov    $0x5,%r12d
    11e9:	48 8d 2d 14 0e 00 00 	lea    0xe14(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    11f0:	bb 05 00 00 00       	mov    $0x5,%ebx
    11f5:	e8 d6 fe ff ff       	callq  10d0 <rand@plt>
    11fa:	48 63 d0             	movslq %eax,%rdx
    11fd:	48 69 d2 1f 85 eb 51 	imul   $0x51eb851f,%rdx,%rdx
    1204:	48 c1 fa 25          	sar    $0x25,%rdx
    1208:	89 c1                	mov    %eax,%ecx
    120a:	c1 f9 1f             	sar    $0x1f,%ecx
    120d:	29 ca                	sub    %ecx,%edx
    120f:	6b d2 64             	imul   $0x64,%edx,%edx
    1212:	29 d0                	sub    %edx,%eax
    1214:	8d 50 01             	lea    0x1(%rax),%edx
    1217:	48 89 ee             	mov    %rbp,%rsi
    121a:	bf 01 00 00 00       	mov    $0x1,%edi
    121f:	b8 00 00 00 00       	mov    $0x0,%eax
    1224:	e8 97 fe ff ff       	callq  10c0 <__printf_chk@plt>
    1229:	83 eb 01             	sub    $0x1,%ebx
    122c:	75 c7                	jne    11f5 <main+0x2c>
    122e:	48 8b 35 db 2d 00 00 	mov    0x2ddb(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1235:	bf 0a 00 00 00       	mov    $0xa,%edi
    123a:	e8 61 fe ff ff       	callq  10a0 <putc@plt>
    123f:	41 83 ec 01          	sub    $0x1,%r12d
    1243:	75 ab                	jne    11f0 <main+0x27>
