...
/app/bin_gccgcc10_O1/2022_08_20-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1185:	48 c7 04 24 01 00 00 	movq   $0x1,(%rsp)
    118c:	00 
    118d:	48 c7 44 24 08 0c 00 	movq   $0xc,0x8(%rsp)
    1194:	00 00 
    1196:	48 c7 44 24 10 7b 00 	movq   $0x7b,0x10(%rsp)
    119d:	00 00 
    119f:	48 c7 44 24 18 d2 04 	movq   $0x4d2,0x18(%rsp)
    11a6:	00 00 
    11a8:	48 c7 44 24 20 39 30 	movq   $0x3039,0x20(%rsp)
    11af:	00 00 
    11b1:	48 c7 44 24 28 40 e2 	movq   $0x1e240,0x28(%rsp)
    11b8:	01 00 
    11ba:	48 c7 44 24 30 87 d6 	movq   $0x12d687,0x30(%rsp)
    11c1:	12 00 
    11c3:	48 c7 44 24 38 4e 61 	movq   $0xbc614e,0x38(%rsp)
    11ca:	bc 00 
    11cc:	48 c7 44 24 40 15 cd 	movq   $0x75bcd15,0x40(%rsp)
    11d3:	5b 07 
    11d5:	48 c7 44 24 48 d2 02 	movq   $0x499602d2,0x48(%rsp)
    11dc:	96 49 
    11de:	48 89 e5             	mov    %rsp,%rbp
    11e1:	4c 8d 64 24 50       	lea    0x50(%rsp),%r12
    11e6:	48 bb 00 e4 0b 54 02 	movabs $0x2540be400,%rbx
    11ed:	00 00 00 
    11f0:	eb 25                	jmp    1217 <main+0xae>
    11f2:	83 e9 01             	sub    $0x1,%ecx
    11f5:	48 89 f2             	mov    %rsi,%rdx
    11f8:	48 8d 35 05 0e 00 00 	lea    0xe05(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11ff:	bf 01 00 00 00       	mov    $0x1,%edi
    1204:	b8 00 00 00 00       	mov    $0x0,%eax
    1209:	e8 62 fe ff ff       	callq  1070 <__printf_chk@plt>
    120e:	48 83 c5 08          	add    $0x8,%rbp
    1212:	4c 39 e5             	cmp    %r12,%rbp
    1215:	74 27                	je     123e <main+0xd5>
    1217:	48 8b 75 00          	mov    0x0(%rbp),%rsi
    121b:	b9 01 00 00 00       	mov    $0x1,%ecx
    1220:	ba 01 00 00 00       	mov    $0x1,%edx
    1225:	48 39 d6             	cmp    %rdx,%rsi
    1228:	7c c8                	jl     11f2 <main+0x89>
    122a:	48 8d 04 92          	lea    (%rdx,%rdx,4),%rax
    122e:	48 01 c0             	add    %rax,%rax
    1231:	48 89 c2             	mov    %rax,%rdx
    1234:	83 c1 01             	add    $0x1,%ecx
    1237:	48 39 d8             	cmp    %rbx,%rax
    123a:	7e e9                	jle    1225 <main+0xbc>
    123c:	eb d0                	jmp    120e <main+0xa5>
    123e:	48 8b 44 24 58       	mov    0x58(%rsp),%rax
    1243:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    124a:	00 00 
    124c:	75 0e                	jne    125c <main+0xf3>
    124e:	b8 00 00 00 00       	mov    $0x0,%eax
    1253:	48 83 c4 60          	add    $0x60,%rsp
    1257:	5b                   	pop    %rbx
    1258:	5d                   	pop    %rbp
    1259:	41 5c                	pop    %r12
    125b:	c3                   	retq   
    125c:	e8 ff fd ff ff       	callq  1060 <__stack_chk_fail@plt>
