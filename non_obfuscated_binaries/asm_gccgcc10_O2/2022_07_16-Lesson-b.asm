...
/app/bin_gccgcc10_O2/2022_07_16-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a6:	41 55                	push   %r13
    10a8:	41 54                	push   %r12
    10aa:	4c 8d 25 53 0f 00 00 	lea    0xf53(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    10b1:	55                   	push   %rbp
    ...
    10cc:	4c 8d 74 24 08       	lea    0x8(%rsp),%r14
    10d1:	49 89 e5             	mov    %rsp,%r13
    10d4:	48 8d 5c 24 10       	lea    0x10(%rsp),%rbx
    10d9:	48 c7 04 24 00 00 00 	movq   $0x0,(%rsp)
    10e0:	00 
    10e1:	89 ea                	mov    %ebp,%edx
    10e3:	b9 05 00 00 00       	mov    $0x5,%ecx
    10e8:	4c 89 e6             	mov    %r12,%rsi
    10eb:	bf 01 00 00 00       	mov    $0x1,%edi
    10f0:	31 c0                	xor    %eax,%eax
    10f2:	e8 89 ff ff ff       	callq  1080 <__printf_chk@plt>
    10f7:	48 8b 15 12 2f 00 00 	mov    0x2f12(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    10fe:	4c 89 f6             	mov    %r14,%rsi
    1101:	4c 89 ef             	mov    %r13,%rdi
    1104:	e8 87 ff ff ff       	callq  1090 <getline@plt>
    1109:	48 8b 04 24          	mov    (%rsp),%rax
    110d:	48 89 44 eb f8       	mov    %rax,-0x8(%rbx,%rbp,8)
    1112:	48 83 c5 01          	add    $0x1,%rbp
    1116:	48 83 fd 06          	cmp    $0x6,%rbp
    111a:	75 c5                	jne    10e1 <main+0x41>
    111c:	4c 8d 64 24 38       	lea    0x38(%rsp),%r12
    1121:	48 8d 2d ea 0e 00 00 	lea    0xeea(%rip),%rbp        # 2012 <_IO_stdin_used+0x12>
    1128:	48 8b 13             	mov    (%rbx),%rdx
    112b:	48 89 ee             	mov    %rbp,%rsi
    112e:	bf 01 00 00 00       	mov    $0x1,%edi
    1133:	31 c0                	xor    %eax,%eax
    1135:	48 83 c3 08          	add    $0x8,%rbx
    1139:	e8 42 ff ff ff       	callq  1080 <__printf_chk@plt>
    113e:	4c 39 e3             	cmp    %r12,%rbx
    1141:	75 e5                	jne    1128 <main+0x88>
    1143:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1148:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    114f:	00 00 
    1151:	75 0f                	jne    1162 <main+0xc2>
    1153:	48 83 c4 40          	add    $0x40,%rsp
    ...
    115f:	41 5e                	pop    %r14
    1161:	c3                   	retq   
    1162:	e8 09 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
