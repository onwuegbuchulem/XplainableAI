...
/app/bin_gccgcc10_O1/2022_07_16-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119c:	00 00 
    119e:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    11a3:	31 c0                	xor    %eax,%eax
    11a5:	48 c7 04 24 00 00 00 	movq   $0x0,(%rsp)
    11ac:	00 
    11ad:	bb 01 00 00 00       	mov    $0x1,%ebx
    11b2:	48 8d 6c 24 08       	lea    0x8(%rsp),%rbp
    11b7:	b9 05 00 00 00       	mov    $0x5,%ecx
    11bc:	89 da                	mov    %ebx,%edx
    ...
    11d4:	48 89 e7             	mov    %rsp,%rdi
    11d7:	48 8b 15 32 2e 00 00 	mov    0x2e32(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    11de:	48 89 ee             	mov    %rbp,%rsi
    11e1:	e8 aa fe ff ff       	callq  1090 <getline@plt>
    11e6:	48 8b 04 24          	mov    (%rsp),%rax
    11ea:	48 89 44 dc 08       	mov    %rax,0x8(%rsp,%rbx,8)
    11ef:	48 83 c3 01          	add    $0x1,%rbx
    11f3:	48 83 fb 06          	cmp    $0x6,%rbx
    11f7:	75 be                	jne    11b7 <main+0x2e>
    11f9:	48 8d 5c 24 10       	lea    0x10(%rsp),%rbx
    11fe:	4c 8d 64 24 38       	lea    0x38(%rsp),%r12
    1203:	48 8d 2d 08 0e 00 00 	lea    0xe08(%rip),%rbp        # 2012 <_IO_stdin_used+0x12>
    120a:	48 8b 13             	mov    (%rbx),%rdx
    120d:	48 89 ee             	mov    %rbp,%rsi
    1210:	bf 01 00 00 00       	mov    $0x1,%edi
    1215:	b8 00 00 00 00       	mov    $0x0,%eax
    121a:	e8 61 fe ff ff       	callq  1080 <__printf_chk@plt>
    121f:	48 83 c3 08          	add    $0x8,%rbx
    1223:	4c 39 e3             	cmp    %r12,%rbx
    1226:	75 e2                	jne    120a <main+0x81>
    1228:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    122d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1234:	00 00 
    1236:	75 0e                	jne    1246 <main+0xbd>
    1238:	b8 00 00 00 00       	mov    $0x0,%eax
    123d:	48 83 c4 40          	add    $0x40,%rsp
    1241:	5b                   	pop    %rbx
    1242:	5d                   	pop    %rbp
    1243:	41 5c                	pop    %r12
    1245:	c3                   	retq   
