...
/app/bin_gccgcc10_O1/2023_08_01-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    118a:	48 89 04 24          	mov    %rax,(%rsp)
    118e:	48 8d 05 7e 0e 00 00 	lea    0xe7e(%rip),%rax        # 2013 <_IO_stdin_used+0x13>
    1195:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    119a:	48 8d 05 8c 0e 00 00 	lea    0xe8c(%rip),%rax        # 202d <_IO_stdin_used+0x2d>
    11a1:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11a6:	48 8d 05 8a 0e 00 00 	lea    0xe8a(%rip),%rax        # 2037 <_IO_stdin_used+0x37>
    11ad:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    11b2:	48 8d 05 8e 0e 00 00 	lea    0xe8e(%rip),%rax        # 2047 <_IO_stdin_used+0x47>
    11b9:	48 89 44 24 20       	mov    %rax,0x20(%rsp)
    11be:	48 8d 05 91 0e 00 00 	lea    0xe91(%rip),%rax        # 2056 <_IO_stdin_used+0x56>
    11c5:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    11ca:	48 8d 05 97 0e 00 00 	lea    0xe97(%rip),%rax        # 2068 <_IO_stdin_used+0x68>
    11d1:	48 89 44 24 30       	mov    %rax,0x30(%rsp)
    11d6:	48 89 e3             	mov    %rsp,%rbx
    11d9:	48 8d 6c 24 38       	lea    0x38(%rsp),%rbp
    11de:	48 8b 3b             	mov    (%rbx),%rdi
    11e1:	e8 7a fe ff ff       	callq  1060 <puts@plt>
    11e6:	48 83 c3 08          	add    $0x8,%rbx
    11ea:	48 39 eb             	cmp    %rbp,%rbx
    11ed:	75 ef                	jne    11de <main+0x75>
    11ef:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    11f4:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11fb:	00 00 
    11fd:	75 0c                	jne    120b <main+0xa2>
    11ff:	b8 00 00 00 00       	mov    $0x0,%eax
    1204:	48 83 c4 48          	add    $0x48,%rsp
    1208:	5b                   	pop    %rbx
    1209:	5d                   	pop    %rbp
    120a:	c3                   	retq   
