...
/app/bin_gccgcc10_O1/2020_01_11-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <asprintf@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 1d 2f 00 00 	bnd jmpq *0x2f1d(%rip)        # 3fc8 <asprintf@GLIBC_2.2.5>
...
00000000000011a9 <main>:
    ...
    11b9:	00 00 
    11bb:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11c0:	31 c0                	xor    %eax,%eax
    11c2:	48 89 e7             	mov    %rsp,%rdi
    11c5:	ba 0d 00 00 00       	mov    $0xd,%edx
    11ca:	48 8d 35 33 0e 00 00 	lea    0xe33(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11d1:	e8 ca fe ff ff       	callq  10a0 <asprintf@plt>
    11d6:	89 c3                	mov    %eax,%ebx
    11d8:	48 8b 3c 24          	mov    (%rsp),%rdi
    11dc:	e8 9f fe ff ff       	callq  1080 <puts@plt>
    ...
    1205:	00 00 
    1207:	75 0b                	jne    1214 <main+0x6b>
    1209:	b8 00 00 00 00       	mov    $0x0,%eax
    120e:	48 83 c4 10          	add    $0x10,%rsp
    1212:	5b                   	pop    %rbx
    1213:	c3                   	retq   
    1214:	e8 77 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
