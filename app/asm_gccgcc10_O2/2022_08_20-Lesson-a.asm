...
/app/bin_gccgcc10_O2/2022_08_20-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	55                   	push   %rbp
    1085:	ba 01 00 00 00       	mov    $0x1,%edx
    108a:	53                   	push   %rbx
    108b:	48 83 ec 68          	sub    $0x68,%rsp
    108f:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1096:	00 00 
    1098:	48 89 44 24 58       	mov    %rax,0x58(%rsp)
    109d:	31 c0                	xor    %eax,%eax
    109f:	48 8d 5c 24 08       	lea    0x8(%rsp),%rbx
    10a4:	48 8d 6c 24 50       	lea    0x50(%rsp),%rbp
    10a9:	48 c7 44 24 08 0c 00 	movq   $0xc,0x8(%rsp)
    10b0:	00 00 
    10b2:	48 c7 44 24 10 7b 00 	movq   $0x7b,0x10(%rsp)
    10b9:	00 00 
    10bb:	48 c7 44 24 18 d2 04 	movq   $0x4d2,0x18(%rsp)
    10c2:	00 00 
    10c4:	48 c7 44 24 20 39 30 	movq   $0x3039,0x20(%rsp)
    10cb:	00 00 
    10cd:	48 c7 44 24 28 40 e2 	movq   $0x1e240,0x28(%rsp)
    10d4:	01 00 
    10d6:	48 c7 44 24 30 87 d6 	movq   $0x12d687,0x30(%rsp)
    10dd:	12 00 
    10df:	48 c7 44 24 38 4e 61 	movq   $0xbc614e,0x38(%rsp)
    10e6:	bc 00 
    10e8:	48 c7 44 24 40 15 cd 	movq   $0x75bcd15,0x40(%rsp)
    10ef:	5b 07 
    10f1:	48 c7 44 24 48 d2 02 	movq   $0x499602d2,0x48(%rsp)
    10f8:	96 49 
    10fa:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1100:	b9 01 00 00 00       	mov    $0x1,%ecx
    1105:	b8 01 00 00 00       	mov    $0x1,%eax
    110a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1110:	48 39 c2             	cmp    %rax,%rdx
    1113:	7c 23                	jl     1138 <main+0xb8>
    1115:	48 8d 04 80          	lea    (%rax,%rax,4),%rax
    1119:	83 c1 01             	add    $0x1,%ecx
    111c:	48 01 c0             	add    %rax,%rax
    111f:	83 f9 0c             	cmp    $0xc,%ecx
    1122:	75 ec                	jne    1110 <main+0x90>
    1124:	48 39 eb             	cmp    %rbp,%rbx
    1127:	74 2a                	je     1153 <main+0xd3>
    1129:	48 8b 13             	mov    (%rbx),%rdx
    112c:	48 83 c3 08          	add    $0x8,%rbx
    1130:	eb ce                	jmp    1100 <main+0x80>
    1132:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1138:	83 e9 01             	sub    $0x1,%ecx
    113b:	31 c0                	xor    %eax,%eax
    113d:	bf 01 00 00 00       	mov    $0x1,%edi
    1142:	48 8d 35 bb 0e 00 00 	lea    0xebb(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1149:	e8 22 ff ff ff       	callq  1070 <__printf_chk@plt>
    114e:	48 39 eb             	cmp    %rbp,%rbx
    1151:	75 d6                	jne    1129 <main+0xa9>
    1153:	48 8b 44 24 58       	mov    0x58(%rsp),%rax
    1158:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    115f:	00 00 
    1161:	75 09                	jne    116c <main+0xec>
    1163:	48 83 c4 68          	add    $0x68,%rsp
    1167:	31 c0                	xor    %eax,%eax
    1169:	5b                   	pop    %rbx
    116a:	5d                   	pop    %rbp
    116b:	c3                   	retq   
    116c:	e8 ef fe ff ff       	callq  1060 <__stack_chk_fail@plt>
