...
/app/bin_gccgcc10_O3/2023_03_25-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10bf:	48 89 ef             	mov    %rbp,%rdi
    10c2:	e8 b9 ff ff ff       	callq  1080 <time@plt>
    10c7:	4c 8b 24 24          	mov    (%rsp),%r12
    10cb:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10d0:	48 89 ef             	mov    %rbp,%rdi
    10d3:	e8 a8 ff ff ff       	callq  1080 <time@plt>
    10d8:	48 8b 1c 24          	mov    (%rsp),%rbx
    10dc:	4c 39 e3             	cmp    %r12,%rbx
    10df:	74 ef                	je     10d0 <main+0x30>
    10e1:	45 31 e4             	xor    %r12d,%r12d
    10e4:	0f 1f 40 00          	nopl   0x0(%rax)
    10e8:	48 89 ef             	mov    %rbp,%rdi
    10eb:	49 83 c4 01          	add    $0x1,%r12
    10ef:	e8 8c ff ff ff       	callq  1080 <time@plt>
    10f4:	48 3b 1c 24          	cmp    (%rsp),%rbx
    10f8:	74 ee                	je     10e8 <main+0x48>
    10fa:	31 c0                	xor    %eax,%eax
    10fc:	4c 89 e2             	mov    %r12,%rdx
    10ff:	bf 01 00 00 00       	mov    $0x1,%edi
    1104:	48 8d 35 f9 0e 00 00 	lea    0xef9(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    110b:	e8 80 ff ff ff       	callq  1090 <__printf_chk@plt>
    1110:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1115:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    111c:	00 00 
    111e:	75 0b                	jne    112b <main+0x8b>
    1120:	48 83 c4 10          	add    $0x10,%rsp
    1124:	31 c0                	xor    %eax,%eax
    1126:	5b                   	pop    %rbx
    1127:	5d                   	pop    %rbp
    1128:	41 5c                	pop    %r12
    112a:	c3                   	retq   
    112b:	e8 40 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
