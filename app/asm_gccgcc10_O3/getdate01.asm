...
/app/bin_gccgcc10_O3/getdate01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10ca:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10d1:	00 00 
    10d3:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10d8:	31 c0                	xor    %eax,%eax
    10da:	e8 c1 ff ff ff       	callq  10a0 <time@plt>
    10df:	48 89 e7             	mov    %rsp,%rdi
    10e2:	48 89 04 24          	mov    %rax,(%rsp)
    10e6:	e8 95 ff ff ff       	callq  1080 <localtime@plt>
    10eb:	bf 01 00 00 00       	mov    $0x1,%edi
    10f0:	8b 50 10             	mov    0x10(%rax),%edx
    10f3:	8b 70 14             	mov    0x14(%rax),%esi
    10f6:	44 8b 40 0c          	mov    0xc(%rax),%r8d
    10fa:	8d 4a 01             	lea    0x1(%rdx),%ecx
    10fd:	8b 50 18             	mov    0x18(%rax),%edx
    1100:	44 8d 8e 6c 07 00 00 	lea    0x76c(%rsi),%r9d
    1107:	31 c0                	xor    %eax,%eax
    1109:	48 8d 35 f4 0e 00 00 	lea    0xef4(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1110:	e8 9b ff ff ff       	callq  10b0 <__printf_chk@plt>
