...
/app/bin_gccgcc10_O2/2021_10_09-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	41 54                	push   %r12
    10a6:	48 83 ec 10          	sub    $0x10,%rsp
    10aa:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10b1:	00 00 
    10b3:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10b8:	31 c0                	xor    %eax,%eax
    10ba:	4c 8d 64 24 03       	lea    0x3(%rsp),%r12
    10bf:	c7 44 24 03 41 42 43 	movl   $0x44434241,0x3(%rsp)
    10c6:	44 
    10c7:	4c 89 e7             	mov    %r12,%rdi
    10ca:	c6 44 24 07 00       	movb   $0x0,0x7(%rsp)
    10cf:	e8 9c ff ff ff       	callq  1070 <puts@plt>
    10d4:	4c 89 e2             	mov    %r12,%rdx
    ...
    10ec:	4c 89 e2             	mov    %r12,%rdx
    10ef:	bf 01 00 00 00       	mov    $0x1,%edi
    10f4:	48 8d 35 0d 0f 00 00 	lea    0xf0d(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    10fb:	e8 90 ff ff ff       	callq  1090 <__printf_chk@plt>
    1100:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1105:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    110c:	00 00 
    110e:	75 09                	jne    1119 <main+0x79>
    1110:	48 83 c4 10          	add    $0x10,%rsp
    1114:	31 c0                	xor    %eax,%eax
    1116:	41 5c                	pop    %r12
    1118:	c3                   	retq   
    1119:	e8 62 ff ff ff       	callq  1080 <__stack_chk_fail@plt>
