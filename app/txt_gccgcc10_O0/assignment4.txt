...
/app/bin_gccgcc10_O0/assignment4:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 3d 67 0e 00 00 	lea    0xe67(%rip),%rdi        # 202a <_IO_stdin_used+0x2a>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	e8 c3 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cd:	f3 0f 10 4d f0       	movss  -0x10(%rbp),%xmm1
    11d2:	f3 0f 10 45 f0       	movss  -0x10(%rbp),%xmm0
    11d7:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    11db:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11df:	f3 0f 5a c8          	cvtss2sd %xmm0,%xmm1
    11e3:	f2 0f 10 05 65 0e 00 	movsd  0xe65(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    11ea:	00 
    11eb:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    11ef:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    11f3:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    11f8:	66 0f ef d2          	pxor   %xmm2,%xmm2
    11fc:	f3 0f 5a 55 f4       	cvtss2sd -0xc(%rbp),%xmm2
    1201:	66 48 0f 7e d0       	movq   %xmm2,%rax
    1206:	66 48 0f 6e c0       	movq   %rax,%xmm0
    120b:	48 8d 3d 1b 0e 00 00 	lea    0xe1b(%rip),%rdi        # 202d <_IO_stdin_used+0x2d>
    1212:	b8 01 00 00 00       	mov    $0x1,%eax
    1217:	e8 64 fe ff ff       	callq  1080 <printf@plt>
    121c:	b8 00 00 00 00       	mov    $0x0,%eax
    1221:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1225:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    122c:	00 00 
    122e:	74 05                	je     1235 <main+0xac>
    1230:	e8 3b fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1235:	c9                   	leaveq 
    1236:	c3                   	retq   
