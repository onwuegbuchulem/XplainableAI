...
/app/bin_gccgcc10_O3/Separate:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c5:	e8 b6 ff ff ff       	callq  1080 <__printf_chk@plt>
    10ca:	48 8d 74 24 14       	lea    0x14(%rsp),%rsi
    10cf:	48 8d 3d 6a 0f 00 00 	lea    0xf6a(%rip),%rdi        # 2040 <_IO_stdin_used+0x40>
    10d6:	31 c0                	xor    %eax,%eax
    10d8:	e8 b3 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10dd:	f3 0f 10 44 24 14    	movss  0x14(%rsp),%xmm0
    10e3:	48 8d 35 2e 0f 00 00 	lea    0xf2e(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    10ea:	31 c0                	xor    %eax,%eax
    10ec:	bf 01 00 00 00       	mov    $0x1,%edi
    10f1:	f3 0f 2c d8          	cvttss2si %xmm0,%ebx
    10f5:	f3 0f 11 44 24 0c    	movss  %xmm0,0xc(%rsp)
    10fb:	89 da                	mov    %ebx,%edx
    10fd:	e8 7e ff ff ff       	callq  1080 <__printf_chk@plt>
    1102:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1106:	f3 0f 10 44 24 0c    	movss  0xc(%rsp),%xmm0
    110c:	48 8d 35 1b 0f 00 00 	lea    0xf1b(%rip),%rsi        # 202e <_IO_stdin_used+0x2e>
    1113:	f3 0f 2a cb          	cvtsi2ss %ebx,%xmm1
    1117:	bf 01 00 00 00       	mov    $0x1,%edi
    111c:	b8 01 00 00 00       	mov    $0x1,%eax
    1121:	f3 0f 5c c1          	subss  %xmm1,%xmm0
    1125:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1129:	e8 52 ff ff ff       	callq  1080 <__printf_chk@plt>
    112e:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1133:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    113a:	00 00 
    113c:	75 06                	jne    1144 <main+0xa4>
    113e:	48 83 c4 20          	add    $0x20,%rsp
    1142:	5b                   	pop    %rbx
    1143:	c3                   	retq   
    1144:	e8 27 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
