...
/app/bin_gccgcc10_O0/2020_05_16-Lesson:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    1224:	48 b8 66 69 6c 65 5f 	movabs $0x74756f5f656c6966,%rax
    122b:	6f 75 74 
    122e:	48 ba 70 75 74 2e 74 	movabs $0x7478742e747570,%rdx
    1235:	78 74 00 
    1238:	48 89 45 c0          	mov    %rax,-0x40(%rbp)
    123c:	48 89 55 c8          	mov    %rdx,-0x38(%rbp)
    1240:	48 b8 57 68 61 74 20 	movabs $0x6c20612074616857,%rax
    1247:	61 20 6c 
    124a:	48 ba 6f 76 65 6c 79 	movabs $0x696c20796c65766f,%rdx
    1251:	20 6c 69 
    1254:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    1258:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
    125c:	48 b8 74 74 6c 65 20 	movabs $0x6c696620656c7474,%rax
    1263:	66 69 6c 
    1266:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
    126a:	66 c7 45 e8 65 0a    	movw   $0xa65,-0x18(%rbp)
    1270:	c6 45 ea 00          	movb   $0x0,-0x16(%rbp)
    1274:	48 8d 45 c0          	lea    -0x40(%rbp),%rax
    1278:	ba a4 01 00 00       	mov    $0x1a4,%edx
    127d:	be 41 00 00 00       	mov    $0x41,%esi
    1282:	48 89 c7             	mov    %rax,%rdi
    1285:	b8 00 00 00 00       	mov    $0x0,%eax
    128a:	e8 71 fe ff ff       	callq  1100 <open@plt>
    128f:	89 45 b8             	mov    %eax,-0x48(%rbp)
    1292:	83 7d b8 ff          	cmpl   $0xffffffff,-0x48(%rbp)
    1296:	75 26                	jne    12be <main+0xb5>
    1298:	48 8b 05 81 2d 00 00 	mov    0x2d81(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    129f:	48 8d 55 c0          	lea    -0x40(%rbp),%rdx
    ...
    12b2:	e8 39 fe ff ff       	callq  10f0 <fprintf@plt>
    12b7:	b8 01 00 00 00       	mov    $0x1,%eax
    12bc:	eb 66                	jmp    1324 <main+0x11b>
    12be:	48 8d 4d d0          	lea    -0x30(%rbp),%rcx
    12c2:	8b 45 b8             	mov    -0x48(%rbp),%eax
    12c5:	ba 1a 00 00 00       	mov    $0x1a,%edx
    12ca:	48 89 ce             	mov    %rcx,%rsi
    12cd:	89 c7                	mov    %eax,%edi
    12cf:	e8 dc fd ff ff       	callq  10b0 <write@plt>
    12d4:	89 45 bc             	mov    %eax,-0x44(%rbp)
    12d7:	83 7d bc 1a          	cmpl   $0x1a,-0x44(%rbp)
    12db:	74 20                	je     12fd <main+0xf4>
    12dd:	48 8b 05 3c 2d 00 00 	mov    0x2d3c(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    12e4:	48 89 c1             	mov    %rax,%rcx
    12e7:	ba 20 00 00 00       	mov    $0x20,%edx
    12ec:	be 01 00 00 00       	mov    $0x1,%esi
    12f1:	48 8d 3d 28 0d 00 00 	lea    0xd28(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    12f8:	e8 13 fe ff ff       	callq  1110 <fwrite@plt>
    12fd:	48 8d 45 c0          	lea    -0x40(%rbp),%rax
    1301:	48 89 c6             	mov    %rax,%rsi
    1304:	48 8d 3d 36 0d 00 00 	lea    0xd36(%rip),%rdi        # 2041 <_IO_stdin_used+0x41>
    130b:	b8 00 00 00 00       	mov    $0x0,%eax
    1310:	e8 bb fd ff ff       	callq  10d0 <printf@plt>
    1315:	8b 45 b8             	mov    -0x48(%rbp),%eax
    1318:	89 c7                	mov    %eax,%edi
    131a:	e8 c1 fd ff ff       	callq  10e0 <close@plt>
    131f:	b8 00 00 00 00       	mov    $0x0,%eax
    1324:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1328:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    132f:	00 00 
    1331:	74 05                	je     1338 <main+0x12f>
    1333:	e8 88 fd ff ff       	callq  10c0 <__stack_chk_fail@plt>
    1338:	c9                   	leaveq 
    1339:	c3                   	retq   
