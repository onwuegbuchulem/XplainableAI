...
/app/bin_gccgcc10_O1/2021_07_03-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1171:	c7 05 a5 2e 00 00 00 	movl   $0x0,0x2ea5(%rip)        # 4020 <opterr@@GLIBC_2.2.5>
    1178:	00 00 00 
    117b:	48 8d 15 82 0e 00 00 	lea    0xe82(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    1182:	e8 e9 fe ff ff       	callq  1070 <getopt@plt>
    1187:	89 c2                	mov    %eax,%edx
    1189:	48 8d 35 78 0e 00 00 	lea    0xe78(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    1190:	bf 01 00 00 00       	mov    $0x1,%edi
    1195:	b8 00 00 00 00       	mov    $0x0,%eax
    119a:	e8 c1 fe ff ff       	callq  1060 <__printf_chk@plt>
