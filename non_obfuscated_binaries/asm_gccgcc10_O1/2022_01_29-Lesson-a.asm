...
/app/bin_gccgcc10_O1/2022_01_29-Lesson-a:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11b3:	55                   	push   %rbp
    11b4:	53                   	push   %rbx
    11b5:	48 83 ec 30          	sub    $0x30,%rsp
    11b9:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11c0:	00 00 
    11c2:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    11c7:	31 c0                	xor    %eax,%eax
    11c9:	49 89 e5             	mov    %rsp,%r13
    11cc:	48 8d 54 24 1b       	lea    0x1b(%rsp),%rdx
    11d1:	4c 89 e8             	mov    %r13,%rax
    11d4:	c6 00 2e             	movb   $0x2e,(%rax)
    11d7:	c6 40 01 2e          	movb   $0x2e,0x1(%rax)
    11db:	c6 40 02 2e          	movb   $0x2e,0x2(%rax)
    11df:	c6 40 03 2e          	movb   $0x2e,0x3(%rax)
    11e3:	c6 40 04 2e          	movb   $0x2e,0x4(%rax)
    11e7:	c6 40 05 2e          	movb   $0x2e,0x5(%rax)
    11eb:	c6 40 06 2e          	movb   $0x2e,0x6(%rax)
    11ef:	c6 40 07 2e          	movb   $0x2e,0x7(%rax)
    11f3:	c6 40 08 2e          	movb   $0x2e,0x8(%rax)
    11f7:	48 83 c0 09          	add    $0x9,%rax
    11fb:	48 39 d0             	cmp    %rdx,%rax
    11fe:	75 d4                	jne    11d4 <main+0x2b>
    1200:	48 8d 3d fd 0d 00 00 	lea    0xdfd(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1207:	e8 74 fe ff ff       	callq  1080 <puts@plt>
    120c:	49 83 c5 09          	add    $0x9,%r13
    1210:	41 be 00 00 00 00    	mov    $0x0,%r14d
    1216:	4c 8d 25 f7 0d 00 00 	lea    0xdf7(%rip),%r12        # 2014 <_IO_stdin_used+0x14>
    121d:	eb 62                	jmp    1281 <main+0xd8>
    121f:	48 8d 35 f3 0d 00 00 	lea    0xdf3(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    1226:	bf 01 00 00 00       	mov    $0x1,%edi
    122b:	b8 00 00 00 00       	mov    $0x0,%eax
    1230:	e8 7b fe ff ff       	callq  10b0 <__printf_chk@plt>
    1235:	48 83 c5 03          	add    $0x3,%rbp
    1239:	49 39 ed             	cmp    %rbp,%r13
    123c:	74 28                	je     1266 <main+0xbd>
    123e:	bb 00 00 00 00       	mov    $0x0,%ebx
    1243:	0f be 54 1d 00       	movsbl 0x0(%rbp,%rbx,1),%edx
    ...
    125e:	48 83 fb 03          	cmp    $0x3,%rbx
    1262:	75 df                	jne    1243 <main+0x9a>
    1264:	eb b9                	jmp    121f <main+0x76>
    1266:	48 8b 35 a3 2d 00 00 	mov    0x2da3(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    126d:	bf 0a 00 00 00       	mov    $0xa,%edi
    1272:	e8 29 fe ff ff       	callq  10a0 <putc@plt>
    1277:	49 83 c5 09          	add    $0x9,%r13
    127b:	41 83 fe 03          	cmp    $0x3,%r14d
    127f:	74 28                	je     12a9 <main+0x100>
    1281:	41 83 c6 01          	add    $0x1,%r14d
    1285:	b9 20 00 00 00       	mov    $0x20,%ecx
    128a:	44 89 f2             	mov    %r14d,%edx
    ...
    129e:	e8 0d fe ff ff       	callq  10b0 <__printf_chk@plt>
    12a3:	49 8d 6d f7          	lea    -0x9(%r13),%rbp
    12a7:	eb 95                	jmp    123e <main+0x95>
    12a9:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    12ae:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12b5:	00 00 
    12b7:	75 12                	jne    12cb <main+0x122>
    12b9:	b8 00 00 00 00       	mov    $0x0,%eax
    12be:	48 83 c4 30          	add    $0x30,%rsp
    12c2:	5b                   	pop    %rbx
    12c3:	5d                   	pop    %rbp
    12c4:	41 5c                	pop    %r12
    12c6:	41 5d                	pop    %r13
