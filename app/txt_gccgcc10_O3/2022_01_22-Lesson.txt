...
/app/bin_gccgcc10_O3/2022_01_22-Lesson:     file format elf64-x86-64
...
00000000000011d0 <_start>:
    ...
    11e1:	50                   	push   %rax
    11e2:	54                   	push   %rsp
    11e3:	4c 8d 05 66 02 00 00 	lea    0x266(%rip),%r8        # 1450 <__libc_csu_fini>
    11ea:	48 8d 0d ef 01 00 00 	lea    0x1ef(%rip),%rcx        # 13e0 <__libc_csu_init>
...
0000000000001350 <test>:
    ...
    1359:	49 89 fd             	mov    %rdi,%r13
    135c:	48 89 fa             	mov    %rdi,%rdx
    135f:	41 54                	push   %r12
    1361:	bf 01 00 00 00       	mov    $0x1,%edi
    1366:	49 89 f4             	mov    %rsi,%r12
    1369:	31 c0                	xor    %eax,%eax
    136b:	55                   	push   %rbp
    136c:	48 8d 35 91 0c 00 00 	lea    0xc91(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1373:	53                   	push   %rbx
    1374:	48 83 ec 08          	sub    $0x8,%rsp
    1378:	e8 33 fd ff ff       	callq  10b0 <__printf_chk@plt>
    137d:	eb 19                	jmp    1398 <test+0x48>
    137f:	90                   	nop
    1380:	e8 fb fc ff ff       	callq  1080 <__ctype_toupper_loc@plt>
    1385:	49 83 c5 01          	add    $0x1,%r13
    1389:	49 83 c4 01          	add    $0x1,%r12
    138d:	48 8b 00             	mov    (%rax),%rax
    1390:	8b 14 98             	mov    (%rax,%rbx,4),%edx
    1393:	39 14 a8             	cmp    %edx,(%rax,%rbp,4)
    1396:	75 28                	jne    13c0 <test+0x70>
    1398:	41 0f b6 6d 00       	movzbl 0x0(%r13),%ebp
    139d:	41 0f b6 1c 24       	movzbl (%r12),%ebx
    13a2:	89 e8                	mov    %ebp,%eax
    13a4:	08 d8                	or     %bl,%al
    13a6:	75 d8                	jne    1380 <test+0x30>
    13a8:	48 83 c4 08          	add    $0x8,%rsp
    13ac:	48 8d 3d 60 0c 00 00 	lea    0xc60(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    13b3:	5b                   	pop    %rbx
    13b4:	5d                   	pop    %rbp
    13b5:	41 5c                	pop    %r12
    13b7:	41 5d                	pop    %r13
    13b9:	e9 d2 fc ff ff       	jmpq   1090 <puts@plt>
    13be:	66 90                	xchg   %ax,%ax
    13c0:	48 83 c4 08          	add    $0x8,%rsp
    13c4:	48 8d 3d 45 0c 00 00 	lea    0xc45(%rip),%rdi        # 2010 <_IO_stdin_used+0x10>
    13cb:	5b                   	pop    %rbx
    13cc:	5d                   	pop    %rbp
    13cd:	41 5c                	pop    %r12
    13cf:	41 5d                	pop    %r13
    13d1:	e9 ba fc ff ff       	jmpq   1090 <puts@plt>
