...
/app/bin_gccgcc10_O0/Swap_2:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11c0:	48 8d 3d 52 0e 00 00 	lea    0xe52(%rip),%rdi        # 2019 <_IO_stdin_used+0x19>
    ...
    11d9:	89 45 f0             	mov    %eax,-0x10(%rbp)
    11dc:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11df:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11e2:	29 d0                	sub    %edx,%eax
    11e4:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11e7:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11ea:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11ed:	29 d0                	sub    %edx,%eax
    11ef:	89 45 f0             	mov    %eax,-0x10(%rbp)
    11f2:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11f5:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11f8:	89 c6                	mov    %eax,%esi
    11fa:	48 8d 3d 1e 0e 00 00 	lea    0xe1e(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
