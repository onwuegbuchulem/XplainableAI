...
/app/bin_gccgcc10_O3/EligibleForVoting:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ce:	48 8d 3d 40 0f 00 00 	lea    0xf40(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	e8 b4 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10dc:	8b 44 24 04          	mov    0x4(%rsp),%eax
    10e0:	83 f8 11             	cmp    $0x11,%eax
    10e3:	7f 43                	jg     1128 <main+0x88>
    10e5:	85 c0                	test   %eax,%eax
    10e7:	7e 2a                	jle    1113 <main+0x73>
    10e9:	48 8d 35 60 0f 00 00 	lea    0xf60(%rip),%rsi        # 2050 <_IO_stdin_used+0x50>
    10f0:	bf 01 00 00 00       	mov    $0x1,%edi
    10f5:	31 c0                	xor    %eax,%eax
    10f7:	e8 84 ff ff ff       	callq  1080 <__printf_chk@plt>
    10fc:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1101:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1108:	00 00 
    110a:	75 31                	jne    113d <main+0x9d>
    110c:	31 c0                	xor    %eax,%eax
    110e:	48 83 c4 18          	add    $0x18,%rsp
    1112:	c3                   	retq   
    1113:	48 8d 35 1b 0f 00 00 	lea    0xf1b(%rip),%rsi        # 2035 <_IO_stdin_used+0x35>
    111a:	bf 01 00 00 00       	mov    $0x1,%edi
    111f:	31 c0                	xor    %eax,%eax
    1121:	e8 5a ff ff ff       	callq  1080 <__printf_chk@plt>
    1126:	eb d4                	jmp    10fc <main+0x5c>
    1128:	48 8d 35 e9 0e 00 00 	lea    0xee9(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    112f:	bf 01 00 00 00       	mov    $0x1,%edi
    1134:	31 c0                	xor    %eax,%eax
    1136:	e8 45 ff ff ff       	callq  1080 <__printf_chk@plt>
    113b:	eb bf                	jmp    10fc <main+0x5c>
