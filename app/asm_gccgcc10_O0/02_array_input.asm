...
/app/bin_gccgcc10_O0/02_array_input:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    120e:	eb 23                	jmp    1233 <main+0x8a>
    1210:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1213:	48 98                	cltq   
    1215:	8b 54 85 e0          	mov    -0x20(%rbp,%rax,4),%edx
    1219:	8b 45 dc             	mov    -0x24(%rbp),%eax
    121c:	89 c6                	mov    %eax,%esi
    121e:	48 8d 3d 03 0e 00 00 	lea    0xe03(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    1225:	b8 00 00 00 00       	mov    $0x0,%eax
    122a:	e8 71 fe ff ff       	callq  10a0 <printf@plt>
    122f:	83 45 dc 01          	addl   $0x1,-0x24(%rbp)
    1233:	83 7d dc 04          	cmpl   $0x4,-0x24(%rbp)
    1237:	7e d7                	jle    1210 <main+0x67>
    1239:	b8 00 00 00 00       	mov    $0x0,%eax
    123e:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1242:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1249:	00 00 
    124b:	74 05                	je     1252 <main+0xa9>
