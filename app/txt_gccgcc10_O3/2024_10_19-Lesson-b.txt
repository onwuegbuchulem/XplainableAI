...
/app/bin_gccgcc10_O3/2024_10_19-Lesson-b:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1084:	48 89 ee             	mov    %rbp,%rsi
    1087:	bf 01 00 00 00       	mov    $0x1,%edi
    108c:	b8 02 00 00 00       	mov    $0x2,%eax
    1091:	f3 0f 5a c2          	cvtss2sd %xmm2,%xmm0
    1095:	66 0f 28 c8          	movapd %xmm0,%xmm1
    1099:	f2 0f 5c 0d 77 0f 00 	subsd  0xf77(%rip),%xmm1        # 2018 <_IO_stdin_used+0x18>
    10a0:	00 
    10a1:	f3 0f 11 54 24 0c    	movss  %xmm2,0xc(%rsp)
    10a7:	f2 0f 59 0d 71 0f 00 	mulsd  0xf71(%rip),%xmm1        # 2020 <_IO_stdin_used+0x20>
    10ae:	00 
    10af:	f2 0f 5a c9          	cvtsd2ss %xmm1,%xmm1
    10b3:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
    10b7:	e8 94 ff ff ff       	callq  1050 <__printf_chk@plt>
    10bc:	f3 0f 10 54 24 0c    	movss  0xc(%rsp),%xmm2
    10c2:	f3 0f 58 15 5e 0f 00 	addss  0xf5e(%rip),%xmm2        # 2028 <_IO_stdin_used+0x28>
    10c9:	00 
    10ca:	83 eb 01             	sub    $0x1,%ebx
    10cd:	75 b1                	jne    1080 <main+0x20>
