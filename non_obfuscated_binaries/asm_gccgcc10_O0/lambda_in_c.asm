...
/app/bin_gccgcc10_O0/lambda_in_c:     file format elf64-x86-64
...
0000000000001169 <__fn__.0>:
    1169:	f3 0f 1e fa          	endbr64 
    116d:	55                   	push   %rbp
    116e:	48 89 e5             	mov    %rsp,%rbp
    1171:	89 7d fc             	mov    %edi,-0x4(%rbp)
    1174:	89 75 f8             	mov    %esi,-0x8(%rbp)
    1177:	4c 89 55 f0          	mov    %r10,-0x10(%rbp)
    117b:	8b 45 fc             	mov    -0x4(%rbp),%eax
    117e:	39 45 f8             	cmp    %eax,-0x8(%rbp)
    1181:	0f 4d 45 f8          	cmovge -0x8(%rbp),%eax
    1185:	5d                   	pop    %rbp
    1186:	c3                   	retq   
...
0000000000001187 <main>:
    ...
    118f:	48 83 ec 40          	sub    $0x40,%rsp
    1193:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    119a:	00 00 
    119c:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11a0:	31 c0                	xor    %eax,%eax
    11a2:	48 8d 45 10          	lea    0x10(%rbp),%rax
    11a6:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11aa:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    11ae:	48 8d 55 d0          	lea    -0x30(%rbp),%rdx
    11b2:	c7 00 f3 0f 1e fa    	movl   $0xfa1e0ff3,(%rax)
    11b8:	66 c7 40 04 49 bb    	movw   $0xbb49,0x4(%rax)
    11be:	48 8d 0d a4 ff ff ff 	lea    -0x5c(%rip),%rcx        # 1169 <__fn__.0>
    11c5:	48 89 48 06          	mov    %rcx,0x6(%rax)
    11c9:	66 c7 40 0e 49 ba    	movw   $0xba49,0xe(%rax)
    11cf:	48 89 50 10          	mov    %rdx,0x10(%rax)
    11d3:	c7 40 18 49 ff e3 90 	movl   $0x90e3ff49,0x18(%rax)
    11da:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    11de:	48 89 45 c8          	mov    %rax,-0x38(%rbp)
    11e2:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    11e6:	be 17 00 00 00       	mov    $0x17,%esi
    11eb:	bf 01 00 00 00       	mov    $0x1,%edi
    11f0:	ff d0                	callq  *%rax
    11f2:	89 c6                	mov    %eax,%esi
    11f4:	48 8d 3d 09 0e 00 00 	lea    0xe09(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    ...
    120e:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1215:	00 00 
    1217:	74 05                	je     121e <main+0x97>
    1219:	e8 42 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    121e:	c9                   	leaveq 
    121f:	c3                   	retq   
