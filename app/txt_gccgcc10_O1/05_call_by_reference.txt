...
/app/bin_gccgcc10_O1/05_call_by_reference:     file format elf64-x86-64
...
0000000000001149 <sum>:
    ...
    114d:	c7 07 06 00 00 00    	movl   $0x6,(%rdi)
    1153:	8b 06                	mov    (%rsi),%eax
    1155:	83 c0 06             	add    $0x6,%eax
    1158:	c3                   	retq   

0000000000001159 <main>:
    1159:	f3 0f 1e fa          	endbr64 
    115d:	48 83 ec 08          	sub    $0x8,%rsp
    1161:	ba 0c 00 00 00       	mov    $0xc,%edx
    ...
    1177:	e8 d4 fe ff ff       	callq  1050 <__printf_chk@plt>
    117c:	ba 06 00 00 00       	mov    $0x6,%edx
    1181:	48 8d 35 96 0e 00 00 	lea    0xe96(%rip),%rsi        # 201e <_IO_stdin_used+0x1e>
