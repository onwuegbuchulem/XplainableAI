...
/app/bin_gccgcc10_O1/2024_02_17-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <getenv@plt>:
    ...
    10a4:	f2 ff 25 fd 2e 00 00 	bnd jmpq *0x2efd(%rip)        # 3fa8 <getenv@GLIBC_2.2.5>
...
00000000000010c0 <setenv@plt>:
    10c0:	f3 0f 1e fa          	endbr64 
    10c4:	f2 ff 25 ed 2e 00 00 	bnd jmpq *0x2eed(%rip)        # 3fb8 <setenv@GLIBC_2.2.5>
...
00000000000010f0 <unsetenv@plt>:
    10f0:	f3 0f 1e fa          	endbr64 
    10f4:	f2 ff 25 d5 2e 00 00 	bnd jmpq *0x2ed5(%rip)        # 3fd0 <unsetenv@GLIBC_2.2.5>
...
0000000000001100 <_start>:
    ...
    1111:	50                   	push   %rax
    1112:	54                   	push   %rsp
    1113:	4c 8d 05 26 02 00 00 	lea    0x226(%rip),%r8        # 1340 <__libc_csu_fini>
    111a:	48 8d 0d af 01 00 00 	lea    0x1af(%rip),%rcx        # 12d0 <__libc_csu_init>
...
00000000000011e9 <main>:
    ...
    1203:	48 b8 6c 61 6e 67 61 	movabs $0x65677561676e616c,%rax
    120a:	75 67 65 
    120d:	48 89 44 24 0f       	mov    %rax,0xf(%rsp)
    1212:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    1217:	66 c7 44 24 0d 43 00 	movw   $0x43,0xd(%rsp)
    121e:	48 8d 6c 24 0d       	lea    0xd(%rsp),%rbp
    1223:	48 8d 5c 24 0f       	lea    0xf(%rsp),%rbx
    1228:	48 89 e9             	mov    %rbp,%rcx
    122b:	48 89 da             	mov    %rbx,%rdx
    122e:	48 8d 35 d3 0d 00 00 	lea    0xdd3(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    ...
    124f:	e8 6c fe ff ff       	callq  10c0 <setenv@plt>
    1254:	48 89 df             	mov    %rbx,%rdi
    1257:	e8 44 fe ff ff       	callq  10a0 <getenv@plt>
    125c:	48 89 c2             	mov    %rax,%rdx
    125f:	48 8d 35 c1 0d 00 00 	lea    0xdc1(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    1266:	bf 01 00 00 00       	mov    $0x1,%edi
    126b:	b8 00 00 00 00       	mov    $0x0,%eax
    1270:	e8 6b fe ff ff       	callq  10e0 <__printf_chk@plt>
    1275:	48 89 da             	mov    %rbx,%rdx
    1278:	48 8d 35 b6 0d 00 00 	lea    0xdb6(%rip),%rsi        # 2035 <_IO_stdin_used+0x35>
    127f:	bf 01 00 00 00       	mov    $0x1,%edi
    1284:	b8 00 00 00 00       	mov    $0x0,%eax
    1289:	e8 52 fe ff ff       	callq  10e0 <__printf_chk@plt>
    128e:	48 89 df             	mov    %rbx,%rdi
    1291:	e8 5a fe ff ff       	callq  10f0 <unsetenv@plt>
    1296:	48 8d 3d a8 0d 00 00 	lea    0xda8(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    129d:	e8 0e fe ff ff       	callq  10b0 <puts@plt>
    12a2:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    12a7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12ae:	00 00 
    12b0:	75 0c                	jne    12be <main+0xd5>
    12b2:	b8 00 00 00 00       	mov    $0x0,%eax
    12b7:	48 83 c4 28          	add    $0x28,%rsp
    12bb:	5b                   	pop    %rbx
    12bc:	5d                   	pop    %rbp
    12bd:	c3                   	retq   
    12be:	e8 0d fe ff ff       	callq  10d0 <__stack_chk_fail@plt>
