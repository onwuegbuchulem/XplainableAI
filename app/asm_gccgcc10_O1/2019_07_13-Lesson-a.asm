...
/app/bin_gccgcc10_O1/2019_07_13-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a2:	48 b8 6e 6f 6e 73 65 	movabs $0x65736e65736e6f6e,%rax
    11a9:	6e 73 65 
    11ac:	48 89 44 24 0f       	mov    %rax,0xf(%rsp)
    11b1:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    11b6:	48 89 e6             	mov    %rsp,%rsi
    11b9:	48 8d 5c 24 0f       	lea    0xf(%rsp),%rbx
    11be:	ba 0a 00 00 00       	mov    $0xa,%edx
    11c3:	48 89 df             	mov    %rbx,%rdi
    11c6:	e8 b5 fe ff ff       	callq  1080 <strtol@plt>
    11cb:	48 89 c1             	mov    %rax,%rcx
    11ce:	48 89 da             	mov    %rbx,%rdx
