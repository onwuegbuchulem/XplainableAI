...
/app/bin_gccgcc10_O1/2023_07_01-Lesson:     file format elf64-x86-64
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d 42 01 00 00 	lea    0x142(%rip),%rdi        # 122a <main>
...
00000000000011a9 <sum>:
    ...
    11b1:	41 89 f9             	mov    %edi,%r9d
    11b4:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11bb:	00 00 
    11bd:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    11c2:	31 c0                	xor    %eax,%eax
    11c4:	48 89 e7             	mov    %rsp,%rdi
    11c7:	4c 8d 05 36 0e 00 00 	lea    0xe36(%rip),%r8        # 2004 <_IO_stdin_used+0x4>
    11ce:	b9 20 00 00 00       	mov    $0x20,%ecx
    11d3:	ba 01 00 00 00       	mov    $0x1,%edx
    11d8:	be 20 00 00 00       	mov    $0x20,%esi
    11dd:	e8 9e fe ff ff       	callq  1080 <__snprintf_chk@plt>
    11e2:	0f b6 04 24          	movzbl (%rsp),%eax
    11e6:	84 c0                	test   %al,%al
    11e8:	74 34                	je     121e <sum+0x75>
    11ea:	48 8d 54 24 01       	lea    0x1(%rsp),%rdx
    11ef:	b9 00 00 00 00       	mov    $0x0,%ecx
    11f4:	0f be c0             	movsbl %al,%eax
    11f7:	8d 4c 01 d0          	lea    -0x30(%rcx,%rax,1),%ecx
    11fb:	48 83 c2 01          	add    $0x1,%rdx
    11ff:	0f b6 42 ff          	movzbl -0x1(%rdx),%eax
    1203:	84 c0                	test   %al,%al
    1205:	75 ed                	jne    11f4 <sum+0x4b>
    1207:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    120c:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1213:	00 00 
    1215:	75 0e                	jne    1225 <sum+0x7c>
    1217:	89 c8                	mov    %ecx,%eax
    1219:	48 83 c4 38          	add    $0x38,%rsp
    121d:	c3                   	retq   
    121e:	b9 00 00 00 00       	mov    $0x0,%ecx
    1223:	eb e2                	jmp    1207 <sum+0x5e>
...
000000000000122a <main>:
    ...
    1242:	48 8d 35 be 0d 00 00 	lea    0xdbe(%rip),%rsi        # 2007 <_IO_stdin_used+0x7>
    1249:	bf 01 00 00 00       	mov    $0x1,%edi
    124e:	e8 4d fe ff ff       	callq  10a0 <__printf_chk@plt>
    1253:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    1258:	48 8d 3d a5 0d 00 00 	lea    0xda5(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    125f:	b8 00 00 00 00       	mov    $0x0,%eax
    1264:	e8 47 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1269:	8b 7c 24 04          	mov    0x4(%rsp),%edi
    126d:	e8 37 ff ff ff       	callq  11a9 <sum>
    1272:	89 c2                	mov    %eax,%edx
    1274:	48 8d 35 a7 0d 00 00 	lea    0xda7(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    127b:	bf 01 00 00 00       	mov    $0x1,%edi
    1280:	b8 00 00 00 00       	mov    $0x0,%eax
    1285:	e8 16 fe ff ff       	callq  10a0 <__printf_chk@plt>
    128a:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    128f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1296:	00 00 
    1298:	75 0a                	jne    12a4 <main+0x7a>
