...
/app/bin_gccgcc10_O3/2021_03_06-Lesson:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    10ff:	48 c7 04 24 00 00 00 	movq   $0x0,(%rsp)
    1106:	00 
    1107:	e8 a4 ff ff ff       	callq  10b0 <putenv@plt>
    110c:	e8 af ff ff ff       	callq  10c0 <tzset@plt>
    1111:	48 89 e7             	mov    %rsp,%rdi
    1114:	e8 77 ff ff ff       	callq  1090 <ctime@plt>
    1119:	48 8d 35 eb 0e 00 00 	lea    0xeeb(%rip),%rsi        # 200b <_IO_stdin_used+0xb>
    1120:	bf 01 00 00 00       	mov    $0x1,%edi
    1125:	48 89 c2             	mov    %rax,%rdx
    ...
    113b:	00 00 
    113d:	75 07                	jne    1146 <main+0x66>
    113f:	31 c0                	xor    %eax,%eax
    1141:	48 83 c4 18          	add    $0x18,%rsp
    1145:	c3                   	retq   
    1146:	e8 55 ff ff ff       	callq  10a0 <__stack_chk_fail@plt>
