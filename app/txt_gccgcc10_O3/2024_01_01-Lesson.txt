...
/app/bin_gccgcc10_O3/2024_01_01-Lesson:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1068:	b9 0a 00 00 00       	mov    $0xa,%ecx
    ...
    1085:	b9 0a 00 00 00       	mov    $0xa,%ecx
    108a:	ba 05 00 00 00       	mov    $0x5,%edx
    108f:	31 c0                	xor    %eax,%eax
    1091:	48 8d 35 85 0f 00 00 	lea    0xf85(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    1098:	bf 01 00 00 00       	mov    $0x1,%edi
    109d:	e8 ae ff ff ff       	callq  1050 <__printf_chk@plt>
    10a2:	31 c0                	xor    %eax,%eax
    10a4:	48 83 c4 08          	add    $0x8,%rsp
    10a8:	c3                   	retq   
