...
/app/bin_gccgcc10_O2/2019_07_13-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10bf:	4c 8d 64 24 17       	lea    0x17(%rsp),%r12
    10c4:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    10c9:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    10ce:	4c 89 e7             	mov    %r12,%rdi
    10d1:	e8 aa ff ff ff       	callq  1080 <strtol@plt>
    10d6:	4c 89 e2             	mov    %r12,%rdx
    10d9:	bf 01 00 00 00       	mov    $0x1,%edi
    10de:	48 8d 35 1f 0f 00 00 	lea    0xf1f(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10e5:	48 89 c1             	mov    %rax,%rcx
    10e8:	31 c0                	xor    %eax,%eax
    10ea:	e8 a1 ff ff ff       	callq  1090 <__printf_chk@plt>
    10ef:	4c 39 64 24 08       	cmp    %r12,0x8(%rsp)
    10f4:	74 19                	je     110f <main+0x6f>
    10f6:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10fb:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1102:	00 00 
    1104:	75 21                	jne    1127 <main+0x87>
    1106:	48 83 c4 20          	add    $0x20,%rsp
    110a:	31 c0                	xor    %eax,%eax
    110c:	41 5c                	pop    %r12
    110e:	c3                   	retq   
    110f:	4c 89 e2             	mov    %r12,%rdx
    1112:	48 8d 35 07 0f 00 00 	lea    0xf07(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    1119:	bf 01 00 00 00       	mov    $0x1,%edi
    111e:	31 c0                	xor    %eax,%eax
    1120:	e8 6b ff ff ff       	callq  1090 <__printf_chk@plt>
    1125:	eb cf                	jmp    10f6 <main+0x56>
    1127:	e8 44 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
