...
/app/bin_gccgcc10_O0/2020_01_11-Lesson-a:     file format elf64-x86-64
...
00000000000010b0 <asprintf@plt>:
    10b0:	f3 0f 1e fa          	endbr64 
    10b4:	f2 ff 25 15 2f 00 00 	bnd jmpq *0x2f15(%rip)        # 3fd0 <asprintf@GLIBC_2.2.5>
...
00000000000011a9 <main>:
    ...
    11c8:	ba 0d 00 00 00       	mov    $0xd,%edx
    ...
    11dc:	e8 cf fe ff ff       	callq  10b0 <asprintf@plt>
    11e1:	89 45 ec             	mov    %eax,-0x14(%rbp)
    11e4:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    11e8:	48 89 c7             	mov    %rax,%rdi
    11eb:	e8 90 fe ff ff       	callq  1080 <puts@plt>
    11f0:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11f3:	89 c6                	mov    %eax,%esi
    11f5:	48 8d 3d 19 0e 00 00 	lea    0xe19(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    ...
    1216:	00 00 
    1218:	74 05                	je     121f <main+0x76>
    121a:	e8 71 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    121f:	c9                   	leaveq 
    1220:	c3                   	retq   
