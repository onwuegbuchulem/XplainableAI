...
/app/bin_gccgcc10_O0/Pointers:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 ec 16 00 00 00 	movl   $0x16,-0x14(%rbp)
    ...
    119e:	e8 cd fe ff ff       	callq  1070 <printf@plt>
    11a3:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11a6:	89 c6                	mov    %eax,%esi
    11a8:	48 8d 3d 67 0e 00 00 	lea    0xe67(%rip),%rdi        # 2016 <_IO_stdin_used+0x16>
    ...
    11e1:	48 8d 3d 3f 0e 00 00 	lea    0xe3f(%rip),%rdi        # 2027 <_IO_stdin_used+0x27>
    11e8:	b8 00 00 00 00       	mov    $0x0,%eax
    11ed:	e8 7e fe ff ff       	callq  1070 <printf@plt>
    11f2:	c7 45 ec 0b 00 00 00 	movl   $0xb,-0x14(%rbp)
    ...
    1219:	48 8d 3d 07 0e 00 00 	lea    0xe07(%rip),%rdi        # 2027 <_IO_stdin_used+0x27>
    1220:	b8 00 00 00 00       	mov    $0x0,%eax
    1225:	e8 46 fe ff ff       	callq  1070 <printf@plt>
    122a:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    122e:	c7 00 02 00 00 00    	movl   $0x2,(%rax)
    1234:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    ...
    1247:	e8 24 fe ff ff       	callq  1070 <printf@plt>
    124c:	8b 45 ec             	mov    -0x14(%rbp),%eax
    124f:	89 c6                	mov    %eax,%esi
    1251:	48 8d 3d be 0d 00 00 	lea    0xdbe(%rip),%rdi        # 2016 <_IO_stdin_used+0x16>
    ...
    1272:	00 00 
    1274:	74 05                	je     127b <main+0x112>
    1276:	e8 e5 fd ff ff       	callq  1060 <__stack_chk_fail@plt>
    127b:	c9                   	leaveq 
    127c:	c3                   	retq   
