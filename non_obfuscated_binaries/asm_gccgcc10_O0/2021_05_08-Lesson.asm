...
/app/bin_gccgcc10_O0/2021_05_08-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1188:	e8 e3 fe ff ff       	callq  1070 <printf@plt>
    118d:	83 7d fc 03          	cmpl   $0x3,-0x4(%rbp)
    1191:	74 30                	je     11c3 <main+0x5a>
    1193:	83 7d fc 03          	cmpl   $0x3,-0x4(%rbp)
    1197:	7f 38                	jg     11d1 <main+0x68>
    1199:	83 7d fc 01          	cmpl   $0x1,-0x4(%rbp)
    119d:	74 08                	je     11a7 <main+0x3e>
    119f:	83 7d fc 02          	cmpl   $0x2,-0x4(%rbp)
    11a3:	74 10                	je     11b5 <main+0x4c>
    11a5:	eb 2a                	jmp    11d1 <main+0x68>
    11a7:	48 8d 3d 5e 0e 00 00 	lea    0xe5e(%rip),%rdi        # 200c <_IO_stdin_used+0xc>
    11ae:	e8 ad fe ff ff       	callq  1060 <puts@plt>
    11b3:	eb 28                	jmp    11dd <main+0x74>
    11b5:	48 8d 3d 57 0e 00 00 	lea    0xe57(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    11bc:	e8 9f fe ff ff       	callq  1060 <puts@plt>
    11c1:	eb 1a                	jmp    11dd <main+0x74>
    11c3:	48 8d 3d 50 0e 00 00 	lea    0xe50(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    11ca:	e8 91 fe ff ff       	callq  1060 <puts@plt>
    11cf:	eb 0c                	jmp    11dd <main+0x74>
    11d1:	48 8d 3d 49 0e 00 00 	lea    0xe49(%rip),%rdi        # 2021 <_IO_stdin_used+0x21>
    11d8:	e8 83 fe ff ff       	callq  1060 <puts@plt>
