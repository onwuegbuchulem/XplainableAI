...
/app/bin_gccgcc10_O0/2023_06-Exercise:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11cd:	48 8d 3d 43 0e 00 00 	lea    0xe43(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    ...
    11e5:	48 8d 3d 28 0e 00 00 	lea    0xe28(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    11ec:	b8 00 00 00 00       	mov    $0x0,%eax
    11f1:	e8 9a fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f6:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11f9:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11fc:	89 c6                	mov    %eax,%esi
    11fe:	48 8d 3d 22 0e 00 00 	lea    0xe22(%rip),%rdi        # 2027 <_IO_stdin_used+0x27>
    1205:	b8 00 00 00 00       	mov    $0x0,%eax
    120a:	e8 71 fe ff ff       	callq  1080 <printf@plt>
    120f:	8b 55 f4             	mov    -0xc(%rbp),%edx
    1212:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1215:	01 d0                	add    %edx,%eax
    1217:	89 45 f4             	mov    %eax,-0xc(%rbp)
    121a:	8b 45 f4             	mov    -0xc(%rbp),%eax
    121d:	8b 55 f0             	mov    -0x10(%rbp),%edx
    1220:	29 d0                	sub    %edx,%eax
    1222:	89 45 f0             	mov    %eax,-0x10(%rbp)
    1225:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1228:	8b 55 f0             	mov    -0x10(%rbp),%edx
    122b:	29 d0                	sub    %edx,%eax
    122d:	89 45 f4             	mov    %eax,-0xc(%rbp)
    1230:	8b 55 f4             	mov    -0xc(%rbp),%edx
    1233:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1236:	89 c6                	mov    %eax,%esi
    1238:	48 8d 3d fc 0d 00 00 	lea    0xdfc(%rip),%rdi        # 203b <_IO_stdin_used+0x3b>
    123f:	b8 00 00 00 00       	mov    $0x0,%eax
    1244:	e8 37 fe ff ff       	callq  1080 <printf@plt>
    1249:	b8 00 00 00 00       	mov    $0x0,%eax
    124e:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1252:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1259:	00 00 
    125b:	74 05                	je     1262 <main+0xd9>
    125d:	e8 0e fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1262:	c9                   	leaveq 
    1263:	c3                   	retq   
