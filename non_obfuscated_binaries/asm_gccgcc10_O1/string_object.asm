...
/app/bin_gccgcc10_O1/string_object:     file format elf64-x86-64
...
0000000000001100 <_start>:
    ...
    1121:	48 8d 3d 38 01 00 00 	lea    0x138(%rip),%rdi        # 1260 <main>
...
00000000000011e9 <string_create>:
    ...
    11f2:	48 85 ff             	test   %rdi,%rdi
    11f5:	74 48                	je     123f <string_create+0x56>
    11f7:	55                   	push   %rbp
    11f8:	53                   	push   %rbx
    11f9:	48 83 ec 08          	sub    $0x8,%rsp
    11fd:	48 89 fb             	mov    %rdi,%rbx
    1200:	48 89 f5             	mov    %rsi,%rbp
    1203:	48 89 f7             	mov    %rsi,%rdi
    1206:	e8 b5 fe ff ff       	callq  10c0 <strlen@plt>
    120b:	89 43 08             	mov    %eax,0x8(%rbx)
    120e:	48 98                	cltq   
    1210:	48 8d 78 01          	lea    0x1(%rax),%rdi
    1214:	e8 c7 fe ff ff       	callq  10e0 <malloc@plt>
    1219:	48 89 c7             	mov    %rax,%rdi
    121c:	48 89 03             	mov    %rax,(%rbx)
    121f:	48 85 c0             	test   %rax,%rax
    1222:	74 14                	je     1238 <string_create+0x4f>
    1224:	48 89 ee             	mov    %rbp,%rsi
    1227:	e8 84 fe ff ff       	callq  10b0 <strcpy@plt>
    ...
    123d:	eb f2                	jmp    1231 <string_create+0x48>
    123f:	c3                   	retq   

0000000000001240 <string_destroy>:
    1240:	f3 0f 1e fa          	endbr64 
    1244:	53                   	push   %rbx
    1245:	48 89 fb             	mov    %rdi,%rbx
    1248:	48 8b 3f             	mov    (%rdi),%rdi
    124b:	e8 50 fe ff ff       	callq  10a0 <free@plt>
    1250:	48 c7 03 00 00 00 00 	movq   $0x0,(%rbx)
    1257:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%rbx)
    125e:	5b                   	pop    %rbx
    125f:	c3                   	retq   
...
0000000000001260 <main>:
    ...
    1270:	00 00 
    1272:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    1277:	31 c0                	xor    %eax,%eax
    1279:	48 89 e3             	mov    %rsp,%rbx
    127c:	48 8d 35 81 0d 00 00 	lea    0xd81(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1283:	48 89 df             	mov    %rbx,%rdi
    1286:	e8 5e ff ff ff       	callq  11e9 <string_create>
    128b:	8b 4c 24 08          	mov    0x8(%rsp),%ecx
    128f:	48 8b 14 24          	mov    (%rsp),%rdx
    1293:	48 8d 35 86 0d 00 00 	lea    0xd86(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    ...
    12ac:	e8 8f ff ff ff       	callq  1240 <string_destroy>
    12b1:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    12b6:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12bd:	00 00 
    12bf:	75 0b                	jne    12cc <main+0x6c>
    12c1:	b8 00 00 00 00       	mov    $0x0,%eax
    12c6:	48 83 c4 20          	add    $0x20,%rsp
    12ca:	5b                   	pop    %rbx
    12cb:	c3                   	retq   
    12cc:	e8 ff fd ff ff       	callq  10d0 <__stack_chk_fail@plt>
