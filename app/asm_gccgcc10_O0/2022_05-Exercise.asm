...
/app/bin_gccgcc10_O0/2022_05-Exercise:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 3d 5d 0e 00 00 	lea    0xe5d(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	e8 c3 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cd:	f3 0f 10 45 ec       	movss  -0x14(%rbp),%xmm0
    11d2:	f3 0f 2c c0          	cvttss2si %xmm0,%eax
    11d6:	89 45 f0             	mov    %eax,-0x10(%rbp)
    11d9:	f3 0f 10 45 ec       	movss  -0x14(%rbp),%xmm0
    11de:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11e2:	f3 0f 2a 4d f0       	cvtsi2ssl -0x10(%rbp),%xmm1
    11e7:	f3 0f 5c c1          	subss  %xmm1,%xmm0
    11eb:	f3 0f 11 45 f4       	movss  %xmm0,-0xc(%rbp)
    11f0:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11f4:	f3 0f 5a 45 f4       	cvtss2sd -0xc(%rbp),%xmm0
    11f9:	f3 0f 10 4d ec       	movss  -0x14(%rbp),%xmm1
    11fe:	66 0f ef d2          	pxor   %xmm2,%xmm2
    1202:	f3 0f 5a d1          	cvtss2sd %xmm1,%xmm2
    1206:	66 48 0f 7e d0       	movq   %xmm2,%rax
    120b:	8b 55 f0             	mov    -0x10(%rbp),%edx
    120e:	66 0f 28 c8          	movapd %xmm0,%xmm1
    1212:	89 d6                	mov    %edx,%esi
    1214:	66 48 0f 6e c0       	movq   %rax,%xmm0
    1219:	48 8d 3d 08 0e 00 00 	lea    0xe08(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    1220:	b8 02 00 00 00       	mov    $0x2,%eax
    1225:	e8 56 fe ff ff       	callq  1080 <printf@plt>
    122a:	b8 00 00 00 00       	mov    $0x0,%eax
    122f:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1233:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    123a:	00 00 
    123c:	74 05                	je     1243 <main+0xba>
    123e:	e8 2d fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1243:	c9                   	leaveq 
    1244:	c3                   	retq   
