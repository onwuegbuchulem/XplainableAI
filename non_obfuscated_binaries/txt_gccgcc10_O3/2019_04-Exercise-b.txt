...
/app/bin_gccgcc10_O3/2019_04-Exercise-b:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    106c:	53                   	push   %rbx
    106d:	bb 65 00 00 00       	mov    $0x65,%ebx
    1072:	48 83 ec 08          	sub    $0x8,%rsp
    1076:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    107d:	00 00 00 
    1080:	69 c3 8f 5e 19 db    	imul   $0xdb195e8f,%ebx,%eax
    1086:	3d 17 6a 4e 02       	cmp    $0x24e6a17,%eax
    108b:	77 11                	ja     109e <main+0x3e>
    108d:	89 da                	mov    %ebx,%edx
    108f:	48 89 ee             	mov    %rbp,%rsi
    ...
    10a1:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
    10a7:	75 d7                	jne    1080 <main+0x20>
    10a9:	48 83 c4 08          	add    $0x8,%rsp
    10ad:	31 c0                	xor    %eax,%eax
    10af:	5b                   	pop    %rbx
    10b0:	5d                   	pop    %rbp
    10b1:	c3                   	retq   
    10b2:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10b9:	00 00 00 
