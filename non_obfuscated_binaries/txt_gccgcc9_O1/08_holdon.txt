...
/app/bin_gccgcc9_O1/08_holdon:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11d8:	e8 d3 fe ff ff       	callq  10b0 <time@plt>
    11dd:	48 89 c7             	mov    %rax,%rdi
    11e0:	e8 ab fe ff ff       	callq  1090 <srand@plt>
    11e5:	bb 0c 00 00 00       	mov    $0xc,%ebx
    11ea:	48 8d 2d 13 0e 00 00 	lea    0xe13(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    11f1:	e8 da fe ff ff       	callq  10d0 <rand@plt>
    11f6:	89 c2                	mov    %eax,%edx
    11f8:	48 98                	cltq   
    11fa:	48 69 c0 1f 85 eb 51 	imul   $0x51eb851f,%rax,%rax
    1201:	48 c1 f8 25          	sar    $0x25,%rax
    1205:	89 d1                	mov    %edx,%ecx
    1207:	c1 f9 1f             	sar    $0x1f,%ecx
    120a:	29 c8                	sub    %ecx,%eax
    120c:	6b c0 64             	imul   $0x64,%eax,%eax
    120f:	29 c2                	sub    %eax,%edx
    1211:	48 89 ee             	mov    %rbp,%rsi
    1214:	bf 01 00 00 00       	mov    $0x1,%edi
    1219:	b8 00 00 00 00       	mov    $0x0,%eax
    121e:	e8 9d fe ff ff       	callq  10c0 <__printf_chk@plt>
    1223:	83 eb 01             	sub    $0x1,%ebx
    1226:	75 c9                	jne    11f1 <main+0x28>
    1228:	48 8b 35 e1 2d 00 00 	mov    0x2de1(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    122f:	bf 0a 00 00 00       	mov    $0xa,%edi
    1234:	e8 67 fe ff ff       	callq  10a0 <putc@plt>
