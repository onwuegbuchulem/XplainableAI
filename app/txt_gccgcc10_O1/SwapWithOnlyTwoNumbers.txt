...
/app/bin_gccgcc10_O1/SwapWithOnlyTwoNumbers:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b5:	48 8d 3d 52 0e 00 00 	lea    0xe52(%rip),%rdi        # 200e <_IO_stdin_used+0xe>
    11bc:	b8 00 00 00 00       	mov    $0x0,%eax
    11c1:	e8 ca fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c6:	48 8d 35 44 0e 00 00 	lea    0xe44(%rip),%rsi        # 2011 <_IO_stdin_used+0x11>
    ...
    11e1:	48 8d 3d 26 0e 00 00 	lea    0xe26(%rip),%rdi        # 200e <_IO_stdin_used+0xe>
    11e8:	b8 00 00 00 00       	mov    $0x0,%eax
    11ed:	e8 9e fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f2:	8b 0c 24             	mov    (%rsp),%ecx
    11f5:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11f9:	89 4c 24 04          	mov    %ecx,0x4(%rsp)
    11fd:	89 14 24             	mov    %edx,(%rsp)
    1200:	48 8d 35 19 0e 00 00 	lea    0xe19(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
