...
/app/bin_gccgcc10_O0/2020_09_01-Exercise-skeleton:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d cf 00 00 00 	lea    0xcf(%rip),%rdi        # 1157 <main>
...
0000000000001157 <main>:
    ...
    115f:	48 83 ec 10          	sub    $0x10,%rsp
    1163:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
    116a:	eb 16                	jmp    1182 <main+0x2b>
    116c:	8b 45 fc             	mov    -0x4(%rbp),%eax
    116f:	89 c7                	mov    %eax,%edi
    1171:	e8 d3 ff ff ff       	callq  1149 <verbal>
    1176:	48 89 c7             	mov    %rax,%rdi
    1179:	e8 d2 fe ff ff       	callq  1050 <puts@plt>
    117e:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    1182:	83 7d fc 64          	cmpl   $0x64,-0x4(%rbp)
    1186:	7e e4                	jle    116c <main+0x15>
