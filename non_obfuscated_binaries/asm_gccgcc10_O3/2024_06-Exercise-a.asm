...
/app/bin_gccgcc10_O3/2024_06-Exercise-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e2:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    10e6:	31 c0                	xor    %eax,%eax
    10e8:	48 8d 35 2e 0f 00 00 	lea    0xf2e(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    10ef:	bf 01 00 00 00       	mov    $0x1,%edi
    10f4:	44 8d 04 0a          	lea    (%rdx,%rcx,1),%r8d
    10f8:	e8 83 ff ff ff       	callq  1080 <__printf_chk@plt>
