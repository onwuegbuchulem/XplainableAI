...
/app/bin_gccgcc10_O2/2022_03_26-Lesson:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10b3:	e8 c8 ff ff ff       	callq  1080 <popen@plt>
    10b8:	48 85 c0             	test   %rax,%rax
    10bb:	74 28                	je     10e5 <main+0x45>
    10bd:	48 89 c5             	mov    %rax,%rbp
    10c0:	48 89 c1             	mov    %rax,%rcx
    10c3:	ba 14 00 00 00       	mov    $0x14,%edx
    10c8:	be 01 00 00 00       	mov    $0x1,%esi
    10cd:	48 8d 3d 4a 0f 00 00 	lea    0xf4a(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    10d4:	e8 b7 ff ff ff       	callq  1090 <fwrite@plt>
    10d9:	48 89 ef             	mov    %rbp,%rdi
    10dc:	e8 8f ff ff ff       	callq  1070 <pclose@plt>
    10e1:	31 c0                	xor    %eax,%eax
    10e3:	5d                   	pop    %rbp
    10e4:	c3                   	retq   
    10e5:	48 8b 0d 34 2f 00 00 	mov    0x2f34(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    10ec:	ba 14 00 00 00       	mov    $0x14,%edx
    10f1:	be 01 00 00 00       	mov    $0x1,%esi
    10f6:	48 8d 3d 0c 0f 00 00 	lea    0xf0c(%rip),%rdi        # 2009 <_IO_stdin_used+0x9>
    10fd:	e8 8e ff ff ff       	callq  1090 <fwrite@plt>
