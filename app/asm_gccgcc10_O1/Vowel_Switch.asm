...
/app/bin_gccgcc10_O1/Vowel_Switch:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11cd:	0f be d0             	movsbl %al,%edx
    11d0:	83 e8 41             	sub    $0x41,%eax
    11d3:	3c 34                	cmp    $0x34,%al
    11d5:	77 44                	ja     121b <main+0x92>
    11d7:	0f b6 c0             	movzbl %al,%eax
    11da:	48 8d 0d 63 0e 00 00 	lea    0xe63(%rip),%rcx        # 2044 <_IO_stdin_used+0x44>
    11e1:	48 63 04 81          	movslq (%rcx,%rax,4),%rax
    11e5:	48 01 c8             	add    %rcx,%rax
    11e8:	3e ff e0             	notrack jmpq *%rax
    11eb:	48 8d 35 29 0e 00 00 	lea    0xe29(%rip),%rsi        # 201b <_IO_stdin_used+0x1b>
    11f2:	bf 01 00 00 00       	mov    $0x1,%edi
    11f7:	b8 00 00 00 00       	mov    $0x0,%eax
    11fc:	e8 7f fe ff ff       	callq  1080 <__printf_chk@plt>
    1201:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1206:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    120d:	00 00 
    120f:	75 22                	jne    1233 <main+0xaa>
    1211:	b8 00 00 00 00       	mov    $0x0,%eax
    1216:	48 83 c4 18          	add    $0x18,%rsp
    121a:	c3                   	retq   
    121b:	48 8d 35 0a 0e 00 00 	lea    0xe0a(%rip),%rsi        # 202c <_IO_stdin_used+0x2c>
    1222:	bf 01 00 00 00       	mov    $0x1,%edi
    1227:	b8 00 00 00 00       	mov    $0x0,%eax
    122c:	e8 4f fe ff ff       	callq  1080 <__printf_chk@plt>
    1231:	eb ce                	jmp    1201 <main+0x78>
