...
/app/bin_gccgcc10_O3/2020_08_22-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108c:	48 8d 2d 7c 0f 00 00 	lea    0xf7c(%rip),%rbp        # 200f <_IO_stdin_used+0xf>
    1093:	53                   	push   %rbx
    ...
    10aa:	b9 ff ff ff ff       	mov    $0xffffffff,%ecx
    10af:	48 89 ee             	mov    %rbp,%rsi
    10b2:	bf 01 00 00 00       	mov    $0x1,%edi
    10b7:	31 c0                	xor    %eax,%eax
    10b9:	48 83 c3 01          	add    $0x1,%rbx
    10bd:	e8 ae ff ff ff       	callq  1070 <__printf_chk@plt>
    10c2:	48 83 fb 0b          	cmp    $0xb,%rbx
    10c6:	75 e0                	jne    10a8 <main+0x28>
