...
/app/bin_gccgcc10_O1/2022_08-Exercise-d:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1178:	00 00 
    117a:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    117f:	31 c0                	xor    %eax,%eax
    1181:	48 89 e2             	mov    %rsp,%rdx
    1184:	b8 41 00 00 00       	mov    $0x41,%eax
    1189:	88 02                	mov    %al,(%rdx)
    118b:	83 c0 01             	add    $0x1,%eax
    118e:	48 83 c2 02          	add    $0x2,%rdx
    1192:	3c 5b                	cmp    $0x5b,%al
    1194:	75 f3                	jne    1189 <main+0x20>
    1196:	48 8d 54 24 01       	lea    0x1(%rsp),%rdx
    119b:	b8 61 00 00 00       	mov    $0x61,%eax
    11a0:	88 02                	mov    %al,(%rdx)
    11a2:	83 c0 01             	add    $0x1,%eax
    11a5:	48 83 c2 02          	add    $0x2,%rdx
    11a9:	3c 7b                	cmp    $0x7b,%al
    11ab:	75 f3                	jne    11a0 <main+0x37>
    11ad:	c6 44 24 34 00       	movb   $0x0,0x34(%rsp)
    11b2:	48 89 e7             	mov    %rsp,%rdi
    11b5:	e8 a6 fe ff ff       	callq  1060 <puts@plt>
    11ba:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    11bf:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11c6:	00 00 
    11c8:	75 0a                	jne    11d4 <main+0x6b>
    11ca:	b8 00 00 00 00       	mov    $0x0,%eax
    11cf:	48 83 c4 48          	add    $0x48,%rsp
    11d3:	c3                   	retq   
    11d4:	e8 97 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
