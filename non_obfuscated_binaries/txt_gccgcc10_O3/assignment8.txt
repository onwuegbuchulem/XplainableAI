...
/app/bin_gccgcc10_O3/assignment8:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ce:	48 8d 3d 4d 10 00 00 	lea    0x104d(%rip),%rdi        # 2122 <_IO_stdin_used+0x122>
    ...
    10e3:	76 6f                	jbe    1154 <main+0xb4>
    10e5:	8d 50 9b             	lea    -0x65(%rax),%edx
    10e8:	83 fa 63             	cmp    $0x63,%edx
    10eb:	76 3d                	jbe    112a <main+0x8a>
    10ed:	8d 90 37 ff ff ff    	lea    -0xc9(%rax),%edx
    10f3:	83 fa 63             	cmp    $0x63,%edx
    10f6:	0f 86 82 00 00 00    	jbe    117e <main+0xde>
    10fc:	8d 90 d3 fe ff ff    	lea    -0x12d(%rax),%edx
    1102:	83 fa 63             	cmp    $0x63,%edx
    1105:	0f 86 88 00 00 00    	jbe    1193 <main+0xf3>
    110b:	2d 91 01 00 00       	sub    $0x191,%eax
    1110:	83 f8 63             	cmp    $0x63,%eax
    1113:	77 54                	ja     1169 <main+0xc9>
    1115:	48 8d 35 b4 0f 00 00 	lea    0xfb4(%rip),%rsi        # 20d0 <_IO_stdin_used+0xd0>
    111c:	bf 01 00 00 00       	mov    $0x1,%edi
    1121:	31 c0                	xor    %eax,%eax
    1123:	e8 58 ff ff ff       	callq  1080 <__printf_chk@plt>
    1128:	eb 13                	jmp    113d <main+0x9d>
    112a:	48 8d 35 27 0f 00 00 	lea    0xf27(%rip),%rsi        # 2058 <_IO_stdin_used+0x58>
    1131:	bf 01 00 00 00       	mov    $0x1,%edi
    1136:	31 c0                	xor    %eax,%eax
    1138:	e8 43 ff ff ff       	callq  1080 <__printf_chk@plt>
    113d:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1142:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1149:	00 00 
    114b:	75 5b                	jne    11a8 <main+0x108>
    114d:	31 c0                	xor    %eax,%eax
    114f:	48 83 c4 18          	add    $0x18,%rsp
    1153:	c3                   	retq   
    1154:	48 8d 35 d5 0e 00 00 	lea    0xed5(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    115b:	bf 01 00 00 00       	mov    $0x1,%edi
    1160:	31 c0                	xor    %eax,%eax
    1162:	e8 19 ff ff ff       	callq  1080 <__printf_chk@plt>
    1167:	eb d4                	jmp    113d <main+0x9d>
    1169:	48 8d 35 88 0f 00 00 	lea    0xf88(%rip),%rsi        # 20f8 <_IO_stdin_used+0xf8>
    1170:	bf 01 00 00 00       	mov    $0x1,%edi
    1175:	31 c0                	xor    %eax,%eax
    1177:	e8 04 ff ff ff       	callq  1080 <__printf_chk@plt>
    117c:	eb bf                	jmp    113d <main+0x9d>
    117e:	48 8d 35 fb 0e 00 00 	lea    0xefb(%rip),%rsi        # 2080 <_IO_stdin_used+0x80>
    1185:	bf 01 00 00 00       	mov    $0x1,%edi
    118a:	31 c0                	xor    %eax,%eax
    118c:	e8 ef fe ff ff       	callq  1080 <__printf_chk@plt>
    1191:	eb aa                	jmp    113d <main+0x9d>
    1193:	48 8d 35 0e 0f 00 00 	lea    0xf0e(%rip),%rsi        # 20a8 <_IO_stdin_used+0xa8>
    119a:	bf 01 00 00 00       	mov    $0x1,%edi
    119f:	31 c0                	xor    %eax,%eax
    11a1:	e8 da fe ff ff       	callq  1080 <__printf_chk@plt>
    11a6:	eb 95                	jmp    113d <main+0x9d>
