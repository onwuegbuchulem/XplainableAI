...
/app/bin_gccgcc10_O3/getdate03:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10d4:	c7 44 24 14 7a 00 00 	movl   $0x7a,0x14(%rsp)
    10db:	00 
    10dc:	66 48 0f 6e c8       	movq   %rax,%xmm1
    10e1:	48 8d 05 23 0f 00 00 	lea    0xf23(%rip),%rax        # 200b <_IO_stdin_used+0xb>
    10e8:	66 48 0f 6e d0       	movq   %rax,%xmm2
    10ed:	66 0f 6f c1          	movdqa %xmm1,%xmm0
    10f1:	48 8d 05 22 0f 00 00 	lea    0xf22(%rip),%rax        # 201a <_IO_stdin_used+0x1a>
    10f8:	66 0f 6c c2          	punpcklqdq %xmm2,%xmm0
    10fc:	66 48 0f 6e d8       	movq   %rax,%xmm3
    1101:	48 8d 05 25 0f 00 00 	lea    0xf25(%rip),%rax        # 202d <_IO_stdin_used+0x2d>
    1108:	0f 29 44 24 40       	movaps %xmm0,0x40(%rsp)
    110d:	66 48 0f 6e c1       	movq   %rcx,%xmm0
    1112:	66 48 0f 6e e0       	movq   %rax,%xmm4
    1117:	48 8d 05 16 0f 00 00 	lea    0xf16(%rip),%rax        # 2034 <_IO_stdin_used+0x34>
    111e:	66 0f 6c c3          	punpcklqdq %xmm3,%xmm0
    1122:	0f 29 44 24 50       	movaps %xmm0,0x50(%rsp)
    1127:	66 48 0f 6e c6       	movq   %rsi,%xmm0
    112c:	66 0f 6c c4          	punpcklqdq %xmm4,%xmm0
    1130:	0f 29 44 24 60       	movaps %xmm0,0x60(%rsp)
    1135:	66 48 0f 6e c0       	movq   %rax,%xmm0
    113a:	48 8b 05 17 0f 00 00 	mov    0xf17(%rip),%rax        # 2058 <_IO_stdin_used+0x58>
    1141:	66 0f 6c c1          	punpcklqdq %xmm1,%xmm0
    1145:	48 89 44 24 0c       	mov    %rax,0xc(%rsp)
    114a:	0f 29 44 24 70       	movaps %xmm0,0x70(%rsp)
    114f:	e8 2c ff ff ff       	callq  1080 <mktime@plt>
    1154:	48 63 44 24 18       	movslq 0x18(%rsp),%rax
    1159:	8b 54 24 10          	mov    0x10(%rsp),%edx
    115d:	48 8d 35 d9 0e 00 00 	lea    0xed9(%rip),%rsi        # 203d <_IO_stdin_used+0x3d>
    1164:	8b 4c 24 0c          	mov    0xc(%rsp),%ecx
    1168:	bf 01 00 00 00       	mov    $0x1,%edi
    116d:	4c 8b 4c c4 40       	mov    0x40(%rsp,%rax,8),%r9
    1172:	8b 44 24 14          	mov    0x14(%rsp),%eax
    1176:	83 c2 01             	add    $0x1,%edx
    1179:	44 8d 80 6c 07 00 00 	lea    0x76c(%rax),%r8d
    1180:	31 c0                	xor    %eax,%eax
    1182:	e8 09 ff ff ff       	callq  1090 <__printf_chk@plt>
    1187:	48 8b 84 24 88 00 00 	mov    0x88(%rsp),%rax
    118e:	00 
    118f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1196:	00 00 
    1198:	75 0a                	jne    11a4 <main+0x104>
    119a:	31 c0                	xor    %eax,%eax
    119c:	48 81 c4 98 00 00 00 	add    $0x98,%rsp
    11a3:	c3                   	retq   
    11a4:	e8 c7 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
