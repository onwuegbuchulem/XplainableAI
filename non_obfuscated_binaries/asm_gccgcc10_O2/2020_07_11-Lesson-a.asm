...
/app/bin_gccgcc10_O2/2020_07_11-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <gettimeofday@plt>:
    ...
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <gettimeofday@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10af:	00 00 
    10b1:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    10b6:	31 c0                	xor    %eax,%eax
    10b8:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    10bd:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
    10c2:	e8 b9 ff ff ff       	callq  1080 <gettimeofday@plt>
    10c7:	48 8b 54 24 10       	mov    0x10(%rsp),%rdx
    10cc:	48 8d 35 31 0f 00 00 	lea    0xf31(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10d3:	31 c0                	xor    %eax,%eax
    10d5:	bf 01 00 00 00       	mov    $0x1,%edi
    10da:	e8 b1 ff ff ff       	callq  1090 <__printf_chk@plt>
    10df:	48 8b 54 24 18       	mov    0x18(%rsp),%rdx
    10e4:	48 8d 35 36 0f 00 00 	lea    0xf36(%rip),%rsi        # 2021 <_IO_stdin_used+0x21>
    10eb:	31 c0                	xor    %eax,%eax
    10ed:	bf 01 00 00 00       	mov    $0x1,%edi
    10f2:	e8 99 ff ff ff       	callq  1090 <__printf_chk@plt>
    10f7:	8b 54 24 08          	mov    0x8(%rsp),%edx
    10fb:	bf 01 00 00 00       	mov    $0x1,%edi
    1100:	31 c0                	xor    %eax,%eax
    1102:	48 8d 35 2f 0f 00 00 	lea    0xf2f(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    1109:	e8 82 ff ff ff       	callq  1090 <__printf_chk@plt>
    110e:	8b 54 24 0c          	mov    0xc(%rsp),%edx
    1112:	31 c0                	xor    %eax,%eax
    1114:	bf 01 00 00 00       	mov    $0x1,%edi
    1119:	48 8d 35 38 0f 00 00 	lea    0xf38(%rip),%rsi        # 2058 <_IO_stdin_used+0x58>
    1120:	e8 6b ff ff ff       	callq  1090 <__printf_chk@plt>
    1125:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    112a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1131:	00 00 
    1133:	75 07                	jne    113c <main+0x9c>
    1135:	31 c0                	xor    %eax,%eax
    1137:	48 83 c4 38          	add    $0x38,%rsp
    113b:	c3                   	retq   
    113c:	e8 2f ff ff ff       	callq  1070 <__stack_chk_fail@plt>
