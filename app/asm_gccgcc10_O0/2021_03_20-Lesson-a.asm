...
/app/bin_gccgcc10_O0/2021_03_20-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	48 8b 15 65 0e 00 00 	mov    0xe65(%rip),%rdx        # 2010 <_IO_stdin_used+0x10>
    11ab:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    11af:	66 48 0f 6e c2       	movq   %rdx,%xmm0
    11b4:	48 8d 15 4d 0e 00 00 	lea    0xe4d(%rip),%rdx        # 2008 <_IO_stdin_used+0x8>
    11bb:	be 20 00 00 00       	mov    $0x20,%esi
    11c0:	48 89 c7             	mov    %rax,%rdi
    11c3:	b8 01 00 00 00       	mov    $0x1,%eax
    11c8:	e8 c3 fe ff ff       	callq  1090 <strfmon@plt>
    ...
    11e2:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11e9:	00 00 
    11eb:	74 05                	je     11f2 <main+0x69>
    11ed:	e8 8e fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    11f2:	c9                   	leaveq 
    11f3:	c3                   	retq   
