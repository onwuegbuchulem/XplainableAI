...
/app/bin_gccgcc10_O0/2019_03_23-Lesson:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117c:	bf 06 00 00 00       	mov    $0x6,%edi
    1181:	e8 ea fe ff ff       	callq  1070 <setlocale@plt>
    1186:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    118a:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    118e:	48 89 c6             	mov    %rax,%rsi
    1191:	48 8d 3d 6d 0e 00 00 	lea    0xe6d(%rip),%rdi        # 2005 <_IO_stdin_used+0x5>
    1198:	b8 00 00 00 00       	mov    $0x0,%eax
    119d:	e8 be fe ff ff       	callq  1060 <printf@plt>
