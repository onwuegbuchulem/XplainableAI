...
/app/bin_gccgcc10_O2/max_heap:     file format elf64-x86-64
...
0000000000001470 <push>:
    ...
    14b9:	48 8b 33             	mov    (%rbx),%rsi
    14bc:	48 63 d2             	movslq %edx,%rdx
    14bf:	8b 3c 96             	mov    (%rsi,%rdx,4),%edi
    14c2:	eb 1e                	jmp    14e2 <push+0x72>
    14c4:	0f 1f 40 00          	nopl   0x0(%rax)
    14c8:	41 89 10             	mov    %edx,(%r8)
    14cb:	8d 51 ff             	lea    -0x1(%rcx),%edx
    14ce:	89 38                	mov    %edi,(%rax)
    ...
    14e5:	4c 8d 04 96          	lea    (%rsi,%rdx,4),%r8
    14e9:	48 8d 04 86          	lea    (%rsi,%rax,4),%rax
    14ed:	8b 10                	mov    (%rax),%edx
    14ef:	39 fa                	cmp    %edi,%edx
