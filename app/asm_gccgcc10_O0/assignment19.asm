...
/app/bin_gccgcc10_O0/assignment19:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1195:	bf 0a 00 00 00       	mov    $0xa,%edi
    119a:	e8 f1 fe ff ff       	callq  1090 <malloc@plt>
    119f:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11a3:	48 83 7d f8 00       	cmpq   $0x0,-0x8(%rbp)
    11a8:	75 18                	jne    11c2 <main+0x39>
    11aa:	48 8d 3d 57 0e 00 00 	lea    0xe57(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11b1:	b8 00 00 00 00       	mov    $0x0,%eax
    11b6:	e8 c5 fe ff ff       	callq  1080 <printf@plt>
    11bb:	b8 01 00 00 00       	mov    $0x1,%eax
    11c0:	eb 22                	jmp    11e4 <main+0x5b>
    11c2:	48 8d 3d 5f 0e 00 00 	lea    0xe5f(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    ...
    11da:	e8 91 fe ff ff       	callq  1070 <free@plt>
