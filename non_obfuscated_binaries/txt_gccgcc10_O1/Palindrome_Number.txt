...
/app/bin_gccgcc10_O1/Palindrome_Number:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b3:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11b8:	48 8d 3d 58 0e 00 00 	lea    0xe58(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    11bf:	b8 00 00 00 00       	mov    $0x0,%eax
    11c4:	e8 c7 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c9:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11cd:	85 d2                	test   %edx,%edx
    11cf:	74 7e                	je     124f <main+0xc6>
    11d1:	bb 00 00 00 00       	mov    $0x0,%ebx
    11d6:	8d 34 9b             	lea    (%rbx,%rbx,4),%esi
    11d9:	48 63 c2             	movslq %edx,%rax
    ...
    11ec:	29 c8                	sub    %ecx,%eax
    11ee:	8d 0c 80             	lea    (%rax,%rax,4),%ecx
    11f1:	01 c9                	add    %ecx,%ecx
    11f3:	29 ca                	sub    %ecx,%edx
    11f5:	8d 1c 72             	lea    (%rdx,%rsi,2),%ebx
    11f8:	89 c2                	mov    %eax,%edx
    11fa:	85 c0                	test   %eax,%eax
    11fc:	75 d8                	jne    11d6 <main+0x4d>
    11fe:	89 da                	mov    %ebx,%edx
    1200:	48 8d 35 13 0e 00 00 	lea    0xe13(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    1207:	bf 01 00 00 00       	mov    $0x1,%edi
    120c:	b8 00 00 00 00       	mov    $0x0,%eax
    1211:	e8 6a fe ff ff       	callq  1080 <__printf_chk@plt>
    1216:	8b 54 24 04          	mov    0x4(%rsp),%edx
    121a:	39 da                	cmp    %ebx,%edx
    121c:	74 35                	je     1253 <main+0xca>
    121e:	48 8d 35 2b 0e 00 00 	lea    0xe2b(%rip),%rsi        # 2050 <_IO_stdin_used+0x50>
    1225:	bf 01 00 00 00       	mov    $0x1,%edi
    122a:	b8 00 00 00 00       	mov    $0x0,%eax
    122f:	e8 4c fe ff ff       	callq  1080 <__printf_chk@plt>
    1234:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1239:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1240:	00 00 
    1242:	75 29                	jne    126d <main+0xe4>
    1244:	b8 00 00 00 00       	mov    $0x0,%eax
    1249:	48 83 c4 10          	add    $0x10,%rsp
    124d:	5b                   	pop    %rbx
    124e:	c3                   	retq   
    124f:	89 d3                	mov    %edx,%ebx
    1251:	eb ab                	jmp    11fe <main+0x75>
    1253:	89 da                	mov    %ebx,%edx
    1255:	48 8d 35 d3 0d 00 00 	lea    0xdd3(%rip),%rsi        # 202f <_IO_stdin_used+0x2f>
    125c:	bf 01 00 00 00       	mov    $0x1,%edi
    1261:	b8 00 00 00 00       	mov    $0x0,%eax
    1266:	e8 15 fe ff ff       	callq  1080 <__printf_chk@plt>
    126b:	eb c7                	jmp    1234 <main+0xab>
