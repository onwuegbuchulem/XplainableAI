...
/app/bin_gccgcc10_O1/2022_07_09-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1199:	00 00 
    119b:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    11a0:	31 c0                	xor    %eax,%eax
    11a2:	48 8d 5c 24 10       	lea    0x10(%rsp),%rbx
    11a7:	48 89 1c 24          	mov    %rbx,(%rsp)
    11ab:	48 c7 44 24 08 20 00 	movq   $0x20,0x8(%rsp)
    11b2:	00 00 
    ...
    11c5:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    11ca:	48 89 e7             	mov    %rsp,%rdi
    11cd:	48 8b 15 3c 2e 00 00 	mov    0x2e3c(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    11d4:	e8 b7 fe ff ff       	callq  1090 <getline@plt>
    11d9:	48 89 c2             	mov    %rax,%rdx
    11dc:	48 8d 35 32 0e 00 00 	lea    0xe32(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    11e3:	bf 01 00 00 00       	mov    $0x1,%edi
    11e8:	b8 00 00 00 00       	mov    $0x0,%eax
    11ed:	e8 8e fe ff ff       	callq  1080 <__printf_chk@plt>
    11f2:	48 89 da             	mov    %rbx,%rdx
    11f5:	48 8d 35 34 0e 00 00 	lea    0xe34(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    11fc:	bf 01 00 00 00       	mov    $0x1,%edi
    1201:	b8 00 00 00 00       	mov    $0x0,%eax
    1206:	e8 75 fe ff ff       	callq  1080 <__printf_chk@plt>
    120b:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1210:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1217:	00 00 
    1219:	75 0b                	jne    1226 <main+0x9d>
    121b:	b8 00 00 00 00       	mov    $0x0,%eax
    1220:	48 83 c4 40          	add    $0x40,%rsp
    1224:	5b                   	pop    %rbx
    1225:	c3                   	retq   
