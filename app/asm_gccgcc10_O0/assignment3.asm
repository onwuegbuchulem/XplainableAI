...
/app/bin_gccgcc10_O0/assignment3:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11cd:	48 8d 3d 4b 0e 00 00 	lea    0xe4b(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    ...
    11e5:	48 8d 3d 30 0e 00 00 	lea    0xe30(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    11ec:	b8 00 00 00 00       	mov    $0x0,%eax
    11f1:	e8 9a fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f6:	48 8d 55 e0          	lea    -0x20(%rbp),%rdx
    11fa:	48 8d 45 c0          	lea    -0x40(%rbp),%rax
    11fe:	48 89 c6             	mov    %rax,%rsi
    1201:	48 8d 3d 2e 0e 00 00 	lea    0xe2e(%rip),%rdi        # 2036 <_IO_stdin_used+0x36>
