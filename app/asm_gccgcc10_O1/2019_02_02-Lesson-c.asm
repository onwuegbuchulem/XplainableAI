...
/app/bin_gccgcc10_O1/2019_02_02-Lesson-c:     file format elf64-x86-64
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d f0 00 00 00 	lea    0xf0(%rip),%rdi        # 11d8 <main>
...
00000000000011a9 <change>:
    ...
    11ad:	c6 47 01 69          	movb   $0x69,0x1(%rdi)
    11b1:	c3                   	retq   

00000000000011b2 <output>:
    11b2:	f3 0f 1e fa          	endbr64 
    11b6:	48 83 ec 08          	sub    $0x8,%rsp
    11ba:	48 89 fa             	mov    %rdi,%rdx
    ...
    11ce:	e8 cd fe ff ff       	callq  10a0 <__printf_chk@plt>
    11d3:	48 83 c4 08          	add    $0x8,%rsp
    11d7:	c3                   	retq   

00000000000011d8 <main>:
    11d8:	f3 0f 1e fa          	endbr64 
    11dc:	53                   	push   %rbx
    11dd:	bf 04 00 00 00       	mov    $0x4,%edi
    11e2:	e8 a9 fe ff ff       	callq  1090 <malloc@plt>
    11e7:	48 85 c0             	test   %rax,%rax
    11ea:	74 24                	je     1210 <main+0x38>
    11ec:	48 89 c3             	mov    %rax,%rbx
    11ef:	c7 00 66 61 74 00    	movl   $0x746166,(%rax)
    11f5:	48 89 c7             	mov    %rax,%rdi
    11f8:	e8 b5 ff ff ff       	callq  11b2 <output>
    11fd:	c6 43 01 69          	movb   $0x69,0x1(%rbx)
    1201:	48 89 df             	mov    %rbx,%rdi
    1204:	e8 a9 ff ff ff       	callq  11b2 <output>
    ...
    1221:	e8 8a fe ff ff       	callq  10b0 <exit@plt>
