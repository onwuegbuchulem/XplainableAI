...
/app/bin_gccgcc10_O1/strlower:     file format elf64-x86-64
...
0000000000001169 <strlower>:
    1169:	f3 0f 1e fa          	endbr64 
    116d:	0f b6 07             	movzbl (%rdi),%eax
    1170:	84 c0                	test   %al,%al
    1172:	75 0c                	jne    1180 <strlower+0x17>
    1174:	c3                   	retq   
    1175:	48 83 c7 01          	add    $0x1,%rdi
    1179:	0f b6 07             	movzbl (%rdi),%eax
    117c:	84 c0                	test   %al,%al
    117e:	74 f4                	je     1174 <strlower+0xb>
    1180:	8d 50 bf             	lea    -0x41(%rax),%edx
    1183:	80 fa 19             	cmp    $0x19,%dl
    1186:	77 ed                	ja     1175 <strlower+0xc>
    1188:	83 c0 20             	add    $0x20,%eax
    118b:	88 07                	mov    %al,(%rdi)
    118d:	eb e6                	jmp    1175 <strlower+0xc>
...
000000000000118f <main>:
    ...
    11a8:	48 b8 52 61 6e 64 6f 	movabs $0x53206d6f646e6152,%rax
    11af:	6d 20 53 
    11b2:	48 ba 54 52 49 4e 47 	movabs $0x617320474e495254,%rdx
    11b9:	20 73 61 
    11bc:	48 89 04 24          	mov    %rax,(%rsp)
    11c0:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    11c5:	48 b8 6d 70 6c 65 20 	movabs $0x33323120656c706d,%rax
    11cc:	31 32 33 
    11cf:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11d4:	c7 44 24 18 40 23 24 	movl   $0x242340,0x18(%rsp)
    11db:	00 
    11dc:	48 89 e3             	mov    %rsp,%rbx
    ...
    11fb:	e8 69 ff ff ff       	callq  1169 <strlower>
    1200:	48 89 da             	mov    %rbx,%rdx
    1203:	48 8d 35 0f 0e 00 00 	lea    0xe0f(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    120a:	bf 01 00 00 00       	mov    $0x1,%edi
    120f:	b8 00 00 00 00       	mov    $0x0,%eax
    1214:	e8 57 fe ff ff       	callq  1070 <__printf_chk@plt>
    1219:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    121e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1225:	00 00 
    1227:	75 0b                	jne    1234 <main+0xa5>
    1229:	b8 00 00 00 00       	mov    $0x0,%eax
    122e:	48 83 c4 30          	add    $0x30,%rsp
    1232:	5b                   	pop    %rbx
    1233:	c3                   	retq   
