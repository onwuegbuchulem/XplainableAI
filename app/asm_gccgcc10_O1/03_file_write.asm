...
/app/bin_gccgcc10_O1/03_file_write:     file format elf64-x86-64
...
0000000000001070 <fclose@plt>:
    ...
    1074:	f2 ff 25 45 2f 00 00 	bnd jmpq *0x2f45(%rip)        # 3fc0 <fclose@GLIBC_2.2.5>
    107b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

0000000000001080 <fopen@plt>:
    1080:	f3 0f 1e fa          	endbr64 
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <fopen@GLIBC_2.2.5>
...
0000000000001189 <main>:
    ...
    119c:	e8 df fe ff ff       	callq  1080 <fopen@plt>
    11a1:	48 89 c3             	mov    %rax,%rbx
    11a4:	b9 b0 01 00 00       	mov    $0x1b0,%ecx
    11a9:	48 8d 15 60 0e 00 00 	lea    0xe60(%rip),%rdx        # 2010 <_IO_stdin_used+0x10>
    11b0:	be 01 00 00 00       	mov    $0x1,%esi
    11b5:	48 89 c7             	mov    %rax,%rdi
    11b8:	b8 00 00 00 00       	mov    $0x0,%eax
    11bd:	e8 ce fe ff ff       	callq  1090 <__fprintf_chk@plt>
    11c2:	48 89 df             	mov    %rbx,%rdi
    11c5:	e8 a6 fe ff ff       	callq  1070 <fclose@plt>
