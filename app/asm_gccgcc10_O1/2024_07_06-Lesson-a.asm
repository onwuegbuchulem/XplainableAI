...
/app/bin_gccgcc10_O1/2024_07_06-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	53                   	push   %rbx
    118e:	bb 14 00 00 00       	mov    $0x14,%ebx
    1193:	48 8b 35 76 2e 00 00 	mov    0x2e76(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    119a:	bf 58 00 00 00       	mov    $0x58,%edi
    119f:	e8 cc fe ff ff       	callq  1070 <putc@plt>
    11a4:	83 eb 01             	sub    $0x1,%ebx
    11a7:	75 ea                	jne    1193 <main+0xa>
    11a9:	48 8b 3d 60 2e 00 00 	mov    0x2e60(%rip),%rdi        # 4010 <stdout@@GLIBC_2.2.5>
    11b0:	e8 cb fe ff ff       	callq  1080 <fflush@plt>
    11b5:	bf 01 00 00 00       	mov    $0x1,%edi
    11ba:	e8 d1 fe ff ff       	callq  1090 <sleep@plt>
    11bf:	bb 14 00 00 00       	mov    $0x14,%ebx
    11c4:	48 8b 35 45 2e 00 00 	mov    0x2e45(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11cb:	bf 08 00 00 00       	mov    $0x8,%edi
    11d0:	e8 9b fe ff ff       	callq  1070 <putc@plt>
    11d5:	83 eb 01             	sub    $0x1,%ebx
    11d8:	75 ea                	jne    11c4 <main+0x3b>
    11da:	48 8b 35 2f 2e 00 00 	mov    0x2e2f(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11e1:	bf 0a 00 00 00       	mov    $0xa,%edi
