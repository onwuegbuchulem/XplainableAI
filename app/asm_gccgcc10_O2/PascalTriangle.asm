...
/app/bin_gccgcc10_O2/PascalTriangle:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10d1:	55                   	push   %rbp
    10d2:	53                   	push   %rbx
    10d3:	48 83 ec 10          	sub    $0x10,%rsp
    10d7:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10de:	00 00 
    10e0:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10e5:	31 c0                	xor    %eax,%eax
    10e7:	48 89 e6             	mov    %rsp,%rsi
    10ea:	e8 c1 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10ef:	48 83 3c 24 00       	cmpq   $0x0,(%rsp)
    10f4:	0f 8e b1 00 00 00    	jle    11ab <main+0xeb>
    10fa:	31 db                	xor    %ebx,%ebx
    10fc:	4c 8d 2d 06 0f 00 00 	lea    0xf06(%rip),%r13        # 2009 <_IO_stdin_used+0x9>
    1103:	48 8d 2d 02 0f 00 00 	lea    0xf02(%rip),%rbp        # 200c <_IO_stdin_used+0xc>
    110a:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1110:	bf 0a 00 00 00       	mov    $0xa,%edi
    1115:	e8 66 ff ff ff       	callq  1080 <putchar@plt>
    111a:	48 89 d8             	mov    %rbx,%rax
    111d:	48 f7 d0             	not    %rax
    1120:	48 03 04 24          	add    (%rsp),%rax
    1124:	48 85 c0             	test   %rax,%rax
    1127:	7e 29                	jle    1152 <main+0x92>
    1129:	45 31 e4             	xor    %r12d,%r12d
    112c:	0f 1f 40 00          	nopl   0x0(%rax)
    1130:	4c 89 ee             	mov    %r13,%rsi
    1133:	bf 01 00 00 00       	mov    $0x1,%edi
    1138:	31 c0                	xor    %eax,%eax
    113a:	49 83 c4 01          	add    $0x1,%r12
    113e:	e8 5d ff ff ff       	callq  10a0 <__printf_chk@plt>
    1143:	48 89 d8             	mov    %rbx,%rax
    1146:	48 f7 d0             	not    %rax
    1149:	48 03 04 24          	add    (%rsp),%rax
    114d:	4c 39 e0             	cmp    %r12,%rax
    1150:	7f de                	jg     1130 <main+0x70>
    1152:	45 31 f6             	xor    %r14d,%r14d
    1155:	41 bc 01 00 00 00    	mov    $0x1,%r12d
    115b:	eb 1b                	jmp    1178 <main+0xb8>
    115d:	0f 1f 00             	nopl   (%rax)
    1160:	48 89 d8             	mov    %rbx,%rax
    1163:	4c 29 f0             	sub    %r14,%rax
    1166:	49 89 ce             	mov    %rcx,%r14
    1169:	4c 0f af e0          	imul   %rax,%r12
    116d:	4c 89 e0             	mov    %r12,%rax
    1170:	48 99                	cqto   
    1172:	48 f7 f9             	idiv   %rcx
    1175:	49 89 c4             	mov    %rax,%r12
    1178:	4c 89 e2             	mov    %r12,%rdx
    ...
    118a:	49 8d 4e 01          	lea    0x1(%r14),%rcx
    118e:	48 39 d9             	cmp    %rbx,%rcx
    1191:	7e cd                	jle    1160 <main+0xa0>
    1193:	bf 0a 00 00 00       	mov    $0xa,%edi
    1198:	48 83 c3 01          	add    $0x1,%rbx
    119c:	e8 df fe ff ff       	callq  1080 <putchar@plt>
    11a1:	48 39 1c 24          	cmp    %rbx,(%rsp)
    11a5:	0f 8f 65 ff ff ff    	jg     1110 <main+0x50>
