...
/app/bin_gccgcc10_O1/2019_01_05-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ac:	e8 bf fe ff ff       	callq  1070 <ctime@plt>
    11b1:	48 89 c2             	mov    %rax,%rdx
    ...
    11c5:	e8 c6 fe ff ff       	callq  1090 <__printf_chk@plt>
    11ca:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11cf:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11d6:	00 00 
    11d8:	75 0a                	jne    11e4 <main+0x5b>
    11da:	b8 00 00 00 00       	mov    $0x0,%eax
    11df:	48 83 c4 18          	add    $0x18,%rsp
    11e3:	c3                   	retq   
    11e4:	e8 97 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
