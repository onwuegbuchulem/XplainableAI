...
/app/bin_gccgcc10_O3/cyrillic:     file format elf64-x86-64
...
00000000000010e0 <main>:
    ...
    10ec:	48 8d 3d 13 0f 00 00 	lea    0xf13(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    10f3:	53                   	push   %rbx
    10f4:	bb 10 04 00 00       	mov    $0x410,%ebx
    10f9:	48 83 ec 08          	sub    $0x8,%rsp
    10fd:	e8 be ff ff ff       	callq  10c0 <fopen@plt>
    1102:	48 8d 35 0b 0f 00 00 	lea    0xf0b(%rip),%rsi        # 2014 <_IO_stdin_used+0x14>
    1109:	31 ff                	xor    %edi,%edi
    110b:	48 89 c5             	mov    %rax,%rbp
    110e:	e8 9d ff ff ff       	callq  10b0 <setlocale@plt>
    1113:	48 8d 35 06 0f 00 00 	lea    0xf06(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    111a:	bf 01 00 00 00       	mov    $0x1,%edi
    111f:	31 c0                	xor    %eax,%eax
    1121:	e8 aa ff ff ff       	callq  10d0 <__wprintf_chk@plt>
    1126:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    112d:	00 00 00 
    1130:	89 df                	mov    %ebx,%edi
    1132:	48 89 ee             	mov    %rbp,%rsi
    1135:	e8 66 ff ff ff       	callq  10a0 <fputwc@plt>
    113a:	48 8b 35 cf 2e 00 00 	mov    0x2ecf(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1141:	89 df                	mov    %ebx,%edi
    1143:	83 c3 01             	add    $0x1,%ebx
    1146:	e8 55 ff ff ff       	callq  10a0 <fputwc@plt>
    114b:	81 fb 30 04 00 00    	cmp    $0x430,%ebx
    1151:	75 dd                	jne    1130 <main+0x50>
    1153:	48 89 ee             	mov    %rbp,%rsi
    1156:	31 ff                	xor    %edi,%edi
    1158:	e8 43 ff ff ff       	callq  10a0 <fputwc@plt>
    115d:	48 89 ef             	mov    %rbp,%rdi
    1160:	e8 2b ff ff ff       	callq  1090 <fclose@plt>
    1165:	48 8d 35 3c 0f 00 00 	lea    0xf3c(%rip),%rsi        # 20a8 <_IO_stdin_used+0xa8>
    116c:	bf 01 00 00 00       	mov    $0x1,%edi
    1171:	31 c0                	xor    %eax,%eax
    1173:	e8 58 ff ff ff       	callq  10d0 <__wprintf_chk@plt>
