...
/app/bin_gccgcc10_O2/2021_10_23-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10b1:	66 89 54 24 30       	mov    %dx,0x30(%rsp)
    10b6:	48 89 e2             	mov    %rsp,%rdx
    10b9:	0f 11 04 24          	movups %xmm0,(%rsp)
    10bd:	66 0f 6f 05 5b 0f 00 	movdqa 0xf5b(%rip),%xmm0        # 2020 <_IO_stdin_used+0x20>
    10c4:	00 
    10c5:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10ca:	66 0f 6f 05 5e 0f 00 	movdqa 0xf5e(%rip),%xmm0        # 2030 <_IO_stdin_used+0x30>
    10d1:	00 
    10d2:	0f 11 44 24 20       	movups %xmm0,0x20(%rsp)
    10d7:	e8 94 ff ff ff       	callq  1070 <__printf_chk@plt>
    10dc:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    10e1:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10e8:	00 00 
    10ea:	75 07                	jne    10f3 <main+0x73>
    10ec:	31 c0                	xor    %eax,%eax
    10ee:	48 83 c4 48          	add    $0x48,%rsp
    10f2:	c3                   	retq   
