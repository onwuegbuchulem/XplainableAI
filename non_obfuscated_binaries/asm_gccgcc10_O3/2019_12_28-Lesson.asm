...
/app/bin_gccgcc10_O3/2019_12_28-Lesson:     file format elf64-x86-64
...
00000000000012e0 <strlcat>:
    ...
    12fd:	48 98                	cltq   
    12ff:	80 3e 00             	cmpb   $0x0,(%rsi)
    1302:	74 1a                	je     131e <strlcat+0x3e>
    ...
    131c:	48 98                	cltq   
    131e:	48 29 d6             	sub    %rdx,%rsi
    1321:	49 83 e8 01          	sub    $0x1,%r8
    1325:	eb 15                	jmp    133c <strlcat+0x5c>
