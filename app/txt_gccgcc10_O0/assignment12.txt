...
/app/bin_gccgcc10_O0/assignment12:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    1204:	c7 45 ec 01 00 00 00 	movl   $0x1,-0x14(%rbp)
    120b:	c7 45 f0 02 00 00 00 	movl   $0x2,-0x10(%rbp)
    1212:	bf 00 00 00 00       	mov    $0x0,%edi
    1217:	e8 b4 fe ff ff       	callq  10d0 <time@plt>
    121c:	89 c7                	mov    %eax,%edi
    121e:	e8 9d fe ff ff       	callq  10c0 <srand@plt>
    1223:	48 8d 3d de 0d 00 00 	lea    0xdde(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    122a:	b8 00 00 00 00       	mov    $0x0,%eax
    122f:	e8 7c fe ff ff       	callq  10b0 <printf@plt>
    1234:	48 8d 45 dc          	lea    -0x24(%rbp),%rax
    1238:	48 89 c6             	mov    %rax,%rsi
    123b:	48 8d 3d f7 0d 00 00 	lea    0xdf7(%rip),%rdi        # 2039 <_IO_stdin_used+0x39>
    1242:	b8 00 00 00 00       	mov    $0x0,%eax
    1247:	e8 94 fe ff ff       	callq  10e0 <__isoc99_scanf@plt>
    124c:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%rbp)
    1253:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%rbp)
    125a:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%rbp)
    1261:	eb 33                	jmp    1296 <main+0xad>
    1263:	e8 88 fe ff ff       	callq  10f0 <rand@plt>
    1268:	8b 55 f0             	mov    -0x10(%rbp),%edx
    126b:	2b 55 ec             	sub    -0x14(%rbp),%edx
    126e:	8d 4a 01             	lea    0x1(%rdx),%ecx
    1271:	99                   	cltd   
    1272:	f7 f9                	idiv   %ecx
    1274:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1277:	01 d0                	add    %edx,%eax
    1279:	89 45 f4             	mov    %eax,-0xc(%rbp)
    127c:	83 7d f4 01          	cmpl   $0x1,-0xc(%rbp)
    1280:	75 06                	jne    1288 <main+0x9f>
    1282:	83 45 e4 01          	addl   $0x1,-0x1c(%rbp)
    1286:	eb 0a                	jmp    1292 <main+0xa9>
    1288:	83 7d f4 02          	cmpl   $0x2,-0xc(%rbp)
    128c:	75 04                	jne    1292 <main+0xa9>
    128e:	83 45 e8 01          	addl   $0x1,-0x18(%rbp)
    1292:	83 45 e0 01          	addl   $0x1,-0x20(%rbp)
    1296:	8b 45 dc             	mov    -0x24(%rbp),%eax
    1299:	39 45 e0             	cmp    %eax,-0x20(%rbp)
    129c:	7c c5                	jl     1263 <main+0x7a>
    129e:	8b 45 dc             	mov    -0x24(%rbp),%eax
    12a1:	8b 4d e8             	mov    -0x18(%rbp),%ecx
    12a4:	8b 55 e4             	mov    -0x1c(%rbp),%edx
    12a7:	89 c6                	mov    %eax,%esi
    12a9:	48 8d 3d 90 0d 00 00 	lea    0xd90(%rip),%rdi        # 2040 <_IO_stdin_used+0x40>
    12b0:	b8 00 00 00 00       	mov    $0x0,%eax
    12b5:	e8 f6 fd ff ff       	callq  10b0 <printf@plt>
    12ba:	90                   	nop
    12bb:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    12bf:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12c6:	00 00 
    12c8:	74 05                	je     12cf <main+0xe6>
    12ca:	e8 d1 fd ff ff       	callq  10a0 <__stack_chk_fail@plt>
    12cf:	c9                   	leaveq 
    12d0:	c3                   	retq   
