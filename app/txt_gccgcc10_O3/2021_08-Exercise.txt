...
/app/bin_gccgcc10_O3/2021_08-Exercise:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 54                	push   %r12
    1086:	48 8d 3d 7b 0f 00 00 	lea    0xf7b(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    108d:	55                   	push   %rbp
    108e:	48 8d 2d d4 0f 00 00 	lea    0xfd4(%rip),%rbp        # 2069 <_IO_stdin_used+0x69>
    1095:	53                   	push   %rbx
    1096:	31 db                	xor    %ebx,%ebx
    1098:	e8 c3 ff ff ff       	callq  1060 <puts@plt>
    109d:	0f 1f 00             	nopl   (%rax)
    10a0:	44 8d 63 40          	lea    0x40(%rbx),%r12d
    10a4:	41 89 d8             	mov    %ebx,%r8d
    10a7:	89 d9                	mov    %ebx,%ecx
    10a9:	89 da                	mov    %ebx,%edx
    10ab:	45 89 e1             	mov    %r12d,%r9d
    10ae:	48 8d 35 9e 0f 00 00 	lea    0xf9e(%rip),%rsi        # 2053 <_IO_stdin_used+0x53>
    10b5:	bf 01 00 00 00       	mov    $0x1,%edi
    10ba:	31 c0                	xor    %eax,%eax
    10bc:	e8 af ff ff ff       	callq  1070 <__printf_chk@plt>
    10c1:	8d 53 20             	lea    0x20(%rbx),%edx
    10c4:	48 89 ee             	mov    %rbp,%rsi
    10c7:	bf 01 00 00 00       	mov    $0x1,%edi
    10cc:	41 89 d1             	mov    %edx,%r9d
    10cf:	41 89 d0             	mov    %edx,%r8d
    10d2:	89 d1                	mov    %edx,%ecx
    10d4:	31 c0                	xor    %eax,%eax
    10d6:	e8 95 ff ff ff       	callq  1070 <__printf_chk@plt>
    10db:	45 89 e1             	mov    %r12d,%r9d
    10de:	45 89 e0             	mov    %r12d,%r8d
    10e1:	44 89 e1             	mov    %r12d,%ecx
    10e4:	44 89 e2             	mov    %r12d,%edx
    10e7:	48 89 ee             	mov    %rbp,%rsi
    10ea:	bf 01 00 00 00       	mov    $0x1,%edi
    10ef:	31 c0                	xor    %eax,%eax
    10f1:	e8 7a ff ff ff       	callq  1070 <__printf_chk@plt>
    10f6:	8d 53 60             	lea    0x60(%rbx),%edx
    10f9:	bf 01 00 00 00       	mov    $0x1,%edi
    10fe:	31 c0                	xor    %eax,%eax
    1100:	41 89 d1             	mov    %edx,%r9d
    1103:	41 89 d0             	mov    %edx,%r8d
    1106:	89 d1                	mov    %edx,%ecx
    1108:	83 c3 01             	add    $0x1,%ebx
    110b:	48 8d 35 6c 0f 00 00 	lea    0xf6c(%rip),%rsi        # 207e <_IO_stdin_used+0x7e>
    1112:	e8 59 ff ff ff       	callq  1070 <__printf_chk@plt>
    1117:	83 fb 20             	cmp    $0x20,%ebx
    111a:	75 84                	jne    10a0 <main+0x20>
    111c:	5b                   	pop    %rbx
    111d:	31 c0                	xor    %eax,%eax
    111f:	5d                   	pop    %rbp
    1120:	41 5c                	pop    %r12
    1122:	c3                   	retq   
    1123:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    112a:	00 00 00 
