...
/app/bin_gccgcc10_O2/trimming:     file format elf64-x86-64
...
0000000000001100 <main>:
    ...
    118f:	e8 cc 02 00 00       	callq  1460 <mid>
...
0000000000001200 <_start>:
    ...
    1211:	50                   	push   %rax
    1212:	54                   	push   %rsp
    1213:	4c 8d 05 36 03 00 00 	lea    0x336(%rip),%r8        # 1550 <__libc_csu_fini>
    121a:	48 8d 0d bf 02 00 00 	lea    0x2bf(%rip),%rcx        # 14e0 <__libc_csu_init>
...
00000000000013b0 <right>:
    ...
    1423:	41 5c                	pop    %r12
    1425:	c3                   	retq   
    1426:	48 8b 0d f3 2b 00 00 	mov    0x2bf3(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    142d:	ba 18 00 00 00       	mov    $0x18,%edx
    1432:	be 01 00 00 00       	mov    $0x1,%esi
    1437:	48 8d 3d c6 0b 00 00 	lea    0xbc6(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    143e:	e8 ad fc ff ff       	callq  10f0 <fwrite@plt>
    1443:	bf 01 00 00 00       	mov    $0x1,%edi
    1448:	e8 93 fc ff ff       	callq  10e0 <exit@plt>
    144d:	bf 01 00 00 00       	mov    $0x1,%edi
    1452:	e8 89 fc ff ff       	callq  10e0 <exit@plt>
    1457:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    145e:	00 00 

0000000000001460 <mid>:
    1460:	f3 0f 1e fa          	endbr64 
    1464:	41 54                	push   %r12
    1466:	4c 63 e6             	movslq %esi,%r12
    1469:	55                   	push   %rbp
    146a:	53                   	push   %rbx
    146b:	48 89 fb             	mov    %rdi,%rbx
    146e:	48 63 fa             	movslq %edx,%rdi
    1471:	48 89 fd             	mov    %rdi,%rbp
    1474:	48 83 c7 01          	add    $0x1,%rdi
    1478:	e8 43 fc ff ff       	callq  10c0 <malloc@plt>
    147d:	48 85 c0             	test   %rax,%rax
    1480:	74 57                	je     14d9 <mid+0x79>
    1482:	49 89 c0             	mov    %rax,%r8
    1485:	85 ed                	test   %ebp,%ebp
    1487:	7e 31                	jle    14ba <mid+0x5a>
    1489:	8d 7d 01             	lea    0x1(%rbp),%edi
    148c:	ba 01 00 00 00       	mov    $0x1,%edx
    1491:	4a 8d 34 23          	lea    (%rbx,%r12,1),%rsi
    1495:	eb 18                	jmp    14af <mid+0x4f>
    1497:	66 0f 1f 84 00 00 00 	nopw   0x0(%rax,%rax,1)
    149e:	00 00 
    14a0:	89 d1                	mov    %edx,%ecx
    14a2:	48 83 c2 01          	add    $0x1,%rdx
    14a6:	48 83 c0 01          	add    $0x1,%rax
    14aa:	48 39 d7             	cmp    %rdx,%rdi
    14ad:	74 19                	je     14c8 <mid+0x68>
    14af:	0f b6 4c 16 fe       	movzbl -0x2(%rsi,%rdx,1),%ecx
    14b4:	88 08                	mov    %cl,(%rax)
    14b6:	84 c9                	test   %cl,%cl
    14b8:	75 e6                	jne    14a0 <mid+0x40>
    14ba:	c6 00 00             	movb   $0x0,(%rax)
    14bd:	4c 89 c0             	mov    %r8,%rax
    14c0:	5b                   	pop    %rbx
    14c1:	5d                   	pop    %rbp
    14c2:	41 5c                	pop    %r12
    14c4:	c3                   	retq   
    14c5:	0f 1f 00             	nopl   (%rax)
    14c8:	48 63 c1             	movslq %ecx,%rax
    14cb:	4c 01 c0             	add    %r8,%rax
    14ce:	c6 00 00             	movb   $0x0,(%rax)
    14d1:	4c 89 c0             	mov    %r8,%rax
    14d4:	5b                   	pop    %rbx
    14d5:	5d                   	pop    %rbp
    14d6:	41 5c                	pop    %r12
    14d8:	c3                   	retq   
    14d9:	e8 12 fe ff ff       	callq  12f0 <left.part.0>
