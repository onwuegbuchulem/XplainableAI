...
/app/bin_gccgcc10_O2/LinearCongruentialGenerator:     file format elf64-x86-64
...
00000000000011c0 <new_generator>:
    ...
    11c4:	41 55                	push   %r13
    11c6:	41 89 f5             	mov    %esi,%r13d
    11c9:	41 54                	push   %r12
    11cb:	49 89 fc             	mov    %rdi,%r12
    11ce:	31 ff                	xor    %edi,%edi
    11d0:	55                   	push   %rbp
    11d1:	89 d5                	mov    %edx,%ebp
    11d3:	53                   	push   %rbx
    11d4:	89 cb                	mov    %ecx,%ebx
    11d6:	48 83 ec 08          	sub    $0x8,%rsp
    11da:	e8 81 fe ff ff       	callq  1060 <time@plt>
    11df:	45 89 2c 24          	mov    %r13d,(%r12)
    11e3:	41 89 6c 24 04       	mov    %ebp,0x4(%r12)
    11e8:	41 89 5c 24 08       	mov    %ebx,0x8(%r12)
    11ed:	41 89 44 24 0c       	mov    %eax,0xc(%r12)
    11f2:	41 89 44 24 10       	mov    %eax,0x10(%r12)
    11f7:	48 83 c4 08          	add    $0x8,%rsp
    11fb:	4c 89 e0             	mov    %r12,%rax
    11fe:	5b                   	pop    %rbx
    11ff:	5d                   	pop    %rbp
    1200:	41 5c                	pop    %r12
    1202:	41 5d                	pop    %r13
