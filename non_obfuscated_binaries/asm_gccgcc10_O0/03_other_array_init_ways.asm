...
/app/bin_gccgcc10_O0/03_other_array_init_ways:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 ec 09 00 00 00 	movl   $0x9,-0x14(%rbp)
    118b:	c7 45 f0 08 00 00 00 	movl   $0x8,-0x10(%rbp)
    1192:	c7 45 f4 08 00 00 00 	movl   $0x8,-0xc(%rbp)
    1199:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%rbp)
    11a0:	eb 23                	jmp    11c5 <main+0x5c>
    11a2:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11a5:	48 98                	cltq   
    11a7:	8b 54 85 ec          	mov    -0x14(%rbp,%rax,4),%edx
    11ab:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11ae:	89 c6                	mov    %eax,%esi
    11b0:	48 8d 3d 51 0e 00 00 	lea    0xe51(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11b7:	b8 00 00 00 00       	mov    $0x0,%eax
    11bc:	e8 af fe ff ff       	callq  1070 <printf@plt>
    11c1:	83 45 e8 01          	addl   $0x1,-0x18(%rbp)
    11c5:	83 7d e8 02          	cmpl   $0x2,-0x18(%rbp)
    11c9:	7e d7                	jle    11a2 <main+0x39>
    11cb:	b8 00 00 00 00       	mov    $0x0,%eax
    11d0:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11d4:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11db:	00 00 
    11dd:	74 05                	je     11e4 <main+0x7b>
    11df:	e8 7c fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    11e4:	c9                   	leaveq 
    11e5:	c3                   	retq   
