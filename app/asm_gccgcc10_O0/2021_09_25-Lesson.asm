...
/app/bin_gccgcc10_O0/2021_09_25-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    119c:	e8 cf fe ff ff       	callq  1070 <puts@plt>
    11a1:	c7 45 fc 01 00 00 00 	movl   $0x1,-0x4(%rbp)
    11a8:	eb 27                	jmp    11d1 <main+0x48>
    11aa:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11ad:	89 c7                	mov    %eax,%edi
    11af:	e8 dc fe ff ff       	callq  1090 <strerror@plt>
    ...
    11d1:	8b 05 d9 2b 00 00    	mov    0x2bd9(%rip),%eax        # 3db0 <sys_nerr@@GLIBC_2.12>
    11d7:	39 45 fc             	cmp    %eax,-0x4(%rbp)
    11da:	7c ce                	jl     11aa <main+0x21>
