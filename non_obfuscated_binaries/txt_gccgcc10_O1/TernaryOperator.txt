...
/app/bin_gccgcc10_O1/TernaryOperator:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11ed:	f3 0f 10 4c 24 0c    	movss  0xc(%rsp),%xmm1
    11f3:	f3 0f 10 44 24 10    	movss  0x10(%rsp),%xmm0
    11f9:	0f 2f c8             	comiss %xmm0,%xmm1
    11fc:	76 3d                	jbe    123b <main+0x92>
    11fe:	f3 0f 5f 4c 24 14    	maxss  0x14(%rsp),%xmm1
    1204:	0f 28 c1             	movaps %xmm1,%xmm0
    1207:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    120b:	48 8d 35 0d 0e 00 00 	lea    0xe0d(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    ...
    122d:	00 00 
    122f:	75 12                	jne    1243 <main+0x9a>
    1231:	b8 00 00 00 00       	mov    $0x0,%eax
    1236:	48 83 c4 28          	add    $0x28,%rsp
    123a:	c3                   	retq   
    123b:	f3 0f 5f 44 24 14    	maxss  0x14(%rsp),%xmm0
    1241:	eb c4                	jmp    1207 <main+0x5e>
    1243:	e8 48 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
