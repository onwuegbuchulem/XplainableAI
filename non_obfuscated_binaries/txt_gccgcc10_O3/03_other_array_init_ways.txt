...
/app/bin_gccgcc10_O3/03_other_array_init_ways:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 54                	push   %r12
    1086:	55                   	push   %rbp
    1087:	48 8d 2d 7a 0f 00 00 	lea    0xf7a(%rip),%rbp        # 2008 <_IO_stdin_used+0x8>
    108e:	53                   	push   %rbx
    ...
    10a5:	48 8b 05 84 0f 00 00 	mov    0xf84(%rip),%rax        # 2030 <_IO_stdin_used+0x30>
    10ac:	c7 44 24 10 08 00 00 	movl   $0x8,0x10(%rsp)
    10b3:	00 
    10b4:	4c 8d 64 24 08       	lea    0x8(%rsp),%r12
    10b9:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10be:	41 8b 0c 9c          	mov    (%r12,%rbx,4),%ecx
    10c2:	89 da                	mov    %ebx,%edx
    10c4:	48 89 ee             	mov    %rbp,%rsi
    10c7:	bf 01 00 00 00       	mov    $0x1,%edi
    10cc:	31 c0                	xor    %eax,%eax
    10ce:	48 83 c3 01          	add    $0x1,%rbx
    10d2:	e8 99 ff ff ff       	callq  1070 <__printf_chk@plt>
    10d7:	48 83 fb 03          	cmp    $0x3,%rbx
    10db:	75 e1                	jne    10be <main+0x3e>
    10dd:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10e2:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10e9:	00 00 
    10eb:	75 0b                	jne    10f8 <main+0x78>
    10ed:	48 83 c4 20          	add    $0x20,%rsp
    10f1:	31 c0                	xor    %eax,%eax
    10f3:	5b                   	pop    %rbx
    10f4:	5d                   	pop    %rbp
    10f5:	41 5c                	pop    %r12
    10f7:	c3                   	retq   
    10f8:	e8 63 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
