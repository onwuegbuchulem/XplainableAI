...
/app/bin_gccgcc10_O2/03_struct_arrays:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	ba 64 00 00 00       	mov    $0x64,%edx
    ...
    10a8:	48 b8 64 00 00 00 a4 	movabs $0x428e70a400000064,%rax
    10af:	70 8e 42 
    10b2:	48 8d 4c 24 08       	lea    0x8(%rsp),%rcx
    10b7:	48 8d 35 46 0f 00 00 	lea    0xf46(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10be:	48 89 04 24          	mov    %rax,(%rsp)
    10c2:	48 b8 68 61 72 72 79 	movabs $0x7972726168,%rax
    10c9:	00 00 00 
    10cc:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10d1:	31 c0                	xor    %eax,%eax
    10d3:	66 89 44 24 10       	mov    %ax,0x10(%rsp)
