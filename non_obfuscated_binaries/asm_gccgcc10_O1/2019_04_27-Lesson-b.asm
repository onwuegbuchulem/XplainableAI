...
/app/bin_gccgcc10_O1/2019_04_27-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1182:	41 bc 00 00 00 00    	mov    $0x0,%r12d
    1188:	bb 00 00 00 00       	mov    $0x0,%ebx
    118d:	eb 13                	jmp    11a2 <main+0x39>
    118f:	44 39 e3             	cmp    %r12d,%ebx
    1192:	7e 06                	jle    119a <main+0x31>
    1194:	41 89 ed             	mov    %ebp,%r13d
    1197:	41 89 dc             	mov    %ebx,%r12d
    119a:	83 c5 01             	add    $0x1,%ebp
    119d:	bb 00 00 00 00       	mov    $0x0,%ebx
    11a2:	48 8b 3d 67 2e 00 00 	mov    0x2e67(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    11a9:	e8 c2 fe ff ff       	callq  1070 <getc@plt>
    11ae:	83 f8 ff             	cmp    $0xffffffff,%eax
    11b1:	74 0a                	je     11bd <main+0x54>
    11b3:	83 f8 0a             	cmp    $0xa,%eax
    11b6:	74 d7                	je     118f <main+0x26>
    11b8:	83 c3 01             	add    $0x1,%ebx
    11bb:	eb e5                	jmp    11a2 <main+0x39>
    11bd:	44 89 e1             	mov    %r12d,%ecx
    11c0:	44 89 ea             	mov    %r13d,%edx
    ...
    11d4:	e8 87 fe ff ff       	callq  1060 <__printf_chk@plt>
