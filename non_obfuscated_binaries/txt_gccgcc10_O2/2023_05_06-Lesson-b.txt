...
/app/bin_gccgcc10_O2/2023_05_06-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ae:	53                   	push   %rbx
    10af:	bb 14 00 00 00       	mov    $0x14,%ebx
    10b4:	48 83 ec 20          	sub    $0x20,%rsp
    ...
    10d0:	31 ff                	xor    %edi,%edi
    10d2:	4c 89 e6             	mov    %r12,%rsi
    10d5:	e8 96 ff ff ff       	callq  1070 <clock_gettime@plt>
    10da:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    ...
    10ee:	83 eb 01             	sub    $0x1,%ebx
    10f1:	75 dd                	jne    10d0 <main+0x30>
    10f3:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10f8:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10ff:	00 00 
    1101:	75 0b                	jne    110e <main+0x6e>
    ...
    110b:	41 5c                	pop    %r12
    110d:	c3                   	retq   
    110e:	e8 6d ff ff ff       	callq  1080 <__stack_chk_fail@plt>
