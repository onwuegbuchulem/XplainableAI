...
/app/bin_gccgcc10_O1/is_armstrong:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b7:	48 8d 3d 55 0e 00 00 	lea    0xe55(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    ...
    11fc:	0f af d0             	imul   %eax,%edx
    11ff:	0f af c2             	imul   %edx,%eax
    1202:	01 c7                	add    %eax,%edi
    1204:	89 f2                	mov    %esi,%edx
    1206:	85 f6                	test   %esi,%esi
    1208:	75 d0                	jne    11da <main+0x51>
    120a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%rsp)
    1211:	00 
    1212:	41 39 f8             	cmp    %edi,%r8d
    1215:	74 33                	je     124a <main+0xc1>
    1217:	44 89 c2             	mov    %r8d,%edx
    121a:	48 8d 35 17 0e 00 00 	lea    0xe17(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    ...
    1263:	eb cb                	jmp    1230 <main+0xa7>
    1265:	e8 06 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
