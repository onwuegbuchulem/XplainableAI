...
/app/bin_gccgcc10_O1/2022_02-Exercise:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b7:	48 8d 3d 5e 0e 00 00 	lea    0xe5e(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	8b 4c 24 04          	mov    0x4(%rsp),%ecx
    11cc:	48 63 d1             	movslq %ecx,%rdx
    11cf:	48 69 d2 c5 b3 a2 91 	imul   $0xffffffff91a2b3c5,%rdx,%rdx
    11d6:	48 c1 ea 20          	shr    $0x20,%rdx
    11da:	01 ca                	add    %ecx,%edx
    11dc:	c1 fa 0b             	sar    $0xb,%edx
    11df:	89 c8                	mov    %ecx,%eax
    11e1:	c1 f8 1f             	sar    $0x1f,%eax
    11e4:	29 c2                	sub    %eax,%edx
    11e6:	69 c2 f0 f1 ff ff    	imul   $0xfffff1f0,%edx,%eax
    11ec:	01 c8                	add    %ecx,%eax
    11ee:	48 63 c8             	movslq %eax,%rcx
    11f1:	48 69 c9 89 88 88 88 	imul   $0xffffffff88888889,%rcx,%rcx
    11f8:	48 c1 e9 20          	shr    $0x20,%rcx
    11fc:	01 c1                	add    %eax,%ecx
    11fe:	c1 f9 05             	sar    $0x5,%ecx
    1201:	89 c6                	mov    %eax,%esi
    1203:	c1 fe 1f             	sar    $0x1f,%esi
    1206:	29 f1                	sub    %esi,%ecx
    1208:	89 cf                	mov    %ecx,%edi
    120a:	c1 e7 04             	shl    $0x4,%edi
    120d:	89 ce                	mov    %ecx,%esi
    120f:	29 fe                	sub    %edi,%esi
    1211:	44 8d 04 b0          	lea    (%rax,%rsi,4),%r8d
    1215:	44 89 44 24 04       	mov    %r8d,0x4(%rsp)
    121a:	48 8d 35 fe 0d 00 00 	lea    0xdfe(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    1221:	bf 01 00 00 00       	mov    $0x1,%edi
    1226:	b8 00 00 00 00       	mov    $0x0,%eax
    122b:	e8 50 fe ff ff       	callq  1080 <__printf_chk@plt>
    1230:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1235:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    123c:	00 00 
    123e:	75 0a                	jne    124a <main+0xc1>
