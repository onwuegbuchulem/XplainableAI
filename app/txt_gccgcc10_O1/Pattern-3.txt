...
/app/bin_gccgcc10_O1/Pattern-3:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    117d:	eb 2d                	jmp    11ac <main+0x43>
    117f:	89 da                	mov    %ebx,%edx
    1181:	4c 89 e6             	mov    %r12,%rsi
    1184:	bf 01 00 00 00       	mov    $0x1,%edi
    1189:	b8 00 00 00 00       	mov    $0x0,%eax
    118e:	e8 dd fe ff ff       	callq  1070 <__printf_chk@plt>
    1193:	83 c3 01             	add    $0x1,%ebx
    1196:	39 eb                	cmp    %ebp,%ebx
    1198:	7e e5                	jle    117f <main+0x16>
    119a:	bf 0a 00 00 00       	mov    $0xa,%edi
    119f:	e8 bc fe ff ff       	callq  1060 <putchar@plt>
    11a4:	83 c5 01             	add    $0x1,%ebp
    11a7:	83 fd 06             	cmp    $0x6,%ebp
    11aa:	74 0b                	je     11b7 <main+0x4e>
    11ac:	bb 01 00 00 00       	mov    $0x1,%ebx
    11b1:	85 ed                	test   %ebp,%ebp
    11b3:	7f ca                	jg     117f <main+0x16>
    11b5:	eb e3                	jmp    119a <main+0x31>
