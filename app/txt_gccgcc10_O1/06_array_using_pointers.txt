...
/app/bin_gccgcc10_O1/06_array_using_pointers:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1183:	c7 04 24 0c 00 00 00 	movl   $0xc,(%rsp)
    118a:	c7 44 24 04 22 00 00 	movl   $0x22,0x4(%rsp)
    1191:	00 
    1192:	c7 44 24 08 35 00 00 	movl   $0x35,0x8(%rsp)
    1199:	00 
    119a:	c7 44 24 0c 42 00 00 	movl   $0x42,0xc(%rsp)
    11a1:	00 
    11a2:	bb 00 00 00 00       	mov    $0x0,%ebx
    11a7:	48 8d 2d 56 0e 00 00 	lea    0xe56(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    11ae:	8b 0c 9c             	mov    (%rsp,%rbx,4),%ecx
    11b1:	89 da                	mov    %ebx,%edx
    ...
    11c9:	48 83 fb 04          	cmp    $0x4,%rbx
    11cd:	75 df                	jne    11ae <main+0x45>
    11cf:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11d4:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11db:	00 00 
    11dd:	75 0c                	jne    11eb <main+0x82>
    11df:	b8 00 00 00 00       	mov    $0x0,%eax
    11e4:	48 83 c4 28          	add    $0x28,%rsp
    11e8:	5b                   	pop    %rbx
    11e9:	5d                   	pop    %rbp
    11ea:	c3                   	retq   
