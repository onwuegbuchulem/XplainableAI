...
/app/bin_gccgcc10_O2/2022_05_01-Lesson:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10dc:	66 0f ef c0          	pxor   %xmm0,%xmm0
    10e0:	31 d2                	xor    %edx,%edx
    10e2:	66 0f ef c9          	pxor   %xmm1,%xmm1
    10e6:	bf 01 00 00 00       	mov    $0x1,%edi
    10eb:	48 8d 35 2e 0f 00 00 	lea    0xf2e(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    10f2:	b8 02 00 00 00       	mov    $0x2,%eax
    10f7:	f3 0f 5a 44 24 04    	cvtss2sd 0x4(%rsp),%xmm0
