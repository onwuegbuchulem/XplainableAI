...
/app/bin_gccgcc10_O2/CommonElementsInTwoArrays:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    118e:	0f 85 03 01 00 00    	jne    1297 <main+0x1d7>
    ...
    11e2:	8b 55 c4             	mov    -0x3c(%rbp),%edx
    ...
    1217:	e8 84 fe ff ff       	callq  10a0 <__printf_chk@plt>
    121c:	8b 45 c4             	mov    -0x3c(%rbp),%eax
    121f:	85 c0                	test   %eax,%eax
    1221:	7e 54                	jle    1277 <main+0x1b7>
    1223:	45 31 e4             	xor    %r12d,%r12d
    1226:	4c 8d 2d 67 0e 00 00 	lea    0xe67(%rip),%r13        # 2094 <_IO_stdin_used+0x94>
    122d:	0f 1f 00             	nopl   (%rax)
    1230:	31 db                	xor    %ebx,%ebx
    1232:	eb 0f                	jmp    1243 <main+0x183>
    1234:	0f 1f 40 00          	nopl   0x0(%rax)
    1238:	8b 45 c4             	mov    -0x3c(%rbp),%eax
    123b:	48 83 c3 01          	add    $0x1,%rbx
    123f:	39 d8                	cmp    %ebx,%eax
    1241:	7e 23                	jle    1266 <main+0x1a6>
    1243:	41 8b 14 9f          	mov    (%r15,%rbx,4),%edx
    1247:	41 39 16             	cmp    %edx,(%r14)
    124a:	75 ec                	jne    1238 <main+0x178>
    124c:	4c 89 ee             	mov    %r13,%rsi
    124f:	bf 01 00 00 00       	mov    $0x1,%edi
    1254:	31 c0                	xor    %eax,%eax
    1256:	48 83 c3 01          	add    $0x1,%rbx
    125a:	e8 41 fe ff ff       	callq  10a0 <__printf_chk@plt>
    125f:	8b 45 c4             	mov    -0x3c(%rbp),%eax
    1262:	39 d8                	cmp    %ebx,%eax
    1264:	7f dd                	jg     1243 <main+0x183>
    1266:	41 83 c4 01          	add    $0x1,%r12d
    126a:	49 83 c6 04          	add    $0x4,%r14
    126e:	44 39 e0             	cmp    %r12d,%eax
    1271:	7e 04                	jle    1277 <main+0x1b7>
    1273:	85 c0                	test   %eax,%eax
    1275:	7f b9                	jg     1230 <main+0x170>
    1277:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
    127b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1282:	00 00 
    1284:	75 1c                	jne    12a2 <main+0x1e2>
    1286:	48 8d 65 d8          	lea    -0x28(%rbp),%rsp
    ...
    1295:	5d                   	pop    %rbp
    1296:	c3                   	retq   
    1297:	48 83 4c 14 f8 00    	orq    $0x0,-0x8(%rsp,%rdx,1)
    129d:	e9 f2 fe ff ff       	jmpq   1194 <main+0xd4>
    12a2:	e8 e9 fd ff ff       	callq  1090 <__stack_chk_fail@plt>
