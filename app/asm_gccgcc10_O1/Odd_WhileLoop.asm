...
/app/bin_gccgcc10_O1/Odd_WhileLoop:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    115f:	eb 1c                	jmp    117d <main+0x34>
    1161:	89 da                	mov    %ebx,%edx
    1163:	48 89 ee             	mov    %rbp,%rsi
    ...
    1178:	83 fb 33             	cmp    $0x33,%ebx
    117b:	74 07                	je     1184 <main+0x3b>
    117d:	f6 c3 01             	test   $0x1,%bl
    1180:	74 f3                	je     1175 <main+0x2c>
    1182:	eb dd                	jmp    1161 <main+0x18>
    1184:	b8 00 00 00 00       	mov    $0x0,%eax
    1189:	48 83 c4 08          	add    $0x8,%rsp
    118d:	5b                   	pop    %rbx
    118e:	5d                   	pop    %rbp
    118f:	c3                   	retq   
