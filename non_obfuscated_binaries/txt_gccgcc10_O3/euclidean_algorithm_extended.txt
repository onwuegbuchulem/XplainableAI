...
/app/bin_gccgcc10_O3/euclidean_algorithm_extended:     file format elf64-x86-64
...
0000000000001250 <extended_euclidean_algorithm>:
    ...
    12d4:	66 41 0f 6e ce       	movd   %r14d,%xmm1
    12d9:	66 0f 6e c7          	movd   %edi,%xmm0
    12dd:	48 83 c4 20          	add    $0x20,%rsp
    12e1:	89 ea                	mov    %ebp,%edx
    12e3:	66 0f 62 c1          	punpckldq %xmm1,%xmm0
    12e7:	5b                   	pop    %rbx
    12e8:	5d                   	pop    %rbp
    12e9:	66 48 0f 7e c0       	movq   %xmm0,%rax
    12ee:	41 5c                	pop    %r12
    12f0:	41 5d                	pop    %r13
    12f2:	41 5e                	pop    %r14
    12f4:	c3                   	retq   
