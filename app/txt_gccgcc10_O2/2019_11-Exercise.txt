...
/app/bin_gccgcc10_O2/2019_11-Exercise:     file format elf64-x86-64
...
0000000000001230 <yorn>:
    ...
    1242:	55                   	push   %rbp
    1243:	53                   	push   %rbx
    1244:	48 83 ec 20          	sub    $0x20,%rsp
    1248:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    124f:	00 00 
    1251:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    1256:	31 c0                	xor    %eax,%eax
    1258:	4c 8d 64 24 0c       	lea    0xc(%rsp),%r12
    125d:	e8 6e fe ff ff       	callq  10d0 <__printf_chk@plt>
    1262:	48 8b 15 a7 2d 00 00 	mov    0x2da7(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    1269:	be 0c 00 00 00       	mov    $0xc,%esi
    126e:	4c 89 e7             	mov    %r12,%rdi
    1271:	e8 4a fe ff ff       	callq  10c0 <fgets@plt>
    1276:	48 0f be 44 24 0c    	movsbq 0xc(%rsp),%rax
    127c:	48 89 c3             	mov    %rax,%rbx
    127f:	83 c0 01             	add    $0x1,%eax
    1282:	83 f8 01             	cmp    $0x1,%eax
    1285:	76 56                	jbe    12dd <yorn+0xad>
    1287:	31 ed                	xor    %ebp,%ebp
    1289:	eb 0a                	jmp    1295 <yorn+0x65>
    128b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1290:	49 0f be 1c 2c       	movsbq (%r12,%rbp,1),%rbx
    1295:	48 63 c5             	movslq %ebp,%rax
    1298:	84 db                	test   %bl,%bl
    129a:	74 1e                	je     12ba <yorn+0x8a>
    129c:	80 fb 0a             	cmp    $0xa,%bl
    129f:	74 7f                	je     1320 <yorn+0xf0>
    12a1:	e8 ea fd ff ff       	callq  1090 <__ctype_toupper_loc@plt>
    12a6:	48 8b 00             	mov    (%rax),%rax
    12a9:	8b 04 98             	mov    (%rax,%rbx,4),%eax
    12ac:	41 88 04 2c          	mov    %al,(%r12,%rbp,1)
    12b0:	48 83 c5 01          	add    $0x1,%rbp
    12b4:	48 83 fd 0c          	cmp    $0xc,%rbp
    12b8:	75 d6                	jne    1290 <yorn+0x60>
    12ba:	81 7c 24 0c 59 45 53 	cmpl   $0x534559,0xc(%rsp)
    12c1:	00 
    12c2:	74 24                	je     12e8 <yorn+0xb8>
    12c4:	66 83 7c 24 0c 59    	cmpw   $0x59,0xc(%rsp)
    12ca:	74 1c                	je     12e8 <yorn+0xb8>
    12cc:	66 81 7c 24 0c 4e 4f 	cmpw   $0x4f4e,0xc(%rsp)
    12d3:	74 3b                	je     1310 <yorn+0xe0>
    12d5:	66 83 7c 24 0c 4e    	cmpw   $0x4e,0xc(%rsp)
    12db:	74 3a                	je     1317 <yorn+0xe7>
    12dd:	31 c0                	xor    %eax,%eax
    12df:	eb 0c                	jmp    12ed <yorn+0xbd>
    ...
    12f9:	00 00 
    12fb:	75 34                	jne    1331 <yorn+0x101>
    ...
    1315:	75 be                	jne    12d5 <yorn+0xa5>
    1317:	b8 02 00 00 00       	mov    $0x2,%eax
    131c:	eb cf                	jmp    12ed <yorn+0xbd>
    131e:	66 90                	xchg   %ax,%ax
    1320:	c6 44 04 0c 00       	movb   $0x0,0xc(%rsp,%rax,1)
    1325:	81 7c 24 0c 59 45 53 	cmpl   $0x534559,0xc(%rsp)
    132c:	00 
    132d:	75 95                	jne    12c4 <yorn+0x94>
    132f:	eb b7                	jmp    12e8 <yorn+0xb8>
    1331:	e8 7a fd ff ff       	callq  10b0 <__stack_chk_fail@plt>
