...
/app/bin_gccgcc10_O3/2021_08_28-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10b1:	48 83 ec 20          	sub    $0x20,%rsp
    10b5:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10bc:	00 00 
    10be:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10c3:	48 b8 48 65 6c 6c 6f 	movabs $0x77202c6f6c6c6548,%rax
    10ca:	2c 20 77 
    10cd:	48 8d 6c 24 0a       	lea    0xa(%rsp),%rbp
    10d2:	c7 44 24 12 6f 72 6c 	movl   $0x646c726f,0x12(%rsp)
    10d9:	64 
    10da:	48 89 ea             	mov    %rbp,%rdx
    10dd:	48 89 44 24 0a       	mov    %rax,0xa(%rsp)
    10e2:	b8 21 00 00 00       	mov    $0x21,%eax
    10e7:	66 89 44 24 16       	mov    %ax,0x16(%rsp)
    10ec:	31 c0                	xor    %eax,%eax
    10ee:	e8 9d ff ff ff       	callq  1090 <__printf_chk@plt>
    10f3:	0f b6 44 24 0a       	movzbl 0xa(%rsp),%eax
    10f8:	84 c0                	test   %al,%al
    10fa:	74 15                	je     1111 <main+0x71>
    10fc:	48 89 ea             	mov    %rbp,%rdx
    10ff:	90                   	nop
    1100:	83 c0 01             	add    $0x1,%eax
    1103:	48 83 c2 01          	add    $0x1,%rdx
    1107:	88 42 ff             	mov    %al,-0x1(%rdx)
    110a:	0f b6 02             	movzbl (%rdx),%eax
    110d:	84 c0                	test   %al,%al
    110f:	75 ef                	jne    1100 <main+0x60>
    1111:	48 89 ef             	mov    %rbp,%rdi
    1114:	e8 57 ff ff ff       	callq  1070 <puts@plt>
    1119:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    111e:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1125:	00 00 
    1127:	75 08                	jne    1131 <main+0x91>
    1129:	48 83 c4 20          	add    $0x20,%rsp
    112d:	31 c0                	xor    %eax,%eax
    112f:	5d                   	pop    %rbp
    1130:	c3                   	retq   
    1131:	e8 4a ff ff ff       	callq  1080 <__stack_chk_fail@plt>
...
0000000000001230 <increase>:
    1230:	f3 0f 1e fa          	endbr64 
    1234:	eb 14                	jmp    124a <increase+0x1a>
    1236:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    123d:	00 00 00 
    1240:	83 c0 01             	add    $0x1,%eax
    1243:	48 83 c7 01          	add    $0x1,%rdi
    1247:	88 47 ff             	mov    %al,-0x1(%rdi)
    124a:	0f b6 07             	movzbl (%rdi),%eax
    124d:	84 c0                	test   %al,%al
    124f:	75 ef                	jne    1240 <increase+0x10>
    1251:	c3                   	retq   
