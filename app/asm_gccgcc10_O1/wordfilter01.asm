...
/app/bin_gccgcc10_O1/wordfilter01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11bc:	00 00 
    11be:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    11c3:	31 c0                	xor    %eax,%eax
    11c5:	bd 00 00 00 00       	mov    $0x0,%ebp
    11ca:	49 89 e4             	mov    %rsp,%r12
    11cd:	eb 1d                	jmp    11ec <main+0x43>
    11cf:	4c 89 e7             	mov    %r12,%rdi
    11d2:	e8 a9 fe ff ff       	callq  1080 <puts@plt>
    11d7:	bd 00 00 00 00       	mov    $0x0,%ebp
    11dc:	eb 0e                	jmp    11ec <main+0x43>
    11de:	48 63 c5             	movslq %ebp,%rax
    11e1:	88 1c 04             	mov    %bl,(%rsp,%rax,1)
    11e4:	83 c5 01             	add    $0x1,%ebp
    11e7:	83 fd 3f             	cmp    $0x3f,%ebp
    11ea:	74 3a                	je     1226 <main+0x7d>
    11ec:	48 8b 3d 1d 2e 00 00 	mov    0x2e1d(%rip),%rdi        # 4010 <stdin@@GLIBC_2.2.5>
    11f3:	e8 a8 fe ff ff       	callq  10a0 <getc@plt>
    11f8:	89 c3                	mov    %eax,%ebx
    11fa:	83 f8 ff             	cmp    $0xffffffff,%eax
    11fd:	74 3b                	je     123a <main+0x91>
    11ff:	e8 ac fe ff ff       	callq  10b0 <__ctype_b_loc@plt>
    1204:	48 89 c2             	mov    %rax,%rdx
    1207:	48 63 c3             	movslq %ebx,%rax
    120a:	48 8b 12             	mov    (%rdx),%rdx
    120d:	f6 44 42 01 20       	testb  $0x20,0x1(%rdx,%rax,2)
    1212:	74 ca                	je     11de <main+0x35>
    1214:	48 63 c5             	movslq %ebp,%rax
    1217:	c6 04 04 00          	movb   $0x0,(%rsp,%rax,1)
    121b:	85 ed                	test   %ebp,%ebp
    121d:	7f b0                	jg     11cf <main+0x26>
    121f:	bd 00 00 00 00       	mov    $0x0,%ebp
    1224:	eb c6                	jmp    11ec <main+0x43>
    1226:	c6 44 24 3f 00       	movb   $0x0,0x3f(%rsp)
    122b:	4c 89 e7             	mov    %r12,%rdi
    122e:	e8 4d fe ff ff       	callq  1080 <puts@plt>
    1233:	bd 00 00 00 00       	mov    $0x0,%ebp
    1238:	eb b2                	jmp    11ec <main+0x43>
    123a:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    123f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1246:	00 00 
    1248:	75 0e                	jne    1258 <main+0xaf>
    124a:	b8 00 00 00 00       	mov    $0x0,%eax
    124f:	48 83 c4 50          	add    $0x50,%rsp
    1253:	5b                   	pop    %rbx
    1254:	5d                   	pop    %rbp
    1255:	41 5c                	pop    %r12
    1257:	c3                   	retq   
    1258:	e8 33 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
