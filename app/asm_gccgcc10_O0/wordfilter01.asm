...
/app/bin_gccgcc10_O0/wordfilter01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c4:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%rbp)
    11cb:	eb 7c                	jmp    1249 <main+0xa0>
    11cd:	e8 de fe ff ff       	callq  10b0 <__ctype_b_loc@plt>
    11d2:	48 8b 10             	mov    (%rax),%rdx
    11d5:	8b 45 ac             	mov    -0x54(%rbp),%eax
    11d8:	48 98                	cltq   
    11da:	48 01 c0             	add    %rax,%rax
    11dd:	48 01 d0             	add    %rdx,%rax
    11e0:	0f b7 00             	movzwl (%rax),%eax
    11e3:	0f b7 c0             	movzwl %ax,%eax
    11e6:	25 00 20 00 00       	and    $0x2000,%eax
    11eb:	85 c0                	test   %eax,%eax
    11ed:	74 25                	je     1214 <main+0x6b>
    11ef:	8b 45 a8             	mov    -0x58(%rbp),%eax
    11f2:	48 98                	cltq   
    11f4:	c6 44 05 b0 00       	movb   $0x0,-0x50(%rbp,%rax,1)
    11f9:	83 7d a8 00          	cmpl   $0x0,-0x58(%rbp)
    11fd:	7e 0c                	jle    120b <main+0x62>
    11ff:	48 8d 45 b0          	lea    -0x50(%rbp),%rax
    1203:	48 89 c7             	mov    %rax,%rdi
    1206:	e8 75 fe ff ff       	callq  1080 <puts@plt>
    120b:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%rbp)
    1212:	eb 35                	jmp    1249 <main+0xa0>
    1214:	8b 45 ac             	mov    -0x54(%rbp),%eax
    1217:	89 c2                	mov    %eax,%edx
    1219:	8b 45 a8             	mov    -0x58(%rbp),%eax
    121c:	48 98                	cltq   
    121e:	88 54 05 b0          	mov    %dl,-0x50(%rbp,%rax,1)
    1222:	83 45 a8 01          	addl   $0x1,-0x58(%rbp)
    1226:	83 7d a8 3f          	cmpl   $0x3f,-0x58(%rbp)
    122a:	75 1d                	jne    1249 <main+0xa0>
    122c:	8b 45 a8             	mov    -0x58(%rbp),%eax
    122f:	48 98                	cltq   
    1231:	c6 44 05 b0 00       	movb   $0x0,-0x50(%rbp,%rax,1)
    1236:	48 8d 45 b0          	lea    -0x50(%rbp),%rax
    123a:	48 89 c7             	mov    %rax,%rdi
    123d:	e8 3e fe ff ff       	callq  1080 <puts@plt>
    1242:	c7 45 a8 00 00 00 00 	movl   $0x0,-0x58(%rbp)
    1249:	e8 52 fe ff ff       	callq  10a0 <getchar@plt>
    124e:	89 45 ac             	mov    %eax,-0x54(%rbp)
    1251:	83 7d ac ff          	cmpl   $0xffffffff,-0x54(%rbp)
    1255:	0f 85 72 ff ff ff    	jne    11cd <main+0x24>
    125b:	b8 00 00 00 00       	mov    $0x0,%eax
    1260:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1264:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    126b:	00 00 
    126d:	74 05                	je     1274 <main+0xcb>
    126f:	e8 1c fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    1274:	c9                   	leaveq 
    1275:	c3                   	retq   
