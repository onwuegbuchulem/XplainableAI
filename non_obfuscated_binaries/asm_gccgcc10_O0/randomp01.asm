...
/app/bin_gccgcc10_O0/randomp01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c1:	e8 da fe ff ff       	callq  10a0 <time@plt>
    11c6:	89 c7                	mov    %eax,%edi
    11c8:	e8 c3 fe ff ff       	callq  1090 <srand@plt>
    11cd:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    11d4:	eb 3b                	jmp    1211 <main+0x68>
    11d6:	e8 d5 fe ff ff       	callq  10b0 <rand@plt>
    11db:	48 63 d0             	movslq %eax,%rdx
    11de:	48 69 d2 5d 41 4c ae 	imul   $0xffffffffae4c415d,%rdx,%rdx
    11e5:	48 c1 ea 20          	shr    $0x20,%rdx
    11e9:	01 c2                	add    %eax,%edx
    11eb:	c1 fa 06             	sar    $0x6,%edx
    11ee:	89 c1                	mov    %eax,%ecx
    11f0:	c1 f9 1f             	sar    $0x1f,%ecx
    11f3:	29 ca                	sub    %ecx,%edx
    11f5:	6b ca 5e             	imul   $0x5e,%edx,%ecx
    11f8:	29 c8                	sub    %ecx,%eax
    11fa:	89 c2                	mov    %eax,%edx
    11fc:	88 55 f7             	mov    %dl,-0x9(%rbp)
    11ff:	0f be 45 f7          	movsbl -0x9(%rbp),%eax
    1203:	83 c0 21             	add    $0x21,%eax
    1206:	89 c7                	mov    %eax,%edi
    1208:	e8 73 fe ff ff       	callq  1080 <putchar@plt>
    120d:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    1211:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1214:	3b 45 fc             	cmp    -0x4(%rbp),%eax
    1217:	7c bd                	jl     11d6 <main+0x2d>
    1219:	bf 0a 00 00 00       	mov    $0xa,%edi
    121e:	e8 5d fe ff ff       	callq  1080 <putchar@plt>
