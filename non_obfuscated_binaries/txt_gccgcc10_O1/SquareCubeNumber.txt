...
/app/bin_gccgcc10_O1/SquareCubeNumber:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b4:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11b9:	48 8d 3d 57 0e 00 00 	lea    0xe57(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    11c0:	b8 00 00 00 00       	mov    $0x0,%eax
    11c5:	e8 c6 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11ca:	8b 5c 24 04          	mov    0x4(%rsp),%ebx
    11ce:	89 dd                	mov    %ebx,%ebp
    11d0:	0f af eb             	imul   %ebx,%ebp
    11d3:	89 ea                	mov    %ebp,%edx
    11d5:	48 8d 35 3e 0e 00 00 	lea    0xe3e(%rip),%rsi        # 201a <_IO_stdin_used+0x1a>
    ...
    11ed:	0f af d5             	imul   %ebp,%edx
    11f0:	48 8d 35 30 0e 00 00 	lea    0xe30(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    ...
    1212:	00 00 
    1214:	75 0c                	jne    1222 <main+0x99>
    1216:	b8 00 00 00 00       	mov    $0x0,%eax
    121b:	48 83 c4 18          	add    $0x18,%rsp
    121f:	5b                   	pop    %rbx
    1220:	5d                   	pop    %rbp
    1221:	c3                   	retq   
    1222:	e8 49 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
