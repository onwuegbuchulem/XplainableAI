...
/app/bin_gccgcc10_O0/2022_07_16-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	48 c7 45 e8 00 00 00 	movq   $0x0,-0x18(%rbp)
    11ab:	00 
    ...
    11bd:	48 8b 15 4c 2e 00 00 	mov    0x2e4c(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    11c4:	48 8d 4d f0          	lea    -0x10(%rbp),%rcx
    11c8:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    11cc:	48 89 ce             	mov    %rcx,%rsi
    11cf:	48 89 c7             	mov    %rax,%rdi
    11d2:	e8 b9 fe ff ff       	callq  1090 <getline@plt>
    11d7:	89 45 e4             	mov    %eax,-0x1c(%rbp)
    11da:	48 8b 55 e8          	mov    -0x18(%rbp),%rdx
    11de:	8b 45 e4             	mov    -0x1c(%rbp),%eax
    ...
    11f4:	83 7d e4 01          	cmpl   $0x1,-0x1c(%rbp)
    11f8:	7f b2                	jg     11ac <main+0x23>
    11fa:	b8 00 00 00 00       	mov    $0x0,%eax
    11ff:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1203:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    120a:	00 00 
