...
/app/bin_gccgcc10_O0/strcat:     file format elf64-x86-64
...
0000000000001090 <strcat@plt>:
    ...
    1094:	f2 ff 25 35 2f 00 00 	bnd jmpq *0x2f35(%rip)        # 3fd0 <strcat@GLIBC_2.2.5>
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d ea 00 00 00 	lea    0xea(%rip),%rdi        # 11b2 <main>
...
0000000000001189 <strappend>:
    ...
    119d:	48 8b 55 f0          	mov    -0x10(%rbp),%rdx
    11a1:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11a5:	48 89 d6             	mov    %rdx,%rsi
    11a8:	48 89 c7             	mov    %rax,%rdi
    11ab:	e8 e0 fe ff ff       	callq  1090 <strcat@plt>
    11b0:	c9                   	leaveq 
    11b1:	c3                   	retq   
...
00000000000011b2 <main>:
    ...
    11ba:	48 83 ec 50          	sub    $0x50,%rsp
    11be:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11c5:	00 00 
    11c7:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    11cb:	31 c0                	xor    %eax,%eax
    11cd:	48 b8 54 68 69 73 20 	movabs $0x2073692073696854,%rax
    11d4:	69 73 20 
    11d7:	48 ba 61 6e 6f 74 68 	movabs $0x20726568746f6e61,%rdx
    11de:	65 72 20 
    11e1:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    11e5:	48 89 55 d8          	mov    %rdx,-0x28(%rbp)
    11e9:	48 c7 45 e0 00 00 00 	movq   $0x0,-0x20(%rbp)
    11f0:	00 
    11f1:	48 c7 45 e8 00 00 00 	movq   $0x0,-0x18(%rbp)
    11f8:	00 
    11f9:	48 b8 66 69 6e 65 20 	movabs $0x73656d20656e6966,%rax
    1200:	6d 65 73 
    1203:	48 89 45 c5          	mov    %rax,-0x3b(%rbp)
    1207:	66 c7 45 cd 73 21    	movw   $0x2173,-0x33(%rbp)
    120d:	c6 45 cf 00          	movb   $0x0,-0x31(%rbp)
    1211:	48 8d 55 c5          	lea    -0x3b(%rbp),%rdx
    1215:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    1219:	48 89 d6             	mov    %rdx,%rsi
    121c:	48 89 c7             	mov    %rax,%rdi
    121f:	e8 65 ff ff ff       	callq  1189 <strappend>
    1224:	48 89 45 b8          	mov    %rax,-0x48(%rbp)
    1228:	48 8b 45 b8          	mov    -0x48(%rbp),%rax
    122c:	48 89 c7             	mov    %rax,%rdi
    122f:	e8 3c fe ff ff       	callq  1070 <puts@plt>
    1234:	b8 00 00 00 00       	mov    $0x0,%eax
    1239:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    123d:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1244:	00 00 
    1246:	74 05                	je     124d <main+0x9b>
    1248:	e8 33 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    124d:	c9                   	leaveq 
    124e:	c3                   	retq   
    124f:	90                   	nop
