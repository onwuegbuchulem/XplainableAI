...
/app/bin_gccgcc10_O3/buffering01:     file format elf64-x86-64
...
0000000000001090 <setbuf@plt>:
    ...
    1094:	f2 ff 25 25 2f 00 00 	bnd jmpq *0x2f25(%rip)        # 3fc0 <setbuf@GLIBC_2.2.5>
...
00000000000010c0 <main>:
    ...
    10c4:	41 54                	push   %r12
    10c6:	48 81 ec 00 10 00 00 	sub    $0x1000,%rsp
    10cd:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    10d2:	48 81 ec 00 10 00 00 	sub    $0x1000,%rsp
    10d9:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    10de:	48 83 ec 10          	sub    $0x10,%rsp
    10e2:	48 8b 3d 27 2f 00 00 	mov    0x2f27(%rip),%rdi        # 4010 <stdout@@GLIBC_2.2.5>
    10e9:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10f0:	00 00 
    10f2:	48 89 84 24 08 20 00 	mov    %rax,0x2008(%rsp)
    10f9:	00 
    10fa:	31 c0                	xor    %eax,%eax
    10fc:	48 89 e6             	mov    %rsp,%rsi
    10ff:	e8 8c ff ff ff       	callq  1090 <setbuf@plt>
    1104:	48 8d 35 f9 0e 00 00 	lea    0xef9(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    110b:	bf 01 00 00 00       	mov    $0x1,%edi
    1110:	31 c0                	xor    %eax,%eax
    1112:	e8 89 ff ff ff       	callq  10a0 <__printf_chk@plt>
    1117:	48 8b 3d 02 2f 00 00 	mov    0x2f02(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    111e:	e8 8d ff ff ff       	callq  10b0 <getc@plt>
    1123:	48 8d 35 da 0e 00 00 	lea    0xeda(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    112a:	bf 01 00 00 00       	mov    $0x1,%edi
    112f:	41 89 c4             	mov    %eax,%r12d
    1132:	31 c0                	xor    %eax,%eax
    1134:	e8 67 ff ff ff       	callq  10a0 <__printf_chk@plt>
    1139:	48 8b 3d e0 2e 00 00 	mov    0x2ee0(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    1140:	e8 6b ff ff ff       	callq  10b0 <getc@plt>
    1145:	44 89 e2             	mov    %r12d,%edx
    1148:	bf 01 00 00 00       	mov    $0x1,%edi
    114d:	48 8d 35 bf 0e 00 00 	lea    0xebf(%rip),%rsi        # 2013 <_IO_stdin_used+0x13>
    1154:	89 c1                	mov    %eax,%ecx
    1156:	31 c0                	xor    %eax,%eax
    1158:	e8 43 ff ff ff       	callq  10a0 <__printf_chk@plt>
    115d:	48 8b 84 24 08 20 00 	mov    0x2008(%rsp),%rax
    1164:	00 
    1165:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    116c:	00 00 
    116e:	75 0c                	jne    117c <main+0xbc>
    1170:	48 81 c4 10 20 00 00 	add    $0x2010,%rsp
    1177:	31 c0                	xor    %eax,%eax
    1179:	41 5c                	pop    %r12
    117b:	c3                   	retq   
    117c:	e8 ff fe ff ff       	callq  1080 <__stack_chk_fail@plt>
