...
/app/bin_gccgcc10_O0/2019_09_07-Lesson-b:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11d1:	48 81 ec f0 00 00 00 	sub    $0xf0,%rsp
    ...
    11f8:	c7 85 18 ff ff ff 00 	movl   $0x0,-0xe8(%rbp)
    11ff:	00 00 00 
    1202:	eb 1a                	jmp    121e <main+0x55>
    1204:	8b 85 18 ff ff ff    	mov    -0xe8(%rbp),%eax
    120a:	48 98                	cltq   
    120c:	c7 84 85 20 ff ff ff 	movl   $0x0,-0xe0(%rbp,%rax,4)
    1213:	00 00 00 00 
    1217:	83 85 18 ff ff ff 01 	addl   $0x1,-0xe8(%rbp)
    121e:	83 bd 18 ff ff ff 33 	cmpl   $0x33,-0xe8(%rbp)
    1225:	7e dd                	jle    1204 <main+0x3b>
    1227:	48 8d 85 20 ff ff ff 	lea    -0xe0(%rbp),%rax
    122e:	48 89 c7             	mov    %rax,%rdi
    1231:	e8 3a 00 00 00       	callq  1270 <draw>
    1236:	89 85 1c ff ff ff    	mov    %eax,-0xe4(%rbp)
    123c:	8b 85 1c ff ff ff    	mov    -0xe4(%rbp),%eax
    ...
    125a:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    125e:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1265:	00 00 
    1267:	74 05                	je     126e <main+0xa5>
    1269:	e8 22 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
    126e:	c9                   	leaveq 
    126f:	c3                   	retq   
...
0000000000001270 <draw>:
    ...
    1288:	48 69 d2 4f ec c4 4e 	imul   $0x4ec4ec4f,%rdx,%rdx
    128f:	48 c1 ea 20          	shr    $0x20,%rdx
    1293:	c1 fa 04             	sar    $0x4,%edx
    1296:	89 c1                	mov    %eax,%ecx
    1298:	c1 f9 1f             	sar    $0x1f,%ecx
    129b:	29 ca                	sub    %ecx,%edx
    129d:	89 55 fc             	mov    %edx,-0x4(%rbp)
    12a0:	8b 55 fc             	mov    -0x4(%rbp),%edx
    12a3:	6b d2 34             	imul   $0x34,%edx,%edx
    12a6:	29 d0                	sub    %edx,%eax
    12a8:	89 45 fc             	mov    %eax,-0x4(%rbp)
    12ab:	8b 45 fc             	mov    -0x4(%rbp),%eax
    12ae:	48 98                	cltq   
    12b0:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
    12b7:	00 
    12b8:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    12bc:	48 01 d0             	add    %rdx,%rax
    12bf:	8b 00                	mov    (%rax),%eax
    12c1:	85 c0                	test   %eax,%eax
    12c3:	74 02                	je     12c7 <draw+0x57>
    12c5:	eb b9                	jmp    1280 <draw+0x10>
    12c7:	90                   	nop
    ...
    12dc:	c7 00 01 00 00 00    	movl   $0x1,(%rax)
