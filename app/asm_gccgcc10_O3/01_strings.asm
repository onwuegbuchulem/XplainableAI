...
/app/bin_gccgcc10_O3/01_strings:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108e:	53                   	push   %rbx
    108f:	48 83 ec 10          	sub    $0x10,%rsp
    1093:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    109a:	00 00 
    109c:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10a1:	31 c0                	xor    %eax,%eax
    10a3:	c7 44 24 04 61 62 63 	movl   $0x636261,0x4(%rsp)
    10aa:	00 
    10ab:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx
    10b0:	4c 8d 64 24 07       	lea    0x7(%rsp),%r12
    10b5:	0f be 13             	movsbl (%rbx),%edx
    10b8:	48 89 ee             	mov    %rbp,%rsi
    10bb:	bf 01 00 00 00       	mov    $0x1,%edi
    10c0:	31 c0                	xor    %eax,%eax
    10c2:	48 83 c3 01          	add    $0x1,%rbx
    10c6:	e8 a5 ff ff ff       	callq  1070 <__printf_chk@plt>
    10cb:	4c 39 e3             	cmp    %r12,%rbx
    10ce:	75 e5                	jne    10b5 <main+0x35>
    10d0:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10d5:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10dc:	00 00 
    10de:	75 0b                	jne    10eb <main+0x6b>
    10e0:	48 83 c4 10          	add    $0x10,%rsp
    10e4:	31 c0                	xor    %eax,%eax
    10e6:	5b                   	pop    %rbx
    10e7:	5d                   	pop    %rbp
    10e8:	41 5c                	pop    %r12
    10ea:	c3                   	retq   
    10eb:	e8 70 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
