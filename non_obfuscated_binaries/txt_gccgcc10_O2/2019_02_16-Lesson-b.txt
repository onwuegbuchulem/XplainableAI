...
/app/bin_gccgcc10_O2/2019_02_16-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1093:	53                   	push   %rbx
    1094:	48 83 ec 10          	sub    $0x10,%rsp
    1098:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    109f:	00 00 
    10a1:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10a6:	31 c0                	xor    %eax,%eax
    10a8:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%rsp)
    10af:	00 
    10b0:	48 89 e3             	mov    %rsp,%rbx
    10b3:	4c 8d 64 24 10       	lea    0x10(%rsp),%r12
    10b8:	48 89 ee             	mov    %rbp,%rsi
    10bb:	bf 01 00 00 00       	mov    $0x1,%edi
    10c0:	31 c0                	xor    %eax,%eax
    10c2:	48 83 c3 04          	add    $0x4,%rbx
    10c6:	e8 a5 ff ff ff       	callq  1070 <__printf_chk@plt>
    10cb:	4c 39 e3             	cmp    %r12,%rbx
    10ce:	74 08                	je     10d8 <main+0x58>
    10d0:	8b 13                	mov    (%rbx),%edx
    10d2:	eb e4                	jmp    10b8 <main+0x38>
    10d4:	0f 1f 40 00          	nopl   0x0(%rax)
    10d8:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10dd:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10e4:	00 00 
    10e6:	75 0b                	jne    10f3 <main+0x73>
    10e8:	48 83 c4 10          	add    $0x10,%rsp
    10ec:	31 c0                	xor    %eax,%eax
    10ee:	5b                   	pop    %rbx
    10ef:	5d                   	pop    %rbp
    10f0:	41 5c                	pop    %r12
    10f2:	c3                   	retq   
    10f3:	e8 68 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
