...
/app/bin_gccgcc10_O1/assignment2:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1181:	48 b8 48 65 6c 6c 6f 	movabs $0x57202c6f6c6c6548,%rax
    1188:	2c 20 57 
    118b:	48 89 44 24 0a       	mov    %rax,0xa(%rsp)
    1190:	c7 44 24 12 6f 72 6c 	movl   $0x646c726f,0x12(%rsp)
    1197:	64 
    1198:	66 c7 44 24 16 21 00 	movw   $0x21,0x16(%rsp)
    ...
    11ba:	f2 0f 10 05 76 0e 00 	movsd  0xe76(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    11c1:	00 
    11c2:	48 8d 35 4e 0e 00 00 	lea    0xe4e(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    11c9:	bf 01 00 00 00       	mov    $0x1,%edi
    11ce:	b8 01 00 00 00       	mov    $0x1,%eax
    11d3:	e8 98 fe ff ff       	callq  1070 <__printf_chk@plt>
    11d8:	48 8d 54 24 0a       	lea    0xa(%rsp),%rdx
    11dd:	48 8d 35 43 0e 00 00 	lea    0xe43(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    11e4:	bf 01 00 00 00       	mov    $0x1,%edi
    11e9:	b8 00 00 00 00       	mov    $0x0,%eax
    11ee:	e8 7d fe ff ff       	callq  1070 <__printf_chk@plt>
    11f3:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
