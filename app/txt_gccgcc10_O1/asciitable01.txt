...
/app/bin_gccgcc10_O1/asciitable01:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1173:	48 8d 3d 8e 0e 00 00 	lea    0xe8e(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    117a:	e8 e1 fe ff ff       	callq  1060 <puts@plt>
    117f:	bb 00 00 00 00       	mov    $0x0,%ebx
    1184:	48 8d 2d db 0e 00 00 	lea    0xedb(%rip),%rbp        # 2066 <_IO_stdin_used+0x66>
    118b:	41 89 d8             	mov    %ebx,%r8d
    118e:	89 d9                	mov    %ebx,%ecx
    1190:	89 da                	mov    %ebx,%edx
    1192:	48 8d 35 b9 0e 00 00 	lea    0xeb9(%rip),%rsi        # 2052 <_IO_stdin_used+0x52>
    1199:	bf 01 00 00 00       	mov    $0x1,%edi
    119e:	b8 00 00 00 00       	mov    $0x0,%eax
    11a3:	e8 c8 fe ff ff       	callq  1070 <__printf_chk@plt>
    11a8:	8d 53 20             	lea    0x20(%rbx),%edx
    11ab:	41 89 d1             	mov    %edx,%r9d
    11ae:	41 89 d0             	mov    %edx,%r8d
    ...
    11c5:	8d 53 40             	lea    0x40(%rbx),%edx
    11c8:	41 89 d1             	mov    %edx,%r9d
    11cb:	41 89 d0             	mov    %edx,%r8d
    ...
    11e2:	8d 53 60             	lea    0x60(%rbx),%edx
    11e5:	41 89 d1             	mov    %edx,%r9d
    11e8:	41 89 d0             	mov    %edx,%r8d
    11eb:	89 d1                	mov    %edx,%ecx
    11ed:	48 8d 35 87 0e 00 00 	lea    0xe87(%rip),%rsi        # 207b <_IO_stdin_used+0x7b>
    11f4:	bf 01 00 00 00       	mov    $0x1,%edi
    11f9:	b8 00 00 00 00       	mov    $0x0,%eax
    11fe:	e8 6d fe ff ff       	callq  1070 <__printf_chk@plt>
    1203:	83 c3 01             	add    $0x1,%ebx
    1206:	83 fb 20             	cmp    $0x20,%ebx
    1209:	75 80                	jne    118b <main+0x22>
