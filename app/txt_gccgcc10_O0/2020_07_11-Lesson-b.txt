...
/app/bin_gccgcc10_O0/2020_07_11-Lesson-b:     file format elf64-x86-64
...
00000000000010b0 <gettimeofday@plt>:
    ...
    10b4:	f2 ff 25 15 2f 00 00 	bnd jmpq *0x2f15(%rip)        # 3fd0 <gettimeofday@GLIBC_2.2.5>
...
00000000000011a9 <main>:
    ...
    11c4:	48 8d 55 d8          	lea    -0x28(%rbp),%rdx
    11c8:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11cc:	48 89 d6             	mov    %rdx,%rsi
    11cf:	48 89 c7             	mov    %rax,%rdi
    11d2:	e8 d9 fe ff ff       	callq  10b0 <gettimeofday@plt>
    11d7:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11db:	48 89 c7             	mov    %rax,%rdi
    11de:	e8 9d fe ff ff       	callq  1080 <localtime@plt>
    11e3:	48 89 45 d0          	mov    %rax,-0x30(%rbp)
    11e7:	48 8b 75 e8          	mov    -0x18(%rbp),%rsi
    11eb:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
    11ef:	8b 08                	mov    (%rax),%ecx
    11f1:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
    11f5:	8b 50 04             	mov    0x4(%rax),%edx
    11f8:	48 8b 45 d0          	mov    -0x30(%rbp),%rax
    11fc:	8b 40 08             	mov    0x8(%rax),%eax
    11ff:	49 89 f0             	mov    %rsi,%r8
    1202:	89 c6                	mov    %eax,%esi
    1204:	48 8d 3d fd 0d 00 00 	lea    0xdfd(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    120b:	b8 00 00 00 00       	mov    $0x0,%eax
    1210:	e8 8b fe ff ff       	callq  10a0 <printf@plt>
    1215:	8b 45 d8             	mov    -0x28(%rbp),%eax
    1218:	48 63 d0             	movslq %eax,%rdx
    121b:	48 69 d2 89 88 88 88 	imul   $0xffffffff88888889,%rdx,%rdx
    1222:	48 c1 ea 20          	shr    $0x20,%rdx
    1226:	01 c2                	add    %eax,%edx
    1228:	c1 fa 05             	sar    $0x5,%edx
    122b:	c1 f8 1f             	sar    $0x1f,%eax
    122e:	89 c1                	mov    %eax,%ecx
    1230:	89 d0                	mov    %edx,%eax
    1232:	29 c8                	sub    %ecx,%eax
    1234:	89 45 cc             	mov    %eax,-0x34(%rbp)
    1237:	83 7d cc 0c          	cmpl   $0xc,-0x34(%rbp)
    123b:	7e 04                	jle    1241 <main+0x98>
    123d:	83 6d cc 18          	subl   $0x18,-0x34(%rbp)
    1241:	8b 45 cc             	mov    -0x34(%rbp),%eax
    1244:	89 c6                	mov    %eax,%esi
    1246:	48 8d 3d cf 0d 00 00 	lea    0xdcf(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    124d:	b8 00 00 00 00       	mov    $0x0,%eax
    1252:	e8 49 fe ff ff       	callq  10a0 <printf@plt>
    1257:	8b 45 dc             	mov    -0x24(%rbp),%eax
    125a:	89 c6                	mov    %eax,%esi
    125c:	48 8d 3d cd 0d 00 00 	lea    0xdcd(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    1263:	b8 00 00 00 00       	mov    $0x0,%eax
    1268:	e8 33 fe ff ff       	callq  10a0 <printf@plt>
    126d:	b8 00 00 00 00       	mov    $0x0,%eax
    1272:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1276:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    127d:	00 00 
    127f:	74 05                	je     1286 <main+0xdd>
