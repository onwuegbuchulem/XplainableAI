...
/app/bin_gccgcc8_O1/buffering01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11ad:	53                   	push   %rbx
    11ae:	48 81 ec 00 10 00 00 	sub    $0x1000,%rsp
    11b5:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    11ba:	48 81 ec 00 10 00 00 	sub    $0x1000,%rsp
    11c1:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    11c6:	48 83 ec 10          	sub    $0x10,%rsp
    11ca:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11d1:	00 00 
    11d3:	48 89 84 24 08 20 00 	mov    %rax,0x2008(%rsp)
    11da:	00 
    11db:	31 c0                	xor    %eax,%eax
    11dd:	48 89 e6             	mov    %rsp,%rsi
    11e0:	48 8b 3d 29 2e 00 00 	mov    0x2e29(%rip),%rdi        # 4010 <stdout@@GLIBC_2.2.5>
    11e7:	e8 a4 fe ff ff       	callq  1090 <setbuf@plt>
    ...
    1202:	48 8b 3d 17 2e 00 00 	mov    0x2e17(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    1209:	e8 a2 fe ff ff       	callq  10b0 <getc@plt>
    ...
    1221:	e8 7a fe ff ff       	callq  10a0 <__printf_chk@plt>
    1226:	48 8b 3d f3 2d 00 00 	mov    0x2df3(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    122d:	e8 7e fe ff ff       	callq  10b0 <getc@plt>
    1232:	89 c1                	mov    %eax,%ecx
    1234:	89 da                	mov    %ebx,%edx
    1236:	48 8d 35 d6 0d 00 00 	lea    0xdd6(%rip),%rsi        # 2013 <_IO_stdin_used+0x13>
    123d:	bf 01 00 00 00       	mov    $0x1,%edi
    1242:	b8 00 00 00 00       	mov    $0x0,%eax
    1247:	e8 54 fe ff ff       	callq  10a0 <__printf_chk@plt>
    124c:	48 8b 84 24 08 20 00 	mov    0x2008(%rsp),%rax
    1253:	00 
    1254:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    125b:	00 00 
    125d:	75 0e                	jne    126d <main+0xc4>
    125f:	b8 00 00 00 00       	mov    $0x0,%eax
    1264:	48 81 c4 10 20 00 00 	add    $0x2010,%rsp
    126b:	5b                   	pop    %rbx
    126c:	c3                   	retq   
    126d:	e8 0e fe ff ff       	callq  1080 <__stack_chk_fail@plt>
