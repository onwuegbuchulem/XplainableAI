...
/app/bin_gccgcc10_O2/2022_04_01-Lesson:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ec:	73 18                	jae    1106 <main+0x66>
    10ee:	48 8d 35 33 0f 00 00 	lea    0xf33(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    10f5:	bf 01 00 00 00       	mov    $0x1,%edi
    10fa:	b8 02 00 00 00       	mov    $0x2,%eax
    10ff:	e8 7c ff ff ff       	callq  1080 <__printf_chk@plt>
    1104:	31 c0                	xor    %eax,%eax
    1106:	48 8b 54 24 08       	mov    0x8(%rsp),%rdx
    110b:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1112:	00 00 
    1114:	75 05                	jne    111b <main+0x7b>
    1116:	48 83 c4 18          	add    $0x18,%rsp
    111a:	c3                   	retq   
    111b:	e8 50 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
...
0000000000001210 <babylonian_sr>:
