...
/app/bin_gccgcc10_O3/2019_02_16-Lesson-b:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1078:	31 db                	xor    %ebx,%ebx
    107a:	48 83 ec 10          	sub    $0x10,%rsp
    107e:	e8 cd ff ff ff       	callq  1050 <__printf_chk@plt>
    1083:	ba 03 00 00 00       	mov    $0x3,%edx
    ...
    109b:	8b 54 24 10          	mov    0x10(%rsp),%edx
    109f:	bf 01 00 00 00       	mov    $0x1,%edi
    10a4:	31 c0                	xor    %eax,%eax
    10a6:	48 8d 35 57 0f 00 00 	lea    0xf57(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10ad:	48 89 5c 24 08       	mov    %rbx,0x8(%rsp)
    10b2:	e8 99 ff ff ff       	callq  1050 <__printf_chk@plt>
    10b7:	8b 54 24 14          	mov    0x14(%rsp),%edx
    10bb:	bf 01 00 00 00       	mov    $0x1,%edi
    10c0:	31 c0                	xor    %eax,%eax
    10c2:	48 8d 35 3b 0f 00 00 	lea    0xf3b(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10c9:	48 89 5c 24 08       	mov    %rbx,0x8(%rsp)
    10ce:	e8 7d ff ff ff       	callq  1050 <__printf_chk@plt>
    10d3:	48 83 c4 10          	add    $0x10,%rsp
