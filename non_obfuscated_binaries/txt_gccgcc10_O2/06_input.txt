...
/app/bin_gccgcc10_O2/06_input:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a8:	48 8d 3d 67 0f 00 00 	lea    0xf67(%rip),%rdi        # 2016 <_IO_stdin_used+0x16>
    ...
    10c9:	8b 54 24 04          	mov    0x4(%rsp),%edx
    10cd:	31 c0                	xor    %eax,%eax
    10cf:	bf 01 00 00 00       	mov    $0x1,%edi
    10d4:	48 8d 35 29 0f 00 00 	lea    0xf29(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10db:	e8 a0 ff ff ff       	callq  1080 <__printf_chk@plt>
    10e0:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10e5:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10ec:	00 00 
    10ee:	75 07                	jne    10f7 <main+0x57>
    10f0:	31 c0                	xor    %eax,%eax
    10f2:	48 83 c4 18          	add    $0x18,%rsp
    10f6:	c3                   	retq   
    10f7:	e8 74 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
