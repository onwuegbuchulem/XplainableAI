...
/app/bin_gccgcc10_O2/06_typedef:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	41 54                	push   %r12
    1086:	ba 9f 11 00 00       	mov    $0x119f,%edx
    ...
    109b:	f2 0f 10 05 6d 0f 00 	movsd  0xf6d(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    10a2:	00 
    10a3:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10aa:	00 00 
    10ac:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10b1:	31 c0                	xor    %eax,%eax
    10b3:	b8 79 00 00 00       	mov    $0x79,%eax
    10b8:	4c 8d 64 24 08       	lea    0x8(%rsp),%r12
    10bd:	c7 44 24 08 48 61 72 	movl   $0x72726148,0x8(%rsp)
    10c4:	72 
    10c5:	66 89 44 24 0c       	mov    %ax,0xc(%rsp)
    10ca:	4c 89 e1             	mov    %r12,%rcx
    10cd:	48 b8 9f 11 00 00 8f 	movabs $0x4259c28f0000119f,%rax
    10d4:	c2 59 42 
    10d7:	48 89 04 24          	mov    %rax,(%rsp)
    10db:	b8 01 00 00 00       	mov    $0x1,%eax
    10e0:	e8 8b ff ff ff       	callq  1070 <__printf_chk@plt>
    10e5:	8b 14 24             	mov    (%rsp),%edx
    10e8:	66 0f ef c0          	pxor   %xmm0,%xmm0
    10ec:	4c 89 e1             	mov    %r12,%rcx
    ...
    1100:	f3 0f 5a 44 24 04    	cvtss2sd 0x4(%rsp),%xmm0
    1106:	e8 65 ff ff ff       	callq  1070 <__printf_chk@plt>
    110b:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1110:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1117:	00 00 
    1119:	75 09                	jne    1124 <main+0xa4>
    111b:	48 83 c4 20          	add    $0x20,%rsp
