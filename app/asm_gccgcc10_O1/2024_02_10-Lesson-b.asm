...
/app/bin_gccgcc10_O1/2024_02_10-Lesson-b:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    115d:	48 8b 05 bc 2e 00 00 	mov    0x2ebc(%rip),%rax        # 4020 <__environ@@GLIBC_2.2.5>
    1164:	4c 8b 00             	mov    (%rax),%r8
    1167:	4d 85 c0             	test   %r8,%r8
    116a:	74 40                	je     11ac <main+0x63>
    116c:	48 83 c0 08          	add    $0x8,%rax
    1170:	4c 8d 0d 9a 0e 00 00 	lea    0xe9a(%rip),%r9        # 2011 <_IO_stdin_used+0x11>
    1177:	b9 04 00 00 00       	mov    $0x4,%ecx
    117c:	4c 89 c6             	mov    %r8,%rsi
    117f:	4c 89 cf             	mov    %r9,%rdi
    1182:	f3 a6                	repz cmpsb %es:(%rdi),%ds:(%rsi)
    1184:	0f 97 c2             	seta   %dl
    1187:	80 da 00             	sbb    $0x0,%dl
    118a:	84 d2                	test   %dl,%dl
    118c:	74 16                	je     11a4 <main+0x5b>
    118e:	48 89 05 8b 2e 00 00 	mov    %rax,0x2e8b(%rip)        # 4020 <__environ@@GLIBC_2.2.5>
    1195:	48 83 c0 08          	add    $0x8,%rax
    1199:	4c 8b 40 f8          	mov    -0x8(%rax),%r8
    119d:	4d 85 c0             	test   %r8,%r8
    11a0:	75 d5                	jne    1177 <main+0x2e>
    11a2:	eb 08                	jmp    11ac <main+0x63>
    11a4:	4c 89 c7             	mov    %r8,%rdi
    11a7:	e8 a4 fe ff ff       	callq  1050 <puts@plt>
