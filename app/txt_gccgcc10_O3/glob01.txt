...
/app/bin_gccgcc10_O3/glob01:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1064:	83 ff 01             	cmp    $0x1,%edi
    1067:	7e 2e                	jle    1097 <main+0x37>
    1069:	55                   	push   %rbp
    106a:	8d 47 fe             	lea    -0x2(%rdi),%eax
    106d:	53                   	push   %rbx
    106e:	48 8d 6c c6 10       	lea    0x10(%rsi,%rax,8),%rbp
    1073:	48 8d 5e 08          	lea    0x8(%rsi),%rbx
    1077:	51                   	push   %rcx
    1078:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
    107f:	00 
    1080:	48 8b 3b             	mov    (%rbx),%rdi
    1083:	48 83 c3 08          	add    $0x8,%rbx
    1087:	e8 c4 ff ff ff       	callq  1050 <puts@plt>
    108c:	48 39 eb             	cmp    %rbp,%rbx
    108f:	75 ef                	jne    1080 <main+0x20>
    1091:	5a                   	pop    %rdx
