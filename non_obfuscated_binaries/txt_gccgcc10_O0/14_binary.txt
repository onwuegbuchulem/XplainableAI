...
/app/bin_gccgcc10_O0/14_binary:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11d0:	01 c0                	add    %eax,%eax
    11d2:	89 c6                	mov    %eax,%esi
    11d4:	48 8d 3d 3f 0e 00 00 	lea    0xe3f(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    ...
    11ec:	48 8d 3d 27 0e 00 00 	lea    0xe27(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    11f3:	b8 00 00 00 00       	mov    $0x0,%eax
    11f8:	e8 83 fe ff ff       	callq  1080 <printf@plt>
    11fd:	b8 00 00 00 00       	mov    $0x0,%eax
    1202:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1206:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    120d:	00 00 
