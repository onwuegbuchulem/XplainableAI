...
/app/bin_gccgcc10_O0/is_armstrong:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    11c0:	48 89 c6             	mov    %rax,%rsi
    11c3:	48 8d 3d 4d 0e 00 00 	lea    0xe4d(%rip),%rdi        # 2017 <_IO_stdin_used+0x17>
    11ca:	b8 00 00 00 00       	mov    $0x0,%eax
    11cf:	e8 bc fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11d4:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11d7:	89 45 f0             	mov    %eax,-0x10(%rbp)
    11da:	eb 5c                	jmp    1238 <main+0xaf>
    11dc:	8b 55 e8             	mov    -0x18(%rbp),%edx
    11df:	48 63 c2             	movslq %edx,%rax
    11e2:	48 69 c0 67 66 66 66 	imul   $0x66666667,%rax,%rax
    11e9:	48 c1 e8 20          	shr    $0x20,%rax
    11ed:	c1 f8 02             	sar    $0x2,%eax
    11f0:	89 d1                	mov    %edx,%ecx
    11f2:	c1 f9 1f             	sar    $0x1f,%ecx
    11f5:	29 c8                	sub    %ecx,%eax
    11f7:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11fa:	8b 4d f4             	mov    -0xc(%rbp),%ecx
    11fd:	89 c8                	mov    %ecx,%eax
    11ff:	c1 e0 02             	shl    $0x2,%eax
    1202:	01 c8                	add    %ecx,%eax
    1204:	01 c0                	add    %eax,%eax
    1206:	29 c2                	sub    %eax,%edx
    1208:	89 55 f4             	mov    %edx,-0xc(%rbp)
    120b:	8b 45 f4             	mov    -0xc(%rbp),%eax
    120e:	0f af c0             	imul   %eax,%eax
    1211:	0f af 45 f4          	imul   -0xc(%rbp),%eax
    1215:	01 45 ec             	add    %eax,-0x14(%rbp)
    1218:	8b 45 e8             	mov    -0x18(%rbp),%eax
    121b:	48 63 d0             	movslq %eax,%rdx
    121e:	48 69 d2 67 66 66 66 	imul   $0x66666667,%rdx,%rdx
    1225:	48 c1 ea 20          	shr    $0x20,%rdx
    1229:	c1 fa 02             	sar    $0x2,%edx
    122c:	c1 f8 1f             	sar    $0x1f,%eax
    122f:	89 c1                	mov    %eax,%ecx
    1231:	89 d0                	mov    %edx,%eax
    1233:	29 c8                	sub    %ecx,%eax
    1235:	89 45 e8             	mov    %eax,-0x18(%rbp)
    1238:	8b 45 e8             	mov    -0x18(%rbp),%eax
    123b:	85 c0                	test   %eax,%eax
    123d:	75 9d                	jne    11dc <main+0x53>
    123f:	8b 45 ec             	mov    -0x14(%rbp),%eax
    1242:	3b 45 f0             	cmp    -0x10(%rbp),%eax
    1245:	75 18                	jne    125f <main+0xd6>
    1247:	8b 45 f0             	mov    -0x10(%rbp),%eax
    124a:	89 c6                	mov    %eax,%esi
    124c:	48 8d 3d c7 0d 00 00 	lea    0xdc7(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    1253:	b8 00 00 00 00       	mov    $0x0,%eax
    1258:	e8 23 fe ff ff       	callq  1080 <printf@plt>
    125d:	eb 16                	jmp    1275 <main+0xec>
    125f:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1262:	89 c6                	mov    %eax,%esi
    1264:	48 8d 3d cd 0d 00 00 	lea    0xdcd(%rip),%rdi        # 2038 <_IO_stdin_used+0x38>
    126b:	b8 00 00 00 00       	mov    $0x0,%eax
    1270:	e8 0b fe ff ff       	callq  1080 <printf@plt>
    1275:	b8 00 00 00 00       	mov    $0x0,%eax
    127a:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    127e:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    1285:	00 00 
    1287:	74 05                	je     128e <main+0x105>
    1289:	e8 e2 fd ff ff       	callq  1070 <__stack_chk_fail@plt>
    128e:	c9                   	leaveq 
    128f:	c3                   	retq   
