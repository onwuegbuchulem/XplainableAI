...
/app/bin_gccgcc10_O3/AreaOfCircle:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10c9:	48 8d 74 24 14       	lea    0x14(%rsp),%rsi
    10ce:	48 8d 3d 45 0f 00 00 	lea    0xf45(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	e8 b4 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10dc:	66 0f ef c9          	pxor   %xmm1,%xmm1
    10e0:	bf 01 00 00 00       	mov    $0x1,%edi
    10e5:	f3 0f 10 05 5f 0f 00 	movss  0xf5f(%rip),%xmm0        # 204c <_IO_stdin_used+0x4c>
    10ec:	00 
    10ed:	f3 0f 2a 4c 24 14    	cvtsi2ssl 0x14(%rsp),%xmm1
    10f3:	48 8d 35 23 0f 00 00 	lea    0xf23(%rip),%rsi        # 201d <_IO_stdin_used+0x1d>
    10fa:	b8 01 00 00 00       	mov    $0x1,%eax
    10ff:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    1103:	f3 0f 11 4c 24 0c    	movss  %xmm1,0xc(%rsp)
    1109:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    110d:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1111:	e8 6a ff ff ff       	callq  1080 <__printf_chk@plt>
    1116:	f3 0f 10 4c 24 0c    	movss  0xc(%rsp),%xmm1
    111c:	f3 0f 59 0d 2c 0f 00 	mulss  0xf2c(%rip),%xmm1        # 2050 <_IO_stdin_used+0x50>
    1123:	00 
    1124:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1128:	bf 01 00 00 00       	mov    $0x1,%edi
    112d:	b8 01 00 00 00       	mov    $0x1,%eax
    1132:	48 8d 35 f8 0e 00 00 	lea    0xef8(%rip),%rsi        # 2031 <_IO_stdin_used+0x31>
    1139:	f3 0f 5a c1          	cvtss2sd %xmm1,%xmm0
