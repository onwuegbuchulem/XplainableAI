...
/app/bin_gccgcc10_O2/c_atoi_str_to_integer:     file format elf64-x86-64
...
0000000000001210 <c_atoi>:
    ...
    1214:	0f b6 07             	movzbl (%rdi),%eax
    1217:	49 89 f8             	mov    %rdi,%r8
    121a:	8d 50 f7             	lea    -0x9(%rax),%edx
    121d:	80 fa 04             	cmp    $0x4,%dl
    1220:	76 08                	jbe    122a <c_atoi+0x1a>
    1222:	3c 20                	cmp    $0x20,%al
    1224:	0f 85 d4 00 00 00    	jne    12fe <c_atoi+0xee>
    122a:	49 8d 50 01          	lea    0x1(%r8),%rdx
    122e:	31 c9                	xor    %ecx,%ecx
    1230:	84 c0                	test   %al,%al
    1232:	74 53                	je     1287 <c_atoi+0x77>
    1234:	0f b6 02             	movzbl (%rdx),%eax
    1237:	83 c1 01             	add    $0x1,%ecx
    123a:	48 83 c2 01          	add    $0x1,%rdx
    123e:	8d 70 f7             	lea    -0x9(%rax),%esi
    1241:	40 80 fe 04          	cmp    $0x4,%sil
    1245:	76 e9                	jbe    1230 <c_atoi+0x20>
    1247:	3c 20                	cmp    $0x20,%al
    1249:	74 e5                	je     1230 <c_atoi+0x20>
    124b:	3c 2d                	cmp    $0x2d,%al
    124d:	75 31                	jne    1280 <c_atoi+0x70>
    124f:	83 c1 01             	add    $0x1,%ecx
    1252:	48 63 c9             	movslq %ecx,%rcx
    1255:	41 0f b6 04 08       	movzbl (%r8,%rcx,1),%eax
    125a:	83 e8 30             	sub    $0x30,%eax
    125d:	3c 09                	cmp    $0x9,%al
    125f:	0f 87 8b 00 00 00    	ja     12f0 <c_atoi+0xe0>
    1265:	0f be c0             	movsbl %al,%eax
    1268:	41 ba 01 00 00 00    	mov    $0x1,%r10d
    126e:	45 31 c9             	xor    %r9d,%r9d
    1271:	bf ff ff ff ff       	mov    $0xffffffff,%edi
    1276:	f7 d8                	neg    %eax
    1278:	48 63 d0             	movslq %eax,%rdx
    127b:	eb 2c                	jmp    12a9 <c_atoi+0x99>
    127d:	0f 1f 00             	nopl   (%rax)
    1280:	3c 2b                	cmp    $0x2b,%al
    1282:	75 03                	jne    1287 <c_atoi+0x77>
    1284:	83 c1 01             	add    $0x1,%ecx
    1287:	48 63 c9             	movslq %ecx,%rcx
    128a:	41 0f b6 04 08       	movzbl (%r8,%rcx,1),%eax
    128f:	8d 50 d0             	lea    -0x30(%rax),%edx
    1292:	80 fa 09             	cmp    $0x9,%dl
    1295:	77 59                	ja     12f0 <c_atoi+0xe0>
    1297:	48 0f be d2          	movsbq %dl,%rdx
    129b:	45 31 d2             	xor    %r10d,%r10d
    129e:	41 b9 01 00 00 00    	mov    $0x1,%r9d
    12a4:	bf 01 00 00 00       	mov    $0x1,%edi
    12a9:	49 8d 74 08 01       	lea    0x1(%r8,%rcx,1),%rsi
    12ae:	eb 2b                	jmp    12db <c_atoi+0xcb>
    12b0:	0f be c0             	movsbl %al,%eax
    12b3:	48 8d 0c 92          	lea    (%rdx,%rdx,4),%rcx
    12b7:	0f af c7             	imul   %edi,%eax
    12ba:	48 98                	cltq   
    12bc:	48 8d 04 48          	lea    (%rax,%rcx,2),%rax
    12c0:	48 39 d0             	cmp    %rdx,%rax
    12c3:	7d 05                	jge    12ca <c_atoi+0xba>
    12c5:	45 84 c9             	test   %r9b,%r9b
    12c8:	75 2e                	jne    12f8 <c_atoi+0xe8>
    12ca:	48 83 c6 01          	add    $0x1,%rsi
    12ce:	48 39 d0             	cmp    %rdx,%rax
    12d1:	7e 05                	jle    12d8 <c_atoi+0xc8>
    12d3:	45 84 d2             	test   %r10b,%r10b
    12d6:	75 18                	jne    12f0 <c_atoi+0xe0>
    12d8:	48 89 c2             	mov    %rax,%rdx
    12db:	0f b6 06             	movzbl (%rsi),%eax
    12de:	83 e8 30             	sub    $0x30,%eax
    12e1:	3c 09                	cmp    $0x9,%al
    12e3:	76 cb                	jbe    12b0 <c_atoi+0xa0>
    ...
    1300:	e9 46 ff ff ff       	jmpq   124b <c_atoi+0x3b>
