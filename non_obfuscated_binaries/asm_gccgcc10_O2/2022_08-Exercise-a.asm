...
/app/bin_gccgcc10_O2/2022_08-Exercise-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1084:	55                   	push   %rbp
    1085:	48 8d 2d 78 0f 00 00 	lea    0xf78(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    108c:	53                   	push   %rbx
    108d:	bb 41 00 00 00       	mov    $0x41,%ebx
    1092:	48 83 ec 08          	sub    $0x8,%rsp
    1096:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    109d:	00 00 00 
    10a0:	8d 4b 20             	lea    0x20(%rbx),%ecx
    10a3:	89 da                	mov    %ebx,%edx
    10a5:	48 89 ee             	mov    %rbp,%rsi
    10a8:	bf 01 00 00 00       	mov    $0x1,%edi
    10ad:	31 c0                	xor    %eax,%eax
    10af:	83 c3 01             	add    $0x1,%ebx
    10b2:	e8 b9 ff ff ff       	callq  1070 <__printf_chk@plt>
    10b7:	83 fb 5b             	cmp    $0x5b,%ebx
    10ba:	75 e4                	jne    10a0 <main+0x20>
    10bc:	48 8b 35 4d 2f 00 00 	mov    0x2f4d(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10c3:	bf 0a 00 00 00       	mov    $0xa,%edi
    10c8:	e8 93 ff ff ff       	callq  1060 <putc@plt>
    10cd:	48 83 c4 08          	add    $0x8,%rsp
