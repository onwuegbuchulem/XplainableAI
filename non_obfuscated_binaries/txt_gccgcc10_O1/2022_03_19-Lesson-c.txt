...
/app/bin_gccgcc10_O1/2022_03_19-Lesson-c:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d f3 00 00 00 	lea    0xf3(%rip),%rdi        # 117b <main>
...
0000000000001149 <memzero>:
    ...
    114d:	c7 44 24 fc 00 00 00 	movl   $0x0,-0x4(%rsp)
    1154:	00 
    1155:	8b 44 24 fc          	mov    -0x4(%rsp),%eax
    1159:	39 c6                	cmp    %eax,%esi
    115b:	7e 1d                	jle    117a <memzero+0x31>
    115d:	8b 44 24 fc          	mov    -0x4(%rsp),%eax
    1161:	48 98                	cltq   
    1163:	c6 04 07 00          	movb   $0x0,(%rdi,%rax,1)
    1167:	8b 44 24 fc          	mov    -0x4(%rsp),%eax
    116b:	83 c0 01             	add    $0x1,%eax
    116e:	89 44 24 fc          	mov    %eax,-0x4(%rsp)
    1172:	8b 44 24 fc          	mov    -0x4(%rsp),%eax
    1176:	39 f0                	cmp    %esi,%eax
    1178:	7c e3                	jl     115d <memzero+0x14>
    117a:	c3                   	retq   

000000000000117b <main>:
    117b:	f3 0f 1e fa          	endbr64 
    117f:	48 83 ec 38          	sub    $0x38,%rsp
    1183:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    118a:	00 00 
    118c:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    1191:	31 c0                	xor    %eax,%eax
    1193:	48 89 e7             	mov    %rsp,%rdi
    1196:	be 28 00 00 00       	mov    $0x28,%esi
    119b:	e8 a9 ff ff ff       	callq  1149 <memzero>
    11a0:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    11a5:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11ac:	00 00 
    11ae:	75 0a                	jne    11ba <main+0x3f>
    11b0:	b8 00 00 00 00       	mov    $0x0,%eax
    11b5:	48 83 c4 38          	add    $0x38,%rsp
    11b9:	c3                   	retq   
    11ba:	e8 91 fe ff ff       	callq  1050 <__stack_chk_fail@plt>
    11bf:	90                   	nop
