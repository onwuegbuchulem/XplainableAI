...
/app/bin_gccgcc10_O3/hexencode01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10cc:	48 8d 2d 41 0f 00 00 	lea    0xf41(%rip),%rbp        # 2014 <_IO_stdin_used+0x14>
    10d3:	53                   	push   %rbx
    10d4:	48 83 ec 08          	sub    $0x8,%rsp
    10d8:	e8 a3 ff ff ff       	callq  1080 <puts@plt>
    10dd:	bb 12 00 00 00       	mov    $0x12,%ebx
    10e2:	eb 18                	jmp    10fc <main+0x3c>
    ...
    10f7:	83 eb 01             	sub    $0x1,%ebx
    10fa:	74 2c                	je     1128 <main+0x68>
    10fc:	48 8b 3d 1d 2f 00 00 	mov    0x2f1d(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    1103:	e8 a8 ff ff ff       	callq  10b0 <getc@plt>
    1108:	89 c2                	mov    %eax,%edx
    110a:	83 f8 ff             	cmp    $0xffffffff,%eax
    110d:	75 d9                	jne    10e8 <main+0x28>
    110f:	48 8d 3d 04 0f 00 00 	lea    0xf04(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    1116:	e8 65 ff ff ff       	callq  1080 <puts@plt>
    111b:	48 83 c4 08          	add    $0x8,%rsp
    ...
    1134:	e8 57 ff ff ff       	callq  1090 <putc@plt>
    1139:	eb a2                	jmp    10dd <main+0x1d>
