...
/app/bin_gccgcc10_O0/assignment25:     file format elf64-x86-64
...
00000000000010c0 <close@plt>:
    ...
    10c4:	f2 ff 25 fd 2e 00 00 	bnd jmpq *0x2efd(%rip)        # 3fc8 <close@GLIBC_2.2.5>
...
00000000000011c9 <main>:
    ...
    11d5:	ba c0 01 00 00       	mov    $0x1c0,%edx
    11da:	be 41 00 00 00       	mov    $0x41,%esi
    11df:	48 8d 3d 22 0e 00 00 	lea    0xe22(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11e6:	b8 00 00 00 00       	mov    $0x0,%eax
    11eb:	e8 e0 fe ff ff       	callq  10d0 <open@plt>
    11f0:	89 45 f8             	mov    %eax,-0x8(%rbp)
    11f3:	83 7d f8 00          	cmpl   $0x0,-0x8(%rbp)
    11f7:	79 18                	jns    1211 <main+0x48>
    11f9:	48 8d 3d 15 0e 00 00 	lea    0xe15(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    1200:	b8 00 00 00 00       	mov    $0x0,%eax
    1205:	e8 a6 fe ff ff       	callq  10b0 <printf@plt>
    120a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    120f:	eb 7f                	jmp    1290 <main+0xc7>
    ...
    1220:	ba 1e 00 00 00       	mov    $0x1e,%edx
    1225:	48 8d 35 24 0e 00 00 	lea    0xe24(%rip),%rsi        # 2050 <_IO_stdin_used+0x50>
    122c:	89 c7                	mov    %eax,%edi
    122e:	e8 6d fe ff ff       	callq  10a0 <write@plt>
    1233:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1236:	83 7d fc 1e          	cmpl   $0x1e,-0x4(%rbp)
    123a:	74 18                	je     1254 <main+0x8b>
    123c:	48 8d 3d 2b 0e 00 00 	lea    0xe2b(%rip),%rdi        # 206e <_IO_stdin_used+0x6e>
    1243:	b8 00 00 00 00       	mov    $0x0,%eax
    1248:	e8 63 fe ff ff       	callq  10b0 <printf@plt>
    124d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    1252:	eb 3c                	jmp    1290 <main+0xc7>
    1254:	48 8d 3d 35 0e 00 00 	lea    0xe35(%rip),%rdi        # 2090 <_IO_stdin_used+0x90>
    125b:	b8 00 00 00 00       	mov    $0x0,%eax
    1260:	e8 4b fe ff ff       	callq  10b0 <printf@plt>
    1265:	8b 45 f8             	mov    -0x8(%rbp),%eax
    1268:	89 c7                	mov    %eax,%edi
    126a:	e8 51 fe ff ff       	callq  10c0 <close@plt>
    126f:	85 c0                	test   %eax,%eax
    1271:	74 18                	je     128b <main+0xc2>
    1273:	48 8d 3d 35 0e 00 00 	lea    0xe35(%rip),%rdi        # 20af <_IO_stdin_used+0xaf>
    127a:	b8 00 00 00 00       	mov    $0x0,%eax
    127f:	e8 2c fe ff ff       	callq  10b0 <printf@plt>
    1284:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
    1289:	eb 05                	jmp    1290 <main+0xc7>
