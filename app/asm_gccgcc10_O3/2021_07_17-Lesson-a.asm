...
/app/bin_gccgcc10_O3/2021_07_17-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ab:	00 00 00 
    10ae:	41 54                	push   %r12
    10b0:	4c 8d 25 a9 0f 00 00 	lea    0xfa9(%rip),%r12        # 2060 <_IO_stdin_used+0x60>
    10b7:	55                   	push   %rbp
    ...
    10d0:	74 5e                	je     1130 <main+0x90>
    10d2:	83 f8 61             	cmp    $0x61,%eax
    10d5:	74 19                	je     10f0 <main+0x50>
    10d7:	83 f8 7a             	cmp    $0x7a,%eax
    10da:	74 44                	je     1120 <main+0x80>
    10dc:	83 f8 3f             	cmp    $0x3f,%eax
    10df:	74 1f                	je     1100 <main+0x60>
    10e1:	48 8d 3d 67 0f 00 00 	lea    0xf67(%rip),%rdi        # 204f <_IO_stdin_used+0x4f>
    10e8:	e8 83 ff ff ff       	callq  1070 <puts@plt>
    10ed:	eb d1                	jmp    10c0 <main+0x20>
    10ef:	90                   	nop
    10f0:	48 8d 3d 0d 0f 00 00 	lea    0xf0d(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    10f7:	e8 74 ff ff ff       	callq  1070 <puts@plt>
    10fc:	eb c2                	jmp    10c0 <main+0x20>
    10fe:	66 90                	xchg   %ax,%ax
    1100:	8b 15 1a 2f 00 00    	mov    0x2f1a(%rip),%edx        # 4020 <optopt@@GLIBC_2.2.5>
    1106:	48 8d 35 25 0f 00 00 	lea    0xf25(%rip),%rsi        # 2032 <_IO_stdin_used+0x32>
    110d:	bf 01 00 00 00       	mov    $0x1,%edi
    1112:	31 c0                	xor    %eax,%eax
    1114:	e8 67 ff ff ff       	callq  1080 <__printf_chk@plt>
    1119:	eb a5                	jmp    10c0 <main+0x20>
    111b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1120:	48 8d 3d f4 0e 00 00 	lea    0xef4(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
...
00000000000011e0 <__do_global_dtors_aux>:
    ...
    11e4:	80 3d 59 2e 00 00 00 	cmpb   $0x0,0x2e59(%rip)        # 4044 <completed.0>
    ...
    120c:	c6 05 31 2e 00 00 01 	movb   $0x1,0x2e31(%rip)        # 4044 <completed.0>
    1213:	5d                   	pop    %rbp
    1214:	c3                   	retq   
