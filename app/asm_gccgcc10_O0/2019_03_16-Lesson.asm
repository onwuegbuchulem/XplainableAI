...
/app/bin_gccgcc10_O0/2019_03_16-Lesson:     file format elf64-x86-64
...
0000000000001070 <putchar@plt>:
    ...
    1074:	f2 ff 25 55 2f 00 00 	bnd jmpq *0x2f55(%rip)        # 3fd0 <putchar@GLIBC_2.2.5>
...
0000000000001169 <main>:
    ...
    117c:	e8 df fe ff ff       	callq  1060 <getenv@plt>
    1181:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    1185:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1189:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    118d:	eb 2d                	jmp    11bc <main+0x53>
    118f:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    1193:	0f b6 00             	movzbl (%rax),%eax
    1196:	3c 3a                	cmp    $0x3a,%al
    1198:	75 0c                	jne    11a6 <main+0x3d>
    119a:	bf 0a 00 00 00       	mov    $0xa,%edi
    119f:	e8 cc fe ff ff       	callq  1070 <putchar@plt>
    11a4:	eb 11                	jmp    11b7 <main+0x4e>
    11a6:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    11aa:	0f b6 00             	movzbl (%rax),%eax
    11ad:	0f be c0             	movsbl %al,%eax
    11b0:	89 c7                	mov    %eax,%edi
    11b2:	e8 b9 fe ff ff       	callq  1070 <putchar@plt>
    11b7:	48 83 45 f0 01       	addq   $0x1,-0x10(%rbp)
    11bc:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    11c0:	0f b6 00             	movzbl (%rax),%eax
    11c3:	84 c0                	test   %al,%al
    11c5:	75 c8                	jne    118f <main+0x26>
    11c7:	bf 0a 00 00 00       	mov    $0xa,%edi
    11cc:	e8 9f fe ff ff       	callq  1070 <putchar@plt>
