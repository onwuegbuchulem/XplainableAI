...
/app/bin_gccgcc8_O0/WeekDays_Switch:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11f0:	83 f8 07             	cmp    $0x7,%eax
    11f3:	0f 87 85 00 00 00    	ja     127e <main+0xd5>
    11f9:	89 c0                	mov    %eax,%eax
    11fb:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
    1202:	00 
    1203:	48 8d 05 86 0e 00 00 	lea    0xe86(%rip),%rax        # 2090 <_IO_stdin_used+0x90>
    120a:	8b 04 02             	mov    (%rdx,%rax,1),%eax
    120d:	48 98                	cltq   
    120f:	48 8d 15 7a 0e 00 00 	lea    0xe7a(%rip),%rdx        # 2090 <_IO_stdin_used+0x90>
    1216:	48 01 d0             	add    %rdx,%rax
    1219:	3e ff e0             	notrack jmpq *%rax
    121c:	48 8d 3d fb 0d 00 00 	lea    0xdfb(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    1223:	e8 58 fe ff ff       	callq  1080 <puts@plt>
    1228:	eb 65                	jmp    128f <main+0xe6>
    122a:	48 8d 3d f4 0d 00 00 	lea    0xdf4(%rip),%rdi        # 2025 <_IO_stdin_used+0x25>
    1231:	e8 4a fe ff ff       	callq  1080 <puts@plt>
    1236:	eb 57                	jmp    128f <main+0xe6>
    1238:	48 8d 3d ed 0d 00 00 	lea    0xded(%rip),%rdi        # 202c <_IO_stdin_used+0x2c>
    123f:	e8 3c fe ff ff       	callq  1080 <puts@plt>
    1244:	eb 49                	jmp    128f <main+0xe6>
    1246:	48 8d 3d e7 0d 00 00 	lea    0xde7(%rip),%rdi        # 2034 <_IO_stdin_used+0x34>
    124d:	e8 2e fe ff ff       	callq  1080 <puts@plt>
    1252:	eb 3b                	jmp    128f <main+0xe6>
    1254:	48 8d 3d e3 0d 00 00 	lea    0xde3(%rip),%rdi        # 203e <_IO_stdin_used+0x3e>
    125b:	e8 20 fe ff ff       	callq  1080 <puts@plt>
    1260:	eb 2d                	jmp    128f <main+0xe6>
    1262:	48 8d 3d de 0d 00 00 	lea    0xdde(%rip),%rdi        # 2047 <_IO_stdin_used+0x47>
    1269:	e8 12 fe ff ff       	callq  1080 <puts@plt>
    126e:	eb 1f                	jmp    128f <main+0xe6>
    1270:	48 8d 3d d7 0d 00 00 	lea    0xdd7(%rip),%rdi        # 204e <_IO_stdin_used+0x4e>
    1277:	e8 04 fe ff ff       	callq  1080 <puts@plt>
    127c:	eb 11                	jmp    128f <main+0xe6>
    127e:	48 8d 3d d3 0d 00 00 	lea    0xdd3(%rip),%rdi        # 2058 <_IO_stdin_used+0x58>
    1285:	b8 00 00 00 00       	mov    $0x0,%eax
    128a:	e8 11 fe ff ff       	callq  10a0 <printf@plt>
    128f:	b8 00 00 00 00       	mov    $0x0,%eax
    1294:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1298:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    129f:	00 00 
    12a1:	74 05                	je     12a8 <main+0xff>
    12a3:	e8 e8 fd ff ff       	callq  1090 <__stack_chk_fail@plt>
    12a8:	c9                   	leaveq 
    12a9:	c3                   	retq   
