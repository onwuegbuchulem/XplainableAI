...
/app/bin_gccgcc10_O2/strupper:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10e0:	e8 2b 01 00 00       	callq  1210 <strupper>
...
0000000000001210 <strupper>:
    1210:	f3 0f 1e fa          	endbr64 
    1214:	eb 1b                	jmp    1231 <strupper+0x21>
    1216:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    121d:	00 00 00 
    1220:	8d 50 9f             	lea    -0x61(%rax),%edx
    1223:	80 fa 19             	cmp    $0x19,%dl
    1226:	77 05                	ja     122d <strupper+0x1d>
    1228:	83 e0 df             	and    $0xffffffdf,%eax
    122b:	88 07                	mov    %al,(%rdi)
    122d:	48 83 c7 01          	add    $0x1,%rdi
    1231:	0f b6 07             	movzbl (%rdi),%eax
    1234:	84 c0                	test   %al,%al
    1236:	75 e8                	jne    1220 <strupper+0x10>
    1238:	c3                   	retq   
