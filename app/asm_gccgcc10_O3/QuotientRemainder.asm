...
/app/bin_gccgcc10_O3/QuotientRemainder:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10dc:	48 8d 35 35 0f 00 00 	lea    0xf35(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    ...
    10f4:	48 8d 3d 1a 0f 00 00 	lea    0xf1a(%rip),%rdi        # 2015 <_IO_stdin_used+0x15>
    ...
    110a:	48 8d 35 18 0f 00 00 	lea    0xf18(%rip),%rsi        # 2029 <_IO_stdin_used+0x29>
    1111:	99                   	cltd   
    1112:	f7 7c 24 04          	idivl  0x4(%rsp)
    1116:	41 89 d4             	mov    %edx,%r12d
    1119:	89 c2                	mov    %eax,%edx
    111b:	31 c0                	xor    %eax,%eax
    111d:	e8 5e ff ff ff       	callq  1080 <__printf_chk@plt>
    1122:	31 c0                	xor    %eax,%eax
    1124:	44 89 e2             	mov    %r12d,%edx
    1127:	bf 01 00 00 00       	mov    $0x1,%edi
    112c:	48 8d 35 05 0f 00 00 	lea    0xf05(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    1133:	e8 48 ff ff ff       	callq  1080 <__printf_chk@plt>
    1138:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    113d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1144:	00 00 
    1146:	75 09                	jne    1151 <main+0xb1>
    1148:	48 83 c4 10          	add    $0x10,%rsp
    114c:	31 c0                	xor    %eax,%eax
    114e:	41 5c                	pop    %r12
    1150:	c3                   	retq   
    1151:	e8 1a ff ff ff       	callq  1070 <__stack_chk_fail@plt>
