...
/app/bin_gccgcc10_O2/Table_Loops:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    107d:	00 00 00 
    1080:	44 8d 04 9b          	lea    (%rbx,%rbx,4),%r8d
    1084:	89 d9                	mov    %ebx,%ecx
    1086:	ba 05 00 00 00       	mov    $0x5,%edx
    108b:	48 89 ee             	mov    %rbp,%rsi
    108e:	bf 01 00 00 00       	mov    $0x1,%edi
    1093:	31 c0                	xor    %eax,%eax
    1095:	83 c3 01             	add    $0x1,%ebx
    1098:	e8 b3 ff ff ff       	callq  1050 <__printf_chk@plt>
    109d:	83 fb 0b             	cmp    $0xb,%ebx
    10a0:	75 de                	jne    1080 <main+0x20>
