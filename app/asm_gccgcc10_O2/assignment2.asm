...
/app/bin_gccgcc10_O2/assignment2:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10a0:	48 b8 48 65 6c 6c 6f 	movabs $0x57202c6f6c6c6548,%rax
    10a7:	2c 20 57 
    10aa:	48 8d 35 53 0f 00 00 	lea    0xf53(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    10b1:	c7 44 24 12 6f 72 6c 	movl   $0x646c726f,0x12(%rsp)
    10b8:	64 
    10b9:	48 89 44 24 0a       	mov    %rax,0xa(%rsp)
    10be:	b8 21 00 00 00       	mov    $0x21,%eax
    10c3:	66 89 44 24 16       	mov    %ax,0x16(%rsp)
    10c8:	31 c0                	xor    %eax,%eax
    10ca:	e8 a1 ff ff ff       	callq  1070 <__printf_chk@plt>
    10cf:	bf 01 00 00 00       	mov    $0x1,%edi
    10d4:	b8 01 00 00 00       	mov    $0x1,%eax
    10d9:	f2 0f 10 05 57 0f 00 	movsd  0xf57(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    10e0:	00 
    10e1:	48 8d 35 2f 0f 00 00 	lea    0xf2f(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    10e8:	e8 83 ff ff ff       	callq  1070 <__printf_chk@plt>
    10ed:	31 c0                	xor    %eax,%eax
    10ef:	48 8d 54 24 0a       	lea    0xa(%rsp),%rdx
    10f4:	48 8d 35 2c 0f 00 00 	lea    0xf2c(%rip),%rsi        # 2027 <_IO_stdin_used+0x27>
    10fb:	bf 01 00 00 00       	mov    $0x1,%edi
    1100:	e8 6b ff ff ff       	callq  1070 <__printf_chk@plt>
    1105:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    110a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1111:	00 00 
    1113:	75 07                	jne    111c <main+0x9c>
