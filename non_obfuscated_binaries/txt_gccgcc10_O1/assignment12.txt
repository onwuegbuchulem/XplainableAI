...
/app/bin_gccgcc10_O1/assignment12:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    120a:	e8 b1 fe ff ff       	callq  10c0 <time@plt>
    120f:	48 89 c7             	mov    %rax,%rdi
    1212:	e8 99 fe ff ff       	callq  10b0 <srand@plt>
    1217:	48 8d 35 ea 0d 00 00 	lea    0xdea(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    121e:	bf 01 00 00 00       	mov    $0x1,%edi
    1223:	b8 00 00 00 00       	mov    $0x0,%eax
    1228:	e8 a3 fe ff ff       	callq  10d0 <__printf_chk@plt>
    122d:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    1232:	48 8d 3d 4d 0e 00 00 	lea    0xe4d(%rip),%rdi        # 2086 <_IO_stdin_used+0x86>
    1239:	b8 00 00 00 00       	mov    $0x0,%eax
    123e:	e8 9d fe ff ff       	callq  10e0 <__isoc99_scanf@plt>
    1243:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1247:	85 d2                	test   %edx,%edx
    1249:	7e 44                	jle    128f <main+0xa6>
    124b:	bd 00 00 00 00       	mov    $0x0,%ebp
    1250:	41 bc 00 00 00 00    	mov    $0x0,%r12d
    1256:	bb 00 00 00 00       	mov    $0x0,%ebx
    125b:	eb 0f                	jmp    126c <main+0x83>
    125d:	41 83 c4 01          	add    $0x1,%r12d
    1261:	83 c3 01             	add    $0x1,%ebx
    1264:	8b 54 24 04          	mov    0x4(%rsp),%edx
    1268:	39 da                	cmp    %ebx,%edx
    126a:	7e 2e                	jle    129a <main+0xb1>
    126c:	e8 7f fe ff ff       	callq  10f0 <rand@plt>
    1271:	89 c2                	mov    %eax,%edx
    1273:	c1 ea 1f             	shr    $0x1f,%edx
    1276:	01 d0                	add    %edx,%eax
    1278:	83 e0 01             	and    $0x1,%eax
    127b:	29 d0                	sub    %edx,%eax
    127d:	8d 50 01             	lea    0x1(%rax),%edx
    1280:	74 db                	je     125d <main+0x74>
    1282:	83 fa 02             	cmp    $0x2,%edx
    1285:	0f 94 c0             	sete   %al
    1288:	0f b6 c0             	movzbl %al,%eax
    128b:	01 c5                	add    %eax,%ebp
    128d:	eb d2                	jmp    1261 <main+0x78>
    128f:	bd 00 00 00 00       	mov    $0x0,%ebp
    1294:	41 bc 00 00 00 00    	mov    $0x0,%r12d
    129a:	41 89 e8             	mov    %ebp,%r8d
    129d:	44 89 e1             	mov    %r12d,%ecx
    12a0:	48 8d 35 99 0d 00 00 	lea    0xd99(%rip),%rsi        # 2040 <_IO_stdin_used+0x40>
    12a7:	bf 01 00 00 00       	mov    $0x1,%edi
    12ac:	b8 00 00 00 00       	mov    $0x0,%eax
    12b1:	e8 1a fe ff ff       	callq  10d0 <__printf_chk@plt>
    12b6:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    12bb:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12c2:	00 00 
    12c4:	75 09                	jne    12cf <main+0xe6>
    12c6:	48 83 c4 10          	add    $0x10,%rsp
    12ca:	5b                   	pop    %rbx
    12cb:	5d                   	pop    %rbp
    12cc:	41 5c                	pop    %r12
    12ce:	c3                   	retq   
    12cf:	e8 cc fd ff ff       	callq  10a0 <__stack_chk_fail@plt>
