...
/app/bin_gccgcc10_O1/Division:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ce:	99                   	cltd   
    11cf:	f7 7c 24 04          	idivl  0x4(%rsp)
    11d3:	89 c2                	mov    %eax,%edx
    11d5:	48 8d 35 43 0e 00 00 	lea    0xe43(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    ...
    11f7:	00 00 
    11f9:	75 05                	jne    1200 <main+0x77>
    11fb:	48 83 c4 18          	add    $0x18,%rsp
    11ff:	c3                   	retq   
