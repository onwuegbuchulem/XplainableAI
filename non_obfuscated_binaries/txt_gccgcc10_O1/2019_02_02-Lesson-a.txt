...
/app/bin_gccgcc10_O1/2019_02_02-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d f0 00 00 00 	lea    0xf0(%rip),%rdi        # 1198 <main>
...
0000000000001169 <change>:
    1169:	f3 0f 1e fa          	endbr64 
    116d:	c6 47 01 69          	movb   $0x69,0x1(%rdi)
    1171:	c3                   	retq   

0000000000001172 <output>:
    1172:	f3 0f 1e fa          	endbr64 
    1176:	48 83 ec 08          	sub    $0x8,%rsp
    117a:	48 89 fa             	mov    %rdi,%rdx
    117d:	48 8d 35 80 0e 00 00 	lea    0xe80(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1184:	bf 01 00 00 00       	mov    $0x1,%edi
    1189:	b8 00 00 00 00       	mov    $0x0,%eax
    118e:	e8 dd fe ff ff       	callq  1070 <__printf_chk@plt>
...
0000000000001198 <main>:
    ...
    11a8:	00 00 
    11aa:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11af:	31 c0                	xor    %eax,%eax
    11b1:	c7 44 24 04 66 61 74 	movl   $0x746166,0x4(%rsp)
    11b8:	00 
    11b9:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx
    11be:	48 89 df             	mov    %rbx,%rdi
    11c1:	e8 ac ff ff ff       	callq  1172 <output>
    11c6:	c6 44 24 05 69       	movb   $0x69,0x5(%rsp)
    11cb:	48 89 df             	mov    %rbx,%rdi
    11ce:	e8 9f ff ff ff       	callq  1172 <output>
    11d3:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11d8:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11df:	00 00 
    11e1:	75 0b                	jne    11ee <main+0x56>
