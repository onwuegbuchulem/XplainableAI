...
/app/bin_gccgcc10_O0/censored01:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1175:	eb 44                	jmp    11bb <main+0x52>
    1177:	8b 45 fc             	mov    -0x4(%rbp),%eax
    117a:	83 e8 41             	sub    $0x41,%eax
    117d:	83 f8 34             	cmp    $0x34,%eax
    1180:	77 2f                	ja     11b1 <main+0x48>
    1182:	89 c0                	mov    %eax,%eax
    1184:	48 8d 14 85 00 00 00 	lea    0x0(,%rax,4),%rdx
    118b:	00 
    118c:	48 8d 05 71 0e 00 00 	lea    0xe71(%rip),%rax        # 2004 <_IO_stdin_used+0x4>
    1193:	8b 04 02             	mov    (%rdx,%rax,1),%eax
    1196:	48 98                	cltq   
    1198:	48 8d 15 65 0e 00 00 	lea    0xe65(%rip),%rdx        # 2004 <_IO_stdin_used+0x4>
    119f:	48 01 d0             	add    %rdx,%rax
    11a2:	3e ff e0             	notrack jmpq *%rax
    11a5:	bf 2a 00 00 00       	mov    $0x2a,%edi
    11aa:	e8 b1 fe ff ff       	callq  1060 <putchar@plt>
    11af:	eb 0a                	jmp    11bb <main+0x52>
    11b1:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11b4:	89 c7                	mov    %eax,%edi
    11b6:	e8 a5 fe ff ff       	callq  1060 <putchar@plt>
    11bb:	e8 b0 fe ff ff       	callq  1070 <getchar@plt>
    11c0:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11c3:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%rbp)
    11c7:	75 ae                	jne    1177 <main+0xe>
