...
/app/bin_gccgcc10_O1/filter03:     file format elf64-x86-64
...
0000000000001120 <_start>:
    ...
    1131:	50                   	push   %rax
    1132:	54                   	push   %rsp
    1133:	4c 8d 05 d6 01 00 00 	lea    0x1d6(%rip),%r8        # 1310 <__libc_csu_fini>
    113a:	48 8d 0d 5f 01 00 00 	lea    0x15f(%rip),%rcx        # 12a0 <__libc_csu_init>
...
0000000000001209 <main>:
    ...
    120d:	53                   	push   %rbx
    120e:	bf 00 00 00 00       	mov    $0x0,%edi
    1213:	e8 c8 fe ff ff       	callq  10e0 <time@plt>
    1218:	48 89 c7             	mov    %rax,%rdi
    121b:	e8 a0 fe ff ff       	callq  10c0 <srand@plt>
    1220:	eb 0e                	jmp    1230 <main+0x27>
    1222:	48 8b 35 e7 2d 00 00 	mov    0x2de7(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1229:	89 df                	mov    %ebx,%edi
    122b:	e8 a0 fe ff ff       	callq  10d0 <putc@plt>
    1230:	48 8b 3d e9 2d 00 00 	mov    0x2de9(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    1237:	e8 b4 fe ff ff       	callq  10f0 <getc@plt>
    123c:	89 c3                	mov    %eax,%ebx
    123e:	83 f8 ff             	cmp    $0xffffffff,%eax
    1241:	74 51                	je     1294 <main+0x8b>
    1243:	e8 b8 fe ff ff       	callq  1100 <rand@plt>
    1248:	a8 01                	test   $0x1,%al
    124a:	74 1d                	je     1269 <main+0x60>
    124c:	8d 83 80 00 00 00    	lea    0x80(%rbx),%eax
    1252:	3d 7f 01 00 00       	cmp    $0x17f,%eax
    1257:	77 c9                	ja     1222 <main+0x19>
    1259:	e8 52 fe ff ff       	callq  10b0 <__ctype_toupper_loc@plt>
    125e:	48 63 db             	movslq %ebx,%rbx
    1261:	48 8b 00             	mov    (%rax),%rax
    1264:	8b 1c 98             	mov    (%rax,%rbx,4),%ebx
    1267:	eb b9                	jmp    1222 <main+0x19>
    1269:	8d 83 80 00 00 00    	lea    0x80(%rbx),%eax
    126f:	3d 7f 01 00 00       	cmp    $0x17f,%eax
    1274:	77 0e                	ja     1284 <main+0x7b>
    1276:	e8 95 fe ff ff       	callq  1110 <__ctype_tolower_loc@plt>
    127b:	48 63 db             	movslq %ebx,%rbx
    127e:	48 8b 00             	mov    (%rax),%rax
    1281:	8b 1c 98             	mov    (%rax,%rbx,4),%ebx
    1284:	48 8b 35 85 2d 00 00 	mov    0x2d85(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    128b:	89 df                	mov    %ebx,%edi
    128d:	e8 3e fe ff ff       	callq  10d0 <putc@plt>
    1292:	eb 9c                	jmp    1230 <main+0x27>
