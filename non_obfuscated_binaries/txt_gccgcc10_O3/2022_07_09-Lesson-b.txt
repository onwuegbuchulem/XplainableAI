...
/app/bin_gccgcc10_O3/2022_07_09-Lesson-b:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10b2:	48 83 ec 40          	sub    $0x40,%rsp
    10b6:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10bd:	00 00 
    10bf:	48 89 44 24 38       	mov    %rax,0x38(%rsp)
    10c4:	31 c0                	xor    %eax,%eax
    10c6:	4c 8d 64 24 10       	lea    0x10(%rsp),%r12
    10cb:	48 c7 44 24 08 20 00 	movq   $0x20,0x8(%rsp)
    10d2:	00 00 
    10d4:	4c 89 24 24          	mov    %r12,(%rsp)
    10d8:	e8 a3 ff ff ff       	callq  1080 <__printf_chk@plt>
    10dd:	48 8b 15 2c 2f 00 00 	mov    0x2f2c(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    10e4:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    10e9:	48 89 e7             	mov    %rsp,%rdi
    10ec:	e8 9f ff ff ff       	callq  1090 <getline@plt>
    10f1:	48 8d 35 1d 0f 00 00 	lea    0xf1d(%rip),%rsi        # 2015 <_IO_stdin_used+0x15>
    10f8:	bf 01 00 00 00       	mov    $0x1,%edi
    10fd:	48 89 c2             	mov    %rax,%rdx
    1100:	31 c0                	xor    %eax,%eax
    1102:	e8 79 ff ff ff       	callq  1080 <__printf_chk@plt>
    1107:	31 c0                	xor    %eax,%eax
    1109:	4c 89 e2             	mov    %r12,%rdx
    110c:	bf 01 00 00 00       	mov    $0x1,%edi
    1111:	48 8d 35 18 0f 00 00 	lea    0xf18(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    1118:	e8 63 ff ff ff       	callq  1080 <__printf_chk@plt>
    111d:	48 8b 44 24 38       	mov    0x38(%rsp),%rax
    1122:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1129:	00 00 
    112b:	75 09                	jne    1136 <main+0x96>
    112d:	48 83 c4 40          	add    $0x40,%rsp
