...
/app/bin_gccgcc10_O1/2024_05_04-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    1193:	48 8d 2d 6a 0e 00 00 	lea    0xe6a(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    119a:	eb 12                	jmp    11ae <main+0x25>
    ...
    11ae:	48 8b 3d 6b 2e 00 00 	mov    0x2e6b(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    11b5:	e8 d6 fe ff ff       	callq  1090 <getc@plt>
    11ba:	89 c3                	mov    %eax,%ebx
    11bc:	83 f8 20             	cmp    $0x20,%eax
    11bf:	74 db                	je     119c <main+0x13>
    11c1:	48 8b 35 48 2e 00 00 	mov    0x2e48(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11c8:	89 c7                	mov    %eax,%edi
    11ca:	e8 a1 fe ff ff       	callq  1070 <putc@plt>
    11cf:	83 fb ff             	cmp    $0xffffffff,%ebx
    11d2:	75 da                	jne    11ae <main+0x25>
    11d4:	b8 00 00 00 00       	mov    $0x0,%eax
    11d9:	48 83 c4 08          	add    $0x8,%rsp
    11dd:	5b                   	pop    %rbx
    11de:	5d                   	pop    %rbp
    11df:	c3                   	retq   
