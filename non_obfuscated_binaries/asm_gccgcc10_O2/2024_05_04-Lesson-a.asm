...
/app/bin_gccgcc10_O2/2024_05_04-Lesson-a:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	55                   	push   %rbp
    10a5:	48 8d 2d 58 0f 00 00 	lea    0xf58(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    10ac:	53                   	push   %rbx
    ...
    10c4:	89 c3                	mov    %eax,%ebx
    10c6:	83 f8 20             	cmp    $0x20,%eax
    10c9:	74 25                	je     10f0 <main+0x50>
    10cb:	48 8b 35 3e 2f 00 00 	mov    0x2f3e(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10d2:	89 c7                	mov    %eax,%edi
    10d4:	e8 97 ff ff ff       	callq  1070 <putc@plt>
    10d9:	83 fb ff             	cmp    $0xffffffff,%ebx
    10dc:	75 da                	jne    10b8 <main+0x18>
    10de:	48 83 c4 08          	add    $0x8,%rsp
    ...
    10ee:	00 00 
    10f0:	48 89 ee             	mov    %rbp,%rsi
    10f3:	bf 01 00 00 00       	mov    $0x1,%edi
    10f8:	31 c0                	xor    %eax,%eax
    10fa:	e8 81 ff ff ff       	callq  1080 <__printf_chk@plt>
    10ff:	eb b7                	jmp    10b8 <main+0x18>
