...
/app/bin_gccgcc10_O0/2023_10_14-Lesson-a:     file format elf64-x86-64
...
0000000000001110 <feof@plt>:
    ...
    1114:	f2 ff 25 a5 2e 00 00 	bnd jmpq *0x2ea5(%rip)        # 3fc0 <feof@GLIBC_2.2.5>
...
0000000000001229 <main>:
    ...
    1244:	48 8d 35 bd 0d 00 00 	lea    0xdbd(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    124b:	48 8d 3d b8 0d 00 00 	lea    0xdb8(%rip),%rdi        # 200a <_IO_stdin_used+0xa>
    1252:	e8 c9 fe ff ff       	callq  1120 <fopen@plt>
    1257:	48 89 45 c0          	mov    %rax,-0x40(%rbp)
    125b:	48 83 7d c0 00       	cmpq   $0x0,-0x40(%rbp)
    1260:	75 2c                	jne    128e <main+0x65>
    1262:	48 8b 05 b7 2d 00 00 	mov    0x2db7(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    1269:	48 8d 15 9a 0d 00 00 	lea    0xd9a(%rip),%rdx        # 200a <_IO_stdin_used+0xa>
    1270:	48 8d 35 a9 0d 00 00 	lea    0xda9(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    1277:	48 89 c7             	mov    %rax,%rdi
    127a:	b8 00 00 00 00       	mov    $0x0,%eax
    127f:	e8 7c fe ff ff       	callq  1100 <fprintf@plt>
    1284:	bf 01 00 00 00       	mov    $0x1,%edi
    1289:	e8 a2 fe ff ff       	callq  1130 <exit@plt>
    128e:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%rbp)
    1295:	eb 3c                	jmp    12d3 <main+0xaa>
    1297:	48 8b 55 c0          	mov    -0x40(%rbp),%rdx
    129b:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    129f:	be 20 00 00 00       	mov    $0x20,%esi
    12a4:	48 89 c7             	mov    %rax,%rdi
    12a7:	e8 44 fe ff ff       	callq  10f0 <fgets@plt>
    12ac:	48 89 45 c8          	mov    %rax,-0x38(%rbp)
    12b0:	48 83 7d c8 00       	cmpq   $0x0,-0x38(%rbp)
    12b5:	74 2e                	je     12e5 <main+0xbc>
    12b7:	48 8d 45 d0          	lea    -0x30(%rbp),%rax
    12bb:	48 89 c6             	mov    %rax,%rsi
    12be:	48 8d 3d 6e 0d 00 00 	lea    0xd6e(%rip),%rdi        # 2033 <_IO_stdin_used+0x33>
    12c5:	b8 00 00 00 00       	mov    $0x0,%eax
    12ca:	e8 11 fe ff ff       	callq  10e0 <printf@plt>
    12cf:	83 45 bc 01          	addl   $0x1,-0x44(%rbp)
    12d3:	48 8b 45 c0          	mov    -0x40(%rbp),%rax
    12d7:	48 89 c7             	mov    %rax,%rdi
    12da:	e8 31 fe ff ff       	callq  1110 <feof@plt>
    12df:	85 c0                	test   %eax,%eax
    12e1:	74 b4                	je     1297 <main+0x6e>
    12e3:	eb 01                	jmp    12e6 <main+0xbd>
    12e5:	90                   	nop
    12e6:	8b 45 bc             	mov    -0x44(%rbp),%eax
    12e9:	89 c6                	mov    %eax,%esi
    12eb:	48 8d 3d 46 0d 00 00 	lea    0xd46(%rip),%rdi        # 2038 <_IO_stdin_used+0x38>
    12f2:	b8 00 00 00 00       	mov    $0x0,%eax
    12f7:	e8 e4 fd ff ff       	callq  10e0 <printf@plt>
    12fc:	48 8b 45 c0          	mov    -0x40(%rbp),%rax
    1300:	48 89 c7             	mov    %rax,%rdi
    1303:	e8 b8 fd ff ff       	callq  10c0 <fclose@plt>
    1308:	b8 00 00 00 00       	mov    $0x0,%eax
    130d:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1311:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1318:	00 00 
    131a:	74 05                	je     1321 <main+0xf8>
    131c:	e8 af fd ff ff       	callq  10d0 <__stack_chk_fail@plt>
    1321:	c9                   	leaveq 
    1322:	c3                   	retq   
