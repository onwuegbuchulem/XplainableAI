...
/app/bin_gccgcc10_O2/stack:     file format elf64-x86-64
...
0000000000001350 <push>:
    ...
    13a5:	83 05 6c 2c 00 00 01 	addl   $0x1,0x2c6c(%rip)        # 4018 <count>
    13ac:	48 c7 40 08 00 00 00 	movq   $0x0,0x8(%rax)
    13b3:	00 
    13b4:	48 c7 40 10 00 00 00 	movq   $0x0,0x10(%rax)
    13bb:	00 
    13bc:	89 18                	mov    %ebx,(%rax)
    13be:	48 89 05 63 2c 00 00 	mov    %rax,0x2c63(%rip)        # 4028 <head>
