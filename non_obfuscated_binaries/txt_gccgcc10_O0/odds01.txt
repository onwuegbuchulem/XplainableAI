...
/app/bin_gccgcc10_O0/odds01:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	48 8d 3d 5c 0e 00 00 	lea    0xe5c(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    11c3:	b8 00 00 00 00       	mov    $0x0,%eax
    11c8:	e8 c3 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cd:	48 8d 3d 4e 0e 00 00 	lea    0xe4e(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    ...
    11e5:	48 8d 3d 33 0e 00 00 	lea    0xe33(%rip),%rdi        # 201f <_IO_stdin_used+0x1f>
    11ec:	b8 00 00 00 00       	mov    $0x0,%eax
    11f1:	e8 9a fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f6:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11f9:	8b 4d f0             	mov    -0x10(%rbp),%ecx
    11fc:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11ff:	66 0f ef c0          	pxor   %xmm0,%xmm0
    1203:	f3 0f 2a c0          	cvtsi2ss %eax,%xmm0
    1207:	8b 75 f0             	mov    -0x10(%rbp),%esi
    120a:	8b 45 f4             	mov    -0xc(%rbp),%eax
    120d:	01 f0                	add    %esi,%eax
    120f:	66 0f ef d2          	pxor   %xmm2,%xmm2
    1213:	f3 0f 2a d0          	cvtsi2ss %eax,%xmm2
    1217:	0f 28 c8             	movaps %xmm0,%xmm1
    121a:	f3 0f 5e ca          	divss  %xmm2,%xmm1
    121e:	f3 0f 10 05 46 0e 00 	movss  0xe46(%rip),%xmm0        # 206c <_IO_stdin_used+0x6c>
    1225:	00 
    1226:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    122a:	66 0f ef db          	pxor   %xmm3,%xmm3
    122e:	f3 0f 5a d8          	cvtss2sd %xmm0,%xmm3
    1232:	66 48 0f 7e d8       	movq   %xmm3,%rax
    1237:	89 ce                	mov    %ecx,%esi
    1239:	66 48 0f 6e c0       	movq   %rax,%xmm0
    123e:	48 8d 3d fb 0d 00 00 	lea    0xdfb(%rip),%rdi        # 2040 <_IO_stdin_used+0x40>
    ...
    1263:	e8 08 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1268:	c9                   	leaveq 
    1269:	c3                   	retq   
