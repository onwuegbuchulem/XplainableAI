...
/app/bin_gccgcc10_O1/04_fgetc_fputc:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1178:	48 8d 3d 87 0e 00 00 	lea    0xe87(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    117f:	e8 ec fe ff ff       	callq  1070 <fopen@plt>
    1184:	48 89 c6             	mov    %rax,%rsi
    1187:	bf 63 00 00 00       	mov    $0x63,%edi
    118c:	e8 cf fe ff ff       	callq  1060 <fputc@plt>
