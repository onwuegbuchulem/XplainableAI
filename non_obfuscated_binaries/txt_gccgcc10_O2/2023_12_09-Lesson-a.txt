...
/app/bin_gccgcc10_O2/2023_12_09-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10a6:	48 b8 14 00 00 00 1e 	movabs $0x1e00000014,%rax
    10ad:	00 00 00 
    10b0:	48 89 e3             	mov    %rsp,%rbx
    10b3:	4c 8d 64 24 18       	lea    0x18(%rsp),%r12
    10b8:	c7 44 24 14 3c 00 00 	movl   $0x3c,0x14(%rsp)
    10bf:	00 
    10c0:	48 89 44 24 04       	mov    %rax,0x4(%rsp)
    10c5:	48 b8 28 00 00 00 32 	movabs $0x3200000028,%rax
    10cc:	00 00 00 
    10cf:	48 89 44 24 0c       	mov    %rax,0xc(%rsp)
    10d4:	eb 0c                	jmp    10e2 <main+0x62>
    10d6:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    10dd:	00 00 00 
    10e0:	8b 13                	mov    (%rbx),%edx
    10e2:	48 89 ee             	mov    %rbp,%rsi
    10e5:	bf 01 00 00 00       	mov    $0x1,%edi
    10ea:	31 c0                	xor    %eax,%eax
    10ec:	48 83 c3 04          	add    $0x4,%rbx
    10f0:	e8 7b ff ff ff       	callq  1070 <__printf_chk@plt>
    10f5:	4c 39 e3             	cmp    %r12,%rbx
    10f8:	75 e6                	jne    10e0 <main+0x60>
    10fa:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10ff:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1106:	00 00 
    1108:	75 0b                	jne    1115 <main+0x95>
    110a:	48 83 c4 20          	add    $0x20,%rsp
    110e:	31 c0                	xor    %eax,%eax
    1110:	5b                   	pop    %rbx
    1111:	5d                   	pop    %rbp
    1112:	41 5c                	pop    %r12
    1114:	c3                   	retq   
    1115:	e8 46 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
