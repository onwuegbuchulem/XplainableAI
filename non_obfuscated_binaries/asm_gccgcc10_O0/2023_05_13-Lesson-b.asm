...
/app/bin_gccgcc10_O0/2023_05_13-Lesson-b:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b5:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11b9:	48 89 c6             	mov    %rax,%rsi
    11bc:	bf 00 00 00 00       	mov    $0x0,%edi
    11c1:	e8 aa fe ff ff       	callq  1070 <clock_gettime@plt>
    11c6:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    11ca:	48 8b 55 d8          	mov    -0x28(%rbp),%rdx
    11ce:	48 29 d0             	sub    %rdx,%rax
    ...
    11ea:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11ee:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11f5:	00 00 
    11f7:	74 05                	je     11fe <main+0x75>
    11f9:	e8 82 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    11fe:	c9                   	leaveq 
    11ff:	c3                   	retq   
