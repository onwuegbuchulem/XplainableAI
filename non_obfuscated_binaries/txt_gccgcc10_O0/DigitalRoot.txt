...
/app/bin_gccgcc10_O0/DigitalRoot:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11c3:	48 8d 3d 54 0e 00 00 	lea    0xe54(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    11ca:	b8 00 00 00 00       	mov    $0x0,%eax
    11cf:	e8 bc fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11d4:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11d7:	89 45 ec             	mov    %eax,-0x14(%rbp)
    11da:	eb 5e                	jmp    123a <main+0xb1>
    11dc:	8b 4d ec             	mov    -0x14(%rbp),%ecx
    11df:	89 ca                	mov    %ecx,%edx
    11e1:	b8 cd cc cc cc       	mov    $0xcccccccd,%eax
    11e6:	48 0f af c2          	imul   %rdx,%rax
    11ea:	48 c1 e8 20          	shr    $0x20,%rax
    11ee:	89 c2                	mov    %eax,%edx
    11f0:	c1 ea 03             	shr    $0x3,%edx
    11f3:	89 d0                	mov    %edx,%eax
    11f5:	c1 e0 02             	shl    $0x2,%eax
    11f8:	01 d0                	add    %edx,%eax
    11fa:	01 c0                	add    %eax,%eax
    11fc:	29 c1                	sub    %eax,%ecx
    11fe:	89 ca                	mov    %ecx,%edx
    1200:	89 55 f4             	mov    %edx,-0xc(%rbp)
    1203:	8b 45 f4             	mov    -0xc(%rbp),%eax
    1206:	01 45 f0             	add    %eax,-0x10(%rbp)
    1209:	8b 45 ec             	mov    -0x14(%rbp),%eax
    120c:	89 c2                	mov    %eax,%edx
    120e:	b8 cd cc cc cc       	mov    $0xcccccccd,%eax
    1213:	48 0f af c2          	imul   %rdx,%rax
    1217:	48 c1 e8 20          	shr    $0x20,%rax
    121b:	c1 e8 03             	shr    $0x3,%eax
    121e:	89 45 ec             	mov    %eax,-0x14(%rbp)
    1221:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
    1225:	75 13                	jne    123a <main+0xb1>
    1227:	83 7d f0 09          	cmpl   $0x9,-0x10(%rbp)
    122b:	76 0d                	jbe    123a <main+0xb1>
    122d:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1230:	89 45 ec             	mov    %eax,-0x14(%rbp)
    1233:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%rbp)
    123a:	83 7d ec 00          	cmpl   $0x0,-0x14(%rbp)
    123e:	75 9c                	jne    11dc <main+0x53>
    ...
    1254:	e8 27 fe ff ff       	callq  1080 <printf@plt>
    1259:	b8 00 00 00 00       	mov    $0x0,%eax
    125e:	48 8b 75 f8          	mov    -0x8(%rbp),%rsi
    1262:	64 48 2b 34 25 28 00 	sub    %fs:0x28,%rsi
    1269:	00 00 
    126b:	74 05                	je     1272 <main+0xe9>
