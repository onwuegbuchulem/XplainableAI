...
/app/bin_gccgcc10_O1/oddandeven:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d2:	48 8d 3d 43 0e 00 00 	lea    0xe43(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	e8 cd fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e3:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11e7:	f6 c2 01             	test   $0x1,%dl
    11ea:	75 30                	jne    121c <main+0x73>
    11ec:	48 8d 35 2c 0e 00 00 	lea    0xe2c(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    ...
    1207:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    120e:	00 00 
    1210:	75 22                	jne    1234 <main+0x8b>
    1212:	b8 00 00 00 00       	mov    $0x0,%eax
    1217:	48 83 c4 18          	add    $0x18,%rsp
    121b:	c3                   	retq   
    121c:	48 8d 35 13 0e 00 00 	lea    0xe13(%rip),%rsi        # 2036 <_IO_stdin_used+0x36>
    1223:	bf 01 00 00 00       	mov    $0x1,%edi
    1228:	b8 00 00 00 00       	mov    $0x0,%eax
    122d:	e8 6e fe ff ff       	callq  10a0 <__printf_chk@plt>
    1232:	eb ce                	jmp    1202 <main+0x59>
