...
/app/bin_gccgcc10_O1/struct_funct:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a2:	c7 44 24 01 48 65 72 	movl   $0x65726548,0x1(%rsp)
    11a9:	65 
    11aa:	66 c7 44 24 05 73 79 	movw   $0x7973,0x5(%rsp)
    11b1:	c6 44 24 07 00       	movb   $0x0,0x7(%rsp)
    11b6:	48 8d 5c 24 01       	lea    0x1(%rsp),%rbx
    11bb:	48 89 df             	mov    %rbx,%rdi
    11be:	e8 ad fe ff ff       	callq  1070 <strlen@plt>
    11c3:	48 89 c1             	mov    %rax,%rcx
    11c6:	48 89 da             	mov    %rbx,%rdx
    11c9:	48 8d 35 38 0e 00 00 	lea    0xe38(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    11d0:	bf 01 00 00 00       	mov    $0x1,%edi
    11d5:	b8 00 00 00 00       	mov    $0x0,%eax
    11da:	e8 b1 fe ff ff       	callq  1090 <__printf_chk@plt>
    11df:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11e4:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11eb:	00 00 
    11ed:	75 0b                	jne    11fa <main+0x71>
    11ef:	b8 00 00 00 00       	mov    $0x0,%eax
    11f4:	48 83 c4 10          	add    $0x10,%rsp
    11f8:	5b                   	pop    %rbx
    11f9:	c3                   	retq   
    11fa:	e8 81 fe ff ff       	callq  1080 <__stack_chk_fail@plt>
    11ff:	90                   	nop
