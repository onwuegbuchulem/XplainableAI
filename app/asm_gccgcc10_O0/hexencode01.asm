...
/app/bin_gccgcc10_O0/hexencode01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11b5:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    11bc:	48 8d 3d 41 0e 00 00 	lea    0xe41(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11c3:	e8 c8 fe ff ff       	callq  1090 <puts@plt>
    11c8:	eb 31                	jmp    11fb <main+0x52>
    11ca:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11cd:	89 c6                	mov    %eax,%esi
    11cf:	48 8d 3d 3e 0e 00 00 	lea    0xe3e(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    11d6:	b8 00 00 00 00       	mov    $0x0,%eax
    11db:	e8 c0 fe ff ff       	callq  10a0 <printf@plt>
    11e0:	83 45 f8 01          	addl   $0x1,-0x8(%rbp)
    11e4:	83 7d f8 12          	cmpl   $0x12,-0x8(%rbp)
    11e8:	75 11                	jne    11fb <main+0x52>
    11ea:	bf 0a 00 00 00       	mov    $0xa,%edi
    11ef:	e8 8c fe ff ff       	callq  1080 <putchar@plt>
    11f4:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%rbp)
    11fb:	e8 b0 fe ff ff       	callq  10b0 <getchar@plt>
    1200:	89 45 fc             	mov    %eax,-0x4(%rbp)
    1203:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%rbp)
    1207:	75 c1                	jne    11ca <main+0x21>
    1209:	48 8d 3d 0a 0e 00 00 	lea    0xe0a(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    1210:	e8 7b fe ff ff       	callq  1090 <puts@plt>
