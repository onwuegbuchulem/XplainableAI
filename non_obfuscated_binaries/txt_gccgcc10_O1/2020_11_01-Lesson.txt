...
/app/bin_gccgcc10_O1/2020_11_01-Lesson:     file format elf64-x86-64
...
000000000000118e <main>:
    ...
    11a6:	48 89 e7             	mov    %rsp,%rdi
    11a9:	e8 d2 fe ff ff       	callq  1080 <time@plt>
    ...
    11c4:	e8 c7 fe ff ff       	callq  1090 <__printf_chk@plt>
    11c9:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11ce:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11d5:	00 00 
    11d7:	75 0a                	jne    11e3 <main+0x55>
    11d9:	b8 00 00 00 00       	mov    $0x0,%eax
    11de:	48 83 c4 18          	add    $0x18,%rsp
    11e2:	c3                   	retq   
