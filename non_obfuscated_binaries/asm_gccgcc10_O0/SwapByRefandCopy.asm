...
/app/bin_gccgcc10_O0/SwapByRefandCopy:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d 15 01 00 00 	lea    0x115(%rip),%rdi        # 11bd <main>
...
0000000000001169 <swap_ref>:
    ...
    1182:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1186:	8b 10                	mov    (%rax),%edx
    1188:	48 8b 45 e8          	mov    -0x18(%rbp),%rax
    118c:	89 10                	mov    %edx,(%rax)
    118e:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    1192:	8b 55 fc             	mov    -0x4(%rbp),%edx
    1195:	89 10                	mov    %edx,(%rax)
    1197:	90                   	nop
    1198:	5d                   	pop    %rbp
    1199:	c3                   	retq   

000000000000119a <swap>:
    119a:	f3 0f 1e fa          	endbr64 
    119e:	55                   	push   %rbp
    119f:	48 89 e5             	mov    %rsp,%rbp
    11a2:	89 7d ec             	mov    %edi,-0x14(%rbp)
    11a5:	89 75 e8             	mov    %esi,-0x18(%rbp)
    11a8:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11ab:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11ae:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11b1:	89 45 ec             	mov    %eax,-0x14(%rbp)
    11b4:	8b 45 fc             	mov    -0x4(%rbp),%eax
    11b7:	89 45 e8             	mov    %eax,-0x18(%rbp)
    11ba:	90                   	nop
    11bb:	5d                   	pop    %rbp
    11bc:	c3                   	retq   
...
00000000000011bd <main>:
    ...
    11df:	c7 45 ec 02 00 00 00 	movl   $0x2,-0x14(%rbp)
    ...
    11fc:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11ff:	89 c6                	mov    %eax,%esi
    1201:	48 8d 3d fc 0d 00 00 	lea    0xdfc(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1208:	b8 00 00 00 00       	mov    $0x0,%eax
    120d:	e8 5e fe ff ff       	callq  1070 <printf@plt>
    1212:	48 8d 55 ec          	lea    -0x14(%rbp),%rdx
    1216:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    121a:	48 89 d6             	mov    %rdx,%rsi
    121d:	48 89 c7             	mov    %rax,%rdi
    1220:	e8 44 ff ff ff       	callq  1169 <swap_ref>
    1225:	8b 45 e8             	mov    -0x18(%rbp),%eax
    ...
    1240:	48 8d 3d bd 0d 00 00 	lea    0xdbd(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1247:	b8 00 00 00 00       	mov    $0x0,%eax
    124c:	e8 1f fe ff ff       	callq  1070 <printf@plt>
    1251:	c7 45 f0 05 00 00 00 	movl   $0x5,-0x10(%rbp)
    1258:	c7 45 f4 0a 00 00 00 	movl   $0xa,-0xc(%rbp)
    ...
    1286:	e8 e5 fd ff ff       	callq  1070 <printf@plt>
    128b:	8b 55 f4             	mov    -0xc(%rbp),%edx
    128e:	8b 45 f0             	mov    -0x10(%rbp),%eax
    1291:	89 d6                	mov    %edx,%esi
    1293:	89 c7                	mov    %eax,%edi
    1295:	e8 00 ff ff ff       	callq  119a <swap>
    129a:	8b 45 f0             	mov    -0x10(%rbp),%eax
    129d:	89 c6                	mov    %eax,%esi
    129f:	48 8d 3d 5e 0d 00 00 	lea    0xd5e(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    12a6:	b8 00 00 00 00       	mov    $0x0,%eax
    12ab:	e8 c0 fd ff ff       	callq  1070 <printf@plt>
    ...
    12d6:	00 00 
    12d8:	74 05                	je     12df <main+0x122>
    12da:	e8 81 fd ff ff       	callq  1060 <__stack_chk_fail@plt>
    12df:	c9                   	leaveq 
    12e0:	c3                   	retq   
