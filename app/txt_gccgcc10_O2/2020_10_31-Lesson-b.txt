...
/app/bin_gccgcc10_O2/2020_10_31-Lesson-b:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    109f:	00 
    10a0:	41 83 fc 02          	cmp    $0x2,%r12d
    10a4:	74 24                	je     10ca <main+0x4a>
    10a6:	41 f6 c4 01          	test   $0x1,%r12b
    10aa:	74 30                	je     10dc <main+0x5c>
    10ac:	b9 02 00 00 00       	mov    $0x2,%ecx
    10b1:	eb 0f                	jmp    10c2 <main+0x42>
    10b3:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10b8:	44 89 e0             	mov    %r12d,%eax
    10bb:	99                   	cltd   
    10bc:	f7 f9                	idiv   %ecx
    10be:	85 d2                	test   %edx,%edx
    10c0:	74 1a                	je     10dc <main+0x5c>
    10c2:	83 c1 01             	add    $0x1,%ecx
    10c5:	44 39 e1             	cmp    %r12d,%ecx
    10c8:	75 ee                	jne    10b8 <main+0x38>
    10ca:	44 89 e2             	mov    %r12d,%edx
    10cd:	48 89 de             	mov    %rbx,%rsi
    10d0:	bf 01 00 00 00       	mov    $0x1,%edi
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	e8 94 ff ff ff       	callq  1070 <__printf_chk@plt>
    10dc:	41 83 c4 01          	add    $0x1,%r12d
    10e0:	41 83 fc 64          	cmp    $0x64,%r12d
    10e4:	75 ba                	jne    10a0 <main+0x20>
    10e6:	48 8b 35 23 2f 00 00 	mov    0x2f23(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10ed:	bf 0a 00 00 00       	mov    $0xa,%edi
