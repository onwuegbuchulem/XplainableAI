...
/app/bin_gccgcc10_O2/13_complement:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10e7:	48 8d 35 34 0f 00 00 	lea    0xf34(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    10ee:	f7 da                	neg    %edx
    10f0:	e8 8b ff ff ff       	callq  1080 <__printf_chk@plt>
    10f5:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10fa:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1101:	00 00 
    1103:	75 07                	jne    110c <main+0x6c>
    1105:	31 c0                	xor    %eax,%eax
    1107:	48 83 c4 18          	add    $0x18,%rsp
    110b:	c3                   	retq   
    110c:	e8 5f ff ff ff       	callq  1070 <__stack_chk_fail@plt>
