...
/app/bin_gccgcc10_O1/2021_08_28-Lesson-b:     file format elf64-x86-64
...
00000000000011a5 <main>:
    ...
    11c3:	48 8d 05 3a 0e 00 00 	lea    0xe3a(%rip),%rax        # 2004 <_IO_stdin_used+0x4>
    11ca:	48 89 04 24          	mov    %rax,(%rsp)
    11ce:	48 8d 05 3d 0e 00 00 	lea    0xe3d(%rip),%rax        # 2012 <_IO_stdin_used+0x12>
    11d5:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11da:	48 8d 05 4f 0e 00 00 	lea    0xe4f(%rip),%rax        # 2030 <_IO_stdin_used+0x30>
    11e1:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11e6:	48 89 e3             	mov    %rsp,%rbx
    11e9:	4c 8d 6c 24 18       	lea    0x18(%rsp),%r13
    11ee:	4c 8d 25 33 0e 00 00 	lea    0xe33(%rip),%r12        # 2028 <_IO_stdin_used+0x28>
    11f5:	48 8b 2b             	mov    (%rbx),%rbp
    11f8:	48 89 ea             	mov    %rbp,%rdx
    11fb:	4c 89 e6             	mov    %r12,%rsi
    11fe:	bf 01 00 00 00       	mov    $0x1,%edi
    1203:	b8 00 00 00 00       	mov    $0x0,%eax
    1208:	e8 83 fe ff ff       	callq  1090 <__printf_chk@plt>
    120d:	48 89 ef             	mov    %rbp,%rdi
    1210:	e8 74 ff ff ff       	callq  1189 <increase>
    1215:	48 89 ef             	mov    %rbp,%rdi
    1218:	e8 53 fe ff ff       	callq  1070 <puts@plt>
    121d:	48 83 c3 08          	add    $0x8,%rbx
    1221:	4c 39 eb             	cmp    %r13,%rbx
    1224:	75 cf                	jne    11f5 <main+0x50>
    1226:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    122b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1232:	00 00 
    1234:	75 10                	jne    1246 <main+0xa1>
    1236:	b8 00 00 00 00       	mov    $0x0,%eax
    123b:	48 83 c4 28          	add    $0x28,%rsp
    123f:	5b                   	pop    %rbx
    1240:	5d                   	pop    %rbp
    1241:	41 5c                	pop    %r12
    1243:	41 5d                	pop    %r13
