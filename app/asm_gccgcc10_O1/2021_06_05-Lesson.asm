...
/app/bin_gccgcc10_O1/2021_06_05-Lesson:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    1216:	e8 b5 fe ff ff       	callq  10d0 <glob@plt>
    121b:	85 c0                	test   %eax,%eax
    121d:	75 53                	jne    1272 <main+0x89>
    121f:	48 8b 14 24          	mov    (%rsp),%rdx
    1223:	48 8d 35 01 0e 00 00 	lea    0xe01(%rip),%rsi        # 202b <_IO_stdin_used+0x2b>
    122a:	bf 01 00 00 00       	mov    $0x1,%edi
    122f:	b8 00 00 00 00       	mov    $0x0,%eax
    1234:	e8 87 fe ff ff       	callq  10c0 <__printf_chk@plt>
    1239:	48 8b 5c 24 08       	mov    0x8(%rsp),%rbx
    123e:	48 8b 3b             	mov    (%rbx),%rdi
    1241:	48 85 ff             	test   %rdi,%rdi
    1244:	74 11                	je     1257 <main+0x6e>
    1246:	e8 55 fe ff ff       	callq  10a0 <puts@plt>
    124b:	48 83 c3 08          	add    $0x8,%rbx
    124f:	48 8b 3b             	mov    (%rbx),%rdi
    1252:	48 85 ff             	test   %rdi,%rdi
    1255:	75 ef                	jne    1246 <main+0x5d>
    1257:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    125c:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1263:	00 00 
    1265:	75 56                	jne    12bd <main+0xd4>
    1267:	b8 00 00 00 00       	mov    $0x0,%eax
    126c:	48 83 c4 50          	add    $0x50,%rsp
    1270:	5b                   	pop    %rbx
    1271:	c3                   	retq   
    1272:	83 f8 03             	cmp    $0x3,%eax
    1275:	74 27                	je     129e <main+0xb5>
    1277:	48 8b 0d a2 2d 00 00 	mov    0x2da2(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    127e:	ba 16 00 00 00       	mov    $0x16,%edx
    1283:	be 01 00 00 00       	mov    $0x1,%esi
    1288:	48 8d 3d 85 0d 00 00 	lea    0xd85(%rip),%rdi        # 2014 <_IO_stdin_used+0x14>
    128f:	e8 5c fe ff ff       	callq  10f0 <fwrite@plt>
    1294:	bf 01 00 00 00       	mov    $0x1,%edi
    1299:	e8 42 fe ff ff       	callq  10e0 <exit@plt>
    129e:	48 8b 0d 7b 2d 00 00 	mov    0x2d7b(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    12a5:	ba 0b 00 00 00       	mov    $0xb,%edx
    12aa:	be 01 00 00 00       	mov    $0x1,%esi
    12af:	48 8d 3d 52 0d 00 00 	lea    0xd52(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    12b6:	e8 35 fe ff ff       	callq  10f0 <fwrite@plt>
    12bb:	eb d7                	jmp    1294 <main+0xab>
    12bd:	e8 ee fd ff ff       	callq  10b0 <__stack_chk_fail@plt>
