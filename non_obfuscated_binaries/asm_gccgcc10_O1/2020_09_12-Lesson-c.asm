...
/app/bin_gccgcc10_O1/2020_09_12-Lesson-c:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    118d:	53                   	push   %rbx
    118e:	48 81 ec 90 00 00 00 	sub    $0x90,%rsp
    1195:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    119c:	00 00 
    119e:	48 89 84 24 88 00 00 	mov    %rax,0x88(%rsp)
    11a5:	00 
    11a6:	31 c0                	xor    %eax,%eax
    11a8:	48 8d 35 55 0e 00 00 	lea    0xe55(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11af:	bf 01 00 00 00       	mov    $0x1,%edi
    11b4:	e8 c7 fe ff ff       	callq  1080 <__printf_chk@plt>
    11b9:	48 89 e3             	mov    %rsp,%rbx
    11bc:	48 89 de             	mov    %rbx,%rsi
    11bf:	48 8d 3d 45 0e 00 00 	lea    0xe45(%rip),%rdi        # 200b <_IO_stdin_used+0xb>
    11c6:	b8 00 00 00 00       	mov    $0x0,%eax
    11cb:	e8 c0 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11d0:	48 89 da             	mov    %rbx,%rdx
    11d3:	48 8d 35 37 0e 00 00 	lea    0xe37(%rip),%rsi        # 2011 <_IO_stdin_used+0x11>
    11da:	bf 01 00 00 00       	mov    $0x1,%edi
    11df:	b8 00 00 00 00       	mov    $0x0,%eax
    11e4:	e8 97 fe ff ff       	callq  1080 <__printf_chk@plt>
    11e9:	48 8b 84 24 88 00 00 	mov    0x88(%rsp),%rax
    11f0:	00 
    11f1:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f8:	00 00 
    11fa:	75 0e                	jne    120a <main+0x81>
    11fc:	b8 00 00 00 00       	mov    $0x0,%eax
    1201:	48 81 c4 90 00 00 00 	add    $0x90,%rsp
    1208:	5b                   	pop    %rbx
    1209:	c3                   	retq   
    120a:	e8 61 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    120f:	90                   	nop
