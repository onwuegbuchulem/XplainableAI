...
/app/bin_gccgcc10_O2/2019_04-Exercise-b:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    106c:	53                   	push   %rbx
    106d:	bb 64 00 00 00       	mov    $0x64,%ebx
    1072:	48 83 ec 08          	sub    $0x8,%rsp
    1076:	66 2e 0f 1f 84 00 00 	nopw   %cs:0x0(%rax,%rax,1)
    107d:	00 00 00 
    1080:	83 c3 01             	add    $0x1,%ebx
    1083:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
    1089:	74 29                	je     10b4 <main+0x54>
    108b:	69 c3 8f 5e 19 db    	imul   $0xdb195e8f,%ebx,%eax
    1091:	3d 17 6a 4e 02       	cmp    $0x24e6a17,%eax
    1096:	77 e8                	ja     1080 <main+0x20>
    1098:	89 da                	mov    %ebx,%edx
    109a:	48 89 ee             	mov    %rbp,%rsi
    ...
    10ac:	81 fb e8 03 00 00    	cmp    $0x3e8,%ebx
    10b2:	75 d7                	jne    108b <main+0x2b>
