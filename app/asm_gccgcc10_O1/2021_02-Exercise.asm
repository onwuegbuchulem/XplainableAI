...
/app/bin_gccgcc10_O1/2021_02-Exercise:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    116d:	55                   	push   %rbp
    116e:	53                   	push   %rbx
    116f:	48 81 ec 88 00 00 00 	sub    $0x88,%rsp
    1176:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    117d:	00 00 
    117f:	48 89 44 24 78       	mov    %rax,0x78(%rsp)
    1184:	31 c0                	xor    %eax,%eax
    1186:	b8 01 00 00 00       	mov    $0x1,%eax
    118b:	48 8d 74 24 ff       	lea    -0x1(%rsp),%rsi
    1190:	48 8d 4c 24 3f       	lea    0x3f(%rsp),%rcx
    1195:	88 04 06             	mov    %al,(%rsi,%rax,1)
    1198:	8d 50 32             	lea    0x32(%rax),%edx
    119b:	88 14 01             	mov    %dl,(%rcx,%rax,1)
    119e:	48 83 c0 01          	add    $0x1,%rax
    11a2:	48 83 f8 33          	cmp    $0x33,%rax
    11a6:	75 ed                	jne    1195 <main+0x2c>
    11a8:	bb 00 00 00 00       	mov    $0x0,%ebx
    11ad:	48 8d 6c 24 40       	lea    0x40(%rsp),%rbp
    11b2:	0f be 0c 2b          	movsbl (%rbx,%rbp,1),%ecx
    11b6:	0f be 14 1c          	movsbl (%rsp,%rbx,1),%edx
    ...
    11d0:	48 83 c3 01          	add    $0x1,%rbx
    11d4:	48 83 fb 32          	cmp    $0x32,%rbx
    11d8:	75 d8                	jne    11b2 <main+0x49>
    11da:	48 8b 44 24 78       	mov    0x78(%rsp),%rax
    11df:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11e6:	00 00 
    11e8:	75 0f                	jne    11f9 <main+0x90>
    11ea:	b8 00 00 00 00       	mov    $0x0,%eax
    11ef:	48 81 c4 88 00 00 00 	add    $0x88,%rsp
    11f6:	5b                   	pop    %rbx
    11f7:	5d                   	pop    %rbp
    11f8:	c3                   	retq   
    11f9:	e8 62 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
