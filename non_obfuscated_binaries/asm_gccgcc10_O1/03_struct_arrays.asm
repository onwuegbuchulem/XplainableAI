...
/app/bin_gccgcc10_O1/03_struct_arrays:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1181:	c7 04 24 64 00 00 00 	movl   $0x64,(%rsp)
    1188:	c7 44 24 04 a4 70 8e 	movl   $0x428e70a4,0x4(%rsp)
    118f:	42 
    1190:	48 b8 68 61 72 72 79 	movabs $0x7972726168,%rax
    1197:	00 00 00 
    119a:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    119f:	66 c7 44 24 10 00 00 	movw   $0x0,0x10(%rsp)
    11a6:	48 8d 4c 24 08       	lea    0x8(%rsp),%rcx
    11ab:	f2 0f 10 05 5d 0e 00 	movsd  0xe5d(%rip),%xmm0        # 2010 <_IO_stdin_used+0x10>
    11b2:	00 
    11b3:	ba 64 00 00 00       	mov    $0x64,%edx
    ...
    11ce:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11d3:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11da:	00 00 
    11dc:	75 0a                	jne    11e8 <main+0x7f>
    11de:	b8 00 00 00 00       	mov    $0x0,%eax
    11e3:	48 83 c4 28          	add    $0x28,%rsp
    11e7:	c3                   	retq   
    11e8:	e8 73 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
