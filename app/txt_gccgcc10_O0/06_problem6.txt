...
/app/bin_gccgcc10_O0/06_problem6:     file format elf64-x86-64
...
0000000000001060 <_start>:
    ...
    1081:	48 8d 3d f1 00 00 00 	lea    0xf1(%rip),%rdi        # 1179 <main>
...
0000000000001149 <sum_natural>:
    ...
    115c:	75 07                	jne    1165 <sum_natural+0x1c>
    115e:	b8 01 00 00 00       	mov    $0x1,%eax
    1163:	eb 12                	jmp    1177 <sum_natural+0x2e>
    1165:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1168:	83 e8 01             	sub    $0x1,%eax
    116b:	89 c7                	mov    %eax,%edi
    116d:	e8 d7 ff ff ff       	callq  1149 <sum_natural>
    1172:	8b 55 fc             	mov    -0x4(%rbp),%edx
    1175:	01 d0                	add    %edx,%eax
    1177:	c9                   	leaveq 
    1178:	c3                   	retq   
...
0000000000001179 <main>:
    ...
    1186:	e8 be ff ff ff       	callq  1149 <sum_natural>
