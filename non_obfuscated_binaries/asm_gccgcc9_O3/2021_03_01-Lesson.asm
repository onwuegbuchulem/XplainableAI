...
/app/bin_gccgcc9_O3/2021_03_01-Lesson:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ae:	53                   	push   %rbx
    10af:	48 83 ec 60          	sub    $0x60,%rsp
    10b3:	66 0f 6f 05 85 0f 00 	movdqa 0xf85(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    10ba:	00 
    10bb:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10c2:	00 00 
    10c4:	48 89 44 24 58       	mov    %rax,0x58(%rsp)
    10c9:	31 c0                	xor    %eax,%eax
    10cb:	48 89 e3             	mov    %rsp,%rbx
    10ce:	4c 8d 64 24 50       	lea    0x50(%rsp),%r12
    10d3:	0f 29 04 24          	movaps %xmm0,(%rsp)
    10d7:	66 0f 6f 05 71 0f 00 	movdqa 0xf71(%rip),%xmm0        # 2050 <_IO_stdin_used+0x50>
    10de:	00 
    10df:	0f 29 44 24 10       	movaps %xmm0,0x10(%rsp)
    10e4:	66 0f 6f 05 74 0f 00 	movdqa 0xf74(%rip),%xmm0        # 2060 <_IO_stdin_used+0x60>
    10eb:	00 
    10ec:	0f 29 44 24 20       	movaps %xmm0,0x20(%rsp)
    10f1:	66 0f 6f 05 77 0f 00 	movdqa 0xf77(%rip),%xmm0        # 2070 <_IO_stdin_used+0x70>
    10f8:	00 
    10f9:	0f 29 44 24 30       	movaps %xmm0,0x30(%rsp)
    10fe:	66 0f 6f 05 7a 0f 00 	movdqa 0xf7a(%rip),%xmm0        # 2080 <_IO_stdin_used+0x80>
    1105:	00 
    1106:	0f 29 44 24 40       	movaps %xmm0,0x40(%rsp)
    110b:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    1110:	8b 13                	mov    (%rbx),%edx
    1112:	48 89 ee             	mov    %rbp,%rsi
    1115:	bf 01 00 00 00       	mov    $0x1,%edi
    111a:	31 c0                	xor    %eax,%eax
    111c:	48 83 c3 04          	add    $0x4,%rbx
    1120:	e8 6b ff ff ff       	callq  1090 <__printf_chk@plt>
    1125:	48 8d 3d fa 0e 00 00 	lea    0xefa(%rip),%rdi        # 2026 <_IO_stdin_used+0x26>
    112c:	e8 3f ff ff ff       	callq  1070 <puts@plt>
    1131:	49 39 dc             	cmp    %rbx,%r12
    1134:	75 da                	jne    1110 <main+0x70>
    1136:	48 8b 44 24 58       	mov    0x58(%rsp),%rax
    113b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1142:	00 00 
    1144:	75 0b                	jne    1151 <main+0xb1>
    1146:	48 83 c4 60          	add    $0x60,%rsp
    114a:	31 c0                	xor    %eax,%eax
    114c:	5b                   	pop    %rbx
    114d:	5d                   	pop    %rbp
    114e:	41 5c                	pop    %r12
    1150:	c3                   	retq   
    1151:	e8 2a ff ff ff       	callq  1080 <__stack_chk_fail@plt>
...
0000000000001160 <_start>:
    ...
    1171:	50                   	push   %rax
    1172:	54                   	push   %rsp
    1173:	4c 8d 05 56 01 00 00 	lea    0x156(%rip),%r8        # 12d0 <__libc_csu_fini>
    117a:	48 8d 0d df 00 00 00 	lea    0xdf(%rip),%rcx        # 1260 <__libc_csu_init>
