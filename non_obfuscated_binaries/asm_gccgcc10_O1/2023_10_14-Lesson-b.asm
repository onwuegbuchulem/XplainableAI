...
/app/bin_gccgcc10_O1/2023_10_14-Lesson-b:     file format elf64-x86-64
...
0000000000001209 <main>:
    ...
    121a:	48 8d 3d e5 0d 00 00 	lea    0xde5(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1221:	e8 ca fe ff ff       	callq  10f0 <fopen@plt>
    1226:	48 85 c0             	test   %rax,%rax
    1229:	74 0a                	je     1235 <main+0x2c>
    122b:	48 89 c3             	mov    %rax,%rbx
    122e:	bd 00 00 00 00       	mov    $0x0,%ebp
    1233:	eb 40                	jmp    1275 <main+0x6c>
    1235:	48 8d 0d ca 0d 00 00 	lea    0xdca(%rip),%rcx        # 2006 <_IO_stdin_used+0x6>
    123c:	48 8d 15 d9 0d 00 00 	lea    0xdd9(%rip),%rdx        # 201c <_IO_stdin_used+0x1c>
    1243:	be 01 00 00 00       	mov    $0x1,%esi
    1248:	48 8b 3d d1 2d 00 00 	mov    0x2dd1(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    124f:	b8 00 00 00 00       	mov    $0x0,%eax
    1254:	e8 b7 fe ff ff       	callq  1110 <__fprintf_chk@plt>
    1259:	bf 01 00 00 00       	mov    $0x1,%edi
    125e:	e8 9d fe ff ff       	callq  1100 <exit@plt>
    1263:	48 89 df             	mov    %rbx,%rdi
    1266:	e8 55 fe ff ff       	callq  10c0 <fgetc@plt>
    126b:	3c 0a                	cmp    $0xa,%al
    126d:	0f 94 c0             	sete   %al
    1270:	0f b6 c0             	movzbl %al,%eax
    1273:	01 c5                	add    %eax,%ebp
    1275:	48 89 df             	mov    %rbx,%rdi
    1278:	e8 53 fe ff ff       	callq  10d0 <feof@plt>
    127d:	85 c0                	test   %eax,%eax
    127f:	74 e2                	je     1263 <main+0x5a>
    1281:	89 ea                	mov    %ebp,%edx
    1283:	48 8d 35 a6 0d 00 00 	lea    0xda6(%rip),%rsi        # 2030 <_IO_stdin_used+0x30>
    128a:	bf 01 00 00 00       	mov    $0x1,%edi
    128f:	b8 00 00 00 00       	mov    $0x0,%eax
    1294:	e8 47 fe ff ff       	callq  10e0 <__printf_chk@plt>
    1299:	48 89 df             	mov    %rbx,%rdi
    129c:	e8 0f fe ff ff       	callq  10b0 <fclose@plt>
