...
/app/bin_gccgcc10_O1/randomp01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11ad:	53                   	push   %rbx
    11ae:	bf 00 00 00 00       	mov    $0x0,%edi
    11b3:	e8 e8 fe ff ff       	callq  10a0 <time@plt>
    11b8:	48 89 c7             	mov    %rax,%rdi
    11bb:	e8 c0 fe ff ff       	callq  1080 <srand@plt>
    11c0:	bb 0a 00 00 00       	mov    $0xa,%ebx
    11c5:	e8 e6 fe ff ff       	callq  10b0 <rand@plt>
    11ca:	89 c7                	mov    %eax,%edi
    11cc:	48 98                	cltq   
    11ce:	48 69 c0 5d 41 4c ae 	imul   $0xffffffffae4c415d,%rax,%rax
    11d5:	48 c1 e8 20          	shr    $0x20,%rax
    11d9:	01 f8                	add    %edi,%eax
    11db:	c1 f8 06             	sar    $0x6,%eax
    11de:	89 fa                	mov    %edi,%edx
    11e0:	c1 fa 1f             	sar    $0x1f,%edx
    11e3:	29 d0                	sub    %edx,%eax
    11e5:	6b c0 5e             	imul   $0x5e,%eax,%eax
    11e8:	29 c7                	sub    %eax,%edi
    11ea:	83 c7 21             	add    $0x21,%edi
    11ed:	40 0f be ff          	movsbl %dil,%edi
    11f1:	48 8b 35 18 2e 00 00 	mov    0x2e18(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11f8:	e8 93 fe ff ff       	callq  1090 <putc@plt>
    11fd:	83 eb 01             	sub    $0x1,%ebx
    1200:	75 c3                	jne    11c5 <main+0x1c>
    1202:	48 8b 35 07 2e 00 00 	mov    0x2e07(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    1209:	bf 0a 00 00 00       	mov    $0xa,%edi
    120e:	e8 7d fe ff ff       	callq  1090 <putc@plt>
