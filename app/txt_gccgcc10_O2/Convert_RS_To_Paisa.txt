...
/app/bin_gccgcc10_O2/Convert_RS_To_Paisa:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10ce:	48 8d 3d 3d 0f 00 00 	lea    0xf3d(%rip),%rdi        # 2012 <_IO_stdin_used+0x12>
    10d5:	31 c0                	xor    %eax,%eax
    10d7:	e8 b4 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10dc:	6b 54 24 04 64       	imul   $0x64,0x4(%rsp),%edx
    ...
    10ef:	e8 8c ff ff ff       	callq  1080 <__printf_chk@plt>
    10f4:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10f9:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1100:	00 00 
    1102:	75 07                	jne    110b <main+0x6b>
    1104:	31 c0                	xor    %eax,%eax
    1106:	48 83 c4 18          	add    $0x18,%rsp
    110a:	c3                   	retq   
    110b:	e8 60 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
