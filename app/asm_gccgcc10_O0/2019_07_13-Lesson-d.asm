...
/app/bin_gccgcc10_O0/2019_07_13-Lesson-d:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	48 b8 20 20 20 20 20 	movabs $0x372b202020202020,%rax
    11ab:	20 2b 37 
    11ae:	48 89 45 ed          	mov    %rax,-0x13(%rbp)
    11b2:	66 c7 45 f5 38 39    	movw   $0x3938,-0xb(%rbp)
    11b8:	c6 45 f7 00          	movb   $0x0,-0x9(%rbp)
    11bc:	48 8d 4d e0          	lea    -0x20(%rbp),%rcx
    11c0:	48 8d 45 ed          	lea    -0x13(%rbp),%rax
    11c4:	ba 0a 00 00 00       	mov    $0xa,%edx
    11c9:	48 89 ce             	mov    %rcx,%rsi
    11cc:	48 89 c7             	mov    %rax,%rdi
    11cf:	e8 bc fe ff ff       	callq  1090 <strtol@plt>
    11d4:	89 45 dc             	mov    %eax,-0x24(%rbp)
    11d7:	8b 55 dc             	mov    -0x24(%rbp),%edx
    11da:	48 8d 45 ed          	lea    -0x13(%rbp),%rax
    11de:	48 89 c6             	mov    %rax,%rsi
    11e1:	48 8d 3d 20 0e 00 00 	lea    0xe20(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11e8:	b8 00 00 00 00       	mov    $0x0,%eax
    11ed:	e8 8e fe ff ff       	callq  1080 <printf@plt>
    11f2:	48 8b 55 e0          	mov    -0x20(%rbp),%rdx
    11f6:	48 8d 45 ed          	lea    -0x13(%rbp),%rax
    11fa:	48 39 c2             	cmp    %rax,%rdx
    11fd:	75 18                	jne    1217 <main+0x8e>
    11ff:	48 8d 45 ed          	lea    -0x13(%rbp),%rax
    1203:	48 89 c6             	mov    %rax,%rsi
    1206:	48 8d 3d 13 0e 00 00 	lea    0xe13(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    120d:	b8 00 00 00 00       	mov    $0x0,%eax
    1212:	e8 69 fe ff ff       	callq  1080 <printf@plt>
    1217:	b8 00 00 00 00       	mov    $0x0,%eax
    121c:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    1220:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1227:	00 00 
    1229:	74 05                	je     1230 <main+0xa7>
    122b:	e8 40 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1230:	c9                   	leaveq 
    1231:	c3                   	retq   
