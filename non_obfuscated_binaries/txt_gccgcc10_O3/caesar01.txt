...
/app/bin_gccgcc10_O3/caesar01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10ca:	eb 1a                	jmp    10e6 <main+0x26>
    10cc:	0f 1f 40 00          	nopl   0x0(%rax)
    10d0:	83 c5 0d             	add    $0xd,%ebp
    10d3:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)
    10d8:	48 8b 35 31 2f 00 00 	mov    0x2f31(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    10df:	89 ef                	mov    %ebp,%edi
    10e1:	e8 aa ff ff ff       	callq  1090 <putc@plt>
    10e6:	48 8b 3d 33 2f 00 00 	mov    0x2f33(%rip),%rdi        # 4020 <stdin@@GLIBC_2.2.5>
    10ed:	e8 ae ff ff ff       	callq  10a0 <getc@plt>
    10f2:	89 c5                	mov    %eax,%ebp
    10f4:	83 f8 ff             	cmp    $0xffffffff,%eax
    10f7:	74 4f                	je     1148 <main+0x88>
    10f9:	e8 b2 ff ff ff       	callq  10b0 <__ctype_b_loc@plt>
    10fe:	48 63 dd             	movslq %ebp,%rbx
    1101:	48 8b 00             	mov    (%rax),%rax
    1104:	f6 44 58 01 04       	testb  $0x4,0x1(%rax,%rbx,2)
    1109:	74 cd                	je     10d8 <main+0x18>
    110b:	8d 85 80 00 00 00    	lea    0x80(%rbp),%eax
    1111:	3d 7f 01 00 00       	cmp    $0x17f,%eax
    1116:	77 20                	ja     1138 <main+0x78>
    1118:	e8 63 ff ff ff       	callq  1080 <__ctype_toupper_loc@plt>
    111d:	48 8b 00             	mov    (%rax),%rax
    1120:	8b 04 98             	mov    (%rax,%rbx,4),%eax
    1123:	83 f8 40             	cmp    $0x40,%eax
    1126:	7e 05                	jle    112d <main+0x6d>
    1128:	83 f8 4d             	cmp    $0x4d,%eax
    112b:	7e a3                	jle    10d0 <main+0x10>
    112d:	83 ed 0d             	sub    $0xd,%ebp
    1130:	eb a6                	jmp    10d8 <main+0x18>
    1132:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1138:	83 fd 40             	cmp    $0x40,%ebp
    113b:	7e f0                	jle    112d <main+0x6d>
    113d:	89 e8                	mov    %ebp,%eax
    113f:	eb e7                	jmp    1128 <main+0x68>
