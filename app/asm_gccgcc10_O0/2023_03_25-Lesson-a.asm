...
/app/bin_gccgcc10_O0/2023_03_25-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ab:	e8 e0 fe ff ff       	callq  1090 <time@plt>
    11b0:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    11b4:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11b8:	eb 0c                	jmp    11c6 <main+0x3d>
    11ba:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11be:	48 89 c7             	mov    %rax,%rdi
    11c1:	e8 ca fe ff ff       	callq  1090 <time@plt>
    11c6:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    11ca:	48 39 45 f0          	cmp    %rax,-0x10(%rbp)
    11ce:	74 ea                	je     11ba <main+0x31>
    11d0:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    11d4:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    11d8:	48 c7 45 e8 00 00 00 	movq   $0x0,-0x18(%rbp)
    11df:	00 
    11e0:	eb 11                	jmp    11f3 <main+0x6a>
    11e2:	48 83 45 e8 01       	addq   $0x1,-0x18(%rbp)
    11e7:	48 8d 45 e0          	lea    -0x20(%rbp),%rax
    11eb:	48 89 c7             	mov    %rax,%rdi
    11ee:	e8 9d fe ff ff       	callq  1090 <time@plt>
    11f3:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
    11f7:	48 39 45 f0          	cmp    %rax,-0x10(%rbp)
    11fb:	74 e5                	je     11e2 <main+0x59>
    ...
    121a:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    121e:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1225:	00 00 
    1227:	74 05                	je     122e <main+0xa5>
