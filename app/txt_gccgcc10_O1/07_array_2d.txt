...
/app/bin_gccgcc10_O1/07_array_2d:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11c7:	48 89 e3             	mov    %rsp,%rbx
    11ca:	49 89 dc             	mov    %rbx,%r12
    11cd:	bd 00 00 00 00       	mov    $0x0,%ebp
    11d2:	4c 8d 2d 2f 0e 00 00 	lea    0xe2f(%rip),%r13        # 2008 <_IO_stdin_used+0x8>
    11d9:	b9 00 00 00 00       	mov    $0x0,%ecx
    11de:	89 ea                	mov    %ebp,%edx
    11e0:	4c 89 ee             	mov    %r13,%rsi
    11e3:	bf 01 00 00 00       	mov    $0x1,%edi
    11e8:	b8 00 00 00 00       	mov    $0x0,%eax
    11ed:	e8 ae fe ff ff       	callq  10a0 <__printf_chk@plt>
    11f2:	4c 89 e6             	mov    %r12,%rsi
    11f5:	48 8d 3d 2c 0e 00 00 	lea    0xe2c(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    11fc:	b8 00 00 00 00       	mov    $0x0,%eax
    1201:	e8 aa fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1206:	b9 01 00 00 00       	mov    $0x1,%ecx
    120b:	89 ea                	mov    %ebp,%edx
    120d:	4c 89 ee             	mov    %r13,%rsi
    1210:	bf 01 00 00 00       	mov    $0x1,%edi
    1215:	b8 00 00 00 00       	mov    $0x0,%eax
    121a:	e8 81 fe ff ff       	callq  10a0 <__printf_chk@plt>
    121f:	49 8d 74 24 04       	lea    0x4(%r12),%rsi
    1224:	48 8d 3d fd 0d 00 00 	lea    0xdfd(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    122b:	b8 00 00 00 00       	mov    $0x0,%eax
    1230:	e8 7b fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1235:	83 c5 01             	add    $0x1,%ebp
    1238:	49 83 c4 08          	add    $0x8,%r12
    123c:	83 fd 03             	cmp    $0x3,%ebp
    123f:	75 98                	jne    11d9 <main+0x30>
    1241:	4c 8d 63 18          	lea    0x18(%rbx),%r12
    1245:	48 8d 2d df 0d 00 00 	lea    0xddf(%rip),%rbp        # 202b <_IO_stdin_used+0x2b>
    124c:	8b 13                	mov    (%rbx),%edx
    124e:	48 89 ee             	mov    %rbp,%rsi
    1251:	bf 01 00 00 00       	mov    $0x1,%edi
    1256:	b8 00 00 00 00       	mov    $0x0,%eax
    125b:	e8 40 fe ff ff       	callq  10a0 <__printf_chk@plt>
    1260:	8b 53 04             	mov    0x4(%rbx),%edx
    1263:	48 89 ee             	mov    %rbp,%rsi
    1266:	bf 01 00 00 00       	mov    $0x1,%edi
    126b:	b8 00 00 00 00       	mov    $0x0,%eax
    1270:	e8 2b fe ff ff       	callq  10a0 <__printf_chk@plt>
    1275:	bf 0a 00 00 00       	mov    $0xa,%edi
    127a:	e8 01 fe ff ff       	callq  1080 <putchar@plt>
    127f:	48 83 c3 08          	add    $0x8,%rbx
    1283:	49 39 dc             	cmp    %rbx,%r12
    1286:	75 c4                	jne    124c <main+0xa3>
    1288:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    128d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1294:	00 00 
    1296:	75 10                	jne    12a8 <main+0xff>
    1298:	b8 00 00 00 00       	mov    $0x0,%eax
    129d:	48 83 c4 28          	add    $0x28,%rsp
    12a1:	5b                   	pop    %rbx
    12a2:	5d                   	pop    %rbp
    12a3:	41 5c                	pop    %r12
    12a5:	41 5d                	pop    %r13
