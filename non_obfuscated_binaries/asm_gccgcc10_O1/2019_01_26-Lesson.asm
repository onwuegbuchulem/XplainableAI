...
/app/bin_gccgcc10_O1/2019_01_26-Lesson:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a1:	48 b8 67 65 74 74 79 	movabs $0x7562737974746567,%rax
    11a8:	73 62 75 
    11ab:	48 89 44 24 09       	mov    %rax,0x9(%rsp)
    11b0:	c7 44 24 11 72 67 2e 	movl   $0x742e6772,0x11(%rsp)
    11b7:	74 
    11b8:	66 c7 44 24 15 78 74 	movw   $0x7478,0x15(%rsp)
    11bf:	c6 44 24 17 00       	movb   $0x0,0x17(%rsp)
    11c4:	48 8d 7c 24 09       	lea    0x9(%rsp),%rdi
    11c9:	be 00 00 00 00       	mov    $0x0,%esi
    11ce:	e8 bd fe ff ff       	callq  1090 <access@plt>
    11d3:	85 c0                	test   %eax,%eax
    11d5:	75 30                	jne    1207 <main+0x7e>
    11d7:	48 8d 54 24 09       	lea    0x9(%rsp),%rdx
    11dc:	48 8d 35 21 0e 00 00 	lea    0xe21(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11e3:	bf 01 00 00 00       	mov    $0x1,%edi
    11e8:	e8 93 fe ff ff       	callq  1080 <__printf_chk@plt>
    11ed:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11f2:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f9:	00 00 
    11fb:	75 27                	jne    1224 <main+0x9b>
    11fd:	b8 00 00 00 00       	mov    $0x0,%eax
    1202:	48 83 c4 28          	add    $0x28,%rsp
    1206:	c3                   	retq   
    1207:	48 8d 54 24 09       	lea    0x9(%rsp),%rdx
    120c:	48 8d 35 03 0e 00 00 	lea    0xe03(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    1213:	bf 01 00 00 00       	mov    $0x1,%edi
    1218:	b8 00 00 00 00       	mov    $0x0,%eax
    121d:	e8 5e fe ff ff       	callq  1080 <__printf_chk@plt>
    1222:	eb c9                	jmp    11ed <main+0x64>
