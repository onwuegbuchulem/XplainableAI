...
/app/bin_gccgcc10_O0/2023_12_09-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 e0 0a 00 00 00 	movl   $0xa,-0x20(%rbp)
    118b:	c7 45 e4 14 00 00 00 	movl   $0x14,-0x1c(%rbp)
    1192:	c7 45 e8 1e 00 00 00 	movl   $0x1e,-0x18(%rbp)
    1199:	c7 45 ec 28 00 00 00 	movl   $0x28,-0x14(%rbp)
    11a0:	c7 45 f0 32 00 00 00 	movl   $0x32,-0x10(%rbp)
    11a7:	c7 45 f4 3c 00 00 00 	movl   $0x3c,-0xc(%rbp)
    11ae:	c7 45 dc 00 00 00 00 	movl   $0x0,-0x24(%rbp)
    11b5:	eb 20                	jmp    11d7 <main+0x6e>
    11b7:	8b 45 dc             	mov    -0x24(%rbp),%eax
    11ba:	48 98                	cltq   
    11bc:	8b 44 85 e0          	mov    -0x20(%rbp,%rax,4),%eax
    ...
    11d3:	83 45 dc 01          	addl   $0x1,-0x24(%rbp)
    11d7:	83 7d dc 05          	cmpl   $0x5,-0x24(%rbp)
    11db:	7e da                	jle    11b7 <main+0x4e>
    11dd:	b8 00 00 00 00       	mov    $0x0,%eax
    11e2:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    11e6:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    11ed:	00 00 
    11ef:	74 05                	je     11f6 <main+0x8d>
    11f1:	e8 6a fe ff ff       	callq  1060 <__stack_chk_fail@plt>
    11f6:	c9                   	leaveq 
    11f7:	c3                   	retq   
