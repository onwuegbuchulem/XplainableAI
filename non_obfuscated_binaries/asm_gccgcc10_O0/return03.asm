...
/app/bin_gccgcc10_O0/return03:     file format elf64-x86-64
...
00000000000011c9 <main>:
    ...
    11da:	e8 d1 fe ff ff       	callq  10b0 <time@plt>
    11df:	89 c7                	mov    %eax,%edi
    11e1:	e8 ba fe ff ff       	callq  10a0 <srand@plt>
    11e6:	e8 e5 fe ff ff       	callq  10d0 <rand@plt>
    11eb:	99                   	cltd   
    11ec:	c1 ea 1f             	shr    $0x1f,%edx
    11ef:	01 d0                	add    %edx,%eax
    11f1:	83 e0 01             	and    $0x1,%eax
    11f4:	29 d0                	sub    %edx,%eax
    11f6:	89 45 fc             	mov    %eax,-0x4(%rbp)
    11f9:	83 7d fc 00          	cmpl   $0x0,-0x4(%rbp)
    11fd:	74 27                	je     1226 <main+0x5d>
    11ff:	48 8b 05 1a 2e 00 00 	mov    0x2e1a(%rip),%rax        # 4020 <stderr@@GLIBC_2.2.5>
    1206:	48 89 c1             	mov    %rax,%rcx
    1209:	ba 1f 00 00 00       	mov    $0x1f,%edx
    120e:	be 01 00 00 00       	mov    $0x1,%esi
    1213:	48 8d 3d ee 0d 00 00 	lea    0xdee(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    121a:	e8 a1 fe ff ff       	callq  10c0 <fwrite@plt>
    121f:	b8 01 00 00 00       	mov    $0x1,%eax
    1224:	eb 11                	jmp    1237 <main+0x6e>
    1226:	48 8d 3d fb 0d 00 00 	lea    0xdfb(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
