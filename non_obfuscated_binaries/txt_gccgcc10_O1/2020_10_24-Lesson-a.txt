...
/app/bin_gccgcc10_O1/2020_10_24-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1177:	ba 02 00 00 00       	mov    $0x2,%edx
    ...
    118d:	e8 de fe ff ff       	callq  1070 <__printf_chk@plt>
    1192:	41 bc 02 00 00 00    	mov    $0x2,%r12d
    1198:	4c 8d 2d 69 0e 00 00 	lea    0xe69(%rip),%r13        # 2008 <_IO_stdin_used+0x8>
    119f:	eb 2c                	jmp    11cd <main+0x64>
    11a1:	8d 43 01             	lea    0x1(%rbx),%eax
    11a4:	41 39 dc             	cmp    %ebx,%r12d
    11a7:	74 21                	je     11ca <main+0x61>
    11a9:	89 c3                	mov    %eax,%ebx
    11ab:	89 e8                	mov    %ebp,%eax
    11ad:	99                   	cltd   
    11ae:	f7 fb                	idiv   %ebx
    11b0:	85 d2                	test   %edx,%edx
    11b2:	75 ed                	jne    11a1 <main+0x38>
    11b4:	89 da                	mov    %ebx,%edx
    11b6:	4c 89 ee             	mov    %r13,%rsi
    11b9:	bf 01 00 00 00       	mov    $0x1,%edi
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 a8 fe ff ff       	callq  1070 <__printf_chk@plt>
    11c8:	eb d7                	jmp    11a1 <main+0x38>
    11ca:	41 89 ec             	mov    %ebp,%r12d
    11cd:	41 8d 6c 24 01       	lea    0x1(%r12),%ebp
    11d2:	48 8b 35 37 2e 00 00 	mov    0x2e37(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11d9:	bf 0a 00 00 00       	mov    $0xa,%edi
    11de:	e8 7d fe ff ff       	callq  1060 <putc@plt>
    11e3:	83 fd 64             	cmp    $0x64,%ebp
    11e6:	74 24                	je     120c <main+0xa3>
    11e8:	89 ea                	mov    %ebp,%edx
    ...
    1200:	83 fd 02             	cmp    $0x2,%ebp
    1203:	7e c5                	jle    11ca <main+0x61>
    1205:	bb 02 00 00 00       	mov    $0x2,%ebx
    120a:	eb 9f                	jmp    11ab <main+0x42>
