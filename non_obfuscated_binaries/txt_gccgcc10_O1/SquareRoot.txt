...
/app/bin_gccgcc10_O1/SquareRoot:     file format elf64-x86-64
...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d 3f 01 00 00 	lea    0x13f(%rip),%rdi        # 1207 <main>
...
0000000000001189 <squareRoot>:
    ...
    118d:	66 0f ef d2          	pxor   %xmm2,%xmm2
    1191:	f2 0f 2a d7          	cvtsi2sd %edi,%xmm2
    1195:	f2 0f 10 05 7b 0e 00 	movsd  0xe7b(%rip),%xmm0        # 2018 <MAX_ERROR+0x8>
    119c:	00 
    119d:	f2 0f 5c c2          	subsd  %xmm2,%xmm0
    11a1:	66 0f 54 05 87 0e 00 	andpd  0xe87(%rip),%xmm0        # 2030 <MAX_ERROR+0x20>
    11a8:	00 
    11a9:	66 0f 28 c8          	movapd %xmm0,%xmm1
    11ad:	f2 0f 10 05 63 0e 00 	movsd  0xe63(%rip),%xmm0        # 2018 <MAX_ERROR+0x8>
    11b4:	00 
    11b5:	66 0f 2f 0d 63 0e 00 	comisd 0xe63(%rip),%xmm1        # 2020 <MAX_ERROR+0x10>
    11bc:	00 
    11bd:	76 3f                	jbe    11fe <squareRoot+0x75>
    11bf:	f2 0f 10 2d 61 0e 00 	movsd  0xe61(%rip),%xmm5        # 2028 <MAX_ERROR+0x18>
    11c6:	00 
    11c7:	f3 0f 7e 25 61 0e 00 	movq   0xe61(%rip),%xmm4        # 2030 <MAX_ERROR+0x20>
    11ce:	00 
    11cf:	f2 0f 10 1d 49 0e 00 	movsd  0xe49(%rip),%xmm3        # 2020 <MAX_ERROR+0x10>
    11d6:	00 
    11d7:	66 0f 28 ca          	movapd %xmm2,%xmm1
    11db:	f2 0f 5e c8          	divsd  %xmm0,%xmm1
    11df:	f2 0f 58 c1          	addsd  %xmm1,%xmm0
    11e3:	f2 0f 59 c5          	mulsd  %xmm5,%xmm0
    11e7:	66 0f 28 c8          	movapd %xmm0,%xmm1
    11eb:	f2 0f 59 c8          	mulsd  %xmm0,%xmm1
    11ef:	f2 0f 5c ca          	subsd  %xmm2,%xmm1
    11f3:	66 0f 54 cc          	andpd  %xmm4,%xmm1
    11f7:	66 0f 2f cb          	comisd %xmm3,%xmm1
    11fb:	77 da                	ja     11d7 <squareRoot+0x4e>
    11fd:	c3                   	retq   
    11fe:	f2 0f 10 05 12 0e 00 	movsd  0xe12(%rip),%xmm0        # 2018 <MAX_ERROR+0x8>
    1205:	00 
    1206:	c3                   	retq   

0000000000001207 <main>:
    1207:	f3 0f 1e fa          	endbr64 
    120b:	48 83 ec 18          	sub    $0x18,%rsp
    120f:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1216:	00 00 
    1218:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    121d:	31 c0                	xor    %eax,%eax
    121f:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    1224:	48 8d 3d d9 0d 00 00 	lea    0xdd9(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    122b:	e8 60 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    1230:	8b 7c 24 04          	mov    0x4(%rsp),%edi
    1234:	e8 50 ff ff ff       	callq  1189 <squareRoot>
    1239:	48 8d 35 c7 0d 00 00 	lea    0xdc7(%rip),%rsi        # 2007 <_IO_stdin_used+0x7>
    1240:	bf 01 00 00 00       	mov    $0x1,%edi
    1245:	b8 01 00 00 00       	mov    $0x1,%eax
    124a:	e8 31 fe ff ff       	callq  1080 <__printf_chk@plt>
    124f:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1254:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    125b:	00 00 
    125d:	75 0a                	jne    1269 <main+0x62>
    125f:	b8 00 00 00 00       	mov    $0x0,%eax
    1264:	48 83 c4 18          	add    $0x18,%rsp
    1268:	c3                   	retq   
