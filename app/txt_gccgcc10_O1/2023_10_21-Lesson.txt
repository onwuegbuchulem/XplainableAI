...
/app/bin_gccgcc10_O1/2023_10_21-Lesson:     file format elf64-x86-64
...
0000000000001249 <main>:
    ...
    124f:	55                   	push   %rbp
    1250:	53                   	push   %rbx
    1251:	48 81 ec 10 04 00 00 	sub    $0x410,%rsp
    1258:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    125f:	00 00 
    1261:	48 89 84 24 08 04 00 	mov    %rax,0x408(%rsp)
    1268:	00 
    1269:	31 c0                	xor    %eax,%eax
    126b:	48 8d 35 92 0d 00 00 	lea    0xd92(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    1272:	48 8d 3d 8d 0d 00 00 	lea    0xd8d(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    1279:	e8 b2 fe ff ff       	callq  1130 <fopen@plt>
    127e:	48 85 c0             	test   %rax,%rax
    1281:	74 66                	je     12e9 <main+0xa0>
    1283:	48 89 c3             	mov    %rax,%rbx
    1286:	41 bc 00 00 00 00    	mov    $0x0,%r12d
    128c:	48 89 e5             	mov    %rsp,%rbp
    128f:	48 89 df             	mov    %rbx,%rdi
    1292:	e8 79 fe ff ff       	callq  1110 <feof@plt>
    1297:	85 c0                	test   %eax,%eax
    1299:	75 7c                	jne    1317 <main+0xce>
    129b:	48 89 da             	mov    %rbx,%rdx
    129e:	be 00 04 00 00       	mov    $0x400,%esi
    12a3:	48 89 ef             	mov    %rbp,%rdi
    12a6:	e8 55 fe ff ff       	callq  1100 <fgets@plt>
    12ab:	48 85 c0             	test   %rax,%rax
    12ae:	74 67                	je     1317 <main+0xce>
    12b0:	48 89 ef             	mov    %rbp,%rdi
    12b3:	e8 28 fe ff ff       	callq  10e0 <strlen@plt>
    12b8:	48 89 c2             	mov    %rax,%rdx
    12bb:	49 63 c4             	movslq %r12d,%rax
    12be:	48 39 c2             	cmp    %rax,%rdx
    12c1:	76 cc                	jbe    128f <main+0x46>
    12c3:	48 89 ea             	mov    %rbp,%rdx
    12c6:	48 8d 35 62 0d 00 00 	lea    0xd62(%rip),%rsi        # 202f <_IO_stdin_used+0x2f>
    12cd:	bf 01 00 00 00       	mov    $0x1,%edi
    12d2:	b8 00 00 00 00       	mov    $0x0,%eax
    12d7:	e8 44 fe ff ff       	callq  1120 <__printf_chk@plt>
    12dc:	48 89 ef             	mov    %rbp,%rdi
    12df:	e8 fc fd ff ff       	callq  10e0 <strlen@plt>
    12e4:	41 89 c4             	mov    %eax,%r12d
    12e7:	eb a6                	jmp    128f <main+0x46>
    12e9:	48 8d 0d 16 0d 00 00 	lea    0xd16(%rip),%rcx        # 2006 <_IO_stdin_used+0x6>
    12f0:	48 8d 15 25 0d 00 00 	lea    0xd25(%rip),%rdx        # 201c <_IO_stdin_used+0x1c>
    12f7:	be 01 00 00 00       	mov    $0x1,%esi
    12fc:	48 8b 3d 1d 2d 00 00 	mov    0x2d1d(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    1303:	b8 00 00 00 00       	mov    $0x0,%eax
    1308:	e8 43 fe ff ff       	callq  1150 <__fprintf_chk@plt>
    130d:	bf 01 00 00 00       	mov    $0x1,%edi
    1312:	e8 29 fe ff ff       	callq  1140 <exit@plt>
    1317:	44 89 e2             	mov    %r12d,%edx
    131a:	48 8d 35 17 0d 00 00 	lea    0xd17(%rip),%rsi        # 2038 <_IO_stdin_used+0x38>
    1321:	bf 01 00 00 00       	mov    $0x1,%edi
    1326:	b8 00 00 00 00       	mov    $0x0,%eax
    132b:	e8 f0 fd ff ff       	callq  1120 <__printf_chk@plt>
    1330:	48 89 df             	mov    %rbx,%rdi
    1333:	e8 98 fd ff ff       	callq  10d0 <fclose@plt>
    1338:	48 8b 84 24 08 04 00 	mov    0x408(%rsp),%rax
    133f:	00 
    1340:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1347:	00 00 
    1349:	75 11                	jne    135c <main+0x113>
    134b:	b8 00 00 00 00       	mov    $0x0,%eax
    1350:	48 81 c4 10 04 00 00 	add    $0x410,%rsp
    1357:	5b                   	pop    %rbx
    1358:	5d                   	pop    %rbp
    1359:	41 5c                	pop    %r12
    135b:	c3                   	retq   
    135c:	e8 8f fd ff ff       	callq  10f0 <__stack_chk_fail@plt>
