...
/app/bin_gccgcc10_O3/readdir02:     file format elf64-x86-64
...
0000000000001100 <main>:
    ...
    1104:	55                   	push   %rbp
    1105:	48 8d 3d f8 0e 00 00 	lea    0xef8(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    110c:	e8 9f ff ff ff       	callq  10b0 <opendir@plt>
    1111:	48 85 c0             	test   %rax,%rax
    1114:	74 2e                	je     1144 <main+0x44>
    1116:	48 89 c7             	mov    %rax,%rdi
    1119:	48 89 c5             	mov    %rax,%rbp
    111c:	e8 af ff ff ff       	callq  10d0 <readdir@plt>
    1121:	48 8d 35 f7 0e 00 00 	lea    0xef7(%rip),%rsi        # 201f <_IO_stdin_used+0x1f>
    1128:	bf 01 00 00 00       	mov    $0x1,%edi
    112d:	48 8d 50 13          	lea    0x13(%rax),%rdx
    1131:	31 c0                	xor    %eax,%eax
    1133:	e8 a8 ff ff ff       	callq  10e0 <__printf_chk@plt>
    1138:	48 89 ef             	mov    %rbp,%rdi
    113b:	e8 80 ff ff ff       	callq  10c0 <closedir@plt>
    1140:	31 c0                	xor    %eax,%eax
    1142:	5d                   	pop    %rbp
    1143:	c3                   	retq   
    1144:	48 8d 3d bb 0e 00 00 	lea    0xebb(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    114b:	e8 50 ff ff ff       	callq  10a0 <puts@plt>
    1150:	bf 01 00 00 00       	mov    $0x1,%edi
    1155:	e8 96 ff ff ff       	callq  10f0 <exit@plt>
...
0000000000001250 <__libc_csu_init>:
    ...
    1254:	41 57                	push   %r15
    1256:	4c 8d 3d 33 2b 00 00 	lea    0x2b33(%rip),%r15        # 3d90 <__frame_dummy_init_array_entry>
    125d:	41 56                	push   %r14
    ...
    126c:	55                   	push   %rbp
    126d:	48 8d 2d 24 2b 00 00 	lea    0x2b24(%rip),%rbp        # 3d98 <__do_global_dtors_aux_fini_array_entry>
    1274:	53                   	push   %rbx
