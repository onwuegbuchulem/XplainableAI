...
/app/bin_gccgcc9_O2/DynamicTwoDArrayUsingArrayOfPointer:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10fc:	48 b9 01 00 00 00 02 	movabs $0x200000001,%rcx
    1103:	00 00 00 
    1106:	48 89 4d 00          	mov    %rcx,0x0(%rbp)
    110a:	48 b9 03 00 00 00 04 	movabs $0x400000003,%rcx
    1111:	00 00 00 
    1114:	48 89 4d 08          	mov    %rcx,0x8(%rbp)
    1118:	48 b9 05 00 00 00 06 	movabs $0x600000005,%rcx
    111f:	00 00 00 
    1122:	48 89 0b             	mov    %rcx,(%rbx)
    1125:	48 b9 07 00 00 00 08 	movabs $0x800000007,%rcx
    112c:	00 00 00 
    112f:	48 89 4b 08          	mov    %rcx,0x8(%rbx)
    1133:	48 b9 09 00 00 00 0a 	movabs $0xa00000009,%rcx
    113a:	00 00 00 
    113d:	48 89 08             	mov    %rcx,(%rax)
    1140:	48 b9 0b 00 00 00 0c 	movabs $0xc0000000b,%rcx
    1147:	00 00 00 
    114a:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    114f:	48 89 48 08          	mov    %rcx,0x8(%rax)
    1153:	49 8b 5d 00          	mov    0x0(%r13),%rbx
    1157:	48 8d 6b 10          	lea    0x10(%rbx),%rbp
    115b:	8b 13                	mov    (%rbx),%edx
    115d:	4c 89 e6             	mov    %r12,%rsi
    1160:	bf 01 00 00 00       	mov    $0x1,%edi
    1165:	31 c0                	xor    %eax,%eax
    1167:	48 83 c3 04          	add    $0x4,%rbx
    116b:	e8 20 ff ff ff       	callq  1090 <__printf_chk@plt>
    1170:	48 39 eb             	cmp    %rbp,%rbx
    1173:	75 e6                	jne    115b <main+0xbb>
    1175:	49 83 c5 08          	add    $0x8,%r13
    1179:	4d 39 ee             	cmp    %r13,%r14
    117c:	75 d5                	jne    1153 <main+0xb3>
    117e:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1183:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    118a:	00 00 
    118c:	75 0f                	jne    119d <main+0xfd>
    118e:	48 83 c4 20          	add    $0x20,%rsp
    ...
    119a:	41 5e                	pop    %r14
    119c:	c3                   	retq   
    119d:	e8 ce fe ff ff       	callq  1070 <__stack_chk_fail@plt>
