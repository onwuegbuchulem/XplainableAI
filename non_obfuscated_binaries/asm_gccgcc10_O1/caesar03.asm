...
/app/bin_gccgcc10_O1/caesar03:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11c9:	8d 43 fd             	lea    -0x3(%rbx),%eax
    11cc:	8d 53 a2             	lea    -0x5e(%rbx),%edx
    11cf:	83 fa 05             	cmp    $0x5,%edx
    11d2:	76 bc                	jbe    1190 <main+0x7>
    11d4:	83 f8 40             	cmp    $0x40,%eax
    11d7:	7e b7                	jle    1190 <main+0x7>
