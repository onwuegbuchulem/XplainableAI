...
/app/bin_gccgcc10_O1/2019_07_13-Lesson-c:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a2:	66 c7 44 24 16 30 00 	movw   $0x30,0x16(%rsp)
    11a9:	48 8d 74 24 08       	lea    0x8(%rsp),%rsi
    11ae:	48 8d 5c 24 16       	lea    0x16(%rsp),%rbx
    11b3:	ba 0a 00 00 00       	mov    $0xa,%edx
    11b8:	48 89 df             	mov    %rbx,%rdi
    11bb:	e8 c0 fe ff ff       	callq  1080 <strtol@plt>
    11c0:	48 89 c1             	mov    %rax,%rcx
    11c3:	48 89 da             	mov    %rbx,%rdx
    ...
    11d7:	e8 b4 fe ff ff       	callq  1090 <__printf_chk@plt>
    11dc:	48 39 5c 24 08       	cmp    %rbx,0x8(%rsp)
    11e1:	74 1b                	je     11fe <main+0x75>
    11e3:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    11e8:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11ef:	00 00 
    11f1:	75 26                	jne    1219 <main+0x90>
    11f3:	b8 00 00 00 00       	mov    $0x0,%eax
    11f8:	48 83 c4 20          	add    $0x20,%rsp
    11fc:	5b                   	pop    %rbx
    11fd:	c3                   	retq   
    11fe:	48 89 da             	mov    %rbx,%rdx
    1201:	48 8d 35 18 0e 00 00 	lea    0xe18(%rip),%rsi        # 2020 <_IO_stdin_used+0x20>
    1208:	bf 01 00 00 00       	mov    $0x1,%edi
    120d:	b8 00 00 00 00       	mov    $0x0,%eax
    1212:	e8 79 fe ff ff       	callq  1090 <__printf_chk@plt>
    1217:	eb ca                	jmp    11e3 <main+0x5a>
