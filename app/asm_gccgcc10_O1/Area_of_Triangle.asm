...
/app/bin_gccgcc10_O1/Area_of_Triangle:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b5:	48 8d 3d 76 0e 00 00 	lea    0xe76(%rip),%rdi        # 2032 <_IO_stdin_used+0x32>
    11bc:	b8 00 00 00 00       	mov    $0x0,%eax
    11c1:	e8 ca fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c6:	48 8d 35 49 0e 00 00 	lea    0xe49(%rip),%rsi        # 2016 <_IO_stdin_used+0x16>
    ...
    11e1:	48 8d 3d 4a 0e 00 00 	lea    0xe4a(%rip),%rdi        # 2032 <_IO_stdin_used+0x32>
    11e8:	b8 00 00 00 00       	mov    $0x0,%eax
    11ed:	e8 9e fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11f2:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11f6:	f3 0f 5a 04 24       	cvtss2sd (%rsp),%xmm0
    11fb:	f2 0f 59 05 35 0e 00 	mulsd  0xe35(%rip),%xmm0        # 2038 <_IO_stdin_used+0x38>
    1202:	00 
    1203:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1207:	f3 0f 5a 4c 24 04    	cvtss2sd 0x4(%rsp),%xmm1
    120d:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    1211:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    1215:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1219:	48 8d 35 0a 0e 00 00 	lea    0xe0a(%rip),%rsi        # 202a <_IO_stdin_used+0x2a>
