...
/app/bin_gccgcc10_O1/weekday01:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    12d3:	48 63 78 18          	movslq 0x18(%rax),%rdi
    12d7:	8b 70 14             	mov    0x14(%rax),%esi
    12da:	8b 48 0c             	mov    0xc(%rax),%ecx
    12dd:	48 63 40 10          	movslq 0x10(%rax),%rax
    12e1:	48 8b 54 c4 50       	mov    0x50(%rsp,%rax,8),%rdx
    12e6:	4c 8b 4c fc 10       	mov    0x10(%rsp,%rdi,8),%r9
    12eb:	44 8d 86 6c 07 00 00 	lea    0x76c(%rsi),%r8d
    ...
    1308:	48 8b 84 24 b8 00 00 	mov    0xb8(%rsp),%rax
    130f:	00 
    1310:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1317:	00 00 
    1319:	75 0e                	jne    1329 <main+0x180>
    131b:	b8 00 00 00 00       	mov    $0x0,%eax
    1320:	48 81 c4 c0 00 00 00 	add    $0xc0,%rsp
    1327:	5b                   	pop    %rbx
    1328:	c3                   	retq   
    1329:	e8 62 fd ff ff       	callq  1090 <__stack_chk_fail@plt>
