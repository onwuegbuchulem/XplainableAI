...
/app/bin_gccgcc10_O2/Value_Address:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	ba 1a 00 00 00       	mov    $0x1a,%edx
    ...
    10a9:	c7 44 24 04 1a 00 00 	movl   $0x1a,0x4(%rsp)
    10b0:	00 
    10b1:	e8 ba ff ff ff       	callq  1070 <__printf_chk@plt>
    10b6:	31 c0                	xor    %eax,%eax
    10b8:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    10bd:	48 8d 35 4c 0f 00 00 	lea    0xf4c(%rip),%rsi        # 2010 <_IO_stdin_used+0x10>
    10c4:	bf 01 00 00 00       	mov    $0x1,%edi
    10c9:	e8 a2 ff ff ff       	callq  1070 <__printf_chk@plt>
    10ce:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10d3:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10da:	00 00 
    10dc:	75 07                	jne    10e5 <main+0x65>
    10de:	31 c0                	xor    %eax,%eax
    10e0:	48 83 c4 18          	add    $0x18,%rsp
    10e4:	c3                   	retq   
