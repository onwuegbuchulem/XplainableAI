...
/app/bin_gccgcc10_O1/2022_04_23-Lesson-b:     file format elf64-x86-64
...
0000000000001100 <_start>:
    ...
    1121:	48 8d 3d 0c 01 00 00 	lea    0x10c(%rip),%rdi        # 1234 <main>
...
00000000000011e9 <memory>:
    11e9:	f3 0f 1e fa          	endbr64 
    11ed:	48 83 ec 08          	sub    $0x8,%rsp
    11f1:	bf 00 00 00 40       	mov    $0x40000000,%edi
    11f6:	e8 c5 fe ff ff       	callq  10c0 <malloc@plt>
    11fb:	48 85 c0             	test   %rax,%rax
    11fe:	74 0d                	je     120d <memory+0x24>
    1200:	48 89 c7             	mov    %rax,%rdi
    1203:	e8 98 fe ff ff       	callq  10a0 <free@plt>
    1208:	48 83 c4 08          	add    $0x8,%rsp
    120c:	c3                   	retq   
    120d:	48 8b 0d 0c 2e 00 00 	mov    0x2e0c(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1214:	ba 1a 00 00 00       	mov    $0x1a,%edx
    1219:	be 01 00 00 00       	mov    $0x1,%esi
    121e:	48 8d 3d df 0d 00 00 	lea    0xddf(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1225:	e8 c6 fe ff ff       	callq  10f0 <fwrite@plt>
    122a:	bf 01 00 00 00       	mov    $0x1,%edi
    122f:	e8 ac fe ff ff       	callq  10e0 <exit@plt>

0000000000001234 <main>:
    1234:	f3 0f 1e fa          	endbr64 
    1238:	55                   	push   %rbp
    1239:	53                   	push   %rbx
    123a:	48 83 ec 08          	sub    $0x8,%rsp
    123e:	bb 00 00 00 00       	mov    $0x0,%ebx
    1243:	48 8d 2d d5 0d 00 00 	lea    0xdd5(%rip),%rbp        # 201f <_IO_stdin_used+0x1f>
    124a:	89 da                	mov    %ebx,%edx
    124c:	48 89 ee             	mov    %rbp,%rsi
    124f:	bf 01 00 00 00       	mov    $0x1,%edi
    1254:	b8 00 00 00 00       	mov    $0x0,%eax
    1259:	e8 72 fe ff ff       	callq  10d0 <__printf_chk@plt>
    125e:	e8 86 ff ff ff       	callq  11e9 <memory>
    1263:	48 8d 3d cf 0d 00 00 	lea    0xdcf(%rip),%rdi        # 2039 <_IO_stdin_used+0x39>
    126a:	e8 41 fe ff ff       	callq  10b0 <puts@plt>
    126f:	83 c3 01             	add    $0x1,%ebx
    1272:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
    1278:	75 d0                	jne    124a <main+0x16>
