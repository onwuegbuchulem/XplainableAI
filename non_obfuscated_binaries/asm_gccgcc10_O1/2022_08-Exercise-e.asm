...
/app/bin_gccgcc10_O1/2022_08-Exercise-e:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11b1:	bf 35 00 00 00       	mov    $0x35,%edi
    11b6:	e8 d5 fe ff ff       	callq  1090 <malloc@plt>
    11bb:	48 85 c0             	test   %rax,%rax
    11be:	74 3f                	je     11ff <main+0x56>
    11c0:	48 89 c7             	mov    %rax,%rdi
    11c3:	48 8d 50 35          	lea    0x35(%rax),%rdx
    11c7:	c6 00 41             	movb   $0x41,(%rax)
    11ca:	48 83 c0 01          	add    $0x1,%rax
    11ce:	48 39 d0             	cmp    %rdx,%rax
    11d1:	75 f4                	jne    11c7 <main+0x1e>
    11d3:	b8 00 00 00 00       	mov    $0x0,%eax
    11d8:	00 04 47             	add    %al,(%rdi,%rax,2)
    11db:	8d 50 20             	lea    0x20(%rax),%edx
    11de:	00 54 47 01          	add    %dl,0x1(%rdi,%rax,2)
    11e2:	48 83 c0 01          	add    $0x1,%rax
    11e6:	48 83 f8 1a          	cmp    $0x1a,%rax
    11ea:	75 ec                	jne    11d8 <main+0x2f>
    11ec:	c6 47 34 00          	movb   $0x0,0x34(%rdi)
    11f0:	e8 8b fe ff ff       	callq  1080 <puts@plt>
    11f5:	b8 00 00 00 00       	mov    $0x0,%eax
    11fa:	48 83 c4 08          	add    $0x8,%rsp
    11fe:	c3                   	retq   
    11ff:	48 8b 0d 1a 2e 00 00 	mov    0x2e1a(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1206:	ba 1a 00 00 00       	mov    $0x1a,%edx
    120b:	be 01 00 00 00       	mov    $0x1,%esi
    1210:	48 8d 3d ed 0d 00 00 	lea    0xded(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1217:	e8 94 fe ff ff       	callq  10b0 <fwrite@plt>
    121c:	bf 01 00 00 00       	mov    $0x1,%edi
    1221:	e8 7a fe ff ff       	callq  10a0 <exit@plt>
