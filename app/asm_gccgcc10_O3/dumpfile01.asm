...
/app/bin_gccgcc10_O3/dumpfile01:     file format elf64-x86-64
...
0000000000001390 <line_out>:
    ...
    1398:	41 55                	push   %r13
    139a:	41 89 f5             	mov    %esi,%r13d
    139d:	48 8d 35 60 0c 00 00 	lea    0xc60(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    13a4:	41 54                	push   %r12
    13a6:	55                   	push   %rbp
    ...
    13cb:	45 8d 75 01          	lea    0x1(%r13),%r14d
    13cf:	48 8d 35 34 0c 00 00 	lea    0xc34(%rip),%rsi        # 200a <_IO_stdin_used+0xa>
    13d6:	bb 02 00 00 00       	mov    $0x2,%ebx
    13db:	4c 8d 25 28 0c 00 00 	lea    0xc28(%rip),%r12        # 200a <_IO_stdin_used+0xa>
    13e2:	e8 49 fd ff ff       	callq  1130 <__printf_chk@plt>
    13e7:	41 83 fd 01          	cmp    $0x1,%r13d
    13eb:	74 36                	je     1423 <line_out+0x93>
    13ed:	0f 1f 00             	nopl   (%rax)
    13f0:	0f b6 54 1d ff       	movzbl -0x1(%rbp,%rbx,1),%edx
    13f5:	31 c0                	xor    %eax,%eax
    13f7:	4c 89 e6             	mov    %r12,%rsi
    ...
    1432:	e8 d9 fc ff ff       	callq  1110 <putc@plt>
    1437:	41 8d 45 ff          	lea    -0x1(%r13),%eax
    143b:	48 8d 6c 05 01       	lea    0x1(%rbp,%rax,1),%rbp
