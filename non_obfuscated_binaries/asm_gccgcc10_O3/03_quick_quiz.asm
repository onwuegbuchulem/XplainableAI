...
/app/bin_gccgcc10_O3/03_quick_quiz:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10cb:	ba 03 00 00 00       	mov    $0x3,%edx
    ...
    10e1:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10e6:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10ed:	00 00 
    10ef:	75 07                	jne    10f8 <main+0x58>
    10f1:	31 c0                	xor    %eax,%eax
    10f3:	48 83 c4 18          	add    $0x18,%rsp
    10f7:	c3                   	retq   
    10f8:	e8 73 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
