...
/app/bin_gccgcc10_O1/Area_of_Circle:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11b7:	48 8d 3d 62 0e 00 00 	lea    0xe62(%rip),%rdi        # 2020 <_IO_stdin_used+0x20>
    11be:	b8 00 00 00 00       	mov    $0x0,%eax
    11c3:	e8 c8 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11c8:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11cc:	f3 0f 5a 4c 24 04    	cvtss2sd 0x4(%rsp),%xmm1
    11d2:	66 0f 28 c1          	movapd %xmm1,%xmm0
    11d6:	f2 0f 59 05 4a 0e 00 	mulsd  0xe4a(%rip),%xmm0        # 2028 <_IO_stdin_used+0x28>
    11dd:	00 
    11de:	f2 0f 59 c1          	mulsd  %xmm1,%xmm0
    11e2:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    11e6:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    11ea:	48 8d 35 27 0e 00 00 	lea    0xe27(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
