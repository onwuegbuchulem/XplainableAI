...
/app/bin_gccgcc10_O2/2023_02_04-Lesson:     file format elf64-x86-64
...
0000000000001080 <ioctl@plt>:
    1080:	f3 0f 1e fa          	endbr64 
    1084:	f2 ff 25 3d 2f 00 00 	bnd jmpq *0x2f3d(%rip)        # 3fc8 <ioctl@GLIBC_2.2.5>
...
00000000000010a0 <main>:
    ...
    10a8:	be 13 54 00 00       	mov    $0x5413,%esi
    ...
    10c5:	e8 b6 ff ff ff       	callq  1080 <ioctl@plt>
    10ca:	0f b7 4c 24 02       	movzwl 0x2(%rsp),%ecx
    10cf:	0f b7 14 24          	movzwl (%rsp),%edx
    10d3:	31 c0                	xor    %eax,%eax
    10d5:	48 8d 35 2c 0f 00 00 	lea    0xf2c(%rip),%rsi        # 2008 <_IO_stdin_used+0x8>
    10dc:	bf 01 00 00 00       	mov    $0x1,%edi
    10e1:	e8 aa ff ff ff       	callq  1090 <__printf_chk@plt>
    10e6:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    10eb:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10f2:	00 00 
    10f4:	75 07                	jne    10fd <main+0x5d>
    10f6:	31 c0                	xor    %eax,%eax
    10f8:	48 83 c4 18          	add    $0x18,%rsp
    10fc:	c3                   	retq   
    10fd:	e8 6e ff ff ff       	callq  1070 <__stack_chk_fail@plt>
