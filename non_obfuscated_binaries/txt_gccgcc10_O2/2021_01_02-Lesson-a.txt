...
/app/bin_gccgcc10_O2/2021_01_02-Lesson-a:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1093:	f3 0f 10 05 71 0f 00 	movss  0xf71(%rip),%xmm0        # 200c <_IO_stdin_used+0xc>
    109a:	00 
    109b:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10a2:	00 00 
    10a4:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10a9:	48 b8 66 66 b6 40 00 	movabs $0x4110000040b66666,%rax
    10b0:	00 10 41 
    10b3:	48 89 e3             	mov    %rsp,%rbx
    10b6:	4c 8d 64 24 14       	lea    0x14(%rsp),%r12
    10bb:	48 89 44 24 04       	mov    %rax,0x4(%rsp)
    10c0:	48 b8 9a 99 b5 41 9a 	movabs $0x42b1999a41b5999a,%rax
    10c7:	99 b1 42 
    10ca:	48 89 44 24 0c       	mov    %rax,0xc(%rsp)
    10cf:	48 89 ee             	mov    %rbp,%rsi
    10d2:	bf 01 00 00 00       	mov    $0x1,%edi
    10d7:	48 83 c3 04          	add    $0x4,%rbx
    10db:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    10df:	b8 01 00 00 00       	mov    $0x1,%eax
    10e4:	e8 87 ff ff ff       	callq  1070 <__printf_chk@plt>
    10e9:	4c 39 e3             	cmp    %r12,%rbx
    10ec:	74 0a                	je     10f8 <main+0x78>
    10ee:	f3 0f 10 03          	movss  (%rbx),%xmm0
    10f2:	eb db                	jmp    10cf <main+0x4f>
    10f4:	0f 1f 40 00          	nopl   0x0(%rax)
    10f8:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    10fd:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1104:	00 00 
    1106:	75 0b                	jne    1113 <main+0x93>
    ...
    1110:	41 5c                	pop    %r12
    1112:	c3                   	retq   
    1113:	e8 48 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
