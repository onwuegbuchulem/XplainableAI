...
/app/bin_gccgcc10_O0/sol2:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a4:	48 8d 45 e4          	lea    -0x1c(%rbp),%rax
    ...
    11bc:	c7 45 e8 00 00 00 00 	movl   $0x0,-0x18(%rbp)
    11c3:	c7 45 ec 02 00 00 00 	movl   $0x2,-0x14(%rbp)
    11ca:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%rbp)
    11d1:	c7 45 f4 01 00 00 00 	movl   $0x1,-0xc(%rbp)
    11d8:	eb 15                	jmp    11ef <main+0x66>
    11da:	8b 45 ec             	mov    -0x14(%rbp),%eax
    11dd:	99                   	cltd   
    11de:	f7 7d f4             	idivl  -0xc(%rbp)
    11e1:	89 d0                	mov    %edx,%eax
    11e3:	85 c0                	test   %eax,%eax
    11e5:	75 04                	jne    11eb <main+0x62>
    11e7:	83 45 f0 01          	addl   $0x1,-0x10(%rbp)
    11eb:	83 45 f4 01          	addl   $0x1,-0xc(%rbp)
    11ef:	8b 45 f4             	mov    -0xc(%rbp),%eax
    11f2:	3b 45 ec             	cmp    -0x14(%rbp),%eax
    11f5:	7e e3                	jle    11da <main+0x51>
    11f7:	83 7d f0 02          	cmpl   $0x2,-0x10(%rbp)
    11fb:	75 39                	jne    1236 <main+0xad>
    11fd:	83 45 e8 01          	addl   $0x1,-0x18(%rbp)
    1201:	8b 45 e4             	mov    -0x1c(%rbp),%eax
    1204:	39 45 e8             	cmp    %eax,-0x18(%rbp)
    1207:	75 2d                	jne    1236 <main+0xad>
    1209:	8b 45 ec             	mov    -0x14(%rbp),%eax
    120c:	89 c6                	mov    %eax,%esi
    120e:	48 8d 3d ef 0d 00 00 	lea    0xdef(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    ...
    1230:	00 00 
    1232:	74 0d                	je     1241 <main+0xb8>
    1234:	eb 06                	jmp    123c <main+0xb3>
    1236:	83 45 ec 01          	addl   $0x1,-0x14(%rbp)
    123a:	eb 8e                	jmp    11ca <main+0x41>
    123c:	e8 2f fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1241:	c9                   	leaveq 
    1242:	c3                   	retq   
