...
/app/bin_gccgcc10_O2/18_array:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    108b:	b9 02 00 00 00       	mov    $0x2,%ecx
    1090:	55                   	push   %rbp
    ...
    10ab:	48 b8 02 00 00 00 03 	movabs $0x300000002,%rax
    10b2:	00 00 00 
    10b5:	c7 44 24 10 0d 00 00 	movl   $0xd,0x10(%rsp)
    10bc:	00 
    10bd:	48 89 e3             	mov    %rsp,%rbx
    10c0:	4c 8d 64 24 14       	lea    0x14(%rsp),%r12
    10c5:	48 89 04 24          	mov    %rax,(%rsp)
    10c9:	48 b8 05 00 00 00 08 	movabs $0x800000005,%rax
    10d0:	00 00 00 
    10d3:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    10d8:	48 89 ee             	mov    %rbp,%rsi
    10db:	bf 01 00 00 00       	mov    $0x1,%edi
    10e0:	31 c0                	xor    %eax,%eax
    10e2:	48 83 c3 04          	add    $0x4,%rbx
    10e6:	e8 85 ff ff ff       	callq  1070 <__printf_chk@plt>
    10eb:	4c 39 e3             	cmp    %r12,%rbx
    10ee:	74 10                	je     1100 <main+0x80>
    10f0:	8b 0b                	mov    (%rbx),%ecx
    10f2:	89 ca                	mov    %ecx,%edx
    10f4:	eb e2                	jmp    10d8 <main+0x58>
    ...
    1118:	41 5c                	pop    %r12
    111a:	c3                   	retq   
    111b:	e8 40 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
