...
/app/bin_gccgcc10_O0/01_pointer:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 e8 48 00 00 00 	movl   $0x48,-0x18(%rbp)
    118b:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    118f:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    1193:	c7 45 ec 43 00 00 00 	movl   $0x43,-0x14(%rbp)
    119a:	48 8d 45 e8          	lea    -0x18(%rbp),%rax
    ...
    11b6:	48 89 c6             	mov    %rax,%rsi
    11b9:	48 8d 3d 44 0e 00 00 	lea    0xe44(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11c0:	b8 00 00 00 00       	mov    $0x0,%eax
    11c5:	e8 a6 fe ff ff       	callq  1070 <printf@plt>
    11ca:	48 8d 45 ec          	lea    -0x14(%rbp),%rax
    ...
    11e2:	8b 45 e8             	mov    -0x18(%rbp),%eax
    11e5:	89 c6                	mov    %eax,%esi
    11e7:	48 8d 3d 2e 0e 00 00 	lea    0xe2e(%rip),%rdi        # 201c <_IO_stdin_used+0x1c>
    11ee:	b8 00 00 00 00       	mov    $0x0,%eax
    11f3:	e8 78 fe ff ff       	callq  1070 <printf@plt>
    11f8:	b8 00 00 00 00       	mov    $0x0,%eax
    11fd:	48 8b 55 f8          	mov    -0x8(%rbp),%rdx
    1201:	64 48 2b 14 25 28 00 	sub    %fs:0x28,%rdx
    1208:	00 00 
    120a:	74 05                	je     1211 <main+0xa8>
