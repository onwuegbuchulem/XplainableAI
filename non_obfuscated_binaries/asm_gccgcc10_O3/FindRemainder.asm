...
/app/bin_gccgcc10_O3/FindRemainder:     file format elf64-x86-64
...
00000000000010a0 <main>:
    ...
    10a4:	41 54                	push   %r12
    10a6:	48 8d 3d 59 0f 00 00 	lea    0xf59(%rip),%rdi        # 2006 <_IO_stdin_used+0x6>
    10ad:	55                   	push   %rbp
    10ae:	53                   	push   %rbx
    10af:	48 83 ec 20          	sub    $0x20,%rsp
    10b3:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10ba:	00 00 
    10bc:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    10c1:	31 c0                	xor    %eax,%eax
    10c3:	48 8d 74 24 0c       	lea    0xc(%rsp),%rsi
    10c8:	e8 c3 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    10cd:	8b 44 24 0c          	mov    0xc(%rsp),%eax
    10d1:	8d 50 ff             	lea    -0x1(%rax),%edx
    10d4:	89 54 24 0c          	mov    %edx,0xc(%rsp)
    10d8:	85 c0                	test   %eax,%eax
    10da:	74 4f                	je     112b <main+0x8b>
    10dc:	4c 8d 64 24 14       	lea    0x14(%rsp),%r12
    10e1:	48 8d 6c 24 10       	lea    0x10(%rsp),%rbp
    10e6:	48 8d 1d 17 0f 00 00 	lea    0xf17(%rip),%rbx        # 2004 <_IO_stdin_used+0x4>
    10ed:	0f 1f 00             	nopl   (%rax)
    10f0:	4c 89 e2             	mov    %r12,%rdx
    10f3:	48 89 ee             	mov    %rbp,%rsi
    10f6:	48 89 df             	mov    %rbx,%rdi
    10f9:	31 c0                	xor    %eax,%eax
    10fb:	e8 90 ff ff ff       	callq  1090 <__isoc99_scanf@plt>
    1100:	8b 44 24 10          	mov    0x10(%rsp),%eax
    1104:	bf 01 00 00 00       	mov    $0x1,%edi
    1109:	48 8d 35 f9 0e 00 00 	lea    0xef9(%rip),%rsi        # 2009 <_IO_stdin_used+0x9>
    1110:	99                   	cltd   
    1111:	f7 7c 24 14          	idivl  0x14(%rsp)
    1115:	31 c0                	xor    %eax,%eax
    1117:	e8 64 ff ff ff       	callq  1080 <__printf_chk@plt>
    111c:	8b 44 24 0c          	mov    0xc(%rsp),%eax
    1120:	8d 50 ff             	lea    -0x1(%rax),%edx
    1123:	89 54 24 0c          	mov    %edx,0xc(%rsp)
    1127:	85 c0                	test   %eax,%eax
    1129:	75 c5                	jne    10f0 <main+0x50>
    112b:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1130:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1137:	00 00 
    1139:	75 0b                	jne    1146 <main+0xa6>
    113b:	48 83 c4 20          	add    $0x20,%rsp
    113f:	31 c0                	xor    %eax,%eax
    1141:	5b                   	pop    %rbx
    1142:	5d                   	pop    %rbp
    1143:	41 5c                	pop    %r12
    1145:	c3                   	retq   
    1146:	e8 25 ff ff ff       	callq  1070 <__stack_chk_fail@plt>
