...
/app/bin_gccgcc10_O3/assignment24:     file format elf64-x86-64
...
0000000000001070 <open@plt>:
    ...
    1074:	f2 ff 25 55 2f 00 00 	bnd jmpq *0x2f55(%rip)        # 3fd0 <open@GLIBC_2.2.5>
...
0000000000001080 <main>:
    ...
    108a:	ba c0 01 00 00       	mov    $0x1c0,%edx
    108f:	be 41 00 00 00       	mov    $0x41,%esi
    1094:	48 8d 3d 69 0f 00 00 	lea    0xf69(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    109b:	e8 d0 ff ff ff       	callq  1070 <open@plt>
    10a0:	85 c0                	test   %eax,%eax
    10a2:	78 1a                	js     10be <main+0x3e>
    10a4:	48 8d 35 83 0f 00 00 	lea    0xf83(%rip),%rsi        # 202e <_IO_stdin_used+0x2e>
    10ab:	bf 01 00 00 00       	mov    $0x1,%edi
    10b0:	31 c0                	xor    %eax,%eax
    10b2:	e8 a9 ff ff ff       	callq  1060 <__printf_chk@plt>
    10b7:	31 c0                	xor    %eax,%eax
    10b9:	48 83 c4 08          	add    $0x8,%rsp
    10bd:	c3                   	retq   
    10be:	48 8d 35 4c 0f 00 00 	lea    0xf4c(%rip),%rsi        # 2011 <_IO_stdin_used+0x11>
    10c5:	bf 01 00 00 00       	mov    $0x1,%edi
    10ca:	31 c0                	xor    %eax,%eax
    10cc:	e8 8f ff ff ff       	callq  1060 <__printf_chk@plt>
    10d1:	83 c8 ff             	or     $0xffffffff,%eax
    10d4:	eb e3                	jmp    10b9 <main+0x39>
