...
/app/bin_gccgcc10_O1/2024_07_20-Lesson:     file format elf64-x86-64
...
0000000000001080 <_start>:
    ...
    10a1:	48 8d 3d 0e 01 00 00 	lea    0x10e(%rip),%rdi        # 11b6 <main>
...
0000000000001169 <one>:
    ...
    117d:	48 8b 3b             	mov    (%rbx),%rdi
    1180:	48 85 ff             	test   %rdi,%rdi
    1183:	74 11                	je     1196 <one+0x2d>
    1185:	48 83 c3 08          	add    $0x8,%rbx
    1189:	e8 d2 fe ff ff       	callq  1060 <puts@plt>
    118e:	48 8b 3b             	mov    (%rbx),%rdi
    1191:	48 85 ff             	test   %rdi,%rdi
    1194:	75 ef                	jne    1185 <one+0x1c>
    1196:	5b                   	pop    %rbx
    1197:	c3                   	retq   

0000000000001198 <two>:
    1198:	f3 0f 1e fa          	endbr64 
    119c:	53                   	push   %rbx
    119d:	48 89 fb             	mov    %rdi,%rbx
    11a0:	48 8d 3d 89 0e 00 00 	lea    0xe89(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
    11a7:	e8 b4 fe ff ff       	callq  1060 <puts@plt>
    11ac:	48 89 df             	mov    %rbx,%rdi
    11af:	e8 ac fe ff ff       	callq  1060 <puts@plt>
    11b4:	5b                   	pop    %rbx
    11b5:	c3                   	retq   
...
00000000000011b6 <main>:
    ...
    11c5:	00 00 
    11c7:	48 89 44 24 28       	mov    %rax,0x28(%rsp)
    11cc:	31 c0                	xor    %eax,%eax
    11ce:	48 8d 05 7c 0e 00 00 	lea    0xe7c(%rip),%rax        # 2051 <_IO_stdin_used+0x51>
    11d5:	48 89 04 24          	mov    %rax,(%rsp)
    11d9:	48 8d 05 77 0e 00 00 	lea    0xe77(%rip),%rax        # 2057 <_IO_stdin_used+0x57>
    11e0:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11e5:	48 8d 05 70 0e 00 00 	lea    0xe70(%rip),%rax        # 205c <_IO_stdin_used+0x5c>
    11ec:	48 89 44 24 10       	mov    %rax,0x10(%rsp)
    11f1:	48 8d 05 6a 0e 00 00 	lea    0xe6a(%rip),%rax        # 2062 <_IO_stdin_used+0x62>
    11f8:	48 89 44 24 18       	mov    %rax,0x18(%rsp)
    11fd:	48 c7 44 24 20 00 00 	movq   $0x0,0x20(%rsp)
    1204:	00 00 
    1206:	48 89 e7             	mov    %rsp,%rdi
    1209:	e8 5b ff ff ff       	callq  1169 <one>
    120e:	48 8b 3c 24          	mov    (%rsp),%rdi
    1212:	e8 81 ff ff ff       	callq  1198 <two>
    1217:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    121c:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1223:	00 00 
    1225:	75 0a                	jne    1231 <main+0x7b>
    1227:	b8 00 00 00 00       	mov    $0x0,%eax
    122c:	48 83 c4 38          	add    $0x38,%rsp
    1230:	c3                   	retq   
