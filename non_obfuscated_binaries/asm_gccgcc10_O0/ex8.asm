...
/app/bin_gccgcc10_O0/ex8:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a3:	83 7d ec 01          	cmpl   $0x1,-0x14(%rbp)
    11a7:	75 0e                	jne    11b7 <main+0x2e>
    11a9:	48 8d 3d 58 0e 00 00 	lea    0xe58(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    11b0:	e8 cb fe ff ff       	callq  1080 <puts@plt>
    11b5:	eb 76                	jmp    122d <main+0xa4>
    11b7:	83 7d ec 01          	cmpl   $0x1,-0x14(%rbp)
    11bb:	7e 5e                	jle    121b <main+0x92>
    11bd:	83 7d ec 03          	cmpl   $0x3,-0x14(%rbp)
    11c1:	7f 58                	jg     121b <main+0x92>
    11c3:	48 8d 3d 64 0e 00 00 	lea    0xe64(%rip),%rdi        # 202e <_IO_stdin_used+0x2e>
    11ca:	e8 b1 fe ff ff       	callq  1080 <puts@plt>
    11cf:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%rbp)
    11d6:	eb 2f                	jmp    1207 <main+0x7e>
    ...
    11f2:	48 8d 3d 4c 0e 00 00 	lea    0xe4c(%rip),%rdi        # 2045 <_IO_stdin_used+0x45>
    11f9:	b8 00 00 00 00       	mov    $0x0,%eax
    11fe:	e8 8d fe ff ff       	callq  1090 <printf@plt>
    1203:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    1207:	8b 45 fc             	mov    -0x4(%rbp),%eax
    120a:	3b 45 ec             	cmp    -0x14(%rbp),%eax
    120d:	7c c9                	jl     11d8 <main+0x4f>
    120f:	bf 0a 00 00 00       	mov    $0xa,%edi
    1214:	e8 57 fe ff ff       	callq  1070 <putchar@plt>
    1219:	eb 12                	jmp    122d <main+0xa4>
    121b:	83 7d ec 0a          	cmpl   $0xa,-0x14(%rbp)
    121f:	7e 0c                	jle    122d <main+0xa4>
    1221:	48 8d 3d 28 0e 00 00 	lea    0xe28(%rip),%rdi        # 2050 <_IO_stdin_used+0x50>
