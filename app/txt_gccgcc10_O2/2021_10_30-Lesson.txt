...
/app/bin_gccgcc10_O2/2021_10_30-Lesson:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    1088:	b9 1d 00 00 00       	mov    $0x1d,%ecx
    ...
    10b4:	48 b8 1d 00 00 00 9a 	movabs $0x433d999a0000001d,%rax
    10bb:	99 3d 43 
    10be:	0f 11 04 24          	movups %xmm0,(%rsp)
    10c2:	66 0f ef c0          	pxor   %xmm0,%xmm0
    10c6:	0f 11 44 24 10       	movups %xmm0,0x10(%rsp)
    10cb:	f2 0f 10 05 55 0f 00 	movsd  0xf55(%rip),%xmm0        # 2028 <_IO_stdin_used+0x28>
    10d2:	00 
    10d3:	48 89 44 24 20       	mov    %rax,0x20(%rsp)
    10d8:	b8 01 00 00 00       	mov    $0x1,%eax
    10dd:	e8 8e ff ff ff       	callq  1070 <__printf_chk@plt>
    10e2:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    10e7:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    10ee:	00 00 
    10f0:	75 07                	jne    10f9 <main+0x79>
    10f2:	31 c0                	xor    %eax,%eax
    10f4:	48 83 c4 38          	add    $0x38,%rsp
    10f8:	c3                   	retq   
    10f9:	e8 62 ff ff ff       	callq  1060 <__stack_chk_fail@plt>
