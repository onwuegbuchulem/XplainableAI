...
/app/bin_gccgcc10_O1/2020_10_17-Lesson-a:     file format elf64-x86-64
...
0000000000001169 <str_tolower>:
    ...
    1172:	75 0c                	jne    1180 <str_tolower+0x17>
    1174:	c3                   	retq   
    1175:	48 83 c7 01          	add    $0x1,%rdi
    1179:	0f b6 07             	movzbl (%rdi),%eax
    117c:	84 c0                	test   %al,%al
    117e:	74 f4                	je     1174 <str_tolower+0xb>
    1180:	8d 50 bf             	lea    -0x41(%rax),%edx
    1183:	80 fa 19             	cmp    $0x19,%dl
    1186:	77 ed                	ja     1175 <str_tolower+0xc>
    1188:	83 c8 20             	or     $0x20,%eax
    118b:	88 07                	mov    %al,(%rdi)
    118d:	eb e6                	jmp    1175 <str_tolower+0xc>
...
000000000000118f <main>:
    ...
    1207:	e8 5d ff ff ff       	callq  1169 <str_tolower>
