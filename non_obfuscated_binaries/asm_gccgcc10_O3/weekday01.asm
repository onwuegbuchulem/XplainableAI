...
/app/bin_gccgcc10_O3/weekday01:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    1230:	48 63 78 18          	movslq 0x18(%rax),%rdi
    1234:	8b 70 14             	mov    0x14(%rax),%esi
    1237:	8b 48 0c             	mov    0xc(%rax),%ecx
    123a:	48 63 40 10          	movslq 0x10(%rax),%rax
    123e:	4c 8b 4c fc 10       	mov    0x10(%rsp,%rdi,8),%r9
    1243:	44 8d 86 6c 07 00 00 	lea    0x76c(%rsi),%r8d
    124a:	bf 01 00 00 00       	mov    $0x1,%edi
    124f:	48 8d 35 3d 0e 00 00 	lea    0xe3d(%rip),%rsi        # 2093 <_IO_stdin_used+0x93>
    1256:	48 8b 54 c4 50       	mov    0x50(%rsp,%rax,8),%rdx
