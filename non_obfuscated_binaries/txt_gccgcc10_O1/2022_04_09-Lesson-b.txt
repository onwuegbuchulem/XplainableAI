...
/app/bin_gccgcc10_O1/2022_04_09-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1177:	bd 30 00 00 00       	mov    $0x30,%ebp
    117c:	4c 8d 2d 81 0e 00 00 	lea    0xe81(%rip),%r13        # 2004 <_IO_stdin_used+0x4>
    1183:	44 8d 65 d0          	lea    -0x30(%rbp),%r12d
    1187:	bb 00 00 00 00       	mov    $0x0,%ebx
    118c:	8d 4b 30             	lea    0x30(%rbx),%ecx
    118f:	41 89 d9             	mov    %ebx,%r9d
    1192:	45 89 e0             	mov    %r12d,%r8d
    1195:	89 ea                	mov    %ebp,%edx
    ...
    11ac:	83 fb 08             	cmp    $0x8,%ebx
    11af:	75 db                	jne    118c <main+0x23>
    11b1:	48 8d 3d 62 0e 00 00 	lea    0xe62(%rip),%rdi        # 201a <_IO_stdin_used+0x1a>
    11b8:	e8 a3 fe ff ff       	callq  1060 <puts@plt>
    11bd:	83 c5 01             	add    $0x1,%ebp
    11c0:	83 fd 38             	cmp    $0x38,%ebp
    11c3:	75 be                	jne    1183 <main+0x1a>
    11c5:	b8 00 00 00 00       	mov    $0x0,%eax
    11ca:	48 83 c4 08          	add    $0x8,%rsp
    11ce:	5b                   	pop    %rbx
    11cf:	5d                   	pop    %rbp
    11d0:	41 5c                	pop    %r12
    11d2:	41 5d                	pop    %r13
