...
/app/bin_gccgcc10_O3/decimal_to_hexa:     file format elf64-x86-64
...
0000000000001210 <decimal2Hexadecimal>:
    ...
    122d:	0f 84 9d 00 00 00    	je     12d0 <decimal2Hexadecimal+0xc0>
    1233:	b9 01 00 00 00       	mov    $0x1,%ecx
    1238:	48 8d 74 24 ff       	lea    -0x1(%rsp),%rsi
    123d:	eb 1f                	jmp    125e <decimal2Hexadecimal+0x4e>
    123f:	90                   	nop
    1240:	83 c0 30             	add    $0x30,%eax
    1243:	48 85 ff             	test   %rdi,%rdi
    1246:	88 04 0e             	mov    %al,(%rsi,%rcx,1)
    1249:	48 8d 47 0f          	lea    0xf(%rdi),%rax
    124d:	48 0f 48 f8          	cmovs  %rax,%rdi
    1251:	48 8d 41 01          	lea    0x1(%rcx),%rax
    1255:	48 c1 ff 04          	sar    $0x4,%rdi
    1259:	74 2d                	je     1288 <decimal2Hexadecimal+0x78>
    125b:	48 89 c1             	mov    %rax,%rcx
    125e:	48 89 fa             	mov    %rdi,%rdx
    1261:	48 63 e9             	movslq %ecx,%rbp
    1264:	48 c1 fa 3f          	sar    $0x3f,%rdx
    1268:	48 c1 ea 3c          	shr    $0x3c,%rdx
    126c:	48 8d 04 17          	lea    (%rdi,%rdx,1),%rax
    1270:	83 e0 0f             	and    $0xf,%eax
    1273:	48 29 d0             	sub    %rdx,%rax
    1276:	48 83 f8 09          	cmp    $0x9,%rax
    127a:	7e c4                	jle    1240 <decimal2Hexadecimal+0x30>
    127c:	83 c0 37             	add    $0x37,%eax
    127f:	eb c2                	jmp    1243 <decimal2Hexadecimal+0x33>
    1281:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    1288:	48 8d 1c 2c          	lea    (%rsp,%rbp,1),%rbx
    128c:	48 01 f5             	add    %rsi,%rbp
    128f:	48 29 cd             	sub    %rcx,%rbp
    1292:	66 0f 1f 44 00 00    	nopw   0x0(%rax,%rax,1)
    1298:	0f be 3b             	movsbl (%rbx),%edi
    129b:	48 83 eb 01          	sub    $0x1,%rbx
    129f:	e8 dc fd ff ff       	callq  1080 <putchar@plt>
    12a4:	48 39 dd             	cmp    %rbx,%rbp
    12a7:	75 ef                	jne    1298 <decimal2Hexadecimal+0x88>
    12a9:	48 8b 44 24 68       	mov    0x68(%rsp),%rax
    12ae:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    12b5:	00 00 
    12b7:	75 22                	jne    12db <decimal2Hexadecimal+0xcb>
    12b9:	48 83 c4 78          	add    $0x78,%rsp
    12bd:	bf 0a 00 00 00       	mov    $0xa,%edi
    12c2:	5b                   	pop    %rbx
    12c3:	5d                   	pop    %rbp
    12c4:	e9 b7 fd ff ff       	jmpq   1080 <putchar@plt>
    12c9:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    12d0:	0f be 3c 24          	movsbl (%rsp),%edi
    12d4:	e8 a7 fd ff ff       	callq  1080 <putchar@plt>
    12d9:	eb ce                	jmp    12a9 <decimal2Hexadecimal+0x99>
    12db:	e8 b0 fd ff ff       	callq  1090 <__stack_chk_fail@plt>
