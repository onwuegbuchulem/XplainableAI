...
/app/bin_gccgcc10_O1/2019_02_16-Lesson-b:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1197:	4c 8d 64 24 10       	lea    0x10(%rsp),%r12
    119c:	48 8d 2d 61 0e 00 00 	lea    0xe61(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    11a3:	8b 13                	mov    (%rbx),%edx
    11a5:	48 89 ee             	mov    %rbp,%rsi
    11a8:	bf 01 00 00 00       	mov    $0x1,%edi
    11ad:	b8 00 00 00 00       	mov    $0x0,%eax
    11b2:	e8 b9 fe ff ff       	callq  1070 <__printf_chk@plt>
    11b7:	48 83 c3 04          	add    $0x4,%rbx
    11bb:	4c 39 e3             	cmp    %r12,%rbx
    11be:	75 e3                	jne    11a3 <main+0x3a>
    11c0:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11c5:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11cc:	00 00 
    11ce:	75 0e                	jne    11de <main+0x75>
    11d0:	b8 00 00 00 00       	mov    $0x0,%eax
    11d5:	48 83 c4 10          	add    $0x10,%rsp
    11d9:	5b                   	pop    %rbx
    11da:	5d                   	pop    %rbp
    11db:	41 5c                	pop    %r12
    11dd:	c3                   	retq   
    11de:	e8 7d fe ff ff       	callq  1060 <__stack_chk_fail@plt>
