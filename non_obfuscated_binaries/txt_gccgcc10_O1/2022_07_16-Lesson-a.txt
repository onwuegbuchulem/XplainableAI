...
/app/bin_gccgcc10_O1/2022_07_16-Lesson-a:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11a3:	48 c7 44 24 08 00 00 	movq   $0x0,0x8(%rsp)
    11aa:	00 00 
    11ac:	48 8d 6c 24 10       	lea    0x10(%rsp),%rbp
    11b1:	48 8d 35 4c 0e 00 00 	lea    0xe4c(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    11b8:	bf 01 00 00 00       	mov    $0x1,%edi
    11bd:	b8 00 00 00 00       	mov    $0x0,%eax
    11c2:	e8 b9 fe ff ff       	callq  1080 <__printf_chk@plt>
    11c7:	48 8d 7c 24 08       	lea    0x8(%rsp),%rdi
    11cc:	48 8b 15 3d 2e 00 00 	mov    0x2e3d(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    11d3:	48 89 ee             	mov    %rbp,%rsi
    11d6:	e8 b5 fe ff ff       	callq  1090 <getline@plt>
    11db:	48 89 c3             	mov    %rax,%rbx
    11de:	48 8b 4c 24 08       	mov    0x8(%rsp),%rcx
    11e3:	89 c2                	mov    %eax,%edx
    11e5:	48 8d 35 1f 0e 00 00 	lea    0xe1f(%rip),%rsi        # 200b <_IO_stdin_used+0xb>
    11ec:	bf 01 00 00 00       	mov    $0x1,%edi
    11f1:	b8 00 00 00 00       	mov    $0x0,%eax
    11f6:	e8 85 fe ff ff       	callq  1080 <__printf_chk@plt>
    11fb:	83 fb 01             	cmp    $0x1,%ebx
    11fe:	7f b1                	jg     11b1 <main+0x28>
    1200:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    1205:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    120c:	00 00 
    120e:	75 0c                	jne    121c <main+0x93>
    1210:	b8 00 00 00 00       	mov    $0x0,%eax
    1215:	48 83 c4 28          	add    $0x28,%rsp
    1219:	5b                   	pop    %rbx
    121a:	5d                   	pop    %rbp
    121b:	c3                   	retq   
    121c:	e8 4f fe ff ff       	callq  1070 <__stack_chk_fail@plt>
