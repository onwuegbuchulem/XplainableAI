...
/app/bin_gccgcc10_O1/02_array_input:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11d4:	4c 8d 64 24 14       	lea    0x14(%rsp),%r12
    11d9:	48 8d 2d 3e 0e 00 00 	lea    0xe3e(%rip),%rbp        # 201e <_IO_stdin_used+0x1e>
    ...
    11f0:	48 83 c3 04          	add    $0x4,%rbx
    11f4:	4c 39 e3             	cmp    %r12,%rbx
    11f7:	75 e7                	jne    11e0 <main+0x37>
    11f9:	bb 00 00 00 00       	mov    $0x0,%ebx
    11fe:	48 8d 2d 23 0e 00 00 	lea    0xe23(%rip),%rbp        # 2028 <_IO_stdin_used+0x28>
    1205:	8b 0c 9c             	mov    (%rsp,%rbx,4),%ecx
    ...
    1220:	48 83 fb 05          	cmp    $0x5,%rbx
    1224:	75 df                	jne    1205 <main+0x5c>
    1226:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    122b:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1232:	00 00 
    1234:	75 0e                	jne    1244 <main+0x9b>
    1236:	b8 00 00 00 00       	mov    $0x0,%eax
    123b:	48 83 c4 20          	add    $0x20,%rsp
    123f:	5b                   	pop    %rbx
    1240:	5d                   	pop    %rbp
    1241:	41 5c                	pop    %r12
    1243:	c3                   	retq   
