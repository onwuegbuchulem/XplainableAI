...
/app/bin_gccgcc10_O0/assignment9:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    115c:	83 7d fc 02          	cmpl   $0x2,-0x4(%rbp)
    1160:	7e 06                	jle    1168 <main+0x1f>
    1162:	83 7d fc 03          	cmpl   $0x3,-0x4(%rbp)
    1166:	7e 13                	jle    117b <main+0x32>
    ...
    1179:	eb 2a                	jmp    11a5 <main+0x5c>
    117b:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    117f:	48 83 c0 10          	add    $0x10,%rax
    1183:	48 8b 10             	mov    (%rax),%rdx
    1186:	48 8b 45 f0          	mov    -0x10(%rbp),%rax
    118a:	48 83 c0 08          	add    $0x8,%rax
    118e:	48 8b 00             	mov    (%rax),%rax
    1191:	48 89 c6             	mov    %rax,%rsi
    1194:	48 8d 3d 95 0e 00 00 	lea    0xe95(%rip),%rdi        # 2030 <_IO_stdin_used+0x30>
