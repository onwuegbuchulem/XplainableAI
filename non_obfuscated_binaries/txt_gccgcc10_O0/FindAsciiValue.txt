...
/app/bin_gccgcc10_O0/FindAsciiValue:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11d1:	0f be d0             	movsbl %al,%edx
    11d4:	0f b6 45 f7          	movzbl -0x9(%rbp),%eax
    11d8:	0f be c0             	movsbl %al,%eax
    11db:	89 c6                	mov    %eax,%esi
    11dd:	48 8d 3d 37 0e 00 00 	lea    0xe37(%rip),%rdi        # 201b <_IO_stdin_used+0x1b>
    11e4:	b8 00 00 00 00       	mov    $0x0,%eax
    11e9:	e8 92 fe ff ff       	callq  1080 <printf@plt>
    11ee:	b8 00 00 00 00       	mov    $0x0,%eax
    11f3:	48 8b 4d f8          	mov    -0x8(%rbp),%rcx
    11f7:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11fe:	00 00 
    1200:	74 05                	je     1207 <main+0x7e>
    1202:	e8 69 fe ff ff       	callq  1070 <__stack_chk_fail@plt>
    1207:	c9                   	leaveq 
    1208:	c3                   	retq   
