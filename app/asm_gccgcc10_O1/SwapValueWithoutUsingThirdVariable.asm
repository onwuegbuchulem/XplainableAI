...
/app/bin_gccgcc10_O1/SwapValueWithoutUsingThirdVariable:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11cd:	48 8d 54 24 04       	lea    0x4(%rsp),%rdx
    11d2:	48 89 e6             	mov    %rsp,%rsi
    11d5:	48 8d 3d 37 0e 00 00 	lea    0xe37(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    11dc:	b8 00 00 00 00       	mov    $0x0,%eax
    11e1:	e8 ca fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    11e6:	8b 0c 24             	mov    (%rsp),%ecx
    11e9:	8b 54 24 04          	mov    0x4(%rsp),%edx
    11ed:	89 4c 24 04          	mov    %ecx,0x4(%rsp)
    11f1:	89 14 24             	mov    %edx,(%rsp)
    11f4:	48 8d 35 1d 0e 00 00 	lea    0xe1d(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    11fb:	bf 01 00 00 00       	mov    $0x1,%edi
    1200:	b8 00 00 00 00       	mov    $0x0,%eax
    1205:	e8 96 fe ff ff       	callq  10a0 <__printf_chk@plt>
    120a:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    120f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1216:	00 00 
    1218:	75 0a                	jne    1224 <main+0x7b>
    121a:	b8 00 00 00 00       	mov    $0x0,%eax
    121f:	48 83 c4 18          	add    $0x18,%rsp
    1223:	c3                   	retq   
    1224:	e8 67 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
