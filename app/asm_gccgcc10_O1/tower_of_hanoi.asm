...
/app/bin_gccgcc10_O1/tower_of_hanoi:     file format elf64-x86-64
...
00000000000010c0 <_start>:
    ...
    10e1:	48 8d 3d 2a 01 00 00 	lea    0x12a(%rip),%rdi        # 1212 <main>
...
00000000000011a9 <hanoi>:
    ...
    11b8:	55                   	push   %rbp
    11b9:	53                   	push   %rbx
    11ba:	89 fb                	mov    %edi,%ebx
    11bc:	44 0f be ea          	movsbl %dl,%r13d
    11c0:	44 0f be e1          	movsbl %cl,%r12d
    11c4:	40 0f be ee          	movsbl %sil,%ebp
    11c8:	44 8d 77 ff          	lea    -0x1(%rdi),%r14d
    11cc:	44 89 e9             	mov    %r13d,%ecx
    11cf:	44 89 e2             	mov    %r12d,%edx
    11d2:	89 ee                	mov    %ebp,%esi
    11d4:	44 89 f7             	mov    %r14d,%edi
    11d7:	e8 cd ff ff ff       	callq  11a9 <hanoi>
    11dc:	45 89 e8             	mov    %r13d,%r8d
    11df:	89 e9                	mov    %ebp,%ecx
    11e1:	89 da                	mov    %ebx,%edx
    ...
    11f9:	89 e9                	mov    %ebp,%ecx
    11fb:	44 89 ea             	mov    %r13d,%edx
    11fe:	44 89 e6             	mov    %r12d,%esi
    1201:	44 89 f7             	mov    %r14d,%edi
    1204:	e8 a0 ff ff ff       	callq  11a9 <hanoi>
    1209:	5b                   	pop    %rbx
    120a:	5d                   	pop    %rbp
    120b:	41 5c                	pop    %r12
    120d:	41 5d                	pop    %r13
...
0000000000001212 <main>:
    ...
    1216:	48 83 ec 18          	sub    $0x18,%rsp
    121a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1221:	00 00 
    1223:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    1228:	31 c0                	xor    %eax,%eax
    122a:	48 8d 3d f1 0d 00 00 	lea    0xdf1(%rip),%rdi        # 2022 <_IO_stdin_used+0x22>
    1231:	e8 4a fe ff ff       	callq  1080 <puts@plt>
    1236:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    123b:	48 8d 3d f2 0d 00 00 	lea    0xdf2(%rip),%rdi        # 2034 <_IO_stdin_used+0x34>
    1242:	b8 00 00 00 00       	mov    $0x0,%eax
    1247:	e8 64 fe ff ff       	callq  10b0 <__isoc99_scanf@plt>
    124c:	b9 43 00 00 00       	mov    $0x43,%ecx
    1251:	ba 42 00 00 00       	mov    $0x42,%edx
    1256:	be 41 00 00 00       	mov    $0x41,%esi
    125b:	8b 7c 24 04          	mov    0x4(%rsp),%edi
    125f:	e8 45 ff ff ff       	callq  11a9 <hanoi>
    1264:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1269:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1270:	00 00 
    1272:	75 0a                	jne    127e <main+0x6c>
