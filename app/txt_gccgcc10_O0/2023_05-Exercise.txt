...
/app/bin_gccgcc10_O0/2023_05-Exercise:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    12aa:	48 8d 85 38 ff ff ff 	lea    -0xc8(%rbp),%rax
    12b1:	48 89 c7             	mov    %rax,%rdi
    12b4:	e8 f7 fd ff ff       	callq  10b0 <time@plt>
    12b9:	48 8d 85 38 ff ff ff 	lea    -0xc8(%rbp),%rax
    12c0:	48 89 c7             	mov    %rax,%rdi
    12c3:	e8 b8 fd ff ff       	callq  1080 <localtime@plt>
    12c8:	48 89 85 40 ff ff ff 	mov    %rax,-0xc0(%rbp)
    12cf:	48 8b 85 40 ff ff ff 	mov    -0xc0(%rbp),%rax
    12d6:	8b 40 14             	mov    0x14(%rax),%eax
    12d9:	8d b0 6c 07 00 00    	lea    0x76c(%rax),%esi
    12df:	48 8b 85 40 ff ff ff 	mov    -0xc0(%rbp),%rax
    12e6:	8b 40 10             	mov    0x10(%rax),%eax
    12e9:	48 98                	cltq   
    12eb:	48 8b 4c c5 90       	mov    -0x70(%rbp,%rax,8),%rcx
    12f0:	48 8b 85 40 ff ff ff 	mov    -0xc0(%rbp),%rax
    12f7:	8b 50 0c             	mov    0xc(%rax),%edx
    12fa:	48 8b 85 40 ff ff ff 	mov    -0xc0(%rbp),%rax
    1301:	8b 40 18             	mov    0x18(%rax),%eax
    1304:	48 98                	cltq   
    1306:	48 8b 84 c5 50 ff ff 	mov    -0xb0(%rbp,%rax,8),%rax
    130d:	ff 
    130e:	41 89 f0             	mov    %esi,%r8d
    ...
    1325:	48 8b 85 38 ff ff ff 	mov    -0xc8(%rbp),%rax
    132c:	48 2d 80 51 01 00    	sub    $0x15180,%rax
    1332:	48 89 85 38 ff ff ff 	mov    %rax,-0xc8(%rbp)
    1339:	48 8d 85 38 ff ff ff 	lea    -0xc8(%rbp),%rax
    1340:	48 89 c7             	mov    %rax,%rdi
    1343:	e8 38 fd ff ff       	callq  1080 <localtime@plt>
    1348:	48 89 85 48 ff ff ff 	mov    %rax,-0xb8(%rbp)
    134f:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
    1356:	8b 40 14             	mov    0x14(%rax),%eax
    1359:	8d b0 6c 07 00 00    	lea    0x76c(%rax),%esi
    135f:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
    1366:	8b 40 10             	mov    0x10(%rax),%eax
    1369:	48 98                	cltq   
    136b:	48 8b 4c c5 90       	mov    -0x70(%rbp,%rax,8),%rcx
    1370:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
    1377:	8b 50 0c             	mov    0xc(%rax),%edx
    137a:	48 8b 85 48 ff ff ff 	mov    -0xb8(%rbp),%rax
    1381:	8b 40 18             	mov    0x18(%rax),%eax
    1384:	48 98                	cltq   
    1386:	48 8b 84 c5 50 ff ff 	mov    -0xb0(%rbp,%rax,8),%rax
    138d:	ff 
    138e:	41 89 f0             	mov    %esi,%r8d
    1391:	48 89 c6             	mov    %rax,%rsi
    1394:	48 8d 3d 0f 0d 00 00 	lea    0xd0f(%rip),%rdi        # 20aa <_IO_stdin_used+0xaa>
    139b:	b8 00 00 00 00       	mov    $0x0,%eax
    13a0:	e8 fb fc ff ff       	callq  10a0 <printf@plt>
    13a5:	b8 00 00 00 00       	mov    $0x0,%eax
    13aa:	48 8b 7d f8          	mov    -0x8(%rbp),%rdi
    13ae:	64 48 2b 3c 25 28 00 	sub    %fs:0x28,%rdi
    13b5:	00 00 
    13b7:	74 05                	je     13be <main+0x215>
    13b9:	e8 d2 fc ff ff       	callq  1090 <__stack_chk_fail@plt>
    13be:	c9                   	leaveq 
    13bf:	c3                   	retq   
