...
/app/bin_gccgcc10_O3/2019_11_30-Lesson:     file format elf64-x86-64
...
0000000000001180 <_start>:
    ...
    1191:	50                   	push   %rax
    1192:	54                   	push   %rsp
    1193:	4c 8d 05 56 02 00 00 	lea    0x256(%rip),%r8        # 13f0 <__libc_csu_fini>
    119a:	48 8d 0d df 01 00 00 	lea    0x1df(%rip),%rcx        # 1380 <__libc_csu_init>
...
00000000000012e0 <test>:
    ...
    12e9:	48 89 fa             	mov    %rdi,%rdx
    12ec:	49 89 f5             	mov    %rsi,%r13
    12ef:	41 54                	push   %r12
    12f1:	48 8d 35 0c 0d 00 00 	lea    0xd0c(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    12f8:	49 89 fc             	mov    %rdi,%r12
    ...
    130d:	41 0f b6 1c 24       	movzbl (%r12),%ebx
    1312:	84 db                	test   %bl,%bl
    1314:	74 52                	je     1368 <test+0x88>
    1316:	49 83 c4 01          	add    $0x1,%r12
    131a:	eb 25                	jmp    1341 <test+0x61>
    131c:	0f 1f 40 00          	nopl   0x0(%rax)
    1320:	e8 5b fd ff ff       	callq  1080 <__ctype_toupper_loc@plt>
    1325:	48 8b 00             	mov    (%rax),%rax
    1328:	8b 14 a8             	mov    (%rax,%rbp,4),%edx
    132b:	39 14 98             	cmp    %edx,(%rax,%rbx,4)
    132e:	75 1b                	jne    134b <test+0x6b>
    1330:	41 0f b6 1c 24       	movzbl (%r12),%ebx
    1335:	49 83 c5 01          	add    $0x1,%r13
    1339:	49 83 c4 01          	add    $0x1,%r12
    133d:	84 db                	test   %bl,%bl
    133f:	74 27                	je     1368 <test+0x88>
    1341:	41 0f b6 6d 00       	movzbl 0x0(%r13),%ebp
    1346:	40 84 ed             	test   %bpl,%bpl
    1349:	75 d5                	jne    1320 <test+0x40>
    134b:	48 83 c4 08          	add    $0x8,%rsp
    134f:	48 8d 3d ba 0c 00 00 	lea    0xcba(%rip),%rdi        # 2010 <_IO_stdin_used+0x10>
    1356:	5b                   	pop    %rbx
    1357:	5d                   	pop    %rbp
    1358:	41 5c                	pop    %r12
    135a:	41 5d                	pop    %r13
    135c:	e9 2f fd ff ff       	jmpq   1090 <puts@plt>
    1361:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    1368:	48 83 c4 08          	add    $0x8,%rsp
    136c:	48 8d 3d a0 0c 00 00 	lea    0xca0(%rip),%rdi        # 2013 <_IO_stdin_used+0x13>
    1373:	5b                   	pop    %rbx
    1374:	5d                   	pop    %rbp
    1375:	41 5c                	pop    %r12
    1377:	41 5d                	pop    %r13
    1379:	e9 12 fd ff ff       	jmpq   1090 <puts@plt>
