...
/app/bin_gccgcc10_O1/time01:     file format elf64-x86-64
...
0000000000001080 <ctime@plt>:
    1080:	f3 0f 1e fa          	endbr64 
    1084:	f2 ff 25 2d 2f 00 00 	bnd jmpq *0x2f2d(%rip)        # 3fb8 <ctime@GLIBC_2.2.5>
...
00000000000011a9 <main>:
    ...
    11e7:	48 89 df             	mov    %rbx,%rdi
    11ea:	e8 91 fe ff ff       	callq  1080 <ctime@plt>
    11ef:	48 89 c2             	mov    %rax,%rdx
    11f2:	48 8d 35 29 0e 00 00 	lea    0xe29(%rip),%rsi        # 2022 <_IO_stdin_used+0x22>
    11f9:	bf 01 00 00 00       	mov    $0x1,%edi
    11fe:	b8 00 00 00 00       	mov    $0x0,%eax
    1203:	e8 a8 fe ff ff       	callq  10b0 <__printf_chk@plt>
    1208:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    120d:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1214:	00 00 
    1216:	75 0b                	jne    1223 <main+0x7a>
    1218:	b8 00 00 00 00       	mov    $0x0,%eax
    121d:	48 83 c4 10          	add    $0x10,%rsp
    1221:	5b                   	pop    %rbx
    1222:	c3                   	retq   
    1223:	e8 68 fe ff ff       	callq  1090 <__stack_chk_fail@plt>
