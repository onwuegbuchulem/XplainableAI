...
/app/bin_gccgcc10_O1/changecwd:     file format elf64-x86-64
...
00000000000010a0 <chdir@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 fd 2e 00 00 	bnd jmpq *0x2efd(%rip)        # 3fa8 <chdir@GLIBC_2.2.5>
...
00000000000010c0 <getcwd@plt>:
    10c0:	f3 0f 1e fa          	endbr64 
    10c4:	f2 ff 25 ed 2e 00 00 	bnd jmpq *0x2eed(%rip)        # 3fb8 <getcwd@GLIBC_2.2.5>
...
00000000000011e9 <main>:
    ...
    11f5:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    11fa:	48 81 ec 00 10 00 00 	sub    $0x1000,%rsp
    1201:	48 83 0c 24 00       	orq    $0x0,(%rsp)
    1206:	48 83 ec 10          	sub    $0x10,%rsp
    120a:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    1211:	00 00 
    1213:	48 89 84 24 08 20 00 	mov    %rax,0x2008(%rsp)
    121a:	00 
    121b:	31 c0                	xor    %eax,%eax
    121d:	48 8d 3d e0 0d 00 00 	lea    0xde0(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1224:	e8 77 fe ff ff       	callq  10a0 <chdir@plt>
    1229:	83 f8 ff             	cmp    $0xffffffff,%eax
    122c:	74 4a                	je     1278 <main+0x8f>
    122e:	48 89 e3             	mov    %rsp,%rbx
    1231:	be 00 20 00 00       	mov    $0x2000,%esi
    1236:	48 89 df             	mov    %rbx,%rdi
    1239:	e8 82 fe ff ff       	callq  10c0 <getcwd@plt>
    123e:	48 89 da             	mov    %rbx,%rdx
    1241:	48 8d 35 e0 0d 00 00 	lea    0xde0(%rip),%rsi        # 2028 <_IO_stdin_used+0x28>
    1248:	bf 01 00 00 00       	mov    $0x1,%edi
    124d:	b8 00 00 00 00       	mov    $0x0,%eax
    1252:	e8 79 fe ff ff       	callq  10d0 <__printf_chk@plt>
    1257:	48 8b 84 24 08 20 00 	mov    0x2008(%rsp),%rax
    125e:	00 
    125f:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1266:	00 00 
    1268:	75 35                	jne    129f <main+0xb6>
    126a:	b8 00 00 00 00       	mov    $0x0,%eax
    126f:	48 81 c4 10 20 00 00 	add    $0x2010,%rsp
    1276:	5b                   	pop    %rbx
    1277:	c3                   	retq   
    1278:	48 8b 0d a1 2d 00 00 	mov    0x2da1(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    127f:	ba 1d 00 00 00       	mov    $0x1d,%edx
    1284:	be 01 00 00 00       	mov    $0x1,%esi
    1289:	48 8d 3d 77 0d 00 00 	lea    0xd77(%rip),%rdi        # 2007 <_IO_stdin_used+0x7>
    1290:	e8 5b fe ff ff       	callq  10f0 <fwrite@plt>
    1295:	bf 01 00 00 00       	mov    $0x1,%edi
    129a:	e8 41 fe ff ff       	callq  10e0 <exit@plt>
    129f:	e8 0c fe ff ff       	callq  10b0 <__stack_chk_fail@plt>
