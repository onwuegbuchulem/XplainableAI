...
/app/bin_gccgcc10_O1/2024_07_06-Lesson-b:     file format elf64-x86-64
...
00000000000011a9 <main>:
    ...
    11b3:	bb 14 00 00 00       	mov    $0x14,%ebx
    11b8:	48 8b 35 51 2e 00 00 	mov    0x2e51(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11bf:	bf 58 00 00 00       	mov    $0x58,%edi
    11c4:	e8 b7 fe ff ff       	callq  1080 <putc@plt>
    11c9:	83 eb 01             	sub    $0x1,%ebx
    11cc:	75 ea                	jne    11b8 <main+0xf>
    11ce:	48 8b 3d 3b 2e 00 00 	mov    0x2e3b(%rip),%rdi        # 4010 <stdout@@GLIBC_2.2.5>
    11d5:	e8 b6 fe ff ff       	callq  1090 <fflush@plt>
    11da:	bf 01 00 00 00       	mov    $0x1,%edi
    11df:	e8 cc fe ff ff       	callq  10b0 <sleep@plt>
    11e4:	bb 14 00 00 00       	mov    $0x14,%ebx
    11e9:	48 8d 2d 14 0e 00 00 	lea    0xe14(%rip),%rbp        # 2004 <_IO_stdin_used+0x4>
    11f0:	48 89 ee             	mov    %rbp,%rsi
    11f3:	bf 01 00 00 00       	mov    $0x1,%edi
    11f8:	b8 00 00 00 00       	mov    $0x0,%eax
    11fd:	e8 9e fe ff ff       	callq  10a0 <__printf_chk@plt>
    1202:	83 eb 01             	sub    $0x1,%ebx
    1205:	75 e9                	jne    11f0 <main+0x47>
