...
/app/bin_gccgcc10_O2/2020_12_19-Lesson-b:     file format elf64-x86-64
...
0000000000001060 <main>:
    ...
    1064:	41 54                	push   %r12
    1066:	4c 8d 25 97 0f 00 00 	lea    0xf97(%rip),%r12        # 2004 <_IO_stdin_used+0x4>
    106d:	55                   	push   %rbp
    106e:	bd 09 00 00 00       	mov    $0x9,%ebp
    1073:	53                   	push   %rbx
    1074:	bb 02 00 00 00       	mov    $0x2,%ebx
    1079:	48 83 ec 10          	sub    $0x10,%rsp
    107d:	48 8b 05 bc 0f 00 00 	mov    0xfbc(%rip),%rax        # 2040 <_IO_stdin_used+0x40>
    1084:	66 48 0f 6e d0       	movq   %rax,%xmm2
    1089:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
    1090:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1094:	89 da                	mov    %ebx,%edx
    1096:	4c 89 e6             	mov    %r12,%rsi
    1099:	bf 01 00 00 00       	mov    $0x1,%edi
    109e:	f3 0f 2a cb          	cvtsi2ss %ebx,%xmm1
    10a2:	f2 0f 10 05 96 0f 00 	movsd  0xf96(%rip),%xmm0        # 2040 <_IO_stdin_used+0x40>
    10a9:	00 
    10aa:	b8 01 00 00 00       	mov    $0x1,%eax
    10af:	01 db                	add    %ebx,%ebx
    10b1:	f3 0f 5a c9          	cvtss2sd %xmm1,%xmm1
    10b5:	f2 0f 5e c1          	divsd  %xmm1,%xmm0
    10b9:	f2 0f 58 c2          	addsd  %xmm2,%xmm0
    10bd:	66 0f ef d2          	pxor   %xmm2,%xmm2
    10c1:	f2 0f 5a c0          	cvtsd2ss %xmm0,%xmm0
    10c5:	f3 0f 5a d0          	cvtss2sd %xmm0,%xmm2
    10c9:	66 0f 28 c2          	movapd %xmm2,%xmm0
    10cd:	f2 0f 11 54 24 08    	movsd  %xmm2,0x8(%rsp)
    10d3:	e8 78 ff ff ff       	callq  1050 <__printf_chk@plt>
    10d8:	83 ed 01             	sub    $0x1,%ebp
    10db:	f2 0f 10 54 24 08    	movsd  0x8(%rsp),%xmm2
    10e1:	75 ad                	jne    1090 <main+0x30>
    10e3:	66 0f 28 c2          	movapd %xmm2,%xmm0
    10e7:	bf 01 00 00 00       	mov    $0x1,%edi
    10ec:	b8 01 00 00 00       	mov    $0x1,%eax
    10f1:	48 8d 35 20 0f 00 00 	lea    0xf20(%rip),%rsi        # 2018 <_IO_stdin_used+0x18>
    10f8:	e8 53 ff ff ff       	callq  1050 <__printf_chk@plt>
    10fd:	48 83 c4 10          	add    $0x10,%rsp
...
0000000000001110 <_start>:
    ...
    1131:	48 8d 3d 28 ff ff ff 	lea    -0xd8(%rip),%rdi        # 1060 <main>
...
00000000000011b0 <__do_global_dtors_aux>:
    ...
    11d2:	e8 69 fe ff ff       	callq  1040 <__cxa_finalize@plt>
