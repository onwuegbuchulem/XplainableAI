...
/app/bin_gccgcc10_O1/2019_06_15-Lesson-b:     file format elf64-x86-64
...
00000000000011e9 <main>:
    ...
    11ed:	53                   	push   %rbx
    11ee:	48 81 ec 20 08 00 00 	sub    $0x820,%rsp
    11f5:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11fc:	00 00 
    11fe:	48 89 84 24 18 08 00 	mov    %rax,0x818(%rsp)
    1205:	00 
    1206:	31 c0                	xor    %eax,%eax
    1208:	48 b8 64 65 63 6c 61 	movabs $0x746172616c636564,%rax
    120f:	72 61 74 
    1212:	48 ba 69 6f 6e 2e 74 	movabs $0x7478742e6e6f69,%rdx
    1219:	78 74 00 
    121c:	48 89 04 24          	mov    %rax,(%rsp)
    1220:	48 89 54 24 08       	mov    %rdx,0x8(%rsp)
    1225:	48 89 e7             	mov    %rsp,%rdi
    1228:	48 8d 35 d5 0d 00 00 	lea    0xdd5(%rip),%rsi        # 2004 <_IO_stdin_used+0x4>
    122f:	e8 ac fe ff ff       	callq  10e0 <fopen@plt>
    1234:	48 85 c0             	test   %rax,%rax
    1237:	74 5c                	je     1295 <main+0xac>
    1239:	48 89 c3             	mov    %rax,%rbx
    123c:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
    1241:	48 89 c1             	mov    %rax,%rcx
    1244:	ba 00 08 00 00       	mov    $0x800,%edx
    1249:	be 01 00 00 00       	mov    $0x1,%esi
    124e:	e8 4d fe ff ff       	callq  10a0 <fread@plt>
    1253:	48 89 c2             	mov    %rax,%rdx
    1256:	48 8d 35 bc 0d 00 00 	lea    0xdbc(%rip),%rsi        # 2019 <_IO_stdin_used+0x19>
    125d:	bf 01 00 00 00       	mov    $0x1,%edi
    1262:	b8 00 00 00 00       	mov    $0x0,%eax
    1267:	e8 64 fe ff ff       	callq  10d0 <__printf_chk@plt>
    126c:	48 89 df             	mov    %rbx,%rdi
    126f:	e8 3c fe ff ff       	callq  10b0 <fclose@plt>
    1274:	b8 00 00 00 00       	mov    $0x0,%eax
    1279:	48 8b 8c 24 18 08 00 	mov    0x818(%rsp),%rcx
    1280:	00 
    1281:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    1288:	00 00 
    128a:	75 30                	jne    12bc <main+0xd3>
    128c:	48 81 c4 20 08 00 00 	add    $0x820,%rsp
    1293:	5b                   	pop    %rbx
    1294:	c3                   	retq   
    1295:	48 89 e1             	mov    %rsp,%rcx
    1298:	48 8d 15 67 0d 00 00 	lea    0xd67(%rip),%rdx        # 2006 <_IO_stdin_used+0x6>
    129f:	be 01 00 00 00       	mov    $0x1,%esi
    12a4:	48 8b 3d 75 2d 00 00 	mov    0x2d75(%rip),%rdi        # 4020 <stderr@@GLIBC_2.2.5>
    12ab:	b8 00 00 00 00       	mov    $0x0,%eax
    12b0:	e8 3b fe ff ff       	callq  10f0 <__fprintf_chk@plt>
    12b5:	b8 01 00 00 00       	mov    $0x1,%eax
    12ba:	eb bd                	jmp    1279 <main+0x90>
