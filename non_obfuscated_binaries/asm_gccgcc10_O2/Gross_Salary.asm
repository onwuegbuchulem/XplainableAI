...
/app/bin_gccgcc10_O2/Gross_Salary:     file format elf64-x86-64
...
00000000000010c0 <main>:
    ...
    10e4:	48 8d 74 24 10       	lea    0x10(%rsp),%rsi
    10e9:	48 8d 3d 6d 0f 00 00 	lea    0xf6d(%rip),%rdi        # 205d <_IO_stdin_used+0x5d>
    10f0:	31 c0                	xor    %eax,%eax
    10f2:	e8 b9 ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    10f7:	48 8d 3d 20 0f 00 00 	lea    0xf20(%rip),%rdi        # 201e <_IO_stdin_used+0x1e>
    10fe:	e8 7d ff ff ff       	callq  1080 <puts@plt>
    1103:	48 8d 74 24 0c       	lea    0xc(%rsp),%rsi
    1108:	48 8d 3d 4e 0f 00 00 	lea    0xf4e(%rip),%rdi        # 205d <_IO_stdin_used+0x5d>
    110f:	31 c0                	xor    %eax,%eax
    1111:	e8 9a ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1116:	48 8d 3d 12 0f 00 00 	lea    0xf12(%rip),%rdi        # 202f <_IO_stdin_used+0x2f>
    111d:	e8 5e ff ff ff       	callq  1080 <puts@plt>
    1122:	48 8d 74 24 14       	lea    0x14(%rsp),%rsi
    1127:	48 8d 3d 2f 0f 00 00 	lea    0xf2f(%rip),%rdi        # 205d <_IO_stdin_used+0x5d>
    112e:	31 c0                	xor    %eax,%eax
    1130:	e8 7b ff ff ff       	callq  10b0 <__isoc99_scanf@plt>
    1135:	f3 0f 10 44 24 10    	movss  0x10(%rsp),%xmm0
    113b:	f3 0f 10 4c 24 14    	movss  0x14(%rsp),%xmm1
    1141:	f3 0f 5e 0d 17 0f 00 	divss  0xf17(%rip),%xmm1        # 2060 <_IO_stdin_used+0x60>
    1148:	00 
    1149:	f3 0f 58 44 24 0c    	addss  0xc(%rsp),%xmm0
    114f:	bf 01 00 00 00       	mov    $0x1,%edi
    1154:	b8 01 00 00 00       	mov    $0x1,%eax
    1159:	f3 0f 58 0d 03 0f 00 	addss  0xf03(%rip),%xmm1        # 2064 <_IO_stdin_used+0x64>
    1160:	00 
    1161:	48 8d 35 e5 0e 00 00 	lea    0xee5(%rip),%rsi        # 204d <_IO_stdin_used+0x4d>
    1168:	f3 0f 59 c1          	mulss  %xmm1,%xmm0
    116c:	f3 0f 5a c0          	cvtss2sd %xmm0,%xmm0
    1170:	e8 2b ff ff ff       	callq  10a0 <__printf_chk@plt>
    1175:	48 8b 44 24 18       	mov    0x18(%rsp),%rax
    117a:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    1181:	00 00 
    1183:	75 05                	jne    118a <main+0xca>
    1185:	48 83 c4 28          	add    $0x28,%rsp
    1189:	c3                   	retq   
