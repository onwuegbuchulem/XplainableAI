...
/app/bin_gccgcc10_O0/SwapIntegersWithout3rdVariable(Arithmatic):     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    1184:	c7 45 f0 05 00 00 00 	movl   $0x5,-0x10(%rbp)
    118b:	c7 45 f4 0a 00 00 00 	movl   $0xa,-0xc(%rbp)
    1192:	48 8d 55 f4          	lea    -0xc(%rbp),%rdx
    1196:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    ...
    11bc:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11bf:	29 d0                	sub    %edx,%eax
    11c1:	89 45 f4             	mov    %eax,-0xc(%rbp)
    11c4:	8b 45 f0             	mov    -0x10(%rbp),%eax
    11c7:	8b 55 f4             	mov    -0xc(%rbp),%edx
    11ca:	29 d0                	sub    %edx,%eax
    11cc:	89 45 f0             	mov    %eax,-0x10(%rbp)
    11cf:	48 8d 55 f4          	lea    -0xc(%rbp),%rdx
    11d3:	48 8d 45 f0          	lea    -0x10(%rbp),%rax
    11d7:	48 89 c6             	mov    %rax,%rsi
    11da:	48 8d 3d 47 0e 00 00 	lea    0xe47(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    ...
    11f4:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    11fb:	00 00 
    11fd:	74 05                	je     1204 <main+0x9b>
