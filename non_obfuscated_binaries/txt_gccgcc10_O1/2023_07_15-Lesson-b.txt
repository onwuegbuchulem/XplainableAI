...
/app/bin_gccgcc10_O1/2023_07_15-Lesson-b:     file format elf64-x86-64
...
00000000000010d0 <malloc@plt>:
    ...
    10d4:	f2 ff 25 c5 2e 00 00 	bnd jmpq *0x2ec5(%rip)        # 3fa0 <malloc@GLIBC_2.2.5>
    10db:	0f 1f 44 00 00       	nopl   0x0(%rax,%rax,1)

00000000000010e0 <realloc@plt>:
    10e0:	f3 0f 1e fa          	endbr64 
    10e4:	f2 ff 25 bd 2e 00 00 	bnd jmpq *0x2ebd(%rip)        # 3fa8 <realloc@GLIBC_2.2.5>
...
0000000000001140 <_start>:
    ...
    1151:	50                   	push   %rax
    1152:	54                   	push   %rsp
    1153:	4c 8d 05 46 02 00 00 	lea    0x246(%rip),%r8        # 13a0 <__libc_csu_fini>
    115a:	48 8d 0d cf 01 00 00 	lea    0x1cf(%rip),%rcx        # 1330 <__libc_csu_init>
...
0000000000001229 <main>:
    ...
    1237:	bf 10 00 00 00       	mov    $0x10,%edi
    123c:	e8 8f fe ff ff       	callq  10d0 <malloc@plt>
    1241:	49 89 c4             	mov    %rax,%r12
    1244:	bf 01 00 00 00       	mov    $0x1,%edi
    1249:	e8 82 fe ff ff       	callq  10d0 <malloc@plt>
    124e:	4d 85 e4             	test   %r12,%r12
    1251:	0f 84 80 00 00 00    	je     12d7 <main+0xae>
    1257:	48 89 c3             	mov    %rax,%rbx
    125a:	48 85 c0             	test   %rax,%rax
    125d:	74 78                	je     12d7 <main+0xae>
    125f:	c6 00 00             	movb   $0x0,(%rax)
    1262:	41 c6 04 24 00       	movb   $0x0,(%r12)
    1267:	4c 8d 2d af 0d 00 00 	lea    0xdaf(%rip),%r13        # 201d <_IO_stdin_used+0x1d>
    126e:	4c 89 ee             	mov    %r13,%rsi
    1271:	bf 01 00 00 00       	mov    $0x1,%edi
    1276:	b8 00 00 00 00       	mov    $0x0,%eax
    127b:	e8 70 fe ff ff       	callq  10f0 <__printf_chk@plt>
    1280:	4c 89 e6             	mov    %r12,%rsi
    1283:	48 8d 3d 9a 0d 00 00 	lea    0xd9a(%rip),%rdi        # 2024 <_IO_stdin_used+0x24>
    128a:	b8 00 00 00 00       	mov    $0x0,%eax
    128f:	e8 6c fe ff ff       	callq  1100 <__isoc99_scanf@plt>
    1294:	48 89 df             	mov    %rbx,%rdi
    1297:	e8 24 fe ff ff       	callq  10c0 <strlen@plt>
    129c:	48 89 c5             	mov    %rax,%rbp
    129f:	4c 89 e7             	mov    %r12,%rdi
    12a2:	e8 19 fe ff ff       	callq  10c0 <strlen@plt>
    12a7:	48 8d 74 05 02       	lea    0x2(%rbp,%rax,1),%rsi
    12ac:	48 89 df             	mov    %rbx,%rdi
    12af:	e8 2c fe ff ff       	callq  10e0 <realloc@plt>
    12b4:	48 89 c3             	mov    %rax,%rbx
    12b7:	48 85 c0             	test   %rax,%rax
    12ba:	74 42                	je     12fe <main+0xd5>
    12bc:	4c 89 e6             	mov    %r12,%rsi
    12bf:	48 89 c7             	mov    %rax,%rdi
    12c2:	e8 49 fe ff ff       	callq  1110 <strcat@plt>
    12c7:	48 89 df             	mov    %rbx,%rdi
    12ca:	e8 f1 fd ff ff       	callq  10c0 <strlen@plt>
    12cf:	66 c7 04 03 20 00    	movw   $0x20,(%rbx,%rax,1)
    12d5:	eb 97                	jmp    126e <main+0x45>
    12d7:	48 8b 0d 42 2d 00 00 	mov    0x2d42(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    12de:	ba 18 00 00 00       	mov    $0x18,%edx
    12e3:	be 01 00 00 00       	mov    $0x1,%esi
    12e8:	48 8d 3d 15 0d 00 00 	lea    0xd15(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    12ef:	e8 3c fe ff ff       	callq  1130 <fwrite@plt>
    12f4:	bf 01 00 00 00       	mov    $0x1,%edi
    12f9:	e8 22 fe ff ff       	callq  1120 <exit@plt>
    12fe:	48 8b 0d 1b 2d 00 00 	mov    0x2d1b(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    1305:	ba 13 00 00 00       	mov    $0x13,%edx
