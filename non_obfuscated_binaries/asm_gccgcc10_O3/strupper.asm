...
/app/bin_gccgcc10_O3/strupper:     file format elf64-x86-64
...
0000000000001080 <main>:
    ...
    10e8:	8d 48 9f             	lea    -0x61(%rax),%ecx
    10eb:	80 f9 19             	cmp    $0x19,%cl
    10ee:	77 40                	ja     1130 <main+0xb0>
    10f0:	83 e0 df             	and    $0xffffffdf,%eax
...
0000000000001240 <strupper>:
    ...
    127a:	75 d4                	jne    1250 <strupper+0x10>
    127c:	c3                   	retq   
