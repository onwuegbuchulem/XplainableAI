...
/app/bin_gccgcc10_O1/random01:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11bc:	83 eb 01             	sub    $0x1,%ebx
    11bf:	75 e2                	jne    11a3 <main+0x1a>
    11c1:	48 8b 35 48 2e 00 00 	mov    0x2e48(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11c8:	bf 0a 00 00 00       	mov    $0xa,%edi
    11cd:	e8 9e fe ff ff       	callq  1070 <putc@plt>
    11d2:	41 83 ec 01          	sub    $0x1,%r12d
    11d6:	75 c6                	jne    119e <main+0x15>
