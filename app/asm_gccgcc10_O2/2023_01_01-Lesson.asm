...
/app/bin_gccgcc10_O2/2023_01_01-Lesson:     file format elf64-x86-64
...
00000000000010a0 <__xstat@plt>:
    10a0:	f3 0f 1e fa          	endbr64 
    10a4:	f2 ff 25 1d 2f 00 00 	bnd jmpq *0x2f1d(%rip)        # 3fc8 <__xstat@GLIBC_2.2.5>
...
00000000000010c0 <main>:
    ...
    10c4:	41 54                	push   %r12
    10c6:	48 81 ec a0 00 00 00 	sub    $0xa0,%rsp
    10cd:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    10d4:	00 00 
    10d6:	48 89 84 24 98 00 00 	mov    %rax,0x98(%rsp)
    10dd:	00 
    10de:	31 c0                	xor    %eax,%eax
    10e0:	83 ff 01             	cmp    $0x1,%edi
    10e3:	7e 6d                	jle    1152 <main+0x92>
    10e5:	4c 8b 66 08          	mov    0x8(%rsi),%r12
    10e9:	48 89 e2             	mov    %rsp,%rdx
    10ec:	bf 01 00 00 00       	mov    $0x1,%edi
    10f1:	4c 89 e6             	mov    %r12,%rsi
    10f4:	e8 a7 ff ff ff       	callq  10a0 <__xstat@plt>
    10f9:	83 f8 ff             	cmp    $0xffffffff,%eax
    10fc:	74 3a                	je     1138 <main+0x78>
    10fe:	48 8b 4c 24 30       	mov    0x30(%rsp),%rcx
    1103:	4c 89 e2             	mov    %r12,%rdx
    1106:	bf 01 00 00 00       	mov    $0x1,%edi
    110b:	31 c0                	xor    %eax,%eax
    110d:	48 8d 35 16 0f 00 00 	lea    0xf16(%rip),%rsi        # 202a <_IO_stdin_used+0x2a>
    1114:	e8 97 ff ff ff       	callq  10b0 <__printf_chk@plt>
    1119:	31 c0                	xor    %eax,%eax
    111b:	48 8b 8c 24 98 00 00 	mov    0x98(%rsp),%rcx
    1122:	00 
    1123:	64 48 2b 0c 25 28 00 	sub    %fs:0x28,%rcx
    112a:	00 00 
    112c:	75 37                	jne    1165 <main+0xa5>
    112e:	48 81 c4 a0 00 00 00 	add    $0xa0,%rsp
    1135:	41 5c                	pop    %r12
    1137:	c3                   	retq   
    1138:	4c 89 e2             	mov    %r12,%rdx
    113b:	48 8d 35 d5 0e 00 00 	lea    0xed5(%rip),%rsi        # 2017 <_IO_stdin_used+0x17>
    1142:	bf 01 00 00 00       	mov    $0x1,%edi
    1147:	31 c0                	xor    %eax,%eax
    1149:	e8 62 ff ff ff       	callq  10b0 <__printf_chk@plt>
    114e:	31 c0                	xor    %eax,%eax
    1150:	eb c9                	jmp    111b <main+0x5b>
    1152:	48 8d 3d ab 0e 00 00 	lea    0xeab(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1159:	e8 22 ff ff ff       	callq  1080 <puts@plt>
    115e:	b8 01 00 00 00       	mov    $0x1,%eax
    1163:	eb b6                	jmp    111b <main+0x5b>
    1165:	e8 26 ff ff ff       	callq  1090 <__stack_chk_fail@plt>
