...
/app/bin_gccgcc10_O1/return03:     file format elf64-x86-64
...
00000000000010e0 <_start>:
    ...
    10f1:	50                   	push   %rax
    10f2:	54                   	push   %rsp
    10f3:	4c 8d 05 a6 01 00 00 	lea    0x1a6(%rip),%r8        # 12a0 <__libc_csu_fini>
    10fa:	48 8d 0d 2f 01 00 00 	lea    0x12f(%rip),%rcx        # 1230 <__libc_csu_init>
...
00000000000011c9 <main>:
    ...
    11d1:	bf 00 00 00 00       	mov    $0x0,%edi
    11d6:	e8 d5 fe ff ff       	callq  10b0 <time@plt>
    11db:	48 89 c7             	mov    %rax,%rdi
    11de:	e8 bd fe ff ff       	callq  10a0 <srand@plt>
    11e3:	e8 e8 fe ff ff       	callq  10d0 <rand@plt>
    11e8:	a8 01                	test   $0x1,%al
    11ea:	74 27                	je     1213 <main+0x4a>
    11ec:	48 8b 0d 2d 2e 00 00 	mov    0x2e2d(%rip),%rcx        # 4020 <stderr@@GLIBC_2.2.5>
    11f3:	ba 1f 00 00 00       	mov    $0x1f,%edx
    11f8:	be 01 00 00 00       	mov    $0x1,%esi
    11fd:	48 8d 3d 04 0e 00 00 	lea    0xe04(%rip),%rdi        # 2008 <_IO_stdin_used+0x8>
    1204:	e8 b7 fe ff ff       	callq  10c0 <fwrite@plt>
    1209:	b8 01 00 00 00       	mov    $0x1,%eax
    120e:	48 83 c4 08          	add    $0x8,%rsp
    1212:	c3                   	retq   
    1213:	48 8d 3d 0e 0e 00 00 	lea    0xe0e(%rip),%rdi        # 2028 <_IO_stdin_used+0x28>
    121a:	e8 71 fe ff ff       	callq  1090 <puts@plt>
    121f:	b8 00 00 00 00       	mov    $0x0,%eax
    1224:	eb e8                	jmp    120e <main+0x45>
...
0000000000001230 <__libc_csu_init>:
    ...
    1234:	41 57                	push   %r15
    1236:	4c 8d 3d 5b 2b 00 00 	lea    0x2b5b(%rip),%r15        # 3d98 <__frame_dummy_init_array_entry>
    123d:	41 56                	push   %r14
    ...
    124c:	55                   	push   %rbp
    124d:	48 8d 2d 4c 2b 00 00 	lea    0x2b4c(%rip),%rbp        # 3da0 <__do_global_dtors_aux_fini_array_entry>
    1254:	53                   	push   %rbx
