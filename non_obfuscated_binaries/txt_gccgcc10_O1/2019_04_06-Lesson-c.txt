...
/app/bin_gccgcc10_O1/2019_04_06-Lesson-c:     file format elf64-x86-64
...
0000000000001189 <main>:
    ...
    11ba:	48 8d 3d 70 0e 00 00 	lea    0xe70(%rip),%rdi        # 2031 <_IO_stdin_used+0x31>
    11c1:	b8 00 00 00 00       	mov    $0x0,%eax
    11c6:	e8 c5 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11cb:	8b 14 24             	mov    (%rsp),%edx
    11ce:	39 54 24 04          	cmp    %edx,0x4(%rsp)
    11d2:	0f 4d 54 24 04       	cmovge 0x4(%rsp),%edx
    11d7:	48 8d 35 59 0e 00 00 	lea    0xe59(%rip),%rsi        # 2037 <_IO_stdin_used+0x37>
    11de:	bf 01 00 00 00       	mov    $0x1,%edi
    11e3:	b8 00 00 00 00       	mov    $0x0,%eax
    11e8:	e8 93 fe ff ff       	callq  1080 <__printf_chk@plt>
    11ed:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11f2:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f9:	00 00 
    11fb:	75 0a                	jne    1207 <main+0x7e>
