...
/app/bin_gccgcc10_O1/word_parse01:     file format elf64-x86-64
...
00000000000010b0 <fgets@plt>:
    ...
    10b4:	f2 ff 25 05 2f 00 00 	bnd jmpq *0x2f05(%rip)        # 3fc0 <fgets@GLIBC_2.2.5>
...
00000000000011c9 <main>:
    ...
    11cd:	53                   	push   %rbx
    11ce:	48 83 ec 50          	sub    $0x50,%rsp
    11d2:	64 48 8b 04 25 28 00 	mov    %fs:0x28,%rax
    11d9:	00 00 
    11db:	48 89 44 24 48       	mov    %rax,0x48(%rsp)
    ...
    11f3:	48 89 e3             	mov    %rsp,%rbx
    11f6:	48 8b 15 13 2e 00 00 	mov    0x2e13(%rip),%rdx        # 4010 <stdin@@GLIBC_2.2.5>
    11fd:	be 40 00 00 00       	mov    $0x40,%esi
    1202:	48 89 df             	mov    %rbx,%rdi
    1205:	e8 a6 fe ff ff       	callq  10b0 <fgets@plt>
    120a:	48 8d 35 02 0e 00 00 	lea    0xe02(%rip),%rsi        # 2013 <_IO_stdin_used+0x13>
    1211:	48 89 df             	mov    %rbx,%rdi
    1214:	e8 b7 fe ff ff       	callq  10d0 <strtok@plt>
    1219:	48 85 c0             	test   %rax,%rax
    121c:	74 24                	je     1242 <main+0x79>
    121e:	48 89 c7             	mov    %rax,%rdi
    1221:	48 8d 1d eb 0d 00 00 	lea    0xdeb(%rip),%rbx        # 2013 <_IO_stdin_used+0x13>
    1228:	e8 63 fe ff ff       	callq  1090 <puts@plt>
    122d:	48 89 de             	mov    %rbx,%rsi
    1230:	bf 00 00 00 00       	mov    $0x0,%edi
    1235:	e8 96 fe ff ff       	callq  10d0 <strtok@plt>
    123a:	48 89 c7             	mov    %rax,%rdi
    123d:	48 85 c0             	test   %rax,%rax
    1240:	75 e6                	jne    1228 <main+0x5f>
    1242:	48 8b 44 24 48       	mov    0x48(%rsp),%rax
    1247:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    124e:	00 00 
    1250:	75 0b                	jne    125d <main+0x94>
    1252:	b8 00 00 00 00       	mov    $0x0,%eax
    1257:	48 83 c4 50          	add    $0x50,%rsp
    125b:	5b                   	pop    %rbx
    125c:	c3                   	retq   
    125d:	e8 3e fe ff ff       	callq  10a0 <__stack_chk_fail@plt>
