...
/app/bin_gccgcc10_O0/02_problem2:     file format elf64-x86-64
...
0000000000001149 <main>:
    ...
    1155:	c7 45 f8 06 00 00 00 	movl   $0x6,-0x8(%rbp)
    115c:	c7 45 fc 0a 00 00 00 	movl   $0xa,-0x4(%rbp)
    1163:	66 0f ef c9          	pxor   %xmm1,%xmm1
    1167:	f2 0f 2a 4d f8       	cvtsi2sdl -0x8(%rbp),%xmm1
    116c:	f2 0f 10 05 04 0f 00 	movsd  0xf04(%rip),%xmm0        # 2078 <_IO_stdin_used+0x78>
    1173:	00 
    1174:	f2 0f 59 c8          	mulsd  %xmm0,%xmm1
    1178:	66 0f ef c0          	pxor   %xmm0,%xmm0
    117c:	f2 0f 2a 45 f8       	cvtsi2sdl -0x8(%rbp),%xmm0
    1181:	f2 0f 59 c8          	mulsd  %xmm0,%xmm1
    1185:	66 48 0f 7e ca       	movq   %xmm1,%rdx
    118a:	8b 45 f8             	mov    -0x8(%rbp),%eax
    118d:	66 48 0f 6e c2       	movq   %rdx,%xmm0
    ...
    11a5:	66 0f ef c9          	pxor   %xmm1,%xmm1
    11a9:	f2 0f 2a 4d f8       	cvtsi2sdl -0x8(%rbp),%xmm1
    11ae:	f2 0f 10 05 c2 0e 00 	movsd  0xec2(%rip),%xmm0        # 2078 <_IO_stdin_used+0x78>
    11b5:	00 
    11b6:	f2 0f 59 c8          	mulsd  %xmm0,%xmm1
    11ba:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11be:	f2 0f 2a 45 f8       	cvtsi2sdl -0x8(%rbp),%xmm0
    11c3:	f2 0f 59 c8          	mulsd  %xmm0,%xmm1
    11c7:	66 0f ef c0          	pxor   %xmm0,%xmm0
    11cb:	f2 0f 2a 45 fc       	cvtsi2sdl -0x4(%rbp),%xmm0
    11d0:	f2 0f 59 c8          	mulsd  %xmm0,%xmm1
    11d4:	66 48 0f 7e c9       	movq   %xmm1,%rcx
    11d9:	8b 55 fc             	mov    -0x4(%rbp),%edx
    11dc:	8b 45 f8             	mov    -0x8(%rbp),%eax
    11df:	66 48 0f 6e c1       	movq   %rcx,%xmm0
    11e4:	89 c6                	mov    %eax,%esi
    11e6:	48 8d 3d 4b 0e 00 00 	lea    0xe4b(%rip),%rdi        # 2038 <_IO_stdin_used+0x38>
