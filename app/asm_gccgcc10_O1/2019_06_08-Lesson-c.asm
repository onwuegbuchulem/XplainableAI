...
/app/bin_gccgcc10_O1/2019_06_08-Lesson-c:     file format elf64-x86-64
...
0000000000001169 <main>:
    ...
    11d1:	48 89 e3             	mov    %rsp,%rbx
    11d4:	0f be 3b             	movsbl (%rbx),%edi
    11d7:	48 8b 35 32 2e 00 00 	mov    0x2e32(%rip),%rsi        # 4010 <stdout@@GLIBC_2.2.5>
    11de:	e8 8d fe ff ff       	callq  1070 <putc@plt>
    11e3:	48 83 c3 01          	add    $0x1,%rbx
    11e7:	85 c0                	test   %eax,%eax
    11e9:	75 e9                	jne    11d4 <main+0x6b>
    11eb:	48 8b 44 24 28       	mov    0x28(%rsp),%rax
    11f0:	64 48 2b 04 25 28 00 	sub    %fs:0x28,%rax
    11f7:	00 00 
    11f9:	75 0b                	jne    1206 <main+0x9d>
    11fb:	b8 00 00 00 00       	mov    $0x0,%eax
    1200:	48 83 c4 30          	add    $0x30,%rsp
    1204:	5b                   	pop    %rbx
    1205:	c3                   	retq   
    1206:	e8 55 fe ff ff       	callq  1060 <__stack_chk_fail@plt>
